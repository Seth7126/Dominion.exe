...
0073490C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00734924    push 0x00
00734926    push eax
00734927    call 0x00761FC4                                 ; => [ Type: FD_SET | Call: memset ]
0073492C    mov esi, dword ptr ss:[ebp+0x08]
0073492F    lea eax, ss:[esp+0x124]
00734936    inc dword ptr ss:[esp+0x1C]                     ; => [ Field: fd_count ]
0073493A    push 0x104
0073493F    push 0x00
00734941    push eax
00734942    mov dword ptr ss:[esp+0x2C], esi                ; => [ Field: fd_array ]
00734946    call 0x00761FC4                                 ; => [ Type: FD_SET | Call: memset ]
0073494B    inc dword ptr ss:[esp+0x130]                    ; => [ Field: fd_count ]
00734952    lea eax, ss:[esp+0x20]
00734956    add esp, 0x18
00734959    mov dword ptr ss:[esp+0x11C], esi               ; => [ Field: fd_array ]
00734960    mov dword ptr ss:[esp+0x08], 0x00               ; => [ Type: TIMEVAL | Call: __builtin_memset ]
...
0073497E    push 0x00
00734980    push esi
00734981    call dword ptr ds:[0x007754D0]                  ; => [ Call: nullptr ]
...
007349AB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
007349D9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
007349FD    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: result != SOCKET_ERROR | String: C:\x\ax2017\Engine\Windows\WindowsNetwork.cpp | String: WinsockNetworkInterface::TCPIsConnected ]
00734A02    add esp, 0x0C
00734A05    call 0x0063BC30
00734A0A    test al, al
00734A0C    jz 0x00734A0F                                   ; => [ Call: sub_63bc30 ]
00734A0E    int3
00734A0F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
