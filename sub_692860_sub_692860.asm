...
00692865    push 0x76EEFE                                   ; => [ Call: sub_76eefe | Type: EHRegistrationNode ]
0069286A    mov eax, dword ptr fs:[0x00000000]
00692870    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0069287E    push eax                                        ; => [ Data: __security_cookie ]
0069287F    lea eax, ss:[ebp-0x0C]
00692882    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00692888    mov edi, edx
0069288A    mov ebx, ecx
0069288C    mov dword ptr ss:[ebp-0x1C], ebx
0069288F    mov dword ptr ss:[ebp-0x18], 0x00
00692896    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
006928CC    movzx eax, byte ptr ds:[eax+0x692B18]           ; => [ Data: lookup_table_692b18 ]
006928D3    jmp dword ptr ds:[eax*4+0x692B04]               ; => [ Data: jump_table_692b04 ]
006928DA    push dword ptr ss:[ebp+0x14]
006928DD    mov ecx, ebx
006928DF    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
00692925    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
00692936    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00692944    mov eax, 0x807454                               ; => [ Data: data_807454 ]
...
00692985    dword 80723468                                  ; => [ Data: data_807234 ]
...
006929A5    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006929AA    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_6921f0 | String: . ]
006929AC    test eax, eax
006929AE    cmovnz ecx, eax
006929B1    push ecx
006929B2    mov ecx, ebx
006929B4    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006929B9    mov dword ptr ss:[ebp-0x04], 0x02
006929C0    cmp dword ptr ds:[0x00CF65BC], 0x00
006929C7    jz 0x006929F7                                   ; => [ Data: data_cf65bc ]
...
006929D8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006929EB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006929F0    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006929F7    inc edi
006929F8    mov byte ptr ss:[ebp-0x04], 0x00
006929FC    cmp byte ptr ds:[edi], 0x2C
006929FF    jz 0x00692A95
00692A05    push 0x878214                                   ; => [ String: FormatMicros ]
00692A0A    push 0x742
00692A0F    mov ecx, 0x878200                               ; => [ String: *curFormat == ',' ]
00692A14    jmp 0x00692AE1
00692A19    push 0x8033D0                                   ; => [ Data: data_8033d0 ]
...
00692A39    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00692A3E    mov eax, dword ptr ds:[eax]                     ; => [ Data: data_807234 | Call: sub_6921f0 ]
00692A40    test eax, eax
00692A42    cmovnz ecx, eax
00692A45    push ecx
00692A46    mov ecx, ebx
00692A48    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
00692A4D    mov dword ptr ss:[ebp-0x04], 0x04
00692A54    cmp dword ptr ds:[0x00CF65BC], 0x00
00692A5B    jz 0x00692A8B                                   ; => [ Data: data_cf65bc ]
...
00692A6C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00692A7F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00692A84    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
00692A8B    inc edi
...
00692AAD    push 0x878214                                   ; => [ String: FormatMicros ]
00692AB2    push 0x747
00692AB7    mov ecx, 0x878228                               ; => [ String: *curFormat == '.' ]
00692ABC    jmp 0x00692AE1
00692ABE    mov eax, ebx
00692AC0    mov ecx, dword ptr ss:[ebp-0x0C]
00692AC3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00692ACA    pop ecx
00692ACB    pop edi
00692ACC    pop esi
00692ACD    pop ebx
...
00692AD0    pop ebp
00692AD1    ret
00692AD2    push 0x878214                                   ; => [ String: FormatMicros ]
00692AD7    push 0x74A
00692ADC    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00692AE1    push 0x877D0C
00692AE6    mov edx, 0x801800
00692AEB    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Localization.cpp | String: FormatMicros ]
00692AF0    add esp, 0x0C
00692AF3    call 0x0063BC30
00692AF8    test al, al
00692AFA    jz 0x00692AFD                                   ; => [ Call: sub_63bc30 ]
00692AFC    int3
00692AFD    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
