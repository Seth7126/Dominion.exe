...
00599CF8    push 0x7679FE                                   ; => [ Type: EHRegistrationNode | Call: sub_7679fe ]
00599CFD    mov eax, dword ptr fs:[0x00000000]
00599D03    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00599D04    push ebx
...
00599D12    push esi
00599D13    push edi
00599D14    push eax                                        ; => [ Data: __security_cookie ]
00599D15    lea eax, ss:[ebp-0x0C]
00599D18    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00599D40    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: sub_576c00 ]
...
00599D54    push 0x824CBC                                   ; => [ String: GetCostStr ]
00599D59    push 0x602
00599D5E    mov ecx, 0x81A628                               ; => [ String: costParsed.debt == 0 ]
...
00599E97    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
00599EA8    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00599ED1    mov ecx, 0x824CF8                               ; => [ String: {potion} ]
...
00599EF2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00599EF9    pop ecx
00599EFA    pop edi
00599EFB    pop esi
00599EFC    mov ecx, dword ptr ss:[ebp-0x14]
00599EFF    xor ecx, ebp
00599F01    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00599F06    mov esp, ebp
00599F08    pop ebp
00599F09    mov esp, ebx
00599F0B    pop ebx
00599F0C    ret
00599F0D    push 0x824CBC                                   ; => [ String: GetCostStr ]
00599F12    push 0x603
00599F17    mov ecx, 0x824CC8                               ; => [ String: costParsed.money >= 0 ]
00599F1C    push 0x82487C
00599F21    mov edx, 0x801800
00599F26    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp | Call: sub_63b870 | Data: data_801800 | String: GetCostStr ]
00599F2B    add esp, 0x0C
00599F2E    call 0x0063BC30
00599F33    test al, al
00599F35    jz 0x00599F38                                   ; => [ Call: sub_63bc30 ]
00599F37    int3
00599F38    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00599F3D    push 0x824CBC
00599F42    push 0x609
00599F47    push 0x82487C
00599F4C    mov edx, 0x801800
00599F51    mov ecx, 0x824CE0
00599F56    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp | Call: sub_63b870 | String: costParsed.potions == 1 | Data: data_801800 | String: GetCostStr ]
00599F5B    add esp, 0x0C
00599F5E    call 0x0063BC30
00599F63    test al, al
00599F65    jz 0x00599F68                                   ; => [ Call: sub_63bc30 ]
00599F67    int3
00599F68    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
