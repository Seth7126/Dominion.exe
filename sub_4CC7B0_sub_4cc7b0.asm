...
004CC7B5    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
004CC7BA    mov eax, dword ptr fs:[0x00000000]
004CC7C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004CC7C1    sub esp, 0x08
004CC7C4    push esi
004CC7C5    push edi
004CC7C6    mov eax, dword ptr ds:[0x008C4040]
004CC7CB    xor eax, ebp
004CC7CD    push eax                                        ; => [ Data: __security_cookie ]
004CC7CE    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004CC7D1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004CC7D7    mov esi, edx
004CC7D9    mov edi, ecx
004CC7DB    cmp byte ptr ds:[esi+0x10], 0x00
004CC7DF    jz 0x004CC874
004CC7E5    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CC7EA    movss xmm3, dword ptr ds:[0x00890E18]
004CC7F2    mov edx, 0x8DC4F4
004CC7F7    push 0x00
004CC7F9    push 0xFFFFFFFF
004CC7FB    mov ecx, eax
004CC7FD    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc4f4 ]
004CC802    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
...
004CC81C    call 0x00692B30                                 ; => [ Call: sub_692b30 ]
...
004CC85C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CC86F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CC874    mov ecx, dword ptr ss:[ebp-0x0C]
004CC877    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CC87E    pop ecx
004CC87F    pop edi
004CC880    pop esi
