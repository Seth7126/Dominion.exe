...
00529BE8    push 0x765BBB                                   ; => [ Call: sub_765bbb | Type: EHRegistrationNode ]
00529BED    mov eax, dword ptr fs:[0x00000000]
00529BF3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00529BF4    push ebx
00529BF5    mov eax, 0x2638
00529BFA    call 0x00761E50                                 ; => [ Call: __chkstk ]
00529BFF    mov eax, dword ptr ds:[0x008C4040]
00529C04    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00529C06    mov dword ptr ss:[ebp-0x14], eax
00529C09    push esi
00529C0A    push edi
00529C0B    push eax
00529C0C    lea eax, ss:[ebp-0x0C]
00529C0F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00529C15    xor edx, edx
00529C17    push ecx
00529C18    push 0x00
00529C1A    lea ecx, ds:[edx+0x02]
00529C1D    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
00529C22    call 0x00573400                                 ; => [ Call: sub_573400 ]
00529C27    push 0x00
00529C29    push 0x00
00529C2B    push 0x02
...
00529C33    push 0x01
00529C35    call 0x00590760                                 ; => [ Call: sub_590760 ]
00529C3A    add esp, 0x18
00529C3D    call 0x00573400                                 ; => [ Call: sub_573400 ]
00529C42    mov ecx, dword ptr ds:[eax+0x0C]
00529C45    cmp ecx, 0xFFFFFFFF
00529C48    jnz 0x00529C5B
00529C4A    push 0x81EA64                                   ; => [ String: SetGainFlag ]
00529C4F    push 0x52
00529C51    mov ecx, 0x813C5C                               ; => [ String: c.activePlayer != PLAYER_NONE ]
...
00529C78    call 0x00568780                                 ; => [ Call: sub_568780 ]
00529C7D    mov esi, eax
00529C7F    mov dword ptr ss:[ebp-0x2618], 0x8193B8         ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_bca72008a7f96554d016000a2f4e6e39>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_bca72008a7f96554d016000a2f4e6e39>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00529C89    mov ecx, 0x321
00529C8E    lea edi, ss:[ebp-0xCA0]
00529C94    lea eax, ss:[ebp-0x2618]
00529C9A    add esp, 0x04
00529C9D    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00529C9F    mov dword ptr ss:[ebp-0x25F4], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_bca72008a7f96554d016000a2f4e6e39>,bool,enum CardID>::VTable ]
...
00529CE0    call eax                                        ; => [ Field: vFunc_0 ]
...
00529D03    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
00529D1A    push eax
00529D1B    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00529D1E    mov dword ptr ss:[ebp-0x25F4], 0x00
00529D28    xorps xmm0, xmm0
00529D2B    mov dword ptr ss:[ebp-0x25E4], 0x00
00529D35    movlpd qword ptr ss:[ebp-0x25EC], xmm0          ; => [ Call: __builtin_memset ]
...
00529E12    mov esi, eax                                    ; => [ Call: sub_56b800 ]
00529E14    jz 0x00529E45
00529E16    mov ecx, 0x01
00529E1B    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
00529E20    mov ecx, dword ptr ss:[ebp-0x0C]
00529E23    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00529E2A    pop ecx
00529E2B    pop edi
00529E2C    pop esi
00529E2D    mov ecx, dword ptr ss:[ebp-0x14]
00529E30    xor ecx, ebp
00529E32    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00529E43    mov esi, eax                                    ; => [ Call: sub_56b800 ]
...
00529E5B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00529E7B    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00529E9D    push 0x00
00529E9F    push 0x00
00529EA1    push 0x00                                       ; => [ Call: __builtin_memset ]
...
00529EAF    push 0x00                                       ; => [ Call: nullptr ]
00529EB1    push 0x457
00529EB6    push 0x0B
00529EB8    mov edx, dword ptr ds:[eax+edx*1+0x1A70]
00529EBF    push 0x3E9
00529EC4    push esi
00529EC5    call 0x00582D10                                 ; => [ Call: sub_582d10 ]
...
00529EEF    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00529F23    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00529F49    call 0x005916D0                                 ; => [ Call: sub_5916d0 ]
...
0052A014    call 0x0056B8E0                                 ; => [ Call: sub_56b8e0 ]
0052A019    add esp, 0x0C
0052A01C    jmp 0x00529E20
0052A021    push 0x81EC18                                   ; => [ String: StartOfCleanup ]
0052A026    push 0x1121
0052A02B    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0052A030    push 0x81EA70
0052A035    mov edx, 0x801800
0052A03A    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052A03F    add esp, 0x0C
0052A042    call 0x0063BC30
0052A047    test al, al
0052A049    jz 0x0052A04C                                   ; => [ Call: sub_63bc30 ]
0052A04B    int3
0052A04C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
