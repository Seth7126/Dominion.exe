...
00602F95    push 0x76A8B6                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$copy_wide_to_narrow_find_data@U_wfinddata32_t@@U_finddata32_t@@@@YA_NABU_wfinddata32_t@@AAU_finddata32_t@@I@Z ]
00602F9A    mov eax, dword ptr fs:[0x00000000]
00602FA0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00602FAE    push eax                                        ; => [ Data: __security_cookie ]
00602FAF    lea eax, ss:[ebp-0x0C]
00602FB2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00602FC3    mov eax, 0x7FCAF8                               ; => [ Data: data_7fcaf8 ]
...
0060305C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060306F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00603074    mov eax, edi
00603076    mov ecx, dword ptr ss:[ebp-0x0C]
00603079    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00603080    pop ecx
00603081    pop edi
00603082    pop esi
00603083    pop ebx
...
00603099    push 0x02
0060309B    push esi
0060309C    call 0x00693100                                 ; => [ Call: sub_693100 ]
...
006030AA    push esi
006030AB    push eax
006030AC    call 0x00598720                                 ; => [ Call: sub_598720 ]
...
006030DD    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: CardTypeDefGet | String: Halt ]
006030E2    add esp, 0x0C
006030E5    call 0x0063BC30
006030EA    test al, al
006030EC    jz 0x006030EF                                   ; => [ Call: sub_63bc30 ]
006030EE    int3
006030EF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
