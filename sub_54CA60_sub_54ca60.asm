...
0054CB55    push eax
0054CB56    call dword ptr ds:[edx+0x10]
...
0054CB8D    movlpd qword ptr ss:[ebp-0x197C], xmm0
...
0054CC0B    call 0x00563C40
0054CC10    add esp, 0x0C
0054CC13    mov edi, eax
0054CC15    call 0x00573400
