...
005028F8    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
005028FD    mov eax, dword ptr fs:[0x00000000]
00502903    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00502904    push ebx
00502905    mov eax, 0x19A8
0050290A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0050290F    mov eax, dword ptr ds:[0x008C4040]
00502914    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00502916    mov dword ptr ss:[ebp-0x14], eax
00502919    push esi
0050291A    push edi
0050291B    push eax
0050291C    lea eax, ss:[ebp-0x0C]
0050291F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00502925    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050292A    lea ecx, ss:[ebp-0x19B8]
00502930    push 0x04
00502932    push ecx
00502933    mov edx, dword ptr ds:[eax+0x0C]
00502936    mov ecx, dword ptr ds:[eax+0x04]
00502939    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0050293E    mov ecx, 0x321
00502943    mov dword ptr ss:[ebp-0xD38], eax
00502949    lea esi, ss:[ebp-0x19B8]
0050294F    mov dword ptr ss:[ebp-0xD00], 0x80AA5C          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2a614212a69c33da78a6126eb7977b4f>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_2a614212a69c33da78a6126eb7977b4f>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00502959    lea edi, ss:[ebp-0xCA0]
0050295F    add esp, 0x08
00502962    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00502964    lea ecx, ss:[ebp-0xD00]
0050296A    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2a614212a69c33da78a6126eb7977b4f>,bool,enum CardID>::VTable ]
...
005029AB    call eax
005029AD    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
005029D3    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
005029EA    push eax
005029EB    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
005029EE    xorps xmm0, xmm0
005029F1    mov dword ptr ss:[ebp-0xCCC], 0x00
005029FB    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
00502A9F    push 0x476
00502AA4    push esi
00502AA5    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00502AAA    add esp, 0x1C
00502AAD    mov ecx, dword ptr ss:[ebp-0x0C]
00502AB0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00502AB7    pop ecx
00502AB8    pop edi
00502AB9    pop esi
00502ABA    mov ecx, dword ptr ss:[ebp-0x14]
00502ABD    xor ecx, ebp
00502ABF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
