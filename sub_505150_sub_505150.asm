...
0050515B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00505160    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00505190    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
00505192    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005051B3    jnl 0x005051CF                                  ; => [ Call: sub_583fc0 ]
005051B5    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005051CD    mov ecx, eax                                    ; => [ Call: sub_583fc0 ]
...
005051E8    movlpd qword ptr ss:[esp+0x2C], xmm0            ; => [ Call: __builtin_memset ]
...
00505256    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
00505258    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050525D    mov esi, eax
0050525F    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
00505264    mov edi, dword ptr ss:[esp+0xCF8]
0050526B    mov edx, dword ptr ds:[esi+0x0C]
0050526E    mov ecx, dword ptr ds:[esi+0x04]
00505271    push edi
00505272    push eax
00505273    call 0x00594010                                 ; => [ Call: sub_594010 ]
00505278    add esp, 0x08
0050527B    mov ecx, edi
0050527D    neg ecx
0050527F    xor edx, edx
00505281    call 0x00561F60                                 ; => [ Call: sub_561f60 ]
00505286    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005052C1    push edi
005052C2    push eax
005052C3    call 0x00590DE0                                 ; => [ Call: sub_590de0 ]
005052C8    mov ecx, dword ptr ss:[esp+0x19A0]
005052CF    add esp, 0x14
005052D2    pop edi
005052D3    pop esi
005052D4    xor ecx, esp
005052D6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
