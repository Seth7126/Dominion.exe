...
00666853    mov ecx, dword ptr ds:[0x00C27C24]
00666859    sub esp, 0x14
0066685C    mov dword ptr ds:[0x00C27C18], 0x00
00666866    mov dword ptr ds:[0x00C27C1C], 0x00
00666870    push ebx
00666871    push esi
00666872    push edi
...
006668D1    jle 0x006669DF
006668D7    mov edi, 0xC23C24
...
0066694C    inc eax
0066694D    inc dword ptr ds:[0x00C27C1C]
...
00666963    push 0x8757B0
00666968    push 0x3824
0066696D    mov ecx, 0x8757DC
...
006669E4    pop ebp
006669E5    ret
006669E6    push 0x8757B0
006669EB    push 0x3806
006669F0    mov ecx, 0x875798
006669F5    jmp 0x00666A17
006669F7    push 0x8757B0
006669FC    push 0x3829
00666A01    mov ecx, 0x8757CC
00666A06    jmp 0x00666A17
00666A08    push 0x874584
00666A0D    push 0xC6B
00666A12    mov ecx, 0x8745F0
00666A17    push 0x8739B4
00666A1C    mov edx, 0x801800
00666A21    call 0x0063B870
00666A26    add esp, 0x0C
00666A29    call 0x0063BC30
00666A2E    test al, al
00666A30    jz 0x00666A33
00666A32    int3
00666A33    call 0x0063BB00
