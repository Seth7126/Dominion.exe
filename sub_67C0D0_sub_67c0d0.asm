...
0067C0D7    mov ecx, dword ptr ds:[0x00C23BE0]              ; => [ Data: data_c23be0 ]
...
0067C0FE    jnz 0x0067C141                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
0067C100    call 0x0064E7A0
0067C105    mov esi, eax                                    ; => [ Call: sub_64e7a0 ]
...
0067C124    call 0x0067C0A0                                 ; => [ Call: sub_67c0a0 ]
0067C129    test al, al
0067C12B    jz 0x0067C141
0067C12D    lea eax, ds:[esi+0x1720]
0067C133    mov ecx, ebx
0067C135    push eax
0067C136    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0067C13B    pop edi
0067C13C    pop esi
