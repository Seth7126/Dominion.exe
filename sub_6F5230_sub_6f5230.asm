...
006F5235    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
006F523A    mov eax, dword ptr fs:[0x00000000]
006F5240    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006F5241    sub esp, 0x0C
006F5244    push esi
006F5245    push edi
006F5246    mov eax, dword ptr ds:[0x008C4040]
006F524B    xor eax, ebp
006F524D    push eax                                        ; => [ Data: __security_cookie ]
006F524E    lea eax, ss:[ebp-0x0C]
006F5251    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006F526E    test eax, eax                                   ; => [ String: %d | Call: sub_64b6d0 ]
...
006F5280    push eax
006F5281    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
006F52BD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F52D0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F52D5    mov eax, dword ptr ds:[esi]
006F52D7    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006F52DC    test eax, eax
006F52DE    cmovnz ecx, eax
006F52E1    mov dword ptr ds:[edi], ecx
006F52E3    mov ecx, dword ptr ss:[ebp-0x0C]
006F52E6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F52ED    pop ecx
006F52EE    pop edi
006F52EF    pop esi
