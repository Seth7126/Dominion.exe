...
0062A279    call 0x0066B600                                 ; => [ Call: sub_66b600 | String: tbl_logEntries | Call: sub_64e7a0 | Call: sub_4bb9f0 ]
...
0062A28F    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
0062A294    test eax, eax
0062A296    jnz 0x0062A2AE
0062A298    push 0x77EB90                                   ; => [ String: GetClient ]
0062A29D    push 0x7B
0062A29F    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
0062A2A4    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
0062A2A9    jmp 0x0062A375
0062A2AE    cmp dword ptr ds:[eax+0x5068], 0x00
0062A2B5    jnz 0x0062A2D0
0062A2B7    push 0x871028                                   ; => [ String: GetActiveConfig ]
0062A2BC    push 0x33B6
0062A2C1    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
0062A2C6    mov ecx, 0x871038                               ; => [ String: c.activeGame.gameType != GAME_NONE ]
0062A2CB    jmp 0x0062A375
0062A2D0    mov edx, 0xBDFB60
0062A2D5    mov ecx, 0xB80AD8
0062A2DA    call 0x005DA130                                 ; => [ Call: sub_5da130 ]
0062A2DF    cmp dword ptr ds:[0x00CC8D5C], 0x00
0062A2E6    jz 0x0062A298                                   ; => [ Data: data_cc8d5c ]
0062A2E8    sub eax, 0x00
0062A2EB    jz 0x0062A2FC
0062A2ED    sub eax, 0x01
0062A2F0    jnz 0x0062A361
0062A2F2    lea ecx, ds:[eax+0x01]
0062A2F5    call 0x005A04D0                                 ; => [ Call: sub_5a04d0 ]
0062A2FA    jmp 0x0062A303
0062A2FC    mov dword ptr ss:[ebp-0x10], 0x00
0062A303    mov edx, dword ptr ds:[0x01597E30]              ; => [ Data: data_1597e30 ]
...
0062A32C    mov byte ptr ds:[0x01724A4C], al                ; => [ Data: data_1724a4c ]
...
0062A344    pop ebp
0062A345    ret                                             ; => [ Call: sub_66b420 ]
0062A346    push 0x00
0062A348    lea edx, ss:[ebp-0x08]
0062A34B    mov byte ptr ds:[0x01724A4C], 0x01              ; => [ Data: data_1724a4c ]
0062A352    call 0x0066B420                                 ; => [ Call: sub_66b420 ]
...
0062A35F    pop ebp
0062A360    ret
0062A361    push 0x824F5C                                   ; => [ String: DomLogRange ]
0062A366    push 0x1383
0062A36B    push 0x82487C                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp ]
0062A370    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0062A375    mov edx, 0x801800
0062A37A    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0062A37F    add esp, 0x0C
0062A382    call 0x0063BC30
0062A387    test al, al
0062A389    jz 0x0062A38C                                   ; => [ Call: sub_63bc30 ]
0062A38B    int3
0062A38C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
