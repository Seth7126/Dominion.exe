...
0052DEE8    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
0052DEED    mov eax, dword ptr fs:[0x00000000]
0052DEF3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0052DEF4    push ebx
0052DEF5    mov eax, 0x19A8
0052DEFA    call 0x00761E50                                 ; => [ Call: __chkstk ]
0052DEFF    mov eax, dword ptr ds:[0x008C4040]
0052DF04    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0052DF06    mov dword ptr ss:[ebp-0x14], eax
0052DF09    push esi
0052DF0A    push edi
0052DF0B    push eax
0052DF0C    lea eax, ss:[ebp-0x0C]
0052DF0F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0052DF15    mov edi, 0x02
0052DF1A    nop word ptr ds:[eax+eax*1], ax
0052DF20    mov ecx, 0x104
0052DF25    call 0x00563590                                 ; => [ Call: sub_563590 ]
0052DF2A    mov esi, eax
0052DF2C    test esi, esi
0052DF2E    jz 0x0052DF56
0052DF30    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052DF35    push 0x04
0052DF37    push 0x00
0052DF39    push 0x00
...
0052DF48    push 0x476
0052DF4D    push esi
0052DF4E    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0052DF53    add esp, 0x1C
0052DF56    sub edi, 0x01
0052DF59    jnz 0x0052DF20
0052DF5B    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052DF60    lea ecx, ss:[ebp-0x19B8]
0052DF66    push 0x04
0052DF68    push ecx
0052DF69    mov edx, dword ptr ds:[eax+0x0C]
0052DF6C    mov ecx, dword ptr ds:[eax+0x04]
0052DF6F    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0052DF74    mov ecx, 0x321
0052DF79    mov dword ptr ss:[ebp-0xD38], eax
0052DF7F    lea esi, ss:[ebp-0x19B8]
0052DF85    mov dword ptr ss:[ebp-0xD00], 0x8191DC          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_85f7b1f3c2fe9ca7cfb2964042d896ed>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_85f7b1f3c2fe9ca7cfb2964042d896ed>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0052DF8F    lea edi, ss:[ebp-0xCA0]
0052DF95    add esp, 0x08
0052DF98    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0052DF9A    lea ecx, ss:[ebp-0xD00]
0052DFA0    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_85f7b1f3c2fe9ca7cfb2964042d896ed>,bool,enum CardID>::VTable ]
...
0052DFE1    call eax
0052DFE3    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
0052E009    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0052E020    push eax
0052E021    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0052E024    xorps xmm0, xmm0
0052E027    mov dword ptr ss:[ebp-0xCCC], 0x00
0052E031    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
0052E0D5    push 0x476
0052E0DA    push esi
0052E0DB    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0052E0E0    add esp, 0x1C
0052E0E3    mov ecx, dword ptr ss:[ebp-0x0C]
0052E0E6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0052E0ED    pop ecx
0052E0EE    pop edi
0052E0EF    pop esi
0052E0F0    mov ecx, dword ptr ss:[ebp-0x14]
0052E0F3    xor ecx, ebp
0052E0F5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
