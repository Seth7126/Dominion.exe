...
0050D4D2    push esi
0050D4D3    push edi
0050D4D4    call 0x00513D60                                 ; => [ Call: sub_513d60 ]
0050D4D9    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050D4DE    cmp dword ptr ds:[eax], 0x04
0050D4E1    jz 0x0050D4FC
0050D4E3    push 0x813AF4                                   ; => [ String: StampGetPileSetup ]
0050D4E8    push 0xC59
0050D4ED    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0050D4F2    mov ecx, 0x813B08                               ; => [ String: c.contextType == CONTEXT_SETUP ]
0050D4F7    jmp 0x0050D5CE
0050D4FC    mov ecx, dword ptr ds:[eax+0x10]
0050D4FF    call 0x0050CC00                                 ; => [ Call: sub_50cc00 ]
0050D504    mov ebx, eax
0050D506    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0050D51F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050D544    push eax
0050D545    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
0050D559    push 0x8138D8                                   ; => [ String: Landmod_Event_Motivational ]
0050D55E    push 0x8DB
0050D563    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0050D568    mov ecx, 0x8138A0                               ; => [ String: c.g->turn_id == 0 ]
...
0050D592    call 0x0056C680                                 ; => [ Call: sub_50d5f0 | Call: sub_4f9bf0 | Call: sub_56c680 ]
0050D597    mov eax, dword ptr fs:[0x0000002C]
0050D59D    add esp, 0x10
0050D5A0    mov ecx, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
0050D5B8    pop ebp
0050D5B9    ret
0050D5BA    push 0x81F9E0                                   ; => [ String: DomPopContext ]
0050D5BF    push 0x792
0050D5C4    push 0x81F4B8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
0050D5C9    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
0050D5CE    mov edx, 0x801800
0050D5D3    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0050D5D8    add esp, 0x0C
0050D5DB    call 0x0063BC30
0050D5E0    test al, al
0050D5E2    jz 0x0050D5E5                                   ; => [ Call: sub_63bc30 ]
0050D5E4    int3
0050D5E5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
