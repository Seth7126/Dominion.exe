...
00537B80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00537B81    mov eax, 0x1910
00537B86    call 0x00761E50                                 ; => [ Call: __chkstk ]
00537B8B    mov eax, dword ptr ds:[0x008C4040]
00537B90    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00537B92    mov dword ptr ss:[ebp-0x10], eax
00537B95    push esi
00537B96    push eax
00537B97    lea eax, ss:[ebp-0x0C]
00537B9A    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00537BA0    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
00537BA5    push 0xC80
00537BAA    mov esi, eax
00537BAC    lea eax, ss:[ebp-0xC90]
00537BB2    push 0x00
00537BB4    push eax
00537BB5    call 0x00761FC4                                 ; => [ Call: memset ]
...
00537C0C    call 0x00567110                                 ; => [ Call: sub_567110 ]
00537C11    add esp, 0x18
00537C14    lea ecx, ss:[ebp-0xC95]
00537C1A    call 0x0056EFB0                                 ; => [ Call: sub_56efb0 ]
00537C1F    mov ecx, dword ptr ss:[ebp-0x0C]
00537C22    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00537C29    pop ecx
00537C2A    pop esi
00537C2B    mov ecx, dword ptr ss:[ebp-0x10]
00537C2E    xor ecx, ebp
00537C30    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
