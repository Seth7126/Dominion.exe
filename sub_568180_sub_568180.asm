...
00568186    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0056819C    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056819F    cmp esi, 0x320
005681A5    jb 0x005681AC
005681A7    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005681BF    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
...
005681D3    movups xmm1, xmmword ptr ds:[eax]               ; => [ Call: sub_576c00 ]
005681D6    lea eax, ss:[ebp-0x44]
005681D9    push eax
005681DA    movups xmmword ptr ss:[ebp-0x30], xmm1
005681DE    call 0x00576C00                                 ; => [ Call: sub_576c00 ]
...
0056821B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0056822B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
