...
00706A3C    push 0x88D4A8                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayAlloc ]
00706A41    push 0xF4
00706A46    mov ecx, 0x8019B8                               ; => [ String: mUsedCount < mMaxSize ]
...
00706A85    push ebx
00706A86    call 0x00761FC4                                 ; => [ Call: memset ]
...
00706AB6    pop esi
00706AB7    ret
00706AB8    push 0x88D4A8                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayAlloc ]
00706ABD    push 0xF5
00706AC2    mov ecx, 0x8019D0                               ; => [ String: mFreeListHead <= mMaxUsedCount ]
00706AC7    push 0x80193C
00706ACC    mov edx, 0x801800
00706AD1    call 0x0063B870                                 ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayAlloc | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\DataArray.h ]
00706AD6    add esp, 0x0C
00706AD9    call 0x0063BC30
00706ADE    test al, al
00706AE0    jz 0x00706AE3                                   ; => [ Call: sub_63bc30 ]
00706AE2    int3
00706AE3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
