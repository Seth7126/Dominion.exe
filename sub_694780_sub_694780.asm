...
00694785    push 0x76EF5D                                   ; => [ Type: EHRegistrationNode | Call: sub_76ef5d ]
0069478A    mov eax, dword ptr fs:[0x00000000]
00694790    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0069479E    push eax                                        ; => [ Data: __security_cookie ]
0069479F    lea eax, ss:[ebp-0x0C]
006947A2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006947CC    test al, al
006947CE    jz 0x00694838                                   ; => [ Type: FILE | Call: sub_69dec0 ]
006947D0    mov edi, dword ptr ss:[ebp-0x14]                ; => [ Type: FILE ]
...
00694826    test al, al
00694828    jz 0x00694838                                   ; => [ Call: nullptr | Call: sub_695870 ]
0069482A    push edi
...
00694848    jz 0x00694871                                   ; => [ Data: data_cf65bc ]
0069484A    mov eax, dword ptr ss:[ebp+0x0C]                ; => [ Type: FILE ]
0069484D    test eax, eax
0069484F    jz 0x00694871
00694851    cmp byte ptr ds:[eax], 0x00
00694854    jz 0x00694871                                   ; => [ Field: _Placeholder ]
00694856    lea ecx, ss:[ebp+0x0C]
00694859    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069486C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00694871    mov al, bl
00694873    mov ecx, dword ptr ss:[ebp-0x0C]
00694876    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069487D    pop ecx
0069487E    pop edi
0069487F    pop esi
00694880    pop ebx
