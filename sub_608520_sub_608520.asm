...
00608542    mov dword ptr fs:[0x00000000], eax
...
0060856A    call 0x0063D720
0060856F    mov edi, dword ptr ss:[ebp+0x08]
00608572    mov ecx, 0x801800
...
006085D2    jz 0x006085F6
006085D4    lea ecx, ss:[ebp-0x1C]
006085D7    call 0x0063D4E0
...
006085EA    call 0x0064C080
006085EF    mov dword ptr ss:[ebp-0x1C], 0x801800
006085F6    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006085FD    test bl, bl
006085FF    jz 0x0060862C
00608601    cmp dword ptr ds:[0x00CCF6E8], 0x00
00608608    jnz 0x00608622
0060860A    xor dl, dl
0060860C    mov ecx, 0x07
00608611    call 0x004D46E0
00608616    mov dword ptr ds:[0x008DB660], 0x10
00608620    jmp 0x0060862C
00608622    mov dword ptr ds:[0x008DB660], 0x04
0060862C    mov edx, 0x804984
00608631    lea ecx, ss:[ebp-0x1C]
00608634    call 0x0063D720
00608639    mov eax, dword ptr ss:[ebp-0x1C]
0060863C    mov ecx, 0x801800
...
006086A1    jz 0x006086C5
006086A3    lea ecx, ss:[ebp-0x1C]
006086A6    call 0x0063D4E0
...
006086B9    call 0x0064C080
006086BE    mov dword ptr ss:[ebp-0x1C], 0x801800
006086C5    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006086CC    test bl, bl
006086CE    jz 0x00608703
006086D0    mov ecx, dword ptr ds:[0x00BE1538]
006086D6    or edx, 0xFFFFFFFF
006086D9    mov dword ptr ds:[0x00CCF6FC], 0x00
006086E3    mov byte ptr ds:[0x00CCF6F8], 0x00
006086EA    call 0x004AD010
006086EF    mov al, 0x01
006086F1    mov ecx, dword ptr ss:[ebp-0x0C]
006086F4    mov dword ptr fs:[0x00000000], ecx
006086FB    pop ecx
006086FC    pop edi
006086FD    pop esi
006086FE    pop ebx
...
0060877E    jz 0x006087A2
00608780    lea ecx, ss:[ebp-0x1C]
00608783    call 0x0063D4E0
...
00608796    call 0x0064C080
0060879B    mov dword ptr ss:[ebp-0x1C], 0x801800
...
006087EC    call 0x00607140
006087F1    mov esi, eax
006087F3    mov edi, edx
006087F5    mov eax, dword ptr ds:[0x00CC8D94]
006087FA    test eax, eax
006087FC    jnz 0x00608808
006087FE    call 0x004ACC60
00608803    mov dword ptr ds:[0x00CC8D94], eax
00608808    mov ecx, eax
0060880A    mov dword ptr ds:[0x00CC8D98], esi
00608810    mov dword ptr ds:[0x00CC8D9C], edi
00608816    mov byte ptr ds:[0x00CC8D90], 0x00
0060881D    mov dword ptr ds:[0x00CC8DA0], 0x7E6
00608827    mov dword ptr ds:[0x00CC8DA4], 0x00
00608831    call 0x004ADD50
00608836    mov edi, dword ptr ss:[ebp+0x08]
00608839    mov dword ptr ds:[0x008DB660], 0x16
00608843    mov edx, 0x861DF4
00608848    lea ecx, ss:[ebp-0x1C]
0060884B    call 0x0063D720
00608850    mov eax, dword ptr ss:[ebp-0x1C]
00608853    mov ecx, 0x801800
...
0060889C    jz 0x006088C0
0060889E    lea ecx, ss:[ebp-0x1C]
006088A1    call 0x0063D4E0
...
006088B4    call 0x0064C080
006088B9    mov dword ptr ss:[ebp-0x1C], 0x801800
...
0060895E    jz 0x00608982
00608960    lea ecx, ss:[ebp-0x1C]
00608963    call 0x0063D4E0
...
00608976    call 0x0064C080
0060897B    mov dword ptr ss:[ebp-0x1C], 0x801800
00608982    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00608989    test bl, bl
0060898B    jz 0x00608999
0060898D    mov byte ptr ds:[0x00CCF6F8], 0x00
00608994    call 0x00608460
00608999    mov edx, 0x865508
0060899E    lea ecx, ss:[ebp-0x1C]
006089A1    call 0x0063D720
006089A6    mov dword ptr ss:[ebp-0x04], 0x05
006089AD    mov eax, 0x801800
...
00608A65    jz 0x00608A89
00608A67    lea ecx, ss:[ebp-0x1C]
00608A6A    call 0x0063D4E0
...
00608B35    jz 0x00608B59
00608B37    lea ecx, ss:[ebp-0x1C]
00608B3A    call 0x0063D4E0
...
00608C0D    jz 0x00608C31
00608C0F    lea ecx, ss:[ebp-0x1C]
00608C12    call 0x0063D4E0
...
00608C25    call 0x0064C080
00608C2A    mov dword ptr ss:[ebp-0x1C], 0x801800
00608C31    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00608C38    test bl, bl
00608C3A    jz 0x00608C53
00608C3C    dec dword ptr ds:[0x00CCF6F4]
00608C42    mov dword ptr ds:[0x00CCF6FC], 0x00
00608C4C    mov byte ptr ds:[0x00CCF6F8], 0x00
00608C53    mov edx, 0x865534
00608C58    lea ecx, ss:[ebp-0x1C]
00608C5B    call 0x0063D720
00608C60    mov eax, dword ptr ss:[ebp-0x1C]
00608C63    mov ecx, 0x801800
...
00608CAC    jz 0x00608CD0
00608CAE    lea ecx, ss:[ebp-0x1C]
00608CB1    call 0x0063D4E0
...
00608CC4    call 0x0064C080
00608CC9    mov dword ptr ss:[ebp-0x1C], 0x801800
...
00608CF2    push eax
00608CF3    call 0x006062D0
00608CF8    mov ecx, dword ptr ds:[0x00BE1538]
00608CFE    add esp, 0x08
00608D01    mov ecx, dword ptr ds:[ecx+0xBD4]
...
00608E2C    jz 0x00608E50
00608E2E    lea ecx, ss:[ebp-0x1C]
00608E31    call 0x0063D4E0
...
00608E44    call 0x0064C080
00608E49    mov dword ptr ss:[ebp-0x1C], 0x801800
...
00608E6E    push eax
00608E6F    call 0x006062D0
00608E74    mov ecx, dword ptr ds:[0x00BE1538]
00608E7A    add esp, 0x08
00608E7D    mov ecx, dword ptr ds:[ecx+0xBD4]
...
00608F11    jz 0x00608F35
00608F13    lea ecx, ss:[ebp-0x1C]
00608F16    call 0x0063D4E0
...
00608F29    call 0x0064C080
00608F2E    mov dword ptr ss:[ebp-0x1C], 0x801800
...
00608F53    push eax
00608F54    call 0x006062D0
00608F59    mov ecx, dword ptr ds:[0x00BE1538]
00608F5F    add esp, 0x08
00608F62    mov ecx, dword ptr ds:[ecx+0xBD4]
...
00608FFC    jz 0x00609020
00608FFE    lea ecx, ss:[ebp-0x1C]
00609001    call 0x0063D4E0
...
00609014    call 0x0064C080
00609019    mov dword ptr ss:[ebp-0x1C], 0x801800
...
00609033    push 0x86553C
00609038    push 0xA6AD
0060903D    push 0x86F1E8
00609042    mov ecx, 0x865560
00609047    jmp 0x0060927E
0060904C    lea eax, ds:[ecx*8]
00609053    sub eax, ecx
00609055    mov eax, dword ptr ds:[eax*4+0x77FCA8]
0060905C    mov dword ptr ds:[0x00CCF6F0], eax
00609061    mov dword ptr ds:[0x00CCF6F4], 0x00
0060906B    mov byte ptr ds:[0x00CCF6F8], 0x00
00609072    mov dword ptr ds:[0x00CCF6FC], 0x00
0060907C    mov edx, 0x80501C
00609081    lea ecx, ss:[ebp-0x1C]
00609084    call 0x0063D720
00609089    mov eax, dword ptr ss:[ebp-0x1C]
0060908C    mov ecx, 0x801800
...
006090DC    jz 0x00609100
006090DE    lea ecx, ss:[ebp-0x1C]
006090E1    call 0x0063D4E0
...
006090F4    call 0x0064C080
006090F9    mov dword ptr ss:[ebp-0x1C], 0x801800
...
00609116    push 0x807ECC
0060911B    push 0x118B
00609120    mov ecx, 0x807EE0
...
00609143    mov esi, dword ptr ds:[eax*4+0x77FCA8]
0060914A    call 0x004D46E0
0060914F    cmp esi, 0x13
00609152    jnz 0x0060917E
00609154    mov dword ptr ds:[0x00CC8D80], 0x02
0060915E    mov dword ptr ds:[0x00CC8D84], 0x7E6
00609168    mov dword ptr ds:[0x00CC8D88], 0x00
00609172    mov dword ptr ds:[0x008DB660], 0x15
0060917C    jmp 0x006091DF
0060917E    mov edx, dword ptr ds:[edi+0x08]
00609181    xor ecx, ecx
00609183    push 0x00
00609185    call 0x004C9C50
0060918A    mov esi, eax
0060918C    add esp, 0x04
0060918F    mov eax, dword ptr ds:[0x00CC8D94]
00609194    mov edi, edx
00609196    test eax, eax
00609198    jnz 0x006091A4
0060919A    call 0x004ACC60
0060919F    mov dword ptr ds:[0x00CC8D94], eax
006091A4    mov ecx, eax
006091A6    mov dword ptr ds:[0x00CC8D98], esi
006091AC    mov dword ptr ds:[0x00CC8D9C], edi
006091B2    mov byte ptr ds:[0x00CC8D90], 0x00
006091B9    mov dword ptr ds:[0x00CC8DA0], 0x7E6
006091C3    mov dword ptr ds:[0x00CC8DA4], 0x00
006091CD    call 0x004ADD50
006091D2    mov edi, dword ptr ss:[ebp+0x08]
006091D5    mov dword ptr ds:[0x008DB660], 0x16
006091DF    lea edx, ss:[ebp-0x28]
006091E2    lea ecx, ss:[ebp-0x24]
006091E5    call 0x004ADDA0
006091EA    cmp dword ptr ds:[edi+0x18], 0x05
006091EE    jnz 0x00609221
006091F0    test al, al
006091F2    jnz 0x00609221
006091F4    mov ecx, dword ptr ds:[0x00CCF6F0]
006091FA    cmp ecx, 0x02
006091FD    jz 0x00609227
006091FF    dec ecx
00609200    mov dword ptr ds:[0x00CCF6F4], 0x00
0060920A    mov dword ptr ds:[0x00CCF6F0], ecx
00609210    mov dword ptr ds:[0x00CCF6FC], 0x00
0060921A    mov byte ptr ds:[0x00CCF6F8], al
0060921F    jmp 0x00609227
00609221    mov ecx, dword ptr ds:[0x00CCF6F0]
...
00609236    inc ecx
00609237    mov dword ptr ds:[0x00CCF6F4], 0x00
00609241    mov dword ptr ds:[0x00CCF6F0], ecx
00609247    mov dword ptr ds:[0x00CCF6FC], 0x00
00609251    mov byte ptr ds:[0x00CCF6F8], al
00609256    xor al, al
00609258    mov ecx, dword ptr ss:[ebp-0x0C]
0060925B    mov dword ptr fs:[0x00000000], ecx
00609262    pop ecx
00609263    pop edi
00609264    pop esi
00609265    pop ebx
...
00609268    pop ebp
00609269    ret
0060926A    push 0x807ECC
0060926F    push 0x118C
00609274    mov ecx, 0x807EE8
00609279    push 0x806FE4
0060927E    mov edx, 0x801800
00609283    call 0x0063B870
00609288    add esp, 0x0C
0060928B    call 0x0063BC30
00609290    test al, al
00609292    jz 0x00609295
00609294    int3
00609295    call 0x0063BB00
