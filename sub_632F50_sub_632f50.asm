...
00632F5B    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
00632F6B    push 0x86DC2C                                   ; => [ String: UpdateCardHints ]
00632F70    push 0x10F71
00632F75    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00632F7A    mov ecx, 0x86F474                               ; => [ String: gfx.type == DOMGFX_CARD ]
00632F7F    jmp 0x0063324F
00632F84    lea eax, ss:[ebp-0x18]
00632F87    push eax
00632F88    lea edx, ss:[ebp-0x20]
00632F8B    call 0x005E32F0                                 ; => [ Call: sub_5e32f0 ]
...
00632FA1    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
...
00633039    mov edi, 0x86E394                               ; => [ Data: data_86e394 ]
0063303E    mov edx, dword ptr ds:[ebx+0x98]
00633044    mov dword ptr ss:[ebp-0x28], eax
00633047    mov eax, dword ptr fs:[0x0000002C]              ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
0063306C    call 0x005731D0                                 ; => [ Call: sub_5731d0 ]
...
006330B8    jnz 0x00633060                                  ; => [ String: RectBottomRight ]
006330BA    push ecx
006330BB    lea edx, ss:[ebp-0x14]
006330BE    jmp 0x006330E6
006330C0    push 0x81F9E0                                   ; => [ String: DomPopContext ]
006330C5    push 0x792
006330CA    push 0x81F4B8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
006330CF    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
...
0063312D    mov edx, dword ptr ds:[eax+0x30]                ; => [ Call: sub_4b9480 ]
...
00633149    or eax, 0x00                                    ; => [ Call: sub_571b30 ]
...
006331AA    call 0x005CBAA0                                 ; => [ Call: sub_5cbaa0 ]
...
006331F9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0063320C    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
00633211    mov esi, eax
00633213    mov edx, ebx
00633215    mov ecx, esi
00633217    call 0x005CD880                                 ; => [ Call: sub_5cd880 ]
0063321C    mov ecx, esi
0063321E    call 0x005CB5A0                                 ; => [ Call: sub_5cb5a0 ]
...
00633234    pop ebx
00633235    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0063323A    mov esp, ebp
0063323C    pop ebp
0063323D    ret
0063323E    push 0x77EB90                                   ; => [ String: GetClient ]
00633243    push 0x7B
00633245    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
0063324A    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
0063324F    mov edx, 0x801800
00633254    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00633259    add esp, 0x0C
0063325C    call 0x0063BC30
00633261    test al, al
00633263    jz 0x00633266                                   ; => [ Call: sub_63bc30 ]
00633265    int3
00633266    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
