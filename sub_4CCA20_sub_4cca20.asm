...
004CCA25    push 0x76339E                                   ; => [ Call: __ehhandler$??$_Getloctxt@V?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@D@std@@YAHAAV?$istreambuf_iterator@DU?$char_traits@D@std@@@0@0IPBDW4_Case_sensitive@0@@Z | Type: EHRegistrationNode ]
004CCA2A    mov eax, dword ptr fs:[0x00000000]
004CCA30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004CCA3F    push esi
004CCA40    push edi
004CCA41    push eax                                        ; => [ Data: __security_cookie ]
004CCA42    lea eax, ss:[ebp-0x0C]
004CCA45    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004CCA63    mov dword ptr ds:[eax+0x18BC], 0x4CC050         ; => [ Call: sub_64e7a0 | Call: sub_4cc050 ]
004CCA6D    call 0x00628360                                 ; => [ Data: data_cc8d98 | Call: sub_628360 ]
004CCA72    mov ecx, 0xCC8D98
004CCA77    call 0x00571C40                                 ; => [ Call: sub_571c40 | Data: data_cc8d98 ]
004CCA7C    mov ebx, eax
004CCA7E    mov ecx, ebx
004CCA80    call 0x004DAE80                                 ; => [ Call: sub_4dae80 ]
004CCA85    cmp dword ptr ds:[0x00CC8D98], 0x03
004CCA8C    jnz 0x004CCCF4
004CCA92    cmp eax, 0x01
004CCA95    jnz 0x004CCCF4                                  ; => [ Data: data_cc8d98 ]
004CCA9B    cmp dword ptr ds:[0x00CC8D9C], 0x100002
004CCAA5    jz 0x004CCABB                                   ; => [ Data: data_cc8d9c ]
004CCAA7    push 0x804AF0                                   ; => [ String: StoreItemUpdate ]
004CCAAC    push 0x2609
004CCAB1    mov ecx, 0x804B00                               ; => [ String: gStoreItemDlg.exp.type == (DLCType)DOM_CURRENT_BUNDLE ]
004CCAB6    jmp 0x004CD04B
004CCABB    xor ecx, ecx
004CCABD    xor eax, eax
004CCABF    nop
004CCAC0    cmp dword ptr ds:[eax+0x780878], 0x100002
004CCACA    jz 0x004CCAE0                                   ; => [ Data: data_780878 ]
004CCACC    add eax, 0x10C
004CCAD1    inc ecx
004CCAD2    cmp eax, 0x28D4
004CCAD7    jb 0x004CCAC0
004CCAD9    mov ecx, 0x780878                               ; => [ Data: data_780878 ]
004CCADE    jmp 0x004CCAEC
004CCAE0    imul ecx, ecx, 0x10C
004CCAE6    add ecx, 0x780878                               ; => [ Data: data_780878 ]
004CCAEC    lea edx, ss:[ebp-0x48]
004CCAEF    call 0x004BE540                                 ; => [ Call: sub_4be540 ]
...
004CCC0F    call 0x004CC890                                 ; => [ Call: sub_4cc890 | Call: sub_665db0 | Data: data_8dc3f8 ]
004CCC14    add esp, 0x08
004CCC17    lea edx, ss:[ebp-0x48]
004CCC1A    mov ecx, edi
004CCC1C    call 0x004CC7B0                                 ; => [ Call: sub_4cc7b0 ]
004CCC21    mov ecx, edi
004CCC23    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004CCC46    call 0x004CC890                                 ; => [ Call: sub_4cc890 ]
004CCC4B    mov ecx, edi
004CCC4D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004CCC6A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004CCC8F    call 0x004CC890                                 ; => [ Call: sub_4cc890 | Call: sub_665db0 | Data: data_8dc3f8 ]
004CCC94    mov ecx, edi
004CCC96    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CCC9B    movss xmm3, dword ptr ds:[0x00890E18]
004CCCA3    mov edx, 0x8DC548
004CCCA8    push 0x00
004CCCAA    push 0xFFFFFFFF
004CCCAC    mov ecx, eax
004CCCAE    call 0x00665DB0                                 ; => [ Data: data_8dc548 | Call: sub_665db0 ]
...
004CCDB5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CCE37    push eax
004CCE38    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: dom_expansion_name_%s ]
004CCE3D    mov byte ptr ss:[ebp-0x04], 0x03
004CCE41    lea ecx, ss:[ebp-0x50]
004CCE44    mov eax, dword ptr ss:[ebp-0x4C]
004CCE47    mov edx, 0x801800                               ; => [ Data: data_801800 ]
004CCE4C    test eax, eax
004CCE4E    push 0x00
004CCE50    cmovnz edx, eax
004CCE53    push 0x01
004CCE55    call 0x0060DB00                                 ; => [ Call: sub_60db00 ]
...
004CCE6F    jz 0x004CCE98                                   ; => [ Data: data_cf65bc ]
...
004CCE80    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CCE93    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004CCEA9    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8dc4e8 ]
004CCEAE    mov al, byte ptr ds:[0x00CC8D90]                ; => [ Data: data_cc8d90 ]
004CCEB3    add esp, 0x08
004CCEB6    test al, al
004CCEB8    jnz 0x004CCEE1
004CCEBA    mov ecx, edi
004CCEBC    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CCEC1    movss xmm3, dword ptr ds:[0x00890E18]
004CCEC9    mov edx, 0x8DC4DC
004CCECE    push 0x00
004CCED0    push 0xFFFFFFFF
004CCED2    mov ecx, eax
004CCED4    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc4dc ]
004CCED9    mov al, byte ptr ds:[0x00CC8D90]                ; => [ Data: data_cc8d90 ]
...
004CD008    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CD01B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CD020    mov ecx, dword ptr ss:[ebp-0x0C]
004CD023    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CD02A    pop ecx
004CD02B    pop edi
004CD02C    pop esi
004CD02D    pop ebx
...
004CD033    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004CD038    mov esp, ebp
004CD03A    pop ebp
004CD03B    ret
004CD03C    push 0x804AF0                                   ; => [ String: StoreItemUpdate ]
004CD041    push 0x269B
004CD046    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004CD04B    push 0x80292C
004CD050    mov edx, 0x801800
004CD055    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: StoreItemUpdate ]
004CD05A    add esp, 0x0C
004CD05D    call 0x0063BC30
004CD062    test al, al
004CD064    jz 0x004CD067                                   ; => [ Call: sub_63bc30 ]
004CD066    int3
004CD067    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
