...
004F4B63    push ecx
004F4B64    mov ecx, dword ptr ds:[0x01779F88]
004F4B6A    push ebx
004F4B6B    push esi
004F4B6C    push edi
...
004F4B88    mov eax, dword ptr ds:[eax+edi*8]
004F4B8B    add edx, dword ptr ds:[eax+0xD0]
004F4B91    cmp edi, esi
004F4B93    jnl 0x004F4B9E
004F4B95    mov esi, dword ptr ds:[edi*8+0x1777F90]
...
004F4BCC    mov ecx, dword ptr ds:[0x01779F88]
...
004F4C21    call 0x0063B870
004F4C26    add esp, 0x0C
004F4C29    call 0x0063BC30
004F4C2E    test al, al
004F4C30    jz 0x004F4C33
004F4C32    int3
004F4C33    call 0x0063BB00
