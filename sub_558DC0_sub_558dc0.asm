...
00558DCB    call 0x00761E50                                 ; => [ Call: __chkstk ]
00558DD0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00558DEE    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
00558DF3    xorps xmm0, xmm0
00558DF6    mov dword ptr ss:[esp+0x28], 0x00               ; => [ Call: __builtin_memset ]
...
00558E54    push 0x00
00558E56    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00558E97    push 0x3EA
00558E9C    push esi
00558E9D    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00558EA2    add esp, 0x1C
00558EA5    mov ecx, dword ptr ss:[esp+0x198C]
00558EAC    pop edi
00558EAD    pop esi
00558EAE    xor ecx, esp
00558EB0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
