...
00626D15    push 0x76B7FD                                   ; => [ Call: __ehhandler$?_Process_message_helper@?$ordered_message_processor@I@Concurrency@@AAEJXZ | Type: EHRegistrationNode ]
00626D1A    mov eax, dword ptr fs:[0x00000000]
00626D20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00626D2E    push eax                                        ; => [ Data: __security_cookie ]
00626D2F    lea eax, ss:[ebp-0x0C]
00626D32    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00626D6D    mov eax, dword ptr ds:[0x00CF6498]              ; => [ Data: data_cf6498 ]
...
00626D99    push 0x86B7D8                                   ; => [ String: ScorescreenUpdateCardsTab ]
00626D9E    push 0xEF9B
00626DA3    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00626DA8    mov ecx, 0x86B7B8                               ; => [ String: idxCardEnd <= info.numEntries ]
00626DAD    jmp 0x006270F0
00626DB2    cmp esi, ebx
00626DB4    jnl 0x00626DCF
00626DB6    push 0x86B7D8                                   ; => [ String: ScorescreenUpdateCardsTab ]
00626DBB    push 0xEF9C
00626DC0    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00626DC5    mov ecx, 0x86B7F4                               ; => [ String: idxCardEnd >= idxCardStart ]
00626DCA    jmp 0x006270F0
00626DCF    push 0xFFFFFFFF
00626DD1    push eax
00626DD2    mov edx, 0xBF0F44
00626DD7    call 0x00666120                                 ; => [ Data: data_bf0f44 | Call: sub_666120 ]
...
00626DED    xor esi, esi                                    ; => [ Call: nullptr ]
00626DEF    lea edi, ds:[eax*4+0x1A96684]                   ; => [ Data: data_1a96684 ]
00626DF6    mov dword ptr ss:[ebp-0x20], esi                ; => [ Call: nullptr ]
...
00626E3E    jnz 0x00626E66                                  ; => [ String: tbl_cards ]
...
00626E64    jz 0x00626E9D                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
00626E66    mov ecx, dword ptr ss:[ebp-0x10]
00626E69    mov edx, 0x85EF44
00626E6E    push esi
00626E6F    call 0x0067BE20
00626E74    mov ebx, eax                                    ; => [ Call: sub_67be20 ]
...
00626E8A    mov dword ptr ds:[edi], 0x85EF44                ; => [ String: tbl_cards ]
...
00626EB1    call 0x00626070                                 ; => [ Call: sub_626070 ]
00626EB6    jmp 0x00626FD7
00626EBB    call 0x005CF7E0                                 ; => [ Call: sub_5cf7e0 ]
00626EC0    mov ecx, dword ptr ss:[ebp-0x18]
00626EC3    mov edx, eax
00626EC5    mov ecx, dword ptr ds:[ecx+0x04]
00626EC8    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
00626ECD    mov ecx, ebx
00626ECF    mov esi, eax
00626ED1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00626F01    call 0x005E0DF0                                 ; => [ Call: sub_665db0 | Call: sub_5e0df0 | Call: nullptr | Call: sub_5e01b0 ]
00626F06    add esp, 0x18
00626F09    mov edx, esi
00626F0B    mov ecx, ebx
00626F0D    call 0x005DEFB0                                 ; => [ Call: sub_5defb0 ]
00626F12    call 0x005CF7E0                                 ; => [ Call: sub_5cf7e0 ]
00626F17    mov esi, dword ptr ss:[ebp-0x18]
00626F1A    mov edx, eax
00626F1C    mov ecx, dword ptr ds:[esi+0x04]
00626F1F    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
00626FAE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00626FC1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00626FC6    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
00626FF9    push 0x86B7D8                                   ; => [ String: ScorescreenUpdateCardsTab ]
00626FFE    push 0xEFB2
00627003    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00627008    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0062700D    jmp 0x006270F0
00627012    push 0x86B5D0                                   ; => [ String: DeclarePlainVPCardEntry ]
00627017    push 0xEECF
0062701C    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00627021    mov ecx, 0x86B608                               ; => [ String: !IsLandscape(entry.vpcard.what, DomCurrentGameVersion()) ]
00627026    jmp 0x006270F0
0062702B    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
00627048    lea esi, ds:[ebx+eax*1]                         ; => [ Call: sub_4b95e0 ]
0062704B    cmovns esi, ebx
0062704E    call 0x004B9480
00627053    mov edx, dword ptr ss:[ebp-0x30]
00627056    mov ecx, dword ptr ds:[eax+0x11A8]              ; => [ Call: sub_4b9480 ]
...
006270DD    pop ebp
006270DE    ret
006270DF    push 0x77EB90                                   ; => [ String: GetClient ]
006270E4    push 0x7B
006270E6    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
006270EB    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
006270F0    mov edx, 0x801800
006270F5    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006270FA    add esp, 0x0C
006270FD    call 0x0063BC30
00627102    test al, al
00627104    jz 0x00627107                                   ; => [ Call: sub_63bc30 ]
00627106    int3
00627107    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
