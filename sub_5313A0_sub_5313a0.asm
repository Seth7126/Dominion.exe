...
005313AB    call 0x00761E50                                 ; => [ Call: __chkstk ]
005313B0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005313B5    xor eax, esp
005313B7    mov dword ptr ss:[esp+0x1984], eax
005313BE    push esi
005313BF    push edi
005313C0    call 0x00573400                                 ; => [ Call: sub_573400 ]
005313C5    push 0x00
005313C7    push 0x00
005313C9    push 0x01
...
005313D1    push 0x01
005313D3    call 0x00590760                                 ; => [ Call: sub_590760 ]
005313D8    add esp, 0x10
005313DB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053148F    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005314B7    call 0x00563B20                                 ; => [ Call: sub_563b20 ]
...
005314FF    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053152C    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
00531531    add esp, 0x28
00531534    mov edx, 0x3EE
00531539    lea ecx, ss:[esp+0xD00]
00531540    call 0x00569500                                 ; => [ Call: sub_569500 ]
00531545    mov ecx, dword ptr ss:[esp+0x198C]
0053154C    pop edi
0053154D    pop esi
0053154E    xor ecx, esp
00531550    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0053156F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00531574    add esp, 0x0C
00531577    call 0x0063BC30
0053157C    test al, al
0053157E    jz 0x00531581                                   ; => [ Call: sub_63bc30 ]
00531580    int3
00531581    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
