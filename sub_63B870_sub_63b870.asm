...
0063B87A    push 0x759CDD                                   ; => [ Type: _EXCEPTION_DISPOSITION | Call: __except_handler4 | Type: _EXCEPTION_REGISTRATION_RECORD | Type: _CONTEXT ]
0063B87F    mov eax, dword ptr fs:[0x00000000]
0063B885    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0063B886    sub esp, 0x834
0063B88C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0063B8A0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0063B970    call esi                                        ; => [ String: Failed to write to log file\n ]
0063B972    push edi
...
0063B98E    call dword ptr ds:[0x007750D0]                  ; => [ Call: nullptr ]
