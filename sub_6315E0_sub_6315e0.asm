...
006315E5    push 0x76C076                                   ; => [ Call: __ehhandler$___std_smf_sph_legendref@12 | Type: EHRegistrationNode ]
006315EA    mov eax, dword ptr fs:[0x00000000]
006315F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006315F1    push ecx
006315F2    push esi
006315F3    push edi
006315F4    mov eax, dword ptr ds:[0x008C4040]
006315F9    xor eax, ebp
006315FB    push eax                                        ; => [ Data: __security_cookie ]
006315FC    lea eax, ss:[ebp-0x0C]
006315FF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00631622    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00631642    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063165F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063167C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00631699    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006316B6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006316D3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006316F0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063170D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063172A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00631747    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00631764    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00631781    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063179E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006317BB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006317D8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006317F5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00631812    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063182F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063184C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
00631851    inc dword ptr ds:[eax+0x04]
00631854    mov eax, esi
00631856    mov ecx, dword ptr ss:[ebp-0x0C]
00631859    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00631860    pop ecx
00631861    pop edi
00631862    pop esi
