...
0052B9C4    push eax
0052B9C5    call 0x00568780
0052B9CA    mov esi, eax
0052B9CC    mov dword ptr ss:[ebp-0xD08], 0x819380
...
0052B9F6    rep movsd
0052B9F8    mov dword ptr ss:[ebp-0xCE4], eax
...
0052BA5C    mov dword ptr ss:[ebp-0x20], eax
...
0052BA73    push eax
0052BA74    call dword ptr ds:[edx+0x10]
...
0052BA9A    movlpd qword ptr ss:[ebp-0xCCC], xmm0
