...
0058B7AC    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058B80B    push eax
0058B80C    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
0058B828    mov ecx, dword ptr ds:[ecx]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
0058B842    pop ebp
0058B843    ret
0058B844    push 0x81F9E0                                   ; => [ String: DomPopContext ]
0058B849    push 0x792
0058B84E    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
0058B853    push 0x81F4B8
0058B858    mov edx, 0x801800
0058B85D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
0058B862    add esp, 0x0C
0058B865    call 0x0063BC30
0058B86A    test al, al
0058B86C    jz 0x0058B86F                                   ; => [ Call: sub_63bc30 ]
0058B86E    int3
0058B86F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
