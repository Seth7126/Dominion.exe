...
00627FD4    jz 0x00627FF1
00627FD6    lea ecx, ss:[ebp-0x10]
00627FD9    call 0x0063D4E0
...
0062805D    jz 0x0062807A
0062805F    lea ecx, ss:[ebp-0x10]
00628062    call 0x0063D4E0
...
0062808A    call 0x005CB4F0
0062808F    xor al, al
00628091    mov ecx, dword ptr ss:[ebp-0x0C]
00628094    mov dword ptr fs:[0x00000000], ecx
0062809B    pop ecx
0062809C    pop edi
0062809D    pop esi
0062809E    pop ebx
