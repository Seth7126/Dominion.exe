...
0074F199    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0074F19E    xor eax, ebp
0074F1A0    mov dword ptr ss:[ebp-0x04], eax
0074F1A3    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 | Type: LRESULT ]
0074F1A8    push ebx
0074F1A9    mov ebx, edx
0074F1AB    push esi
0074F1AC    push edi
0074F1AD    mov dword ptr ss:[ebp-0x204], ebx
0074F1B3    mov edx, dword ptr ds:[ebx+0x14]                ; => [ Type: HWND ]
0074F1B6    mov ecx, dword ptr ds:[ebx+0x08]                ; => [ Type: WPARAM ]
...
0074F1EA    mov edi, eax                                    ; => [ Type: LRESULT ]
0074F1EC    mov dword ptr ss:[ebp-0x20C], edi               ; => [ Type: LRESULT ]
0074F1F2    cmp edi, 0xFFFFFFFF
0074F1F5    jz 0x0074FA8E
0074F1FB    test edi, edi
0074F1FD    jz 0x0074FA8E
0074F203    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074F209    movups xmm1, xmmword ptr ds:[ebx+0x1C]
0074F20D    cmp dword ptr ds:[esi+0x24], 0x00
0074F211    movups xmmword ptr ss:[ebp-0x140], xmm1         ; => [ Type: RECT | Field: left | Field: top | Field: right | Field: bottom ]
0074F218    mov ecx, dword ptr ss:[ebp-0x140]               ; => [ Field: left ]
...
0074F236    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074F23C    lea eax, ds:[ecx+0x10]
0074F23F    xor ecx, ecx
0074F241    movups xmmword ptr ss:[ebp-0x130], xmm1         ; => [ Type: RECT | Field: left | Field: top | Field: right | Field: bottom ]
0074F248    mov dword ptr ss:[ebp-0x130], eax               ; => [ Field: left ]
0074F24E    movups xmm0, xmmword ptr ss:[ebp-0x130]         ; => [ Type: RECT | Field: left | Field: top | Field: right | Field: bottom ]
0074F255    movups xmmword ptr ss:[ebp-0x180], xmm1         ; => [ Type: RECT | Field: left | Field: top | Field: right | Field: bottom ]
0074F25C    mov dword ptr ss:[ebp-0x178], eax               ; => [ Field: right ]
0074F262    movups xmmword ptr ss:[ebp-0x150], xmm0         ; => [ Type: RECT | Field: left | Field: top | Field: right | Field: bottom ]
0074F269    mov eax, dword ptr ds:[esi+0x24]
0074F26C    mov dword ptr ss:[ebp-0x148], eax               ; => [ Field: right ]
...
0074F29B    mov esi, dword ptr ds:[ebx+0x18]                ; => [ Type: HDC ]
...
0074F2CC    jnz 0x0074F55B                                  ; => [ Type: HGDIOBJ | Type: RECT | Type: LOGFONTA ]
...
0074F2E7    push 0x05
0074F2E9    mov dword ptr ss:[ebp-0x120], edx               ; => [ Field: left ]
0074F2EF    lea eax, ds:[edx+0x09]
0074F2F2    mov dword ptr ss:[ebp-0x11C], ecx               ; => [ Field: top ]
0074F2F8    mov dword ptr ss:[ebp-0x118], eax               ; => [ Field: left | Field: right ]
0074F2FE    lea eax, ds:[ecx+0x09]
0074F301    mov dword ptr ss:[ebp-0x114], eax               ; => [ Field: top | Field: bottom ]
...
0074F366    addsd xmm1, xmm0                                ; => [ Field: right ]
...
0074F39F    cvttsd2si ebx, xmm1                             ; => [ Field: bottom ]
0074F3A3    call dword ptr ds:[0x00775408]
0074F3A9    mov edi, dword ptr ss:[ebp-0x204]
0074F3AF    mov esi, dword ptr ss:[ebp-0x118]               ; => [ Field: right ]
0074F3B5    push 0x00
0074F3B7    push ebx
0074F3B8    mov edi, dword ptr ds:[edi+0x18]                ; => [ Type: HDC ]
0074F3BB    push dword ptr ss:[ebp-0x120]
0074F3C1    push edi
0074F3C2    call dword ptr ds:[0x0077507C]                  ; => [ Call: nullptr | Field: left ]
0074F3C8    push ebx
0074F3C9    push esi
0074F3CA    push edi
...
0074F3E3    mov edi, dword ptr ds:[ebx+0x18]                ; => [ Type: HDC ]
0074F3E6    mov esi, dword ptr ss:[ebp-0x114]               ; => [ Field: bottom ]
0074F3EC    push 0x00
0074F3EE    push dword ptr ss:[ebp-0x11C]
0074F3F4    push dword ptr ss:[ebp-0x200]
0074F3FA    push edi
0074F3FB    call dword ptr ds:[0x0077507C]                  ; => [ Call: nullptr | Field: top ]
0074F401    push esi
...
0074F45C    jz 0x0074F49A                                   ; => [ Data: data_19e2778 ]
...
0074F505    push eax
0074F506    call dword ptr ds:[0x0077505C]                  ; => [ Type: HFONT ]
0074F50C    push eax
...
0074F58A    setz cl                                         ; => [ Data: data_19e2778 ]
...
0074F621    push eax
0074F622    call dword ptr ds:[0x0077505C]                  ; => [ Type: HFONT ]
0074F628    push eax
...
0074F658    setz cl                                         ; => [ Data: data_19e2778 ]
...
0074F6A3    mov esi, dword ptr ds:[ebx+0x18]                ; => [ Type: HDC ]
0074F6A6    push 0x0F
...
0074F6B9    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074F6F8    movups xmmword ptr ss:[ebp-0x120], xmm0         ; => [ Field: left | Field: top | Field: right | Field: bottom ]
0074F6FF    mov eax, dword ptr ss:[ebp-0x11C]
0074F705    add eax, 0x03
0074F708    movd ecx, xmm0
0074F70C    mov dword ptr ss:[ebp-0x11C], eax               ; => [ Field: top ]
0074F712    add eax, 0x0F
0074F715    mov dword ptr ss:[ebp-0x114], eax               ; => [ Field: top | Field: bottom ]
0074F71B    add ecx, 0x02
0074F71E    mov dword ptr ss:[ebp-0x120], ecx               ; => [ Field: left ]
0074F724    lea eax, ds:[ecx+0x0F]
0074F727    mov dword ptr ss:[ebp-0x118], eax               ; => [ Field: right ]
0074F72D    mov eax, dword ptr ds:[edi+0x14]
0074F730    cmp eax, 0x04
0074F733    jnz 0x0074F784
0074F735    mov ecx, dword ptr ds:[edi+0x10]
0074F738    call 0x0074B3B0                                 ; => [ Call: sub_74b3b0 ]
0074F73D    mov edi, dword ptr ds:[ebx+0x18]                ; => [ Type: HDC ]
0074F740    push eax
0074F741    call dword ptr ds:[0x00775044]                  ; => [ Type: HBRUSH ]
...
0074F7A0    jnz 0x0074F7BC                                  ; => [ Data: data_8901e0 ]
...
0074F7CD    xor ecx, ecx                                    ; => [ Type: DFCS_STATE ]
0074F7CF    test eax, eax
0074F7D1    mov edx, 0x400
0074F7D6    lea eax, ss:[ebp-0x120]
0074F7DC    cmovz ecx, edx                                  ; => [ Data: data_8901e0 ]
0074F7DF    push ecx
0074F7E0    push 0x04
0074F7E2    push eax
...
0074F840    mov esi, dword ptr ds:[ebx+0x18]                ; => [ Type: HDC ]
0074F843    push 0x0F
...
0074F856    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074F8A8    push 0x00
0074F8AA    push eax
0074F8AB    call 0x00761FC4                                 ; => [ Type: va_list | Call: memset ]
0074F8B0    add esp, 0x0C
0074F8B3    lea eax, ss:[ebp-0x184]
0074F8B9    push eax                                        ; => [ Type: COLORREF ]
...
0074F91B    push eax                                        ; => [ Type: LOGFONTA | Type: LOGFONTA ]
0074F91C    push 0x88FF80
0074F921    push dword ptr ds:[edi+0x10]
0074F924    call 0x0064B6D0                                 ; => [ String: Height: %d Width: %d Escapement: %d Orientation:  %d Weight: %d Italic: %hhd Underline: %hhd StrikeOut: %hhd CharSet: %hhd OutPrecision: %hhd ClipPrecision: %hhd Quality: %hhd PitchAndFamily: %hhd FaceName: %32[^\r\n] Color: %d | Call: sub_64b6d0 ]
...
0074F948    neg esi                                         ; => [ Field: lfHeight ]
...
0074F96F    mov dword ptr ss:[ebp-0x1C0], eax               ; => [ Field: lfHeight ]
0074F975    lea eax, ss:[ebp-0x1C0]
0074F97B    push eax
0074F97C    call dword ptr ds:[0x0077505C]                  ; => [ Type: HFONT ]
0074F982    push eax
0074F983    push dword ptr ds:[ebx+0x18]
0074F986    call dword ptr ds:[0x00775098]                  ; => [ Type: HGDIOBJ ]
...
0074F9B0    push 0x104
0074F9B5    push eax
0074F9B6    call 0x0074AFA0                                 ; => [ Call: sub_74afa0 | String: %s %d ]
...
0074F9D5    paddd xmm1, xmm0                                ; => [ Data: data_891420 ]
0074F9D9    movups xmmword ptr ss:[ebp-0x140], xmm1         ; => [ Field: left | Field: top | Field: right | Field: bottom ]
...
0074FA3F    paddd xmm1, xmm0                                ; => [ Data: data_891420 ]
0074FA43    movups xmmword ptr ss:[ebp-0x140], xmm1         ; => [ Field: left | Field: top | Field: right | Field: bottom ]
...
0074FA70    mov esi, dword ptr ds:[ebx+0x18]                ; => [ Type: HDC ]
0074FA73    push 0x0F
...
0074FA86    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074FA95    pop ebx
0074FA96    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
