...
0061C27C    mov eax, dword ptr ds:[0x008C4040]
...
0061C2A7    jz 0x0061C3D7
0061C2AD    cmp dword ptr ds:[0x008DB5C4], 0x27
0061C2B4    jnz 0x0061C2BE
0061C2B6    mov ecx, dword ptr ds:[0x008DB5C8]
0061C2BC    jmp 0x0061C2CD
0061C2BE    cmp dword ptr ds:[0x008DB5D4], 0x27
0061C2C5    jnz 0x0061C30A
0061C2C7    mov ecx, dword ptr ds:[0x008DB5D8]
...
0061C2EE    jnz 0x0061C30A
0061C2F0    call 0x0064E7A0
...
0061C311    movups xmmword ptr ss:[esp+0x20], xmm0
0061C316    movups xmm0, xmmword ptr ds:[0x00BF21F8]
...
0061C338    mov byte ptr ds:[0x00CCF769], 0x01
0061C33F    movss dword ptr ss:[esp+0x14], xmm0
0061C345    movss dword ptr ds:[0x00CCF774], xmm0
0061C34D    movsd xmm0, qword ptr ds:[0x00890E48]
0061C355    call 0x00762392
...
0061C3B2    call 0x0076238C
0061C3B7    cvtsd2ss xmm0, xmm0
0061C3BB    movss dword ptr ds:[0x00CCF77C], xmm0
0061C3C3    pop edi
0061C3C4    pop esi
0061C3C5    mov ecx, dword ptr ss:[esp+0xA4]
0061C3CC    xor ecx, esp
0061C3CE    call 0x0075927A
...
0061C499    jnz 0x0061C4A3
0061C49B    mov esi, dword ptr ds:[0x008DB5C8]
0061C4A1    jmp 0x0061C4B3
0061C4A3    xor esi, esi
0061C4A5    cmp dword ptr ds:[0x008DB5D4], 0x27
0061C4AC    cmovz esi, dword ptr ds:[0x008DB5D8]
0061C4B3    mov ecx, dword ptr ds:[ecx+0x08]
0061C4B6    call 0x005CBA00
...
0061C55E    jnz 0x0061C568
0061C560    mov ecx, dword ptr ds:[0x008DB5C8]
0061C566    jmp 0x0061C578
0061C568    xor ecx, ecx
0061C56A    cmp dword ptr ds:[0x008DB5D4], 0x27
0061C571    cmovz ecx, dword ptr ds:[0x008DB5D8]
...
0061C58E    call 0x0067A8A0
0061C593    mov byte ptr ds:[0x00B7FCFA], 0x01
0061C59A    pop edi
0061C59B    pop esi
0061C59C    mov ecx, dword ptr ss:[esp+0xA4]
0061C5A3    xor ecx, esp
0061C5A5    call 0x0075927A
...
0061C70E    call 0x005CB630
0061C713    mov esi, dword ptr ds:[esi+0x1C28]
0061C719    mov dword ptr ds:[0x019E39E0], esi
...
0061C7A1    call 0x005CB630
0061C7A6    mov esi, dword ptr ds:[0x019E39E0]
0061C7AC    mov ecx, esi
0061C7AE    call 0x005CBA00
0061C7B3    mov dword ptr ds:[0x00B7FCD0], esi
