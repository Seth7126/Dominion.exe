...
004D6965    push 0x7629E0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Move@?$_Func_impl_no_alloc@P6A_NABW4agent_status@Concurrency@@@Z_NABW412@@std@@EAEPAV?$_Func_base@_NABW4agent_status@Concurrency@@@2@PAX@Z ]
004D696A    mov eax, dword ptr fs:[0x00000000]
004D6970    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D6971    push ecx
004D6972    push esi
004D6973    push edi
004D6974    mov eax, dword ptr ds:[0x008C4040]
004D6979    xor eax, ebp
004D697B    push eax                                        ; => [ Data: __security_cookie ]
004D697C    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004D697F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D6985    mov esi, ecx
004D6987    mov dword ptr ss:[ebp-0x04], 0x00
004D698E    cmp dword ptr ds:[0x00CF65BC], 0x00
004D6995    jz 0x004D69C5                                   ; => [ Data: data_cf65bc ]
...
004D69A6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D69B9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D69BE    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
004D69C5    mov dword ptr ss:[ebp-0x04], 0x01
004D69CC    cmp dword ptr ds:[0x00CF65BC], 0x00
004D69D3    jz 0x004D6A00                                   ; => [ Data: data_cf65bc ]
...
004D69E2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D69F5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D69FA    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
004D6A00    mov ecx, dword ptr ss:[ebp-0x0C]
004D6A03    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D6A0A    pop ecx
004D6A0B    pop edi
004D6A0C    pop esi
