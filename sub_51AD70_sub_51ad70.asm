...
0051AD78    call 0x00761E50                                 ; => [ Call: __chkstk ]
0051AD7D    mov eax, dword ptr ds:[0x008C4040]
0051AD82    xor eax, ebp
0051AD84    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
0051AD87    push ebx
...
0051ADA3    call 0x00761FC4                                 ; => [ Call: memset | Data: data_cc8de0 ]
0051ADA8    add esp, 0x0C
0051ADAB    lea eax, ss:[ebp-0x5028]
0051ADB1    push 0x5020
0051ADB6    push 0x00
0051ADB8    push eax
0051ADB9    call 0x00761FC4                                 ; => [ Call: memset ]
...
0051ADE3    call 0x007621D0                                 ; => [ Call: __allmul ]
0051ADE8    add eax, 0x7D1
0051ADED    mov dword ptr ds:[0x00CC8DE8], 0x7D1            ; => [ Data: data_cc8de8 ]
0051ADF7    mov dword ptr ds:[0x00CC8DE0], eax              ; => [ Data: data_cc8de0 ]
0051ADFC    lea eax, ss:[ebp-0x5028]
0051AE02    adc edx, 0x00
0051AE05    mov dword ptr ds:[0x00CCA780], eax              ; => [ Data: data_cca780 ]
0051AE0A    mov dword ptr ds:[0x00CC8DE4], edx              ; => [ Data: data_cc8de4 ]
0051AE10    mov dword ptr ds:[0x00CC8DEC], 0x00             ; => [ Data: data_cc8dec ]
0051AE1A    mov eax, dword ptr ds:[esi]
0051AE1C    sub eax, 0x00
0051AE1F    jz 0x0051AE62
0051AE21    sub eax, 0x01
0051AE24    jz 0x0051AE35
0051AE26    push 0x816620                                   ; => [ String: RollBlueprint ]
...
0051AE47    call 0x0050AF00                                 ; => [ Call: sub_516f30 | Call: sub_50af00 ]
0051AE4C    mov edx, dword ptr ss:[ebp-0x5038]
0051AE52    mov ecx, 0xCC8DE0
0051AE57    push eax
0051AE58    call 0x0050AF60                                 ; => [ Call: sub_50af60 | Data: data_cc8de0 ]
...
0051AE6C    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
0051AE89    push 0x8166E8                                   ; => [ String: CampaignGenerate ]
0051AE8E    push 0x28F3
0051AE93    mov ecx, 0x8166FC                               ; => [ String: numMissions == 10 ]
...
0051AF14    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0051AF43    mov edx, 0xCC97BC                               ; => [ Data: data_cc97bc ]
...
0051AF94    mov dword ptr ds:[eax+0xCC97B8], 0x02           ; => [ Data: data_cc97b8 ]
0051AF9E    mov dword ptr ds:[eax+0xCC97BC], 0xFFFFFFFF     ; => [ Data: data_cc97bc ]
0051AFA8    mov eax, ecx
0051AFAA    shl eax, 0x04
0051AFAD    mov dword ptr ds:[eax+0xCC97C0], 0x00           ; => [ Data: data_cc97c0 ]
0051AFB7    mov dword ptr ds:[eax+0xCC97C4], 0x0A           ; => [ Data: data_cc97c4 ]
0051AFC1    jmp 0x0051B01D
0051AFC3    mov dword ptr ds:[0x00CC97B8], 0x02             ; => [ Data: data_cc97b8 ]
0051AFCD    mov dword ptr ds:[0x00CC97BC], 0xFFFFFFFF       ; => [ Data: data_cc97bc ]
0051AFD7    mov dword ptr ds:[0x00CC97C0], 0x00             ; => [ Data: data_cc97c0 ]
0051AFE1    mov dword ptr ds:[0x00CC97C4], 0x0A             ; => [ Data: data_cc97c4 ]
0051AFEB    mov eax, dword ptr ds:[esi+0x04]
0051AFEE    mov dword ptr ds:[0x00CC97C8], eax              ; => [ Data: data_cc97c8 ]
0051AFF3    mov eax, dword ptr ss:[ebp-0x502C]
0051AFF9    mov dword ptr ds:[0x00CC97CC], 0xFFFFFFFF       ; => [ Data: data_cc97cc ]
0051B003    mov dword ptr ds:[0x00CC97D0], 0x00             ; => [ Data: data_cc97d0 ]
0051B00D    mov dword ptr ds:[0x00CC97D4], 0x0A             ; => [ Data: data_cc97d4 ]
...
0051B03E    add ebx, 0x0C                                   ; => [ Data: data_cca780 ]
0051B041    mov dword ptr ds:[0x00CCB414], 0x00             ; => [ Data: data_ccb414 ]
0051B04B    add ebx, ecx
0051B04D    mov dword ptr ds:[0x00CCC098], 0x00             ; => [ Data: data_ccc098 ]
0051B057    push 0x00
0051B059    push 0xCCA794                                   ; => [ Data: data_cca794 ]
0051B05E    mov dword ptr ds:[0x00CCCD1C], 0x00             ; => [ Data: data_cccd1c ]
0051B068    mov dword ptr ds:[0x00CCE620], 0x00             ; => [ Data: data_cce620 ]
0051B072    mov dword ptr ds:[0x00CCA784], eax              ; => [ Data: data_cca784 ]
0051B077    mov dword ptr ss:[ebp-0x5048], ebx
0051B07D    movlpd qword ptr ds:[0x00CCE9B4], xmm0          ; => [ Data: data_cce9b4 ]
0051B085    movlpd qword ptr ds:[0x00CCE9CC], xmm0          ; => [ Data: data_cce9cc ]
0051B08D    mov dword ptr ds:[0x00CCE9D4], 0x00             ; => [ Data: data_cce9d4 ]
0051B097    mov dword ptr ds:[0x00CCE9C4], ebx              ; => [ Data: data_cce9c4 ]
0051B09D    mov dword ptr ds:[0x00CCE9C8], 0xCC8DF0         ; => [ Data: data_cce9c8 ]
0051B0A7    mov dword ptr ds:[0x00CCE9BC], 0xCC8DE0         ; => [ Data: data_cce9bc | Data: data_cc8de0 ]
0051B0B1    mov dword ptr ds:[0x00CCE9B0], 0x17             ; => [ Data: data_cce9b0 ]
0051B0BB    mov dword ptr ds:[0x00CCE9C0], 0x00             ; => [ Data: data_cce9c0 ]
...
0051B0D9    push 0x17
0051B0DB    push ebx
0051B0DC    call 0x00590090                                 ; => [ Data: data_cca794 | Call: sub_590090 | Call: memset ]
0051B0E1    mov edx, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
0051B0E7    add esp, 0x0C
0051B0EA    mov dword ptr ds:[0x00CCE9C0], 0xCCA794         ; => [ Data: data_cce9c0 | Data: data_cca794 ]
...
0051B119    call 0x0058FFD0                                 ; => [ Data: data_cca794 | Call: sub_58ffd0 ]
0051B11E    mov edx, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
...
0051B1A5    mov eax, dword ptr ds:[eax+0x90]                ; => [ Call: sub_50b550 ]
...
0051B1BA    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
0051B1F6    call 0x0051AC20                                 ; => [ Call: sub_51ac20 ]
0051B1FB    mov ecx, 0x01
0051B200    call 0x0051AC20                                 ; => [ Call: sub_51ac20 ]
0051B205    xor ecx, ecx
0051B207    call 0x0051AC20                                 ; => [ Call: sub_51ac20 ]
0051B20C    mov ecx, 0x02
0051B211    call 0x0051AC20                                 ; => [ Call: sub_51ac20 ]
0051B216    mov ecx, 0x03
0051B21B    call 0x0051AC20                                 ; => [ Call: sub_51ac20 ]
0051B220    mov ecx, 0xCC8DF0
0051B225    call 0x0058F630                                 ; => [ Call: sub_58f630 ]
...
0051B25E    or eax, edx
0051B260    jnz 0x0051B290                                  ; => [ Data: data_cce9b0 | Call: sub_571b30 ]
...
0051B285    jnz 0x0051B296                                  ; => [ Data: data_cce9b0 | Call: sub_571b30 ]
0051B287    dec eax
...
0051B2B0    mov esi, dword ptr ds:[0x00CC8DE4]              ; => [ Data: data_cc8de4 ]
0051B2B6    mov edi, dword ptr ds:[0x00CC8DE0]              ; => [ Data: data_cc8de0 ]
0051B2BC    push 0x5851F42D
0051B2C1    push 0x4C957F2D
0051B2C6    push esi
0051B2C7    push edi
0051B2C8    call 0x007621D0                                 ; => [ Call: __allmul ]
0051B2CD    add eax, dword ptr ds:[0x00CC8DE8]              ; => [ Data: data_cc8de8 ]
0051B2D3    mov ecx, esi
0051B2D5    mov dword ptr ds:[0x00CC8DE0], eax              ; => [ Data: data_cc8de8 | Data: data_cc8de0 ]
...
0051B2F0    mov dword ptr ds:[0x00CC8DE4], edx              ; => [ Data: data_cc8dec | Data: data_cc8de4 ]
0051B2F6    neg ecx
...
0051B31F    mov dword ptr ds:[eax], 0x816D0C                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_41006f407378fa9eb3ad32886a3fba35>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
0051B325    mov dword ptr ds:[eax+0x24], eax
0051B328    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
...
0051B33A    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
...
0051B420    push eax
0051B421    push esi
0051B422    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0051B432    pop esi
0051B433    pop ebx
0051B434    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0051B439    mov esp, ebp
0051B43B    pop ebp
0051B43C    ret
0051B43D    push 0x80CF80                                   ; => [ String: CampaignPieceDefGetFn ]
0051B442    push 0x30A
0051B447    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0051B44C    push 0x80CD80
0051B451    mov edx, 0x801800
0051B456    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0051B45B    add esp, 0x0C
0051B45E    call 0x0063BC30
0051B463    test al, al
0051B465    jz 0x0051B468                                   ; => [ Call: sub_63bc30 ]
0051B467    int3
0051B468    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
