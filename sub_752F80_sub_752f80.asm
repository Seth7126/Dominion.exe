...
00752F80    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00752F85    push esi
00752F86    push edi
...
00752F94    push 0xA0
00752F99    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\MeshAttachment.c ]
00752F9B    add esp, 0x0C
00752F9E    jmp 0x00752FAE
00752FA0    push 0xA0
00752FA5    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00752FB9    push 0x00
00752FBB    push esi
00752FBC    call 0x00761FC4                                 ; => [ Call: memset ]
00752FC1    add esp, 0x0C
00752FC4    mov ecx, dword ptr ds:[0x019E277C]              ; => [ Data: data_19e277c ]
00752FCA    movzx eax, cx
00752FCD    inc ecx
00752FCE    mov dword ptr ds:[0x019E277C], ecx              ; => [ Data: data_19e277c ]
...
00752FFB    call 0x00752330                                 ; => [ Call: sub_752330 ]
00753000    push 0x752BD0
00753005    push 0x752B00
0075300A    push 0x02
0075300C    mov edx, edi
0075300E    mov ecx, esi
00753010    call 0x00752290                                 ; => [ Call: sub_752bd0 | Call: sub_752b00 | Call: sub_752290 ]
