...
006F727B    mov dword ptr fs:[0x00000000], eax
006F7281    push 0xAC
006F7286    push dword ptr ds:[0x0147D470]
006F728C    call dword ptr ds:[0x007752FC]
006F7292    push 0x00
006F7294    push 0x00
...
006F72A4    call dword ptr ds:[0x00775308]
006F72AA    cmp dword ptr ds:[0x0147EF94], 0x00
006F72B1    jz 0x006F7EBE
006F72B7    mov ecx, dword ptr ds:[0x0147DF94]
006F72BD    call 0x00740CF0
006F72C2    mov edi, eax
006F72C4    mov dword ptr ss:[ebp-0x17C], edi
...
006F72EF    mov dword ptr ss:[ebp-0x138], 0x875A70
006F72F9    mov dword ptr ss:[ebp-0x134], 0x88B944
006F7303    mov dword ptr ss:[ebp-0x12C], 0x801800
006F730D    mov dword ptr ss:[ebp-0x128], ecx
006F7313    mov dword ptr ss:[ebp-0x130], 0x00
...
006F7345    mov dword ptr ss:[ebp-0x138], 0x875A70
006F734F    mov dword ptr ss:[ebp-0x134], 0x875A80
006F7359    mov dword ptr ss:[ebp-0x12C], 0x801800
006F7363    mov dword ptr ss:[ebp-0x130], 0x00
006F736D    call dword ptr ds:[0x00775308]
006F7373    mov ecx, dword ptr ds:[edi]
006F7375    mov eax, 0x800510
...
006F73B6    mov dword ptr ss:[ebp-0x16C], 0x875A70
006F73C0    mov dword ptr ss:[ebp-0x168], 0x875A78
006F73CA    mov dword ptr ss:[ebp-0x160], 0x801800
006F73D4    mov dword ptr ss:[ebp-0x164], 0x88B97C
...
006F7403    movsd qword ptr ss:[esp+0x08], xmm0
...
006F741B    push eax
006F741C    call 0x0063DF30
006F7421    mov eax, dword ptr ss:[ebp-0x11C]
006F7427    add esp, 0x20
006F742A    mov esi, 0x801800
006F742F    mov dword ptr ss:[ebp-0x124], 0x00
006F7439    test eax, eax
006F743B    mov dword ptr ss:[ebp-0x138], 0x875A70
006F7445    mov ecx, esi
006F7447    mov dword ptr ss:[ebp-0x134], 0x88B970
006F7451    cmovnz ecx, eax
006F7454    mov dword ptr ss:[ebp-0x12C], esi
...
006F74BC    call 0x0064C080
006F74C1    mov dword ptr ss:[ebp-0x11C], esi
...
006F74ED    movsd qword ptr ss:[esp+0x08], xmm0
...
006F75A5    call 0x0064C080
006F75AA    mov dword ptr ss:[ebp-0x11C], 0x801800
...
006F75DA    movsd qword ptr ss:[esp+0x08], xmm0
...
006F7695    call 0x0064C080
006F769A    mov dword ptr ss:[ebp-0x11C], 0x801800
...
006F76FC    mov dword ptr ss:[ebp-0x158], 0x88B9A8
006F7706    mov dword ptr ss:[ebp-0x164], 0x88B998
006F7710    mov dword ptr ss:[ebp-0x15C], 0x8762F0
006F771A    mov dword ptr ss:[ebp-0x124], 0x06
006F7724    mov dword ptr ss:[ebp-0x138], 0x875C80
006F772E    mov dword ptr ss:[ebp-0x134], 0x875C80
006F7738    mov dword ptr ss:[ebp-0x12C], 0x801800
006F7742    mov dword ptr ss:[ebp-0x130], 0x00
...
006F7779    mov dword ptr ss:[ebp-0x138], 0x875C80
006F7783    mov dword ptr ss:[ebp-0x134], 0x875C90
006F778D    mov dword ptr ss:[ebp-0x12C], 0x801800
006F7797    mov dword ptr ss:[ebp-0x130], 0x00
006F77A1    call dword ptr ds:[0x00775308]
006F77A7    mov ecx, dword ptr ds:[edi+0x60]
006F77AA    cmp dword ptr ds:[ecx+0x04], 0x02
006F77AE    jz 0x006F77C9
006F77B0    push 0x8811E4
006F77B5    push 0x559
006F77BA    push 0x880FE4
006F77BF    mov ecx, 0x87A4FC
006F77C4    jmp 0x006F7EF0
006F77C9    call 0x005AF880
006F77CE    mov ecx, dword ptr ds:[0x0088B93C]
006F77D4    lea edx, ss:[ebp-0x111]
006F77DA    mov dword ptr ss:[ebp-0x118], ecx
...
006F7814    xor ecx, ecx
006F7816    mov dword ptr ss:[ebp-0x11C], ecx
...
006F78D3    mov dword ptr ss:[ebp-0x138], 0x875C80
006F78DD    mov dword ptr ss:[ebp-0x134], 0x88B9B8
006F78E7    mov dword ptr ss:[ebp-0x12C], 0x801800
006F78F1    jmp 0x006F7E95
006F78F6    mov eax, dword ptr ds:[edi+0x88]
006F78FC    test eax, eax
006F78FE    jnz 0x006F7907
006F7900    mov esi, 0x801800
...
006F7927    mov dword ptr ss:[ebp-0x158], 0x8790B4
006F7931    mov dword ptr ss:[ebp-0x164], 0x88B9AC
006F793B    mov dword ptr ss:[ebp-0x15C], 0x88B9C4
006F7945    mov dword ptr ss:[ebp-0x124], 0x06
006F794F    mov dword ptr ss:[ebp-0x138], 0x87EB88
006F7959    mov dword ptr ss:[ebp-0x134], 0x87EB88
006F7963    mov dword ptr ss:[ebp-0x12C], 0x801800
006F796D    mov dword ptr ss:[ebp-0x130], 0x00
...
006F79EA    mov dword ptr ss:[ebp-0x158], 0x88B9C0
006F79F4    mov dword ptr ss:[ebp-0x164], 0x88BA10
006F79FE    mov dword ptr ss:[ebp-0x15C], 0x88B9E8
006F7A08    mov dword ptr ss:[ebp-0x13C], 0x06
006F7A12    mov dword ptr ss:[ebp-0x150], 0x87EB9C
006F7A1C    mov dword ptr ss:[ebp-0x14C], 0x88BA28
006F7A26    mov dword ptr ss:[ebp-0x144], 0x801800
...
006F7A6B    movsd qword ptr ss:[esp+0x08], xmm0
...
006F7AA4    mov dword ptr ss:[ebp-0x150], 0x87EB9C
006F7AAE    cmovnz esi, eax
006F7AB1    mov dword ptr ss:[ebp-0x14C], 0x88BA1C
006F7ABB    lea eax, ss:[ebp-0x150]
006F7AC1    mov dword ptr ss:[ebp-0x144], 0x801800
006F7ACB    push eax
006F7ACC    push 0x00
006F7ACE    push 0x180
...
006F7B6F    mov dword ptr ss:[ebp-0x158], 0x875B58
006F7B79    mov dword ptr ss:[ebp-0x164], 0x88BA40
006F7B83    mov dword ptr ss:[ebp-0x15C], 0x871C44
006F7B8D    mov dword ptr ss:[ebp-0x13C], 0x06
006F7B97    mov dword ptr ss:[ebp-0x150], 0x875B58
006F7BA1    mov dword ptr ss:[ebp-0x14C], 0x875B58
006F7BAB    mov dword ptr ss:[ebp-0x144], 0x801800
...
006F7BF5    mov dword ptr ss:[ebp-0x158], 0x875B24
006F7BFF    mov dword ptr ss:[ebp-0x164], 0x88BA30
006F7C09    mov dword ptr ss:[ebp-0x15C], 0x876270
006F7C13    mov dword ptr ss:[ebp-0x13C], 0x06
006F7C1D    mov dword ptr ss:[ebp-0x150], 0x875B24
006F7C27    mov dword ptr ss:[ebp-0x14C], 0x875B24
006F7C31    mov dword ptr ss:[ebp-0x144], 0x801800
006F7C3B    mov dword ptr ss:[ebp-0x148], 0x00
006F7C45    jmp 0x006F7E95
006F7C4A    mov ecx, dword ptr ds:[edi+0xB4]
006F7C50    mov eax, 0x800428
...
006F7C90    mov dword ptr ss:[ebp-0x150], 0x804D30
006F7C9A    mov dword ptr ss:[ebp-0x14C], 0x88BA50
006F7CA4    mov dword ptr ss:[ebp-0x144], 0x801800
006F7CAE    mov dword ptr ss:[ebp-0x148], 0x88BA5C
...
006F7CF7    mov ecx, esi
006F7CF9    mov dword ptr ss:[ebp-0x150], 0x804D30
006F7D03    cmovnz ecx, eax
006F7D06    mov dword ptr ss:[ebp-0x14C], 0x88BA7C
006F7D10    lea eax, ss:[ebp-0x150]
006F7D16    mov dword ptr ss:[ebp-0x144], 0x801800
006F7D20    push eax
006F7D21    push 0x00
006F7D23    push 0x180
...
006F7D7C    call 0x0064C080
006F7D81    movups xmm0, xmmword ptr ds:[edi+0xB8]
006F7D88    sub esp, 0x10
006F7D8B    mov eax, esp
006F7D8D    movups xmmword ptr ds:[eax], xmm0
006F7D90    call 0x0064B360
...
006F7DB5    or ecx, eax
006F7DB7    mov dword ptr ss:[ebp-0x150], 0x804D30
006F7DC1    movzx eax, dl
006F7DC4    shl ecx, 0x08
006F7DC7    or ecx, eax
006F7DC9    mov dword ptr ss:[ebp-0x14C], 0x875AC0
006F7DD3    lea eax, ss:[ebp-0x150]
006F7DD9    mov dword ptr ss:[ebp-0x144], 0x801800
006F7DE3    push eax
006F7DE4    push 0x00
006F7DE6    push 0x180
...
006F7E45    mov dword ptr ss:[ebp-0x124], 0x87EBFC
006F7E4F    mov dword ptr ss:[ebp-0x130], 0x88BA70
006F7E59    mov dword ptr ss:[ebp-0x128], 0x88BA8C
006F7E63    mov dword ptr ss:[ebp-0x180], 0x06
006F7E6D    mov dword ptr ss:[ebp-0x194], 0x804D30
006F7E77    mov dword ptr ss:[ebp-0x190], 0x87EBFC
006F7E81    mov dword ptr ss:[ebp-0x188], 0x801800
...
006F7EC1    mov dword ptr fs:[0x00000000], ecx
006F7EC8    pop ecx
006F7EC9    pop edi
006F7ECA    pop esi
006F7ECB    mov ecx, dword ptr ss:[ebp-0x14]
006F7ECE    xor ecx, ebp
006F7ED0    call 0x0075927A
006F7ED5    mov esp, ebp
006F7ED7    pop ebp
006F7ED8    mov esp, ebx
006F7EDA    pop ebx
006F7EDB    ret
006F7EDC    push 0x88B92C
006F7EE1    push 0x132E
006F7EE6    push 0x88AF54
006F7EEB    mov ecx, 0x88B94C
006F7EF0    mov edx, esi
006F7EF2    call 0x0063B870
006F7EF7    add esp, 0x0C
006F7EFA    call 0x0063BC30
006F7EFF    test al, al
006F7F01    jz 0x006F7F04
006F7F03    int3
006F7F04    call 0x0063BB00
