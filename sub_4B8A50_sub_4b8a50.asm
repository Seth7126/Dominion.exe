...
004B8A55    push esi
004B8A56    push edi
004B8A57    mov edi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004B8A5D    test edi, edi
004B8A5F    jnz 0x004B8A77
004B8A61    push 0x77EB90                                   ; => [ String: GetClient ]
004B8A66    push 0x7B
004B8A68    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004B8A6D    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004B8A72    jmp 0x004B8C7E
004B8A77    lea ecx, ds:[edi+0x7570]
004B8A7D    call 0x004AC320                                 ; => [ Call: sub_4ac320 ]
004B8A82    lea ecx, ds:[edi+0x75B8]
004B8A88    call 0x004AC120                                 ; => [ Call: sub_4ac120 ]
004B8A8D    lea ecx, ds:[edi+0x75C4]
004B8A93    call 0x004AC220                                 ; => [ Call: sub_4ac220 ]
...
004B8AAF    call 0x004BAE80                                 ; => [ Call: sub_4bae80 ]
...
004B8AC0    mov dword ptr ds:[esi], 0x00                    ; => [ Call: __builtin_memset ]
...
004B8AFA    call 0x004BB0C0                                 ; => [ Call: sub_4bb0c0 ]
...
004B8B0B    mov dword ptr ds:[esi], 0x00                    ; => [ Call: __builtin_memset ]
...
004B8B34    xor cl, cl
004B8B36    call 0x004AEB40                                 ; => [ Call: sub_4aeb40 ]
004B8B3B    mov eax, dword ptr ds:[0x00BF23B8]              ; => [ Data: data_bf23b8 ]
...
004B8B54    mov eax, dword ptr ds:[0x00BF23D4]              ; => [ Data: data_bf23d4 ]
004B8B59    mov dword ptr ds:[0x00BF23B8], 0x00             ; => [ Data: data_bf23b8 ]
004B8B63    test eax, eax
004B8B65    jz 0x004B8BA3
004B8B67    cmp eax, 0x801800
004B8B6C    jz 0x004B8BA3                                   ; => [ Data: data_801800 ]
004B8B6E    cmp dword ptr ds:[0x00CF65BC], 0x00
004B8B75    jz 0x004B8B99
004B8B77    cmp byte ptr ds:[eax], 0x00
004B8B7A    jz 0x004B8B99                                   ; => [ Data: data_cf65bc ]
004B8B7C    mov ecx, 0xBF23D4
004B8B81    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 | Data: data_bf23d4 ]
...
004B8B94    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B8B99    mov dword ptr ds:[0x00BF23D4], 0x801800         ; => [ Data: data_801800 | Data: data_bf23d4 ]
004B8BA3    push 0xBF23E8
004B8BA8    call dword ptr ds:[0x00775134]                  ; => [ Data: data_bf23e8 ]
004B8BAE    call 0x004D0550                                 ; => [ Call: sub_4d0550 ]
...
004B8BCB    jz 0x004B8BFB                                   ; => [ Data: data_801800 ]
004B8BCD    cmp dword ptr ds:[0x00CF65BC], 0x00
004B8BD4    jz 0x004B8BF5
004B8BD6    cmp byte ptr ds:[eax], 0x00
004B8BD9    jz 0x004B8BF5                                   ; => [ Data: data_cf65bc ]
004B8BDB    mov ecx, esi
004B8BDD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B8BF0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B8BF5    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
004B8BFB    inc ebx
...
004B8C39    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B8C3E    mov dword ptr ds:[edi+0x20], 0x801800           ; => [ Data: data_801800 ]
004B8C45    cmp dword ptr ds:[edi+0x5068], 0x00
004B8C4C    jz 0x004B8C59
004B8C4E    lea ecx, ds:[edi+0x5098]
004B8C54    call 0x004D6110                                 ; => [ Call: sub_4d6110 ]
004B8C59    call 0x0061B2F0                                 ; => [ Call: sub_61b2f0 ]
...
004B8C68    pop ebp
004B8C69    ret                                             ; => [ Call: sub_4acd60 ]
004B8C6A    push 0x8735EC                                   ; => [ String: GameCenterDisconnect ]
004B8C6F    push 0x357
004B8C74    push 0x873508                                   ; => [ String: C:\x\ax2017\Engine\GameCenter.cpp ]
004B8C79    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004B8C7E    mov edx, 0x801800
004B8C83    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004B8C88    add esp, 0x0C
004B8C8B    call 0x0063BC30
004B8C90    test al, al
004B8C92    jz 0x004B8C95                                   ; => [ Call: sub_63bc30 ]
004B8C94    int3
004B8C95    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
