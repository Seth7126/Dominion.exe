...
006B1C67    push esi
006B1C68    push edi
006B1C69    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B1C6E    mov edx, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B1C74    test eax, eax
006B1C76    jnz 0x006B1C7C
006B1C78    xor esi, esi                                    ; => [ Call: nullptr ]
006B1C7A    jmp 0x006B1C9C
006B1C7C    movzx ecx, ax
006B1C7F    cmp ecx, dword ptr ds:[edx+0x3C]
006B1C82    jb 0x006B1C88
006B1C84    xor esi, esi                                    ; => [ Call: nullptr ]
...
006B1C99    cmovnz esi, ecx                                 ; => [ Call: nullptr ]
006B1C9C    mov ebx, dword ptr ss:[ebp+0x0C]
006B1C9F    mov ecx, ebx
006B1CA1    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B1CA6    mov edx, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B1CAC    test eax, eax
006B1CAE    jnz 0x006B1CB4
006B1CB0    xor edi, edi                                    ; => [ Call: nullptr ]
006B1CB2    jmp 0x006B1CD4
006B1CB4    movzx ecx, ax
006B1CB7    cmp ecx, dword ptr ds:[edx+0x3C]
006B1CBA    jb 0x006B1CC0
006B1CBC    xor edi, edi                                    ; => [ Call: nullptr ]
...
006B1CD1    cmovnz edi, ecx                                 ; => [ Call: nullptr ]
...
006B1CE6    call 0x006AEA20                                 ; => [ Call: sub_5af880 | Call: sub_6aea20 ]
006B1CEB    mov ecx, dword ptr ds:[0x0147B078]
006B1CF1    push eax
006B1CF2    push 0x00
006B1CF4    push dword ptr ds:[esi+0x1C]
006B1CF7    mov ecx, dword ptr ds:[ecx+0x08]                ; => [ Data: data_147b078 ]
006B1CFA    push 0x00
...
006B1D28    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\Texture.h | Data: data_801800 | String: assetPtr->assetType == ASSET_TYPE_TEXTURE | String: TextureGetDef ]
006B1D2D    add esp, 0x0C
006B1D30    call 0x0063BC30
006B1D35    test al, al
006B1D37    jz 0x006B1D3A                                   ; => [ Call: sub_63bc30 ]
006B1D39    int3
006B1D3A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
