...
00602745    push 0x76A86D                                   ; => [ Call: __ehhandler$?link_target@?$source_block@V?$multi_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@V?$ordered_message_processor@I@2@@Concurrency@@UAEXPAV?$ITarget@I@2@@Z | Type: EHRegistrationNode ]
0060274A    mov eax, dword ptr fs:[0x00000000]
00602750    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060275E    push eax                                        ; => [ Data: __security_cookie ]
0060275F    lea eax, ss:[ebp-0x0C]
00602762    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00602778    jnz 0x006027F6                                  ; => [ Data: data_b80b44 ]
0060277A    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
0060279C    jnz 0x006027F6                                  ; => [ Data: data_b824dc | Data: data_b80b48 ]
0060279E    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
...
00602871    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00602876    movss xmm3, dword ptr ds:[0x00890E18]
0060287E    mov edx, 0xBE4D20
00602883    push 0x00
00602885    push 0xFFFFFFFF
00602887    mov ecx, eax
00602889    call 0x00665DB0                                 ; => [ Data: data_be4d20 | Call: sub_665db0 ]
0060288E    add esp, 0x08
00602891    cmp dword ptr ds:[0x00B604E4], ebx
00602897    jnz 0x006028BB                                  ; => [ Data: data_b604e4 ]
00602899    mov ecx, edi
0060289B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
006028A0    movss xmm3, dword ptr ds:[0x00890E18]
006028A8    mov edx, 0xBE4C6C
006028AD    push 0x00
006028AF    push 0xFFFFFFFF
006028B1    mov ecx, eax
006028B3    call 0x00665DB0                                 ; => [ Data: data_be4c6c | Call: sub_665db0 ]
006028B8    add esp, 0x08
006028BB    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006028C2    mov dword ptr ss:[ebp-0x04], 0x00
006028C9    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
006028D0    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
0060296B    call 0x004B9680                                 ; => [ Call: sub_4b9680 ]
...
006029C1    call 0x0063D850                                 ; => [ Call: sub_597aa0 | Call: sub_63d850 ]
006029C6    mov byte ptr ss:[ebp-0x04], 0x05
006029CA    cmp dword ptr ds:[0x00CF65BC], 0x00
006029D1    jz 0x00602A01                                   ; => [ Data: data_cf65bc ]
...
006029E2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602A48    test al, al
00602A4A    jz 0x00602A6E                                   ; => [ Call: sub_4c3550 ]
00602A4C    mov ecx, edi
00602A4E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00602A53    movss xmm3, dword ptr ds:[0x00890E18]
00602A5B    mov edx, 0xBE4CE4
00602A60    push 0x00
00602A62    push 0xFFFFFFFF
00602A64    mov ecx, eax
00602A66    call 0x00665DB0                                 ; => [ Data: data_be4ce4 | Call: sub_665db0 ]
00602A6B    add esp, 0x08
00602A6E    mov ecx, ebx
00602A70    call 0x005CC5E0                                 ; => [ Call: sub_5cc5e0 ]
...
00602A83    push eax
00602A84    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
00602ABE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602B1C    mov esi, 0xBE4CC0                               ; => [ Data: data_be4cc0 ]
...
00602B2E    mov esi, 0xBE4CC0                               ; => [ Data: data_be4cc0 ]
00602B33    jmp 0x00602B57
00602B35    jle 0x00602B3E
00602B37    mov esi, 0xBE4CD8                               ; => [ Data: data_be4cd8 | Data: data_be4cd8 ]
00602B3C    jmp 0x00602B57
00602B3E    push 0x861FE0                                   ; => [ String: GetOpponentAlignement ]
00602B43    push 0x9494
00602B48    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00602B4D    jmp 0x00602F51
00602B52    mov esi, 0xBE4CCC                               ; => [ Data: data_be4ccc ]
00602B57    mov ecx, edi
00602B59    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00602B5E    movss xmm3, dword ptr ds:[0x00890E18]
00602B66    mov edx, esi
00602B68    push 0x00
00602B6A    push 0xFFFFFFFF
00602B6C    mov ecx, eax
00602B6E    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
00602C54    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602C67    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00602C6C    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
00602C73    mov byte ptr ss:[ebp-0x04], 0x03
00602C77    push 0x00
00602C79    push 0x00
00602C7B    mov edx, 0x3EC
00602C80    mov ecx, ebx
00602C82    call 0x005D1210                                 ; => [ Call: sub_5d1210 ]
00602C87    push 0x00
00602C89    push 0x00
...
00602CAF    mov dword ptr ss:[ebp-0x2C], eax                ; => [ Call: sub_5d1210 ]
...
00602E45    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602E58    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00602E5D    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00602E64    mov byte ptr ss:[ebp-0x04], 0x0B
00602E68    cmp dword ptr ds:[0x00CF65BC], 0x00
00602E6F    jz 0x00602E98                                   ; => [ Data: data_cf65bc ]
...
00602E80    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602E93    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00602E98    mov byte ptr ss:[ebp-0x04], 0x0C
00602E9C    cmp dword ptr ds:[0x00CF65BC], 0x00
00602EA3    jz 0x00602ECC                                   ; => [ Data: data_cf65bc ]
...
00602EB4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602EEB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00602EFE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00602F03    mov ecx, dword ptr ss:[ebp-0x0C]
00602F06    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00602F0D    pop ecx
00602F0E    pop edi
00602F0F    pop esi
00602F10    pop ebx
...
00602F2B    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
00602F30    add esp, 0x0C
00602F33    call 0x0063BC30
00602F38    test al, al
00602F3A    jz 0x00602F3D                                   ; => [ Call: sub_63bc30 ]
00602F3C    int3
00602F3D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00602F42    push 0x871028                                   ; => [ String: GetActiveConfig ]
00602F47    push 0x33B6
00602F4C    mov ecx, 0x871038                               ; => [ String: c.activeGame.gameType != GAME_NONE ]
00602F51    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00602F56    mov edx, 0x801800
00602F5B    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00602F60    add esp, 0x0C
00602F63    call 0x0063BC30
00602F68    test al, al
00602F6A    jz 0x00602F6D                                   ; => [ Call: sub_63bc30 ]
00602F6C    int3
00602F6D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
