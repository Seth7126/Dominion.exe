...
005B0FB0    mov dword ptr fs:[0x00000000], eax
...
005B10C8    call 0x0063B870
005B10CD    add esp, 0x14
005B10D0    call 0x0063BC30
005B10D5    test al, al
005B10D7    jz 0x005B10DA
005B10D9    int3
005B10DA    call 0x0063BB00
