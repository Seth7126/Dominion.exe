...
0055F280    mov dword ptr ss:[ebp-0x70], 0x81E8B8
0055F287    mov dword ptr ss:[ebp-0x6C], eax
0055F28A    lea eax, ss:[ebp-0x70]
0055F28D    mov dword ptr ss:[ebp-0x4C], eax
...
0055F2AA    mov dword ptr ss:[ebp-0x40], 0x81E89C
0055F2B1    mov dword ptr ss:[ebp-0x1C], eax
