...
00772A4E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00772A53    mov ecx, dword ptr ds:[edx-0x04]
00772A56    xor ecx, eax
00772A58    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00772A5D    mov eax, 0x8BF718
00772A62    jmp 0x00761FA6                                  ; => [ Data: data_8bf718 | Call: __CxxFrameHandler3 ]
