...
00760BD9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00760BF9    push 0x77EA10                                   ; => [ String: aVoice < VOICE_COUNT ]
00760BFE    push 0x21
00760C00    push 0x77EA28                                   ; => [ String: D:\soloud\src\core\soloud_core_voiceops.cpp ]
00760C05    lea eax, ss:[ebp-0xCC]
00760C0B    push 0x77E920
00760C10    push eax
00760C11    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
00760C29    push 0x77E9B8                                   ; => [ String: mInsideAudioThreadMutex ]
00760C2E    push 0x22
00760C30    push 0x77EA28                                   ; => [ String: D:\soloud\src\core\soloud_core_voiceops.cpp ]
00760C35    lea eax, ss:[ebp-0xCC]
00760C3B    push 0x77E920
00760C40    push eax
00760C41    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
00760C6D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00760C91    push 0x77EA10                                   ; => [ String: aVoice < VOICE_COUNT ]
00760C96    push 0x8E
00760C9B    push 0x77EA28                                   ; => [ String: D:\soloud\src\core\soloud_core_voiceops.cpp ]
00760CA0    lea eax, ss:[ebp-0xCC]
00760CA6    push 0x77E920
00760CAB    push eax
00760CAC    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
00760CC4    push 0x77E9B8                                   ; => [ String: mInsideAudioThreadMutex ]
00760CC9    push 0x8F
00760CCE    push 0x77EA28                                   ; => [ String: D:\soloud\src\core\soloud_core_voiceops.cpp ]
00760CD3    lea eax, ss:[ebp-0xCC]
00760CD9    push 0x77E920
00760CDE    push eax
00760CDF    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
00760D27    pop ebx
00760D28    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
