...
00584BE2    push edi
00584BE3    setz cl
00584BE6    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
...
00584BFB    call 0x00581700                                 ; => [ Call: sub_581700 ]
...
00584CD7    push 0x820120                                   ; => [ String: MarkLandscapeBought ]
00584CDC    push 0x2E53
00584CE1    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
00584D2D    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00584D52    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00584D79    test al, al
00584D7B    jz 0x00584D95                                   ; => [ Call: sub_5754f0 ]
...
00584DAA    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00584DCA    test al, al
00584DCC    jz 0x00584F37                                   ; => [ Call: sub_5754f0 ]
...
00584E1A    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
00584E41    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00584E64    push eax
00584E65    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
00584E7F    push 0x00
00584E81    push eax
00584E82    call 0x00761FC4                                 ; => [ Call: memset ]
...
00584EA9    push 0x01
00584EAB    push eax
00584EAC    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
00584EB1    mov eax, dword ptr fs:[0x0000002C]
00584EB7    add esp, 0x1C
00584EBA    mov ecx, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
00584F2D    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
00584F70    push 0x3F1
00584F75    push 0xE01
00584F7A    call 0x00571F30                                 ; => [ Call: sub_571f30 ]
...
00584F92    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00584FA9    call 0x00584790                                 ; => [ Call: sub_584790 ]
...
00584FD4    pop ebp
00584FD5    ret                                             ; => [ Call: sub_5911e0 | Call: sub_5911e0 ]
00584FD6    push 0x81F9E0                                   ; => [ String: DomPopContext ]
00584FDB    push 0x792
00584FE0    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
00584FE5    push 0x81F4B8
00584FEA    mov edx, 0x801800
00584FEF    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
00584FF4    add esp, 0x0C
00584FF7    call 0x0063BC30
00584FFC    test al, al
00584FFE    jz 0x00585001                                   ; => [ Call: sub_63bc30 ]
00585000    int3
00585001    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
