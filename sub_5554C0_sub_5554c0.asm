...
005554D5    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005554D8    cmp edi, 0x320
005554DE    jb 0x005554E5
005554E0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005554FD    test al, al
005554FF    jz 0x0055552F                                   ; => [ Call: sub_5754f0 ]
00555501    call 0x00573400                                 ; => [ Call: sub_573400 ]
