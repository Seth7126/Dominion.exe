...
004CC075    mov dword ptr fs:[0x00000000], eax
...
004CC089    call 0x0063D720
004CC08E    mov eax, dword ptr ss:[ebp-0x4C]
004CC091    mov edi, 0x801800
004CC096    test eax, eax
004CC098    mov ecx, edi
...
004CC0EC    jz 0x004CC110
004CC0EE    lea ecx, ss:[ebp-0x4C]
004CC0F1    call 0x0063D4E0
...
004CC104    call 0x0064C080
004CC109    mov dword ptr ss:[ebp-0x4C], 0x801800
004CC110    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CC117    test bl, bl
004CC119    jz 0x004CC133
004CC11B    mov eax, dword ptr ds:[0x00CC8DA0]
004CC120    mov dword ptr ds:[0x008DB660], eax
004CC125    mov eax, dword ptr ds:[0x00CC8DA4]
004CC12A    test eax, eax
004CC12C    jz 0x004CC133
004CC12E    mov dword ptr ds:[0x008DB6B0], eax
...
004CC141    call 0x0063D720
004CC146    mov eax, dword ptr ss:[ebp-0x4C]
004CC149    mov ecx, edi
...
004CC18C    jz 0x004CC1B0
004CC18E    lea ecx, ss:[ebp-0x4C]
004CC191    call 0x0063D4E0
...
004CC1A4    call 0x0064C080
004CC1A9    mov dword ptr ss:[ebp-0x4C], 0x801800
...
004CC3BC    jz 0x004CC3E0
004CC3BE    lea ecx, ss:[ebp-0x4C]
004CC3C1    call 0x0063D4E0
...
004CC46C    jz 0x004CC489
004CC46E    lea ecx, ss:[ebp-0x4C]
004CC471    call 0x0063D4E0
...
004CC4FC    jz 0x004CC519
004CC4FE    lea ecx, ss:[ebp-0x4C]
004CC501    call 0x0063D4E0
...
004CC5BC    jz 0x004CC5D9
004CC5BE    lea ecx, ss:[ebp-0x4C]
004CC5C1    call 0x0063D4E0
...
004CC67D    jz 0x004CC69A
004CC67F    lea ecx, ss:[ebp-0x4C]
004CC682    call 0x0063D4E0
...
004CC70C    jz 0x004CC729
004CC70E    lea ecx, ss:[ebp-0x4C]
004CC711    call 0x0063D4E0
...
004CC724    call 0x0064C080
004CC729    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CC730    test esi, esi
004CC732    jnz 0x004CC749
004CC734    mov ecx, 0xCC8D98
004CC739    call 0x004CBFA0
004CC73E    mov dword ptr ds:[0x00CC8D9C], edx
004CC744    mov dword ptr ds:[0x00CC8D98], eax
004CC749    xor al, al
004CC74B    mov ecx, dword ptr ss:[ebp-0x0C]
004CC74E    mov dword ptr fs:[0x00000000], ecx
004CC755    pop ecx
004CC756    pop edi
004CC757    pop esi
004CC758    pop ebx
...
004CC77D    call 0x0063B870
004CC782    add esp, 0x0C
004CC785    call 0x0063BC30
004CC78A    test al, al
004CC78C    jz 0x004CC78F
004CC78E    int3
004CC78F    call 0x0063BB00
