...
004C3A48    call 0x00761E50                                 ; => [ Call: __chkstk ]
004C3A4D    mov eax, dword ptr ds:[0x008C4040]
004C3A52    xor eax, ebp
004C3A54    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
004C3A57    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C3A72    push 0x77EB90                                   ; => [ String: GetClient ]
004C3A77    push 0x7B
004C3A79    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004C3A7E    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
...
004C3AAC    call 0x004DA580                                 ; => [ Call: sub_4da580 ]
...
004C3ACA    mov dword ptr ss:[ebp-0x5090], 0x3E9            ; => [ Call: nullptr ]
...
004C3B3E    push eax
004C3B3F    call 0x004C3550                                 ; => [ Call: sub_4c3550 ]
004C3B44    mov edx, dword ptr ds:[esi-0x04]
004C3B47    add esp, 0x08
004C3B4A    mov esi, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
...
004C3B8C    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C3B92    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004C3B97    mov edx, dword ptr ss:[ebp-0x5090]
004C3B9D    mov ecx, esi
004C3B9F    lea edx, ds:[edi+edx*1]
004C3BA2    call 0x004BAA90                                 ; => [ Call: sub_4baa90 ]
...
004C3BBE    jz 0x004C3CF6                                   ; => [ Call: sub_61dad0 ]
...
004C3BE2    call 0x004BA400                                 ; => [ Call: sub_4ba400 ]
004C3BE7    test al, al
004C3BE9    jz 0x004C40E6
004C3BEF    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004C3BF5    test ecx, ecx
004C3BF7    jz 0x004C3A72
004C3BFD    lea eax, ss:[ebp-0x50B4]
004C3C03    add ecx, 0x75B8
004C3C09    push eax
004C3C0A    call 0x004BADC0                                 ; => [ Call: sub_4badc0 ]
...
004C3C56    call 0x004B9970                                 ; => [ Call: sub_4b9970 ]
...
004C3C7B    call 0x004B9970                                 ; => [ Call: sub_4b9970 ]
...
004C3CA0    call 0x004B9970                                 ; => [ Call: nullptr | Call: sub_4b9970 ]
...
004C3CC5    call 0x004B9970                                 ; => [ Call: sub_4b9970 ]
...
004C3CE2    call 0x004B9970                                 ; => [ Call: nullptr | Call: sub_4b9970 ]
004C3CE7    add esp, 0x08
004C3CEA    mov byte ptr ss:[ebp-0x5072], 0x01
004C3CF1    jmp 0x004C3EEE
004C3CF6    call 0x0061DAD0                                 ; => [ Call: sub_61dad0 ]
004C3CFB    mov dword ptr ss:[ebp-0x5078], eax
004C3D01    call 0x0061DAD0                                 ; => [ Call: sub_61dad0 ]
...
004C3D24    call 0x004C3970                                 ; => [ Call: sub_4c3970 ]
...
004C3D46    call 0x0061DAD0                                 ; => [ Call: sub_61dad0 ]
...
004C3D78    xor edx, edx                                    ; => [ Call: nullptr ]
...
004C3D90    xor ecx, ecx                                    ; => [ Call: nullptr ]
...
004C3E0D    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C3E8D    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C3E93    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
004C3EB0    call 0x0061DBA0                                 ; => [ Call: sub_61dba0 ]
004C3EB5    test al, al
...
004C3EC7    call 0x004B98A0                                 ; => [ Call: sub_4b98a0 ]
004C3ECC    add esp, 0x08
004C3ECF    jmp 0x004C3EEE
004C3ED1    call 0x0061DAD0
004C3ED6    lea ecx, ds:[esi+esi*2]
004C3ED9    mov dword ptr ds:[eax+ecx*4+0x18], 0x02         ; => [ Call: sub_61dad0 ]
004C3EE1    jmp 0x004C3EA4
004C3EE3    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C3EE9    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
004C3F19    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C3F5F    jz 0x004C4109                                   ; => [ Call: sub_61dad0 ]
...
004C3F75    movlpd qword ptr ss:[ebp-0x4C], xmm0            ; => [ Call: __builtin_memset ]
...
004C3FDC    push eax
004C3FDD    push 0x00
004C3FDF    call 0x005F1AE0                                 ; => [ Call: sub_5f1ae0 ]
004C3FE4    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
...
004C4017    jnz 0x004C4056                                  ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C403F    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004C4044    or dword ptr ds:[eax+0x42D4], 0x01
004C404B    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C4051    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004C4056    inc edi
004C4057    add esi, 0x22C
004C405D    cmp edi, dword ptr ds:[ebx+0x11A8]
004C4063    jl 0x004C3FB0
004C4069    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004C406E    test eax, eax
004C4070    jz 0x004C3A72
004C4076    mov eax, dword ptr ds:[eax+0x14]
004C4079    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004C40B6    call 0x00689E00                                 ; => [ Call: sub_689e00 ]
004C40BB    add esp, 0x04
004C40BE    lea eax, ss:[ebp-0x50]
004C40C1    mov edx, 0x44
004C40C6    lea ecx, ds:[esi+0x50]
004C40C9    push eax
004C40CA    call 0x00689BE0                                 ; => [ Call: sub_689be0 ]
004C40CF    add esp, 0x04
004C40D2    jmp 0x004C41BF
004C40D7    push 0x803BC8                                   ; => [ String: ActiveGameComplete_Stats ]
004C40DC    push 0x16DE
004C40E1    jmp 0x004C4390
004C40E6    push 0x803BC8                                   ; => [ String: ActiveGameComplete_Stats ]
004C40EB    push 0x16CA
004C40F0    mov ecx, 0x803BE4                               ; => [ String: retval ]
004C40F5    jmp 0x004C4395
004C40FA    push 0x803BC8                                   ; => [ String: ActiveGameComplete_Stats ]
004C40FF    push 0x1678
004C4104    jmp 0x004C4390
004C4109    call 0x0061DAD0
004C410E    mov dword ptr ss:[ebp-0x5080], eax              ; => [ Call: sub_61dad0 ]
004C4114    call 0x0061DAD0
004C4119    lea ecx, ds:[edi+edi*2]
004C411C    mov dword ptr ss:[ebp-0x5088], 0x00             ; => [ Call: nullptr ]
004C4126    lea eax, ds:[eax+ecx*4]
004C4129    add eax, 0x08
004C412C    cmp dword ptr ds:[ebx+0x11A8], 0x00
004C4133    mov dword ptr ss:[ebp-0x5078], eax              ; => [ Call: sub_61dad0 ]
...
004C419C    call 0x004B98A0                                 ; => [ Call: sub_4b98a0 ]
...
004C41D0    mov dword ptr ss:[ebp-0x5088], 0x00             ; => [ Call: nullptr ]
...
004C4202    push eax
004C4203    call 0x004C3550                                 ; => [ Call: sub_4c3550 ]
...
004C425E    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C42A2    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C42BF    cdq                                             ; => [ Call: sub_4c38b0 ]
004C42C0    mov ecx, esi
004C42C2    push edx
004C42C3    push eax
004C42C4    lea edx, ds:[edi+0x10C8E0]
004C42CA    call 0x004BAC10                                 ; => [ Call: sub_4bac10 ]
004C42CF    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C42D5    add esp, 0x08
004C42D8    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
004C4300    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 ]
...
004C431D    cdq                                             ; => [ Call: sub_4c38b0 ]
004C431E    mov ecx, esi
004C4320    push edx
004C4321    push eax
004C4322    lea edx, ds:[edi+0x10C8E0]
004C4328    call 0x004BAC10                                 ; => [ Call: sub_4bac10 ]
004C432D    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C4333    add esp, 0x08
004C4336    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
004C437B    pop esi
004C437C    pop ebx
004C437D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004C4382    mov esp, ebp
004C4384    pop ebp
004C4385    ret
004C4386    push 0x803BC8                                   ; => [ String: ActiveGameComplete_Stats ]
004C438B    push 0x1762
004C4390    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004C4395    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004C439A    mov edx, 0x801800
004C439F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004C43A4    add esp, 0x0C
004C43A7    call 0x0063BC30
004C43AC    test al, al
004C43AE    jz 0x004C43B1                                   ; => [ Call: sub_63bc30 ]
004C43B0    int3
004C43B1    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
