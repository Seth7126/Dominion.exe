...
00766D4C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00766D51    mov ecx, dword ptr ds:[edx-0x08]
00766D54    xor ecx, eax
00766D56    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00766D5B    mov eax, 0x8B2878
00766D60    jmp 0x00761FA6                                  ; => [ Data: data_8b2878 | Call: __CxxFrameHandler3 ]
