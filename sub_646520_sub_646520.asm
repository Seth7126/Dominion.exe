...
0064652A    jz 0x0064654E                                   ; => [ Data: data_cf65b8 ]
0064652C    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
00646545    setnz al                                        ; => [ Data: data_cc8ddf ]
00646548    pop ecx
00646549    ret
...
00646568    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
0064656D    add esp, 0x0C
00646570    call 0x0063BC30
00646575    test al, al
00646577    jz 0x0064657A                                   ; => [ Call: sub_63bc30 ]
00646579    int3
0064657A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
