...
00545960    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00545961    mov eax, 0x25CC
00545966    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054596B    mov eax, dword ptr ds:[0x008C4040]
00545970    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0054597C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005459A8    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_566240 | Data: data_7bfa0c ]
005459AA    call 0x00573400
005459AF    mov eax, dword ptr ds:[eax+0x04]
005459B2    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
005459D6    push 0x00
005459D8    push 0x00
005459DA    push 0x00                                       ; => [ Call: __builtin_memset ]
005459DC    push 0x01
005459DE    cmp eax, 0x02
005459E1    mov edx, 0x07
005459E6    push 0x00                                       ; => [ Call: nullptr ]
005459E8    push 0xFFFFFFFF
005459EA    setz cl
005459ED    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
005459F2    add esp, 0x2C
005459F5    lea eax, ss:[ebp-0x1950]
005459FB    mov dword ptr ss:[ebp-0x1950], 0x81B938         ; => [ Data: std::_Func_impl_no_alloc<class <lambda_f5912014766a6c1a1030741512201879>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_f5912014766a6c1a1030741512201879>,bool,enum CardID>::VTable ]
00545A05    mov dword ptr ss:[ebp-0x192C], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_f5912014766a6c1a1030741512201879>,bool,enum CardID>::VTable ]
...
00545A85    push eax
00545A86    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00545A89    mov dword ptr ss:[ebp-0x192C], 0x00
00545A93    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00545AC3    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
...
00545AEC    push 0x0B
00545AEE    call 0x005695C0                                 ; => [ Call: sub_5695c0 ]
00545AF3    inc esi
00545AF4    add esp, 0x04
00545AF7    cmp esi, edi
00545AF9    jl 0x00545AE0
00545AFB    call 0x00573400                                 ; => [ Call: sub_573400 ]
00545B00    mov edx, dword ptr ds:[eax+0x0C]
00545B03    mov ecx, dword ptr ds:[eax+0x04]
00545B06    call 0x00588340                                 ; => [ Call: sub_588340 ]
00545B0B    mov ecx, dword ptr ss:[ebp-0x0C]
00545B0E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00545B15    pop ecx
00545B16    pop edi
00545B17    pop esi
00545B18    pop ebx
...
00545B1E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
