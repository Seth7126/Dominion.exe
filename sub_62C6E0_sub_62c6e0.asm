...
0062C702    mov dword ptr fs:[0x00000000], eax
...
0062C717    mov dword ptr ds:[eax], 0x801800
0062C71D    mov esi, dword ptr ss:[ebp+0x08]
0062C720    mov edi, 0x801800
...
0062C7BE    mov dword ptr ss:[ebp-0x24], 0x801800
0062C7C5    sub eax, dword ptr ss:[ebp-0x34]
0062C7C8    push eax
0062C7C9    push ecx
0062C7CA    lea ecx, ss:[ebp-0x24]
0062C7CD    call 0x0063DB30
...
0062C904    call 0x0064C080
0062C909    mov dword ptr ss:[ebp-0x14], 0x801800
0062C910    mov byte ptr ss:[ebp-0x04], 0x09
0062C914    cmp dword ptr ds:[0x00CF65BC], 0x00
0062C91B    jz 0x0062C94B
...
0062C93F    call 0x0064C080
0062C944    mov dword ptr ss:[ebp-0x28], 0x801800
...
0062C965    jz 0x0062C989
0062C967    lea ecx, ss:[ebp-0x18]
0062C96A    call 0x0063D4E0
...
0062C97D    call 0x0064C080
0062C982    mov dword ptr ss:[ebp-0x18], 0x801800
...
0062C9A3    jz 0x0062C9C7
0062C9A5    lea ecx, ss:[ebp-0x1C]
0062C9A8    call 0x0063D4E0
...
0062C9BB    call 0x0064C080
0062C9C0    mov dword ptr ss:[ebp-0x1C], 0x801800
0062C9C7    mov byte ptr ss:[ebp-0x04], 0x0C
0062C9CB    cmp dword ptr ds:[0x00CF65BC], 0x00
0062C9D2    jz 0x0062CA02
...
0062C9F6    call 0x0064C080
0062C9FB    mov dword ptr ss:[ebp-0x2C], 0x801800
0062CA02    mov byte ptr ss:[ebp-0x04], 0x0D
0062CA06    cmp dword ptr ds:[0x00CF65BC], 0x00
0062CA0D    jz 0x0062CA3D
...
0062CA31    call 0x0064C080
0062CA36    mov dword ptr ss:[ebp-0x20], 0x801800
...
0062CA7D    call 0x0064C080
0062CA82    mov dword ptr ss:[ebp-0x24], 0x801800
...
0062CAEC    call 0x0063B870
0062CAF1    add esp, 0x0C
0062CAF4    call 0x0063BC30
0062CAF9    test al, al
0062CAFB    jz 0x0062CAFE
0062CAFD    int3
0062CAFE    call 0x0063BB00
0062CB03    push 0x871DD4
0062CB08    push 0x9A
0062CB0D    push 0x871D5C
0062CB12    mov ecx, 0x871E0C
0062CB17    jmp 0x0062CB2D
0062CB19    push 0x86D2A0
0062CB1E    push 0x106CA
0062CB23    push 0x86F1E8
0062CB28    mov ecx, 0x86D290
0062CB2D    mov edx, 0x801800
0062CB32    call 0x0063B870
0062CB37    add esp, 0x0C
0062CB3A    call 0x0063BC30
0062CB3F    test al, al
0062CB41    jz 0x0062CB44
0062CB43    int3
0062CB44    call 0x0063BB00
