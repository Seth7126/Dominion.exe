...
00565AB8    push 0x76646B                                   ; => [ Call: sub_76646b | Type: EHRegistrationNode ]
00565ABD    mov eax, dword ptr fs:[0x00000000]
00565AC3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00565AC4    push ebx
00565AC5    mov eax, 0x19B0
00565ACA    call 0x00761E50                                 ; => [ Call: __chkstk ]
00565ACF    mov eax, dword ptr ds:[0x008C4040]
00565AD4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00565AD6    mov dword ptr ss:[ebp-0x14], eax
00565AD9    push esi
00565ADA    push edi
00565ADB    push eax
00565ADC    lea eax, ss:[ebp-0x0C]
00565ADF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00565AE5    mov dword ptr ss:[ebp-0xCA8], ecx
00565AEB    mov dword ptr ss:[ebp-0xCB0], 0x04
00565AF5    mov dword ptr ss:[ebp-0xCAC], 0x00
00565AFF    call 0x00573400                                 ; => [ Call: sub_573400 ]
00565B04    lea ecx, ss:[ebp-0x19C0]
00565B0A    push 0x04
00565B0C    push ecx
00565B0D    mov edx, dword ptr ds:[eax+0x0C]
00565B10    mov ecx, dword ptr ds:[eax+0x04]
00565B13    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00565B18    mov ecx, 0x321
00565B1D    mov dword ptr ss:[ebp-0xD40], eax
00565B23    lea esi, ss:[ebp-0x19C0]
00565B29    mov dword ptr ss:[ebp-0xD08], 0x81F1BC          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_d69ccaea5a0a2bfefbfa197248291e34>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_d69ccaea5a0a2bfefbfa197248291e34>,bool,enum CardID>::VTable ]
00565B33    lea edi, ss:[ebp-0xCA0]
00565B39    add esp, 0x08
00565B3C    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00565B59    mov dword ptr ss:[ebp-0xCE4], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_d69ccaea5a0a2bfefbfa197248291e34>,bool,enum CardID>::VTable ]
...
00565BDB    push eax
00565BDC    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00565C0C    movlpd qword ptr ss:[ebp-0xCCC], xmm0           ; => [ Call: __builtin_memset ]
...
00565C78    mov esi, eax                                    ; => [ Call: sub_563c40 ]
00565C7A    add esp, 0x0C
00565C7D    test esi, esi
00565C7F    jz 0x00565CB2
00565C81    call 0x00573400                                 ; => [ Call: sub_573400 ]
00565C86    push 0x04
00565C88    push 0x00
00565C8A    push 0x00
...
00565CA9    test al, al
00565CAB    cmovz esi, ecx                                  ; => [ Call: nullptr | Call: sub_583720 | Call: nullptr ]
00565CAE    mov eax, esi
00565CB0    jmp 0x00565CB4
00565CB2    xor eax, eax                                    ; => [ Call: nullptr ]
00565CB4    mov ecx, dword ptr ss:[ebp-0x0C]
00565CB7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00565CBE    pop ecx
00565CBF    pop edi
00565CC0    pop esi
00565CC1    mov ecx, dword ptr ss:[ebp-0x14]
00565CC4    xor ecx, ebp
00565CC6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
