...
00647074    mov eax, dword ptr ds:[0x0147ABE8]
00647079    test eax, eax
0064707B    jnz 0x00647093
0064707D    push 0x871F88
00647082    push 0x45
00647084    push 0x871FA0
00647089    mov ecx, 0x871F94
...
006470A2    mov ebx, dword ptr ds:[0x01724A64]
006470A8    jnz 0x006470B0
006470AA    mov ebx, dword ptr ds:[0x01724A60]
006470B0    call 0x00643950
006470B5    mov ecx, dword ptr ss:[ebp+0x10]
006470B8    mov esi, eax
...
0064711D    mov dword ptr ds:[esi+0x14C], eax
00647123    call 0x00643B50
...
006471E2    mov eax, dword ptr ds:[0x00CF6680]
...
00647254    movups xmmword ptr ss:[ebp-0x28], xmm0
00647258    movq xmm0, qword ptr ds:[0x00CF6678]
...
006472AB    pop ebp
006472AC    ret
006472AD    push 0x880BB4
006472B2    push 0x8A
006472B7    push 0x880B94
006472BC    mov ecx, 0x880BC4
006472C1    mov edx, 0x801800
006472C6    call 0x0063B870
006472CB    add esp, 0x0C
006472CE    call 0x0063BC30
006472D3    test al, al
006472D5    jz 0x006472D8
006472D7    int3
006472D8    call 0x0063BB00
