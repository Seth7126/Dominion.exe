...
007613A6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
007613C0    mov esi, eax                                    ; => [ Call: operator new ]
007613C2    add esp, 0x04
007613C5    test esi, esi
007613C7    jz 0x0076140C
007613C9    mov ecx, esi
007613CB    call 0x0075A3F0                                 ; => [ Call: Stack<unsigned long,64>::Stack<unsigned long,64> ]
007613D0    mov ecx, esi
007613D2    call 0x0075A8B0                                 ; => [ Call: sub_75a8b0 ]
...
007613F1    movups xmmword ptr ds:[eax-0x20], xmm0          ; => [ Call: __builtin_memset ]
...
0076140C    xor esi, esi                                    ; => [ Call: nullptr ]
...
0076141F    mov dword ptr ds:[ebx+0x0C], 0x761240           ; => [ Call: sub_761240 ]
00761426    push 0x00
00761428    mov dword ptr ds:[esi+0x64], eax
0076142B    mov dword ptr ds:[esi+0x60], ebx
0076142E    call edi                                        ; => [ Call: nullptr | Type: HANDLE ]
...
0076143F    push 0x00
00761441    push 0x00
00761443    call edi                                        ; => [ Call: nullptr | Type: HANDLE ]
...
0076145E    mov word ptr ss:[ebp-0x16], ax                  ; => [ Type: WAVEFORMATEX | Field: nChannels ]
00761462    add eax, eax
00761464    mov word ptr ss:[ebp-0x0C], ax                  ; => [ Field: nBlockAlign ]
00761468    movzx eax, ax
0076146B    imul eax, ecx
0076146E    push 0x50000
00761473    push 0x00
00761475    mov dword ptr ss:[ebp-0x14], ecx                ; => [ Field: nSamplesPerSec ]
00761478    lea ecx, ss:[ebp-0x18]
0076147B    mov dword ptr ss:[ebp-0x0A], 0x10               ; => [ Field: wBitsPerSample | Field: cbSize ]
00761482    mov dword ptr ss:[ebp-0x10], eax                ; => [ Field: nAvgBytesPerSec ]
00761485    lea eax, ds:[esi+0x54]
00761488    mov word ptr ss:[ebp-0x18], dx                  ; => [ Field: wFormatTag ]
...
007614AB    push eax
007614AC    call 0x0075AC90                                 ; => [ Call: sub_75ac90 | Field: nChannels ]
...
007614C7    imul eax, dword ptr ds:[esi+0x64]               ; => [ Field: nChannels ]
007614CB    mul edx
007614CD    seto cl
007614D0    neg ecx
007614D2    or ecx, eax
...
007614E3    mov dword ptr ds:[ecx], eax                     ; => [ Call: sub_7597a2 ]
007614E5    movups xmmword ptr ds:[edi], xmm0               ; => [ Call: __builtin_memset ]
007614E8    push 0x20
...
007614F9    mov dword ptr ds:[edi+0x04], eax                ; => [ Field: nChannels ]
...
00761534    call 0x0075E950                                 ; => [ Call: sub_75e950 | Field: nChannels ]
00761539    push esi
0076153A    push 0x761310
0076153F    call 0x00761D00                                 ; => [ Call: sub_761310 | Call: sub_761d00 ]
...
0076154E    pop edi
0076154F    pop esi
00761550    mov dword ptr ds:[ebx+0x1060], 0x77EA68         ; => [ String: WinMM ]
0076155A    xor eax, eax
0076155C    pop ebx
0076155D    mov ecx, dword ptr ss:[ebp-0x04]
00761560    xor ecx, ebp
00761562    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00761567    mov esp, ebp
00761569    pop ebp
0076156A    ret
0076156B    mov ebx, dword ptr ss:[ebp-0x20]
0076156E    push ebx
0076156F    call 0x00761240                                 ; => [ Call: sub_761240 ]
...
00761582    pop esi
00761583    pop ebx
00761584    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
