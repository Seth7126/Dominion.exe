...
0068A4E1    push eax
0068A4E2    lea eax, ss:[ebp-0x0C]
0068A4E5    mov dword ptr fs:[0x00000000], eax
0068A4EB    mov esi, ecx
0068A4ED    mov ecx, dword ptr ds:[esi+0x44]
...
0068A522    call 0x00688D40
0068A527    cmp dword ptr ds:[esi+0x4C], 0x00
0068A52B    jz 0x0068A5AF
...
0068A54E    mov edi, dword ptr ds:[ecx]
0068A550    mov edx, 0x0C
0068A555    dec dword ptr ds:[esi+0x4C]
0068A558    call 0x0064C080
...
0068A5BD    push 0x877728
0068A5C2    push 0x3FD
0068A5C7    mov ecx, 0x8776A0
0068A5CC    jmp 0x0068A7DD
0068A5D1    push 0x877728
0068A5D6    push 0x3FB
0068A5DB    mov ecx, 0x8776D8
0068A5E0    jmp 0x0068A7DD
0068A5E5    mov eax, dword ptr ds:[edi]
0068A5E7    mov dword ptr ss:[ebp-0x18], 0x801800
0068A5EE    mov byte ptr ds:[ecx+eax*1], 0x00
0068A5F2    mov dword ptr ss:[ebp-0x04], 0x00
0068A5F9    mov dword ptr ss:[ebp-0x14], 0x801800
...
0068A7B5    call 0x0064C080
0068A7BA    mov ecx, dword ptr ss:[ebp-0x0C]
0068A7BD    mov dword ptr fs:[0x00000000], ecx
0068A7C4    pop ecx
0068A7C5    pop edi
0068A7C6    pop esi
