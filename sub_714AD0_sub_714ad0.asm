...
00714AD3    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00714AD8    push ebx
...
00714AED    push 0x18
00714AEF    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00714AF1    add esp, 0x0C
00714AF4    jmp 0x00714B01
00714AF6    push 0x18
00714AF8    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00714AFE    add esp, 0x04
00714B01    mov esi, eax
00714B03    test esi, esi
00714B05    jz 0x00714B12
00714B07    xorps xmm0, xmm0
00714B0A    movups xmmword ptr ds:[esi], xmm0               ; => [ Call: __builtin_memset ]
...
00714B21    push ebx
00714B22    call 0x007149A0                                 ; => [ Call: sub_7149a0 | Call: sub_714aa0 ]
00714B27    imul ebx, dword ptr ss:[ebp+0x08]
00714B2B    add esp, 0x10
00714B2E    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00714B47    push ebx
00714B48    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00714B4A    add esp, 0x0C
00714B4D    jmp 0x00714B59
00714B4F    push ebx
00714B50    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00714B60    push 0x00
00714B62    push edi
00714B63    call 0x00761FC4                                 ; => [ Call: memset ]
