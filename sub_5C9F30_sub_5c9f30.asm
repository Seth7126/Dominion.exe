...
005C9F55    mov dword ptr fs:[0x00000000], eax
005C9F5B    mov esi, dword ptr ss:[ebp+0x0C]
005C9F5E    mov dword ptr ss:[ebp-0x04], 0x00
005C9F65    mov ecx, 0x801800
005C9F6A    mov eax, dword ptr ss:[ebp+0x10]
...
005C9F80    mov ebx, eax
005C9F82    add esp, 0x08
005C9F85    mov dword ptr ss:[ebp-0x6C], ebx
...
005C9FC5    mov dword ptr ds:[esi+0x20], eax
...
005CA07D    mov dword ptr ds:[esi+0x10], eax
...
005CA167    call 0x0064C080
005CA16C    mov al, bl
005CA16E    mov ecx, dword ptr ss:[ebp-0x0C]
005CA171    mov dword ptr fs:[0x00000000], ecx
005CA178    pop ecx
005CA179    pop edi
005CA17A    pop esi
005CA17B    pop ebx
