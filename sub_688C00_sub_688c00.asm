00688C00    mov eax, dword ptr ds:[0x00CF65B8]
00688C05    mov ecx, dword ptr ds:[0x0147ABF0]
00688C0B    push esi
...
00688CA8    pop esi
00688CA9    jmp dword ptr ds:[eax+0x18]
00688CAC    mov ecx, esi
00688CAE    call 0x00688AC0
00688CB3    mov ecx, dword ptr ds:[0x0147ABF0]
