...
004E01F8    push 0x7640D6                                   ; => [ Call: __ehhandler$?release@?$source_block@V?$multi_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@V?$ordered_message_processor@I@2@@Concurrency@@UAEXHPAV?$ITarget@I@2@@Z | Type: EHRegistrationNode ]
004E01FD    mov eax, dword ptr fs:[0x00000000]
004E0203    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E0204    push ebx
...
004E0211    push eax                                        ; => [ Data: __security_cookie ]
004E0212    lea eax, ss:[ebp-0x0C]
004E0215    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E022A    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
...
004E02BF    call 0x0063D960                                 ; => [ Call: sub_63d960 | Call: sub_4e3950 ]
...
004E0317    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0328    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0351    mov ecx, 0x807488                               ; => [ Data: data_807488 ]
...
004E0365    mov byte ptr ds:[edx+ecx*1-0x01], al            ; => [ Data: data_807478 ]
004E0369    test al, al
...
004E03CB    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E03DC    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0405    mov ecx, 0x8071F4                               ; => [ String: Black Market ]
...
004E0477    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0488    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E04B1    mov ecx, 0x807478                               ; => [ Data: data_807478 ]
...
004E04C5    mov byte ptr ds:[edx+ecx*1-0x01], al            ; => [ String: rds ]
004E04C9    test al, al
...
004E0519    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E052A    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0553    mov ecx, 0x807204                               ; => [ String: Promo Pack 1 ]
...
004E05C7    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E05D8    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0601    mov ecx, 0x807478                               ; => [ Data: data_807478 ]
...
004E0615    mov byte ptr ds:[edx+ecx*1-0x01], al            ; => [ String: rds ]
004E0619    test al, al
...
004E0669    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E067A    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E06A3    mov ecx, 0x807214                               ; => [ String: Promo Pack 2 ]
...
004E0717    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0728    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0751    mov ecx, 0x807478                               ; => [ Data: data_807478 ]
...
004E0765    mov byte ptr ds:[edx+ecx*1-0x01], al            ; => [ String: rds ]
004E0769    test al, al
...
004E07B6    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E07DF    mov ecx, 0x807224                               ; => [ String: Promo Marchland ]
...
004E0836    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0847    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0870    mov ecx, 0x80748C                               ; => [ Data: data_80748c ]
...
004E0885    mov byte ptr ds:[edx+ecx*1-0x01], al            ; => [ String: %s(%d,%d) ]
004E0889    test al, al
...
004E08A8    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E08AD    mov eax, dword ptr ds:[eax]                     ; => [ String: (%d) | Call: sub_63df30 ]
004E08AF    test eax, eax
004E08B1    cmovnz ecx, eax
004E08B4    push ecx
004E08B5    mov ecx, edi
004E08B7    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E08BC    mov dword ptr ss:[ebp-0x04], 0x02
004E08C3    cmp dword ptr ds:[0x00CF65BC], 0x00
004E08CA    jz 0x004E08FA                                   ; => [ Data: data_cf65bc ]
...
004E08DB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E08EE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E08F3    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
004E0916    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E091D    pop ecx
004E091E    pop edi
004E091F    pop esi
