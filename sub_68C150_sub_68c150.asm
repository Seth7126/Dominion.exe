...
0068C168    push 0x76DFFD                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?Add@?$ListArray@VExternalStatistics@details@Concurrency@@@details@Concurrency@@QAEHPAVExternalStatistics@23@@Z ]
0068C16D    mov eax, dword ptr fs:[0x00000000]
0068C173    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0068C174    push ebx
0068C175    sub esp, 0x40
0068C178    push esi
0068C179    push edi
0068C17A    mov eax, dword ptr ds:[0x008C4040]
0068C17F    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0068C181    push eax
0068C182    lea eax, ss:[ebp-0x0C]
0068C185    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0068C18B    cmp dword ptr ds:[ecx+0x04], 0x1F
0068C18F    jnz 0x0068C6FA
0068C195    call 0x005AF880
0068C19A    mov edi, eax                                    ; => [ Call: sub_5af880 ]
...
0068C1C5    call 0x0068BD30                                 ; => [ Call: sub_68bd30 ]
0068C1CA    add esp, 0x04
0068C1CD    mov dword ptr ss:[ebp-0x04], 0x00
0068C1D4    mov dword ptr ss:[ebp-0x50], 0x801800           ; => [ Data: data_801800 ]
0068C1DB    mov dword ptr ss:[ebp-0x4C], 0x801800           ; => [ Data: data_801800 ]
0068C1E2    mov dword ptr ss:[ebp-0x48], 0x801800           ; => [ Data: data_801800 ]
0068C1E9    mov byte ptr ss:[ebp-0x04], 0x01
0068C1ED    xorps xmm0, xmm0
0068C1F0    mov eax, dword ptr ds:[0x0147ABFC]
0068C1F5    movups xmmword ptr ss:[ebp-0x44], xmm0          ; => [ String: 0 | String: zx ]
0068C1F9    mov dword ptr ss:[ebp-0x40], 0x01
0068C200    mov ecx, dword ptr ds:[eax+0x200]               ; => [ Data: data_147abfc ]
...
0068C22D    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0068C232    mov byte ptr ss:[ebp-0x04], 0x03
0068C236    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C23D    jz 0x0068C26D                                   ; => [ Data: data_cf65bc ]
...
0068C24E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C335    cmovnz ecx, eax                                 ; => [ Call: nullptr | Call: sub_68bfa0 | String: {[p\rnm ]
0068C338    mov byte ptr ss:[ebp-0x38], cl
0068C33B    push 0x00
0068C33D    mov edx, 0x877DB4
0068C342    lea ecx, ss:[ebp-0x48]
0068C345    call 0x0068BFA0                                 ; => [ Call: nullptr | Call: sub_68bfa0 | String: {[p\rnm ]
...
0068C367    call 0x0068BFA0                                 ; => [ Call: nullptr | Call: sub_68bfa0 | String: {[p\rnm ]
...
0068C389    call 0x0068BFA0                                 ; => [ Call: nullptr | Call: sub_68bfa0 | String: f ]
...
0068C3B3    test al, al
0068C3B5    jz 0x0068C3C3                                   ; => [ Call: nullptr | Call: sub_68bfa0 | String: {[p\rnm ]
...
0068C3E6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0068C3EB    inc dword ptr ds:[eax+0x04]
0068C3EE    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
0068C40D    test al, al
0068C40F    jz 0x0068C44E                                   ; => [ String: o | Call: sub_68cbb0 ]
0068C411    mov byte ptr ss:[ebp-0x04], 0x07
0068C415    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C41C    jz 0x0068C445                                   ; => [ Data: data_cf65bc ]
...
0068C42D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C440    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068C462    test al, al
0068C464    jz 0x0068C4D2                                   ; => [ String: a | Call: sub_68cbb0 ]
0068C466    mov byte ptr ss:[ebp-0x04], 0x09
0068C46A    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C471    jz 0x0068C49A                                   ; => [ Data: data_cf65bc ]
...
0068C482    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C495    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068C4AE    jz 0x0068C4CB                                   ; => [ Data: data_cf65bc ]
0068C4B0    lea ecx, ss:[ebp-0x1C]
0068C4B3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C4C6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068C4DD    jz 0x0068C506                                   ; => [ Data: data_cf65bc ]
...
0068C4EE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C501    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068C51A    jz 0x0068C537                                   ; => [ Data: data_cf65bc ]
0068C51C    lea ecx, ss:[ebp-0x1C]
0068C51F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C532    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068C55F    call 0x00693230                                 ; => [ Call: sub_693230 | Data: data_147abfc ]
...
0068C5B3    jz 0x0068C5D7                                   ; => [ Data: data_cf65bc ]
0068C5B5    lea ecx, ss:[ebp-0x14]
0068C5B8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C5CB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068C5D0    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
0068C60F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C622    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068C627    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
...
0068C64A    call 0x00693230                                 ; => [ Call: sub_693230 | Data: data_147abfc ]
...
0068C663    jz 0x0068C680                                   ; => [ Data: data_cf65bc ]
0068C665    lea ecx, ss:[ebp-0x28]
0068C668    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C67B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068C680    lea ecx, ss:[ebp-0x50]
0068C683    call 0x004E3EA0                                 ; => [ Call: sub_4e3ea0 ]
0068C688    mov dword ptr ss:[ebp-0x04], 0x10
0068C68F    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C696    jz 0x0068C6C6                                   ; => [ Data: data_cf65bc ]
...
0068C6A7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C6BA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068C6BF    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
0068C6E9    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068C6F0    pop ecx
0068C6F1    pop edi
0068C6F2    pop esi
...
0068C710    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\Localization.cpp | Data: data_801800 | String: ptr->assetType == ASSET_TYPE_TRANSLATION | String: TranslationGet ]
0068C715    add esp, 0x0C
0068C718    call 0x0063BC30
0068C71D    test al, al
0068C71F    jz 0x0068C722                                   ; => [ Call: sub_63bc30 ]
0068C721    int3
0068C722    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
