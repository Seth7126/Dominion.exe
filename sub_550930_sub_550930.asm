...
00550935    push 0x76699B                                   ; => [ Call: sub_76699b | Type: EHRegistrationNode ]
0055093A    mov eax, dword ptr fs:[0x00000000]
00550940    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00550941    mov eax, 0x19A0
00550946    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055094B    mov eax, dword ptr ds:[0x008C4040]
00550950    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0055095C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00550962    mov edi, dword ptr ss:[ebp+0x08]
00550965    mov dword ptr ds:[edi+0xC80], 0x00
0055096F    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005509C5    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
005509E3    mov dword ptr ss:[ebp-0x1964], 0x81CD10         ; => [ Data: std::_Func_impl_no_alloc<class <lambda_36b9ce5a9e60cb269e3387342efe3d6f>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_36b9ce5a9e60cb269e3387342efe3d6f>,bool,enum CardID>::VTable ]
005509ED    mov dword ptr ss:[ebp-0x1960], esi
005509F3    mov dword ptr ss:[ebp-0x1940], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_36b9ce5a9e60cb269e3387342efe3d6f>,bool,enum CardID>::VTable ]
...
00550A34    mov dword ptr ds:[edi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00550A5A    mov ebx, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00550A76    push eax
00550A77    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00550A7A    mov dword ptr ss:[ebp-0x192C], 0x00
00550A84    test ebx, ebx
00550A86    jnz 0x00550BF1                                  ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_36b9ce5a9e60cb269e3387342efe3d6f>,bool,enum CardID>::VTable ]
...
00550AB6    push 0x00
00550AB8    push 0x00
00550ABA    push 0x00                                       ; => [ Call: __builtin_memset ]
00550ABC    push ebx
...
00550AC9    setz cl
00550ACC    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
...
00550B2E    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
00550B48    mov ebx, eax                                    ; => [ Call: sub_590990 ]
...
00550B82    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00550BC0    push 0x00
00550BC2    push 0x00
00550BC4    push 0x00                                       ; => [ Call: __builtin_memset ]
00550BC6    push ecx
00550BC7    cmp eax, 0x02
00550BCA    mov edx, 0x21
00550BCF    push 0xFFFFFFFF
00550BD1    setz cl
00550BD4    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
...
00550C08    mov ecx, 0x1777938                              ; => [ Data: data_1777938 ]
00550C0D    jnz 0x00550C11
00550C0F    mov ecx, esi
00550C11    mov edx, ebx
00550C13    call 0x0063ED10                                 ; => [ Call: sub_63ed10 ]
...
00550C2E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00550CD1    mov dword ptr ss:[ebp-0x1928], eax              ; => [ Call: nullptr ]
...
00550D50    push 0x00
00550D52    push 0x00                                       ; => [ Call: nullptr ]
00550D54    push 0x00
00550D56    push 0x00
00550D58    push dword ptr ss:[ebp-0x1934]
00550D5E    push dword ptr ss:[ebp-0x1938]
00550D64    push dword ptr ss:[ebp-0x193C]
00550D6A    push 0x00                                       ; => [ Call: nullptr ]
00550D6C    push 0x3EE
00550D71    push 0x00                                       ; => [ Call: nullptr ]
00550D73    push ebx
00550D74    call 0x005822E0                                 ; => [ Call: sub_5822e0 ]
...
00550D8B    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00550E00    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
00550E1F    push 0x00
00550E21    push eax
00550E22    call 0x00761FC4                                 ; => [ Call: memset ]
...
00550E47    push 0x01
00550E49    push eax
00550E4A    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
00550E4F    add esp, 0x1C
00550E52    mov eax, edi
00550E54    mov ecx, dword ptr ss:[ebp-0x0C]
00550E57    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00550E5E    pop ecx
00550E5F    pop edi
00550E60    pop esi
00550E61    pop ebx
...
00550E67    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
