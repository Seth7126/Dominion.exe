...
006532F5    push 0x7629E0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Move@?$_Func_impl_no_alloc@P6A_NABW4agent_status@Concurrency@@@Z_NABW412@@std@@EAEPAV?$_Func_base@_NABW4agent_status@Concurrency@@@2@PAX@Z ]
006532FA    mov eax, dword ptr fs:[0x00000000]
00653300    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00653301    push ecx
00653302    push esi
00653303    push edi
00653304    mov eax, dword ptr ds:[0x008C4040]
00653309    xor eax, ebp
0065330B    push eax                                        ; => [ Data: __security_cookie ]
0065330C    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0065330F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00653315    mov edi, ecx
00653317    mov dword ptr ss:[ebp-0x04], 0x00
0065331E    cmp dword ptr ds:[0x00CF65BC], 0x00
00653325    jz 0x0065335E                                   ; => [ Data: data_cf65bc ]
...
0065333C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065334F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00653354    mov dword ptr ds:[edi+0x1E0], 0x801800          ; => [ Data: data_801800 ]
0065335E    mov dword ptr ss:[ebp-0x04], 0x01
00653365    cmp dword ptr ds:[0x00CF65BC], 0x00
0065336C    jz 0x006533A5                                   ; => [ Data: data_cf65bc ]
...
00653383    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00653396    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065339B    mov dword ptr ds:[edi+0x134], 0x801800          ; => [ Data: data_801800 ]
006533A5    mov ecx, dword ptr ss:[ebp-0x0C]
006533A8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006533AF    pop ecx
006533B0    pop edi
006533B1    pop esi
