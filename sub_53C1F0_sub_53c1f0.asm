...
0053C1FD    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053C202    push 0x00
0053C204    push 0x00
0053C206    push 0x01
...
0053C20E    push 0x02
0053C210    call 0x00590760                                 ; => [ Call: sub_590760 ]
0053C215    add esp, 0x18
0053C218    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053C23F    mov esi, dword ptr ds:[eax+0x19CC]              ; => [ Call: sub_573400 ]
0053C245    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053C258    mov eax, dword ptr ds:[eax+0x19EC]              ; => [ Call: sub_573400 ]
0053C25E    cmp eax, 0x03
0053C261    jz 0x0053C268
0053C263    cmp eax, 0x02
0053C266    jnz 0x0053C26D
0053C268    jmp 0x0056D320                                  ; => [ Call: sub_56d320 ]
0053C26D    ret
...
0053C284    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0053C289    add esp, 0x0C
0053C28C    call 0x0063BC30
0053C291    test al, al
0053C293    jz 0x0053C296                                   ; => [ Call: sub_63bc30 ]
0053C295    int3
0053C296    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
