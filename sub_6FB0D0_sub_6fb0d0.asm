...
006FB0D5    push 0x7631ED                                   ; => [ Call: __ehhandler$??2@YAPAXIABUnothrow_t@std@@@Z | Type: EHRegistrationNode ]
006FB0DA    mov eax, dword ptr fs:[0x00000000]
006FB0E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FB0EE    push eax                                        ; => [ Data: __security_cookie ]
006FB0EF    lea eax, ss:[ebp-0x0C]
006FB0F2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006FB0F8    mov edx, ecx
006FB0FA    lea ecx, ss:[ebp-0x10]
006FB0FD    call 0x006C85B0                                 ; => [ Call: sub_6c85b0 ]
...
006FB162    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006FB167    inc dword ptr ds:[eax+0x04]
006FB16A    xor edx, edx
006FB16C    mov ecx, ebx
006FB16E    call 0x0069FAF0                                 ; => [ Call: sub_69faf0 ]
...
006FB187    mov esi, eax                                    ; => [ Call: sub_69f030 ]
...
006FB1A7    jz 0x006FB1C4                                   ; => [ Data: data_cf65bc ]
006FB1A9    lea ecx, ss:[ebp-0x10]
006FB1AC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FB1BF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FB1C4    mov eax, esi
006FB1C6    mov ecx, dword ptr ss:[ebp-0x0C]
006FB1C9    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006FB1D0    pop ecx
006FB1D1    pop edi
006FB1D2    pop esi
006FB1D3    pop ebx
