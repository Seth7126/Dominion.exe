...
006B2785    push 0x76FDA1                                   ; => [ Type: EHRegistrationNode | Call: sub_76fda1 ]
006B278A    mov eax, dword ptr fs:[0x00000000]
006B2790    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006B27A2    push esi
006B27A3    push edi
006B27A4    push eax                                        ; => [ Data: __security_cookie ]
006B27A5    lea eax, ss:[ebp-0x0C]
006B27A8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006B27DB    call 0x00762210                                 ; => [ Call: __alloca_probe_16 ]
006B27E0    mov eax, esp
006B27E2    mov ebx, 0x02
006B27E7    mov dword ptr ss:[ebp-0x230], eax
006B27ED    mov dword ptr ds:[eax], 0x87C618                ; => [ String: HAVE_DX11 ]
006B27F3    mov dword ptr ds:[eax+0x04], 0x8737CC           ; => [ Data: data_8737cc ]
006B27FA    mov dword ptr ds:[eax+0x08], 0x87C648           ; => [ String: HAVE_RIFT ]
006B2801    mov dword ptr ds:[eax+0x0C], 0x8737CC           ; => [ Data: data_8737cc ]
...
006B2819    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006B281E    cmovnz ecx, eax
006B2821    mov dword ptr ds:[edi+ebx*8], ecx
006B2824    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006B28E4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006B28E9    inc dword ptr ds:[eax+0x04]
006B28EC    lea eax, ss:[ebp-0x220]
006B28F2    mov byte ptr ss:[ebp-0x04], 0x02
006B28F6    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
006B28FC    push eax
006B28FD    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006B2916    jz 0x006B2936                                   ; => [ Data: data_cf65bc ]
006B2918    lea ecx, ss:[ebp-0x220]
006B291E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B2931    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006B29C9    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
006B29CE    lea eax, ss:[ebp-0x220]
006B29D4    mov byte ptr ss:[ebp-0x04], 0x04
006B29D8    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
006B29DE    push eax
006B29DF    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
006B29E4    mov byte ptr ss:[ebp-0x04], 0x05
006B29E8    cmp dword ptr ds:[0x00CF65BC], 0x00
006B29EF    jz 0x006B2A1E                                   ; => [ Data: data_cf65bc ]
006B29F1    mov eax, dword ptr ss:[ebp-0x220]               ; => [ Type: ID3DBlob ]
...
006B2A06    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B2A19    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B2A1E    mov byte ptr ss:[ebp-0x04], 0x06
006B2A22    cmp dword ptr ds:[0x00CF65BC], 0x00
006B2A29    jz 0x006B2A62                                   ; => [ Data: data_cf65bc ]
...
006B2A40    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B2A53    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B2A58    mov dword ptr ss:[ebp-0x228], 0x801800          ; => [ Data: data_801800 ]
006B2A62    mov dword ptr ss:[ebp-0x04], 0x07
006B2A69    cmp dword ptr ds:[0x00CF65BC], 0x00
006B2A70    jz 0x006B2AA9                                   ; => [ Data: data_cf65bc ]
006B2A72    mov eax, dword ptr ss:[ebp-0x22C]               ; => [ Type: ID3DBlob ]
006B2A78    test eax, eax
006B2A7A    jz 0x006B2AA9
006B2A7C    cmp byte ptr ds:[eax], 0x00
006B2A7F    jz 0x006B2AA9                                   ; => [ Field: vtable ]
006B2A81    lea ecx, ss:[ebp-0x22C]
006B2A87    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B2A9A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B2A9F    mov dword ptr ss:[ebp-0x22C], 0x801800          ; => [ Data: data_801800 ]
006B2AA9    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006B2AB0    jmp 0x006B2B01
006B2AB2    mov ecx, edi
006B2AB4    mov ebx, 0x87C690                               ; => [ String: memory_shader ]
...
006B2AFF    mov esi, eax                                    ; => [ String: memory_shader ]
006B2B01    test esi, esi
006B2B03    jns 0x006B2B44
006B2B05    mov eax, dword ptr ss:[ebp-0x234]               ; => [ Type: ID3DBlob ]
006B2B0B    push eax
...
006B2B18    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: Dx11 compile error on %s:\n%s\n ]
006B2B1D    add esp, 0x0C
006B2B20    xor al, al
006B2B22    lea esp, ss:[ebp-0x25C]
006B2B28    mov ecx, dword ptr ss:[ebp-0x0C]
006B2B2B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B2B32    pop ecx
006B2B33    pop edi
006B2B34    pop esi
006B2B35    pop ebx
...
006B2B3B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006B2B40    mov esp, ebp
006B2B42    pop ebp
006B2B43    ret
006B2B44    mov ecx, dword ptr ss:[ebp-0x234]               ; => [ Type: ID3DBlob ]
...
006B2B5B    call 0x0063B5F0                                 ; => [ String: Dx11 compile warning on %s:\n%s\n | Call: sub_63b5f0 ]
006B2B60    mov ecx, dword ptr ss:[ebp-0x234]               ; => [ Type: ID3DBlob ]
...
006B2B73    mov eax, dword ptr ss:[ebp-0x23C]               ; => [ Type: ID3DBlob ]
006B2B79    push eax
006B2B7A    mov ecx, dword ptr ds:[eax]
006B2B7C    call dword ptr ds:[ecx+0x0C]
006B2B7F    mov ecx, dword ptr ss:[ebp-0x23C]               ; => [ Type: ID3DBlob ]
...
006B2B99    call 0x00687730                                 ; => [ Call: sub_687730 ]
006B2B9E    mov ecx, dword ptr ss:[ebp-0x248]
006B2BA4    push esi
006B2BA5    push edi
006B2BA6    push eax
006B2BA7    mov dword ptr ds:[ecx], eax
006B2BA9    call 0x00761FBE                                 ; => [ Call: memcpy ]
006B2BAE    add esp, 0x0C
006B2BB1    mov al, 0x01
006B2BB3    jmp 0x006B2B22
006B2BB8    push 0x87C654                                   ; => [ String: Dx11CompileShader ]
006B2BBD    push 0xA44
006B2BC2    push 0x87B990
006B2BC7    mov edx, 0x801800
006B2BCC    mov ecx, 0x801AA4
006B2BD1    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: Halt ]
006B2BD6    add esp, 0x0C
006B2BD9    call 0x0063BC30
006B2BDE    test al, al
006B2BE0    jz 0x006B2BE3                                   ; => [ Call: sub_63bc30 ]
006B2BE2    int3
006B2BE3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006B2BE8    call 0x007598E1                                 ; => [ Call: ___report_rangecheckfailure ]
