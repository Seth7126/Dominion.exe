...
0053DA80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053DA81    sub esp, 0x98
0053DA87    mov eax, dword ptr ds:[0x008C4040]
0053DA8C    xor eax, ebp
0053DA8E    mov dword ptr ss:[ebp-0x10], eax
0053DA91    push eax                                        ; => [ Data: __security_cookie ]
0053DA92    lea eax, ss:[ebp-0x0C]
0053DA95    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053DA9B    call 0x0056D1F0                                 ; => [ Call: sub_56d1f0 ]
0053DAA0    mov ecx, 0x100
0053DAA5    call 0x00563590                                 ; => [ Call: sub_563590 ]
0053DAAA    test eax, eax
0053DAAC    jz 0x0053DBD7
0053DAB2    xorps xmm0, xmm0
0053DAB5    mov dword ptr ss:[ebp-0x40], 0xCB               ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_e2eabc5e9a9b3277b862cbe0e27fc293>, void>::VTable ]
0053DABC    movlpd qword ptr ss:[ebp-0x18], xmm0
0053DAC1    lea eax, ss:[ebp-0x74]
0053DAC4    movlpd qword ptr ss:[ebp-0x20], xmm0
0053DAC9    movlpd qword ptr ss:[ebp-0x3C], xmm0            ; => [ Call: __builtin_memset ]
...
0053DAFD    mov dword ptr ss:[ebp-0x4C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_77c7a96fa0c127cf6c7a85bf3ec39f30>, void>::VTable ]
0053DB00    lea eax, ss:[ebp-0x40]
0053DB03    mov dword ptr ss:[ebp-0x74], 0x00
0053DB0A    movups xmmword ptr ss:[ebp-0x94], xmm0
0053DB11    mov dword ptr ss:[ebp-0x70], 0x81AE9C           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_77c7a96fa0c127cf6c7a85bf3ec39f30>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
0053DB31    mov dword ptr ss:[ebp-0x40], 0x81AE80           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_e2eabc5e9a9b3277b862cbe0e27fc293>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
0053DB68    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
0053DB81    push 0x30
0053DB83    push eax
0053DB84    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
0053DB89    cmp dword ptr ss:[ebp-0x74], 0x00
0053DB8D    jz 0x0053DBD7
0053DB8F    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053DB94    push 0x00
0053DB96    push 0x00
0053DB98    push 0x01
...
0053DBA0    push 0x02
0053DBA2    call 0x00590760                                 ; => [ Call: sub_590760 ]
0053DBA7    add esp, 0x10
0053DBAA    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053DBCF    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
0053DBD4    add esp, 0x04
0053DBD7    mov ecx, dword ptr ss:[ebp-0x0C]
0053DBDA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053DBE1    pop ecx
0053DBE2    mov ecx, dword ptr ss:[ebp-0x10]
0053DBE5    xor ecx, ebp
0053DBE7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0053DC06    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0053DC0B    add esp, 0x0C
0053DC0E    call 0x0063BC30
0053DC13    test al, al
0053DC15    jz 0x0053DC18                                   ; => [ Call: sub_63bc30 ]
0053DC17    int3
0053DC18    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
