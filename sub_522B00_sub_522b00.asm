...
00522BDF    mov dword ptr ss:[ebp-0x20], eax
...
00522C06    movlpd qword ptr ss:[ebp-0xCD4], xmm0
...
00522D6A    mov dword ptr ss:[ebp-0x20], eax
...
00522D81    push eax
00522D82    call dword ptr ds:[edx+0x10]
00522D85    xorps xmm0, xmm0
00522D88    mov dword ptr ss:[ebp-0xCCC], 0x00
00522D92    movlpd qword ptr ss:[ebp-0xCD4], xmm0
