...
00693055    push 0x76DB00                                   ; => [ Call: __ehhandler$??0VirtualProcessorRoot@details@Concurrency@@QAE@PAVSchedulerProxy@12@PAUSchedulerNode@12@I@Z | Type: EHRegistrationNode ]
0069305A    mov eax, dword ptr fs:[0x00000000]
00693060    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00693061    sub esp, 0x08
00693064    push esi
00693065    mov eax, dword ptr ds:[0x008C4040]
0069306A    xor eax, ebp
0069306C    push eax                                        ; => [ Data: __security_cookie ]
0069306D    lea eax, ss:[ebp-0x0C]
00693070    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0069308A    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0069308F    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_691e10 ]
...
006930A4    jz 0x006930CD                                   ; => [ Data: data_cf65bc ]
...
006930B5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006930C8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006930CD    mov eax, esi
006930CF    mov ecx, dword ptr ss:[ebp-0x0C]
006930D2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006930D9    pop ecx
006930DA    pop esi
...
006930E1    mov eax, 0x801800                               ; => [ Data: data_801800 ]
006930E6    test ecx, ecx
006930E8    cmovnz eax, ecx
006930EB    mov ecx, dword ptr ss:[ebp-0x0C]
006930EE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006930F5    pop ecx
006930F6    pop esi
