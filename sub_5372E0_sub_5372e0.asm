...
005373EB    mov dword ptr ss:[ebp-0xCE4], ecx
...
0053746D    push eax
0053746E    call dword ptr ds:[edx+0x10]
...
00537511    call 0x00563C40
00537516    mov esi, eax
00537518    call 0x00573400
