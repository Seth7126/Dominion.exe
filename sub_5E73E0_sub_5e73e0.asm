...
005E73F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005E73FE    push eax                                        ; => [ Data: __security_cookie ]
005E73FF    lea eax, ss:[ebp-0x0C]
005E7402    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005E741D    call 0x0063D720                                 ; => [ String: btn_settings | Call: sub_63d720 ]
005E7422    mov eax, dword ptr ss:[ebp-0x14]
005E7425    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E746C    jz 0x005E7490                                   ; => [ Data: data_cf65bc ]
005E746E    lea ecx, ss:[ebp-0x14]
005E7471    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E7484    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E7489    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E74A4    setz byte ptr ds:[0x00B7D418]                   ; => [ Data: data_b7d418 ]
005E74AB    mov ecx, dword ptr ss:[ebp-0x0C]
005E74AE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E74B5    pop ecx
005E74B6    pop edi
005E74B7    pop esi
005E74B8    pop ebx
...
005E74C5    call 0x0063D720                                 ; => [ String: btnItem | Call: sub_63d720 ]
005E74CA    mov eax, dword ptr ss:[ebp-0x14]
005E74CD    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E751C    jz 0x005E7540                                   ; => [ Data: data_cf65bc ]
005E751E    lea ecx, ss:[ebp-0x14]
005E7521    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E7534    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E7539    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E7551    call 0x005E3EC0                                 ; => [ Call: sub_5e3ec0 ]
005E7556    mov al, 0x01
005E7558    mov ecx, dword ptr ss:[ebp-0x0C]
005E755B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E7562    pop ecx
005E7563    pop edi
005E7564    pop esi
005E7565    pop ebx
...
005E7572    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_apply_allgames ]
005E7577    mov eax, dword ptr ss:[ebp-0x14]
005E757A    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E75C3    jz 0x005E75E7                                   ; => [ Data: data_cf65bc ]
005E75C5    lea ecx, ss:[ebp-0x14]
005E75C8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E75DB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E75E0    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
005E75E7    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005E75EE    test esi, esi
005E75F0    jnz 0x005E7645
005E75F2    lea ecx, ds:[esi+0x01]
005E75F5    call 0x005E3C60                                 ; => [ Call: sub_5e3c60 ]
005E75FA    lea ecx, ds:[esi+0x07]
005E75FD    mov edi, eax
005E75FF    call 0x0061CEE0                                 ; => [ Call: sub_61cee0 ]
...
005E7629    call 0x005E3E50                                 ; => [ Call: sub_5e3e50 ]
005E762E    add esp, 0x04
005E7631    mov al, 0x01
005E7633    mov ecx, dword ptr ss:[ebp-0x0C]
005E7636    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E763D    pop ecx
005E763E    pop edi
005E763F    pop esi
005E7640    pop ebx
...
005E7650    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_icon ]
005E7655    mov dword ptr ss:[ebp-0x04], 0x03
005E765C    mov ebx, 0x01
005E7661    mov esi, dword ptr ss:[ebp-0x18]
005E7664    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
005E76AC    call 0x0063D720                                 ; => [ String: btn_bg | Call: sub_63d720 ]
005E76B1    mov eax, dword ptr ss:[ebp-0x14]
005E76B4    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E7723    jz 0x005E7747                                   ; => [ Data: data_cf65bc ]
005E7725    lea ecx, ss:[ebp-0x14]
005E7728    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E773B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E7740    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E7765    jz 0x005E7789                                   ; => [ Data: data_cf65bc ]
005E7767    lea ecx, ss:[ebp-0x18]
005E776A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E777D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E7782    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
005E779C    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
...
005E77CE    call 0x005CE8B0                                 ; => [ Call: sub_5ce8b0 ]
005E77D3    xor al, al
005E77D5    mov ecx, dword ptr ss:[ebp-0x0C]
005E77D8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E77DF    pop ecx
005E77E0    pop edi
005E77E1    pop esi
005E77E2    pop ebx
...
005E7800    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: gfx.type == DOMGFX_PILE | String: PodClick ]
005E7805    add esp, 0x0C
005E7808    call 0x0063BC30
005E780D    test al, al
005E780F    jz 0x005E7812                                   ; => [ Call: sub_63bc30 ]
005E7811    int3
005E7812    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
