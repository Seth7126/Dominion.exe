...
0052035C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00520361    xor eax, esp
00520363    mov dword ptr ss:[esp+0xCA0], eax
0052036A    push ebx
0052036B    push esi
0052036C    push edi
0052036D    call 0x00573400                                 ; => [ Call: sub_573400 ]
00520372    push 0x00
00520374    push 0x00
00520376    push 0x02
...
0052037E    push 0x01
00520380    call 0x00590760                                 ; => [ Call: sub_590760 ]
00520385    add esp, 0x10
00520388    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00520406    test al, al
00520408    jnz 0x00520521                                  ; => [ Call: sub_5754f0 ]
0052040E    call 0x00573400                                 ; => [ Call: sub_573400 ]
00520413    mov ebx, dword ptr ds:[eax+0x04]
00520416    cmp edi, 0x320
0052041C    jb 0x00520423
0052041E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00520473    mov esi, eax                                    ; => [ Call: sub_566920 ]
...
0052048F    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
005204C7    setz cl
005204CA    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
005204CF    add esp, 0x2C
005204D2    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00520504    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
...
00520518    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0052051D    mov esp, ebp
0052051F    pop ebp
00520520    ret
00520521    call 0x00573400
00520526    mov eax, dword ptr ds:[eax+0x04]
00520529    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
00520561    setz cl
00520564    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
...
0052057A    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
0052057E    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00520594    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005205CD    push 0x3EE
005205D2    push esi
005205D3    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
...
005205F6    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
005205FB    add esp, 0x0C
005205FE    call 0x0063BC30
00520603    test al, al
00520605    jz 0x00520608                                   ; => [ Call: sub_63bc30 ]
00520607    int3
00520608    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
