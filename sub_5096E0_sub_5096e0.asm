...
00509735    call 0x0063B870
0050973A    add esp, 0x0C
0050973D    call 0x0063BC30
00509742    test al, al
00509744    jz 0x00509747
00509746    int3
00509747    call 0x0063BB00
