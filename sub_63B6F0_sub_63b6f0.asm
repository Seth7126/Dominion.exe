...
0063B6F9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0063B715    call 0x0063BC40                                 ; => [ Call: Mod1::CheckFCreateWriter ]
...
0063B742    push esi
0063B743    mov esi, dword ptr ds:[0x00CF64AC]              ; => [ Data: data_cf64ac | Type: FILE ]
0063B749    test esi, esi
0063B74B    jnz 0x0063B78A
0063B74D    mov ecx, 0xCF64B0
0063B752    call 0x0069DB50                                 ; => [ Data: data_cf64b0 | Call: sub_69db50 ]
0063B757    push 0x871B58
0063B75C    push 0xCF64B0
0063B761    call dword ptr ds:[0x0077564C]
0063B767    mov esi, eax                                    ; => [ String: a | Data: data_cf64b0 ]
0063B769    add esp, 0x08
0063B76C    test esi, esi
0063B76E    jnz 0x0063B78A
0063B770    push 0x871B3C
0063B775    call dword ptr ds:[0x007750A8]                  ; => [ String: Failed to open log file\n ]
0063B77B    pop esi
0063B77C    mov ecx, dword ptr ss:[ebp-0x04]
0063B77F    xor ecx, ebp
0063B781    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0063B786    mov esp, ebp
0063B788    pop ebp
0063B789    ret
0063B78A    lea ecx, ss:[ebp-0x404]
0063B790    mov dword ptr ds:[0x00CF64AC], esi              ; => [ Data: data_cf64ac ]
...
0063B7C7    call dword ptr ds:[0x007750A8]                  ; => [ String: Failed to write to log file\n ]
0063B7CD    push esi
...
0063B7DC    pop esi
0063B7DD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
