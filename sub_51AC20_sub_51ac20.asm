...
0051AC26    mov edx, dword ptr ds:[0x00CCE9A8]              ; => [ Data: data_cce9a8 ]
...
0051AC39    push esi
0051AC3A    push edi
0051AC3B    mov esi, 0xCCE738                               ; => [ Data: data_cce738 ]
...
0051AC4D    mov edi, dword ptr ds:[0x00CCE9AC]              ; => [ Data: data_cce9ac ]
0051AC53    mov ebx, dword ptr ds:[0x00CCA790]              ; => [ Data: data_cca790 ]
0051AC59    mov dword ptr ds:[0x00CCE9AC], eax              ; => [ Data: data_cce9ac ]
0051AC5E    mov eax, dword ptr ds:[esi-0x08]
0051AC61    mov dword ptr ds:[0x00CCA790], eax              ; => [ Data: data_cca790 ]
0051AC66    mov eax, dword ptr ds:[esi-0x10]
0051AC69    call eax
0051AC6B    mov eax, dword ptr ss:[ebp-0x04]
0051AC6E    mov ecx, dword ptr ss:[ebp-0x08]
0051AC71    mov dword ptr ds:[0x00CCE9AC], edi              ; => [ Data: data_cce9ac ]
0051AC77    mov dword ptr ds:[0x00CCA790], ebx              ; => [ Data: data_cca790 ]
0051AC7D    mov byte ptr ds:[esi-0x04], 0x01
0051AC81    mov edx, dword ptr ds:[0x00CCE9A8]              ; => [ Data: data_cce9a8 ]
0051AC87    inc eax
