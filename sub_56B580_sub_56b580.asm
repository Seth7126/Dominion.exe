...
0056B58C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0056B5AD    add eax, 0x1594                                 ; => [ Call: sub_573400 ]
...
0056B5CF    nop
0056B5D0    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056B5F6    jnz 0x0056B608                                  ; => [ Call: sub_571b30 ]
...
0056B630    mov dword ptr ss:[esp+0x20], 0x00               ; => [ Call: __builtin_memset ]
...
0056B666    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056B6B9    call 0x00623B70                                 ; => [ Call: sub_623b70 ]
...
0056B6D7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0056B6ED    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
