...
004D4B75    push 0x7637A5                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Push@_Micro_queue@details@Concurrency@@QAEXPAXIAAV_Concurrent_queue_base_v4@23@P8423@AEXAAU_Page@423@I0@Z@Z ]
004D4B7A    mov eax, dword ptr fs:[0x00000000]
004D4B80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D4B81    sub esp, 0x54
004D4B84    push ebx
004D4B85    push esi
004D4B86    push edi
004D4B87    mov eax, dword ptr ds:[0x008C4040]
004D4B8C    xor eax, ebp                                    ; => [ Data: __security_cookie ]
004D4B8E    push eax
004D4B8F    lea eax, ss:[ebp-0x0C]
004D4B92    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D4BC2    call 0x004D51F0                                 ; => [ Call: sub_4d51f0 ]
...
004D4C23    call 0x004D5020                                 ; => [ Call: sub_4d5020 ]
004D4C28    add esp, 0x04
004D4C2B    mov ecx, dword ptr ss:[ebp-0x0C]
004D4C2E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D4C35    pop ecx
004D4C36    pop edi
004D4C37    pop esi
004D4C38    pop ebx
...
004D4C84    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4CDF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4CF2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004D4D4D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4D84    push eax
004D4D85    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
004D4DDD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4DF0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004D4E13    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D4E1A    pop ecx
004D4E1B    pop edi
004D4E1C    pop esi
004D4E1D    pop ebx
