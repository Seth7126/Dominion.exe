...
006336C3    add esi, 0xB6521C                               ; => [ Data: data_b6521c ]
006336C9    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
006336E2    mov ecx, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
00633706    mov eax, dword ptr ds:[0x00B80B48]              ; => [ Data: data_b80b48 ]
0063370B    cmp eax, edx
0063370D    jnz 0x0063383F
00633713    cmp eax, dword ptr ds:[0x00B80B44]
00633719    jz 0x0063383F                                   ; => [ Data: data_b80b44 ]
...
00633735    jnz 0x0063383F                                  ; => [ Data: data_b80b44 | Data: data_b824dc ]
...
00633759    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
0063378A    call 0x00761FC4                                 ; => [ Call: memset ]
...
00633827    call 0x005CD0A0                                 ; => [ Call: sub_5cb630 | Call: sub_5cd0a0 ]
...
0063384E    jnb 0x00633880                                  ; => [ Data: data_b809e4 ]
00633850    imul eax, eax, 0x1C30
00633856    add eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
...
006338C7    call 0x005CF960                                 ; => [ Call: sub_5cf960 ]
...
006338ED    push 0x77EB90                                   ; => [ String: GetClient ]
006338F2    push 0x7B
006338F4    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
006338F9    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
006338FE    jmp 0x006339A3
00633903    push 0x86F4F8                                   ; => [ String: PGUIGet ]
00633908    push 0xA87
0063390D    mov ecx, 0x86F500                               ; => [ String: (int)who < (int)MAX_PLAYERS_DOM ]
00633912    jmp 0x0063399E
00633917    push 0x86F4F8                                   ; => [ String: PGUIGet ]
0063391C    push 0xA86
00633921    mov ecx, 0x805B34                               ; => [ String: who >= 0 ]
00633926    jmp 0x0063399E
00633928    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
00633946    call 0x00632520                                 ; => [ Call: sub_632520 ]
...
00633964    call 0x006333F0                                 ; => [ Call: sub_6333f0 ]
...
00633982    pop esi
00633983    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00633988    mov esp, ebp
0063398A    pop ebp
0063398B    mov esp, ebx
0063398D    pop ebx
0063398E    ret
0063398F    push 0x86DD04                                   ; => [ String: UpdatePods ]
00633994    push 0x11090
00633999    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0063399E    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
006339A3    mov edx, 0x801800
006339A8    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006339AD    add esp, 0x0C
006339B0    call 0x0063BC30
006339B5    test al, al
006339B7    jz 0x006339BA                                   ; => [ Call: sub_63bc30 ]
006339B9    int3
006339BA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
