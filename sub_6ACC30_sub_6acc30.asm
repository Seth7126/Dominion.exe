...
006ACC35    push 0x76D2F0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??1_Cancellation_beacon@details@Concurrency@@QAE@XZ ]
006ACC3A    mov eax, dword ptr fs:[0x00000000]
006ACC40    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006ACC41    push esi
006ACC42    push edi
006ACC43    mov eax, dword ptr ds:[0x008C4040]
006ACC48    xor eax, ebp
006ACC4A    push eax                                        ; => [ Data: __security_cookie ]
006ACC4B    lea eax, ss:[ebp-0x0C]
006ACC4E    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006ACC54    mov esi, 0x1476B4C                              ; => [ Data: data_1476b4c ]
...
006ACC6F    call dword ptr ds:[eax+0x30]                    ; => [ Data: data_147b070 ]
006ACC72    mov dword ptr ds:[esi], 0x00
006ACC78    add esi, 0x04
006ACC7B    cmp esi, 0x1476B8C
006ACC81    jl 0x006ACC60                                   ; => [ Data: data_1476b8c ]
006ACC83    mov edx, dword ptr ds:[0x01476B48]              ; => [ Data: data_1476b48 ]
006ACC89    test edx, edx
006ACC8B    jz 0x006ACCA3
006ACC8D    mov ecx, dword ptr ds:[0x0147B070]
006ACC93    push edx
006ACC94    mov eax, dword ptr ds:[ecx]
006ACC96    call dword ptr ds:[eax+0x3C]                    ; => [ Data: data_147b070 ]
006ACC99    mov dword ptr ds:[0x01476B48], 0x00             ; => [ Data: data_1476b48 ]
006ACCA3    xor esi, esi                                    ; => [ Call: nullptr ]
006ACCA5    mov ecx, dword ptr ds:[0x00CAFE8C]              ; => [ Data: data_cafe8c ]
...
006ACCC8    add eax, ecx                                    ; => [ Data: data_cafe90 ]
...
006ACCEE    xor edx, edx                                    ; => [ Call: nullptr ]
...
006ACD14    call dword ptr ds:[eax+0x54]                    ; => [ Data: data_147b070 ]
...
006ACD69    add eax, ecx                                    ; => [ Data: data_cafe90 ]
...
006ACD8C    mov dword ptr ds:[0x00CAFE90], 0x00             ; => [ Data: data_cafe90 ]
006ACD96    mov dword ptr ds:[0x00CAFE98], 0x00             ; => [ Data: data_cafe98 ]
006ACDA0    test ecx, ecx
006ACDA2    jz 0x006ACDAE
006ACDA4    push ecx
006ACDA5    call dword ptr ds:[0x00775524]
006ACDAB    add esp, 0x04
006ACDAE    mov dword ptr ds:[0x00CAFE8C], 0x00             ; => [ Data: data_cafe8c | Call: __builtin_memset ]
...
006ACDE0    mov dword ptr ds:[0x00CAFEA4], 0x00             ; => [ Data: data_cafea4 ]
006ACDEA    mov ecx, dword ptr ds:[0x0147D2DC]              ; => [ Data: data_147d2dc ]
006ACDF0    test ecx, ecx
006ACDF2    jz 0x006ACE08
006ACDF4    mov edx, 0x01
006ACDF9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ACDFE    mov dword ptr ds:[0x0147D2DC], 0x00             ; => [ Data: data_147d2dc ]
006ACE08    call 0x00681A70                                 ; => [ Call: sub_681a70 ]
006ACE0D    mov ecx, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
006ACE13    xor esi, esi                                    ; => [ Call: nullptr ]
...
006ACE25    call dword ptr ds:[eax+0x30]                    ; => [ Data: data_147b070 ]
006ACE28    mov ecx, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
...
006ACE46    call dword ptr ds:[eax+0x3C]                    ; => [ Data: data_147b070 ]
006ACE49    mov ecx, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
...
006ACE6D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ACE72    test esi, esi
006ACE74    jnz 0x006ACE63
006ACE76    mov ecx, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
...
006ACE9C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ACEA1    mov dword ptr ds:[0x0147ABE4], 0x00             ; => [ Data: data_147abe4 ]
006ACEAB    mov ecx, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
006ACEB1    test ecx, ecx
006ACEB3    jz 0x006ACEC9
006ACEB5    mov edx, 0x2E0
006ACEBA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ACEBF    mov dword ptr ds:[0x0147B06C], 0x00             ; => [ Data: data_147b06c ]
006ACEC9    mov ecx, dword ptr ss:[ebp-0x0C]
006ACECC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006ACED3    pop ecx
006ACED4    pop edi
006ACED5    pop esi
...
006ACED8    pop ebp
006ACED9    ret
006ACEDA    mov ecx, dword ptr ds:[0x00CAFE98]              ; => [ Data: data_cafe98 ]
006ACEE0    movzx eax, si
006ACEE3    mov dword ptr ds:[0x00CAFE98], eax              ; => [ Data: data_cafe98 ]
006ACEE8    mov dword ptr ds:[edx+0xF0C], ecx
006ACEEE    dec dword ptr ds:[0x00CAFE9C]                   ; => [ Data: data_cafe9c ]
006ACEF4    mov ecx, dword ptr ds:[0x00CAFE8C]              ; => [ Data: data_cafe8c ]
