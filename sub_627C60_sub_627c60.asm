...
00627C65    push 0x76B965                                   ; => [ Call: __ehhandler$??$parse_floating_point_possible_nan@DV?$input_adapter_character_source@V?$string_input_adapter@D@__crt_stdio_input@@@__crt_strtox@@_K@__crt_strtox@@YA?AW4floating_point_parse_result@0@AADAAV?$input_adapter_character_source@V?$string_input_adapter@D@__crt_stdio_input@@@0@_K@Z | Type: EHRegistrationNode ]
00627C6A    mov eax, dword ptr fs:[0x00000000]
00627C70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00627C7E    push eax                                        ; => [ Data: __security_cookie ]
00627C7F    lea eax, ss:[ebp-0x0C]
00627C82    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00627C88    mov ebx, dword ptr ss:[ebp+0x08]
00627C8B    mov ecx, ebx
00627C8D    call 0x0064E7A0
00627C92    mov dword ptr ds:[eax+0x18BC], 0x6250F0         ; => [ Call: sub_64e7a0 | Call: sub_6250f0 ]
00627C9C    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
00627CA1    test eax, eax
00627CA3    jnz 0x00627CBB
00627CA5    push 0x77EB90                                   ; => [ String: GetClient ]
00627CAA    byte 6A
00627CAB    byte 7B
00627CAC    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
00627CB1    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
00627CB6    byte E9
...
00627CC8    mov esi, dword ptr ds:[0x00CF6494]              ; => [ Data: data_cf6494 ]
00627CCE    call 0x004B9480
00627CD3    mov edx, esi
00627CD5    lea edi, ds:[eax+0x08]                          ; => [ Call: sub_4b9480 ]
00627CD8    mov ecx, edi
00627CDA    call 0x004B9680                                 ; => [ Call: sub_4b9680 ]
00627CDF    lea ecx, ss:[ebp-0x18]
00627CE2    mov edx, edi
00627CE4    push ecx
00627CE5    push eax
00627CE6    lea ecx, ss:[ebp-0x10]
00627CE9    call 0x004B06C0                                 ; => [ Call: sub_4b06c0 ]
...
00627D29    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00627D3C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00627D41    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00627D48    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00627D4F    imul eax, dword ptr ds:[0x00CF6494], 0x5DD4
00627D59    push dword ptr ds:[eax+0xCD3198]                ; => [ Data: data_cf6494 ]
00627D5F    lea eax, ss:[ebp-0x14]
00627D62    push 0x808880
00627D67    push eax
00627D68    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
00627DA8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00627DBB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00627DC0    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
00627DC7    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00627DCE    mov eax, dword ptr ds:[0x00CF6490]              ; => [ Data: data_cf6490 ]
00627DD3    sub eax, 0x00
00627DD6    jz 0x00627E1B
00627DD8    sub eax, 0x01
00627DDB    jnz 0x00627E68
00627DE1    mov ecx, ebx
00627DE3    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00627DE8    movss xmm3, dword ptr ds:[0x00890E18]
00627DF0    mov edx, 0xBF10D8
00627DF5    push 0x00
00627DF7    push 0xFFFFFFFF
00627DF9    mov ecx, eax
00627DFB    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf10d8 ]
00627E00    mov edx, dword ptr ds:[0x00CF6494]              ; => [ Data: data_cf6494 ]
00627E06    mov ecx, ebx
00627E08    imul eax, edx, 0x5DD4
00627E0E    add eax, 0xCD3198
00627E13    push eax
00627E14    call 0x00626D10                                 ; => [ Call: sub_626d10 ]
00627E19    jmp 0x00627E53
00627E1B    mov ecx, ebx
00627E1D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00627E22    movss xmm3, dword ptr ds:[0x00890E18]
00627E2A    mov edx, 0xBF10CC
00627E2F    push 0x00
00627E31    push 0xFFFFFFFF
00627E33    mov ecx, eax
00627E35    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf10cc ]
00627E3A    mov edx, dword ptr ds:[0x00CF6494]              ; => [ Data: data_cf6494 ]
00627E40    mov ecx, ebx
00627E42    imul eax, edx, 0x5DD4
00627E48    add eax, 0xCD3198
00627E4D    push eax
00627E4E    call 0x006261F0                                 ; => [ Call: sub_6261f0 ]
00627E53    add esp, 0x0C
00627E56    mov ecx, dword ptr ss:[ebp-0x0C]
00627E59    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
00627E60    pop ecx
00627E61    pop edi
00627E62    pop esi
00627E63    pop ebx
...
00627E66    pop ebp
00627E67    ret
00627E68    push 0x86BA84                                   ; => [ String: ScorescreenCardsUpdate ]
00627E6D    push 0xF20D
00627E72    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00627E77    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00627E7C    mov edx, 0x801800
00627E81    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00627E86    add esp, 0x0C
00627E89    call 0x0063BC30
00627E8E    test al, al
00627E90    jz 0x00627E93                                   ; => [ Call: sub_63bc30 ]
00627E92    int3
00627E93    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
