...
0052C0C0    dword 4733BE8                                   ; => [ Call: sub_573400 ]
...
0052C0D1    push 0x01
0052C0D3    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052C0D8    add esp, 0x10
0052C0DB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052C0F9    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052C0FE    push 0x00
0052C100    push 0x00
0052C102    push 0x01
...
0052C10A    push 0x02
0052C10C    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052C111    add esp, 0x10
0052C114    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052C137    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052C13C    add esp, 0x0C
0052C13F    call 0x0063BC30
0052C144    test al, al
0052C146    jz 0x0052C149                                   ; => [ Call: sub_63bc30 ]
0052C148    int3
0052C149    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
