...
00522F9B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00522FA0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00522FD6    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_5685f0 ]
00522FD8    xor edx, edx
00522FDA    lea ecx, ss:[esp+0xC90]
00522FE1    call 0x00561A00                                 ; => [ Call: nullptr | Call: sub_561a00 ]
00522FE6    push ecx
00522FE7    mov ecx, dword ptr ss:[esp+0x1914]
00522FEE    xor edx, edx
00522FF0    push 0x00
00522FF2    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
00522FF7    mov ecx, dword ptr ss:[esp+0x1924]
00522FFE    add esp, 0x08
00523001    pop edi
00523002    pop esi
00523003    xor ecx, esp
00523005    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
