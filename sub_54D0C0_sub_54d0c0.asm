...
0054D0CB    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054D0D0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0054D0ED    push 0x20
0054D0EF    push eax
0054D0F0    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
...
0054D10D    movlpd qword ptr ss:[esp+0x34], xmm0            ; => [ Call: __builtin_memset ]
...
0054D164    push 0x01
0054D166    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0054D19D    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
...
0054D1B4    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054D1D2    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0054D210    push eax
0054D211    call 0x00586320                                 ; => [ Call: sub_586320 ]
0054D216    add esp, 0x10
0054D219    mov ecx, 0x102
0054D21E    call 0x00563590                                 ; => [ Call: sub_563590 ]
0054D223    mov esi, eax
0054D225    test esi, esi
0054D227    jz 0x0054D24F
0054D229    call 0x00573400                                 ; => [ Call: sub_573400 ]
0054D22E    push 0x04
0054D230    push 0x00
0054D232    push 0x00
...
0054D241    push 0x476
0054D246    push esi
0054D247    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0054D24C    add esp, 0x1C
0054D24F    push 0x00
0054D251    push 0x04
0054D253    mov edx, 0x3EB
0054D258    mov ecx, 0x11A
0054D25D    call 0x005636E0                                 ; => [ Call: sub_5636e0 ]
0054D262    add esp, 0x08
0054D265    mov ecx, 0x476
0054D26A    call 0x00547860                                 ; => [ Call: sub_547860 ]
0054D26F    mov esi, eax
0054D271    test esi, esi
0054D273    jz 0x0054D2E5
0054D275    mov ecx, esi
0054D277    call 0x0056F260                                 ; => [ Call: sub_56f260 ]
0054D27C    test al, al
0054D27E    jz 0x0054D2E5
0054D280    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054D29E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0054D2B9    movlpd qword ptr ss:[esp+0x1C], xmm0            ; => [ Call: __builtin_memset ]
...
0054D2DC    push eax
0054D2DD    call 0x00586320                                 ; => [ Call: sub_586320 ]
0054D2E2    add esp, 0x10
0054D2E5    mov ecx, dword ptr ss:[esp+0x19AC]
0054D2EC    pop edi
0054D2ED    pop esi
0054D2EE    xor ecx, esp
0054D2F0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
