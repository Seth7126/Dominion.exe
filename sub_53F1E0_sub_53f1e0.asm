...
0053F1E8    call 0x00761E50
0053F1ED    mov eax, dword ptr ds:[0x008C4040]
0053F1F2    xor eax, ebp
0053F1F4    mov dword ptr ss:[ebp-0x04], eax
0053F1F7    push esi
0053F1F8    push edi
0053F1F9    call 0x00573400
