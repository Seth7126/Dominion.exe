...
006A1CF5    push 0x76F566                                   ; => [ Call: sub_76f566 | Type: EHRegistrationNode ]
006A1CFA    mov eax, dword ptr fs:[0x00000000]
006A1D00    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A1D0E    push eax                                        ; => [ Data: __security_cookie ]
006A1D0F    lea eax, ss:[ebp-0x0C]
006A1D12    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A1D31    mov esi, dword ptr ds:[esi]                     ; => [ Data: data_147d094 ]
...
006A1D42    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1D66    mov edi, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
006A1D81    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
006A1D95    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006A1D9A    push edi
006A1D9B    cmovnz ecx, eax
006A1D9E    test esi, esi
006A1DA0    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
006A1DEC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1E0F    jz 0x006A1E2C                                   ; => [ Data: data_cf65bc ]
006A1E11    lea ecx, ss:[ebp-0x18]
006A1E14    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1E27    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A1E40    jz 0x006A1E5D                                   ; => [ Data: data_cf65bc ]
006A1E42    lea ecx, ss:[ebp-0x10]
006A1E45    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1E83    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1EA9    jz 0x006A1EC9                                   ; => [ Data: data_cf65bc ]
006A1EAB    lea ecx, ss:[ebp-0x10]
006A1EAE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1EE5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1EF8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A1EFD    mov eax, ebx
006A1EFF    mov ecx, dword ptr ss:[ebp-0x0C]
006A1F02    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A1F09    pop ecx
006A1F0A    pop edi
006A1F0B    pop esi
006A1F0C    pop ebx
...
006A1F2A    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006A1F2F    add esp, 0x0C
006A1F32    call 0x0063BC30
006A1F37    test al, al
006A1F39    jz 0x006A1F3C                                   ; => [ Call: sub_63bc30 ]
006A1F3B    int3
006A1F3C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
