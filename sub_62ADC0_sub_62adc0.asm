...
0062ADD0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0062ADD1    push ecx
0062ADD2    push ebx
0062ADD3    push esi
0062ADD4    push edi
...
0062ADDC    push eax                                        ; => [ Data: __security_cookie ]
0062ADDD    lea eax, ss:[ebp-0x0C]
0062ADE0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0062ADF4    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
0062ADF9    mov eax, dword ptr ss:[ebp-0x10]
0062ADFC    mov edi, 0x801800                               ; => [ Data: data_801800 ]
0062AE01    test eax, eax
0062AE03    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0062AE54    jz 0x0062AE71                                   ; => [ Data: data_cf65bc ]
0062AE56    lea ecx, ss:[ebp-0x10]
0062AE59    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062AE96    call 0x0063D720                                 ; => [ String: BtnResign | Call: sub_63d720 ]
0062AE9B    mov eax, dword ptr ss:[ebp+0x08]
0062AE9E    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0062AEE1    jz 0x0062AEFE                                   ; => [ Data: data_cf65bc ]
0062AEE3    lea ecx, ss:[ebp+0x08]
0062AEE6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062AEF9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062AEFE    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062AF05    test esi, esi
0062AF07    jnz 0x0062AF1D
0062AF09    xor dl, dl
0062AF0B    lea ecx, ds:[esi+0x07]
0062AF0E    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
0062AF13    call 0x004C43F0                                 ; => [ Call: sub_4c43f0 ]
0062AF18    call 0x004C44F0                                 ; => [ Call: sub_4c44f0 ]
0062AF1D    mov esi, dword ptr ds:[ebx+0x04]
0062AF20    lea ecx, ss:[ebp+0x08]
0062AF23    mov edx, 0x8050CC
0062AF28    call 0x0063D720                                 ; => [ String: BtnDiscord | Call: sub_63d720 ]
0062AF2D    mov eax, dword ptr ss:[ebp+0x08]
0062AF30    mov ecx, edi                                    ; => [ Data: data_801800 ]
0062AF32    test eax, eax
0062AF34    cmovnz ecx, eax
0062AF37    mov dl, byte ptr ds:[ecx]                       ; => [ Type: PSTR ]
...
0062AF53    xor esi, esi                                    ; => [ Call: nullptr | Call: nullptr ]
...
0062AF73    jz 0x0062AF90                                   ; => [ Data: data_cf65bc ]
0062AF75    lea ecx, ss:[ebp+0x08]
0062AF78    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062AFB3    push esi
0062AFB4    call dword ptr ds:[0x00775268]                  ; => [ String: open | String: https://discord.com/channels/609163450077151233/1245133481877704945 ]
0062AFBA    mov esi, dword ptr ds:[ebx+0x04]
0062AFBD    lea ecx, ss:[ebp+0x08]
0062AFC0    mov edx, 0x86CE38
0062AFC5    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: BtnCustomize ]
...
0062B00E    jz 0x0062B02B                                   ; => [ Data: data_cf65bc ]
0062B010    lea ecx, ss:[ebp+0x08]
0062B013    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062B026    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062B02B    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062B032    test esi, esi
0062B034    jnz 0x0062B054
0062B036    xor dl, dl
0062B038    lea ecx, ds:[esi+0x07]
0062B03B    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
0062B040    mov dword ptr ds:[0x008DB6B0], 0x7F1            ; => [ Data: data_8db6b0 ]
0062B04A    mov dword ptr ds:[0x00CCF6E0], 0x01             ; => [ Data: data_ccf6e0 ]
0062B054    xor al, al
0062B056    mov ecx, dword ptr ss:[ebp-0x0C]
0062B059    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0062B060    pop ecx
0062B061    pop edi
0062B062    pop esi
0062B063    pop ebx
