...
004BFD01    mov eax, dword ptr ds:[eax+0x42B4]
...
004BFD16    push 0x8033A4
004BFD1B    push 0xFC5
004BFD20    push 0x80292C
004BFD25    mov ecx, 0x801AA4
004BFD2A    jmp 0x004BFD52
004BFD2C    mov eax, 0x02
004BFD31    ret
004BFD32    mov eax, 0x03
004BFD37    ret
004BFD38    mov eax, dword ptr ds:[0x00CC8D5C]
004BFD3D    test eax, eax
004BFD3F    jnz 0x004BFD6E
004BFD41    push 0x77EB90
004BFD46    push 0x7B
004BFD48    push 0x77EB50
004BFD4D    mov ecx, 0x77EB9C
004BFD52    mov edx, 0x801800
004BFD57    call 0x0063B870
004BFD5C    add esp, 0x0C
004BFD5F    call 0x0063BC30
004BFD64    test al, al
004BFD66    jz 0x004BFD69
004BFD68    int3
004BFD69    jmp 0x0063BB00
