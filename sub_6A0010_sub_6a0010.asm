...
006A0015    push 0x76F2E6                                   ; => [ Call: sub_76f2e6 | Type: EHRegistrationNode ]
006A001A    mov eax, dword ptr fs:[0x00000000]
006A0020    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A002E    push eax                                        ; => [ Data: __security_cookie ]
006A002F    lea eax, ss:[ebp-0x0C]
006A0032    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A0084    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
006A0094    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
006A00A9    call 0x0063DC00                                 ; => [ Call: sub_63dc00 ]
006A00AE    mov eax, dword ptr ss:[ebp+0x08]
006A00B1    inc esi
006A00B2    jmp 0x006A0073
006A00B4    test ecx, ecx
006A00B6    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
006A00CE    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006A00E8    push eax
006A00E9    push esi
006A00EA    call 0x0063DC00                                 ; => [ Call: sub_63dc00 ]
...
006A010F    jz 0x006A012C                                   ; => [ Data: data_cf65bc ]
006A0111    lea ecx, ss:[ebp+0x08]
006A0114    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A0127    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A012C    mov eax, edi
006A012E    mov ecx, dword ptr ss:[ebp-0x0C]
006A0131    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A0138    pop ecx
006A0139    pop edi
006A013A    pop esi
006A013B    pop ebx
