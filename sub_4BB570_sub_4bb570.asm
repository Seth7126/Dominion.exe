...
004BB57C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
004BB581    xor eax, esp
004BB583    mov dword ptr ss:[esp+0x358], eax
004BB58A    movss xmm0, dword ptr ds:[0x0177747C]
004BB592    addss xmm0, dword ptr ds:[0x008C4634]           ; => [ Data: data_8c4634 | Data: data_177747c ]
004BB59A    push ebx
004BB59B    push esi
004BB59C    push edi
004BB59D    mov dword ptr ds:[0x01724B18], 0x00             ; => [ Data: data_1724b18 ]
004BB5A7    movss dword ptr ds:[0x0177747C], xmm0           ; => [ Data: data_177747c ]
004BB5AF    mov dword ptr ds:[0x01777478], 0x01             ; => [ Data: data_1777478 ]
004BB5B9    call dword ptr ds:[0x00775378]                  ; => [ Type: HWND ]
004BB5BF    cmp dword ptr ds:[0x0147B084], eax
004BB5C5    jz 0x004BB5EA                                   ; => [ Data: data_147b084 ]
004BB5C7    mov word ptr ds:[0x01777480], 0x00              ; => [ Data: data_1777480 ]
004BB5D0    mov dword ptr ds:[0x01777484], 0x00             ; => [ Data: data_1777484 ]
004BB5DA    mov byte ptr ds:[0x0177748E], 0x00              ; => [ Data: data_177748e ]
004BB5E1    mov byte ptr ds:[0x017774AB], 0x00              ; => [ Data: data_17774ab ]
004BB5E8    jmp 0x004BB624
004BB5EA    cmp dword ptr ds:[0x0147CC88], 0x00
004BB5F1    mov ecx, dword ptr ds:[0x0147AC28]              ; => [ Data: data_147ac28 ]
004BB5F7    mov eax, dword ptr ds:[0x00CF65B4]              ; => [ Data: data_cf65b4 ]
...
004BB608    jnz 0x004BB611                                  ; => [ Data: data_147cc88 ]
004BB60A    mov byte ptr ds:[0x01777480], 0x00              ; => [ Data: data_1777480 ]
...
004BB61D    mov byte ptr ds:[0x01777481], 0x00              ; => [ Data: data_1777480 ]
004BB624    movss xmm1, dword ptr ds:[0x0177747C]
004BB62C    xorps xmm0, xmm0
004BB62F    mulss xmm1, dword ptr ds:[0x00891064]           ; => [ Data: data_177747c ]
...
004BB658    mov eax, dword ptr ds:[0x01777478]              ; => [ Data: data_1777478 ]
004BB65D    mov dword ptr ss:[esp+0x2C], eax
004BB661    test eax, eax
004BB663    jz 0x004BB821
004BB669    mov edi, 0x1724B18                              ; => [ Data: data_1724b18 ]
004BB66E    mov dword ptr ss:[esp+0x1C], edi                ; => [ Data: data_1724b18 ]
004BB672    lea eax, ss:[esp+0x30]
004BB676    push edi
004BB677    push eax
004BB678    call 0x004AF390                                 ; => [ Type: InputHitResult::HitResult::VTable | Call: sub_4af390 ]
004BB67D    add esp, 0x08
004BB680    lea edx, ss:[esp+0x60]
004BB684    mov ecx, edi
004BB686    call 0x006936C0                                 ; => [ Call: sub_6936c0 ]
004BB68B    mov dword ptr ss:[esp+0x20], eax
004BB68F    mov dword ptr ss:[esp+0x18], 0x00               ; => [ Call: nullptr ]
...
004BB6F0    mov bl, byte ptr ds:[ecx+0x1777480]             ; => [ Data: data_1777480 ]
...
004BB706    mov cl, byte ptr ds:[ecx+0x17774A4]             ; => [ Data: data_17774a4 ]
...
004BB74B    call 0x0069E6F0                                 ; => [ Call: sub_69e6f0 ]
...
004BB77F    push eax
004BB780    push edi
004BB781    call 0x004B0180                                 ; => [ Call: sub_4b0180 ]
...
004BB798    mov edi, 0x802890                               ; => [ Data: data_802890 ]
...
004BB7AF    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: nullptr ]
004BB7B7    call 0x006940A0
004BB7BC    add esp, 0x04
004BB7BF    test al, al
004BB7C1    jnz 0x004BB7D4                                  ; => [ Call: sub_6940a0 ]
004BB7C3    add edi, 0x04
004BB7C6    cmp edi, 0x8028B8
004BB7CC    jnz 0x004BB7A0                                  ; => [ Data: data_8028b8 ]
...
004BB7E8    push eax
004BB7E9    push edi
004BB7EA    call 0x004AFF40                                 ; => [ Call: sub_4aff40 ]
...
004BB803    setz cl
004BB806    inc ecx
004BB807    call 0x0063C150                                 ; => [ Call: sub_63c150 ]
004BB80C    inc esi
...
004BB82D    mov word ptr ds:[0x01777482], 0x00              ; => [ Data: data_1777482 ]
004BB836    mov word ptr ds:[0x017774A4], 0x00              ; => [ Data: data_17774a4 ]
004BB83F    mov byte ptr ds:[0x017774AA], 0x00              ; => [ Data: data_17774aa ]
004BB846    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004BB84B    mov esp, ebp
004BB84D    pop ebp
004BB84E    ret
004BB84F    push 0x878680                                   ; => [ String: ButtonSourceIsDown ]
004BB854    push 0x16C
004BB859    push 0x878528                                   ; => [ String: C:\x\ax2017\Engine\Controller.cpp ]
004BB85E    mov ecx, 0x8786D0                               ; => [ String: idx < NUM_BUTTONSOURCES_HANDED ]
004BB863    jmp 0x004BB88C
004BB865    push 0x878680                                   ; => [ String: ButtonSourceIsDown ]
004BB86A    push 0x17A
004BB86F    push 0x878528                                   ; => [ String: C:\x\ax2017\Engine\Controller.cpp ]
004BB874    mov ecx, 0x87870C                               ; => [ String: source >= 0 ]
004BB879    jmp 0x004BB88C
004BB87B    push 0x802850                                   ; => [ String: ControllersUpdate ]
004BB880    push 0x6A
004BB882    push 0x802864                                   ; => [ String: C:\x\ax2017\Engine\Controller.h ]
004BB887    mov ecx, 0x802884                               ; => [ String: lastOver ]
004BB88C    mov edx, 0x801800
004BB891    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004BB896    add esp, 0x0C
004BB899    call 0x0063BC30
004BB89E    test al, al
004BB8A0    jz 0x004BB8A3                                   ; => [ Call: sub_63bc30 ]
004BB8A2    int3
004BB8A3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
