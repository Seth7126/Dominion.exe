...
00759797    jz 0x004F7EE0                                   ; => [ Call: sub_4f7ee0 ]
0075979D    jmp 0x005B0890                                  ; => [ Call: sub_5b0890 ]
