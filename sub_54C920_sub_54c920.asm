...
0054C92B    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054C930    push esi
0054C931    push edi
0054C932    push 0x00
...
0054C945    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
...
0054C966    call 0x0056A740                                 ; => [ Call: __builtin_memcpy | Call: sub_56a740 ]
0054C96B    add esp, 0x08
0054C96E    test eax, eax
0054C970    jz 0x0054C97C
0054C972    mov ecx, 0x476
0054C977    call 0x00547860                                 ; => [ Call: sub_547860 ]
0054C97C    pop edi
0054C97D    pop esi
