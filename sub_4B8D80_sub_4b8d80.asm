...
004B8D86    mov eax, dword ptr ds:[0x008C4040]
...
004B8D9D    mov eax, dword ptr ds:[0x00CC8D5C]
...
004B8DB6    mov ecx, dword ptr ds:[0x0147ABF4]
...
004B8E22    call 0x0063B870
004B8E27    add esp, 0x0C
004B8E2A    call 0x0063BC30
004B8E2F    test al, al
004B8E31    jz 0x004B8E34
004B8E33    int3
004B8E34    call 0x0063BB00
