...
0063D8D7    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0063D8DC    push edi
...
0063D909    jz 0x0063D925                                   ; => [ Data: data_cf65bc ]
0063D90B    mov ecx, edi
0063D90D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063D920    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063D925    pop esi
0063D926    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
...
0063D93A    call 0x0063D5E0                                 ; => [ Call: sub_63d5e0 ]
0063D93F    lea eax, ds:[esi+0x01]
0063D942    push eax
0063D943    push ebx
0063D944    push dword ptr ds:[edi]
0063D946    call 0x00761FBE                                 ; => [ Call: memcpy ]
