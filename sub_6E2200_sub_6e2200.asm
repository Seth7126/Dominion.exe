...
006E2205    push 0x77123E                                   ; => [ Type: EHRegistrationNode | Call: sub_77123e ]
006E220A    mov eax, dword ptr fs:[0x00000000]
006E2210    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006E221E    push eax                                        ; => [ Data: __security_cookie ]
006E221F    lea eax, ss:[ebp-0x0C]
006E2222    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E224B    jz 0x006E225D                                   ; => [ String: 0x ]
006E224D    movq xmm0, qword ptr ds:[0x00CB2F14]            ; => [ Data: data_cb2f14 ]
006E2255    mov esi, dword ptr ds:[0x00CB2F1C]              ; => [ Data: data_cb2f1c ]
006E225B    jmp 0x006E2276
006E225D    add dword ptr ds:[ebx+0x04], 0x02
006E2261    mov ecx, ebx
006E2263    call 0x006E1920                                 ; => [ Call: sub_6e1920 ]
006E2268    movq xmm0, qword ptr ds:[0x00CB2F08]            ; => [ Data: data_cb2f08 ]
006E2270    mov esi, dword ptr ds:[0x00CB2F10]              ; => [ Data: data_cb2f10 ]
...
006E228A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E22D3    jz 0x006E22EA                                   ; => [ String: 0X ]
006E22D5    mov eax, dword ptr ds:[0x00CB2F14]
006E22DA    mov esi, dword ptr ds:[0x00CB2F1C]              ; => [ Data: data_cb2f1c ]
006E22E0    mov dword ptr ss:[ebp-0x30], eax                ; => [ Data: data_cb2f14 ]
006E22E3    mov eax, dword ptr ds:[0x00CB2F18]              ; => [ Data: data_cb2f18 ]
006E22E8    jmp 0x006E2308
006E22EA    add dword ptr ds:[ebx+0x04], 0x02
006E22EE    mov ecx, ebx
006E22F0    call 0x006E1920                                 ; => [ Call: sub_6e1920 ]
006E22F5    mov eax, dword ptr ds:[0x00CB2F08]
006E22FA    mov esi, dword ptr ds:[0x00CB2F10]              ; => [ Data: data_cb2f10 ]
006E2300    mov dword ptr ss:[ebp-0x30], eax                ; => [ Data: data_cb2f08 ]
006E2303    mov eax, dword ptr ds:[0x00CB2F0C]              ; => [ Data: data_cb2f08 ]
...
006E231D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E2342    push eax
006E2343    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006E235C    jz 0x006E2379                                   ; => [ Data: data_cf65bc ]
006E235E    lea ecx, ss:[ebp-0x28]
006E2361    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E2374    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006E23B0    jz 0x006E23C8                                   ; => [ String: # ]
006E23B2    mov eax, dword ptr ds:[0x00CB2F14]
006E23B7    mov dword ptr ds:[edi], eax                     ; => [ Data: data_cb2f14 ]
006E23B9    mov eax, dword ptr ds:[0x00CB2F18]
006E23BE    mov dword ptr ds:[edi+0x04], eax                ; => [ Data: data_cb2f18 ]
006E23C1    mov eax, dword ptr ds:[0x00CB2F1C]              ; => [ Data: data_cb2f1c ]
006E23C6    jmp 0x006E23E6
006E23C8    inc dword ptr ds:[ebx+0x04]
006E23CB    mov ecx, ebx
006E23CD    call 0x006E1920                                 ; => [ Call: sub_6e1920 ]
006E23D2    mov eax, dword ptr ds:[0x00CB2F08]
006E23D7    mov dword ptr ds:[edi], eax                     ; => [ Data: data_cb2f08 ]
006E23D9    mov eax, dword ptr ds:[0x00CB2F0C]
006E23DE    mov dword ptr ds:[edi+0x04], eax                ; => [ Data: data_cb2f08 ]
006E23E1    mov eax, dword ptr ds:[0x00CB2F10]              ; => [ Data: data_cb2f10 ]
...
006E23F5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E2412    jz 0x006E24B2                                   ; => [ Data: data_cf65bc ]
...
006E2441    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E246F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E24AD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E24B2    mov eax, edi
006E24B4    mov ecx, dword ptr ss:[ebp-0x0C]
006E24B7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E24BE    pop ecx
006E24BF    pop edi
006E24C0    pop esi
006E24C1    pop ebx
