...
006653D2    mov dword ptr fs:[0x00000000], eax
006653D8    mov eax, ecx
006653DA    mov dword ptr ss:[ebp-0x24], eax
006653DD    cmp dword ptr ds:[eax], 0x00
006653E0    mov dword ptr ss:[ebp-0x1C], 0x00
006653E7    jle 0x0066557B
006653ED    mov esi, dword ptr ds:[0x008CAE80]
...
006654C6    jnb 0x0066551E
006654C8    imul esi, ecx, 0x248
006654CE    add esi, dword ptr ds:[0x00C23BC4]
...
006654F3    push eax
006654F4    call 0x007592FC
006654F9    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00665500    movzx eax, word ptr ds:[esi+0x244]
00665507    mov ecx, dword ptr ds:[0x00C23BD0]
0066550D    mov dword ptr ds:[0x00C23BD0], eax
00665512    mov dword ptr ds:[esi+0x244], ecx
00665518    dec dword ptr ds:[0x00C23BD4]
0066551E    mov dword ptr ds:[edi+0x08], 0x00
00665525    mov esi, dword ptr ds:[0x008CAE80]
...
0066557E    mov dword ptr fs:[0x00000000], ecx
00665585    pop ecx
00665586    pop edi
00665587    pop esi
00665588    pop ebx
...
0066558B    pop ebp
0066558C    ret
0066558D    push 0x881518
00665592    push 0x1FE
00665597    mov ecx, 0x88156C
0066559C    jmp 0x006655AD
0066559E    push 0x88131C
006655A3    push 0x8B
006655A8    mov ecx, 0x881344
006655AD    push 0x8812F8
006655B2    mov edx, 0x801800
006655B7    call 0x0063B870
006655BC    add esp, 0x0C
006655BF    call 0x0063BC30
006655C4    test al, al
006655C6    jz 0x006655C9
006655C8    int3
006655C9    call 0x0063BB00
