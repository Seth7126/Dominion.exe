...
006A3151    call 0x006A3220                                 ; => [ Call: sub_6a3220 ]
...
006A3168    jz 0x006A3198                                   ; => [ Data: data_801800 ]
006A316A    cmp dword ptr ds:[0x00CF65BC], 0x00
006A3171    jz 0x006A3192
006A3173    cmp byte ptr ds:[eax], 0x00
006A3176    jz 0x006A3192                                   ; => [ Data: data_cf65bc ]
006A3178    mov ecx, esi
006A317A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A3208    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A320D    mov dword ptr ds:[esi+0x08], 0x801800           ; => [ Data: data_801800 ]
006A3214    push esi
