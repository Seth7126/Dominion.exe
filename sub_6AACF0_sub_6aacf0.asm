...
006AAD01    push eax
006AAD02    mov dword ptr ss:[ebp-0x0C], eax
006AAD05    lea eax, ss:[ebp-0x08]
006AAD08    push eax
006AAD09    call dword ptr ds:[0x00775610]
006AAD0F    add esp, 0x0C
006AAD12    test eax, eax
006AAD14    jz 0x006AAD1D
006AAD16    xor edi, edi
006AAD18    mov dword ptr ss:[ebp-0x08], edi
...
006AADA9    push 0x87B500
006AADAE    push 0x339
006AADB3    mov ecx, 0x87B4EC
...
006AAE5D    push 0x87B500
006AAE62    push 0x34F
006AAE67    mov ecx, 0x87B4EC
...
006AAF71    mov dword ptr ds:[ebx], eax
006AAF73    lea ecx, ss:[ebp-0x20]
006AAF76    call 0x006A9DE0
...
006AAF8E    pop ebp
006AAF8F    ret
006AAF90    push 0x87B500
006AAF95    push 0x371
006AAF9A    mov ecx, 0x801AA4
006AAF9F    push 0x87B3F4
006AAFA4    mov edx, 0x801800
006AAFA9    call 0x0063B870
006AAFAE    add esp, 0x0C
006AAFB1    call 0x0063BC30
006AAFB6    test al, al
006AAFB8    jz 0x006AAFBB
006AAFBA    int3
006AAFBB    call 0x0063BB00
