...
004D6435    push 0x763958                                   ; => [ Call: __ehhandler$??0ThreadVirtualProcessor@details@Concurrency@@QAE@PAVSchedulingNode@12@PAUIVirtualProcessorRoot@2@@Z | Type: EHRegistrationNode ]
004D643A    mov eax, dword ptr fs:[0x00000000]
004D6440    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D6441    sub esp, 0x0C
004D6444    push esi
004D6445    mov eax, dword ptr ds:[0x008C4040]
004D644A    xor eax, ebp
004D644C    push eax                                        ; => [ Data: __security_cookie ]
004D644D    lea eax, ss:[ebp-0x0C]
004D6450    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D6456    mov esi, ecx
004D6458    mov dword ptr ss:[ebp-0x10], esi
004D645B    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
004D6461    mov dword ptr ss:[ebp-0x04], 0x00
004D6468    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
004D646F    push 0x4AB080                                   ; => [ Call: sub_4ab080 ]
...
004D6487    push eax
004D6488    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_4ab060 ]
004D648D    mov dword ptr ds:[esi+0x350C], 0x801800         ; => [ Data: data_801800 ]
004D6497    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D64AF    push eax
004D64B0    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' ]
004D64B5    mov dword ptr ds:[esi+0x4244], 0x801800         ; => [ Data: data_801800 ]
004D64BF    mov dword ptr ds:[esi+0x4248], 0x801800         ; => [ Data: data_801800 ]
004D64C9    mov dword ptr ds:[esi+0x4254], 0x801800         ; => [ Data: data_801800 ]
004D64D3    mov dword ptr ds:[esi+0x4258], 0x801800         ; => [ Data: data_801800 ]
004D64DD    mov dword ptr ds:[esi+0x4290], 0x00             ; => [ Call: __builtin_memset ]
...
004D6519    push 0x4D6880                                   ; => [ Call: sub_4d6880 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D6534    push eax
004D6535    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_4d6870 ]
...
004D6558    push 0x4D6960                                   ; => [ Call: sub_4d6960 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D6574    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_4d6950 ]
004D6579    mov dword ptr ds:[esi+0x7200], 0x00             ; => [ Call: __builtin_memset ]
...
004D65B5    push 0x4AB1F0                                   ; => [ Call: sub_4ab1f0 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D65D1    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_4ab1e0 ]
004D65D6    mov dword ptr ds:[esi+0x72EC], 0x00             ; => [ Call: __builtin_memset ]
...
004D663D    push 0x806EE0                                   ; => [ String: XMap<enum DLCType,int>::SetNumBuckets ]
004D6642    jmp 0x004D67A3
004D6647    mov ecx, 0x200
004D664C    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D666A    push 0x806EA0                                   ; => [ String: XMap<enum TGGEntitlement,enum EntitlementState>::SetNumBuckets ]
004D666F    jmp 0x004D67A3
004D6674    mov ecx, 0x100
004D6679    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D6697    push 0x806F08                                   ; => [ String: XMap<enum DayID,enum GameIndex>::SetNumBuckets ]
004D669C    jmp 0x004D67A3
004D66A1    mov ecx, 0x1000
004D66A6    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D66C4    push 0x806F60                                   ; => [ String: XMap<enum DayID,struct DailySeedStatusEntryClient>::SetNumBuckets ]
004D66C9    jmp 0x004D67A3
004D66CE    mov ecx, 0x1000
004D66D3    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D66F1    push 0x806FA4                                   ; => [ String: XMap<enum WeekID,struct WeeklyCampaignStatus>::SetNumBuckets ]
004D66F6    jmp 0x004D67A3
004D66FB    mov ecx, 0x1000
004D6700    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D671E    push 0x806F38                                   ; => [ String: XMap<struct Date,int>::SetNumBuckets ]
004D6723    jmp 0x004D67A3
004D6725    mov ecx, 0x80
004D672A    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D6748    push 0x806E10                                   ; => [ String: XMap<enum SyncedDataKey,unsigned __int64>::SetNumBuckets ]
004D674D    jmp 0x004D67A3
004D674F    mov ecx, 0x1000
004D6754    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
004D677C    mov dword ptr ds:[esi+0x429C], eax              ; => [ Call: sub_64c020 ]
004D6782    mov eax, esi
004D6784    mov dword ptr ds:[esi+0x42A0], 0x3FF
004D678E    mov ecx, dword ptr ss:[ebp-0x0C]
004D6791    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D6798    pop ecx
004D6799    pop esi
004D679A    mov esp, ebp
004D679C    pop ebp
004D679D    ret
004D679E    push 0x806E50                                   ; => [ String: XMap<enum SyncedDataKey,struct SyncDataEntry<unsigned __int64> >::SetNumBuckets ]
004D67A3    push 0x74
004D67A5    push 0x802620
004D67AA    mov edx, 0x801800
004D67AF    mov ecx, 0x80264C
004D67B4    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xMap.h | String: mNodeBuckets == NULL ]
004D67B9    add esp, 0x0C
004D67BC    call 0x0063BC30
004D67C1    test al, al
004D67C3    jz 0x004D67C6                                   ; => [ Call: sub_63bc30 ]
004D67C5    int3
004D67C6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
