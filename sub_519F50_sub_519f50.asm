...
00519F72    mov dword ptr fs:[0x00000000], eax
...
0051A00D    call 0x0064C080
0051A012    mov dword ptr ss:[ebp-0x10], esi
...
0051A09B    mov ecx, esi
0051A09D    mov eax, dword ptr ds:[eax]
...
0051A0FA    call 0x0064C080
0051A0FF    mov dword ptr ss:[ebp-0x10], 0x801800
0051A106    mov dword ptr ss:[ebp-0x04], 0x06
0051A10D    cmp dword ptr ds:[0x00CF65BC], 0x00
0051A114    jz 0x0051A13D
...
0051A15F    mov ecx, esi
0051A161    mov eax, dword ptr ds:[eax]
...
0051A1BC    call 0x0064C080
0051A1C1    mov dword ptr ss:[ebp-0x10], 0x801800
0051A1C8    mov dword ptr ss:[ebp-0x04], 0x0A
0051A1CF    cmp dword ptr ds:[0x00CF65BC], 0x00
0051A1D6    jz 0x0051A1FF
...
0051A1FA    call 0x0064C080
0051A1FF    mov eax, edi
0051A201    mov ecx, dword ptr ss:[ebp-0x0C]
0051A204    mov dword ptr fs:[0x00000000], ecx
0051A20B    pop ecx
0051A20C    pop edi
0051A20D    pop esi
0051A20E    pop ebx
...
0051A229    call 0x0063B870
0051A22E    add esp, 0x0C
0051A231    call 0x0063BC30
0051A236    test al, al
0051A238    jz 0x0051A23B
0051A23A    int3
0051A23B    call 0x0063BB00
