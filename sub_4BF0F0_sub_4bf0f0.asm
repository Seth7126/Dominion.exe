...
004BF110    mov dword ptr fs:[0x00000000], eax
...
004BF124    call 0x0063D720
004BF129    mov eax, dword ptr ss:[ebp-0x10]
004BF12C    mov edi, 0x801800
004BF131    test eax, eax
004BF133    mov ecx, edi
...
004BF184    jz 0x004BF1A1
004BF186    lea ecx, ss:[ebp-0x10]
004BF189    call 0x0063D4E0
...
004BF19C    call 0x0064C080
004BF1A1    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004BF1A8    test bl, bl
004BF1AA    jz 0x004BF1CA
004BF1AC    mov dword ptr ds:[0x008DB660], 0x04
004BF1B6    xor al, al
004BF1B8    mov ecx, dword ptr ss:[ebp-0x0C]
004BF1BB    mov dword ptr fs:[0x00000000], ecx
004BF1C2    pop ecx
004BF1C3    pop edi
004BF1C4    pop esi
004BF1C5    pop ebx
...
004BF1D8    call 0x0063D720
004BF1DD    mov eax, dword ptr ss:[ebp-0x10]
004BF1E0    mov ecx, edi
...
004BF223    jz 0x004BF240
004BF225    lea ecx, ss:[ebp-0x10]
004BF228    call 0x0063D4E0
...
004BF23B    call 0x0064C080
004BF240    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004BF247    test esi, esi
004BF249    jnz 0x004BF26F
004BF24B    mov dword ptr ds:[0x00CC8DBC], esi
004BF251    xor al, al
004BF253    mov dword ptr ds:[0x008DB660], 0x06
004BF25D    mov ecx, dword ptr ss:[ebp-0x0C]
004BF260    mov dword ptr fs:[0x00000000], ecx
004BF267    pop ecx
004BF268    pop edi
004BF269    pop esi
004BF26A    pop ebx
...
004BF27A    call 0x0063D720
004BF27F    mov eax, dword ptr ss:[ebp-0x10]
004BF282    mov ecx, edi
...
004BF2CC    jz 0x004BF2E9
004BF2CE    lea ecx, ss:[ebp-0x10]
004BF2D1    call 0x0063D4E0
...
004BF31D    call 0x0063D720
004BF322    mov eax, dword ptr ss:[ebp-0x10]
004BF325    mov ecx, edi
...
004BF36C    jz 0x004BF389
004BF36E    lea ecx, ss:[ebp-0x10]
004BF371    call 0x0063D4E0
...
004BF3E5    pop ebp
004BF3E6    ret
004BF3E7    call 0x004AEA20
004BF3EC    xor al, al
004BF3EE    mov ecx, dword ptr ss:[ebp-0x0C]
004BF3F1    mov dword ptr fs:[0x00000000], ecx
004BF3F8    pop ecx
004BF3F9    pop edi
004BF3FA    pop esi
004BF3FB    pop ebx
...
004BF408    call 0x0063D720
004BF40D    mov eax, dword ptr ss:[ebp-0x10]
004BF410    mov ecx, edi
...
004BF45C    jz 0x004BF479
004BF45E    lea ecx, ss:[ebp-0x10]
004BF461    call 0x0063D4E0
...
004BF4BD    call 0x0064C080
004BF4C2    mov dword ptr ds:[0x008DBC48], 0x801800
004BF4CC    mov edx, edi
004BF4CE    mov dword ptr ds:[0x008DBC4C], 0x01
004BF4D8    lea ecx, ss:[ebp+0x08]
004BF4DB    call 0x0063D720
004BF4E0    mov dword ptr ss:[ebp-0x04], 0x05
004BF4E7    lea eax, ss:[ebp+0x08]
004BF4EA    push eax
004BF4EB    mov ecx, 0x8DB76C
004BF4F0    mov dword ptr ds:[0x008DB6B0], 0x22
004BF4FA    mov dword ptr ds:[0x008DB768], 0x8DBC78
004BF504    mov dword ptr ds:[0x008DB770], 0x4BFB40
004BF50E    mov dword ptr ds:[0x008DB774], 0x4BFB50
004BF518    call 0x0063D850
004BF51D    mov dword ptr ds:[0x008DB778], 0x03
004BF527    mov dword ptr ss:[ebp-0x04], 0x06
004BF52E    jmp 0x004BF89E
004BF533    mov edx, 0x803360
004BF538    lea ecx, ss:[ebp-0x10]
004BF53B    call 0x0063D720
004BF540    mov eax, dword ptr ss:[ebp+0x08]
004BF543    mov ecx, edi
...
004BF58C    jz 0x004BF5A9
004BF58E    lea ecx, ss:[ebp-0x10]
004BF591    call 0x0063D4E0
...
004BF639    call 0x0064C080
004BF63E    mov dword ptr ds:[0x008DBC44], 0x801800
004BF648    mov ecx, dword ptr ds:[0x00CC8DC8]
004BF64E    mov dword ptr ds:[0x008DBC4C], 0x00
004BF658    mov dword ptr ds:[0x008DBC40], 0x00
004BF662    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004BF668    call 0x004D8F30
...
004BF6E5    call 0x0064C080
004BF6EA    mov dword ptr ds:[esi+0x4258], 0x801800
004BF6F4    and dword ptr ds:[esi+0x425C], 0xFFFFFFFE
004BF6FB    mov ecx, dword ptr ds:[0x00CC8DC8]
004BF701    call 0x004D8AD0
004BF706    xor al, al
004BF708    mov ecx, dword ptr ss:[ebp-0x0C]
004BF70B    mov dword ptr fs:[0x00000000], ecx
004BF712    pop ecx
004BF713    pop edi
004BF714    pop esi
004BF715    pop ebx
...
004BF722    call 0x0063D720
004BF727    mov eax, dword ptr ss:[ebp+0x08]
004BF72A    mov ecx, edi
...
004BF773    jz 0x004BF790
004BF775    lea ecx, ss:[ebp-0x10]
004BF778    call 0x0063D4E0
...
004BF826    call 0x0064C080
004BF82B    mov dword ptr ds:[0x008DBC44], 0x801800
004BF835    mov dword ptr ds:[0x008DBC40], 0x01
004BF83F    lea ecx, ss:[ebp+0x08]
004BF842    and dword ptr ds:[ebx+0x425C], 0xFFFFFFFE
004BF849    mov edx, edi
004BF84B    call 0x0063D720
004BF850    mov dword ptr ss:[ebp-0x04], 0x09
004BF857    lea eax, ss:[ebp+0x08]
004BF85A    push eax
004BF85B    mov ecx, 0x8DB76C
004BF860    mov dword ptr ds:[0x008DB6B0], 0x22
004BF86A    mov dword ptr ds:[0x008DB768], 0x8DBC54
004BF874    mov dword ptr ds:[0x008DB770], 0x4BFB60
004BF87E    mov dword ptr ds:[0x008DB774], 0x4BFB50
004BF888    call 0x0063D850
004BF88D    mov dword ptr ds:[0x008DB778], 0x02
004BF897    mov dword ptr ss:[ebp-0x04], 0x0A
004BF89E    cmp dword ptr ds:[0x00CF65BC], 0x00
004BF8A5    jz 0x004BFB2A
...
004BF8D9    call 0x0064C080
004BF8DE    xor al, al
004BF8E0    mov ecx, dword ptr ss:[ebp-0x0C]
004BF8E3    mov dword ptr fs:[0x00000000], ecx
004BF8EA    pop ecx
004BF8EB    pop edi
004BF8EC    pop esi
004BF8ED    pop ebx
...
004BF900    call 0x0063D720
004BF905    mov eax, dword ptr ss:[ebp+0x08]
004BF908    mov ecx, edi
...
004BF94C    jz 0x004BF969
004BF94E    lea ecx, ss:[ebp+0x08]
004BF951    call 0x0063D4E0
...
004BF985    mov eax, dword ptr ds:[eax+0x04]
004BF988    test eax, eax
004BF98A    cmovnz edi, eax
004BF98D    mov ecx, edi
004BF98F    call 0x004B8CC0
004BF994    xor al, al
004BF996    mov ecx, dword ptr ss:[ebp-0x0C]
004BF999    mov dword ptr fs:[0x00000000], ecx
004BF9A0    pop ecx
004BF9A1    pop edi
004BF9A2    pop esi
004BF9A3    pop ebx
...
004BF9B3    call 0x0063D720
004BF9B8    mov eax, dword ptr ss:[ebp+0x08]
004BF9BB    mov ecx, edi
...
004BF9FE    jz 0x004BFA1B
004BFA00    lea ecx, ss:[ebp+0x08]
004BFA03    call 0x0063D4E0
...
004BFA72    mov dword ptr fs:[0x00000000], ecx
004BFA79    pop ecx
004BFA7A    pop edi
004BFA7B    pop esi
004BFA7C    pop ebx
...
004BFA9C    mov dword ptr fs:[0x00000000], ecx
004BFAA3    pop ecx
004BFAA4    pop edi
004BFAA5    pop esi
004BFAA6    pop ebx
...
004BFAFF    jz 0x004BFB1C
004BFB01    lea ecx, ss:[ebp+0x08]
004BFB04    call 0x0063D4E0
...
004BFB17    call 0x0064C080
004BFB1C    test esi, esi
004BFB1E    jnz 0x004BFB2A
004BFB20    mov dword ptr ds:[0x008DB660], 0x1E
004BFB2A    xor al, al
004BFB2C    mov ecx, dword ptr ss:[ebp-0x0C]
004BFB2F    mov dword ptr fs:[0x00000000], ecx
004BFB36    pop ecx
004BFB37    pop edi
004BFB38    pop esi
004BFB39    pop ebx
