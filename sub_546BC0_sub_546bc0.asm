...
00546C26    mov dword ptr ss:[ebp-0xCC0], 0x81B9C4
00546C30    mov dword ptr ss:[ebp-0xCBC], eax
00546C36    lea eax, ss:[ebp-0xCC0]
00546C3C    mov dword ptr ss:[ebp-0xC9C], eax
...
00546CE3    call 0x0056ACC0
00546CE8    add esp, 0x0C
00546CEB    mov ecx, dword ptr ss:[ebp-0x0C]
00546CEE    mov dword ptr fs:[0x00000000], ecx
00546CF5    pop ecx
00546CF6    pop edi
00546CF7    pop esi
00546CF8    pop ebx
