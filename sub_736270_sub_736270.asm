...
00736299    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\Texture.h | Data: data_801800 | String: assetPtr->assetType == ASSET_TYPE_TEXTURE | String: TextureGetDef ]
0073629E    add esp, 0x0C
007362A1    jmp 0x0073632B
007362A6    call 0x005AF880
007362AB    mov ecx, dword ptr ss:[ebp+0x08]
007362AE    mov esi, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
007362BE    call 0x006A9450                                 ; => [ Call: sub_6a9450 ]
...
007362E5    mov dword ptr ds:[ebx], eax                     ; => [ Call: sub_687730 | Call: sub_6a9660 ]
007362E7    mov ecx, esi
007362E9    call 0x00735A50                                 ; => [ Call: sub_735a50 ]
007362EE    test al, al
...
007362FF    push eax                                        ; => [ Call: sub_63d7e0 ]
...
00736323    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: AtlasLoadFontTexture | String: Failed to read texture %s | Call: sub_63b5f0 | String: Halt | String: C:\x\ax2017\Engine\Editor\AtlasMaker.cpp ]
00736328    add esp, 0x14
0073632B    call 0x0063BC30
00736330    test al, al
00736332    jz 0x00736335                                   ; => [ Call: sub_63bc30 ]
00736334    int3
00736335    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
