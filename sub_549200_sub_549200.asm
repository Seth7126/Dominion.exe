...
0054920B    call 0x00761E50
00549210    mov eax, dword ptr ds:[0x008C4040]
...
00549291    xor edi, edi
00549293    mov ecx, esi
00549295    mov dword ptr ss:[esp+0x1C], edi
00549299    mov dword ptr ss:[esp+0x2620], edi
...
00549307    mov eax, dword ptr ds:[eax+0x04]
...
005493B5    movlpd qword ptr ss:[esp+0x34], xmm0
...
005494CF    movlpd qword ptr ss:[esp+0x34], xmm0
...
0054952D    mov eax, dword ptr ds:[eax+0x04]
...
0054956B    mov eax, dword ptr ds:[eax+0x04]
...
005495F7    push 0x81EAD8
005495FC    push 0x3C3
00549601    mov ecx, 0x801AA4
