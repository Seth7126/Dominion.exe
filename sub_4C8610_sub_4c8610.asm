...
004C86F0    call 0x00666380
004C86F5    add esp, 0x08
004C86F8    mov esi, 0x801800
004C86FD    mov dword ptr ss:[ebp-0x10], esi
...
004C88F5    jz 0x004C8912
004C88F7    lea ecx, ss:[ebp-0x10]
004C88FA    call 0x0063D4E0
...
004C8929    jz 0x004C8946
004C892B    lea ecx, ss:[ebp-0x20]
004C892E    call 0x0063D4E0
...
004C8941    call 0x0064C080
004C8946    mov ecx, dword ptr ss:[ebp-0x0C]
004C8949    mov dword ptr fs:[0x00000000], ecx
004C8950    pop ecx
004C8951    pop edi
004C8952    pop esi
004C8953    pop ebx
...
004C8971    call 0x0063B870
004C8976    add esp, 0x0C
004C8979    call 0x0063BC30
004C897E    test al, al
004C8980    jz 0x004C8983
004C8982    int3
004C8983    call 0x0063BB00
