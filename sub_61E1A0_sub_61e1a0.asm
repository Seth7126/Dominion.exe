...
0061E257    call 0x0061E070
0061E25C    jmp 0x0061E58E
0061E261    cmp byte ptr ds:[0x0171EFCC], 0x00
0061E268    jnz 0x0061E274
0061E26A    mov dword ptr ds:[0x0171EFC8], 0x00
...
0061E31A    call 0x0064C080
0061E31F    mov dword ptr ss:[ebp-0x5068], 0x801800
0061E329    mov byte ptr ss:[ebp-0x04], 0x04
0061E32D    cmp dword ptr ds:[0x00CF65BC], 0x00
0061E334    jz 0x0061E363
...
0061E3BE    call 0x0064C080
0061E3C3    mov dword ptr ss:[ebp-0x5064], 0x801800
...
0061E465    jz 0x0061E487
0061E467    mov ecx, edi
0061E469    call 0x0063D4E0
...
0061E47C    call 0x0064C080
0061E481    mov dword ptr ds:[edi], 0x801800
...
0061E4D9    call 0x0064C080
0061E4DE    mov dword ptr ss:[ebp-0x5064], 0x801800
...
0061E538    push esi
0061E539    call 0x004E5AC0
0061E53E    mov ecx, dword ptr ds:[0x00CC8DC8]
0061E544    add esp, 0x04
0061E547    call 0x004D8AD0
0061E54C    lea ecx, ss:[ebp-0x5060]
0061E552    call 0x005AC2E0
0061E557    mov dword ptr ds:[0x0171EFD0], eax
0061E55C    lea eax, ss:[ebp-0x5060]
0061E562    push 0x5020
0061E567    push eax
0061E568    push 0x171EFD4
0061E56D    call 0x00761FBE
...
0061E586    push 0x04
0061E588    push eax
0061E589    call 0x007592FC
0061E58E    mov ecx, dword ptr ss:[ebp-0x0C]
0061E591    mov dword ptr fs:[0x00000000], ecx
0061E598    pop ecx
0061E599    pop edi
0061E59A    pop esi
0061E59B    pop ebx
...
0061E5A1    call 0x0075927A
0061E5A6    mov esp, ebp
0061E5A8    pop ebp
0061E5A9    ret
0061E5AA    push 0x813640
0061E5AF    push 0x672
0061E5B4    mov ecx, 0x813670
0061E5B9    push 0x80CD80
0061E5BE    mov edx, 0x801800
0061E5C3    call 0x0063B870
0061E5C8    add esp, 0x0C
0061E5CB    call 0x0063BC30
0061E5D0    test al, al
0061E5D2    jz 0x0061E5D5
0061E5D4    int3
0061E5D5    call 0x0063BB00
