...
0054E441    mov ecx, eax
0054E443    xor eax, eax
0054E445    mov dword ptr ss:[esp+0x2C], ecx
0054E449    mov dword ptr ss:[esp+0x10], eax
...
0054E5D8    mov dword ptr ss:[esp+0x14], eax
...
0054E5EC    mov eax, dword ptr ds:[eax+0x04]
...
0054E71E    call 0x0063B870
0054E723    add esp, 0x0C
0054E726    call 0x0063BC30
0054E72B    test al, al
0054E72D    jz 0x0054E730
0054E72F    int3
0054E730    call 0x0063BB00
