...
006C4225    push 0x770176                                   ; => [ Call: sub_770176 | Type: EHRegistrationNode ]
006C422A    mov eax, dword ptr fs:[0x00000000]
006C4230    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C423E    push eax                                        ; => [ Data: __security_cookie ]
006C423F    lea eax, ss:[ebp-0x0C]
006C4242    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C425F    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006C4264    lea ecx, ss:[ebp-0x14]
006C4267    call 0x006A0010                                 ; => [ Call: sub_6a0010 ]
006C426C    mov ecx, esp
006C426E    mov dword ptr ss:[ebp-0x04], 0x01
006C4275    mov edx, 0x147CF90
006C427A    call 0x0063D720                                 ; => [ Data: data_147cf90 | Call: sub_63d720 ]
006C427F    lea ecx, ss:[ebp-0x10]
006C4282    call 0x006A0010                                 ; => [ Call: sub_6a0010 ]
...
006C42DC    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006C42FA    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
006C42FD    jmp 0x006C4301
006C42FF    xor eax, eax                                    ; => [ Call: nullptr ]
...
006C4348    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4365    jz 0x006C4398                                   ; => [ Data: data_cf65bc ]
...
006C4376    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4389    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C438E    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006C43E5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C43F8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C43FD    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C4404    mov dword ptr ss:[ebp-0x04], 0x06
006C440B    jmp 0x006C4691
006C4410    push ecx
006C4411    mov ecx, esp
006C4413    mov edx, 0x147D098
006C4418    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006C441D    lea ecx, ss:[ebp-0x18]
006C4420    call 0x006A0010                                 ; => [ Call: sub_6a0010 ]
...
006C4476    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006C4492    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
006C4495    jmp 0x006C4499
006C4497    xor eax, eax                                    ; => [ Call: nullptr ]
...
006C44AB    push edi
006C44AC    call dword ptr ds:[0x00775670]                  ; => [ String: sys/ ]
...
006C44CD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C44E7    jz 0x006C4517                                   ; => [ Data: data_cf65bc ]
...
006C44F8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C450B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4510    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006C4517    mov byte ptr ss:[ebp-0x04], 0x09
006C451B    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4522    jz 0x006C4552                                   ; => [ Data: data_cf65bc ]
...
006C4533    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4546    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C454B    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006C4592    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C45A5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C45AA    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006C45B1    mov byte ptr ss:[ebp-0x04], 0x0C
006C45B5    cmp dword ptr ds:[0x00CF65BC], 0x00
006C45BC    jz 0x006C45EC                                   ; => [ Data: data_cf65bc ]
...
006C45CD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C45E0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C45E5    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006C4605    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C461F    jz 0x006C464F                                   ; => [ Data: data_cf65bc ]
...
006C4630    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4643    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4648    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006C464F    mov byte ptr ss:[ebp-0x04], 0x0F
006C4653    cmp dword ptr ds:[0x00CF65BC], 0x00
006C465A    jz 0x006C468A                                   ; => [ Data: data_cf65bc ]
...
006C466B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C46BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C46C1    mov eax, esi
006C46C3    mov ecx, dword ptr ss:[ebp-0x0C]
006C46C6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
006C46CD    pop ecx
006C46CE    pop edi
006C46CF    pop esi
006C46D0    pop ebx
...
006C46EE    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006C46F3    add esp, 0x0C
006C46F6    call 0x0063BC30
006C46FB    test al, al
006C46FD    jz 0x006C4700                                   ; => [ Call: sub_63bc30 ]
006C46FF    int3
006C4700    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006C4705    push 0x871DD4                                   ; => [ String: XString::XString ]
006C470A    push 0x94
006C470F    push 0x871D5C
006C4714    mov edx, 0x801800
006C4719    mov ecx, 0x871E0C
006C471E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: str | String: C:\x\ax2017\Engine\xString.cpp ]
006C4723    add esp, 0x0C
006C4726    call 0x0063BC30
006C472B    test al, al
006C472D    jz 0x006C4730                                   ; => [ Call: sub_63bc30 ]
006C472F    int3
006C4730    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
