...
006A1F55    push 0x76F5CE                                   ; => [ Call: sub_76f5ce | Type: EHRegistrationNode ]
006A1F5A    mov eax, dword ptr fs:[0x00000000]
006A1F60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A1F6E    push eax                                        ; => [ Data: __security_cookie ]
006A1F6F    lea eax, ss:[ebp-0x0C]
006A1F72    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A1F93    mov esi, dword ptr ds:[esi]                     ; => [ Data: data_147d094 ]
...
006A1FA4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1FCB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006A1FD0    inc dword ptr ds:[eax+0x04]
006A1FD3    lea ecx, ss:[ebp-0x10]
006A1FD6    call 0x006C5250                                 ; => [ Call: sub_6c5250 ]
...
006A1FF4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006A1FF9    inc dword ptr ds:[eax+0x04]
006A1FFC    lea eax, ss:[ebp-0x14]
006A1FFF    mov byte ptr ss:[ebp-0x04], 0x03
006A2003    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
006A2009    push eax
006A200A    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006A2023    jz 0x006A2043                                   ; => [ Data: data_cf65bc ]
006A2025    lea ecx, ss:[ebp-0x14]
006A2028    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A203E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A205B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006A2060    inc dword ptr ds:[eax+0x04]
006A2063    mov ecx, ebx
006A2065    call 0x006A1CF0                                 ; => [ Call: sub_6a1cf0 ]
...
006A2083    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006A2088    inc dword ptr ds:[eax+0x04]
006A208B    lea eax, ss:[ebp+0x08]
006A208E    mov byte ptr ss:[ebp-0x04], 0x05
006A2092    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
006A2098    push eax
006A2099    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006A20B2    jz 0x006A20CF                                   ; => [ Data: data_cf65bc ]
006A20B4    lea ecx, ss:[ebp+0x08]
006A20B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A20CA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A20CF    mov byte ptr ss:[ebp-0x04], 0x07
006A20D3    cmp dword ptr ds:[0x00CF65BC], 0x00
006A20DA    jz 0x006A210A                                   ; => [ Data: data_cf65bc ]
...
006A20EB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A20FE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A2103    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006A2121    jz 0x006A213E                                   ; => [ Data: data_cf65bc ]
006A2123    lea ecx, ss:[ebp-0x1C]
006A2126    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A2139    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A213E    mov eax, ebx
006A2140    mov ecx, dword ptr ss:[ebp-0x0C]
006A2143    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A214A    pop ecx
006A214B    pop edi
006A214C    pop esi
006A214D    pop ebx
