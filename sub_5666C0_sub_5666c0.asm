...
005666CB    call 0x00761E50                                 ; => [ Call: __chkstk ]
005666D0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005666E8    push edi
005666E9    push eax
005666EA    call 0x00568780                                 ; => [ Call: sub_568780 ]
005666EF    add esp, 0x04
005666F2    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
00566761    push 0x20
00566763    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00566794    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
...
005667AD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005667B2    mov esp, ebp
005667B4    pop ebp
005667B5    ret
005667B6    call 0x00573400                                 ; => [ Call: sub_573400 ]
005667BB    push 0x00
005667BD    sub esp, 0x10
005667C0    lea edx, ss:[esp+0xD0C]
005667C7    mov ecx, dword ptr ds:[eax+0x04]
005667CA    push 0x3EA
005667CF    call 0x00579A20                                 ; => [ Call: sub_579a20 ]
...
005667E9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
