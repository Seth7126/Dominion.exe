...
006DD7E2    mov dword ptr fs:[0x00000000], eax
006DD7E8    mov esi, ecx
006DD7EA    mov dl, 0x01
006DD7EC    call 0x006DD740
006DD7F1    mov ebx, dword ptr ds:[0x0147ABE8]
006DD7F7    test ebx, ebx
006DD7F9    jnz 0x006DD811
006DD7FB    push 0x871F88
006DD800    push 0x45
006DD802    push 0x871FA0
006DD807    mov ecx, 0x871F94
...
006DD915    mov dword ptr fs:[0x00000000], ecx
006DD91C    pop ecx
006DD91D    pop edi
006DD91E    pop esi
006DD91F    pop ebx
...
006DD922    pop ebp
006DD923    ret
006DD924    push 0x881AC8
006DD929    push 0x112
006DD92E    push 0x825828
006DD933    mov ecx, 0x8736D4
006DD938    mov edx, 0x801800
006DD93D    call 0x0063B870
006DD942    add esp, 0x0C
006DD945    call 0x0063BC30
006DD94A    test al, al
006DD94C    jz 0x006DD94F
006DD94E    int3
006DD94F    call 0x0063BB00
