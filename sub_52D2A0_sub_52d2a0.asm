...
0052D2AB    call 0x00761E50                                 ; => [ Call: __chkstk ]
0052D2B0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0052D2E9    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_5685f0 ]
...
0052D3AE    push 0x476
0052D3B3    push esi
0052D3B4    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0052D3B9    add esp, 0x1C
0052D3BC    pop edi
0052D3BD    pop esi
0052D3BE    mov ecx, dword ptr ss:[esp+0x191C]
0052D3C5    xor ecx, esp
0052D3C7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0052D411    push 0x476
0052D416    push esi
0052D417    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0052D41C    add esp, 0x1C
0052D41F    mov ecx, dword ptr ss:[esp+0x1924]
0052D426    pop edi
0052D427    pop esi
0052D428    xor ecx, esp
0052D42A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
