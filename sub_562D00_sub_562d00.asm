...
00562D18    push 0x765D0B                                   ; => [ Type: EHRegistrationNode | Call: sub_765d0b ]
00562D1D    mov eax, dword ptr fs:[0x00000000]
00562D23    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00562D24    push ebx
00562D25    mov eax, 0x2630
00562D2A    call 0x00761E50                                 ; => [ Call: __chkstk ]
00562D2F    mov eax, dword ptr ds:[0x008C4040]
00562D34    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00562D36    mov dword ptr ss:[ebp-0x14], eax
00562D39    push esi
00562D3A    push edi
00562D3B    push eax
00562D3C    lea eax, ss:[ebp-0x0C]
00562D3F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00562D45    lea eax, ss:[ebp-0x19B8]
00562D4B    mov dword ptr ss:[ebp-0xCA8], 0x104
00562D55    push eax
00562D56    mov ecx, 0x3EA
00562D5B    call 0x00568780                                 ; => [ Call: sub_568780 ]
00562D60    mov esi, eax
00562D62    mov dword ptr ss:[ebp-0xD00], 0x81F344          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_86d77341cb13661f5befa60f8d6560d5>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_86d77341cb13661f5befa60f8d6560d5>,bool,enum CardID>::VTable ]
...
00562D8C    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00562D8E    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_86d77341cb13661f5befa60f8d6560d5>,bool,enum CardID>::VTable ]
...
00562DCF    call eax                                        ; => [ Field: vFunc_0 ]
...
00562DF2    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
00562E09    push eax
00562E0A    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00562E0D    xorps xmm0, xmm0
00562E10    mov dword ptr ss:[ebp-0xCCC], 0x00
00562E1A    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
00562EB7    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
