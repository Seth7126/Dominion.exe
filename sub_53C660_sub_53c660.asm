...
0053C670    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0053C682    push esi
0053C683    push edi
0053C684    push eax                                        ; => [ Data: __security_cookie ]
0053C685    lea eax, ss:[ebp-0x0C]
0053C688    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053C68E    mov edx, 0x04
0053C693    mov ecx, 0x100
0053C698    call 0x00563820
0053C69D    cmp al, 0x01
0053C69F    jz 0x0053C7C2                                   ; => [ Call: sub_563820 ]
...
0053C717    mov dword ptr ss:[ebp-0xCA4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_49d75f4efc8fd7809ac3f7ea885f7ade>,bool,enum CardID>::VTable ]
...
0053C7C7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053C7CE    pop ecx
0053C7CF    pop edi
0053C7D0    pop esi
0053C7D1    pop ebx
...
0053C7D7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
