...
006830DC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006830F1    push eax
006830F2    call 0x0064B1B0                                 ; => [ Call: sub_64b1b0 ]
...
0068312D    movss dword ptr ss:[esp+0xDC], xmm0             ; => [ Call: sub_4ae0d0 ]
00683136    movss xmm0, dword ptr ds:[0x008910D8]
0068313E    call 0x004AE0F0                                 ; => [ Call: sub_4ae0f0 ]
...
00683188    call 0x006875E0                                 ; => [ Call: sub_6875e0 ]
...
006831C3    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
006831DD    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
00683205    call 0x00649CC0                                 ; => [ Call: sub_649cc0 ]
0068320A    mov ecx, dword ptr ss:[esp+0xEC]
00683211    pop esi
00683212    xor ecx, esp
00683214    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
