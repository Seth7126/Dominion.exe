...
0063E815    push 0x76C576                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$copy_wide_to_narrow_find_data@U_wfinddata64i32_t@@U_finddata64i32_t@@@@YA_NABU_wfinddata64i32_t@@AAU_finddata64i32_t@@I@Z ]
0063E81A    mov eax, dword ptr fs:[0x00000000]
0063E820    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0063E82E    push eax                                        ; => [ Data: __security_cookie ]
0063E82F    lea eax, ss:[ebp-0x0C]
0063E832    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0063E838    mov dword ptr ss:[ebp-0x10], ecx
0063E83B    lea ecx, ss:[ebp-0x14]
0063E83E    mov dword ptr ss:[ebp-0x18], 0x00
0063E845    call 0x0063E630                                 ; => [ Call: sub_63e630 ]
...
0063E8B0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0063E8B5    inc dword ptr ds:[eax+0x04]
0063E8B8    jmp 0x0063E8D2
0063E8BA    test eax, eax
0063E8BC    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
0063E8F8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063E90B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063E910    mov eax, esi
0063E912    mov ecx, dword ptr ss:[ebp-0x0C]
0063E915    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063E91C    pop ecx
0063E91D    pop edi
0063E91E    pop esi
0063E91F    pop ebx
...
0063E93D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
0063E942    add esp, 0x0C
0063E945    call 0x0063BC30
0063E94A    test al, al
0063E94C    jz 0x0063E94F                                   ; => [ Call: sub_63bc30 ]
0063E94E    int3
0063E94F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
