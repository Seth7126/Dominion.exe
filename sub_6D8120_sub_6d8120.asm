...
006D8137    call 0x006DD320                                 ; => [ Call: sub_6dd320 | Data: data_8ce7bc ]
...
006D815A    movzx eax, byte ptr ds:[eax+0x6D82EC]           ; => [ Data: lookup_table_6d82ec ]
...
006D8178    mov dword ptr ds:[esi+0x04], eax                ; => [ Call: sub_6dcf50 | Data: data_8ce7bc ]
...
006D8198    mov dword ptr ds:[esi+0x04], eax                ; => [ Call: sub_6dd090 | Data: data_8ce7bc ]
...
006D81B3    mov dword ptr ds:[esi+0x04], eax                ; => [ Call: sub_6dcff0 | Data: data_8ce7bc ]
...
006D81CB    mov dword ptr ds:[esi+0x04], eax                ; => [ Call: sub_6dd280 | Data: data_8ce7bc ]
006D81CE    jmp 0x006D8282
006D81D3    push edi
006D81D4    push dword ptr ds:[0x01724A70]
006D81DA    mov edx, ebx
006D81DC    mov ecx, 0x8CE7BC
006D81E1    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Data: data_1724a70 | Data: data_8ce7bc ]
...
006D8223    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Data: data_1724a6c | Data: data_8ce7bc ]
006D8228    mov ecx, eax
006D822A    add esp, 0x08
006D822D    test ecx, ecx
006D822F    jnz 0x006D8242
006D8231    push 0x8805F4                                   ; => [ String: sMaterialFunctionalRenderStateValueFromConstant ]
006D8236    push 0x287
006D823B    mov ecx, 0x880524                               ; => [ String: pColor ]
...
006D824D    call 0x0064B360                                 ; => [ Call: sub_64b360 ]
...
006D829C    pop ebp
006D829D    ret                                             ; => [ Data: data_147b070 ]
006D829E    dword 8805F468                                  ; => [ String: sMaterialFunctionalRenderStateValueFromConstant ]
006D82A2    byte 0
006D82A3    push 0x28C
006D82A8    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006D82AD    push 0x88052C                                   ; => [ String: C:\x\ax2017\Engine\Material.cpp ]
006D82B2    mov edx, 0x801800
006D82B7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006D82BC    add esp, 0x0C
006D82BF    call 0x0063BC30
006D82C4    test al, al
006D82C6    jz 0x006D82C9                                   ; => [ Call: sub_63bc30 ]
006D82C8    int3
006D82C9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
