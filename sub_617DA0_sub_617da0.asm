...
00617DC9    movzx eax, byte ptr ds:[eax+0x617FB4]
...
00617E37    mov eax, dword ptr ds:[0x00CC8DC0]
00617E3C    test eax, eax
00617E3E    jnz 0x00617E59
00617E40    push 0x806A44
00617E45    push 0x5FB
00617E4A    push 0x806734
00617E4F    mov ecx, 0x806A58
...
00617E6B    push 0x8689D8
00617E70    push 0xCB8A
00617E75    mov ecx, 0x868A08
...
00617E8E    push 0x8689D8
00617E93    push 0xCB9D
00617E98    jmp 0x00617F75
00617E9D    mov ecx, dword ptr ds:[esi+0x0C]
00617EA0    mov eax, dword ptr ds:[0x00CC8D5C]
00617EA5    jmp 0x00617F02
00617EA7    mov ecx, dword ptr ds:[esi+0x08]
00617EAA    mov eax, dword ptr ds:[0x00CC8D5C]
00617EAF    jmp 0x00617F02
00617EB1    mov eax, dword ptr ds:[0x00CC8D5C]
00617EB6    test eax, eax
00617EB8    jnz 0x00617ED0
00617EBA    push 0x77EB90
00617EBF    push 0x7B
00617EC1    push 0x77EB50
00617EC6    mov ecx, 0x77EB9C
...
00617EEC    jnz 0x00617EFA
00617EEE    mov ecx, dword ptr ds:[esi+0x04]
00617EF1    mov eax, dword ptr ds:[0x00CC8D5C]
00617EF6    add ecx, ecx
00617EF8    jmp 0x00617F02
00617EFA    mov eax, dword ptr ds:[0x00CC8D5C]
...
00617F10    mov edi, dword ptr ds:[0x019E39EC]
00617F16    cmp edi, eax
00617F18    jl 0x00617F26
00617F1A    mov esi, dword ptr ds:[0x019E39E8]
...
00617F2F    mov dword ptr ds:[0x019E39E8], eax
00617F34    adc edx, edi
00617F36    mov dword ptr ds:[0x019E39EC], edx
00617F3C    pop edi
...
00617F4F    cmp dword ptr ds:[0x019E39EC], edi
00617F55    jnle 0x00617DAE
00617F5B    jl 0x00617F2A
00617F5D    cmp dword ptr ds:[0x019E39E8], esi
00617F63    jnbe 0x00617DAE
00617F69    jmp 0x00617F2A
00617F6B    push 0x8689F8
00617F70    push 0xCC1F
00617F75    mov ecx, 0x801AA4
00617F7A    push 0x86F1E8
00617F7F    mov edx, 0x801800
00617F84    call 0x0063B870
00617F89    add esp, 0x0C
00617F8C    call 0x0063BC30
00617F91    test al, al
00617F93    jz 0x00617F96
00617F95    int3
00617F96    call 0x0063BB00
