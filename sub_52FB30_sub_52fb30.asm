...
0052FB48    push 0x765D0B                                   ; => [ Type: EHRegistrationNode | Call: sub_765d0b ]
0052FB4D    mov eax, dword ptr fs:[0x00000000]
0052FB53    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0052FB54    push ebx
0052FB55    mov eax, 0x2630
0052FB5A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0052FB5F    mov eax, dword ptr ds:[0x008C4040]
0052FB64    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0052FB66    mov dword ptr ss:[ebp-0x14], eax
0052FB69    push esi
0052FB6A    push edi
0052FB6B    push eax
0052FB6C    lea eax, ss:[ebp-0x0C]
0052FB6F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0052FB75    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052FB7A    mov esi, eax
0052FB7C    cmp dword ptr ds:[esi+0x40], 0x00
0052FB80    jnz 0x0052FB87
0052FB82    call 0x00591930                                 ; => [ Call: sub_591930 ]
0052FB87    mov eax, dword ptr ds:[esi+0x40]
0052FB8A    mov dword ptr ss:[ebp-0xCA8], eax
0052FB90    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052FB95    lea ecx, ss:[ebp-0x19B8]
0052FB9B    push 0x04
0052FB9D    push ecx
0052FB9E    mov edx, dword ptr ds:[eax+0x0C]
0052FBA1    mov ecx, dword ptr ds:[eax+0x04]
0052FBA4    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0052FBA9    mov ecx, 0x321
0052FBAE    mov dword ptr ss:[ebp-0xD38], eax
0052FBB4    lea esi, ss:[ebp-0x19B8]
0052FBBA    mov dword ptr ss:[ebp-0xD00], 0x819188          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_855aba401808d1fc3830d0c3dd5cd769>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_855aba401808d1fc3830d0c3dd5cd769>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0052FBC4    lea edi, ss:[ebp-0xCA0]
0052FBCA    add esp, 0x08
0052FBCD    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0052FBCF    lea ecx, ss:[ebp-0xCA8]
0052FBD5    mov dword ptr ss:[ebp-0xCFC], ecx
0052FBDB    lea ecx, ss:[ebp-0xD00]
0052FBE1    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_855aba401808d1fc3830d0c3dd5cd769>,bool,enum CardID>::VTable ]
...
0052FC22    call eax
0052FC24    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
0052FC4A    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0052FC61    push eax
0052FC62    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0052FC65    mov esi, dword ptr ss:[ebp-0xCA8]
0052FC6B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052FC87    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052FCA7    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
...
0052FCDC    movlpd qword ptr ss:[ebp-0xCC4], xmm0           ; => [ Call: __builtin_memset ]
...
0052FD6D    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052FD72    push 0x04
0052FD74    push 0x00
0052FD76    push 0x00
...
0052FD85    push 0x476
0052FD8A    push esi
0052FD8B    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0052FD90    add esp, 0x1C
0052FD93    mov ecx, dword ptr ss:[ebp-0x0C]
0052FD96    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0052FD9D    pop ecx
0052FD9E    pop edi
0052FD9F    pop esi
0052FDA0    mov ecx, dword ptr ss:[ebp-0x14]
0052FDA3    xor ecx, ebp
0052FDA5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
