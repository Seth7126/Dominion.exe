...
004BA1D6    mov ecx, dword ptr ds:[0x00CC8D5C]
004BA1DC    push esi
004BA1DD    test ecx, ecx
004BA1DF    jnz 0x004BA1F7
004BA1E1    push 0x77EB90
004BA1E6    push 0x7B
004BA1E8    push 0x77EB50
004BA1ED    mov ecx, 0x77EB9C
004BA1F2    jmp 0x004BA373
004BA1F7    push eax
004BA1F8    add ecx, 0x75B8
004BA1FE    call 0x004BADC0
...
004BA35D    pop ebp
004BA35E    ret
004BA35F    push 0x802510
004BA364    push 0x160E
004BA369    mov ecx, 0x801AA4
004BA36E    push 0x801AF8
004BA373    mov edx, 0x801800
004BA378    call 0x0063B870
004BA37D    add esp, 0x0C
004BA380    call 0x0063BC30
004BA385    test al, al
004BA387    jz 0x004BA38A
004BA389    int3
004BA38A    call 0x0063BB00
