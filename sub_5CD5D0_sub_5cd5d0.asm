...
005CD60B    jnb 0x005CD7A1
005CD611    imul eax, eax, 0x1C30
005CD617    add eax, dword ptr ds:[0x00B809E0]
...
005CD67A    jnb 0x005CD7A1
005CD680    imul esi, eax, 0x1C30
005CD686    add esi, dword ptr ds:[0x00B809E0]
...
005CD731    pop ebx
005CD732    call 0x0075927A
005CD737    mov esp, ebp
005CD739    pop ebp
005CD73A    ret
005CD73B    push 0x86F648
005CD740    push 0xCF3
005CD745    push 0x86F1E8
005CD74A    mov ecx, 0x86F5C4
005CD74F    jmp 0x005CD7B2
005CD751    push 0x86F648
005CD756    push 0xCF2
005CD75B    push 0x86F1E8
005CD760    mov ecx, 0x86F5B4
005CD765    jmp 0x005CD7B2
005CD767    push 0x86E294
005CD76C    push 0x6C
005CD76E    mov ecx, 0x802734
005CD773    jmp 0x005CD7AD
005CD775    push 0x86F648
005CD77A    push 0xD03
005CD77F    push 0x86F1E8
005CD784    mov ecx, 0x86F5C4
005CD789    jmp 0x005CD7B2
005CD78B    push 0x86F648
005CD790    push 0xD01
005CD795    push 0x86F1E8
005CD79A    mov ecx, 0x86F5B4
005CD79F    jmp 0x005CD7B2
005CD7A1    push 0x86E294
005CD7A6    push 0x6D
005CD7A8    mov ecx, 0x802748
005CD7AD    push 0x80193C
005CD7B2    mov edx, 0x801800
005CD7B7    call 0x0063B870
005CD7BC    add esp, 0x0C
005CD7BF    call 0x0063BC30
005CD7C4    test al, al
005CD7C6    jz 0x005CD7C9
005CD7C8    int3
005CD7C9    call 0x0063BB00
