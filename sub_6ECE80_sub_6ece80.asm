...
006ECEF4    call 0x006ECD70                                 ; => [ Call: sub_6ecd70 | Call: sub_63df30 | String: float4 %s(float2 arg_uv, float4 diffuse)\n{\n ]
006ECEF9    mov dword ptr ss:[ebp-0x04], 0x01
006ECF00    cmp dword ptr ds:[0x00CF65BC], 0x00
006ECF07    jz 0x006ECF37                                   ; => [ Data: data_cf65bc ]
...
006ECF18    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECF2B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECF30    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006ECF37    mov edx, 0x8830AC
006ECF3C    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006ECF43    lea ecx, ss:[ebp-0x10]
006ECF46    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: \treturn retval;\n}\n ]
006ECF4B    mov dword ptr ss:[ebp-0x04], 0x02
006ECF52    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
006ECF75    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
006ECF91    jz 0x006ECFB5                                   ; => [ Data: data_cf65bc ]
006ECF93    lea ecx, ss:[ebp-0x10]
006ECF96    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECFA9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECFAE    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006ECFD0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006ECFD7    pop ecx
006ECFD8    pop edi
006ECFD9    pop esi
...
006ECFF2    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\MaterialFnDef.cpp | Data: data_801800 | String: EmitFnEndLine | String: emitResults.currentFunctionStackDepth > 0 ]
006ECFF7    add esp, 0x0C
006ECFFA    call 0x0063BC30
006ECFFF    test al, al
006ED001    jz 0x006ED004                                   ; => [ Call: sub_63bc30 ]
006ED003    int3
006ED004    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006ED009    push 0x882FB4                                   ; => [ String: EmitFnEnd ]
006ED00E    push 0x39B
006ED013    push 0x882BB8
006ED018    mov edx, 0x801800
006ED01D    mov ecx, 0x883018
006ED022    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Engine\MaterialFnDef.cpp | Call: sub_63b870 | Data: data_801800 | String: emitResults.currentFunctionStackDepth > 0 ]
006ED027    add esp, 0x0C
006ED02A    call 0x0063BC30
006ED02F    test al, al
006ED031    jz 0x006ED034                                   ; => [ Call: sub_63bc30 ]
006ED033    int3
006ED034    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
