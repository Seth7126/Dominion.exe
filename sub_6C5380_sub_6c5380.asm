...
006C5385    push 0x770366                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$__acrt_lock_and_call@V<lambda_6c00ff020565541b7bec2b9d9869f0ef>@@@@YA_NW4__acrt_lock_id@@$$QAV<lambda_6c00ff020565541b7bec2b9d9869f0ef>@@@Z ]
006C538A    mov eax, dword ptr fs:[0x00000000]
006C5390    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C5391    sub esp, 0x10
006C5394    push esi
006C5395    mov eax, dword ptr ds:[0x008C4040]
006C539A    xor eax, ebp
006C539C    push eax                                        ; => [ Data: __security_cookie ]
006C539D    lea eax, ss:[ebp-0x0C]
006C53A0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C5442    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C54BC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C54DC    jz 0x006C5502                                   ; => [ Data: data_cf65bc ]
...
006C54EA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C54FD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5502    mov eax, esi
006C5504    mov ecx, dword ptr ss:[ebp-0x0C]
006C5507    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C550E    pop ecx
006C550F    pop esi
