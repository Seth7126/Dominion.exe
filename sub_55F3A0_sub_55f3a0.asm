...
0055F3B8    push 0x76572B                                   ; => [ Call: sub_76572b | Type: EHRegistrationNode ]
0055F3BD    mov eax, dword ptr fs:[0x00000000]
0055F3C3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0055F3C4    push ebx
0055F3C5    mov eax, 0x2630
0055F3CA    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055F3CF    mov eax, dword ptr ds:[0x008C4040]
0055F3D4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0055F3D6    mov dword ptr ss:[ebp-0x14], eax
0055F3D9    push esi
0055F3DA    push edi
0055F3DB    push eax
0055F3DC    lea eax, ss:[ebp-0x0C]
0055F3DF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0055F3E5    mov dword ptr ss:[ebp-0x1930], ecx
0055F3EB    lea eax, ss:[ebp-0x2640]
0055F3F1    mov ecx, 0x02
0055F3F6    push 0x7BFAB4
0055F3FB    push eax
0055F3FC    call 0x00566240                                 ; => [ Data: data_7bfab4 | Call: sub_566240 ]
0055F401    mov esi, eax
0055F403    mov dword ptr ss:[ebp-0x1988], 0x81E880         ; => [ Data: std::_Func_impl_no_alloc<class <lambda_85ee9da5d97228af7c1e02c7a83578b1>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_85ee9da5d97228af7c1e02c7a83578b1>,bool,enum CardID>::VTable ]
0055F40D    mov ecx, 0x321
0055F412    lea edi, ss:[ebp-0xCA0]
0055F418    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0055F430    mov dword ptr ss:[ebp-0x1964], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_85ee9da5d97228af7c1e02c7a83578b1>,bool,enum CardID>::VTable ]
0055F436    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0055F473    call eax                                        ; => [ Field: vFunc_0 ]
...
0055F484    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0055F4B5    push eax
0055F4B6    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0055F4B9    test esi, esi
0055F4BB    jz 0x0055F5B5
0055F4C1    mov ecx, 0x01
0055F4C6    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
0055F4CB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055F4E6    movlpd qword ptr ss:[ebp-0x194C], xmm0          ; => [ Call: __builtin_memset ]
...
0055F563    call 0x00563B20                                 ; => [ Call: sub_563b20 ]
...
0055F580    call 0x00562400                                 ; => [ Call: sub_562400 ]
...
0055F5B7    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
0055F5BC    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055F5EC    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
0055F5F1    add esp, 0x28
0055F5F4    mov ecx, dword ptr ss:[ebp-0x0C]
0055F5F7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055F5FE    pop ecx
0055F5FF    pop edi
0055F600    pop esi
0055F601    mov ecx, dword ptr ss:[ebp-0x14]
0055F604    xor ecx, ebp
0055F606    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
