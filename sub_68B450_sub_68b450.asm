...
0068B470    push esi
0068B471    push edi
0068B472    jz 0x0068B6DF                                   ; => [ Data: data_147abf4 ]
0068B478    xor esi, esi                                    ; => [ Call: nullptr ]
0068B47A    nop word ptr ds:[eax+eax*1], ax
0068B480    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
0068B4B0    xor esi, esi                                    ; => [ Call: nullptr ]
0068B4B2    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
0068B4B8    test esi, esi
0068B4BA    jnz 0x0068B549
0068B4C0    mov esi, dword ptr ds:[ecx]
0068B4C2    jmp 0x0068B54C
0068B4C7    mov ecx, dword ptr ds:[0x0147ABF8]              ; => [ Data: data_147abf8 ]
0068B4CD    lea edx, ss:[ebp-0x20]
0068B4D0    mov eax, dword ptr ds:[esi+0x08]
0068B4D3    xorps xmm0, xmm0
0068B4D6    movaps xmmword ptr ss:[ebp-0x20], xmm0          ; => [ Call: __builtin_memset ]
...
0068B4F2    call 0x00689090                                 ; => [ Call: sub_689090 ]
...
0068B525    call 0x006891A0                                 ; => [ Call: sub_6891a0 ]
...
0068B53C    call eax
0068B53E    mov edi, eax                                    ; => [ Data: data_147abf8 ]
...
0068B566    mov esi, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
0068B5B3    push 0x877AEC                                   ; => [ String: NetworkUpdateReceive ]
0068B5B8    push 0x681
0068B5BD    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0068B5C2    jmp 0x0068B6F7
0068B5C7    mov ecx, esi
0068B5C9    call 0x0068AA70                                 ; => [ Call: sub_68aa70 ]
...
0068B5FA    call 0x0068ADC0                                 ; => [ Call: sub_68adc0 ]
0068B5FF    jmp 0x0068B608
0068B601    mov ecx, esi
0068B603    call 0x0068ABB0                                 ; => [ Call: sub_68abb0 ]
...
0068B630    push 0x877A84                                   ; => [ String: NetworkLocReceive ]
0068B635    push 0x5D5
0068B63A    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0068B63F    jmp 0x0068B6F7
0068B644    mov ecx, esi
0068B646    call 0x0068A830                                 ; => [ Call: sub_68a830 ]
0068B64B    jmp 0x0068B4B2
0068B650    mov ecx, esi
0068B652    call 0x0068A4B0                                 ; => [ Call: sub_68a4b0 ]
0068B657    jmp 0x0068B4B2
0068B65C    push 0x877A84                                   ; => [ String: NetworkLocReceive ]
0068B661    push 0x5C1
0068B666    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
0068B6B0    mov edx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
0068B6D0    call 0x006892C0                                 ; => [ Call: sub_6892c0 ]
...
0068B6E6    pop ebx
0068B6E7    ret
0068B6E8    push 0x877A98                                   ; => [ String: NetworkProcessMessages ]
0068B6ED    push 0x63F
0068B6F2    mov ecx, 0x877AC4                               ; => [ String: message->messageType > NETMSG_MIN_VALUE ]
0068B6F7    push 0x8773A8
0068B6FC    mov edx, 0x801800
0068B701    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Network.cpp ]
0068B706    add esp, 0x0C
0068B709    call 0x0063BC30
0068B70E    test al, al
0068B710    jz 0x0068B713                                   ; => [ Call: sub_63bc30 ]
0068B712    int3
0068B713    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
