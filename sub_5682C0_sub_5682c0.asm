...
005682C6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005682D5    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005682EB    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00568301    push ebx
00568302    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
...
00568319    movups xmm1, xmmword ptr ds:[eax]               ; => [ Call: sub_576c00 ]
0056831C    lea eax, ss:[ebp-0x50]
0056831F    push eax
00568320    movups xmmword ptr ss:[ebp-0x34], xmm1
00568324    call 0x00576C00                                 ; => [ Call: sub_576c00 ]
...
00568362    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00568374    pop ebx
00568375    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
