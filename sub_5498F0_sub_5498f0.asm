...
00549905    test al, al
00549907    jz 0x00549971
00549909    call 0x00573400
0054990E    mov eax, dword ptr ds:[eax+0x64]
...
00549990    call 0x0063B870
00549995    add esp, 0x0C
00549998    call 0x0063BC30
0054999D    test al, al
0054999F    jz 0x005499A2
005499A1    int3
005499A2    call 0x0063BB00
