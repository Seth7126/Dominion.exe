...
00677765    push 0x76D925                                   ; => [ Call: sub_76d925 | Type: EHRegistrationNode ]
0067776A    mov eax, dword ptr fs:[0x00000000]
00677770    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0067777E    push eax                                        ; => [ Data: __security_cookie ]
0067777F    lea eax, ss:[ebp-0x0C]
00677782    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006777AB    mov esi, dword ptr ds:[esi]                     ; => [ Data: data_147d094 ]
...
006777BC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006777DC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006777E1    inc dword ptr ds:[eax+0x04]
006777E4    lea ecx, ss:[ebp-0x10]
006777E7    call 0x006C5250                                 ; => [ Type: MESSAGEBOX_RESULT | Call: sub_6c5250 ]
...
00677805    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0067780A    inc dword ptr ds:[eax+0x04]
0067780D    lea eax, ss:[ebp-0x14]
00677810    mov byte ptr ss:[ebp-0x04], 0x02
00677814    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
0067781A    push eax
0067781B    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
00677834    jz 0x00677851                                   ; => [ Data: data_cf65bc ]
00677836    lea ecx, ss:[ebp-0x14]
00677839    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677889    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0067788E    inc dword ptr ds:[eax+0x04]
00677891    lea eax, ss:[ebp-0x14]
00677894    mov byte ptr ss:[ebp-0x04], 0x04
00677898    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
0067789E    push eax
0067789F    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006778B8    jz 0x006778D5                                   ; => [ Data: data_cf65bc ]
006778BA    lea ecx, ss:[ebp-0x14]
006778BD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006778D0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006778E3    push ebx
006778E4    call 0x006F9E10                                 ; => [ Call: sub_6f9e10 ]
006778E9    add esp, 0x04
006778EC    mov ecx, ebx
006778EE    call 0x006A3220                                 ; => [ Call: sub_6a3220 ]
006778F3    mov edi, dword ptr ss:[ebp-0x24]
006778F6    mov ecx, edi
006778F8    call 0x0069FC10                                 ; => [ Type: MESSAGEBOX_RESULT | Call: sub_69fc10 ]
006778FD    test al, al
006778FF    jnz 0x00677990
00677905    mov eax, dword ptr ds:[edi+0x20]
00677908    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
0067790D    test eax, eax
0067790F    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
00677926    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: Failed to save '%s'. ]
00677928    test eax, eax
0067792A    cmovnz ebx, eax
0067792D    call dword ptr ds:[0x007753B8]
00677933    mov edi, eax                                    ; => [ Type: HWND ]
...
0067794B    push ecx                                        ; => [ Call: nullptr ]
0067794C    push 0x8767FC
00677951    cmovnz edi, ecx                                 ; => [ Call: nullptr ]
00677954    push ebx
00677955    push edi
00677956    call dword ptr ds:[0x007753B0]                  ; => [ String: Can't save ]
0067795C    mov byte ptr ss:[ebp-0x04], 0x06
00677960    cmp dword ptr ds:[0x00CF65BC], 0x00
00677967    jz 0x00677990                                   ; => [ Data: data_cf65bc ]
...
00677978    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067798B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00677990    mov byte ptr ss:[ebp-0x04], 0x07
00677994    cmp dword ptr ds:[0x00CF65BC], 0x00
0067799B    jz 0x006779CB                                   ; => [ Data: data_cf65bc ]
...
006779AC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006779BF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006779C4    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006779E2    jz 0x006779FF                                   ; => [ Data: data_cf65bc ]
006779E4    lea ecx, ss:[ebp-0x18]
006779E7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006779FA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006779FF    mov ecx, dword ptr ss:[ebp-0x0C]
00677A02    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00677A09    pop ecx
00677A0A    pop edi
00677A0B    pop esi
00677A0C    pop ebx
...
00677A0F    pop ebp
00677A10    ret
00677A11    push 0x8767F0                                   ; => [ String: AssetSave ]
00677A16    push 0x53BC
00677A1B    push 0x8739B4
00677A20    mov edx, 0x801800
00677A25    mov ecx, 0x8767A8
00677A2A    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: (pDefHeader->defFlags & DEF_FIELD_FLAG_DO_NOT_WRITE_TO_PARSETREE) == 0 | String: C:\x\ax2017\Engine\UI2.cpp ]
00677A2F    add esp, 0x0C
00677A32    call 0x0063BC30
00677A37    test al, al
00677A39    jz 0x00677A3C                                   ; => [ Call: sub_63bc30 ]
00677A3B    int3
00677A3C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
