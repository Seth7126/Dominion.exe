...
0074CAF6    push 0x00
0074CAF8    call dword ptr ds:[0x00775344]                  ; => [ Call: nullptr | String: ComboBox | Type: HWND ]
...
0074CB11    push esi
0074CB12    call dword ptr ds:[0x00775424]                  ; => [ Data: data_88ff34 ]
0074CB18    push 0x00
0074CB1A    push 0x11
...
0074CB3B    push esi
0074CB3C    call dword ptr ds:[0x00775410]                  ; => [ String: Wprc ]
0074CB42    push 0x74C630
0074CB47    push 0xFFFFFFFC
0074CB49    push esi
0074CB4A    call dword ptr ds:[0x007753D8]                  ; => [ Call: sub_74c630 ]
