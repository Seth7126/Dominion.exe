...
005383A8    call 0x00761E50
005383AD    mov eax, dword ptr ds:[0x008C4040]
005383B2    xor eax, ebp
...
00538412    call 0x00561E00
00538417    sub esp, 0x20
0053841A    mov eax, esp
0053841C    mov dword ptr ds:[eax], 0x81A328
00538422    mov dword ptr ds:[eax+0x24], eax
00538425    call 0x005699B0
0053842A    mov ecx, dword ptr ss:[ebp-0x04]
0053842D    add esp, 0x28
00538430    xor ecx, ebp
00538432    pop edi
00538433    pop esi
00538434    call 0x0075927A
