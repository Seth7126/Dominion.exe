...
0058B898    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
0058B8BF    call 0x0057DA30                                 ; => [ Call: sub_57da30 ]
0058B8C4    push 0x00
0058B8C6    push 0x00
0058B8C8    push eax
0058B8C9    push 0x22
...
0058B8D9    jle 0x0058B8DE                                  ; => [ Call: sub_576b30 ]
...
0058B8FB    mov eax, dword ptr fs:[0x0000002C]              ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
0058B918    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
0058B94B    mov dword ptr ss:[ebp-0x08], 0x00               ; => [ Call: nullptr ]
...
0058B97B    call 0x0057DA30                                 ; => [ Call: sub_57da30 ]
...
0058B9CE    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: cs.numContexts > 0 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: DomPopContext ]
0058B9D3    add esp, 0x0C
0058B9D6    call 0x0063BC30
0058B9DB    test al, al
0058B9DD    jz 0x0058B9E0                                   ; => [ Call: sub_63bc30 ]
0058B9DF    int3
0058B9E0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
