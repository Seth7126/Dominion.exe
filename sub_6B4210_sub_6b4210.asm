...
006B4215    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
006B421A    mov eax, dword ptr fs:[0x00000000]
006B4220    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B4221    sub esp, 0x08
006B4224    push esi
006B4225    push edi
006B4226    mov eax, dword ptr ds:[0x008C4040]
006B422B    xor eax, ebp
006B422D    push eax                                        ; => [ Data: __security_cookie ]
006B422E    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006B4231    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006B4237    mov edi, edx
006B4239    mov esi, ecx                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006B423B    test edi, edi
006B423D    jns 0x006B4258
006B423F    push 0x87CA6C                                   ; => [ String: FontHasCharacter ]
006B4244    push 0x21B
006B4249    push 0x87CA3C                                   ; => [ String: C:\x\ax2017\Engine\Font.cpp ]
006B424E    mov ecx, 0x87CAC4                               ; => [ String: unicode >= 0 ]
...
006B4266    call 0x0069FD50                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | String: !Null\Null | Call: sub_69fd50 ]
006B426B    add esp, 0x04
006B426E    mov dword ptr ss:[ebp-0x04], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006B4271    lea edx, ds:[esi+0x12]
006B4274    mov eax, dword ptr ss:[ebp-0x10]
006B4277    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006B427C    test eax, eax
006B427E    cmovnz ecx, eax
006B4281    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
006B4286    mov esi, eax
006B4288    mov dword ptr ss:[ebp-0x04], 0x01
006B428F    cmp dword ptr ds:[0x00CF65BC], 0x00
006B4296    jz 0x006B42C6                                   ; => [ Data: data_cf65bc ]
...
006B42A7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B42BA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B42BF    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006B42E4    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006B42F7    mov eax, dword ptr ds:[eax]                     ; => [ Field: Next | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006B4311    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B4318    pop ecx
006B4319    pop edi
006B431A    pop esi
...
006B4346    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B434D    pop ecx
006B434E    pop edi
006B434F    pop esi
...
006B4361    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B4368    pop ecx
006B4369    pop edi
006B436A    pop esi
...
006B436D    pop ebp
006B436E    ret
006B436F    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
006B4374    push 0x19
006B4376    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
006B437B    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
006B4380    mov edx, 0x801800
006B4385    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006B438A    add esp, 0x0C
006B438D    call 0x0063BC30
006B4392    test al, al
006B4394    jz 0x006B4397                                   ; => [ Call: sub_63bc30 ]
006B4396    int3
006B4397    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
