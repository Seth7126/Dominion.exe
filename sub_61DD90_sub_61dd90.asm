...
0061DDAA    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
0061DDAF    push 0x80
0061DDB4    push 0x00
0061DDB6    push esi
0061DDB7    mov ebx, eax
0061DDB9    call 0x00761FC4                                 ; => [ Call: memset ]
...
0061DE07    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061DE0C    mov dword ptr ds:[ebx+0x350C], 0x801800         ; => [ Data: data_801800 ]
...
0061DE2C    jz 0x0061DE5C                                   ; => [ Data: data_801800 ]
0061DE2E    cmp dword ptr ds:[0x00CF65BC], 0x00
0061DE35    jz 0x0061DE56
0061DE37    cmp byte ptr ds:[eax], 0x00
0061DE3A    jz 0x0061DE56                                   ; => [ Data: data_cf65bc ]
0061DE3C    mov ecx, esi
0061DE3E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0061DE51    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061DE56    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
0061DE5C    add esi, 0x04
0061DE5F    sub edi, 0x01
0061DE62    jnz 0x0061DE21
0061DE64    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
0061DE6A    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
0061DE87    call 0x005AC1B0                                 ; => [ Call: sub_5ac1b0 | Data: data_171efd0 ]
0061DE8C    pop edi
0061DE8D    pop esi
0061DE8E    mov dword ptr ds:[0x0171EFD0], 0x00             ; => [ Data: data_171efd0 ]
0061DE98    mov dword ptr ds:[0x01723FF4], 0x00             ; => [ Data: data_1723ff4 ]
0061DEA2    pop ebx
