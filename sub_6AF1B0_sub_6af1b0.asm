...
006AF1D4    mov dword ptr fs:[0x00000000], eax
...
006AF1F6    push 0x87BCDC
006AF1FB    push 0x304
006AF200    push 0x87B990
006AF205    mov ecx, 0x87BD38
...
006AF21A    push 0x87BCDC
006AF21F    push 0x305
006AF224    push 0x87B990
006AF229    mov ecx, 0x87BD14
...
006AF29B    call 0x0064C080
006AF2A0    mov dword ptr ss:[ebp-0x2C], 0x801800
...
006AF324    movups xmm0, xmmword ptr ds:[eax]
...
006AF369    push 0x87BCDC
006AF36E    push 0x30C
006AF373    mov ecx, 0x87BD5C
...
006AF3E4    mov dword ptr fs:[0x00000000], ecx
006AF3EB    pop ecx
006AF3EC    pop edi
006AF3ED    pop esi
006AF3EE    mov ecx, dword ptr ss:[ebp-0x10]
006AF3F1    xor ecx, ebp
006AF3F3    call 0x0075927A
006AF3F8    mov esp, ebp
006AF3FA    pop ebp
006AF3FB    ret 0x0C
006AF3FE    push 0x828280
006AF403    push 0x19
006AF405    push 0x82829C
006AF40A    mov ecx, 0x8282BC
006AF40F    mov edx, 0x801800
006AF414    call 0x0063B870
006AF419    add esp, 0x0C
006AF41C    call 0x0063BC30
006AF421    test al, al
006AF423    jz 0x006AF426
006AF425    int3
006AF426    call 0x0063BB00
006AF42B    push 0x87BCDC
006AF430    push 0x30B
006AF435    mov ecx, 0x87BD84
006AF43A    push 0x87B990
006AF43F    mov edx, 0x801800
006AF444    call 0x0063B870
006AF449    add esp, 0x0C
006AF44C    call 0x0063BC30
006AF451    test al, al
006AF453    jz 0x006AF456
006AF455    int3
006AF456    call 0x0063BB00
