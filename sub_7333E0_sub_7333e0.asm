...
007333FB    push eax
007333FC    lea eax, ss:[ebp-0x0C]
007333FF    mov dword ptr fs:[0x00000000], eax
...
00733417    call 0x004D6960
0073341C    mov edx, 0x10
00733421    mov ecx, edi
00733423    call 0x0064C080
...
00733443    mov dword ptr fs:[0x00000000], ecx
0073344A    pop ecx
0073344B    pop edi
0073344C    pop esi
0073344D    pop ebx
