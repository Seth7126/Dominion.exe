...
0064C025    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0064C03F    call 0x00687730                                 ; => [ Call: sub_687730 ]
0064C044    push ebx
0064C045    mov esi, eax
0064C047    push 0x00
0064C049    push esi
0064C04A    call 0x00761FC4                                 ; => [ Call: memset ]
...
0064C05F    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0064C06E    call 0x00761FC4                                 ; => [ Call: memset ]
