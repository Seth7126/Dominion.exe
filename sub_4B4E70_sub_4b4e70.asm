...
004B4E76    mov eax, dword ptr ds:[0x008C4040]
...
004B4EA1    push 0x80210C
004B4EA6    push 0xBCE
004B4EAB    push 0x801AF8
004B4EB0    mov ecx, 0x802128
004B4EB5    jmp 0x004B4F2C
004B4EB7    mov eax, dword ptr ds:[0x00CC8D5C]
004B4EBC    test eax, eax
004B4EBE    jz 0x004B4F1B
004B4EC0    mov eax, dword ptr ds:[eax+0x14]
004B4EC3    mov ecx, dword ptr ds:[0x0147ABF4]
