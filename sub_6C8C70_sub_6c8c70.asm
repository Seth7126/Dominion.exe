...
006C8C75    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
006C8C7A    mov eax, dword ptr fs:[0x00000000]
006C8C80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C8C81    sub esp, 0x08
006C8C84    push esi
006C8C85    push edi
006C8C86    mov eax, dword ptr ds:[0x008C4040]
006C8C8B    xor eax, ebp
006C8C8D    push eax                                        ; => [ Data: __security_cookie ]
006C8C8E    lea eax, ss:[ebp-0x0C]
006C8C91    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C8C97    mov edx, ecx
006C8C99    lea ecx, ss:[ebp-0x10]
006C8C9C    call 0x006C85B0                                 ; => [ Call: sub_6c85b0 ]
...
006C8CCB    push 0x87E5B4                                   ; => [ Data: data_87e5b4 ]
006C8CD0    push esi
006C8CD1    call edi
006C8CD3    add esp, 0x08
006C8CD6    test eax, eax
006C8CD8    jnz 0x006C8D83
006C8CDE    push 0x87E5D4                                   ; => [ Data: data_87e5d4 ]
006C8CE3    push esi
006C8CE4    call edi
...
006C8D02    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006C8D07    inc dword ptr ds:[eax+0x04]
006C8D0A    call 0x0069EF40                                 ; => [ Call: sub_69ef40 ]
...
006C8D26    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006C8D2B    test eax, eax
006C8D2D    mov ecx, esi                                    ; => [ Data: data_801800 ]
006C8D2F    cmovnz ecx, eax
006C8D32    call 0x006B7EF0                                 ; => [ Call: sub_6b7ef0 ]
006C8D37    cmp byte ptr ds:[0x00CC8D6F], 0x00
006C8D3E    mov edi, eax
006C8D40    jz 0x006C8D5E                                   ; => [ Data: data_cc8d6f ]
...
006C8D57    call 0x006C5B80                                 ; => [ Call: sub_6c5b80 | Call: sub_69f030 ]
...
006C8D6F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006C8D74    inc dword ptr ds:[eax+0x04]
006C8D77    xor edx, edx
006C8D79    mov ecx, edi
006C8D7B    call 0x0069FAF0                                 ; => [ Call: sub_69faf0 ]
...
006C8D9D    jz 0x006C8DBA                                   ; => [ Data: data_cf65bc ]
006C8D9F    lea ecx, ss:[ebp-0x10]
006C8DA2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C8DB5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C8DBA    mov ecx, dword ptr ss:[ebp-0x0C]
006C8DBD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C8DC4    pop ecx
006C8DC5    pop edi
006C8DC6    pop esi
