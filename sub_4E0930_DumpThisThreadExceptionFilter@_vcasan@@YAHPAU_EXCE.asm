...
004E0935    push 0x764156                                   ; => [ Call: __ehhandler$?wait@?$ordered_message_processor@I@Concurrency@@UAEXXZ | Type: EHRegistrationNode ]
004E093A    mov eax, dword ptr fs:[0x00000000]
004E0940    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E094E    push eax                                        ; => [ Data: __security_cookie ]
004E094F    lea eax, ss:[ebp-0x0C]
004E0952    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E0969    call 0x004DF8F0                                 ; => [ Call: sub_4df8f0 ]
...
004E09C6    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E09D7    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0A00    mov ecx, 0x807478                               ; => [ Data: data_807478 ]
...
004E0A64    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0A75    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0A9E    mov ecx, 0x807180                               ; => [ String: colonies ]
...
004E0B0E    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0B1F    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0B48    mov ecx, 0x807478                               ; => [ Data: data_807478 ]
...
004E0BA6    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004E0BB7    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
004E0BE0    mov ecx, 0x80718C                               ; => [ String: shelters ]
...
004E0C39    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004E0C3E    mov dword ptr ss:[ebp-0x14], esi                ; => [ Data: data_801800 ]
004E0C41    mov byte ptr ss:[ebp-0x04], 0x07
004E0C45    mov edi, esi                                    ; => [ Data: data_801800 ]
...
004E0C69    mov ecx, edi                                    ; => [ Data: data_801800 ]
004E0C6B    mov eax, dword ptr ds:[eax]                     ; => [ String: -k %s | Call: sub_63df30 ]
004E0C6D    test eax, eax
004E0C6F    cmovnz ecx, eax
004E0C72    push ecx
004E0C73    lea ecx, ss:[ebp-0x14]
004E0C76    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E0C7B    mov byte ptr ss:[ebp-0x04], 0x09
004E0C7F    cmp dword ptr ds:[0x00CF65BC], 0x00
004E0C86    jz 0x004E0CAF                                   ; => [ Data: data_cf65bc ]
...
004E0C97    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0CAA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E0D09    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004E0D24    mov ecx, edi                                    ; => [ Data: data_801800 ]
004E0D26    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: -e %s ]
004E0D28    test eax, eax
004E0D2A    cmovnz ecx, eax
004E0D2D    push ecx
004E0D2E    lea ecx, ss:[ebp-0x14]
004E0D31    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E0D36    mov byte ptr ss:[ebp-0x04], 0x0B
004E0D3A    cmp dword ptr ds:[0x00CF65BC], 0x00
004E0D41    jz 0x004E0D6A                                   ; => [ Data: data_cf65bc ]
...
004E0D52    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0D65    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E0DC5    mov eax, edi                                    ; => [ Data: data_801800 ]
...
004E0DE5    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: -m %s ]
004E0DE7    test eax, eax
004E0DE9    cmovnz edi, eax
004E0DEC    push edi
004E0DED    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E0DF2    mov byte ptr ss:[ebp-0x04], 0x0D
004E0DF6    cmp dword ptr ds:[0x00CF65BC], 0x00
004E0DFD    jz 0x004E0E26                                   ; => [ Data: data_cf65bc ]
...
004E0E0E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0E21    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E0E3D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0E63    jz 0x004E0E83                                   ; => [ Data: data_cf65bc ]
004E0E65    lea ecx, ss:[ebp-0x14]
004E0E68    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0E7B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E0E97    jz 0x004E0EBB                                   ; => [ Data: data_cf65bc ]
004E0E99    lea ecx, ss:[ebp-0x18]
004E0E9C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0EAF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0EB4    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
004E0EBB    mov byte ptr ss:[ebp-0x04], 0x10
004E0EBF    cmp dword ptr ds:[0x00CF65BC], 0x00
004E0EC6    jz 0x004E0EF6                                   ; => [ Data: data_cf65bc ]
...
004E0ED7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0EEA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0EEF    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
004E0F12    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0F38    jz 0x004E0F5C                                   ; => [ Data: data_cf65bc ]
004E0F3A    lea ecx, ss:[ebp-0x18]
004E0F3D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0F50    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0F55    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
004E0F5C    mov byte ptr ss:[ebp-0x04], 0x05
004E0F60    cmp dword ptr ds:[0x00CF65BC], 0x00
004E0F67    jz 0x004E0F97                                   ; => [ Data: data_cf65bc ]
...
004E0F78    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0F8B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0F90    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
004E0F97    mov dword ptr ss:[ebp-0x04], 0x06
004E0F9E    cmp dword ptr ds:[0x00CF65BC], 0x00
004E0FA5    jz 0x004E0FCE                                   ; => [ Data: data_cf65bc ]
...
004E0FB6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0FC9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0FCE    mov eax, ebx
004E0FD0    mov ecx, dword ptr ss:[ebp-0x0C]
004E0FD3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E0FDA    pop ecx
004E0FDB    pop edi
004E0FDC    pop esi
004E0FDD    pop ebx
