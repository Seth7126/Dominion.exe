...
00712B23    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00712B28    push ebx
00712B29    push esi
00712B2A    push edi
...
00712B3B    push 0x84
00712B40    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00712B42    add esp, 0x0C
00712B45    jmp 0x00712B55
00712B47    push 0x84
00712B4C    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00712B63    push 0x00
00712B65    push eax
00712B66    movups xmmword ptr ds:[esi+0x04], xmm0          ; => [ String: 0 | String: zx ]
00712B6A    call 0x00761FC4                                 ; => [ Call: memset ]
00712B6F    add esp, 0x0C
00712B72    mov ecx, dword ptr ss:[ebp+0x08]
00712B75    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
...
00712B8A    mov dword ptr ds:[esi+0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
00712BCF    mov dword ptr ds:[esi+0x44], 0xBF800000         ; => [ Call: __builtin_memcpy | String: \x00\x00\x80\xbf\x00\x00\x80\xbf\x00\x00\x00\x4f\x00\x00\x80\x3f\x00\x00\x80\x3f ]
...
00712C11    movaps xmm1, xmm0                               ; => [ Call: sub_70fd30 ]
...
00712C2A    mov dword ptr ds:[esi+0x6C], eax                ; => [ Call: sub_7523c0 ]
00712C2D    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00712C32    test eax, eax
00712C34    jz 0x00712C46
00712C36    push 0x28
00712C38    push 0x88DC70
00712C3D    push 0x0C
00712C3F    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00712C41    add esp, 0x0C
00712C44    jmp 0x00712C51
00712C46    push 0x0C
00712C48    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00712C5E    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00712C7B    push 0x40
00712C7D    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00712C7F    add esp, 0x0C
00712C82    jmp 0x00712C8F
00712C84    push 0x40
00712C86    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00712C97    push 0x00
00712C99    push ebx
00712C9A    call 0x00761FC4                                 ; => [ Call: memset ]
