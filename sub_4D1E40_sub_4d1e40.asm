...
004D1E49    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004D1E65    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004D1E6A    mov edi, eax
004D1E6C    push esi
004D1E6D    mov ecx, edi
004D1E6F    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
004D1E74    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004D1E7A    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004D1E7F    xor dl, dl
004D1E81    mov ecx, 0x07
004D1E86    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
004D1E8B    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004D1E90    test eax, eax
004D1E92    jz 0x004D1FE4
004D1E98    mov dword ptr ds:[eax+0x75B0], 0x01
004D1EA2    mov dword ptr ds:[0x008DB660], 0x13             ; => [ Data: data_8db660 ]
004D1EAC    call 0x004C5750                                 ; => [ Call: sub_4c5750 ]
004D1EB1    xor ecx, ecx
004D1EB3    mov dword ptr ds:[0x008DBFB8], 0x00             ; => [ Data: data_8dbfb8 ]
004D1EBD    test al, al
004D1EBF    mov eax, dword ptr ds:[0x008DC144]              ; => [ Data: data_8dc144 ]
004D1EC4    setnz cl
004D1EC7    mov dword ptr ds:[0x008DBFB0], ecx              ; => [ Data: data_8dbfb0 ]
004D1ECD    test eax, eax
004D1ECF    jz 0x004D1F0D
004D1ED1    cmp eax, 0x801800
004D1ED6    jz 0x004D1F0D                                   ; => [ Data: data_801800 ]
004D1ED8    cmp dword ptr ds:[0x00CF65BC], 0x00
004D1EDF    jz 0x004D1F03
004D1EE1    cmp byte ptr ds:[eax], 0x00
004D1EE4    jz 0x004D1F03                                   ; => [ Data: data_cf65bc ]
004D1EE6    mov ecx, 0x8DC144
004D1EEB    call 0x0063D4E0                                 ; => [ Data: data_8dc144 | Call: sub_63d4e0 ]
...
004D1EFE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D1F03    mov dword ptr ds:[0x008DC144], 0x801800         ; => [ Data: data_8dc144 | Data: data_801800 ]
004D1F0D    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D1F55    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D1F69    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004D1F96    call 0x00689E00                                 ; => [ Call: sub_689e00 ]
004D1F9B    add esp, 0x04
004D1F9E    lea eax, ss:[esp+0x10]
004D1FA2    mov edx, 0x18
004D1FA7    lea ecx, ds:[esi+0x50]
004D1FAA    push eax
004D1FAB    call 0x00689BE0                                 ; => [ Call: sub_689be0 ]
004D1FB0    add esp, 0x04
004D1FB3    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004D1FB9    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004D1FBE    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D1FD9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004D1FFA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004D1FFF    add esp, 0x0C
004D2002    call 0x0063BC30
004D2007    test al, al
004D2009    jz 0x004D200C                                   ; => [ Call: sub_63bc30 ]
004D200B    int3
004D200C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
