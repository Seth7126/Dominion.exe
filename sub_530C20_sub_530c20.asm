...
00530C37    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00530C3A    cmp esi, 0x320
00530C40    jb 0x00530C47
00530C42    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00530C5B    call 0x005754F0                                 ; => [ Call: sub_5754f0 ]
...
00530C7A    test al, al
00530C7C    jz 0x00530CBE                                   ; => [ Call: sub_568470 ]
00530C7E    call 0x00573400                                 ; => [ Call: sub_573400 ]
00530C83    mov edi, dword ptr ds:[eax+0x04]
00530C86    cmp esi, 0x320
00530C8C    jb 0x00530C93
00530C8E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00530CAF    test al, al
00530CB1    jnz 0x00530CBE                                  ; => [ Call: sub_5754f0 ]
