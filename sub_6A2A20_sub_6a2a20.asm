...
006A2A6C    mov dword ptr ds:[edi], 0x801800
006A2A72    mov eax, edi
006A2A74    mov ecx, dword ptr ss:[ebp-0x0C]
006A2A77    mov dword ptr fs:[0x00000000], ecx
006A2A7E    pop ecx
006A2A7F    pop edi
006A2A80    pop esi
006A2A81    pop ebx
...
006A2AE1    mov dword ptr ds:[edi], 0x801800
006A2AE7    mov eax, edi
006A2AE9    mov ecx, dword ptr ss:[ebp-0x0C]
006A2AEC    mov dword ptr fs:[0x00000000], ecx
006A2AF3    pop ecx
006A2AF4    pop edi
006A2AF5    pop esi
006A2AF6    pop ebx
...
006A2B58    jz 0x006A2B75
006A2B5A    lea ecx, ss:[ebp-0x14]
006A2B5D    call 0x0063D4E0
...
006A2B70    call 0x0064C080
006A2B75    mov eax, edi
006A2B77    mov ecx, dword ptr ss:[ebp-0x0C]
006A2B7A    mov dword ptr fs:[0x00000000], ecx
006A2B81    pop ecx
006A2B82    pop edi
006A2B83    pop esi
006A2B84    pop ebx
...
006A2BA2    call 0x0063B870
006A2BA7    add esp, 0x0C
006A2BAA    call 0x0063BC30
006A2BAF    test al, al
006A2BB1    jz 0x006A2BB4
006A2BB3    int3
006A2BB4    call 0x0063BB00
