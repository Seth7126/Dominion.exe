...
0065E2E5    push 0x76D0A5                                   ; => [ Call: sub_76d0a5 | Type: EHRegistrationNode ]
0065E2EA    mov eax, dword ptr fs:[0x00000000]
0065E2F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0065E2FE    push eax                                        ; => [ Data: __security_cookie ]
0065E2FF    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0065E302    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0065E324    jz 0x0065E39F                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0065E336    push 0x872364                                   ; => [ String: TTFontGet ]
0065E33B    push 0x1EF
0065E340    push 0x8720A4                                   ; => [ String: C:\x\ax2017\Engine\TTFont.cpp ]
0065E345    mov ecx, 0x87233C                               ; => [ String: ttf->assetType == ASSET_TYPE_TRUETYPE ]
0065E34A    jmp 0x0065E48C
0065E34F    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0065E3F3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065E406    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065E40B    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0065E412    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0065E419    jmp 0x0065E421
0065E41B    cmp dword ptr ds:[esi+0x04], 0x12
0065E41F    jnz 0x0065E47B                                  ; => [ Field: Handler ]
0065E421    cmp dword ptr ds:[esi], 0x00
0065E424    mov dword ptr ss:[ebp-0x18], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0065E427    jnz 0x0065E437                                  ; => [ Field: Next ]
0065E429    push 0x01
0065E42B    xor dl, dl
0065E42D    mov ecx, esi
0065E42F    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
0065E442    mov eax, dword ptr ds:[eax]                     ; => [ Field: Next ]
...
0065E46C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
0065E473    pop ecx
0065E474    pop edi
0065E475    pop esi
0065E476    pop ebx
...
0065E479    pop ebp
0065E47A    ret
0065E47B    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
0065E480    push 0x19
0065E482    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
0065E487    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
0065E48C    mov edx, 0x801800
0065E491    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0065E496    add esp, 0x0C
0065E499    call 0x0063BC30
0065E49E    test al, al
0065E4A0    jz 0x0065E4A3                                   ; => [ Call: sub_63bc30 ]
0065E4A2    int3
0065E4A3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0065E4A8    push 0x874F08
0065E4AD    push 0x28EE
0065E4B2    push 0x8739B4
0065E4B7    mov edx, 0x801800
0065E4BC    mov ecx, 0x874EE4
0065E4C1    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | Data: data_801800 | String: FancyLineSpacing | String: pDefFont->fontLineBreakSpacing != 0 ]
0065E4C6    add esp, 0x0C
0065E4C9    call 0x0063BC30
0065E4CE    test al, al
0065E4D0    jz 0x0065E4D3                                   ; => [ Call: sub_63bc30 ]
0065E4D2    int3
0065E4D3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
