...
00519AC1    mov dword ptr ds:[eax], 0x816D44                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_2a8e46be9d0e07fd20f10f90667b7f33>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
00519AC7    mov dword ptr ds:[eax+0x24], eax
00519ACA    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
00519ACF    mov ecx, dword ptr ds:[0x00CCA790]              ; => [ Data: data_cca790 ]
...
00519AF4    add ecx, edx                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
00519AF6    jmp 0x00519B06
00519AF8    mov eax, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
...
00519B2B    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: RollThemeCard | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: what != CARD_NONE ]
00519B30    add esp, 0x0C
00519B33    call 0x0063BC30
00519B38    test al, al
00519B3A    jz 0x00519B3D                                   ; => [ Call: sub_63bc30 ]
00519B3C    int3
00519B3D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
