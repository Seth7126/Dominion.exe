...
0061D5B5    push 0x7631ED                                   ; => [ Call: __ehhandler$??2@YAPAXIABUnothrow_t@std@@@Z | Type: EHRegistrationNode ]
0061D5BA    mov eax, dword ptr fs:[0x00000000]
0061D5C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0061D5CE    push eax                                        ; => [ Data: __security_cookie ]
0061D5CF    lea eax, ss:[ebp-0x0C]
0061D5D2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0061D5D8    mov esi, dword ptr ds:[ecx]
0061D5DA    xor edi, edi
0061D5DC    test esi, esi
0061D5DE    jnz 0x0061D5E5
0061D5E0    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
0061D610    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
0061D621    push eax
0061D622    push esi
0061D623    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
0061D628    mov dword ptr ss:[ebp-0x04], 0x00
0061D62F    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0061D634    mov edx, dword ptr ds:[edi]
0061D636    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
0061D65C    jz 0x0061D678                                   ; => [ Data: data_cf65bc ]
0061D65E    mov ecx, edi
0061D660    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0061D673    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0061D685    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0061D6A4    jz 0x0061D6C1                                   ; => [ Data: data_cf65bc ]
0061D6A6    lea ecx, ss:[ebp-0x10]
0061D6A9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0061D6BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0061D6E6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0061D6ED    pop ecx
0061D6EE    pop edi
0061D6EF    pop esi
0061D6F0    pop ebx
...
0061D6F8    push esi
0061D6F9    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
0061D6FE    mov eax, edi
0061D700    mov ecx, dword ptr ss:[ebp-0x0C]
0061D703    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0061D70A    pop ecx
0061D70B    pop edi
0061D70C    pop esi
0061D70D    pop ebx
