...
005248B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005248B1    mov eax, 0x25CC
005248B6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005248BB    mov eax, dword ptr ds:[0x008C4040]
005248C0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
005248CC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005248D2    lea eax, ss:[ebp-0xC98]
005248D8    mov ecx, 0x3EC
005248DD    push eax
005248DE    call 0x00568780                                 ; => [ Call: sub_568780 ]
...
005248F9    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005248FB    push eax
...
00524916    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
...
00524956    mov dword ptr ss:[ebp-0x1950], 0x8187A0         ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8aae151a8c52cfca9c482f21829167b6>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_8aae151a8c52cfca9c482f21829167b6>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00524960    mov dword ptr ss:[ebp-0x192C], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8aae151a8c52cfca9c482f21829167b6>,bool,enum CardID>::VTable ]
...
005249D7    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8aae151a8c52cfca9c482f21829167b6>,bool,enum CardID>::VTable ]
005249DA    push eax
005249DB    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
005249FF    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00524A02    cmp esi, 0x320
00524A08    jb 0x00524A0F
00524A0A    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00524A66    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
