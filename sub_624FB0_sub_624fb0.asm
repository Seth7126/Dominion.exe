...
00624FB4    push ebx
00624FB5    mov al, cl
00624FB7    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
00624FD9    mov dl, al
00624FDB    call 0x004B90E0                                 ; => [ Call: sub_4b90e0 ]
00624FE0    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
00624FE6    test ecx, ecx
00624FE8    jz 0x006250C1
00624FEE    mov ecx, dword ptr ds:[ecx+0x506C]
00624FF4    call 0x004C5930                                 ; => [ Call: sub_4c5930 ]
00624FF9    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
0062503C    mov ebx, dword ptr ds:[eax]                     ; => [ Call: sub_4b9480 ]
0062503E    nop
00625040    call 0x0061DAD0
00625045    cmp dword ptr ds:[eax+esi*1+0x08], ebx
00625049    jz 0x00625086                                   ; => [ Call: sub_61dad0 ]
...
0062505F    mov ecx, dword ptr ds:[eax+0x34]                ; => [ Call: sub_4b9480 ]
00625062    jmp 0x00625066
00625064    xor ecx, ecx
00625066    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
0062508E    mov dword ptr ds:[eax+ecx*4+0x08], 0x00         ; => [ Call: sub_61dad0 ]
00625096    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
0062509C    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
006250A1    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
006250D7    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
006250DC    add esp, 0x0C
006250DF    call 0x0063BC30
006250E4    test al, al
006250E6    jz 0x006250E9                                   ; => [ Call: sub_63bc30 ]
006250E8    int3
006250E9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
