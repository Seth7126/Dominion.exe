...
004C2F96    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C2FAF    push 0x77EB90                                   ; => [ String: GetClient ]
004C2FB4    push 0x7B
004C2FB6    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004C2FBB    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004C2FC0    jmp 0x004C3339
004C2FC5    cmp dword ptr ds:[0x008DB7F4], 0x01
004C2FCC    jnz 0x004C2FF8                                  ; => [ Data: data_8db7f4 ]
004C2FCE    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C2FD3    movss xmm3, dword ptr ds:[0x00890E18]
004C2FDB    mov edx, 0x8DBE90
004C2FE0    push 0x00
004C2FE2    push 0xFFFFFFFF
004C2FE4    mov ecx, eax
004C2FE6    call 0x00665DB0                                 ; => [ Data: data_8dbe90 | Call: sub_665db0 ]
004C2FEB    add esp, 0x08
004C2FEE    mov dword ptr ds:[0x008DB7F8], 0x00             ; => [ Data: data_8db7f8 ]
004C2FF8    lea edx, ss:[ebp-0x18]
004C2FFB    mov ecx, esi
004C2FFD    call 0x004C2720
004C3002    mov ebx, eax                                    ; => [ Call: sub_4c2720 ]
...
004C3011    imul ecx
004C3013    mov eax, dword ptr ds:[0x008DB7FC]              ; => [ Data: data_8db7fc ]
...
004C3043    call 0x00666120                                 ; => [ Data: data_8dbd88 | Call: sub_666120 ]
...
004C30C1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C30C6    movss xmm3, dword ptr ds:[0x00890E18]
004C30CE    mov edx, 0x8DBD94
004C30D3    push ebx
004C30D4    push ebx
004C30D5    mov ecx, eax
004C30D7    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dbd94 ]
...
004C3116    call 0x004BBA60                                 ; => [ Data: data_19e5670 | String: tblFriends | Call: sub_4bba60 ]
...
004C3168    mov esi, 0x8DBE48                               ; => [ Data: data_8dbe48 ]
004C316D    jmp 0x004C3189
004C316F    mov esi, 0x8DBE54                               ; => [ Data: data_8dbe54 ]
004C3174    jmp 0x004C3189
004C3176    mov esi, 0x8DBE60                               ; => [ Data: data_8dbe60 ]
004C317B    jmp 0x004C3189
004C317D    mov esi, 0x8DBE6C                               ; => [ Data: data_8dbe6c ]
004C3182    jmp 0x004C3189
004C3184    mov esi, 0x8DBE78                               ; => [ Data: data_8dbe78 ]
004C3189    mov eax, dword ptr ss:[ebp-0x04]
004C318C    mov ecx, eax
004C318E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C3193    movss xmm3, dword ptr ds:[0x00890E18]
004C319B    mov edx, esi
004C319D    push 0x00
004C319F    push ebx
004C31A0    mov ecx, eax
004C31A2    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
004C31B7    push ebx
004C31B8    push eax
004C31B9    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8dbdb8 ]
004C31BE    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C31E7    mov esi, 0x8DBE3C                               ; => [ Data: data_8dbe3c ]
004C31EC    jmp 0x004C31FA
004C31EE    mov esi, 0x8DBE24                               ; => [ Data: data_8dbe24 ]
004C31F3    jmp 0x004C31FA
004C31F5    mov esi, 0x8DBE30                               ; => [ Data: data_8dbe30 ]
004C31FA    mov ecx, dword ptr ss:[ebp-0x04]
004C31FD    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C3202    movss xmm3, dword ptr ds:[0x00890E18]
004C320A    mov edx, esi
004C320C    push 0x00
004C320E    push ebx
004C320F    mov ecx, eax
004C3211    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
004C3216    add esp, 0x08
004C3219    mov esi, 0x8DBDAC                               ; => [ Data: data_8dbdac | Data: data_8dbdac ]
004C321E    mov ecx, dword ptr ss:[ebp-0x04]
004C3221    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C3226    movss xmm3, dword ptr ds:[0x00890E18]
004C322E    mov edx, esi
004C3230    push 0x00
004C3232    push ebx
004C3233    mov ecx, eax
004C3235    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
004C324E    call 0x004B9280                                 ; => [ Call: sub_4b9280 ]
...
004C3266    mov esi, 0x8DBE0C                               ; => [ Data: data_8dbe0c ]
004C326B    jmp 0x004C32B0
004C326D    cmp dword ptr ds:[0x008DB7F4], 0x01
004C3274    jnz 0x004C3219                                  ; => [ Data: data_8db7f4 ]
004C3276    call 0x004BBDB0
004C327B    xor edx, edx
004C327D    lea ecx, ds:[eax+0x58]                          ; => [ Call: sub_4bbdb0 ]
...
004C329A    mov esi, 0x8DBDA0                               ; => [ Data: data_8dbda0 ]
004C329F    jmp 0x004C321E
004C32A4    mov esi, 0x8DBDF4                               ; => [ Data: data_8dbdf4 ]
004C32A9    jmp 0x004C32B0
004C32AB    mov esi, 0x8DBE00                               ; => [ Data: data_8dbe00 ]
004C32B0    mov ecx, dword ptr ss:[ebp-0x04]
004C32B3    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C32B8    movss xmm3, dword ptr ds:[0x00890E18]
004C32C0    mov edx, esi
004C32C2    push 0x00
004C32C4    push ebx
004C32C5    mov ecx, eax
004C32C7    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
004C32E5    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C32EA    movss xmm3, dword ptr ds:[0x00890E18]
004C32F2    mov edx, 0x8DBE84
004C32F7    push 0x00
004C32F9    push ebx
004C32FA    mov ecx, eax
004C32FC    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dbe84 ]
...
004C330B    pop ebp
004C330C    ret
004C330D    push 0x803B00                                   ; => [ String: FriendsUpdateTable ]
004C3312    push 0x14FD
004C3317    jmp 0x004C332F
004C3319    push 0x803B00                                   ; => [ Call: nullptr | String: FriendsUpdateTable ]
004C331E    push 0x14B3
004C3323    jmp 0x004C332F
004C3325    push 0x803B00                                   ; => [ String: FriendsUpdateTable ]
004C332A    push 0x14C4
004C332F    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004C3334    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004C3339    mov edx, 0x801800
004C333E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004C3343    add esp, 0x0C
004C3346    call 0x0063BC30
004C334B    test al, al
004C334D    jz 0x004C3350                                   ; => [ Call: sub_63bc30 ]
004C334F    int3
004C3350    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
