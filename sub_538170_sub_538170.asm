...
0053828A    call 0x00566370
0053828F    mov ecx, esi
00538291    call 0x00564930
00538296    lea ecx, ss:[ebp-0xD0]
0053829C    mov dword ptr ss:[ebp-0xD0], 0x81A398
005382A6    mov dword ptr ss:[ebp-0xAC], ecx
005382AC    lea ecx, ss:[ebp-0xA0]
005382B2    mov dword ptr ss:[ebp-0x7C], ecx
005382B5    lea ecx, ss:[ebp-0x70]
005382B8    mov dword ptr ss:[ebp-0x4C], ecx
005382BB    lea ecx, ss:[ebp-0x40]
005382BE    mov dword ptr ss:[ebp-0xA8], 0x20
005382C8    mov dword ptr ss:[ebp-0xA4], 0x00
005382D2    mov dword ptr ss:[ebp-0xA0], 0x81A37C
005382DC    mov dword ptr ss:[ebp-0x78], 0x21
005382E3    mov dword ptr ss:[ebp-0x74], 0x00
005382EA    mov dword ptr ss:[ebp-0x70], 0x81A360
005382F1    mov dword ptr ss:[ebp-0x48], 0x22
005382F8    mov dword ptr ss:[ebp-0x44], 0x00
005382FF    mov dword ptr ss:[ebp-0x40], 0x81A344
00538306    mov dword ptr ss:[ebp-0x1C], ecx
