...
00733344    byte FF
00733345    push 0x772B3D                                   ; => [ Call: __ehhandler$??$uninitialize@A6AXAAPAPAD@_E@?$dual_state_global@PAPAD@__crt_state_management@@QAEXA6AXAAPAPAD@_E@Z | Type: EHRegistrationNode ]
0073334A    mov eax, dword ptr fs:[0x00000000]
00733350    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00733351    push ecx
00733352    push ebx
00733353    mov eax, dword ptr ds:[0x008C4040]
00733358    xor eax, ebp
0073335A    push eax                                        ; => [ Data: __security_cookie ]
0073335B    lea eax, ss:[ebp-0x0C]
0073335E    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00733364    push 0x01
00733366    push ecx
...
007333B2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
007333C5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
007333CA    mov al, bl
007333CC    mov ecx, dword ptr ss:[ebp-0x0C]
007333CF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
007333D6    pop ecx
007333D7    pop ebx
