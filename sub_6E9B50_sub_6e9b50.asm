...
006E9B55    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
006E9B5A    mov eax, dword ptr fs:[0x00000000]
006E9B60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006E9B6E    push eax                                        ; => [ Data: __security_cookie ]
006E9B6F    lea eax, ss:[ebp-0x0C]
006E9B72    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E9B8E    call 0x006E9790                                 ; => [ Call: sub_6e9790 ]
006E9B93    mov eax, dword ptr ds:[edi+0x60]
006E9B96    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
006E9B9B    test eax, eax
006E9B9D    jle 0x006E9BD6
006E9B9F    mov eax, dword ptr ds:[edi]
006E9BA1    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006E9BB7    jz 0x006E9BDC                                   ; => [ Call: sub_5a0d00 ]
006E9BB9    nop dword ptr ds:[eax], eax
006E9BC0    lea ecx, ss:[ebp-0x10]
006E9BC3    inc esi
006E9BC4    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
006E9BDC    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006E9BE3    mov dword ptr ss:[ebp-0x04], 0x00
006E9BEA    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006E9BFA    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006E9BFF    push dword ptr ss:[ebp+0x08]
006E9C02    lea ecx, ss:[ebp-0x10]
006E9C05    call 0x0063DCD0                                 ; => [ Call: sub_63dcd0 ]
...
006E9C1C    mov edx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
006E9C1F    jmp 0x006E9C23
006E9C21    xor edx, edx
006E9C23    mov eax, dword ptr ds:[edi]
006E9C25    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006E9C38    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
006E9C6C    push ecx
006E9C6D    call 0x006417E0                                 ; => [ Call: sub_6417e0 ]
...
006E9C7F    call 0x006B43A0                                 ; => [ Call: sub_6b43a0 ]
...
006E9CDD    jz 0x006E9CFA                                   ; => [ Data: data_cf65bc ]
006E9CDF    lea ecx, ss:[ebp-0x10]
006E9CE2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E9CF5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E9CFA    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006E9D01    mov ecx, edi
006E9D03    call 0x006E9A30                                 ; => [ Call: sub_6e9a30 ]
006E9D08    mov dword ptr ds:[edi+0x08], 0x00
006E9D0F    mov ecx, dword ptr ss:[ebp-0x0C]
006E9D12    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E9D19    pop ecx
006E9D1A    pop edi
006E9D1B    pop esi
006E9D1C    pop ebx
