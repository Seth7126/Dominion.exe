...
004E3FA5    push 0x76439E                                   ; => [ Call: __ehhandler$??$_Emplace_reallocate@UGSISymbolEntry@@@?$vector@UGSISymbolEntry@@V?$allocator@UGSISymbolEntry@@@std@@@std@@QAEPAUGSISymbolEntry@@QAU2@$$QAU2@@Z | Type: EHRegistrationNode ]
004E3FAA    mov eax, dword ptr fs:[0x00000000]
004E3FB0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E3FBE    push eax                                        ; => [ Data: __security_cookie ]
004E3FBF    lea eax, ss:[ebp-0x0C]
004E3FC2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E3FD9    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
004E401B    call 0x0063D850                                 ; => [ Call: sub_63df30 | Call: sub_63d850 | String: dom_expansion_name_%s ]
...
004E404E    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: dom_card_type_%s | Call: sub_63d850 ]
...
004E4068    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
004E4088    call 0x0063D850                                 ; => [ String: dom_card_title_%s | Call: sub_63df30 | Call: sub_63d850 ]
004E408D    mov byte ptr ss:[ebp-0x04], 0x07
004E4091    cmp dword ptr ds:[0x00CF65BC], 0x00
004E4098    jz 0x004E40C8                                   ; => [ Data: data_cf65bc ]
...
004E40A9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E40BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E40C1    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
004E40C8    mov byte ptr ss:[ebp-0x04], 0x01
004E40CC    mov edi, dword ptr ss:[ebp-0x10]
004E40CF    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E40D4    mov esi, dword ptr ss:[ebp+0x08]
004E40D7    test edi, edi
004E40D9    mov edx, esi
004E40DB    cmovnz ecx, edi
004E40DE    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
004E40E3    test eax, eax
004E40E5    jnz 0x004E40F9
004E40E7    test edi, edi
004E40E9    lea edx, ds:[eax+0x01]
004E40EC    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E40F1    cmovnz ecx, edi
004E40F4    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
004E40F9    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
004E412B    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: **missing:%s** | Call: sub_63d850 ]
004E4130    mov byte ptr ss:[ebp-0x04], 0x0A
004E4134    cmp dword ptr ds:[0x00CF65BC], 0x00
004E413B    jz 0x004E4164                                   ; => [ Data: data_cf65bc ]
...
004E414C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E415F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E4178    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E419B    jz 0x004E41B8                                   ; => [ Data: data_cf65bc ]
004E419D    lea ecx, ss:[ebp-0x14]
004E41A0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E41B3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E41FB    jz 0x004E4218                                   ; => [ Data: data_cf65bc ]
004E41FD    lea ecx, ss:[ebp-0x10]
004E4200    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E4213    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E4218    mov eax, ebx
004E421A    mov ecx, dword ptr ss:[ebp-0x0C]
004E421D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E4224    pop ecx
004E4225    pop edi
004E4226    pop esi
004E4227    pop ebx
...
004E4245    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
004E424A    add esp, 0x0C
004E424D    call 0x0063BC30
004E4252    test al, al
004E4254    jz 0x004E4257                                   ; => [ Call: sub_63bc30 ]
004E4256    int3
004E4257    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
