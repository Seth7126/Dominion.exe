...
00766D9C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00766DA1    mov ecx, dword ptr ds:[edx-0x08]
00766DA4    xor ecx, eax
00766DA6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00766DAB    mov eax, 0x8B28B4
00766DB0    jmp 0x00761FA6                                  ; => [ Call: __CxxFrameHandler3 | Data: data_8b28b4 ]
