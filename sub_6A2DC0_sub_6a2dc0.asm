...
006A2DC6    push ebx
006A2DC7    mov ebx, dword ptr ds:[0x0147AC60]              ; => [ Data: data_147ac60 ]
...
006A2DDC    mov esi, dword ptr ds:[0x0147B080]              ; => [ Data: data_147b080 ]
006A2DE2    mov eax, 0x147AC68                              ; => [ Data: data_147ac68 ]
006A2DE7    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: data_147ac68 ]
...
006A2E7B    mov ebx, dword ptr ds:[0x0147AC60]              ; => [ Data: data_147ac60 ]
006A2E81    mov esi, dword ptr ds:[0x0147B080]              ; => [ Data: data_147b080 ]
...
006A2E98    mov eax, 0x147B088                              ; => [ Data: data_147b088 ]
...
006A2EDC    pop ebp
006A2EDD    ret
006A2EDE    push 0x87A620                                   ; => [ String: DefTypeInitializeFields ]
006A2EE3    push 0x5A
006A2EE5    push 0x87A564                                   ; => [ String: C:\x\ax2017\Engine\DefTypeRegistry.cpp ]
006A2EEA    mov edx, 0x87A5E8                               ; => [ String: The hw buffer must be the last field in the definition\n ]
006A2EEF    mov ecx, 0x874B64                               ; => [ String: HaltMsg ]
...
006A2F07    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: In definition %s field %s has the wrong type ]
006A2F0C    add esp, 0x0C
006A2F0F    mov edx, 0x87A638                               ; => [ String: The field type in a definition is wrong\n ]
006A2F14    mov ecx, 0x874B64                               ; => [ String: HaltMsg ]
006A2F19    push 0x87A620                                   ; => [ String: DefTypeInitializeFields ]
006A2F1E    push 0x63
006A2F20    push 0x87A564                                   ; => [ String: C:\x\ax2017\Engine\DefTypeRegistry.cpp ]
...
006A2F35    call 0x0063B5F0                                 ; => [ String: In definition %s ptr field %s has the wrong type | Call: sub_63b5f0 ]
006A2F3A    add esp, 0x0C
006A2F3D    mov edx, 0x87A638                               ; => [ String: The field type in a definition is wrong\n ]
006A2F42    mov ecx, 0x874B64                               ; => [ String: HaltMsg ]
006A2F47    push 0x87A620                                   ; => [ String: DefTypeInitializeFields ]
006A2F4C    push 0x6D
006A2F4E    push 0x87A564                                   ; => [ String: C:\x\ax2017\Engine\DefTypeRegistry.cpp ]
006A2F53    jmp 0x006A2F7F
006A2F55    push 0x87CE28                                   ; => [ String: AssetRegistrySetDefMap ]
006A2F5A    push 0x99
006A2F5F    mov ecx, 0x87CE80                               ; => [ String: pAssetTableItem->pDefMap == NULL ]
006A2F64    jmp 0x006A2F75
006A2F66    push 0x87CE28                                   ; => [ String: AssetRegistrySetDefMap ]
006A2F6B    push 0x9F
006A2F70    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006A2F75    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006A2F7A    push 0x87CC50                                   ; => [ String: C:\x\ax2017\Engine\AssetTypeRegistry.cpp ]
006A2F7F    call 0x0063B870                                 ; => [ Call: sub_63b870 ]
006A2F84    add esp, 0x0C
006A2F87    call 0x0063BC30
006A2F8C    test al, al
006A2F8E    jz 0x006A2F91                                   ; => [ Call: sub_63bc30 ]
006A2F90    int3
006A2F91    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
