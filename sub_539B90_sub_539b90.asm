...
00539BB1    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00539BB4    cmp esi, 0x320
00539BBA    jb 0x00539BC1
00539BBC    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00539BD9    test al, al
00539BDB    jz 0x00539C5A                                   ; => [ Call: sub_5754f0 ]
00539BDD    mov esi, dword ptr ds:[edi]
00539BDF    call 0x00573400
00539BE4    movzx esi, si
00539BE7    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00539BEA    cmp esi, 0x320
00539BF0    jb 0x00539BF7
00539BF2    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00539C0F    test al, al
00539C11    jnz 0x00539C51                                  ; => [ Call: sub_5754f0 ]
00539C13    mov esi, dword ptr ds:[edi]
00539C15    call 0x00573400
00539C1A    movzx esi, si
00539C1D    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00539C20    cmp esi, 0x320
00539C26    jb 0x00539C2D
00539C28    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00539C7C    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Intrigue.cpp | String: numCards == 1 | Data: data_801800 | String: Replace_Achievement_OnGain ]
00539C81    add esp, 0x0C
00539C84    call 0x0063BC30
00539C89    test al, al
00539C8B    jz 0x00539C8E                                   ; => [ Call: sub_63bc30 ]
00539C8D    int3
00539C8E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
