...
0055662E    mov dword ptr ss:[ebp-0x48], 0x81F0F8
00556635    mov dword ptr ss:[ebp-0x44], eax
00556638    lea eax, ss:[ebp-0x48]
0055663B    mov dword ptr ss:[ebp-0x24], eax
...
005566A0    push eax
005566A1    call dword ptr ds:[edx+0x10]
...
005566BB    call 0x005624A0
005566C0    add esp, 0x04
005566C3    mov ecx, dword ptr ss:[ebp-0x0C]
005566C6    mov dword ptr fs:[0x00000000], ecx
005566CD    pop ecx
005566CE    pop edi
005566CF    pop esi
005566D0    pop ebx
