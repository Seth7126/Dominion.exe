...
0053BD8B    call 0x00761E50
0053BD90    mov eax, dword ptr ds:[0x008C4040]
0053BD95    xor eax, esp
0053BD97    mov dword ptr ss:[esp+0x1914], eax
0053BD9E    push esi
0053BD9F    push edi
0053BDA0    call 0x00573400
0053BDA5    push 0x00
0053BDA7    push 0x00
0053BDA9    push 0x01
...
0053BDB1    push 0x01
0053BDB3    call 0x00590760
0053BDB8    add esp, 0x10
0053BDBB    call 0x00573400
...
0053BE9C    call 0x0063B870
0053BEA1    add esp, 0x0C
0053BEA4    call 0x0063BC30
0053BEA9    test al, al
0053BEAB    jz 0x0053BEAE
0053BEAD    int3
0053BEAE    call 0x0063BB00
