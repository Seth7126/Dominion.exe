...
00631C1B    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
00631C22    push ebx
...
00631C3E    mov edi, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
00631C44    jmp 0x00631C59
00631C46    cmp dword ptr ds:[0x008DB5D4], 0x27
00631C4D    jnz 0x00631E80                                  ; => [ Data: data_8db5d4 ]
00631C53    mov edi, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
...
00631CAB    jnz 0x00631CB6                                  ; => [ String: tbl_opponent_pods | Data: data_1a98d20 | Data: data_1a98d18 | Data: data_1a98d2c | Data: data_1a98d24 | Data: data_1a98d1c | Data: data_1a98d28 | String: tbl_opponents ]
00631CAD    mov eax, dword ptr ds:[esi*4+0x1A98D38]
00631CB4    jmp 0x00631D35
00631CB6    push edx
00631CB7    mov edx, 0x86FA90
00631CBC    mov ecx, edi
00631CBE    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
00631CC3    add esp, 0x04
00631CC6    mov dword ptr ds:[esi*4+0x1A98D38], eax         ; => [ Data: data_1a98d38 ]
...
00631CE6    call 0x0067BD70                                 ; => [ String: tbl_opponent_pods | Call: sub_67bd70 ]
00631CEB    mov edx, dword ptr ss:[ebp-0x04]
00631CEE    mov ecx, dword ptr ds:[0x007FFB20]
00631CF4    mov dword ptr ds:[esi*4+0x1A98D38], eax         ; => [ Data: data_1a98d38 ]
00631CFB    mov dword ptr ds:[esi*4+0x1A98D18], edi         ; => [ Data: data_1a98d18 ]
00631D02    mov dword ptr ds:[esi*4+0x1A98D1C], 0x86FA90    ; => [ Data: data_1a98d1c | String: tbl_opponents ]
00631D0D    mov dword ptr ds:[esi*4+0x1A98D20], edx         ; => [ Data: data_1a98d20 ]
00631D14    mov dword ptr ds:[esi*4+0x1A98D24], 0x86FAC8    ; => [ Data: data_1a98d24 | String: tbl_opponent_pods ]
00631D1F    mov dword ptr ds:[esi*4+0x1A98D28], 0xFFFFFFFF  ; => [ Data: data_1a98d28 ]
00631D2A    mov dword ptr ds:[esi*4+0x1A98D2C], 0x00        ; => [ Data: data_1a98d2c ]
00631D35    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: data_1a98d38 ]
...
00631D7B    jnz 0x00631D89                                  ; => [ String: tbl_opponent_pods | Data: data_1a98df8 | Data: data_1a98e04 | Data: data_1a98df0 | Data: data_1a98e00 | Data: data_1a98dfc | Data: data_1a98df4 | String: tbl_opponents ]
00631D7D    mov edi, dword ptr ds:[esi*4+0x1A98E10]         ; => [ Data: data_1a98e10 ]
00631D84    jmp 0x00631E24
00631D89    push edx
00631D8A    mov edx, 0x86FA90
00631D8F    mov ecx, edi
00631D91    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
00631D96    add esp, 0x04
00631D99    test eax, eax
00631D9B    jnz 0x00631DA8
00631D9D    mov dword ptr ds:[esi*4+0x1A98E10], eax         ; => [ Data: data_1a98e10 ]
00631DA4    xor edi, edi
00631DA6    jmp 0x00631E19
00631DA8    mov edx, 0x86FAC8
00631DAD    mov ecx, eax
00631DAF    call 0x0067BD70                                 ; => [ String: tbl_opponent_pods | Call: sub_67bd70 ]
...
00631DCC    mov edi, eax                                    ; => [ Call: nullptr | Call: sub_64c870 | Call: sub_64e7a0 ]
00631DCE    mov dword ptr ds:[esi*4+0x1A98E10], edi         ; => [ Data: data_1a98e10 ]
00631DD5    test edi, edi
00631DD7    jz 0x00631E19
00631DD9    mov eax, dword ptr ss:[ebp-0x0C]
00631DDC    mov dword ptr ds:[esi*4+0x1A98DF0], eax         ; => [ Data: data_1a98df0 ]
00631DE3    mov eax, dword ptr ss:[ebp-0x04]
00631DE6    mov dword ptr ds:[esi*4+0x1A98DF4], 0x86FA90    ; => [ Data: data_1a98df4 | String: tbl_opponents ]
00631DF1    mov dword ptr ds:[esi*4+0x1A98DF8], eax         ; => [ Data: data_1a98df8 ]
00631DF8    mov dword ptr ds:[esi*4+0x1A98DFC], 0x86FAC8    ; => [ String: tbl_opponent_pods | Data: data_1a98dfc ]
00631E03    mov dword ptr ds:[esi*4+0x1A98E00], 0x00        ; => [ Data: data_1a98e00 ]
00631E0E    mov dword ptr ds:[esi*4+0x1A98E04], 0x00        ; => [ Data: data_1a98e04 ]
...
00631E2D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00631E5B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
