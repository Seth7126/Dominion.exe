...
006C3EA5    push 0x763270                                   ; => [ Call: __ehhandler$___std_smf_ellint_2@16 | Type: EHRegistrationNode ]
006C3EAA    mov eax, dword ptr fs:[0x00000000]
006C3EB0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C3EB1    push ecx
006C3EB2    push ebx
006C3EB3    push esi
006C3EB4    push edi
...
006C3EBC    push eax                                        ; => [ Data: __security_cookie ]
006C3EBD    lea eax, ss:[ebp-0x0C]
006C3EC0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C3EC6    mov esi, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
006C3F00    call 0x0069ED20                                 ; => [ Call: sub_6a01a0 | Call: sub_69ed20 ]
006C3F05    cmp dword ptr ss:[ebp-0x10], 0x00
006C3F09    jnz 0x006C3EF4
006C3F0B    mov esi, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
006C3F11    mov ecx, esi
006C3F13    call 0x004E9E80                                 ; => [ Call: sub_4e9e80 ]
006C3F18    mov ecx, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
006C3F36    mov ecx, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
006C3F5B    call 0x004E9E80                                 ; => [ Call: sub_4e9e80 ]
006C3F60    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006C3F67    mov edx, 0x28
006C3F6C    mov ecx, dword ptr ds:[0x0147AC2C]
006C3F72    call 0x0064C080                                 ; => [ Data: data_147ac2c | Call: sub_64c080 ]
006C3F77    mov dword ptr ds:[0x0147AC2C], 0x00             ; => [ Data: data_147ac2c ]
006C3F81    mov ecx, dword ptr ds:[0x0147AC64]              ; => [ Data: data_147ac64 ]
...
006C3F9F    mov ecx, dword ptr ds:[0x0147AC64]              ; => [ Data: data_147ac64 ]
...
006C3FD0    mov ecx, dword ptr ds:[0x0147AC64]              ; => [ Data: data_147ac64 ]
...
006C4037    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C403E    pop ecx
006C403F    pop edi
006C4040    pop esi
006C4041    pop ebx
