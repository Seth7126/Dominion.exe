...
004B90EB    mov ecx, dword ptr ds:[0x00CC8D5C]
004B90F1    push ebx
004B90F2    mov bl, dl
004B90F4    push esi
004B90F5    push edi
...
004B9127    mov ecx, dword ptr ds:[0x00CC8DC8]
...
004B916F    xor edx, dword ptr ds:[eax*4+0x7FFD70]
...
004B91AE    xor eax, dword ptr ds:[ecx*4+0x7FFD70]
004B91B5    sub edx, 0x01
004B91B8    jnz 0x004B91A0
004B91BA    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004B9206    call 0x0063B870
004B920B    add esp, 0x0C
004B920E    call 0x0063BC30
004B9213    test al, al
004B9215    jz 0x004B9218
004B9217    int3
004B9218    call 0x0063BB00
