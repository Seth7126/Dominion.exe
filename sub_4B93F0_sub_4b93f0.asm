004B93F0    push ecx
004B93F1    mov ecx, dword ptr ds:[0x00CC8D5C]
004B93F7    test ecx, ecx
004B93F9    jnz 0x004B940E
004B93FB    push 0x77EB90
004B9400    push 0x7B
004B9402    push 0x77EB50
004B9407    mov ecx, 0x77EB9C
...
004B9434    pop ecx
004B9435    ret
004B9436    push 0x802408
004B943B    push 0x129B
004B9440    push 0x801AF8
004B9445    mov ecx, 0x801AA4
004B944A    mov edx, 0x801800
004B944F    call 0x0063B870
004B9454    add esp, 0x0C
004B9457    call 0x0063BC30
004B945C    test al, al
004B945E    jz 0x004B9461
004B9460    int3
004B9461    call 0x0063BB00
