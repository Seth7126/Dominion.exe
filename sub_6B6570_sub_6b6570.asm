...
006B6575    push 0x76FF65                                   ; => [ Type: EHRegistrationNode | Call: sub_76ff65 ]
006B657A    mov eax, dword ptr fs:[0x00000000]
006B6580    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006B658E    push eax                                        ; => [ Data: __security_cookie ]
006B658F    lea eax, ss:[ebp-0x0C]
006B6592    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006B65AA    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
006B65CC    call 0x006B59E0                                 ; => [ Call: sub_6b59e0 ]
...
006B65E5    call 0x006B4F30                                 ; => [ Call: sub_6b4f30 ]
...
006B660C    call 0x006B5090                                 ; => [ Call: sub_6b5090 ]
...
006B663C    mov dword ptr ss:[ebp-0x1C], ebx                ; => [ Data: data_801800 ]
006B663F    nop
006B6640    lea edx, ss:[ebp-0x28]
006B6643    mov ecx, edi
006B6645    call 0x006B59E0                                 ; => [ Call: sub_6b59e0 ]
...
006B666E    addss xmm0, dword ptr ss:[ebp-0x10]             ; => [ Call: sub_6b4f30 ]
...
006B66A5    call 0x006B4B00                                 ; => [ Call: sub_6b4b00 ]
006B66AA    mov ebx, eax
006B66AC    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006B66C9    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006B66CE    mov ecx, dword ptr ds:[edi+0x38]
006B66D1    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
006B66F2    mulss xmm0, dword ptr ds:[edi+0x28]             ; => [ Call: sub_6417e0 ]
...
006B671D    mulss xmm0, dword ptr ss:[ebp-0x2C]             ; => [ Call: sub_6b43a0 ]
...
006B674C    jz 0x006B6770                                   ; => [ Data: data_cf65bc ]
006B674E    lea ecx, ss:[ebp-0x18]
006B6751    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B6764    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B6769    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006B6793    jz 0x006B67B7                                   ; => [ Data: data_cf65bc ]
006B6795    lea ecx, ss:[ebp-0x18]
006B6798    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B67AB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B67B0    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006B6815    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
006B681A    mov ecx, edi
006B681C    call 0x006B4B00                                 ; => [ Call: sub_6b4b00 ]
006B6821    mov dword ptr ss:[ebp-0x24], eax
006B6824    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006B683F    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006B6844    mov ecx, dword ptr ds:[edi+0x38]
006B6847    mov edx, ebx                                    ; => [ Data: data_801800 ]
...
006B6865    mulss xmm0, dword ptr ds:[edi+0x28]             ; => [ Call: sub_6417e0 ]
...
006B6890    mulss xmm0, dword ptr ss:[ebp-0x2C]             ; => [ Call: sub_6b43a0 ]
...
006B68C4    call 0x006B5AE0                                 ; => [ Call: sub_6b5ae0 ]
...
006B6906    jz 0x006B6936                                   ; => [ Data: data_cf65bc ]
...
006B6917    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B692A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B692F    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006B6954    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B695B    pop ecx
006B695C    pop edi
006B695D    pop esi
006B695E    pop ebx
...
006B6979    call 0x006B5090                                 ; => [ Call: sub_6b5090 ]
...
006B698C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B6993    pop ecx
006B6994    pop edi
006B6995    pop esi
006B6996    pop ebx
...
006B69B7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B69BE    pop ecx
006B69BF    pop edi
006B69C0    pop esi
006B69C1    pop ebx
...
006B6A18    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B6A2B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006B6A50    jz 0x006B6C09                                   ; => [ Data: data_cf65bc ]
...
006B6A7C    call 0x006B4C60                                 ; => [ Call: sub_6b4c60 ]
006B6A81    mov byte ptr ss:[ebp-0x04], 0x0E
006B6A85    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006B6AD1    jz 0x006B6AF5                                   ; => [ Data: data_cf65bc ]
006B6AD3    lea ecx, ss:[ebp-0x14]
006B6AD6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B6AE9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B6AEE    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006B6B0C    jz 0x006B6B29                                   ; => [ Data: data_cf65bc ]
006B6B0E    lea ecx, ss:[ebp-0x10]
006B6B11    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B6B24    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B6B29    mov al, 0x01
006B6B2B    mov ecx, dword ptr ss:[ebp-0x0C]
006B6B2E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B6B35    pop ecx
006B6B36    pop edi
006B6B37    pop esi
006B6B38    pop ebx
...
006B6B42    call 0x006B5AE0                                 ; => [ Call: sub_6b5ae0 ]
...
006B6B5B    mov edx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
006B6B8B    jz 0x006B6BAF                                   ; => [ Data: data_cf65bc ]
006B6B8D    lea ecx, ss:[ebp-0x14]
006B6B90    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B6BA3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B6BA8    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006B6BE0    jz 0x006B6C09                                   ; => [ Data: data_cf65bc ]
...
006B6BF1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B6C04    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B6C09    xor al, al
006B6C0B    mov ecx, dword ptr ss:[ebp-0x0C]
006B6C0E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B6C15    pop ecx
006B6C16    pop edi
006B6C17    pop esi
006B6C18    pop ebx
...
006B6C33    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: WrapperLine | Data: data_801800 | String: wrapperData.mCurrentTextPtr <= wrapperData.mTextLength | String: C:\x\ax2017\Engine\Font.cpp ]
006B6C38    add esp, 0x0C
006B6C3B    call 0x0063BC30
006B6C40    test al, al
006B6C42    jz 0x006B6C45                                   ; => [ Call: sub_63bc30 ]
006B6C44    int3
006B6C45    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
