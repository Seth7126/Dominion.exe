...
004C8145    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
004C814A    mov eax, dword ptr fs:[0x00000000]
004C8150    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004C8151    push ecx
004C8152    push ebx
004C8153    push esi
004C8154    push edi
...
004C815C    push eax                                        ; => [ Data: __security_cookie ]
004C815D    lea eax, ss:[ebp-0x0C]
004C8160    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004C8166    mov edi, dword ptr ss:[ebp+0x08]
004C8169    mov ecx, edi
004C816B    call 0x0064E7A0
004C8170    mov ecx, edi
004C8172    mov dword ptr ds:[eax+0x18BC], 0x4C5F50         ; => [ Call: sub_64e7a0 | Call: sub_4c5f50 ]
004C817C    call 0x0064E7A0
004C8181    mov ecx, edi
004C8183    mov dword ptr ds:[eax+0x18C0], 0x4C5EB0         ; => [ Call: sub_64e7a0 | Call: sub_4c5eb0 ]
004C818D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C8192    movss xmm3, dword ptr ds:[0x00890E18]
004C819A    mov edx, 0x8DC2FC
004C819F    push 0x00
004C81A1    push 0xFFFFFFFF
004C81A3    mov ecx, eax
004C81A5    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc2fc ]
004C81AA    mov ecx, edi
004C81AC    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004C81DD    call 0x004C7D90                                 ; => [ Data: data_8dbfbc | Call: sub_665db0 | Data: data_8dc320 | Data: data_8dc140 | Data: data_8dc0bc | Data: data_8dc0c0 | Call: sub_4c7d90 ]
004C81E2    add esp, 0x18
004C81E5    cmp dword ptr ds:[0x008DC0BC], 0x32
004C81EC    jl 0x004C8210                                   ; => [ Data: data_8dc0bc ]
004C81EE    mov ecx, edi
004C81F0    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C81F5    movss xmm3, dword ptr ds:[0x00890E18]
004C81FD    mov edx, 0x8DBC04
004C8202    push 0x00
004C8204    push 0xFFFFFFFF
004C8206    mov ecx, eax
004C8208    call 0x00665DB0                                 ; => [ Data: data_8dbc04 | Call: sub_665db0 ]
004C820D    add esp, 0x08
004C8210    mov eax, dword ptr ds:[0x008DBFB0]              ; => [ Data: data_8dbfb0 ]
...
004C8231    call 0x004C7F30                                 ; => [ Call: sub_4c7f30 ]
004C8236    add esp, 0x0C
004C8239    mov esi, 0x8DC2E4                               ; => [ Data: data_8dc2e4 ]
004C823E    jmp 0x004C840B
004C8243    push 0x01
004C8245    sub esp, 0x08
004C8248    call 0x004C7F30                                 ; => [ Call: sub_4c7f30 ]
004C824D    add esp, 0x0C
004C8250    mov esi, 0x8DC2D8                               ; => [ Data: data_8dc2d8 ]
004C8255    jmp 0x004C840B
004C825A    xor ebx, ebx                                    ; => [ Call: nullptr ]
004C825C    mov esi, 0x19E57DC                              ; => [ Data: data_19e57dc ]
...
004C8277    jnz 0x004C829F                                  ; => [ String: tblGames ]
...
004C8326    jnz 0x004C834E                                  ; => [ String: tblGames ]
...
004C8574    jz 0x004C8591                                   ; => [ Data: data_cf65bc ]
004C8576    lea ecx, ss:[ebp-0x10]
004C8579    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C858C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C8591    mov ecx, dword ptr ss:[ebp-0x0C]
004C8594    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C859B    pop ecx
004C859C    pop edi
004C859D    pop esi
004C859E    pop ebx
...
004C85A1    pop ebp
004C85A2    ret
004C85A3    push 0x804374                                   ; => [ String: MultiplayerUpdate ]
004C85A8    push 0x1EA4
004C85AD    push 0x80292C
004C85B2    mov edx, 0x801800
004C85B7    mov ecx, 0x801AA4
004C85BC    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: MultiplayerUpdate | String: Halt ]
004C85C1    add esp, 0x0C
004C85C4    call 0x0063BC30
004C85C9    test al, al
004C85CB    jz 0x004C85CE                                   ; => [ Call: sub_63bc30 ]
004C85CD    int3
004C85CE    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004C85D3    push 0x77EB90
004C85D8    push 0x7B
004C85DA    push 0x77EB50
004C85DF    mov edx, 0x801800
004C85E4    mov ecx, 0x77EB9C
004C85E9    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004C85EE    add esp, 0x0C
004C85F1    call 0x0063BC30
004C85F6    test al, al
004C85F8    jz 0x004C85FB                                   ; => [ Call: sub_63bc30 ]
004C85FA    int3
004C85FB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
