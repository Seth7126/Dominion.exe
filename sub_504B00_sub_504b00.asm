...
00504B0B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00504B10    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00504B15    xor eax, esp
00504B17    mov dword ptr ss:[esp+0x19A4], eax
00504B1E    push esi
00504B1F    push edi
00504B20    call 0x00573400                                 ; => [ Call: sub_573400 ]
00504B25    mov esi, eax
00504B27    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
00504B2C    mov edx, dword ptr ds:[esi+0x0C]
00504B2F    mov ecx, dword ptr ds:[esi+0x04]
00504B32    push 0x01
00504B34    push eax
00504B35    call 0x00594010                                 ; => [ Call: sub_594010 ]
00504B3A    xor edx, edx
00504B3C    or ecx, 0xFFFFFFFF
00504B3F    call 0x00561F60                                 ; => [ Call: sub_561f60 ]
00504B44    push 0x00
00504B46    push 0x00
00504B48    push 0x00
...
00504B51    push 0x04
00504B53    push eax
00504B54    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
00504B59    xorps xmm0, xmm0
00504B5C    mov dword ptr ss:[esp+0x58], 0x00
00504B64    movlpd qword ptr ss:[esp+0x50], xmm0            ; => [ Call: __builtin_memset ]
...
00504BBA    push 0x00
00504BBC    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00504BDD    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
00504BEF    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00504C09    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00504C49    push eax
00504C4A    call 0x00586320                                 ; => [ Call: sub_586320 ]
00504C4F    add esp, 0x10
00504C52    mov ecx, dword ptr ss:[esp+0x19AC]
00504C59    pop edi
00504C5A    pop esi
00504C5B    xor ecx, esp
00504C5D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
