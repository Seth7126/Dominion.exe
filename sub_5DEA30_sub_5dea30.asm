...
005DEAA5    push 0x85E55C
005DEAAA    push 0x3DDA
005DEAAF    mov ecx, 0x85E53C
...
005DEB0E    pop ecx
005DEB0F    ret
005DEB10    push 0x85E55C
005DEB15    push 0x3DEB
005DEB1A    mov ecx, 0x801AA4
005DEB1F    push 0x86F1E8
005DEB24    mov edx, 0x801800
005DEB29    call 0x0063B870
005DEB2E    add esp, 0x0C
005DEB31    call 0x0063BC30
005DEB36    test al, al
005DEB38    jz 0x005DEB3B
005DEB3A    int3
005DEB3B    call 0x0063BB00
