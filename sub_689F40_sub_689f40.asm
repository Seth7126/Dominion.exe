...
00689F45    push 0x76DE4D                                   ; => [ Call: sub_76de4d | Type: EHRegistrationNode ]
00689F4A    mov eax, dword ptr fs:[0x00000000]
00689F50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00689F5E    push eax                                        ; => [ Data: __security_cookie ]
00689F5F    lea eax, ss:[ebp-0x0C]
00689F62    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00689F83    jz 0x00689FB3                                   ; => [ Data: data_801800 ]
00689F85    cmp dword ptr ds:[0x00CF65BC], 0x00
00689F8C    jz 0x00689FAD
00689F8E    cmp byte ptr ds:[eax], 0x00
00689F91    jz 0x00689FAD                                   ; => [ Data: data_cf65bc ]
00689F93    mov ecx, ebx
00689F95    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00689FA8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00689FAD    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
00689FC1    jz 0x00689FF1                                   ; => [ Data: data_801800 ]
00689FC3    cmp dword ptr ds:[0x00CF65BC], 0x00
00689FCA    jz 0x00689FEB
00689FCC    cmp byte ptr ds:[eax], 0x00
00689FCF    jz 0x00689FEB                                   ; => [ Data: data_cf65bc ]
00689FD1    mov ecx, ebx
00689FD3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00689FE6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00689FEB    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
00689FF1    mov eax, dword ptr ds:[edi]
00689FF3    mov dword ptr ss:[ebp-0x14], eax
00689FF6    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
00689FFD    lea edx, ss:[ebp-0x1C]
0068A000    mov dword ptr ss:[ebp-0x04], 0x00
0068A007    lea ecx, ss:[ebp-0x14]
0068A00A    call 0x00689E90                                 ; => [ Type: va_list | Call: sub_689e90 ]
0068A00F    mov edi, dword ptr ss:[ebp-0x1C]
0068A012    test al, al
0068A014    jz 0x0068A155
0068A01A    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
0068A01F    test edi, edi
0068A021    push esi
0068A022    mov eax, ebx                                    ; => [ Data: data_801800 ]
0068A024    cmovnz eax, edi
0068A027    push 0x87761C
0068A02C    push eax
0068A02D    call 0x0064B6D0                                 ; => [ Type: va_list | Call: sub_64b6d0 | String: HTTP/1.1 %d ]
0068A032    add esp, 0x0C
0068A035    cmp eax, 0x01
0068A038    jz 0x0068A059
0068A03A    test edi, edi
0068A03C    mov eax, ebx                                    ; => [ Data: data_801800 ]
0068A03E    push esi
0068A03F    cmovnz eax, edi
0068A042    push 0x877660
0068A047    push eax
0068A048    call 0x0064B6D0                                 ; => [ Call: sub_64b6d0 | String: HTTP/1.0 %d ]
...
0068A0C2    jz 0x0068A1A2                                   ; => [ Call: sub_63d4e0 ]
0068A0C8    lea eax, ss:[ebp-0x18]
0068A0CB    push eax
0068A0CC    push 0x87768C
0068A0D1    push esi
0068A0D2    call 0x0064B6D0                                 ; => [ Call: sub_64b6d0 | String: Content-Length: %d ]
...
0068A0EA    jz 0x0068A107                                   ; => [ Data: data_cf65bc ]
0068A0EC    lea ecx, ss:[ebp-0x10]
0068A0EF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068A13D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068A150    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068A171    jz 0x0068A18E                                   ; => [ Data: data_cf65bc ]
0068A173    lea ecx, ss:[ebp-0x1C]
0068A176    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068A189    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068A18E    mov eax, ebx
0068A190    mov ecx, dword ptr ss:[ebp-0x0C]
0068A193    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068A19A    pop ecx
0068A19B    pop edi
0068A19C    pop esi
0068A19D    pop ebx
...
0068A1B1    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
0068A1CA    jz 0x0068A1E7                                   ; => [ Data: data_cf65bc ]
0068A1CC    lea ecx, ss:[ebp-0x10]
0068A1CF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068A227    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0068A22C    push 0x875F54
0068A231    cmovnz eax, esi
0068A234    push eax
0068A235    call 0x0064B6D0                                 ; => [ String: %x | Call: sub_64b6d0 ]
...
0068A25A    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
0068A284    jz 0x0068A15A                                   ; => [ Data: data_cf65bc ]
0068A28A    lea ecx, ss:[ebp+0x08]
0068A28D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068A2A4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
