...
004F1789    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004F17B3    push 0x808C50                                   ; => [ String: FillNodeType ]
004F17B8    push 0xFE6
004F17BD    mov ecx, 0x808B7C                               ; => [ String: yld.minChoices == 0 || yld.minChoices == 1 ]
...
004F17D9    call 0x005939A0                                 ; => [ Call: sub_5939a0 ]
...
004F180C    push eax
004F180D    call 0x004EFCF0                                 ; => [ Call: sub_4efcf0 ]
004F1812    inc ebx
...
004F1843    call 0x004EFCF0                                 ; => [ Call: sub_4efcf0 ]
...
004F1852    pop ebx
004F1853    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004F1858    mov esp, ebp
004F185A    pop ebp
004F185B    ret
004F185C    push 0x808C50                                   ; => [ String: FillNodeType ]
004F1861    push 0xFE7
004F1866    mov ecx, 0x808BA8                               ; => [ String: yld.maxChoices == 1 ]
004F186B    push 0x8088A8
004F1870    mov edx, 0x801800
004F1875    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: FillNodeType | String: C:\x\ax2017\Jams\Dominion\code\DomAIMCTS.cpp ]
004F187A    add esp, 0x0C
004F187D    call 0x0063BC30
004F1882    test al, al
004F1884    jz 0x004F1887                                   ; => [ Call: sub_63bc30 ]
004F1886    int3
004F1887    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
