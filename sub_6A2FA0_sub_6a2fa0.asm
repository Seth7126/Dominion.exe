...
006A2FA0    push esi
006A2FA1    mov esi, dword ptr ds:[0x0147AC64]              ; => [ Data: data_147ac64 ]
...
006A2FB3    call 0x006A6440                                 ; => [ Call: sub_6a6440 ]
...
006A2FD7    mov dword ptr ds:[ecx], 0x801800                ; => [ Data: data_801800 ]
