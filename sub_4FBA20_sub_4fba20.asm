...
004FBA2B    call 0x00761E50
004FBA30    mov eax, dword ptr ds:[0x008C4040]
...
004FBA47    call 0x0056B270
004FBA4C    call 0x0056B3A0
004FBA51    test al, al
