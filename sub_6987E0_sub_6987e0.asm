...
006987E3    mov eax, dword ptr ds:[0x00CAF270]              ; => [ Data: data_caf270 ]
...
006987F6    jb 0x00698811                                   ; => [ Data: data_caf268 ]
006987F8    push 0x87937C                                   ; => [ String: DataArray<struct UIState>::DataArrayAlloc ]
006987FD    push 0xF4
00698802    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h ]
00698807    mov ecx, 0x8019B8                               ; => [ String: mUsedCount < mMaxSize ]
0069880C    jmp 0x00698A07
00698811    mov eax, dword ptr ds:[0x00CAF26C]              ; => [ Data: data_caf26c ]
00698816    mov esi, dword ptr ds:[0x00CAF264]              ; => [ Data: data_caf264 ]
0069881C    cmp eax, esi
0069881E    jbe 0x00698839
00698820    push 0x87937C                                   ; => [ String: DataArray<struct UIState>::DataArrayAlloc ]
00698825    push 0xF5
0069882A    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h ]
0069882F    mov ecx, 0x8019D0                               ; => [ String: mFreeListHead <= mMaxUsedCount ]
00698834    jmp 0x00698A07
00698839    mov ecx, dword ptr ds:[0x00CAF260]              ; => [ Data: data_caf260 ]
0069883F    jnz 0x0069884B
00698841    lea eax, ds:[esi+0x01]
00698844    mov dword ptr ds:[0x00CAF264], eax              ; => [ Data: data_caf264 ]
...
00698860    push 0x434
00698865    push 0x00
00698867    mov dword ptr ds:[0x00CAF26C], eax              ; => [ Data: data_caf26c ]
0069886C    add edi, ecx
0069886E    push edi
0069886F    mov dword ptr ss:[ebp-0x0C], edi
00698872    call 0x00761FC4                                 ; => [ Call: memset ]
00698877    mov eax, dword ptr ds:[0x00CAF274]
0069887C    add esp, 0x0C
0069887F    shl eax, 0x10
00698882    or eax, esi
00698884    mov dword ptr ds:[edi+0x434], eax               ; => [ Data: data_caf274 ]
0069888A    mov eax, dword ptr ds:[0x00CAF274]
0069888F    inc eax                                         ; => [ Data: data_caf274 ]
00698890    mov dword ptr ds:[0x00CAF274], eax              ; => [ Data: data_caf274 ]
00698895    cmp eax, 0x10000
0069889A    jnz 0x006988A6
0069889C    mov dword ptr ds:[0x00CAF274], 0x01             ; => [ Data: data_caf274 ]
006988A6    inc dword ptr ds:[0x00CAF270]                   ; => [ Data: data_caf270 ]
006988AC    mov dword ptr ds:[edi+0x04], ebx
006988AF    cmp dword ptr ds:[ebx+0x04], 0x1E
006988B3    jz 0x006988C9
006988B5    push 0x8790A8                                   ; => [ String: UIDefGet ]
006988BA    push 0x127
006988BF    mov ecx, 0x8790C8                               ; => [ String: ptr->assetType == ASSET_TYPE_UI ]
006988C4    jmp 0x00698A02
006988C9    mov ecx, ebx
006988CB    call 0x005AF880
006988D0    mov ebx, eax                                    ; => [ Call: sub_5af880 ]
...
0069891A    call 0x00698630                                 ; => [ Call: sub_698630 ]
...
00698935    call 0x006B8340                                 ; => [ Data: data_7ffb14 | Call: sub_6b8340 ]
...
0069895C    call 0x00698630                                 ; => [ Call: sub_698630 ]
00698961    mov ecx, dword ptr ds:[ebx+0x48]
00698964    add esp, 0x04
00698967    mov edi, eax
00698969    call 0x006E5AB0                                 ; => [ Call: sub_6e5ab0 ]
...
0069897D    call 0x006E68F0                                 ; => [ Call: sub_6e68f0 ]
...
006989A0    call 0x00698630                                 ; => [ Call: sub_698630 ]
...
006989F1    pop ebp
006989F2    ret
006989F3    push 0x879184                                   ; => [ String: UIStateLoad ]
006989F8    push 0x57A
006989FD    mov ecx, 0x8791A8                               ; => [ String: layout.numElements < MAX_UI_ELEMENTS ]
00698A02    push 0x878EA8                                   ; => [ String: C:\x\ax2017\Engine\UIDef.cpp ]
00698A07    mov edx, 0x801800
00698A0C    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00698A11    add esp, 0x0C
00698A14    call 0x0063BC30
00698A19    test al, al
00698A1B    jz 0x00698A1E                                   ; => [ Call: sub_63bc30 ]
00698A1D    int3
00698A1E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
