...
00522896    call 0x0063B870
0052289B    add esp, 0x0C
0052289E    call 0x0063BC30
005228A3    test al, al
005228A5    jz 0x005228A8
005228A7    int3
005228A8    call 0x0063BB00
