...
00529896    call 0x00761E50
0052989B    mov eax, dword ptr ds:[0x008C4040]
005298A0    xor eax, ebp
...
0052996C    push edi
0052996D    call dword ptr ds:[eax]
...
005299C1    mov dword ptr ss:[ebp-0xCD0], 0x81F0F8
005299CB    mov dword ptr ss:[ebp-0xCCC], eax
005299D1    lea eax, ss:[ebp-0xCD0]
005299D7    mov dword ptr ss:[ebp-0xCAC], eax
...
00529A15    push edi
00529A16    call dword ptr ds:[eax]
...
00529A38    mov dword ptr ss:[ebp-0xD00], eax
...
00529A52    push eax
00529A53    call dword ptr ds:[edx+0x10]
...
00529AA3    call 0x00582EB0
00529AA8    add esp, 0x28
00529AAB    mov ecx, dword ptr ss:[ebp-0x0C]
00529AAE    mov dword ptr fs:[0x00000000], ecx
00529AB5    pop ecx
00529AB6    pop edi
00529AB7    pop esi
00529AB8    pop ebx
