...
00537C9C    test al, al
00537C9E    jz 0x00537CDD                                   ; => [ Call: sub_5754f0 ]
00537CA0    call 0x00573400                                 ; => [ Call: sub_573400 ]
00537CA5    push 0x00
00537CA7    push 0x00
00537CA9    push 0x01
...
00537CB1    push 0x01
00537CB3    call 0x00590760                                 ; => [ Call: sub_590760 ]
00537CB8    add esp, 0x10
00537CBB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00537D50    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
...
00537D75    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00537D7A    add esp, 0x0C
00537D7D    call 0x0063BC30
00537D82    test al, al
00537D84    jz 0x00537D87                                   ; => [ Call: sub_63bc30 ]
00537D86    int3
00537D87    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
