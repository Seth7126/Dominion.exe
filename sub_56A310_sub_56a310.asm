...
0056A315    push 0x767358                                   ; => [ Call: __ehhandler$?CaptureProcessAffinity@ResourceManager@details@Concurrency@@CAXXZ | Type: EHRegistrationNode ]
0056A31A    mov eax, dword ptr fs:[0x00000000]
0056A320    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0056A32E    push esi
0056A32F    push edi
0056A330    push eax                                        ; => [ Data: __security_cookie ]
0056A331    lea eax, ss:[ebp-0x0C]
0056A334    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0056A36F    mov dword ptr ss:[ebp-0x40], 0x81F06C           ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_a7652d2ce0fa712dd02a3f2f4704133c>, void>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_a7652d2ce0fa712dd02a3f2f4704133c>, void>::`vftable'{for `std::_Func_base<void>'} ]
0056A376    mov dword ptr ss:[ebp-0x1C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_a7652d2ce0fa712dd02a3f2f4704133c>, void>::VTable ]
...
0056A39D    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
0056A3B3    push 0x30
0056A3B5    push eax
0056A3B6    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
...
0056A3D6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0056A3DD    pop ecx
0056A3DE    pop edi
0056A3DF    pop esi
0056A3E0    mov ecx, dword ptr ss:[ebp-0x10]
0056A3E3    xor ecx, ebp
0056A3E5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
