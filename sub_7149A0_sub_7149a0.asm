...
007149A3    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
007149A8    push ebx
007149A9    push esi
007149AA    push edi
...
007149BA    push 0x0C
007149BC    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
007149BE    add esp, 0x0C
007149C1    jmp 0x007149CE
007149C3    push 0x0C
007149C5    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00714A02    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00714A07    test eax, eax
00714A09    jz 0x00714A1A
00714A0B    push 0x75
00714A0D    push 0x88DCF8
00714A12    push ebx
00714A13    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00714A15    add esp, 0x0C
00714A18    jmp 0x00714A24
00714A1A    push ebx
00714A1B    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00714A2B    push 0x00
00714A2D    push esi
00714A2E    call 0x00761FC4                                 ; => [ Call: memset ]
