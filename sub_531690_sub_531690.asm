...
005316D4    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005316F0    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
005316F5    add esp, 0x0C
005316F8    call 0x00573400
005316FD    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00531700    cmp esi, 0x320
00531706    jb 0x0053170D
00531708    call 0x00591930                                 ; => [ Call: sub_591930 ]
0053170D    mov ecx, dword ptr ds:[ebx+edi*1+0x1A4C]
00531714    sub esp, 0x28
00531717    mov eax, esp
00531719    mov dword ptr ds:[eax], 0x819700                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_f652bf34ba97b8d425f6a2bb45d8c85f>, void>::`vftable'{for `std::_Func_base<void>'} | Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_f652bf34ba97b8d425f6a2bb45d8c85f>, void>::VTable ]
0053171F    mov dword ptr ds:[eax+0x04], ecx
00531722    mov dword ptr ds:[eax+0x24], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_f652bf34ba97b8d425f6a2bb45d8c85f>, void>::VTable ]
00531725    call 0x005699B0                                 ; => [ Call: sub_5699b0 ]
...
00531741    push 0x02
00531743    push eax
00531744    call 0x005657E0                                 ; => [ Call: sub_5657e0 ]
