...
0060059C    mov ecx, dword ptr ds:[0x008DB664]
...
006005B5    jnz 0x006005C8
006005B7    pop edi
006005B8    pop esi
006005B9    pop ebx
006005BA    pop ebp
006005BB    jmp 0x005EC880
006005C0    mov ecx, dword ptr ds:[0x008DB664]
006005C6    jmp 0x006005AA
006005C8    cmp ecx, 0x7EC
006005CE    jz 0x0060062B
006005D0    cmp dword ptr ds:[0x00BE220C], 0x00
006005D7    jz 0x00600601
...
006005F0    mov dword ptr ds:[0x00BE220C], 0x00
006005FA    mov byte ptr ds:[0x00B7D418], 0x00
00600601    call 0x005CB070
...
00600619    pop ebx
0060061A    pop ebp
0060061B    jmp 0x005F4E70
00600620    xor ecx, ecx
00600622    pop edi
00600623    pop esi
00600624    pop ebx
00600625    pop ebp
00600626    jmp 0x005F4E70
0060062B    xor dl, dl
...
00600656    call 0x0063B870
0060065B    add esp, 0x0C
0060065E    call 0x0063BC30
00600663    test al, al
00600665    jz 0x00600668
00600667    int3
00600668    call 0x0063BB00
