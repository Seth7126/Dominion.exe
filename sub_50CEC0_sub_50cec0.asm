...
0050CECD    call 0x00513D60                                 ; => [ Call: sub_513d60 ]
0050CED2    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0050CEF1    shl esi, 0x10                                   ; => [ Call: sub_571b30 ]
0050CEF4    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050CEF9    push 0x00
0050CEFB    push 0x00
...
0050CF1E    pop ebp
0050CF1F    ret                                             ; => [ Call: sub_5911e0 ]
0050CF20    push 0x813AF4
0050CF25    push 0xC59
0050CF2A    push 0x80CD80
0050CF2F    mov edx, 0x801800
0050CF34    mov ecx, 0x813B08
0050CF39    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: StampGetPileSetup | String: c.contextType == CONTEXT_SETUP ]
0050CF3E    add esp, 0x0C
0050CF41    call 0x0063BC30
0050CF46    test al, al
0050CF48    jz 0x0050CF4B                                   ; => [ Call: sub_63bc30 ]
0050CF4A    int3
0050CF4B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
