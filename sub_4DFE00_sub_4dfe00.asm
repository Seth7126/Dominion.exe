...
004DFE05    push 0x76408E                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??1_Blocking_recipient@?1???$_Receive_impl@W4agent_status@Concurrency@@@Concurrency@@YA?AW4agent_status@1@PAV?$ISource@W4agent_status@Concurrency@@@1@IPBV?$function@$$A6A_NABW4agent_status@Concurrency@@@Z@std@@@Z@UAE@XZ ]
004DFE0A    mov eax, dword ptr fs:[0x00000000]
004DFE10    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DFE11    sub esp, 0x18
004DFE14    push esi
004DFE15    push edi
004DFE16    mov eax, dword ptr ds:[0x008C4040]
004DFE1B    xor eax, ebp
004DFE1D    push eax                                        ; => [ Data: __security_cookie ]
004DFE1E    lea eax, ss:[ebp-0x0C]
004DFE21    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004DFE27    mov edi, edx
004DFE29    mov esi, ecx
004DFE2B    mov dword ptr ss:[ebp-0x18], esi
004DFE2E    mov dword ptr ss:[ebp-0x14], 0x00
004DFE35    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
004DFE5F    call 0x0063D720                                 ; => [ String: Landscapes | Call: sub_63d720 ]
...
004DFEA2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DFEB5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004DFED4    call 0x0063D720                                 ; => [ String: Events | Call: sub_63d720 ]
...
004DFF17    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DFF2A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004DFF49    call 0x0063D720                                 ; => [ String: Landmarks | Call: sub_63d720 ]
...
004DFF8C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DFF9F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004DFFBE    call 0x0063D720                                 ; => [ String: Projects | Call: sub_63d720 ]
...
004E0001    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0014    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E0033    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: Ways ]
...
004E0076    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0089    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E00A8    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: Traits ]
...
004E00EB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E00FE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0103    mov edx, 0x807274
004E0108    mov byte ptr ss:[ebp-0x04], 0x00
004E010C    lea ecx, ss:[ebp-0x10]
004E010F    call 0x0063D720                                 ; => [ String: Ally | Call: sub_63d720 ]
...
004E014E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E0161    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E0166    mov edx, 0x80727C
004E016B    mov byte ptr ss:[ebp-0x04], 0x00
004E016F    lea ecx, ss:[ebp-0x10]
004E0172    call 0x0063D720                                 ; => [ String: Prophecy | Call: sub_63d720 ]
...
004E01B1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E01C4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E01C9    mov eax, esi
004E01CB    mov ecx, dword ptr ss:[ebp-0x0C]
004E01CE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E01D5    pop ecx
004E01D6    pop edi
004E01D7    pop esi
