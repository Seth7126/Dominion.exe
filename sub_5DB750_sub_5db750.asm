...
005DB756    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005DB75B    xor eax, ebp
005DB75D    mov dword ptr ss:[ebp-0x04], eax
005DB760    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
005DB7C3    call 0x005D77E0                                 ; => [ Call: sub_5d77e0 ]
...
005DB7DC    call 0x005D8610                                 ; => [ Call: sub_5d8610 ]
005DB7E1    push 0x00
005DB7E3    push 0x00
005DB7E5    push eax
...
005DB7FD    call 0x00654CE0                                 ; => [ Call: nullptr | String: arrow | Data: data_171e874 | Call: sub_654ce0 ]
005DB802    mov ecx, dword ptr ds:[edi]
005DB804    lea edx, ss:[ebp-0x24]
005DB807    add esp, 0x18
005DB80A    call 0x00666060                                 ; => [ Call: sub_666060 ]
005DB80F    mov ecx, dword ptr ds:[edi]
005DB811    call 0x0064E7A0
005DB816    mov dword ptr ds:[eax+0x18BC], 0x5DB060         ; => [ Call: sub_5db060 | Call: sub_64e7a0 ]
...
005DB833    push 0x871628                                   ; => [ String: DomDeclareArrow ]
005DB838    push 0x36B1
005DB83D    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005DB842    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005DB847    jmp 0x005DB97D
005DB84C    mov ecx, dword ptr ds:[edi]
005DB84E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005DB853    movss xmm3, dword ptr ds:[0x00890E18]
005DB85B    mov edx, 0xBE2FA4
005DB860    push 0x00
005DB862    push 0xFFFFFFFF
005DB864    mov ecx, eax
005DB866    call 0x00665DB0                                 ; => [ Data: data_be2fa4 | Call: sub_665db0 ]
005DB86B    mov ecx, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
005DB884    jnz 0x005DB8BE                                  ; => [ Data: data_b80b44 ]
005DB886    xor eax, eax
005DB888    cmp ecx, 0xFFFFFFFF
005DB88B    cmovz ecx, eax
005DB88E    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
005DB893    test eax, eax
005DB895    jnz 0x005DB8AD
005DB897    push 0x77EB90                                   ; => [ String: GetClient ]
005DB89C    push 0x7B
005DB89E    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
005DB8A3    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
...
005DB8BC    jnz 0x005DB911                                  ; => [ Data: data_b604cc ]
005DB8BE    mov ecx, dword ptr ds:[edi]
005DB8C0    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005DB8C5    movss xmm3, dword ptr ds:[0x00890E18]
005DB8CD    mov edx, 0xBE31B4
005DB8D2    push 0x00
005DB8D4    push 0xFFFFFFFF
005DB8D6    mov ecx, eax
005DB8D8    call 0x00665DB0                                 ; => [ Data: data_be31b4 | Call: sub_665db0 ]
005DB8DD    add esp, 0x08
005DB8E0    jmp 0x005DB911
005DB8E2    mov ecx, dword ptr ds:[edi]
005DB8E4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005DB8E9    movss xmm3, dword ptr ds:[0x00890E18]
005DB8F1    mov edx, 0xBE31A8
005DB8F6    push 0x00
005DB8F8    push 0xFFFFFFFF
005DB8FA    mov ecx, eax
005DB8FC    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be31a8 ]
005DB901    mov edx, dword ptr ds:[esi+0x228]
005DB907    add esp, 0x08
005DB90A    mov ecx, dword ptr ds:[edi]
005DB90C    call 0x005D8950                                 ; => [ Call: sub_5d8950 ]
005DB911    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
005DB916    test eax, eax
005DB918    jz 0x005DB969
005DB91A    cmp dword ptr ds:[eax+0x0C], 0x00
005DB91E    mov ecx, 0xCADF60
005DB923    mov esi, 0xCADF54                               ; => [ Data: data_cadf54 ]
005DB928    cmovz esi, ecx                                  ; => [ Data: data_cadf60 ]
005DB92B    mov ecx, dword ptr ds:[edi]
005DB92D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005DB932    movss xmm3, dword ptr ds:[0x00890E18]
005DB93A    mov edx, esi
005DB93C    push 0x00
005DB93E    push 0xFFFFFFFF
005DB940    mov ecx, eax
005DB942    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
005DB947    movss xmm1, dword ptr ds:[0x008C4634]
005DB94F    add esp, 0x08
005DB952    mov ecx, dword ptr ds:[edi]
005DB954    call 0x0065D6E0                                 ; => [ Data: data_8c4634 | Call: sub_65d6e0 ]
005DB959    mov ecx, dword ptr ss:[ebp-0x04]
005DB95C    pop edi
005DB95D    xor ecx, ebp
005DB95F    pop esi
005DB960    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005DB965    mov esp, ebp
005DB967    pop ebp
005DB968    ret
005DB969    push 0x806A44                                   ; => [ String: GetLocalSettings ]
005DB96E    push 0x5FB
005DB973    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
005DB978    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
005DB97D    mov edx, 0x801800
005DB982    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005DB987    add esp, 0x0C
005DB98A    call 0x0063BC30
005DB98F    test al, al
005DB991    jz 0x005DB994                                   ; => [ Call: sub_63bc30 ]
005DB993    int3
005DB994    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
