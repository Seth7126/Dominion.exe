...
00752B0A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B10    push dword ptr ds:[esi+0x6C]
00752B13    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
00752B40    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B46    push dword ptr ds:[esi]
00752B48    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B4E    push dword ptr ds:[esi+0x18]
00752B51    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B57    push dword ptr ds:[esi+0x20]
00752B5A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B60    push dword ptr ds:[esi+0x68]
00752B63    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B69    push dword ptr ds:[esi+0x74]
00752B6C    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752B72    push dword ptr ds:[esi+0x94]
00752B78    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
00752BA6    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00752BAC    push dword ptr ds:[esi]
00752BAE    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
