...
004DFA15    push 0x763FCD                                   ; => [ Call: __ehhandler$??1?$single_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@UAE@XZ | Type: EHRegistrationNode ]
004DFA1A    mov eax, dword ptr fs:[0x00000000]
004DFA20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DFA21    push ecx
004DFA22    push ebx
004DFA23    push esi
004DFA24    push edi
...
004DFA2C    push eax                                        ; => [ Data: __security_cookie ]
004DFA2D    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004DFA30    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DFA98    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004DFA9D    push dword ptr ds:[ebx+0x04]
004DFAA0    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004DFAC6    mov eax, dword ptr ds:[eax]                     ; => [ String: %s(%d,%d) | Call: sub_63df30 ]
004DFAC8    test eax, eax
004DFACA    cmovnz esi, eax
004DFACD    push esi
004DFACE    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004DFAD3    mov dword ptr ss:[ebp-0x04], 0x01
004DFADA    cmp dword ptr ds:[0x00CF65BC], 0x00
004DFAE1    jz 0x004DFB0A                                   ; => [ Data: data_cf65bc ]
...
004DFAF2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DFB05    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DFB0A    mov ecx, dword ptr ss:[ebp-0x0C]
004DFB0D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DFB14    pop ecx
004DFB15    pop edi
004DFB16    pop esi
004DFB17    pop ebx
