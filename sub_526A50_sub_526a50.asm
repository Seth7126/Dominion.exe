...
00526A60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00526A61    mov eax, 0x2620
00526A66    call 0x00761E50                                 ; => [ Call: __chkstk ]
00526A6B    mov eax, dword ptr ds:[0x008C4040]
00526A70    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00526A72    mov dword ptr ss:[ebp-0x10], eax
00526A75    push esi
00526A76    push edi
00526A77    push eax
00526A78    lea eax, ss:[ebp-0x0C]
00526A7B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00526AA4    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
00526AA6    lea ecx, ss:[ebp-0xCF4]
00526AAC    call 0x00561940                                 ; => [ Call: sub_561940 ]
00526AB1    push 0x00
...
00526AD6    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568920 ]
00526AD8    mov eax, dword ptr ss:[ebp-0xD28]
00526ADE    add esp, 0x10
00526AE1    mov ecx, 0x6C                                   ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_084898625d6b0b449ee1221793ad2881>, void>::VTable ]
...
00526B04    mov dword ptr ss:[ebp-0x40], ecx                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_084898625d6b0b449ee1221793ad2881>, void>::VTable ]
00526B07    movlpd qword ptr ss:[ebp-0x18], xmm0
00526B0C    lea ecx, ss:[ebp-0x70]
00526B0F    movlpd qword ptr ss:[ebp-0x20], xmm0
00526B14    neg edx
00526B16    movlpd qword ptr ss:[ebp-0x3C], xmm0            ; => [ Call: __builtin_memset ]
...
00526B30    mov dword ptr ss:[ebp-0x24], 0x00               ; => [ Call: __builtin_memset ]
00526B37    neg eax
00526B39    mov dword ptr ss:[ebp-0x30], 0x00
00526B40    movups xmmword ptr ss:[ebp-0xD24], xmm0
00526B47    sbb eax, eax
00526B49    mov dword ptr ss:[ebp-0x4C], ecx                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_562d387227112c831166beca1059eb7d>, void>::VTable ]
00526B4C    movups xmm0, xmmword ptr ss:[ebp-0x30]
00526B50    lea ecx, ss:[ebp-0x40]
00526B53    mov dword ptr ss:[ebp-0x70], 0x81858C           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_562d387227112c831166beca1059eb7d>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
00526B72    mov dword ptr ss:[ebp-0x40], 0x818570           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_084898625d6b0b449ee1221793ad2881>, void>::`vftable'{for `std::_Func_base<void>'} ]
00526B79    mov dword ptr ss:[ebp-0x1C], ecx                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_084898625d6b0b449ee1221793ad2881>, void>::VTable ]
...
00526BA9    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
00526BAE    add esp, 0x14
00526BB1    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00526BB8    lea eax, ss:[ebp-0x70]
00526BBB    push 0x4F8780                                   ; => [ Call: sub_4f8780 ]
00526BC0    push 0x02
00526BC2    push 0x30
00526BC4    push eax                                        ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_562d387227112c831166beca1059eb7d>, void>::VTable ]
00526BC5    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' ]
00526BCA    mov ecx, dword ptr ss:[ebp-0x0C]
00526BCD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00526BD4    pop ecx
00526BD5    pop edi
00526BD6    pop esi
00526BD7    mov ecx, dword ptr ss:[ebp-0x10]
00526BDA    xor ecx, ebp
00526BDC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
