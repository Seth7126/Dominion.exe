...
00656532    mov dword ptr ds:[esi+0x04], eax                ; => [ Data: data_c23c04 ]
00656535    mov eax, dword ptr ds:[0x00C23C08]
0065653A    mov dword ptr ds:[esi+0x08], eax                ; => [ Data: data_c23c08 ]
0065653D    mov eax, dword ptr ds:[0x00C23C0C]
00656542    mov dword ptr ds:[esi+0x0C], eax                ; => [ Data: data_c23c0c ]
00656545    mov eax, dword ptr ds:[0x00C23C10]
0065654A    mov dword ptr ds:[esi+0x10], eax                ; => [ Data: data_c23c10 ]
0065654D    mov eax, dword ptr ds:[0x00C23C14]
00656552    mov dword ptr ds:[esi+0x14], eax                ; => [ Data: data_c23c14 ]
00656555    mov eax, esi
00656557    mov dword ptr ds:[esi], 0x8028C4                ; => [ Data: UI2HitResult::`vftable'{for `InputHitResult'} ]
0065655D    pop esi
0065655E    mov esp, ebp
00656560    pop ebp
00656561    ret
00656562    mov ecx, edx
00656564    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00656569    push 0x00
0065656B    push dword ptr ss:[ebp+0x08]
0065656E    mov edx, eax
00656570    lea ecx, ss:[ebp-0x1C]
00656573    push 0xFF
00656578    call 0x00655F50                                 ; => [ Call: sub_655f50 ]
...
006565A0    mov dword ptr ds:[esi], 0x8028C4                ; => [ Data: UI2HitResult::`vftable'{for `InputHitResult'} ]
006565A6    pop esi
