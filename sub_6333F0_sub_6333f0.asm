...
00633565    push 0x86DC50
0063356A    push 0x10FD9
0063356F    mov ecx, 0x86DC3C
00633574    jmp 0x00633636
00633579    push 0x86DC50
...
006335B6    call 0x005CD880
006335BB    mov ecx, edi
006335BD    call 0x005CB5A0
006335C2    mov eax, dword ptr ss:[ebp-0x08]
006335C5    mov dword ptr ds:[ebx], 0x00
006335CB    inc esi
...
00633625    pop ebp
00633626    ret
00633627    push 0x86DBE0
0063362C    push 0x10DD4
00633631    mov ecx, 0x86F83C
00633636    push 0x86F1E8
0063363B    mov edx, 0x801800
00633640    call 0x0063B870
00633645    add esp, 0x0C
00633648    call 0x0063BC30
0063364D    test al, al
0063364F    jz 0x00633652
00633651    int3
00633652    call 0x0063BB00
