...
004BC4B2    push ecx
004BC4B3    mov ecx, dword ptr ds:[0x00CC8D5C]
004BC4B9    test ecx, ecx
004BC4BB    jz 0x004BC4EF
004BC4BD    add ecx, 0x507C
004BC4C3    push eax
004BC4C4    call 0x004BB050
004BC4C9    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004BC505    call 0x0063B870
004BC50A    add esp, 0x0C
004BC50D    call 0x0063BC30
004BC512    test al, al
004BC514    jz 0x004BC517
004BC516    int3
004BC517    call 0x0063BB00
