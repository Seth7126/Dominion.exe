...
006D9967    call dword ptr ds:[eax+0x30]
...
006D9981    call dword ptr ds:[eax+0x3C]
...
006D999B    call dword ptr ds:[eax+0x30]
...
006D99B5    call dword ptr ds:[eax+0x3C]
