...
0063DEAA    push dword ptr ds:[eax+0x04]                    ; => [ Data: data_19e399c ]
0063DEAD    or ecx, 0x02
0063DEB0    push ecx
0063DEB1    call dword ptr ds:[0x00775640]
0063DEB7    mov edi, eax                                    ; => [ Call: nullptr | Data: data_19e3998 ]
...
0063DECF    jz 0x0063DEF6                                   ; => [ Data: data_cf65bc ]
...
0063DEDE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063DEF1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063DEF6    pop edi
0063DEF7    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
0063DF1A    call 0x0063BC40                                 ; => [ Call: Mod1::CheckFCreateWriter | Call: sub_63d5e0 ]
