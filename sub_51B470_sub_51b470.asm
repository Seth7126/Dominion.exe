...
0051B47E    mov edi, 0x77FCA8                               ; => [ Data: data_77fca8 ]
0051B483    mov dword ptr ss:[ebp-0x08], ecx
0051B486    mov dword ptr ss:[ebp-0x04], eax
0051B489    mov dword ptr ss:[ebp-0x0C], edi                ; => [ Data: data_77fca8 ]
...
0051B499    call 0x0060EAE0                                 ; => [ Call: sub_60eae0 ]
0051B49E    test al, al
0051B4A0    jnz 0x0051B4CB
0051B4A2    lea edx, ss:[ebp-0x18]
0051B4A5    lea ecx, ss:[ebp-0x10]
0051B4A8    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
0051B4C2    test al, al
0051B4C4    jnz 0x0051B4E9                                  ; => [ Call: sub_4db700 ]
0051B4C6    inc esi
...
0051B4E0    jl 0x0051B490                                   ; => [ Data: data_77fea0 ]
0051B4E2    pop edi
0051B4E3    pop esi
0051B4E4    pop ebx
