...
0058A238    call 0x00761E50                                 ; => [ Call: __chkstk ]
0058A23D    mov eax, dword ptr ds:[0x008C4040]
0058A242    xor eax, ebp
0058A244    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
0058A247    push ebx
...
0058A278    push 0x00
0058A27A    push 0x00
0058A27C    push 0x00                                       ; => [ Call: __builtin_memset ]
0058A27E    push 0x05
...
0058A28A    push edi
0058A28B    setz cl
0058A28E    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
...
0058A2AA    call 0x00581450                                 ; => [ Call: sub_581450 ]
0058A2AF    add esp, 0x0C
0058A2B2    lea eax, ss:[ebp-0x2610]
0058A2B8    push 0x48
0058A2BA    push 0x00
0058A2BC    push eax
0058A2BD    call 0x00761FC4                                 ; => [ Call: memset ]
...
0058A2E8    push 0x01
0058A2EA    push eax
0058A2EB    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
...
0058A32E    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
0058A346    mov dword ptr ss:[ebp-0xC90], 0x00              ; => [ Call: nullptr ]
0058A350    mov edx, 0x3E9
0058A355    mov dword ptr ss:[ebp-0x25A0], eax              ; => [ Call: nullptr ]
0058A35B    mov ecx, ebx
0058A35D    mov dword ptr ss:[ebp-0x1918], eax              ; => [ Call: nullptr ]
0058A363    call 0x005722C0                                 ; => [ Call: sub_5722c0 ]
...
0058A37C    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A3E6    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A409    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A4BB    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A523    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
...
0058A562    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A5E6    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A616    push 0x00
0058A618    push 0x00
0058A61A    push 0x00                                       ; => [ Call: __builtin_memset ]
0058A61C    push 0x451
0058A621    push 0x08
0058A623    push eax
0058A624    call 0x005822E0                                 ; => [ Call: sub_5822e0 ]
...
0058A65D    test al, al
0058A65F    jnz 0x0058A668                                  ; => [ Call: sub_5757f0 ]
0058A661    xor eax, eax                                    ; => [ Call: nullptr ]
0058A663    jmp 0x0058A70F
0058A668    cmp esi, 0x320
0058A66E    jb 0x0058A675
0058A670    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A68A    xor eax, eax                                    ; => [ Call: nullptr ]
0058A68C    mov dword ptr ss:[ebp-0x25A4], eax              ; => [ Call: nullptr ]
...
0058A6EF    jz 0x0058A700                                   ; => [ Call: sub_5941b0 ]
0058A6F1    inc eax
...
0058A726    push eax
0058A727    call 0x00578D00                                 ; => [ Call: sub_578d00 ]
0058A72C    inc esi
...
0058A74F    call 0x005722C0                                 ; => [ Call: sub_5722c0 ]
...
0058A76E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A7AB    call 0x00589E00                                 ; => [ Call: sub_589e00 ]
...
0058A7CA    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A801    push 0x00
0058A803    push eax
0058A804    call 0x00761FC4                                 ; => [ Call: memset ]
...
0058A88C    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A8BF    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058A8FE    push dword ptr ds:[0x007C0168]                  ; => [ Call: nullptr ]
0058A904    push dword ptr ds:[0x007C0164]
0058A90A    jmp 0x0058A918
0058A90C    push dword ptr ds:[0x007C0160]                  ; => [ Call: nullptr ]
...
0058A92D    push eax
0058A92E    call 0x00582EB0                                 ; => [ Call: sub_582eb0 ]
...
0058A959    push 0x00
0058A95B    push eax
0058A95C    call 0x00761FC4                                 ; => [ Call: memset ]
...
0058A987    push 0x01
0058A989    push eax
0058A98A    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
0058A98F    add esp, 0x18
0058A992    mov edx, edi
0058A994    mov ecx, ebx
0058A996    call 0x00588EE0                                 ; => [ Call: sub_588ee0 ]
0058A99B    add esp, 0x04
0058A99E    lea eax, ss:[ebp-0x2610]
0058A9A4    push 0x48
0058A9A6    push 0x00
0058A9A8    push eax
0058A9A9    call 0x00761FC4                                 ; => [ Call: memset ]
...
0058A9D4    push 0x01
0058A9D6    push eax
0058A9D7    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
...
0058A9FE    call 0x00589F70                                 ; => [ Call: sub_589f70 ]
...
0058AA32    push 0x05
0058AA34    call 0x00581450                                 ; => [ Call: sub_581450 ]
0058AA39    add esp, 0x0C
0058AA3C    mov edx, edi
0058AA3E    mov ecx, ebx
0058AA40    call 0x005811F0                                 ; => [ Call: sub_5811f0 ]
...
0058AA7F    call 0x005757F0                                 ; => [ Call: sub_5757f0 ]
...
0058AAA2    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058AAE4    push 0x00
0058AAE6    push 0x80
0058AAEB    call 0x005757F0                                 ; => [ Call: sub_5757f0 ]
...
0058AB12    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058AB48    call 0x0058A020                                 ; => [ Call: sub_58a020 ]
...
0058AB74    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0058ABE2    push 0x00                                       ; => [ Call: __builtin_memset ]
0058ABE4    push edi
0058ABE5    setz cl
0058ABE8    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
...
0058AC01    pop ebx
0058AC02    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0058AC24    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: c.moveIdx == idxBefore | Data: data_801800 | String: CleanupPhase | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
0058AC29    add esp, 0x0C
0058AC2C    call 0x0063BC30
0058AC31    test al, al
0058AC33    jz 0x0058AC36                                   ; => [ Call: sub_63bc30 ]
0058AC35    int3
0058AC36    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
