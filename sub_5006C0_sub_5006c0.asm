...
005006CB    call 0x00761E50
005006D0    mov eax, dword ptr ds:[0x008C4040]
005006D5    xor eax, esp
005006D7    mov dword ptr ss:[esp+0x1994], eax
005006DE    push esi
005006DF    push edi
005006E0    call 0x00573400
005006E5    push 0x00
005006E7    push 0x00
005006E9    push 0x01
...
005006F1    push 0x01
005006F3    call 0x00590760
005006F8    add esp, 0x10
005006FB    call 0x00573400
...
005007B2    call 0x00561880
005007B7    xorps xmm0, xmm0
005007BA    mov dword ptr ss:[esp+0x34], 0x00
005007C2    movlpd qword ptr ss:[esp+0x2C], xmm0
...
0050090F    call 0x00561880
00500914    xorps xmm0, xmm0
00500917    mov dword ptr ss:[esp+0x34], 0x00
0050091F    movlpd qword ptr ss:[esp+0x2C], xmm0
...
00500A6F    call 0x00561880
00500A74    xorps xmm0, xmm0
00500A77    mov dword ptr ss:[esp+0x34], 0x00
00500A7F    movlpd qword ptr ss:[esp+0x2C], xmm0
...
00500BA1    push 0x3EE
00500BA6    push esi
00500BA7    call 0x00582D10
00500BAC    add esp, 0x38
00500BAF    call 0x00573400
...
00500C16    call 0x0063B870
00500C1B    add esp, 0x0C
00500C1E    call 0x0063BC30
00500C23    test al, al
00500C25    jz 0x00500C28
00500C27    int3
00500C28    call 0x0063BB00
