...
006FFB65    push 0x7724E5                                   ; => [ Call: sub_7724e5 | Type: EHRegistrationNode ]
006FFB6A    mov eax, dword ptr fs:[0x00000000]
006FFB70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FFB7E    push eax                                        ; => [ Data: __security_cookie ]
006FFB7F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006FFB82    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006FFB88    mov esi, ecx
006FFB8A    mov edx, dword ptr ss:[ebp+0x0C]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Type: _EXCEPTION_REGISTRATION_RECORD ]
006FFB8D    test edx, edx
006FFB8F    jnz 0x006FFBA2
006FFB91    push 0x88D514                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayGet ]
006FFB96    push 0x6C
006FFB98    mov ecx, 0x802734                               ; => [ String: id != DATAID_NULL ]
...
006FFBBF    mov dword ptr ss:[ebp-0x18], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FFBD4    push 0x88C8A8                                   ; => [ String: OpenGLInterface::UnlockTextureBuffer ]
006FFBD9    push 0x5B5
006FFBDE    push 0x88C504                                   ; => [ String: C:\x\ax2017\Engine\OpenGLGraphics.cpp ]
006FFBE3    mov ecx, 0x88C840                               ; => [ String: bufferData->mIsLoading == 0 ]
006FFBE8    jmp 0x006FFED0
006FFBED    mov eax, dword ptr ds:[eax]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FFC52    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FFC65    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FFC6A    mov dword ptr ss:[ebp+0x0C], 0x801800           ; => [ Data: data_801800 ]
...
006FFC86    mov dword ptr ss:[ebp-0x1C], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006FFC89    cmp dword ptr ds:[edi], 0x00
006FFC8C    jnz 0x006FFC9C
006FFC8E    push 0x01
006FFC90    xor dl, dl
006FFC92    mov ecx, edi
006FFC94    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
006FFC99    add esp, 0x04
006FFC9C    mov eax, dword ptr ds:[edi]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006FFC9E    inc dword ptr ds:[edi+0x1C]                     ; => [ Field: Next ]
006FFCA1    mov eax, dword ptr ds:[eax]
006FFCA3    mov ecx, dword ptr ss:[ebp+0x10]
006FFCA6    mov dword ptr ss:[ebp-0x04], 0x02
006FFCAD    mov eax, dword ptr ds:[eax]                     ; => [ Field: Next | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FFCC0    push 0x88C8A8                                   ; => [ String: OpenGLInterface::UnlockTextureBuffer ]
006FFCC5    push 0x5C4
006FFCCA    mov ecx, 0x879F74                               ; => [ String: imageIndex < pTextureData->imageCount ]
...
006FFCEE    shr eax, cl                                     ; => [ Field: Next ]
...
006FFD18    call 0x006FF830                                 ; => [ Call: sub_6ff830 ]
...
006FFD2D    mov ecx, dword ptr ds:[0x0147DED4]              ; => [ Data: data_147ded4 ]
006FFD33    mov eax, dword ptr ss:[ebp-0x10]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FFDC9    push eax
006FFDCA    push 0xDE1
006FFDCF    call dword ptr ds:[0x0077520C]                  ; => [ Call: nullptr ]
...
006FFDEB    jnl 0x006FFE74                                  ; => [ Data: data_cf65b8 ]
...
006FFE0A    mov eax, dword ptr ds:[0x0147DED4]              ; => [ Data: data_147ded4 ]
...
006FFE6E    call dword ptr ds:[0x0077520C]                  ; => [ Call: nullptr | Data: data_800a58 ]
...
006FFE9B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006FFEA2    pop ecx
006FFEA3    pop edi
006FFEA4    pop esi
006FFEA5    pop ebx
...
006FFEA8    pop ebp
006FFEA9    ret 0x10
006FFEAC    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
006FFEB1    push 0x19
006FFEB3    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
006FFEB8    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
006FFEBD    jmp 0x006FFED0
006FFEBF    push 0x88D514                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayGet ]
006FFEC4    push 0x6D
006FFEC6    mov ecx, 0x802748                               ; => [ String: DataArrayTryToGet(id) != NULL ]
006FFECB    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h | String: C:\x\ax2017\Engine\DataArray.h ]
006FFED0    mov edx, 0x801800
006FFED5    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006FFEDA    add esp, 0x0C
006FFEDD    call 0x0063BC30
006FFEE2    test al, al
006FFEE4    jz 0x006FFEE7                                   ; => [ Call: sub_63bc30 ]
006FFEE6    int3
006FFEE7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006FFEEC    push 0x88C8A8                                   ; => [ String: OpenGLInterface::UnlockTextureBuffer ]
006FFEF1    push 0x5F0
006FFEF6    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006FFEFB    push 0x88C504
006FFF00    mov edx, 0x801800
006FFF05    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: OpenGLInterface::UnlockTextureBuffer | String: C:\x\ax2017\Engine\OpenGLGraphics.cpp ]
006FFF0A    add esp, 0x0C
006FFF0D    call 0x0063BC30
006FFF12    test al, al
006FFF14    jz 0x006FFF17                                   ; => [ Call: sub_63bc30 ]
006FFF16    int3
006FFF17    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
