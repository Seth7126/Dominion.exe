...
004FFCF1    mov edi, dword ptr ds:[eax+0x58]                ; => [ Call: sub_573400 ]
004FFCF4    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FFD0E    call 0x00591930                                 ; => [ Call: sub_591930 ]
