...
0055922C    call 0x00573400                                 ; => [ Call: sub_573400 ]
00559231    mov edi, eax
00559233    call 0x00573400
00559238    mov esi, dword ptr ss:[ebp-0x04]
0055923B    mov ecx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
...
0055925A    mov dword ptr ss:[ebp-0x08], eax                ; => [ Call: sub_573400 ]
0055925D    cmp esi, 0x320
00559263    jb 0x0055926A
00559265    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0055927E    call 0x00594010                                 ; => [ Call: sub_594010 ]
...
005592C3    setz cl
005592C6    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
...
00559317    push 0x3D
00559319    push eax
0055931A    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
00559336    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00559357    push eax
00559358    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
00559378    push 0x81DB90                                   ; => [ String: TriggerProphecy ]
0055937D    push 0x1D
0055937F    push 0x81DBA0                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_RisingSun.cpp ]
00559384    mov ecx, 0x81DBD8                               ; => [ String: def.playFn ]
...
00559392    push 0x00
00559394    push eax
00559395    call 0x00761FC4                                 ; => [ Call: memset ]
...
005593BB    push 0x01
005593BD    push eax
005593BE    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
005593C3    mov eax, dword ptr fs:[0x0000002C]
005593C9    add esp, 0x1C
005593CC    mov ecx, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
005593E4    pop ebp
005593E5    ret
005593E6    push 0x81F9E0                                   ; => [ String: DomPopContext ]
005593EB    push 0x792
005593F0    push 0x81F4B8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
005593F5    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
005593FA    mov edx, 0x801800
005593FF    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00559404    add esp, 0x0C
00559407    call 0x0063BC30
0055940C    test al, al
0055940E    jz 0x00559411                                   ; => [ Call: sub_63bc30 ]
00559410    int3
00559411    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
