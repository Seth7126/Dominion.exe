...
0061D72E    xor eax, esp                                    ; => [ Data: __security_cookie ]
0061D730    mov dword ptr ss:[esp+0x6C], eax
0061D734    cmp dword ptr ds:[0x01724034], 0x00
0061D73B    push esi
0061D73C    push edi
0061D73D    jz 0x0061D8F1                                   ; => [ Data: data_1724034 ]
0061D743    movss xmm0, dword ptr ds:[0x008C4634]
0061D74B    mulss xmm0, dword ptr ds:[0x00890D48]
0061D753    mov edx, dword ptr ds:[0x0171EFD0]              ; => [ Data: data_171efd0 ]
0061D759    movss xmm1, dword ptr ds:[0x01724038]           ; => [ Data: data_1724038 ]
0061D761    movss dword ptr ss:[esp+0x10], xmm1
0061D767    addss xmm0, xmm1                                ; => [ Data: data_8c4634 ]
0061D76B    movss dword ptr ss:[esp+0x0C], xmm0
0061D771    movss dword ptr ds:[0x01724038], xmm0           ; => [ Data: data_1724038 ]
0061D779    test edx, edx
0061D77B    jz 0x0061D8BC
0061D781    movzx eax, dx
0061D784    cmp eax, dword ptr ds:[0x00B4A5C4]
0061D78A    jnb 0x0061D8BC                                  ; => [ Data: data_b4a5c4 ]
0061D790    imul ecx, eax, 0x510C
0061D796    add ecx, dword ptr ds:[0x00B4A5C0]              ; => [ Data: data_b4a5c0 ]
...
0061D7C4    mov eax, dword ptr ds:[0x0171EFC8]              ; => [ Data: data_171efc8 ]
...
0061D7FE    divss xmm0, dword ptr ds:[0x00890F98]           ; => [ Call: sub_4ac580 ]
...
0061D831    call 0x004D5CB0                                 ; => [ Call: sub_4d5cb0 ]
...
0061D861    call 0x004D5CB0                                 ; => [ Call: sub_4d5cb0 ]
...
0061D89E    call 0x006883D0                                 ; => [ Data: data_171e6b4 | Call: sub_6883d0 ]
0061D8A3    lea ecx, ss:[esp+0x14]
0061D8A7    call 0x00688660                                 ; => [ Call: sub_688660 ]
0061D8AC    movss xmm0, dword ptr ds:[0x01724038]           ; => [ Data: data_1724038 ]
...
0061D8CF    call 0x006883D0                                 ; => [ Data: data_171e6b8 | Call: sub_6883d0 ]
0061D8D4    lea ecx, ss:[esp+0x44]
0061D8D8    call 0x00688660                                 ; => [ Call: sub_688660 ]
0061D8DD    mov dword ptr ds:[0x01724034], 0x00             ; => [ Data: data_1724034 ]
0061D8E7    mov dword ptr ds:[0x01724038], 0x00             ; => [ Data: data_1724038 ]
0061D8F1    mov ecx, dword ptr ss:[esp+0x74]
0061D8F5    pop edi
0061D8F6    pop esi
0061D8F7    xor ecx, esp
0061D8F9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
