...
00681C61    xor eax, esp
00681C63    mov dword ptr ss:[esp+0x360], eax
00681C6A    mov ecx, dword ptr ds:[0x0147ABE4]
00681C70    push ebx
00681C71    push esi
00681C72    push edi
...
00681C84    push 0x876D94
00681C89    push 0xD9
00681C8E    push 0x876CB0
00681C93    mov ecx, 0x876D74
...
00681CB0    call dword ptr ds:[eax+0x6C]
00681CB3    mov esi, dword ptr ds:[0x0147ABE4]
00681CB9    cmp dword ptr ds:[esi+0x18], 0x400
00681CC0    mov dword ptr ds:[esi+0x3C], 0x00
00681CC7    jle 0x00681CE2
00681CC9    push 0x876D94
00681CCE    push 0xE2
00681CD3    push 0x876CB0
00681CD8    mov ecx, 0x876DC0
00681CDD    jmp 0x00681E2B
00681CE2    push 0x358
00681CE7    lea eax, ss:[esp+0x14]
00681CEB    push 0x00
00681CED    push eax
00681CEE    call 0x00761FC4
00681CF3    mov edx, dword ptr ds:[esi+0x50]
...
00681D13    call 0x00681B40
00681D18    mov esi, dword ptr ds:[0x0147ABE4]
...
00681D2D    push 0x876CEC
00681D32    push 0x6B
00681D34    push 0x876CB0
00681D39    mov ecx, 0x876D0C
00681D3E    jmp 0x00681E2B
00681D43    cmp dword ptr ds:[esi+0x48], 0x00
00681D47    jnle 0x00681D5F
00681D49    push 0x876CEC
00681D4E    push 0x6C
00681D50    push 0x876CB0
00681D55    mov ecx, 0x876D40
...
00681D9B    call dword ptr ds:[eax+0x80]
00681DA1    mov ecx, dword ptr ds:[0x0147B070]
00681DA7    lea edx, ss:[esp+0x10]
00681DAB    push edx
00681DAC    mov eax, dword ptr ds:[ecx]
00681DAE    call dword ptr ds:[eax+0x44]
00681DB1    mov esi, dword ptr ds:[0x0147ABE4]
...
00681DD7    push ebx
00681DD8    push 0x04
00681DDA    call dword ptr ds:[edi+0x40]
00681DDD    mov ecx, dword ptr ds:[0x0147ABE4]
...
00681DFD    mov eax, dword ptr ds:[0x0147B06C]
...
00681E11    call 0x0075927A
00681E16    mov esp, ebp
00681E18    pop ebp
00681E19    ret
00681E1A    push 0x876FE4
00681E1F    push 0x53
00681E21    push 0x86E34C
00681E26    mov ecx, 0x876FD4
00681E2B    mov edx, 0x801800
00681E30    call 0x0063B870
00681E35    add esp, 0x0C
00681E38    call 0x0063BC30
00681E3D    test al, al
00681E3F    jz 0x00681E42
00681E41    int3
00681E42    call 0x0063BB00
