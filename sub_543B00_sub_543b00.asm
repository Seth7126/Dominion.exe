...
00543B68    mov dword ptr ss:[ebp-0xCC4], eax
00543B6E    lea eax, ss:[ebp-0xCC8]
00543B74    mov dword ptr ss:[ebp-0xCC8], 0x81BA6C
00543B7E    mov dword ptr ss:[ebp-0xCA4], eax
...
00543BBC    push esi
00543BBD    call dword ptr ds:[eax]
...
00543C2A    push 0x476
00543C2F    push esi
00543C30    call 0x00583720
00543C35    add esp, 0x1C
00543C38    jmp 0x00543CAB
00543C3A    call 0x00573400
...
00543C68    call 0x00589750
00543C6D    push ecx
00543C6E    mov ecx, esp
00543C70    mov esi, eax
00543C72    mov dword ptr ds:[ecx], 0x81BA50
00543C78    mov dword ptr ds:[ecx+0x04], esi
00543C7B    mov dword ptr ds:[ecx+0x24], ecx
00543C7E    call 0x005699B0
00543C83    add esp, 0x28
00543C86    mov dword ptr ss:[ebp-0xC9C], esi
00543C8C    call 0x00573400
00543C91    push 0x08
00543C93    push 0x3E9
00543C98    push ecx
