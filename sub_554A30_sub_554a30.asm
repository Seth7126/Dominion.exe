...
00554A40    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
00554A45    xorps xmm0, xmm0
00554A48    mov dword ptr ss:[esp+0x10], 0x00
00554A50    movlpd qword ptr ss:[esp+0x08], xmm0            ; => [ Call: __builtin_memset ]
...
00554AA7    call 0x00563050                                 ; => [ Call: sub_563050 ]
...
00554AC3    call 0x00564CE0                                 ; => [ Call: sub_564ce0 ]
