...
0056A3FB    call 0x00761E50                                 ; => [ Call: __chkstk ]
0056A400    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0056A49E    push 0x2B
0056A4A0    push eax
0056A4A1    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
0056A4DF    mov edi, eax                                    ; => [ Call: sub_573400 ]
...
0056A4FB    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056A512    push 0x00
0056A514    push 0x00
0056A516    push 0x00                                       ; => [ Call: __builtin_memset ]
...
0056A55F    mov edi, eax                                    ; => [ Call: sub_573400 ]
...
0056A57B    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056A592    push 0x00
0056A594    push 0x00
0056A596    push 0x00                                       ; => [ Call: __builtin_memset ]
...
0056A5D4    mov edi, eax                                    ; => [ Call: sub_573400 ]
...
0056A5F0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056A607    push 0x00
0056A609    push 0x00
0056A60B    push 0x00                                       ; => [ Call: __builtin_memset ]
...
0056A647    mov edi, eax                                    ; => [ Call: sub_573400 ]
...
0056A663    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056A6A5    call 0x00582D10                                 ; => [ Call: sub_582d10 ]
0056A6AA    inc esi
...
0056A6E6    call 0x0056F1A0                                 ; => [ Call: sub_56f1a0 ]
...
0056A6FA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0056A71C    call 0x0063B870                                 ; => [ String: MovePileTo | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp | String: Halt ]
0056A721    add esp, 0x0C
0056A724    call 0x0063BC30
0056A729    test al, al
0056A72B    jz 0x0056A72E                                   ; => [ Call: sub_63bc30 ]
0056A72D    int3
0056A72E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
