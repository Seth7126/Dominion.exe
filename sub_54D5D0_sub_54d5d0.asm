...
0054D5E8    push 0x76646B                                   ; => [ Call: sub_76646b | Type: EHRegistrationNode ]
0054D5ED    mov eax, dword ptr fs:[0x00000000]
0054D5F3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0054D5F4    push ebx
0054D5F5    mov eax, 0x19B0
0054D5FA    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054D5FF    mov eax, dword ptr ds:[0x008C4040]
0054D604    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0054D606    mov dword ptr ss:[ebp-0x14], eax
0054D609    push esi
0054D60A    push edi
0054D60B    push eax
0054D60C    lea eax, ss:[ebp-0x0C]
0054D60F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0054D62D    call 0x00577BB0                                 ; => [ Call: sub_573400 | Call: sub_577bb0 ]
...
0054D6B7    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0054D6B9    mov dword ptr ss:[ebp-0xD08], 0x81C634          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8055c69b52bd819ff5cd360040ba4567>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_8055c69b52bd819ff5cd360040ba4567>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0054D6C3    mov dword ptr ss:[ebp-0xCE4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8055c69b52bd819ff5cd360040ba4567>,bool,enum CardID>::VTable ]
...
0054D704    call eax                                        ; => [ Field: vFunc_0 ]
...
0054D715    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0054D743    push eax
0054D744    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
0054D764    movlpd qword ptr ss:[ebp-0xCDC], xmm0           ; => [ Call: __builtin_memset ]
...
0054D802    push 0x476
0054D807    push esi
0054D808    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0054D80D    add esp, 0x1C
0054D810    mov ecx, dword ptr ss:[ebp-0x0C]
0054D813    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0054D81A    pop ecx
0054D81B    pop edi
0054D81C    pop esi
0054D81D    mov ecx, dword ptr ss:[ebp-0x14]
0054D820    xor ecx, ebp
0054D822    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
