...
0051630E    mov ecx, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
00516314    cmp dword ptr ds:[ecx], 0x00
00516317    jz 0x0051632D
00516319    push 0x81444C                                   ; => [ String: CampaignAddExpFeature ]
0051631E    push 0x1B3D
00516323    mov ecx, 0x814160                               ; => [ String: setup.params.type == CAMPAIGNTYPE_EXPANSION ]
00516328    jmp 0x00516511
0051632D    mov ecx, dword ptr ds:[ecx+0x04]
00516330    cmp ecx, 0x03
00516333    jnl 0x00516349
00516335    push 0x813640                                   ; => [ String: ExpansionCampaignDefGet ]
0051633A    push 0x669
0051633F    mov ecx, 0x813658                               ; => [ String: exp >= DOM_EXP_INTRIGUE ]
...
0051635B    push 0x813640                                   ; => [ String: ExpansionCampaignDefGet ]
00516360    push 0x672
00516365    mov ecx, 0x813670                               ; => [ String: retval.exp == exp ]
...
00516381    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
005163DB    pop ebp
005163DC    ret                                             ; => [ Call: sub_50ac80 | Call: sub_50ac80 | Call: sub_50ac80 ]
...
005163F9    push 0x81444C                                   ; => [ String: CampaignAddExpFeature ]
005163FE    push 0x1B69
00516403    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
00516424    mov dword ptr ds:[eax], 0x816F04                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_1a26e074cbf2dcc23cd5d8b5a34d12ea>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
0051642A    mov dword ptr ds:[eax+0x04], 0x01
00516431    mov dword ptr ds:[eax+0x24], eax
00516434    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
...
0051644C    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
...
0051648A    test al, al
0051648C    jnz 0x0051649B                                  ; => [ Call: sub_50a6a0 ]
0051648E    push 0x814464
00516493    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: couldn't add exp feature trait ]
00516498    add esp, 0x04
0051649B    xor eax, eax                                    ; => [ Call: nullptr ]
...
005164B1    push 0x80CF80                                   ; => [ String: CampaignPieceDefGetFn ]
005164B6    push 0x30A
005164BB    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
005164D3    jnz 0x00516502                                  ; => [ Data: data_cca78c ]
005164D5    mov eax, dword ptr ds:[0x00CCA788]
005164DA    mov dword ptr ds:[0x00CCA78C], eax              ; => [ Data: data_cca78c | Data: data_cca788 ]
005164DF    mov dword ptr ds:[0x00CCA788], edi              ; => [ Data: data_cca788 ]
005164E5    call ecx
005164E7    mov eax, dword ptr ds:[0x00CCA78C]              ; => [ Data: data_cca78c ]
005164EC    mov dword ptr ds:[0x00CCA788], eax              ; => [ Data: data_cca788 ]
005164F1    mov dword ptr ds:[0x00CCA78C], 0x00             ; => [ Data: data_cca78c ]
005164FB    pop edi
005164FC    pop esi
005164FD    pop ebx
...
00516500    pop ebp
00516501    ret
00516502    push 0x813794                                   ; => [ String: CampaignContextPushPile ]
00516507    push 0x748
0051650C    mov ecx, 0x8137AC                               ; => [ String: gCampaignSetup.favoredPileStack == CARD_NONE ]
00516511    push 0x80CD80
00516516    mov edx, 0x801800
0051651B    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
00516520    add esp, 0x0C
00516523    call 0x0063BC30
00516528    test al, al
0051652A    jz 0x0051652D                                   ; => [ Call: sub_63bc30 ]
0051652C    int3
0051652D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
