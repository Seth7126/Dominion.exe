...
00542A0D    mov dword ptr ss:[ebp-0xCDC], ecx
...
00542A4E    call eax
00542A50    mov dword ptr ds:[esi+0x24], eax
...
00542A76    mov dword ptr ss:[ebp-0x20], eax
...
00542A8D    push eax
00542A8E    call dword ptr ds:[edx+0x10]
00542A91    xorps xmm0, xmm0
00542A94    mov dword ptr ss:[ebp-0xCCC], 0x00
00542A9E    movlpd qword ptr ss:[ebp-0xCD4], xmm0
