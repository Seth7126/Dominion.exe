...
004B1E29    push ebx
004B1E2A    push esi
004B1E2B    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B1E5B    lea ebx, ds:[eax+0x10]                          ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004B1E5E    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
004B1E63    mov edx, dword ptr ss:[esp+0x10]
004B1E67    push ecx
004B1E68    push eax
004B1E69    mov ecx, ebx
004B1E6B    call 0x004DBEF0                                 ; => [ Call: sub_4dbef0 ]
004B1E70    add esp, 0x08
004B1E73    mov dword ptr ds:[ebx+0x28], 0x17
004B1E7A    lea edi, ds:[esi+0x5098]
004B1E80    call 0x004B1070                                 ; => [ Call: sub_4b1070 ]
...
004B1EA8    call 0x004D5E20                                 ; => [ Call: sub_4d5e20 ]
004B1EAD    add esp, 0x0C
004B1EB0    mov ecx, edi
004B1EB2    call 0x004B11C0                                 ; => [ Call: sub_4b11c0 ]
004B1EB7    push dword ptr ss:[ebp+0x08]
004B1EBA    lea eax, ss:[esp+0x24]
004B1EBE    mov edx, 0x77F0A0
004B1EC3    push eax
004B1EC4    mov ecx, edi
004B1EC6    call 0x00624070                                 ; => [ Call: sub_624070 ]
004B1ECB    add esp, 0x08
004B1ECE    mov edx, esi
004B1ED0    mov ecx, edi
004B1ED2    call 0x004DA580                                 ; => [ Call: sub_4da580 ]
004B1ED7    mov ecx, dword ptr ds:[0x00CC8DC8]
004B1EDD    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004B1EE3    call 0x004D8F30
004B1EE8    mov dword ptr ds:[eax+0x42C0], esi              ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004B1EEE    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004B1EF4    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
004B1F10    or edx, eax
004B1F12    mov dword ptr ds:[edi+0x20], edx                ; => [ Call: sub_4d6320 ]
...
004B1F21    pop ebp
004B1F22    ret                                             ; => [ Call: sub_4da3a0 ]
004B1F23    push 0x77EB90
004B1F28    push 0x7B
004B1F2A    push 0x77EB50
004B1F2F    mov edx, 0x801800
004B1F34    mov ecx, 0x77EB9C
004B1F39    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004B1F3E    add esp, 0x0C
004B1F41    call 0x0063BC30
004B1F46    test al, al
004B1F48    jz 0x004B1F4B                                   ; => [ Call: sub_63bc30 ]
004B1F4A    int3
004B1F4B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
