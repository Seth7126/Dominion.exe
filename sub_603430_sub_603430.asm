...
00603452    mov dword ptr fs:[0x00000000], eax
...
006034A1    mov edx, 0x862360
006034A6    call 0x0063D720
006034AB    mov eax, esi
006034AD    mov ecx, dword ptr ss:[ebp-0x0C]
006034B0    mov dword ptr fs:[0x00000000], ecx
006034B7    pop ecx
006034B8    pop edi
006034B9    pop esi
006034BA    pop ebx
...
006034BD    pop ebp
006034BE    ret
006034BF    mov edx, 0x8623A4
006034C4    jmp 0x006034A6
006034C6    mov eax, dword ptr ds:[0x00B80B58]
...
006034F5    mov eax, dword ptr ds:[eax]
006034F7    mov edx, 0x801800
006034FC    test eax, eax
006034FE    cmovnz edx, eax
00603501    call 0x0063D720
...
00603580    mov eax, dword ptr ds:[eax]
00603582    mov edx, 0x801800
00603587    test eax, eax
00603589    cmovnz edx, eax
0060358C    call 0x0063D720
...
00603601    mov eax, dword ptr ds:[eax]
00603603    mov edx, 0x801800
00603608    test eax, eax
0060360A    cmovnz edx, eax
0060360D    call 0x0063D720
...
00603692    mov edx, 0x801800
00603697    lea ecx, ss:[ebp+0x0C]
0060369A    call 0x0063D720
...
00603711    mov eax, dword ptr ds:[eax]
00603713    mov edx, 0x801800
00603718    test eax, eax
0060371A    cmovnz edx, eax
0060371D    call 0x0063D720
...
0060378C    mov eax, dword ptr ds:[eax]
0060378E    mov edx, 0x801800
00603793    test eax, eax
00603795    cmovnz edx, eax
00603798    call 0x0063D720
...
0060382F    call 0x0064C080
00603834    mov eax, esi
00603836    mov ecx, dword ptr ss:[ebp-0x0C]
00603839    mov dword ptr fs:[0x00000000], ecx
00603840    pop ecx
00603841    pop edi
00603842    pop esi
00603843    pop ebx
...
006038E6    call 0x0064C080
006038EB    mov dword ptr ss:[ebp+0x0C], 0x801800
...
00603909    mov edi, eax
0060390B    test edi, edi
0060390D    jnz 0x0060391B
0060390F    mov edx, 0x86248C
...
00603953    call 0x004D47C0
00603958    mov eax, esi
0060395A    mov ecx, dword ptr ss:[ebp-0x0C]
0060395D    mov dword ptr fs:[0x00000000], ecx
00603964    pop ecx
00603965    pop edi
00603966    pop esi
00603967    pop ebx
...
0060398F    call 0x0063B870
00603994    add esp, 0x0C
00603997    call 0x0063BC30
0060399C    test al, al
0060399E    jz 0x006039A1
006039A0    int3
006039A1    call 0x0063BB00
