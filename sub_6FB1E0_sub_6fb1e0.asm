...
006FB1EC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006FB211    call 0x00761FC4                                 ; => [ Call: memset ]
006FB216    push 0x58
006FB218    lea eax, ss:[esp+0x20]
006FB21C    push 0x00
006FB21E    push eax
006FB21F    call 0x00761FC4                                 ; => [ Type: OPENFILENAMEA | Call: memset ]
006FB224    mov eax, dword ptr ds:[0x0147D46C]
006FB229    add esp, 0x18
006FB22C    mov dword ptr ss:[esp+0x14], eax                ; => [ Data: data_147d46c | Field: hwndOwner ]
006FB230    lea eax, ss:[esp+0x68]
006FB234    mov dword ptr ss:[esp+0x2C], eax                ; => [ Field: lpstrFile ]
006FB238    lea eax, ss:[esp+0x10]
006FB23C    mov dword ptr ss:[esp+0x10], 0x58               ; => [ Field: lStructSize ]
006FB244    push eax
006FB245    mov dword ptr ss:[esp+0x34], 0x104              ; => [ Field: nMaxFile ]
006FB24D    mov dword ptr ss:[esp+0x20], esi                ; => [ Field: lpstrFilter ]
006FB251    mov dword ptr ss:[esp+0x2C], 0x00               ; => [ Field: nFilterIndex ]
006FB259    mov dword ptr ss:[esp+0x38], 0x00               ; => [ Field: lpstrFileTitle ]
006FB261    mov dword ptr ss:[esp+0x3C], 0x00               ; => [ Field: nMaxFileTitle ]
006FB269    mov dword ptr ss:[esp+0x40], 0x00               ; => [ Field: lpstrInitialDir ]
006FB271    mov dword ptr ss:[esp+0x48], 0x2001808          ; => [ Field: Flags ]
006FB279    call dword ptr ds:[0x0077501C]
006FB27F    test eax, eax
006FB281    jz 0x006FB325                                   ; => [ Type: BOOL ]
...
006FB2B9    jz 0x006FB2D5                                   ; => [ Data: data_cf65bc ]
006FB2BB    mov ecx, edi
006FB2BD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FB2D0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FB2D5    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
006FB2DB    mov al, 0x01
006FB2DD    pop edi
006FB2DE    pop esi
006FB2DF    mov ecx, dword ptr ss:[esp+0x16C]
006FB2E6    xor ecx, esp
006FB2E8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006FB31C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006FB332    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
