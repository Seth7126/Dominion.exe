...
0051FDAC    mov eax, dword ptr ds:[0x008C4040]
...
0051FE95    mov eax, dword ptr ds:[eax+0x1504]
...
0051FEE6    mov dword ptr ss:[esp+0x14], eax
0051FEEA    call 0x00573400
...
0051FF59    mov eax, dword ptr ds:[eax+0x1504]
...
0051FF91    setz cl
0051FF94    call 0x0061B1B0
0051FF99    add esp, 0x2C
0051FF9C    call 0x00573400
