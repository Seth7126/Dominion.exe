...
0050992E    push 0x80AF68                                   ; => [ String: Mine_Achievement_OnTrash ]
00509933    push 0x389
00509938    push 0x80AE10                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Base.cpp ]
0050993D    mov ecx, 0x80AE74                               ; => [ String: numCards == 1 ]
...
00509954    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00509957    cmp esi, 0x320
0050995D    jb 0x00509964
0050995F    call 0x00591930                                 ; => [ Call: sub_591930 ]
00509964    imul eax, esi, 0x64
00509967    mov edi, dword ptr ds:[eax+edi*1+0x1A4C]
0050996E    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005099AA    call 0x00509340                                 ; => [ Call: sub_509340 ]
...
005099C3    pop ebp
005099C4    ret
005099C5    push 0x81EF48                                   ; => [ String: DomAchievementDataGet ]
005099CA    push 0x1CB1
005099CF    push 0x81EA70                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
005099D4    mov ecx, 0x80AEA0                               ; => [ String: c.contextType == CONTEXT_ACHIEVEMENT ]
005099D9    mov edx, 0x801800
005099DE    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005099E3    add esp, 0x0C
005099E6    call 0x0063BC30
005099EB    test al, al
005099ED    jz 0x005099F0                                   ; => [ Call: sub_63bc30 ]
005099EF    int3
005099F0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
