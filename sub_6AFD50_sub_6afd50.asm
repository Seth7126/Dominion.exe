...
006AFD5C    mov eax, dword ptr ds:[0x008C4040]
...
006AFD7D    call 0x006B2E00
006AFD82    mov dword ptr ss:[esp+0x20], eax
006AFD86    mov esi, 0x1E
006AFD8B    mov dword ptr ss:[esp+0x14], 0x00
...
006AFE51    movss dword ptr ss:[esp+0x38], xmm0
...
006B02DE    mov dword ptr ss:[esp+0x98], eax
006B02E5    call 0x006AFD00
006B02EA    mov dword ptr ss:[esp+0x9C], eax
