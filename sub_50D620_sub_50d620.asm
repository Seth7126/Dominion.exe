...
0050D632    push esi
0050D633    push edi
0050D634    call 0x00513D60                                 ; => [ Call: sub_513d60 ]
0050D639    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050D63E    cmp dword ptr ds:[eax], 0x04
0050D641    jz 0x0050D65C
0050D643    push 0x813AF4                                   ; => [ String: StampGetPileSetup ]
0050D648    push 0xC59
0050D64D    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0050D652    mov ecx, 0x813B08                               ; => [ String: c.contextType == CONTEXT_SETUP ]
0050D657    jmp 0x0050D72E
0050D65C    mov ecx, dword ptr ds:[eax+0x10]
0050D65F    call 0x0050CC00                                 ; => [ Call: sub_50cc00 ]
0050D664    mov ebx, eax
0050D666    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0050D67F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050D6A4    push eax
0050D6A5    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
0050D6B9    push 0x8138F4                                   ; => [ String: Landmod_Event_PerksOfWealth ]
0050D6BE    push 0x8F1
0050D6C3    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0050D6C8    mov ecx, 0x8138A0                               ; => [ String: c.g->turn_id == 0 ]
...
0050D6F2    call 0x0056C680                                 ; => [ Call: sub_50ce00 | Call: sub_50d750 | Call: sub_56c680 ]
0050D6F7    mov eax, dword ptr fs:[0x0000002C]
0050D6FD    add esp, 0x10
0050D700    mov ecx, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
0050D718    pop ebp
0050D719    ret
0050D71A    push 0x81F9E0                                   ; => [ String: DomPopContext ]
0050D71F    push 0x792
0050D724    push 0x81F4B8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
0050D729    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
0050D72E    mov edx, 0x801800
0050D733    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0050D738    add esp, 0x0C
0050D73B    call 0x0063BC30
0050D740    test al, al
0050D742    jz 0x0050D745                                   ; => [ Call: sub_63bc30 ]
0050D744    int3
0050D745    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
