...
005E9361    push ebx
005E9362    push esi
005E9363    mov esi, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
005E9369    push edi
005E936A    add eax, esi                                    ; => [ Data: data_b809e4 ]
...
005E93BD    call 0x00664D00                                 ; => [ Call: sub_64e7a0 | Call: sub_664d00 ]
...
005E93DB    call 0x00664D00                                 ; => [ Call: sub_64e7a0 | Call: sub_664d00 ]
005E93E0    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
005E9417    jz 0x005E948D                                   ; => [ Data: data_147aba1 ]
005E9419    mov edi, dword ptr ds:[0x00CF6B14]              ; => [ Data: data_cf6b14 ]
005E941F    mov edx, 0xBF21E8
005E9424    mov dword ptr ds:[0x00CF6B14], 0x2DE60000       ; => [ Data: data_cf6b14 ]
005E942E    call 0x006C24D0                                 ; => [ Data: data_bf21e8 | Call: sub_6c24d0 ]
005E9433    cmp byte ptr ds:[0x0147ABA1], 0x00
005E943A    jz 0x005E948D                                   ; => [ Data: data_147aba1 ]
005E943C    mov dword ptr ds:[0x00CF6B14], edi              ; => [ Data: data_cf6b14 ]
005E9442    imul eax, dword ptr ds:[0x00B809E4], 0x1C30
005E944C    add esi, 0x1C30
005E9452    add eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e4 | Data: data_b809e0 ]
...
005E948B    pop ebp
005E948C    ret
005E948D    push 0x8728D8                                   ; => [ String: Draw3DLayer ]
005E9492    push 0x32C
005E9497    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
005E949C    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
005E94A1    jmp 0x005E94B4
005E94A3    push 0x871F88                                   ; => [ String: GetGameData ]
005E94A8    push 0x45
005E94AA    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
005E94AF    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
005E94B4    mov edx, 0x801800
005E94B9    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005E94BE    add esp, 0x0C
005E94C1    call 0x0063BC30
005E94C6    test al, al
005E94C8    jz 0x005E94CB                                   ; => [ Call: sub_63bc30 ]
005E94CA    int3
005E94CB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
