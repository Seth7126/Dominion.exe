...
00564CF8    push 0x76646B                                   ; => [ Call: sub_76646b | Type: EHRegistrationNode ]
00564CFD    mov eax, dword ptr fs:[0x00000000]
00564D03    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00564D04    push ebx
00564D05    mov eax, 0x19B0
00564D0A    call 0x00761E50                                 ; => [ Call: __chkstk ]
00564D0F    mov eax, dword ptr ds:[0x008C4040]
00564D14    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00564D16    mov dword ptr ss:[ebp-0x14], eax
00564D19    push esi
00564D1A    push edi
00564D1B    push eax
00564D1C    lea eax, ss:[ebp-0x0C]
00564D1F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00564D25    mov dword ptr ss:[ebp-0xCA8], edx
00564D2B    mov dword ptr ss:[ebp-0xCAC], ecx
00564D31    call 0x00573400                                 ; => [ Call: sub_573400 ]
00564D36    lea ecx, ss:[ebp-0x19C0]
00564D3C    push 0x04
00564D3E    push ecx
00564D3F    mov edx, dword ptr ds:[eax+0x0C]
00564D42    mov ecx, dword ptr ds:[eax+0x04]
00564D45    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00564D4A    mov ecx, 0x321
00564D4F    mov dword ptr ss:[ebp-0xD40], eax
00564D55    lea esi, ss:[ebp-0x19C0]
00564D5B    mov dword ptr ss:[ebp-0xD08], 0x81F29C          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_87cc34e558cd0856e4415141beb0f6c7>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_87cc34e558cd0856e4415141beb0f6c7>,bool,enum CardID>::VTable ]
00564D65    lea edi, ss:[ebp-0xCA0]
00564D6B    add esp, 0x08
00564D6E    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00564D70    lea ecx, ds:[ebx+0x08]
00564D73    mov dword ptr ss:[ebp-0xD04], ecx
00564D79    lea ecx, ss:[ebp-0xD08]
00564D7F    mov dword ptr ss:[ebp-0xCE4], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_87cc34e558cd0856e4415141beb0f6c7>,bool,enum CardID>::VTable ]
...
00564E01    push eax
00564E02    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00564E36    movlpd qword ptr ss:[ebp-0xCCC], xmm0           ; => [ Call: __builtin_memset ]
...
00564EA0    mov esi, eax                                    ; => [ Call: sub_563c40 ]
00564EA2    add esp, 0x0C
00564EA5    test esi, esi
00564EA7    jz 0x00564EDB
00564EA9    call 0x00573400                                 ; => [ Call: sub_573400 ]
00564EAE    push 0x04
00564EB0    push 0x00
00564EB2    push 0x00
...
00564ED2    test al, al
00564ED4    cmovz esi, ecx                                  ; => [ Call: nullptr | Call: sub_583720 | Call: nullptr ]
00564ED7    mov eax, esi
00564ED9    jmp 0x00564EDD
00564EDB    xor eax, eax                                    ; => [ Call: nullptr ]
00564EDD    mov ecx, dword ptr ss:[ebp-0x0C]
00564EE0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00564EE7    pop ecx
00564EE8    pop edi
00564EE9    pop esi
00564EEA    mov ecx, dword ptr ss:[ebp-0x14]
00564EED    xor ecx, ebp
00564EEF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
