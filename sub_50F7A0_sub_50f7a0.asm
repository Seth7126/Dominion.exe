...
0050F7A4    in al, dx
0050F7A5    or al, 0x53
0050F7A7    mov ebx, dword ptr ds:[0x00CC8DE0]              ; => [ Data: data_cc8de0 ]
0050F7AD    push esi
0050F7AE    push edi
0050F7AF    mov edi, dword ptr ds:[0x00CC8DE4]              ; => [ Data: data_cc8de4 ]
...
0050F7D6    call 0x007621D0                                 ; => [ Call: __allmul ]
0050F7DB    add eax, dword ptr ds:[0x00CC8DE8]              ; => [ Data: data_cc8de8 ]
0050F7E1    mov ecx, edi
0050F7E3    mov esi, edi
0050F7E5    mov dword ptr ds:[0x00CC8DE0], eax              ; => [ Data: data_cc8de8 | Data: data_cc8de0 ]
...
0050F801    mov dword ptr ds:[0x00CC8DE4], edx              ; => [ Data: data_cc8dec | Data: data_cc8de4 ]
0050F807    ror esi, cl
0050F809    mul esi
...
0050F842    add ecx, eax                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
...
0050F877    pop ebp
0050F878    ret
0050F879    push 0x80CF1C                                   ; => [ String: CampaignAddExtra ]
0050F87E    push 0x242
0050F883    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0050F888    jmp 0x0050F8AA
0050F88A    push 0x813BAC                                   ; => [ String: Bell_ExoticStart_Shelter ]
0050F88F    push 0xF15
0050F894    mov ecx, 0x813BD8                               ; => [ String: what > 0 ]
0050F899    jmp 0x0050F8AA
0050F89B    push 0x813BAC                                   ; => [ String: Bell_ExoticStart_Shelter ]
0050F8A0    push 0xF14
0050F8A5    mov ecx, 0x813BC8                               ; => [ String: what <= 5000 ]
0050F8AA    push 0x80CD80
0050F8AF    mov edx, 0x801800
0050F8B4    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0050F8B9    add esp, 0x0C
0050F8BC    call 0x0063BC30
0050F8C1    test al, al
0050F8C3    jz 0x0050F8C6                                   ; => [ Call: sub_63bc30 ]
0050F8C5    int3
0050F8C6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
