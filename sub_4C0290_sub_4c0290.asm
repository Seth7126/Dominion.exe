...
004C0294    byte FF
004C0295    push 0x762E0D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_beta@16 ]
004C029A    mov eax, dword ptr fs:[0x00000000]
004C02A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004C02A1    push ecx
004C02A2    push ebx
004C02A3    push esi
004C02A4    push edi
...
004C02AC    push eax                                        ; => [ Data: __security_cookie ]
004C02AD    lea eax, ss:[ebp-0x0C]
004C02B0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004C02B6    mov edx, 0x802BCC
004C02BB    lea ecx, ss:[ebp-0x10]
004C02BE    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
004C02C3    mov edi, dword ptr ss:[ebp+0x08]
004C02C6    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004C02CB    mov eax, dword ptr ss:[ebp-0x10]
004C02CE    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004C0324    jz 0x004C0348                                   ; => [ Data: data_cf65bc ]
004C0326    lea ecx, ss:[ebp-0x10]
004C0329    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C033C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C0341    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004C0348    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C034F    test bl, bl
004C0351    jz 0x004C0371
004C0353    mov dword ptr ds:[0x008DB660], 0x05             ; => [ Data: data_8db660 ]
004C035D    xor al, al
004C035F    mov ecx, dword ptr ss:[ebp-0x0C]
004C0362    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C0369    pop ecx
004C036A    pop edi
004C036B    pop esi
004C036C    pop ebx
...
004C0379    call 0x0063D720                                 ; => [ String: btn_trash | Call: sub_63d720 ]
004C037E    mov eax, dword ptr ss:[ebp-0x10]
004C0381    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004C03CC    jz 0x004C03F0                                   ; => [ Data: data_cf65bc ]
004C03CE    lea ecx, ss:[ebp-0x10]
004C03D1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C03E4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C03E9    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
004C040D    mov dword ptr ds:[0x008DBC50], eax              ; => [ Data: data_8dbc50 ]
004C0412    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004C041C    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_msg_delete_profile_header ]
004C0421    add esp, 0x04
004C0424    test eax, eax
004C0426    jnz 0x004C042F
004C0428    mov ecx, 0x803420                               ; => [ String: dom_msg_delete_profile_header ]
004C042D    jmp 0x004C0438
004C042F    mov eax, dword ptr ds:[eax]
004C0431    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004C044C    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_63d8d0 | Call: sub_68caf0 | Data: data_8db750 | String: dom_msg_delete_profile_body ]
004C0451    add esp, 0x04
004C0454    test eax, eax
004C0456    jnz 0x004C045F
004C0458    mov ecx, 0x803404                               ; => [ String: dom_msg_delete_profile_body ]
004C045D    jmp 0x004C0468
004C045F    mov eax, dword ptr ds:[eax]
004C0461    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004C0479    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_63d8d0 | Call: sub_68caf0 | Data: data_801800 | Data: data_8db754 ]
004C047E    add esp, 0x04
004C0481    test eax, eax
004C0483    jnz 0x004C048C
004C0485    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004C048A    jmp 0x004C0495
004C048C    mov eax, dword ptr ds:[eax]
004C048E    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004C04A6    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_63d8d0 | Data: data_8db758 | Call: sub_68caf0 | Data: data_801800 ]
004C04AB    add esp, 0x04
004C04AE    test eax, eax
004C04B0    jnz 0x004C04B9
004C04B2    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
004C04C6    call 0x0063D8D0                                 ; => [ Data: data_8db75c | Call: sub_63d8d0 ]
004C04CB    mov dword ptr ds:[0x008DB760], 0x4C0780         ; => [ Call: sub_4c0780 | Data: data_8db760 ]
004C04D5    xor al, al
004C04D7    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004C04E1    mov ecx, dword ptr ss:[ebp-0x0C]
004C04E4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C04EB    pop ecx
004C04EC    pop edi
004C04ED    pop esi
004C04EE    pop ebx
...
004C04FB    call 0x0063D720                                 ; => [ String: btn_profile | Call: sub_63d720 ]
004C0500    mov eax, dword ptr ss:[ebp+0x08]
004C0503    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004C054C    jz 0x004C0570                                   ; => [ Data: data_cf65bc ]
004C054E    lea ecx, ss:[ebp-0x10]
004C0551    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C0564    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C0569    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004C0570    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C0577    test edi, edi
004C0579    jnz 0x004C035D
004C057F    mov eax, dword ptr ds:[0x008DBC44]              ; => [ Data: data_8dbc44 ]
004C0584    test eax, eax
004C0586    jz 0x004C05C3
004C0588    cmp eax, 0x801800
004C058D    jz 0x004C05C3                                   ; => [ Data: data_801800 ]
004C058F    cmp dword ptr ds:[0x00CF65BC], edi
004C0595    jz 0x004C05B9
004C0597    cmp byte ptr ds:[eax], 0x00
004C059A    jz 0x004C05B9                                   ; => [ Data: data_cf65bc ]
004C059C    mov ecx, 0x8DBC44
004C05A1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 | Data: data_8dbc44 ]
...
004C05B4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C05B9    mov dword ptr ds:[0x008DBC44], 0x801800         ; => [ Data: data_801800 | Data: data_8dbc44 ]
004C05C3    mov dword ptr ds:[0x008DBC40], 0x00             ; => [ Data: data_8dbc40 ]
004C05CD    call 0x004C01D0                                 ; => [ Call: sub_4c01d0 ]
004C05D2    mov ecx, dword ptr ss:[ebp+0x08]
004C05D5    mov edx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
...
004C05F1    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C05F6    mov dword ptr ss:[ebp-0x04], 0x03
004C05FD    lea eax, ss:[ebp-0x10]
004C0600    push eax
004C0601    mov ecx, 0x8DB76C
004C0606    mov dword ptr ds:[0x008DB6B0], 0x22             ; => [ Data: data_8db6b0 ]
004C0610    mov dword ptr ds:[0x008DB768], 0x8DBC60         ; => [ Data: data_8db768 | Data: data_8dbc60 ]
004C061A    mov dword ptr ds:[0x008DB770], 0x4C0890         ; => [ Data: data_8db770 | Call: sub_4c0890 ]
004C0624    mov dword ptr ds:[0x008DB774], 0x4BFB50         ; => [ Call: sub_4bfb50 | Data: data_8db774 ]
004C062E    call 0x0063D850                                 ; => [ Data: data_8db76c | Call: sub_63d850 ]
004C0633    mov dword ptr ds:[0x008DB778], 0x01             ; => [ Data: data_8db778 ]
004C063D    mov dword ptr ss:[ebp-0x04], 0x04
004C0644    cmp dword ptr ds:[0x00CF65BC], 0x00
004C064B    jz 0x004C035D                                   ; => [ Data: data_cf65bc ]
...
004C0668    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C067F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C0684    xor al, al
004C0686    mov ecx, dword ptr ss:[ebp-0x0C]
004C0689    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C0690    pop ecx
004C0691    pop edi
004C0692    pop esi
004C0693    pop ebx
...
004C06C2    call 0x004D9160                                 ; => [ Call: sub_4d9160 ]
004C06C7    call 0x0061E010                                 ; => [ Call: sub_61e010 ]
004C06CC    mov ecx, dword ptr ds:[0x00CC8DC8]
004C06D2    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004C06D8    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004C06DD    cmp dword ptr ds:[eax+0x42B4], 0x02
004C06E4    jnz 0x004C06F0
004C06E6    mov dword ptr ds:[eax+0x42B4], 0x00
004C06F0    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004C06F5    test eax, eax
004C06F7    jnz 0x004C070C
004C06F9    push 0x77EB90                                   ; => [ String: GetClient ]
004C06FE    push 0x7B
004C0700    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004C0705    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004C070A    jmp 0x004C075B
004C070C    cmp dword ptr ds:[eax+0x18], 0x03
004C0710    jz 0x004C0719
004C0712    call 0x004AEA20                                 ; => [ Call: sub_4aea20 ]
004C0717    jmp 0x004C0723
004C0719    mov dword ptr ds:[eax+0x75B0], 0x01
004C0723    call 0x004C01D0                                 ; => [ Call: sub_4c01d0 ]
004C0728    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C072E    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 | Data: data_801800 ]
004C0733    xor al, al
004C0735    mov ecx, dword ptr ss:[ebp-0x0C]
004C0738    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C073F    pop ecx
004C0740    pop edi
004C0741    pop esi
004C0742    pop ebx
...
004C0745    pop ebp
004C0746    ret
004C0747    push 0x8069D4                                   ; => [ String: GetProfileBySlot ]
004C074C    push 0x544
004C0751    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004C0756    mov ecx, 0x803BE4                               ; => [ String: retval ]
004C075B    mov edx, esi
004C075D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004C0762    add esp, 0x0C
004C0765    call 0x0063BC30
004C076A    test al, al
004C076C    jz 0x004C076F                                   ; => [ Call: sub_63bc30 ]
004C076E    int3
004C076F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
