...
004C50BD    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C50C2    push 0xFFFFFFFF
004C50C4    push 0x8DB750
004C50C9    mov edx, 0x8DBED8
004C50CE    mov ecx, edi
004C50D0    mov dword ptr ds:[eax+0x18BC], 0x4C4F20         ; => [ Call: sub_4c4f20 ]
004C50DA    call 0x00666380
004C50DF    push 0xFFFFFFFF
004C50E1    push 0x8DB754
004C50E6    mov edx, 0x8DBEE4
004C50EB    mov ecx, edi
004C50ED    call 0x00666380                                 ; => [ Data: data_8dbed8 | Data: data_8db754 | Data: data_8dbee4 | Call: sub_666380 | Data: data_8db750 ]
004C50F2    mov eax, dword ptr ds:[0x008DB758]              ; => [ Data: data_8db758 ]
004C50F7    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004C50FC    add esp, 0x10
004C50FF    mov ecx, esi                                    ; => [ Data: data_801800 ]
004C5101    test eax, eax
004C5103    cmovnz ecx, eax
004C5106    mov eax, esi                                    ; => [ Data: data_801800 ]
...
004C513F    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8dbef0 | Data: data_8db758 ]
004C5144    add esp, 0x08
004C5147    mov eax, dword ptr ds:[0x008DB75C]              ; => [ Data: data_8db75c ]
004C514C    test eax, eax
004C514E    cmovnz esi, eax
004C5151    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
004C5172    xor eax, eax                                    ; => [ Call: nullptr | Call: nullptr ]
...
004C518D    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8dbefc | Data: data_8db75c ]
