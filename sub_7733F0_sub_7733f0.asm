...
007734CF    call 0x0064C080
007734D4    mov dword ptr ds:[0x008D2FF0], 0x801800
007734DE    mov ecx, dword ptr ss:[ebp-0x0C]
007734E1    mov dword ptr fs:[0x00000000], ecx
007734E8    pop ecx
