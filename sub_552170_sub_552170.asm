...
00552188    push 0x7669EB                                   ; => [ Type: EHRegistrationNode | Call: sub_7669eb ]
0055218D    mov eax, dword ptr fs:[0x00000000]
00552193    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00552194    push ebx
00552195    mov eax, 0x19B8
0055219A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055219F    mov eax, dword ptr ds:[0x008C4040]
005521A4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
005521A6    mov dword ptr ss:[ebp-0x14], eax
005521A9    push esi
005521AA    push edi
005521AB    push eax
005521AC    lea eax, ss:[ebp-0x0C]
005521AF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005521B5    call 0x00573400                                 ; => [ Call: sub_573400 ]
005521BA    lea ecx, ss:[ebp-0x19C8]
005521C0    push 0x04
005521C2    push ecx
005521C3    mov edx, dword ptr ds:[eax+0x0C]
005521C6    mov ecx, dword ptr ds:[eax+0x04]
005521C9    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
005521CE    mov ecx, 0x321
005521D3    mov dword ptr ss:[ebp-0xD48], eax
005521D9    lea esi, ss:[ebp-0x19C8]
005521DF    mov dword ptr ss:[ebp-0xD10], 0x81CC14          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_e526870c9f0b19951e850c16e7ec29b1>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_e526870c9f0b19951e850c16e7ec29b1>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
005521E9    lea edi, ss:[ebp-0xCA0]
005521EF    add esp, 0x08
005521F2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005521F4    lea ecx, ss:[ebp-0xD10]
005521FA    mov dword ptr ss:[ebp-0xCEC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_e526870c9f0b19951e850c16e7ec29b1>,bool,enum CardID>::VTable ]
...
0055223B    call eax
0055223D    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00552263    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0055227A    push eax
0055227B    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0055227E    xorps xmm0, xmm0
00552281    mov dword ptr ss:[ebp-0xCDC], 0x00
0055228B    movlpd qword ptr ss:[ebp-0xCE4], xmm0           ; => [ Call: __builtin_memset ]
...
00552397    mov ecx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0055239A    mov dword ptr ss:[ebp-0xCA4], ecx
005523A0    jb 0x005523AD
005523A2    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005523E2    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005523E5    mov dword ptr ss:[ebp-0xCAC], eax
005523EB    jb 0x00552442
005523ED    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00552415    mov dword ptr ss:[ebp-0xCA8], eax               ; => [ Call: nullptr ]
0055241B    call 0x00573400                                 ; => [ Call: sub_573400 ]
00552420    mov dword ptr ss:[ebp-0xCAC], eax
00552426    mov eax, dword ptr ds:[eax+0x04]
00552429    mov dword ptr ss:[ebp-0xCB4], eax
0055242F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0055245F    mov dword ptr ss:[ebp-0xCA8], eax               ; => [ Call: nullptr ]
00552465    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005524D9    call 0x0056BBA0                                 ; => [ Call: sub_4ffce0 | Call: sub_56bba0 ]
005524DE    add esp, 0x0C
005524E1    mov ecx, dword ptr ss:[ebp-0x0C]
005524E4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005524EB    pop ecx
005524EC    pop edi
005524ED    pop esi
005524EE    mov ecx, dword ptr ss:[ebp-0x14]
005524F1    xor ecx, ebp
005524F3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
