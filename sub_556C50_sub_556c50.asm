...
00556C5B    call 0x00761E50
00556C60    mov eax, dword ptr ds:[0x008C4040]
00556C65    xor eax, esp
00556C67    mov dword ptr ss:[esp+0x1994], eax
00556C6E    push esi
00556C6F    push edi
00556C70    call 0x00573400
00556C75    push 0x00
00556C77    push 0x00
00556C79    push 0x02
...
00556C81    push 0x01
00556C83    call 0x00590760
00556C88    add esp, 0x10
00556C8B    call 0x00573400
...
00556D64    mov dword ptr ss:[esp+0x14], eax
00556D68    call 0x00573400
...
00556E18    call 0x0063B870
00556E1D    add esp, 0x0C
00556E20    call 0x0063BC30
00556E25    test al, al
00556E27    jz 0x00556E2A
00556E29    int3
00556E2A    call 0x0063BB00
