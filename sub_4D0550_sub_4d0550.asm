...
004D05B1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D05B6    mov dword ptr ds:[0x008DB800], 0x801800         ; => [ Data: data_801800 | Data: data_8db800 ]
004D05C0    mov eax, dword ptr ds:[0x008DB750]              ; => [ Data: data_8db750 ]
004D05C5    test eax, eax
004D05C7    jz 0x004D0605
004D05C9    cmp eax, 0x801800
004D05CE    jz 0x004D0605                                   ; => [ Data: data_801800 ]
004D05D0    cmp dword ptr ds:[0x00CF65BC], 0x00
004D05D7    jz 0x004D05FB
004D05D9    cmp byte ptr ds:[eax], 0x00
004D05DC    jz 0x004D05FB                                   ; => [ Data: data_cf65bc ]
004D05DE    mov ecx, 0x8DB750
004D05E3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 | Data: data_8db750 ]
...
004D05F6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D05FB    mov dword ptr ds:[0x008DB750], 0x801800         ; => [ Data: data_8db750 | Data: data_801800 ]
004D0605    mov eax, dword ptr ds:[0x008DB754]              ; => [ Data: data_8db754 ]
004D060A    test eax, eax
004D060C    jz 0x004D064A
004D060E    cmp eax, 0x801800
004D0613    jz 0x004D064A                                   ; => [ Data: data_801800 ]
004D0615    cmp dword ptr ds:[0x00CF65BC], 0x00
004D061C    jz 0x004D0640
004D061E    cmp byte ptr ds:[eax], 0x00
004D0621    jz 0x004D0640                                   ; => [ Data: data_cf65bc ]
004D0623    mov ecx, 0x8DB754
004D0628    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 | Data: data_8db754 ]
...
004D063B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D0640    mov dword ptr ds:[0x008DB754], 0x801800         ; => [ Data: data_801800 | Data: data_8db754 ]
004D064A    mov eax, dword ptr ds:[0x008DB758]              ; => [ Data: data_8db758 ]
004D064F    test eax, eax
004D0651    jz 0x004D068F
004D0653    cmp eax, 0x801800
004D0658    jz 0x004D068F                                   ; => [ Data: data_801800 ]
004D065A    cmp dword ptr ds:[0x00CF65BC], 0x00
004D0661    jz 0x004D0685
004D0663    cmp byte ptr ds:[eax], 0x00
004D0666    jz 0x004D0685                                   ; => [ Data: data_cf65bc ]
004D0668    mov ecx, 0x8DB758
004D066D    call 0x0063D4E0                                 ; => [ Data: data_8db758 | Call: sub_63d4e0 ]
...
004D0680    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D0685    mov dword ptr ds:[0x008DB758], 0x801800         ; => [ Data: data_8db758 | Data: data_801800 ]
004D068F    mov eax, dword ptr ds:[0x008DB75C]              ; => [ Data: data_8db75c ]
004D0694    test eax, eax
004D0696    jz 0x004D06D4
004D0698    cmp eax, 0x801800
004D069D    jz 0x004D06D4                                   ; => [ Data: data_801800 ]
004D069F    cmp dword ptr ds:[0x00CF65BC], 0x00
004D06A6    jz 0x004D06CA
004D06A8    cmp byte ptr ds:[eax], 0x00
004D06AB    jz 0x004D06CA                                   ; => [ Data: data_cf65bc ]
004D06AD    mov ecx, 0x8DB75C
004D06B2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 | Data: data_8db75c ]
...
004D06C5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D06CA    mov dword ptr ds:[0x008DB75C], 0x801800         ; => [ Data: data_801800 | Data: data_8db75c ]
004D06D4    mov esi, dword ptr ds:[0x01597CC4]              ; => [ Data: data_1597cc4 ]
...
004D06EA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D06EF    test esi, esi
004D06F1    jnz 0x004D06E0
004D06F3    pop edi
004D06F4    mov dword ptr ds:[0x01597CCC], 0x00             ; => [ Data: data_1597ccc ]
004D06FE    mov dword ptr ds:[0x01597CC4], 0x00             ; => [ Data: data_1597cc4 ]
004D0708    mov dword ptr ds:[0x01597CC8], 0x00             ; => [ Data: data_1597cc8 ]
004D0712    pop esi
