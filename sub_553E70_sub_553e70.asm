...
00553E7B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00553E80    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00553E9C    push edi
00553E9D    push eax
00553E9E    call 0x00568780                                 ; => [ Call: sub_568780 ]
00553EA3    add esp, 0x04
00553EA6    lea edi, ss:[esp+0x10]
00553EAA    mov esi, eax
00553EAC    mov ecx, 0x321
00553EB1    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00553EB3    push 0x00
00553EB5    push 0x02
00553EB7    lea ecx, ss:[esp+0x18]
00553EBB    call 0x00561880                                 ; => [ Call: sub_561880 ]
00553EC0    add esp, 0x08
00553EC3    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00553EFB    push esi
00553EFC    push eax
00553EFD    call 0x00590DE0                                 ; => [ Call: sub_590de0 ]
...
00553F11    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
