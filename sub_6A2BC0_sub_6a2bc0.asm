...
006A2C22    call 0x006A0F60
006A2C27    mov ecx, dword ptr ss:[ebp-0x0C]
006A2C2A    mov dword ptr fs:[0x00000000], ecx
006A2C31    pop ecx
006A2C32    pop edi
006A2C33    pop esi
...
006A2C3F    call 0x006D95C0
006A2C44    mov ecx, dword ptr ss:[ebp-0x0C]
006A2C47    mov dword ptr fs:[0x00000000], ecx
006A2C4E    pop ecx
006A2C4F    pop edi
006A2C50    pop esi
...
006A2C5E    call 0x006D8ED0
006A2C63    mov edx, 0x01
006A2C68    mov ecx, esi
006A2C6A    call 0x006D8ED0
006A2C6F    mov ecx, dword ptr ss:[ebp-0x0C]
006A2C72    mov dword ptr fs:[0x00000000], ecx
006A2C79    pop ecx
006A2C7A    pop edi
006A2C7B    pop esi
...
006A2CBF    mov dword ptr fs:[0x00000000], ecx
006A2CC6    pop ecx
006A2CC7    pop edi
006A2CC8    pop esi
...
006A2D28    call 0x0063B870
006A2D2D    add esp, 0x0C
006A2D30    call 0x0063BC30
006A2D35    test al, al
006A2D37    jz 0x006A2D3A
006A2D39    int3
006A2D3A    call 0x0063BB00
