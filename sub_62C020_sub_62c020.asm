...
0062C042    mov dword ptr fs:[0x00000000], eax
...
0062C05D    call dword ptr ds:[0x00775458]
0062C063    mov edi, eax
0062C065    add esp, 0x08
0062C068    test edi, edi
0062C06A    jnz 0x0062C085
0062C06C    push 0x86D240
0062C071    push 0x10670
0062C076    push 0x86F1E8
0062C07B    mov ecx, 0x86D25C
...
0062C094    mov dword ptr ss:[ebp-0x24], 0x801800
0062C09B    call 0x0063DB30
...
0062C16B    mov eax, dword ptr ds:[eax+0x08]
...
0062C1A7    mov dword ptr ss:[ebp-0x30], 0x801800
0062C1AE    call 0x0063DB30
...
0062C1E4    mov ecx, dword ptr ds:[eax+0x08]
...
0062C22B    mov eax, dword ptr ds:[eax+0x08]
...
0062C289    jz 0x0062C47D
0062C28F    lea ecx, ss:[ebp-0x1C]
0062C292    call 0x0063D4E0
...
0062C2A9    call 0x0064C080
0062C2AE    mov dword ptr ss:[ebp-0x1C], 0x801800
0062C2B5    jmp 0x0062C47D
0062C2BA    mov eax, dword ptr ss:[ebp-0x2C]
0062C2BD    mov dword ptr ss:[ebp-0x2C], eax
0062C2C0    mov dword ptr ss:[ebp-0x1C], 0x801800
...
0062C32E    call 0x0064C080
0062C333    mov dword ptr ss:[ebp-0x38], 0x801800
...
0062C364    mov dword ptr ss:[ebp-0x34], 0x801800
0062C36B    call 0x0063DB30
...
0062C3FB    call 0x0064C080
0062C400    mov dword ptr ss:[ebp-0x18], 0x801800
...
0062C41B    jz 0x0062C43F
0062C41D    lea ecx, ss:[ebp-0x34]
0062C420    call 0x0063D4E0
...
0062C433    call 0x0064C080
0062C438    mov dword ptr ss:[ebp-0x34], 0x801800
0062C43F    mov byte ptr ss:[ebp-0x04], 0x11
0062C443    cmp dword ptr ds:[0x00CF65BC], 0x00
0062C44A    jz 0x0062C47A
...
0062C46E    call 0x0064C080
0062C473    mov dword ptr ss:[ebp-0x1C], 0x801800
...
0062C495    mov eax, dword ptr ds:[eax+0x08]
0062C498    jmp 0x0062C49C
0062C49A    xor eax, eax
...
0062C4BD    jz 0x0062C4E4
0062C4BF    lea ecx, ss:[ebp-0x30]
0062C4C2    call 0x0063D4E0
...
0062C4D5    call 0x0064C080
0062C4DA    mov dword ptr ss:[ebp-0x30], 0x801800
...
0062C50D    jz 0x0062C52A
0062C50F    lea ecx, ss:[ebp-0x20]
0062C512    call 0x0063D4E0
...
0062C553    jz 0x0062C570
0062C555    lea ecx, ss:[ebp-0x20]
0062C558    call 0x0063D4E0
...
0062C587    jz 0x0062C5A4
0062C589    lea ecx, ss:[ebp-0x24]
0062C58C    call 0x0063D4E0
