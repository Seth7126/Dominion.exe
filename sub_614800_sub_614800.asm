...
0061481F    push esi
00614820    call 0x005CBA00                                 ; => [ Call: sub_5cba00 | Data: data_b7d434 ]
00614825    cmp dword ptr ds:[eax+0x2C], 0x01
00614829    jz 0x0061483F
0061482B    push 0x868554                                   ; => [ String: DomZoomDismissAll ]
00614830    push 0xC21B
00614835    mov ecx, 0x86F8D4                               ; => [ String: gfx.type == DOMGFX_CARD_PLACEHOLDER ]
0061483A    jmp 0x00614A24
0061483F    imul eax, dword ptr ds:[0x00B809E4], 0x1C30
00614849    mov esi, 0xB809E0                               ; => [ Data: data_b809e0 ]
0061484E    mov ecx, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
00614854    mov dword ptr ss:[ebp-0x08], esi                ; => [ Data: data_b809e0 ]
00614857    add eax, ecx                                    ; => [ Data: data_b809e4 ]
...
006148C0    jnz 0x006149BB                                  ; => [ Data: data_b7d434 ]
...
006148DD    jnb 0x006149BB                                  ; => [ Data: data_b809e4 ]
006148E3    imul eax, eax, 0x1C30
006148E9    add eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
...
0061493F    jnb 0x006149BB                                  ; => [ Data: data_b809e4 ]
00614941    imul eax, eax, 0x1C30
00614947    add eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
...
006149B1    call 0x005CB7C0                                 ; => [ Call: sub_5cb7c0 ]
006149B6    add esp, 0x08
006149B9    jmp 0x006149C0
006149BB    call 0x005CB5A0                                 ; => [ Call: sub_5cb5a0 | Call: sub_5cb5a0 | Call: sub_5cb5a0 | Call: sub_5cb5a0 | Call: sub_5cb5a0 | Call: sub_5cb5a0 | Call: sub_5cb5a0 ]
006149C0    lea eax, ss:[ebp-0x04]
006149C3    mov ecx, esi
006149C5    push eax
006149C6    call 0x006376D0                                 ; => [ Call: sub_6376d0 ]
...
006149DB    mov dword ptr ds:[0x00B7D424], 0x00             ; => [ Data: data_b7d424 ]
006149E5    mov dword ptr ds:[0x00B7D434], 0x00             ; => [ Data: data_b7d434 ]
006149EF    mov dword ptr ds:[0x00B7D42C], 0x00             ; => [ Data: data_b7d42c ]
006149F9    mov dword ptr ds:[0x00B7D430], 0x00             ; => [ Data: data_b7d430 ]
00614A03    mov dword ptr ds:[0x00B7F4C0], 0x00             ; => [ Data: data_b7f4c0 ]
00614A0D    pop esi
...
00614A13    pop ebx
00614A14    ret
00614A15    push 0x868554                                   ; => [ String: DomZoomDismissAll ]
00614A1A    push 0xC251
00614A1F    mov ecx, 0x86F8F8                               ; => [ String: source->move.locCurrent.type == LOC_USER ]
00614A24    push 0x86F1E8
00614A29    mov edx, 0x801800
00614A2E    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 | String: DomZoomDismissAll ]
00614A33    add esp, 0x0C
00614A36    call 0x0063BC30
00614A3B    test al, al
00614A3D    jz 0x00614A40                                   ; => [ Call: sub_63bc30 ]
00614A3F    int3
00614A40    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
