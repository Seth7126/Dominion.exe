...
0054E8C8    push 0x76582B                                   ; => [ Call: sub_76582b | Type: EHRegistrationNode ]
0054E8CD    mov eax, dword ptr fs:[0x00000000]
0054E8D3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0054E8D4    push ebx
0054E8D5    mov eax, 0x19A8
0054E8DA    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054E8DF    mov eax, dword ptr ds:[0x008C4040]
0054E8E4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0054E8E6    mov dword ptr ss:[ebp-0x14], eax
0054E8E9    push esi
0054E8EA    push edi
0054E8EB    push eax
0054E8EC    lea eax, ss:[ebp-0x0C]
0054E8EF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0054E8F5    lea eax, ss:[ebp-0xCA0]
0054E8FB    mov ecx, 0x3EA
0054E900    push eax
0054E901    call 0x00568780                                 ; => [ Call: sub_568780 ]
0054E906    mov esi, eax
0054E908    mov dword ptr ss:[ebp-0x1988], 0x81C554         ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_44377537478ea6093d77c304591c8f1e>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_44377537478ea6093d77c304591c8f1e>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0054E912    mov ecx, 0x321
0054E917    lea edi, ss:[ebp-0x1928]
0054E91D    lea eax, ss:[ebp-0x1988]
0054E923    add esp, 0x04
0054E926    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0054E928    mov dword ptr ss:[ebp-0x1964], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_44377537478ea6093d77c304591c8f1e>,bool,enum CardID>::VTable ]
...
0054E969    call eax                                        ; => [ Field: vFunc_0 ]
...
0054E97A    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0054E9AB    push eax
0054E9AC    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0054E9AF    xorps xmm0, xmm0
0054E9B2    mov dword ptr ss:[ebp-0x1954], 0x00
0054E9BC    movlpd qword ptr ss:[ebp-0x195C], xmm0          ; => [ Call: __builtin_memset ]
...
0054EA7F    push 0x00
0054EA81    push 0x46B
0054EA86    call 0x00566140                                 ; => [ Call: nullptr | Call: sub_566140 ]
...
0054EAAA    push eax
0054EAAB    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0054EAC5    push 0x42
0054EAC7    push eax
0054EAC8    call 0x0056BBA0                                 ; => [ Call: sub_54eaf0 | Call: sub_56bba0 ]
0054EACD    add esp, 0x0C
0054EAD0    mov ecx, dword ptr ss:[ebp-0x0C]
0054EAD3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0054EADA    pop ecx
0054EADB    pop edi
0054EADC    pop esi
0054EADD    mov ecx, dword ptr ss:[ebp-0x14]
0054EAE0    xor ecx, ebp
0054EAE2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
