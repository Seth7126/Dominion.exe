...
006C85D2    mov dword ptr fs:[0x00000000], eax
...
006C8611    call 0x0063D720
006C8616    mov eax, edi
006C8618    mov ecx, dword ptr ss:[ebp-0x0C]
006C861B    mov dword ptr fs:[0x00000000], ecx
006C8622    pop ecx
006C8623    pop edi
006C8624    pop esi
006C8625    pop ebx
...
006C8744    jz 0x006C8768
006C8746    lea ecx, ss:[ebp-0x10]
006C8749    call 0x0063D4E0
...
006C875C    call 0x0064C080
006C8761    mov dword ptr ss:[ebp-0x10], 0x801800
006C8768    mov dword ptr ss:[ebp-0x04], 0x06
006C876F    jmp 0x006C8A86
006C8774    mov eax, 0x800338
...
006C8848    call 0x0064C080
006C884D    mov dword ptr ss:[ebp-0x18], 0x801800
...
006C8868    jz 0x006C8885
006C886A    lea ecx, ss:[ebp-0x24]
006C886D    call 0x0063D4E0
...
006C88E3    call 0x0064C080
006C88E8    mov dword ptr ss:[ebp-0x18], 0x801800
...
006C8903    jz 0x006C8920
006C8905    lea ecx, ss:[ebp-0x24]
006C8908    call 0x0063D4E0
...
006C894F    call 0x0064C080
006C8954    mov dword ptr ss:[ebp-0x10], 0x801800
...
006C89A0    jz 0x006C89C4
006C89A2    lea ecx, ss:[ebp-0x10]
006C89A5    call 0x0063D4E0
...
006C89B8    call 0x0064C080
006C89BD    mov dword ptr ss:[ebp-0x10], 0x801800
...
006C8A73    call 0x0064C080
006C8A78    mov dword ptr ss:[ebp-0x10], 0x801800
...
006C8A96    jz 0x006C8AB3
006C8A98    lea ecx, ss:[ebp-0x14]
006C8A9B    call 0x0063D4E0
...
006C8AAE    call 0x0064C080
006C8AB3    mov eax, ebx
006C8AB5    mov ecx, dword ptr ss:[ebp-0x0C]
006C8AB8    mov dword ptr fs:[0x00000000], ecx
006C8ABF    pop ecx
006C8AC0    pop edi
006C8AC1    pop esi
006C8AC2    pop ebx
...
006C8B8D    mov ecx, dword ptr ds:[eax+0x08]
...
006C8C08    jz 0x006C8C2C
006C8C0A    lea ecx, ss:[ebp-0x10]
006C8C0D    call 0x0063D4E0
...
006C8C20    call 0x0064C080
006C8C25    mov dword ptr ss:[ebp-0x10], 0x801800
...
006C8C51    call 0x0063B870
006C8C56    add esp, 0x0C
006C8C59    call 0x0063BC30
006C8C5E    test al, al
006C8C60    jz 0x006C8C63
006C8C62    int3
006C8C63    call 0x0063BB00
