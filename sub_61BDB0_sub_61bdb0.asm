...
0061BDB9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0061BDBE    xor eax, esp
0061BDC0    mov dword ptr ss:[esp+0x54], eax
0061BDC4    push esi
0061BDC5    push edi
0061BDC6    mov esi, ecx
0061BDC8    mov byte ptr ds:[0x00C23BF8], 0x00              ; => [ Data: data_c23bf8 ]
0061BDCF    call 0x006053A0                                 ; => [ Call: sub_6053a0 ]
0061BDD4    test al, al
0061BDD6    jnz 0x0061BFFE
0061BDDC    lea eax, ss:[esp+0x10]
0061BDE0    mov ecx, esi
0061BDE2    push eax
0061BDE3    call 0x005DE520                                 ; => [ Call: sub_5de520 ]
...
0061BE06    call 0x005CB6E0                                 ; => [ Call: sub_5cb6e0 ]
0061BE0B    mov dword ptr ds:[0x00B7FCD0], 0x00             ; => [ Data: data_b7fcd0 ]
...
0061BE3C    call 0x00617BB0                                 ; => [ Call: nullptr | Data: data_7ffb14 | Call: sub_617bb0 ]
0061BE41    add esp, 0x0C
0061BE44    mov ecx, esi
0061BE46    call 0x005CB5A0                                 ; => [ Call: sub_5cb5a0 ]
0061BE4B    pop edi
0061BE4C    pop esi
0061BE4D    mov ecx, dword ptr ss:[esp+0x54]
0061BE51    xor ecx, esp
0061BE53    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0061BE58    mov esp, ebp
0061BE5A    pop ebp
0061BE5B    ret
0061BE5C    test eax, eax
0061BE5E    jz 0x0061BE74
0061BE60    push 0x86A578                                   ; => [ String: DomDragCardEnd ]
0061BE65    push 0xDA4A
0061BE6A    mov ecx, 0x86F474                               ; => [ String: gfx.type == DOMGFX_CARD ]
...
0061BEB6    jz 0x0061BF3D                                   ; => [ Data: data_b80b54 | Data: data_b80afc | Data: data_b80b08 ]
0061BEBC    push eax
0061BEBD    push ecx
0061BEBE    push eax
0061BEBF    mov edx, 0x7FFB14
0061BEC4    mov ecx, esi
0061BEC6    call 0x00617BB0                                 ; => [ Data: data_7ffb14 | Call: sub_617bb0 ]
...
0061BEE6    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
0061BEEB    mov ecx, eax
0061BEED    add esp, 0x08
0061BEF0    test ecx, ecx
0061BEF2    jnz 0x0061BF08
0061BEF4    push 0x86F4D8                                   ; => [ String: DomPileGet ]
0061BEF9    push 0x9B0
0061BEFE    mov ecx, 0x86F4E4                               ; => [ String: pPile ]
...
0061BF24    call 0x005F2D80                                 ; => [ Call: sub_5f2d80 ]
0061BF29    add esp, 0x18
0061BF2C    pop edi
0061BF2D    pop esi
0061BF2E    mov ecx, dword ptr ss:[esp+0x54]
0061BF32    xor ecx, esp
0061BF34    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0061BF49    call 0x00617BB0                                 ; => [ Call: nullptr | Data: data_7ffb14 | Call: sub_617bb0 ]
...
0061BF73    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
0061BFA1    call 0x005F2D80                                 ; => [ Call: sub_5f2d80 ]
0061BFA6    add esp, 0x18
0061BFA9    cmp dword ptr ds:[esi+0x1BE0], 0x3EA
0061BFB3    jnz 0x0061BFBF
0061BFB5    mov dword ptr ds:[0x00B7FCF0], 0x00             ; => [ Data: data_b7fcf0 ]
0061BFBF    pop edi
0061BFC0    pop esi
0061BFC1    mov ecx, dword ptr ss:[esp+0x54]
0061BFC5    xor ecx, esp
0061BFC7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction | Call: CookieCheckFunction | Call: CookieCheckFunction ]
...
0061BFE8    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
0061C004    push 0x86A578                                   ; => [ String: DomDragCardEnd ]
0061C009    push 0xDA83
0061C00E    mov ecx, 0x86F474                               ; => [ String: gfx.type == DOMGFX_CARD ]
0061C013    jmp 0x0061C22D
0061C018    lea eax, ss:[esp+0x10]
0061C01C    mov ecx, esi
0061C01E    push eax
0061C01F    call 0x005DE520                                 ; => [ Call: sub_5de520 ]
...
0061C042    call 0x005CB6E0                                 ; => [ Call: sub_5cb6e0 ]
0061C047    mov dword ptr ds:[0x00B7FCD0], 0x00             ; => [ Data: data_b7fcd0 ]
0061C051    mov dword ptr ds:[esi+0x1B88], 0x00
0061C05B    mov ecx, dword ptr ds:[0x00B7FCF4]
0061C061    call 0x005CBA00
0061C066    mov edi, dword ptr ds:[eax+0x5C]                ; => [ Data: data_b7fcf4 | Call: sub_5cba00 ]
...
0061C08A    push 0x00
0061C08C    push 0x00
0061C08E    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
0061C0BF    call 0x005CE6D0                                 ; => [ Call: sub_5ce6d0 ]
...
0061C0E2    push eax
0061C0E3    call 0x005F2D80                                 ; => [ Call: sub_5f2d80 ]
...
0061C106    or edx, 0xFFFFFFFF                              ; => [ Call: nullptr ]
0061C109    cmp dword ptr ds:[0x00B80B08], 0x3B             ; => [ Data: data_b80b08 ]
...
0061C142    call 0x0061BC40                                 ; => [ Call: sub_61bc40 ]
...
0061C163    cmovz eax, ecx                                  ; => [ Data: data_b80b08 ]
0061C166    mov ecx, esi
0061C168    push eax
0061C169    push 0x7FEED4
0061C16E    call 0x0061BC40                                 ; => [ Data: data_7feed4 | Call: sub_61bc40 ]
...
0061C18C    cmovz eax, ecx                                  ; => [ Data: data_b80b08 ]
0061C18F    mov ecx, esi
0061C191    push eax
0061C192    push 0x7FEED4
0061C197    call 0x0061BC40                                 ; => [ Data: data_7feed4 | Call: sub_61bc40 ]
...
0061C1AC    push 0x00
0061C1AE    push 0x00
0061C1B0    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
0061C1D9    push eax
0061C1DA    call 0x005F2D80                                 ; => [ Call: sub_5f2d80 | Data: data_7feed4 ]
0061C1DF    add esp, 0x18
0061C1E2    mov dword ptr ds:[0x00B7FCF0], 0x00             ; => [ Data: data_b7fcf0 ]
...
0061C215    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0061C21A    mov esp, ebp
0061C21C    pop ebp
0061C21D    ret
0061C21E    push 0x86A578                                   ; => [ String: DomDragCardEnd ]
0061C223    push 0xDAD5
0061C228    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0061C22D    push 0x86F1E8
0061C232    mov edx, 0x801800
0061C237    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 ]
0061C23C    add esp, 0x0C
0061C23F    call 0x0063BC30
0061C244    test al, al
0061C246    jz 0x0061C249                                   ; => [ Call: sub_63bc30 ]
0061C248    int3
0061C249    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
