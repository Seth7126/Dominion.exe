...
0076C9AE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C9B3    mov ecx, dword ptr ds:[edx-0x04]
0076C9B6    xor ecx, eax
0076C9B8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C9BD    mov eax, 0x8B8B50
0076C9C2    jmp 0x00761FA6                                  ; => [ Data: data_8b8b50 | Call: __CxxFrameHandler3 ]
