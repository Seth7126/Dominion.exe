...
00703B03    push ecx
00703B04    mov eax, dword ptr ss:[ebp+0x08]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00703B07    push ebx
00703B08    push esi
00703B09    mov ebx, dword ptr ds:[eax+0x350]
00703B0F    mov ecx, dword ptr ds:[ebx]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00703B11    cmp ecx, dword ptr ds:[ebx+0x3F0]
00703B17    jz 0x00703B32
00703B19    push 0x88CE64                                   ; => [ String: OpenGLInterface::GraphicsMaterialSetup ]
00703B1E    push 0x1058
00703B23    push 0x88C504                                   ; => [ String: C:\x\ax2017\Engine\OpenGLGraphics.cpp ]
00703B28    mov ecx, 0x88CEC8                               ; => [ String: pVertexShader->assetShader == pPixelShader->assetShader ]
00703B2D    jmp 0x00703C1A
00703B32    xor edx, edx
00703B34    call 0x006D8ED0                                 ; => [ Call: sub_6d8ed0 ]
...
00703B45    pop ebp
00703B46    ret 0x04
00703B49    mov eax, dword ptr ds:[0x0147DED4]              ; => [ Data: data_147ded4 ]
...
00703BA0    push 0xFE
00703BA5    push eax
00703BA6    call 0x00761FC4                                 ; => [ Data: data_147ded4 | Call: memset ]
...
00703BF9    call 0x00703330                                 ; => [ Call: sub_703330 ]
00703BFE    pop edi
00703BFF    pop esi
...
00703C05    pop ebp
00703C06    ret 0x04
00703C09    push 0x88D514                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayGet ]
00703C0E    push 0x6D
00703C10    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h ]
00703C15    mov ecx, 0x802748                               ; => [ String: DataArrayTryToGet(id) != NULL ]
00703C1A    mov edx, 0x801800
00703C1F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00703C24    add esp, 0x0C
00703C27    call 0x0063BC30
00703C2C    test al, al
00703C2E    jz 0x00703C31                                   ; => [ Call: sub_63bc30 ]
00703C30    int3
00703C31    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
