...
00559448    call 0x00591930
0055944D    mov ebx, dword ptr ds:[esi+ebx*1+0x1524]
00559454    call 0x00573400
...
005594A5    call 0x0063B870
005594AA    add esp, 0x0C
005594AD    call 0x0063BC30
005594B2    test al, al
005594B4    jz 0x005594B7
005594B6    int3
005594B7    call 0x0063BB00
