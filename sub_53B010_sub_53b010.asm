...
0053B01C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0053B037    movlpd qword ptr ss:[esp+0x18], xmm0            ; => [ Call: __builtin_memset ]
...
0053B0A2    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
0053B0BB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0053B0C0    mov esp, ebp
0053B0C2    pop ebp
0053B0C3    ret
0053B0C4    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053B0EA    call 0x00565FF0                                 ; => [ Call: nullptr | Call: sub_565ff0 ]
...
0053B113    call 0x0056F1A0                                 ; => [ Call: sub_56f1a0 ]
...
0053B128    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
