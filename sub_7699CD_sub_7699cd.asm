...
007699DB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007699E0    mov ecx, dword ptr ds:[edx-0x04]
007699E3    xor ecx, eax
007699E5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007699EA    mov eax, 0x8B57EC
007699EF    jmp 0x00761FA6                                  ; => [ Data: data_8b57ec | Call: __CxxFrameHandler3 ]
