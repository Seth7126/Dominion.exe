...
005533A7    mov dword ptr fs:[0x00000000], eax
005533AD    call 0x0056B800
005533B2    push 0xC80
005533B7    mov esi, eax
005533B9    lea eax, ss:[ebp-0xC90]
005533BF    push 0x00
005533C1    push eax
005533C2    call 0x00761FC4
...
00553452    movlpd qword ptr ss:[ebp-0xCB8], xmm0
