...
0055E051    push edi
0055E052    push ecx                                        ; => [ Call: __chkstk ]
0055E053    push 0x00
0055E055    lea ecx, ds:[edx+0x01]
0055E058    call 0x00561E00                                 ; => [ Data: __security_cookie | Call: sub_561e00 ]
0055E05D    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055E062    push 0x00
0055E064    push 0x00
0055E066    push 0x01
...
0055E06E    push 0x01
0055E070    call 0x00590760                                 ; => [ Call: sub_590760 ]
0055E075    add esp, 0x18
0055E078    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055E0AD    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
0055E116    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
0055E118    push 0x12
0055E11A    push eax
0055E11B    mov edx, 0x19
0055E120    lea ecx, ss:[esp+0xD10]
0055E127    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
0055E12C    mov edi, eax
0055E12E    add esp, 0x10
0055E131    test edi, edi
0055E133    jz 0x0055E19B
0055E135    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
0055E13A    mov esi, eax
0055E13C    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055E141    push 0x00
0055E143    push 0x00
0055E145    push 0x00
...
0055E158    push 0x3EA
0055E15D    push edi
0055E15E    call 0x005820C0                                 ; => [ Call: sub_5820c0 | Call: nullptr ]
0055E163    push 0x02
...
0055E193    call 0x0056BBA0                                 ; => [ Call: sub_56bba0 | Call: sub_56f110 ]
0055E198    add esp, 0x34
0055E19B    mov ecx, dword ptr ss:[esp+0x198C]
0055E1A2    pop edi
0055E1A3    pop esi
0055E1A4    xor ecx, esp
0055E1A6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0055E1C5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0055E1CA    add esp, 0x0C
0055E1CD    call 0x0063BC30
0055E1D2    test al, al
0055E1D4    jz 0x0055E1D7                                   ; => [ Call: sub_63bc30 ]
0055E1D6    int3
0055E1D7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
