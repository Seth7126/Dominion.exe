...
00681B40    mov eax, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
00681B45    push ebx
00681B46    push esi
00681B47    push edi
...
00681B59    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
00681B73    mov edi, eax                                    ; => [ Call: sub_687730 ]
00681B75    push 0xF04
00681B7A    push 0x00
...
00681B89    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00681B9E    push eax
00681B9F    call 0x00761FC4                                 ; => [ Call: memset ]
00681BA4    add esp, 0x0C
00681BA7    mov dword ptr ds:[edi], ebx
00681BA9    lea ecx, ds:[edi+0x04]
00681BAC    mov edx, ebx
00681BAE    call 0x006D8660                                 ; => [ Call: sub_6d8660 ]
00681BB3    mov esi, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
00681BB9    mov ecx, 0x0C
00681BBE    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
00681BCF    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00681C2D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SpritePutMaterialInCache | Data: data_801800 | String: gpSpriteAppData->materialBound | String: C:\x\ax2017\Engine\Sprite.cpp ]
00681C32    add esp, 0x0C
00681C35    call 0x0063BC30
00681C3A    test al, al
00681C3C    jz 0x00681C3F                                   ; => [ Call: sub_63bc30 ]
00681C3E    int3
00681C3F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
