...
00634165    push 0x76C135                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_RegisterConcRTEventTracing@details@Concurrency@@YAXXZ ]
0063416A    mov eax, dword ptr fs:[0x00000000]
00634170    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00634171    sub esp, 0x0C
00634174    push esi
00634175    push edi
00634176    mov eax, dword ptr ds:[0x008C4040]
0063417B    xor eax, ebp
0063417D    push eax                                        ; => [ Data: __security_cookie ]
0063417E    lea eax, ss:[ebp-0x0C]
00634181    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00634187    mov esi, edx
00634189    mov edi, ecx
0063418B    push 0xFFFFFFFF
0063418D    push esi
0063418E    mov edx, 0xBF1630
00634193    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_bf1630 ]
00634198    mov edx, dword ptr ss:[ebp+0x08]
0063419B    mov ecx, edi
0063419D    call 0x005D8950                                 ; => [ Call: sub_5d8950 ]
006341A2    push dword ptr ds:[esi+0x04]
006341A5    lea eax, ss:[ebp-0x14]
006341A8    push 0x808880
006341AD    push eax
006341AE    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
006341F1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00634204    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0063421B    push eax
0063421C    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
0063425F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00634272    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00634277    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
