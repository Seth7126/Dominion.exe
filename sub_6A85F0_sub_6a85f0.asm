...
006A8600    call 0x006A82E0                                 ; => [ Call: sub_6a82e0 ]
006A8605    mov esi, eax
006A8607    cmp byte ptr ds:[esi+0x11], 0x00
006A860B    jz 0x006A8646
006A860D    mov ecx, edi
006A860F    call 0x006A82E0                                 ; => [ Call: sub_6a82e0 ]
006A8614    mov esi, eax
006A8616    mov ecx, dword ptr ds:[esi+0x08]
006A8619    call 0x007112E0                                 ; => [ Call: sub_7112e0 ]
006A861E    mov ecx, dword ptr ds:[esi+0x04]
006A8621    call 0x00713890                                 ; => [ Call: sub_713890 ]
006A8626    movzx ecx, word ptr ds:[esi+0x14]
006A862A    mov edx, dword ptr ds:[0x00CAF778]              ; => [ Data: data_caf778 ]
006A8630    mov dword ptr ds:[0x00CAF778], ecx              ; => [ Data: data_caf778 ]
006A8636    mov dword ptr ds:[esi+0x14], edx
006A8639    dec dword ptr ds:[0x00CAF77C]                   ; => [ Data: data_caf77c ]
006A863F    pop edi
006A8640    pop esi
006A8641    pop ebx
...
006A8688    call 0x00711450                                 ; => [ Call: sub_711450 ]
006A868D    mov edx, dword ptr ds:[esi+0x04]
006A8690    mov ecx, dword ptr ds:[esi+0x08]
006A8693    call 0x007117C0                                 ; => [ Call: sub_7117c0 ]
