...
004C7F39    xor ebx, ebx                                    ; => [ Call: nullptr ]
004C7F3B    mov esi, 0x19E57DC                              ; => [ Data: data_19e57dc ]
004C7F40    push edi
...
004C7F57    jnz 0x004C7F7F                                  ; => [ String: tblGames ]
...
004C7F7D    jz 0x004C7FAC                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
004C7F7F    push ebx
004C7F80    mov edx, 0x804368
004C7F85    call 0x0067BE20
004C7F8A    mov edi, eax                                    ; => [ Call: sub_67be20 ]
...
004C7F99    mov dword ptr ds:[esi], 0x804368                ; => [ String: tblGames ]
...
004C8077    add esi, edx                                    ; => [ Data: data_8dc140 ]
...
004C809E    add esi, edx                                    ; => [ Data: data_8dc0bc ]
...
004C811D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004C8122    add esp, 0x0C
004C8125    call 0x0063BC30
004C812A    test al, al
004C812C    jz 0x004C812F                                   ; => [ Call: sub_63bc30 ]
004C812E    int3
004C812F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
