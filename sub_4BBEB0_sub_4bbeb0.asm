...
004BBF8F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BBFB4    pop ebp
004BBFB5    ret                                             ; => [ Call: sub_665db0 | Data: data_8db794 ]
004BBFB6    mov ecx, ebx
004BBFB8    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BBFDD    pop ebp
004BBFDE    ret                                             ; => [ Call: sub_665db0 | Data: data_8db7ac ]
004BBFDF    mov ecx, ebx
004BBFE1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BC006    pop ebp
004BC007    ret                                             ; => [ Data: data_8db7a0 | Call: sub_665db0 ]
004BC008    mov ecx, ebx
004BC00A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BC02F    pop ebp
004BC030    ret                                             ; => [ Call: sub_665db0 | Data: data_8db7b8 ]
004BC031    mov ecx, ebx
004BC033    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BC058    pop ebp
004BC059    ret                                             ; => [ Call: sub_665db0 | Data: data_8db7c4 ]
004BC05A    mov ecx, ebx
004BC05C    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BC081    pop ebp
004BC082    ret                                             ; => [ Call: sub_665db0 | Data: data_8db7d0 ]
004BC083    mov ecx, ebx
004BC085    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BC0AA    pop ebp
004BC0AB    ret                                             ; => [ Call: sub_665db0 | Data: data_8db7dc ]
004BC0AC    push 0x802A48
004BC0B1    push 0x1C1
004BC0B6    push 0x80292C
004BC0BB    mov edx, 0x801800
004BC0C0    mov ecx, 0x801AA4
004BC0C5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GameCreateButtonsUpdate | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: Halt ]
004BC0CA    add esp, 0x0C
004BC0CD    call 0x0063BC30
004BC0D2    test al, al
004BC0D4    jz 0x004BC0D7                                   ; => [ Call: sub_63bc30 ]
004BC0D6    int3
004BC0D7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
