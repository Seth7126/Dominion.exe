...
004D6A25    push 0x7631ED                                   ; => [ Call: __ehhandler$??2@YAPAXIABUnothrow_t@std@@@Z | Type: EHRegistrationNode ]
004D6A2A    mov eax, dword ptr fs:[0x00000000]
004D6A30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D6A3E    push eax                                        ; => [ Data: __security_cookie ]
004D6A3F    lea eax, ss:[ebp-0x0C]
004D6A42    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D6A48    mov edi, dword ptr ds:[0x00CC8DC0]
004D6A4E    test edi, edi
004D6A50    jz 0x004D6B17                                   ; => [ Data: data_cc8dc0 ]
004D6A56    call 0x0063C090
004D6A5B    push eax                                        ; => [ Call: sub_63c090 ]
004D6A5C    lea eax, ss:[ebp-0x10]
004D6A5F    push 0x80676C
004D6A64    push eax
004D6A65    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %slocalsettings.xml ]
004D6A6A    add esp, 0x0C
004D6A6D    mov dword ptr ss:[ebp-0x04], 0x00
004D6A74    mov esi, dword ptr ds:[0x01597D80]              ; => [ Data: data_1597d80 ]
004D6A7A    call 0x006A2FA0                                 ; => [ Call: sub_6a2fa0 ]
004D6A7F    mov ebx, eax
004D6A81    mov edx, edi
004D6A83    push 0x00
004D6A85    push esi
004D6A86    mov ecx, ebx
004D6A88    call 0x006A6290                                 ; => [ Call: nullptr | Call: sub_6a6290 ]
004D6A8D    mov ecx, dword ptr ss:[ebp-0x10]
004D6A90    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004D6A95    test ecx, ecx
004D6A97    mov edx, esi                                    ; => [ Data: data_801800 ]
...
004D6AED    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D6B00    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D6B05    mov ecx, dword ptr ss:[ebp-0x0C]
004D6B08    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D6B0F    pop ecx
004D6B10    pop edi
004D6B11    pop esi
004D6B12    pop ebx
...
004D6B30    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetLocalSettings | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp | Data: data_801800 | String: gGameSettings.localSettings ]
004D6B35    add esp, 0x0C
004D6B38    call 0x0063BC30
004D6B3D    test al, al
004D6B3F    jz 0x004D6B42                                   ; => [ Call: sub_63bc30 ]
004D6B41    int3
004D6B42    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
