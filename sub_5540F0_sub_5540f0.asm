...
005540F5    push 0x76641B                                   ; => [ Call: sub_76641b | Type: EHRegistrationNode ]
005540FA    mov eax, dword ptr fs:[0x00000000]
00554100    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00554101    mov eax, 0x25CC
00554106    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055410B    mov eax, dword ptr ds:[0x008C4040]
00554110    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0055411C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00554148    rep movsd                                       ; => [ Call: __builtin_memcpy | Data: data_7bfa58 | Call: sub_566240 ]
0055414A    call 0x00573400
0055414F    mov eax, dword ptr ds:[eax+0x04]
00554152    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
00554176    push 0x00
00554178    push 0x00
0055417A    push 0x00                                       ; => [ Call: __builtin_memset ]
0055417C    push 0x01
0055417E    cmp eax, 0x02
00554181    mov edx, 0x07
00554186    push 0x00                                       ; => [ Call: nullptr ]
00554188    push 0xFFFFFFFF
0055418A    setz cl
0055418D    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
00554192    add esp, 0x2C
00554195    lea eax, ss:[ebp-0x1950]
0055419B    mov dword ptr ss:[ebp-0x1950], 0x81D378         ; => [ Data: std::_Func_impl_no_alloc<class <lambda_25803763f7320df8f0796c2bb8bf8806>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_25803763f7320df8f0796c2bb8bf8806>,bool,enum CardID>::VTable ]
005541A5    mov dword ptr ss:[ebp-0x192C], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_25803763f7320df8f0796c2bb8bf8806>,bool,enum CardID>::VTable ]
...
00554225    push eax
00554226    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00554229    mov dword ptr ss:[ebp-0x192C], 0x00
00554233    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00554275    call 0x00569330                                 ; => [ Call: sub_569330 | Call: sub_582eb0 | Call: nullptr ]
0055427A    add esp, 0x2C
0055427D    mov ecx, dword ptr ss:[ebp-0x0C]
00554280    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00554287    pop ecx
00554288    pop edi
00554289    pop esi
0055428A    pop ebx
...
00554290    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
