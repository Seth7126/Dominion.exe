...
004B8E49    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004B8E63    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B8E7D    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004B8EED    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004B8EF2    add esp, 0x0C
004B8EF5    call 0x0063BC30
004B8EFA    test al, al
004B8EFC    jz 0x004B8EFF                                   ; => [ Call: sub_63bc30 ]
004B8EFE    int3
004B8EFF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
