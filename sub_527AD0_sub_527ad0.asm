...
00527AF2    mov dword ptr fs:[0x00000000], eax
00527AF8    lea eax, ss:[ebp-0x70]
00527AFB    mov dword ptr ss:[ebp-0x70], 0x8184E4
00527B02    mov dword ptr ss:[ebp-0x4C], eax
00527B05    lea eax, ss:[ebp-0x40]
00527B08    mov dword ptr ss:[ebp-0x48], 0x4A
00527B0F    mov dword ptr ss:[ebp-0x44], 0x00
00527B16    mov dword ptr ss:[ebp-0x40], 0x8184C8
00527B1D    mov dword ptr ss:[ebp-0x1C], eax
