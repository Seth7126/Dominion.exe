...
004E5925    push 0x764535                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??1_TaskCollection@details@Concurrency@@QAE@XZ ]
004E592A    mov eax, dword ptr fs:[0x00000000]
004E5930    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E5931    sub esp, 0x10
004E5934    push esi
004E5935    push edi
004E5936    mov eax, dword ptr ds:[0x008C4040]
004E593B    xor eax, ebp
004E593D    push eax                                        ; => [ Data: __security_cookie ]
004E593E    lea eax, ss:[ebp-0x0C]
004E5941    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E595F    call 0x0063D850                                 ; => [ Call: sub_4dfb20 | Call: sub_63d850 ]
004E5964    mov dword ptr ss:[ebp-0x04], 0x01
004E596B    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5972    jz 0x004E599B                                   ; => [ Data: data_cf65bc ]
...
004E5983    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5996    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E59B2    call 0x004E5370                                 ; => [ Call: sub_4e5370 ]
...
004E59CF    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
004E59F3    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: -k %s -x %s | Call: sub_63d850 ]
004E59F8    mov byte ptr ss:[ebp-0x04], 0x04
004E59FC    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5A03    jz 0x004E5A74                                   ; => [ Data: data_cf65bc ]
...
004E5A18    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
004E5A3B    call 0x0063D850                                 ; => [ String: -k %s | Call: sub_63df30 | Call: sub_63d850 ]
004E5A40    mov byte ptr ss:[ebp-0x04], 0x06
004E5A44    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5A4B    jz 0x004E5A74                                   ; => [ Data: data_cf65bc ]
...
004E5A5C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5A93    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5AA6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5AAB    mov ecx, dword ptr ss:[ebp-0x0C]
004E5AAE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E5AB5    pop ecx
004E5AB6    pop edi
004E5AB7    pop esi
