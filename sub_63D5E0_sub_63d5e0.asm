...
0063D5E5    push 0x7631ED                                   ; => [ Call: __ehhandler$??2@YAPAXIABUnothrow_t@std@@@Z | Type: EHRegistrationNode ]
0063D5EA    mov eax, dword ptr fs:[0x00000000]
0063D5F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0063D5FE    push eax                                        ; => [ Data: __security_cookie ]
0063D5FF    lea eax, ss:[ebp-0x0C]
0063D602    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0063D61F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063D63E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063D645    pop ecx
0063D646    pop edi
0063D647    pop esi
0063D648    pop ebx
...
0063D683    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063D696    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063D69B    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
0063D6A1    mov edx, ebx
0063D6A3    mov ecx, edi
0063D6A5    call 0x0063D540                                 ; => [ Call: sub_63d540 ]
...
0063D6B6    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0063D6D5    jz 0x0063D709                                   ; => [ Data: data_cf65bc ]
0063D6D7    lea ecx, ss:[ebp-0x10]
0063D6DA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063D6ED    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063D6F2    mov ecx, dword ptr ss:[ebp-0x0C]
0063D6F5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063D6FC    pop ecx
0063D6FD    pop edi
0063D6FE    pop esi
0063D6FF    pop ebx
...
0063D702    pop ebp
0063D703    ret
0063D704    call 0x0063D540                                 ; => [ Call: sub_63d540 ]
0063D709    mov ecx, dword ptr ss:[ebp-0x0C]
0063D70C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063D713    pop ecx
0063D714    pop edi
0063D715    pop esi
0063D716    pop ebx
