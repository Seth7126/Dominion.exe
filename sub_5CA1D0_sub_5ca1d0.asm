...
005CA1D6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005CA23C    mov dword ptr ds:[ebx*4+0x1839FB0], 0x00        ; => [ Data: data_1839fb0 ]
005CA247    add eax, edx
005CA249    mov dword ptr ds:[ebx*4+0x1839FE0], edi         ; => [ Data: data_1839fe0 ]
005CA250    sar eax, 0x02
005CA253    mov dword ptr ss:[ebp+ebx*4-0x1C], eax
005CA257    xor eax, eax                                    ; => [ Call: nullptr ]
...
005CA277    mov dword ptr ds:[ebx*4+0x1839FE0], edi         ; => [ Data: data_1839fe0 ]
...
005CA2AB    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
005CA2BC    movups xmmword ptr ds:[0x01839FC8], xmm0        ; => [ Data: data_1839fc8 ]
005CA2C3    movq xmm0, qword ptr ss:[ebp-0x0C]
005CA2C8    pop edi
005CA2C9    pop esi
005CA2CA    movq qword ptr ds:[0x01839FD8], xmm0            ; => [ Data: data_1839fd8 ]
005CA2D2    pop ebx
005CA2D3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005CA2D8    mov esp, ebp
005CA2DA    pop ebp
005CA2DB    ret
005CA2DC    push 0x805B2C                                   ; => [ String: LogGet ]
005CA2E1    push 0x3B
005CA2E3    mov ecx, 0x805B6C                               ; => [ String: who < save.setup.numPlayers ]
005CA2E8    jmp 0x005CA304
005CA2EA    push 0x805B2C                                   ; => [ String: LogGet ]
005CA2EF    push 0x3A
005CA2F1    mov ecx, 0x805B40                               ; => [ String: save.setup.numPlayers <= MAX_PLAYERS_LATEST ]
005CA2F6    jmp 0x005CA304
005CA2F8    push 0x805B2C                                   ; => [ String: LogGet ]
005CA2FD    push 0x39
005CA2FF    mov ecx, 0x805B34                               ; => [ String: who >= 0 ]
005CA304    push 0x805AF8
005CA309    mov edx, 0x801800
005CA30E    call 0x0063B870                                 ; => [ String: LogGet | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSave.cpp ]
005CA313    add esp, 0x0C
005CA316    call 0x0063BC30
005CA31B    test al, al
005CA31D    jz 0x005CA320                                   ; => [ Call: sub_63bc30 ]
005CA31F    int3
005CA320    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
