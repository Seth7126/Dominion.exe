...
0074D1B9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0074D1CC    push esi
0074D1CD    mov esi, dword ptr ds:[eax+0x24]                ; => [ Data: data_19e2778 ]
0074D1D0    push edi
...
0074D1FC    push eax
0074D1FD    call dword ptr ds:[0x007753A4]                  ; => [ Call: nullptr ]
0074D203    lea eax, ss:[ebp-0x124]
0074D209    push eax
0074D20A    push edi
0074D20B    call dword ptr ds:[0x007753C4]                  ; => [ Type: RECT ]
0074D211    add dword ptr ss:[ebp-0x124], 0x10              ; => [ Field: left ]
0074D218    lea eax, ss:[ebp-0x124]
0074D21E    sub dword ptr ss:[ebp-0x11C], 0x0A              ; => [ Field: right ]
0074D225    push eax
0074D226    call dword ptr ds:[0x007753CC]
0074D22C    lea eax, ss:[ebp-0x134]
0074D232    push eax
0074D233    push edi
0074D234    call dword ptr ds:[0x007753C0]                  ; => [ Type: RECT ]
0074D23A    mov eax, dword ptr ds:[0x019E2778]
0074D23F    push edi
0074D240    mov dword ptr ds:[eax+0x40], 0x01               ; => [ Data: data_19e2778 ]
0074D247    mov ecx, dword ptr ds:[0x019E2778]
0074D24D    mov eax, dword ptr ss:[ebp-0x130]
0074D253    mov dword ptr ds:[ecx+0x4C], eax                ; => [ Data: data_19e2778 | Field: top ]
0074D256    mov ecx, dword ptr ds:[0x019E2778]
0074D25C    mov eax, dword ptr ss:[ebp-0x128]
0074D262    mov dword ptr ds:[ecx+0x50], eax                ; => [ Data: data_19e2778 | Field: bottom ]
0074D265    mov eax, dword ptr ds:[0x019E2778]
0074D26A    mov dword ptr ds:[eax+0x44], ebx                ; => [ Data: data_19e2778 ]
0074D26D    call dword ptr ds:[0x00775414]                  ; => [ Type: HDC ]
0074D273    mov ebx, dword ptr ss:[ebp-0x128]               ; => [ Field: bottom ]
0074D279    mov esi, dword ptr ss:[ebp-0x130]               ; => [ Field: top ]
0074D27F    push 0x06
0074D281    push eax
...
0074D29C    push esi
0074D29D    call dword ptr ds:[0x0077507C]                  ; => [ Call: nullptr ]
0074D2A3    push ebx
...
0074D2CA    mov esi, dword ptr ds:[esi+0x04]                ; => [ Data: data_19e2778 ]
...
0074D2E0    push 0x00
0074D2E2    push eax
0074D2E3    call 0x00761FC4                                 ; => [ Call: memset ]
...
0074D314    push ebx
0074D315    mov dword ptr ds:[esi+0x08], 0x88FF00           ; => [ Data: data_88ff00 ]
0074D31C    call dword ptr ds:[0x00775384]                  ; => [ Type: HWND ]
0074D322    pop edi
0074D323    pop esi
0074D324    pop ebx
0074D325    mov ecx, dword ptr ss:[ebp-0x08]
0074D328    xor ecx, ebp
0074D32A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074D47C    push edx
0074D47D    push esi
0074D47E    call 0x00761FBE                                 ; => [ Call: memcpy ]
0074D483    add esp, 0x0C
0074D486    mov eax, dword ptr ds:[0x019E2778]
0074D48B    push 0x00
0074D48D    mov eax, dword ptr ds:[eax+0x04]
0074D490    mov dword ptr ds:[eax+0x10], esi                ; => [ Data: data_19e2778 ]
0074D493    mov eax, dword ptr ds:[0x019E2778]
0074D498    push dword ptr ds:[eax+0x1C]
0074D49B    call dword ptr ds:[0x007752BC]                  ; => [ Data: data_19e2778 ]
0074D4A1    push ebx
0074D4A2    call dword ptr ds:[0x00775384]                  ; => [ Type: HWND ]
0074D4A8    pop edi
0074D4A9    pop esi
0074D4AA    pop ebx
0074D4AB    mov ecx, dword ptr ss:[ebp-0x08]
0074D4AE    xor ecx, ebp
0074D4B0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074D4E0    push 0x199
0074D4E5    push edi
0074D4E6    call esi                                        ; => [ Type: LRESULT ]
...
0074D4F9    call 0x0074CE10                                 ; => [ Call: sub_74ce10 ]
0074D4FE    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074D511    pop ebx
0074D512    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
