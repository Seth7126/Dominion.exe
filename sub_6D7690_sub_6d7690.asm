...
006D7693    push ecx
006D7694    push ebx
006D7695    mov ebx, dword ptr ds:[0x00CAFE8C]              ; => [ Data: data_cafe8c ]
006D769B    xor eax, eax                                    ; => [ Call: nullptr ]
006D769D    push esi
006D769E    push edi
006D769F    mov edi, dword ptr ds:[0x00CAFE90]              ; => [ Data: data_cafe90 ]
...
006D76E7    mov eax, dword ptr ds:[0x00CAFE9C]              ; => [ Data: data_cafe9c ]
006D76EC    cmp eax, dword ptr ds:[0x00CAFE94]
006D76F2    jb 0x006D7715                                   ; => [ Data: data_cafe94 ]
006D76F4    push 0x87F9EC                                   ; => [ String: DataArray<struct MaterialCacheItem>::DataArrayAlloc ]
006D76F9    push 0xF4
006D76FE    mov ecx, 0x8019B8                               ; => [ String: mUsedCount < mMaxSize ]
...
006D7713    pop ebp
006D7714    ret
006D7715    mov eax, dword ptr ds:[0x00CAFE98]              ; => [ Data: data_cafe98 ]
006D771A    cmp eax, edi
006D771C    jnbe 0x006D779A
006D771E    jnz 0x006D772A
006D7720    lea eax, ds:[edi+0x01]
006D7723    mov dword ptr ds:[0x00CAFE90], eax              ; => [ Data: data_cafe90 ]
...
006D773F    push 0xF0C
006D7744    push 0x00
006D7746    mov dword ptr ds:[0x00CAFE98], eax              ; => [ Data: data_cafe98 ]
006D774B    add esi, ebx
006D774D    push esi
006D774E    call 0x00761FC4                                 ; => [ Call: memset ]
006D7753    mov eax, dword ptr ds:[0x00CAFEA0]
006D7758    add esp, 0x0C
006D775B    shl eax, 0x10
006D775E    or eax, edi
006D7760    mov dword ptr ds:[esi+0xF0C], eax               ; => [ Data: data_cafea0 ]
006D7766    mov eax, dword ptr ds:[0x00CAFEA0]
006D776B    inc eax                                         ; => [ Data: data_cafea0 ]
006D776C    mov dword ptr ds:[0x00CAFEA0], eax              ; => [ Data: data_cafea0 ]
006D7771    cmp eax, 0x10000
006D7776    jnz 0x006D7782
006D7778    mov dword ptr ds:[0x00CAFEA0], 0x01             ; => [ Data: data_cafea0 ]
006D7782    inc dword ptr ds:[0x00CAFE9C]                   ; => [ Data: data_cafe9c ]
...
006D7798    pop ebp
006D7799    ret
006D779A    push 0x87F9EC                                   ; => [ String: DataArray<struct MaterialCacheItem>::DataArrayAlloc ]
006D779F    push 0xF5
006D77A4    mov ecx, 0x8019D0                               ; => [ String: mFreeListHead <= mMaxUsedCount ]
006D77A9    push 0x80193C
006D77AE    mov edx, 0x801800
006D77B3    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: DataArray<struct MaterialCacheItem>::DataArrayAlloc | String: C:\x\ax2017\Engine\DataArray.h ]
006D77B8    add esp, 0x0C
006D77BB    call 0x0063BC30
006D77C0    test al, al
006D77C2    jz 0x006D77C5                                   ; => [ Call: sub_63bc30 ]
006D77C4    int3
006D77C5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
