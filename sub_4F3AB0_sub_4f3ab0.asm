...
004F3ACC    push 0x808D90                                   ; => [ String: ValidateNode ]
004F3AD1    push 0x144E
004F3AD6    mov ecx, 0x808DA0                               ; => [ String: node->choice == yld.choice ]
...
004F3AE8    push 0x808D90                                   ; => [ String: ValidateNode ]
004F3AED    push 0x144F
004F3AF2    mov ecx, 0x808DBC                               ; => [ String: node->aiHint == yld.aiHint ]
004F3AF7    jmp 0x004F3B3E
004F3AF9    mov ebx, dword ptr ds:[esi+0xD4]
004F3AFF    push edi
004F3B00    call 0x004F22D0                                 ; => [ Call: sub_4f22d0 ]
...
004F3B15    push edi
004F3B16    call 0x004F22D0                                 ; => [ Call: sub_4f22d0 ]
...
004F3B2D    pop ebp
004F3B2E    ret
004F3B2F    push 0x808D90                                   ; => [ String: ValidateNode ]
004F3B34    push 0x145A
004F3B39    mov ecx, 0x808DD8                               ; => [ String: n == node->numEdges ]
004F3B3E    push 0x8088A8
004F3B43    mov edx, 0x801800
004F3B48    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: ValidateNode | String: C:\x\ax2017\Jams\Dominion\code\DomAIMCTS.cpp ]
004F3B4D    add esp, 0x0C
004F3B50    call 0x0063BC30
004F3B55    test al, al
004F3B57    jz 0x004F3B5A                                   ; => [ Call: sub_63bc30 ]
004F3B59    int3
004F3B5A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
