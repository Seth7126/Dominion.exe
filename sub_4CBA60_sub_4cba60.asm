...
004CBA65    push 0x7632C0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$common_find_first_narrow@U_wfinddata32_t@@U_finddata32_t@@@@YAHQBDQAU_finddata32_t@@I@Z ]
004CBA6A    mov eax, dword ptr fs:[0x00000000]
004CBA70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004CBA82    push esi
004CBA83    push edi
004CBA84    push eax                                        ; => [ Data: __security_cookie ]
004CBA85    lea eax, ss:[ebp-0x0C]
004CBA88    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004CBA8E    mov edi, dword ptr ss:[ebp+0x08]
004CBA91    mov ecx, edi
004CBA93    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CBA98    mov ecx, dword ptr ds:[0x00CC8D80]              ; => [ Data: data_cc8d80 ]
004CBA9E    lea edx, ss:[ebp-0x250]
004CBAA4    mov dword ptr ds:[eax+0x18BC], 0x4C9F00         ; => [ Call: sub_4c9f00 ]
004CBAAE    call 0x00571BC0
004CBAB3    mov edx, eax                                    ; => [ Call: sub_571bc0 ]
004CBAB5    xor esi, esi                                    ; => [ Call: nullptr ]
...
004CBAEC    jz 0x004CBB02                                   ; => [ Data: data_780878 ]
004CBAEE    add eax, 0x10C
004CBAF3    inc ecx
004CBAF4    cmp eax, 0x28D4
004CBAF9    jb 0x004CBAE2
004CBAFB    mov ecx, 0x780878                               ; => [ Data: data_780878 ]
004CBB00    jmp 0x004CBB0E
004CBB02    imul ecx, ecx, 0x10C
004CBB08    add ecx, 0x780878                               ; => [ Data: data_780878 ]
004CBB0E    lea edx, ss:[ebp-0x248]
004CBB14    call 0x004BE540                                 ; => [ Call: sub_4be540 ]
004CBB19    cmp dword ptr ss:[ebp-0x23C], 0x01
004CBB20    mov ecx, dword ptr ds:[0x00CC8D80]              ; => [ Data: data_cc8d80 ]
004CBB26    mov ebx, dword ptr ds:[0x00CC8D8C]              ; => [ Data: data_cc8d8c ]
...
004CBC0E    push eax
004CBC0F    call 0x004CABD0                                 ; => [ Call: sub_4cabd0 ]
004CBC14    push 0xFFFFFFFF
004CBC16    push eax
004CBC17    mov edx, 0x8DC350
004CBC1C    mov ecx, edi
004CBC1E    call 0x00666120                                 ; => [ Data: data_8dc350 | Call: sub_666120 ]
004CBC23    mov eax, dword ptr ds:[0x00CC8D80]              ; => [ Data: data_cc8d80 ]
...
004CBE31    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CBEC2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004CBEE4    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: StoreUpdate | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: Halt ]
004CBEE9    add esp, 0x0C
004CBEEC    call 0x0063BC30
004CBEF1    test al, al
004CBEF3    jz 0x004CBEF6                                   ; => [ Call: sub_63bc30 ]
004CBEF5    int3
004CBEF6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
