...
0068E115    push 0x76E47B                                   ; => [ Call: sub_76e47b | Type: EHRegistrationNode ]
0068E11A    mov eax, dword ptr fs:[0x00000000]
0068E120    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068E12E    push eax                                        ; => [ Data: __security_cookie ]
0068E12F    lea eax, ss:[ebp-0x0C]
0068E132    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0068E138    mov edi, edx
0068E13A    mov ebx, ecx
0068E13C    mov dword ptr ss:[ebp-0x1C], ebx
0068E13F    mov dword ptr ss:[ebp-0x14], 0x00
0068E146    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0068E14D    mov dword ptr ss:[ebp-0x04], 0x01
0068E154    xor esi, esi
0068E156    mov dword ptr ss:[ebp-0x30], 0x871B58           ; => [ Data: data_871b58 ]
0068E15D    mov dword ptr ss:[ebp-0x2C], 0x824DB0           ; => [ Data: data_824db0 ]
0068E164    mov dword ptr ss:[ebp-0x28], 0x877F58           ; => [ Data: data_877f58 ]
0068E16B    mov dword ptr ss:[ebp-0x24], 0x877E34           ; => [ Data: data_877e34 ]
0068E172    mov dword ptr ss:[ebp-0x20], 0x877F54           ; => [ Data: data_877f54 ]
...
0068E192    test al, al
0068E194    jnz 0x0068E486                                  ; => [ Call: sub_68cbb0 ]
0068E19A    inc esi
0068E19B    cmp esi, 0x05
0068E19E    jl 0x0068E180
0068E1A0    mov dword ptr ss:[ebp-0x28], 0x85E314           ; => [ Data: data_85e314 ]
0068E1A7    xor esi, esi
0068E1A9    mov dword ptr ss:[ebp-0x24], 0x824DB4           ; => [ Data: data_824db4 ]
0068E1B0    mov dword ptr ss:[ebp-0x20], 0x877F60           ; => [ Data: data_877f60 ]
...
0068E1C9    test al, al
0068E1CB    jnz 0x0068E3F7                                  ; => [ Call: sub_68cbb0 ]
0068E1D1    inc esi
0068E1D2    cmp esi, 0x03
0068E1D5    jl 0x0068E1B7
0068E1D7    mov dword ptr ss:[ebp-0x18], 0x877DC0           ; => [ String: {[p\rnm ]
...
0068E1F2    test al, al
0068E1F4    jnz 0x0068E367                                  ; => [ Call: sub_68cbb0 ]
0068E1FA    inc esi
0068E1FB    cmp esi, 0x01
0068E1FE    jl 0x0068E1E0
0068E200    mov dword ptr ss:[ebp-0x18], 0x877F68           ; => [ Data: data_877f68 ]
...
0068E296    jz 0x0068E2B3                                   ; => [ Data: data_cf65bc ]
0068E298    lea ecx, ss:[ebp-0x18]
0068E29B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068E326    jz 0x0068E343                                   ; => [ Data: data_cf65bc ]
0068E328    lea ecx, ss:[ebp-0x18]
0068E32B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068E36F    call 0x0063D720                                 ; => [ String: ns | Call: sub_63d720 ]
...
0068E3CE    jz 0x0068E3EB                                   ; => [ Data: data_cf65bc ]
0068E3D0    lea ecx, ss:[ebp-0x18]
0068E3D3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068E45D    jz 0x0068E47A                                   ; => [ Data: data_cf65bc ]
0068E45F    lea ecx, ss:[ebp-0x18]
0068E462    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068E4EC    jz 0x0068E509                                   ; => [ Data: data_cf65bc ]
0068E4EE    lea ecx, ss:[ebp-0x18]
0068E4F1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068E528    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068E53B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068E540    mov eax, ebx
0068E542    mov ecx, dword ptr ss:[ebp-0x0C]
0068E545    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068E54C    pop ecx
0068E54D    pop edi
0068E54E    pop esi
0068E54F    pop ebx
