...
006AEF45    push 0x76FC15                                   ; => [ Call: sub_76fc15 | Type: EHRegistrationNode ]
006AEF4A    mov eax, dword ptr fs:[0x00000000]
006AEF50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006AEF5E    push eax                                        ; => [ Data: __security_cookie ]
006AEF5F    lea eax, ss:[ebp-0x0C]
006AEF62    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006AEF73    call 0x006B2EC0                                 ; => [ Call: sub_6b2ec0 ]
006AEF78    mov ebx, eax
006AEF7A    cmp dword ptr ds:[ebx], 0x02
006AEF7D    jz 0x006AEF98
006AEF7F    push 0x87BC94                                   ; => [ String: Dx11GraphicsInterface::UnlockTextureBuffer ]
006AEF84    push 0x2D8
006AEF89    push 0x87B990                                   ; => [ String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp ]
006AEF8E    mov ecx, 0x87BC18                               ; => [ String: bufferData->mBufferType == DX11BUFFER_TEXTURE ]
...
006AEFA9    call 0x0069FD50                                 ; => [ String: !Null\Null | Call: sub_69fd50 ]
...
006AEFEA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AEFFD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AF002    mov dword ptr ss:[ebp+0x0C], 0x801800           ; => [ Data: data_801800 ]
...
006AF02C    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006AF06D    call 0x006A9570                                 ; => [ Call: sub_6a9570 ]
...
006AF08C    push 0x87BC94                                   ; => [ String: Dx11GraphicsInterface::UnlockTextureBuffer ]
006AF091    push 0x2E6
006AF096    mov ecx, 0x87BD08                               ; => [ String: depth == 0 ]
...
006AF129    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AF130    pop ecx
006AF131    pop edi
006AF132    pop esi
006AF133    pop ebx
...
006AF136    pop ebp
006AF137    ret 0x10
006AF13A    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
006AF13F    push 0x19
006AF141    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
006AF146    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
006AF14B    mov edx, 0x801800
006AF150    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006AF155    add esp, 0x0C
006AF158    call 0x0063BC30
006AF15D    test al, al
006AF15F    jz 0x006AF162                                   ; => [ Call: sub_63bc30 ]
006AF161    int3
006AF162    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006AF167    cmp ecx, 0x02
006AF16A    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006AF16F    push 0x87BC94                                   ; => [ String: Dx11GraphicsInterface::UnlockTextureBuffer ]
...
006AF18C    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: Dx11GraphicsInterface::UnlockTextureBuffer ]
006AF191    add esp, 0x0C
006AF194    call 0x0063BC30
006AF199    test al, al
006AF19B    jz 0x006AF19E                                   ; => [ Call: sub_63bc30 ]
006AF19D    int3
006AF19E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
