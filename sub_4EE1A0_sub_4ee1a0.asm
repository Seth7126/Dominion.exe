...
004EE1C8    mov edx, dword ptr ds:[ecx*4+0x1938E70]         ; => [ Data: data_1938e70 ]
...
004EE1E7    call 0x004F7F30                                 ; => [ String: Couldn't lookup %d\n | Call: sub_4f7f30 ]
004EE1EC    add esp, 0x08
004EE1EF    xor edx, edx                                    ; => [ Call: nullptr ]
...
004EE240    mov dword ptr ds:[eax*4+0x19CA9D0], edi         ; => [ Data: data_19ca9d0 ]
004EE247    lea eax, ds:[ebx+0x01]
004EE24A    mov dword ptr ds:[ecx*4+0x19E1708], eax         ; => [ Data: data_19e1708 ]
004EE251    jmp 0x004EE2A8
004EE253    lea eax, ds:[ecx+ecx*2]
004EE256    lea ebx, ds:[ebx+eax*2]
004EE259    mov eax, dword ptr ds:[ebx*4+0x19E1450]         ; => [ Data: data_19e1450 ]
...
004EE26F    add ecx, 0x1942AD0                              ; => [ Data: data_1942ad0 ]
...
004EE293    add eax, dword ptr ds:[ebx*4+0x19E1450]         ; => [ Data: data_19e1450 ]
004EE29A    inc dword ptr ds:[ebx*4+0x19E1450]              ; => [ Data: data_19e1450 ]
004EE2A1    mov dword ptr ds:[eax*4+0x1942AD0], edi         ; => [ Data: data_1942ad0 ]
