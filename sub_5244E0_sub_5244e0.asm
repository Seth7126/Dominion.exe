...
005244F4    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
005244F9    call 0x00573400                                 ; => [ Call: sub_573400 ]
005244FE    push 0x00
00524500    push 0x00
00524502    push 0x01
...
0052450A    push 0x01
0052450C    call 0x00590760                                 ; => [ Call: sub_590760 ]
00524511    add esp, 0x18
00524514    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00524536    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052453B    push 0x00
0052453D    mov edx, dword ptr ds:[eax+0x0C]
00524540    mov ecx, dword ptr ds:[eax+0x04]
00524543    call 0x005887C0                                 ; => [ Call: sub_5887c0 ]
...
00524589    test al, al
0052458B    jnz 0x00524632                                  ; => [ Call: sub_5754f0 ]
00524591    call 0x00573400                                 ; => [ Call: sub_573400 ]
00524596    mov ebx, dword ptr ds:[eax+0x04]
00524599    cmp esi, 0x320
0052459F    jb 0x005245A6
005245A1    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005245BE    test al, al
005245C0    jnz 0x00524632                                  ; => [ Call: sub_5754f0 ]
005245C2    call 0x00573400                                 ; => [ Call: sub_573400 ]
005245C7    mov ebx, dword ptr ds:[eax+0x04]
005245CA    cmp esi, 0x320
005245D0    jb 0x005245D7
005245D2    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005245EC    test al, al
005245EE    jnz 0x00524632                                  ; => [ Call: sub_5754f0 ]
005245F0    call 0x00573400                                 ; => [ Call: sub_573400 ]
005245F5    mov ebx, dword ptr ds:[eax+0x04]
005245F8    cmp esi, 0x320
005245FE    jb 0x00524605
00524600    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052461D    test al, al
0052461F    jnz 0x00524632                                  ; => [ Call: sub_5754f0 ]
...
00524630    pop ebp
00524631    ret                                             ; => [ Call: sub_566890 ]
00524632    xor ecx, ecx
00524634    call 0x00566890                                 ; => [ Call: sub_566890 ]
...
0052464B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00524661    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052469F    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
005246A4    add esp, 0x38
005246A7    mov ecx, 0x01
005246AC    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
005246B1    pop edi
005246B2    pop esi
005246B3    pop ebx
...
005246CE    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
005246D3    add esp, 0x0C
005246D6    call 0x0063BC30
005246DB    test al, al
005246DD    jz 0x005246E0                                   ; => [ Call: sub_63bc30 ]
005246DF    int3
005246E0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
