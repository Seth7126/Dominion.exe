...
006C5DF5    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
006C5DFA    mov eax, dword ptr fs:[0x00000000]
006C5E00    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C5E01    sub esp, 0x08
006C5E04    push esi
006C5E05    push edi
006C5E06    mov eax, dword ptr ds:[0x008C4040]
006C5E0B    xor eax, ebp                                    ; => [ Data: __security_cookie ]
006C5E0D    push eax
006C5E0E    lea eax, ss:[ebp-0x0C]
006C5E11    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C5E3C    push 0x87E1A8                                   ; => [ String: DefinitionLoadPackAsset ]
006C5E41    push 0x264
006C5E46    push 0x87DF78                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.cpp ]
006C5E4B    mov ecx, 0x87E184                               ; => [ String: assetPtr->xbinFilePath.IsEmpty() ]
006C5E50    jmp 0x006C5FA2
006C5E55    mov eax, dword ptr ds:[esi+0x20]
006C5E58    lea ecx, ss:[ebp-0x10]
006C5E5B    test eax, eax
006C5E5D    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006C5E62    cmovnz edx, eax
006C5E65    call 0x006C48E0
006C5E6A    push eax
006C5E6B    mov ecx, edi
006C5E6D    mov dword ptr ss:[ebp-0x04], 0x00
006C5E74    call 0x0063D850                                 ; => [ Call: sub_6c48e0 | Call: sub_63d850 ]
006C5E79    mov dword ptr ss:[ebp-0x04], 0x01
006C5E80    cmp dword ptr ds:[0x00CF65BC], 0x00
006C5E87    jz 0x006C5EB7                                   ; => [ Data: data_cf65bc ]
...
006C5E98    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5EAB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5EB0    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C5EB7    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006C5EBE    mov edx, esi
006C5EC0    lea ecx, ss:[ebp-0x14]
006C5EC3    call 0x00696510                                 ; => [ Call: sub_696510 ]
006C5EC8    test al, al
...
006C5EDE    jz 0x006C5F14                                   ; => [ Data: data_801800 ]
006C5EE0    cmp dword ptr ds:[0x00CF65BC], 0x00
006C5EE7    jz 0x006C5F0E
006C5EE9    cmp byte ptr ds:[eax], 0x00
006C5EEC    jz 0x006C5F0E                                   ; => [ Data: data_cf65bc ]
006C5EEE    mov ecx, edi
006C5EF0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5F03    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5F08    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
006C5F0E    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
006C5F14    xor al, al
006C5F16    mov ecx, dword ptr ss:[ebp-0x0C]
006C5F19    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C5F20    pop ecx
006C5F21    pop edi
006C5F22    pop esi
...
006C5F36    mov eax, dword ptr ds:[0x0147B07C]              ; => [ Data: data_147b07c ]
...
006C5F4C    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006C5F63    push 0x87E1A8                                   ; => [ String: DefinitionLoadPackAsset ]
006C5F68    push 0x279
006C5F6D    push 0x87DF78                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.cpp ]
006C5F72    mov ecx, 0x87E1F8                               ; => [ String: assetPtr->pAssetData == NULL ]
006C5F77    jmp 0x006C5FA2
006C5F79    mov dword ptr ds:[esi], edi
006C5F7B    mov al, 0x01
006C5F7D    mov ecx, dword ptr ss:[ebp-0x0C]
006C5F80    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C5F87    pop ecx
006C5F88    pop edi
006C5F89    pop esi
...
006C5F8C    pop ebp
006C5F8D    ret
006C5F8E    push 0x87CF18                                   ; => [ String: AssetTypeGetInfo ]
006C5F93    push 0xC3
006C5F98    push 0x87CC50                                   ; => [ String: C:\x\ax2017\Engine\AssetTypeRegistry.cpp ]
006C5F9D    mov ecx, 0x87CF74                               ; => [ String: assetType >= 0 && assetType < ASSET_TYPE_COUNT ]
006C5FA2    mov edx, 0x801800
006C5FA7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006C5FAC    add esp, 0x0C
006C5FAF    call 0x0063BC30
006C5FB4    test al, al
006C5FB6    jz 0x006C5FB9                                   ; => [ Call: sub_63bc30 ]
006C5FB8    int3
006C5FB9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
