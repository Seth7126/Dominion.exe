...
00565D39    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00565D4A    call 0x00573400                                 ; => [ Call: sub_573400 ]
00565D4F    push esi
...
00565D60    call 0x00582DE0                                 ; => [ Call: sub_582de0 ]
...
00565DBF    push 0x0B
00565DC1    push edi
00565DC2    call 0x005822E0                                 ; => [ Call: nullptr | Call: sub_5822e0 ]
...
00565DD1    pop ebx
00565DD2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
