...
0070FDC9    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FDCF    push esi
0070FDD0    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FDD6    inc ebx
0070FDD7    add esp, 0x08
0070FDDA    cmp ebx, dword ptr ds:[edi+0x20]
0070FDDD    jl 0x0070FDC0
0070FDDF    push dword ptr ds:[edi+0x24]
0070FDE2    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FDFB    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FE01    push dword ptr ds:[esi+0x0C]
0070FE04    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FE0A    push dword ptr ds:[esi+0x20]
0070FE0D    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FE13    push esi
0070FE14    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FE1A    inc ebx
0070FE1B    add esp, 0x10
0070FE1E    cmp ebx, dword ptr ds:[edi+0x28]
0070FE21    jl 0x0070FDF2
0070FE23    push dword ptr ds:[edi+0x2C]
0070FE26    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FE6D    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FE73    push esi
0070FE74    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FEA3    push eax
0070FEA4    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FECA    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FED0    push esi
0070FED1    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FED7    mov esi, dword ptr ds:[ebx+0x08]
0070FEDA    push dword ptr ds:[esi+0x08]
0070FEDD    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FEE3    push esi
0070FEE4    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FEEA    mov esi, dword ptr ds:[ebx+0x0C]
0070FEED    push dword ptr ds:[esi+0x08]
0070FEF0    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FEF6    push esi
0070FEF7    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FEFD    mov esi, dword ptr ds:[ebx+0x10]
0070FF00    push dword ptr ds:[esi+0x08]
0070FF03    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF09    push esi
0070FF0A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF10    push dword ptr ds:[ebx]
0070FF12    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF18    push ebx
0070FF19    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FF35    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FF4E    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF54    push dword ptr ds:[esi+0x0C]
0070FF57    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF5D    push dword ptr ds:[esi]
0070FF5F    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF65    push esi
0070FF66    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FF6C    inc ebx
0070FF6D    add esp, 0x10
0070FF70    cmp ebx, dword ptr ds:[edi+0x3C]
0070FF73    jl 0x0070FF45
0070FF75    push dword ptr ds:[edi+0x40]
0070FF78    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FFBB    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FFC1    push dword ptr ds:[ebx]
0070FFC3    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0070FFC9    push ebx
0070FFCA    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FFE2    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0070FFFA    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00710000    push dword ptr ds:[esi+0x10]
00710003    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00710009    push esi
0071000A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00710010    inc ebx
00710011    add esp, 0x0C
00710014    cmp ebx, dword ptr ds:[edi+0x4C]
00710017    jl 0x0070FFF2
00710019    push dword ptr ds:[edi+0x50]
0071001C    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
00710038    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071003E    push dword ptr ds:[esi+0x10]
00710041    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00710047    push esi
00710048    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071004E    inc ebx
0071004F    add esp, 0x0C
00710052    cmp ebx, dword ptr ds:[edi+0x54]
00710055    jl 0x00710030
00710057    push dword ptr ds:[edi+0x58]
0071005A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
00710078    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071007E    push dword ptr ds:[esi+0x10]
00710081    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00710087    push esi
00710088    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071008E    inc ebx
0071008F    add esp, 0x0C
00710092    cmp ebx, dword ptr ds:[edi+0x5C]
00710095    jl 0x00710070
00710097    push dword ptr ds:[edi+0x60]
0071009A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007100A0    push dword ptr ds:[edi+0x04]
007100A3    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007100A9    push dword ptr ds:[edi]
007100AB    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007100B1    push edi
