...
0063BD15    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
0063BD1A    mov eax, dword ptr fs:[0x00000000]
0063BD20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0063BD21    push ecx
0063BD22    push ebx
0063BD23    push esi
0063BD24    push edi
...
0063BD2C    push eax                                        ; => [ Data: __security_cookie ]
0063BD2D    lea eax, ss:[ebp-0x0C]
0063BD30    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0063BD36    mov edi, edx
0063BD38    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0063BD3F    push ecx
0063BD40    lea eax, ss:[ebp-0x10]
0063BD43    mov dword ptr ss:[ebp-0x04], 0x00
0063BD4A    push 0x871C3C
0063BD4F    push eax
0063BD50    call 0x0063DE70                                 ; => [ Call: sub_63de70 | String: %s*.* ]
0063BD55    mov esi, dword ptr ss:[ebp-0x10]
0063BD58    add esp, 0x0C
0063BD5B    test esi, esi
0063BD5D    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
0063BD90    jz 0x0063BDAD                                   ; => [ Data: data_cf65bc ]
0063BD92    lea ecx, ss:[ebp-0x10]
0063BD95    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063BDA8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063BDAD    mov al, bl
0063BDAF    mov ecx, dword ptr ss:[ebp-0x0C]
0063BDB2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063BDB9    pop ecx
0063BDBA    pop edi
0063BDBB    pop esi
0063BDBC    pop ebx
