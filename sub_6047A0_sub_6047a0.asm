...
006047C2    mov dword ptr fs:[0x00000000], eax
006047C8    mov dword ptr ss:[ebp-0x14], edx
006047CB    mov dword ptr ss:[ebp-0x24], ecx
006047CE    xor ebx, ebx
006047D0    mov edi, 0x801800
006047D5    mov dword ptr ss:[ebp-0x1C], ebx
...
0060494F    mov edx, dword ptr ds:[0x00B80B48]
...
00604B1A    call 0x0064C080
00604B1F    mov dword ptr ss:[ebp-0x18], 0x801800
00604B26    mov byte ptr ss:[ebp-0x04], 0x12
00604B2A    cmp dword ptr ds:[0x00CF65BC], 0x00
00604B31    jz 0x00604B5A
...
00604B94    call 0x0064C080
00604B99    mov esi, dword ptr ss:[ebp-0x10]
00604B9C    mov eax, 0x801800
00604BA1    mov dword ptr ss:[ebp-0x14], eax
...
00604C2E    jz 0x00604C4B
00604C30    lea ecx, ss:[ebp-0x10]
00604C33    call 0x0063D4E0
...
00604CE2    call 0x0064C080
00604CE7    mov dword ptr ss:[ebp-0x20], 0x801800
00604CEE    mov byte ptr ss:[ebp-0x04], 0x16
00604CF2    cmp dword ptr ds:[0x00CF65BC], 0x00
00604CF9    jz 0x00604D22
...
00604E42    imul eax, dword ptr ds:[0x00B80B18], 0x64
00604E49    push 0x00
00604E4B    push ecx
00604E4C    push 0x00
00604E4E    lea ecx, ss:[ebp-0x14]
00604E51    mov edx, dword ptr ds:[eax+0xB82520]
00604E57    call 0x004E3FA0
00604E5C    push eax
...
00604EB7    call 0x0064C080
00604EBC    mov dword ptr ss:[ebp-0x20], 0x801800
00604EC3    mov dword ptr ss:[ebp-0x04], 0x20
00604ECA    cmp dword ptr ds:[0x00CF65BC], 0x00
00604ED1    jz 0x00604EFA
...
00605036    mov eax, dword ptr ds:[0x01A94E5C]
...
00605091    call 0x0064C080
00605096    mov dword ptr ss:[ebp-0x24], 0x801800
0060509D    mov byte ptr ss:[ebp-0x04], 0x2A
006050A1    cmp dword ptr ds:[0x00CF65BC], 0x00
006050A8    jz 0x006050D8
...
006050CC    call 0x0064C080
006050D1    mov dword ptr ss:[ebp-0x1C], 0x801800
006050D8    mov byte ptr ss:[ebp-0x04], 0x2B
006050DC    cmp dword ptr ds:[0x00CF65BC], 0x00
006050E3    jz 0x00605113
...
00605107    call 0x0064C080
0060510C    mov dword ptr ss:[ebp-0x18], 0x801800
00605113    mov dword ptr ss:[ebp-0x04], 0x2C
0060511A    cmp dword ptr ds:[0x00CF65BC], 0x00
00605121    jz 0x00604EFA
...
00605155    call 0x0064C080
0060515A    mov dword ptr ss:[ebp-0x10], 0x801800
...
0060520B    call 0x0063B870
00605210    add esp, 0x0C
00605213    call 0x0063BC30
00605218    test al, al
0060521A    jz 0x0060521D
0060521C    int3
0060521D    call 0x0063BB00
00605222    push 0x8643E0
00605227    push 0x9983
0060522C    push 0x86F1E8
00605231    mov ecx, 0x801AA4
00605236    mov edx, edi
00605238    call 0x0063B870
0060523D    add esp, 0x0C
00605240    call 0x0063BC30
00605245    test al, al
00605247    jz 0x0060524A
00605249    int3
0060524A    call 0x0063BB00
