...
005ED122    mov dword ptr fs:[0x00000000], eax
005ED128    mov edi, dword ptr ss:[ebp+0x08]
005ED12B    mov ecx, edi
005ED12D    call 0x0064E7A0
005ED132    mov dword ptr ds:[eax+0x18BC], 0x5EAEB0
005ED13C    call 0x004B9480
...
005ED168    mov dword ptr ds:[0x00CB4510], eax
...
005ED1D0    mov edx, dword ptr ds:[0x01597E30]
...
005ED249    jz 0x005ED26D
005ED24B    lea ecx, ss:[ebp-0x10]
005ED24E    call 0x0063D4E0
...
005ED40E    call 0x0064C080
005ED413    mov ecx, dword ptr ss:[ebp-0x0C]
005ED416    mov dword ptr fs:[0x00000000], ecx
005ED41D    pop ecx
005ED41E    pop edi
005ED41F    pop esi
005ED420    pop ebx
