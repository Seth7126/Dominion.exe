...
006006CE    xor eax, esp                                    ; => [ Data: __security_cookie ]
006006D0    mov dword ptr ss:[esp+0x20], eax
006006D4    push ebx
006006D5    push esi
006006D6    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
006006DC    mov ebx, edx
006006DE    push edi
006006DF    mov edi, ecx
006006E1    test esi, esi
006006E3    jnz 0x006006FB
006006E5    push 0x77EB90                                   ; => [ String: GetClient ]
006006EA    push 0x7B
006006EC    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
006006F1    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
006006F6    jmp 0x0060080A
006006FB    mov eax, dword ptr ds:[esi+0x5068]
00600701    cmp eax, 0x05
00600704    jnz 0x00600715
00600706    push 0x861C70                                   ; => [ String: DomGameUndo ]
0060070B    push 0x91DF
00600710    jmp 0x00600800
00600715    cmp eax, 0x01
00600718    jnz 0x00600779
0060071A    call 0x005CBF20                                 ; => [ Call: sub_5cbf20 ]
0060071F    xor dl, dl
00600721    mov ecx, 0x02
00600726    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
0060072B    cmp dword ptr ds:[0x008DB664], 0x29
00600732    mov ecx, 0x05
00600737    setnz dl
0060073A    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 | Data: data_8db664 ]
0060073F    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
00600744    lea ecx, ss:[esp+0x10]
00600748    mov edx, edi
0060074A    push ecx
0060074B    mov ecx, eax
0060074D    call 0x004B4CC0                                 ; => [ Call: sub_4b4cc0 ]
00600752    add esp, 0x04
00600755    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
0060075A    mov edx, dword ptr ds:[esi+0x506C]
00600760    mov ecx, eax
00600762    call 0x004DA150                                 ; => [ Call: TPI1::QueryTiForCVRecord ]
00600767    pop edi
00600768    pop esi
00600769    pop ebx
0060076A    mov ecx, dword ptr ss:[esp+0x20]
0060076E    xor ecx, esp
00600770    call 0x0075927A                                 ; => [ Call: CookieCheckFunction | Call: CookieCheckFunction ]
...
00600784    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
00600789    mov edx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
006007ED    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006007F2    mov esp, ebp
006007F4    pop ebp
006007F5    ret
006007F6    push 0x861C70                                   ; => [ String: DomGameUndo ]
006007FB    push 0x91FC
00600800    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00600805    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
0060080A    mov edx, 0x801800
0060080F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00600814    add esp, 0x0C
00600817    call 0x0063BC30
0060081C    test al, al
0060081E    jz 0x00600821                                   ; => [ Call: sub_63bc30 ]
00600820    int3
00600821    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
