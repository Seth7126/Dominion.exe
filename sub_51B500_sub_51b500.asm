...
0051B508    call 0x00761E50                                 ; => [ Call: __chkstk ]
0051B50D    mov eax, dword ptr ds:[0x008C4040]
0051B512    xor eax, ebp
0051B514    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
0051B517    push ebx
0051B518    push esi
0051B519    push edi
...
0051B52E    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
0051B533    mov ebx, eax
0051B535    lea edx, ss:[ebp-0xA8]
0051B53B    mov ecx, dword ptr ds:[ebx+0x423C]
0051B541    call 0x0051B470                                 ; => [ Call: sub_51b470 ]
...
0051B557    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
0051B55D    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
0051B562    mov ecx, dword ptr ds:[ebx+0x423C]
0051B568    lea edx, ss:[ebp-0xA8]
0051B56E    call 0x0051B470
0051B573    mov esi, eax                                    ; => [ Call: sub_51b470 ]
...
0051B595    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0051B5FA    pop esi
0051B5FB    pop ebx
0051B5FC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
