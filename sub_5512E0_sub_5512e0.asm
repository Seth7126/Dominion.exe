...
00551332    push 0x03
00551334    push 0x3EA
00551339    call 0x00566140                                 ; => [ Call: nullptr | Call: sub_566140 ]
