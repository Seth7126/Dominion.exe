...
004F821E    push 0x01
004F8220    call 0x00590760                                 ; => [ Call: sub_590760 ]
004F8225    add esp, 0x18
004F8228    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004F824B    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
004F8250    add esp, 0x0C
004F8253    call 0x0063BC30
004F8258    test al, al
004F825A    jz 0x004F825D                                   ; => [ Call: sub_63bc30 ]
004F825C    int3
004F825D    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
004F8262    mov eax, dword ptr ds:[eax+0x04]
004F8265    imul ecx, ecx, 0x5A30
004F826B    or dword ptr ds:[ecx+eax*1+0x17558], 0x02
004F8273    jmp 0x0056D290                                  ; => [ Call: sub_56d290 ]
