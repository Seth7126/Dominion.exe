...
005E3C76    push 0x85F570                                   ; => [ String: GetSmartplays ]
005E3C7B    push 0x4BE1
005E3C80    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005E3C85    jmp 0x005E3D45
005E3C8A    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
005E3C90    test esi, esi
005E3C92    jnz 0x005E3CAA
005E3C94    push 0x77EB90                                   ; => [ String: GetClient ]
005E3C99    push 0x7B
005E3C9B    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
005E3CA0    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
...
005E3CC7    pop ebp
005E3CC8    ret                                             ; => [ Call: sub_4b9680 | Call: sub_4b9480 ]
005E3CC9    mov ecx, dword ptr ds:[0x00CC8DC8]
005E3CCF    mov ecx, dword ptr ds:[ecx+0x1E1A4]
005E3CD5    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
005E3D23    push eax
005E3D24    push ebx
005E3D25    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
005E3D34    pop ebp
005E3D35    ret
005E3D36    push 0x85F570                                   ; => [ String: GetSmartplays ]
005E3D3B    push 0x4BD1
005E3D40    mov ecx, 0x85F5A4                               ; => [ String: profile.smartplays.numSmartplays >= 0 ]
005E3D45    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E3D4A    mov edx, 0x801800
005E3D4F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005E3D54    add esp, 0x0C
005E3D57    call 0x0063BC30
005E3D5C    test al, al
005E3D5E    jz 0x005E3D61                                   ; => [ Call: sub_63bc30 ]
005E3D60    int3
005E3D61    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
005E3D66    push 0x801E10
005E3D6B    push 0x640
005E3D70    push 0x801AF8
005E3D75    mov edx, 0x801800
005E3D7A    mov ecx, 0x801E20
005E3D7F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: source.numSmartplays >= 0 | Data: data_801800 | String: CopySmartplays | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
005E3D84    add esp, 0x0C
005E3D87    call 0x0063BC30
005E3D8C    test al, al
005E3D8E    jz 0x005E3D91                                   ; => [ Call: sub_63bc30 ]
005E3D90    int3
005E3D91    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
