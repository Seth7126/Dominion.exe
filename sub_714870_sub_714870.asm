...
00714870    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00714875    push esi
...
00714884    push 0x10
00714886    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00714888    add esp, 0x0C
0071488B    jmp 0x00714898
0071488D    push 0x10
0071488F    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00714895    add esp, 0x04
00714898    mov edi, eax
0071489A    test edi, edi
0071489C    jz 0x007148A4
0071489E    xorps xmm0, xmm0
007148A1    movups xmmword ptr ds:[edi], xmm0               ; => [ String: 0 | String: zx ]
...
007148B7    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007148CA    push ecx
007148CB    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
007148CD    add esp, 0x0C
007148D0    jmp 0x007148DC
007148D2    push ecx
007148D3    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007148EF    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071490D    mov dword ptr ds:[edi+0x0C], eax                ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
...
00714920    mov dword ptr ds:[edi+0x0C], eax                ; => [ Call: malloc ]
