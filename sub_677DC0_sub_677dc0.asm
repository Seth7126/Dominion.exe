...
00677DC5    push 0x76D9DD                                   ; => [ Call: sub_76d9dd | Type: EHRegistrationNode ]
00677DCA    mov eax, dword ptr fs:[0x00000000]
00677DD0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00677DDE    push eax                                        ; => [ Data: __security_cookie ]
00677DDF    lea eax, ss:[ebp-0x0C]
00677DE2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00677DE8    mov bl, dl
00677DEA    mov byte ptr ss:[ebp-0x0D], bl
00677DED    test ecx, ecx
00677DEF    jnz 0x00677E0A
00677DF1    push 0x874440                                   ; => [ String: UI2DefGet ]
00677DF6    push 0xC16
00677DFB    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
00677E00    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
00677E05    jmp 0x00677FF8
00677E0A    cmp dword ptr ds:[ecx+0x04], 0x22
00677E0E    jnz 0x00677FE4
00677E14    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
00677E32    xor eax, eax                                    ; => [ Call: nullptr ]
00677E34    mov dword ptr ss:[ebp-0x18], eax                ; => [ Call: nullptr ]
00677E37    mov esi, dword ptr ds:[ecx]
00677E39    mov ecx, 0x8CAE70
00677E3E    add esi, eax
00677E40    push 0x66
00677E42    mov edx, esi
00677E44    call 0x006DCF50                                 ; => [ Call: sub_6dcf50 | Data: data_8cae70 ]
...
00677E73    push eax                                        ; => [ Data: data_8cae70 | Call: sub_6dd140 ]
00677E74    push dword ptr ds:[0x00C27C20]                  ; => [ Data: data_c27c20 ]
00677E7A    call 0x00676E70                                 ; => [ Call: sub_676e70 | String: dom_ui_ ]
...
00677EB8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677ECB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00677ED0    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
00677EF2    call 0x006DD280                                 ; => [ Call: sub_6dd280 | Data: data_8cae70 ]
...
00677F18    push eax                                        ; => [ Data: data_8cae70 | Call: sub_6dd140 ]
00677F19    push 0x876854
00677F1E    call 0x0063B5F0
00677F23    push 0x105
00677F28    mov edx, esi
00677F2A    mov ecx, 0x8CAE70
00677F2F    call 0x006DD140                                 ; => [ String: el %s | Call: sub_63b5f0 | Data: data_8cae70 | Call: sub_6dd140 ]
...
00677F45    call 0x00677A50                                 ; => [ Call: sub_677a50 ]
00677F4A    add esp, 0x04
00677F4D    push 0x69
00677F4F    push dword ptr ds:[0x01724A80]
00677F55    mov edx, esi
00677F57    mov ecx, 0x8CAE70
00677F5C    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Type: MESSAGEBOX_RESULT | Data: data_8cae70 | Data: data_1724a80 ]
...
00677F84    call 0x006DD140                                 ; => [ Data: data_8cae70 | Call: sub_6dd140 ]
...
00677F9D    call 0x00677A50                                 ; => [ Call: sub_677a50 ]
...
00677FD5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00677FDC    pop ecx
00677FDD    pop edi
00677FDE    pop esi
00677FDF    pop ebx
...
00677FE2    pop ebp
00677FE3    ret
00677FE4    push 0x874440                                   ; => [ String: UI2DefGet ]
00677FE9    push 0xC17
00677FEE    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00677FF3    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
00677FF8    push 0x8739B4
00677FFD    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: UI2DefGet | String: C:\x\ax2017\Engine\UI2.cpp ]
00678002    add esp, 0x0C
00678005    call 0x0063BC30
0067800A    test al, al
0067800C    jz 0x0067800F                                   ; => [ Call: sub_63bc30 ]
0067800E    int3
0067800F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
