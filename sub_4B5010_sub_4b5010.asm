...
004B5016    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004B503D    lea esi, ds:[eax+0x11B8]
...
004B5057    mov eax, dword ptr ds:[0x00CC8D5C]
004B505C    pop edi
004B505D    pop esi
004B505E    pop ebx
...
004B5096    call 0x0063B870
004B509B    add esp, 0x0C
004B509E    call 0x0063BC30
004B50A3    test al, al
004B50A5    jz 0x004B50A8
004B50A7    int3
004B50A8    call 0x0063BB00
