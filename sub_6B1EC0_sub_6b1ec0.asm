...
006B1EC9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006B1EFB    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B1F00    mov edi, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B1F06    test eax, eax
006B1F08    jnz 0x006B1F0E
006B1F0A    xor edx, edx                                    ; => [ Call: nullptr ]
006B1F0C    jmp 0x006B1F2E
006B1F0E    movzx ecx, ax
006B1F11    cmp ecx, dword ptr ds:[edi+0x3C]
006B1F14    jb 0x006B1F1A
006B1F16    xor edx, edx                                    ; => [ Call: nullptr ]
...
006B1F2B    cmovnz edx, ecx                                 ; => [ Call: nullptr ]
...
006B1FB9    mov ecx, dword ptr ds:[esi+0x5C]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006B1FBC    test ecx, ecx
006B1FBE    jz 0x006B200A
006B1FC0    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B1FC5    mov edi, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B1FCB    test eax, eax
006B1FCD    jnz 0x006B1FD3
006B1FCF    xor edx, edx                                    ; => [ Call: nullptr ]
...
006B1FEC    cmovnz edx, ecx                                 ; => [ Call: nullptr ]
...
006B2012    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
