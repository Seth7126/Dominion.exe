...
0050EE46    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0050EE5D    add edx, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 | Data: data_cca784 ]
0050EE63    push edi
0050EE64    xor edi, edi
0050EE66    xor eax, eax                                    ; => [ Call: nullptr ]
...
0050EE9C    mov eax, dword ptr ds:[edx+eax*4]               ; => [ Data: data_1597e0c | Data: data_1597e10 ]
...
0050EEB9    xor eax, eax                                    ; => [ Call: nullptr ]
...
0050EEDB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0050EEED    pop ebx
0050EEEE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0050EF10    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: cards[i] != CARD_NONE | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: HasAtLeastOne ]
0050EF15    add esp, 0x0C
0050EF18    call 0x0063BC30
0050EF1D    test al, al
0050EF1F    jz 0x0050EF22                                   ; => [ Call: sub_63bc30 ]
0050EF21    int3
0050EF22    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
