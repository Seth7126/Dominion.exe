...
00558250    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00558251    sub esp, 0x94
00558257    mov eax, dword ptr ds:[0x008C4040]
0055825C    xor eax, ebp
0055825E    mov dword ptr ss:[ebp-0x10], eax
00558261    push eax                                        ; => [ Data: __security_cookie ]
00558262    lea eax, ss:[ebp-0x0C]
00558265    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0055826B    xorps xmm0, xmm0
0055826E    mov dword ptr ss:[ebp-0x40], 0xBC               ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_cdc6ecb770f38bd76a643c810ab6cc0d>, void>::VTable ]
00558275    movlpd qword ptr ss:[ebp-0x18], xmm0
0055827A    lea eax, ss:[ebp-0x70]
0055827D    movlpd qword ptr ss:[ebp-0x20], xmm0
00558282    movlpd qword ptr ss:[ebp-0x3C], xmm0            ; => [ Call: __builtin_memset ]
...
005582AC    mov dword ptr ss:[ebp-0x4C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_bd5b8173b110c2bd8bbcbeae8230c7e4>, void>::VTable ]
005582AF    lea eax, ss:[ebp-0x40]
005582B2    movups xmm0, xmmword ptr ss:[ebp-0x30]
005582B6    mov dword ptr ss:[ebp-0x70], 0x81D980           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_bd5b8173b110c2bd8bbcbeae8230c7e4>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
005582D6    mov dword ptr ss:[ebp-0x40], 0x81D964           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_cdc6ecb770f38bd76a643c810ab6cc0d>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
00558311    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
0055832A    push 0x30
0055832C    push eax
0055832D    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
00558332    mov ecx, dword ptr ss:[ebp-0x0C]
00558335    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055833C    pop ecx
0055833D    mov ecx, dword ptr ss:[ebp-0x10]
00558340    xor ecx, ebp
00558342    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
