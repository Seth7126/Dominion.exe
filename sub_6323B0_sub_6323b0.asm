...
006323B9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006323D2    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
00632402    push eax
00632403    call 0x00761FC4                                 ; => [ Call: memset ]
...
00632444    push 0x00
00632446    push eax
00632447    call 0x00761FC4                                 ; => [ Call: memset ]
...
006324D1    call 0x005CB630                                 ; => [ Call: sub_5cb630 ]
...
006324DF    pop ebx
006324E0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00632502    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: DomCreateArrow | String: Halt ]
00632507    add esp, 0x0C
0063250A    call 0x0063BC30
0063250F    test al, al
00632511    jz 0x00632514                                   ; => [ Call: sub_63bc30 ]
00632513    int3
00632514    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
