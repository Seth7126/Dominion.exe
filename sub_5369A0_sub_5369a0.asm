...
005369C5    mov dword ptr fs:[0x00000000], eax
005369CB    lea eax, ss:[ebp-0xD0]
005369D1    mov dword ptr ss:[ebp-0xD0], 0x81A504
005369DB    mov dword ptr ss:[ebp-0xAC], eax
005369E1    lea eax, ss:[ebp-0xA0]
005369E7    mov dword ptr ss:[ebp-0x7C], eax
005369EA    lea eax, ss:[ebp-0x70]
005369ED    mov dword ptr ss:[ebp-0x4C], eax
005369F0    lea eax, ss:[ebp-0x40]
005369F3    mov dword ptr ss:[ebp-0xA8], 0x17
005369FD    mov dword ptr ss:[ebp-0xA4], 0x00
00536A07    mov dword ptr ss:[ebp-0xA0], 0x81A4E8
00536A11    mov dword ptr ss:[ebp-0x78], 0x16
00536A18    mov dword ptr ss:[ebp-0x74], 0x00
00536A1F    mov dword ptr ss:[ebp-0x70], 0x81A4CC
00536A26    mov dword ptr ss:[ebp-0x48], 0x19
00536A2D    mov dword ptr ss:[ebp-0x44], 0x00
00536A34    mov dword ptr ss:[ebp-0x40], 0x81A4B0
00536A3B    mov dword ptr ss:[ebp-0x1C], eax
