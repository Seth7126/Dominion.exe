...
00655F56    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00655F6F    mov dword ptr ss:[ebp-0x38], eax                ; => [ Data: data_c23c04 ]
00655F72    mov eax, dword ptr ds:[0x00C23C08]
00655F77    mov dword ptr ss:[ebp-0x34], eax                ; => [ Data: data_c23c08 ]
00655F7A    mov eax, dword ptr ds:[0x00C23C0C]
00655F7F    movss xmm1, dword ptr ds:[esi+0x1680]
00655F87    ucomiss xmm1, xmm0
00655F8A    mov dword ptr ss:[ebp-0x30], eax                ; => [ Data: data_c23c0c ]
00655F8D    mov eax, dword ptr ds:[0x00C23C10]
00655F92    mov dword ptr ss:[ebp-0x2C], eax                ; => [ Data: data_c23c10 ]
00655F95    mov eax, dword ptr ds:[0x00C23C14]
00655F9A    mov dword ptr ss:[ebp-0x28], eax                ; => [ Data: data_c23c14 ]
00655F9D    push edi
00655F9E    mov dword ptr ss:[ebp-0x4C], ecx
00655FA1    mov dword ptr ss:[ebp-0x40], ebx
00655FA4    mov dword ptr ss:[ebp-0x3C], 0x8028C4           ; => [ Data: UI2HitResult::`vftable'{for `InputHitResult'} | Type: InputHitResult::UI2HitResult::VTable ]
00655FAB    lahf
...
00656002    call 0x0067D460                                 ; => [ Call: sub_67d460 | Data: data_147abe8 ]
...
0065609F    call 0x006559A0                                 ; => [ Call: sub_6559a0 ]
...
006560E7    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00656118    call dword ptr ds:[eax]                         ; => [ Data: data_c23c00 ]
0065611A    cmp ebx, eax
0065611C    jnz 0x00656134
0065611E    lea eax, ss:[ebp-0x24]
00656121    push 0xC23C00
00656126    push eax
00656127    call ebx                                        ; => [ Data: data_c23c00 ]
00656129    add esp, 0x08
0065612C    test al, al
0065612E    jnz 0x00656323
00656134    mov eax, dword ptr ss:[ebp-0x3C]
00656137    mov eax, dword ptr ds:[eax]                     ; => [ Field: vFunc_0 ]
00656139    cmp eax, 0x4AE6D0
0065613E    jnz 0x006562D2                                  ; => [ Call: sub_4ae6d0 ]
00656144    mov ebx, 0x4AE6A0                               ; => [ Call: sub_4ae6a0 ]
00656149    jmp 0x006562D9
0065614E    xorps xmm0, xmm0
00656151    cmp byte ptr ss:[ebp+0x10], 0x00                ; => [ Call: nullptr ]
...
00656203    mov eax, dword ptr ds:[esi+0x15F8]              ; => [ Call: nullptr ]
...
00656250    test al, al
00656252    jz 0x006560B6                                   ; => [ Call: sub_6559a0 ]
...
006562C3    push 0x874AAC                                   ; => [ String: UI2AcceptsHover ]
...
00656363    jz 0x00656420                                   ; => [ Call: sub_64e7a0 ]
...
00656397    call dword ptr ds:[eax]                         ; => [ Data: data_c23c00 ]
00656399    cmp esi, eax
0065639B    jnz 0x006563AF
0065639D    lea eax, ss:[ebp-0x24]
006563A0    push 0xC23C00
006563A5    push eax
006563A6    call esi                                        ; => [ Data: data_c23c00 ]
006563A8    add esp, 0x08
006563AB    test al, al
006563AD    jnz 0x00656413
006563AF    mov eax, dword ptr ss:[ebp-0x3C]
006563B2    mov eax, dword ptr ds:[eax]                     ; => [ Field: vFunc_0 ]
006563B4    cmp eax, 0x4AE6D0
006563B9    jnz 0x006563C2                                  ; => [ Call: sub_4ae6d0 ]
006563BB    mov esi, 0x4AE6A0                               ; => [ Call: sub_4ae6a0 ]
...
0065643E    mov dword ptr ds:[eax], 0x8028C4                ; => [ Data: UI2HitResult::`vftable'{for `InputHitResult'} ]
...
0065644F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00656454    mov esp, ebp
00656456    pop ebp
00656457    ret
00656458    mov dword ptr ds:[ecx], 0x8028C4                ; => [ Data: UI2HitResult::`vftable'{for `InputHitResult'} ]
0065645E    mov eax, dword ptr ds:[0x00C23C04]
00656463    mov dword ptr ds:[ecx+0x04], eax                ; => [ Data: data_c23c04 ]
00656466    mov eax, dword ptr ds:[0x00C23C08]
0065646B    mov dword ptr ds:[ecx+0x08], eax                ; => [ Data: data_c23c08 ]
0065646E    mov eax, dword ptr ds:[0x00C23C0C]
00656473    mov dword ptr ds:[ecx+0x0C], eax                ; => [ Data: data_c23c0c ]
00656476    mov eax, dword ptr ds:[0x00C23C10]
0065647B    mov dword ptr ds:[ecx+0x10], eax                ; => [ Data: data_c23c10 ]
0065647E    mov eax, dword ptr ds:[0x00C23C14]
00656483    mov dword ptr ds:[ecx+0x14], eax                ; => [ Data: data_c23c14 ]
...
0065648F    pop ebx
00656490    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00656495    mov esp, ebp
00656497    pop ebp
00656498    ret
00656499    push 0x876CA0                                   ; => [ String: RectInflate ]
0065649E    push 0xB3
006564A3    push 0x801A00                                   ; => [ String: C:\x\ax2017\Engine\Rect.cpp ]
006564A8    mov ecx, 0x801A1C                               ; => [ String: RectIsNormalized(r) ]
006564AD    jmp 0x006564C3
006564AF    push 0x874B00                                   ; => [ String: UI2HitTest ]
006564B4    push 0x1AD4
006564B9    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
006564BE    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006564C3    mov edx, 0x801800
006564C8    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006564CD    add esp, 0x0C
006564D0    call 0x0063BC30
006564D5    test al, al
006564D7    jz 0x006564DA                                   ; => [ Call: sub_63bc30 ]
006564D9    int3
006564DA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
