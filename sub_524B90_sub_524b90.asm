...
00524C04    push 0x476
00524C09    push esi
00524C0A    call 0x00583720
00524C0F    add esp, 0x1C
00524C12    lea ecx, ss:[ebp-0x0D]
00524C15    call 0x0056EFB0
00524C1A    mov ecx, dword ptr ss:[ebp-0x0C]
00524C1D    mov dword ptr fs:[0x00000000], ecx
00524C24    pop ecx
00524C25    pop esi
