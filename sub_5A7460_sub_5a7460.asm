...
005A746B    call 0x00761E50                                 ; => [ Call: __chkstk ]
005A7470    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005A7475    xor eax, esp
005A7477    mov dword ptr ss:[esp+0x10018], eax
005A747E    movss xmm4, dword ptr ds:[0x00B4A5B8]           ; => [ Data: data_b4a5b8 ]
005A7486    movss xmm5, dword ptr ds:[0x00B4A5B4]           ; => [ Data: data_b4a5b4 ]
005A748E    movss xmm3, dword ptr ds:[0x00890C78]
005A7496    movss xmm6, dword ptr ds:[0x00890D00]
005A749E    push ebx
005A749F    push esi
005A74A0    xor esi, esi                                    ; => [ Call: nullptr ]
005A74A2    mov dword ptr ss:[esp+0x0C], edx
005A74A6    push edi
005A74A7    mov dword ptr ss:[esp+0x1C], ecx
005A74AB    lea ebx, ds:[ecx+0x04]
005A74AE    mov dword ptr ss:[esp+0x14], esi                ; => [ Call: nullptr ]
...
005A7510    divss xmm1, xmm0                                ; => [ Call: sub_4ae0b0 ]
...
005A7531    divss xmm1, xmm0                                ; => [ Call: sub_4ae0b0 ]
...
005A7552    call 0x00762084                                 ; => [ Call: _libm_sse2_sqrt_precise ]
...
005A75D3    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
005A7616    movss xmm5, dword ptr ds:[0x00B4A5B4]           ; => [ Data: data_b4a5b4 ]
005A761E    movss xmm4, dword ptr ds:[0x00B4A5B8]           ; => [ Data: data_b4a5b8 ]
005A7626    inc esi
...
005A763E    call 0x005AC8C0                                 ; => [ Call: sub_5ac8c0 ]
005A7643    mov ecx, dword ptr ss:[esp+0x10024]
005A764A    pop edi
005A764B    pop esi
005A764C    pop ebx
005A764D    xor ecx, esp
005A764F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
