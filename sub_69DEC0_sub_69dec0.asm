...
0069DEC5    push 0x76DEB0                                   ; => [ Call: __ehhandler$___dcrt_uninitialize_environments_nolock | Type: EHRegistrationNode ]
0069DECA    mov eax, dword ptr fs:[0x00000000]
0069DED0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0069DED1    push ecx                                        ; => [ Type: FILE ]
0069DED2    push esi
0069DED3    push edi
0069DED4    mov eax, dword ptr ds:[0x008C4040]
0069DED9    xor eax, ebp
0069DEDB    push eax                                        ; => [ Data: __security_cookie ]
0069DEDC    lea eax, ss:[ebp-0x0C]
0069DEDF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0069DEF8    mov esi, 0x878BE8                               ; => [ Data: data_878be8 ]
0069DEFD    jmp 0x0069DF04
0069DEFF    mov esi, 0x8723C4                               ; => [ Data: data_8723c4 ]
0069DF04    lea ecx, ss:[ebp+0x08]
0069DF07    call 0x0069DDF0                                 ; => [ Call: sub_69ddf0 ]
0069DF0C    mov eax, dword ptr ss:[ebp+0x08]
0069DF0F    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0069DF14    test eax, eax
0069DF16    push esi
0069DF17    cmovnz ecx, eax
0069DF1A    push ecx
0069DF1B    call dword ptr ds:[0x0077564C]                  ; => [ Type: FILE ]
...
0069DF63    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069DF68    mov al, 0x01
0069DF6A    mov ecx, dword ptr ss:[ebp-0x0C]
0069DF6D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069DF74    pop ecx
0069DF75    pop edi
0069DF76    pop esi
...
0069DFAD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069DFB2    xor al, al
0069DFB4    mov ecx, dword ptr ss:[ebp-0x0C]
0069DFB7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069DFBE    pop ecx
0069DFBF    pop edi
0069DFC0    pop esi
...
0069DFDB    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\xPlatformGeneric.cpp | Data: data_801800 | String: HalOpen | String: Halt ]
0069DFE0    add esp, 0x0C
0069DFE3    call 0x0063BC30
0069DFE8    test al, al
0069DFEA    jz 0x0069DFED                                   ; => [ Call: sub_63bc30 ]
0069DFEC    int3
0069DFED    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
