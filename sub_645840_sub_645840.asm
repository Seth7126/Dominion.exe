...
00645852    jz 0x0064590C                                   ; => [ Data: data_147aba1 ]
00645858    lea ebx, ds:[esi+esi*2]
0064585B    movss xmm0, dword ptr ds:[ebx*4+0xCF6AE4]       ; => [ Data: data_cf6ae4 ]
00645864    ucomiss xmm0, dword ptr ds:[edi]
00645867    lahf
00645868    test ah, 0x44
0064586B    jp 0x006458E1
0064586D    movss xmm0, dword ptr ds:[ebx*4+0xCF6AE8]       ; => [ Data: data_cf6ae4 ]
00645876    ucomiss xmm0, dword ptr ds:[edi+0x04]
0064587A    lahf
0064587B    test ah, 0x44
0064587E    jp 0x006458E1
00645880    movss xmm0, dword ptr ds:[ebx*4+0xCF6AEC]       ; => [ Data: data_cf6ae4 ]
...
006458EA    movq qword ptr ds:[ebx*4+0xCF6AE4], xmm0        ; => [ Data: data_cf6ae4 ]
006458F3    mov eax, dword ptr ds:[edi+0x08]
006458F6    mov dword ptr ds:[ebx*4+0xCF6AEC], eax          ; => [ Data: data_cf6ae4 ]
006458FD    movups xmm0, xmmword ptr ds:[edx]
00645900    movups xmmword ptr ds:[ecx+0xCF6AA4], xmm0      ; => [ Data: data_cf6aa4 ]
00645907    pop edi
00645908    pop esi
00645909    pop ebx
0064590A    pop ebp
...
00645925    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: gDraw3DData.submittingRenderItems | String: Draw3DDirectionalLight | Data: data_801800 | String: C:\x\ax2017\Engine\Draw3d.cpp ]
0064592A    add esp, 0x0C
0064592D    call 0x0063BC30
00645932    test al, al
00645934    jz 0x00645937                                   ; => [ Call: sub_63bc30 ]
00645936    int3
00645937    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
