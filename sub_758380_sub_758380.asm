...
007583C5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
007583CC    pop ecx
007583CD    pop edi
007583CE    pop esi
007583CF    pop ebx
...
007583E5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
007583EC    pop ecx
007583ED    pop edi
007583EE    pop esi
007583EF    pop ebx
...
007583F3    ret
007583F4    push 0x78
007583F6    call 0x00759772                                 ; => [ Call: operator new ]
...
0075840C    call 0x0075ECE0                                 ; => [ Call: sub_75ece0 ]
00758411    mov byte ptr ss:[ebp-0x04], 0x01
00758415    mov dword ptr ds:[edi], 0x890A70                ; => [ Data: data_890a70 ]
...
00758438    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
00758464    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0075846B    pop ecx
0075846C    pop edi
0075846D    pop esi
0075846E    pop ebx
...
00758476    call 0x00757270                                 ; => [ Call: sub_757270 ]
0075847B    mov eax, edi
0075847D    mov ecx, dword ptr ss:[ebp-0x0C]
00758480    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00758487    pop ecx
00758488    pop edi
00758489    pop esi
0075848A    pop ebx
...
007584A8    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SoundGetDef | String: C:\x\ax2017\Engine\Sound.cpp | Data: data_801800 | String: assetPtr->assetType == ASSET_TYPE_SOUND ]
007584AD    add esp, 0x0C
007584B0    call 0x0063BC30
007584B5    test al, al
007584B7    jz 0x007584BA                                   ; => [ Call: sub_63bc30 ]
007584B9    int3
007584BA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
007584BF    push 0x877324
007584C4    push 0x356
007584C9    push 0x8772E4
007584CE    mov edx, 0x801800
007584D3    mov ecx, 0x877344
007584D8    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SoundGetDef | String: C:\x\ax2017\Engine\Sound.cpp | Data: data_801800 | String: assetPtr->assetType == ASSET_TYPE_SOUND ]
007584DD    add esp, 0x0C
007584E0    call 0x0063BC30
007584E5    test al, al
007584E7    jz 0x007584EA                                   ; => [ Call: sub_63bc30 ]
007584E9    int3
007584EA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
