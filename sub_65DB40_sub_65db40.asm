...
0065DB45    push 0x76D03E                                   ; => [ Type: EHRegistrationNode | Call: sub_76d03e ]
0065DB4A    mov eax, dword ptr fs:[0x00000000]
0065DB50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0065DB5E    push eax                                        ; => [ Data: __security_cookie ]
0065DB5F    lea eax, ss:[ebp-0x0C]
0065DB62    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0065DB75    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
0065DBCA    call 0x0065D9C0                                 ; => [ Call: sub_65d9c0 ]
...
0065DBEB    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
0065DC1B    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 ]
...
0065DC3B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DC57    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0065DC5C    mov byte ptr ss:[ebp-0x04], 0x03
0065DC60    cmp dword ptr ds:[0x00CF65BC], 0x00
0065DC67    jz 0x0065DD3D                                   ; => [ Data: data_cf65bc ]
...
0065DC81    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DC98    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0065DCB5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DCC9    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 ]
...
0065DCE8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DD07    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DD5E    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0065DD63    lea ecx, ss:[ebp-0x18]
0065DD66    call 0x0063E4D0                                 ; => [ Call: sub_63e4d0 ]
...
0065DD7E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DDA0    jz 0x0065DDBD                                   ; => [ Data: data_cf65bc ]
0065DDA2    lea ecx, ss:[ebp-0x18]
0065DDA5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DDB8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0065DDD6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DDFB    jz 0x0065DE18                                   ; => [ Data: data_cf65bc ]
0065DDFD    lea ecx, ss:[ebp-0x14]
0065DE00    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DE13    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065DE18    mov eax, dword ptr ss:[ebp-0x20]
0065DE1B    mov ecx, dword ptr ss:[ebp-0x0C]
0065DE1E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0065DE25    pop ecx
0065DE26    pop edi
0065DE27    pop esi
0065DE28    pop ebx
