...
00750615    mov ecx, eax                                    ; => [ Type: HANDLE | String: lpInsData ]
00750617    mov dword ptr ds:[0x019E2778], ecx              ; => [ Data: data_19e2778 ]
...
00750644    jmp dword ptr ds:[eax*4+0x7508B4]               ; => [ Data: jump_table_7508b4 | Data: lookup_table_7508d0 ]
0075064B    mov eax, dword ptr ds:[ecx+0x04]                ; => [ Data: lookup_table_7508d0 ]
0075064E    test eax, eax
00750650    jz 0x00750665
00750652    cmp dword ptr ds:[eax+0x14], 0x08
00750656    jnz 0x00750665
00750658    mov dword ptr ds:[eax+0x08], 0x88FF00           ; => [ Data: data_88ff00 ]
0075065F    mov ecx, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
00750691    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
007506A8    call dword ptr ds:[0x007753FC]                  ; => [ Call: nullptr ]
...
007506B6    ret 0x10
007506B9    push 0x105
007506BE    mov dword ptr ds:[ecx+0x38], 0x01               ; => [ Data: lookup_table_7508d0 ]
007506C5    mov eax, dword ptr ds:[0x019E2778]
007506CA    push 0x00
007506CC    push 0x00
007506CE    push dword ptr ds:[eax+0x14]
007506D1    call dword ptr ds:[0x007753FC]                  ; => [ Data: data_19e2778 | Call: nullptr ]
...
007506E6    jz 0x00750893                                   ; => [ Data: lookup_table_7508d0 ]
007506EC    mov ecx, edi
007506EE    call 0x0074CF70                                 ; => [ Call: sub_74cf70 ]
007506F3    mov eax, dword ptr ds:[0x019E2778]
007506F8    mov dword ptr ds:[eax+0x3C], 0x00               ; => [ Data: data_19e2778 ]
...
0075070E    pop ebp
0075070F    ret 0x10                                        ; => [ Data: lookup_table_7508d0 ]
...
0075071D    push edi
0075071E    call dword ptr ds:[0x007753D8]                  ; => [ Data: lookup_table_7508d0 | String: Wprc ]
00750724    push 0x88FEE8
00750729    push edi
0075072A    call dword ptr ds:[0x00775418]                  ; => [ String: Wprc ]
...
0075074E    call 0x0074DF30                                 ; => [ Call: sub_74df30 ]
...
00750784    push ecx                                        ; => [ Type: HANDLE ]
00750785    push dword ptr ss:[ebp+0x14]
00750788    mov ecx, edi
0075078A    call 0x0074E640                                 ; => [ Call: sub_74e640 ]
...
007507AF    push eax
007507B0    call 0x0074D1B0                                 ; => [ Call: sub_74d1b0 ]
...
007507D8    push eax
007507D9    call 0x0074D1B0                                 ; => [ Call: sub_74d1b0 ]
...
007507FB    push eax
007507FC    call 0x0074D590                                 ; => [ Call: sub_74d590 ]
...
0075081E    push eax
0075081F    call 0x0074D7E0                                 ; => [ Call: sub_74d7e0 ]
...
00750839    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
00750852    push 0x00
00750854    push dword ptr ds:[eax+0x1C]                    ; => [ Type: HWND ]
...
00750876    call esi                                        ; => [ Data: data_19e2778 ]
00750878    mov esi, dword ptr ds:[0x007753E0]
0075087E    jmp 0x00750887
00750880    mov dword ptr ds:[edx+0x08], 0x88FF00           ; => [ Data: data_88ff00 ]
00750887    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
007508AF    pop ebp
007508B0    ret 0x10                                        ; => [ String: Wprc | String: Wprc | String: Wprc | String: Wprc | Data: lookup_table_7508d0 | String: Wprc | String: Wprc ]
