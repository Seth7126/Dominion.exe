...
006E4C45    push 0x7711E6                                   ; => [ Type: EHRegistrationNode | Call: sub_7711e6 ]
006E4C4A    mov eax, dword ptr fs:[0x00000000]
006E4C50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006E4C5E    push eax                                        ; => [ Data: __security_cookie ]
006E4C5F    lea eax, ss:[ebp-0x0C]
006E4C62    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E4C79    call 0x006E1D60                                 ; => [ Call: sub_6e1d60 ]
...
006E4CB0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E4CD0    jz 0x006E4D77                                   ; => [ Data: data_cf65bc ]
...
006E4CF6    jz 0x006E4D19                                   ; => [ String: linear | String: wave ]
...
006E4D4E    jz 0x006E4D77                                   ; => [ Data: data_cf65bc ]
...
006E4D5F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E4D72    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E4D77    mov eax, esi
006E4D79    mov ecx, dword ptr ss:[ebp-0x0C]
006E4D7C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E4D83    pop ecx
006E4D84    pop edi
006E4D85    pop esi
006E4D86    pop ebx
