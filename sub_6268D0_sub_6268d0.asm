...
006268E1    xor eax, esp                                    ; => [ Data: __security_cookie ]
006268E3    mov dword ptr ss:[esp+0x94], eax
006268EA    mov ecx, dword ptr ds:[0x0171E94C]              ; => [ Data: data_171e94c ]
006268F0    push esi
006268F1    push edi
006268F2    test ecx, ecx
006268F4    jnz 0x00626914
006268F6    push 0x874440                                   ; => [ String: UI2DefGet ]
006268FB    push 0xC16
00626900    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
00626905    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
0062690A    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
0062690F    jmp 0x00626CEC
00626914    cmp dword ptr ds:[ecx+0x04], 0x22
00626918    jz 0x00626933
0062691A    push 0x874440                                   ; => [ String: UI2DefGet ]
0062691F    push 0xC17
00626924    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
00626929    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
0062692E    jmp 0x00626CE7
00626933    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
00626938    cmp dword ptr ds:[eax+0x08], 0x00
0062693C    jnz 0x00626947
0062693E    movups xmm0, xmmword ptr ds:[0x007FF520]        ; => [ Data: data_7ff520 ]
...
0062695A    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: nullptr | Call: sub_64f140 ]
...
00626991    mov edx, dword ptr ds:[0x00CF6494]              ; => [ Data: data_cf6494 ]
...
006269D4    call 0x006261F0                                 ; => [ Call: sub_6261f0 ]
006269D9    mov edx, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
006269DF    mov edi, eax
006269E1    mov esi, dword ptr ds:[0x00CF6494]              ; => [ Data: data_cf6494 ]
...
00626A03    jnz 0x00626A0C                                  ; => [ Data: data_8db5c4 ]
00626A05    mov eax, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
00626A0A    jmp 0x00626A1C
00626A0C    xor eax, eax
00626A0E    cmp dword ptr ds:[0x008DB5D4], 0x27
00626A15    cmovz eax, dword ptr ds:[0x008DB5D8]            ; => [ Data: data_8db5d4 | Data: data_8db5d8 ]
00626A1C    push 0x870C6C
00626A21    push eax
00626A22    mov ecx, 0x1A9665C
00626A27    call 0x004BB9F0                                 ; => [ Data: data_1a9665c | String: grpScore | Call: sub_4bb9f0 ]
00626A2C    inc edi
...
00626A41    add eax, esi                                    ; => [ Call: sub_4b95e0 ]
00626A43    test esi, esi
00626A45    cmovns eax, esi
00626A48    cmp dword ptr ds:[0x008DB5C4], 0x27
00626A4F    jnz 0x00626A59                                  ; => [ Data: data_8db5c4 ]
00626A51    mov esi, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
00626A57    jmp 0x00626A69
00626A59    xor esi, esi
00626A5B    cmp dword ptr ds:[0x008DB5D4], 0x27
00626A62    cmovz esi, dword ptr ds:[0x008DB5D8]            ; => [ Data: data_8db5d4 | Data: data_8db5d8 ]
...
00626AA4    jnz 0x00626AAD                                  ; => [ Data: data_1a96664 | Data: data_1a96668 | Data: data_1a96660 | String: grpOpponentScore | Data: data_1a96670 | Data: data_1a9666c | String: tbl_opponents | Data: data_1a9665c ]
00626AA6    mov eax, dword ptr ds:[0x01A9667C]              ; => [ Data: data_1a9667c ]
00626AAB    jmp 0x00626B25
00626AAD    push edi
00626AAE    mov edx, 0x86FA90
00626AB3    mov ecx, esi
00626AB5    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
00626ABA    add esp, 0x04
00626ABD    test eax, eax
00626ABF    jnz 0x00626AC8
00626AC1    mov dword ptr ds:[0x01A9667C], eax              ; => [ Data: data_1a9667c ]
00626AC6    jmp 0x00626B25
00626AC8    mov edx, 0x870CAC
00626ACD    mov ecx, eax
00626ACF    call 0x0067BD70                                 ; => [ Call: sub_67bd70 | String: grpOpponentScore ]
...
00626AE3    call 0x0064C870                                 ; => [ Call: nullptr | Call: sub_64c870 | Call: sub_64e7a0 ]
00626AE8    mov dword ptr ds:[0x01A9667C], eax              ; => [ Data: data_1a9667c ]
00626AED    test eax, eax
00626AEF    jz 0x00626B25
00626AF1    mov dword ptr ds:[0x01A9665C], esi              ; => [ Data: data_1a9665c ]
00626AF7    mov dword ptr ds:[0x01A96660], 0x86FA90         ; => [ String: tbl_opponents | Data: data_1a96660 ]
00626B01    mov dword ptr ds:[0x01A96664], edi              ; => [ Data: data_1a96664 ]
00626B07    mov dword ptr ds:[0x01A96668], 0x870CAC         ; => [ String: grpOpponentScore | Data: data_1a96668 ]
00626B11    mov dword ptr ds:[0x01A9666C], 0x00             ; => [ Data: data_1a9666c ]
00626B1B    mov dword ptr ds:[0x01A96670], 0x00             ; => [ Data: data_1a96670 ]
...
00626B34    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00626B7E    call 0x00655430                                 ; => [ Call: sub_655430 ]
00626B83    add esp, 0x04
00626B86    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
00626B8D    movups xmm0, xmmword ptr ds:[eax]
00626B90    movups xmmword ptr ss:[esp+0x70], xmm0
00626B95    jnz 0x00626B9F
00626B97    mov ecx, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
00626B9D    jmp 0x00626BAE
00626B9F    cmp dword ptr ds:[0x008DB5D4], 0x27
00626BA6    jnz 0x00626BEB                                  ; => [ Data: data_8db5d4 ]
00626BA8    mov ecx, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
...
00626BCF    jnz 0x00626BEB                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
00626BD1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00626BF2    movups xmmword ptr ss:[esp+0x50], xmm0          ; => [ Data: data_bf21e8 | Data: data_bf21e8 | Data: data_bf21e8 ]
00626BF7    movups xmm0, xmmword ptr ds:[0x00BF21F8]        ; => [ Data: data_bf21f8 | Data: data_bf21f8 | Data: data_bf21f8 ]
...
00626C70    xorps xmm0, xmmword ptr ds:[0x008937C0]         ; => [ Data: data_8937c0 ]
...
00626C9A    call 0x00658160                                 ; => [ Call: sub_658160 ]
...
00626CBA    call 0x00666060                                 ; => [ Call: sub_666060 ]
00626CBF    mov ecx, dword ptr ss:[esp+0x9C]
00626CC6    pop edi
00626CC7    pop esi
00626CC8    xor ecx, esp
00626CCA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00626CCF    mov esp, ebp
00626CD1    pop ebp
00626CD2    ret
00626CD3    push 0x86B77C                                   ; => [ String: ScoresBreakdownUpdate ]
00626CD8    push 0xEF53
00626CDD    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00626CE2    mov ecx, 0x870F84                               ; => [ String: RectTopLeft(taptipBoundary) == V20 ]
00626CE7    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00626CEC    call 0x0063B870                                 ; => [ Call: sub_63b870 ]
00626CF1    add esp, 0x0C
00626CF4    call 0x0063BC30
00626CF9    test al, al
00626CFB    jz 0x00626CFE                                   ; => [ Call: sub_63bc30 ]
00626CFD    int3
00626CFE    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
