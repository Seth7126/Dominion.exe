...
005AC6BA    call esi
005AC6BC    mov edi, dword ptr ds:[0x00B4A5C4]
005AC6C2    mov edx, dword ptr ds:[0x00B4A5C0]
...
005AC70A    call 0x0069EC60
005AC70F    mov ecx, dword ptr ds:[esi+0x507C]
005AC715    call 0x0069ED20
005AC71A    mov dword ptr ds:[esi+0x507C], 0x00
005AC724    mov edi, dword ptr ds:[0x00B4A5C4]
005AC72A    mov edx, dword ptr ds:[0x00B4A5C0]
...
005AC75F    mov esi, dword ptr ds:[0x00B4A5DC]
...
005AC77A    call 0x0064C080
005AC77F    test esi, esi
005AC781    jnz 0x005AC770
005AC783    mov esi, dword ptr ds:[0x00775144]
005AC789    push 0xB4A5E8
005AC78E    mov dword ptr ds:[0x00B4A5E4], 0x00
005AC798    mov dword ptr ds:[0x00B4A5DC], 0x00
005AC7A2    mov dword ptr ds:[0x00B4A5E0], 0x00
005AC7AC    call esi
