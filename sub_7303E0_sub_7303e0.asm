...
00730407    mov dword ptr fs:[0x00000000], eax
...
00730423    call 0x004ACB60
00730428    mov eax, dword ptr ds:[0x007FEFAC]
0073042D    xor esi, esi
0073042F    movss xmm3, dword ptr ds:[0x00890E18]
00730437    movss dword ptr ss:[ebp-0x78], xmm0
0073043C    movss xmm0, dword ptr ds:[0x00CF660C]
00730444    movss dword ptr ss:[ebp-0x70], xmm0
00730449    movss xmm0, dword ptr ds:[0x00CF6610]
...
00730478    mov dword ptr ss:[ebp-0x218], esi
0073047E    nop
...
007304C8    xorps xmm1, xmm1
007304CB    mov dword ptr ss:[ebp-0x34], 0xBF800000
007304D2    xorps xmm3, xmm3
...
00730513    xorps xmm2, xmm2
00730516    xorps xmm3, xmm3
...
0073052B    xorps xmm1, xmm1
0073052E    xorps xmm2, xmm2
...
007306EB    movups xmmword ptr ss:[ebp-0x254], xmm0
...
007308E5    mov dword ptr ds:[0x01A9A3CC], eax
007308EA    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
007308F1    call 0x007596BD
007308F6    add esp, 0x04
007308F9    mov ecx, dword ptr ds:[0x01A9A3C4]
007308FF    cmp dword ptr ds:[ecx+0x04], 0x02
00730903    jnz 0x00730BA5
00730909    call 0x005AF880
...
00730924    call 0x006E1520
00730929    mov eax, dword ptr ds:[0x0147ABB4]
0073092E    xor esi, esi
00730930    mov dword ptr ds:[0x0147ABB4], 0x02
...
0073099A    movups xmmword ptr ss:[ebp-0x20C], xmm0
...
00730A0C    mov dword ptr ds:[0x0147ABB4], eax
00730A11    call 0x006E1520
00730A16    call 0x006ADB80
...
00730A49    push 0x871DD4
00730A4E    push 0x94
00730A53    push 0x871D5C
00730A58    mov ecx, 0x871E0C
00730A5D    jmp 0x00730BCF
00730A62    mov edx, eax
00730A64    lea ecx, ss:[ebp-0x218]
00730A6A    call 0x0063D720
...
00730AD5    call 0x0064BE70
00730ADA    mov esi, dword ptr ds:[edi]
00730ADC    mov ecx, 0x88E47C
...
00730B57    jz 0x00730B77
00730B59    lea ecx, ss:[ebp-0x218]
00730B5F    call 0x0063D4E0
...
00730B72    call 0x0064C080
00730B77    mov eax, edi
00730B79    mov ecx, dword ptr ss:[ebp-0x0C]
00730B7C    mov dword ptr fs:[0x00000000], ecx
00730B83    pop ecx
00730B84    pop edi
00730B85    pop esi
00730B86    mov ecx, dword ptr ss:[ebp-0x10]
00730B89    xor ecx, ebp
00730B8B    call 0x0075927A
00730B90    mov esp, ebp
00730B92    pop ebp
00730B93    ret
00730B94    push 0x88E484
00730B99    push 0x24C
00730B9E    mov ecx, 0x88E3FC
00730BA3    jmp 0x00730BCA
00730BA5    push 0x87A528
00730BAA    push 0x313
00730BAF    push 0x87A2E0
00730BB4    mov ecx, 0x87A4FC
00730BB9    jmp 0x00730BCF
00730BBB    push 0x88E484
00730BC0    push 0x228
00730BC5    mov ecx, 0x801AA4
00730BCA    push 0x88E364
00730BCF    mov edx, 0x801800
00730BD4    call 0x0063B870
00730BD9    add esp, 0x0C
00730BDC    call 0x0063BC30
00730BE1    test al, al
00730BE3    jz 0x00730BE6
00730BE5    int3
00730BE6    call 0x0063BB00
