...
006AED5F    mov dword ptr fs:[0x00000000], eax
006AED65    push dword ptr ss:[ebp+0x0C]
006AED68    add ecx, 0x38
006AED6B    call 0x006B2EC0
006AED70    mov edi, eax
006AED72    cmp dword ptr ds:[edi], 0x02
006AED75    jz 0x006AED90
006AED77    push 0x87BC48
006AED7C    push 0x2B9
006AED81    push 0x87B990
006AED86    mov ecx, 0x87BC18
...
006AEDF5    call 0x0064C080
006AEDFA    mov dword ptr ss:[ebp+0x0C], 0x801800
...
006AEE7C    mov dword ptr ds:[edi+0x08], eax
...
006AEEB8    mov dword ptr fs:[0x00000000], ecx
006AEEBF    pop ecx
006AEEC0    pop edi
006AEEC1    pop esi
006AEEC2    pop ebx
...
006AEEC5    pop ebp
006AEEC6    ret 0x18
006AEEC9    push 0x828280
006AEECE    push 0x19
006AEED0    push 0x82829C
006AEED5    mov ecx, 0x8282BC
006AEEDA    mov edx, 0x801800
006AEEDF    call 0x0063B870
006AEEE4    add esp, 0x0C
006AEEE7    call 0x0063BC30
006AEEEC    test al, al
006AEEEE    jz 0x006AEEF1
006AEEF0    int3
006AEEF1    call 0x0063BB00
006AEEF6    push 0x87BC48
006AEEFB    push 0x2C5
006AEF00    push 0x87B990
006AEF05    mov edx, 0x801800
006AEF0A    mov ecx, 0x87BCC0
006AEF0F    call 0x0063B870
006AEF14    add esp, 0x0C
006AEF17    call 0x0063BC30
006AEF1C    test al, al
006AEF1E    jz 0x006AEF21
006AEF20    int3
006AEF21    call 0x0063BB00
