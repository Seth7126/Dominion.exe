...
004BBBB5    push 0x762C40                                   ; => [ Call: __ehhandler$?_Move@?$_Func_impl_no_alloc@V<lambda_1>@?1??initialize_source@?$source_block@V?$multi_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@V?$ordered_message_processor@I@2@@Concurrency@@IAEXPAVScheduler@4@PAVScheduleGroup@4@@Z@XPAV?$message@I@4@@std@@EAEPAV?$_Func_base@XPAV?$message@I@Concurrency@@@2@PAX@Z | Type: EHRegistrationNode ]
004BBBBA    mov eax, dword ptr fs:[0x00000000]
004BBBC0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004BBBC1    push ecx
004BBBC2    push esi
004BBBC3    push edi
004BBBC4    mov eax, dword ptr ds:[0x008C4040]
004BBBC9    xor eax, ebp
004BBBCB    push eax                                        ; => [ Data: __security_cookie ]
004BBBCC    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004BBBCF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004BBBD5    mov esi, ecx
004BBBD7    mov dword ptr ss:[ebp-0x04], 0x00
004BBBDE    cmp dword ptr ds:[0x00CF65BC], 0x00
004BBBE5    jz 0x004BBC1E                                   ; => [ Data: data_cf65bc ]
...
004BBBFC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BBC0F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BBC14    mov dword ptr ds:[esi+0x1D4], 0x801800          ; => [ Data: data_801800 ]
004BBC1E    mov dword ptr ss:[ebp-0x04], 0x01
004BBC25    cmp dword ptr ds:[0x00CF65BC], 0x00
004BBC2C    jz 0x004BBC65                                   ; => [ Data: data_cf65bc ]
...
004BBC43    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BBC56    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BBC5B    mov dword ptr ds:[esi+0x1C4], 0x801800          ; => [ Data: data_801800 ]
004BBC65    mov dword ptr ss:[ebp-0x04], 0x02
004BBC6C    cmp dword ptr ds:[0x00CF65BC], 0x00
004BBC73    jz 0x004BBCAC                                   ; => [ Data: data_cf65bc ]
...
004BBC8A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BBC9D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BBCA2    mov dword ptr ds:[esi+0x1C0], 0x801800          ; => [ Data: data_801800 ]
004BBCAC    mov dword ptr ss:[ebp-0x04], 0x03
004BBCB3    cmp dword ptr ds:[0x00CF65BC], 0x00
004BBCBA    jz 0x004BBCF3                                   ; => [ Data: data_cf65bc ]
...
004BBCD1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BBCE4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BBCE9    mov dword ptr ds:[esi+0x1BC], 0x801800          ; => [ Data: data_801800 ]
004BBCF3    mov dword ptr ss:[ebp-0x04], 0x04
004BBCFA    cmp dword ptr ds:[0x00CF65BC], 0x00
004BBD01    jz 0x004BBD3A                                   ; => [ Data: data_cf65bc ]
...
004BBD18    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BBD2B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BBD30    mov dword ptr ds:[esi+0x1B8], 0x801800          ; => [ Data: data_801800 ]
004BBD3A    mov ecx, dword ptr ss:[ebp-0x0C]
004BBD3D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004BBD44    pop ecx
004BBD45    pop edi
004BBD46    pop esi
