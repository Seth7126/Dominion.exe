...
006E8A55    push 0x77173D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0ThreadProxyFactoryManager@details@Concurrency@@QAE@XZ ]
006E8A5A    mov eax, dword ptr fs:[0x00000000]
006E8A60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E8A61    push ecx
006E8A62    push ebx
006E8A63    push esi
006E8A64    push edi
...
006E8A6C    push eax                                        ; => [ Data: __security_cookie ]
006E8A6D    lea eax, ss:[ebp-0x0C]
006E8A70    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006E8A76    mov dword ptr ss:[ebp-0x04], 0x00
006E8A7D    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
006E8A92    push 0x00
006E8A94    call 0x006A70C0                                 ; => [ Call: sub_6a70c0 | Data: data_1777580 | Call: nullptr ]
...
006E8AED    jz 0x006E8B16                                   ; => [ Data: data_cf65bc ]
...
006E8AFE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E8B11    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E8B16    mov al, bl
006E8B18    mov ecx, dword ptr ss:[ebp-0x0C]
006E8B1B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E8B22    pop ecx
006E8B23    pop edi
006E8B24    pop esi
006E8B25    pop ebx
