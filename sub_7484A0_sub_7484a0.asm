...
007484A8    call 0x00761E50                                 ; => [ Call: __chkstk ]
007484AD    mov eax, dword ptr ds:[0x008C4040]
007484B2    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
007484C8    jle 0x0074865A                                  ; => [ Data: data_151345c ]
007484CE    nop
007484D0    mov ecx, dword ptr ds:[0x01512450]              ; => [ Data: data_1512450 ]
007484D6    cmp dword ptr ds:[ecx+0x04], 0x1E
007484DA    jnz 0x007486BE
007484E0    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
007484F4    call 0x0069DD00                                 ; => [ Call: sub_69dd00 | Data: data_17774dc ]
007484F9    add esp, 0x04
007484FC    mov edx, eax
007484FE    mov ecx, edi
00748500    call 0x006FB630                                 ; => [ Call: sub_6fb630 ]
...
0074852B    call 0x00744F10                                 ; => [ Call: sub_744f10 | Call: nullptr | Data: data_151245c ]
...
00748554    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0074858D    call 0x00687730                                 ; => [ Call: sub_687730 ]
00748592    push esi
00748593    push ebx
00748594    push eax
00748595    mov dword ptr ds:[edi+0x08], eax
00748598    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
007485CC    call 0x00687730                                 ; => [ Call: sub_687730 ]
007485D1    push esi
007485D2    push ebx
007485D3    push eax
007485D4    mov dword ptr ds:[edi+0x120], eax
007485DA    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0074860E    call 0x00687730                                 ; => [ Call: sub_687730 ]
00748613    push esi
00748614    push ebx
00748615    push eax
00748616    mov dword ptr ds:[edi+0xE0], eax
0074861C    call 0x00761FBE                                 ; => [ Call: memcpy ]
00748621    mov ecx, dword ptr ds:[0x01512458]              ; => [ Data: data_1512458 ]
...
0074863A    mov dword ptr ds:[0x01512458], eax              ; => [ Data: data_1512458 ]
...
00748654    jl 0x007484D0                                   ; => [ Data: data_151345c ]
0074865A    call 0x00748410                                 ; => [ Call: sub_748410 ]
...
00748677    call 0x00761FBE                                 ; => [ Data: data_151345c | Call: memcpy | Data: data_151245c ]
0074867C    add esp, 0x0C
0074867F    lea ecx, ds:[esi+0x01]
00748682    call 0x0074AE80                                 ; => [ Call: sub_74ae80 ]
00748687    mov ecx, dword ptr ds:[0x01512450]
0074868D    call 0x006F6E30                                 ; => [ Call: sub_6f6e30 | Data: data_1512450 ]
00748692    call 0x0074AC70                                 ; => [ Type: LRESULT | Call: sub_74ac70 ]
00748697    mov ecx, dword ptr ss:[ebp-0x04]
0074869A    pop edi
0074869B    pop esi
0074869C    xor ecx, ebp
0074869E    pop ebx
0074869F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007486A4    mov esp, ebp
007486A6    pop ebp
007486A7    ret
007486A8    push 0x8795E0                                   ; => [ String: DefDeepCopyString ]
007486AD    push 0x25B
007486B2    push 0x879400                                   ; => [ String: C:\x\ax2017\Engine\Definition.cpp ]
007486B7    mov ecx, 0x8795D0                               ; => [ String: pExistingString ]
007486BC    jmp 0x007486D2
007486BE    push 0x8790A8                                   ; => [ String: UIDefGet ]
007486C3    push 0x127
007486C8    push 0x878EA8                                   ; => [ String: C:\x\ax2017\Engine\UIDef.cpp ]
007486CD    mov ecx, 0x8790C8                               ; => [ String: ptr->assetType == ASSET_TYPE_UI ]
007486D2    mov edx, 0x801800
007486D7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
007486DC    add esp, 0x0C
007486DF    call 0x0063BC30
007486E4    test al, al
007486E6    jz 0x007486E9                                   ; => [ Call: sub_63bc30 ]
007486E8    int3
007486E9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
