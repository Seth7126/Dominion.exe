...
004AB2D7    call 0x0064C080
004AB2DC    mov dword ptr ds:[esi], 0x801800
004AB2E2    mov ecx, dword ptr ss:[ebp-0x0C]
004AB2E5    mov dword ptr fs:[0x00000000], ecx
004AB2EC    pop ecx
004AB2ED    pop esi
