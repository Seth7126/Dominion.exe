...
006A9259    mov eax, dword ptr ds:[edi+0x10]                ; => [ Type: HANDLE ]
006A925C    mov ebx, dword ptr ds:[edi+0x0C]                ; => [ Type: HANDLE ]
006A925F    mov esi, dword ptr ds:[edi+0x14]                ; => [ Type: HANDLE ]
006A9262    mov dword ptr ss:[ebp-0x04], eax
006A9265    mov eax, dword ptr ds:[edi]                     ; => [ Type: BOOL ]
...
006A927E    call dword ptr ds:[0x0077510C]                  ; => [ Call: nullptr ]
006A9284    test eax, eax
006A9286    jnz 0x006A929A
006A9288    push 0x87B07C                                   ; => [ String: mutex_release ]
006A928D    push 0x83
...
006A92AA    call esi
006A92AC    push ebx
006A92AD    mov dword ptr ds:[0x0147B068], 0x00             ; => [ Data: data_147b068 ]
006A92B7    call esi
...
006A92CF    pop ebp
006A92D0    ret                                             ; => [ Call: sub_64c080 ]
006A92D1    push 0x87B0C4                                   ; => [ String: co_destroy_android10 ]
006A92D6    push 0x15A
006A92DB    push 0x87B044
006A92E0    mov edx, 0x801800
006A92E5    mov ecx, 0x801AA4
006A92EA    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: Halt | String: C:\x\ax2017\Engine\Coroutine.cpp ]
006A92EF    add esp, 0x0C
006A92F2    call 0x0063BC30
006A92F7    test al, al
006A92F9    jz 0x006A92FC                                   ; => [ Call: sub_63bc30 ]
006A92FB    int3
006A92FC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
