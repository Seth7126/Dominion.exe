...
006F6B05    push 0x77211F                                   ; => [ Type: EHRegistrationNode | Call: sub_77211f ]
006F6B0A    mov eax, dword ptr fs:[0x00000000]
006F6B10    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006F6B1E    push eax                                        ; => [ Data: __security_cookie ]
006F6B1F    lea eax, ss:[ebp-0x0C]
006F6B22    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006F6B28    mov esi, ecx
006F6B2A    xor edi, edi
006F6B2C    push 0xAB
006F6B31    mov dword ptr ss:[ebp-0x18], edi
006F6B34    push dword ptr ds:[0x0147D470]
006F6B3A    call dword ptr ds:[0x007752FC]                  ; => [ Data: data_147d470 | Type: HWND ]
006F6B40    push edi
006F6B41    push edi
006F6B42    push 0x184
006F6B47    push eax
006F6B48    mov dword ptr ss:[ebp-0x2C], eax
006F6B4B    call dword ptr ds:[0x00775308]                  ; => [ Type: LRESULT ]
006F6B51    cmp dword ptr ds:[esi+0x04], 0x20
006F6B55    jz 0x006F6B70
006F6B57    push 0x87ECE4                                   ; => [ String: FabDefGet ]
006F6B5C    push 0xEB
006F6B61    push 0x87ED1C                                   ; => [ String: C:\x\ax2017\Engine\FabDef.cpp ]
006F6B66    mov ecx, 0x87ECF8                               ; => [ String: ptr->assetType == ASSET_TYPE_FAB ]
006F6B6B    jmp 0x006F6E05
006F6B70    mov ecx, esi
006F6B72    call 0x005AF880                                 ; => [ Call: sub_5af880 | Type: LRESULT ]
006F6B77    mov esi, eax                                    ; => [ Type: LRESULT ]
006F6B79    mov dword ptr ss:[ebp-0x24], edi
006F6B7C    mov dword ptr ss:[ebp-0x28], esi                ; => [ Type: LRESULT ]
...
006F6BA1    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
006F6BC2    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: - ]
...
006F6BDD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6BF0    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006F6BF5    cmovnz ecx, eax
006F6BF8    push ecx
006F6BF9    lea ecx, ss:[ebp-0x14]
006F6BFC    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006F6C01    lea eax, ss:[ebp-0x14]
006F6C04    push eax
006F6C05    lea ecx, ss:[ebp-0x10]
006F6C08    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006F6C1E    jz 0x006F6C4E                                   ; => [ Data: data_cf65bc ]
...
006F6C2F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6C42    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F6C47    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006F6C62    jz 0x006F6C86                                   ; => [ Data: data_cf65bc ]
006F6C64    lea ecx, ss:[ebp-0x1C]
006F6C67    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6C7A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F6C7F    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
006F6CA2    call 0x0063D720                                 ; => [ String: * | Call: sub_63d720 ]
...
006F6CBD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6CD0    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006F6CD5    cmovnz ecx, eax
006F6CD8    push ecx
006F6CD9    lea ecx, ss:[ebp-0x14]
006F6CDC    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006F6CE1    lea eax, ss:[ebp-0x14]
006F6CE4    push eax
006F6CE5    lea ecx, ss:[ebp-0x10]
006F6CE8    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006F6CFE    jz 0x006F6D2E                                   ; => [ Data: data_cf65bc ]
...
006F6D0F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6D22    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F6D27    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006F6D42    jz 0x006F6D66                                   ; => [ Data: data_cf65bc ]
006F6D44    lea ecx, ss:[ebp-0x20]
006F6D47    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6D5A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F6D5F    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
006F6D66    mov esi, dword ptr ss:[ebp-0x10]
006F6D69    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
006F6D9B    jz 0x006F6DBF                                   ; => [ Data: data_cf65bc ]
006F6D9D    lea ecx, ss:[ebp-0x10]
006F6DA0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F6DB3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F6DB8    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006F6DE2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F6DE9    pop ecx
006F6DEA    pop edi
006F6DEB    pop esi
006F6DEC    pop ebx
...
006F6DEF    pop ebp
006F6DF0    ret
006F6DF1    push 0x871DD4                                   ; => [ String: XString::XString ]
006F6DF6    push 0x94
006F6DFB    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
006F6E00    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
006F6E05    mov edx, 0x801800
006F6E0A    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006F6E0F    add esp, 0x0C
006F6E12    call 0x0063BC30
006F6E17    test al, al
006F6E19    jz 0x006F6E1C                                   ; => [ Call: sub_63bc30 ]
006F6E1B    int3
006F6E1C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
