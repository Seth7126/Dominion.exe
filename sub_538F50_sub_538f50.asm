...
00538FDA    mov eax, dword ptr ds:[eax+0x1504]
...
005390BC    mov eax, dword ptr ds:[eax+0x1504]
...
005390F4    setz cl
005390F7    call 0x0061B1B0
005390FC    add esp, 0x2C
005390FF    call 0x00573400
