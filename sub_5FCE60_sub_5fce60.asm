...
005FCE6B    call 0x00761E50                                 ; => [ Call: __chkstk ]
...
005FCE84    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
005FCEAF    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
005FCEB4    push ebx
005FCEB5    lea ecx, ds:[esi+0x04]
005FCEB8    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
005FCEE8    push eax
005FCEE9    call 0x00761FBE                                 ; => [ Call: memcpy | Call: sub_4deeb0 ]
005FCEEE    add esp, 0x0C
005FCEF1    lea ecx, ss:[esp+0x10]
005FCEF5    call 0x004E4560
005FCEFA    mov dword ptr ds:[esi+0x08], eax                ; => [ Call: sub_4e4560 ]
005FCEFD    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
005FCF03    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
...
005FCF2F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: DomSetSaveNew | Data: data_801800 | String: sets.numSets < MAX_SAVE_SETS ]
005FCF34    add esp, 0x0C
005FCF37    call 0x0063BC30
005FCF3C    test al, al
005FCF3E    jz 0x005FCF41                                   ; => [ Call: sub_63bc30 ]
005FCF40    int3
005FCF41    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
