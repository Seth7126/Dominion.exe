...
00628379    mov esi, 0x780878                               ; => [ Data: data_780878 ]
0062837E    nop
...
0062839A    jnz 0x00628380                                  ; => [ Data: data_78314c ]
...
006283AE    call 0x004E3950                                 ; => [ Call: sub_4e3950 ]
...
006283C8    push 0x86BBF0                                   ; => [ String: GameSpecific_UpdateStoreItem ]
006283CD    push 0xF4AE
006283D2    jmp 0x006285FE
006283D7    mov ebx, 0xBF1168                               ; => [ Data: data_bf1168 ]
006283DC    jmp 0x006283EA
006283DE    mov ebx, 0xBF115C                               ; => [ Data: data_bf115c ]
006283E3    jmp 0x006283EA
006283E5    mov ebx, 0xBF1150                               ; => [ Data: data_bf1150 ]
006283EA    mov esi, dword ptr ss:[ebp-0x0C]
006283ED    mov ecx, esi
006283EF    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
006283F4    movss xmm3, dword ptr ds:[0x00890E18]
006283FC    mov edx, ebx
006283FE    push 0x00
00628400    push 0xFFFFFFFF
00628402    mov ecx, eax
00628404    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
0062857C    jz 0x0062859E                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
0062857E    mov ecx, esi
00628580    call 0x0067BD70                                 ; => [ Call: sub_67bd70 ]
...
006285AA    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
006285C6    push 0x00
006285C8    call 0x005E0DF0                                 ; => [ Call: nullptr | Call: sub_5e0df0 | Call: sub_5e01b0 ]
006285CD    mov ecx, dword ptr ss:[ebp-0x10]
006285D0    add esp, 0x10
006285D3    mov edx, esi
006285D5    call 0x005DEFB0                                 ; => [ Call: sub_5defb0 ]
...
006285F2    pop ebp
006285F3    ret
006285F4    push 0x86BBF0                                   ; => [ String: GameSpecific_UpdateStoreItem ]
006285F9    push 0xF4BD
006285FE    push 0x86F1E8
00628603    mov edx, 0x801800
00628608    mov ecx, 0x801AA4
0062860D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: Halt | String: GameSpecific_UpdateStoreItem ]
00628612    add esp, 0x0C
00628615    call 0x0063BC30
0062861A    test al, al
0062861C    jz 0x0062861F                                   ; => [ Call: sub_63bc30 ]
0062861E    int3
0062861F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
