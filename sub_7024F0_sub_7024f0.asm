...
00702542    call 0x006A0F60
00702547    mov esi, dword ptr ds:[0x0147DED4]
0070254D    mov edx, eax
0070254F    test edx, edx
00702551    jnz 0x00702569
00702553    push 0x88D514
00702558    push 0x6C
0070255A    push 0x80193C
0070255F    mov ecx, 0x802734
...
007025EA    mov eax, dword ptr ds:[0x0147DED4]
...
0070262B    push 0x88C598
00702630    push 0x30C
00702635    mov ecx, 0x88C570
0070263A    jmp 0x0070277B
0070263F    mov edx, esi
00702641    mov ecx, ebx
00702643    call 0x006FEC70
...
007026AE    mov eax, dword ptr ds:[eax+edi*8+0x28]
...
007026C3    call eax
007026C5    mov eax, dword ptr ds:[0x0147DED4]
...
007026D3    pop ebp
007026D4    ret
007026D5    push 0x88D514
007026DA    push 0x6D
007026DC    push 0x80193C
007026E1    mov ecx, 0x802748
...
00702755    push edi
00702756    call eax
00702758    mov eax, dword ptr ds:[0x0147DED4]
...
0070276A    pop ebp
0070276B    ret
0070276C    push 0x88C644
00702771    push 0x37E
00702776    mov ecx, 0x88C60C
0070277B    push 0x88C504
00702780    mov edx, 0x801800
00702785    call 0x0063B870
0070278A    add esp, 0x0C
0070278D    call 0x0063BC30
00702792    test al, al
00702794    jz 0x00702797
00702796    int3
00702797    call 0x0063BB00
