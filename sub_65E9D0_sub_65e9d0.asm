...
0065E9D5    push 0x76D0DD                                   ; => [ Type: EHRegistrationNode | Call: sub_76d0dd ]
0065E9DA    mov eax, dword ptr fs:[0x00000000]
0065E9E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0065E9EE    push eax                                        ; => [ Data: __security_cookie ]
0065E9EF    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0065E9F2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0065EA09    push 0x874F4C                                   ; => [ String: TextEntryAlloc ]
0065EA0E    push 0x29D9
0065EA13    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
0065EA18    mov ecx, 0x874F7C                               ; => [ String: lineParams.currentEntryIdx == -1 ]
...
0065EA38    call 0x0065E2E0                                 ; => [ Call: sub_65e2e0 ]
...
0065EACC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065EADF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065EAE4    mov dword ptr ss:[ebp+0x0C], 0x801800           ; => [ Data: data_801800 ]
...
0065EB05    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
0065EB21    mulss xmm0, dword ptr ds:[ebx+0x20]             ; => [ Field: Next ]
...
0065EB44    call 0x0065E4E0                                 ; => [ Call: sub_65e4e0 ]
...
0065EB6F    call 0x0065E4E0                                 ; => [ Call: sub_65e4e0 ]
0065EB74    jmp 0x0065EB96
0065EB76    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
0065EB7B    push 0x19
0065EB7D    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
0065EB82    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
...
0065EBC4    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
0065EC0F    mov dword ptr ds:[ecx+eax*1-0x30], 0x00         ; => [ Call: __builtin_memset ]
...
0065EC96    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
...
0065ED0B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0065ED12    pop ecx
0065ED13    pop edi
0065ED14    pop esi
0065ED15    pop ebx
...
0065ED18    pop ebp
0065ED19    ret
0065ED1A    push 0x876A2C                                   ; => [ String: XDynArray<struct TextEntry>::operator [] ]
0065ED1F    push 0xD4
0065ED24    push 0x824FB0                                   ; => [ String: C:\x\ax2017\Engine\xDynArray.h ]
0065ED29    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
0065ED2E    mov edx, 0x801800
0065ED33    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0065ED38    add esp, 0x0C
0065ED3B    call 0x0063BC30
0065ED40    test al, al
0065ED42    jz 0x0065ED45                                   ; => [ Call: sub_63bc30 ]
0065ED44    int3
0065ED45    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
