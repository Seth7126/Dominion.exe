...
00758A10    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00758A15    push esi
00758A16    push edi
...
00758A24    push 0x34
00758A26    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\ClippingAttachment.c ]
00758A28    add esp, 0x0C
00758A2B    jmp 0x00758A38
00758A2D    push 0x34
00758A2F    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00758A35    add esp, 0x04
00758A38    mov esi, eax
00758A3A    test esi, esi
00758A3C    jz 0x00758A8A
00758A3E    mov dword ptr ds:[esi], 0x00                    ; => [ Call: __builtin_memset ]
