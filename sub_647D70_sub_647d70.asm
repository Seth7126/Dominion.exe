...
00647DFE    mov ecx, 0x801800
00647E03    test eax, eax
00647E05    cmovnz ecx, eax
00647E08    call 0x0069F030
...
00647E43    call 0x0064C080
00647E48    mov dword ptr ss:[ebp-0x68], 0x801800
00647E4F    mov eax, edi
00647E51    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00647E58    mov ecx, dword ptr ds:[0x0147ABE8]
...
00647E85    call 0x0069F4A0
00647E8A    mov ecx, dword ptr ds:[0x0147ABE8]
...
00647F54    movups xmmword ptr ss:[ebp-0xC8], xmm0
00647F5B    movaps xmm0, xmmword ptr ds:[0x00893480]
00647F62    movups xmmword ptr ss:[ebp-0x30], xmm0
00647F66    call 0x006444F0
...
00647F82    movups xmmword ptr ss:[ebp-0xC8], xmm0
...
00647FA0    push eax
00647FA1    movups xmmword ptr ss:[ebp-0x30], xmm0
00647FA5    call 0x006444F0
...
00647FC1    movups xmmword ptr ss:[ebp-0xC8], xmm0
...
00647FDF    push eax
00647FE0    movups xmmword ptr ss:[ebp-0x30], xmm0
00647FE4    call 0x006444F0
00647FE9    inc edi
00647FEA    add esp, 0x04
00647FED    cmp edi, dword ptr ss:[ebp-0x5C]
00647FF0    jl 0x00647ED0
00647FF6    mov ecx, dword ptr ds:[0x0147ABE8]
...
00648033    push 0x87A528
00648038    push 0x313
0064803D    push 0x87A2E0
00648042    mov ecx, 0x87A4FC
00648047    jmp 0x006483BF
0064804C    mov ecx, esi
0064804E    call 0x005AF880
...
00648110    movups xmmword ptr ss:[ebp-0xC8], xmm0
00648117    call 0x00644C70
...
0064813D    movups xmmword ptr ss:[ebp-0xC8], xmm0
00648144    call 0x006472E0
...
00648168    mov ecx, dword ptr ds:[0x0147ABE8]
...
006481FF    call 0x0064C080
00648204    mov dword ptr ss:[ebp-0x68], 0x801800
...
006482EC    movups xmmword ptr ss:[ebp-0xC8], xmm0
006482F3    call 0x006444F0
...
0064830D    movups xmmword ptr ss:[ebp-0xC8], xmm0
00648314    lea edx, ds:[edx-0x94]
0064831A    push eax
0064831B    call 0x00642E30
