...
006C72F8    push 0x770580                                   ; => [ Type: EHRegistrationNode | Call: sub_770580 ]
006C72FD    mov eax, dword ptr fs:[0x00000000]
006C7303    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C7304    push ebx
...
006C7315    push esi
006C7316    push edi
006C7317    push eax                                        ; => [ Data: __security_cookie ]
006C7318    lea eax, ss:[ebp-0x0C]
006C731B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C7321    mov esi, ecx                                    ; => [ Type: HDROP ]
006C7323    mov dword ptr ss:[ebp-0x14C], esi               ; => [ Type: HDROP ]
006C7329    push dword ptr ds:[0x0147B084]
006C732F    call dword ptr ds:[0x0077539C]                  ; => [ Data: data_147b084 ]
006C7335    mov eax, dword ptr ds:[0x0077527C]
006C733A    push 0x00
006C733C    push 0x00
006C733E    push 0xFFFFFFFF
006C7340    push esi
006C7341    mov dword ptr ss:[ebp-0x140], eax               ; => [ Type: HDROP ]
006C7347    call eax                                        ; => [ Call: nullptr ]
...
006C735E    mov dword ptr ss:[ebp-0x144], eax               ; => [ Type: WPARAM | Type: LPARAM | Type: HWND | Type: BOOL ]
006C7364    push 0x100
...
006C7382    movups xmmword ptr ss:[ebp-0x13C], xmm0         ; => [ String: 0 | String: zx ]
006C7389    mov dword ptr ss:[ebp-0x13C], 0x1C
006C7393    movups xmmword ptr ss:[ebp-0x12C], xmm0         ; => [ String: 0 | String: zx ]
006C739A    psrldq xmm0, 0x08
006C739F    movd eax, xmm0                                  ; => [ String: 0 | String: zx ]
...
006C73D5    jz 0x006C7404                                   ; => [ Data: data_cf65bc ]
...
006C73EC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C73FF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C7404    mov dword ptr ss:[ebp-0x124], 0x801800          ; => [ Data: data_801800 ]
006C740E    jmp 0x006C743B
006C7410    push 0x00
006C7412    mov edx, esi
006C7414    lea ecx, ss:[ebp-0x124]
006C741A    call 0x0063D5E0                                 ; => [ Call: sub_63d5e0 ]
...
006C7433    call 0x00761FBE                                 ; => [ Call: memcpy ]
006C7438    add esp, 0x0C
006C743B    mov edx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006C7441    test edx, edx
006C7443    jz 0x006C7733
006C7449    mov eax, dword ptr ss:[ebp-0x13C]
006C744F    mov esi, dword ptr ds:[0x0147AC28]              ; => [ Data: data_147ac28 ]
006C7455    add eax, 0xFFFFFFF3
006C7458    cmp eax, 0x0B
006C745B    jnbe 0x006C748F
006C745D    movzx eax, byte ptr ds:[eax+0x6C77C0]
006C7464    jmp dword ptr ds:[eax*4+0x6C77A8]               ; => [ Data: jump_table_6c77a8 ]
006C746B    mov eax, 0x02                                   ; => [ Data: lookup_table_6c77c0 ]
006C7470    jmp 0x006C748C
006C7472    mov eax, 0x03                                   ; => [ Data: lookup_table_6c77c0 ]
006C7477    jmp 0x006C748C
006C7479    mov eax, 0x04                                   ; => [ Data: lookup_table_6c77c0 ]
006C747E    jmp 0x006C748C
006C7480    mov eax, 0x06                                   ; => [ Data: lookup_table_6c77c0 ]
006C7485    jmp 0x006C748C
006C7487    mov eax, 0x07                                   ; => [ Data: lookup_table_6c77c0 ]
...
006C74E7    mov ecx, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
006C7509    call dword ptr ds:[eax+0xB4]                    ; => [ Data: data_147b070 ]
...
006C752F    jz 0x006C76EB                                   ; => [ Data: data_cf65b8 ]
...
006C7568    push 0x00
006C756A    push 0x10
006C756C    push dword ptr ds:[0x0147B084]                  ; => [ Data: data_147b084 ]
...
006C75CA    movups xmmword ptr ds:[0x0147D2B4], xmm0        ; => [ Data: data_800248 | Data: data_147d2b4 ]
006C75D1    mov edx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
006C761F    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006C7647    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
006C764C    mov dword ptr ds:[eax], 0x00
006C7652    jmp 0x006C7733
006C7657    mov ecx, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006C76F1    call 0x006CBE10                                 ; => [ Call: sub_6cbe10 ]
006C76F6    test al, al
006C76F8    jnz 0x006C7733
006C76FA    mov ecx, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
006C7758    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C776B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C778D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C7794    pop ecx
006C7795    pop edi
006C7796    pop esi
006C7797    mov ecx, dword ptr ss:[ebp-0x14]
006C779A    xor ecx, ebp
006C779C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
