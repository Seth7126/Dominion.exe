...
006EC541    mov dword ptr fs:[0x00000000], eax
...
006EC5C1    movups xmmword ptr ds:[ecx+esi*1], xmm0
...
006EC646    mov dword ptr fs:[0x00000000], ecx
006EC64D    pop ecx
006EC64E    pop edi
006EC64F    pop esi
...
006EC66D    call 0x0063B870
006EC672    add esp, 0x0C
006EC675    call 0x0063BC30
006EC67A    test al, al
006EC67C    jz 0x006EC67F
006EC67E    int3
006EC67F    call 0x0063BB00
