...
0069ED25    push 0x76F1C0                                   ; => [ Call: sub_76f1c0 | Type: EHRegistrationNode ]
0069ED2A    mov eax, dword ptr fs:[0x00000000]
0069ED30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0069ED3E    push eax                                        ; => [ Data: __security_cookie ]
0069ED3F    lea eax, ss:[ebp-0x0C]
0069ED42    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0069ED48    mov edi, ecx
0069ED4A    call 0x0069EC60                                 ; => [ Call: sub_69ec60 ]
0069ED4F    mov eax, dword ptr ds:[edi+0x20]
0069ED52    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0069ED57    mov ebx, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
0069ED5D    test eax, eax
0069ED5F    mov dword ptr ss:[ebp-0x18], ebx
0069ED62    cmovnz ecx, eax
0069ED65    xor edx, edx
0069ED67    call 0x0069C4D0                                 ; => [ Call: sub_69c4d0 ]
...
0069ED7E    mov dword ptr ss:[ebp-0x10], eax                ; => [ Call: nullptr ]
...
0069ED9C    test al, al
0069ED9E    jz 0x0069EDAB                                   ; => [ Call: sub_63d7f0 ]
...
0069EDCA    jz 0x0069EDF7                                   ; => [ Data: data_cf65bc ]
...
0069EDD9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069EDEC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069EDF1    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
0069EDF7    mov edx, 0x0C
0069EDFC    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0069EE03    mov ecx, esi
0069EE05    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069EE0A    mov eax, dword ptr ss:[ebp-0x18]
0069EE0D    dec dword ptr ds:[eax+0x08]
0069EE10    mov ebx, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
0069EE49    mov ebx, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
0069EE7A    jz 0x0069EEAA                                   ; => [ Data: data_cf65bc ]
...
0069EE8B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069EE9E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069EEA3    mov dword ptr ds:[edi+0x20], 0x801800           ; => [ Data: data_801800 ]
0069EEAA    mov dword ptr ss:[ebp-0x04], 0x02
0069EEB1    cmp dword ptr ds:[0x00CF65BC], 0x00
0069EEB8    jz 0x0069EEE8                                   ; => [ Data: data_cf65bc ]
...
0069EEC9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069EEDC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069EEE1    mov dword ptr ds:[edi+0x0C], 0x801800           ; => [ Data: data_801800 ]
...
0069EEF3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069EEFA    pop ecx
0069EEFB    pop edi
0069EEFC    pop esi
0069EEFD    pop ebx
...
0069EF1B    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\xAlloc.h | Data: data_801800 | String: IsPointerFromAllocator(pItem) | String: XTypedAllocator<struct XAsset>::Free ]
0069EF20    add esp, 0x0C
0069EF23    call 0x0063BC30
0069EF28    test al, al
0069EF2A    jz 0x0069EF2D                                   ; => [ Call: sub_63bc30 ]
0069EF2C    int3
0069EF2D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
