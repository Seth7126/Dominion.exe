...
0066CA95    push 0x76D48D                                   ; => [ Call: sub_76d48d | Type: EHRegistrationNode ]
0066CA9A    mov eax, dword ptr fs:[0x00000000]
0066CAA0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0066CAA1    sub esp, 0x18
0066CAA4    push ebx
0066CAA5    push esi
0066CAA6    push edi
0066CAA7    mov eax, dword ptr ds:[0x008C4040]
0066CAAC    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0066CAAE    push eax
0066CAAF    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0066CAB2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0066CAB8    mov bl, dl
0066CABA    test ecx, ecx
0066CABC    jz 0x0066CBEF
0066CAC2    movzx eax, cx
0066CAC5    cmp eax, dword ptr ds:[0x00C23BAC]
0066CACB    jnb 0x0066CBEF                                  ; => [ Data: data_c23bac ]
0066CAD1    imul eax, eax, 0x18D0
0066CAD7    add eax, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
0066CADD    cmp dword ptr ds:[eax+0x18C8], ecx
0066CAE3    jnz 0x0066CBEF
0066CAE9    mov edi, dword ptr ds:[0x00C23BE0]              ; => [ Data: data_c23be0 ]
0066CAEF    cmp edi, ecx
0066CAF1    jnz 0x0066CC0B
0066CAF7    mov ecx, edi
0066CAF9    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0066CAFE    mov esi, eax                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0066CB00    mov dword ptr ds:[0x00C23BE0], 0x00             ; => [ Data: data_c23be0 ]
...
0066CB24    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
0066CB4A    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0066CB61    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0066CB66    cmp byte ptr ss:[ebp+0x08], 0x00
0066CB6A    mov eax, dword ptr ds:[esi+0x16B0]
0066CB70    mov dword ptr ss:[ebp-0x18], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0066CB96    call 0x0066CA60                                 ; => [ Call: sub_66ca60 ]
...
0066CBB4    jz 0x0066CBF9                                   ; => [ Data: data_cf65bc ]
...
0066CBC5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0066CBD8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0066CBDD    mov ecx, dword ptr ss:[ebp-0x0C]
0066CBE0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0066CBE7    pop ecx
0066CBE8    pop edi
0066CBE9    pop esi
0066CBEA    pop ebx
...
0066CBED    pop ebp
0066CBEE    ret
0066CBEF    mov dword ptr ds:[0x00C23BE0], 0x00             ; => [ Data: data_c23be0 | Data: data_c23be0 | Data: data_c23be0 ]
0066CBF9    mov ecx, dword ptr ss:[ebp-0x0C]
0066CBFC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0066CC03    pop ecx
0066CC04    pop edi
0066CC05    pop esi
0066CC06    pop ebx
...
0066CC24    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | Data: data_801800 | String: UI2ClearFocus | String: gUI2.focus == handle ]
0066CC29    add esp, 0x0C
0066CC2C    call 0x0063BC30
0066CC31    test al, al
0066CC33    jz 0x0066CC36                                   ; => [ Call: sub_63bc30 ]
0066CC35    int3
0066CC36    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
