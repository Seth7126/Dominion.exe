...
0069C765    movzx eax, byte ptr ds:[eax+0x69C824]
...
0069C79D    push 0x8794AC
0069C7A2    push 0xDD
0069C7A7    mov ecx, 0x878A5C
...
0069C7E7    pop ebp
0069C7E8    ret
0069C7E9    push 0x87943C
0069C7EE    push 0x6D
0069C7F0    mov ecx, 0x87948C
0069C7F5    push 0x879400
0069C7FA    mov edx, 0x801800
0069C7FF    call 0x0063B870
0069C804    add esp, 0x0C
0069C807    call 0x0063BC30
0069C80C    test al, al
0069C80E    jz 0x0069C811
0069C810    int3
0069C811    call 0x0063BB00
