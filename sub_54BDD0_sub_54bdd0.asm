...
0054BE14    movups xmmword ptr ds:[eax-0x3C], xmm3          ; => [ String: \x29\x11\x00\x00\x2a\x11\x00\x00\x2b\x11\x00\x00\x2c\x11\x00\x00\x2d\x11\x00\x00\x2e\x11\x00\x00\x2f\x11\x00\x00\x30\x11\x00\x00\x31\x11\x00\x00\x32\x11\x00\x00\x33\x11\x00\x00\x34\x11\x00\x00\x35\x11\x00\x00\x36\x11\x00\x00\x37\x11\x00\x00 | Call: __builtin_memcpy ]
...
0054BE2E    push esi
0054BE2F    push edi
0054BE30    call 0x00573400                                 ; => [ Call: sub_573400 ]
0054BE35    mov ebx, dword ptr ds:[eax+0x04]
0054BE38    test ebx, ebx
0054BE3A    jnz 0x0054BE55
0054BE3C    push 0x81EDE0                                   ; => [ String: GameRNG ]
0054BE41    push 0x1577
0054BE46    push 0x81EA70                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0054BE4B    mov ecx, 0x81EDE8                               ; => [ Data: data_81ede8 ]
...
0054BE69    call 0x0063ED10                                 ; => [ Call: sub_63ed10 ]
...
0054BE93    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054BEB1    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
0054BEC8    pop ebx
0054BEC9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0054BECE    mov esp, ebp
0054BED0    pop ebp
0054BED1    ret
0054BED2    push 0x871F38                                   ; => [ String: RandomPCGIntRange ]
0054BED7    push 0x120
0054BEDC    push 0x871ED0                                   ; => [ String: C:\x\ax2017\Engine\Random.cpp ]
0054BEE1    mov ecx, 0x871F28                               ; => [ String: mmin <= mmax ]
0054BEE6    mov edx, 0x801800
0054BEEB    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0054BEF0    add esp, 0x0C
0054BEF3    call 0x0063BC30
0054BEF8    test al, al
0054BEFA    jz 0x0054BEFD                                   ; => [ Call: sub_63bc30 ]
0054BEFC    int3
0054BEFD    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
