...
0076B0A1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076B0A6    mov ecx, dword ptr ds:[edx-0x04]
0076B0A9    xor ecx, eax
0076B0AB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076B0B0    mov eax, 0x8B5918
0076B0B5    jmp 0x00761FA6                                  ; => [ Call: __CxxFrameHandler3 | Data: data_8b5918 ]
