...
004B0E6A    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004B0E70    test ecx, ecx
004B0E72    jz 0x004B1033
004B0E78    add ecx, 0x507C
004B0E7E    push edi
004B0E7F    call 0x004BB050                                 ; => [ Call: sub_4bb050 ]
...
004B0E97    pop ebp
004B0E98    ret                                             ; => [ Call: sub_4b0bf0 ]
004B0E99    cmp eax, 0x17
004B0E9C    jle 0x004B0F47
004B0EA2    push 0x00
004B0EA4    xor edx, edx
004B0EA6    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004B0EB0    mov ecx, 0x801DA8
004B0EB5    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_msg_out_of_date_header ]
004B0EBA    add esp, 0x04
004B0EBD    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004B0EC2    test eax, eax
004B0EC4    jnz 0x004B0ECD
004B0EC6    mov ecx, 0x801DA8                               ; => [ String: dom_msg_out_of_date_header ]
004B0ECB    jmp 0x004B0ED6
004B0ECD    mov eax, dword ptr ds:[eax]
004B0ECF    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004B0EEA    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_63d8d0 | String: dom_msg_app_out_of_date_body | Call: sub_68caf0 | Data: data_8db750 ]
004B0EEF    add esp, 0x04
004B0EF2    test eax, eax
004B0EF4    jnz 0x004B0EFD
004B0EF6    mov esi, 0x801DC4                               ; => [ String: dom_msg_app_out_of_date_body ]
...
004B0F0A    call 0x0063D8D0                                 ; => [ Data: data_8db754 | Call: sub_63d8d0 ]
004B0F0F    push 0x801800
004B0F14    mov ecx, 0x8DB758
004B0F19    call 0x0063D8D0                                 ; => [ Data: data_8db758 | Data: data_801800 | Call: sub_63d8d0 ]
004B0F1E    push 0x801800
004B0F23    mov ecx, 0x8DB75C
004B0F28    call 0x0063D8D0                                 ; => [ Data: data_801800 | Data: data_8db75c | Call: sub_63d8d0 ]
004B0F2D    mov dword ptr ds:[0x008DB760], 0x00             ; => [ Data: data_8db760 ]
004B0F37    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004B0F41    pop edi
004B0F42    pop esi
004B0F43    mov esp, ebp
004B0F45    pop ebp
004B0F46    ret
004B0F47    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B0F82    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
004B0F87    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B0FBB    pop ebp
004B0FBC    ret
004B0FBD    mov dword ptr ds:[0x008DB660], 0x1C             ; => [ Data: data_8db660 ]
...
004B0FDD    mov edx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004B100A    call 0x00689E00                                 ; => [ Call: sub_689e00 ]
004B100F    add esp, 0x04
004B1012    lea eax, ss:[ebp-0x04]
004B1015    mov edx, 0x04
004B101A    lea ecx, ds:[esi+0x50]
004B101D    push eax
004B101E    call 0x00689BE0                                 ; => [ Call: sub_689be0 ]
004B1023    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B1049    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004B104E    add esp, 0x0C
004B1051    call 0x0063BC30
004B1056    test al, al
004B1058    jz 0x004B105B                                   ; => [ Call: sub_63bc30 ]
004B105A    int3
004B105B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
