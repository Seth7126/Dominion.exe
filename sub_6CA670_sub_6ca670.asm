...
006CA675    push 0x770A1D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0?$messages@G@std@@QAE@ABV_Locinfo@1@I@Z ]
006CA67A    mov eax, dword ptr fs:[0x00000000]
006CA680    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006CA681    push ecx
006CA682    mov eax, dword ptr ds:[0x008C4040]
006CA687    xor eax, ebp
006CA689    push eax                                        ; => [ Data: __security_cookie ]
006CA68A    lea eax, ss:[ebp-0x0C]
006CA68D    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006CA693    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006CA6CF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006CA6E2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006CA6E7    mov ecx, dword ptr ss:[ebp-0x0C]
006CA6EA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006CA6F1    pop ecx
