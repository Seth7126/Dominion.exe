...
005E3319    jnb 0x005E333E                                  ; => [ Data: data_b809e4 ]
005E331B    imul eax, eax, 0x1C30
005E3321    add eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
...
005E3365    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
005E336A    xor ecx, ecx
005E336C    cmp eax, 0xFFFFFFFF
005E336F    cmovz eax, ecx                                  ; => [ Call: nullptr ]
...
005E33AF    call 0x005CC6C0                                 ; => [ Call: sub_5cbb20 | Call: sub_5cc6c0 ]
005E33B4    jmp 0x005E33C1
005E33B6    mov ecx, dword ptr ds:[ebx+0x9C]
005E33BC    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
...
005E33F2    call 0x005CBB20                                 ; => [ Call: sub_5cbb20 ]
...
005E340D    call 0x00571B30                                 ; => [ Call: sub_571b30 | Call: sub_5cf7e0 ]
005E3412    xor edi, edi                                    ; => [ Call: nullptr ]
005E3414    mov dword ptr ss:[ebp-0x1C], eax
005E3417    mov dword ptr ss:[ebp-0x18], edi                ; => [ Call: nullptr ]
...
005E3437    test al, al
005E3439    jz 0x005E373D                                   ; => [ Call: sub_5e3790 ]
005E343F    mov ecx, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
005E3462    call 0x005731D0                                 ; => [ Call: sub_5731d0 ]
...
005E3492    setnle bl                                       ; => [ Call: sub_576b30 ]
005E3495    inc ebx
...
005E34DC    mov ecx, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
005E3593    call 0x005CBAA0                                 ; => [ Call: sub_5cbaa0 ]
005E3598    mov ecx, dword ptr ss:[ebp-0x08]
005E359B    mov bl, al
005E359D    push 0x00
005E359F    push 0x02
005E35A1    call 0x005CBAA0                                 ; => [ Call: sub_5cbaa0 ]
...
005E363A    jnz 0x005E3696                                  ; => [ Data: data_b824a4 ]
005E363C    test al, 0x02
005E363E    jz 0x005E3644
005E3640    mov cl, 0x01
005E3642    jmp 0x005E3696
005E3644    mov edx, dword ptr ds:[0x00B824C4]              ; => [ Data: data_b824c4 ]
...
005E366F    push 0x00
005E3671    call 0x005EFE00                                 ; => [ Call: sub_5efe00 ]
...
005E36D2    movzx eax, al                                   ; => [ Call: nullptr ]
...
005E36EF    jnz 0x005E3721                                  ; => [ Call: sub_5efe00 ]
005E36F1    push esi
...
005E3744    pop ebp
005E3745    ret
005E3746    push 0x81F9E0                                   ; => [ String: DomPopContext ]
005E374B    push 0x792
005E3750    push 0x81F4B8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
005E3755    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
005E375A    jmp 0x005E3770
005E375C    push 0x85F4DC                                   ; => [ String: ShowHintValue ]
005E3761    push 0x49BA
005E3766    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E376B    mov ecx, 0x85F50C                               ; => [ String: info.fn ]
005E3770    mov edx, 0x801800
005E3775    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005E377A    add esp, 0x0C
005E377D    call 0x0063BC30
005E3782    test al, al
005E3784    jz 0x005E3787                                   ; => [ Call: sub_63bc30 ]
005E3786    int3
005E3787    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
