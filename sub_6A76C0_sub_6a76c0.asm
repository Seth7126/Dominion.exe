...
006A76E1    mov dword ptr fs:[0x00000000], eax
...
006A77CE    jz 0x006A77EB
006A77D0    lea ecx, ss:[ebp-0x20]
006A77D3    call 0x0063D4E0
...
006A7868    call 0x0064C080
006A786D    mov dword ptr ss:[ebp-0x14], 0x801800
006A7874    mov dword ptr ss:[ebp-0x04], 0x0C
006A787B    cmp dword ptr ds:[0x00CF65BC], 0x00
006A7882    jz 0x006A78AB
...
006A78A6    call 0x0064C080
006A78AB    mov eax, esi
006A78AD    mov ecx, dword ptr ss:[ebp-0x0C]
006A78B0    mov dword ptr fs:[0x00000000], ecx
006A78B7    pop ecx
006A78B8    pop edi
006A78B9    pop esi
...
006A78D7    call 0x0063B870
006A78DC    add esp, 0x0C
006A78DF    call 0x0063BC30
006A78E4    test al, al
006A78E6    jz 0x006A78E9
006A78E8    int3
006A78E9    call 0x0063BB00
006A78EE    push 0x871DD4
006A78F3    push 0x94
006A78F8    push 0x871D5C
006A78FD    mov edx, 0x801800
006A7902    mov ecx, 0x871E0C
006A7907    call 0x0063B870
006A790C    add esp, 0x0C
006A790F    call 0x0063BC30
006A7914    test al, al
006A7916    jz 0x006A7919
006A7918    int3
006A7919    call 0x0063BB00
