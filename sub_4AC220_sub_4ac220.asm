...
004AC225    push 0x7626C0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?GetResourceForNewSubscription@SchedulerProxy@details@Concurrency@@QAEPAVExecutionResource@23@PAV423@@Z ]
004AC22A    mov eax, dword ptr fs:[0x00000000]
004AC230    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004AC23E    push eax                                        ; => [ Data: __security_cookie ]
004AC23F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004AC242    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004AC283    jz 0x004AC2B3                                   ; => [ Data: data_cf65bc ]
...
004AC294    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004AC2A7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AC2AC    mov dword ptr ds:[ebx+0x10], 0x801800           ; => [ Data: data_801800 ]
004AC2B3    mov edx, 0x1C
004AC2B8    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004AC2BF    mov ecx, ebx
004AC2C1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004AC2FB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AC300    mov dword ptr ds:[ebx], 0x00
004AC306    mov ecx, dword ptr ss:[ebp-0x0C]
004AC309    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004AC310    pop ecx
004AC311    pop edi
004AC312    pop esi
004AC313    pop ebx
