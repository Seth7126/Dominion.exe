...
00747DDC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00747DF6    movss xmm0, dword ptr ds:[0x01593C6C]           ; => [ Data: data_1593c6c ]
...
00747E2A    mulss xmm2, xmm0                                ; => [ Data: data_8937c0 | Data: data_1593c70 ]
...
00747E43    push 0x00
00747E45    movss dword ptr ss:[esp+0x18], xmm1             ; => [ Data: data_8937c0 | Data: data_1593c74 ]
00747E4B    movaps xmm1, xmmword ptr ds:[0x00893730]        ; => [ Data: data_893730 ]
...
00747E9E    mov ecx, dword ptr ds:[0x01512454]              ; => [ Data: data_1512454 ]
00747EA4    movaps xmmword ptr ss:[esp+0xE0], xmm0          ; => [ Data: data_7ff530 ]
...
00747ED5    push eax
00747ED6    movaps xmmword ptr ss:[esp+0xBC], xmm3          ; => [ String: 0 | String: zx ]
00747EDE    call 0x00699C40                                 ; => [ Data: data_8c4634 | Data: data_7ffb14 | Call: sub_699c40 | Call: nullptr ]
00747EE3    add esp, 0x1C
00747EE6    call 0x007461F0                                 ; => [ Call: sub_7461f0 ]
00747EEB    cmp byte ptr ds:[0x01513460], 0x00
00747EF2    jnz 0x00747F93
00747EF8    cmp byte ptr ds:[0x01513462], 0x00
00747EFF    jnz 0x00747F93                                  ; => [ Data: data_1513460 | Data: data_1513462 ]
00747F05    cmp byte ptr ds:[0x01513461], 0x00
00747F0C    lea ecx, ss:[esp+0x08]
00747F10    jz 0x00747FD5                                   ; => [ Data: data_1513460 ]
00747F16    call 0x0063C270                                 ; => [ Call: sub_63c270 ]
00747F1B    push dword ptr ss:[esp+0x0C]
00747F1F    push dword ptr ss:[esp+0x0C]
00747F23    call 0x00747970                                 ; => [ Call: sub_747970 ]
...
00747FEB    push eax
00747FEC    call dword ptr ds:[0x007753A4]                  ; => [ Call: nullptr ]
00747FF2    mov ecx, dword ptr ss:[esp+0xFC]
00747FF9    xor ecx, esp
00747FFB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction | Call: CookieCheckFunction | Call: CookieCheckFunction | Call: CookieCheckFunction | Call: CookieCheckFunction | Call: CookieCheckFunction ]
00748000    mov esp, ebp
00748002    pop ebp
00748003    ret
00748004    push 0x88FD8C                                   ; => [ String: UIEditorUpdate ]
00748009    push 0x45E
0074800E    push 0x88FC60
00748013    mov edx, 0x801800
00748018    mov ecx, 0x801AA4
0074801D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: UIEditorUpdate | Data: data_801800 | String: C:\x\ax2017\Engine\Editor\UIEditor.cpp | String: Halt ]
00748022    add esp, 0x0C
00748025    call 0x0063BC30
0074802A    test al, al
0074802C    jz 0x0074802F                                   ; => [ Call: sub_63bc30 ]
0074802E    int3
0074802F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
