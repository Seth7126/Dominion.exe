...
00598AFE    push eax
00598AFF    lea eax, ss:[ebp-0x0C]
00598B02    mov dword ptr fs:[0x00000000], eax
...
00598DE5    mov edi, 0x801800
00598DEA    test eax, eax
00598DEC    mov edx, edi
00598DEE    push edi
...
00598EA8    call 0x0064C080
00598EAD    mov eax, esi
00598EAF    mov ecx, dword ptr ss:[ebp-0x0C]
00598EB2    mov dword ptr fs:[0x00000000], ecx
00598EB9    pop ecx
00598EBA    pop edi
00598EBB    pop esi
00598EBC    pop ebx
...
00598EDA    call 0x0063B870
00598EDF    add esp, 0x0C
00598EE2    call 0x0063BC30
00598EE7    test al, al
00598EE9    jz 0x00598EEC
00598EEB    int3
00598EEC    call 0x0063BB00
