...
005268C1    push edi
005268C2    push ecx                                        ; => [ Call: __chkstk ]
005268C3    push 0x00
005268C5    lea ecx, ds:[edx+0x02]
005268C8    call 0x00561E00                                 ; => [ Data: __security_cookie | Call: sub_561e00 ]
005268CD    sub esp, 0x20
005268D0    mov eax, esp
005268D2    mov dword ptr ds:[eax], 0x8185A8                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_08e96e2386070e81fc3185175b09ad2e>, void>::`vftable'{for `std::_Func_base<void>'} | Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_08e96e2386070e81fc3185175b09ad2e>, void>::VTable ]
005268D8    mov dword ptr ds:[eax+0x24], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_08e96e2386070e81fc3185175b09ad2e>, void>::VTable ]
005268DB    call 0x005699B0                                 ; => [ Call: sub_5699b0 ]
005268E0    lea eax, ss:[esp+0xC0]
005268E7    mov ecx, 0x919
005268EC    push eax
005268ED    call 0x00567780                                 ; => [ Call: sub_567780 ]
...
0052690A    movlpd qword ptr ss:[esp+0x34], xmm0            ; => [ Call: __builtin_memset ]
...
00526961    push 0x01
00526963    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
005269B1    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005269CF    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005269E2    push 0x00
005269E4    movlpd qword ptr ss:[esp+0x1C], xmm0            ; => [ Call: __builtin_memset ]
...
00526A0D    push eax
00526A0E    call 0x00586320                                 ; => [ Call: sub_586320 ]
00526A13    add esp, 0x10
00526A16    mov ecx, dword ptr ss:[esp+0x19AC]
00526A1D    pop edi
00526A1E    pop esi
00526A1F    xor ecx, esp
00526A21    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
