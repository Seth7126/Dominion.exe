...
004C3626    push ebx
004C3627    mov ebx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C3687    mov dword ptr ds:[eax+0x42C4], 0x00             ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004C3691    mov ecx, dword ptr ds:[0x00CC8DC8]
004C3697    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004C369D    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C36C5    mov dword ptr ds:[eax+0x42C0], 0x00             ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004C36CF    push esi
004C36D0    xor esi, esi
004C36D2    mov ecx, dword ptr ds:[0x00CC8DC8]
004C36D8    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004C36DE    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C3707    mov dword ptr ds:[eax+esi*1+0x3544], 0x00       ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C3726    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C3764    lea edi, ds:[eax+0x720C]                        ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C379E    xor esi, esi                                    ; => [ Call: nullptr ]
...
004C37B8    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
...
004C37E2    call 0x004BB2F0                                 ; => [ Call: sub_4d8f30 | Call: sub_4bb2f0 | Data: data_cc8dc8 ]
004C37E7    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004C37ED    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004C37F2    pop edi
004C37F3    pop esi
004C37F4    pop ebx
...
004C380F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004C3814    add esp, 0x0C
004C3817    call 0x0063BC30
004C381C    test al, al
004C381E    jz 0x004C3821                                   ; => [ Call: sub_63bc30 ]
004C3820    int3
004C3821    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
