...
0064B7A6    pop ebp
0064B7A7    ret 0x08                                        ; => [ Call: sub_63b5f0 | String: There has been an IO Failure when requesting the Encrypted App Ticket. ]
0064B7AA    mov eax, dword ptr ss:[ebp+0x08]
0064B7AD    mov eax, dword ptr ds:[eax]
0064B7AF    dec eax
0064B7B0    cmp eax, 0x1C
0064B7B3    jnbe 0x0064B83C
0064B7B9    movzx eax, byte ptr ds:[eax+0x64B854]           ; => [ Data: lookup_table_64b854 ]
...
0064B7EB    call eax                                        ; => [ Data: data_c2140c | Data: data_cb4530 ]
0064B7ED    test al, al
0064B7EF    jz 0x0064B7FC
0064B7F1    mov byte ptr ds:[0x00C21410], 0x01              ; => [ Data: data_c21410 ]
0064B7F8    pop ebp
0064B7F9    ret 0x08
...
0064B809    pop ebp
0064B80A    ret 0x08                                        ; => [ String: GetEncryptedAppTicket failed. | Call: sub_63b5f0 ]
0064B80D    push 0x873410
0064B812    call 0x0063B5F0
0064B817    add esp, 0x04
0064B81A    pop ebp
0064B81B    ret 0x08                                        ; => [ Call: sub_63b5f0 | String: Calling RequestEncryptedAppTicket while not connected to steam. ]
0064B81E    push 0x8733C0
0064B823    call 0x0063B5F0
0064B828    add esp, 0x04
0064B82B    pop ebp
0064B82C    ret 0x08                                        ; => [ Call: sub_63b5f0 | String: Calling RequestEncryptedAppTicket while there is already a pending request. ]
0064B82F    push 0x873468
0064B834    call 0x0063B5F0                                 ; => [ String: Calling RequestEncryptedAppTicket more than once per minute. | Call: sub_63b5f0 ]
