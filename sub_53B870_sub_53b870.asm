...
0053B876    push ecx
0053B877    push esi
0053B878    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053B87D    push 0x00
0053B87F    push 0x00
0053B881    push 0x01
...
0053B889    push 0x01
0053B88B    call 0x00590760                                 ; => [ Call: sub_590760 ]
0053B890    add esp, 0x10
0053B893    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053B8B1    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053B8D8    mov esi, dword ptr ds:[ecx+eax*1+0x17540]       ; => [ Call: sub_573400 ]
0053B8DF    test esi, esi
0053B8E1    jle 0x0053B8ED
0053B8E3    mov ecx, 0x01
0053B8E8    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
0053B8ED    xor edx, edx
0053B8EF    lea ecx, ds:[edx+0x07]
0053B8F2    call 0x00562F10                                 ; => [ Call: sub_562f10 ]
0053B8F7    push ecx
0053B8F8    push 0x00
...
0053B909    pop ebp
0053B90A    ret                                             ; => [ Call: sub_561e00 ]
0053B90B    push 0x81EA64
0053B910    push 0x52
0053B912    push 0x81EA70
0053B917    mov edx, 0x801800
0053B91C    mov ecx, 0x813C5C
0053B921    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0053B926    add esp, 0x0C
0053B929    call 0x0063BC30
0053B92E    test al, al
0053B930    jz 0x0053B933                                   ; => [ Call: sub_63bc30 ]
0053B932    int3
0053B933    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
