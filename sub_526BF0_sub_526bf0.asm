...
00526BF8    call 0x00761E50                                 ; => [ Call: __chkstk ]
00526BFD    xor edx, edx
00526BFF    push ecx
00526C00    push 0x00
00526C02    lea ecx, ds:[edx+0x01]
00526C05    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
00526C0A    call 0x00573400                                 ; => [ Call: sub_573400 ]
00526C0F    push 0x00
00526C11    push 0x00
00526C13    push 0x01
...
00526C1B    push 0x01
00526C1D    call 0x00590760                                 ; => [ Call: sub_590760 ]
00526C22    add esp, 0x18
00526C25    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00526C5C    push eax
00526C5D    call 0x00568780                                 ; => [ Call: sub_568780 | Call: sub_561af0 ]
00526C62    add esp, 0x04
00526C65    lea edi, ss:[ebp-0xC84]
00526C6B    mov esi, eax
00526C6D    mov ecx, 0x321
00526C72    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00526C8F    pop ebp
00526C90    ret                                             ; => [ Call: sub_56ab80 ]
00526C91    push 0x81EA64
00526C96    push 0x52
00526C98    push 0x81EA70
00526C9D    mov edx, 0x801800
00526CA2    mov ecx, 0x813C5C
00526CA7    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00526CAC    add esp, 0x0C
00526CAF    call 0x0063BC30
00526CB4    test al, al
00526CB6    jz 0x00526CB9                                   ; => [ Call: sub_63bc30 ]
00526CB8    int3
00526CB9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
