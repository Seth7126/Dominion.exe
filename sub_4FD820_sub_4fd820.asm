...
004FD82C    mov eax, dword ptr ds:[0x008C4040]
...
004FD842    mov esi, dword ptr ds:[eax+0x0C]
004FD845    call 0x00573400
004FD84A    push 0x00
004FD84C    push 0x00
004FD84E    push 0x01
...
004FD856    push 0x01
004FD858    call 0x00590760
004FD85D    add esp, 0x10
004FD860    call 0x00573400
...
004FD8EE    mov ebx, dword ptr ds:[eax+0x04]
004FD8F1    cmp edi, 0x320
004FD8F7    jb 0x004FD8FE
004FD8F9    call 0x00591930
...
004FD967    call 0x0063B870
004FD96C    add esp, 0x0C
004FD96F    call 0x0063BC30
004FD974    test al, al
004FD976    jz 0x004FD979
004FD978    int3
004FD979    call 0x0063BB00
