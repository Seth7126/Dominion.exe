...
004BA8F9    mov eax, dword ptr ds:[0x008C4040]
004BA8FE    xor eax, esp
004BA900    mov dword ptr ss:[esp+0x18], eax
004BA904    mov eax, dword ptr ds:[0x00CC8D68]
004BA909    push ebx
004BA90A    push esi
004BA90B    push edi
...
004BA984    call 0x004BB950
004BA989    mov eax, dword ptr ds:[0x00CC8D68]
...
004BA99C    mov eax, dword ptr ds:[0x00CC8D5C]
...
004BA9B2    mov ecx, dword ptr ds:[0x0147ABF4]
...
004BAA24    call 0x0063B870
004BAA29    add esp, 0x0C
004BAA2C    call 0x0063BC30
004BAA31    test al, al
004BAA33    jz 0x004BAA36
004BAA35    int3
004BAA36    call 0x0063BB00
