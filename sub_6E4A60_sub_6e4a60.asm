...
006E4A65    push 0x7623F0                                   ; => [ Call: __ehhandler$??0?$call@IV?$function@$$A6AXABI@Z@std@@@Concurrency@@QAE@ABV?$function@$$A6AXABI@Z@std@@@Z | Type: EHRegistrationNode ]
006E4A6A    mov eax, dword ptr fs:[0x00000000]
006E4A70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E4A71    push ecx
006E4A72    push esi
006E4A73    mov eax, dword ptr ds:[0x008C4040]
006E4A78    xor eax, ebp
006E4A7A    push eax                                        ; => [ Data: __security_cookie ]
006E4A7B    lea eax, ss:[ebp-0x0C]
006E4A7E    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E4A92    push eax
006E4A93    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4ab280 ]
006E4A98    mov dword ptr ss:[ebp-0x04], 0x00
006E4A9F    cmp dword ptr ds:[0x00CF65BC], 0x00
006E4AA6    jz 0x006E4AD6                                   ; => [ Data: data_cf65bc ]
...
006E4AB7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E4ACA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E4ACF    mov dword ptr ds:[esi+0x0C], 0x801800           ; => [ Data: data_801800 ]
006E4AD6    mov ecx, dword ptr ss:[ebp-0x0C]
006E4AD9    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E4AE0    pop ecx
006E4AE1    pop esi
