...
00757166    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00757183    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
007571B8    push 0x00
007571BA    push edi
007571BB    call 0x00761FC4                                 ; => [ Call: memset ]
007571C0    add esp, 0x0C
007571C3    mov ecx, edi
007571C5    call 0x0075A410
007571CA    mov ecx, dword ptr ss:[ebp-0x38]
007571CD    mov dword ptr ds:[ecx+0x04], eax                ; => [ Call: sub_75a410 ]
007571D0    mov eax, ecx
007571D2    movaps xmm0, xmmword ptr ds:[0x008911F0]
007571D9    lea esi, ss:[ebp-0x34]
007571DC    movups xmmword ptr ss:[ebp-0x34], xmm0          ; => [ String: \x00\x00\x00\x00\x00\x00\x00\x00\x06\x00\x00\x00\x00\x00\x00\x00\x06\x00\x00\x00\x80\xbb\x00\x00\x06\x00\x00\x00\x44\xac\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x04\x00\x00\x00\x44\xac\x00\x00 | Call: __builtin_memcpy ]
...
00757203    push ebx
00757204    push 0x01
00757206    call 0x0075ACF0                                 ; => [ Call: sub_75acf0 ]
...
00757217    call 0x0063B7F0                                 ; => [ Call: sub_63b7f0 | String: Sound failed to init (%d, %d) error:%d ]
...
0075723A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00757251    call 0x0063B7F0                                 ; => [ String: Sound initialized (%d, %d) | Call: sub_63b7f0 ]
...
0075725F    pop esi
00757260    pop ebx
00757261    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
