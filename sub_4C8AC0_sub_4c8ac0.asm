...
004C8AC0    push esi
004C8AC1    mov esi, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
...
004C8AE5    call 0x004D6A20                                 ; => [ Call: sub_4d6a20 ]
004C8AEA    mov ecx, 0xBE3598
004C8AEF    pop esi
004C8AF0    jmp 0x006378E0                                  ; => [ Call: sub_6378e0 | Data: data_be3598 ]
004C8AF5    push 0x806A44
004C8AFA    push 0x5FB
004C8AFF    push 0x806734
004C8B04    mov edx, 0x801800
004C8B09    mov ecx, 0x806A58
004C8B0E    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetLocalSettings | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp | Data: data_801800 | String: gGameSettings.localSettings ]
004C8B13    add esp, 0x0C
004C8B16    call 0x0063BC30
004C8B1B    test al, al
004C8B1D    jz 0x004C8B20                                   ; => [ Call: sub_63bc30 ]
004C8B1F    int3
004C8B20    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
