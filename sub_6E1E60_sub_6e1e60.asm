...
006E1E65    push 0x77119E                                   ; => [ Call: sub_77119e | Type: EHRegistrationNode ]
006E1E6A    mov eax, dword ptr fs:[0x00000000]
006E1E70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E1E71    sub esp, 0x1C
006E1E74    push ebx
006E1E75    push esi
006E1E76    push edi
006E1E77    mov eax, dword ptr ds:[0x008C4040]
006E1E7C    xor eax, ebp                                    ; => [ Data: __security_cookie ]
006E1E7E    push eax
006E1E7F    lea eax, ss:[ebp-0x0C]
006E1E82    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E1EC7    mov dword ptr ds:[edi], eax                     ; => [ Data: data_cb2f14 ]
006E1EC9    mov eax, dword ptr ds:[0x00CB2F18]
006E1ECE    mov dword ptr ds:[edi+0x04], eax                ; => [ Data: data_cb2f18 ]
006E1ED1    mov eax, dword ptr ds:[0x00CB2F1C]              ; => [ Data: data_cb2f1c ]
...
006E1EE1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006E1EE6    inc dword ptr ds:[eax+0x04]
006E1EE9    mov eax, edi
006E1EEB    mov ecx, dword ptr ss:[ebp-0x0C]
006E1EEE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E1EF5    pop ecx
006E1EF6    pop edi
006E1EF7    pop esi
006E1EF8    pop ebx
...
006E1F0E    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006E1F15    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006E1F1A    lea edx, ss:[ebp-0x10]
006E1F1D    mov dword ptr ss:[ebp-0x04], 0x01
006E1F24    lea ecx, ss:[ebp-0x28]
006E1F27    call 0x006E19E0                                 ; => [ Call: sub_6e19e0 ]
...
006E1F4F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E1F75    jz 0x006E1F99                                   ; => [ Data: data_cf65bc ]
006E1F77    lea ecx, ss:[ebp-0x20]
006E1F7A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E1F8D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E1F92    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
006E1F99    mov dword ptr ss:[ebp-0x04], 0x04
006E1FA0    cmp dword ptr ds:[0x00CF65BC], 0x00
006E1FA7    jz 0x006E1FD0                                   ; => [ Data: data_cf65bc ]
...
006E1FB8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E1FCB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E1FD0    mov eax, edi
006E1FD2    mov ecx, dword ptr ss:[ebp-0x0C]
006E1FD5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E1FDC    pop ecx
006E1FDD    pop edi
006E1FDE    pop esi
006E1FDF    pop ebx
...
006E1FFD    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006E2002    add esp, 0x0C
006E2005    call 0x0063BC30
006E200A    test al, al
006E200C    jz 0x006E200F                                   ; => [ Call: sub_63bc30 ]
006E200E    int3
006E200F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
