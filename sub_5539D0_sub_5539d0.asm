...
005539E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005539E1    mov eax, 0x1938
005539E6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005539EB    mov eax, dword ptr ds:[0x008C4040]
005539F0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
005539F2    mov dword ptr ss:[ebp-0x10], eax
005539F5    push esi
005539F6    push edi
005539F7    push eax
005539F8    lea eax, ss:[ebp-0x0C]
005539FB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00553A01    lea eax, ss:[ebp-0x1944]
00553A07    mov ecx, 0x3EC
00553A0C    push eax
00553A0D    call 0x00568780                                 ; => [ Call: sub_568780 ]
00553A12    mov esi, eax
00553A14    mov dword ptr ss:[ebp-0xCC0], 0x81D3CC          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ea26141a93027e4b60fc116293766c98>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_ea26141a93027e4b60fc116293766c98>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00553A1E    mov ecx, 0x321
00553A23    lea edi, ss:[ebp-0xC94]
00553A29    lea eax, ss:[ebp-0xCC0]
00553A2F    add esp, 0x04
00553A32    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00553A34    mov dword ptr ss:[ebp-0xC9C], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ea26141a93027e4b60fc116293766c98>,bool,enum CardID>::VTable ]
...
00553A72    push esi
00553A73    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
00553A81    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
00553AA5    push edx
00553AA6    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
00553AA9    mov eax, edi
00553AAB    mov ecx, dword ptr ss:[ebp-0x0C]
00553AAE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00553AB5    pop ecx
00553AB6    pop edi
00553AB7    pop esi
00553AB8    mov ecx, dword ptr ss:[ebp-0x10]
00553ABB    xor ecx, ebp
00553ABD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
