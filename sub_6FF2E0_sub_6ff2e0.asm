...
006FF38D    call dword ptr ds:[0x0077516C]
006FF393    mov ecx, dword ptr ds:[0x00775338]
006FF399    mov esi, eax
006FF39B    xorps xmm0, xmm0
006FF39E    mov dword ptr ss:[esp+0x48], 0x00
006FF3A6    lea eax, ss:[esp+0x28]
006FF3AA    movlpd qword ptr ss:[esp+0x30], xmm0
006FF3B0    push eax
006FF3B1    movlpd qword ptr ss:[esp+0x40], xmm0
006FF3B7    mov dword ptr ss:[esp+0x30], ecx
006FF3BB    mov dword ptr ss:[esp+0x3C], esi
006FF3BF    mov dword ptr ss:[esp+0x48], 0x01
006FF3C7    mov dword ptr ss:[esp+0x50], 0x88C6D4
006FF3CF    mov dword ptr ss:[esp+0x2C], 0x20
...
006FF400    push 0x00
006FF402    call dword ptr ds:[0x007752B4]
006FF408    xorps xmm0, xmm0
006FF40B    mov esi, eax
006FF40D    movaps xmmword ptr ss:[esp+0x80], xmm0
006FF415    push esi
006FF416    movaps xmmword ptr ss:[esp+0x94], xmm0
006FF41E    movq qword ptr ss:[esp+0xA4], xmm0
006FF427    mov dword ptr ss:[esp+0x84], 0x10028
006FF432    mov dword ptr ss:[esp+0x88], 0x1025
006FF43D    mov word ptr ss:[esp+0x8C], 0x2000
006FF447    call edi
006FF449    mov edi, eax
006FF44B    lea eax, ss:[esp+0x80]
006FF452    push eax
006FF453    push edi
006FF454    mov dword ptr ss:[esp+0x14], edi
...
006FF46E    push edi
006FF46F    call dword ptr ds:[0x007751FC]
006FF475    push eax
006FF476    push edi
...
006FF4B1    mov eax, dword ptr ds:[0x00CF65B8]
006FF4B6    xorps xmm0, xmm0
006FF4B9    mov edi, dword ptr ss:[esp+0x10]
006FF4BD    movaps xmmword ptr ss:[esp+0x60], xmm0
006FF4C2    movaps xmmword ptr ss:[esp+0x50], xmm0
006FF4C7    mov al, byte ptr ds:[eax+0x20]
006FF4CA    mov ecx, dword ptr ds:[edi+0x08]
006FF4CD    neg al
006FF4CF    mov dword ptr ss:[esp+0x14], ecx
006FF4D3    sbb al, al
006FF4D5    movq qword ptr ss:[esp+0x70], xmm0
006FF4DB    and al, 0x10
006FF4DD    mov dword ptr ss:[esp+0x50], 0x10028
006FF4E5    mov byte ptr ss:[esp+0x67], al
006FF4E9    lea eax, ss:[esp+0x50]
006FF4ED    push eax
006FF4EE    push ecx
006FF4EF    mov dword ptr ss:[esp+0x5C], 0x1025
006FF4F7    mov word ptr ss:[esp+0x60], 0x2000
006FF4FE    call dword ptr ds:[0x00775050]
006FF504    test dword ptr ss:[esp+0x54], 0x1000
006FF50C    mov esi, eax
006FF50E    jnz 0x006FF524
006FF510    push 0x88C75C
006FF515    push 0x478
006FF51A    mov ecx, 0x88C734
006FF51F    jmp 0x006FF7D2
006FF524    mov eax, dword ptr ds:[0x00CF65B8]
006FF529    mov ecx, dword ptr ds:[eax+0x1C]
...
006FF540    mov dword ptr ss:[esp+0xEC], eax
...
006FF584    movups xmmword ptr ss:[esp+0xD8], xmm0
...
006FF5BA    movups xmmword ptr ss:[esp+0x108], xmm0
...
006FF63F    call dword ptr ds:[0x007753C0]
006FF645    movd xmm0, dword ptr ss:[esp+0xB8]
006FF64E    movd xmm1, dword ptr ss:[esp+0xBC]
006FF657    cvtdq2ps xmm0, xmm0
...
006FF677    push 0x88C79C
006FF67C    push 0x4C3
006FF681    mov ecx, 0x88C7D4
...
006FF755    push dword ptr ss:[esp+0x1C]
006FF759    push 0x88C820
006FF75E    call 0x0063B5F0
...
006FF7AC    call 0x0063B870
006FF7B1    add esp, 0x0C
006FF7B4    call 0x0063BC30
006FF7B9    test al, al
006FF7BB    jz 0x006FF7BE
006FF7BD    int3
006FF7BE    call 0x0063BB00
006FF7C3    push 0x88C75C
006FF7C8    push 0x49B
006FF7CD    mov ecx, 0x8027A0
006FF7D2    push 0x88C504
006FF7D7    mov edx, 0x801800
006FF7DC    call 0x0063B870
006FF7E1    add esp, 0x0C
006FF7E4    call 0x0063BC30
006FF7E9    test al, al
006FF7EB    jz 0x006FF7EE
006FF7ED    int3
006FF7EE    call 0x0063BB00
006FF7F3    push 0x88C79C
006FF7F8    push 0x4C6
006FF7FD    mov ecx, 0x88C700
006FF802    push 0x88C504
006FF807    mov edx, 0x801800
006FF80C    call 0x0063B870
006FF811    add esp, 0x0C
006FF814    call 0x0063BC30
006FF819    test al, al
006FF81B    jz 0x006FF81E
006FF81D    int3
006FF81E    call 0x0063BB00
