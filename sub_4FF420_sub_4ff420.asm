...
004FF4F3    mov dword ptr ss:[ebp-0xD0], 0x80AD50
004FF4FD    mov dword ptr ss:[ebp-0xA8], 0x9D
004FF507    mov dword ptr ss:[ebp-0xA4], 0x00
004FF511    mov dword ptr ss:[ebp-0xA0], 0x80AD34
004FF51B    mov dword ptr ss:[ebp-0x78], 0x9E
004FF522    mov dword ptr ss:[ebp-0x74], 0x00
004FF529    mov dword ptr ss:[ebp-0x70], 0x80AD18
004FF530    mov dword ptr ss:[ebp-0x4C], ecx
004FF533    mov dword ptr ss:[ebp-0x48], 0x9F
004FF53A    mov dword ptr ss:[ebp-0x44], 0x00
004FF541    mov dword ptr ss:[ebp-0x40], 0x80ACFC
004FF548    mov dword ptr ss:[ebp-0x1C], eax
