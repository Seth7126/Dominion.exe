...
00682E12    mov esi, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
00682E2B    addsd xmm0, qword ptr ds:[eax*8+0x893660]       ; => [ Data: data_893660 ]
...
00682E4A    addsd xmm0, qword ptr ds:[eax*8+0x893660]       ; => [ Data: data_893660 ]
00682E53    mov eax, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
...
00682E76    movaps xmmword ptr ss:[esp+0x30], xmm0          ; => [ Data: data_893580 ]
...
00682EC8    call 0x00682670                                 ; => [ Call: sub_682670 ]
...
00682EEE    push eax
00682EEF    call 0x006827E0                                 ; => [ Call: sub_6827e0 | Call: nullptr ]
