...
007501B9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
007501E5    mov dword ptr ss:[ebp-0x114], 0xFFFFFFFF        ; => [ Type: LRESULT ]
007501EF    push 0x00
007501F1    push eax
007501F2    call 0x00761FC4                                 ; => [ Call: memset ]
007501F7    mov eax, dword ptr ds:[0x019E2778]
007501FC    add esp, 0x0C
007501FF    mov edi, 0x801800                               ; => [ Data: data_801800 ]
00750204    push 0x00
00750206    push ebx
00750207    push 0x199
0075020C    push dword ptr ds:[eax+0x18]
0075020F    call dword ptr ds:[0x00775308]                  ; => [ Data: data_19e2778 | Type: LRESULT ]
...
00750261    push 0x104
00750266    push eax
00750267    call 0x0074AFA0                                 ; => [ Call: sub_74afa0 | String: %d,%d,%d ]
0075026C    add esp, 0x18
0075026F    jmp 0x0075038F
00750274    mov ecx, dword ptr ds:[esi+0x10]
00750277    call 0x0074CB60                                 ; => [ Call: sub_74cb60 ]
0075027C    mov edi, eax                                    ; => [ Data: data_1a9a490 ]
0075027E    jmp 0x00750395
00750283    cmp dword ptr ds:[esi+0x10], 0x00
00750287    mov edi, 0x8901E0                               ; => [ Data: data_8901e0 ]
0075028C    mov eax, 0x88FF00                               ; => [ Data: data_88ff00 ]
00750291    cmovz edi, eax                                  ; => [ Data: data_88ff00 ]
00750294    jmp 0x00750395
00750299    mov ecx, dword ptr ds:[esi+0x10]
0075029C    call 0x0074CBE0                                 ; => [ Call: sub_74cbe0 ]
007502A1    mov dword ptr ds:[esi+0x08], eax                ; => [ Data: data_1a9ac18 ]
...
007502D7    push 0x104
007502DC    push eax
007502DD    call 0x0074AFA0                                 ; => [ Call: sub_74afa0 | String: %d.%d.%d.%d ]
...
007502FB    push 0x01
007502FD    push 0x400
00750302    call dword ptr ds:[0x0077511C]                  ; => [ Call: nullptr ]
...
0075032B    push 0x01
0075032D    push 0x400
00750332    call dword ptr ds:[0x0077511C]                  ; => [ Call: nullptr ]
...
00750382    push 0x00
00750384    push 0x400
00750389    call dword ptr ds:[0x00775118]                  ; => [ String: hh':'mm':'ss tt | String: hh':'mm':'ss tt ]
...
007503A3    push edi
007503A4    call 0x0074AFE0                                 ; => [ Call: sub_74afe0 ]
...
007503CD    jz 0x00750481                                   ; => [ Data: data_19e2778 ]
007503D3    mov eax, dword ptr ds:[0x019E2778]
007503D8    push ebx
007503D9    push 0x00
007503DB    push 0x18F
007503E0    push dword ptr ds:[eax+0x14]
007503E3    call esi                                        ; => [ Data: data_19e2778 | Type: WPARAM ]
...
007503FD    call esi                                        ; => [ Data: data_19e2778 | Type: LRESULT ]
007503FF    mov ecx, dword ptr ds:[0x019E2778]
00750405    mov esi, eax
00750407    push 0x105
0075040C    push 0x00
0075040E    push 0x00
00750410    push dword ptr ds:[ecx+0x14]                    ; => [ Data: data_19e2778 | Type: HWND ]
00750413    mov dword ptr ss:[ebp-0x114], esi
00750419    call dword ptr ds:[0x007753FC]                  ; => [ Call: nullptr ]
0075041F    cmp esi, 0xFFFFFFFF
00750422    jz 0x00750481
00750424    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0075046A    mov eax, dword ptr ss:[ebp-0x114]               ; => [ Type: LRESULT ]
00750470    pop edi
00750471    pop esi
00750472    pop ebx
00750473    mov ecx, dword ptr ss:[ebp-0x04]
00750476    xor ecx, ebp
00750478    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0075048B    pop ebx
0075048C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
