...
00516C04    mov ecx, dword ptr ds:[0x00CCA790]
00516C0A    push esi
...
00516CE1    push 0x80CF80
00516CE6    push 0x30A
00516CEB    jmp 0x00516D5D
00516CED    imul eax, ecx, 0x26C
00516CF3    mov eax, dword ptr ds:[eax+esi*1+0x10]
00516CF7    call eax
00516CF9    mov eax, dword ptr ds:[0x00CCA78C]
00516CFE    mov dword ptr ds:[0x00CCA788], eax
00516D03    mov dword ptr ds:[0x00CCA78C], 0x00
00516D0D    pop esi
...
00516D51    pop ebp
00516D52    ret
00516D53    push 0x8145B0
00516D58    push 0x1CBB
00516D5D    mov ecx, 0x801AA4
00516D62    push 0x80CD80
00516D67    mov edx, 0x801800
00516D6C    call 0x0063B870
00516D71    add esp, 0x0C
00516D74    call 0x0063BC30
00516D79    test al, al
00516D7B    jz 0x00516D7E
00516D7D    int3
00516D7E    call 0x0063BB00
