...
004F9255    mov dword ptr fs:[0x00000000], eax
004F925B    push ecx
004F925C    mov edx, 0x104
004F9261    mov ecx, 0x461
004F9266    call 0x00568C20
...
004F9287    movlpd qword ptr ss:[ebp-0x2C], xmm0
...
004F92A1    movups xmmword ptr ss:[ebp-0xA0], xmm0
004F92A8    mov dword ptr ss:[ebp-0x3C], eax
004F92AB    lea eax, ss:[ebp-0x40]
004F92AE    movups xmm0, xmmword ptr ss:[ebp-0x30]
004F92B2    mov dword ptr ss:[ebp-0x70], 0x809C58
004F92B9    mov dword ptr ss:[ebp-0x4C], ecx
...
004F92CE    mov dword ptr ss:[ebp-0x44], 0x00
004F92D5    mov dword ptr ss:[ebp-0x40], 0x809C3C
