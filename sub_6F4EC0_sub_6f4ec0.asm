...
006F4EC5    push 0x771FCD                                   ; => [ Call: sub_771fcd | Type: EHRegistrationNode ]
006F4ECA    mov eax, dword ptr fs:[0x00000000]
006F4ED0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006F4ED1    sub esp, 0x14
006F4ED4    push esi
006F4ED5    push edi
006F4ED6    mov eax, dword ptr ds:[0x008C4040]
006F4EDB    xor eax, ebp
006F4EDD    push eax                                        ; => [ Data: __security_cookie ]
006F4EDE    lea eax, ss:[ebp-0x0C]
006F4EE1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006F4F04    jz 0x006F4F11                                   ; => [ String: %f %f | Call: sub_64b6d0 ]
...
006F4F36    push eax
006F4F37    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %g %g ]
...
006F4F73    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F4F86    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F4F8B    mov eax, dword ptr ds:[esi]
006F4F8D    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006F4F92    test eax, eax
006F4F94    cmovnz ecx, eax
006F4F97    mov dword ptr ds:[edi], ecx
006F4F99    mov ecx, dword ptr ss:[ebp-0x0C]
006F4F9C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F4FA3    pop ecx
006F4FA4    pop edi
006F4FA5    pop esi
