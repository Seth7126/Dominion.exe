...
00532D17    mov dword ptr ss:[ebp-0x264C], ecx
...
00532DED    mov dword ptr ss:[ebp-0x2674], ecx
...
005330CA    mov dword ptr ss:[ebp-0x269C], ecx
...
0053314C    push eax
0053314D    call dword ptr ds:[edx+0x10]
...
00533176    movlpd qword ptr ss:[ebp-0x25E4], xmm0
