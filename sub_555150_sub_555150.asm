...
00555168    push 0x76646B                                   ; => [ Call: sub_76646b | Type: EHRegistrationNode ]
0055516D    mov eax, dword ptr fs:[0x00000000]
00555173    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00555174    push ebx
00555175    mov eax, 0x19B0
0055517A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055517F    mov eax, dword ptr ds:[0x008C4040]
00555184    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00555186    mov dword ptr ss:[ebp-0x14], eax
00555189    push esi
0055518A    push edi
0055518B    push eax
0055518C    lea eax, ss:[ebp-0x0C]
0055518F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00555195    call 0x00573400
0055519A    mov eax, dword ptr ds:[eax+0x0C]
0055519D    mov dword ptr ss:[ebp-0xCAC], eax               ; => [ Call: sub_573400 ]
005551A3    mov dword ptr ss:[ebp-0xCA8], 0x00
005551AD    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005551D6    mov dword ptr ds:[eax], 0x81D180                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_7af27f3a589af73be7a7dfd7222593bc>, void>::`vftable'{for `std::_Func_base<void>'} ]
005551DC    mov dword ptr ds:[eax+0x08], esi
005551DF    mov dword ptr ds:[eax+0x24], eax
005551E2    call 0x005698B0                                 ; => [ Call: sub_5698b0 ]
005551E7    mov esi, dword ptr ss:[ebp-0xCA8]
005551ED    add esp, 0x28
005551F0    mov dword ptr ss:[ebp-0xCA4], esi
005551F6    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00555211    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00555214    mov dword ptr ss:[ebp-0xCB0], eax
0055521A    cmp esi, 0x320
00555220    jb 0x00555227
00555222    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00555252    push 0x1E
00555254    call 0x005911E0                                 ; => [ Call: sub_5911e0 ]
00555259    add esp, 0x24
0055525C    call 0x00573400                                 ; => [ Call: sub_573400 ]
00555261    lea ecx, ss:[ebp-0x19C0]
00555267    push 0x04
00555269    push ecx
0055526A    mov edx, dword ptr ds:[eax+0x0C]
0055526D    mov ecx, dword ptr ds:[eax+0x04]
00555270    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00555275    mov ecx, 0x321
0055527A    mov dword ptr ss:[ebp-0xD40], eax
00555280    lea esi, ss:[ebp-0x19C0]
00555286    mov dword ptr ss:[ebp-0xD08], 0x81D164          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_4fcc5e8dfbe0afdaf1ecd745680b449c>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_4fcc5e8dfbe0afdaf1ecd745680b449c>,bool,enum CardID>::VTable ]
00555290    lea edi, ss:[ebp-0xCA0]
00555296    add esp, 0x08
00555299    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0055529B    lea ecx, ss:[ebp-0xD08]
005552A1    mov dword ptr ss:[ebp-0xCE4], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_4fcc5e8dfbe0afdaf1ecd745680b449c>,bool,enum CardID>::VTable ]
...
00555323    push eax
00555324    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
0055534A    movlpd qword ptr ss:[ebp-0xCCC], xmm0           ; => [ Call: __builtin_memset ]
...
005553E0    push 0x476
005553E5    push esi
005553E6    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
005553EB    add esp, 0x1C
005553EE    mov ecx, dword ptr ss:[ebp-0x0C]
005553F1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005553F8    pop ecx
005553F9    pop edi
005553FA    pop esi
005553FB    mov ecx, dword ptr ss:[ebp-0x14]
005553FE    xor ecx, ebp
00555400    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
