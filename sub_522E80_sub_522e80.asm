...
00522EE2    call 0x00561A00
00522EE7    lea eax, ss:[ebp-0xCC8]
00522EED    mov dword ptr ss:[ebp-0xCC8], 0x817C30
00522EF7    mov dword ptr ss:[ebp-0xCA4], eax
...
00522F35    push esi
00522F36    call dword ptr ds:[eax]
