...
006415E5    push 0x76C5ED                                   ; => [ Type: EHRegistrationNode | Call: sub_76c5ed ]
006415EA    mov eax, dword ptr fs:[0x00000000]
006415F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00641601    push eax                                        ; => [ Data: __security_cookie ]
00641602    lea eax, ss:[ebp-0x0C]
00641605    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0064160B    mov dword ptr ss:[ebp-0x04], 0x00
00641612    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00641617    mov eax, dword ptr ss:[ebp+0x10]
0064161A    test eax, eax
0064161C    push 0x8723C4
00641621    cmovnz ecx, eax
00641624    push ecx
00641625    call dword ptr ds:[0x0077564C]                  ; => [ String: rb | Type: FILE ]
...
00641657    call 0x00687730                                 ; => [ Call: sub_687730 ]
0064165C    push ebx
0064165D    push edi
...
00641685    call 0x006D1AF0                                 ; => [ Call: sub_6d1af0 ]
...
0064169E    jz 0x006416C7                                   ; => [ Data: data_cf65bc ]
...
006416AF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006416C2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006416C7    xor al, al
006416C9    mov ecx, dword ptr ss:[ebp-0x0C]
006416CC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006416D3    pop ecx
006416D4    pop edi
006416D5    pop esi
006416D6    pop ebx
...
00641767    jz 0x00641790                                   ; => [ Data: data_cf65bc ]
...
00641778    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0064178B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00641790    mov al, 0x01
00641792    mov ecx, dword ptr ss:[ebp-0x0C]
00641795    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064179C    pop ecx
0064179D    pop edi
0064179E    pop esi
0064179F    pop ebx
...
006417BD    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: TruetypeReimport | Data: data_801800 | String: C:\x\ax2017\Engine\TTFont.cpp | String: f ]
006417C2    add esp, 0x0C
006417C5    call 0x0063BC30
006417CA    test al, al
006417CC    jz 0x006417CF                                   ; => [ Call: sub_63bc30 ]
006417CE    int3
006417CF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
