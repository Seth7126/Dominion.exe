...
004E102B    mov dword ptr fs:[0x00000000], eax
...
004E1055    mov eax, 0x801800
004E105A    mov dword ptr ss:[ebp-0x228], eax
004E1060    xor edi, edi
004E1062    mov dword ptr ss:[ebp-0x04], 0x01
004E1069    mov dword ptr ss:[ebp-0x224], edi
004E106F    nop
...
004E1157    call 0x0064BE70
004E115C    mov ecx, dword ptr ds:[esi]
004E115E    mov edx, 0x807488
...
004E1192    mov byte ptr ds:[edx+esi*1], cl
004E1195    inc edx
004E1196    test cl, cl
...
004E1222    call 0x0064BE70
004E1227    mov ecx, dword ptr ds:[esi]
004E1229    mov edx, 0x8071F4
...
004E12EC    call 0x0064BE70
004E12F1    mov ecx, dword ptr ds:[esi]
004E12F3    mov edx, 0x807478
...
004E1329    mov byte ptr ds:[edx+esi*1-0x01], cl
004E132D    test cl, cl
...
004E139A    call 0x0064BE70
004E139F    mov ecx, dword ptr ds:[esi]
004E13A1    mov edx, 0x807204
...
004E145E    call 0x0064BE70
004E1463    mov ecx, dword ptr ds:[esi]
004E1465    mov edx, 0x807478
...
004E149B    mov byte ptr ds:[edx+esi*1-0x01], cl
004E149F    test cl, cl
...
004E150C    call 0x0064BE70
004E1511    mov ecx, dword ptr ds:[esi]
004E1513    mov edx, 0x807214
...
004E15D8    call 0x0064BE70
004E15DD    mov ecx, dword ptr ds:[esi]
004E15DF    mov edx, 0x807224
...
004E1671    call 0x0064BE70
004E1676    mov ecx, dword ptr ds:[esi]
004E1678    mov edx, 0x80748C
...
004E16F7    push 0x8071F0
004E16FC    jmp 0x004E170A
004E16FE    push 0x8071EC
004E1703    jmp 0x004E170A
004E1705    push 0x8071E8
004E170A    lea ecx, ss:[ebp-0x228]
004E1710    call 0x0063D960
...
004E17A0    call 0x0064C080
004E17A5    mov dword ptr ss:[ebp-0x254], 0x801800
...
004E17E6    call 0x004DF8F0
004E17EB    mov eax, 0x801800
004E17F0    mov dword ptr ss:[ebp-0x21C], eax
...
004E181B    call 0x0064BE70
004E1820    mov ecx, dword ptr ds:[esi]
004E1822    mov edx, 0x807198
...
004E187D    call 0x0064BE70
004E1882    mov ecx, dword ptr ds:[esi]
004E1884    mov edx, 0x807288
...
004E197C    call 0x0064BE70
004E1981    mov ecx, dword ptr ds:[esi]
004E1983    mov edx, 0x8071D0
...
004E1A83    call 0x0064BE70
004E1A88    mov ecx, dword ptr ds:[esi]
004E1A8A    mov edx, 0x807294
...
004E1B7F    call 0x0064BE70
004E1B84    mov ecx, dword ptr ds:[esi]
004E1B86    mov edx, 0x8072A0
...
004E1C7C    call 0x0064BE70
004E1C81    mov ecx, dword ptr ds:[esi]
004E1C83    mov edx, 0x8072A8
...
004E1D8C    call 0x0064BE70
004E1D91    mov ecx, dword ptr ds:[esi]
004E1D93    mov edx, 0x8072B4
...
004E1E90    call 0x0064BE70
004E1E95    mov ecx, dword ptr ds:[esi]
004E1E97    mov edx, 0x8072C4
...
004E1F9E    call 0x0064BE70
004E1FA3    mov ecx, dword ptr ds:[esi]
004E1FA5    mov edx, 0x8072D4
...
004E209A    call 0x0064BE70
004E209F    mov ecx, dword ptr ds:[esi]
004E20A1    mov edx, 0x8072E0
...
004E225C    call 0x0064C080
004E2261    mov dword ptr ss:[ebp-0x224], 0x801800
...
004E22EE    call 0x0064C080
004E22F3    mov dword ptr ss:[ebp-0x224], 0x801800
...
004E2380    call 0x0064C080
004E2385    mov dword ptr ss:[ebp-0x224], 0x801800
...
004E2412    call 0x0064C080
004E2417    mov dword ptr ss:[ebp-0x224], 0x801800
...
004E24A4    call 0x0064C080
004E24A9    mov dword ptr ss:[ebp-0x224], 0x801800
...
004E2536    call 0x0064C080
004E253B    mov dword ptr ss:[ebp-0x224], 0x801800
004E2545    mov edx, 0x807274
004E254A    mov byte ptr ss:[ebp-0x04], 0x05
004E254E    lea ecx, ss:[ebp-0x224]
004E2554    call 0x0063D720
...
004E25C3    mov eax, 0x801800
004E25C8    cmovnz eax, esi
004E25CB    push eax
004E25CC    call 0x0063D960
...
004E25E5    jz 0x004E260F
004E25E7    lea ecx, ss:[ebp-0x224]
004E25ED    call 0x0063D4E0
...
004E2600    call 0x0064C080
004E2605    mov dword ptr ss:[ebp-0x224], 0x801800
004E260F    mov edx, 0x80727C
004E2614    mov byte ptr ss:[ebp-0x04], 0x05
004E2618    lea ecx, ss:[ebp-0x224]
004E261E    call 0x0063D720
...
004E268D    mov eax, 0x801800
004E2692    cmovnz eax, esi
004E2695    push eax
004E2696    call 0x0063D960
...
004E26AF    jz 0x004E26D9
004E26B1    lea ecx, ss:[ebp-0x224]
004E26B7    call 0x0063D4E0
...
004E26CA    call 0x0064C080
004E26CF    mov dword ptr ss:[ebp-0x224], 0x801800
004E26D9    mov eax, 0x801800
004E26DE    mov dword ptr ss:[ebp-0x224], eax
004E26E4    xor esi, esi
004E26E6    mov byte ptr ss:[ebp-0x04], 0x16
004E26EA    mov dword ptr ss:[ebp-0x238], esi
...
004E27C5    call 0x0064C080
004E27CA    mov dword ptr ss:[ebp-0x24C], 0x801800
004E27D4    inc esi
...
004E27F5    mov edi, 0x801800
004E27FA    mov dword ptr ss:[ebp-0x238], edi
...
004E28CE    call 0x0063D5E0
004E28D3    mov edi, dword ptr ss:[ebp-0x238]
004E28D9    mov esi, 0x801800
004E28DE    mov eax, dword ptr ds:[0x00807324]
004E28E3    add esp, 0x04
004E28E6    mov dword ptr ss:[ebp-0x22C], esi
004E28EC    mov dword ptr ds:[edi], eax
...
004E2AEA    movq qword ptr ds:[esi+ecx*1], xmm0
...
004E2BB6    movq qword ptr ds:[esi+ecx*1], xmm0
...
004E2C86    movq qword ptr ds:[esi+ecx*1], xmm0
...
004E2DDA    movq qword ptr ds:[ecx+esi*1], xmm0
...
004E2EA6    movq qword ptr ds:[ecx+esi*1], xmm0
...
004E2F76    movq qword ptr ds:[esi+ecx*1], xmm0
...
004E3064    push 0x807394
004E3069    lea ecx, ss:[ebp-0x22C]
004E306F    call 0x0063D960
...
004E30F1    call 0x0064C080
004E30F6    mov dword ptr ss:[ebp-0x258], 0x801800
...
004E311A    jz 0x004E313A
004E311C    lea ecx, ss:[ebp-0x22C]
004E3122    call 0x0063D4E0
...
004E3135    call 0x0064C080
004E313A    mov dword ptr ss:[ebp-0x23C], 0x801800
004E3144    mov byte ptr ss:[ebp-0x04], 0x1E
004E3148    mov esi, dword ptr ss:[ebp-0x230]
004E314E    mov dword ptr ds:[esi], 0x801800
...
004E31DC    call 0x0064C080
004E31E1    mov dword ptr ss:[ebp-0x25C], 0x801800
...
004E32B7    call 0x0064C080
004E32BC    mov dword ptr ss:[ebp-0x260], 0x801800
...
004E3390    call 0x0064C080
004E3395    mov dword ptr ss:[ebp-0x264], 0x801800
...
004E3471    call 0x0064C080
004E3476    mov dword ptr ss:[ebp-0x268], 0x801800
...
004E3544    call 0x0064C080
004E3549    mov dword ptr ss:[ebp-0x26C], 0x801800
004E3553    mov byte ptr ss:[ebp-0x04], 0x1E
004E3557    push 0x200
004E355C    lea eax, ss:[ebp-0x218]
004E3562    push 0x00
004E3564    push eax
004E3565    call 0x00761FC4
004E356A    mov ecx, dword ptr ss:[ebp-0x234]
004E3570    xor eax, eax
004E3572    add esp, 0x0C
004E3575    mov dword ptr ss:[ebp-0x22C], eax
...
004E36E1    call 0x0064C080
004E36E6    mov dword ptr ss:[ebp-0x270], 0x801800
004E36F0    mov byte ptr ss:[ebp-0x04], 0x2E
004E36F4    cmp dword ptr ds:[0x00CF65BC], 0x00
004E36FB    jz 0x004E3734
...
004E3725    call 0x0064C080
004E372A    mov dword ptr ss:[ebp-0x244], 0x801800
...
004E3748    jz 0x004E3768
004E374A    lea ecx, ss:[ebp-0x238]
004E3750    call 0x0063D4E0
...
004E37B6    jz 0x004E37D6
004E37B8    lea ecx, ss:[ebp-0x21C]
004E37BE    call 0x0063D4E0
...
004E380B    call 0x0064C080
004E3810    mov dword ptr ss:[ebp-0x248], 0x801800
004E381A    mov dword ptr ss:[ebp-0x04], 0x34
004E3821    cmp dword ptr ds:[0x00CF65BC], 0x00
004E3828    jz 0x004E3857
