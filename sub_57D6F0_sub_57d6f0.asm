...
0057D700    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: __security_cookie ]
0057D703    push ebx
0057D704    xor al, al
...
0057D738    mov ecx, dword ptr ds:[eax]                     ; => [ Call: sub_5722c0 ]
...
0057D74E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0057D7E0    test al, al
0057D7E2    jz 0x0057D7F3                                   ; => [ Call: sub_57c810 ]
...
0057D810    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0057D888    push edi
0057D889    call 0x0057C810                                 ; => [ Call: sub_57c810 ]
...
0057D8B1    pop ebx
0057D8B2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
