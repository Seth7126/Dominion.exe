...
005E0C18    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
005E0C3F    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
005E0C6D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: LandscapeType | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: IsLandscape(what) ]
005E0C72    add esp, 0x0C
005E0C75    call 0x0063BC30
005E0C7A    test al, al
005E0C7C    jz 0x005E0C7F                                   ; => [ Call: sub_63bc30 ]
005E0C7E    int3
005E0C7F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
