...
00512B38    push esi
00512B39    push edi
00512B3A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00512B4E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00512B6B    test al, al
00512B6D    jnz 0x00512BA4                                  ; => [ Call: sub_5754f0 ]
00512B6F    call 0x00573400                                 ; => [ Call: sub_573400 ]
00512B74    mov edi, dword ptr ds:[eax+0x04]
00512B77    cmp esi, 0x320
00512B7D    jb 0x00512B84
00512B7F    call 0x00591930                                 ; => [ Call: sub_591930 ]
00512B84    mov edx, dword ptr ds:[ebx+edi*1+0x1A4C]
00512B8B    mov ecx, edi
00512B8D    push 0x00
00512B8F    push 0x02
00512B91    call 0x005754F0                                 ; => [ Call: sub_5754f0 ]
