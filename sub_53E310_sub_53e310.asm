...
0053E328    push 0x76646B                                   ; => [ Call: sub_76646b | Type: EHRegistrationNode ]
0053E32D    mov eax, dword ptr fs:[0x00000000]
0053E333    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053E334    push ebx
0053E335    mov eax, 0x19B0
0053E33A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053E33F    mov eax, dword ptr ds:[0x008C4040]
0053E344    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0053E346    mov dword ptr ss:[ebp-0x14], eax
0053E349    push esi
0053E34A    push edi
0053E34B    push eax
0053E34C    lea eax, ss:[ebp-0x0C]
0053E34F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053E355    lea eax, ss:[ebp-0x19C0]
0053E35B    mov ecx, 0x3EA
0053E360    push eax
0053E361    call 0x00568780                                 ; => [ Call: sub_568780 ]
0053E366    mov esi, eax
0053E368    mov dword ptr ss:[ebp-0xD08], 0x81AE2C          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_a4b02b81bbdbcf3a79d5c3ae6e1c6852>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_a4b02b81bbdbcf3a79d5c3ae6e1c6852>,bool,enum CardID>::VTable ]
0053E372    mov ecx, 0x321
0053E377    lea edi, ss:[ebp-0xCA0]
0053E37D    lea eax, ss:[ebp-0xD08]
0053E383    add esp, 0x04
0053E386    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0053E388    mov dword ptr ss:[ebp-0xCE4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_a4b02b81bbdbcf3a79d5c3ae6e1c6852>,bool,enum CardID>::VTable ]
...
0053E3C9    call eax                                        ; => [ Field: vFunc_0 ]
...
0053E3EC    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0053E403    push eax
0053E404    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0053E407    xorps xmm0, xmm0
0053E40A    mov dword ptr ss:[ebp-0xCD4], 0x00
0053E414    movlpd qword ptr ss:[ebp-0xCDC], xmm0           ; => [ Call: __builtin_memset ]
...
0053E4CB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053E4ED    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0053E512    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
0053E517    add esp, 0x0C
0053E51A    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053E51F    push 0x3EA
...
0053E542    test al, al
0053E544    jnz 0x0053E574                                  ; => [ Call: sub_582de0 ]
...
0053E56C    call 0x00590DE0                                 ; => [ Call: sub_590de0 ]
...
0053E584    push eax
0053E585    call 0x00564CE0                                 ; => [ Call: sub_564ce0 ]
0053E58A    add esp, 0x04
0053E58D    mov ecx, dword ptr ss:[ebp-0x0C]
0053E590    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053E597    pop ecx
0053E598    pop edi
0053E599    pop esi
0053E59A    mov ecx, dword ptr ss:[ebp-0x14]
0053E59D    xor ecx, ebp
0053E59F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
