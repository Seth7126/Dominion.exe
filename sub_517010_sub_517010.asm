...
0051701B    call 0x00761E50
00517020    mov eax, dword ptr ds:[0x008C4040]
00517025    xor eax, esp
00517027    mov dword ptr ss:[esp+0x1428], eax
0051702E    mov ecx, dword ptr ds:[0x00CCA790]
00517034    push ebx
00517035    push esi
00517036    push edi
...
00517051    add edx, ecx
00517053    jmp 0x00517063
00517055    mov eax, dword ptr ds:[0x00CCA780]
...
00517084    mov eax, dword ptr ds:[eax+ecx*4]
...
00517105    mov eax, dword ptr ds:[eax+ecx*4]
...
005171A8    mov edx, dword ptr ds:[0x00CCB414]
005171AE    inc edi
...
0051727D    call 0x0063B870
00517282    add esp, 0x0C
00517285    call 0x0063BC30
0051728A    test al, al
0051728C    jz 0x0051728F
0051728E    int3
0051728F    call 0x0063BB00
