...
00682F18    push 0x76DC31                                   ; => [ Type: EHRegistrationNode | Call: sub_76dc31 ]
00682F1D    mov eax, dword ptr fs:[0x00000000]
00682F23    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00682F24    push ebx
...
00682F31    push eax                                        ; => [ Data: __security_cookie ]
00682F32    lea eax, ss:[ebp-0x0C]
00682F35    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00682F53    jle 0x00682F9A                                  ; => [ Data: data_1a99fc8 | Field: ThreadLocalStoragePointer ]
00682F55    push 0x1A99FC8
00682F5A    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a99fc8 ]
00682F5F    add esp, 0x04
00682F62    cmp dword ptr ds:[0x01A99FC8], 0xFFFFFFFF
00682F69    jnz 0x00682F9A                                  ; => [ Data: data_1a99fc8 ]
...
00682F86    mov dword ptr ds:[0x01A99FCC], eax              ; => [ String: sys\white_pixel.texture | Data: data_1a99fcc | Call: sub_69f030 ]
00682F8B    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00682F92    call 0x007596BD                                 ; => [ Data: data_1a99fc8 | Call: __Init_thread_footer ]
00682F97    add esp, 0x04
00682F9A    mov eax, dword ptr ds:[edi]
00682F9C    movaps xmm0, xmmword ptr ds:[0x008934E0]        ; => [ Data: data_8934e0 ]
00682FA3    mov edx, dword ptr ss:[ebp-0x14]
00682FA6    mov ecx, dword ptr ds:[0x01A99FCC]              ; => [ Data: data_1a99fcc ]
...
00682FC4    call 0x00682A60                                 ; => [ Call: nullptr | Call: sub_682a60 ]
00682FC9    add esp, 0x0C
00682FCC    mov ecx, dword ptr ss:[ebp-0x0C]
00682FCF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00682FD6    pop ecx
00682FD7    pop edi
00682FD8    pop esi
