...
0040101F    mov dword ptr fs:[0x00000000], eax
00401025    push 0x4AB280
0040102A    push 0x4AB270
0040102F    push 0x280
00401034    push 0x20
00401036    push 0x8D2FF8
0040103B    mov dword ptr ss:[ebp-0x04], 0x00
00401042    call 0x00759288
00401047    mov dword ptr ds:[0x008D804C], 0x00
...
00401079    mov dword ptr ds:[0x008D8060], 0x01
00401083    mov dword ptr ds:[0x008D8064], 0x00
0040108D    mov dword ptr ds:[0x008D80A0], 0x801800
00401097    mov dword ptr ds:[0x008D80A4], 0x801800
004010A1    mov dword ptr ds:[0x008D80A8], 0x801800
004010AB    mov dword ptr ds:[0x008D93C8], 0x801800
004010B5    mov dword ptr ds:[0x008D93CC], 0x801800
004010BF    mov dword ptr ds:[0x008D93D0], 0x801800
004010C9    mov dword ptr ds:[0x008DA540], 0x00
004010D3    mov dword ptr ds:[0x008DA544], 0x00
004010DD    mov dword ptr ds:[0x008DA548], 0x00
004010E7    mov dword ptr ss:[ebp-0x10], 0x8DA588
004010EE    mov dword ptr ds:[0x008DA588], 0x00
...
00401199    mov dword ptr ds:[0x008DA738], 0x01
004011A3    mov dword ptr ds:[0x008DA73C], 0x00
004011AD    call 0x0075964C
004011B2    add esp, 0x04
004011B5    mov ecx, dword ptr ss:[ebp-0x0C]
004011B8    mov dword ptr fs:[0x00000000], ecx
004011BF    pop ecx
