...
0067A00B    jle 0x0067A060
0067A00D    mov ebx, 0xC29C84
...
0067A05E    jl 0x0067A012
0067A060    cmp dword ptr ds:[0x00C27C24], 0x00
0067A067    mov dword ptr ds:[0x00CA9A6C], 0x00
0067A071    mov dword ptr ds:[0x00CA9A70], 0x00
0067A07B    mov dword ptr ds:[0x00C28C58], 0x00
0067A085    jz 0x0067A0A5
0067A087    mov ecx, 0xC27C24
0067A08C    mov dword ptr ds:[0x00C27C20], 0x00
0067A096    call 0x0064E810
0067A09B    mov dword ptr ds:[0x00C27C24], 0x00
0067A0A5    pop edi
0067A0A6    pop esi
0067A0A7    pop ebx
0067A0A8    ret
...
0067A0C2    call 0x0063B870
0067A0C7    add esp, 0x0C
0067A0CA    call 0x0063BC30
0067A0CF    test al, al
0067A0D1    jz 0x0067A0D4
0067A0D3    int3
0067A0D4    call 0x0063BB00
