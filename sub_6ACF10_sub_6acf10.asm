...
006ACF15    push 0x76FAB9                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0ScheduleGroupBase@details@Concurrency@@QAE@PAVSchedulerBase@12@PAVlocation@2@@Z ]
006ACF1A    mov eax, dword ptr fs:[0x00000000]
006ACF20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006ACF21    sub esp, 0x0C
006ACF24    push esi
006ACF25    mov eax, dword ptr ds:[0x008C4040]
006ACF2A    xor eax, ebp
006ACF2C    push eax                                        ; => [ Data: __security_cookie ]
006ACF2D    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006ACF30    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006ACF36    mov esi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
006ACF68    jle 0x006ACFAB                                  ; => [ Data: data_1a9a298 | Field: ThreadLocalStoragePointer ]
006ACF6A    push 0x1A9A298
006ACF6F    call 0x0075970E                                 ; => [ Data: data_1a9a298 | Call: sub_75970e ]
006ACF74    add esp, 0x04
006ACF77    cmp dword ptr ds:[0x01A9A298], 0xFFFFFFFF
006ACF7E    jnz 0x006ACFA8                                  ; => [ Data: data_1a9a298 ]
...
006ACF9B    mov dword ptr ds:[0x01A9A29C], eax              ; => [ Data: data_1a9a29c | String: sys/DebugFont.font | Call: sub_69f030 ]
006ACFA0    call 0x007596BD                                 ; => [ Data: data_1a9a298 | Call: __Init_thread_footer ]
006ACFA5    add esp, 0x04
006ACFA8    xorps xmm1, xmm1
006ACFAB    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006ACFC6    mov ecx, dword ptr ds:[eax+0x14]                ; => [ Data: data_cf65b4 ]
...
006AD000    call 0x0063D850                                 ; => [ String: %d | Call: sub_63df30 | Call: sub_63d850 ]
006AD005    mov byte ptr ss:[ebp-0x04], 0x03
006AD009    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD010    jz 0x006AD0A5                                   ; => [ Data: data_cf65bc ]
...
006AD029    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD03C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AD041    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006AD065    call 0x0063D850                                 ; => [ String: %d stall %d | Call: sub_63df30 | Call: sub_63d850 ]
006AD06A    mov byte ptr ss:[ebp-0x04], 0x05
006AD06E    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD075    jz 0x006AD0A5                                   ; => [ Data: data_cf65bc ]
...
006AD086    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD099    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AD09E    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006AD0A5    mov byte ptr ss:[ebp-0x04], 0x01
006AD0A9    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006AD0D7    call 0x006B3F10                                 ; => [ Data: data_1a9a29c | Call: sub_6b3f10 ]
...
006AD0F6    jz 0x006AD113                                   ; => [ Data: data_cf65bc ]
006AD0F8    lea ecx, ss:[ebp-0x10]
006AD0FB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD10E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AD113    mov ecx, dword ptr ss:[ebp-0x0C]
006AD116    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AD11D    pop ecx
006AD11E    pop esi
...
006AD139    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
006AD13E    add esp, 0x0C
006AD141    call 0x0063BC30
006AD146    test al, al
006AD148    jz 0x006AD14B                                   ; => [ Call: sub_63bc30 ]
006AD14A    int3
006AD14B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
