...
0071115B    jnz 0x00711176                                  ; => [ Data: data_19e2770 ]
0071115D    mov ecx, 0x88DC68
00711162    mov dword ptr ds:[0x019E2770], 0x01             ; => [ Data: data_19e2770 ]
0071116C    call 0x00714870
00711171    mov dword ptr ds:[0x019E2770], eax              ; => [ String: <empty> | Call: sub_714870 | Data: data_19e2770 ]
00711176    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
0071117B    test eax, eax
0071117D    jz 0x00711192
0071117F    push 0xE4
00711184    push 0x88DC70
00711189    push 0x38
0071118B    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
0071118D    add esp, 0x0C
00711190    jmp 0x0071119D
00711192    push 0x38
00711194    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007111A5    push 0x00
007111A7    push esi
007111A8    call 0x00761FC4                                 ; => [ Call: memset ]
007111AD    add esp, 0x0C
007111B0    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007111C9    push 0x14
007111CB    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
007111CD    add esp, 0x0C
007111D0    jmp 0x007111DD
007111D2    push 0x14
007111D4    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007111F1    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00711212    push 0x40
00711214    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00711216    add esp, 0x0C
00711219    jmp 0x00711226
0071121B    push 0x40
0071121D    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0071122E    push 0x00
00711230    push ebx
00711231    call 0x00761FC4                                 ; => [ Call: memset ]
00711236    add esp, 0x0C
00711239    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071125A    push 0x200
0071125F    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00711261    add esp, 0x0C
00711264    jmp 0x00711274
00711266    push 0x200
0071126B    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0071127F    push 0x00
00711281    push edi
00711282    call 0x00761FC4                                 ; => [ Call: memset ]
00711287    add esp, 0x0C
0071128A    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007112A0    push 0x200
007112A5    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
007112A7    add esp, 0x0C
007112AA    jmp 0x007112BA
007112AC    push 0x200
007112B1    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007112C5    push 0x00
007112C7    push edi
007112C8    call 0x00761FC4                                 ; => [ Call: memset ]
