...
004C5696    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004C572E    call 0x0063B870
004C5733    add esp, 0x0C
004C5736    call 0x0063BC30
004C573B    test al, al
004C573D    jz 0x004C5740
004C573F    int3
004C5740    call 0x0063BB00
