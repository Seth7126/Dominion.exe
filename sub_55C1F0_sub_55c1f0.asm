...
0055C1F0    push ecx
0055C1F1    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055C1F6    push 0x00
0055C1F8    push 0x00
0055C1FA    push 0x02
...
0055C202    push 0x02
0055C204    call 0x00590760                                 ; => [ Call: sub_590760 ]
0055C209    add esp, 0x10
0055C20C    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055C242    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0055C247    add esp, 0x0C
0055C24A    call 0x0063BC30
0055C24F    test al, al
0055C251    jz 0x0055C254                                   ; => [ Call: sub_63bc30 ]
0055C253    int3
0055C254    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
