...
004C8B60    mov dword ptr fs:[0x00000000], eax
...
004C8B74    call 0x0063D720
004C8B79    mov eax, dword ptr ss:[ebp-0x10]
004C8B7C    mov ecx, 0x801800
...
004C8BD2    jz 0x004C8BF6
004C8BD4    lea ecx, ss:[ebp-0x10]
004C8BD7    call 0x0063D4E0
...
004C8C94    jz 0x004C8CB8
004C8C96    lea ecx, ss:[ebp-0x10]
004C8C99    call 0x0063D4E0
...
004C8CAC    call 0x0064C080
004C8CB1    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C8D5C    jz 0x004C8D80
004C8D5E    lea ecx, ss:[ebp-0x10]
004C8D61    call 0x0063D4E0
...
004C8D74    call 0x0064C080
004C8D79    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C8E1E    jz 0x004C8E42
004C8E20    lea ecx, ss:[ebp-0x10]
004C8E23    call 0x0063D4E0
...
004C8E36    call 0x0064C080
004C8E3B    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C8EE4    jz 0x004C8F08
004C8EE6    lea ecx, ss:[ebp-0x10]
004C8EE9    call 0x0063D4E0
...
004C8EFC    call 0x0064C080
004C8F01    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C8F24    mov dword ptr ds:[eax+0x42BC], esi
004C8F2A    mov ecx, dword ptr ds:[0x00CC8DC8]
004C8F30    call 0x004D8AD0
004C8F35    mov esi, dword ptr ds:[edi+0x04]
004C8F38    lea ecx, ss:[ebp-0x10]
004C8F3B    mov edx, 0x804414
004C8F40    call 0x0063D720
004C8F45    mov eax, dword ptr ss:[ebp-0x10]
004C8F48    mov ecx, 0x801800
...
004C8F8E    jz 0x004C8FB2
004C8F90    lea ecx, ss:[ebp-0x10]
004C8F93    call 0x0063D4E0
...
004C901C    jz 0x004C9040
004C901E    lea ecx, ss:[ebp-0x10]
004C9021    call 0x0063D4E0
...
004C90AE    jz 0x004C90D2
004C90B0    lea ecx, ss:[ebp-0x10]
004C90B3    call 0x0063D4E0
...
004C90C6    call 0x0064C080
004C90CB    mov dword ptr ss:[ebp-0x10], 0x801800
004C90D2    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C90D9    test esi, esi
004C90DB    jnz 0x004C91A9
004C90E1    mov ecx, dword ptr ds:[0x0147ABFC]
...
004C9202    jz 0x004C9226
004C9204    lea ecx, ss:[ebp-0x10]
004C9207    call 0x0063D4E0
...
004C92BE    jz 0x004C92E2
004C92C0    lea ecx, ss:[ebp-0x10]
004C92C3    call 0x0063D4E0
...
004C92D6    call 0x0064C080
004C92DB    mov dword ptr ss:[ebp-0x10], 0x801800
004C92E2    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C92E9    test esi, esi
004C92EB    jnz 0x004C9324
004C92ED    mov eax, dword ptr ds:[0x00CC8DC0]
004C92F2    test eax, eax
004C92F4    jnz 0x004C930F
004C92F6    push 0x806A44
004C92FB    push 0x5FB
004C9300    push 0x806734
004C9305    mov ecx, 0x806A58
...
004C937D    jz 0x004C93A1
004C937F    lea ecx, ss:[ebp-0x10]
004C9382    call 0x0063D4E0
...
004C9395    call 0x0064C080
004C939A    mov dword ptr ss:[ebp-0x10], 0x801800
004C93A1    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C93A8    test esi, esi
004C93AA    jnz 0x004C93E3
004C93AC    mov eax, dword ptr ds:[0x00CC8DC0]
004C93B1    test eax, eax
004C93B3    jnz 0x004C93CE
004C93B5    push 0x806A44
004C93BA    push 0x5FB
004C93BF    push 0x806734
004C93C4    mov ecx, 0x806A58
...
004C943C    jz 0x004C9460
004C943E    lea ecx, ss:[ebp-0x10]
004C9441    call 0x0063D4E0
...
004C94CC    jz 0x004C94F0
004C94CE    lea ecx, ss:[ebp-0x10]
004C94D1    call 0x0063D4E0
...
004C94E4    call 0x0064C080
004C94E9    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C9562    jz 0x004C9586
004C9564    lea ecx, ss:[ebp-0x10]
004C9567    call 0x0063D4E0
...
004C957A    call 0x0064C080
004C957F    mov dword ptr ss:[ebp-0x10], 0x801800
004C9586    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C958D    test esi, esi
004C958F    jnz 0x004C95CA
004C9591    mov esi, dword ptr ds:[0x00CC8DC0]
004C9597    test esi, esi
004C9599    jnz 0x004C95B4
004C959B    push 0x806A44
004C95A0    push 0x5FB
004C95A5    push 0x806734
004C95AA    mov ecx, 0x806A58
...
004C9623    jz 0x004C9647
004C9625    lea ecx, ss:[ebp-0x10]
004C9628    call 0x0063D4E0
...
004C96B0    jz 0x004C96D4
004C96B2    lea ecx, ss:[ebp-0x10]
004C96B5    call 0x0063D4E0
...
004C973D    jz 0x004C9761
004C973F    lea ecx, ss:[ebp-0x10]
004C9742    call 0x0063D4E0
...
004C97FC    jz 0x004C9820
004C97FE    lea ecx, ss:[ebp-0x10]
004C9801    call 0x0063D4E0
...
004C98BC    jz 0x004C98E0
004C98BE    lea ecx, ss:[ebp-0x10]
004C98C1    call 0x0063D4E0
...
004C98D4    call 0x0064C080
004C98D9    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C98FA    mov esi, dword ptr ds:[eax+0x1718]
...
004C9912    call 0x0063D720
004C9917    mov ecx, esi
004C9919    mov dword ptr ss:[ebp-0x04], 0x13
004C9920    call 0x0064E7A0
004C9925    mov ecx, 0x801800
004C992A    mov edx, 0x801800
004C992F    mov eax, dword ptr ds:[eax+0x15E0]
...
004C997E    jz 0x004C99A2
004C9980    lea ecx, ss:[ebp-0x10]
004C9983    call 0x0063D4E0
...
004C9996    call 0x0064C080
004C999B    mov dword ptr ss:[ebp-0x10], 0x801800
004C99A2    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C99A9    test esi, esi
004C99AB    mov esi, dword ptr ds:[0x00CC8DC0]
004C99B1    jnz 0x004C9A72
004C99B7    test esi, esi
004C99B9    jnz 0x004C99D4
004C99BB    push 0x806A44
004C99C0    push 0x5FB
004C99C5    push 0x806734
004C99CA    mov ecx, 0x806A58
...
004C9A0E    mov dword ptr ds:[0x00CC8DAC], 0x01
004C9A18    jmp 0x004C9A25
004C9A1A    mov dword ptr ds:[0x00CC8DAC], 0x00
004C9A24    inc edi
004C9A25    mov ecx, dword ptr ds:[0x0171E6B0]
004C9A2B    movd xmm0, edi
004C9A2F    cvtdq2ps xmm0, xmm0
004C9A32    mov dword ptr ds:[0x00CC8DA8], 0x01
004C9A3C    mulss xmm0, dword ptr ds:[0x00890D24]
004C9A44    movss dword ptr ds:[esi], xmm0
004C9A48    call 0x00688A10
004C9A4D    movss xmm4, dword ptr ds:[esi+0x04]
004C9A52    xorps xmm0, xmm0
...
004C9A6A    xorps xmm1, xmm1
004C9A6D    jmp 0x004C9B2F
004C9A72    test esi, esi
004C9A74    jnz 0x004C9A8F
004C9A76    push 0x806A44
004C9A7B    push 0x5FB
004C9A80    push 0x806734
004C9A85    mov ecx, 0x806A58
...
004C9ACA    mov dword ptr ds:[0x00CC8DB4], 0x01
004C9AD4    jmp 0x004C9AE1
004C9AD6    mov dword ptr ds:[0x00CC8DB4], 0x00
004C9AE0    inc edi
004C9AE1    mov ecx, dword ptr ds:[0x0171E6B0]
004C9AE7    movd xmm0, edi
004C9AEB    cvtdq2ps xmm0, xmm0
004C9AEE    mov dword ptr ds:[0x00CC8DB0], 0x01
004C9AF8    mulss xmm0, dword ptr ds:[0x00890D24]
004C9B00    movss dword ptr ds:[esi+0x04], xmm0
004C9B05    call 0x00688A10
004C9B0A    movss xmm4, dword ptr ds:[esi+0x04]
004C9B0F    xorps xmm0, xmm0
...
004C9B5D    call 0x0063D720
004C9B62    mov eax, dword ptr ss:[ebp+0x08]
004C9B65    mov ecx, 0x801800
...
004C9BAC    jz 0x004C9BD0
004C9BAE    lea ecx, ss:[ebp+0x08]
004C9BB1    call 0x0063D4E0
...
004C9BC4    call 0x0064C080
004C9BC9    mov dword ptr ss:[ebp+0x08], 0x801800
004C9BD0    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C9BD7    test esi, esi
004C9BD9    jnz 0x004C9C0C
004C9BDB    mov eax, dword ptr ds:[0x00CC8D5C]
004C9BE0    test eax, eax
004C9BE2    jz 0x004C9C20
004C9BE4    cmp dword ptr ds:[eax+0x5068], esi
004C9BEA    mov dword ptr ds:[0x00CD3190], esi
004C9BF0    mov dword ptr ds:[0x008DB660], 0x7E5
004C9BFA    mov dword ptr ds:[0x00CD318C], esi
004C9C00    jz 0x004C9C0C
004C9C02    mov dword ptr ds:[0x00CD318C], 0x01
004C9C0C    xor al, al
004C9C0E    mov ecx, dword ptr ss:[ebp-0x0C]
004C9C11    mov dword ptr fs:[0x00000000], ecx
004C9C18    pop ecx
004C9C19    pop edi
004C9C1A    pop esi
004C9C1B    pop ebx
...
004C9C1E    pop ebp
004C9C1F    ret
004C9C20    push 0x77EB90
004C9C25    push 0x7B
004C9C27    push 0x77EB50
004C9C2C    mov ecx, 0x77EB9C
004C9C31    mov edx, 0x801800
004C9C36    call 0x0063B870
004C9C3B    add esp, 0x0C
004C9C3E    call 0x0063BC30
004C9C43    test al, al
004C9C45    jz 0x004C9C48
004C9C47    int3
004C9C48    call 0x0063BB00
