...
00597895    push 0x7676BF                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?RemoveCore@SchedulerProxy@details@Concurrency@@QAEXPAUSchedulerNode@23@I@Z ]
0059789A    mov eax, dword ptr fs:[0x00000000]
005978A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005978AE    push eax                                        ; => [ Data: __security_cookie ]
005978AF    lea eax, ss:[ebp-0x0C]
005978B2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0059792D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005979D5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005979DA    mov eax, 0x801800                               ; => [ Data: data_801800 ]
005979DF    mov dword ptr ss:[ebp-0x10], eax                ; => [ Data: data_801800 ]
...
005979F7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00597A3F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00597A76    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00597A89    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00597A8E    mov ecx, dword ptr ss:[ebp-0x0C]
00597A91    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00597A98    pop ecx
00597A99    pop edi
00597A9A    pop esi
00597A9B    pop ebx
