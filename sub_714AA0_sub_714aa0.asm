...
00714AAA    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00714AB0    push dword ptr ds:[esi+0x08]
00714AB3    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00714AB9    push dword ptr ds:[esi+0x10]
00714ABC    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00714AC2    push esi
00714AC3    call dword ptr ds:[0x00800B48]
00714AC9    add esp, 0x10
00714ACC    pop esi
00714ACD    pop ebp
00714ACE    ret                                             ; => [ Call: free ]
