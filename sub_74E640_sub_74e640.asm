...
0074E649    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0074E64E    xor eax, ebp
0074E650    mov dword ptr ss:[ebp-0x04], eax
0074E653    mov eax, dword ptr ss:[ebp+0x08]                ; => [ Type: LRESULT ]
...
0074E671    mov edi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074E691    jmp dword ptr ds:[eax*4+0x74EEF8]               ; => [ Type: OPENFILENAMEA ]
...
0074E6CD    mov dword ptr ss:[ebp-0x6B0], eax               ; => [ Call: sub_74b3b0 ]
...
0074E793    mov dword ptr ds:[eax+0x10], esi                ; => [ Data: data_19e2778 ]
...
0074E887    call 0x0064B6D0                                 ; => [ Call: sub_64b6d0 | String: Title: %32[^\r\n] Path: %256[^\r\n] Filter: %256[^\r\n] Default Extension: %32[^\r\n] ]
...
0074E8B3    push eax
0074E8B4    cmovz ecx, edx                                  ; => [ Data: data_8901d4 | String: Select file ]
0074E8B7    push 0x8901D4
0074E8BC    mov dword ptr ss:[ebp-0x658], ecx               ; => [ Field: lpstrTitle ]
0074E8C2    call esi
0074E8C4    add esp, 0x28
0074E8C7    test eax, eax
0074E8C9    jz 0x0074E90E                                   ; => [ Data: data_8901d4 ]
...
0074E908    mov dword ptr ss:[ebp-0x65C], eax               ; => [ Field: lpstrInitialDir ]
...
0074E921    jz 0x0074E951                                   ; => [ Data: data_8901d4 ]
...
0074E949    mov dword ptr ss:[ebp-0x67C], eax               ; => [ Field: lpstrFilter ]
0074E94F    jmp 0x0074E95B
0074E951    mov dword ptr ss:[ebp-0x67C], 0x890284          ; => [ Field: lpstrFilter | String: All Files (*.*) ]
0074E95B    lea eax, ss:[ebp-0x110]
0074E961    push eax
0074E962    push 0x8901D4
0074E967    call esi                                        ; => [ Data: data_8901d4 ]
0074E969    add esp, 0x08
0074E96C    mov dword ptr ss:[ebp-0x668], 0x104             ; => [ Field: nMaxFile ]
0074E976    test eax, eax
0074E978    mov dword ptr ss:[ebp-0x654], 0x81804           ; => [ Field: Flags ]
0074E982    lea eax, ss:[ebp-0x530]
0074E988    mov edx, 0x876758
0074E98D    mov dword ptr ss:[ebp-0x66C], eax               ; => [ Field: lpstrFile ]
0074E993    lea ecx, ss:[ebp-0x110]
0074E999    lea eax, ss:[ebp-0x688]
0074E99F    cmovz ecx, edx                                  ; => [ Data: data_876758 ]
0074E9A2    push eax
0074E9A3    mov dword ptr ss:[ebp-0x64C], ecx               ; => [ Field: lpstrDefExt ]
0074E9A9    call dword ptr ds:[0x0077501C]
0074E9AF    test eax, eax
0074E9B1    mov eax, dword ptr ss:[ebp-0x658]
0074E9B7    mov dword ptr ss:[ebp-0x6A8], eax               ; => [ Field: lpstrTitle ]
0074E9BD    mov eax, dword ptr ss:[ebp-0x67C]
0074E9C3    mov dword ptr ss:[ebp-0x6A0], eax               ; => [ Field: lpstrFilter ]
0074E9C9    mov eax, dword ptr ss:[ebp-0x64C]
0074E9CF    mov dword ptr ss:[ebp-0x69C], eax               ; => [ Field: lpstrDefExt ]
0074E9D5    mov eax, dword ptr ds:[0x019E2778]
0074E9DA    mov eax, dword ptr ds:[eax+0x04]
0074E9DD    push dword ptr ds:[eax+0x10]                    ; => [ Data: data_19e2778 ]
0074E9E0    jz 0x0074EAC4
0074E9E6    mov esi, dword ptr ss:[ebp-0x66C]               ; => [ Field: lpstrFile | Type: CHAR ]
...
0074EA04    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0074EA09    mov ecx, esi                                    ; => [ Type: CHAR ]
...
0074EA3D    mov ecx, esi                                    ; => [ Type: CHAR ]
...
0074EACA    mov dword ptr ss:[ebp-0x6A4], 0x801800          ; => [ Data: data_801800 ]
0074EAD4    call esi
...
0074EB01    mov dword ptr ds:[eax+0x10], ecx                ; => [ Data: data_19e2778 ]
0074EB04    mov eax, dword ptr ds:[0x019E2778]
0074EB09    mov eax, dword ptr ds:[eax+0x04]
0074EB0C    push dword ptr ds:[eax+0x08]
0074EB0F    call esi                                        ; => [ Data: data_19e2778 ]
0074EB11    add esp, 0x04
0074EB14    lea ecx, ss:[ebp-0x6A8]
0074EB1A    call 0x0074CBE0                                 ; => [ Call: sub_74cbe0 ]
0074EB1F    mov esi, eax                                    ; => [ Data: data_1a9ac18 ]
0074EB21    test esi, esi
0074EB23    jz 0x0074EB2A
0074EB25    cmp byte ptr ds:[esi], 0x00
0074EB28    jnz 0x0074EB2F                                  ; => [ Data: data_1a9ac18 ]
0074EB2A    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
0074EB61    mov dword ptr ds:[eax+0x08], edi                ; => [ Data: data_19e2778 | Data: data_19e2778 ]
...
0074EB7A    push esi
0074EB7B    push edi
0074EB7C    call 0x00761FBE                                 ; => [ Call: memcpy | Call: memcpy ]
0074EB81    mov eax, dword ptr ds:[0x019E2778]
0074EB86    add esp, 0x0C
0074EB89    mov eax, dword ptr ds:[eax+0x04]
0074EB8C    mov dword ptr ds:[eax+0x08], edi                ; => [ Data: data_19e2778 | Data: data_19e2778 ]
0074EB8F    jmp 0x0074EEB2
0074EB94    lea eax, ss:[ebp-0x634]
0074EB9A    mov dword ptr ss:[ebp-0x6CC], 0x00              ; => [ Type: CHOOSEFONTA | Field: hDC ]
0074EBA4    push eax
0074EBA5    lea eax, ss:[ebp-0x654]
0074EBAB    mov dword ptr ss:[ebp-0x6C4], 0x00              ; => [ Field: iPointSize ]
0074EBB5    push eax
...
0074EC3E    call 0x0064B6D0                                 ; => [ String: Height: %d Width: %d Escapement: %d Orientation:  %d Weight: %d Italic: %hhd Underline: %hhd StrikeOut: %hhd CharSet: %hhd OutPrecision: %hhd ClipPrecision: %hhd Quality: %hhd PitchAndFamily: %hhd FaceName: %32[^\r\n] Color: %d | Call: sub_64b6d0 ]
0074EC43    mov eax, dword ptr ss:[ebp-0x68C]
0074EC49    add esp, 0x44
0074EC4C    mov dword ptr ss:[ebp-0x6D0], eax               ; => [ Field: hwndOwner ]
0074EC52    mov eax, dword ptr ds:[0x019E2778]
0074EC57    mov dword ptr ss:[ebp-0x6D4], 0x3C              ; => [ Field: lStructSize ]
0074EC61    mov eax, dword ptr ds:[eax]
0074EC63    mov dword ptr ss:[ebp-0x6AC], eax               ; => [ Data: data_19e2778 ]
0074EC69    lea eax, ss:[ebp-0x670]
0074EC6F    mov dword ptr ss:[ebp-0x6C8], eax               ; => [ Field: lpLogFont ]
0074EC75    mov eax, dword ptr ss:[ebp-0x634]
0074EC7B    mov dword ptr ss:[ebp-0x6BC], eax               ; => [ Field: FlagsEx ]
0074EC81    lea eax, ss:[ebp-0x6D4]
0074EC87    push eax
0074EC88    mov dword ptr ss:[ebp-0x6C0], 0x141             ; => [ Field: Flags ]
0074EC92    call dword ptr ds:[0x00775010]
0074EC98    test eax, eax
0074EC9A    jz 0x0074EEB2
0074ECA0    mov eax, dword ptr ss:[ebp-0x6BC]
0074ECA6    mov dword ptr ss:[ebp-0x634], eax               ; => [ Field: FlagsEx ]
0074ECAC    mov eax, dword ptr ds:[0x019E2778]
0074ECB1    mov eax, dword ptr ds:[eax+0x04]
0074ECB4    push dword ptr ds:[eax+0x10]
0074ECB7    call dword ptr ds:[0x00775528]                  ; => [ Data: data_19e2778 ]
0074ECBD    add esp, 0x04
0074ECC0    lea ecx, ss:[ebp-0x670]
0074ECC6    call 0x0074CB60                                 ; => [ Call: sub_74cb60 ]
0074ECCB    mov esi, eax                                    ; => [ Data: data_1a9a490 ]
0074ECCD    test esi, esi
0074ECCF    jz 0x0074ECD6
0074ECD1    cmp byte ptr ds:[esi], 0x00
0074ECD4    jnz 0x0074ECDB                                  ; => [ Data: data_1a9a490 ]
0074ECD6    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
0074ED2E    js 0x0074EE34                                   ; => [ Type: IMalloc ]
...
0074ED57    rep stosd                                       ; => [ Call: __builtin_memset ]
0074ED59    lea eax, ss:[ebp-0x690]
0074ED5F    mov dword ptr ss:[ebp-0x6B0], 0x00
0074ED69    push eax                                        ; => [ Type: IShellFolder | Type: IShellFolder ]
0074ED6A    mov dword ptr ss:[ebp-0x6AC], 0x801800          ; => [ Data: data_801800 ]
0074ED74    mov dword ptr ss:[ebp-0x694], 0x00
0074ED7E    call dword ptr ds:[0x0077526C]
0074ED84    test eax, eax
0074ED86    js 0x0074EDC0
0074ED88    mov eax, dword ptr ss:[ebp-0x690]               ; => [ Type: IShellFolder ]
...
0074EDB4    mov eax, dword ptr ss:[ebp-0x690]               ; => [ Type: IShellFolder ]
0074EDBA    push eax
...
0074EDDD    mov dword ptr ss:[ebp-0x6A4], 0x74CD20          ; => [ Call: sub_74cd20 ]
0074EDE7    mov dword ptr ss:[ebp-0x6A0], esi
0074EDED    call dword ptr ds:[0x00775274]                  ; => [ Type: ITEMIDLIST ]
0074EDF3    mov esi, eax
0074EDF5    test esi, esi
0074EDF7    jz 0x0074EE07
0074EDF9    push 0x1A9AB10
0074EDFE    push esi
0074EDFF    call dword ptr ds:[0x00775270]                  ; => [ Data: data_1a9ab10 ]
0074EE05    jmp 0x0074EE1B
0074EE07    push 0x104
0074EE0C    push 0x00
0074EE0E    push 0x1A9AB10
0074EE13    call 0x00761FC4                                 ; => [ Data: data_1a9ab10 | Call: memset ]
0074EE18    add esp, 0x0C
0074EE1B    mov eax, dword ptr ss:[ebp-0x698]               ; => [ Type: IMalloc ]
0074EE21    push esi
0074EE22    push eax
0074EE23    mov ecx, dword ptr ds:[eax]
0074EE25    call dword ptr ds:[ecx+0x14]
0074EE28    mov eax, dword ptr ss:[ebp-0x698]               ; => [ Type: IMalloc ]
0074EE2E    push eax
...
0074EE3F    call dword ptr ds:[0x00775528]                  ; => [ Data: data_19e2778 ]
0074EE45    add esp, 0x04
0074EE48    mov eax, 0x1A9AB10
0074EE4D    cmp byte ptr ds:[0x01A9AB10], 0x00
0074EE54    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0074EE59    cmovnz esi, eax                                 ; => [ Data: data_1a9ab10 | Data: data_1a9ab10 ]
...
0074EE9D    push esi
0074EE9E    push edi
0074EE9F    call 0x00761FBE                                 ; => [ Call: memcpy | Call: memcpy ]
0074EEA4    add esp, 0x0C
0074EEA7    mov eax, dword ptr ds:[0x019E2778]
0074EEAC    mov eax, dword ptr ds:[eax+0x04]
0074EEAF    mov dword ptr ds:[eax+0x10], edi                ; => [ Data: data_19e2778 | Data: data_19e2778 | Data: data_19e2778 | Data: data_19e2778 ]
0074EEB2    push 0x00
...
0074EEDB    call dword ptr ds:[0x007753FC]                  ; => [ Call: nullptr ]
0074EEE1    call 0x00750570                                 ; => [ Call: sub_750570 ]
0074EEE6    mov ecx, dword ptr ss:[ebp-0x04]
0074EEE9    pop edi
0074EEEA    pop esi
0074EEEB    xor ecx, ebp
0074EEED    pop ebx
0074EEEE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
