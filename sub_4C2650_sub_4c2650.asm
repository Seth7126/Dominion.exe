...
004C2660    push 0x80397C
004C2665    push 0x13C9
004C266A    mov ecx, 0x803988
...
004C26E7    pop ebp
004C26E8    ret
004C26E9    push 0x80397C
004C26EE    push 0x13DA
004C26F3    mov ecx, 0x8039C0
004C26F8    push 0x80292C
004C26FD    mov edx, 0x801800
004C2702    call 0x0063B870
004C2707    add esp, 0x0C
004C270A    call 0x0063BC30
004C270F    test al, al
004C2711    jz 0x004C2714
004C2713    int3
004C2714    call 0x0063BB00
