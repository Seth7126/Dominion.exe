...
00515B0F    push 0x8142EC                                   ; => [ String: CanAddStamp ]
00515B14    push 0x1A16
00515B19    mov ecx, 0x8142F8                               ; => [ String: stamp != CLANDMOD_EVENT_STAMP_GOT_IT_ALREADY ]
00515B1E    jmp 0x00515BD8
00515B23    test esi, esi
00515B25    jz 0x00515B52
00515B27    mov edx, 0x18
00515B2C    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
00515B59    jnz 0x00515BC9                                  ; => [ Data: data_cca78c ]
00515B5B    mov eax, dword ptr ds:[0x00CCA788]
00515B60    mov ecx, edi
00515B62    mov dword ptr ds:[0x00CCA78C], eax              ; => [ Data: data_cca78c | Data: data_cca788 ]
00515B67    mov dword ptr ds:[0x00CCA788], esi              ; => [ Data: data_cca788 ]
00515B6D    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
00515BB5    pop edi
00515BB6    pop esi
00515BB7    mov dword ptr ds:[0x00CCA788], ecx              ; => [ Data: data_cca78c | Data: data_cca788 ]
00515BBD    mov dword ptr ds:[0x00CCA78C], 0x00             ; => [ Data: data_cca78c ]
00515BC7    pop ebx
00515BC8    ret
00515BC9    push 0x813794                                   ; => [ String: CampaignContextPushPile ]
00515BCE    push 0x748
00515BD3    mov ecx, 0x8137AC                               ; => [ String: gCampaignSetup.favoredPileStack == CARD_NONE ]
00515BD8    push 0x80CD80
00515BDD    mov edx, 0x801800
00515BE2    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
00515BE7    add esp, 0x0C
00515BEA    call 0x0063BC30
00515BEF    test al, al
00515BF1    jz 0x00515BF4                                   ; => [ Call: sub_63bc30 ]
00515BF3    int3
00515BF4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
