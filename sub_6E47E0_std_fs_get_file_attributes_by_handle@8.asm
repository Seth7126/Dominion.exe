...
006E47E5    push 0x7715AC                                   ; => [ Call: __ehhandler$??$common_fstat@U_stat64@@@@YAHHQAU_stat64@@@Z | Type: EHRegistrationNode ]
006E47EA    mov eax, dword ptr fs:[0x00000000]
006E47F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E47F1    sub esp, 0x60
006E47F4    mov eax, dword ptr ds:[0x008C4040]
006E47F9    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
006E4805    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E482C    mov dword ptr ss:[ebp-0x44], 0x801800           ; => [ Data: data_801800 ]
006E4833    push 0x30
006E4835    lea eax, ss:[ebp-0x40]
006E4838    mov dword ptr ss:[ebp-0x04], 0x01
006E483F    push 0x00
006E4841    push eax
006E4842    call 0x00761FC4                                 ; => [ Call: memset ]
006E4847    add esp, 0x0C
006E484A    lea eax, ss:[ebp-0x40]
006E484D    push 0x4AB280                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_4ab280 ]
006E4852    push 0x4AB270
006E4857    push 0x04
006E4859    push 0x0C
006E485B    push eax
006E485C    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_4ab270 ]
...
006E487E    call eax                                        ; => [ Data: data_882124 ]
...
006E489A    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
006E489F    mov byte ptr ss:[ebp-0x04], 0x04
006E48A3    cmp dword ptr ds:[0x00CF65BC], 0x00
006E48AA    jz 0x006E48DA                                   ; => [ Data: data_cf65bc ]
...
006E48BB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E48CE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E48D3    mov dword ptr ss:[ebp-0x60], 0x801800           ; => [ Data: data_801800 ]
...
006E4928    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006E492D    inc dword ptr ds:[eax+0x04]
006E4930    push 0x4AB280                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_4ab280 ]
...
006E4949    push eax
006E494A    call 0x00759A18                                 ; => [ Data: lookup_table_6e197c ]
...
006E4969    push eax
006E496A    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4ab280 ]
006E496F    mov byte ptr ss:[ebp-0x04], 0x0A
006E4973    cmp dword ptr ds:[0x00CF65BC], 0x00
006E497A    jz 0x006E49A3                                   ; => [ Data: data_cf65bc ]
...
006E498B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E499E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E49A3    mov eax, ebx
006E49A5    mov ecx, dword ptr ss:[ebp-0x0C]
006E49A8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E49AF    pop ecx
006E49B0    pop edi
006E49B1    pop esi
006E49B2    pop ebx
...
006E49B8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006E49E0    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006E4A0C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006E4A11    inc dword ptr ds:[eax+0x04]
006E4A14    push 0x4AB280                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_4ab280 ]
...
006E4A2D    push eax
006E4A2E    call 0x00759A18                                 ; => [ Data: lookup_table_6e197c ]
...
006E4A4D    push eax
006E4A4E    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4ab280 ]
006E4A53    mov byte ptr ss:[ebp-0x04], 0x07
006E4A57    jmp 0x006E4973
