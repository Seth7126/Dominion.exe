...
00558C19    mov dword ptr ss:[ebp-0x20], eax
...
00558C30    push eax
00558C31    call dword ptr ds:[edx+0x10]
00558C34    xorps xmm0, xmm0
00558C37    mov dword ptr ss:[ebp-0xCCC], 0x00
00558C41    movlpd qword ptr ss:[ebp-0xCD4], xmm0
