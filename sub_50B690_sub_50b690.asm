...
0050B69B    push 0x813684                                   ; => [ String: CampaignContextFavoredPile ]
0050B6A0    push 0x6CF
0050B6A5    mov ecx, 0x8136A0                               ; => [ String: gCampaignSetup.favoredPile != CARD_NONE ]
...
0050B6C1    add eax, ecx                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
...
0050B6F1    pop esi
0050B6F2    ret
0050B6F3    push 0x80CF1C                                   ; => [ String: CampaignAddExtra ]
0050B6F8    push 0x242
0050B6FD    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0050B702    push 0x80CD80
0050B707    mov edx, 0x801800
0050B70C    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0050B711    add esp, 0x0C
0050B714    call 0x0063BC30
0050B719    test al, al
0050B71B    jz 0x0050B71E                                   ; => [ Call: sub_63bc30 ]
0050B71D    int3
0050B71E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
