...
0054520B    call 0x00761E50
00545210    mov eax, dword ptr ds:[0x008C4040]
...
0054524A    movlpd qword ptr ss:[esp+0x24], xmm0
...
00545300    mov dword ptr ss:[esp+0x14], eax
00545304    call 0x00573400
