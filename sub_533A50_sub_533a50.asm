...
00533A55    push 0x765EEB                                   ; => [ Call: sub_765eeb | Type: EHRegistrationNode ]
00533A5A    mov eax, dword ptr fs:[0x00000000]
00533A60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00533A61    mov eax, 0x325C
00533A66    call 0x00761E50                                 ; => [ Call: __chkstk ]
00533A6B    mov eax, dword ptr ds:[0x008C4040]
00533A70    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
00533A7C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00533AAB    xor ebx, ebx                                    ; => [ Call: nullptr ]
00533AAD    rep movsd                                       ; => [ Call: __builtin_memcpy | Data: data_7bf9d0 | Call: sub_566240 ]
00533AAF    mov eax, dword ptr ss:[ebp-0xC98]
00533AB5    add esp, 0x08
00533AB8    xor edi, edi
00533ABA    mov dword ptr ss:[ebp-0x25A4], ebx              ; => [ Call: nullptr ]
...
00533B31    mov dword ptr ss:[ebp-0x25AC], 0x00             ; => [ Call: nullptr ]
00533B3B    lea esi, ss:[ebp-0x1918]
00533B41    mov dword ptr ss:[ebp-0x25E0], 0x819C7C         ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_a92867737f0bc671aa74725a75ad05c3>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_a92867737f0bc671aa74725a75ad05c3>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00533B4B    lea edi, ss:[ebp-0x25A0]
00533B51    lea eax, ss:[ebp-0x25E0]
00533B57    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00533B59    mov dword ptr ss:[ebp-0x25BC], eax              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_a92867737f0bc671aa74725a75ad05c3>,bool,enum CardID>::VTable ]
...
00533B97    push esi
00533B98    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
00533BA9    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
00533C12    mov dword ptr ds:[eax], 0x819C60                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_28949cb5f430cd754bea91e2240709f3>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
00533C68    jz 0x00533D25                                   ; => [ Call: sub_582de0 ]
00533C6E    push 0x3EE
...
00533CAD    call 0x00590DE0                                 ; => [ Call: sub_590de0 ]
...
00533CD0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00533D25    call 0x00573400                                 ; => [ Call: sub_573400 ]
00533D2A    push dword ptr ds:[0x007BFAD4]                  ; => [ Call: nullptr ]
...
00533D89    push 0x476
00533D8E    push esi
00533D8F    call 0x00583720                                 ; => [ Call: sub_583720 ]
00533D94    add esp, 0x1C
00533D97    mov ecx, dword ptr ss:[ebp-0x0C]
00533D9A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00533DA1    pop ecx
00533DA2    pop edi
00533DA3    pop esi
00533DA4    pop ebx
...
00533DAA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
