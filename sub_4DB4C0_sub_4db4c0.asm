...
004DB4C5    push 0x7626A0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_NewCollection@_AsyncTaskCollection@details@Concurrency@@SAPAV123@PAV_CancellationTokenState@23@@Z ]
004DB4CA    mov eax, dword ptr fs:[0x00000000]
004DB4D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DB4D1    push ebx
004DB4D2    push esi
004DB4D3    push edi
004DB4D4    mov eax, dword ptr ds:[0x008C4040]
004DB4D9    xor eax, ebp
004DB4DB    push eax                                        ; => [ Data: __security_cookie ]
004DB4DC    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004DB4DF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DB50D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004DB537    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DB53C    mov dword ptr ds:[edi], 0x00
004DB542    mov ecx, dword ptr ss:[ebp-0x0C]
004DB545    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DB54C    pop ecx
004DB54D    pop edi
004DB54E    pop esi
004DB54F    pop ebx
