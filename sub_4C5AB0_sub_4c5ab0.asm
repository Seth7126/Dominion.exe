...
004C5AB6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004C5ACD    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004C5AEF    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C5B06    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004C5B74    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004C5B79    add esp, 0x0C
004C5B7C    call 0x0063BC30
004C5B81    test al, al
004C5B83    jz 0x004C5B86                                   ; => [ Call: sub_63bc30 ]
004C5B85    int3
004C5B86    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
