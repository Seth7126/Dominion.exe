...
0076C18C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C191    mov ecx, dword ptr ds:[edx-0x08]
0076C194    xor ecx, eax
0076C196    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C19B    mov eax, 0x8B8414
0076C1A0    jmp 0x00761FA6                                  ; => [ Data: data_8b8414 | Call: __CxxFrameHandler3 ]
