...
006AC5C5    push 0x76F29D                                   ; => [ Call: sub_76f29d | Type: EHRegistrationNode ]
006AC5CA    mov eax, dword ptr fs:[0x00000000]
006AC5D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006AC5D1    push ebx
006AC5D2    push esi
006AC5D3    push edi
006AC5D4    mov eax, dword ptr ds:[0x008C4040]
006AC5D9    xor eax, ebp
006AC5DB    push eax                                        ; => [ Data: __security_cookie ]
006AC5DC    lea eax, ss:[ebp-0x0C]
006AC5DF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006AC5E5    mov edi, ecx
006AC5E7    mov dword ptr ss:[ebp-0x04], 0x00
006AC5EE    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006AC5F3    mov eax, dword ptr ss:[ebp+0x08]
006AC5F6    test eax, eax
006AC5F8    cmovnz esi, eax
006AC5FB    mov ecx, esi
006AC5FD    call 0x006AA0D0                                 ; => [ Call: sub_6aa0d0 ]
...
006AC62D    call 0x006AA7E0                                 ; => [ Call: sub_6aa7e0 ]
...
006AC64D    call 0x006AA7E0                                 ; => [ Call: sub_6aa7e0 ]
...
006AC698    xor eax, eax                                    ; => [ Call: nullptr ]
006AC69A    mov dword ptr ss:[ebp+0x10], eax                ; => [ Call: nullptr ]
...
006AC6D5    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006AC6DA    test eax, eax
006AC6DC    cmovnz ecx, eax
006AC6DF    push ecx
006AC6E0    push 0x87B6F4
006AC6E5    call 0x0063B5F0                                 ; => [ String: texture reimport failed to read '%s' | Call: sub_63b5f0 ]
...
006AC701    jz 0x006AC72A                                   ; => [ Data: data_cf65bc ]
...
006AC712    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AC725    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AC72A    mov al, bl
006AC72C    mov ecx, dword ptr ss:[ebp-0x0C]
006AC72F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AC736    pop ecx
006AC737    pop edi
006AC738    pop esi
006AC739    pop ebx
