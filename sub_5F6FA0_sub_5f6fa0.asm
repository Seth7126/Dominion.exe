...
005F6FAD    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
005F6FB0    push ebx
005F6FB1    push esi
005F6FB2    push edi
005F6FB3    mov dword ptr ss:[ebp-0x28], 0x00
005F6FBA    mov ebx, 0xAF3CCC                               ; => [ Data: data_af3ccc ]
...
005F6FD1    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
005F6FEE    test al, al
005F6FF0    jnz 0x005F707C                                  ; => [ Call: sub_4db7a0 ]
005F6FF6    inc esi
...
005F7011    jl 0x005F6FC6                                   ; => [ Data: data_af9fb4 ]
005F7013    movaps xmm0, xmmword ptr ds:[0x00891400]
005F701A    xor edx, edx
005F701C    movups xmmword ptr ss:[ebp-0x24], xmm0          ; => [ Call: __builtin_memcpy | String: \x00\x13\x00\x00\x01\x00\x00\x00\x0b\x13\x00\x00\x02\x00\x00\x00\x0a\x13\x00\x00\x04\x00\x00\x00\x0e\x13\x00\x00\x08\x00\x00\x00 ]
005F7020    mov esi, 0x01
005F7025    mov edi, 0xAF3CCC                               ; => [ Data: data_af3ccc ]
...
005F7067    jl 0x005F7035                                   ; => [ Data: data_af9fb4 ]
...
005F7072    pop ebx
005F7073    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
