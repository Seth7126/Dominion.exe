...
0059D795    push 0x767FD4                                   ; => [ Type: EHRegistrationNode | Call: sub_767fd4 ]
0059D79A    mov eax, dword ptr fs:[0x00000000]
0059D7A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0059D7A1    mov eax, 0x1928
0059D7A6    call 0x00761E50                                 ; => [ Call: __chkstk ]
0059D7AB    mov eax, dword ptr ds:[0x008C4040]
0059D7B0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0059D7BC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0059D857    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
0059D89E    call 0x0063D850                                 ; => [ Call: sub_63d850 | Call: sub_598ae0 ]
0059D8A3    mov dword ptr ss:[ebp-0x04], 0x02
0059D8AA    cmp dword ptr ds:[0x00CF65BC], 0x00
0059D8B1    jz 0x0059DA60                                   ; => [ Data: data_cf65bc ]
...
0059D8D4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059D8EB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0059D95F    call 0x00598AE0                                 ; => [ Call: sub_598ae0 ]
...
0059D9A0    call 0x0063D850                                 ; => [ Call: sub_599090 | String: [another] | Call: sub_63d850 | String: [one] ]
0059D9A5    mov byte ptr ss:[ebp-0x04], 0x06
0059D9A9    cmp dword ptr ds:[0x00CF65BC], 0x00
0059D9B0    jz 0x0059D9DF                                   ; => [ Data: data_cf65bc ]
...
0059D9C7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059D9DA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059D9DF    mov byte ptr ss:[ebp-0x04], 0x07
0059D9E3    cmp dword ptr ds:[0x00CF65BC], 0x00
0059D9EA    jz 0x0059DA23                                   ; => [ Data: data_cf65bc ]
...
0059DA01    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059DA14    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059DA19    mov dword ptr ss:[ebp-0x1918], 0x801800         ; => [ Data: data_801800 ]
0059DA23    mov dword ptr ss:[ebp-0x04], 0x08
0059DA2A    cmp dword ptr ds:[0x00CF65BC], 0x00
0059DA31    jz 0x0059DA60                                   ; => [ Data: data_cf65bc ]
...
0059DA48    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059DA5B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0059DA96    call 0x00598AE0                                 ; => [ Call: sub_598ae0 ]
...
0059DAB1    push eax
0059DAB2    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0059DB01    call 0x0063D850                                 ; => [ Call: sub_599090 | String: [list] | Call: sub_63d850 | String: [last] ]
0059DB06    mov byte ptr ss:[ebp-0x04], 0x0B
0059DB0A    cmp dword ptr ds:[0x00CF65BC], 0x00
0059DB11    jz 0x0059DBD7                                   ; => [ Data: data_cf65bc ]
...
0059DB34    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059DB4B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059DB50    mov dword ptr ss:[ebp-0x1920], 0x801800         ; => [ Data: data_801800 ]
...
0059DB8E    call 0x0063D850                                 ; => [ Call: sub_599090 | String: [first] | Call: sub_63d850 | String: [rest] ]
0059DB93    mov byte ptr ss:[ebp-0x04], 0x0D
0059DB97    cmp dword ptr ds:[0x00CF65BC], 0x00
0059DB9E    jz 0x0059DBD7                                   ; => [ Data: data_cf65bc ]
...
0059DBB5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059DBC8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059DBCD    mov dword ptr ss:[ebp-0x1924], 0x801800         ; => [ Data: data_801800 ]
0059DBD7    mov dword ptr ss:[ebp-0x04], 0x0E
0059DBDE    cmp dword ptr ds:[0x00CF65BC], 0x00
0059DBE5    jz 0x0059DC1E                                   ; => [ Data: data_cf65bc ]
...
0059DBFC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059DC0F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059DC14    mov dword ptr ss:[ebp-0x1918], 0x801800         ; => [ Data: data_801800 ]
0059DC1E    inc edi
...
0059DC44    call 0x00692C20                                 ; => [ Call: sub_692c20 ]
0059DC49    add esp, 0x04
0059DC4C    mov eax, ebx
0059DC4E    mov ecx, dword ptr ss:[ebp-0x0C]
0059DC51    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0059DC58    pop ecx
0059DC59    pop edi
0059DC5A    pop esi
0059DC5B    pop ebx
...
0059DC61    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
