...
00761009    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00761022    push 0x77EA10                                   ; => [ String: aVoice < VOICE_COUNT ]
00761027    push 0x8E
0076102C    push 0x77EA28                                   ; => [ String: D:\soloud\src\core\soloud_core_voiceops.cpp ]
00761031    lea eax, ss:[ebp-0xCC]
00761037    push 0x77E920
0076103C    push eax
0076103D    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
00761059    push 0x77E9B8                                   ; => [ String: mInsideAudioThreadMutex ]
0076105E    push 0x8F
00761063    push 0x77EA28                                   ; => [ String: D:\soloud\src\core\soloud_core_voiceops.cpp ]
00761068    lea eax, ss:[ebp-0xCC]
0076106E    push 0x77E920
00761073    push eax
00761074    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
007610BE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
