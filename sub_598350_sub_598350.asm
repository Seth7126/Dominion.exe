...
00598355    push 0x7677AE                                   ; => [ Call: __ehhandler$?clone@?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@EBEPBVclone_base@23@XZ | Type: EHRegistrationNode ]
0059835A    mov eax, dword ptr fs:[0x00000000]
00598360    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00598361    sub esp, 0x14
00598364    push esi
00598365    push edi
00598366    mov eax, dword ptr ds:[0x008C4040]
0059836B    xor eax, ebp
0059836D    push eax                                        ; => [ Data: __security_cookie ]
0059836E    lea eax, ss:[ebp-0x0C]
00598371    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00598399    mov esi, 0x824818                               ; => [ Call: nullptr | String: {log_red} ]
0059839E    jmp 0x005983C1
005983A0    mov esi, 0x824824                               ; => [ String: {log_blue} ]
005983A5    jmp 0x005983C1
005983A7    mov esi, 0x824830                               ; => [ String: {log_green} ]
005983AC    jmp 0x005983C1
005983AE    mov esi, 0x82483C                               ; => [ String: {log_yellow} ]
005983B3    jmp 0x005983C1
005983B5    mov esi, 0x82484C                               ; => [ String: {log_orange} ]
005983BA    jmp 0x005983C1
005983BC    mov esi, 0x82485C                               ; => [ String: {log_white} ]
005983C1    push ecx
005983C2    lea ecx, ss:[ebp-0x10]
005983C5    call 0x00597AA0                                 ; => [ Call: sub_597aa0 ]
005983CA    add esp, 0x04
005983CD    mov dword ptr ss:[ebp-0x04], 0x01
005983D4    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005983EB    push eax
005983EC    call 0x0063DF30                                 ; => [ String: %s%s{log_white} | Call: sub_63df30 ]
...
00598408    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059842E    jz 0x00598452                                   ; => [ Data: data_cf65bc ]
00598430    lea ecx, ss:[ebp+0x08]
00598433    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00598446    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059844B    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
00598452    mov dword ptr ss:[ebp-0x04], 0x04
00598459    cmp dword ptr ds:[0x00CF65BC], 0x00
00598460    jz 0x00598489                                   ; => [ Data: data_cf65bc ]
...
00598471    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00598484    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00598489    mov eax, edi
0059848B    mov ecx, dword ptr ss:[ebp-0x0C]
0059848E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00598495    pop ecx
00598496    pop edi
00598497    pop esi
...
005984A3    call 0x0063D720                                 ; => [ String: *none* | Call: sub_63d720 ]
005984A8    mov eax, edi
005984AA    mov ecx, dword ptr ss:[ebp-0x0C]
005984AD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005984B4    pop ecx
005984B5    pop edi
005984B6    pop esi
...
005984D4    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp | Call: sub_63b870 | String: GetPlayerInitial | Data: data_801800 | String: Halt ]
005984D9    add esp, 0x0C
005984DC    call 0x0063BC30
005984E1    test al, al
005984E3    jz 0x005984E6                                   ; => [ Call: sub_63bc30 ]
005984E5    int3
005984E6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
