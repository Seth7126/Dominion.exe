...
006204F9    mov eax, dword ptr ds:[eax]
006204FB    mov dword ptr ss:[esp+0x0C], eax
006204FF    nop
00620500    call 0x0061DAD0
...
0062053D    mov dword ptr ss:[esp+0x08], eax
00620541    mov edx, 0x86AE08
00620546    mov ecx, edi
00620548    call 0x0067BD70
...
00620570    jnz 0x0062058C
00620572    call 0x0064E7A0
...
00620593    movups xmmword ptr ss:[esp+0x10], xmm0
00620598    movups xmm0, xmmword ptr ds:[0x00BF21F8]
...
0062075D    jnz 0x00620779
0062075F    call 0x0064E7A0
...
00620780    movups xmmword ptr ss:[esp+0x10], xmm0
00620785    movups xmm0, xmmword ptr ds:[0x00BF21F8]
