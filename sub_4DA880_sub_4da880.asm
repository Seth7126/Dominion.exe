...
004DA885    push 0x763CA6                                   ; => [ Type: EHRegistrationNode | Call: sub_763ca6 ]
004DA88A    mov eax, dword ptr fs:[0x00000000]
004DA890    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DA891    mov eax, 0x1394
004DA896    call 0x00761E50                                 ; => [ Call: __chkstk ]
004DA89B    mov eax, dword ptr ds:[0x008C4040]
004DA8A0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
004DA8AC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DA8CE    call 0x004D8D70                                 ; => [ Call: sub_4d8d70 ]
004DA8D3    mov dword ptr ss:[ebp-0x04], 0x00
004DA8DA    lea edx, ss:[ebp-0x1394]
004DA8E0    mov eax, dword ptr ds:[0x01597DA0]              ; => [ Data: data_1597da0 ]
004DA8E5    mov ecx, eax
004DA8E7    mov dword ptr ss:[ebp-0x137C], eax
004DA8ED    call 0x006A6E70                                 ; => [ Call: sub_6a6e70 ]
...
004DA910    push 0x00
004DA912    push ebx
004DA913    call 0x006A4770                                 ; => [ Call: sub_6a4770 ]
004DA918    add esp, 0x08
004DA91B    mov ecx, ebx
004DA91D    call 0x006A3220                                 ; => [ Call: sub_6a3220 ]
004DA922    lea edx, ss:[ebp-0x1D0]
004DA928    lea ecx, ss:[ebp-0x1378]
004DA92E    call 0x004D7240
004DA933    push eax                                        ; => [ Call: sub_4d7240 ]
004DA934    lea ecx, ds:[edi+0x08]
004DA937    mov byte ptr ss:[ebp-0x04], 0x02
004DA93B    call 0x004B4AB0                                 ; => [ Call: sub_4b4ab0 ]
004DA940    lea ecx, ss:[ebp-0x1370]
004DA946    mov byte ptr ss:[ebp-0x04], 0x00
004DA94A    call 0x004AB0E0                                 ; => [ Call: Concurrency::details::_Micro_queue::_Pop_finalizer::~_Pop_finalizer ]
004DA94F    mov edx, dword ptr ds:[esi+0x04]
004DA952    lea ecx, ss:[ebp-0x1384]
004DA958    call 0x004D8E50                                 ; => [ Call: sub_4d8e50 ]
004DA95D    push 0x00
004DA95F    lea edx, ss:[ebp-0x1384]
004DA965    mov byte ptr ss:[ebp-0x04], 0x03
004DA969    lea ecx, ss:[ebp-0x138C]
004DA96F    call 0x0069DEC0                                 ; => [ Type: FILE | Call: sub_69dec0 ]
004DA974    add esp, 0x04
004DA977    test al, al
004DA979    jnz 0x004DA98F
004DA97B    push 0x806C20                                   ; => [ String: LocalGameLoad ]
004DA980    push 0x6F5
004DA985    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004DA98A    jmp 0x004DAD28
004DA98F    mov esi, dword ptr ss:[ebp-0x138C]              ; => [ Type: FILE ]
004DA995    push 0x02
004DA997    push 0x00                                       ; => [ Call: nullptr ]
004DA999    push esi
...
004DA9BF    mov dword ptr ss:[ebp-0x138C], 0x00             ; => [ Call: nullptr ]
004DA9C9    mov ecx, ebx
004DA9CB    call 0x00687730                                 ; => [ Call: sub_687730 ]
004DA9D0    mov esi, dword ptr ss:[ebp-0x137C]
004DA9D6    mov ebx, eax
004DA9D8    push esi
004DA9D9    push 0x00                                       ; => [ Call: nullptr ]
004DA9DB    push ebx
004DA9DC    call 0x00761FC4                                 ; => [ Call: memset ]
004DA9E1    mov eax, dword ptr ds:[0x01597DA8]              ; => [ Data: data_1597da8 ]
...
004DAA13    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DAAFC    jz 0x004DAB35                                   ; => [ Data: data_cf65bc ]
...
004DAB13    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DAB26    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DAB2B    mov dword ptr ss:[ebp-0x1380], 0x801800         ; => [ Data: data_801800 ]
004DAB35    mov dword ptr ss:[ebp-0x04], 0x09
004DAB3C    cmp dword ptr ds:[0x00CF65BC], 0x00
004DAB43    jz 0x004DAB72                                   ; => [ Data: data_cf65bc ]
...
004DAB5A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DAB6D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DAB72    mov al, 0x01
004DAB74    jmp 0x004DACCD
004DAB79    mov ecx, esi
004DAB7B    call 0x00687730                                 ; => [ Call: sub_687730 ]
004DAB80    push dword ptr ss:[ebp-0x137C]
004DAB86    mov esi, eax
004DAB88    push 0x00                                       ; => [ Call: nullptr ]
004DAB8A    push esi
004DAB8B    call 0x00761FC4                                 ; => [ Call: memset ]
004DAB90    mov edi, dword ptr ds:[0x01597DA4]              ; => [ Data: data_1597da4 ]
...
004DABBD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DABD1    test al, al
004DABD3    jnz 0x004DAC3C                                  ; => [ Call: sub_694780 ]
...
004DABFA    jz 0x004DAC33                                   ; => [ Data: data_cf65bc ]
...
004DAC11    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DAC24    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DAC29    mov dword ptr ss:[ebp-0x1380], 0x801800         ; => [ Data: data_801800 ]
...
004DAC55    jz 0x004DAC8E                                   ; => [ Data: data_cf65bc ]
...
004DAC6C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DAC7F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DAC84    mov dword ptr ss:[ebp-0x1380], 0x801800         ; => [ Data: data_801800 ]
004DAC8E    mov dword ptr ss:[ebp-0x04], 0x07
004DAC95    cmp dword ptr ds:[0x00CF65BC], 0x00
004DAC9C    jz 0x004DACCB                                   ; => [ Data: data_cf65bc ]
...
004DACB3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DACC6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DACCB    xor al, al
004DACCD    mov ecx, dword ptr ss:[ebp-0x0C]
004DACD0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DACD7    pop ecx
004DACD8    pop edi
004DACD9    pop esi
004DACDA    pop ebx
...
004DACE0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004DACE5    mov esp, ebp
004DACE7    pop ebp
004DACE8    ret
004DACE9    push 0x806C20                                   ; => [ String: LocalGameLoad ]
004DACEE    push 0x6E9
004DACF3    push 0x806734
004DACF8    mov edx, 0x801800
004DACFD    mov ecx, 0x806BEC
004DAD02    call 0x0063B870                                 ; => [ String: handle.gameType == GAME_LOCAL | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004DAD07    add esp, 0x0C
004DAD0A    call 0x0063BC30
004DAD0F    test al, al
004DAD11    jz 0x004DAD14                                   ; => [ Call: sub_63bc30 ]
004DAD13    int3
004DAD14    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004DAD19    push 0x806C20                                   ; => [ String: LocalGameLoad ]
004DAD1E    push 0x70E
004DAD23    mov ecx, 0x805B9C                               ; => [ String: save.logs.logs[i].logBytes == NULL ]
004DAD28    push 0x806734
004DAD2D    mov edx, 0x801800
004DAD32    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004DAD37    add esp, 0x0C
004DAD3A    call 0x0063BC30
004DAD3F    test al, al
004DAD41    jz 0x004DAD44                                   ; => [ Call: sub_63bc30 ]
004DAD43    int3
004DAD44    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
