...
006A7AEB    xor eax, ebp
006A7AED    push eax
006A7AEE    lea eax, ss:[ebp-0x0C]
006A7AF1    mov dword ptr fs:[0x00000000], eax
...
006A7B11    call 0x0063D720
006A7B16    lea ecx, ss:[ebp+0x0C]
006A7B19    call 0x006A7580
...
006A7B4E    mov esi, 0x801800
006A7B53    push ecx
006A7B54    cmovnz esi, eax
006A7B57    push esi
006A7B58    call 0x00707DC0
...
006A7B70    mov ecx, dword ptr ds:[0x0147DED8]
...
006A7B8A    push 0x10
006A7B8C    call dword ptr ds:[0x00800B4C]
006A7B92    add esp, 0x04
006A7B95    mov esi, eax
006A7B97    test esi, esi
006A7B99    jz 0x006A7BA1
006A7B9B    xorps xmm0, xmm0
006A7B9E    movups xmmword ptr ds:[esi], xmm0
006A7BA1    mov eax, dword ptr ds:[0x0147DED8]
...
006A7BFE    call 0x00708770
006A7C03    mov dword ptr ds:[eax+0x0C], 0x01
006A7C0A    jmp 0x006A7C84
006A7C0C    mov eax, dword ptr ds:[0x0147DED8]
...
006A7CB2    push 0x0C
006A7CB4    call dword ptr ds:[0x00800B4C]
...
006A7D06    call 0x0064C080
006A7D0B    mov ecx, dword ptr ss:[ebp-0x0C]
006A7D0E    mov dword ptr fs:[0x00000000], ecx
006A7D15    pop ecx
006A7D16    pop edi
006A7D17    pop esi
