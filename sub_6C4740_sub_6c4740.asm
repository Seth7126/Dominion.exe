...
006C4745    push 0x7701C6                                   ; => [ Call: sub_7701c6 | Type: EHRegistrationNode ]
006C474A    mov eax, dword ptr fs:[0x00000000]
006C4750    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C475E    push eax                                        ; => [ Data: __security_cookie ]
006C475F    lea eax, ss:[ebp-0x0C]
006C4762    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C4786    push 0x879BC4                                   ; => [ String: .xpack ]
006C478B    push eax
006C478C    call dword ptr ds:[0x00775688]
006C4792    add esp, 0x08
006C4795    test eax, eax
006C4797    jnz 0x006C47B2
006C4799    push 0x87DF98                                   ; => [ String: DefLoadRelativeXbinPathFromAssetPath ]
006C479E    push 0xB3
006C47A3    push 0x87DF78                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.cpp ]
006C47A8    mov ecx, 0x87DFCC                               ; => [ String: !AssetPathIsXPack(assetPath) ]
...
006C47BF    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006C47C4    lea ecx, ss:[ebp-0x10]
006C47C7    call 0x006A0010                                 ; => [ Call: sub_6a0010 ]
006C47CC    add esp, 0x04
006C47CF    mov dword ptr ss:[ebp-0x04], 0x01
006C47D6    xor esi, esi                                    ; => [ Call: nullptr ]
006C47D8    mov eax, dword ptr ss:[ebp-0x10]
006C47DB    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006C47F1    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
006C4801    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
006C4812    call 0x0063DC00                                 ; => [ Call: sub_63dc00 ]
006C4817    mov eax, dword ptr ss:[ebp-0x10]
006C481A    inc esi
006C481B    jmp 0x006C47E0
006C481D    cmp byte ptr ds:[0x00CC8DDD], 0x00
006C4824    jz 0x006C482D                                   ; => [ Data: data_cc8ddd ]
006C4826    mov ecx, 0x87DF58                               ; => [ String: xbin/ios/ ]
006C482B    jmp 0x006C4842
006C482D    cmp byte ptr ds:[0x00CC8DDC], 0x00
006C4834    jz 0x006C483D                                   ; => [ Data: data_cc8ddc ]
006C4836    mov ecx, 0x87DF6C                               ; => [ String: xbin/web/ ]
006C483B    jmp 0x006C4842
006C483D    mov ecx, 0x87DF64                               ; => [ String: xbin/ ]
006C4842    test eax, eax
006C4844    mov byte ptr ss:[ebp-0x04], 0x01
006C4848    cmovnz edi, eax
006C484B    push edi
006C484C    push ecx
006C484D    push 0x87DFC0                                   ; => [ String: %s%s.xbin ]
006C4852    push ebx
006C4853    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %s%s.xbin ]
...
006C4870    jz 0x006C4899                                   ; => [ Data: data_cf65bc ]
...
006C4881    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4894    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4899    mov eax, ebx
006C489B    mov ecx, dword ptr ss:[ebp-0x0C]
006C489E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C48A5    pop ecx
006C48A6    pop edi
006C48A7    pop esi
006C48A8    pop ebx
...
006C48AB    pop ebp
006C48AC    ret
006C48AD    push 0x871DD4                                   ; => [ String: XString::XString ]
006C48B2    push 0x94
006C48B7    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
006C48BC    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
006C48C1    mov edx, 0x801800
006C48C6    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006C48CB    add esp, 0x0C
006C48CE    call 0x0063BC30
006C48D3    test al, al
006C48D5    jz 0x006C48D8                                   ; => [ Call: sub_63bc30 ]
006C48D7    int3
006C48D8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
