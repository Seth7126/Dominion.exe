...
0055FDF0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0055FE01    push eax                                        ; => [ Data: __security_cookie ]
0055FE02    lea eax, ss:[ebp-0x0C]
0055FE05    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0055FE0B    xorps xmm0, xmm0
0055FE0E    mov dword ptr ss:[ebp-0x14], 0x103
0055FE15    movlpd qword ptr ss:[ebp-0x1C], xmm0
0055FE1A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055FE88    push edi
0055FE89    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0055FEA8    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
0055FF09    push edi
0055FF0A    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0055FF22    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
0055FF35    push eax
0055FF36    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0055FF39    xor eax, eax
0055FF3B    test esi, esi
0055FF3D    setnz al
0055FF40    mov ecx, dword ptr ss:[ebp-0x0C]
0055FF43    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055FF4A    pop ecx
0055FF4B    pop edi
0055FF4C    pop esi
0055FF4D    pop ebx
