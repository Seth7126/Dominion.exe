...
005265F8    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
005265FD    mov eax, dword ptr fs:[0x00000000]
00526603    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00526604    push ebx
00526605    mov eax, 0x19A8
0052660A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0052660F    mov eax, dword ptr ds:[0x008C4040]
00526614    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00526616    mov dword ptr ss:[ebp-0x14], eax
00526619    push esi
0052661A    push edi
0052661B    push eax
0052661C    lea eax, ss:[ebp-0x0C]
0052661F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00526625    xor edx, edx
00526627    push 0x00
00526629    lea ecx, ds:[edx+0x01]
0052662C    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
00526631    add esp, 0x04
00526634    call 0x00573400                                 ; => [ Call: sub_573400 ]
00526639    push 0x00
0052663B    push 0x00
0052663D    push 0x01
...
00526645    push 0x02
00526647    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052664C    add esp, 0x10
0052664F    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052667F    push eax
00526680    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
00526685    mov esi, eax
00526687    mov dword ptr ss:[ebp-0xD00], 0x8185C4          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_da1a1603d04cac90ca05a3b9a344452d>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_da1a1603d04cac90ca05a3b9a344452d>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00526691    mov ecx, 0x321
00526696    lea edi, ss:[ebp-0xCA0]
0052669C    lea eax, ss:[ebp-0xD00]
005266A2    add esp, 0x14
005266A5    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005266A7    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_da1a1603d04cac90ca05a3b9a344452d>,bool,enum CardID>::VTable ]
...
005266E8    call eax                                        ; => [ Field: vFunc_0 ]
...
0052670B    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
00526722    push eax
00526723    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00526726    xorps xmm0, xmm0
00526729    mov dword ptr ss:[ebp-0xCCC], 0x00
00526733    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
005267E2    push 0x00
005267E4    push ecx
005267E5    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
005267EA    add esp, 0x04
005267ED    mov edx, 0x02
005267F2    mov ecx, esi
005267F4    push eax
005267F5    call 0x00566C60                                 ; => [ Call: sub_566c60 ]
005267FA    call 0x00573400                                 ; => [ Call: sub_573400 ]
005267FF    push 0x3E9
...
0052681A    call 0x00582DE0                                 ; => [ Call: sub_582de0 ]
...
0052684C    call 0x00590DE0                                 ; => [ Call: sub_590de0 ]
00526851    add esp, 0x14
00526854    mov ecx, dword ptr ss:[ebp-0x0C]
00526857    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0052685E    pop ecx
0052685F    pop edi
00526860    pop esi
00526861    mov ecx, dword ptr ss:[ebp-0x14]
00526864    xor ecx, ebp
00526866    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00526888    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052688D    add esp, 0x0C
00526890    call 0x0063BC30
00526895    test al, al
00526897    jz 0x0052689A                                   ; => [ Call: sub_63bc30 ]
00526899    int3
0052689A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
