...
006C4055    push 0x770116                                   ; => [ Type: EHRegistrationNode | Call: sub_770116 ]
006C405A    mov eax, dword ptr fs:[0x00000000]
006C4060    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C406E    push eax                                        ; => [ Data: __security_cookie ]
006C406F    lea eax, ss:[ebp-0x0C]
006C4072    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C4078    mov esi, edx
006C407A    mov edi, ecx
006C407C    mov dword ptr ss:[ebp-0x18], edi
006C407F    mov dword ptr ss:[ebp-0x14], 0x00
006C4086    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
006C408C    push 0x3A
...
006C40C3    jnz 0x006C40F7                                  ; => [ String: sys ]
006C40C5    push esi
...
006C40E6    call 0x0063D850                                 ; => [ String: %s/%s | Call: sub_63df30 | Call: sub_63d850 ]
006C40EB    mov dword ptr ss:[ebp-0x04], 0x02
006C40F2    jmp 0x006C4189
006C40F7    push 0x03
006C40F9    push 0x87A37C
006C40FE    push esi
006C40FF    call ebx                                        ; => [ String: res ]
...
006C410F    push esi
006C4110    call ebx                                        ; => [ String: xbin ]
006C4112    add esp, 0x0C
006C4115    test eax, eax
006C4117    jz 0x006C4153
006C4119    push esi
006C411A    push 0x87DF3C
006C411F    call 0x0063B5F0                                 ; => [ String: Non standard asset path %s | Call: sub_63b5f0 ]
006C4124    push esi
006C4125    push 0x147CF90                                  ; => [ Data: data_147cf90 ]
...
006C4145    call 0x0063D850                                 ; => [ String: %s/%s | Call: sub_63df30 | Call: sub_63d850 ]
006C414A    mov dword ptr ss:[ebp-0x04], 0x06
006C4151    jmp 0x006C4189
006C4153    cmp byte ptr ds:[0x0147CF90], 0x00
006C415A    push esi
006C415B    jz 0x006C41C0                                   ; => [ Data: data_147cf90 ]
006C415D    push 0x147CF90                                  ; => [ Data: data_147cf90 ]
...
006C417D    call 0x0063D850                                 ; => [ String: %s/%s | Call: sub_63df30 | Call: sub_63d850 ]
006C4182    mov dword ptr ss:[ebp-0x04], 0x04
006C4189    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4190    jz 0x006C41B9                                   ; => [ Data: data_cf65bc ]
...
006C41A1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C41B4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C41B9    mov byte ptr ss:[ebp-0x04], 0x00
006C41BD    jmp 0x006C41C7
006C41BF    push esi
006C41C0    mov ecx, edi
006C41C2    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 | Call: sub_63d8d0 ]
006C41C7    xor esi, esi                                    ; => [ Call: nullptr ]
...
006C4204    call 0x0063DC00                                 ; => [ Call: sub_63dc00 ]
006C4209    inc esi
006C420A    jmp 0x006C41D0
006C420C    mov eax, edi
006C420E    mov ecx, dword ptr ss:[ebp-0x0C]
006C4211    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C4218    pop ecx
006C4219    pop edi
006C421A    pop esi
006C421B    pop ebx
