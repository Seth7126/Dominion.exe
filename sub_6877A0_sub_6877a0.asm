...
006877AC    push esi
006877AD    push edi
006877AE    jz 0x006877C6
006877B0    push 0x8770D0
006877B5    push 0x2C
006877B7    push 0x8770F4
006877BC    mov ecx, 0x8770E0
006877C1    jmp 0x00687CD0
006877C6    mov ecx, 0x38
006877CB    call 0x0064BFD0
...
006877EC    call 0x00761FC4
006877F1    add esp, 0x0C
006877F4    mov dword ptr ds:[0x0147ABE8], edi
006877FA    mov ecx, 0x20
006877FF    mov dword ptr ds:[edi+0x34], 0x3B83126F
00687806    call 0x0064BFD0
...
00687825    mov esi, dword ptr ds:[0x0147ABE8]
0068782B    movups xmmword ptr ds:[ecx], xmm0
...
00687839    push 0x871F88
0068783E    push 0x45
00687840    push 0x871FA0
00687845    mov ecx, 0x871F94
...
00687958    push 0x881244
0068795D    push 0xCE
00687962    push 0x80193C
00687967    mov ecx, 0x80195C
...
006879A3    mov dword ptr ds:[esi+0x18], 0x880FD0
006879AA    mov dword ptr ds:[esi+0x14], eax
006879AD    mov eax, dword ptr ds:[0x0147ABE8]
006879B2    mov dword ptr ss:[ebp-0x04], eax
006879B5    test eax, eax
006879B7    jnz 0x006879CF
006879B9    push 0x871F88
006879BE    push 0x45
006879C0    push 0x871FA0
006879C5    mov ecx, 0x871F94
006879CA    jmp 0x00687CFD
006879CF    mov ecx, 0x1C
006879D4    call 0x0064BFD0
...
006879F3    mov dword ptr ds:[esi], 0x00
...
00687A2B    push 0x882958
00687A30    push 0xCE
00687A35    push 0x80193C
00687A3A    mov ecx, 0x80195C
...
00687A70    mov dword ptr ds:[esi+0x18], 0x8822F4
00687A77    mov dword ptr ds:[esi+0x14], eax
00687A7A    cmp dword ptr ds:[0x00CAF76C], 0x00
00687A81    mov dword ptr ds:[0x019E276C], 0x01
00687A8B    jz 0x00687AA6
00687A8D    push 0x87AFEC
00687A92    push 0xCE
00687A97    push 0x80193C
00687A9C    mov ecx, 0x80195C
...
00687ABA    mov dword ptr ds:[0x00CAF76C], eax
00687ABF    mov eax, 0x87AEE0
00687AC4    and eax, 0xFFF
00687AC9    mov dword ptr ds:[0x00CAF774], 0x20
00687AD3    or eax, 0xD000
00687AD8    mov dword ptr ds:[0x00CAF784], 0x87AEE0
00687AE2    mov dword ptr ds:[0x00CAF780], eax
00687AE7    mov eax, dword ptr ds:[0x0147ABE8]
00687AEC    mov dword ptr ss:[ebp-0x04], eax
00687AEF    test eax, eax
00687AF1    jnz 0x00687B09
00687AF3    push 0x871F88
00687AF8    push 0x45
00687AFA    push 0x871FA0
00687AFF    mov ecx, 0x871F94
00687B04    jmp 0x00687D57
00687B09    mov ecx, 0x30
00687B0E    call 0x0064BFD0
...
00687B50    mov dword ptr ds:[esi], 0x00
...
00687B79    mov dword ptr ds:[esi+0x18], 0x00
00687B80    mov dword ptr ds:[eax+0x10], esi
00687B83    cmp dword ptr ds:[esi], 0x00
00687B86    jz 0x00687BA1
00687B88    push 0x87DEC8
00687B8D    push 0xCE
00687B92    push 0x80193C
00687B97    mov ecx, 0x80195C
...
00687BCD    mov dword ptr ds:[esi+0x18], 0x87DB98
00687BD4    mov dword ptr ds:[esi+0x14], eax
00687BD7    mov eax, dword ptr ds:[0x0147ABE8]
00687BDC    mov dword ptr ss:[ebp-0x04], eax
00687BDF    test eax, eax
00687BE1    jnz 0x00687BF9
00687BE3    push 0x871F88
00687BE8    push 0x45
00687BEA    push 0x871FA0
00687BEF    mov ecx, 0x871F94
00687BF4    jmp 0x00687D84
00687BF9    mov ecx, 0x1C
00687BFE    call 0x0064BFD0
...
00687C1D    mov dword ptr ds:[esi], 0x00
...
00687C55    push 0x88C2D0
00687C5A    push 0xCE
00687C5F    push 0x80193C
00687C64    mov ecx, 0x80195C
...
00687C9A    mov dword ptr ds:[esi+0x18], 0x88C254
00687CA1    cmp byte ptr ds:[0x00CC8D6F], 0x00
...
00687CB5    call dword ptr ds:[eax+0x08]
00687CB8    pop edi
00687CB9    pop esi
00687CBA    pop ebx
...
00687CBD    pop ebp
00687CBE    ret
00687CBF    push 0x8770A0
00687CC4    push 0x57
00687CC6    push 0x877080
00687CCB    mov ecx, 0x8770C8
00687CD0    mov edx, 0x801800
00687CD5    call 0x0063B870
00687CDA    add esp, 0x0C
00687CDD    call 0x0063BC30
00687CE2    test al, al
00687CE4    jz 0x00687CE7
00687CE6    int3
00687CE7    call 0x0063BB00
00687CEC    push 0x8770A0
00687CF1    push 0x57
00687CF3    push 0x877080
00687CF8    mov ecx, 0x8770C8
00687CFD    mov edx, 0x801800
00687D02    call 0x0063B870
00687D07    add esp, 0x0C
00687D0A    call 0x0063BC30
00687D0F    test al, al
00687D11    jz 0x00687D14
00687D13    int3
00687D14    call 0x0063BB00
00687D19    push 0x8770A0
00687D1E    push 0x57
00687D20    push 0x877080
00687D25    mov ecx, 0x8770C8
00687D2A    mov edx, 0x801800
00687D2F    call 0x0063B870
00687D34    add esp, 0x0C
00687D37    call 0x0063BC30
00687D3C    test al, al
00687D3E    jz 0x00687D41
00687D40    int3
00687D41    call 0x0063BB00
00687D46    push 0x8770A0
00687D4B    push 0x57
00687D4D    push 0x877080
00687D52    mov ecx, 0x8770C8
00687D57    mov edx, 0x801800
00687D5C    call 0x0063B870
00687D61    add esp, 0x0C
00687D64    call 0x0063BC30
00687D69    test al, al
00687D6B    jz 0x00687D6E
00687D6D    int3
00687D6E    call 0x0063BB00
00687D73    push 0x8770A0
00687D78    push 0x57
00687D7A    push 0x877080
00687D7F    mov ecx, 0x8770C8
00687D84    mov edx, 0x801800
00687D89    call 0x0063B870
00687D8E    add esp, 0x0C
00687D91    call 0x0063BC30
00687D96    test al, al
00687D98    jz 0x00687D9B
00687D9A    int3
00687D9B    call 0x0063BB00
