...
005FD120    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005FD12E    push eax                                        ; => [ Data: __security_cookie ]
005FD12F    lea eax, ss:[ebp-0x0C]
005FD132    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005FD138    mov edx, 0x802BCC
005FD13D    lea ecx, ss:[ebp-0x10]
005FD140    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
005FD145    mov edi, dword ptr ss:[ebp+0x08]
005FD148    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005FD1A4    jz 0x005FD1C8                                   ; => [ Data: data_cf65bc ]
005FD1A6    lea ecx, ss:[ebp-0x10]
005FD1A9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005FD1BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005FD1C1    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
005FD1C8    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005FD1CF    test bl, bl
005FD1D1    jz 0x005FD1DF
005FD1D3    xor dl, dl
005FD1D5    mov ecx, 0x07
005FD1DA    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
005FD1DF    mov edx, 0x8616E8
005FD1E4    lea ecx, ss:[ebp-0x10]
005FD1E7    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: BtnExport ]
005FD1EC    mov eax, dword ptr ss:[ebp-0x10]
005FD1EF    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005FD21C    xor esi, esi                                    ; => [ Call: nullptr | Call: nullptr ]
...
005FD23C    jz 0x005FD260                                   ; => [ Data: data_cf65bc ]
005FD23E    lea ecx, ss:[ebp-0x10]
005FD241    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005FD254    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005FD259    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
005FD260    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005FD267    test esi, esi
005FD269    jnz 0x005FD35A
005FD26F    lea ecx, ss:[ebp-0x10]
005FD272    call 0x005FCD10                                 ; => [ Call: sub_5fcd10 ]
005FD277    mov dword ptr ss:[ebp-0x04], 0x02
005FD27E    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
005FD29A    push esi
005FD29B    push 0x02
005FD29D    call dword ptr ds:[0x007750D4]                  ; => [ Type: HGLOBAL ]
005FD2A3    push esi
...
005FD2AE    push eax
005FD2AF    call 0x00761FBE                                 ; => [ Call: memcpy ]
005FD2B4    add esp, 0x0C
005FD2B7    push edi
005FD2B8    call dword ptr ds:[0x007750F8]
005FD2BE    push 0x00
005FD2C0    call dword ptr ds:[0x00775370]                  ; => [ Call: nullptr ]
005FD2C6    call dword ptr ds:[0x0077536C]
005FD2CC    push edi
005FD2CD    push 0x01
005FD2CF    call dword ptr ds:[0x00775360]
005FD2D5    call dword ptr ds:[0x0077535C]                  ; => [ Type: BOOL ]
005FD2DB    cmp dword ptr ds:[0x008DB6B4], 0x7F0
005FD2E5    jnz 0x005FD2EF                                  ; => [ Data: data_8db6b4 ]
005FD2E7    mov ecx, dword ptr ds:[0x008DB6B8]              ; => [ Data: data_8db6b8 ]
005FD2ED    jmp 0x005FD302
005FD2EF    xor ecx, ecx
005FD2F1    cmp dword ptr ds:[0x008DB6C4], 0x7F0
005FD2FB    cmovz ecx, dword ptr ds:[0x008DB6C8]            ; => [ Data: data_8db6c4 | Data: data_8db6c8 ]
005FD302    push 0x00
005FD304    push ecx
005FD305    mov edx, 0x86170C
005FD30A    call 0x0067CD20                                 ; => [ String: exportToClipboard | Call: sub_67cd20 ]
005FD30F    add esp, 0x08
005FD312    mov dword ptr ss:[ebp-0x04], 0x03
005FD319    cmp dword ptr ds:[0x00CF65BC], 0x00
005FD320    jz 0x005FD350                                   ; => [ Data: data_cf65bc ]
...
005FD331    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005FD344    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005FD349    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
005FD362    call 0x0063D720                                 ; => [ String: BtnSave | Call: sub_63d720 ]
005FD367    mov eax, dword ptr ss:[ebp-0x10]
005FD36A    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005FD3B3    jz 0x005FD3D7                                   ; => [ Data: data_cf65bc ]
005FD3B5    lea ecx, ss:[ebp-0x10]
005FD3B8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005FD3CB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005FD3D0    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
005FD3D7    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005FD3DE    test esi, esi
005FD3E0    jnz 0x005FD40F
005FD3E2    call 0x005FCF50
005FD3E7    mov esi, eax                                    ; => [ Call: sub_5fcf50 ]
005FD3E9    call 0x004BBDB0                                 ; => [ Call: sub_4bbdb0 ]
005FD3EE    mov dword ptr ds:[eax+0x0C], 0x01
005FD3F5    mov dword ptr ds:[eax+0x10], esi
005FD3F8    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
005FD3FE    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
005FD403    xor dl, dl
005FD405    mov ecx, 0x07
005FD40A    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
005FD40F    mov edx, 0x861730
005FD414    lea ecx, ss:[ebp-0x10]
005FD417    call 0x0063D720                                 ; => [ String: BtnDelete | Call: sub_63d720 ]
005FD41C    mov eax, dword ptr ss:[ebp-0x10]
005FD41F    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005FD46C    jz 0x005FD490                                   ; => [ Data: data_cf65bc ]
005FD46E    lea ecx, ss:[ebp-0x10]
005FD471    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005FD484    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005FD489    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
005FD4A6    jz 0x005FD4BC                                   ; => [ Data: data_be4a3c ]
005FD4A8    push 0x861720                                   ; => [ String: DomSetSaveClick ]
005FD4AD    push 0x8D71
005FD4B2    mov ecx, 0x86174C                               ; => [ String: gDomSetSave.style == SETSAVE_EXISTING ]
005FD4B7    jmp 0x005FD5DB
005FD4BC    call 0x004BBDB0                                 ; => [ Call: sub_4bbdb0 ]
005FD4C1    mov dword ptr ds:[eax+0x0C], 0x00
005FD4C8    mov dword ptr ds:[eax+0x10], 0x00
005FD4CF    mov ecx, dword ptr ds:[0x00CC8DC8]
005FD4D5    mov edi, dword ptr ds:[0x00BE4A40]              ; => [ Data: data_be4a40 ]
005FD4DB    mov ecx, dword ptr ds:[ecx+0x1E1A4]
005FD4E1    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
005FD4E6    lea ebx, ds:[eax+0x6EDC]
005FD4EC    test edi, edi
005FD4EE    jns 0x005FD504
005FD4F0    push 0x8616BC                                   ; => [ String: DomSetSaveDelete ]
005FD4F5    push 0x8D28
005FD4FA    mov ecx, 0x86169C                               ; => [ String: setIdx >= 0 ]
...
005FD52C    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
005FD531    lea eax, ds:[esi-0x04]
005FD534    push eax
005FD535    lea ecx, ds:[esi-0x10]
005FD538    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
005FD555    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
005FD55C    mov dword ptr ss:[ebp-0x18], edi
005FD55F    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
005FD57A    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
005FD57F    lea eax, ss:[ebp-0x1C]
005FD582    push eax
005FD583    lea ecx, ds:[esi-0x08]
005FD586    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
005FD58B    lea ecx, ss:[ebp-0x20]
005FD58E    mov dword ptr ds:[esi-0x04], edi
005FD591    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005FD598    call 0x004D6960                                 ; => [ Call: sub_4d6960 ]
005FD59D    dec dword ptr ds:[ebx+0x300]
005FD5A3    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
005FD5A9    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
005FD5AE    xor dl, dl
005FD5B0    lea ecx, ds:[edi+0x07]
005FD5B3    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
005FD5B8    xor al, al
005FD5BA    mov ecx, dword ptr ss:[ebp-0x0C]
005FD5BD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005FD5C4    pop ecx
005FD5C5    pop edi
005FD5C6    pop esi
005FD5C7    pop ebx
...
005FD5CA    pop ebp
005FD5CB    ret
005FD5CC    push 0x8616BC                                   ; => [ String: DomSetSaveDelete ]
005FD5D1    push 0x8D29
005FD5D6    mov ecx, 0x8616D0                               ; => [ String: setIdx < sets.numSets ]
005FD5DB    push 0x86F1E8
005FD5E0    mov edx, 0x801800
005FD5E5    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 ]
005FD5EA    add esp, 0x0C
005FD5ED    call 0x0063BC30
005FD5F2    test al, al
005FD5F4    jz 0x005FD5F7                                   ; => [ Call: sub_63bc30 ]
005FD5F6    int3
005FD5F7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
