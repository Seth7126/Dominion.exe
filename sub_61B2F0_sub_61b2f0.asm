...
0061B2F5    push 0x763270                                   ; => [ Call: __ehhandler$___std_smf_ellint_2@16 | Type: EHRegistrationNode ]
0061B2FA    mov eax, dword ptr fs:[0x00000000]
0061B300    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0061B301    push ecx
0061B302    push ebx
0061B303    push esi
0061B304    push edi
...
0061B30C    push eax                                        ; => [ Data: __security_cookie ]
0061B30D    lea eax, ss:[ebp-0x0C]
0061B310    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0061B316    push 0xB4A600
0061B31B    call dword ptr ds:[0x00775138]                  ; => [ Data: data_b4a600 ]
0061B321    mov edi, dword ptr ds:[0x00B4A618]              ; => [ Data: data_b4a618 ]
...
0061B36D    mov ecx, dword ptr ds:[0x00B4A618]              ; => [ Data: data_b4a618 ]
...
0061B385    jz 0x0061B3B1                                   ; => [ Data: data_cf65bc ]
...
0061B3A6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061B3AB    mov ecx, dword ptr ds:[0x00B4A618]              ; => [ Data: data_b4a618 ]
0061B3B1    mov edx, 0x21B138
0061B3B6    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0061B3BD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061B3C2    mov dword ptr ds:[0x00B4A618], 0x00             ; => [ Data: data_b4a618 ]
0061B3CC    push 0xB4A600
0061B3D1    call dword ptr ds:[0x00775144]                  ; => [ Data: data_b4a600 ]
0061B3D7    mov ecx, 0xB4A5DC
0061B3DC    call 0x004D4B30                                 ; => [ Call: sub_4d4b30 | Data: data_b4a5dc ]
0061B3E1    cmp dword ptr ds:[0x00B4A5C0], 0x00
0061B3E8    jz 0x0061B43F                                   ; => [ Data: data_b4a5c0 ]
0061B3EA    mov ecx, 0xB4A5C0
0061B3EF    call 0x005AC840                                 ; => [ Data: data_b4a5c0 | Call: sub_5ac840 ]
0061B3F4    mov eax, dword ptr ds:[0x00B4A5C0]              ; => [ Data: data_b4a5c0 ]
0061B3F9    test eax, eax
0061B3FB    jz 0x0061B403
0061B3FD    push eax
0061B3FE    call ebx
0061B400    add esp, 0x04
0061B403    mov dword ptr ds:[0x00B4A5C0], 0x00             ; => [ Data: data_b4a5c0 | Call: __builtin_memset ]
...
0061B435    mov dword ptr ds:[0x00B4A5D8], 0x00             ; => [ Data: data_b4a5d8 ]
0061B43F    mov esi, dword ptr ds:[0x00775134]
0061B445    push 0xB4A5E8
0061B44A    call esi                                        ; => [ Data: data_b4a5e8 ]
0061B44C    push 0xB4A600
0061B451    call esi                                        ; => [ Data: data_b4a600 ]
0061B453    cmp byte ptr ds:[0x00B809DC], 0x00
0061B45A    jz 0x0061B461                                   ; => [ Data: data_b809dc ]
0061B45C    call 0x005D0E60                                 ; => [ Call: sub_5d0e60 ]
0061B461    mov eax, dword ptr ds:[0x00BE1538]              ; => [ Data: data_be1538 ]
...
0061B477    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
...
0061B48C    mov ecx, dword ptr ds:[0x008DB528]              ; => [ Data: data_8db528 ]
0061B492    movzx eax, word ptr ds:[edx+0xC00]
0061B499    mov dword ptr ds:[0x008DB528], eax              ; => [ Data: data_8db528 ]
0061B49E    mov dword ptr ds:[edx+0xC00], ecx
0061B4A4    mov eax, dword ptr ds:[0x00BE153C]              ; => [ Data: data_be153c ]
0061B4A9    mov esi, eax
0061B4AB    dec dword ptr ds:[0x008DB52C]                   ; => [ Data: data_8db52c ]
0061B4B1    mov dword ptr ss:[ebp-0x10], eax
0061B4B4    cmp dword ptr ds:[esi], 0x00
0061B4B7    jz 0x0061B4C0
0061B4B9    mov ecx, esi
0061B4BB    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
0061B4C0    add esi, 0x04
0061B4C3    sub edi, 0x01
0061B4C6    jnz 0x0061B4B4
0061B4C8    mov edx, dword ptr ss:[ebp-0x10]
0061B4CB    mov ecx, dword ptr ds:[0x008DB528]              ; => [ Data: data_8db528 ]
0061B4D1    movzx eax, word ptr ds:[edx+0xC00]
0061B4D8    mov dword ptr ds:[0x008DB528], eax              ; => [ Data: data_8db528 ]
0061B4DD    mov dword ptr ds:[edx+0xC00], ecx
0061B4E3    dec dword ptr ds:[0x008DB52C]                   ; => [ Data: data_8db52c ]
0061B4E9    cmp dword ptr ds:[0x00CD3188], edi
0061B4EF    jle 0x0061B509                                  ; => [ Data: data_cd3188 ]
0061B4F1    mov esi, 0xCCF78C                               ; => [ Data: data_ccf78c ]
0061B4F6    mov ecx, esi
0061B4F8    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
0061B4FD    inc edi
0061B4FE    add esi, 0x74
0061B501    cmp edi, dword ptr ds:[0x00CD3188]
0061B507    jl 0x0061B4F6                                   ; => [ Data: data_cd3188 ]
0061B509    cmp dword ptr ds:[0x00B809E0], 0x00             ; => [ Data: data_b809e0 ]
0061B510    mov dword ptr ds:[0x00CD3188], 0x00             ; => [ Data: data_cd3188 ]
0061B51A    jz 0x0061B571
0061B51C    mov ecx, 0xB809E0
0061B521    call 0x00637650                                 ; => [ Call: sub_637650 | Data: data_b809e0 ]
0061B526    mov eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
0061B52B    test eax, eax
0061B52D    jz 0x0061B535
0061B52F    push eax
0061B530    call ebx
0061B532    add esp, 0x04
0061B535    mov dword ptr ds:[0x00B809E0], 0x00             ; => [ Data: data_b809e0 | Call: __builtin_memset ]
...
0061B567    mov dword ptr ds:[0x00B809F8], 0x00             ; => [ Data: data_b809f8 ]
0061B571    cmp dword ptr ds:[0x00BE3598], 0x00
0061B578    jz 0x0061B5A5                                   ; => [ Data: data_be3598 ]
0061B57A    mov ecx, 0xBE3598
0061B57F    call 0x006378E0                                 ; => [ Call: sub_6378e0 | Data: data_be3598 ]
0061B584    mov eax, dword ptr ds:[0x00BE359C]
0061B589    mov ecx, dword ptr ds:[0x00BE3598]
0061B58F    lea edx, ds:[eax*4+0x04]
0061B596    call 0x0064C080                                 ; => [ Data: data_be3598 | Data: data_be359c | Call: sub_64c080 ]
0061B59B    mov dword ptr ds:[0x00BE3598], 0x00             ; => [ Data: data_be3598 ]
0061B5A5    mov ecx, dword ptr ss:[ebp-0x0C]
0061B5A8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0061B5AF    pop ecx
0061B5B0    pop edi
0061B5B1    pop esi
0061B5B2    pop ebx
