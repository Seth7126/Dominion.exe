...
00517E90    push ecx
00517E91    mov ecx, dword ptr ds:[0x00CCA790]              ; => [ Data: data_cca790 ]
00517E97    push esi
00517E98    mov esi, dword ptr ds:[0x00CCA784]              ; => [ Data: data_cca784 ]
00517E9E    push edi
...
00517EB5    add edi, ecx                                    ; => [ Data: data_cca780 ]
00517EB7    jmp 0x00517EC7
00517EB9    mov eax, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
00517EBE    lea edi, ds:[ecx+0xA02]
00517EC4    lea edi, ds:[eax+edi*8]
00517EC7    cmp dword ptr ds:[edi], 0x834
00517ECD    jz 0x00517EE0
00517ECF    push 0x814780                                   ; => [ String: ThemeExpansionBasics ]
00517ED4    push 0x1F4C
00517ED9    mov ecx, 0x814798                               ; => [ String: theme.piece == CTHEME_EXPANSION ]
...
00517EF2    push 0x813640                                   ; => [ String: ExpansionCampaignDefGet ]
00517EF7    push 0x669
00517EFC    mov ecx, 0x813658                               ; => [ String: exp >= DOM_EXP_INTRIGUE ]
...
00517F18    call 0x0050B2A0                                 ; => [ Call: sub_50b2a0 ]
...
00517F2A    call 0x00515FE0                                 ; => [ Call: sub_515fe0 ]
00517F2F    pop edi
00517F30    pop esi
00517F31    pop ecx
00517F32    ret
00517F33    push 0x813640                                   ; => [ String: ExpansionCampaignDefGet ]
00517F38    push 0x672
00517F3D    mov ecx, 0x813670                               ; => [ String: retval.exp == exp ]
00517F42    push 0x80CD80
00517F47    mov edx, 0x801800
00517F4C    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
00517F51    add esp, 0x0C
00517F54    call 0x0063BC30
00517F59    test al, al
00517F5B    jz 0x00517F5E                                   ; => [ Call: sub_63bc30 ]
00517F5D    int3
00517F5E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
