...
006EAD40    movss dword ptr ds:[eax], xmm0
...
006EAD63    movss dword ptr ds:[eax], xmm0
006EAD67    pop esi
006EAD68    pop ecx
006EAD69    pop ebp
006EAD6A    ret 0x08
...
006EADC1    call 0x0063B870
006EADC6    add esp, 0x0C
006EADC9    call 0x0063BC30
006EADCE    test al, al
006EADD0    jz 0x006EADD3
006EADD2    int3
006EADD3    call 0x0063BB00
