...
00503FCB    call 0x00761E50
00503FD0    mov eax, dword ptr ds:[0x008C4040]
...
00504023    jl 0x0050403F
00504025    call 0x00573400
...
00504058    movlpd qword ptr ss:[esp+0x2C], xmm0
