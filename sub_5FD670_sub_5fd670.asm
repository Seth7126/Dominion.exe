...
005FD692    mov dword ptr fs:[0x00000000], eax
005FD698    mov ebx, dword ptr ss:[ebp+0x08]
005FD69B    mov ecx, ebx
005FD69D    call 0x0064E7A0
005FD6A2    mov ecx, ebx
005FD6A4    mov dword ptr ds:[eax+0x18BC], 0x5FD110
005FD6AE    call 0x0064E7A0
005FD6B3    mov dword ptr ds:[eax+0x18C0], 0x5FD0B0
005FD6BD    mov eax, dword ptr ds:[0x00BE4A3C]
...
005FD7C1    mov dword ptr ss:[ebp-0x14], 0x00
005FD7C8    lea ebx, ds:[eax+0x6EDC]
...
005FD826    jz 0x005FD843
005FD828    lea ecx, ss:[ebp-0x18]
005FD82B    call 0x0063D4E0
...
005FD885    jz 0x005FD8A2
005FD887    lea ecx, ss:[ebp-0x10]
005FD88A    call 0x0063D4E0
...
005FD89D    call 0x0064C080
005FD8A2    mov ecx, dword ptr ss:[ebp-0x0C]
005FD8A5    mov dword ptr fs:[0x00000000], ecx
005FD8AC    pop ecx
005FD8AD    pop edi
005FD8AE    pop esi
005FD8AF    pop ebx
...
005FD8CD    call 0x0063B870
005FD8D2    add esp, 0x0C
005FD8D5    call 0x0063BC30
005FD8DA    test al, al
005FD8DC    jz 0x005FD8DF
005FD8DE    int3
005FD8DF    call 0x0063BB00
