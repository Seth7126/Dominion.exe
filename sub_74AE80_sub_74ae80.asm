...
0074AE8B    mov ecx, dword ptr ds:[0x01512450]              ; => [ Data: data_1512450 ]
0074AE91    cmp dword ptr ds:[ecx+0x04], 0x1E
0074AE95    jz 0x0074AEB0
0074AE97    push 0x8790A8                                   ; => [ String: UIDefGet ]
0074AE9C    push 0x127
0074AEA1    push 0x878EA8                                   ; => [ String: C:\x\ax2017\Engine\UIDef.cpp ]
0074AEA6    mov ecx, 0x8790C8                               ; => [ String: ptr->assetType == ASSET_TYPE_UI ]
0074AEAB    jmp 0x0074AF79
0074AEB0    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0074AECB    mov edx, dword ptr ds:[0x0151345C]              ; => [ Data: data_151345c ]
0074AED1    xor ebx, ebx                                    ; => [ Call: nullptr ]
...
0074AEE8    jz 0x0074AEF1                                   ; => [ Data: data_151245c ]
0074AEEA    inc eax
...
0074AEFC    call 0x0074AD60                                 ; => [ Call: sub_74ad60 ]
0074AF01    mov edx, dword ptr ds:[0x0151345C]              ; => [ Data: data_151345c ]
...
0074AF48    call 0x0074AD60                                 ; => [ Call: sub_74ad60 ]
0074AF4D    dec esi
0074AF4E    inc edi
...
0074AF63    pop ebp
0074AF64    ret
0074AF65    push 0x88FEB8                                   ; => [ String: MoveSelectionToPosition ]
0074AF6A    push 0x96B
0074AF6F    push 0x88FC60                                   ; => [ String: C:\x\ax2017\Engine\Editor\UIEditor.cpp ]
0074AF74    mov ecx, 0x88FE94                               ; => [ String: numElements == layout.numElements ]
0074AF79    mov edx, 0x801800
0074AF7E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0074AF83    add esp, 0x0C
0074AF86    call 0x0063BC30
0074AF8B    test al, al
0074AF8D    jz 0x0074AF90                                   ; => [ Call: sub_63bc30 ]
0074AF8F    int3
0074AF90    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
