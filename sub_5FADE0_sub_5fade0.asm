...
005FADE8    call 0x00761E50                                 ; => [ Call: __chkstk ]
005FADED    mov eax, dword ptr ds:[0x008C4040]
005FADF2    xor eax, ebp
005FADF4    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
005FADF7    push ebx
005FADF8    push esi
005FADF9    push edi
005FADFA    mov esi, edx
005FADFC    mov edi, ecx
005FADFE    call 0x004BBDB0                                 ; => [ Call: sub_4bbdb0 ]
...
005FAE22    push eax
005FAE23    call 0x00761FBE                                 ; => [ Call: memcpy | Call: sub_4e49d0 ]
...
005FAE50    push 0x86149C                                   ; => [ String: ToggleTristate ]
...
005FAEA7    push 0x86149C                                   ; => [ String: ToggleTristate ]
...
005FAEF8    push 0x8614F4                                   ; => [ String: ToggleKingdomModifier ]
...
005FAF61    push 0x8614CC                                   ; => [ String: ToggleSetupFlag ]
005FAF66    push 0x89E2
005FAF6B    mov ecx, 0x86150C                               ; => [ String: btn == 0 ]
...
005FAF90    push 0x8614CC                                   ; => [ String: ToggleSetupFlag ]
005FAF95    push 0x89E2
005FAF9A    mov ecx, 0x86150C                               ; => [ String: btn == 0 ]
...
005FAFBC    push 0x8614CC                                   ; => [ String: ToggleSetupFlag ]
005FAFC1    push 0x89E2
005FAFC6    mov ecx, 0x86150C                               ; => [ String: btn == 0 ]
...
005FAFE5    push 0x8614CC                                   ; => [ String: ToggleSetupFlag ]
005FAFEA    push 0x89E2
005FAFEF    mov ecx, 0x86150C                               ; => [ String: btn == 0 ]
...
005FB016    call 0x004E4CB0                                 ; => [ Call: sub_4e4cb0 ]
005FB01B    mov ecx, dword ptr ss:[ebp-0x04]
005FB01E    pop edi
005FB01F    pop esi
005FB020    xor ecx, ebp
005FB022    pop ebx
005FB023    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005FB028    mov esp, ebp
005FB02A    pop ebp
005FB02B    ret
005FB02C    push 0x8614F4                                   ; => [ String: ToggleKingdomModifier ]
005FB031    push 0x8A28
005FB036    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005FB03B    push 0x86F1E8
005FB040    mov edx, 0x801800
005FB045    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 ]
005FB04A    add esp, 0x0C
005FB04D    call 0x0063BC30
005FB052    test al, al
005FB054    jz 0x005FB057                                   ; => [ Call: sub_63bc30 ]
005FB056    int3
005FB057    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
