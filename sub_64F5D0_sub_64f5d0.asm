...
0064F5D5    push 0x76CCB2                                   ; => [ Call: sub_76ccb2 | Type: EHRegistrationNode ]
0064F5DA    mov eax, dword ptr fs:[0x00000000]
0064F5E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064F5EF    push esi
0064F5F0    push edi
0064F5F1    push eax                                        ; => [ Data: __security_cookie ]
0064F5F2    lea eax, ss:[ebp-0x0C]
0064F5F5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0064F5FB    mov esi, edx
0064F5FD    mov dword ptr ss:[ebp-0x6C], esi
0064F600    mov ebx, ecx
0064F602    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064F623    push ecx                                        ; => [ Call: `eh vector constructor iterator' ]
0064F624    mov ecx, dword ptr ds:[esi]
0064F626    call 0x0064C230                                 ; => [ Call: sub_64c230 ]
...
0064F64B    call 0x0067E8F0                                 ; => [ Call: sub_67e8f0 | Call: sub_64f580 ]
...
0064F674    mov edi, 0x801800                               ; => [ Data: data_801800 ]
0064F679    mov esi, dword ptr ds:[0x0147ABD8]              ; => [ Data: data_147abd8 ]
...
0064F6A5    push 0x10
0064F6A7    call 0x00759772                                 ; => [ Call: operator new ]
...
0064F6BE    mov esi, eax                                    ; => [ Call: sub_64c140 ]
...
0064F6D4    mov eax, dword ptr ds:[ecx+eax*4]               ; => [ Call: sub_69c4d0 ]
...
0064F6FB    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0064F70C    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0064F71A    mov dword ptr ds:[ecx], 0x00                    ; => [ Call: __builtin_memset ]
...
0064F7A4    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0064F7B5    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0064F7D4    mov dword ptr ds:[ecx+0x08], eax                ; => [ Call: sub_69c4d0 ]
0064F7D7    mov eax, dword ptr ds:[ebx+0x08]
0064F7DA    mov dword ptr ds:[edx+eax*1], ecx               ; => [ Call: sub_69c4d0 ]
...
0064F7F0    mov eax, dword ptr ds:[ecx+eax*4]               ; => [ Call: sub_69c4d0 ]
...
0064F80B    xor eax, eax                                    ; => [ Call: nullptr ]
...
0064F841    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
0064F846    mov ecx, dword ptr ss:[ebp-0x0C]
0064F849    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064F850    pop ecx
0064F851    pop edi
0064F852    pop esi
0064F853    pop ebx
...
0064F859    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
