...
00502C95    mov dword ptr fs:[0x00000000], eax
00502C9B    lea eax, ss:[ebp-0xA0]
00502CA1    mov dword ptr ss:[ebp-0xA0], 0x80A9EC
00502CAB    mov dword ptr ss:[ebp-0x7C], eax
00502CAE    lea eax, ss:[ebp-0x70]
00502CB1    mov dword ptr ss:[ebp-0x4C], eax
00502CB4    lea eax, ss:[ebp-0x40]
00502CB7    mov dword ptr ss:[ebp-0x78], 0xB0
00502CBE    mov dword ptr ss:[ebp-0x74], 0x00
00502CC5    mov dword ptr ss:[ebp-0x70], 0x80A9D0
00502CCC    mov dword ptr ss:[ebp-0x48], 0xB1
00502CD3    mov dword ptr ss:[ebp-0x44], 0x00
00502CDA    mov dword ptr ss:[ebp-0x40], 0x80A9B4
00502CE1    mov dword ptr ss:[ebp-0x1C], eax
