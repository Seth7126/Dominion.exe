...
00629925    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
0062992A    mov eax, dword ptr fs:[0x00000000]
00629930    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00629931    sub esp, 0x08
00629934    push esi
00629935    push edi
00629936    mov eax, dword ptr ds:[0x008C4040]
0062993B    xor eax, ebp
0062993D    push eax                                        ; => [ Data: __security_cookie ]
0062993E    lea eax, ss:[ebp-0x0C]
00629941    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00629947    mov esi, dword ptr ss:[ebp+0x08]
0062994A    mov ecx, esi
0062994C    call 0x0064E7A0
00629951    mov dword ptr ds:[eax+0x18BC], 0x6291A0         ; => [ Call: sub_64e7a0 | Call: sub_6291a0 ]
0062995B    lea eax, ss:[ebp-0x10]
0062995E    push dword ptr ds:[0x00B80988]                  ; => [ Data: data_b80988 ]
00629964    push 0x808880
00629969    push eax
0062996A    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
006299AA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00629B41    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: NumberPickerUpdate | String: Halt ]
00629B46    add esp, 0x0C
00629B49    call 0x0063BC30
00629B4E    test al, al
00629B50    jz 0x00629B53                                   ; => [ Call: sub_63bc30 ]
00629B52    int3
00629B53    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
