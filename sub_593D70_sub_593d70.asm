...
00593D9D    mov esi, dword ptr ds:[eax]
...
00593ED0    call 0x0063B870
00593ED5    add esp, 0x0C
00593ED8    call 0x0063BC30
00593EDD    test al, al
00593EDF    jz 0x00593EE2
00593EE1    int3
00593EE2    call 0x0063BB00
