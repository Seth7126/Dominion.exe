...
0063B855    call 0x0063B660                                 ; => [ Call: sub_63b660 ]
0063B85A    mov ecx, dword ptr ss:[ebp-0x04]
0063B85D    xor ecx, ebp
0063B85F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
