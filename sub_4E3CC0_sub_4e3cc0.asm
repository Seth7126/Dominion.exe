...
004E3CC5    push 0x764326                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??1_Pop_finalizer@_Micro_queue@details@Concurrency@@QAE@XZ ]
004E3CCA    mov eax, dword ptr fs:[0x00000000]
004E3CD0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E3CD1    sub esp, 0x14
004E3CD4    push esi
004E3CD5    push edi
004E3CD6    mov eax, dword ptr ds:[0x008C4040]
004E3CDB    xor eax, ebp
004E3CDD    push eax                                        ; => [ Data: __security_cookie ]
004E3CDE    lea eax, ss:[ebp-0x0C]
004E3CE1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004E3CE7    mov edi, ecx
004E3CE9    mov dword ptr ss:[ebp-0x1C], edi
004E3CEC    mov dword ptr ss:[ebp-0x18], 0x00
004E3CF3    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
004E3D23    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: dom_log_project_cube | Call: sub_63d850 ]
...
004E3D46    call 0x0063D850                                 ; => [ String: dom_log_%s_token | Call: sub_63df30 | Call: sub_63d850 ]
004E3D4B    mov byte ptr ss:[ebp-0x04], 0x05
004E3D4F    cmp dword ptr ds:[0x00CF65BC], 0x00
004E3D56    jz 0x004E3D7F                                   ; => [ Data: data_cf65bc ]
...
004E3D67    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E3DB2    jle 0x004E3DFF                                  ; => [ Data: data_19e5d14 | Field: ThreadLocalStoragePointer ]
004E3DB4    push 0x19E5D14
004E3DB9    call 0x0075970E                                 ; => [ Data: data_19e5d14 | Call: sub_75970e ]
004E3DBE    add esp, 0x04
004E3DC1    cmp dword ptr ds:[0x019E5D14], 0xFFFFFFFF
004E3DC8    jnz 0x004E3DFF                                  ; => [ Data: data_19e5d14 ]
004E3DCA    push 0x773980
004E3DCF    mov dword ptr ds:[0x019E5D18], 0x801800         ; => [ Data: data_19e5d18 | Data: data_801800 ]
004E3DD9    mov dword ptr ds:[0x019E5D1C], 0x801800         ; => [ Data: data_19e5d1c | Data: data_801800 ]
004E3DE3    mov dword ptr ds:[0x019E5D20], 0x801800         ; => [ Data: data_801800 | Data: data_19e5d20 ]
004E3DED    call 0x0075964C                                 ; => [ Call: _atexit | Call: sub_773980 ]
004E3DF2    push 0x19E5D14
004E3DF7    call 0x007596BD                                 ; => [ Data: data_19e5d14 | Call: __Init_thread_footer ]
004E3DFC    add esp, 0x08
004E3DFF    lea eax, ss:[ebp-0x10]
004E3E02    mov ecx, 0x19E5D18
004E3E07    push eax
004E3E08    call 0x0063D850                                 ; => [ Data: data_19e5d18 | Call: sub_63d850 ]
004E3E0D    mov eax, dword ptr ds:[0x019E5D18]              ; => [ Data: data_19e5d18 ]
...
004E3E1F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E3E46    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E3E6C    jz 0x004E3E89                                   ; => [ Data: data_cf65bc ]
004E3E6E    lea ecx, ss:[ebp-0x10]
004E3E71    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E3E84    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E3E89    mov eax, edi
004E3E8B    mov ecx, dword ptr ss:[ebp-0x0C]
004E3E8E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E3E95    pop ecx
004E3E96    pop edi
004E3E97    pop esi
