...
005685F5    push 0x7671A5                                   ; => [ Call: sub_7671a5 | Type: EHRegistrationNode ]
005685FA    mov eax, dword ptr fs:[0x00000000]
00568600    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0056860F    push esi
00568610    push edi
00568611    push eax                                        ; => [ Data: __security_cookie ]
00568612    lea eax, ss:[ebp-0x0C]
00568615    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0056861B    mov dword ptr ss:[ebp-0x1C], edx
0056861E    mov esi, ecx
00568620    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00568633    call 0x00590AD0                                 ; => [ Call: sub_590ad0 ]
...
0056864B    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00568664    mov dword ptr ss:[ebp-0x44], 0x81F114           ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0056866B    mov dword ptr ss:[ebp-0x40], eax
0056866E    lea eax, ss:[ebp-0x44]
00568671    mov dword ptr ss:[ebp-0x20], eax                ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable ]
...
005686A3    push esi
005686A4    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
005686C3    mov dword ptr ds:[edi+0xC80], eax               ; => [ Call: GSI1::OffForSym ]
...
00568725    push esi
00568726    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0056873E    mov dword ptr ds:[edi+0xC80], eax               ; => [ Call: GSI1::OffForSym ]
...
00568755    push edx
00568756    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
00568759    mov eax, edi
0056875B    mov ecx, dword ptr ss:[ebp-0x0C]
0056875E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00568765    pop ecx
00568766    pop edi
00568767    pop esi
00568768    pop ebx
...
0056876E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
