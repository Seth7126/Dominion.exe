...
004D3C78    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
004D3CE0    call 0x004D3B00                                 ; => [ Call: sub_4d3b00 ]
...
004D3CF3    push 0x80541C                                   ; => [ String: GetDlgAsset ]
004D3CF8    push 0x2E31
004D3CFD    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D3D02    mov ecx, 0x805428                               ; => [ String: def.uiPages ]
...
004D3D3E    call 0x00654CE0                                 ; => [ Call: nullptr | String: dialog (retired) | Call: sub_654ce0 ]
004D3D43    mov ecx, dword ptr ds:[edi]
004D3D45    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3D4A    movss xmm3, dword ptr ds:[0x00890E18]
004D3D52    mov edx, 0x8DBA78
004D3D57    push 0x00
004D3D59    push 0xFFFFFFFF
004D3D5B    mov ecx, eax
004D3D5D    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dba78 ]
004D3D62    mov ecx, dword ptr ds:[edi]
004D3D64    add esp, 0x20
004D3D67    xorps xmm1, xmm1
004D3D6A    call 0x0065D6E0                                 ; => [ String: 0 | Call: sub_65d6e0 | String: zx ]
...
004D3D82    mov eax, dword ptr ds:[eax+0x0C]                ; => [ Call: sub_4d3b00 ]
004D3D85    push 0x00
004D3D87    push 0x00
004D3D89    push eax
...
004D3D9F    call 0x00654CE0                                 ; => [ Call: nullptr | Call: sub_654ce0 | String: dialog ]
004D3DA4    add esp, 0x18
004D3DA7    cmp byte ptr ss:[esp+0x13], 0x00
004D3DAC    jz 0x004D3DD0
004D3DAE    mov ecx, dword ptr ds:[edi]
004D3DB0    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3DB5    movss xmm3, dword ptr ds:[0x00890E18]
004D3DBD    mov edx, 0x8DBA78
004D3DC2    push 0x00
004D3DC4    push 0xFFFFFFFF
004D3DC6    mov ecx, eax
004D3DC8    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dba78 ]
004D3DCD    add esp, 0x08
004D3DD0    mov ecx, dword ptr ds:[edi]
004D3DD2    call 0x004D3B70                                 ; => [ Call: sub_4d3b70 ]
004D3DD7    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
004D3DDC    mov ecx, dword ptr ds:[edi]
004D3DDE    test eax, eax
004D3DE0    jnz 0x004D3DFB
004D3DE2    push 0x806A44                                   ; => [ String: GetLocalSettings ]
004D3DE7    push 0x5FB
004D3DEC    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004D3DF1    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
...
004D3E0D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3E12    mov edx, 0x8DC9F8
004D3E17    jmp 0x004D3E2F
004D3E19    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3E1E    mov edx, 0x8DC9EC
004D3E23    jmp 0x004D3E2F
004D3E25    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3E2A    mov edx, 0x8DC9E0
004D3E2F    movss xmm3, dword ptr ds:[0x00890E18]
004D3E37    mov ecx, eax
004D3E39    push 0x00
004D3E3B    push 0xFFFFFFFF
004D3E3D    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc9e0 | Call: sub_665db0 | Data: data_8dc9ec | Call: sub_665db0 | Data: data_8dc9f8 ]
004D3E42    add esp, 0x08
004D3E45    mov ecx, dword ptr ds:[edi]
004D3E47    call 0x004D2030                                 ; => [ Call: sub_4d2030 ]
004D3E4C    mov ecx, dword ptr ds:[esi]
004D3E4E    call 0x004D3B00
004D3E53    mov eax, dword ptr ds:[eax+0x14]                ; => [ Call: sub_4d3b00 ]
...
004D3E99    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3E9E    movss xmm3, dword ptr ds:[0x00890E18]
004D3EA6    mov edx, 0x8DBD70
004D3EAB    push 0x00
004D3EAD    push 0xFFFFFFFF
004D3EAF    mov ecx, eax
004D3EB1    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dbd70 ]
004D3EB6    add esp, 0x08
004D3EB9    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
004D3EBE    test eax, eax
004D3EC0    jnz 0x004D3EDB
004D3EC2    push 0x806A44                                   ; => [ String: GetLocalSettings ]
004D3EC7    push 0x5FB
004D3ECC    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004D3ED1    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
004D3ED6    jmp 0x004D40B4
004D3EDB    cmp dword ptr ds:[eax+0x0C], 0x00
004D3EDF    mov ecx, 0xCADF60
004D3EE4    mov esi, 0xCADF54                               ; => [ Data: data_cadf54 ]
004D3EE9    cmovz esi, ecx                                  ; => [ Data: data_cadf60 ]
004D3EEC    mov ecx, dword ptr ds:[edi]
004D3EEE    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3EF3    movss xmm3, dword ptr ds:[0x00890E18]
004D3EFB    mov edx, esi
004D3EFD    push 0x00
004D3EFF    push 0xFFFFFFFF
004D3F01    mov ecx, eax
004D3F03    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
004D3F08    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004D3F0D    add esp, 0x08
004D3F10    test eax, eax
004D3F12    jnz 0x004D3F2A
004D3F14    push 0x77EB90                                   ; => [ String: GetClient ]
004D3F19    push 0x7B
004D3F1B    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004D3F20    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004D3F25    jmp 0x004D40B4
004D3F2A    cmp byte ptr ds:[eax+0x75AC], 0x00
004D3F31    jz 0x004D3F55
004D3F33    mov ecx, dword ptr ds:[edi]
004D3F35    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3F3A    movss xmm3, dword ptr ds:[0x00890E18]
004D3F42    mov edx, 0x8DBD58
004D3F47    push 0x00
004D3F49    push 0xFFFFFFFF
004D3F4B    mov ecx, eax
004D3F4D    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dbd58 ]
004D3F52    add esp, 0x08
004D3F55    mov esi, dword ptr ds:[0x007750AC]
004D3F5B    lea eax, ss:[esp+0x18]
004D3F5F    push eax
004D3F60    mov dword ptr ds:[0x0147ABE0], 0x00             ; => [ Data: data_147abe0 ]
004D3F6A    call esi
004D3F6C    mov ecx, dword ptr ss:[esp+0x14]
004D3F70    mov ecx, dword ptr ds:[ecx]
004D3F72    call 0x004D3B00
004D3F77    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_4d3b00 ]
004D3F7A    test eax, eax
004D3F7C    jnz 0x004D3F97
004D3F7E    push 0x805434                                   ; => [ String: GetDlgUpdate ]
004D3F83    push 0x2E45
004D3F88    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D3F8D    mov ecx, 0x805444                               ; => [ String: def.updateFn ]
...
004D3FB5    push eax
004D3FB6    push ecx
004D3FB7    call 0x0063C000                                 ; => [ Call: sub_63c000 ]
...
004D3FCC    call 0x0065D6E0                                 ; => [ Call: sub_65d6e0 ]
...
004D3FEC    push eax
004D3FED    push ecx
004D3FEE    call 0x0063C000                                 ; => [ Call: sub_63c000 ]
...
004D405E    movss xmm0, dword ptr ds:[eax+0x1680]           ; => [ Call: nullptr | Call: sub_64e7a0 | Call: sub_64c870 ]
...
004D4085    mov eax, dword ptr ds:[eax+0x18]                ; => [ Call: sub_4d3b00 ]
...
004D4095    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
004D409A    pop edi
004D409B    pop esi
004D409C    mov esp, ebp
004D409E    pop ebp
004D409F    ret
004D40A0    push 0x87437C                                   ; => [ String: UI2::countChildren ]
004D40A5    push 0xBA8
004D40AA    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
004D40AF    mov ecx, 0x874310                               ; => [ String: numChildren >= 0 ]
004D40B4    mov edx, 0x801800
004D40B9    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004D40BE    add esp, 0x0C
004D40C1    call 0x0063BC30
004D40C6    test al, al
004D40C8    jz 0x004D40CB                                   ; => [ Call: sub_63bc30 ]
004D40CA    int3
004D40CB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
