...
005DB064    byte FF
005DB065    push 0x769C20                                   ; => [ Type: EHRegistrationNode | Call: sub_769c20 ]
005DB06A    mov eax, dword ptr fs:[0x00000000]
005DB070    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005DB082    push esi
005DB083    push edi
005DB084    push eax                                        ; => [ Data: __security_cookie ]
005DB085    lea eax, ss:[ebp-0x0C]
005DB088    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005DB08E    mov ebx, dword ptr ss:[ebp+0x08]
005DB091    mov ecx, dword ptr ds:[ebx+0x1C]
005DB094    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
...
005DB0C7    push 0x8714E4                                   ; => [ String: TokenClick ]
005DB0CC    push 0x35B7
005DB0D1    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005DB0D6    mov ecx, 0x8714F0                               ; => [ String: gfx.type == DOMGFX_TOKEN || gfx.type == DOMGFX_TOKEN_ICON || gfx.type == DOMGFX_ICON_PLACEHOLDER || gfx.type == DOMGFX_HINT || gfx.type == DOMGF ]
005DB0DB    jmp 0x005DB409
005DB0E0    mov esi, dword ptr ds:[ebx+0x04]
005DB0E3    lea ecx, ss:[ebp-0xD30]
005DB0E9    mov edx, 0x871588
005DB0EE    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_icon ]
005DB0F3    mov eax, dword ptr ss:[ebp-0xD30]
005DB0F9    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005DB13F    jz 0x005DB169                                   ; => [ Data: data_cf65bc ]
005DB141    lea ecx, ss:[ebp-0xD30]
005DB147    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005DB15A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005DB15F    mov dword ptr ss:[ebp-0xD30], 0x801800          ; => [ Data: data_801800 ]
...
005DB187    push 0x8714E4                                   ; => [ String: TokenClick ]
005DB18C    push 0x35D2
005DB191    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005DB196    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005DB19B    jmp 0x005DB409
005DB1A0    cmp dword ptr ds:[edi+0x224], 0x00
005DB1A7    jz 0x005DB1C2
005DB1A9    push 0x8714E4                                   ; => [ String: TokenClick ]
005DB1AE    push 0x35C8
005DB1B3    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005DB1B8    mov ecx, 0x86F604                               ; => [ String: gfx.arrow.source.type == DOMARROWSOURCE_PLAYER ]
005DB1BD    jmp 0x005DB409
005DB1C2    mov ecx, dword ptr ds:[edi+0x228]
005DB1C8    call 0x005E9A30                                 ; => [ Call: sub_5e9a30 ]
005DB1CD    mov eax, dword ptr ds:[0x00B604CC]              ; => [ Data: data_b604cc ]
005DB1D2    cmp eax, 0x01
005DB1D5    jnz 0x005DB1E8
005DB1D7    mov dword ptr ds:[0x00B604CC], 0x02             ; => [ Data: data_b604cc ]
005DB1E1    mov al, al
005DB1E3    jmp 0x005DB3DC
005DB1E8    cmp eax, 0x03
005DB1EB    jnz 0x005DB1F7
005DB1ED    mov dword ptr ds:[0x00B604CC], 0x00             ; => [ Data: data_b604cc ]
...
005DB216    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_icon ]
005DB21B    mov eax, dword ptr ss:[ebp-0xD30]
005DB221    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005DB26C    jz 0x005DB296                                   ; => [ Data: data_cf65bc ]
005DB26E    lea ecx, ss:[ebp-0xD30]
005DB274    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005DB287    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005DB28C    mov dword ptr ss:[ebp-0xD30], 0x801800          ; => [ Data: data_801800 ]
...
005DB2A7    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
005DB2AC    push 0x01
005DB2AE    push ecx
005DB2AF    push 0x01
005DB2B1    mov edx, 0x7FFB14
005DB2B6    mov ecx, eax
005DB2B8    call 0x00617BB0                                 ; => [ Data: data_7ffb14 | Call: sub_617bb0 ]
...
005DB2E5    call 0x0063D720                                 ; => [ String: btn_taptip | Call: sub_63d720 ]
005DB2EA    mov eax, dword ptr ss:[ebp-0xD30]
005DB2F0    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005DB33C    jz 0x005DB366                                   ; => [ Data: data_cf65bc ]
005DB33E    lea ecx, ss:[ebp-0xD30]
005DB344    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005DB357    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005DB35C    mov dword ptr ss:[ebp-0xD30], 0x801800          ; => [ Data: data_801800 ]
005DB366    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005DB36D    test esi, esi
005DB36F    jnz 0x005DB3DA
005DB371    call 0x005DAFE0                                 ; => [ Call: sub_5dafe0 ]
005DB376    test al, al
005DB378    jz 0x005DB3DA
005DB37A    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
005DB391    call 0x0063B7F0                                 ; => [ String: failed to submit coffers click, waiting | Call: sub_63b7f0 ]
005DB396    add esp, 0x04
005DB399    jmp 0x005DB3DA
005DB39B    mov edx, 0xB80AF8
005DB3A0    lea ecx, ss:[ebp-0xD2C]
005DB3A6    call 0x005939A0                                 ; => [ Data: data_b80af8 | Call: sub_5939a0 ]
005DB3AB    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
005DB3D5    call 0x005EE590                                 ; => [ Call: sub_5ee590 ]
005DB3DA    xor al, al
005DB3DC    mov ecx, dword ptr ss:[ebp-0x0C]
005DB3DF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005DB3E6    pop ecx
005DB3E7    pop edi
005DB3E8    pop esi
005DB3E9    pop ebx
...
005DB3EF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005DB3F4    mov esp, ebp
005DB3F6    pop ebp
005DB3F7    ret
005DB3F8    push 0x77EB90                                   ; => [ String: GetClient ]
005DB3FD    push 0x7B
005DB3FF    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
005DB404    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
005DB409    mov edx, 0x801800
005DB40E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005DB413    add esp, 0x0C
005DB416    call 0x0063BC30
005DB41B    test al, al
005DB41D    jz 0x005DB420                                   ; => [ Call: sub_63bc30 ]
005DB41F    int3
005DB420    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
