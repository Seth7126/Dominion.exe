...
004B9B98    movups xmmword ptr ds:[edi], xmm0               ; => [ String: 0 | String: zx ]
004B9B9B    mov eax, dword ptr ds:[eax]
004B9B9D    mov dword ptr ds:[edi], eax
004B9B9F    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004B9BC1    test al, al
004B9BC3    jnz 0x004B9BCE                                  ; => [ Call: sub_4db7a0 ]
004B9BC5    inc esi
...
004B9BDA    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004B9C01    test al, al
004B9C03    jnz 0x004B9C0C                                  ; => [ Call: sub_4db7a0 ]
004B9C05    inc esi
...
004B9C1C    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004B9C41    test al, al
004B9C43    jnz 0x004B9C4C                                  ; => [ Call: sub_4db7a0 ]
004B9C45    inc esi
...
004B9C5C    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004B9C81    test al, al
004B9C83    jnz 0x004B9CAF                                  ; => [ Call: sub_4db7a0 ]
004B9C85    inc esi
...
004B9CA3    jl 0x004B9B60                                   ; => [ Data: data_77fea0 ]
004B9CA9    pop edi
004B9CAA    pop esi
...
004B9CC6    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004B9CE3    test al, al
004B9CE5    jnz 0x004B9CF0                                  ; => [ Call: sub_4db700 ]
004B9CE7    inc esi
...
004B9D0D    movups xmmword ptr ds:[edx], xmm0               ; => [ String: 0 | String: zx ]
