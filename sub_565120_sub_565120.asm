...
00565125    push 0x766FAB                                   ; => [ Call: sub_766fab | Type: EHRegistrationNode ]
0056512A    mov eax, dword ptr fs:[0x00000000]
00565130    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00565131    mov eax, 0x25D8
00565136    call 0x00761E50                                 ; => [ Call: __chkstk ]
0056513B    mov eax, dword ptr ds:[0x008C4040]
00565140    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0056514C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00565167    call 0x00573400                                 ; => [ Call: sub_573400 ]
0056516C    push ecx
0056516D    lea ecx, ss:[ebp-0x195C]
00565173    push ecx
00565174    mov edx, dword ptr ds:[eax+0x0C]
00565177    mov ecx, dword ptr ds:[eax+0x04]
0056517A    call 0x00577640                                 ; => [ Call: sub_577640 ]
0056517F    mov ebx, eax
00565181    mov dword ptr ss:[ebp-0xCD4], 0x81F264          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_26dc126f42d981e5efcee2c6428d278e>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_26dc126f42d981e5efcee2c6428d278e>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
...
005651B7    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005651B9    mov dword ptr ss:[ebp-0xCB0], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_26dc126f42d981e5efcee2c6428d278e>,bool,enum CardID>::VTable ]
...
005651F7    push esi
005651F8    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0056521A    mov dword ptr ss:[ebp-0x1C], eax                ; => [ Call: GSI1::OffForSym ]
...
00565231    push eax
00565232    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00565235    push 0x00
00565237    push 0x00
00565239    push 0x0C
...
00565269    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
...
0056527E    call 0x00573400                                 ; => [ Call: sub_573400 ]
00565283    push 0x04
00565285    push 0x00
00565287    push 0x00
...
005652A7    test al, al
005652A9    cmovz esi, ecx                                  ; => [ Call: nullptr | Call: sub_583720 ]
005652AC    mov eax, esi
005652AE    jmp 0x005652B2
005652B0    xor eax, eax
005652B2    mov ecx, dword ptr ss:[ebp-0x0C]
005652B5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005652BC    pop ecx
005652BD    pop edi
005652BE    pop esi
005652BF    pop ebx
...
005652C5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
