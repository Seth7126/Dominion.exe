...
004B02F5    push 0x76270E                                   ; => [ Call: __ehhandler$?accept_message@?$overwrite_buffer@W4agent_status@Concurrency@@@Concurrency@@MAEPAV?$message@W4agent_status@Concurrency@@@2@H@Z | Type: EHRegistrationNode ]
004B02FA    mov eax, dword ptr fs:[0x00000000]
004B0300    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004B0301    sub esp, 0x0C
004B0304    push esi
004B0305    push edi
004B0306    mov eax, dword ptr ds:[0x008C4040]
004B030B    xor eax, ebp
004B030D    push eax                                        ; => [ Data: __security_cookie ]
004B030E    lea eax, ss:[ebp-0x0C]
004B0311    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004B0336    call 0x0063DFA0                                 ; => [ Call: sub_63dfa0 | Data: data_801800 ]
...
004B0360    call 0x0063D850                                 ; => [ Call: sub_63d850 | Call: sub_63e810 ]
...
004B0377    push eax
004B0378    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
004B037D    add esp, 0x0C
004B0380    mov dword ptr ss:[ebp-0x04], 0x04
004B0387    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
004B03C5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B03D8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B03DD    mov eax, esi
004B03DF    mov ecx, dword ptr ss:[ebp-0x0C]
004B03E2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B03E9    pop ecx
004B03EA    pop edi
004B03EB    pop esi
