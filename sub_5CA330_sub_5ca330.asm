...
005CA33C    mov eax, dword ptr ds:[0x008C4040]
...
005CA365    push 0x85E480
005CA36A    push 0xF9
005CA36F    push 0x85E454
005CA374    mov ecx, 0x85E48C
005CA379    jmp 0x005CA4EB
005CA37E    mov edx, ecx
005CA380    lea ecx, ss:[esp+0x28]
005CA384    call 0x005939A0
...
005CA3B9    mov esi, 0x1779FB0
005CA3BE    mov ecx, 0x11B8
005CA3C3    mov dword ptr ss:[esp+0x14], esi
...
005CA3FA    xor eax, eax
005CA3FC    mov dword ptr ds:[edi*4+0x1839FB0], 0x00
005CA407    xor edx, edx
005CA409    mov dword ptr ds:[edi*4+0x1839FE0], eax
005CA410    cmp dword ptr ds:[ecx+ebx*1+0x0C], eax
005CA414    jle 0x005CA445
005CA416    mov edi, eax
...
005CA43E    mov dword ptr ds:[edi*4+0x1839FE0], eax
...
005CA4B5    call 0x0075927A
005CA4BA    mov esp, ebp
005CA4BC    pop ebp
005CA4BD    ret
005CA4BE    push 0x805B2C
005CA4C3    push 0x3B
005CA4C5    mov ecx, 0x805B6C
005CA4CA    jmp 0x005CA4E6
005CA4CC    push 0x805B2C
005CA4D1    push 0x3A
005CA4D3    mov ecx, 0x805B40
005CA4D8    jmp 0x005CA4E6
005CA4DA    push 0x805B2C
005CA4DF    push 0x39
005CA4E1    mov ecx, 0x805B34
005CA4E6    push 0x805AF8
005CA4EB    mov edx, 0x801800
005CA4F0    call 0x0063B870
005CA4F5    add esp, 0x0C
005CA4F8    call 0x0063BC30
005CA4FD    test al, al
005CA4FF    jz 0x005CA502
005CA501    int3
005CA502    call 0x0063BB00
