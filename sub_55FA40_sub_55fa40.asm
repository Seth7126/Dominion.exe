...
0055FA56    call 0x00761E50
0055FA5B    mov eax, dword ptr ds:[0x008C4040]
0055FA60    xor eax, ebp
...
0055FA6C    mov dword ptr fs:[0x00000000], eax
0055FA72    call 0x0056B800
...
0055FB22    push esi
0055FB23    call dword ptr ds:[eax]
...
0055FB74    mov dword ptr ss:[ebp-0x1960], 0x81F0F8
0055FB7E    mov dword ptr ss:[ebp-0x195C], eax
0055FB84    lea eax, ss:[ebp-0x1960]
0055FB8A    mov dword ptr ss:[ebp-0x193C], eax
...
0055FBC8    push esi
0055FBC9    call dword ptr ds:[eax]
...
0055FC04    push eax
0055FC05    call dword ptr ds:[edx+0x10]
