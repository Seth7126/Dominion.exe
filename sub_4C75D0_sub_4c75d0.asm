...
004C75F9    mov dword ptr fs:[0x00000000], eax
...
004C7723    call 0x0064C080
004C7728    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C7751    jnz 0x004C777C
004C7753    mov ebx, dword ptr ds:[0x019E5768]
...
004C777A    jz 0x004C77AE
004C777C    mov edx, 0x804244
004C7781    mov ecx, edi
004C7783    call 0x0067BD70
004C7788    mov ebx, eax
004C778A    mov dword ptr ds:[0x019E5768], ebx
004C7790    test ebx, ebx
004C7792    jz 0x004C77AE
004C7794    mov dword ptr ds:[0x019E574C], 0x804244
004C779E    mov dword ptr ds:[0x019E5748], edi
004C77A4    mov dword ptr ds:[0x019E5750], 0xFFFFFFFF
...
004C77C9    jnz 0x004C77F4
004C77CB    mov esi, dword ptr ds:[0x019E578C]
...
004C77F2    jz 0x004C7826
004C77F4    mov edx, 0x804254
004C77F9    mov ecx, edi
004C77FB    call 0x0067BD70
004C7800    mov esi, eax
004C7802    mov dword ptr ds:[0x019E578C], esi
004C7808    test esi, esi
004C780A    jz 0x004C7826
004C780C    mov dword ptr ds:[0x019E5770], 0x804254
004C7816    mov dword ptr ds:[0x019E576C], edi
004C781C    mov dword ptr ds:[0x019E5774], 0xFFFFFFFF
...
004C7A42    call 0x0064C080
004C7A47    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C7B5D    call 0x0064C080
004C7B62    mov dword ptr ss:[ebp-0x14], 0x801800
...
004C7C1F    call 0x0063B870
004C7C24    add esp, 0x0C
004C7C27    call 0x0063BC30
004C7C2C    test al, al
004C7C2E    jz 0x004C7C31
004C7C30    int3
004C7C31    call 0x0063BB00
