...
004DA172    mov dword ptr fs:[0x00000000], eax
004DA178    mov esi, ecx
004DA17A    lea ecx, ss:[ebp-0x28]
004DA17D    call 0x004D8E50
...
004DA1A5    mov esi, dword ptr ds:[0x01597DAC]
...
004DA278    call 0x0064C080
004DA27D    xor bl, bl
004DA27F    jmp 0x004DA31F
004DA284    mov esi, dword ptr ss:[ebp-0x14]
004DA287    push 0x00
...
004DA351    call 0x0064C080
004DA356    mov al, bl
004DA358    mov ecx, dword ptr ss:[ebp-0x0C]
004DA35B    mov dword ptr fs:[0x00000000], ecx
004DA362    pop ecx
004DA363    pop edi
004DA364    pop esi
004DA365    pop ebx
...
004DA380    call 0x0063B870
004DA385    add esp, 0x0C
004DA388    call 0x0063BC30
004DA38D    test al, al
004DA38F    jz 0x004DA392
004DA391    int3
004DA392    call 0x0063BB00
