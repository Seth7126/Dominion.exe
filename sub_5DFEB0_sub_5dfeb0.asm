...
005DFEB5    push 0x769DCE                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$set_variable_in_other_environment@_W@@YA_NQB_W0@Z ]
005DFEBA    mov eax, dword ptr fs:[0x00000000]
005DFEC0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005DFECE    push eax                                        ; => [ Data: __security_cookie ]
005DFECF    lea eax, ss:[ebp-0x0C]
005DFED2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005DFED8    mov edi, edx
005DFEDA    mov esi, ecx
005DFEDC    mov dword ptr ss:[ebp-0x18], esi
005DFEDF    mov dword ptr ss:[ebp-0x14], 0x00
005DFEE6    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
005DFEEC    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
005DFEF3    mov dword ptr ds:[esi+0x0C], 0x801800           ; => [ Data: data_801800 ]
005DFEFA    push 0x00
005DFEFC    push ecx
...
005DFF22    call 0x0063D850                                 ; => [ Call: nullptr | Call: sub_4e3fa0 | Call: sub_63d850 ]
005DFF27    mov dword ptr ss:[ebp-0x04], 0x02
005DFF2E    cmp dword ptr ds:[0x00CF65BC], 0x00
005DFF35    jz 0x005DFF5E                                   ; => [ Data: data_cf65bc ]
...
005DFF46    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005DFF59    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005DFF7E    call 0x0063D850                                 ; => [ Call: sub_5df320 | Call: sub_63d850 ]
005DFF83    mov dword ptr ss:[ebp-0x04], 0x04
005DFF8A    cmp dword ptr ds:[0x00CF65BC], 0x00
005DFF91    jz 0x005DFFBA                                   ; => [ Data: data_cf65bc ]
...
005DFFA2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005DFFB5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005DFFBA    lea edx, ds:[esi+0x0C]
005DFFBD    mov byte ptr ss:[ebp-0x04], 0x00
005DFFC1    mov ecx, edi
005DFFC3    call 0x005DF190                                 ; => [ Call: sub_5df190 ]
005DFFC8    mov eax, esi
005DFFCA    mov ecx, dword ptr ss:[ebp-0x0C]
005DFFCD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005DFFD4    pop ecx
005DFFD5    pop edi
005DFFD6    pop esi
005DFFD7    pop ebx
