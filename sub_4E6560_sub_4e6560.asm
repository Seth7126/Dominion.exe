...
004E6565    push 0x764650                                   ; => [ Call: sub_764650 | Type: EHRegistrationNode ]
004E656A    mov eax, dword ptr fs:[0x00000000]
004E6570    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E6571    mov eax, 0x199C
004E6576    call 0x00761E50                                 ; => [ Call: __chkstk ]
004E657B    mov eax, dword ptr ds:[0x008C4040]
004E6580    xor eax, ebp                                    ; => [ Data: __security_cookie ]
004E6582    mov dword ptr ss:[ebp-0x10], eax
004E6585    push esi
004E6586    push eax
004E6587    lea eax, ss:[ebp-0x0C]
004E658A    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004E6590    mov esi, ecx
004E6592    push 0x1990
004E6597    lea eax, ss:[ebp-0x19A0]
004E659D    push 0x00
004E659F    push eax
004E65A0    call 0x00761FC4                                 ; => [ Call: memset ]
...
004E65BB    mov dword ptr ss:[ebp-0x19A4], 0x801800         ; => [ Data: data_801800 ]
004E65C5    push eax
004E65C6    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
004E65CB    mov dword ptr ss:[ebp-0x04], 0x00
004E65D2    lea ecx, ss:[ebp-0x19A0]
004E65D8    mov esi, dword ptr ss:[ebp-0x19A4]
004E65DE    mov edx, 0x801800                               ; => [ Data: data_801800 ]
004E65E3    test esi, esi
004E65E5    push 0x18
004E65E7    cmovnz edx, esi
004E65EA    call 0x004DDD90                                 ; => [ Call: sub_4ddd90 ]
...
004E6609    jz 0x004E6629                                   ; => [ Data: data_cf65bc ]
004E660B    lea ecx, ss:[ebp-0x19A4]
004E6611    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E6624    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E6629    mov eax, dword ptr ss:[ebp-0xFD8]
004E662F    mov ecx, dword ptr ss:[ebp-0x0C]
004E6632    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E6639    pop ecx
004E663A    pop esi
004E663B    mov ecx, dword ptr ss:[ebp-0x10]
004E663E    xor ecx, ebp
004E6640    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004E6662    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
004E6667    add esp, 0x0C
004E666A    call 0x0063BC30
004E666F    test al, al
004E6671    jz 0x004E6674                                   ; => [ Call: sub_63bc30 ]
004E6673    int3
004E6674    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
