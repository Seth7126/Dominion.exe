...
0073CA06    mov eax, dword ptr ds:[0x0147AC28]              ; => [ Data: data_147ac28 | Type: BOOL ]
0073CA0B    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
0073CA0E    push esi
0073CA0F    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
0073CA12    movss dword ptr ss:[ebp-0x04], xmm0
0073CA17    test byte ptr ds:[eax+0x1C], 0x02
0073CA1B    jz 0x0073CA9A                                   ; => [ Type: BOOL ]
0073CA1D    mov eax, dword ptr ds:[0x00CF65B4]              ; => [ Data: data_cf65b4 ]
0073CA22    cmp byte ptr ds:[eax+0x18], 0x00
0073CA26    jz 0x0073CA9A
0073CA28    cmp byte ptr ds:[0x0147DEF0], 0x00
0073CA2F    jnz 0x0073CA4B                                  ; => [ Data: data_147def0 ]
0073CA31    push 0x147DEF4
0073CA36    call dword ptr ds:[0x00775394]                  ; => [ Data: data_147def4 ]
0073CA3C    test eax, eax
0073CA3E    jz 0x0073CAB2
0073CA40    mov byte ptr ds:[0x0147DEF0], 0x01              ; => [ Data: data_147def0 ]
0073CA47    push 0x00
0073CA49    jmp 0x0073CAAC
0073CA4B    lea eax, ss:[ebp-0x14]
0073CA4E    push eax
0073CA4F    call dword ptr ds:[0x00775394]                  ; => [ Type: POINT ]
0073CA55    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
0073CA58    test eax, eax
0073CA5A    jz 0x0073CAB5
0073CA5C    mov ecx, dword ptr ss:[ebp-0x14]                ; => [ Field: x ]
0073CA5F    mov edx, ecx
0073CA61    sub edx, dword ptr ds:[0x0147DEF4]              ; => [ Data: data_147def4 ]
0073CA67    mov eax, dword ptr ss:[ebp-0x10]                ; => [ Field: y ]
0073CA6A    mov esi, eax
0073CA6C    sub esi, dword ptr ds:[0x0147DEF8]              ; => [ Data: data_147def8 ]
0073CA72    mov dword ptr ds:[0x0147DEF4], ecx              ; => [ Data: data_147def4 ]
0073CA78    movd xmm0, edx
0073CA7C    cvtdq2ps xmm0, xmm0
0073CA7F    mov dword ptr ds:[0x0147DEF8], eax              ; => [ Data: data_147def8 ]
...
0073CAA1    jnz 0x0073CABA                                  ; => [ Data: data_147def0 ]
0073CAA3    mov byte ptr ds:[0x0147DEF0], 0x00              ; => [ Data: data_147def0 ]
0073CAAA    push 0x01
0073CAAC    call dword ptr ds:[0x007753A0]
0073CAB2    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx | String: 0 | String: zx ]
0073CAB5    movss xmm0, dword ptr ss:[ebp-0x04]
0073CABA    addss xmm0, dword ptr ds:[0x0147DF0C]
0073CAC2    mov ecx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
0073CAC8    mov edx, dword ptr ds:[0x0147DF4C]              ; => [ Data: data_147df4c ]
0073CACE    movss dword ptr ds:[0x0147DF0C], xmm0           ; => [ Data: data_147df0c ]
0073CAD6    movaps xmm0, xmm1
0073CAD9    addss xmm0, dword ptr ds:[0x0147DF10]
0073CAE1    movss dword ptr ds:[0x0147DF10], xmm0           ; => [ Data: data_147df10 ]
...
0073CB2D    mov eax, dword ptr ds:[0x0147DF54]              ; => [ Data: data_147df54 ]
...
0073CC06    addss xmm0, xmm3                                ; => [ Data: data_147df60 ]
0073CC0A    movss dword ptr ds:[esi+0x40], xmm1             ; => [ Data: data_147df5c ]
...
0073CC36    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
0073CC3B    add esp, 0x0C
0073CC3E    call 0x0063BC30
0073CC43    test al, al
0073CC45    jz 0x0073CC48                                   ; => [ Call: sub_63bc30 ]
0073CC47    int3
0073CC48    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
