...
004B95E0    push ecx
004B95E1    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004B95E6    push esi
004B95E7    push edi
004B95E8    test eax, eax
004B95EA    jnz 0x004B95FF
004B95EC    push 0x77EB90                                   ; => [ String: GetClient ]
004B95F1    push 0x7B
004B95F3    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004B95F8    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
...
004B960C    pop ecx
004B960D    ret
004B960E    call 0x004B93F0                                 ; => [ Call: sub_4b93f0 ]
004B9613    xor ecx, ecx                                    ; => [ Call: nullptr ]
...
004B9642    pop ecx
004B9643    ret
004B9644    push 0x802424                                   ; => [ String: ActiveNumPlayers ]
004B9649    push 0x12D9
004B964E    push 0x801AF8                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
004B9653    mov ecx, 0x802438                               ; => [ String: total == gameSafeNumPlayers ]
004B9658    mov edx, 0x801800
004B965D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004B9662    add esp, 0x0C
004B9665    call 0x0063BC30
004B966A    test al, al
004B966C    jz 0x004B966F                                   ; => [ Call: sub_63bc30 ]
004B966E    int3
004B966F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
