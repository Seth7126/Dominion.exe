...
006AD178    push 0x76FB21                                   ; => [ Call: sub_76fb21 | Type: EHRegistrationNode ]
006AD17D    mov eax, dword ptr fs:[0x00000000]
006AD183    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006AD184    push ebx
...
006AD191    push eax                                        ; => [ Data: __security_cookie ]
006AD192    lea eax, ss:[ebp-0x0C]
006AD195    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006AD1AE    jle 0x006AD1F5                                  ; => [ Field: ThreadLocalStoragePointer | Data: data_1a9a2a0 ]
006AD1B0    push 0x1A9A2A0                                  ; => [ Data: data_1a9a2a0 ]
006AD1B5    call 0x0075970E                                 ; => [ Call: sub_75970e ]
006AD1BA    add esp, 0x04
006AD1BD    cmp dword ptr ds:[0x01A9A2A0], 0xFFFFFFFF
006AD1C4    jnz 0x006AD1F5                                  ; => [ Data: data_1a9a2a0 ]
006AD1C6    mov edx, 0x12
006AD1CB    mov dword ptr ss:[ebp-0x04], 0x00
006AD1D2    mov ecx, 0x87B758
006AD1D7    call 0x0069F030                                 ; => [ String: sys/DebugFont.font | Call: sub_69f030 ]
006AD1DC    push 0x1A9A2A0                                  ; => [ Data: data_1a9a2a0 ]
006AD1E1    mov dword ptr ds:[0x01A9A2A4], eax              ; => [ Data: data_1a9a2a4 ]
006AD1E6    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006AD1ED    call 0x007596BD                                 ; => [ Call: __Init_thread_footer ]
006AD1F2    add esp, 0x04
006AD1F5    call 0x00646520                                 ; => [ Call: sub_646520 ]
006AD1FA    test al, al
006AD1FC    movzx edi, al
006AD1FF    mov ecx, 0x7D0
006AD204    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006AD20B    mov edx, 0x3E8
006AD210    cmovz ecx, edx
006AD213    inc edi
006AD214    mov dword ptr ss:[ebp-0x04], 0x01
006AD21B    mov esi, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006AD247    push 0x87B76C                                   ; => [ String: draw calls: %d, vb: %d, vao: %d, verts: %dK, tris: %dK\r ]
006AD24C    push eax
006AD24D    call 0x0063DF30
006AD252    add esp, 0x1C
006AD255    mov byte ptr ss:[ebp-0x04], 0x02
006AD259    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006AD25E    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: draw calls: %d, vb: %d, vao: %d, verts: %dK, tris: %dK\r ]
006AD260    test eax, eax
006AD262    cmovnz ecx, eax
006AD265    push ecx
006AD266    lea ecx, ss:[ebp-0x14]
006AD269    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006AD26E    mov byte ptr ss:[ebp-0x04], 0x03
006AD272    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD279    jz 0x006AD2A2                                   ; => [ Data: data_cf65bc ]
...
006AD28A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD29D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006AD2C7    push 0x87B7D4                                   ; => [ String: sprite: draws %d, draws calls %d, texture swaps %d\r ]
006AD2CC    push eax
006AD2CD    call 0x0063DF30
006AD2D2    add esp, 0x14
006AD2D5    mov byte ptr ss:[ebp-0x04], 0x04
006AD2D9    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006AD2DE    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: sprite: draws %d, draws calls %d, texture swaps %d\r ]
006AD2E0    test eax, eax
006AD2E2    cmovnz ecx, eax
006AD2E5    push ecx
006AD2E6    lea ecx, ss:[ebp-0x14]
006AD2E9    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006AD2EE    mov byte ptr ss:[ebp-0x04], 0x05
006AD2F2    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD2F9    jz 0x006AD322                                   ; => [ Data: data_cf65bc ]
...
006AD30A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD31D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006AD337    push 0x87B7B0                                   ; => [ String: draw3d: meshes %d (draws calls %d)\r ]
006AD33C    push eax
006AD33D    call 0x0063DF30
006AD342    add esp, 0x10
006AD345    mov byte ptr ss:[ebp-0x04], 0x06
006AD349    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006AD34E    mov eax, dword ptr ds:[eax]                     ; => [ String: draw3d: meshes %d (draws calls %d)\r | Call: sub_63df30 ]
006AD350    test eax, eax
006AD352    cmovnz ecx, eax
006AD355    push ecx
006AD356    lea ecx, ss:[ebp-0x14]
006AD359    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006AD35E    mov byte ptr ss:[ebp-0x04], 0x07
006AD362    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD369    jz 0x006AD392                                   ; => [ Data: data_cf65bc ]
...
006AD37A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD38D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006AD3AD    push 0x87B82C                                   ; => [ String: draw3d: quads %d (draws calls %d)\r ]
006AD3B2    push eax
006AD3B3    call 0x0063DF30
006AD3B8    add esp, 0x10
006AD3BB    mov byte ptr ss:[ebp-0x04], 0x08
006AD3BF    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006AD3C4    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: draw3d: quads %d (draws calls %d)\r ]
006AD3C6    mov ecx, esi                                    ; => [ Data: data_801800 ]
006AD3C8    test eax, eax
006AD3CA    cmovnz ecx, eax
006AD3CD    push ecx
006AD3CE    lea ecx, ss:[ebp-0x14]
006AD3D1    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006AD3D6    mov byte ptr ss:[ebp-0x04], 0x09
006AD3DA    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD3E1    jz 0x006AD40D                                   ; => [ Data: data_cf65bc ]
...
006AD3F2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD405    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AD40A    mov dword ptr ss:[ebp-0x18], esi                ; => [ Data: data_801800 ]
006AD40D    mov byte ptr ss:[ebp-0x04], 0x01
006AD411    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
006AD416    cmp byte ptr ds:[eax+0x28], 0x00
006AD41A    jz 0x006AD4CC
006AD420    mov ecx, dword ptr ds:[0x0147B070]              ; => [ Data: data_147b070 ]
006AD426    push 0x00                                       ; => [ Call: nullptr ]
...
006AD445    call eax                                        ; => [ Data: data_147b070 ]
...
006AD4A9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD4BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AD4C1    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
006AD4DC    movups xmmword ptr ss:[ebp-0x30], xmm0          ; => [ Data: data_893700 ]
...
006AD505    push dword ptr ds:[0x01A9A2A4]                  ; => [ Data: data_1a9a2a4 ]
006AD50B    call 0x006B74D0                                 ; => [ Call: sub_6b74d0 ]
006AD510    add esp, 0x1C
006AD513    mov dword ptr ss:[ebp-0x04], 0x0C
006AD51A    cmp dword ptr ds:[0x00CF65BC], 0x00
006AD521    jz 0x006AD54A                                   ; => [ Data: data_cf65bc ]
...
006AD532    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AD545    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AD54A    mov ecx, dword ptr ss:[ebp-0x0C]
006AD54D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AD554    pop ecx
006AD555    pop edi
006AD556    pop esi
