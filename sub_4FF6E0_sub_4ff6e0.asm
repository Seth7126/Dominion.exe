...
004FF821    mov dword ptr ss:[ebp-0x20], eax
...
004FF838    push eax
004FF839    call dword ptr ds:[edx+0x10]
004FF83C    xorps xmm0, xmm0
004FF83F    mov dword ptr ss:[ebp-0xCE4], 0x00
004FF849    movlpd qword ptr ss:[ebp-0xCEC], xmm0
