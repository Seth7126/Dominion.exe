...
0057C1E3    push esi
0057C1E4    call 0x005915B0                                 ; => [ Call: sub_5915b0 ]
0057C1E9    add esp, 0x04
0057C1EC    mov dword ptr ss:[ebp-0x0C], eax
0057C1EF    mov ecx, ebx
0057C1F1    push edi
0057C1F2    call 0x005915B0                                 ; => [ Call: sub_5915b0 ]
...
0057C216    call 0x00576940                                 ; => [ Call: sub_576940 ]
0057C21B    mov eax, dword ptr ds:[eax+0x84]
0057C221    jmp 0x0057C22E
0057C223    call 0x005769E0                                 ; => [ Call: sub_5769e0 ]
...
0057C23D    call 0x00576940                                 ; => [ Call: sub_576940 ]
0057C242    mov ecx, dword ptr ds:[eax+0x84]
0057C248    jmp 0x0057C255
0057C24A    call 0x005769E0                                 ; => [ Call: sub_5769e0 ]
...
0057C26D    call 0x00576940                                 ; => [ Call: sub_576940 ]
0057C272    mov esi, dword ptr ds:[eax+0x84]
0057C278    jmp 0x0057C285
0057C27A    call 0x005769E0                                 ; => [ Call: sub_5769e0 ]
