...
0050A349    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0050A377    call 0x0056F1A0                                 ; => [ Call: sub_56a3f0 | Call: sub_56f1a0 ]
0050A37C    mov ecx, dword ptr ss:[ebp-0x04]
0050A37F    add esp, 0x0C
0050A382    xor ecx, ebp
0050A384    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
