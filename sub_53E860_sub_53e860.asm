...
0053EA4E    mov dword ptr ss:[ebp-0x30], 0x00
...
0053EA66    mov dword ptr ss:[ebp-0x4C], eax
0053EA69    lea eax, ss:[ebp-0x40]
0053EA6C    rep movsd
0053EA6E    movups xmmword ptr ss:[ebp-0x2648], xmm0
0053EA75    mov dword ptr ss:[ebp-0x70], 0x81ADD8
...
0053EA95    mov dword ptr ss:[ebp-0x40], 0x81ADBC
