...
0072FBA8    push 0x77279D                                   ; => [ Call: sub_77279d | Type: EHRegistrationNode ]
0072FBAD    mov eax, dword ptr fs:[0x00000000]
0072FBB3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0072FBB4    push ebx
...
0072FBC5    push esi
0072FBC6    push edi
0072FBC7    push eax                                        ; => [ Data: __security_cookie ]
0072FBC8    lea eax, ss:[ebp-0x0C]
0072FBCB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0072FBE5    call 0x004ACB60                                 ; => [ Call: sub_4acb60 ]
0072FBEA    mov eax, dword ptr ds:[0x007FEFAC]
0072FBEF    xor esi, esi
0072FBF1    movss dword ptr ss:[ebp-0x64], xmm0
0072FBF6    movss xmm0, dword ptr ds:[0x00CF660C]           ; => [ Data: data_cf660c ]
0072FBFE    movss dword ptr ss:[ebp-0x5C], xmm0
0072FC03    movss xmm0, dword ptr ds:[0x00CF6610]           ; => [ Data: data_cf660c ]
...
0072FC44    call 0x0072FA50                                 ; => [ Call: sub_72fa50 ]
...
0072FC93    call 0x006FDE90                                 ; => [ Call: sub_6fde90 ]
0072FC98    push 0x00
0072FC9A    push 0x03
0072FC9C    push dword ptr ds:[ebx+0x0C]
0072FC9F    mov edx, edi
0072FCA1    mov ecx, edi
0072FCA3    call 0x006A1230                                 ; => [ Call: sub_6a1230 ]
0072FCA8    mov edx, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
0072FCF4    call 0x006AD5D0                                 ; => [ Call: sub_6ad5d0 ]
0072FCF9    add esp, 0x04
0072FCFC    cmp byte ptr ds:[0x00CF69DC], 0x00
0072FD03    jz 0x0072FD16                                   ; => [ Data: data_cf69dc ]
0072FD05    mov ecx, 0xCF65FC
0072FD0A    mov byte ptr ds:[0x00CF69DC], 0x00              ; => [ Data: data_cf69dc ]
0072FD11    call 0x00645A20                                 ; => [ Data: data_cf65fc | Call: sub_645a20 ]
0072FD16    mov ecx, dword ptr ds:[0x0147B070]              ; => [ Data: data_147b070 ]
0072FD1C    push 0x00
...
0072FD54    call 0x006DC2D0                                 ; => [ Call: sub_6dc2d0 ]
...
0072FD72    jnz 0x0073020F                                  ; => [ Data: data_147aba1 ]
0072FD78    movups xmmword ptr ds:[0x00CF689C], xmm1        ; => [ Data: data_cf689c ]
...
0072FD95    movups xmmword ptr ds:[0x00CF688C], xmm0        ; => [ Data: data_cf688c ]
0072FD9C    push eax
0072FD9D    movaps xmm0, xmm1
0072FDA0    mulss xmm1, dword ptr ds:[0x00890EB8]
0072FDA8    divss xmm0, dword ptr ss:[ebp-0x60]
0072FDAD    movups xmmword ptr ds:[0x00CF68AC], xmm2        ; => [ Data: data_cf68ac ]
0072FDB4    addss xmm0, xmm0
0072FDB8    movss dword ptr ss:[ebp-0x228], xmm1
0072FDC0    movups xmmword ptr ds:[0x00CF68BC], xmm3        ; => [ Data: data_cf68bc ]
...
0072FDE0    movups xmmword ptr ss:[ebp-0x250], xmm0         ; => [ Data: data_7ffb14 | Call: sub_5af7f0 ]
...
0072FE64    movups xmmword ptr ds:[0x00CF6744], xmm0        ; => [ Data: data_cf688c | Data: data_cf6744 ]
0072FE6B    movups xmm0, xmmword ptr ds:[0x00CF689C]
0072FE72    movups xmmword ptr ds:[0x00CF6754], xmm0        ; => [ Data: data_cf6754 | Data: data_cf689c ]
0072FE79    movups xmm0, xmmword ptr ds:[0x00CF68AC]
0072FE80    movups xmmword ptr ds:[0x00CF6764], xmm0        ; => [ Data: data_cf68ac | Data: data_cf6764 ]
0072FE87    movups xmm0, xmmword ptr ds:[0x00CF68BC]
0072FE8E    movups xmmword ptr ds:[0x00CF6774], xmm0        ; => [ Data: data_cf6774 | Data: data_cf68bc ]
0072FE95    call 0x00642AE0                                 ; => [ Data: data_cf6684 | Data: data_cf6744 | Call: sub_642ae0 ]
0072FE9A    add esp, 0x04
0072FE9D    mov edx, ecx
0072FE9F    mov ecx, 0xCF67C4                               ; => [ Data: data_cf67c4 ]
0072FEA4    movups xmm0, xmmword ptr ds:[eax]
0072FEA7    movups xmmword ptr ds:[0x00CF66C4], xmm0        ; => [ Data: data_cf66c4 ]
0072FEAE    movups xmm0, xmmword ptr ds:[eax+0x10]
0072FEB2    movups xmmword ptr ds:[0x00CF66D4], xmm0        ; => [ Data: data_cf66d4 ]
0072FEB9    movups xmm0, xmmword ptr ds:[eax+0x20]
0072FEBD    movups xmmword ptr ds:[0x00CF66E4], xmm0        ; => [ Data: data_cf66e4 ]
0072FEC4    movups xmm0, xmmword ptr ds:[eax+0x30]
0072FEC8    lea eax, ss:[ebp-0x2A0]
0072FECE    push eax
0072FECF    movups xmmword ptr ds:[0x00CF66F4], xmm0        ; => [ Data: data_cf66f4 ]
0072FED6    call 0x00642AE0                                 ; => [ Data: data_cf6744 | Call: sub_642ae0 ]
0072FEDB    add esp, 0x04
0072FEDE    mov edx, 0xCF66C4
0072FEE3    movups xmm0, xmmword ptr ds:[eax]
0072FEE6    movups xmmword ptr ds:[0x00CF6784], xmm0        ; => [ Data: data_cf6784 ]
0072FEED    movups xmm0, xmmword ptr ds:[eax+0x10]
0072FEF1    movups xmmword ptr ds:[0x00CF6794], xmm0        ; => [ Data: data_cf6794 ]
0072FEF8    movups xmm0, xmmword ptr ds:[eax+0x20]
0072FEFC    movups xmmword ptr ds:[0x00CF67A4], xmm0        ; => [ Data: data_cf67a4 ]
0072FF03    movups xmm0, xmmword ptr ds:[eax+0x30]
0072FF07    lea eax, ss:[ebp-0x2A0]
0072FF0D    push eax
0072FF0E    movups xmmword ptr ds:[0x00CF67B4], xmm0        ; => [ Data: data_cf67b4 ]
0072FF15    call 0x00642AE0                                 ; => [ Data: data_cf66c4 | Call: sub_642ae0 ]
0072FF1A    add esp, 0x04
0072FF1D    movups xmm0, xmmword ptr ds:[eax]
0072FF20    movups xmmword ptr ds:[0x00CF6704], xmm0        ; => [ Data: data_cf6704 ]
0072FF27    movups xmm0, xmmword ptr ds:[eax+0x10]
0072FF2B    movups xmmword ptr ds:[0x00CF6714], xmm0        ; => [ Data: data_cf6714 ]
0072FF32    movups xmm0, xmmword ptr ds:[eax+0x20]
0072FF36    movups xmmword ptr ds:[0x00CF6724], xmm0        ; => [ Data: data_cf6724 ]
0072FF3D    movups xmm0, xmmword ptr ds:[eax+0x30]
0072FF41    mov eax, dword ptr fs:[0x0000002C]              ; => [ Field: ThreadLocalStoragePointer ]
0072FF47    movups xmmword ptr ds:[0x00CF6734], xmm0        ; => [ Data: data_cf6734 ]
0072FF4E    mov esi, dword ptr ds:[eax]
0072FF50    mov eax, dword ptr ds:[0x01A9A3B0]
0072FF55    cmp eax, dword ptr ds:[esi+0x08]
0072FF5B    jle 0x0072FFA2                                  ; => [ Data: data_1a9a3b0 ]
0072FF5D    push 0x1A9A3B0                                  ; => [ Data: data_1a9a3b0 ]
0072FF62    call 0x0075970E                                 ; => [ Call: sub_75970e ]
0072FF67    add esp, 0x04
0072FF6A    cmp dword ptr ds:[0x01A9A3B0], 0xFFFFFFFF
0072FF71    jnz 0x0072FFA2                                  ; => [ Data: data_1a9a3b0 ]
0072FF73    mov edx, 0x02
0072FF78    mov dword ptr ss:[ebp-0x04], 0x00
0072FF7F    mov ecx, 0x85DBE8
0072FF84    call 0x0069F030                                 ; => [ String: sys/editor/video_sphere.structure | Call: sub_69f030 ]
0072FF89    push 0x1A9A3B0                                  ; => [ Data: data_1a9a3b0 ]
0072FF8E    mov dword ptr ds:[0x01A9A3B4], eax              ; => [ Data: data_1a9a3b4 ]
0072FF93    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0072FF9A    call 0x007596BD                                 ; => [ Call: __Init_thread_footer ]
0072FF9F    add esp, 0x04
0072FFA2    mov eax, dword ptr ds:[0x01A9A3B8]              ; => [ Data: data_1a9a3b8 ]
0072FFA7    cmp eax, dword ptr ds:[esi+0x08]
0072FFAD    jle 0x0072FFF4
0072FFAF    push 0x1A9A3B8                                  ; => [ Data: data_1a9a3b8 ]
0072FFB4    call 0x0075970E                                 ; => [ Call: sub_75970e ]
0072FFB9    add esp, 0x04
0072FFBC    cmp dword ptr ds:[0x01A9A3B8], 0xFFFFFFFF
0072FFC3    jnz 0x0072FFF4                                  ; => [ Data: data_1a9a3b8 ]
0072FFC5    mov edx, 0x05
0072FFCA    mov dword ptr ss:[ebp-0x04], 0x01
0072FFD1    mov ecx, 0x85E090
0072FFD6    call 0x0069F030                                 ; => [ String: sys/skybox_equi.material | Call: sub_69f030 ]
0072FFDB    push 0x1A9A3B8                                  ; => [ Data: data_1a9a3b8 ]
0072FFE0    mov dword ptr ds:[0x01A9A3BC], eax              ; => [ Data: data_1a9a3bc ]
0072FFE5    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0072FFEC    call 0x007596BD                                 ; => [ Call: __Init_thread_footer ]
0072FFF1    add esp, 0x04
0072FFF4    mov ecx, dword ptr ds:[0x01A9A3B4]              ; => [ Data: data_1a9a3b4 ]
0072FFFA    cmp dword ptr ds:[ecx+0x04], 0x02
0072FFFE    jnz 0x007301F9
00730004    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0073001F    jnz 0x007301D5                                  ; => [ Data: data_147aba1 ]
00730025    mov ecx, dword ptr ds:[0x0147D2E0]              ; => [ Data: data_147d2e0 ]
...
0073003F    push 0x881BFC                                   ; => [ String: DrawModeSet ]
00730044    push 0x1F
00730046    push 0x881BDC                                   ; => [ String: C:\x\ax2017\Engine\DrawMode.cpp ]
0073004B    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00730050    jmp 0x00730223
00730055    mov eax, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
0073005A    cmp byte ptr ds:[eax+0x1D], 0x00
0073005E    jz 0x007301BF
00730064    mov byte ptr ds:[eax+0x1D], 0x00
00730068    call 0x00681C50                                 ; => [ Call: sub_681c50 ]
0073006D    cmp byte ptr ds:[0x0147ABA1], 0x00
00730074    jnz 0x007301B3                                  ; => [ Data: data_147aba1 ]
0073007A    mov eax, dword ptr ss:[ebp-0x214]
00730080    mov dword ptr ds:[0x0147D2E0], 0x02             ; => [ Data: data_147d2e0 ]
0073008A    mov ecx, dword ptr ds:[0x0147ABB4]              ; => [ Data: data_147abb4 ]
00730090    xor esi, esi
00730092    mov dword ptr ds:[0x0147ABB4], 0x02             ; => [ Data: data_147abb4 ]
...
007300FD    movups xmmword ptr ss:[ebp-0x208], xmm0         ; => [ Call: __builtin_memcpy | String:  ]
...
00730135    movups xmmword ptr ss:[ebp-0x180], xmm0         ; => [ Data: data_7fefb0 ]
0073013C    test esi, esi
0073013E    jnz 0x0073014B
00730140    lea ecx, ss:[ebp-0x210]
00730146    call 0x00642EF0                                 ; => [ Call: sub_642ef0 ]
0073014B    lea ecx, ss:[ebp-0x210]
00730151    call 0x006437E0                                 ; => [ Call: sub_6437e0 ]
...
0073016D    mov dword ptr ds:[0x0147ABB4], ecx              ; => [ Data: data_147abb4 ]
00730173    xor ecx, ecx
00730175    call 0x006E1520                                 ; => [ Call: sub_6e1520 ]
0073017A    call 0x006ADB80                                 ; => [ Call: sub_6adb80 ]
...
00730198    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0073019F    pop ecx
007301A0    pop edi
007301A1    pop esi
007301A2    mov ecx, dword ptr ss:[ebp-0x14]
007301A5    xor ecx, ebp
007301A7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007301AC    mov esp, ebp
007301AE    pop ebp
007301AF    mov esp, ebx
007301B1    pop ebx
007301B2    ret
007301B3    push 0x872D6C                                   ; => [ String: Draw3DBegin ]
007301B8    push 0xB29
007301BD    jmp 0x00730219
007301BF    push 0x876E68                                   ; => [ String: SpriteDrawEnd ]
007301C4    push 0x2FB
007301C9    push 0x876CB0                                   ; => [ String: C:\x\ax2017\Engine\Sprite.cpp ]
007301CE    mov ecx, 0x876EB8                               ; => [ String: gpSpriteAppData->spritesDrawing ]
007301D3    jmp 0x00730223
007301D5    push 0x881BFC                                   ; => [ String: DrawModeSet ]
007301DA    push 0x0D
007301DC    push 0x881BDC                                   ; => [ String: C:\x\ax2017\Engine\DrawMode.cpp ]
007301E1    jmp 0x0073021E
007301E3    push 0x88E3DC                                   ; => [ String: DrawCubemap ]
007301E8    push 0x121
007301ED    push 0x88E364                                   ; => [ String: C:\x\ax2017\Engine\IBLImport.cpp ]
007301F2    mov ecx, 0x88E3FC                               ; => [ String: pDefStructure->pStructureImportData ]
007301F7    jmp 0x00730223
007301F9    push 0x87A528                                   ; => [ String: StructureDefGet ]
007301FE    push 0x313
00730203    push 0x87A2E0                                   ; => [ String: C:\x\ax2017\Engine\AssetUtils.cpp ]
00730208    mov ecx, 0x87A4FC                               ; => [ String: assetPtr->assetType == ASSET_TYPE_STRUCTURE ]
0073020D    jmp 0x00730223
0073020F    push 0x87294C                                   ; => [ String: Draw3DSetView ]
00730214    push 0x369
00730219    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp | String: C:\x\ax2017\Engine\Draw3d.cpp ]
0073021E    mov ecx, 0x872928                               ; => [ String: !gDraw3DData.submittingRenderItems ]
00730223    mov edx, 0x801800
00730228    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0073022D    add esp, 0x0C
00730230    call 0x0063BC30
00730235    test al, al
00730237    jz 0x0073023A                                   ; => [ Call: sub_63bc30 ]
00730239    int3
0073023A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
