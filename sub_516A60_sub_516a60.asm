...
00516A9E    mov esi, dword ptr ds:[eax+0x10]
00516AA1    mov ecx, esi
00516AA3    call 0x00516F30
...
00516B08    call 0x0063B870
00516B0D    add esp, 0x0C
00516B10    call 0x0063BC30
00516B15    test al, al
00516B17    jz 0x00516B1A
00516B19    int3
00516B1A    call 0x0063BB00
