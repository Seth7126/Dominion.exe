...
005BE923    movups xmmword ptr ds:[ecx], xmm0               ; => [ Call: __builtin_memset ]
...
005BE952    push ecx
005BE953    call 0x00759772                                 ; => [ Call: operator new ]
...
005BE97B    xor ebx, ebx                                    ; => [ Call: nullptr ]
...
005BE99E    mov ebx, eax                                    ; => [ Call: operator new ]
...
005BE9B7    call 0x00761FBE                                 ; => [ Call: memcpy ]
005BE9BC    push esi
005BE9BD    push dword ptr ss:[ebp+0x08]
005BE9C0    lea eax, ds:[ebx+edi*1]
005BE9C3    push eax
005BE9C4    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
005BE9DB    pop ebp
005BE9DC    ret
005BE9DD    call 0x005B0860                                 ; => [ Call: sub_5b0860 ]
005BE9E2    call 0x004F7EE0                                 ; => [ Call: sub_4f7ee0 ]
