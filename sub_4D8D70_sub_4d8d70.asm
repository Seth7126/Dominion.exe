...
004D8D75    push 0x763AD6                                   ; => [ Call: __ehhandler$?Initialize@GlobalCore@details@Concurrency@@QAEXPAUGlobalNode@23@IE@Z | Type: EHRegistrationNode ]
004D8D7A    mov eax, dword ptr fs:[0x00000000]
004D8D80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D8D81    sub esp, 0x10
004D8D84    push esi
004D8D85    push edi
004D8D86    mov eax, dword ptr ds:[0x008C4040]
004D8D8B    xor eax, ebp
004D8D8D    push eax                                        ; => [ Data: __security_cookie ]
004D8D8E    lea eax, ss:[ebp-0x0C]
004D8D91    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D8DB1    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004D8DB6    push esi
004D8DB7    push dword ptr ds:[eax+0x42B0]
004D8DBD    lea eax, ss:[ebp-0x10]
004D8DC0    push 0x8069AC
004D8DC5    push eax
004D8DC6    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: gamelocal_%d_%d.xml ]
...
004D8DE5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
004D8DEA    inc dword ptr ds:[eax+0x04]
004D8DED    xor edx, edx
004D8DEF    mov ecx, edi
004D8DF1    call 0x0069E000                                 ; => [ Call: sub_69e000 ]
...
004D8E0E    jz 0x004D8E37                                   ; => [ Data: data_cf65bc ]
...
004D8E1F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D8E32    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D8E37    mov eax, edi
004D8E39    mov ecx, dword ptr ss:[ebp-0x0C]
004D8E3C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D8E43    pop ecx
004D8E44    pop edi
004D8E45    pop esi
