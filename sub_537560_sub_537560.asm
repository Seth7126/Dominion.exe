...
0053756C    mov eax, dword ptr ds:[0x008C4040]
00537571    xor eax, esp
00537573    mov dword ptr ss:[esp+0xC98], eax
0053757A    push ebx
0053757B    push esi
0053757C    push edi
0053757D    call 0x00573400
00537582    push 0x00
00537584    push 0x00
00537586    push 0x01
...
0053758E    push 0x01
00537590    call 0x00590760
00537595    add esp, 0x10
00537598    call 0x00573400
...
005375C2    call 0x00561E00
005375C7    call 0x00564390
005375CC    mov ebx, eax
005375CE    call 0x00573400
005375D3    push 0x00
005375D5    mov edx, dword ptr ds:[eax+0x0C]
005375D8    mov ecx, dword ptr ds:[eax+0x04]
005375DB    call 0x005887C0
...
00537718    call 0x0063B870
0053771D    add esp, 0x0C
00537720    call 0x0063BC30
00537725    test al, al
00537727    jz 0x0053772A
00537729    int3
0053772A    call 0x0063BB00
