...
007523C0    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
007523C5    push ebx
...
007523D5    push 0x0C
007523D7    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Array.c ]
007523D9    add esp, 0x0C
007523DC    jmp 0x007523E9
007523DE    push 0x0C
007523E0    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007523F6    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00752412    push ebx
00752413    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Array.c ]
00752415    add esp, 0x0C
00752418    jmp 0x00752424
0075241A    push ebx
0075241B    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0075242B    push 0x00
0075242D    push edi
0075242E    call 0x00761FC4                                 ; => [ Call: memset ]
