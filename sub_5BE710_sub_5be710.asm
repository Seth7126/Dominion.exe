...
005BE733    movaps xmm2, xmmword ptr ds:[0x008937A0]        ; => [ Data: data_8937a0 ]
005BE73A    movaps xmm3, xmmword ptr ds:[0x00893780]        ; => [ Data: data_893780 ]
005BE741    movaps xmm0, xmm2
005BE744    maxps xmm5, xmm7                                ; => [ Data: data_893280 ]
005BE747    movaps xmm4, xmmword ptr ds:[0x008937D0]        ; => [ Data: data_8937d0 ]
005BE74E    andps xmm0, xmm5
005BE751    mulps xmm3, xmm5
005BE754    cmpps xmm0, xmmword ptr ds:[0x00893280], 0x01   ; => [ Data: data_893280 ]
...
005BE773    orps xmm4, xmmword ptr ds:[0x008934E0]          ; => [ Data: data_8934e0 ]
005BE77A    psrld xmm2, 0x17
005BE77F    movaps xmm3, xmmword ptr ds:[0x00893430]        ; => [ Data: data_893430 ]
...
005BE79F    orps xmm2, xmm0                                 ; => [ Data: data_8936b0 | String: 0 | String: zx ]
...
005BE7B2    movaps xmm5, xmmword ptr ds:[0x00893790]        ; => [ Data: data_893790 ]
005BE7B9    orps xmm1, xmm0
005BE7BC    movaps xmm0, xmm1
005BE7BF    cmpps xmm0, xmmword ptr ds:[0x00893520], 0x01   ; => [ Data: data_893520 ]
...
005BE7D8    subps xmm1, xmmword ptr ds:[0x008935B0]         ; => [ Data: data_8935b0 ]
005BE7DF    cmpps xmm0, xmm7, 0x00                          ; => [ String: 0 | String: zx ]
005BE7E3    addps xmm4, xmm1
005BE7E6    movaps xmm6, xmm5
005BE7E9    movaps xmmword ptr ss:[ebp-0x60], xmm0
005BE7ED    movaps xmm7, xmm0
005BE7F0    movaps xmm0, xmmword ptr ds:[0x00893820]        ; => [ Data: data_893820 ]
005BE7F7    mulps xmm3, xmm4
005BE7FA    movaps xmm2, xmm4
005BE7FD    mulps xmm0, xmm4
005BE800    mulps xmm2, xmm4
005BE803    addps xmm3, xmmword ptr ds:[0x00893810]         ; => [ Data: data_893810 ]
005BE80A    addps xmm0, xmmword ptr ds:[0x00893450]         ; => [ Data: data_893450 ]
005BE811    movaps xmm1, xmm2
005BE814    mulps xmm1, xmm4
005BE817    mulps xmm3, xmm4
005BE81A    mulps xmm0, xmm4
005BE81D    addps xmm3, xmmword ptr ds:[0x00893440]         ; => [ Data: data_893440 ]
005BE824    addps xmm0, xmmword ptr ds:[0x00893830]         ; => [ Data: data_893830 ]
005BE82B    mulps xmm3, xmm1
005BE82E    addps xmm3, xmm0
005BE831    movaps xmm0, xmmword ptr ds:[0x00893470]
005BE838    mulps xmm0, xmm4                                ; => [ Data: data_893470 ]
...
005BE84F    addps xmm3, xmm0                                ; => [ Data: data_893490 | Data: data_893840 ]
005BE852    movaps xmm0, xmmword ptr ds:[0x00893850]
005BE859    mulps xmm0, xmm2                                ; => [ Data: data_893850 ]
