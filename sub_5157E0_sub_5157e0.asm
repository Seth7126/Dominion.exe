...
0051582C    mov dword ptr ds:[ebx+0x54C], eax
...
00515861    mov dword ptr ds:[eax], 0x816F58
00515867    mov dword ptr ds:[eax+0x24], eax
0051586A    call 0x0050AD20
...
005158F8    call 0x00516EC0
005158FD    mov ecx, dword ptr ds:[0x00CCB414]
...
005159A8    inc esi
005159A9    mov ecx, dword ptr ds:[0x00CCB414]
...
005159E8    test al, al
005159EA    jz 0x005159F8
005159EC    mov edx, edi
005159EE    mov ecx, 0xCCA794
005159F3    call 0x0058FFD0
...
00515A2B    mov ecx, dword ptr ds:[0x00CCA780]
...
00515A58    mov dword ptr ds:[eax], 0x816F3C
00515A5E    mov dword ptr ds:[eax+0x24], eax
00515A61    call 0x0050AD20
