...
0052579B    call 0x00761E50
005257A0    mov eax, dword ptr ds:[0x008C4040]
...
005257C0    push 0x04
005257C2    push eax
005257C3    call 0x005678E0
005257C8    add esp, 0x14
005257CB    mov dword ptr ss:[esp+0x1C], 0x00
