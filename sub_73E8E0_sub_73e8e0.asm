...
0073E901    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0073E903    mov dword ptr ss:[ebp-0x04], eax
0073E906    cmp dword ptr ds:[0x0147EF94], 0x00
0073E90D    push esi
0073E90E    push edi
0073E90F    jz 0x0073EAE3                                   ; => [ Data: data_147ef94 ]
0073E915    mov ecx, dword ptr ds:[0x0147DF90]              ; => [ Data: data_147df90 ]
0073E91B    cmp dword ptr ds:[ecx+0x04], 0x20
0073E91F    jnz 0x0073EAF6
0073E925    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0073E93F    call 0x0073E4B0                                 ; => [ Call: sub_73e4b0 | Data: data_147df94 ]
...
0073E95E    movq qword ptr ds:[0x01512404], xmm1            ; => [ Data: data_1512404 ]
0073E966    psrldq xmm1, 0x08
0073E96B    push eax
0073E96C    movups xmmword ptr ss:[ebp-0x30], xmm0
0073E970    movd dword ptr ds:[0x0151240C], xmm1            ; => [ Data: data_151240c ]
0073E978    call 0x004EB2F0
0073E97D    add esp, 0x04
0073E980    movups xmm3, xmmword ptr ds:[eax]               ; => [ Call: sub_4eb2f0 ]
...
0073E9D0    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
0073E9D5    movaps xmm1, xmmword ptr ss:[ebp-0x60]
0073E9D9    mov edx, 0x01
0073E9DE    divss xmm1, xmm0
0073E9E2    mov esi, dword ptr ds:[0x0147EF94]              ; => [ Data: data_147ef94 ]
0073E9E8    mov dword ptr ds:[0x015123F0], 0x3F800000       ; => [ Data: data_15123f0 ]
0073E9F2    movss xmm4, dword ptr ds:[0x00890E18]
0073E9FA    movss dword ptr ds:[0x015123F4], xmm1           ; => [ Data: data_15123f4 ]
0073EA02    movss xmm2, dword ptr ds:[0x01512408]           ; => [ Data: data_1512404 ]
0073EA0A    movss xmm3, dword ptr ds:[0x01512404]           ; => [ Data: data_1512404 ]
0073EA12    movups xmm1, xmmword ptr ss:[ebp-0x70]
0073EA16    divss xmm1, xmm0
0073EA1A    movss dword ptr ds:[0x015123F8], xmm1           ; => [ Data: data_15123f8 ]
0073EA22    movups xmm1, xmmword ptr ss:[ebp-0x80]
0073EA26    divss xmm1, xmm0
0073EA2A    movss dword ptr ds:[0x015123FC], xmm1           ; => [ Data: data_15123fc ]
0073EA32    movups xmm1, xmmword ptr ss:[ebp-0x50]
0073EA36    divss xmm1, xmm0
0073EA3A    movss dword ptr ds:[0x01512400], xmm1           ; => [ Data: data_1512400 ]
0073EA42    movss xmm1, dword ptr ds:[0x0151240C]           ; => [ Data: data_151240c ]
0073EA4A    cmp esi, edx
0073EA4C    jle 0x0073EA8C
0073EA4E    nop
0073EA50    imul ecx, dword ptr ds:[edx*4+0x147DF94], 0xE0  ; => [ Data: data_147df94 ]
0073EA5B    inc edx
0073EA5C    mov eax, dword ptr ds:[edi]
0073EA5E    addss xmm3, dword ptr ds:[ecx+eax*1+0x10]
0073EA64    movss dword ptr ds:[0x01512404], xmm3           ; => [ Data: data_1512404 ]
0073EA6C    addss xmm2, dword ptr ds:[ecx+eax*1+0x14]
0073EA72    movss dword ptr ds:[0x01512408], xmm2           ; => [ Data: data_1512404 ]
0073EA7A    addss xmm1, dword ptr ds:[ecx+eax*1+0x18]
0073EA80    movss dword ptr ds:[0x0151240C], xmm1           ; => [ Data: data_151240c ]
0073EA88    cmp edx, esi
0073EA8A    jl 0x0073EA50
0073EA8C    mov eax, dword ptr ds:[0x01512424]              ; => [ Data: data_1512424 ]
...
0073EAA7    movups xmmword ptr ds:[0x015123F4], xmm0        ; => [ Data: data_800248 | Data: data_15123f4 ]
...
0073EAC0    movss dword ptr ds:[0x01512404], xmm0           ; => [ Data: data_1512404 ]
0073EAC8    movaps xmm0, xmm4
0073EACB    mulss xmm0, xmm2
0073EACF    mulss xmm4, xmm1
0073EAD3    movss dword ptr ds:[0x01512408], xmm0           ; => [ Data: data_1512404 ]
0073EADB    movss dword ptr ds:[0x0151240C], xmm4           ; => [ Data: data_151240c ]
0073EAE3    mov ecx, dword ptr ss:[ebp-0x04]
0073EAE6    pop edi
0073EAE7    xor ecx, ebp
0073EAE9    pop esi
0073EAEA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0073EB0F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\FabDef.cpp | String: FabDefGet | String: ptr->assetType == ASSET_TYPE_FAB | Data: data_801800 ]
0073EB14    add esp, 0x0C
0073EB17    call 0x0063BC30
0073EB1C    test al, al
0073EB1E    jz 0x0073EB21                                   ; => [ Call: sub_63bc30 ]
0073EB20    int3
0073EB21    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
