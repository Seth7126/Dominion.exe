...
005201AB    call 0x00761E50
005201B0    mov eax, dword ptr ds:[0x008C4040]
005201B5    xor eax, esp
005201B7    mov dword ptr ss:[esp+0x1918], eax
005201BE    push ebx
005201BF    push esi
005201C0    push edi
005201C1    call 0x00573400
005201C6    push 0x00
005201C8    push 0x00
005201CA    push 0x01
...
005201D2    push 0x01
005201D4    call 0x00590760
005201D9    add esp, 0x10
005201DC    call 0x00573400
...
00520294    call 0x00573400
00520299    mov esi, eax
0052029B    call 0x0056B800
...
0052032B    call 0x0063B870
00520330    add esp, 0x0C
00520333    call 0x0063BC30
00520338    test al, al
0052033A    jz 0x0052033D
0052033C    int3
0052033D    call 0x0063BB00
