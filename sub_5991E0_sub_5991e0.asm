...
005991FE    push eax
005991FF    lea eax, ss:[ebp-0x0C]
00599202    mov dword ptr fs:[0x00000000], eax
...
00599217    mov dword ptr ds:[edi], 0x801800
0059921D    mov dword ptr ss:[ebp-0x04], 0x00
00599224    mov ebx, dword ptr ss:[ebp+0x10]
00599227    mov ecx, dword ptr ds:[0x01597E48]
0059922D    mov edx, dword ptr ds:[0x01597E44]
00599233    mov dword ptr ss:[ebp-0x1C], 0x01
0059923A    cmp ebx, 0x01
0059923D    jnz 0x005992B7
...
005992D1    jnl 0x0059961F
005992D7    mov eax, dword ptr ds:[0x01597E44]
...
005992F1    call 0x00598AE0
005992F6    add esp, 0x14
005992F9    mov dword ptr ss:[ebp-0x04], 0x03
00599300    inc esi
00599301    mov ecx, dword ptr ds:[0x01597E48]
00599307    cmp esi, ecx
00599309    jnl 0x0059961F
0059930F    mov eax, dword ptr ds:[0x01597E44]
...
005993C2    call 0x0064C080
005993C7    mov dword ptr ss:[ebp+0x10], 0x801800
005993CE    mov dword ptr ss:[ebp-0x04], 0x08
005993D5    cmp dword ptr ds:[0x00CF65BC], 0x00
005993DC    jz 0x00599405
...
005994F6    call 0x0064C080
005994FB    mov dword ptr ss:[ebp-0x14], 0x801800
...
00599557    call 0x0064C080
0059955C    mov dword ptr ss:[ebp-0x18], 0x801800
00599563    mov dword ptr ss:[ebp-0x04], 0x0E
0059956A    cmp dword ptr ds:[0x00CF65BC], 0x00
00599571    jz 0x005995A1
...
00599595    call 0x0064C080
0059959A    mov dword ptr ss:[ebp+0x10], 0x801800
005995A1    inc esi
005995A2    mov byte ptr ss:[ebp-0x04], 0x00
005995A6    cmp esi, ebx
005995A8    jnl 0x00599409
005995AE    mov ecx, dword ptr ds:[0x01597E48]
005995B4    mov edx, dword ptr ds:[0x01597E44]
