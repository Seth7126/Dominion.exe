...
00599785    push 0x7679BD                                   ; => [ Call: __ehhandler$?common_exit@@YAXHW4_crt_exit_cleanup_mode@@W4_crt_exit_return_mode@@@Z | Type: EHRegistrationNode ]
0059978A    mov eax, dword ptr fs:[0x00000000]
00599790    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00599791    sub esp, 0x10
00599794    push esi
00599795    push edi
00599796    mov eax, dword ptr ds:[0x008C4040]
0059979B    xor eax, ebp
0059979D    push eax                                        ; => [ Data: __security_cookie ]
0059979E    lea eax, ss:[ebp-0x0C]
005997A1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005997A7    mov edi, ecx
005997A9    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
005997D8    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: dom_log_project_cube | Call: sub_63d850 ]
005997DD    mov byte ptr ss:[ebp-0x04], 0x02
005997E1    jmp 0x0059980E
005997E3    mov ecx, edx
005997E5    call 0x00571910
005997EA    push dword ptr ds:[eax]                         ; => [ Call: sub_571910 ]
...
00599805    call 0x0063D850                                 ; => [ String: dom_log_%s_token | Call: sub_63df30 | Call: sub_63d850 ]
0059980A    mov byte ptr ss:[ebp-0x04], 0x04
0059980E    cmp dword ptr ds:[0x00CF65BC], 0x00
00599815    jz 0x0059983E                                   ; => [ Data: data_cf65bc ]
...
00599826    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00599839    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059983E    mov byte ptr ss:[ebp-0x04], 0x00
00599842    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
00599856    mov edi, eax                                    ; => [ Call: sub_68c730 ]
...
0059986F    jle 0x005998BF                                  ; => [ Field: ThreadLocalStoragePointer | Data: data_1a8a060 ]
00599871    push 0x1A8A060
00599876    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a8a060 ]
0059987B    add esp, 0x04
0059987E    cmp dword ptr ds:[0x01A8A060], 0xFFFFFFFF
00599885    jnz 0x005998BF                                  ; => [ Data: data_1a8a060 ]
00599887    push 0x773B40
0059988C    mov dword ptr ds:[0x01A8A064], 0x801800         ; => [ Data: data_1a8a064 | Data: data_801800 ]
00599896    mov dword ptr ds:[0x01A8A068], 0x801800         ; => [ Data: data_801800 | Data: data_1a8a068 ]
005998A0    mov dword ptr ds:[0x01A8A06C], 0x801800         ; => [ Data: data_1a8a06c | Data: data_801800 ]
005998AA    call 0x0075964C                                 ; => [ Call: _atexit | Call: sub_773b40 ]
005998AF    add esp, 0x04
005998B2    push 0x1A8A060
005998B7    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a8a060 ]
005998BC    add esp, 0x04
005998BF    lea eax, ss:[ebp-0x10]
005998C2    mov ecx, 0x1A8A064
005998C7    push eax
005998C8    call 0x0063D850                                 ; => [ Data: data_1a8a064 | Call: sub_63d850 ]
005998CD    mov edi, 0x1A8A064                              ; => [ Data: data_1a8a064 ]
...
005998E9    jz 0x00599906                                   ; => [ Data: data_cf65bc ]
005998EB    lea ecx, ss:[ebp-0x10]
005998EE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00599901    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00599906    mov eax, edi
00599908    mov ecx, dword ptr ss:[ebp-0x0C]
0059990B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00599912    pop ecx
00599913    pop edi
00599914    pop esi
