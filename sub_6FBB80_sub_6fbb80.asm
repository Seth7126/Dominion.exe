...
006FBB98    push 0x77232D                                   ; => [ Type: EHRegistrationNode | Call: sub_77232d ]
006FBB9D    mov eax, dword ptr fs:[0x00000000]
006FBBA3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006FBBA4    push ebx
...
006FBBB2    push esi
006FBBB3    push edi
006FBBB4    push eax                                        ; => [ Data: __security_cookie ]
006FBBB5    lea eax, ss:[ebp-0x0C]
006FBBB8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006FBBBE    mov dword ptr ss:[ebp-0x50], edx
006FBBC1    mov esi, ecx
006FBBC3    mov dword ptr ss:[ebp-0x4C], esi
006FBBC6    mov dword ptr ss:[ebp-0x44], 0x00               ; => [ Call: nullptr ]
006FBBCD    mov dword ptr ss:[ebp-0x40], 0x00               ; => [ Call: nullptr ]
006FBBD4    mov dword ptr ss:[ebp-0x3C], 0x00
006FBBDB    mov dword ptr ss:[ebp-0x04], 0x00
006FBBE2    mov eax, dword ptr ds:[0x0147DEC8]
006FBBE7    mov edi, dword ptr ds:[eax+0x0C]                ; => [ Data: data_147dec8 ]
...
006FBBFB    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
006FBC0C    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
006FBC51    call 0x006FBA80                                 ; => [ Call: sub_6fba80 ]
006FBC56    xorps xmm0, xmm0
006FBC59    lea eax, ss:[ebp-0x44]
006FBC5C    movups xmmword ptr ss:[ebp-0x34], xmm0          ; => [ String: 0 | String: zx ]
...
006FBC6C    movups xmmword ptr ss:[ebp-0x24], xmm0          ; => [ String: 0 | String: zx ]
006FBC70    call 0x006DB2F0
006FBC75    test al, al
006FBC77    jnz 0x006FBD3B                                  ; => [ Call: sub_6db2f0 ]
...
006FBCBF    xorps xmm7, xmmword ptr ds:[0x008937C0]         ; => [ Data: data_8937c0 | Data: data_147dec8 ]
006FBCC6    movaps xmm1, xmm5
006FBCC9    andps xmm1, xmmword ptr ds:[0x008937A0]         ; => [ Data: data_8937a0 ]
...
006FBD0E    divss xmm1, xmm5                                ; => [ Data: data_8937c0 ]
