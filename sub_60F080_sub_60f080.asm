...
0060F091    mov edi, 0x77FCA8                               ; => [ Data: data_77fca8 ]
...
0060F0A6    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
0060F0C1    test al, al
0060F0C3    jnz 0x0060F0E1                                  ; => [ Call: sub_4db700 ]
0060F0C5    inc esi
...
0060F0D6    jl 0x0060F096                                   ; => [ Data: data_77fea0 ]
0060F0D8    pop edi
0060F0D9    pop esi
