...
004D67D5    push 0x763980                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_legendref@8 ]
004D67DA    mov eax, dword ptr fs:[0x00000000]
004D67E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D67E1    push esi
004D67E2    push edi
004D67E3    mov eax, dword ptr ds:[0x008C4040]
004D67E8    xor eax, ebp
004D67EA    push eax                                        ; => [ Data: __security_cookie ]
004D67EB    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004D67EE    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
