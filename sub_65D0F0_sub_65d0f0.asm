...
0065D10D    push 0x874E6C                                   ; => [ String: UI2Update ]
0065D112    push 0x26E4
0065D117    mov ecx, 0x874E8C                               ; => [ String: !ui.isTemplate ]
0065D11C    jmp 0x0065D6BB
0065D121    mov eax, dword ptr ds:[0x0147ABE0]
0065D126    inc eax                                         ; => [ Data: data_147abe0 ]
0065D127    mov dword ptr ds:[esi+0x1718], edx
0065D12D    mov dword ptr ds:[esi], eax
0065D12F    mov dword ptr ds:[0x0147ABE0], eax              ; => [ Data: data_147abe0 ]
...
0065D22C    push eax
0065D22D    push ecx
0065D22E    call 0x00762362                                 ; => [ Call: memmove ]
...
0065D260    call 0x0064CC90                                 ; => [ Call: sub_64cc90 ]
...
0065D286    push 0x8769F4                                   ; => [ String: UIStateEffectsUpdate ]
0065D28B    push 0x5CE9
0065D290    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0065D295    jmp 0x0065D6BB
0065D29A    push 0x876AA0                                   ; => [ String: XArray<struct UI2StateEffect>::RemoveAt ]
0065D29F    push 0xDC
0065D2A4    push 0x816BDC                                   ; => [ String: C:\x\ax2017\Engine\xArray.h ]
0065D2A9    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
0065D2AE    jmp 0x0065D6C0
0065D2B3    push 0x876AC8                                   ; => [ String: XArray<struct UI2StateEffect>::operator [] ]
0065D2B8    push 0xB5
0065D2BD    push 0x816BDC                                   ; => [ String: C:\x\ax2017\Engine\xArray.h ]
0065D2C2    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
0065D2C7    jmp 0x0065D6C0
0065D2CC    test edi, edi
0065D2CE    jz 0x0065D30B
0065D2D0    mov edx, 0x70
0065D2D5    mov ecx, 0x8CAE70
0065D2DA    call 0x006DD320                                 ; => [ Call: sub_6dd320 | Data: data_8cae70 ]
0065D2DF    cmp dword ptr ds:[eax+0x10], 0x08
0065D2E3    jz 0x0065D2F9
0065D2E5    push 0x874584                                   ; => [ String: AttribAsString ]
0065D2EA    push 0xC6B
0065D2EF    mov ecx, 0x8745F0                               ; => [ String: AttribTagGetDefMap((AttribTable *)table, tag)->defType == DT_STRING ]
...
0065D306    call 0x00666610                                 ; => [ Call: sub_666610 ]
0065D30B    mov eax, dword ptr ds:[esi+0x16F4]
0065D311    xorps xmm0, xmm0
0065D314    movaps xmmword ptr ss:[esp+0x40], xmm0          ; => [ String: 0 | String: zx ]
...
0065D37D    push eax
0065D37E    call 0x00680320                                 ; => [ Call: sub_680320 ]
...
0065D3AE    mov dword ptr ds:[edi], eax                     ; => [ Call: sub_64c020 ]
...
0065D3E5    call 0x00657930                                 ; => [ Call: sub_657930 ]
...
0065D431    push eax
0065D432    call 0x00680320                                 ; => [ Call: sub_680320 ]
...
0065D449    mov edi, eax                                    ; => [ Call: sub_65bdd0 ]
...
0065D477    call 0x00653A70                                 ; => [ Call: sub_653a70 ]
...
0065D4A6    jnz 0x0065D4BA                                  ; => [ Data: data_c21418 ]
...
0065D4C2    xor ecx, ecx                                    ; => [ Call: nullptr ]
...
0065D4E2    xor edi, dword ptr ds:[eax*4+0x7FFD70]          ; => [ Data: data_7ffd70 ]
...
0065D50E    xor edi, dword ptr ds:[eax*4+0x7FFD70]          ; => [ Data: data_7ffd70 ]
...
0065D546    push eax
0065D547    call 0x0065B750                                 ; => [ Call: sub_65b750 ]
...
0065D566    call 0x0065C8B0                                 ; => [ Call: sub_65c8b0 ]
0065D56B    mov ecx, esi
0065D56D    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
...
0065D590    call 0x0065CD00                                 ; => [ Call: sub_65cd00 ]
...
0065D5A6    call 0x0065C230                                 ; => [ Call: sub_65c230 ]
...
0065D658    call 0x006BCA30                                 ; => [ Call: sub_6bca30 ]
...
0065D67F    call 0x0065AAB0                                 ; => [ Call: sub_65aab0 ]
...
0065D6A1    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
0065D6A6    pop edi
0065D6A7    pop esi
0065D6A8    mov esp, ebp
0065D6AA    pop ebp
0065D6AB    ret
0065D6AC    push 0x874E6C                                   ; => [ String: UI2Update ]
0065D6B1    push 0x2706
0065D6B6    mov ecx, 0x874E78                               ; => [ String: stateName != NULL ]
0065D6BB    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
0065D6C0    mov edx, 0x801800
0065D6C5    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0065D6CA    add esp, 0x0C
0065D6CD    call 0x0063BC30
0065D6D2    test al, al
0065D6D4    jz 0x0065D6D7                                   ; => [ Call: sub_63bc30 ]
0065D6D6    int3
0065D6D7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
