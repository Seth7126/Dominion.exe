...
006FC05F    push 0x00
006FC061    push ecx
006FC062    mov ecx, dword ptr ds:[0x01597CC0]
...
006FC1C0    mov eax, dword ptr ds:[0x0147DF8C]
...
006FC253    call 0x0063C270
006FC258    mov esi, dword ptr ds:[0x0147DEC8]
...
006FC2A7    call 0x0064C080
006FC2AC    mov eax, dword ptr ds:[0x0147DEC8]
...
006FC399    call 0x006FBA80
006FC39E    xorps xmm0, xmm0
006FC3A1    lea eax, ss:[ebp-0xC4]
006FC3A7    movups xmmword ptr ss:[ebp-0xB8], xmm0
...
006FC3C4    movups xmmword ptr ss:[ebp-0xA8], xmm0
006FC3CB    call 0x006DB2F0
006FC3D0    test al, al
006FC3D2    jnz 0x006FC4BE
...
006FC426    andps xmm1, xmmword ptr ds:[0x008937A0]
...
006FC50B    call 0x006FC730
006FC510    test eax, eax
006FC512    jnz 0x006FC520
006FC514    lea ecx, ss:[ebp-0xD8]
006FC51A    call 0x0063C270
006FC51F    nop
006FC520    mov esi, dword ptr ds:[0x0147DEC8]
...
006FC5DC    call 0x0063C270
006FC5E1    test al, al
006FC5E3    jz 0x006FC520
006FC5E9    mov esi, dword ptr ds:[0x0147DEC8]
...
006FC6D4    push 0x88C0B8
006FC6D9    push 0x1CB
006FC6DE    push 0x88C07C
006FC6E3    jmp 0x006FC6F4
006FC6E5    push 0x88FA14
006FC6EA    push 0x507
006FC6EF    push 0x88F938
006FC6F4    mov ecx, 0x801AA4
006FC6F9    mov edx, 0x801800
006FC6FE    call 0x0063B870
006FC703    add esp, 0x0C
006FC706    call 0x0063BC30
006FC70B    test al, al
006FC70D    jz 0x006FC710
006FC70F    int3
006FC710    call 0x0063BB00
