...
0068D5F4    jmp dword ptr ds:[eax*4+0x68D6E4]               ; => [ Data: jump_table_68d6e4 ]
0068D5FB    mov eax, 0x801800
0068D600    pop ebp
0068D601    ret                                             ; => [ Data: data_801800 | Data: lookup_table_68d708 | Data: data_801800 ]
0068D602    mov eax, 0x877F10
0068D607    pop ebp
0068D608    ret                                             ; => [ Data: lookup_table_68d708 | Data: data_877f10 ]
0068D609    mov eax, 0x877F0C
0068D60E    pop ebp
0068D60F    ret                                             ; => [ Data: lookup_table_68d708 | Data: data_877f0c ]
0068D610    mov eax, dword ptr ds:[edx+0x0C]
0068D613    add eax, 0xFFFFFFFE                             ; => [ Data: lookup_table_68d708 ]
0068D616    cmp eax, 0x03
0068D619    jnbe 0x0068D67B
0068D61B    jmp dword ptr ds:[eax*4+0x68D71C]
0068D622    mov eax, 0x877ECC
0068D627    pop ebp
0068D628    ret                                             ; => [ Data: data_877ecc ]
0068D629    mov eax, 0x877EC8
0068D62E    pop ebp
0068D62F    ret                                             ; => [ Data: data_877ec8 ]
0068D630    mov eax, dword ptr ss:[ebp+0x08]
0068D633    sub eax, 0x01
0068D636    mov eax, dword ptr ds:[edx+0x0C]                ; => [ Data: lookup_table_68d708 ]
...
0068D64F    pop ebp
0068D650    ret                                             ; => [ String: eine | String: eine ]
0068D651    mov eax, 0x877EB8
0068D656    pop ebp
0068D657    ret                                             ; => [ String: einen | String: einen ]
...
0068D6D9    pop ebp
0068D6DA    ret                                             ; => [ Data: data_877ea4 ]
0068D6DB    mov eax, 0x871B58                               ; => [ Data: data_871b58 ]
0068D6E0    pop ebp
0068D6E1    ret                                             ; => [ Data: data_877e60 | Data: data_877e4c ]
