...
0054029B    call 0x00761E50
005402A0    mov eax, dword ptr ds:[0x008C4040]
...
005402BC    mov edi, dword ptr ds:[eax+0x04]
005402BF    cmp esi, 0x320
005402C5    jb 0x005402CC
005402C7    call 0x00591930
