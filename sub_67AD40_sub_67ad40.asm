...
0067AD58    push 0x76DA6E                                   ; => [ Type: EHRegistrationNode | Call: sub_76da6e ]
0067AD5D    mov eax, dword ptr fs:[0x00000000]
0067AD63    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0067AD64    push ebx
0067AD65    sub esp, 0x20
0067AD68    push esi
0067AD69    push edi
0067AD6A    mov eax, dword ptr ds:[0x008C4040]
0067AD6F    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0067AD71    push eax
0067AD72    lea eax, ss:[ebp-0x0C]
0067AD75    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0067ADA8    test al, al
0067ADAA    jnz 0x0067ADCE                                  ; => [ Call: sub_67ad00 ]
...
0067ADE5    test al, al
0067ADE7    jnz 0x0067ADFA                                  ; => [ Call: sub_655340 ]
...
0067AE0F    call 0x0063D720                                 ; => [ String: btn_scroll_up | Call: sub_63d720 ]
0067AE14    mov edx, dword ptr ds:[edi+0x04]
0067AE17    mov edi, 0x801800                               ; => [ Data: data_801800 ]
0067AE1C    mov eax, dword ptr ss:[ebp-0x20]
0067AE1F    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0067AE74    call 0x0067ACA0                                 ; => [ Call: sub_67aca0 ]
0067AE79    mov al, 0x01
0067AE7B    mov ecx, dword ptr ss:[ebp-0x0C]
0067AE7E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0067AE85    pop ecx
0067AE86    pop edi
0067AE87    pop esi
...
0067AEAB    jz 0x0067AEC8                                   ; => [ Data: data_cf65bc ]
0067AEAD    lea ecx, ss:[ebp-0x20]
0067AEB0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067AEC3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067AEDB    xorps xmm0, xmmword ptr ds:[0x008937C0]         ; => [ Data: data_8937c0 | Call: sub_67a950 ]
...
0067AEF5    call 0x0067A8A0                                 ; => [ Call: sub_67a8a0 ]
0067AEFA    mov al, 0x01
0067AEFC    mov ecx, dword ptr ss:[ebp-0x0C]
0067AEFF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0067AF06    pop ecx
0067AF07    pop edi
0067AF08    pop esi
...
0067AF18    call 0x0063D720                                 ; => [ String: btn_scroll_down | Call: sub_63d720 ]
0067AF1D    mov eax, dword ptr ss:[ebp-0x18]
0067AF20    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0067AF7C    jz 0x0067AF99                                   ; => [ Data: data_cf65bc ]
0067AF7E    lea ecx, ss:[ebp-0x20]
0067AF81    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067AF94    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067AFA7    call 0x0067A950                                 ; => [ Call: sub_67a950 ]
0067AFAC    jmp 0x0067AEE2
0067AFB1    mov edx, 0x876924
0067AFB6    lea ecx, ss:[ebp-0x20]
0067AFB9    call 0x0063D720                                 ; => [ String: btn_scroll_channel_top | Call: sub_63d720 ]
0067AFBE    mov eax, dword ptr ss:[ebp-0x18]
0067AFC1    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0067B01C    jz 0x0067B039                                   ; => [ Data: data_cf65bc ]
0067B01E    lea ecx, ss:[ebp-0x20]
0067B021    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067B034    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067B060    movss dword ptr ss:[ebp-0x2C], xmm1             ; => [ Data: data_8937c0 ]
0067B065    jmp 0x0067AEF2
0067B06A    mov edx, 0x876908
0067B06F    lea ecx, ss:[ebp-0x20]
0067B072    call 0x0063D720                                 ; => [ String: btn_scroll_channel_bottom | Call: sub_63d720 ]
0067B077    mov eax, dword ptr ss:[ebp-0x18]
0067B07A    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0067B0D3    jz 0x0067B0F0                                   ; => [ Data: data_cf65bc ]
0067B0D5    lea ecx, ss:[ebp-0x20]
0067B0D8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067B0EB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067B122    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_scroll_nub ]
...
0067B144    mov eax, edi                                    ; => [ Data: data_801800 ]
...
0067B188    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_scroll ]
...
0067B208    jz 0x0067B228                                   ; => [ Data: data_cf65bc ]
0067B20A    lea ecx, ss:[ebp-0x24]
0067B20D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067B220    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067B24B    jz 0x0067B268                                   ; => [ Data: data_cf65bc ]
0067B24D    lea ecx, ss:[ebp-0x2C]
0067B250    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067B263    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067B27A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0067B27F    mov ecx, dword ptr ss:[ebp-0x1C]
0067B282    mov edx, eax
0067B284    push esi
0067B285    call 0x0067AA30                                 ; => [ Call: sub_67aa30 ]
...
0067B2BA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0067B2C1    pop ecx
0067B2C2    pop edi
0067B2C3    pop esi
...
0067B2D6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0067B2DD    pop ecx
0067B2DE    pop edi
0067B2DF    pop esi
...
0067B2F0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
0067B2F7    pop ecx
0067B2F8    pop edi
0067B2F9    pop esi
