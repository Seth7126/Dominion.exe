...
007619E6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
007619FD    call dword ptr ds:[0x00775820]                  ; => [ Call: nullptr ]
00761A03    push 0x40
00761A05    call 0x00759772                                 ; => [ Call: operator new ]
00761A0A    push 0x40
00761A0C    mov edi, eax
00761A0E    push 0x00
00761A10    push edi
00761A11    call 0x00761FC4                                 ; => [ Call: memset ]
00761A16    mov esi, dword ptr ds:[0x00775174]
00761A1C    add esp, 0x10
00761A1F    mov dword ptr ds:[ebx], edi
00761A21    mov dword ptr ds:[ebx+0x0C], 0x7616A0           ; => [ Call: sub_7616a0 ]
00761A28    push 0x00
00761A2A    push 0x00
00761A2C    push 0x00
00761A2E    push 0x00
00761A30    call esi                                        ; => [ Call: nullptr | Type: HANDLE ]
...
00761A41    push 0x00
00761A43    push 0x00
00761A45    call esi                                        ; => [ Call: nullptr | Type: HANDLE ]
00761A47    mov dword ptr ds:[edi+0x14], eax
00761A4A    test eax, eax
00761A4C    jz 0x00761C62                                   ; => [ Data: data_77eac0 | Data: data_77ead0 ]
00761A52    push edi
...
00761AD7    mov dword ptr ss:[ebp-0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
00761B5E    addsd xmm0, qword ptr ds:[eax*8+0x893660]       ; => [ Data: data_893660 ]
...
00761B8A    call 0x00761E80                                 ; => [ Data: data_893660 | Call: __dtol3 ]
...
00761C2B    call 0x0075E950                                 ; => [ Call: sub_75e950 ]
00761C30    push edi
00761C31    push 0x761780
00761C36    call 0x00761D00                                 ; => [ Call: sub_761780 | Call: sub_761d00 ]
00761C3B    add esp, 0x08
00761C3E    mov dword ptr ds:[edi+0x18], eax
00761C41    test eax, eax
00761C43    jz 0x00761C62
00761C45    pop edi
00761C46    mov dword ptr ds:[esi+0x1060], 0x77EAE0         ; => [ String: WASAPI ]
00761C50    xor eax, eax
00761C52    pop esi
00761C53    pop ebx
00761C54    mov ecx, dword ptr ss:[ebp-0x04]
00761C57    xor ecx, ebp
00761C59    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00761C6E    pop ebx
00761C6F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
