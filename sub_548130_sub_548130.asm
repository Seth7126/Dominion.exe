...
0054813B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00548140    push esi
00548141    push edi
00548142    push 0x00
...
00548155    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
...
00548176    call 0x0056A740                                 ; => [ Call: __builtin_memcpy | Call: sub_56a740 ]
...
0054818E    movzx esi, si                                   ; => [ Call: sub_56b800 ]
00548191    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00548194    cmp esi, 0x320
0054819A    jb 0x005481A1
0054819C    call 0x00591930                                 ; => [ Call: sub_591930 ]
005481A1    imul eax, esi, 0x64
005481A4    mov esi, dword ptr ds:[eax+edi*1+0x1A58]
005481AB    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
005481B0    push ecx
005481B1    mov edx, esi
005481B3    mov ecx, eax
005481B5    call 0x005624A0                                 ; => [ Call: sub_5624a0 ]
