...
006DD1F0    call 0x006DD320
006DD1F5    cmp eax, dword ptr ss:[ebp+0x08]
006DD1F8    jz 0x006DD20B
006DD1FA    push 0x881480
006DD1FF    push 0x1DA
006DD204    mov ecx, 0x8814E4
...
006DD245    pop ebp
006DD246    ret
006DD247    push 0x88131C
006DD24C    push 0x8B
006DD251    mov ecx, 0x881344
006DD256    push 0x8812F8
006DD25B    mov edx, 0x801800
006DD260    call 0x0063B870
006DD265    add esp, 0x0C
006DD268    call 0x0063BC30
006DD26D    test al, al
006DD26F    jz 0x006DD272
006DD271    int3
006DD272    call 0x0063BB00
