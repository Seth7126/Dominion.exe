...
00545590    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00545591    mov eax, 0x3284
00545596    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054559B    mov eax, dword ptr ds:[0x008C4040]
005455A0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
00545616    mov dword ptr ss:[ebp-0xCD0], 0x81F114          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00545620    mov dword ptr ss:[ebp-0xCCC], eax
00545626    lea eax, ss:[ebp-0xCD0]
0054562C    mov dword ptr ss:[ebp-0xCAC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable ]
...
005456A6    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable ]
005456A9    push eax
005456AA    call edx                                        ; => [ Field: vFunc_4 ]
005456AC    cmp dword ptr ss:[ebp-0xCA0], 0x00
005456B3    jz 0x00545756
005456B9    lea eax, ss:[ebp-0xCA0]
005456BF    mov dword ptr ss:[ebp-0xCF8], 0x81F0F8          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_fb776da0643d44ac1bad3b8864e8b093>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_fb776da0643d44ac1bad3b8864e8b093>,bool,enum CardID>::VTable ]
005456C9    mov dword ptr ss:[ebp-0xCF4], eax
005456CF    lea eax, ss:[ebp-0xCF8]
005456D5    mov dword ptr ss:[ebp-0xCD4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_fb776da0643d44ac1bad3b8864e8b093>,bool,enum CardID>::VTable ]
...
005457DD    push 0x0B
005457DF    call 0x005695C0                                 ; => [ Call: sub_5695c0 ]
005457E4    inc esi
005457E5    add esp, 0x04
005457E8    cmp esi, ebx
005457EA    jl 0x005457D1
005457EC    mov ecx, dword ptr ss:[ebp-0x0C]
005457EF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005457F6    pop ecx
005457F7    pop edi
005457F8    pop esi
005457F9    pop ebx
...
005457FF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
