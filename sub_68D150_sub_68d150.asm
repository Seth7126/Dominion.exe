...
0068D155    push 0x76E175                                   ; => [ Type: EHRegistrationNode | Call: sub_76e175 ]
0068D15A    mov eax, dword ptr fs:[0x00000000]
0068D160    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068D16E    push eax                                        ; => [ Data: __security_cookie ]
0068D16F    lea eax, ss:[ebp-0x0C]
0068D172    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0068D178    mov ebx, edx
0068D17A    mov edi, ecx
0068D17C    mov eax, dword ptr ds:[edi]
0068D17E    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0068D183    test eax, eax
0068D185    mov ecx, esi                                    ; => [ Data: data_801800 ]
0068D187    cmovnz ecx, eax
0068D18A    call 0x0063E960                                 ; => [ Call: sub_63e960 ]
0068D18F    mov ecx, dword ptr ds:[edi]
0068D191    mov edx, esi                                    ; => [ Data: data_801800 ]
...
0068D1DD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068D20D    dec eax
0068D20E    push eax
0068D20F    call 0x0063E9E0                                 ; => [ Call: sub_63e9e0 ]
...
0068D24B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068D25E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068D263    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0068D26A    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0068D271    mov ecx, esi                                    ; => [ Data: data_801800 ]
0068D273    mov eax, dword ptr ds:[ebx]
0068D275    test eax, eax
0068D277    cmovnz ecx, eax
0068D27A    call 0x0068CD20
0068D27F    test al, al
0068D281    jz 0x0068D2A8                                   ; => [ Call: sub_68cd20 ]
...
0068D291    test al, al
0068D293    setz al                                         ; => [ Call: sub_68cd20 ]
0068D296    mov ecx, dword ptr ss:[ebp-0x0C]
0068D299    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068D2A0    pop ecx
0068D2A1    pop edi
0068D2A2    pop esi
0068D2A3    pop ebx
...
0068D2AD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068D2B4    pop ecx
0068D2B5    pop edi
0068D2B6    pop esi
0068D2B7    pop ebx
