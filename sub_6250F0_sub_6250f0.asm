...
006250F4    byte FF
006250F5    push 0x763290                                   ; => [ Call: __ehhandler$___std_smf_hermite@12 | Type: EHRegistrationNode ]
006250FA    mov eax, dword ptr fs:[0x00000000]
00625100    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00625101    push ecx
00625102    push ebx
00625103    push esi
00625104    push edi
...
0062510C    push eax                                        ; => [ Data: __security_cookie ]
0062510D    lea eax, ss:[ebp-0x0C]
00625110    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00625124    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
00625129    mov eax, dword ptr ss:[ebp-0x10]
0062512C    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
00625182    jz 0x006251A6                                   ; => [ Data: data_cf65bc ]
00625184    lea ecx, ss:[ebp-0x10]
00625187    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062519A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062519F    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006251A6    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006251AD    test bl, bl
006251AF    jz 0x006251BB
006251B1    mov dword ptr ds:[0x008DB660], 0x29             ; => [ Data: data_8db660 ]
006251BB    mov esi, dword ptr ds:[edi+0x04]
006251BE    lea ecx, ss:[ebp-0x10]
006251C1    mov edx, 0x86B41C
006251C6    call 0x0063D720                                 ; => [ String: btn_tabCards | Call: sub_63d720 ]
006251CB    mov eax, dword ptr ss:[ebp-0x10]
006251CE    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
00625214    jz 0x00625238                                   ; => [ Data: data_cf65bc ]
00625216    lea ecx, ss:[ebp-0x10]
00625219    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062522C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00625231    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00625238    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062523F    test esi, esi
00625241    jnz 0x00625253
00625243    mov dword ptr ds:[0x00CF6490], 0x01             ; => [ Data: data_cf6490 ]
0062524D    mov dword ptr ds:[0x00CF6498], esi              ; => [ Data: data_cf6498 ]
00625253    mov esi, dword ptr ds:[edi+0x04]
00625256    lea ecx, ss:[ebp-0x10]
00625259    mov edx, 0x86B410
0062525E    call 0x0063D720                                 ; => [ String: btn_tabVPs | Call: sub_63d720 ]
00625263    mov eax, dword ptr ss:[ebp-0x10]
00625266    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006252AC    jz 0x006252D0                                   ; => [ Data: data_cf65bc ]
006252AE    lea ecx, ss:[ebp-0x10]
006252B1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006252C4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006252C9    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006252D0    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006252D7    test esi, esi
006252D9    jnz 0x006252E7
006252DB    mov dword ptr ds:[0x00CF6490], esi              ; => [ Data: data_cf6490 ]
006252E1    mov dword ptr ds:[0x00CF6498], esi              ; => [ Data: data_cf6498 ]
006252E7    mov esi, dword ptr ds:[edi+0x04]
006252EA    lea ecx, ss:[ebp-0x10]
006252ED    mov edx, 0x8033B8
006252F2    call 0x0063D720                                 ; => [ String: btnRight | Call: sub_63d720 ]
006252F7    mov eax, dword ptr ss:[ebp-0x10]
006252FA    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
00625340    jz 0x00625364                                   ; => [ Data: data_cf65bc ]
00625342    lea ecx, ss:[ebp-0x10]
00625345    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00625358    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062535D    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00625364    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062536B    test esi, esi
0062536D    jnz 0x0062548A
00625373    mov eax, dword ptr ds:[0x00CF6490]              ; => [ Data: data_cf6490 ]
00625378    imul ecx, dword ptr ds:[0x00CF6494], 0x5DD4     ; => [ Data: data_cf6494 ]
00625382    sub eax, esi
00625384    jz 0x006253CC
00625386    sub eax, 0x01
00625389    jz 0x006253A4
0062538B    push 0x86B794                                   ; => [ String: ScorescreenNumPages ]
00625390    push 0xEF8A
00625395    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
0062539A    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
006253F0    mov dword ptr ss:[ebp-0x10], eax                ; => [ Call: sub_4b9480 ]
006253F3    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
006253F8    test eax, eax
006253FA    jz 0x006255C2
00625400    mov esi, dword ptr ds:[0x00CF6494]
00625406    sub esi, dword ptr ds:[eax+0x7590]              ; => [ Data: data_cf6494 ]
0062540C    call 0x004B95E0                                 ; => [ Call: sub_4b95e0 ]
00625411    mov edx, dword ptr ds:[0x00CF6498]              ; => [ Data: data_cf6498 ]
...
0062542E    push 0x86B444                                   ; => [ String: ScorescreenCardsClick ]
00625433    push 0xED2B
00625438    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
0062543D    mov ecx, 0x86B42C                               ; => [ String: seat < numPlayers - 1 ]
00625442    jmp 0x006255D3
00625447    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
0062544D    test esi, esi
0062544F    jz 0x006255C2
00625455    mov esi, dword ptr ds:[esi+0x7590]
0062545B    call 0x004B95E0                                 ; => [ Call: sub_4b95e0 ]
00625460    lea edx, ds:[esi+0x01]
00625463    mov dword ptr ds:[0x00CF6498], 0x00             ; => [ Data: data_cf6498 ]
0062546D    add edx, ebx
0062546F    mov ecx, edx
00625471    sub ecx, eax
00625473    cmp edx, eax
00625475    cmovl ecx, edx
00625478    mov dword ptr ds:[0x00CF6494], ecx              ; => [ Data: data_cf6494 ]
0062547E    jmp 0x00625487
00625480    inc edx
00625481    mov dword ptr ds:[0x00CF6498], edx              ; => [ Data: data_cf6498 ]
...
00625495    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btnLeft ]
0062549A    mov eax, dword ptr ss:[ebp+0x08]
0062549D    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006254E3    jz 0x00625507                                   ; => [ Data: data_cf65bc ]
006254E5    lea ecx, ss:[ebp+0x08]
006254E8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006254FB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00625500    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
00625507    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062550E    test esi, esi
00625510    jnz 0x006255AE
00625516    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
0062551B    test eax, eax
0062551D    jz 0x006255C2
00625523    mov esi, dword ptr ds:[0x00CF6494]
00625529    sub esi, dword ptr ds:[eax+0x7590]              ; => [ Data: data_cf6494 ]
0062552F    call 0x004B95E0                                 ; => [ Call: sub_4b95e0 ]
00625534    mov ecx, dword ptr ds:[0x00CF6498]              ; => [ Data: data_cf6498 ]
...
0062554A    push 0x86B444                                   ; => [ String: ScorescreenCardsClick ]
0062554F    push 0xED3B
00625554    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00625559    mov ecx, 0x86B46C                               ; => [ String: seat > SEAT_LOCAL ]
0062555E    jmp 0x006255D3
00625560    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
00625566    test esi, esi
00625568    jz 0x006255C2
0062556A    mov esi, dword ptr ds:[esi+0x7590]
00625570    call 0x004B95E0                                 ; => [ Call: sub_4b95e0 ]
00625575    lea edx, ds:[esi-0x01]
00625578    mov dword ptr ds:[0x00CF6498], 0x00             ; => [ Data: data_cf6498 ]
...
0062558D    xor al, al
0062558F    mov dword ptr ds:[0x00CF6494], ecx              ; => [ Data: data_cf6494 ]
00625595    mov ecx, dword ptr ss:[ebp-0x0C]
00625598    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0062559F    pop ecx
006255A0    pop edi
006255A1    pop esi
006255A2    pop ebx
...
006255A6    ret
006255A7    dec ecx
006255A8    mov dword ptr ds:[0x00CF6498], ecx              ; => [ Data: data_cf6498 ]
006255AE    xor al, al
006255B0    mov ecx, dword ptr ss:[ebp-0x0C]
006255B3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006255BA    pop ecx
006255BB    pop edi
006255BC    pop esi
006255BD    pop ebx
...
006255C0    pop ebp
006255C1    ret
006255C2    push 0x77EB90                                   ; => [ String: GetClient ]
006255C7    push 0x7B
006255C9    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
006255CE    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
006255D3    mov edx, 0x801800
006255D8    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006255DD    add esp, 0x0C
006255E0    call 0x0063BC30
006255E5    test al, al
006255E7    jz 0x006255EA                                   ; => [ Call: sub_63bc30 ]
006255E9    int3
006255EA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
