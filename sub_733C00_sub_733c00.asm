...
00733C05    push 0x772C21                                   ; => [ Type: EHRegistrationNode | Call: sub_772c21 ]
00733C0A    mov eax, dword ptr fs:[0x00000000]
00733C10    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00733C22    push esi
00733C23    push edi
00733C24    push eax                                        ; => [ Data: __security_cookie ]
00733C25    lea eax, ss:[ebp-0x0C]
00733C28    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00733C3D    push 0x00
00733C3F    push eax
00733C40    call 0x00761FC4                                 ; => [ Call: memset ]
...
00733C5B    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
00733C60    mov edx, 0x03
00733C65    lea ecx, ss:[ebp-0x14C]
00733C6B    call 0x0069E000                                 ; => [ Call: sub_69e000 ]
...
00733C88    test al, al
00733C8A    jz 0x007342A3                                   ; => [ Call: sub_7070e0 ]
...
00733CA6    test al, al
00733CA8    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733CDB    jnz 0x007342A3                                  ; => [ String: Root ]
00733CE1    lea ecx, ss:[ebp-0x138]
00733CE7    call 0x007076E0
00733CEC    test al, al
00733CEE    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733D0A    test al, al
00733D0C    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733D39    jnz 0x007342A3                                  ; => [ String: VERSION ]
00733D3F    lea ecx, ss:[ebp-0x138]
00733D45    call 0x007076E0                                 ; => [ Type: va_list | Call: sub_7076e0 ]
00733D4A    test al, al
...
00733DB8    test al, al
00733DBA    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733DE7    jnz 0x007342A3                                  ; => [ String: VERSION ]
00733DED    lea ecx, ss:[ebp-0x138]
00733DF3    call 0x007076E0
00733DF8    test al, al
00733DFA    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733E16    test al, al
00733E18    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733EC9    test al, al
00733ECB    jz 0x00733F05                                   ; => [ Call: sub_7076e0 ]
...
00733EF0    jnz 0x00733F29                                  ; => [ String: BONELIST ]
00733EF2    lea ecx, ss:[ebp-0x138]
00733EF8    call 0x007076E0
00733EFD    test al, al
00733EFF    jnz 0x007340D3                                  ; => [ Call: sub_7076e0 ]
...
00733F1B    test al, al
00733F1D    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00733F4A    jnz 0x007342A3                                  ; => [ String: BONE ]
00733F50    lea ecx, ss:[ebp-0x138]
00733F56    call 0x007076E0
00733F5B    test al, al
00733F5D    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
00733F63    mov esi, 0x801800                               ; => [ Data: data_801800 ]
00733F68    mov dword ptr ss:[ebp-0x140], esi               ; => [ Data: data_801800 ]
...
00734033    mov dword ptr ds:[ecx], eax                     ; => [ Call: sub_69c4d0 ]
...
0073404B    test al, al
0073404D    jz 0x0073426F                                   ; => [ Call: sub_7076e0 ]
...
0073407A    jnz 0x0073426F                                  ; => [ String: BONE | Call: sub_7076e0 ]
...
007340AA    jz 0x007340CA                                   ; => [ Data: data_cf65bc ]
007340AC    lea ecx, ss:[ebp-0x140]
007340B2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
007340C5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
007340E9    test al, al
007340EB    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
...
00734118    jnz 0x007342A3                                  ; => [ String: DATA ]
0073411E    lea ecx, ss:[ebp-0x138]
00734124    call 0x007076E0
00734129    test al, al
0073412B    jz 0x007342A3                                   ; => [ Call: sub_7076e0 ]
00734131    mov esi, 0x801800                               ; => [ Data: data_801800 ]
00734136    mov dword ptr ss:[ebp-0x13C], esi               ; => [ Data: data_801800 ]
...
00734164    call 0x0063DA70                                 ; => [ Call: sub_63da70 ]
00734169    mov esi, dword ptr ss:[ebp-0x13C]
0073416F    lea ecx, ss:[ebp-0x138]
00734175    call 0x007076E0
0073417A    test al, al
0073417C    jz 0x00734237                                   ; => [ Call: sub_7076e0 ]
00734182    test esi, esi
00734184    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00734189    mov edx, ebx
0073418B    cmovnz ecx, esi
0073418E    call 0x00733500                                 ; => [ Call: sub_733500 ]
...
007341A9    test al, al
007341AB    jz 0x00734237                                   ; => [ Call: sub_7076e0 ]
...
007341D4    jnz 0x00734237                                  ; => [ String: DATA ]
007341D6    lea ecx, ss:[ebp-0x138]
007341DC    call 0x007076E0
007341E1    test al, al
007341E3    jz 0x00734237                                   ; => [ Call: sub_7076e0 ]
...
007341FB    test al, al
007341FD    jz 0x00734237                                   ; => [ Call: sub_7076e0 ]
...
00734222    jnz 0x00734237                                  ; => [ String: Root ]
00734224    lea ecx, ss:[ebp-0x138]
0073422A    call 0x007076E0
0073422F    test al, al
00734231    jz 0x00734237                                   ; => [ Call: sub_7076e0 ]
...
0073424D    jz 0x007342A5                                   ; => [ Data: data_cf65bc ]
0073424F    lea ecx, ss:[ebp-0x13C]
00734255    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00734268    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00734283    jz 0x007342A3                                   ; => [ Data: data_cf65bc ]
00734285    lea ecx, ss:[ebp-0x140]
0073428B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073429E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
007342A3    xor bl, bl
007342A5    mov byte ptr ss:[ebp-0x04], 0x25
007342A9    cmp dword ptr ds:[0x00CF65BC], 0x00
007342B0    jz 0x007342E9                                   ; => [ Data: data_cf65bc ]
...
007342C7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
007342DA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
007342DF    mov dword ptr ss:[ebp-0x148], 0x801800          ; => [ Data: data_801800 ]
...
00734307    call 0x007078C0                                 ; => [ Call: sub_7078c0 ]
0073430C    mov dword ptr ss:[ebp-0x138], 0x00              ; => [ Call: nullptr ]
00734316    lea ecx, ss:[ebp-0x1C]
00734319    mov byte ptr ss:[ebp-0x04], 0x27
0073431D    call 0x007078C0                                 ; => [ Call: sub_7078c0 ]
00734322    mov al, bl
00734324    mov ecx, dword ptr ss:[ebp-0x0C]
00734327    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0073432E    pop ecx
0073432F    pop edi
00734330    pop esi
00734331    pop ebx
...
00734337    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00734359    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
0073435E    add esp, 0x0C
00734361    call 0x0063BC30
00734366    test al, al
00734368    jz 0x0073436B                                   ; => [ Call: sub_63bc30 ]
0073436A    int3
0073436B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
