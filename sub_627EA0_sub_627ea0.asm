...
00627EC6    jnz 0x00627F2F                                  ; => [ Data: data_b809e4 | Data: data_b809e0 ]
00627EC8    mov ecx, edx
00627ECA    call 0x005CBA00
00627ECF    mov esi, eax                                    ; => [ Call: sub_5cba00 ]
...
00627EE2    mov esi, eax                                    ; => [ Call: sub_5cba00 ]
00627EE4    mov eax, dword ptr ds:[esi+0x1C28]
00627EEA    mov dword ptr ds:[0x00B7D414], eax              ; => [ Data: data_b7d414 ]
00627EEF    xor al, al
...
00627EFD    call 0x005DEB60                                 ; => [ Call: nullptr | Call: sub_5deb60 ]
...
00627F0D    call 0x005EFE00                                 ; => [ Call: nullptr | Call: sub_5efe00 ]
...
00627F28    mov dword ptr ds:[0x00B7D410], eax              ; => [ Data: data_b7d410 ]
00627F2D    pop esi
00627F2E    ret
00627F2F    mov dword ptr ds:[0x00B7D414], 0x00             ; => [ Data: data_b7d414 ]
00627F39    mov dword ptr ds:[0x00B7D410], 0x00             ; => [ Data: data_b7d410 ]
00627F43    pop esi
00627F44    ret
