...
00685D09    movups xmmword ptr ds:[eax], xmm0
...
00685DF9    call 0x0063B870
00685DFE    add esp, 0x0C
00685E01    call 0x0063BC30
00685E06    test al, al
00685E08    jz 0x00685E0B
00685E0A    int3
00685E0B    call 0x0063BB00
