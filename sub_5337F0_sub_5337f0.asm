...
0053388F    test al, al
00533891    jnz 0x005338CF
00533893    call 0x00573400
00533898    push 0xC80
0053389D    mov esi, eax
0053389F    lea eax, ss:[ebp-0xC94]
005338A5    push 0x00
005338A7    push eax
005338A8    call 0x00761FC4
...
0053394A    push esi
0053394B    call dword ptr ds:[eax]
...
0053396E    mov dword ptr ss:[ebp-0x18], eax
...
00533985    push eax
00533986    call dword ptr ds:[edx+0x10]
00533989    push 0x00
0053398B    push 0x00
0053398D    push 0x64
