...
0074CF76    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0074CF7B    xor eax, ebp
0074CF7D    mov dword ptr ss:[ebp-0x04], eax
0074CF80    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074CF85    push ebx
0074CF86    push esi
0074CF87    push edi
...
0074CFAA    push edi
0074CFAB    movups xmmword ptr ss:[ebp-0x14], xmm0          ; => [ Type: RECT | Call: __builtin_memset ]
0074CFAF    call esi
0074CFB1    push eax
0074CFB2    push 0x198
0074CFB7    push edi
...
0074CFBD    mov edx, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074CFC3    inc ebx                                         ; => [ Field: top ]
0074CFC4    mov dword ptr ss:[ebp-0x10], ebx                ; => [ Field: top ]
0074CFC7    mov esi, dword ptr ds:[edx+0x24]
0074CFCA    inc esi
0074CFCB    mov dword ptr ss:[ebp-0x14], esi                ; => [ Field: left ]
0074CFCE    mov ecx, dword ptr ds:[edx+0x04]
0074CFD1    mov eax, dword ptr ds:[ecx+0x14]
0074CFD4    cmp eax, 0x63
0074CFD7    jnbe 0x0074D0C1                                 ; => [ Type: HWND ]
0074CFDD    movzx eax, byte ptr ds:[eax+0x74D148]           ; => [ Data: lookup_table_74d148 ]
0074CFE4    jmp dword ptr ds:[eax*4+0x74D134]
0074CFEB    push 0x105
0074CFF0    push 0x00
0074CFF2    lea eax, ss:[ebp-0x14]
0074CFF5    mov dword ptr ds:[ecx+0x08], 0x8901E0           ; => [ Data: data_8901e0 ]
0074CFFC    push eax
0074CFFD    push edi
0074CFFE    call dword ptr ds:[0x007753FC]                  ; => [ Call: nullptr | Type: BOOL ]
0074D004    pop edi
0074D005    pop esi
0074D006    pop ebx
0074D007    mov ecx, dword ptr ss:[ebp-0x04]
0074D00A    xor ecx, ebp
0074D00C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0074D011    mov esp, ebp
0074D013    pop ebp
0074D014    ret
0074D015    mov ecx, dword ptr ds:[edx+0x1C]                ; => [ Type: HWND ]
...
0074D02B    push eax                                        ; => [ Field: bottom ]
0074D02C    mov eax, dword ptr ss:[ebp-0x0C]
0074D02F    sub eax, esi
0074D031    push eax                                        ; => [ Field: right ]
0074D032    push ebx
0074D033    push esi
0074D034    push ecx
0074D035    jmp 0x0074D0FF
0074D03A    mov eax, dword ptr ds:[edx+0x1C]                ; => [ Type: HWND ]
...
0074D04A    movups xmm1, xmmword ptr ss:[ebp-0x14]          ; => [ Field: left | Field: top | Field: right | Field: bottom ]
0074D04E    push 0x01
...
0074D0DD    mov dword ptr ss:[ebp-0x14], esi                ; => [ Field: left ]
0074D0E0    mov dword ptr ss:[ebp-0x0C], edi                ; => [ Field: right ]
0074D0E3    mov eax, dword ptr ss:[ebp-0x08]
0074D0E6    lea ecx, ds:[ebx+0x02]
0074D0E9    sub eax, 0x02
0074D0EC    mov dword ptr ss:[ebp-0x10], ecx                ; => [ Field: top ]
0074D0EF    push 0x01
0074D0F1    mov dword ptr ss:[ebp-0x08], eax                ; => [ Field: bottom ]
0074D0F4    sub eax, ecx
0074D0F6    push eax                                        ; => [ Field: bottom ]
...
0074D10F    call dword ptr ds:[0x007752BC]                  ; => [ Data: data_19e2778 ]
0074D115    mov eax, dword ptr ds:[0x019E2778]
0074D11A    push dword ptr ds:[eax+0x1C]
0074D11D    call dword ptr ds:[0x0077539C]                  ; => [ Data: data_19e2778 | Data: data_19e2778 ]
0074D123    mov ecx, dword ptr ss:[ebp-0x04]
0074D126    pop edi
0074D127    pop esi
0074D128    xor ecx, ebp
0074D12A    pop ebx
0074D12B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
