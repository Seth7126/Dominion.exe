...
00761D03    push esi
00761D04    push 0x08
00761D06    call 0x00759772                                 ; => [ Call: operator new ]
...
00761D27    call dword ptr ds:[0x00775114]                  ; => [ Call: nullptr | Type: HANDLE | Call: sub_761db0 ]
...
00761D35    ret
00761D36    push 0x04
00761D38    call 0x00759772                                 ; => [ Call: operator new ]
