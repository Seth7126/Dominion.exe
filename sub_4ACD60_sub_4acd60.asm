...
004ACD70    push eax
004ACD71    call 0x004ADE00                                 ; => [ Call: sub_4ade00 ]
...
004ACDF7    add ecx, edx                                    ; => [ Data: data_8db520 ]
...
004ACE17    mov dword ptr ds:[0x008DB520], 0x00             ; => [ Data: data_8db520 ]
004ACE21    mov dword ptr ds:[0x008DB528], 0x00             ; => [ Data: data_8db528 ]
004ACE2B    test edx, edx
004ACE2D    jz 0x004ACE39
004ACE2F    push edx
004ACE30    call dword ptr ds:[0x00775524]
004ACE36    add esp, 0x04
004ACE39    mov dword ptr ds:[0x008DB51C], 0x00             ; => [ Data: data_8db51c | Call: __builtin_memset ]
...
004ACE6B    mov dword ptr ds:[0x008DB534], 0x00             ; => [ Data: data_8db534 ]
004ACE75    pop edi
004ACE76    pop esi
004ACE77    pop ebx
...
004ACE7A    pop ebp
004ACE7B    ret
004ACE7C    mov edx, dword ptr ds:[0x008DB528]              ; => [ Data: data_8db528 ]
004ACE82    movzx ecx, si
004ACE85    mov dword ptr ds:[0x008DB528], ecx              ; => [ Data: data_8db528 ]
004ACE8B    mov dword ptr ds:[eax+0xC00], edx
004ACE91    dec dword ptr ds:[0x008DB52C]                   ; => [ Data: data_8db52c ]
004ACE97    mov edx, dword ptr ds:[0x008DB51C]              ; => [ Data: data_8db51c ]
004ACE9D    jmp 0x004ACDE0
