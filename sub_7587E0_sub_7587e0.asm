...
007587FB    push 0x877324                                   ; => [ String: SoundGetDef ]
00758800    push 0x356
00758805    push 0x8772E4                                   ; => [ String: C:\x\ax2017\Engine\Sound.cpp ]
0075880A    mov ecx, 0x877344                               ; => [ String: assetPtr->assetType == ASSET_TYPE_SOUND ]
0075880F    jmp 0x00758860
00758811    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0075883A    push edi
0075883B    call 0x0075F500                                 ; => [ Call: sub_75f500 ]
...
00758848    pop ebp
00758849    ret 0x08
0075884C    push 0x8909B8                                   ; => [ String: SoLoudSoundInterface::SoundInterfaceSetCurrentPosition ]
00758851    push 0x48E
00758856    push 0x8907BC                                   ; => [ String: C:\x\ax2017\Engine\SoundSoloud.cpp ]
0075885B    mov ecx, 0x85E314                               ; => [ Data: data_85e314 ]
00758860    mov edx, 0x801800
00758865    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0075886A    add esp, 0x0C
0075886D    call 0x0063BC30
00758872    test al, al
00758874    jz 0x00758877                                   ; => [ Call: sub_63bc30 ]
00758876    int3
00758877    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
