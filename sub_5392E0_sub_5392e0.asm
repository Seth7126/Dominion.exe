...
005392F8    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005392FB    cmp esi, 0x320
00539301    jb 0x00539308
00539303    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00539336    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Intrigue.cpp | String: numCards == 1 | Data: data_801800 | String: Courtyard_Achievement_OnCards ]
0053933B    add esp, 0x0C
0053933E    call 0x0063BC30
00539343    test al, al
00539345    jz 0x00539348                                   ; => [ Call: sub_63bc30 ]
00539347    int3
00539348    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
