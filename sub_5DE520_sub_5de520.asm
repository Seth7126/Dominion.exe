...
005DE627    call 0x004AE110
005DE62C    mov ecx, dword ptr ds:[esi+0x2C]
005DE62F    mov edx, 0x01
005DE634    movss dword ptr ss:[esp+0x0C], xmm0
...
005DE862    pop ebp
005DE863    ret
005DE864    push 0x871874
005DE869    push 0x3D12
005DE86E    mov ecx, 0x86F454
005DE873    push 0x86F1E8
005DE878    mov edx, 0x801800
005DE87D    call 0x0063B870
005DE882    add esp, 0x0C
005DE885    call 0x0063BC30
005DE88A    test al, al
005DE88C    jz 0x005DE88F
005DE88E    int3
005DE88F    call 0x0063BB00
