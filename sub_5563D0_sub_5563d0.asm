...
00556478    push edi
00556479    call dword ptr ds:[eax]
...
005564BA    mov dword ptr ss:[ebp-0x70], 0x81F0F8
005564C1    mov dword ptr ss:[ebp-0x6C], eax
005564C4    lea eax, ss:[ebp-0x70]
005564C7    mov dword ptr ss:[ebp-0x4C], eax
...
005564F9    push edi
005564FA    call dword ptr ds:[eax]
...
00556525    push eax
00556526    call dword ptr ds:[edx+0x10]
00556529    test esi, esi
0055652B    setnle al
0055652E    mov ecx, dword ptr ss:[ebp-0x0C]
00556531    mov dword ptr fs:[0x00000000], ecx
00556538    pop ecx
00556539    pop edi
0055653A    pop esi
0055653B    pop ebx
