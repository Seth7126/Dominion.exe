...
006F5305    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
006F530A    mov eax, dword ptr fs:[0x00000000]
006F5310    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006F5311    sub esp, 0x0C
006F5314    push esi
006F5315    push edi
006F5316    mov eax, dword ptr ds:[0x008C4040]
006F531B    xor eax, ebp
006F531D    push eax                                        ; => [ Data: __security_cookie ]
006F531E    lea eax, ss:[ebp-0x0C]
006F5321    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006F5327    mov esi, edx
006F5329    mov edi, ecx
006F532B    lea eax, ss:[ebp-0x14]
006F532E    push eax
006F532F    push 0x85E318                                   ; => [ Data: data_85e318 ]
006F5334    push dword ptr ds:[esi]
006F5336    call 0x0064B6D0                                 ; => [ Call: sub_64b6d0 | String: %f ]
...
006F535E    push eax
006F535F    call 0x0063DF30                                 ; => [ String: %g | Call: sub_63df30 ]
...
006F539B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F53AE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F53B3    mov eax, dword ptr ds:[edi]
006F53B5    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006F53BA    test eax, eax
006F53BC    cmovnz ecx, eax
006F53BF    mov dword ptr ds:[esi], ecx
006F53C1    mov ecx, dword ptr ss:[ebp-0x0C]
006F53C4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F53CB    pop ecx
006F53CC    pop edi
006F53CD    pop esi
