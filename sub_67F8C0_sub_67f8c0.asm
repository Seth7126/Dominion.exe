...
0067F8C5    push 0x76C84D                                   ; => [ Type: EHRegistrationNode | Call: sub_76c84d ]
0067F8CA    mov eax, dword ptr fs:[0x00000000]
0067F8D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0067F8D1    sub esp, 0x18
0067F8D4    push ebx
0067F8D5    push esi
0067F8D6    push edi
0067F8D7    mov eax, dword ptr ds:[0x008C4040]
0067F8DC    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0067F8DE    push eax
0067F8DF    lea eax, ss:[ebp-0x0C]
0067F8E2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0067F923    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067F960    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0067F965    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0067F986    jz 0x0067F9A8                                   ; => [ Data: data_cf65bc ]
0067F988    mov ecx, esi
0067F98A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067F99D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067F9A2    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
0067F9B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067F9CC    push eax
0067F9CD    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0067F9F2    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0067F9F7    mov eax, dword ptr ds:[edi]
0067F9F9    test ebx, ebx
0067F9FB    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0067FA1C    jz 0x0067FA3E                                   ; => [ Data: data_cf65bc ]
0067FA1E    mov ecx, esi
0067FA20    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FA33    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067FA38    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
0067FA4D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FA6E    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0067FA73    mov eax, dword ptr ss:[ebp-0x10]
0067FA76    test edi, edi
0067FA78    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0067FA99    jz 0x0067FAB8                                   ; => [ Data: data_cf65bc ]
0067FA9B    mov ecx, esi
0067FA9D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FAB0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FAC5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FAE7    jz 0x0067FB04                                   ; => [ Data: data_cf65bc ]
0067FAE9    lea ecx, ss:[ebp-0x10]
0067FAEC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FAFF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FB28    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0067FB2F    pop ecx
0067FB30    pop edi
0067FB31    pop esi
0067FB32    pop ebx
