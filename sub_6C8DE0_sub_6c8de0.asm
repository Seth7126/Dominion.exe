...
006C8DE5    push 0x770675                                   ; => [ Call: sub_770675 | Type: EHRegistrationNode ]
006C8DEA    mov eax, dword ptr fs:[0x00000000]
006C8DF0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C8DFE    push eax                                        ; => [ Data: __security_cookie ]
006C8DFF    lea eax, ss:[ebp-0x0C]
006C8E02    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C8E14    jle 0x006C908E                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C8E4A    push eax
006C8E4B    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %s_ ]
...
006C8EA4    push eax
006C8EA5    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: _%s_ ]
006C8EAA    mov byte ptr ss:[ebp-0x04], 0x01
006C8EAE    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006C8EDC    push eax
006C8EDD    call 0x0063DF30                                 ; => [ String: _%s. | Call: sub_63df30 ]
006C8EE2    mov eax, dword ptr ss:[ebp-0x10]
006C8EE5    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006C8F0C    jz 0x006C8F3C                                   ; => [ Data: data_cf65bc ]
...
006C8F1D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C8F30    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C8F35    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C8F3C    mov byte ptr ss:[ebp-0x04], 0x06
006C8F40    cmp dword ptr ds:[0x00CF65BC], 0x00
006C8F47    jz 0x006C8F77                                   ; => [ Data: data_cf65bc ]
...
006C8F58    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C8F6B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C8F70    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006C8F77    mov dword ptr ss:[ebp-0x04], 0x07
006C8F7E    cmp dword ptr ds:[0x00CF65BC], 0x00
006C8F85    jz 0x006C8FB5                                   ; => [ Data: data_cf65bc ]
...
006C8F96    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C8FA9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C8FAE    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
...
006C8FD8    jz 0x006C9008                                   ; => [ Data: data_cf65bc ]
...
006C8FE9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C8FFC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C9001    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C9008    mov byte ptr ss:[ebp-0x04], 0x03
006C900C    cmp dword ptr ds:[0x00CF65BC], 0x00
006C9013    jz 0x006C9043                                   ; => [ Data: data_cf65bc ]
...
006C9024    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9037    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C903C    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006C9043    mov dword ptr ss:[ebp-0x04], 0x04
006C904A    cmp dword ptr ds:[0x00CF65BC], 0x00
006C9051    jz 0x006C907A                                   ; => [ Data: data_cf65bc ]
...
006C9062    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9075    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C907A    mov al, 0x01
006C907C    mov ecx, dword ptr ss:[ebp-0x0C]
006C907F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C9086    pop ecx
006C9087    pop edi
006C9088    pop esi
006C9089    pop ebx
...
006C9093    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C909A    pop ecx
006C909B    pop edi
006C909C    pop esi
006C909D    pop ebx
