...
004FCEED    call 0x00566920                                 ; => [ Call: sub_566920 ]
...
004FCF01    call 0x005680F0                                 ; => [ Call: sub_5680f0 ]
...
004FCF21    pop ebp
004FCF22    ret                                             ; => [ Call: sub_562400 ]
004FCF23    mov dword ptr ss:[esp+0x04], esi
004FCF27    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FCF54    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
004FCF59    add esp, 0x28
004FCF5C    mov ecx, 0x100
004FCF61    call 0x00563590                                 ; => [ Call: sub_563590 ]
004FCF66    mov esi, eax
004FCF68    test esi, esi
004FCF6A    jz 0x004FCF92
004FCF6C    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FCF71    push 0x04
004FCF73    push 0x00
004FCF75    push 0x00
...
004FCF84    push 0x476
004FCF89    push esi
004FCF8A    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
