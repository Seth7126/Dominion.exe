...
0067BF4D    movups xmmword ptr ds:[eax], xmm0               ; => [ Data: data_bf21e8 ]
0067BF50    movups xmm0, xmmword ptr ds:[0x00BF21F8]
0067BF57    movups xmmword ptr ds:[eax+0x10], xmm0          ; => [ Data: data_bf21f8 ]
0067BF5B    pop esi
0067BF5C    mov ecx, dword ptr ss:[esp+0x48]
0067BF60    xor ecx, esp
0067BF62    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0067BF67    mov esp, ebp
0067BF69    pop ebp
0067BF6A    ret
0067BF6B    mov ecx, eax
0067BF6D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0067BF72    push 0x00
...
0067BF87    call 0x00656980                                 ; => [ Call: sub_656980 ]
...
0067BFA9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0067BFAE    mov esp, ebp
0067BFB0    pop ebp
0067BFB1    ret
0067BFB2    push 0x8769AC                                   ; => [ String: UI2GetTransformSized ]
0067BFB7    push 0x5B92
0067BFBC    mov ecx, 0x8769A0                               ; => [ String: idx < count ]
0067BFC1    push 0x8739B4
0067BFC6    mov edx, 0x801800
0067BFCB    call 0x0063B870                                 ; => [ String: UI2GetTransformSized | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\UI2.cpp ]
0067BFD0    add esp, 0x0C
0067BFD3    call 0x0063BC30
0067BFD8    test al, al
0067BFDA    jz 0x0067BFDD                                   ; => [ Call: sub_63bc30 ]
0067BFDC    int3
0067BFDD    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
