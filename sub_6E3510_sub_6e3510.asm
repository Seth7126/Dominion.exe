...
006E3515    push 0x7713FE                                   ; => [ Call: sub_7713fe | Type: EHRegistrationNode ]
006E351A    mov eax, dword ptr fs:[0x00000000]
006E3520    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006E352E    push eax                                        ; => [ Data: __security_cookie ]
006E352F    lea eax, ss:[ebp-0x0C]
006E3532    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E354B    push eax
006E354C    call 0x006E31B0                                 ; => [ Call: sub_6e31b0 ]
...
006E358E    push edx
006E358F    push eax
006E3590    mov dword ptr ds:[ecx], 0x801800                ; => [ Data: data_801800 ]
006E3596    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006E359B    lea ecx, ss:[ebp+0x0C]
006E359E    call 0x006A17E0                                 ; => [ Call: sub_6a17e0 ]
006E35A3    add esp, 0x04
006E35A6    mov byte ptr ss:[ebp-0x04], 0x02
006E35AA    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006E35AF    mov eax, dword ptr ss:[ebp+0x0C]
006E35B2    mov ecx, esi                                    ; => [ Data: data_801800 ]
006E35B4    test eax, eax
006E35B6    cmovnz ecx, eax
006E35B9    call 0x006B7EF0
006E35BE    test eax, eax
006E35C0    jz 0x006E3654                                   ; => [ Call: sub_6b7ef0 ]
...
006E361B    jz 0x006E364B                                   ; => [ Data: data_cf65bc ]
...
006E362C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E363F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E3644    mov dword ptr ss:[ebp+0x0C], 0x801800           ; => [ Data: data_801800 ]
...
006E365F    jz 0x006E3688                                   ; => [ Data: data_cf65bc ]
...
006E3670    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E3683    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006E369C    mov dword ptr ds:[esi], eax                     ; => [ Data: data_cb2f14 ]
006E369E    mov eax, dword ptr ds:[0x00CB2F18]
006E36A3    mov dword ptr ds:[esi+0x04], eax                ; => [ Data: data_cb2f18 ]
006E36A6    mov eax, dword ptr ds:[0x00CB2F1C]              ; => [ Data: data_cb2f1c ]
...
006E36B6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E36D3    jz 0x006E36FC                                   ; => [ Data: data_cf65bc ]
...
006E36E4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E36F7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E36FC    mov eax, esi
006E36FE    mov ecx, dword ptr ss:[ebp-0x0C]
006E3701    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E3708    pop ecx
006E3709    pop edi
006E370A    pop esi
006E370B    pop ebx
...
006E3729    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006E372E    add esp, 0x0C
006E3731    call 0x0063BC30
006E3736    test al, al
006E3738    jz 0x006E373B                                   ; => [ Call: sub_63bc30 ]
006E373A    int3
006E373B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
