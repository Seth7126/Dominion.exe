...
004C2AF7    mov eax, dword ptr ds:[0x00CC8D5C]
004C2AFC    test eax, eax
004C2AFE    jnz 0x004C2B16
004C2B00    push 0x77EB90
004C2B05    push 0x7B
004C2B07    push 0x77EB50
004C2B0C    mov ecx, 0x77EB9C
...
004C2BBD    mov eax, dword ptr ds:[0x00CC8D5C]
...
004C2BFD    mov edx, dword ptr ds:[0x0147ABF4]
...
004C2C7B    call 0x004C2820
004C2C80    mov eax, dword ptr ds:[0x00CC8D5C]
004C2C85    add esp, 0x04
004C2C88    test eax, eax
004C2C8A    jz 0x004C2B00
004C2C90    mov esi, eax
004C2C92    xor ecx, ecx
...
004C2D3B    mov eax, dword ptr ds:[0x00CC8D5C]
...
004C2D7D    mov edx, dword ptr ds:[0x0147ABF4]
...
004C2DE0    call 0x004C2820
004C2DE5    mov eax, dword ptr ds:[0x00CC8D5C]
004C2DEA    add esp, 0x04
004C2DED    test eax, eax
004C2DEF    jz 0x004C2B00
004C2DF5    mov esi, eax
004C2DF7    xor ecx, ecx
...
004C2E9C    mov eax, dword ptr ds:[0x00CC8D5C]
...
004C2EDD    mov edx, dword ptr ds:[0x0147ABF4]
...
004C2F4D    pop ebp
004C2F4E    ret
004C2F4F    push 0x803A54
004C2F54    push 0x1471
004C2F59    push 0x80292C
004C2F5E    mov ecx, 0x801AA4
004C2F63    mov edx, 0x801800
004C2F68    call 0x0063B870
004C2F6D    add esp, 0x0C
004C2F70    call 0x0063BC30
004C2F75    test al, al
004C2F77    jz 0x004C2F7A
004C2F79    int3
004C2F7A    call 0x0063BB00
