...
0067A959    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0067A980    push eax
0067A981    call 0x00656980                                 ; => [ Call: sub_656980 ]
0067A986    push 0x00
...
0067A9AA    call 0x00656980                                 ; => [ Call: sub_656980 ]
...
0067A9CC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0067A9D1    mov esp, ebp
0067A9D3    pop ebp
0067A9D4    ret
0067A9D5    cmp eax, 0x03
0067A9D8    jnz 0x0067A9F6
0067A9DA    call 0x00657E50                                 ; => [ Call: sub_657e50 ]
...
0067A9EC    pop esi
0067A9ED    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0067AA0F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | Data: data_801800 | String: UI2GetScrollDeltaAmount | String: Halt ]
0067AA14    add esp, 0x0C
0067AA17    call 0x0063BC30
0067AA1C    test al, al
0067AA1E    jz 0x0067AA21                                   ; => [ Call: sub_63bc30 ]
0067AA20    int3
0067AA21    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
