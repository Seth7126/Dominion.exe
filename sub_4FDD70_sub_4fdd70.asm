...
004FDD7B    call 0x00761E50
004FDD80    mov eax, dword ptr ds:[0x008C4040]
...
004FDE28    mov eax, dword ptr ds:[eax+0x04]
004FDE2B    mov dword ptr ss:[esp+0x0C], eax
004FDE2F    jb 0x004FDE3A
004FDE31    call 0x00591930
...
004FDEFD    setz cl
004FDF00    call 0x0061B1B0
004FDF05    add esp, 0x2C
004FDF08    call 0x00573400
...
004FDF6B    movlpd qword ptr ss:[esp+0x34], xmm0
...
004FDFD1    call 0x00563C40
004FDFD6    add esp, 0x0C
004FDFD9    mov edi, eax
004FDFDB    call 0x00573400
