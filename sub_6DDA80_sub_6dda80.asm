...
006DDA94    push 0x881650                                   ; => [ String: AnimSetGetClip ]
006DDA99    push 0x151
006DDA9E    mov ecx, 0x88169C                               ; => [ String: pAnimSet->assetAnimOrStructure ]
006DDAA3    jmp 0x006DDBD5
006DDAA8    mov eax, dword ptr ds:[ecx+0x04]
006DDAAB    cmp eax, 0x0A
006DDAAE    jnz 0x006DDB8D
006DDAB4    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
006DDAB9    mov ebx, eax
006DDABB    mov dword ptr ss:[ebp-0x10], ebx
006DDABE    cmp dword ptr ds:[ebx+0x18], 0x00
006DDAC2    jnz 0x006DDAD8
006DDAC4    push 0x881650                                   ; => [ String: AnimSetGetClip ]
006DDAC9    push 0x157
006DDACE    mov ecx, 0x881674                               ; => [ String: pDefAnimation->animClip.pAnimImportData ]
006DDAD3    jmp 0x006DDBD5
006DDAD8    cmp dword ptr ds:[esi+0x10], 0x00
006DDADC    jz 0x006DDAF2
006DDADE    push 0x881650                                   ; => [ String: AnimSetGetClip ]
006DDAE3    push 0x158
006DDAE8    mov ecx, 0x881728                               ; => [ String: pAnimSet->clipIndex == 0 ]
006DDAED    jmp 0x006DDBD5
006DDAF2    mov ecx, dword ptr ds:[edi]
006DDAF4    cmp dword ptr ds:[ecx+0x04], 0x02
006DDAF8    jz 0x006DDB13
006DDAFA    push 0x8811E4                                   ; => [ String: StructureGetDef ]
006DDAFF    push 0x559
006DDB04    push 0x880FE4                                   ; => [ String: C:\x\ax2017\Engine\Structure.cpp ]
006DDB09    mov ecx, 0x87A4FC                               ; => [ String: assetPtr->assetType == ASSET_TYPE_STRUCTURE ]
006DDB0E    jmp 0x006DDBDA
006DDB13    call 0x005AF880
006DDB18    cmp byte ptr ds:[ebx], 0x00
006DDB1B    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
006DDB92    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006DDBB3    pop ebp
006DDBB4    ret
006DDBB5    push 0x881650                                   ; => [ String: AnimSetGetClip ]
006DDBBA    push 0x165
006DDBBF    mov ecx, 0x8816C0                               ; => [ String: pAnimSet->clipIndex >= 0 && pAnimSet->clipIndex < pAnimStructure->pStructureImportData->numAnimClips ]
006DDBC4    jmp 0x006DDBD5
006DDBC6    push 0x881650                                   ; => [ String: AnimSetGetClip ]
006DDBCB    push 0x16A
006DDBD0    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006DDBD5    push 0x88162C                                   ; => [ String: C:\x\ax2017\Engine\Animation.cpp | String: C:\x\ax2017\Engine\Animation.cpp | String: C:\x\ax2017\Engine\Animation.cpp | String: C:\x\ax2017\Engine\Animation.cpp ]
006DDBDA    mov edx, 0x801800
006DDBDF    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006DDBE4    add esp, 0x0C
006DDBE7    call 0x0063BC30
006DDBEC    test al, al
006DDBEE    jz 0x006DDBF1                                   ; => [ Call: sub_63bc30 ]
006DDBF0    int3
006DDBF1    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
