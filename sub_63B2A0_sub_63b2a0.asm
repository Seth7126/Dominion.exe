...
0063B2A9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0063B2C1    call 0x0063B7F0                                 ; => [ String: creating minidump | Call: sub_63b7f0 ]
0063B2C6    add esp, 0x04
0063B2C9    call 0x0063C090                                 ; => [ Call: sub_63c090 ]
0063B2CE    mov ebx, eax
0063B2D0    mov ecx, ebx
0063B2D2    call 0x0069DB50                                 ; => [ Call: sub_69db50 ]
0063B2D7    lea eax, ss:[ebp-0x118]
0063B2DD    push eax
0063B2DE    call dword ptr ds:[0x007750F0]                  ; => [ Type: SYSTEMTIME ]
0063B2E4    xor esi, esi
0063B2E6    movzx eax, word ptr ss:[ebp-0x10C]
0063B2ED    push esi                                        ; => [ Type: HANDLE ]
0063B2EE    push eax                                        ; => [ Field: wSecond ]
0063B2EF    movzx eax, word ptr ss:[ebp-0x10E]
0063B2F6    push eax                                        ; => [ Field: wMinute ]
0063B2F7    movzx eax, word ptr ss:[ebp-0x110]
0063B2FE    push eax                                        ; => [ Field: wHour ]
0063B2FF    movzx eax, word ptr ss:[ebp-0x112]
0063B306    push eax                                        ; => [ Field: wDay ]
0063B307    movzx eax, word ptr ss:[ebp-0x116]
0063B30E    push eax                                        ; => [ Field: wMonth ]
0063B30F    movzx eax, word ptr ss:[ebp-0x118]
0063B316    push eax                                        ; => [ Field: wYear ]
0063B317    push ebx
0063B318    lea eax, ss:[ebp-0x108]
0063B31E    push 0x8719BC
0063B323    push eax
0063B324    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %sminidump_%4d%02d%02d_%02d%02d%02d_%02d.dmp ]
...
0063B344    push eax
0063B345    call dword ptr ds:[0x007750E8]                  ; => [ Call: nullptr ]
...
0063B35D    call 0x0063B7F0                                 ; => [ String: Can't create minidump file handle | Call: sub_63b7f0 ]
0063B362    add esp, 0x04
0063B365    call dword ptr ds:[0x007750E4]
0063B36B    mov dword ptr ss:[ebp-0x128], eax               ; => [ Type: MINIDUMP_EXCEPTION_INFORMATION | Field: ThreadId ]
0063B371    mov eax, dword ptr ss:[ebp-0x11C]
0063B377    mov dword ptr ss:[ebp-0x124], eax               ; => [ Field: ExceptionPointers ]
0063B37D    mov dword ptr ss:[ebp-0x120], 0x00              ; => [ Field: ClientPointers ]
...
0063B3A3    push eax
0063B3A4    push esi
0063B3A5    call dword ptr ds:[0x007756E8]                  ; => [ Call: nullptr | Type: BOOL ]
0063B3AB    push edi
...
0063B3C2    mov ecx, 0x871A64                               ; => [ String: saved to write minidump file %s ]
0063B3C7    cmovnz ecx, eax                                 ; => [ String: wrote minidump file %s ]
0063B3CA    push ecx
0063B3CB    call 0x0063B7F0                                 ; => [ Call: sub_63b7f0 ]
...
0063B3D9    pop esi
0063B3DA    pop ebx
0063B3DB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
