...
0059D5D9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0059D603    mov dword ptr ds:[edx+0x10], eax                ; => [ Data: data_1597e48 ]
...
0059D630    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0059D689    call 0x004F6C30                                 ; => [ Call: sub_4f6c30 ]
0059D68E    add esp, 0x08
0059D691    xor ecx, ecx                                    ; => [ Call: nullptr ]
...
0059D6BD    mov eax, dword ptr ds:[0x01597E48]              ; => [ Data: data_1597e48 ]
0059D6C2    mov ecx, dword ptr ds:[0x01597E4C]              ; => [ Data: data_1597e4c ]
...
0059D6F9    mov ebx, eax                                    ; => [ Call: sub_64c020 ]
0059D6FB    mov eax, dword ptr ds:[0x01597E44]              ; => [ Data: data_1597e44 ]
0059D700    test eax, eax
0059D702    jz 0x0059D72B
0059D704    push dword ptr ss:[ebp-0xC94]
0059D70A    push eax
0059D70B    push ebx
0059D70C    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0059D726    call 0x0064C080                                 ; => [ Data: data_1597e44 | Call: sub_64c080 | Data: data_1597e4c ]
0059D72B    mov eax, dword ptr ss:[ebp-0xC90]
0059D731    mov dword ptr ds:[0x01597E4C], eax              ; => [ Data: data_1597e4c ]
0059D736    mov eax, dword ptr ds:[0x01597E48]              ; => [ Data: data_1597e48 ]
0059D73B    mov dword ptr ds:[0x01597E44], ebx              ; => [ Data: data_1597e44 ]
0059D741    jmp 0x0059D749
0059D743    mov ebx, dword ptr ds:[0x01597E44]              ; => [ Data: data_1597e44 ]
0059D749    inc eax
0059D74A    mov dword ptr ds:[0x01597E48], eax              ; => [ Data: data_1597e48 ]
0059D74F    dec eax
...
0059D784    pop ebx
0059D785    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
