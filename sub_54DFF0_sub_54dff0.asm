...
0054E000    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0054E001    mov eax, 0x1944
0054E006    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054E00B    mov eax, dword ptr ds:[0x008C4040]
0054E010    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0054E012    mov dword ptr ss:[ebp-0x10], eax
0054E015    push esi
0054E016    push edi
0054E017    push eax
0054E018    lea eax, ss:[ebp-0x0C]
0054E01B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0054E021    lea eax, ss:[ebp-0x1950]
0054E027    mov ecx, 0x3EA
0054E02C    push eax
0054E02D    call 0x00568780                                 ; => [ Call: sub_568780 ]
0054E032    mov esi, eax
0054E034    mov dword ptr ss:[ebp-0xCC8], 0x81C5C4          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_ae928675fbc82363311b658c74b05054>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ae928675fbc82363311b658c74b05054>,bool,enum CardID>::VTable ]
0054E03E    mov ecx, 0x321
0054E043    lea edi, ss:[ebp-0xC98]
0054E049    lea eax, ss:[ebp-0xCC8]
0054E04F    add esp, 0x04
0054E052    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0054E054    mov dword ptr ss:[ebp-0xCA4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ae928675fbc82363311b658c74b05054>,bool,enum CardID>::VTable ]
...
0054E092    push esi
0054E093    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0054E0A1    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0054E0EC    call 0x0056ACC0                                 ; => [ Call: sub_56acc0 ]
...
0054E103    call 0x0054D5D0                                 ; => [ Call: sub_54d5d0 ]
0054E108    add esp, 0x04
0054E10B    mov ecx, dword ptr ss:[ebp-0x0C]
0054E10E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0054E115    pop ecx
0054E116    pop edi
0054E117    pop esi
0054E118    mov ecx, dword ptr ss:[ebp-0x10]
0054E11B    xor ecx, ebp
0054E11D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
