...
006EE5C6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006EE617    call edi                                        ; => [ Data: data_147d46c ]
006EE619    lea eax, ss:[ebp-0x0C]
006EE61C    push eax
006EE61D    push dword ptr ds:[0x0147D46C]
006EE623    call edi                                        ; => [ Data: data_147d46c ]
...
006EE674    call edi                                        ; => [ Data: data_147d46c ]
006EE676    lea eax, ss:[ebp-0x0C]
006EE679    push eax
006EE67A    push dword ptr ds:[0x0147D46C]
006EE680    call edi                                        ; => [ Data: data_147d46c ]
...
006EE697    push ecx
006EE698    push esi
006EE699    call ebx                                        ; => [ Field: right | Field: bottom ]
006EE69B    mov ecx, dword ptr ss:[ebp-0x04]
006EE69E    pop edi
006EE69F    pop esi
006EE6A0    xor ecx, ebp
006EE6A2    pop ebx
006EE6A3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
