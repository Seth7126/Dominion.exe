...
00653225    push 0x76CEAE                                   ; => [ Type: EHRegistrationNode | Call: sub_76ceae ]
0065322A    mov eax, dword ptr fs:[0x00000000]
00653230    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00653231    sub esp, 0x10
00653234    push esi
00653235    push edi
00653236    mov eax, dword ptr ds:[0x008C4040]
0065323B    xor eax, ebp
0065323D    push eax                                        ; => [ Data: __security_cookie ]
0065323E    lea eax, ss:[ebp-0x0C]
00653241    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00653266    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
0065326B    push 0x1E8
00653270    push 0x00
00653272    mov dword ptr ss:[ebp-0x04], 0x00
00653279    push 0x1A99060
0065327E    mov dword ptr ss:[ebp-0x10], 0x01
00653285    call 0x00761FC4                                 ; => [ Call: memset ]
0065328A    mov edi, dword ptr ds:[0x01724B0C]              ; => [ Data: data_1724b0c ]
