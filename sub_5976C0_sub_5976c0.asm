...
005976C5    push 0x76761E                                   ; => [ Call: __ehhandler$?CurrentSubscriptionLevel@ResourceManager@details@Concurrency@@QAEIII@Z | Type: EHRegistrationNode ]
005976CA    mov eax, dword ptr fs:[0x00000000]
005976D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005976DE    push eax                                        ; => [ Data: __security_cookie ]
005976DF    lea eax, ss:[ebp-0x0C]
005976E2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00597717    call 0x005A0DB0                                 ; => [ Call: sub_5a0db0 ]
0059771C    inc esi
0059771D    cmp esi, edi
0059771F    jl 0x00597710
00597721    mov edx, dword ptr ss:[ebp-0x10]
00597724    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
0059773E    call 0x0063DA70                                 ; => [ Call: sub_63da70 ]
00597743    mov eax, ebx
00597745    mov ecx, dword ptr ss:[ebp-0x0C]
00597748    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0059774F    pop ecx
00597750    pop edi
00597751    pop esi
00597752    pop ebx
