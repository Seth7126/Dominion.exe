...
00759718    push edi
00759719    call dword ptr ds:[0x007750F4]                  ; => [ Data: data_cc8a08 ]
...
0075972C    call 0x0075975D                                 ; => [ Call: __Init_thread_wait_v2 ]
...
0075974C    mov dword ptr ds:[ecx+0x08], eax                ; => [ Type: TEB | Data: data_8c4004 | Data: data_cc8d3c | Field: ThreadLocalStoragePointer ]
00759752    push edi
00759753    call dword ptr ds:[0x0077513C]
00759759    pop edi
0075975A    pop esi
0075975B    pop ebp
0075975C    ret                                             ; => [ Data: data_cc8a08 ]
