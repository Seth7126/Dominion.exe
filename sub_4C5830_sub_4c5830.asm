...
004C5836    mov dword ptr ds:[0x008DB660], 0x13
...
004C5857    test al, al
004C5859    setnz cl
004C585C    mov dword ptr ds:[0x008DBFB0], ecx
004C5862    jmp 0x004C586E
004C5864    mov dword ptr ds:[0x008DBFB0], 0x01
004C586E    mov dword ptr ds:[0x008DBFB8], 0x00
004C5878    mov eax, dword ptr ds:[0x008DC144]
004C587D    test eax, eax
004C587F    jz 0x004C58BD
004C5881    cmp eax, 0x801800
004C5886    jz 0x004C58BD
004C5888    cmp dword ptr ds:[0x00CF65BC], 0x00
004C588F    jz 0x004C58B3
004C5891    cmp byte ptr ds:[eax], 0x00
004C5894    jz 0x004C58B3
004C5896    mov ecx, 0x8DC144
004C589B    call 0x0063D4E0
...
004C58AE    call 0x0064C080
004C58B3    mov dword ptr ds:[0x008DC144], 0x801800
004C58BD    mov eax, dword ptr ds:[0x00CC8D5C]
004C58C2    test eax, eax
004C58C4    jnz 0x004C58D9
004C58C6    push 0x77EB90
004C58CB    push 0x7B
004C58CD    push 0x77EB50
004C58D2    mov ecx, 0x77EB9C
004C58D7    jmp 0x004C58FE
004C58D9    cmp dword ptr ds:[eax+0x18], 0x03
004C58DD    jnz 0x004C58E6
004C58DF    mov cl, 0x01
004C58E1    call 0x004AF000
004C58E6    mov esp, ebp
004C58E8    pop ebp
004C58E9    ret
004C58EA    push 0x803D18
004C58EF    push 0x19EE
004C58F4    push 0x80292C
004C58F9    mov ecx, 0x801AA4
004C58FE    mov edx, 0x801800
004C5903    call 0x0063B870
004C5908    add esp, 0x0C
004C590B    call 0x0063BC30
004C5910    test al, al
004C5912    jz 0x004C5915
004C5914    int3
004C5915    call 0x0063BB00
