...
005A9BDC    mov eax, dword ptr ds:[0x008C4040]
...
005A9D58    movups xmmword ptr ss:[ebp-0x78], xmm0
...
005A9FD1    xorps xmm1, xmm1
005A9FD4    comiss xmm1, xmm0
005A9FD7    mov dword ptr ss:[ebp-0x1C4], eax
...
005AA008    mov dword ptr ss:[ebp+esi*1-0x28], eax
...
005AA052    movups xmmword ptr ss:[ebp-0x98], xmm0
...
005AA069    mov eax, dword ptr ds:[0x0147ABE4]
...
005AA08C    push 0x00
005AA08E    push dword ptr ds:[0x0171EFC4]
...
005AA182    pop esi
005AA183    call 0x0075927A
005AA188    mov esp, ebp
005AA18A    pop ebp
005AA18B    mov esp, ebx
005AA18D    pop ebx
005AA18E    ret
005AA18F    push 0x82558C
005AA194    push 0xF22
005AA199    mov ecx, 0x8255A0
005AA19E    jmp 0x005AA1AF
005AA1A0    push 0x82558C
005AA1A5    mov ecx, 0x825570
005AA1AA    push 0xF1F
005AA1AF    push 0x8250E0
005AA1B4    mov edx, 0x801800
005AA1B9    call 0x0063B870
005AA1BE    add esp, 0x0C
005AA1C1    call 0x0063BC30
005AA1C6    test al, al
005AA1C8    jz 0x005AA1CB
005AA1CA    int3
005AA1CB    call 0x0063BB00
