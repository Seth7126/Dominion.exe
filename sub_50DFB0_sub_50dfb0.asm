...
0050DFE7    push 0x3F1
0050DFEC    push 0xE01
0050DFF1    call 0x00571F30                                 ; => [ Call: sub_571f30 ]
...
0050E00C    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050E028    call 0x00584790                                 ; => [ Call: sub_584790 ]
0050E02D    add esp, 0x04
0050E030    call 0x00573400
0050E035    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0050E038    mov dword ptr ss:[esp+0x14], eax
0050E03C    cmp ebx, 0x320
0050E042    jb 0x0050E049
0050E044    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050E099    push 0x50
0050E09B    push eax
0050E09C    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
0050E0C4    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: StampGetPileSetup | String: c.contextType == CONTEXT_SETUP ]
0050E0C9    add esp, 0x0C
0050E0CC    call 0x0063BC30
0050E0D1    test al, al
0050E0D3    jz 0x0050E0D6                                   ; => [ Call: sub_63bc30 ]
0050E0D5    int3
0050E0D6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
