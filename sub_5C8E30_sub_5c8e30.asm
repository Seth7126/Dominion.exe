...
005C8E36    mov eax, dword ptr ds:[0x00CCEA0C]
005C8E3B    push ebx
...
005C8E49    push 0x82854C
005C8E4E    push 0x34
005C8E50    mov ecx, 0x828558
...
005C8E69    jnz 0x005C8E7C
005C8E6B    push 0x82856C
005C8E70    push 0x3A
005C8E72    mov ecx, 0x828538
...
005C8E8E    push 0x828578
005C8E93    push 0xD6
005C8E98    mov ecx, 0x828580
005C8E9D    jmp 0x005C8FAC
005C8EA2    cmp dword ptr ds:[eax], 0x00
005C8EA5    jz 0x005C8EBB
005C8EA7    push 0x828578
005C8EAC    push 0xD8
005C8EB1    mov ecx, 0x828588
...
005C8ECB    push 0x828578
005C8ED0    push 0xE5
005C8ED5    mov ecx, 0x8285A0
005C8EDA    jmp 0x005C8FAC
005C8EDF    cmp esi, dword ptr ds:[edi+0x04]
005C8EE2    jle 0x005C8EFA
005C8EE4    push 0x828578
005C8EE9    push 0xE6
005C8EEE    mov ecx, 0x8285AC
...
005C8F70    push 0x828578
005C8F75    push 0xFB
005C8F7A    mov ecx, 0x8285E4
...
005C8F9B    pop ebp
005C8F9C    ret
005C8F9D    push 0x828578
005C8FA2    push 0x100
005C8FA7    mov ecx, 0x8285EC
005C8FAC    push 0x828508
005C8FB1    mov edx, 0x801800
005C8FB6    call 0x0063B870
005C8FBB    add esp, 0x0C
005C8FBE    call 0x0063BC30
005C8FC3    test al, al
005C8FC5    jz 0x005C8FC8
005C8FC7    int3
005C8FC8    call 0x0063BB00
