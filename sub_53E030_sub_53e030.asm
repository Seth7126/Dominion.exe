...
0053E03B    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053E040    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0053E045    xor eax, esp
0053E047    mov dword ptr ss:[esp+0x19A4], eax
0053E04E    push esi
0053E04F    push edi
0053E050    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053E055    push 0x00
0053E057    push 0x00
0053E059    push 0x01
...
0053E061    push 0x02
0053E063    call 0x00590760                                 ; => [ Call: sub_590760 ]
0053E068    add esp, 0x10
0053E06B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053E09C    push eax
0053E09D    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
...
0053E0BA    movlpd qword ptr ss:[esp+0x34], xmm0            ; => [ Call: __builtin_memset ]
...
0053E111    push 0x01
0053E113    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0053E161    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053E17F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0053E1BD    push eax
0053E1BE    call 0x00586320                                 ; => [ Call: sub_586320 ]
0053E1C3    add esp, 0x10
0053E1C6    mov ecx, dword ptr ss:[esp+0x19AC]
0053E1CD    pop edi
0053E1CE    pop esi
0053E1CF    xor ecx, esp
0053E1D1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0053E1F0    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0053E1F5    add esp, 0x0C
0053E1F8    call 0x0063BC30
0053E1FD    test al, al
0053E1FF    jz 0x0053E202                                   ; => [ Call: sub_63bc30 ]
0053E201    int3
0053E202    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
