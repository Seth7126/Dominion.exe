...
004D48C5    push 0x7636F6                                   ; => [ Call: __ehhandler$?CreateInternalContext@UMSThreadScheduler@details@Concurrency@@MAEPAVInternalContextBase@23@XZ | Type: EHRegistrationNode ]
004D48CA    mov eax, dword ptr fs:[0x00000000]
004D48D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D48D1    sub esp, 0x0C
004D48D4    push esi
004D48D5    mov eax, dword ptr ds:[0x008C4040]
004D48DA    xor eax, ebp
004D48DC    push eax                                        ; => [ Data: __security_cookie ]
004D48DD    lea eax, ss:[ebp-0x0C]
004D48E0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D48F5    call 0x004D47C0                                 ; => [ Call: sub_4d47c0 ]
004D48FA    mov eax, dword ptr ss:[ebp+0x0C]
004D48FD    mov edx, 0x801800                               ; => [ Data: data_801800 ]
004D4902    mov dword ptr ss:[ebp-0x04], 0x01
004D4909    mov ecx, edx                                    ; => [ Data: data_801800 ]
...
004D4920    call 0x0063DFA0                                 ; => [ Call: sub_63dfa0 ]
...
004D493D    jz 0x004D4966                                   ; => [ Data: data_cf65bc ]
...
004D494E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4961    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D4966    mov eax, esi
004D4968    mov ecx, dword ptr ss:[ebp-0x0C]
004D496B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D4972    pop ecx
004D4973    pop esi
