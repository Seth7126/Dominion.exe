...
00552930    test al, al
00552932    jz 0x00552972                                   ; => [ Call: sub_568470 ]
00552934    call 0x00573400
00552939    movzx esi, si
0055293C    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0055293F    cmp esi, 0x320
00552945    jb 0x0055294C
00552947    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00552964    test al, al
00552966    jz 0x00552972                                   ; => [ Call: sub_5754f0 ]
