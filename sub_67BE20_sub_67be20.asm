...
0067BE23    push ecx
0067BE24    call 0x0067BD70                                 ; => [ Call: sub_67bd70 ]
...
0067BE32    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0067BE46    pop ecx
0067BE47    pop ebp
0067BE48    ret                                             ; => [ Call: sub_64c870 ]
0067BE49    push 0x87697C
0067BE4E    push 0x5A8B
0067BE53    push 0x8739B4
0067BE58    mov edx, 0x801800
0067BE5D    mov ecx, 0x814428
0067BE62    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | String: idx >= 0 | Data: data_801800 | String: UI2GetHandle ]
0067BE67    add esp, 0x0C
0067BE6A    call 0x0063BC30
0067BE6F    test al, al
0067BE71    jz 0x0067BE74                                   ; => [ Call: sub_63bc30 ]
0067BE73    int3
0067BE74    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
