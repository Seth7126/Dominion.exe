...
004D58C5    push 0x76380D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Getcat@?$moneypunct@D$00@std@@SAIPAPBVfacet@locale@2@PBV42@@Z ]
004D58CA    mov eax, dword ptr fs:[0x00000000]
004D58D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D58DE    push eax                                        ; => [ Data: __security_cookie ]
004D58DF    lea eax, ss:[ebp-0x0C]
004D58E2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D591B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D595B    push esi
004D595C    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
004D5993    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
004D59BB    jz 0x004D59E4                                   ; => [ Data: data_cf65bc ]
...
004D59CC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D59DF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D59E4    mov ecx, dword ptr ss:[ebp-0x0C]
004D59E7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D59EE    pop ecx
004D59EF    pop edi
004D59F0    pop esi
004D59F1    pop ebx
