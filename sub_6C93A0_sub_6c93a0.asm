...
006C93A5    push 0x770715                                   ; => [ Type: EHRegistrationNode | Call: sub_770715 ]
006C93AA    mov eax, dword ptr fs:[0x00000000]
006C93B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C93BE    push eax                                        ; => [ Data: __security_cookie ]
006C93BF    lea eax, ss:[ebp-0x0C]
006C93C2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C93C8    mov eax, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
006C93E7    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006C93EC    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_6c4050 | String: sys/ ]
006C93EE    mov ecx, esi                                    ; => [ Data: data_801800 ]
006C93F0    test eax, eax
006C93F2    mov edx, edi
006C93F4    push ebx
006C93F5    cmovnz ecx, eax
006C93F8    call 0x006C90B0                                 ; => [ Call: sub_6c90b0 ]
006C93FD    add esp, 0x04
006C9400    mov dword ptr ss:[ebp-0x04], 0x01
006C9407    cmp dword ptr ds:[0x00CF65BC], 0x00
006C940E    jz 0x006C9437                                   ; => [ Data: data_cf65bc ]
...
006C941F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9432    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C9452    mov ecx, esi                                    ; => [ Data: data_801800 ]
006C9454    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_6c4050 | String: res/ ]
006C9456    mov edx, edi
006C9458    test eax, eax
006C945A    push ebx
006C945B    cmovnz ecx, eax
006C945E    call 0x006C90B0                                 ; => [ Call: sub_6c90b0 ]
006C9463    add esp, 0x04
006C9466    mov dword ptr ss:[ebp-0x04], 0x03
006C946D    cmp dword ptr ds:[0x00CF65BC], 0x00
006C9474    jz 0x006C949D                                   ; => [ Data: data_cf65bc ]
...
006C9485    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9498    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C949D    cmp byte ptr ds:[0x00CC8DDD], 0x00
006C94A4    jz 0x006C94AD                                   ; => [ Data: data_cc8ddd ]
006C94A6    mov eax, 0x87DF58                               ; => [ String: xbin/ios/ ]
006C94AB    jmp 0x006C94C2
006C94AD    cmp byte ptr ds:[0x00CC8DDC], 0x00
006C94B4    jz 0x006C94BD                                   ; => [ Data: data_cc8ddc ]
006C94B6    mov eax, 0x87DF6C                               ; => [ String: xbin/web/ ]
006C94BB    jmp 0x006C94C2
006C94BD    mov eax, 0x87DF64                               ; => [ String: xbin/ ]
006C94C2    push eax
006C94C3    lea eax, ss:[ebp-0x10]
006C94C6    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006C94CD    push 0x87E5E8
006C94D2    push eax
006C94D3    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %satlases/ ]
...
006C94E8    mov edx, esi                                    ; => [ Data: data_801800 ]
...
006C9528    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C955F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9572    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C9577    mov ecx, dword ptr ss:[ebp-0x0C]
006C957A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C9581    pop ecx
006C9582    pop edi
006C9583    pop esi
006C9584    pop ebx
