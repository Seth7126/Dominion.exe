...
005A3AC1    mov dword ptr fs:[0x00000000], eax
005A3AC7    mov eax, dword ptr ds:[0x00CC8DC0]
005A3ACC    mov edi, dword ptr ds:[0x0171EFC4]
...
005A3EA7    mov dword ptr fs:[0x00000000], ecx
005A3EAE    pop ecx
005A3EAF    pop edi
005A3EB0    pop esi
...
005A3ECE    call 0x0063B870
005A3ED3    add esp, 0x0C
005A3ED6    call 0x0063BC30
005A3EDB    test al, al
005A3EDD    jz 0x005A3EE0
005A3EDF    int3
005A3EE0    call 0x0063BB00
