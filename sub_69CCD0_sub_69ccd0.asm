...
0069CCDD    call 0x0069C520                                 ; => [ Call: sub_69c520 ]
0069CCE2    test al, al
...
0069CCFC    movzx eax, byte ptr ds:[eax+0x69CE70]           ; => [ Data: lookup_table_69ce70 ]
0069CD03    jmp dword ptr ds:[eax*4+0x69CE54]
0069CD0A    push 0x8795A4                                   ; => [ String: DefinitionDeleteField ]
0069CD0F    push 0x1F4
0069CD14    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
0069CD2B    call 0x0069CC40                                 ; => [ Call: sub_69cc40 ]
...
0069CD54    pop ebx
0069CD55    pop ebp
0069CD56    ret                                             ; => [ Call: sub_69cbc0 ]
0069CD57    mov esi, dword ptr ds:[edi]
0069CD59    mov eax, dword ptr ds:[esi+ebx*1]
0069CD5C    test eax, eax
0069CD5E    jnz 0x0069CD74
0069CD60    push 0x879548                                   ; => [ String: DefinitionDeleteString ]
0069CD65    push 0x17C
0069CD6A    mov ecx, 0x87953C                               ; => [ String: *pString ]
...
0069CDBA    push edi
0069CDBB    call 0x0069CBC0                                 ; => [ Call: sub_69cbc0 ]
0069CDC0    push esi
...
0069CE17    call 0x0069CE80                                 ; => [ Call: sub_69ce80 ]
...
0069CE22    pop ebp
0069CE23    ret
0069CE24    push 0x8795A4                                   ; => [ String: DefinitionDeleteField ]
0069CE29    push 0x21F
0069CE2E    mov ecx, 0x877B04                               ; => [ String: !DefTypeIsBuiltIn(pField->pDefMap) ]
0069CE33    push 0x879400
0069CE38    mov edx, 0x801800
0069CE3D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Definition.cpp ]
0069CE42    add esp, 0x0C
0069CE45    call 0x0063BC30
0069CE4A    test al, al
0069CE4C    jz 0x0069CE4F                                   ; => [ Call: sub_63bc30 ]
0069CE4E    int3
0069CE4F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
