...
006B25F5    push 0x763430                                   ; => [ Call: __ehhandler$??0?$_Mpunct@G@std@@QAE@ABV_Locinfo@1@I_N1@Z | Type: EHRegistrationNode ]
006B25FA    mov eax, dword ptr fs:[0x00000000]
006B2600    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B2601    push ecx
006B2602    push ebx
006B2603    push esi
006B2604    push edi
...
006B260C    push eax                                        ; => [ Data: __security_cookie ]
006B260D    lea eax, ss:[ebp-0x0C]
006B2610    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006B2616    mov edx, dword ptr ss:[ebp+0x10]
006B2619    push ecx
006B261A    mov ecx, esp
006B261C    test edx, edx
006B261E    jz 0x006B271C
006B2624    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006B2629    lea ecx, ss:[ebp-0x10]
006B262C    call 0x006A1BF0                                 ; => [ Call: sub_6a1bf0 ]
006B2631    mov eax, dword ptr ss:[ebp-0x10]
006B2634    lea ecx, ss:[ebp+0x10]
006B2637    add esp, 0x04
006B263A    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
006B263F    test eax, eax
006B2641    mov edx, ebx                                    ; => [ Data: data_801800 ]
006B2643    cmovnz edx, eax
006B2646    call 0x006A2A20                                 ; => [ Call: sub_6a2a20 ]
...
006B265F    mov edi, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
006B2662    mov ecx, edi
006B2664    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
006B2674    push ebx
006B2675    push esi
006B2676    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
006B26AB    jz 0x006B26CF                                   ; => [ Data: data_cf65bc ]
006B26AD    lea ecx, ss:[ebp+0x10]
006B26B0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B26C3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B26C8    mov dword ptr ss:[ebp+0x10], 0x801800           ; => [ Data: data_801800 ]
006B26CF    mov dword ptr ss:[ebp-0x04], 0x01
006B26D6    cmp dword ptr ds:[0x00CF65BC], 0x00
006B26DD    jz 0x006B2706                                   ; => [ Data: data_cf65bc ]
...
006B26EE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B2701    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B2706    mov eax, esi
006B2708    mov ecx, dword ptr ss:[ebp-0x0C]
006B270B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B2712    pop ecx
006B2713    pop edi
006B2714    pop esi
006B2715    pop ebx
...
006B2735    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006B273A    add esp, 0x0C
006B273D    call 0x0063BC30
006B2742    test al, al
006B2744    jz 0x006B2747                                   ; => [ Call: sub_63bc30 ]
006B2746    int3
006B2747    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
