...
004C5B95    push 0x763075                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Reallocate_exactly@?$vector@IV?$allocator@I@std@@@std@@AAEXI@Z ]
004C5B9A    mov eax, dword ptr fs:[0x00000000]
004C5BA0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004C5BA1    sub esp, 0x10
004C5BA4    push esi
004C5BA5    push edi
004C5BA6    mov eax, dword ptr ds:[0x008C4040]
004C5BAB    xor eax, ebp
004C5BAD    push eax                                        ; => [ Data: __security_cookie ]
004C5BAE    lea eax, ss:[ebp-0x0C]
004C5BB1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004C5BE8    call 0x004D48C0                                 ; => [ Data: data_8dc144 | Call: sub_4d48c0 | String: dom_msg_gamecode_error_header | String: [code] | Call: sub_4d47c0 | String: dom_msg_gamecode_error_body ]
004C5BED    add esp, 0x08
004C5BF0    mov edx, 0x801800
004C5BF5    mov byte ptr ss:[ebp-0x04], 0x01
004C5BF9    lea ecx, ss:[ebp-0x18]
004C5BFC    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C5C01    mov edx, 0x801800
004C5C06    mov byte ptr ss:[ebp-0x04], 0x02
004C5C0A    lea ecx, ss:[ebp-0x14]
004C5C0D    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C5C12    lea eax, ss:[ebp-0x1C]
004C5C15    mov byte ptr ss:[ebp-0x04], 0x03
004C5C19    push eax
004C5C1A    mov ecx, 0x8DB750
004C5C1F    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004C5C29    call 0x0063D850                                 ; => [ Data: data_8db750 | Call: sub_63d850 ]
004C5C2E    lea eax, ss:[ebp-0x10]
004C5C31    mov ecx, 0x8DB754
004C5C36    push eax
004C5C37    call 0x0063D850                                 ; => [ Data: data_8db754 | Call: sub_63d850 ]
004C5C3C    lea eax, ss:[ebp-0x14]
004C5C3F    mov ecx, 0x8DB758
004C5C44    push eax
004C5C45    call 0x0063D850                                 ; => [ Data: data_8db758 | Call: sub_63d850 ]
004C5C4A    lea eax, ss:[ebp-0x18]
004C5C4D    mov ecx, 0x8DB75C
004C5C52    push eax
004C5C53    call 0x0063D850                                 ; => [ Data: data_8db75c | Call: sub_63d850 ]
004C5C58    mov dword ptr ds:[0x008DB760], 0x00             ; => [ Data: data_8db760 ]
004C5C62    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004C5C6C    mov byte ptr ss:[ebp-0x04], 0x04
004C5C70    cmp dword ptr ds:[0x00CF65BC], 0x00
004C5C77    jz 0x004C5CA0                                   ; => [ Data: data_cf65bc ]
...
004C5C88    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C5C9B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C5CA0    mov byte ptr ss:[ebp-0x04], 0x05
004C5CA4    cmp dword ptr ds:[0x00CF65BC], 0x00
004C5CAB    jz 0x004C5CD4                                   ; => [ Data: data_cf65bc ]
...
004C5CBC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C5CCF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C5CD4    mov byte ptr ss:[ebp-0x04], 0x01
004C5CD8    mov eax, dword ptr ds:[0x008DC144]              ; => [ Data: data_8dc144 ]
004C5CDD    test eax, eax
004C5CDF    jz 0x004C5D1D
004C5CE1    cmp eax, 0x801800
004C5CE6    jz 0x004C5D1D                                   ; => [ Data: data_801800 ]
004C5CE8    cmp dword ptr ds:[0x00CF65BC], 0x00
004C5CEF    jz 0x004C5D13
004C5CF1    cmp byte ptr ds:[eax], 0x00
004C5CF4    jz 0x004C5D13                                   ; => [ Data: data_cf65bc ]
004C5CF6    mov ecx, 0x8DC144
004C5CFB    call 0x0063D4E0                                 ; => [ Data: data_8dc144 | Call: sub_63d4e0 ]
...
004C5D0E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C5D13    mov dword ptr ds:[0x008DC144], 0x801800         ; => [ Data: data_8dc144 | Data: data_801800 ]
004C5D1D    mov byte ptr ss:[ebp-0x04], 0x06
004C5D21    cmp dword ptr ds:[0x00CF65BC], 0x00
004C5D28    jz 0x004C5D58                                   ; => [ Data: data_cf65bc ]
...
004C5D39    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C5D4C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C5D51    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004C5D58    mov dword ptr ss:[ebp-0x04], 0x07
004C5D5F    cmp dword ptr ds:[0x00CF65BC], 0x00
004C5D66    jz 0x004C5E1C                                   ; => [ Data: data_cf65bc ]
...
004C5D83    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C5D9A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C5D9F    jmp 0x004C5E1C
004C5DA1    mov ecx, dword ptr ds:[esi+0x04]
004C5DA4    call 0x004B50B0                                 ; => [ Call: sub_4b50b0 ]
...
004C5DB7    call 0x0063B5F0                                 ; => [ String: GameCreateDlgHandleJoinByCodeResponse couldn't find game %d | Call: sub_63b5f0 ]
...
004C5DC8    call 0x004B0E60                                 ; => [ Call: sub_4b0e60 ]
004C5DCD    jmp 0x004C5E1C
004C5DCF    push 0x78
004C5DD1    push 0x00
004C5DD3    push 0x8DBF38
004C5DD8    call 0x00761FC4                                 ; => [ Call: memset | Data: data_8dbf38 ]
004C5DDD    add esp, 0x0C
004C5DE0    mov dword ptr ds:[0x008DBF48], edi              ; => [ Data: data_8dbf48 ]
004C5DE6    mov dword ptr ds:[0x008DBF38], 0x02             ; => [ Data: data_8dbf38 ]
004C5DF0    mov dword ptr ds:[0x008DBF40], 0x00             ; => [ Data: data_8dbf40 ]
004C5DFA    call 0x004BBDB0
004C5DFF    mov edx, eax
004C5E01    mov ecx, 0x8DBF38
004C5E06    mov dword ptr ds:[eax+0x28], 0x17               ; => [ Call: sub_4bbdb0 ]
004C5E0D    call 0x0062B4E0                                 ; => [ Call: sub_62b4e0 ]
004C5E12    mov dword ptr ds:[0x008DB660], 0x10             ; => [ Data: data_8db660 ]
004C5E1C    mov dword ptr ds:[0x008DC148], 0x00             ; => [ Data: data_8dc148 ]
004C5E26    mov ecx, dword ptr ss:[ebp-0x0C]
004C5E29    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C5E30    pop ecx
004C5E31    pop edi
004C5E32    pop esi
