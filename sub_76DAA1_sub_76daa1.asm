...
0076DAAF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076DAB4    mov ecx, dword ptr ds:[edx-0x08]
0076DAB7    xor ecx, eax
0076DAB9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076DABE    mov eax, 0x8B9CF4
0076DAC3    jmp 0x00761FA6                                  ; => [ Data: data_8b9cf4 | Call: __CxxFrameHandler3 ]
