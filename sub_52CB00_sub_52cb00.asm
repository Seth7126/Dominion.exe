...
0052CB07    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
0052CB0C    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052CB11    push 0x00
0052CB13    push 0x00
0052CB15    push 0x01
...
0052CB1D    push 0x02
0052CB1F    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052CB24    add esp, 0x14
0052CB27    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052CB4A    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052CB4F    add esp, 0x0C
0052CB52    call 0x0063BC30
0052CB57    test al, al
0052CB59    jz 0x0052CB5C                                   ; => [ Call: sub_63bc30 ]
0052CB5B    int3
0052CB5C    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
