...
004EDE2D    call 0x004EC8B0                                 ; => [ Call: sub_4ec8b0 ]
004EDE32    mov esi, eax
004EDE34    add esp, 0x08
004EDE37    movzx ebx, si
004EDE3A    mov edi, edx
004EDE3C    mov eax, dword ptr ds:[ebx*4+0x18F8E68]         ; => [ Data: data_18f8e68 ]
...
004EDE57    push 0x18
004EDE59    call 0x00759772                                 ; => [ Call: operator new ]
004EDE5E    mov edx, dword ptr ds:[0x018F8E60]              ; => [ Data: data_18f8e60 ]
004EDE64    add esp, 0x04
004EDE67    mov dword ptr ds:[eax+0x0C], edx
004EDE6A    lea ecx, ds:[edx+0x01]
004EDE6D    mov dword ptr ds:[eax], esi
004EDE6F    mov dword ptr ds:[0x018F8E60], ecx              ; => [ Data: data_18f8e60 ]
004EDE75    mov ecx, dword ptr ds:[ebx*4+0x18F8E68]
004EDE7C    mov dword ptr ds:[eax+0x10], ecx                ; => [ Data: data_18f8e68 ]
004EDE7F    mov dword ptr ds:[ebx*4+0x18F8E68], eax         ; => [ Data: data_18f8e68 ]
