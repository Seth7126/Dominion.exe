...
0050D85D    call 0x00513D60                                 ; => [ Call: sub_513d60 ]
0050D862    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050D867    cmp dword ptr ds:[eax], 0x04
0050D86A    jnz 0x0050D898
0050D86C    mov esi, dword ptr ds:[eax+0x10]
0050D86F    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050D874    push 0x00
0050D876    push 0x00
...
0050D896    pop ebp
0050D897    ret                                             ; => [ Call: sub_5911e0 ]
0050D898    push 0x813AF4
0050D89D    push 0xC59
0050D8A2    push 0x80CD80
0050D8A7    mov edx, 0x801800
0050D8AC    mov ecx, 0x813B08
0050D8B1    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: StampGetPileSetup | String: c.contextType == CONTEXT_SETUP ]
0050D8B6    add esp, 0x0C
0050D8B9    call 0x0063BC30
0050D8BE    test al, al
0050D8C0    jz 0x0050D8C3                                   ; => [ Call: sub_63bc30 ]
0050D8C2    int3
0050D8C3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
