...
00567698    call 0x00761E50                                 ; => [ Call: __chkstk ]
0056769D    mov eax, dword ptr ds:[0x008C4040]
005676A2    xor eax, ebp
005676A4    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
005676A7    push ebx
005676A8    push esi
005676A9    push edi
005676AA    mov ebx, ecx
005676AC    call 0x00573400                                 ; => [ Call: sub_573400 ]
005676B1    push 0x00
005676B3    push 0x00
005676B5    push 0x00
...
005676C1    push 0x19
005676C3    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
005676F5    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
00567714    call 0x00586C00                                 ; => [ Call: sub_586c00 ]
...
0056773C    mov dword ptr ds:[eax], 0x81F168                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_6e60a10fd699e3a335e49565f8de86e7>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
...
0056775F    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
00567774    pop ebx
00567775    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
