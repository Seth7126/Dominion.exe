...
0065F0D7    call 0x0063B870                                 ; => [ String: index >= 0 && index < mSize | Call: sub_63b870 | Data: data_801800 | String: XDynArray<struct TextEntry>::operator [] | String: C:\x\ax2017\Engine\xDynArray.h ]
0065F0DC    add esp, 0x0C
0065F0DF    call 0x0063BC30
0065F0E4    test al, al
0065F0E6    jz 0x0065F0E9                                   ; => [ Call: sub_63bc30 ]
0065F0E8    int3
0065F0E9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
