...
0054312B    call 0x00761E50
00543130    mov eax, dword ptr ds:[0x008C4040]
...
005431AC    movlpd qword ptr ss:[esp+0x4C], xmm0
...
00543369    call 0x0063B870
0054336E    add esp, 0x0C
00543371    call 0x0063BC30
00543376    test al, al
00543378    jz 0x0054337B
0054337A    int3
0054337B    call 0x0063BB00
