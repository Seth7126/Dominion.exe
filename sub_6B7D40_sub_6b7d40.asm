...
006B7D45    push 0x76FFCD                                   ; => [ Call: sub_76ffcd | Type: EHRegistrationNode ]
006B7D4A    mov eax, dword ptr fs:[0x00000000]
006B7D50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006B7D5E    push eax                                        ; => [ Data: __security_cookie ]
006B7D5F    lea eax, ss:[ebp-0x0C]
006B7D62    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006B7D68    mov ecx, 0x4C0
006B7D6D    call 0x00687730
006B7D72    push 0x4C0
006B7D77    mov esi, eax                                    ; => [ Call: sub_687730 ]
006B7D79    push 0x00
006B7D7B    push esi
006B7D7C    call 0x00761FC4                                 ; => [ Call: memset ]
006B7D81    add esp, 0x0C
006B7D84    mov dword ptr ds:[0x0147B07C], esi              ; => [ Data: data_147b07c ]
006B7D8A    cmp dword ptr ds:[0x0147B080], 0x00
006B7D91    mov dword ptr ss:[ebp-0x10], 0x00
006B7D98    jle 0x006B7E83                                  ; => [ Data: data_147b080 ]
006B7D9E    mov edi, 0x147B08C                              ; => [ Data: data_147b08c ]
...
006B7DDF    mov dword ptr ss:[ebp-0x20], 0x00               ; => [ Call: nullptr ]
...
006B7E03    push 0x00
006B7E05    push eax
006B7E06    call 0x0069D970                                 ; => [ Call: nullptr | Call: sub_69d970 ]
...
006B7E2A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006B7E44    mov dword ptr ss:[ebp-0x20], 0x00               ; => [ Call: nullptr ]
...
006B7E76    jnl 0x006B7E83                                  ; => [ Data: data_147b080 ]
006B7E78    mov esi, dword ptr ds:[0x0147B07C]              ; => [ Data: data_147b07c ]
006B7E7E    jmp 0x006B7DA3
006B7E83    mov ecx, dword ptr ss:[ebp-0x0C]
006B7E86    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B7E8D    pop ecx
006B7E8E    pop edi
006B7E8F    pop esi
006B7E90    pop ebx
...
006B7E93    pop ebp
006B7E94    ret
006B7E95    push 0x87CE68                                   ; => [ String: AssetRegistryInitForApp ]
006B7E9A    push 0xB8
006B7E9F    mov ecx, 0x87CF30                               ; => [ String: pAssetTableItem->pDefMap->assetType == pAssetTableItem->assetType ]
006B7EA4    jmp 0x006B7EC6
006B7EA6    push 0x87CE68                                   ; => [ String: AssetRegistryInitForApp ]
006B7EAB    push 0xAC
006B7EB0    mov ecx, 0x87CEA4                               ; => [ String: pAssetTableItem->pDefMap != NULL ]
006B7EB5    jmp 0x006B7EC6
006B7EB7    push 0x87CE68                                   ; => [ String: AssetRegistryInitForApp ]
006B7EBC    push 0xA9
006B7EC1    mov ecx, 0x87CEC8                               ; => [ String: pAssetTableItem->assetType >=0 && pAssetTableItem->assetType < ASSET_TYPE_COUNT ]
006B7EC6    push 0x87CC50
006B7ECB    mov edx, 0x801800
006B7ED0    call 0x0063B870                                 ; => [ String: AssetRegistryInitForApp | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\AssetTypeRegistry.cpp ]
006B7ED5    add esp, 0x0C
006B7ED8    call 0x0063BC30
006B7EDD    test al, al
006B7EDF    jz 0x006B7EE2                                   ; => [ Call: sub_63bc30 ]
006B7EE1    int3
006B7EE2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
