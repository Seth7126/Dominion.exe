...
005BEB68    push 0x76949D                                   ; => [ Call: sub_76949d | Type: EHRegistrationNode ]
005BEB6D    mov eax, dword ptr fs:[0x00000000]
005BEB73    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005BEB74    push ebx
...
005BEB81    push eax                                        ; => [ Data: __security_cookie ]
005BEB82    lea eax, ss:[ebp-0x0C]
005BEB85    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005BEBF3    call 0x005BFFD0                                 ; => [ Call: sub_5bffd0 ]
...
005BEC42    call 0x005BFFD0                                 ; => [ Call: sub_5bffd0 ]
...
005BECAF    call 0x005BE710                                 ; => [ Call: sub_5b0d00 | Call: sub_5be710 ]
005BECB4    movaps xmm1, xmmword ptr ds:[0x00893630]
005BECBB    movaps xmm5, xmmword ptr ds:[0x00893880]        ; => [ Data: data_893880 ]
005BECC2    minps xmm1, xmm0                                ; => [ Data: data_893630 ]
...
005BECD1    movaps xmm4, xmmword ptr ds:[0x008937A0]        ; => [ Data: data_8937a0 ]
005BECD8    maxps xmm5, xmm1
005BECDB    andps xmm4, xmm0
005BECDE    movaps xmm2, xmm5
005BECE1    mulps xmm2, xmm5
005BECE4    cmpps xmm4, xmmword ptr ds:[0x00893380], 0x01   ; => [ Data: data_893380 ]
005BECEC    movaps xmm1, xmm2
005BECEF    movaps xmm0, xmm2
005BECF2    mulps xmm1, xmmword ptr ds:[0x008937F0]         ; => [ Data: data_8937f0 ]
005BECF9    movaps xmm3, xmm4
005BECFC    mulps xmm0, xmmword ptr ds:[0x00893330]         ; => [ Data: data_893330 ]
005BED03    andps xmm4, xmm5
005BED06    addps xmm1, xmmword ptr ds:[0x00893310]         ; => [ String: ~3a*~3a*~3a*~3a*A ]
005BED0D    addps xmm0, xmmword ptr ds:[0x00893350]         ; => [ Data: data_893350 ]
005BED14    mulps xmm1, xmm2
005BED17    mulps xmm0, xmm2
005BED1A    addps xmm1, xmmword ptr ds:[0x00893800]         ; => [ Data: data_893800 ]
005BED21    addps xmm0, xmmword ptr ds:[0x008933B0]         ; => [ Data: data_8933b0 ]
005BED28    mulps xmm1, xmm2
005BED2B    mulps xmm0, xmm2
005BED2E    addps xmm1, xmmword ptr ds:[0x00893320]         ; => [ String: A ]
005BED35    addps xmm0, xmmword ptr ds:[0x008933D0]         ; => [ Data: data_8933d0 ]
...
005BED6A    movups xmmword ptr ds:[esi+edi*4], xmm3         ; => [ String: JCy7JCy7JCy7JCy7 | Data: data_893390 | Data: data_8933c0 ]
...
005BED87    call 0x005C8340                                 ; => [ Call: sub_5c8340 ]
005BED8C    add esp, 0x04
005BED8F    mov eax, edi
005BED91    mov ecx, dword ptr ss:[ebp-0x0C]
005BED94    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005BED9B    pop ecx
005BED9C    pop edi
005BED9D    pop esi
...
005BEDA3    pop ebx
005BEDA4    ret
005BEDA5    call 0x005B0890                                 ; => [ Call: sub_5b0890 ]
005BEDAA    call 0x005B0890                                 ; => [ Call: sub_5b0890 ]
