...
0051BD85    push 0x765605                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?CreateAllocatedNodeData@ResourceManager@details@Concurrency@@QAEPAUSchedulerNode@23@XZ ]
0051BD8A    mov eax, dword ptr fs:[0x00000000]
0051BD90    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051BD9E    push eax                                        ; => [ Data: __security_cookie ]
0051BD9F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0051BDA2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0051BDA8    cmp dword ptr ds:[0x01597DD0], 0x00
0051BDAF    jz 0x0051BDBB                                   ; => [ Data: data_1597dd0 ]
0051BDB1    push 0x816A98                                   ; => [ String: XMap<enum CampaignPiece,struct CampaignPieceDef const *>::SetNumBuckets ]
0051BDB6    jmp 0x0051C4EB
0051BDBB    mov ecx, 0x1000
0051BDC0    call 0x0064C020
0051BDC5    mov edi, eax                                    ; => [ Call: sub_64c020 ]
0051BDC7    mov edx, 0x3FF
0051BDCC    mov dword ptr ds:[0x01597DD0], edi              ; => [ Data: data_1597dd0 ]
0051BDD2    mov esi, 0x93E508                               ; => [ Data: data_93e508 ]
0051BDD7    mov dword ptr ds:[0x01597DD4], edx              ; => [ Data: data_1597dd4 ]
...
0051BDEB    lea ebx, ds:[edx*4]                             ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051BE10    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051BE21    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051BE3B    mov dword ptr ds:[ecx+0x08], eax                ; => [ Data: data_1597dd0 ]
0051BE3E    mov eax, dword ptr ds:[0x01597DD0]              ; => [ Data: data_1597dd0 ]
0051BE43    mov dword ptr ds:[eax+ebx*1], ecx
0051BE46    inc dword ptr ds:[0x01597DD8]                   ; => [ Data: data_1597dd8 ]
0051BE4C    add esi, 0x9C0
0051BE52    cmp esi, 0xA0D808
0051BE58    jz 0x0051BE70
0051BE5A    mov edx, dword ptr ds:[0x01597DD4]              ; => [ Data: data_1597dd4 ]
0051BE60    mov edi, dword ptr ds:[0x01597DD0]              ; => [ Data: data_1597dd0 ]
...
0051BE77    jz 0x0051BE83                                   ; => [ Data: data_1597de8 ]
0051BE79    push 0x816B30                                   ; => [ String: XMap<enum DomCardEnum,struct CardCombos const *>::SetNumBuckets ]
0051BE7E    jmp 0x0051C4EB
0051BE83    mov ecx, 0x1000
0051BE88    call 0x0064C020
0051BE8D    mov edi, eax                                    ; => [ Call: sub_64c020 ]
0051BE8F    mov edx, 0x3FF
0051BE94    mov dword ptr ds:[0x01597DE8], edi              ; => [ Data: data_1597de8 ]
0051BE9A    mov esi, 0x790BC0                               ; => [ Data: data_790bc0 ]
0051BE9F    mov dword ptr ds:[0x01597DEC], edx              ; => [ Data: data_1597dec ]
0051BEA5    mov ecx, dword ptr ds:[esi]
0051BEA7    mov eax, ecx
0051BEA9    sar eax, 0x04
0051BEAC    or eax, ecx
0051BEAE    and edx, eax
0051BEB0    lea ebx, ds:[edx*4]                             ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051BED0    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051BEE1    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051BEFB    mov dword ptr ds:[ecx+0x08], eax                ; => [ Data: data_1597de8 ]
0051BEFE    mov eax, dword ptr ds:[0x01597DE8]              ; => [ Data: data_1597de8 ]
0051BF03    mov dword ptr ds:[eax+ebx*1], ecx
0051BF06    inc dword ptr ds:[0x01597DF0]                   ; => [ Data: data_1597df0 ]
0051BF0C    add esi, 0xCC
0051BF12    cmp esi, 0x7B075C
0051BF18    jz 0x0051BF30                                   ; => [ Data: data_7b075c ]
0051BF1A    mov edx, dword ptr ds:[0x01597DEC]              ; => [ Data: data_1597dec ]
0051BF20    mov edi, dword ptr ds:[0x01597DE8]              ; => [ Data: data_1597de8 ]
...
0051BF37    jz 0x0051BF43                                   ; => [ Data: data_1597df4 ]
0051BF39    push 0x816B70                                   ; => [ String: XMap<enum DomCardCategory,struct CategoryCombos const *>::SetNumBuckets ]
0051BF3E    jmp 0x0051C4EB
0051BF43    mov ecx, 0x1000
0051BF48    call 0x0064C020
0051BF4D    mov edi, eax                                    ; => [ Call: sub_64c020 ]
0051BF4F    mov edx, 0x3FF
0051BF54    mov dword ptr ds:[0x01597DF4], edi              ; => [ Data: data_1597df4 ]
0051BF5A    mov esi, 0x7B0760                               ; => [ Data: data_7b0760 ]
0051BF5F    mov dword ptr ds:[0x01597DF8], edx              ; => [ Data: data_1597df8 ]
0051BF65    mov ecx, dword ptr ds:[esi]
0051BF67    mov eax, ecx
0051BF69    sar eax, 0x04
0051BF6C    or eax, ecx
0051BF6E    and edx, eax
0051BF70    lea ebx, ds:[edx*4]                             ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051BF90    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051BFA1    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051BFBB    mov dword ptr ds:[ecx+0x08], eax                ; => [ Data: data_1597df4 ]
0051BFBE    mov eax, dword ptr ds:[0x01597DF4]              ; => [ Data: data_1597df4 ]
0051BFC3    mov dword ptr ds:[eax+ebx*1], ecx
0051BFC6    inc dword ptr ds:[0x01597DFC]                   ; => [ Data: data_1597dfc ]
0051BFCC    add esi, 0xCC
0051BFD2    cmp esi, 0x7B4E4C
0051BFD8    jz 0x0051BFF0                                   ; => [ Data: data_7b4e4c ]
0051BFDA    mov edx, dword ptr ds:[0x01597DF8]              ; => [ Data: data_1597df8 ]
0051BFE0    mov edi, dword ptr ds:[0x01597DF4]              ; => [ Data: data_1597df4 ]
...
0051BFF7    jz 0x0051C003                                   ; => [ Data: data_1597e18 ]
0051BFF9    push 0x816CD4                                   ; => [ String: XMap<enum DomCardEnum,enum Doodad>::SetNumBuckets ]
0051BFFE    jmp 0x0051C4EB
0051C003    mov ecx, 0x800
0051C008    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
0051C00D    mov edx, 0x78E350                               ; => [ Data: data_78e350 ]
0051C012    mov dword ptr ds:[0x01597E18], eax              ; => [ Data: data_1597e18 ]
0051C017    mov dword ptr ds:[0x01597E1C], 0x1FF            ; => [ Data: data_1597e1c ]
0051C021    mov dword ptr ss:[ebp-0x10], edx                ; => [ Data: data_78e350 ]
0051C024    mov dword ptr ss:[ebp-0x14], 0x00               ; => [ Call: nullptr | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051C044    or esi, ecx
0051C046    and esi, dword ptr ds:[0x01597E1C]              ; => [ Data: data_1597e1c ]
0051C04C    mov eax, dword ptr ds:[eax+esi*4]               ; => [ Data: data_1597e18 ]
...
0051C067    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051C078    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051C097    mov dword ptr ds:[ecx+0x08], eax                ; => [ Data: data_1597e18 ]
0051C09A    mov eax, dword ptr ds:[0x01597E18]
0051C09F    mov dword ptr ds:[eax+esi*4], ecx               ; => [ Data: data_1597e18 ]
0051C0A2    inc dword ptr ds:[0x01597E20]                   ; => [ Data: data_1597e20 ]
...
0051C0D4    jz 0x0051C0E7                                   ; => [ Data: data_1597e0c ]
0051C0D6    push 0x816C88                                   ; => [ String: XMap<enum DomCardEnum,class XArray<enum DomCardCategory> >::SetNumBuckets ]
...
0051C0EC    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
0051C0F1    cmp dword ptr ds:[0x01597E00], 0x00             ; => [ Data: data_1597e00 ]
0051C0F8    mov dword ptr ds:[0x01597E0C], eax              ; => [ Data: data_1597e0c ]
0051C0FD    mov dword ptr ds:[0x01597E10], 0x3FF            ; => [ Data: data_1597e10 ]
0051C107    jz 0x0051C113
0051C109    push 0x816C10                                   ; => [ String: XMap<enum DomCardCategory,class XArray<enum DomCardEnum> >::SetNumBuckets ]
0051C10E    jmp 0x0051C4EB
0051C113    mov ecx, 0x1000
0051C118    call 0x0064C020
0051C11D    mov ebx, 0x7B4E50                               ; => [ Data: data_7b4e50 ]
0051C122    mov dword ptr ds:[0x01597E00], eax              ; => [ Call: sub_64c020 | Data: data_1597e00 ]
0051C127    mov dword ptr ds:[0x01597E04], 0x3FF            ; => [ Data: data_1597e04 ]
0051C131    mov dword ptr ss:[ebp-0x14], ebx                ; => [ Data: data_7b4e50 ]
0051C134    mov edx, dword ptr ds:[ebx]
0051C136    mov edi, edx
0051C138    mov eax, dword ptr ds:[0x01597E0C]
0051C13D    sar edi, 0x04
0051C140    or edi, edx
0051C142    and edi, dword ptr ds:[0x01597E10]              ; => [ Data: data_1597e10 ]
0051C148    mov eax, dword ptr ds:[eax+edi*4]               ; => [ Data: data_1597e0c ]
0051C14B    mov ecx, eax                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051C19A    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051C1AB    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051C1D3    mov dword ptr ds:[ecx+0x10], eax                ; => [ Data: data_1597e0c ]
0051C1D6    mov eax, dword ptr ds:[0x01597E0C]
0051C1DB    mov dword ptr ds:[eax+edi*4], ecx               ; => [ Data: data_1597e0c ]
0051C1DE    inc dword ptr ds:[0x01597E14]                   ; => [ Data: data_1597e14 ]
...
0051C1FF    mov eax, dword ptr ds:[eax+ecx*4]               ; => [ Data: data_1597e0c | Data: data_1597e10 ]
...
0051C215    xor esi, esi                                    ; => [ Call: nullptr ]
...
0051C225    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
0051C22A    mov dword ptr ds:[esi], eax
0051C22C    mov dword ptr ds:[esi+0x04], 0x00
0051C233    mov dword ptr ds:[esi+0x08], 0x10
0051C23A    mov dword ptr ss:[ebp-0x18], 0x00               ; => [ Call: nullptr | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051C266    mov edi, dword ptr ds:[0x01597E04]              ; => [ Data: data_1597e04 ]
0051C26C    mov eax, edi
0051C26E    sar ecx, 0x04
0051C271    or ecx, edx
0051C273    and eax, ecx
0051C275    mov ecx, dword ptr ds:[0x01597E00]
0051C27B    mov eax, dword ptr ds:[ecx+eax*4]               ; => [ Data: data_1597e00 ]
...
0051C2DE    mov eax, dword ptr ds:[eax+edi*4]               ; => [ Data: data_1597e00 ]
...
0051C2F9    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051C30A    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051C332    mov dword ptr ds:[ecx+0x10], eax                ; => [ Data: data_1597e00 ]
0051C335    mov eax, dword ptr ds:[0x01597E00]
0051C33A    mov dword ptr ds:[eax+edi*4], ecx               ; => [ Data: data_1597e00 ]
0051C33D    inc dword ptr ds:[0x01597E08]                   ; => [ Data: data_1597e08 ]
...
0051C35E    mov eax, dword ptr ds:[eax+ecx*4]               ; => [ Data: data_1597e04 | Data: data_1597e00 ]
...
0051C374    xor esi, esi                                    ; => [ Call: nullptr ]
...
0051C387    mov dword ptr ds:[esi], eax                     ; => [ Call: sub_64c020 ]
...
0051C3D5    jnz 0x0051C134                                  ; => [ Data: data_7bf960 ]
0051C3DB    cmp dword ptr ds:[0x01597DDC], 0x00
0051C3E2    jnz 0x0051C4E6                                  ; => [ Data: data_1597ddc ]
...
0051C404    push 0x816BB8                                   ; => [ String: XArray<enum DomCardEnum>::Append ]
0051C409    push 0x96
0051C40E    push 0x816BDC                                   ; => [ String: C:\x\ax2017\Engine\xArray.h ]
0051C413    mov ecx, 0x816BF8                               ; => [ String: mSize < mSizeReserved ]
0051C418    jmp 0x0051C4F7
0051C41D    push 0x816C5C                                   ; => [ String: XArray<enum DomCardCategory>::Append ]
0051C422    push 0x96
0051C427    push 0x816BDC                                   ; => [ String: C:\x\ax2017\Engine\xArray.h ]
0051C42C    mov ecx, 0x816BF8                               ; => [ String: mSize < mSizeReserved ]
0051C431    jmp 0x0051C4F7
0051C436    mov ecx, 0x1000
0051C43B    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
0051C440    mov edx, 0x3FF
0051C445    mov dword ptr ds:[0x01597DDC], eax              ; => [ Data: data_1597ddc ]
0051C44A    mov dword ptr ds:[0x01597DE0], edx              ; => [ Data: data_1597de0 ]
0051C450    mov edi, 0x77F298                               ; => [ Data: data_77f298 ]
...
0051C47B    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0051C48C    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0051C4A6    mov dword ptr ds:[ecx+0x08], eax                ; => [ Data: data_1597ddc ]
0051C4A9    mov eax, dword ptr ds:[0x01597DDC]              ; => [ Data: data_1597ddc ]
0051C4AE    mov dword ptr ds:[eax+esi*4], ecx
0051C4B1    inc dword ptr ds:[0x01597DE4]                   ; => [ Data: data_1597de4 ]
0051C4B7    add edi, 0x1C
0051C4BA    cmp edi, 0x77FCA8
0051C4C0    jnl 0x0051C4D4                                  ; => [ Data: data_77fca8 ]
0051C4C2    mov edx, dword ptr ds:[0x01597DE0]              ; => [ Data: data_1597de0 ]
0051C4C8    mov eax, dword ptr ds:[0x01597DDC]              ; => [ Data: data_1597ddc ]
...
0051C4D7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0051C4DE    pop ecx
0051C4DF    pop edi
0051C4E0    pop esi
0051C4E1    pop ebx
...
0051C4E4    pop ebp
0051C4E5    ret
0051C4E6    push 0x816AE0                                   ; => [ String: XMap<enum DomCardCategory,struct DomCardCategoryDef const *>::SetNumBuckets ]
0051C4EB    push 0x74
0051C4ED    push 0x802620                                   ; => [ String: C:\x\ax2017\Engine\xMap.h ]
0051C4F2    mov ecx, 0x80264C                               ; => [ String: mNodeBuckets == NULL ]
0051C4F7    mov edx, 0x801800
0051C4FC    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0051C501    add esp, 0x0C
0051C504    call 0x0063BC30
0051C509    test al, al
0051C50B    jz 0x0051C50E                                   ; => [ Call: sub_63bc30 ]
0051C50D    int3
0051C50E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
