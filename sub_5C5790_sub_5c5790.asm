...
005C5795    push 0x769868                                   ; => [ Call: sub_769868 | Type: EHRegistrationNode ]
005C579A    mov eax, dword ptr fs:[0x00000000]
005C57A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005C57B2    push esi
005C57B3    push edi
005C57B4    push eax                                        ; => [ Data: __security_cookie ]
005C57B5    lea eax, ss:[ebp-0x0C]
005C57B8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005C581E    call 0x00762210                                 ; => [ Call: __alloca_probe_16 ]
...
005C585A    xor eax, eax                                    ; => [ Call: nullptr ]
...
005C58AB    call 0x00762210                                 ; => [ Call: __alloca_probe_16 ]
...
005C58E1    xor ecx, ecx                                    ; => [ Call: nullptr ]
...
005C5922    xor edx, edx                                    ; => [ Call: nullptr ]
005C5924    mov dword ptr ss:[ebp-0x1C], edx                ; => [ Call: nullptr ]
...
005C5987    push eax
005C5988    push esi
005C5989    call 0x005C6650                                 ; => [ Call: sub_5c6650 ]
...
005C59E0    call 0x005C72F0                                 ; => [ Call: sub_5c72f0 ]
...
005C5A22    push eax
005C5A23    call 0x005C67C0                                 ; => [ Call: sub_5c67c0 ]
...
005C5A9E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005C5AA5    pop ecx
005C5AA6    pop edi
005C5AA7    pop esi
005C5AA8    pop ebx
...
005C5AAE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005C5AB3    mov esp, ebp
005C5AB5    pop ebp
005C5AB6    ret
005C5AB7    call 0x005B0890                                 ; => [ Call: sub_5b0890 ]
005C5ABC    call 0x005B0890                                 ; => [ Call: sub_5b0890 ]
