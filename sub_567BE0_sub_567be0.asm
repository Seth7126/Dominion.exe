...
00567BEB    call 0x00761E50                                 ; => [ Call: __chkstk ]
00567BF0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00567C18    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
...
00567C4E    push 0x00
00567C50    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00567C52    push 0x00
...
00567CEF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00567D10    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00567D2E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00567D44    movlpd qword ptr ss:[esp+0x1C], xmm0            ; => [ Call: __builtin_memset ]
...
00567D6D    push eax
00567D6E    call 0x00586320                                 ; => [ Call: sub_586320 ]
...
00567D83    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00567D99    push ecx
00567D9A    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
00567D9F    add esp, 0x04
00567DA2    push eax
00567DA3    mov edx, edi
00567DA5    mov ecx, esi
00567DA7    call 0x00566C60                                 ; => [ Call: sub_566c60 ]
...
00567DBC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
