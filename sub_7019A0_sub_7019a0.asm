...
007019AC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
007019E3    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
007019F8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701A0C    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701A21    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701A38    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701A4D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00701A52    mov esp, ebp
00701A54    pop ebp
00701A55    ret
00701A56    lea edx, ss:[esp+0x88]
00701A5D    call 0x006433D0                                 ; => [ Call: sub_6433d0 ]
00701A62    lea ecx, ss:[esp+0x88]
00701A69    push ecx
00701A6A    mov edx, eax
00701A6C    mov ecx, esi
00701A6E    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701A83    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701A9A    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701AAF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701AC6    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701ADB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701AF2    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701B07    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701B1E    call 0x006FEF50                                 ; => [ Call: sub_6fef50 ]
...
00701B33    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701B4B    push eax
00701B4C    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
00701B6C    call 0x006D7860                                 ; => [ Call: sub_6d7860 ]
...
00701BDC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701BFF    push 0x872E14                                   ; => [ String: XArray<struct Mat4>::operator [] ]
00701C04    push 0xB5
00701C09    push 0x816BDC                                   ; => [ String: C:\x\ax2017\Engine\xArray.h ]
00701C0E    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
...
00701C32    push 0x88CA64                                   ; => [ String: GLGraphicsSetSpecialRenderState ]
00701C37    push 0xB54
00701C3C    mov ecx, 0x88CAB8                               ; => [ String: pBones && numShaderConstants > 0 ]
00701C41    jmp 0x00702175
00701C46    push 0x87C20C
00701C4B    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: Can't use bones shader on non-animation structure\n ]
...
00701C60    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701CFD    push 0x88C5BC                                   ; => [ String: GLDupCheck_glUniform1f ]
00701D02    push 0x364
00701D07    mov ecx, 0x88C60C                               ; => [ String: registerIndex < MAX_UNIFORMS ]
...
00701D24    jz 0x0070213A                                   ; => [ Data: data_147ded4 ]
...
00701D44    mov dword ptr ds:[ecx+edi*8+0x28], eax          ; => [ Data: data_147ded4 ]
00701D48    mov al, 0x01
00701D4A    pop edi
00701D4B    pop esi
00701D4C    mov ecx, dword ptr ss:[esp+0xF84]
00701D53    xor ecx, esp
00701D55    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701DA3    call 0x006FEE60                                 ; => [ Call: sub_6fee60 ]
...
00701DB8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701E44    push 0x88CA64                                   ; => [ String: GLGraphicsSetSpecialRenderState ]
00701E49    push 0xBC8
...
00701E84    call 0x006FEE60                                 ; => [ Call: sub_6fee60 ]
...
00701EAB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00701EB0    mov esp, ebp
00701EB2    pop ebp
00701EB3    ret
00701EB4    cmp edx, 0x04
00701EB7    jle 0x00701EC8
00701EB9    push 0x88CA64                                   ; => [ String: GLGraphicsSetSpecialRenderState ]
00701EBE    push 0xBD3
00701EC3    jmp 0x00702170
00701EC8    lea eax, ds:[edi+0x278]
00701ECE    mov ecx, esi
00701ED0    push eax
00701ED1    call 0x006FEE60                                 ; => [ Call: sub_6fee60 ]
...
00701EE6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701FB7    push eax
00701FB8    call 0x006FED70                                 ; => [ Call: sub_6fed70 ]
...
00701FCD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00701FE2    call 0x006FED70                                 ; => [ Call: sub_6fed70 | Data: data_cf6a40 ]
...
00701FF7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0070200F    push eax
00702010    call 0x00649DA0                                 ; => [ Call: sub_649da0 ]
...
0070203D    push eax
0070203E    call 0x006FEE60                                 ; => [ Call: sub_6fee60 ]
...
00702053    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00702058    mov esp, ebp
0070205A    pop ebp
0070205B    ret
0070205C    movups xmm0, xmmword ptr ds:[0x00CF6668]
00702063    mov eax, dword ptr ds:[0x00CF6680]              ; => [ Data: data_cf6680 ]
00702068    movups xmmword ptr ss:[esp+0x20], xmm0          ; => [ Data: data_cf6668 ]
0070206D    movq xmm0, qword ptr ds:[0x00CF6678]
00702075    movq qword ptr ss:[esp+0x30], xmm0              ; => [ Data: data_cf6678 ]
0070207B    jmp 0x0070202E
0070207D    push 0xCF65FC
00702082    mov edx, 0x01
00702087    mov ecx, esi
00702089    call 0x006FED70                                 ; => [ Call: sub_6fed70 | Data: data_cf65fc ]
...
0070209E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007020A3    mov esp, ebp
007020A5    pop ebp
007020A6    ret
007020A7    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
007020D7    movss dword ptr ss:[esp+0x28], xmm0             ; => [ Data: data_147b06c ]
...
007020EF    mov eax, dword ptr ds:[0x0147DED4]              ; => [ Data: data_147ded4 ]
...
00702131    push eax
00702132    call 0x006FED70                                 ; => [ Call: sub_6fed70 ]
...
00702147    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0070215D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00702162    mov esp, ebp
00702164    pop ebp
00702165    ret
00702166    push 0x88CA64                                   ; => [ String: GLGraphicsSetSpecialRenderState ]
0070216B    push 0xBDE
00702170    mov ecx, 0x88CAA4                               ; => [ String: registerCount <= 4 | String: registerCount <= 4 | String: registerCount <= 4 ]
00702175    push 0x88C504                                   ; => [ String: C:\x\ax2017\Engine\OpenGLGraphics.cpp ]
0070217A    mov edx, 0x801800
0070217F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00702184    add esp, 0x0C
00702187    call 0x0063BC30
0070218C    test al, al
0070218E    jz 0x00702191                                   ; => [ Call: sub_63bc30 ]
00702190    int3
00702191    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
