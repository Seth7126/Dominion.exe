...
00561E0C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00561E4E    test al, al
00561E50    jz 0x00561EC7                                   ; => [ Call: sub_56b800 | Call: sub_561d80 ]
00561E52    test edi, edi
00561E54    jz 0x00561E6F
00561E56    call 0x00573400                                 ; => [ Call: sub_573400 ]
00561E5B    push 0x00
00561E5D    push ebx
00561E5E    push edi
...
00561E65    push 0x00
00561E67    call 0x00590760                                 ; => [ Call: sub_590760 ]
...
00561E90    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00561EBE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00561EDD    push 0x3EA
00561EE2    push edi
00561EE3    call 0x00588DB0                                 ; => [ Call: nullptr | Call: sub_588db0 ]
00561EE8    add esp, 0x24
00561EEB    cmp dword ptr ss:[ebp+0x08], 0x00
00561EEF    jnz 0x00561F0F
00561EF1    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00561F1B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction | Call: CookieCheckFunction ]
...
00561F3A    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00561F3F    add esp, 0x0C
00561F42    call 0x0063BC30
00561F47    test al, al
00561F49    jz 0x00561F4C                                   ; => [ Call: sub_63bc30 ]
00561F4B    int3
00561F4C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
