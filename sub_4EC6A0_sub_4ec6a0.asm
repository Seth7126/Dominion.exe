...
004EC6D0    mov eax, dword ptr ds:[ebx*4+0x1779F8C]         ; => [ Data: data_1779f8c ]
...
004EC6F4    movups xmmword ptr ds:[0x01777938], xmm0        ; => [ Data: data_1777938 | Data: data_1777948 ]
...
004EC70A    call 0x004EC1A0                                 ; => [ Call: sub_4ec1a0 ]
004EC70F    inc esi
...
004EC79F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomAIMCTS.cpp | Data: data_801800 | String: g.simStyle == SIM_SIMULATION || g.simStyle == SIM_PUZZLE_SEARCH | String: ShuffleUnknowns ]
004EC7A4    add esp, 0x0C
004EC7A7    call 0x0063BC30
004EC7AC    test al, al
004EC7AE    jz 0x004EC7B1                                   ; => [ Call: sub_63bc30 ]
004EC7B0    int3
004EC7B1    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
