...
00732385    push 0x772A0D                                   ; => [ Type: EHRegistrationNode | Call: sub_772a0d ]
0073238A    mov eax, dword ptr fs:[0x00000000]
00732390    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0073239E    push eax                                        ; => [ Data: __security_cookie ]
0073239F    lea eax, ss:[ebp-0x0C]
007323A2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
007323BF    mov edi, 0x801800                               ; => [ Data: data_801800 ]
007323C4    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_6c48e0 ]
007323C6    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
007323FB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073240E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00732413    mov dword ptr ss:[ebp-0x14], edi                ; => [ Data: data_801800 ]
00732416    push 0x147D098
0073241B    lea eax, ss:[ebp-0x1C]
0073241E    mov byte ptr ss:[ebp-0x04], 0x03
00732422    push 0x88E988
00732427    push eax
00732428    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %s/ExternalCode/lame/lame.exe ]
0073242D    mov byte ptr ss:[ebp-0x04], 0x05
00732431    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
00732445    mov ecx, edi                                    ; => [ Data: data_801800 ]
00732447    test eax, eax
00732449    cmovnz ecx, eax
0073244C    call 0x0069DB50                                 ; => [ Call: sub_69db50 ]
00732451    mov eax, dword ptr ss:[ebp+0x08]
00732454    mov ecx, edi                                    ; => [ Data: data_801800 ]
00732456    test eax, eax
00732458    cmovnz ecx, eax
0073245B    push ecx
0073245C    push 0x88E9C0
00732461    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: converting to mp3: %s ]
00732466    mov eax, dword ptr ss:[ebp-0x10]
00732469    mov esi, edi                                    ; => [ Data: data_801800 ]
0073246B    test eax, eax
0073246D    mov edx, edi                                    ; => [ Data: data_801800 ]
0073246F    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0073248F    push eax
00732490    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: "%s" "%s" "%s" ]
00732495    mov byte ptr ss:[ebp-0x04], 0x06
00732499    mov ecx, edi                                    ; => [ Data: data_801800 ]
0073249B    mov eax, dword ptr ss:[ebp-0x18]
0073249E    test eax, eax
007324A0    cmovnz ecx, eax
007324A3    call 0x0069E0A0                                 ; => [ Call: sub_69e0a0 ]
007324A8    mov eax, dword ptr ss:[ebp-0x10]
007324AB    mov ecx, edi                                    ; => [ Data: data_801800 ]
007324AD    test eax, eax
007324AF    push 0x8723C4
007324B4    cmovnz ecx, eax
007324B7    push ecx
007324B8    call dword ptr ds:[0x0077564C]                  ; => [ String: rb | Type: FILE ]
...
007324D6    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: failed to convert to mp3: %s ]
...
00732522    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
007325A1    jz 0x007325D1                                   ; => [ Data: data_cf65bc ]
...
007325B2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
007325C5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
007325CA    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
007325D1    mov byte ptr ss:[ebp-0x04], 0x08
007325D5    cmp dword ptr ds:[0x00CF65BC], 0x00
007325DC    jz 0x0073260C                                   ; => [ Data: data_cf65bc ]
...
007325ED    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00732600    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00732605    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
0073260C    mov byte ptr ss:[ebp-0x04], 0x09
00732610    cmp dword ptr ds:[0x00CF65BC], 0x00
00732617    jz 0x00732647                                   ; => [ Data: data_cf65bc ]
...
00732628    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073263B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00732640    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00732647    mov dword ptr ss:[ebp-0x04], 0x0A
0073264E    cmp dword ptr ds:[0x00CF65BC], 0x00
00732655    jz 0x0073267E                                   ; => [ Data: data_cf65bc ]
...
00732666    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00732679    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0073267E    mov al, bl
00732680    mov ecx, dword ptr ss:[ebp-0x0C]
00732683    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0073268A    pop ecx
0073268B    pop edi
0073268C    pop esi
0073268D    pop ebx
