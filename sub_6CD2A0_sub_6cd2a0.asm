...
006CD2C8    push 0x8811E4
006CD2CD    push 0x559
006CD2D2    push 0x880FE4
006CD2D7    mov ecx, 0x87A4FC
006CD2DC    jmp 0x006CD340
006CD2DE    call 0x005AF880
006CD2E3    mov eax, dword ptr ds:[eax]
...
006CD32C    push 0x8790A8
006CD331    push 0x127
006CD336    push 0x878EA8
006CD33B    mov ecx, 0x8790C8
006CD340    mov edx, 0x801800
006CD345    call 0x0063B870
006CD34A    add esp, 0x0C
006CD34D    call 0x0063BC30
006CD352    test al, al
006CD354    jz 0x006CD357
006CD356    int3
006CD357    jmp 0x0063BB00
006CD35C    call 0x005AF880
006CD361    movups xmm0, xmmword ptr ds:[eax+0x0C]
