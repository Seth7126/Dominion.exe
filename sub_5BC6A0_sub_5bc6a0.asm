...
005BC6B8    push 0x7692AA                                   ; => [ Call: sub_7692aa | Type: EHRegistrationNode ]
005BC6BD    mov eax, dword ptr fs:[0x00000000]
005BC6C3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005BC6C4    push ebx
005BC6C5    sub esp, 0x100
005BC6CB    push esi
005BC6CC    push edi
005BC6CD    mov eax, dword ptr ds:[0x008C4040]
005BC6D2    xor eax, ebp                                    ; => [ Data: __security_cookie ]
005BC6D4    push eax
005BC6D5    lea eax, ss:[ebp-0x0C]
005BC6D8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005BC754    mov dword ptr ss:[ebp-0x3C], 0x00               ; => [ Call: nullptr ]
...
005BC767    xor eax, eax                                    ; => [ Call: nullptr ]
005BC769    mov esi, dword ptr ds:[edi+0x08]
005BC76C    mov dword ptr ss:[ebp-0x38], eax                ; => [ Call: nullptr ]
005BC76F    mov dword ptr ss:[ebp-0x34], eax
005BC772    mov byte ptr ss:[ebp-0x04], 0x04
005BC776    test esi, esi
005BC778    jz 0x005BC79D                                   ; => [ Type: std::exception::std::bad_alloc::VTable ]
...
005BC791    call 0x005C0320                                 ; => [ Call: sub_5c0320 ]
005BC796    jmp 0x005BC79A
005BC798    xor eax, eax                                    ; => [ Call: nullptr ]
...
005BC7AE    push esi
005BC7AF    push 0x01
005BC7B1    mov dword ptr ss:[ebp-0x18], 0x00               ; => [ Call: nullptr ]
005BC7B8    call 0x005C0390                                 ; => [ Call: sub_5c0390 ]
...
005BC7FC    call 0x005C0320                                 ; => [ Call: sub_5c0320 ]
...
005BC811    xor eax, eax                                    ; => [ Call: nullptr ]
005BC813    mov dword ptr ss:[ebp-0x38], eax                ; => [ Call: nullptr ]
...
005BC830    call 0x005C3CD0                                 ; => [ Call: sub_5c3cd0 ]
...
005BC853    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
005BC858    push esi
...
005BC86A    call 0x005BC1C0                                 ; => [ Call: sub_5bc1c0 ]
...
005BC87F    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005BC8C9    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005BC949    jnz 0x005BC950                                  ; => [ Call: sub_5c3ca0 ]
005BC94B    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
...
005BC96B    mov dword ptr ss:[ebp-0xF4], eax                ; => [ Call: sub_5bbe40 ]
...
005BC98C    mov dword ptr ss:[ebp-0xE8], eax                ; => [ Call: sub_5bbe40 ]
...
005BC9A6    call 0x005C5E90                                 ; => [ Call: sub_5c5e90 ]
...
005BC9C9    push eax
005BC9CA    call 0x005C03D0                                 ; => [ Call: sub_5c03d0 ]
...
005BC9FE    call 0x005C0320                                 ; => [ Call: sub_5c0320 ]
005BCA03    jmp 0x005BCA07
005BCA05    xor eax, eax                                    ; => [ Call: nullptr ]
...
005BCA34    call 0x005C1B00                                 ; => [ Call: sub_5c1b00 ]
...
005BCAB2    call 0x005BE9F0                                 ; => [ Call: sub_5be9f0 ]
...
005BCB09    push ecx
005BCB0A    push edx
005BCB0B    call 0x00759661                                 ; => [ Call: operator new ]
005BCB10    add esp, 0x08
005BCB13    mov eax, esi
005BCB15    mov ecx, dword ptr ss:[ebp-0x0C]
005BCB18    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005BCB1F    pop ecx
005BCB20    pop edi
005BCB21    pop esi
...
005BCB2C    call 0x005C8E10                                 ; => [ Call: sub_5c8e10 ]
005BCB31    push 0x8C059C
005BCB36    lea eax, ss:[ebp-0x68]
005BCB39    push eax
005BCB3A    call 0x00761FDC                                 ; => [ Data: data_8c059c | Call: _CxxThrowException ]
005BCB3F    lea ecx, ss:[ebp-0x10C]
005BCB45    call 0x005C8E10                                 ; => [ Type: std::exception::std::bad_alloc::VTable | Call: sub_5c8e10 ]
005BCB4A    push 0x8C059C
005BCB4F    lea eax, ss:[ebp-0x10C]
005BCB55    push eax
005BCB56    call 0x00761FDC                                 ; => [ Data: data_8c059c | Call: _CxxThrowException ]
