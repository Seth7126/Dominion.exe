...
00581B4B    mov ecx, dword ptr ds:[eax]                     ; => [ Call: sub_5722c0 ]
...
00581B5F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00581B73    xor eax, eax                                    ; => [ Call: nullptr ]
...
00581BA0    push esi
00581BA1    call 0x00581A00                                 ; => [ Call: sub_581a00 ]
