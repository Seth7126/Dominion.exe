...
00543491    push eax
00543492    call dword ptr ds:[edx+0x10]
00543495    xorps xmm0, xmm0
00543498    mov dword ptr ss:[ebp-0x1954], 0x00
005434A2    movlpd qword ptr ss:[ebp-0x195C], xmm0
