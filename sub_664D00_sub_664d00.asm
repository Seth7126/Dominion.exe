...
00664D0D    mov dword ptr ss:[ebp-0x04], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Data: __security_cookie ]
00664D10    push ebx
00664D11    push esi
...
00664D23    lahf                                            ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00664D24    test ah, 0x44
00664D27    jnp 0x00665158
00664D2D    inc dword ptr ds:[0x0147ABCC]                   ; => [ Data: data_147abcc ]
00664D33    mov eax, dword ptr ds:[esi+0x1694]
00664D39    mov dword ptr ss:[ebp-0x3C], 0x00               ; => [ Call: nullptr | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00664D4F    push 0x875444                                   ; => [ String: UI2DrawInt ]
00664D54    push 0x335E
00664D59    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
00664D5E    mov ecx, 0x874E50                               ; => [ String: ui.worldInfo.sublayer != -1 ]
00664D63    jmp 0x0066517D
00664D68    shl eax, 0x10
00664D6B    or eax, ecx
00664D6D    cmp byte ptr ds:[0x0147ABA1], 0x00
00664D74    jz 0x00665169                                   ; => [ Data: data_147aba1 ]
00664D7A    mov ecx, dword ptr ds:[0x00CF6B14]
00664D80    mov dword ptr ss:[ebp-0x3C], ecx                ; => [ Data: data_cf6b14 ]
00664D83    mov dword ptr ds:[0x00CF6B14], eax              ; => [ Data: data_cf6b14 ]
...
00664DB1    mov ecx, dword ptr ds:[0x019E2740]              ; => [ Data: data_19e2740 ]
...
00664DE9    movups xmmword ptr ss:[ebp-0x50], xmm4          ; => [ Data: data_19e2730 ]
...
00664E20    call 0x00682560                                 ; => [ Call: sub_682560 ]
...
00664E76    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00664E9D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00664EB8    call 0x006C24D0                                 ; => [ Data: data_bf21e8 | Call: sub_6c24d0 ]
00664EBD    cmp byte ptr ss:[ebp-0x21], 0x00
00664EC1    jz 0x00664ED6
00664EC3    mov eax, dword ptr ds:[0x0147ABE4]              ; => [ Data: data_147abe4 ]
...
00664EEA    jz 0x00665169                                   ; => [ Data: data_147aba1 ]
...
00664F0C    xor dl, dl                                      ; => [ Call: nullptr ]
00664F0E    mov ecx, esi
00664F10    call 0x006645F0                                 ; => [ Call: sub_6645f0 ]
...
00664F2D    call 0x006E65E0                                 ; => [ Call: sub_6e65e0 | Data: data_bf21e8 ]
00664F32    add esp, 0x04
00664F35    jmp 0x00664FEB
00664F3A    mov ecx, esi
00664F3C    call 0x00663980                                 ; => [ Call: sub_663980 ]
...
00664F5A    call 0x006A86B0                                 ; => [ Call: sub_6a86b0 ]
00664F5F    jmp 0x00664FEB
00664F64    mov ecx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
00664F6A    mov eax, dword ptr ds:[esi+0x13B0]
00664F70    test ecx, ecx
00664F72    jnz 0x00664F8A
00664F74    push 0x871F88                                   ; => [ String: GetGameData ]
00664F79    push 0x45
00664F7B    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
00664F80    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
...
00664FAC    call 0x006C24D0                                 ; => [ Data: data_bf21e8 | Call: sub_6c24d0 ]
00664FB1    jmp 0x00664FEB
00664FB3    mov ecx, esi
00664FB5    call 0x00663C20                                 ; => [ Call: sub_663c20 ]
...
00664FD4    call 0x006EADE0                                 ; => [ Call: sub_6eade0 ]
00664FD9    jmp 0x00664FEB
00664FDB    xor dl, dl
00664FDD    mov ecx, esi
00664FDF    call 0x006645F0                                 ; => [ Call: sub_6645f0 ]
00664FE4    mov ecx, esi
00664FE6    call 0x00662820                                 ; => [ Call: sub_662820 | Call: sub_662820 ]
00664FEB    mov ebx, dword ptr ds:[esi+0x189C]
00664FF1    test ebx, ebx
00664FF3    jns 0x0066500E
00664FF5    push 0x87437C                                   ; => [ String: UI2::countChildren ]
00664FFA    push 0xBA8
00664FFF    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
00665004    mov ecx, 0x874310                               ; => [ String: numChildren >= 0 ]
...
0066502A    xor edi, edi                                    ; => [ Call: nullptr ]
...
00665041    movss xmm0, dword ptr ds:[ecx+0x1680]           ; => [ Call: sub_64e7a0 ]
...
0066506E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00665092    mov dword ptr ss:[ebp-0x30], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006650AE    mov dword ptr ss:[ebp-0x2C], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006650C4    call 0x006548E0                                 ; => [ Call: sub_6548e0 ]
...
006650DB    jnz 0x006650B1                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006650FD    mov dword ptr ss:[ebp-0x28], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00665119    call 0x006548E0                                 ; => [ Call: sub_6548e0 ]
...
00665133    jns 0x00665106                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00665135    jmp 0x00664E5B
0066513A    push 0x875444                                   ; => [ String: UI2DrawInt ]
0066513F    push 0x33F4
00665144    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
00665149    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0066514E    jmp 0x0066517D
00665150    mov eax, dword ptr ss:[ebp-0x3C]
00665153    mov dword ptr ds:[0x00CF6B14], eax              ; => [ Data: data_cf6b14 ]
00665158    mov ecx, dword ptr ss:[ebp-0x04]
0066515B    pop edi
0066515C    pop esi
0066515D    xor ecx, ebp
0066515F    pop ebx
00665160    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00665165    mov esp, ebp
00665167    pop ebp
00665168    ret
00665169    push 0x8728D8                                   ; => [ String: Draw3DLayer ]
0066516E    push 0x32C
00665173    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
00665178    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
0066517D    mov edx, 0x801800
00665182    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00665187    add esp, 0x0C
0066518A    call 0x0063BC30
0066518F    test al, al
00665191    jz 0x00665194                                   ; => [ Call: sub_63bc30 ]
00665193    int3
00665194    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
