...
006CF765    push 0x770C29                                   ; => [ Call: sub_770c29 | Type: EHRegistrationNode ]
006CF76A    mov eax, dword ptr fs:[0x00000000]
006CF770    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006CF781    push esi
006CF782    push edi
006CF783    push eax                                        ; => [ Data: __security_cookie ]
006CF784    lea eax, ss:[ebp-0x0C]
006CF787    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006CF7FE    push eax
006CF7FF    movups xmmword ptr ss:[ebp-0x7C], xmm0          ; => [ Call: sub_4eb2f0 ]
...
006CF826    call 0x004EB600                                 ; => [ Call: sub_4eb600 ]
...
006CF860    mov dword ptr ds:[0x00CF6A40], eax              ; => [ Data: data_cf6a40 ]
006CF865    movups xmm0, xmmword ptr ds:[esi+0xB8]
006CF86C    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
006CF871    movups xmmword ptr ds:[0x00CF6A44], xmm0        ; => [ Data: data_cf6a40 ]
006CF878    cmp byte ptr ds:[eax+0x39], 0x00
006CF87C    jz 0x006CF993
006CF882    lea ecx, ss:[ebp-0x30]
006CF885    call 0x006830D0                                 ; => [ Call: sub_6830d0 ]
006CF88A    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006CF8C2    movups xmm0, xmmword ptr ds:[eax]               ; => [ Data: data_7ffb14 | Call: sub_5af7f0 ]
006CF8C5    mov eax, dword ptr fs:[0x0000002C]              ; => [ Field: ThreadLocalStoragePointer ]
006CF8CB    movups xmmword ptr ss:[ebp-0x20], xmm0
006CF8CF    mov ecx, dword ptr ds:[eax]
006CF8D1    mov eax, dword ptr ds:[0x01A9A310]              ; => [ Data: data_1a9a310 ]
006CF8D6    cmp eax, dword ptr ds:[ecx+0x08]
006CF8DC    jle 0x006CF923
006CF8DE    push 0x1A9A310
006CF8E3    call 0x0075970E                                 ; => [ Data: data_1a9a310 | Call: sub_75970e ]
006CF8E8    add esp, 0x04
006CF8EB    cmp dword ptr ds:[0x01A9A310], 0xFFFFFFFF
006CF8F2    jnz 0x006CF923                                  ; => [ Data: data_1a9a310 ]
...
006CF90F    mov dword ptr ds:[0x01A9A314], eax              ; => [ String: sys/editor/env_probe.texture | Data: data_1a9a314 | Call: sub_69f030 ]
006CF914    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006CF91B    call 0x007596BD                                 ; => [ Data: data_1a9a310 | Call: __Init_thread_footer ]
...
006CF98E    call 0x00649D30                                 ; => [ Call: sub_649d30 ]
006CF993    mov ecx, dword ptr ss:[ebp-0x0C]
006CF996    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006CF99D    pop ecx
006CF99E    pop edi
006CF99F    pop esi
006CF9A0    mov ecx, dword ptr ss:[ebp-0x10]
006CF9A3    xor ecx, ebp
006CF9A5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006CFA3A    call 0x00645840                                 ; => [ Call: sub_645840 ]
006CFA3F    add esp, 0x04
006CFA42    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
006CFA47    cmp byte ptr ds:[eax+0x39], 0x00
006CFA4B    jz 0x006CF993
006CFA51    lea ecx, ss:[ebp-0x30]
006CFA54    call 0x006830D0                                 ; => [ Call: sub_6830d0 ]
006CFA59    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006CFA8E    movups xmm0, xmmword ptr ds:[eax]               ; => [ Data: data_7ffb14 | Call: sub_5af7f0 ]
006CFA91    mov eax, dword ptr fs:[0x0000002C]              ; => [ Field: ThreadLocalStoragePointer ]
006CFA97    movups xmmword ptr ss:[ebp-0x20], xmm0
006CFA9B    mov esi, dword ptr ds:[eax]
006CFA9D    mov eax, dword ptr ds:[0x01A9A318]              ; => [ Data: data_1a9a318 ]
006CFAA2    cmp eax, dword ptr ds:[esi+0x08]
006CFAA8    jle 0x006CFAEF
006CFAAA    push 0x1A9A318
006CFAAF    call 0x0075970E                                 ; => [ Data: data_1a9a318 | Call: sub_75970e ]
006CFAB4    add esp, 0x04
006CFAB7    cmp dword ptr ds:[0x01A9A318], 0xFFFFFFFF
006CFABE    jnz 0x006CFAEF                                  ; => [ Data: data_1a9a318 ]
...
006CFADB    mov dword ptr ds:[0x01A9A31C], eax              ; => [ String: sys/editor/light.texture | Data: data_1a9a31c | Call: sub_69f030 ]
006CFAE0    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006CFAE7    call 0x007596BD                                 ; => [ Data: data_1a9a318 | Call: __Init_thread_footer ]
...
006CFB04    call 0x00682A60                                 ; => [ Call: nullptr | Data: data_7ff520 | Data: data_bf23ac | Data: data_1a9a31c | Call: sub_682a60 ]
006CFB09    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
006CFB0E    add esp, 0x0C
006CFB11    mov dword ptr ds:[eax+0x2DC], 0x00
006CFB1B    movups xmm0, xmmword ptr ds:[0x00800890]
006CFB22    movups xmmword ptr ds:[eax+0x124], xmm0         ; => [ Call: __builtin_memcpy | String:  ]
...
006CFB5A    call 0x00649D30                                 ; => [ Call: sub_649d30 ]
006CFB5F    mov eax, dword ptr ds:[0x01A9A320]              ; => [ Data: data_1a9a320 ]
006CFB64    cmp eax, dword ptr ds:[esi+0x08]
006CFB6A    jle 0x006CFBB1
006CFB6C    push 0x1A9A320
006CFB71    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a9a320 ]
006CFB76    add esp, 0x04
006CFB79    cmp dword ptr ds:[0x01A9A320], 0xFFFFFFFF
006CFB80    jnz 0x006CFBB1                                  ; => [ Data: data_1a9a320 ]
...
006CFB9D    mov dword ptr ds:[0x01A9A324], eax              ; => [ Data: data_1a9a324 | String: sys/editor/arrow_widget.structure | Call: sub_69f030 ]
006CFBA2    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006CFBA9    call 0x007596BD                                 ; => [ Data: data_1a9a320 | Call: __Init_thread_footer ]
006CFBAE    add esp, 0x04
006CFBB1    cmp byte ptr ds:[0x0147ABA1], 0x00
006CFBB8    movaps xmm0, xmmword ptr ds:[0x00893570]
006CFBBF    jnz 0x006CFBDA                                  ; => [ Data: data_147aba1 ]
006CFBC1    push 0x8728B4                                   ; => [ String: Draw3DSetMaterialColor ]
006CFBC6    push 0x304
006CFBCB    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
006CFBD0    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
006CFBD5    jmp 0x006CFC81
006CFBDA    movups xmm1, xmmword ptr ss:[ebp-0x90]
006CFBE1    mov ecx, dword ptr ds:[0x01A9A324]              ; => [ Data: data_1a9a324 ]
006CFBE7    lea edx, ss:[ebp-0x30]
006CFBEA    movups xmmword ptr ds:[0x00CF6A70], xmm0        ; => [ Data: data_893570 | Data: data_cf6a70 ]
006CFBF1    push 0x00
...
006CFC1B    call 0x00648920                                 ; => [ Call: sub_648920 ]
006CFC20    add esp, 0x0C
006CFC23    cmp byte ptr ds:[0x0147ABA1], 0x00
006CFC2A    jnz 0x006CFC42                                  ; => [ Data: data_147aba1 ]
006CFC2C    push 0x8728B4                                   ; => [ String: Draw3DSetMaterialColor ]
006CFC31    push 0x304
006CFC36    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
006CFC3B    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
006CFC40    jmp 0x006CFC81
006CFC42    movups xmm0, xmmword ptr ds:[0x007FEFB0]
006CFC49    movups xmmword ptr ds:[0x00CF6A70], xmm0        ; => [ Data: data_7fefb0 | Data: data_cf6a70 ]
006CFC50    jmp 0x006CF993
006CFC55    push 0x87EF34                                   ; => [ String: FabLightDraw ]
006CFC5A    push 0x536
006CFC5F    jmp 0x006CFC77
006CFC61    push 0x87EF34                                   ; => [ Call: nullptr | String: FabLightDraw ]
006CFC66    push 0x539
006CFC6B    jmp 0x006CFC77
006CFC6D    push 0x87EF34                                   ; => [ String: FabLightDraw ]
006CFC72    push 0x53C
006CFC77    push 0x87ED1C                                   ; => [ String: C:\x\ax2017\Engine\FabDef.cpp ]
006CFC7C    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006CFC81    mov edx, 0x801800
006CFC86    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006CFC8B    add esp, 0x0C
006CFC8E    call 0x0063BC30
006CFC93    test al, al
006CFC95    jz 0x006CFC98                                   ; => [ Call: sub_63bc30 ]
006CFC97    int3
006CFC98    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
