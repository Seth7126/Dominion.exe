...
00695C85    push 0x76EFCD                                   ; => [ Call: __ehhandler$??$initialize_tmpfile_buffer_nolock@D@@YA_NW4buffer_id@?A0x5b9a7937@@@Z | Type: EHRegistrationNode ]
00695C8A    mov eax, dword ptr fs:[0x00000000]
00695C90    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00695C9E    push eax                                        ; => [ Data: __security_cookie ]
00695C9F    lea eax, ss:[ebp-0x0C]
00695CA2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00695CA8    mov dword ptr ss:[ebp-0x20], edx
00695CAB    mov ecx, dword ptr ds:[ecx]
00695CAD    test ecx, ecx
00695CAF    jz 0x00695E7B                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00695CE2    mov ebx, dword ptr ds:[eax+0x1C]                ; => [ Data: data_147b07c ]
00695CE5    mov dword ptr ss:[ebp-0x18], ebx
00695CE8    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
00695D21    call 0x00694DA0                                 ; => [ Call: sub_694da0 ]
...
00695D63    mov edx, edi                                    ; => [ Data: data_801800 ]
00695D65    mov ecx, dword ptr ds:[ecx+0x20]
00695D68    test ecx, ecx
00695D6A    cmovnz edx, ecx
00695D6D    lea ecx, ss:[ebp-0x10]
00695D70    call 0x006C48E0                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_6c48e0 ]
00695D75    mov dword ptr ss:[ebp-0x04], 0x00
00695D7C    mov ecx, edi                                    ; => [ Data: data_801800 ]
00695D7E    mov eax, dword ptr ss:[ebp-0x10]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00695D81    test eax, eax
00695D83    push 0x8723C4
00695D88    cmovnz ecx, eax
00695D8B    push ecx
00695D8C    call dword ptr ds:[0x0077564C]                  ; => [ String: rb | Type: FILE ]
...
00695E04    jz 0x00695E34                                   ; => [ Data: data_cf65bc ]
00695E06    mov eax, dword ptr ss:[ebp-0x10]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00695E15    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00695E28    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00695E2D    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
00695E48    push esi
00695E49    push ebx
00695E4A    call 0x00695020                                 ; => [ Call: sub_695020 ]
...
00695E80    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00695E87    pop ecx
00695E88    pop edi
00695E89    pop esi
00695E8A    pop ebx
...
00695E8D    pop ebp
00695E8E    ret
00695E8F    mov eax, dword ptr ss:[ebp-0x10]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00695E92    mov ecx, 0x801800                               ; => [ Data: data_801800 | Type: _EXCEPTION_REGISTRATION_RECORD ]
00695E97    test eax, eax
00695E99    cmovnz ecx, eax
00695E9C    push ecx                                        ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
00695E9D    push 0x878BC0
00695EA2    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: DefBinWritePackAssets Failed to open %s ]
00695EA7    add esp, 0x08
00695EAA    mov dword ptr ss:[ebp-0x04], 0x01
00695EB1    cmp dword ptr ds:[0x00CF65BC], 0x00
00695EB8    jz 0x00695EE1                                   ; => [ Data: data_cf65bc ]
...
00695EC9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00695EDC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00695EE1    xor al, al
00695EE3    mov ecx, dword ptr ss:[ebp-0x0C]
00695EE6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00695EED    pop ecx
00695EEE    pop edi
00695EEF    pop esi
00695EF0    pop ebx
...
00695EF3    pop ebp
00695EF4    ret
00695EF5    push 0x8770A0                                   ; => [ String: XMalloc ]
00695EFA    push 0x57
00695EFC    push 0x877080                                   ; => [ String: C:\x\ax2017\Engine\xMemory.cpp ]
00695F01    mov ecx, 0x8770C8                               ; => [ String: pBuffer ]
00695F06    jmp 0x00695F55
00695F08    push 0x8770A0                                   ; => [ String: XMalloc ]
00695F0D    push 0x3E
00695F0F    push 0x877080                                   ; => [ String: C:\x\ax2017\Engine\xMemory.cpp ]
00695F14    mov ecx, 0x8770A8                               ; => [ String: size < 2000000000 ]
00695F19    jmp 0x00695F55
00695F1B    push 0x8770A0                                   ; => [ String: XMalloc ]
00695F20    push 0x3D
00695F22    push 0x877080                                   ; => [ String: C:\x\ax2017\Engine\xMemory.cpp ]
00695F27    mov ecx, 0x8770BC                               ; => [ String: size > 0 ]
00695F2C    jmp 0x00695F55
00695F2E    push 0x87943C                                   ; => [ String: DefinitionGetSize ]
00695F33    push 0x6D
00695F35    push 0x879400                                   ; => [ String: C:\x\ax2017\Engine\Definition.cpp ]
00695F3A    mov ecx, 0x87948C                               ; => [ String: pDefMap->definitionSize != 0 ]
00695F3F    jmp 0x00695F55
00695F41    push 0x87CF18                                   ; => [ String: AssetTypeGetInfo ]
00695F46    push 0xC3
00695F4B    push 0x87CC50                                   ; => [ String: C:\x\ax2017\Engine\AssetTypeRegistry.cpp ]
00695F50    mov ecx, 0x87CF74                               ; => [ String: assetType >= 0 && assetType < ASSET_TYPE_COUNT ]
00695F55    mov edx, edi
00695F57    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00695F5C    add esp, 0x0C
00695F5F    call 0x0063BC30
00695F64    test al, al
00695F66    jz 0x00695F69                                   ; => [ Call: sub_63bc30 ]
00695F68    int3
00695F69    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00695F6E    push 0x878BA8                                   ; => [ String: DefBinWritePackAssets ]
00695F73    push 0x4A6
00695F78    mov ecx, 0x878BEC                               ; => [ String: read_len == (size_t)dataSize ]
00695F7D    jmp 0x00695F8E
00695F7F    push 0x878BA8                                   ; => [ String: DefBinWritePackAssets ]
00695F84    push 0x4A0
00695F89    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00695F8E    push 0x878868
00695F93    mov edx, 0x801800
00695F98    call 0x0063B870                                 ; => [ String: DefBinWritePackAssets | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\DefBin.cpp ]
00695F9D    add esp, 0x0C
00695FA0    call 0x0063BC30
00695FA5    test al, al
00695FA7    jz 0x00695FAA                                   ; => [ Call: sub_63bc30 ]
00695FA9    int3
00695FAA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
