...
0055F03B    call 0x00761E50
0055F040    mov eax, dword ptr ds:[0x008C4040]
...
0055F059    movlpd qword ptr ss:[esp+0x2C], xmm0
...
0055F102    mov dword ptr ss:[esp+0x14], eax
0055F106    call 0x0056B800
0055F10B    mov dword ptr ss:[esp+0x24], eax
0055F10F    call 0x00573400
