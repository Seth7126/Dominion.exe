...
0064AAA5    push 0x76C73D                                   ; => [ Type: EHRegistrationNode | Call: sub_76c73d ]
0064AAAA    mov eax, dword ptr fs:[0x00000000]
0064AAB0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064AABE    push esi
0064AABF    push edi
0064AAC0    push eax                                        ; => [ Data: __security_cookie ]
0064AAC1    lea eax, ss:[ebp-0x0C]
0064AAC4    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0064AACA    mov eax, ecx
0064AACC    mov dword ptr ss:[ebp-0x38], eax
0064AACF    test eax, eax
0064AAD1    jnz 0x0064AAE7
0064AAD3    push 0x872E04                                   ; => [ String: Draw3DSkyBox ]
0064AAD8    push 0xBE1
0064AADD    mov ecx, 0x8722AC                               ; => [ String: texture ]
0064AAE2    jmp 0x0064AC64
0064AAE7    mov eax, dword ptr fs:[0x0000002C]
0064AAED    mov esi, dword ptr ds:[eax]                     ; => [ Field: ThreadLocalStoragePointer ]
0064AAEF    mov eax, dword ptr ds:[0x01A98F80]
0064AAF4    cmp eax, dword ptr ds:[esi+0x08]
0064AAFA    jle 0x0064AB41                                  ; => [ Data: data_1a98f80 ]
0064AAFC    push 0x1A98F80
0064AB01    call 0x0075970E                                 ; => [ Data: data_1a98f80 | Call: sub_75970e ]
0064AB06    add esp, 0x04
0064AB09    cmp dword ptr ds:[0x01A98F80], 0xFFFFFFFF
0064AB10    jnz 0x0064AB41                                  ; => [ Data: data_1a98f80 ]
...
0064AB2D    mov dword ptr ds:[0x01A98F84], eax              ; => [ Data: data_1a98f84 | String: sys/skybox.material | Call: sub_69f030 ]
0064AB32    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0064AB39    call 0x007596BD                                 ; => [ Data: data_1a98f80 | Call: __Init_thread_footer ]
0064AB3E    add esp, 0x04
0064AB41    mov eax, dword ptr ds:[0x01A98F88]
0064AB46    mov edx, dword ptr ds:[0x01A98F84]              ; => [ Data: data_1a98f84 ]
0064AB4C    mov dword ptr ss:[ebp-0x34], edx
0064AB4F    cmp eax, dword ptr ds:[esi+0x08]
0064AB55    jle 0x0064AB9F                                  ; => [ Data: data_1a98f88 ]
0064AB57    push 0x1A98F88
0064AB5C    call 0x0075970E                                 ; => [ Data: data_1a98f88 | Call: sub_75970e ]
0064AB61    add esp, 0x04
0064AB64    cmp dword ptr ds:[0x01A98F88], 0xFFFFFFFF
0064AB6B    jnz 0x0064AB9C                                  ; => [ Data: data_1a98f88 ]
...
0064AB88    mov dword ptr ds:[0x01A98F8C], eax              ; => [ String: sys/skybox.structure | Data: data_1a98f8c | Call: sub_69f030 ]
0064AB8D    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0064AB94    call 0x007596BD                                 ; => [ Data: data_1a98f88 | Call: __Init_thread_footer ]
0064AB99    add esp, 0x04
0064AB9C    mov edx, dword ptr ss:[ebp-0x34]
0064AB9F    mov eax, dword ptr ds:[0x01A98F8C]              ; => [ Data: data_1a98f8c ]
0064ABA4    xor edi, edi
0064ABA6    mov dword ptr ss:[ebp-0x3C], eax
0064ABA9    mov esi, 0xCF6614                               ; => [ Data: data_cf6614 ]
0064ABAE    nop
0064ABB0    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
0064ABC7    jz 0x0064AC55                                   ; => [ Data: data_147aba1 ]
...
0064ABE0    mov dword ptr ds:[0x00CF6B38], eax              ; => [ Data: data_cf6b38 ]
...
0064AC0C    movups xmmword ptr ss:[ebp-0x2C], xmm0          ; => [ Data: data_800248 ]
0064AC10    call 0x00648920                                 ; => [ Call: sub_648920 ]
0064AC15    add esp, 0x0C
0064AC18    mov edx, dword ptr ss:[ebp-0x34]
0064AC1B    add esi, 0x1C
0064AC1E    inc edi
0064AC1F    cmp esi, 0xCF664C
0064AC25    jle 0x0064ABB0                                  ; => [ Data: data_cf664c ]
0064AC27    cmp byte ptr ds:[0x0147ABA1], 0x00
0064AC2E    jz 0x0064AC55                                   ; => [ Data: data_147aba1 ]
0064AC30    mov dword ptr ds:[0x00CF6B38], 0x07             ; => [ Data: data_cf6b38 ]
0064AC3A    mov ecx, dword ptr ss:[ebp-0x0C]
0064AC3D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064AC44    pop ecx
0064AC45    pop edi
0064AC46    pop esi
0064AC47    mov ecx, dword ptr ss:[ebp-0x10]
0064AC4A    xor ecx, ebp
0064AC4C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0064AC51    mov esp, ebp
0064AC53    pop ebp
0064AC54    ret
0064AC55    push 0x8728E4                                   ; => [ String: Draw3DSetDrawEyeMask ]
0064AC5A    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
0064AC5F    push 0x324
0064AC64    push 0x872630
0064AC69    mov edx, 0x801800
0064AC6E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Draw3d.cpp ]
0064AC73    add esp, 0x0C
0064AC76    call 0x0063BC30
0064AC7B    test al, al
0064AC7D    jz 0x0064AC80                                   ; => [ Call: sub_63bc30 ]
0064AC7F    int3
0064AC80    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
