...
005EC8E8    push 0x76A25D                                   ; => [ Type: EHRegistrationNode | Call: sub_76a25d ]
005EC8ED    mov eax, dword ptr fs:[0x00000000]
005EC8F3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005EC8F4    push ebx
005EC8F5    sub esp, 0xA0
005EC8FB    mov eax, dword ptr ds:[0x008C4040]
005EC900    xor eax, ebp                                    ; => [ Data: __security_cookie ]
005EC902    mov dword ptr ss:[ebp-0x14], eax
005EC905    push esi
005EC906    push edi
005EC907    push eax
005EC908    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
005EC90B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005EC911    movss dword ptr ss:[ebp-0x3C], xmm0
005EC916    cmp byte ptr ds:[0x00CCF768], 0x00
005EC91D    jz 0x005ED04B                                   ; => [ Data: data_ccf768 ]
005EC923    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
005EC92A    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
005EC92F    mov edi, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
005EC935    mov ecx, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
005EC93B    mov esi, dword ptr ds:[0x008DB5D4]              ; => [ Data: data_8db5d4 ]
...
005EC99F    jnz 0x005EC9D1                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005EC9A1    mov ecx, edx
005EC9A3    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005EC9A8    mov edi, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
005EC9AE    mov esi, dword ptr ds:[0x008DB5D4]              ; => [ Data: data_8db5d4 ]
005EC9B4    mov ecx, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
...
005EC9D8    movups xmmword ptr ss:[ebp-0x90], xmm0          ; => [ Data: data_bf21e8 | Data: data_bf21e8 | Data: data_bf21e8 ]
005EC9DF    movups xmm0, xmmword ptr ds:[0x00BF21F8]        ; => [ Data: data_bf21f8 | Data: data_bf21f8 | Data: data_bf21f8 ]
005EC9E6    cmp dword ptr ds:[0x008DB5C4], 0x27
005EC9ED    movups xmmword ptr ss:[ebp-0x80], xmm0
005EC9F1    jz 0x005EC9FB                                   ; => [ Data: data_8db5c4 ]
005EC9F3    xor ecx, ecx
005EC9F5    cmp esi, 0x27
005EC9F8    cmovz ecx, edi
005EC9FB    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005ECA28    subss xmm0, xmm1                                ; => [ Data: data_ccf770 ]
005ECA2C    movss dword ptr ds:[0x00CCF780], xmm1           ; => [ Data: data_ccf780 ]
005ECA34    movaps xmm2, xmm1
005ECA37    maxss xmm2, xmm0
005ECA3B    movss xmm0, dword ptr ds:[0x00CCF774]           ; => [ Data: data_ccf774 ]
005ECA43    movaps xmm3, xmm0
005ECA46    movss dword ptr ss:[ebp-0x38], xmm0
005ECA4B    addss xmm3, dword ptr ds:[0x00CCF778]           ; => [ Data: data_ccf778 ]
005ECA53    movss xmm0, dword ptr ds:[0x008937C0]
005ECA5B    movss dword ptr ds:[0x00CCF784], xmm2           ; => [ Data: data_ccf784 ]
005ECA63    xorps xmm2, xmm0
005ECA66    comiss xmm2, xmm3
005ECA69    movss dword ptr ss:[ebp-0x40], xmm3
005ECA6E    movss dword ptr ds:[0x00CCF778], xmm3           ; => [ Data: data_ccf778 ]
...
005ECA9C    call 0x00762090                                 ; => [ Call: _libm_sse2_pow_precise ]
...
005ECACC    minss xmm1, xmm0                                ; => [ Data: data_8937c0 ]
...
005ECAFE    call 0x00762090                                 ; => [ Call: _libm_sse2_pow_precise ]
...
005ECB5D    cvtps2pd xmm0, xmm0                             ; => [ Data: data_ccf77c ]
005ECB60    cvtps2pd xmm1, xmm1
005ECB63    call 0x00762090                                 ; => [ Call: _libm_sse2_pow_precise ]
005ECB68    cmp dword ptr ds:[0x00CD3188], 0x00             ; => [ Data: data_cd3188 ]
005ECB6F    movss xmm3, dword ptr ss:[ebp-0x90]
005ECB77    cvtsd2ss xmm0, xmm0
005ECB7B    mov dword ptr ss:[ebp-0x54], 0x00               ; => [ Call: nullptr | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005ECB96    movss dword ptr ds:[0x00CCF774], xmm0           ; => [ Data: data_ccf774 ]
...
005ECBD8    mov dword ptr ss:[ebp-0x3C], 0x00               ; => [ Call: nullptr ]
005ECBDF    mulss xmm1, xmm0
005ECBE3    mov edi, 0xCCF78C                               ; => [ Data: data_ccf78c ]
005ECBE8    mov dword ptr ss:[ebp-0x44], edi                ; => [ Data: data_ccf78c ]
...
005ECC0B    call 0x00654CE0                                 ; => [ Data: data_171e82c | Call: sub_654ce0 | Call: nullptr | String: kv label ]
...
005ECC20    movups xmm0, xmmword ptr ds:[0x00800248]        ; => [ Data: data_800248 ]
...
005ECC85    call 0x00666060                                 ; => [ Call: sub_666060 ]
...
005ECD02    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005ECD15    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005ECD1A    mov dword ptr ss:[ebp-0x4C], 0x801800           ; => [ Data: data_801800 ]
...
005ECD40    mov esi, 0xBE4458                               ; => [ Data: data_be4458 ]
005ECD45    jmp 0x005ECD53
005ECD47    mov esi, 0xBE444C                               ; => [ Data: data_be444c ]
005ECD4C    jmp 0x005ECD53
005ECD4E    mov esi, 0xBE4440                               ; => [ Data: data_be4440 ]
005ECD53    mov ecx, edi
005ECD55    mov ecx, dword ptr ds:[ecx]
005ECD57    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005ECD7D    call 0x00666120                                 ; => [ Data: data_be4464 | Call: sub_665db0 | Call: sub_666120 ]
005ECD82    xor ecx, ecx                                    ; => [ Call: nullptr ]
005ECD84    add esp, 0x10
005ECD87    mov dword ptr ss:[ebp-0x38], ecx                ; => [ Call: nullptr ]
...
005ECDF2    jnz 0x005ECE25                                  ; => [ Data: data_1a8cae0 | Data: data_1a8cad8 | Data: data_1a8cadc | Data: data_1a8cae4 | String: tbl_landscapes ]
005ECDF4    mov edi, dword ptr ds:[esi*4+0x1A8CAF8]         ; => [ Data: data_1a8caf8 ]
...
005ECE1C    jz 0x005ECF03                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005ECE22    mov eax, dword ptr ss:[ebp-0x48]
005ECE25    push ecx
005ECE26    mov edx, 0x860210
005ECE2B    mov ecx, eax
005ECE2D    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
005ECE32    mov ecx, dword ptr ss:[ebp-0x38]
005ECE35    mov edi, eax
005ECE37    add esp, 0x04
005ECE3A    mov dword ptr ds:[esi*4+0x1A8CAF8], edi         ; => [ Data: data_1a8caf8 ]
005ECE41    test edi, edi
005ECE43    jz 0x005ECF03
005ECE49    mov dword ptr ds:[esi*4+0x1A8CADC], 0x860210    ; => [ Data: data_1a8cadc | String: tbl_landscapes ]
...
005ECE8D    jnz 0x005ECEBC                                  ; => [ Data: data_1a8cae0 | Data: data_1a8cad8 | Data: data_1a8cadc | Data: data_1a8cae4 | String: tbl_cards ]
005ECE8F    mov edi, dword ptr ds:[esi*4+0x1A8CAF8]         ; => [ Data: data_1a8caf8 ]
...
005ECEB7    jz 0x005ECF03                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005ECEB9    mov eax, dword ptr ss:[ebp-0x48]
005ECEBC    push ecx
005ECEBD    mov edx, 0x85EF44
005ECEC2    mov ecx, eax
005ECEC4    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
005ECEC9    mov ecx, dword ptr ss:[ebp-0x38]
005ECECC    mov edi, eax
005ECECE    add esp, 0x04
005ECED1    mov dword ptr ds:[esi*4+0x1A8CAF8], edi         ; => [ Data: data_1a8caf8 ]
005ECED8    test edi, edi
005ECEDA    jz 0x005ECF03
005ECEDC    mov dword ptr ds:[esi*4+0x1A8CADC], 0x85EF44    ; => [ String: tbl_cards | Data: data_1a8cadc ]
005ECEE7    mov eax, dword ptr ss:[ebp-0x48]
005ECEEA    mov dword ptr ds:[esi*4+0x1A8CAE4], 0x00        ; => [ Data: data_1a8cae4 ]
005ECEF5    mov dword ptr ds:[esi*4+0x1A8CAE0], ecx         ; => [ Data: data_1a8cae0 ]
005ECEFC    mov dword ptr ds:[esi*4+0x1A8CAD8], eax         ; => [ Data: data_1a8cad8 ]
...
005ECF19    call 0x00571B30                                 ; => [ Call: sub_571b30 | Call: sub_5cf7e0 ]
005ECF1E    mov ecx, edi
005ECF20    mov esi, eax
005ECF22    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005ECF53    push 0x02
005ECF55    call 0x005E0DF0                                 ; => [ Call: sub_665db0 | Call: sub_5e0df0 | Call: nullptr | Call: sub_5e01b0 ]
005ECF5A    add esp, 0x04
005ECF5D    mov edx, esi
005ECF5F    mov ecx, edi
005ECF61    call 0x005DEFB0                                 ; => [ Call: sub_5defb0 ]
005ECF66    mov ecx, edi
005ECF68    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005ECF90    call 0x00666120                                 ; => [ Call: sub_665db0 | Data: data_be3d98 | Data: data_be4134 | Call: sub_666120 ]
005ECF95    add esp, 0x10
005ECF98    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
005ECF9D    mov ecx, edi
005ECF9F    mov esi, eax
005ECFA1    call 0x004D3B70                                 ; => [ Call: sub_4d3b70 ]
005ECFA6    add esi, 0xFFFFFFF0
005ECFA9    cmp esi, 0x03
005ECFAC    jnbe 0x005ECFB5
005ECFAE    jmp dword ptr ds:[esi*4+0x5ED0EC]
005ECFB5    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
...
005ECFDA    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005ECFDF    mov edx, 0x8DC680                               ; => [ Data: data_8dc680 ]
005ECFE4    jmp 0x005ECFF2
005ECFE6    mov ecx, edi
005ECFE8    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005ECFED    mov edx, 0x8DC674                               ; => [ Data: data_8dc674 ]
005ECFF2    movss xmm3, dword ptr ds:[0x00890E18]
005ECFFA    mov ecx, eax
005ECFFC    push 0x00
005ECFFE    push 0xFFFFFFFF
005ED000    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
005ED029    call 0x0065D6E0                                 ; => [ Data: data_8c4634 | Call: sub_65d6e0 ]
...
005ED045    jl 0x005ECBF0                                   ; => [ Data: data_cd3188 ]
005ED04B    mov ecx, dword ptr ss:[ebp-0x0C]
005ED04E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005ED055    pop ecx
005ED056    pop edi
005ED057    pop esi
005ED058    mov ecx, dword ptr ss:[ebp-0x14]
005ED05B    xor ecx, ebp
005ED05D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005ED062    mov esp, ebp
005ED064    pop ebp
005ED065    mov esp, ebx
005ED067    pop ebx
005ED068    ret
005ED069    push 0x8601E0                                   ; => [ String: KingdomViewUpdate ]
005ED06E    push 0x68EE
005ED073    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005ED078    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005ED07D    jmp 0x005ED0BF
005ED07F    push 0x8601E0                                   ; => [ String: KingdomViewUpdate ]
005ED084    push 0x68FF
005ED089    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005ED08E    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005ED093    jmp 0x005ED0BF
005ED095    push 0x8601E0                                   ; => [ String: KingdomViewUpdate ]
005ED09A    push 0x692C
005ED09F    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005ED0A4    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005ED0A9    jmp 0x005ED0BF
005ED0AB    push 0x806A44                                   ; => [ String: GetLocalSettings ]
005ED0B0    push 0x5FB
005ED0B5    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
005ED0BA    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
005ED0BF    mov edx, 0x801800
005ED0C4    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005ED0C9    add esp, 0x0C
005ED0CC    call 0x0063BC30
005ED0D1    test al, al
005ED0D3    jz 0x005ED0D6                                   ; => [ Call: sub_63bc30 ]
005ED0D5    int3
005ED0D6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
