...
00531BBB    mov dword ptr ss:[ebp-0x25AC], eax
00531BC1    call 0x00573400
...
00531C7E    mov dword ptr ss:[ebp-0x25F4], ecx
...
00531D5D    mov dword ptr ss:[ebp-0x261C], ecx
...
00531ED3    mov dword ptr ss:[ebp-0x25DC], 0x00
00531EDD    push 0x00
...
00531F7B    movups xmm0, xmmword ptr ds:[eax]
00531F7E    movups xmmword ptr ss:[ebp-0x2654], xmm0
00531F85    call 0x00573400
...
00532068    call 0x0063B870
0053206D    add esp, 0x0C
00532070    call 0x0063BC30
00532075    test al, al
00532077    jz 0x0053207A
00532079    int3
0053207A    call 0x0063BB00
