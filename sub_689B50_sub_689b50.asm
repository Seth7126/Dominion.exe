...
00689B5F    push 0x8775D8                                   ; => [ String: NetBufferMakeRoom ]
00689B64    push 0x239
00689B69    push 0x8773A8                                   ; => [ String: C:\x\ax2017\Engine\Network.cpp ]
00689B6E    mov ecx, 0x8775B4                               ; => [ String: roomNeeded <= NETWORK_BUFFER_SIZE ]
...
00689B9E    mov dword ptr ss:[ebp-0x04], eax                ; => [ Call: sub_688f10 | Call: sub_688f10 ]
00689BA1    mov ecx, esi
00689BA3    lea eax, ss:[ebp-0x04]
00689BA6    push eax
00689BA7    call 0x0068B830                                 ; => [ Call: sub_68b830 | Call: sub_68b830 ]
00689BAC    pop esi
00689BAD    mov esp, ebp
00689BAF    pop ebp
00689BB0    ret
00689BB1    push 0x877BA0                                   ; => [ String: XList<struct NetBuffer *>::GetTail ]
00689BB6    push 0x5A
00689BB8    push 0x86E34C                                   ; => [ String: C:\x\ax2017\Engine\xList.h ]
00689BBD    mov ecx, 0x877B90                               ; => [ String: mpTail != NULL ]
00689BC2    mov edx, 0x801800
00689BC7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00689BCC    add esp, 0x0C
00689BCF    call 0x0063BC30
00689BD4    test al, al
00689BD6    jz 0x00689BD9                                   ; => [ Call: sub_63bc30 ]
00689BD8    int3
00689BD9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
