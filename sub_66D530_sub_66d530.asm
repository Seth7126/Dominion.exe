...
0066D53B    call 0x00761E50                                 ; => [ Call: __chkstk ]
0066D540    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0066D55F    call 0x0066D420                                 ; => [ Call: sub_66d420 ]
