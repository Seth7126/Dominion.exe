...
0064FF65    push 0x76CD78                                   ; => [ Type: EHRegistrationNode | Call: sub_76cd78 ]
0064FF6A    mov eax, dword ptr fs:[0x00000000]
0064FF70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064FF7F    push esi
0064FF80    push edi
0064FF81    push eax                                        ; => [ Data: __security_cookie ]
0064FF82    lea eax, ss:[ebp-0x0C]
0064FF85    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0064FFBB    mov dword ptr ss:[ebp-0x70], 0x00               ; => [ Call: nullptr ]
...
0064FFD5    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064FFF5    push ecx                                        ; => [ Call: `eh vector constructor iterator' ]
0064FFF6    mov ecx, dword ptr ds:[ebx]
0064FFF8    call 0x0064C230                                 ; => [ Call: sub_64c230 ]
...
00650024    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00650029    test eax, eax
0065002B    cmovnz edx, eax
0065002E    call 0x0064F870                                 ; => [ Call: sub_64f870 ]
00650033    test al, al
...
00650060    call 0x0064CF70                                 ; => [ Call: sub_64cf70 ]
...
00650084    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
...
006500B4    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006500CA    call 0x0064CF70                                 ; => [ Call: sub_64cf70 ]
...
006500F9    call 0x0064FE30                                 ; => [ Call: sub_64fe30 | Call: sub_64fe30 ]
...
00650114    push eax
00650115    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
...
00650139    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00650140    pop ecx
00650141    pop edi
00650142    pop esi
00650143    pop ebx
...
00650149    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0065014E    mov esp, ebp
00650150    pop ebp
00650151    ret
00650152    push 0x874818                                   ; => [ String: MyMethod ]
00650157    push 0x12F8
0065015C    jmp 0x00650168
0065015E    push 0x874818                                   ; => [ String: MyMethod ]
00650163    push 0x130C
00650168    push 0x8739B4
0065016D    mov edx, 0x801800
00650172    mov ecx, 0x874858
00650177    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | String: MyMethod | String: numMapsToMerge < MAX_STATES | Data: data_801800 ]
0065017C    add esp, 0x0C
0065017F    call 0x0063BC30
00650184    test al, al
00650186    jz 0x00650189                                   ; => [ Call: sub_63bc30 ]
00650188    int3
00650189    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
