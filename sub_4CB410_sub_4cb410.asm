...
004CB420    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004CB421    push ecx
004CB422    push ebx
004CB423    push esi
004CB424    push edi
...
004CB42C    push eax                                        ; => [ Data: __security_cookie ]
004CB42D    lea eax, ss:[ebp-0x0C]
004CB430    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004CB444    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
004CB449    mov eax, dword ptr ss:[ebp-0x10]
004CB44C    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004CB451    test eax, eax
004CB453    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004CB4A4    jz 0x004CB4C1                                   ; => [ Data: data_cf65bc ]
004CB4A6    lea ecx, ss:[ebp-0x10]
004CB4A9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CB4BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CB4C1    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CB4C8    test bl, bl
004CB4CA    jz 0x004CB4EA
004CB4CC    mov dword ptr ds:[0x008DB660], 0x04             ; => [ Data: data_8db660 ]
004CB4D6    xor al, al
004CB4D8    mov ecx, dword ptr ss:[ebp-0x0C]
004CB4DB    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CB4E2    pop ecx
004CB4E3    pop edi
004CB4E4    pop esi
004CB4E5    pop ebx
...
004CB4F8    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_tut ]
004CB4FD    mov eax, dword ptr ss:[ebp+0x08]
004CB500    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004CB543    jz 0x004CB560                                   ; => [ Data: data_cf65bc ]
004CB545    lea ecx, ss:[ebp+0x08]
004CB548    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CB55B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CB560    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CB567    test esi, esi
004CB569    jnz 0x004CB593
004CB56B    mov dword ptr ds:[0x008DB660], 0x23             ; => [ Data: data_8db660 ]
004CB575    xor al, al
004CB577    mov dword ptr ds:[0x00CC8D7C], 0x19             ; => [ Data: data_cc8d7c ]
004CB581    mov ecx, dword ptr ss:[ebp-0x0C]
004CB584    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CB58B    pop ecx
004CB58C    pop edi
004CB58D    pop esi
004CB58E    pop ebx
...
004CB59E    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_rules ]
004CB5A3    mov eax, dword ptr ss:[ebp+0x08]
004CB5A6    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004CB5EC    jz 0x004CB609                                   ; => [ Data: data_cf65bc ]
004CB5EE    lea ecx, ss:[ebp+0x08]
004CB5F1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CB604    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CB609    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CB610    test esi, esi
004CB612    jnz 0x004CB632
004CB614    mov dword ptr ds:[0x008DB660], 0x17             ; => [ Data: data_8db660 ]
004CB61E    xor al, al
004CB620    mov ecx, dword ptr ss:[ebp-0x0C]
004CB623    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CB62A    pop ecx
004CB62B    pop edi
004CB62C    pop esi
004CB62D    pop ebx
...
004CB63D    call 0x0063D720                                 ; => [ String: btn_rules_pdf | Call: sub_63d720 ]
004CB642    mov eax, dword ptr ss:[ebp+0x08]
004CB645    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004CB68C    jz 0x004CB6A9                                   ; => [ Data: data_cf65bc ]
004CB68E    lea ecx, ss:[ebp+0x08]
004CB691    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CB6A4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004CB6C3    call 0x0063D720                                 ; => [ String: btn_video | Call: sub_63d720 ]
004CB6C8    mov eax, dword ptr ss:[ebp+0x08]
004CB6CB    test eax, eax
004CB6CD    cmovnz edi, eax
004CB6D0    mov cl, byte ptr ds:[edi]                       ; => [ Type: PSTR ]
...
004CB6EC    xor esi, esi                                    ; => [ Call: nullptr | Call: nullptr ]
...
004CB70C    jz 0x004CB729                                   ; => [ Data: data_cf65bc ]
004CB70E    lea ecx, ss:[ebp+0x08]
004CB711    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CB724    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004CB73B    push esi
004CB73C    call dword ptr ds:[0x00775268]                  ; => [ String: https://www.templegatesgames.com/how-to-play-video/ | String: open ]
004CB742    xor al, al
004CB744    mov ecx, dword ptr ss:[ebp-0x0C]
004CB747    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CB74E    pop ecx
004CB74F    pop edi
004CB750    pop esi
004CB751    pop ebx
