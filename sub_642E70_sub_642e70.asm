...
00642E70    mov eax, dword ptr ds:[0x00CF65B4]              ; => [ Data: data_cf65b4 ]
...
00642E95    call 0x00687DB0                                 ; => [ Call: sub_687db0 ]
00642E9A    mov eax, dword ptr ds:[0x00CF65B4]              ; => [ Data: data_cf65b4 ]
00642E9F    cmp byte ptr ds:[eax+0x28], 0x00
00642EA3    jnz 0x00642EC2
00642EA5    call 0x006877A0                                 ; => [ Call: sub_6877a0 ]
00642EAA    mov eax, dword ptr ds:[0x00CF65B4]              ; => [ Data: data_cf65b4 ]
00642EAF    mov ecx, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
