...
004EDF2A    mov esi, 0x18F8E68                              ; => [ Data: data_18f8e68 ]
004EDF2F    push edi
...
004EDF5A    jl 0x004EDF33                                   ; => [ Data: data_1938e68 ]
004EDF5C    mov ecx, dword ptr ds:[ebx*4+0x1779F8C]
004EDF63    call 0x004EDEA0                                 ; => [ Data: data_1779f8c | Call: sub_4edea0 ]
004EDF68    mov edx, 0x18F8E68                              ; => [ Data: data_18f8e68 ]
004EDF6D    mov dword ptr ss:[ebp-0x0C], edx                ; => [ Data: data_18f8e68 ]
004EDF70    mov esi, dword ptr ds:[edx]
004EDF72    xor edi, edi                                    ; => [ Call: nullptr ]
004EDF74    mov dword ptr ss:[ebp-0x08], edi                ; => [ Call: nullptr ]
...
004EDFFA    push ecx
004EDFFB    call 0x004EE050                                 ; => [ Call: sub_4ee050 ]
004EE000    push 0x18
004EE002    push esi
004EE003    call 0x00759661                                 ; => [ Call: operator new ]
...
004EE040    jl 0x004EDF70                                   ; => [ Data: data_1938e68 ]
004EE046    pop edi
004EE047    pop esi
004EE048    pop ebx
