...
0055B9D9    mov eax, dword ptr ds:[0x008C4040]
0055B9DE    xor eax, esp
0055B9E0    mov dword ptr ss:[esp+0x60], eax
0055B9E4    push ebx
0055B9E5    push esi
0055B9E6    push edi
0055B9E7    call 0x00573400
...
0055BB7F    mov dword ptr ds:[eax], 0x81E21C
0055BB85    mov dword ptr ds:[eax+0x24], eax
0055BB88    call 0x00569B30
