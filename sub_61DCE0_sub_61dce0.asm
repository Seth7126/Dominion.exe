...
0061DCE3    push ecx
0061DCE4    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
0061DCEA    mov dword ptr ds:[0x01723FF4], 0x00             ; => [ Data: data_1723ff4 ]
0061DCF4    push esi
0061DCF5    mov ecx, dword ptr ds:[ecx+0x1E1A4]
0061DCFB    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 ]
...
0061DD22    call 0x004E6680                                 ; => [ Data: data_171efd4 | Call: sub_4e6680 ]
...
0061DD6A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061DD6F    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
0061DD75    mov dword ptr ds:[0x008DB660], 0x7E1            ; => [ Data: data_8db660 ]
0061DD7F    pop esi
