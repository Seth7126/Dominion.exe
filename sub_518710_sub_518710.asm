...
0051872E    add eax, ecx                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
...
0051877A    add eax, ecx                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
...
005187BE    mov dword ptr ds:[eax], 0x816E5C                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_dbf6d7d123c8b12767cb94d0d57b0fd7>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
005187C4    mov dword ptr ds:[eax+0x24], eax
005187C7    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
005187CC    push 0x00
005187CE    push 0x00
...
005187DC    pop ebp
005187DD    ret                                             ; => [ Call: sub_50a6a0 ]
005187DE    push 0x80CF1C
005187E3    push 0x242
005187E8    push 0x80CD80
005187ED    mov edx, 0x801800
005187F2    mov ecx, 0x801AA4
005187F7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: CampaignAddExtra | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: Halt ]
005187FC    add esp, 0x0C
005187FF    call 0x0063BC30
00518804    test al, al
00518806    jz 0x00518809                                   ; => [ Call: sub_63bc30 ]
00518808    int3
00518809    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
