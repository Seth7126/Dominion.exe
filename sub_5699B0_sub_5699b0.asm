...
005699CC    xor eax, ebp
005699CE    push eax
005699CF    lea eax, ss:[ebp-0x0C]
005699D2    mov dword ptr fs:[0x00000000], eax
005699D8    mov dword ptr ss:[ebp-0x04], 0x00
005699DF    call 0x00573400
...
00569A76    mov byte ptr ds:[eax+0x6C], 0x01
...
00569A8C    mov ecx, dword ptr ds:[eax]
...
00569AAD    push 0x81F9E0
00569AB2    push 0x792
00569AB7    push 0x81F4B8
00569ABC    mov ecx, 0x81F9F0
...
00569AE9    mov dword ptr fs:[0x00000000], ecx
00569AF0    pop ecx
00569AF1    pop edi
00569AF2    pop esi
00569AF3    pop ebx
...
00569AF6    pop ebp
00569AF7    ret
00569AF8    push 0x81EBA8
00569AFD    push 0xC98
00569B02    push 0x81EA70
00569B07    mov ecx, 0x801AA4
00569B0C    mov edx, 0x801800
00569B11    call 0x0063B870
00569B16    add esp, 0x0C
00569B19    call 0x0063BC30
00569B1E    test al, al
00569B20    jz 0x00569B23
00569B22    int3
00569B23    call 0x0063BB00
