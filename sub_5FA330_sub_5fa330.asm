...
005FA358    mov dword ptr fs:[0x00000000], eax
...
005FA394    push 0x861278
005FA399    push 0x85CF
005FA39E    push 0x86F1E8
005FA3A3    mov ecx, 0x801AA4
...
005FA3D3    push 0x861278
005FA3D8    push 0x85DC
005FA3DD    push 0x86F1E8
005FA3E2    mov ecx, 0x801AA4
...
005FA483    call 0x00666120
005FA488    add esp, 0x08
005FA48B    xor ebx, ebx
005FA48D    test edi, edi
005FA48F    jle 0x005FA57E
005FA495    mov esi, 0x1A94584
...
005FA513    mov dword ptr ds:[esi], 0x861478
...
005FA5A4    push edi
005FA5A5    call 0x00666120
005FA5AA    add esp, 0x08
005FA5AD    xor ebx, ebx
005FA5AF    test edi, edi
005FA5B1    jle 0x005FA6C7
005FA5B7    mov edi, 0x1A94584
...
005FA60E    jz 0x005FA680
005FA610    push ebx
005FA611    mov edx, 0x86111C
005FA616    mov ecx, esi
005FA618    call 0x0067BE20
...
005FA634    call 0x005F8B10
005FA639    jmp 0x005FA6B7
005FA63B    push 0x861268
005FA640    push 0x85BD
005FA645    push 0x86F1E8
005FA64A    mov ecx, 0x861234
005FA64F    jmp 0x005FA9D0
005FA654    push 0x861450
005FA659    push 0x889E
005FA65E    push 0x86F1E8
005FA663    mov ecx, 0x861488
005FA668    jmp 0x005FA9D0
005FA66D    mov dword ptr ds:[edi], 0x86111C
...
005FA6EE    push 0x861450
005FA6F3    push 0x88E9
005FA6F8    push 0x86F1E8
005FA6FD    mov ecx, 0x801AA4
005FA702    jmp 0x005FA9D0
005FA707    push 0x861450
005FA70C    push 0x88AA
005FA711    push 0x86F1E8
005FA716    mov ecx, 0x8610D0
...
005FA79C    add edi, 0x10C8E0
005FA7A2    mov ecx, dword ptr ds:[ecx+0x1E1A4]
005FA7A8    call 0x004D8F30
...
005FA998    call 0x005F8DE0
005FA99D    add esp, 0x0C
005FA9A0    mov ecx, dword ptr ss:[ebp-0x0C]
005FA9A3    mov dword ptr fs:[0x00000000], ecx
005FA9AA    pop ecx
005FA9AB    pop edi
005FA9AC    pop esi
005FA9AD    pop ebx
...
005FA9B3    call 0x0075927A
005FA9B8    mov esp, ebp
005FA9BA    pop ebp
005FA9BB    ret
005FA9BC    push 0x81F500
005FA9C1    push 0xB1
005FA9C6    push 0x81F4B8
005FA9CB    mov ecx, 0x81F50C
005FA9D0    mov edx, 0x801800
005FA9D5    call 0x0063B870
005FA9DA    add esp, 0x0C
005FA9DD    call 0x0063BC30
005FA9E2    test al, al
005FA9E4    jz 0x005FA9E7
005FA9E6    int3
005FA9E7    call 0x0063BB00
