...
006E4787    mov dword ptr ds:[esi], eax
006E4789    mov eax, dword ptr ds:[0x00CB2F18]
006E478E    mov dword ptr ds:[esi+0x04], eax
006E4791    mov eax, dword ptr ds:[0x00CB2F1C]
006E4796    jmp 0x006E47B9
006E4798    inc dword ptr ds:[esi+0x04]
006E479B    mov ecx, esi
006E479D    call 0x006E1920
006E47A2    mov esi, dword ptr ss:[ebp+0x08]
006E47A5    mov eax, dword ptr ds:[0x00CB2F08]
006E47AA    mov dword ptr ds:[esi], eax
006E47AC    mov eax, dword ptr ds:[0x00CB2F0C]
006E47B1    mov dword ptr ds:[esi+0x04], eax
006E47B4    mov eax, dword ptr ds:[0x00CB2F10]
