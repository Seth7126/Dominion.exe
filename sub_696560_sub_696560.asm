...
00696627    add edi, dword ptr ds:[0x0147B07C]
0069662D    push eax
0069662E    mov esi, dword ptr ds:[edi+0x1C]
00696631    call 0x0069FD50
...
006967C4    jz 0x006967E1
006967C6    lea ecx, ss:[ebp-0x7C]
006967C9    call 0x0063D4E0
...
00696813    call 0x0064C080
00696818    mov dword ptr ss:[ebp-0x24], 0x801800
...
006968AF    mov dword ptr fs:[0x00000000], ecx
006968B6    pop ecx
006968B7    pop edi
006968B8    pop esi
006968B9    pop ebx
...
006968E1    call 0x0063B870
006968E6    add esp, 0x0C
006968E9    call 0x0063BC30
006968EE    test al, al
006968F0    jz 0x006968F3
006968F2    int3
006968F3    call 0x0063BB00
