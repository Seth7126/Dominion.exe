...
00599FC1    mov dword ptr fs:[0x00000000], eax
...
00599FD9    mov dword ptr ds:[esi], 0x801800
...
0059A35D    call 0x0064C080
0059A362    mov dword ptr ss:[ebp+0x08], 0x801800
0059A369    mov byte ptr ss:[ebp-0x04], 0x11
0059A36D    cmp dword ptr ds:[0x00CF65BC], 0x00
0059A374    jz 0x0059A3A0
...
0059A3E3    movzx eax, byte ptr ds:[eax+0x59A794]
0059A3EA    jmp dword ptr ds:[eax*4+0x59A790]
0059A3F1    push 0x824B14
0059A3F6    push 0x4CD
...
0059A506    call 0x0064C080
0059A50B    mov dword ptr ss:[ebp+0x08], 0x801800
0059A512    mov byte ptr ss:[ebp-0x04], 0x19
0059A516    cmp dword ptr ds:[0x00CF65BC], 0x00
0059A51D    jz 0x0059A549
...
0059A5F0    call 0x0064C080
0059A5F5    mov dword ptr ss:[ebp+0x08], 0x801800
0059A5FC    mov byte ptr ss:[ebp-0x04], 0x1F
0059A600    cmp dword ptr ds:[0x00CF65BC], 0x00
0059A607    jz 0x0059A633
...
0059A6FD    call 0x0064C080
0059A702    mov eax, esi
0059A704    mov ecx, dword ptr ss:[ebp-0x0C]
0059A707    mov dword ptr fs:[0x00000000], ecx
0059A70E    pop ecx
0059A70F    pop edi
0059A710    pop esi
