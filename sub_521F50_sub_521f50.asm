...
00521F68    push 0x76506B                                   ; => [ Call: sub_76506b | Type: EHRegistrationNode ]
00521F6D    mov eax, dword ptr fs:[0x00000000]
00521F73    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00521F74    push ebx
00521F75    mov eax, 0x19C0
00521F7A    call 0x00761E50                                 ; => [ Call: __chkstk ]
00521F7F    mov eax, dword ptr ds:[0x008C4040]
00521F84    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00521F86    mov dword ptr ss:[ebp-0x14], eax
00521F89    push esi
00521F8A    push edi
00521F8B    push eax
00521F8C    lea eax, ss:[ebp-0x0C]
00521F8F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00521FA9    call 0x00561AF0                                 ; => [ Call: sub_561e00 | Call: sub_561af0 ]
...
00521FBD    push 0x04
00521FBF    push eax
00521FC0    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
00521FC5    mov esi, eax
00521FC7    mov dword ptr ss:[ebp-0xD18], 0x817CD8          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_f60371229a408dfdb8bdc0abb21ad626>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_f60371229a408dfdb8bdc0abb21ad626>,bool,enum CardID>::VTable ]
00521FD1    mov ecx, 0x321
00521FD6    lea edi, ss:[ebp-0xCA0]
00521FDC    lea eax, ss:[ebp-0xD18]
00521FE2    add esp, 0x14
00521FE5    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00521FE7    mov dword ptr ss:[ebp-0xCF4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_f60371229a408dfdb8bdc0abb21ad626>,bool,enum CardID>::VTable ]
...
00522028    call eax                                        ; => [ Field: vFunc_0 ]
...
0052204B    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
00522062    push eax
00522063    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00522066    xorps xmm0, xmm0
00522069    mov dword ptr ss:[ebp-0xCE4], 0x00
00522073    movlpd qword ptr ss:[ebp-0xCEC], xmm0           ; => [ Call: __builtin_memset ]
...
00522126    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00522148    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00522198    push eax
00522199    call 0x00586320                                 ; => [ Call: sub_586320 ]
0052219E    add esp, 0x10
005221A1    mov ecx, dword ptr ss:[ebp-0x0C]
005221A4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005221AB    pop ecx
005221AC    pop edi
005221AD    pop esi
005221AE    mov ecx, dword ptr ss:[ebp-0x14]
005221B1    xor ecx, ebp
005221B3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
