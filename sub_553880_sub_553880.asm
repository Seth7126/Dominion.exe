...
00553893    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
00553898    add esp, 0x04
0055389B    call 0x00573400                                 ; => [ Call: sub_573400 ]
005538A0    push 0x00
005538A2    push 0x00
005538A4    push 0x01
...
005538AC    push 0x02
005538AE    call 0x00590760                                 ; => [ Call: sub_590760 ]
005538B3    add esp, 0x10
005538B6    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005538E0    mov dword ptr ss:[esp+0x10], eax                ; => [ Call: sub_573400 ]
005538E4    mov dword ptr ss:[esp+0x0C], 0x00
005538EC    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00553911    mov dword ptr ds:[eax], 0x81D3E8                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_ac83ecee7b857c6795996e9a266765c8>, void>::`vftable'{for `std::_Func_base<void>'} ]
00553917    mov dword ptr ds:[eax+0x08], esi
0055391A    mov dword ptr ds:[eax+0x24], eax
0055391D    call 0x005698B0                                 ; => [ Call: sub_5698b0 ]
00553922    add esp, 0x28
00553925    cmp dword ptr ss:[esp+0x0C], 0x00
0055392A    jz 0x00553995
0055392C    mov ecx, 0x01
00553931    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
00553936    mov ebx, dword ptr ss:[esp+0x0C]
0055393A    xor esi, esi
0055393C    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00553953    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00553956    mov dword ptr ss:[esp+0x14], eax
0055395A    cmp esi, 0x320
00553960    jb 0x00553967
00553962    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0055398A    push ebx
0055398B    push 0x08
0055398D    call 0x005911E0                                 ; => [ Call: sub_5911e0 ]
...
005539B2    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
005539B7    add esp, 0x0C
005539BA    call 0x0063BC30
005539BF    test al, al
005539C1    jz 0x005539C4                                   ; => [ Call: sub_63bc30 ]
005539C3    int3
005539C4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
