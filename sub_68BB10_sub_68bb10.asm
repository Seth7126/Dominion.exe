...
0068BB15    push 0x76DF3E                                   ; => [ Call: sub_76df3e | Type: EHRegistrationNode ]
0068BB1A    mov eax, dword ptr fs:[0x00000000]
0068BB20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068BB2E    push eax                                        ; => [ Data: __security_cookie ]
0068BB2F    lea eax, ss:[ebp-0x0C]
0068BB32    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0068BB4B    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
...
0068BC00    jz 0x0068BC24                                   ; => [ Data: data_cf65bc ]
0068BC02    lea ecx, ss:[ebp-0x10]
0068BC05    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068BC18    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068BC1D    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
0068BC58    push 0x871DD4                                   ; => [ String: XString::XString ]
0068BC5D    push 0x9A
0068BC62    jmp 0x0068BCFA
0068BC67    push 0x877D70                                   ; => [ String: RemoveMarkup ]
0068BC6C    push 0x95
0068BC71    push 0x877D0C                                   ; => [ String: C:\x\ax2017\Engine\Localization.cpp ]
0068BC76    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0068BC7B    jmp 0x0068BD04
0068BC80    mov edx, esi
0068BC82    lea ecx, ss:[ebp-0x10]
0068BC85    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
0068BC8A    mov dword ptr ss:[ebp-0x04], 0x01
0068BC91    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0068BC96    mov esi, dword ptr ss:[ebp-0x10]
0068BC99    test esi, esi
0068BC9B    mov ecx, dword ptr ss:[ebp-0x14]
0068BC9E    cmovnz eax, esi
0068BCA1    push eax
0068BCA2    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
0068BCBE    jz 0x0068BCDB                                   ; => [ Data: data_cf65bc ]
0068BCC0    lea ecx, ss:[ebp-0x10]
0068BCC3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068BCD6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068BCDB    mov eax, dword ptr ss:[ebp-0x14]
0068BCDE    mov ecx, dword ptr ss:[ebp-0x0C]
0068BCE1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068BCE8    pop ecx
0068BCE9    pop edi
0068BCEA    pop esi
0068BCEB    pop ebx
...
0068BCEE    pop ebp
0068BCEF    ret
0068BCF0    push 0x871DD4                                   ; => [ String: XString::XString ]
0068BCF5    push 0x94
0068BCFA    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
0068BCFF    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
0068BD04    mov edx, 0x801800
0068BD09    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0068BD0E    add esp, 0x0C
0068BD11    call 0x0063BC30
0068BD16    test al, al
0068BD18    jz 0x0068BD1B                                   ; => [ Call: sub_63bc30 ]
0068BD1A    int3
0068BD1B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
