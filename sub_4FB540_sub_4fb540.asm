...
004FB54B    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FB550    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
004FB555    xor eax, esp
004FB557    mov dword ptr ss:[esp+0x259C], eax
004FB55E    push esi
004FB55F    push edi
004FB560    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FB565    push 0x00
004FB567    push 0x00
004FB569    push 0x01
...
004FB571    push 0x02
004FB573    call 0x00590760                                 ; => [ Call: sub_590760 ]
004FB578    add esp, 0x10
004FB57B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FB59D    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FB5A2    push 0x0C
004FB5A4    push 0x00
...
004FB667    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
004FB66C    add esp, 0x0C
004FB66F    call 0x0063BC30
004FB674    test al, al
004FB676    jz 0x004FB679                                   ; => [ Call: sub_63bc30 ]
004FB678    int3
004FB679    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
