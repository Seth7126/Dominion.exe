...
0063D85B    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0063D860    mov eax, dword ptr ds:[ebx]
0063D862    mov edx, esi                                    ; => [ Data: data_801800 ]
...
0063D884    jz 0x0063D8A6                                   ; => [ Data: data_cf65bc ]
0063D886    mov ecx, edi
0063D888    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063D89B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063D8A0    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
...
0063D8B5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
