...
006A6D05    push 0x76F800                                   ; => [ Call: __ehhandler$??$common_chdir@D@@YAHQBD@Z | Type: EHRegistrationNode ]
006A6D0A    mov eax, dword ptr fs:[0x00000000]
006A6D10    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A6D22    push esi
006A6D23    push edi
006A6D24    push eax                                        ; => [ Data: __security_cookie ]
006A6D25    lea eax, ss:[ebp-0x0C]
006A6D28    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A6D3D    push 0x00
006A6D3F    push eax
006A6D40    call 0x00761FC4                                 ; => [ Call: memset ]
...
006A6D71    test al, al
006A6D73    jz 0x006A6DED                                   ; => [ Call: sub_7076e0 ]
006A6D75    call 0x006A2FA0
006A6D7A    push dword ptr ds:[ebx]
006A6D7C    mov edi, eax                                    ; => [ Call: sub_6a2fa0 ]
006A6D7E    mov ecx, edi
006A6D80    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
006A6D9D    test al, al
006A6D9F    jz 0x006A6DE6                                   ; => [ Call: sub_7076e0 ]
...
006A6DD1    test al, al
006A6DD3    jz 0x006A6DE6                                   ; => [ Call: sub_7076e0 ]
006A6DD5    lea edx, ss:[ebp-0x138]
006A6DDB    mov ecx, edi
006A6DDD    call 0x006A6C70
006A6DE2    test al, al
006A6DE4    jnz 0x006A6DEF                                  ; => [ Call: sub_6a6c70 ]
006A6DE6    mov ecx, edi
006A6DE8    call 0x006A3220                                 ; => [ Call: sub_6a3220 | Call: sub_6a3220 | Call: sub_6a3220 | Call: sub_6a3220 | Call: sub_6a3220 ]
006A6DED    xor edi, edi                                    ; => [ Call: nullptr | Call: nullptr | Call: nullptr | Call: nullptr | Call: nullptr | Call: nullptr ]
...
006A6E1B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A6E20    test esi, esi
006A6E22    jnz 0x006A6E11
006A6E24    mov dword ptr ss:[ebp-0x14], 0x00
006A6E2B    mov dword ptr ss:[ebp-0x1C], 0x00               ; => [ Call: nullptr ]
...
006A6E4A    call 0x007078C0                                 ; => [ Call: sub_7078c0 ]
006A6E4F    mov eax, edi
006A6E51    mov ecx, dword ptr ss:[ebp-0x0C]
006A6E54    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A6E5B    pop ecx
006A6E5C    pop edi
006A6E5D    pop esi
006A6E5E    pop ebx
...
006A6E64    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
