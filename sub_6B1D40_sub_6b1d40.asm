...
006B1D4B    mov ecx, dword ptr ss:[ebp+0x08]
006B1D4E    push esi
...
006B1D8D    cmovnz edi, ecx
006B1D90    xor ecx, ecx
006B1D92    test esi, esi
006B1D94    jz 0x006B1DD5
006B1D96    mov ecx, esi
006B1D98    call 0x006A0F60
006B1D9D    mov edx, dword ptr ds:[0x0147B078]
...
006B1DFD    mov ecx, dword ptr ds:[eax]
...
006B1E16    addsd xmm0, qword ptr ds:[eax*8+0x893660]
...
006B1E35    addsd xmm0, qword ptr ds:[eax*8+0x893660]
...
006B1E98    mov dword ptr ss:[esp+0x28], esi
006B1E9C    mov dword ptr ss:[esp+0x2C], eax
