...
00544BF4    push esi
00544BF5    call 0x00573400                                 ; => [ Call: sub_573400 ]
00544BFA    push 0x00
00544BFC    mov edx, dword ptr ds:[eax+0x0C]
00544BFF    mov ecx, dword ptr ds:[eax+0x04]
00544C02    call 0x005887C0                                 ; => [ Call: sub_5887c0 ]
...
00544C1B    call 0x00562400                                 ; => [ Call: sub_562400 ]
00544C20    add esp, 0x04
00544C23    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00544C39    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00544C4F    push ebx
00544C50    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
00544C55    mov eax, dword ptr ss:[ebp-0x04]
00544C58    inc eax
00544C59    push eax
00544C5A    call 0x005652D0                                 ; => [ Call: sub_5652d0 ]
