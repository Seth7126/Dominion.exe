...
00549B80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00549B81    mov eax, 0x1944
00549B86    call 0x00761E50                                 ; => [ Call: __chkstk ]
00549B8B    mov eax, dword ptr ds:[0x008C4040]
00549B90    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
00549B9C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00549BA2    push 0x00
00549BA4    push 0x00
00549BA6    mov edx, 0x10F
00549BAB    mov ecx, 0x01
00549BB0    call 0x00567BE0                                 ; => [ Call: sub_567be0 ]
...
00549BCA    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00549BCD    cmp esi, 0x320
00549BD3    jb 0x00549BDA
00549BD5    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00549BF0    push 0x04
00549BF2    push eax
00549BF3    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
00549BF8    mov esi, eax
00549BFA    mov dword ptr ss:[ebp-0xCC8], 0x81F3B4          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_cab62cdb92af660942dc2750289a460f>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_cab62cdb92af660942dc2750289a460f>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
...
00549C1E    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00549C20    mov dword ptr ss:[ebp-0xCA4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_cab62cdb92af660942dc2750289a460f>,bool,enum CardID>::VTable ]
...
00549C5E    push esi
00549C5F    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
00549C82    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00549C9B    push eax
00549C9C    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00549CB8    test al, al
00549CBA    jnz 0x00549CD9                                  ; => [ Call: sub_567520 ]
00549CBC    push 0x0B
00549CBE    mov edx, 0x10F
00549CC3    lea ecx, ss:[ebp-0xC98]
00549CC9    call 0x00570120                                 ; => [ Call: sub_570120 ]
00549CCE    add esp, 0x04
00549CD1    test eax, eax
00549CD3    jnz 0x00549BE4
00549CD9    mov ecx, 0x06
00549CDE    call 0x0056E770                                 ; => [ Call: sub_56e770 ]
00549CE3    mov ecx, dword ptr ss:[ebp-0x0C]
00549CE6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00549CED    pop ecx
00549CEE    pop edi
00549CEF    pop esi
00549CF0    pop ebx
...
00549CF6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
