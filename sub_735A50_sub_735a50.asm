...
00735A84    mov dword ptr ss:[ebp-0x08], eax                ; => [ Call: sub_6a9570 ]
...
00735A92    call 0x006A9DE0                                 ; => [ Call: sub_6a9de0 ]
...
00735AB7    pop ebp
00735AB8    ret                                             ; => [ Call: sub_6ab1b0 ]
00735AB9    push 0x88EFD4
00735ABE    push 0x16B
00735AC3    push 0x88F010
00735AC8    mov edx, 0x801800
00735ACD    mov ecx, 0x88EFFC
00735AD2    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: AtlasTextureLoadBits | Data: data_801800 | String: pDefImage != NULL | String: C:\x\ax2017\Engine\Editor\AtlasMaker.cpp ]
00735AD7    add esp, 0x0C
00735ADA    call 0x0063BC30
00735ADF    test al, al
00735AE1    jz 0x00735AE4                                   ; => [ Call: sub_63bc30 ]
00735AE3    int3
00735AE4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
