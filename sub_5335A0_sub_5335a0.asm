...
005335A5    push 0x76549B                                   ; => [ Type: EHRegistrationNode | Call: sub_76549b ]
005335AA    mov eax, dword ptr fs:[0x00000000]
005335B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005335B1    mov eax, 0x1944
005335B6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005335BB    mov eax, dword ptr ds:[0x008C4040]
005335C0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
005335CC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005335F5    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_56f370 ]
005335F7    mov edi, dword ptr ss:[ebp-0x18]
005335FA    test edi, edi
005335FC    jz 0x0053368D
00533602    lea eax, ss:[ebp-0xCC8]
00533608    mov dword ptr ss:[ebp-0xCC8], 0x819CB4          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_6b1447f7a7ead2f4c6c7d41979181c67>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_6b1447f7a7ead2f4c6c7d41979181c67>,bool,enum CardID>::VTable ]
00533612    mov dword ptr ss:[ebp-0xCA4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_6b1447f7a7ead2f4c6c7d41979181c67>,bool,enum CardID>::VTable ]
...
00533650    push esi
00533651    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0053366C    mov edi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00533682    push eax
00533683    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
00533686    test edi, edi
00533688    setnz al
0053368B    jmp 0x0053368F
0053368D    xor al, al
0053368F    mov ecx, dword ptr ss:[ebp-0x0C]
00533692    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00533699    pop ecx
0053369A    pop edi
0053369B    pop esi
0053369C    pop ebx
...
005336A2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
