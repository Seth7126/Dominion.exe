...
0053DF34    push esi
0053DF35    push edi
0053DF36    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053DF56    mov ecx, eax                                    ; => [ Call: sub_577640 ]
...
0053DF83    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0053DFB6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0053DFC8    pop ebx
0053DFC9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
