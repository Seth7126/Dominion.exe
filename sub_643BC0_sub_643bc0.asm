...
00643BC6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00643BEA    call 0x00643950                                 ; => [ Call: sub_643950 ]
...
00643C07    movups xmmword ptr ds:[ecx+0x08], xmm0          ; => [ Call: __builtin_memcpy | String:  ]
...
00643C31    mov dword ptr ds:[ecx+0x144], eax               ; => [ Data: data_1476b44 ]
...
00643C4C    movups xmmword ptr ss:[ebp-0x38], xmm0          ; => [ Data: data_cf6668 ]
00643C50    movq xmm0, qword ptr ds:[0x00CF6678]            ; => [ Data: data_cf6678 ]
...
00643C76    subss xmm0, dword ptr ss:[ebp-0x10]             ; => [ Data: data_cf6680 ]
...
00643CA3    mov dword ptr ds:[esi+0x14C], eax               ; => [ Call: sub_643ae0 ]
00643CA9    call 0x00643B50
00643CAE    mov ecx, dword ptr ss:[ebp-0x04]
00643CB1    mov dword ptr ds:[esi+0x150], eax               ; => [ Call: sub_643b50 ]
...
00643CC6    pop esi
00643CC7    pop ebx
00643CC8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
