...
0052A523    push 0x01
0052A525    call 0x00590760
0052A52A    add esp, 0x18
0052A52D    call 0x00573400
...
0052A5FA    call eax
0052A5FC    mov dword ptr ds:[edi+0x24], eax
...
0052A654    mov dword ptr ss:[ebp-0xD38], 0x81F0F8
0052A65E    mov dword ptr ss:[ebp-0xD34], eax
0052A664    lea eax, ss:[ebp-0xD38]
0052A66A    mov dword ptr ss:[ebp-0xD14], eax
...
0052A6AB    call eax
0052A6AD    mov dword ptr ds:[edi+0x24], eax
...
0052A6D3    mov dword ptr ss:[ebp-0xD70], eax
...
0052A6ED    push eax
0052A6EE    call dword ptr ds:[edx+0x10]
0052A6F1    xorps xmm0, xmm0
0052A6F4    mov dword ptr ss:[ebp-0xCDC], 0x00
0052A6FE    movlpd qword ptr ss:[ebp-0xCE4], xmm0
...
0052A891    call 0x0063B870
0052A896    add esp, 0x0C
0052A899    call 0x0063BC30
0052A89E    test al, al
0052A8A0    jz 0x0052A8A3
0052A8A2    int3
0052A8A3    call 0x0063BB00
