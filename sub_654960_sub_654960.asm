...
00654965    push 0x76CF2E                                   ; => [ Type: EHRegistrationNode | Call: sub_76cf2e ]
0065496A    mov eax, dword ptr fs:[0x00000000]
00654970    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00654971    mov eax, 0x142C
00654976    call 0x00761E50                                 ; => [ Call: __chkstk ]
0065497B    mov eax, dword ptr ds:[0x008C4040]
00654980    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0065498C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006549A0    push 0x874440                                   ; => [ String: UI2DefGet ]
006549A5    push 0xC16
006549AA    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
006549AF    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
006549B4    jmp 0x00654C8B
006549B9    cmp dword ptr ds:[eax+0x04], 0x22
006549BD    jnz 0x00654C77
006549C3    mov ecx, eax
006549C5    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006549E0    call 0x00761FC4                                 ; => [ Call: memset ]
006549E5    add esp, 0x0C
006549E8    lea eax, ss:[ebp-0x1010]
006549EE    push 0x400
006549F3    push 0x00
006549F5    push eax
006549F6    call 0x00761FC4                                 ; => [ Call: memset ]
...
00654A0F    push 0x00
00654A11    push eax
00654A12    call 0x00761FC4                                 ; => [ Call: memset ]
...
00654A2F    push 0x00
00654A31    push eax
00654A32    call 0x00761FC4                                 ; => [ Call: memset ]
00654A37    add esp, 0x0C
00654A3A    lea eax, ss:[ebp-0x1410]
00654A40    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
00654A45    push 0x5A0BE0
00654A4A    push 0x100
00654A4F    push 0x04
00654A51    push eax
00654A52    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' ]
...
00654A74    push 0x87437C                                   ; => [ String: UI2::countChildren ]
00654A79    push 0xBA8
00654A7E    mov ecx, 0x874310                               ; => [ String: numChildren >= 0 ]
...
00654AF1    call 0x0064E660                                 ; => [ Call: sub_64e660 ]
...
00654B0B    mov edx, eax                                    ; => [ Call: sub_64e7a0 ]
00654B0D    mov dword ptr ss:[ebp-0x141C], edx
00654B13    jmp 0x00654B26
00654B15    mov edx, ebx
00654B17    mov ecx, edi
00654B19    call 0x0064ECE0                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_64ece0 ]
...
00654B82    call 0x006DCF50                                 ; => [ Call: sub_6dcf50 | Data: data_8cae70 ]
...
00654BB2    push eax
00654BB3    call 0x0063D8D0                                 ; => [ Data: data_8cae70 | Call: sub_6dd140 | Call: sub_63d8d0 ]
00654BB8    mov ecx, dword ptr ss:[ebp-0x141C]
00654BBE    push edi
00654BBF    mov dword ptr ds:[ecx+0x15F8], ebx
00654BC5    add ecx, 0x15E0
00654BCB    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
00654C55    push eax
00654C56    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
00654C5B    mov ecx, dword ptr ss:[ebp-0x0C]
00654C5E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00654C65    pop ecx
00654C66    pop edi
00654C67    pop esi
00654C68    pop ebx
...
00654C6E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00654C73    mov esp, ebp
00654C75    pop ebp
00654C76    ret
00654C77    push 0x874440                                   ; => [ String: UI2DefGet ]
00654C7C    push 0xC17
00654C81    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00654C86    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
00654C8B    push 0x8739B4
00654C90    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp ]
00654C95    add esp, 0x0C
00654C98    call 0x0063BC30
00654C9D    test al, al
00654C9F    jz 0x00654CA2                                   ; => [ Call: sub_63bc30 ]
00654CA1    int3
00654CA2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00654CA7    push 0x874728                                   ; => [ String: UI2GetOrAllocTemplateChild ]
00654CAC    push 0xFC1
00654CB1    mov ecx, 0x85F1D0                               ; => [ String: idx == 0 ]
00654CB6    push 0x8739B4
00654CBB    mov edx, 0x801800
00654CC0    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\UI2.cpp ]
00654CC5    add esp, 0x0C
00654CC8    call 0x0063BC30
00654CCD    test al, al
00654CCF    jz 0x00654CD2                                   ; => [ Call: sub_63bc30 ]
00654CD1    int3
00654CD2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
