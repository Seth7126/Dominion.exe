...
006A289D    push 0x8770A0
006A28A2    push 0x57
006A28A4    push 0x877080
006A28A9    mov ecx, 0x8770C8
006A28AE    jmp 0x006A29FC
006A28B3    mov edx, dword ptr ds:[0x017774E8]
006A28B9    mov ecx, ebx
006A28BB    call 0x0069CA80
...
006A2913    imul edi, esi
006A2916    call 0x00687730
006A291B    xorps xmm0, xmm0
006A291E    mov ecx, edi
006A2920    movups xmmword ptr ds:[eax], xmm0
...
006A2930    mov dword ptr ds:[esi+0x08], eax
...
006A29E6    pop ebp
006A29E7    ret
006A29E8    push 0x87DD34
006A29ED    push 0xAC0
006A29F2    push 0x87DBAC
006A29F7    mov ecx, 0x87A950
006A29FC    mov edx, 0x801800
006A2A01    call 0x0063B870
006A2A06    add esp, 0x0C
006A2A09    call 0x0063BC30
006A2A0E    test al, al
006A2A10    jz 0x006A2A13
006A2A12    int3
006A2A13    call 0x0063BB00
