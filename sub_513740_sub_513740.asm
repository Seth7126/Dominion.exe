...
00513775    push 0x8140E0
0051377A    push 0x1634
0051377F    mov ecx, 0x814128
...
005137AA    mov ecx, dword ptr ds:[eax+0x5C]
...
00513954    pop ebp
00513955    ret
00513956    push 0x8140E0
0051395B    push 0x1661
00513960    mov ecx, 0x813BF8
00513965    push 0x80CD80
0051396A    mov edx, 0x801800
0051396F    call 0x0063B870
00513974    add esp, 0x0C
00513977    call 0x0063BC30
0051397C    test al, al
0051397E    jz 0x00513981
00513980    int3
00513981    call 0x0063BB00
