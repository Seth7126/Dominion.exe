...
0058D019    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0058D044    mov dword ptr ss:[ebp-0xC98], edi               ; => [ Call: nullptr ]
...
0058D071    call 0x00571FA0                                 ; => [ Call: sub_571fa0 | Call: nullptr ]
0058D076    add esp, 0x24
0058D079    push 0x02
0058D07B    push ebx
0058D07C    mov edx, edi
0058D07E    mov ecx, esi
0058D080    call 0x0051BB20                                 ; => [ Call: sub_51bb20 ]
...
0058D0B9    lea ebx, ds:[ecx+eax*1]                         ; => [ Call: sub_5b06a0 ]
...
0058D0F0    push eax
0058D0F1    call 0x00574670                                 ; => [ Call: sub_574670 ]
0058D0F6    add esp, 0x10
0058D0F9    xor eax, eax                                    ; => [ Call: nullptr ]
0058D0FB    mov dword ptr ss:[ebp-0xC90], eax               ; => [ Call: nullptr ]
...
0058D125    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
0058D144    mov dword ptr ss:[ebp-0xC8C], 0x00              ; => [ Call: nullptr ]
0058D14E    nop
...
0058D160    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
0058D195    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
0058D1B8    mov dword ptr ss:[ebp-0xC8C], 0x00              ; => [ Call: nullptr ]
...
0058D1D8    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
0058D1FB    mov dword ptr ss:[ebp-0xC8C], 0x00              ; => [ Call: nullptr ]
...
0058D220    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
0058D261    or ebx, eax
0058D263    mov dword ptr ss:[ebp-0xC94], ebx               ; => [ Call: sub_574670 ]
0058D269    lea eax, ss:[ebp-0xC88]
0058D26F    mov edx, edi
0058D271    push eax
0058D272    push 0x3EB
0058D277    mov ecx, esi
0058D279    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
0058D2B0    call 0x005947F0                                 ; => [ Call: sub_5947f0 ]
...
0058D2CB    call 0x004F6C30                                 ; => [ Call: sub_4f6c30 ]
...
0058D323    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
0058D351    pop ebx
0058D352    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
