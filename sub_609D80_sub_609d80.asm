...
00609D89    mov eax, dword ptr ds:[0x008C4040]
...
00609D99    push esi
00609D9A    push edi
00609D9B    call 0x0064E7A0
00609DA0    mov esi, dword ptr ds:[0x00CCF6C0]
00609DA6    xor edi, edi
00609DA8    mov ecx, 0x01
00609DAD    mov byte ptr ss:[ebp-0x95], 0x00
00609DB4    mov dword ptr ds:[eax+0x18BC], 0x609960
00609DBE    mov eax, 0x77FEA0
