...
00706E5D    call ebx                                        ; => [ Data: data_88d844 ]
...
00706E87    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\XmlWriter.cpp | Data: data_801800 | String: resultCount == len | String: sXmlEmit ]
00706E8C    add esp, 0x0C
00706E8F    call 0x0063BC30
00706E94    test al, al
00706E96    jz 0x00706E99                                   ; => [ Call: sub_63bc30 ]
00706E98    int3
00706E99    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
