...
0063B9BB    mov edi, dword ptr ds:[0x00CF64AC]              ; => [ Data: data_cf64ac ]
0063B9C1    test edi, edi
0063B9C3    jnz 0x0063B9F1
0063B9C5    mov ecx, 0xCF64B0
0063B9CA    call 0x0069DB50                                 ; => [ Data: data_cf64b0 | Call: sub_69db50 ]
0063B9CF    push 0x871B58                                   ; => [ Data: data_871b58 ]
0063B9D4    push 0xCF64B0                                   ; => [ Data: data_cf64b0 ]
...
0063B9E8    push 0x871B3C                                   ; => [ String: Failed to open log file\n ]
0063B9ED    call esi
0063B9EF    jmp 0x0063BA20
0063B9F1    mov dword ptr ds:[0x00CF64AC], edi              ; => [ Data: data_cf64ac ]
0063B9F7    push edi
0063B9F8    push 0x01
0063B9FA    push 0x08
0063B9FC    push 0x871AB0                                   ; => [ String: \nStack:\n ]
0063BA01    call dword ptr ds:[0x00775630]
0063BA07    add esp, 0x10
0063BA0A    cmp eax, 0x01
0063BA0D    jz 0x0063BA16
0063BA0F    push 0x871B84                                   ; => [ String: Failed to write to log file\n ]
0063BA14    call esi
0063BA16    push edi
...
0063BAB0    cmovnz esi, ecx                                 ; => [ Call: nullptr ]
0063BAB3    push ecx
0063BAB4    push edi
...
0063BAE4    mov dword ptr fs:[0x00000000], ecx              ; => [ Type: TEB | Field: ExceptionList | Field: NtTib ]
0063BAEB    pop ecx
0063BAEC    pop edi
0063BAED    pop esi
0063BAEE    pop ebx
...
0063BAF4    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
