...
00676E75    push 0x76D857                                   ; => [ Call: sub_76d857 | Type: EHRegistrationNode ]
00676E7A    mov eax, dword ptr fs:[0x00000000]
00676E80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00676E8E    push eax                                        ; => [ Data: __security_cookie ]
00676E8F    lea eax, ss:[ebp-0x0C]
00676E92    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00676EAB    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
00676EB0    mov edx, ebx                                    ; => [ Data: data_801800 ]
00676EB2    mov eax, dword ptr ds:[eax+0x20]
00676EB5    test eax, eax
00676EB7    cmovnz edx, eax
00676EBA    call 0x0069FEB0                                 ; => [ Call: sub_69feb0 ]
...
00676ED3    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
00676EEA    push eax
00676EEB    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
00676F13    call esi                                        ; => [ Data: data_876758 ]
...
00676F25    push edi
00676F26    call esi                                        ; => [ Data: data_876774 ]
...
00676F3E    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
00676F43    lea ecx, ss:[ebp-0x1C]
00676F46    mov byte ptr ss:[ebp-0x04], 0x02
00676F4A    call 0x0063E470                                 ; => [ Call: sub_63e470 ]
00676F4F    mov edx, 0x804D68
00676F54    lea ecx, ss:[ebp-0x18]
00676F57    call 0x0063D720                                 ; => [ String: _- | Call: sub_63d720 ]
...
00676F70    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
00676FA3    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63dde0 ]
...
00676FB2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00676FCB    push ebx
00676FCC    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
00676FEA    jz 0x0067701A                                   ; => [ Data: data_cf65bc ]
...
00676FFB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067700E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00677013    mov dword ptr ss:[ebp+0x0C], 0x801800           ; => [ Data: data_801800 ]
0067701A    mov byte ptr ss:[ebp-0x04], 0x09
0067701E    cmp dword ptr ds:[0x00CF65BC], 0x00
00677025    jz 0x00677055                                   ; => [ Data: data_cf65bc ]
...
00677036    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677049    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067704E    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00677055    mov byte ptr ss:[ebp-0x04], 0x0A
00677059    cmp dword ptr ds:[0x00CF65BC], 0x00
00677060    jz 0x00677089                                   ; => [ Data: data_cf65bc ]
...
00677071    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677084    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00677089    mov byte ptr ss:[ebp-0x04], 0x0B
0067708D    cmp dword ptr ds:[0x00CF65BC], 0x00
00677094    jz 0x006770BD                                   ; => [ Data: data_cf65bc ]
...
006770A5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006770B8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006770D1    jz 0x006770EE                                   ; => [ Data: data_cf65bc ]
006770D3    lea ecx, ss:[ebp-0x1C]
006770D6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067710D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677120    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00677125    mov eax, edi
00677127    mov ecx, dword ptr ss:[ebp-0x0C]
0067712A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00677131    pop ecx
00677132    pop edi
00677133    pop esi
00677134    pop ebx
...
0067714F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
00677154    add esp, 0x0C
00677157    call 0x0063BC30
0067715C    test al, al
0067715E    jz 0x00677161                                   ; => [ Call: sub_63bc30 ]
00677160    int3
00677161    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00677166    push 0x871DD4
0067716B    push 0x94
00677170    push 0x871D5C
00677175    mov edx, ebx
00677177    mov ecx, 0x871E0C
0067717C    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
00677181    add esp, 0x0C
00677184    call 0x0063BC30
00677189    test al, al
0067718B    jz 0x0067718E                                   ; => [ Call: sub_63bc30 ]
0067718D    int3
0067718E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
