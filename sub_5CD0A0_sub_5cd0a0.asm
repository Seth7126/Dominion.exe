...
005CD0A9    mov eax, dword ptr ds:[0x008C4040]
...
005CD0C6    push 0x86F58C
005CD0CB    push 0xC5D
005CD0D0    mov ecx, 0x86F59C
...
005CD0E6    lea ecx, ds:[eax+0x4084]
...
005CD13E    push 0x86F58C
005CD143    push 0xC67
005CD148    mov ecx, 0x86F5B4
...
005CD17C    push 0x86F58C
005CD181    push 0xC73
005CD186    mov ecx, 0x86F5C4
005CD18B    jmp 0x005CD2F8
005CD190    push 0x86F58C
005CD195    push 0xC72
005CD19A    mov ecx, 0x86F5B4
...
005CD2AB    pop esi
005CD2AC    pop ebx
005CD2AD    call 0x0075927A
005CD2B2    mov esp, ebp
005CD2B4    pop ebp
005CD2B5    ret
005CD2B6    push 0x86F58C
005CD2BB    push 0xC99
005CD2C0    mov ecx, 0x86F5DC
005CD2C5    jmp 0x005CD2F8
005CD2C7    push 0x86F58C
005CD2CC    push 0xC98
005CD2D1    mov ecx, 0x86F5C4
005CD2D6    jmp 0x005CD2F8
005CD2D8    push 0x86F58C
005CD2DD    push 0xC96
005CD2E2    mov ecx, 0x86F5B4
005CD2E7    jmp 0x005CD2F8
005CD2E9    push 0x86F58C
005CD2EE    push 0xC8F
005CD2F3    mov ecx, 0x801AA4
005CD2F8    push 0x86F1E8
005CD2FD    mov edx, 0x801800
005CD302    call 0x0063B870
005CD307    add esp, 0x0C
005CD30A    call 0x0063BC30
005CD30F    test al, al
005CD311    jz 0x005CD314
005CD313    int3
005CD314    call 0x0063BB00
