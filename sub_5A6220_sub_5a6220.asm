...
005A62A5    addss xmm2, dword ptr ds:[edi+0x04]
005A62AA    addss xmm3, dword ptr ds:[edi+0x08]
...
005A630F    addss xmm2, dword ptr ds:[edi+0x04]
005A6314    addss xmm3, dword ptr ds:[edi+0x08]
...
005A635A    addss xmm0, dword ptr ds:[esi]
...
005A6526    pop ebp
005A6527    ret
005A6528    push 0x825340
005A652D    push 0x5BC
005A6532    mov ecx, 0x825370
005A6537    jmp 0x005A6559
005A6539    push 0x825340
005A653E    push 0x5BB
005A6543    mov ecx, 0x825354
005A6548    jmp 0x005A6559
005A654A    push 0x825340
005A654F    push 0x5B6
005A6554    mov ecx, 0x801AA4
005A6559    push 0x8250E0
005A655E    mov edx, 0x801800
005A6563    call 0x0063B870
005A6568    add esp, 0x0C
005A656B    call 0x0063BC30
005A6570    test al, al
005A6572    jz 0x005A6575
005A6574    int3
005A6575    call 0x0063BB00
