...
004C51AF    mov dword ptr ds:[eax+0x18BC], 0x4C4610         ; => [ Call: sub_4c4610 | Call: sub_64e7a0 ]
004C51B9    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C51D1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C51D6    movss xmm3, dword ptr ds:[0x00890E18]
004C51DE    mov edx, 0x8DBF08
004C51E3    push 0x00
004C51E5    push 0xFFFFFFFF
004C51E7    mov ecx, eax
004C51E9    call 0x00665DB0                                 ; => [ Data: data_8dbf08 | Call: sub_665db0 ]
004C51EE    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004C5213    mov bl, al                                      ; => [ Call: sub_5f1a50 | Call: sub_4b9480 ]
004C5215    call 0x004B9480
004C521A    mov ecx, dword ptr ds:[eax+0x1C]
004C521D    add ecx, 0xFFFFFF9C
004C5220    cmp ecx, 0x19
004C5223    jnbe 0x004C5255                                 ; => [ Call: sub_4b9480 ]
004C5225    mov ecx, esi
004C5227    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C522C    movss xmm3, dword ptr ds:[0x00890E18]
004C5234    mov edx, 0x8DBF14
004C5239    push 0x00
004C523B    push 0xFFFFFFFF
004C523D    mov ecx, eax
004C523F    call 0x00665DB0                                 ; => [ Data: data_8dbf14 | Call: sub_665db0 ]
004C5244    add esp, 0x08
004C5247    mov ecx, esi
004C5249    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C524E    mov edx, 0x8DBF20                               ; => [ Data: data_8dbf20 ]
004C5253    jmp 0x004C5273
004C5255    test bl, bl
004C5257    jz 0x004C5267
004C5259    mov ecx, esi
004C525B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C5260    mov edx, 0x8DBF20                               ; => [ Data: data_8dbf20 ]
004C5265    jmp 0x004C5273
004C5267    mov ecx, esi
004C5269    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 | Call: sub_64e7a0 ]
004C526E    mov edx, 0x8DBF2C                               ; => [ Data: data_8dbf2c | Data: data_8dbf2c ]
...
004C528A    pop ebx
004C528B    pop ebp
004C528C    ret                                             ; => [ Call: sub_665db0 ]
004C528D    push 0x77EB90
004C5292    push 0x7B
004C5294    push 0x77EB50
004C5299    mov edx, 0x801800
004C529E    mov ecx, 0x77EB9C
004C52A3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004C52A8    add esp, 0x0C
004C52AB    call 0x0063BC30
004C52B0    test al, al
004C52B2    jz 0x004C52B5                                   ; => [ Call: sub_63bc30 ]
004C52B4    int3
004C52B5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
