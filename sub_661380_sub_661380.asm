...
00661398    push 0x76D175                                   ; => [ Type: EHRegistrationNode | Call: sub_76d175 ]
0066139D    mov eax, dword ptr fs:[0x00000000]
006613A3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006613A4    push ebx
...
006613B4    push eax                                        ; => [ Data: __security_cookie ]
006613B5    lea eax, ss:[ebp-0x0C]
006613B8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006613CE    call 0x006B33B0                                 ; => [ Call: sub_6b33b0 ]
006613D3    test esi, esi
006613D5    jnz 0x0066144D
006613D7    push 0x12
006613D9    mov edx, 0x879C7C
006613DE    lea ecx, ss:[ebp-0x14]
006613E1    call 0x0069FD50                                 ; => [ String: !Null\Null | Call: sub_69fd50 ]
...
006613F2    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006613F7    test eax, eax
006613F9    cmovnz ecx, eax
006613FC    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
...
00661414    jz 0x00661444                                   ; => [ Data: data_cf65bc ]
...
00661425    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00661438    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0066143D    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
00661467    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
00661485    mov eax, dword ptr ds:[eax+0x2DC]               ; => [ Data: data_147b06c ]
0066148B    mov dword ptr ss:[ebp-0x44], eax
0066148E    test eax, eax
00661490    jnz 0x006614AB
00661492    push 0x8752E0                                   ; => [ String: MyFontDrawMatrix ]
00661497    push 0x2DE9
0066149C    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
006614A1    mov ecx, 0x873D08                               ; => [ String: material ]
006614A6    jmp 0x006618EE
006614AB    cmp dword ptr ds:[ecx+0x1C], 0x01
006614AF    jz 0x006614CA
006614B1    push 0x8752E0                                   ; => [ String: MyFontDrawMatrix ]
006614B6    push 0x2DF4
006614BB    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
006614C0    mov ecx, 0x8752C4                               ; => [ String: pDefFont->layerCount == 1 ]
...
006614EB    push 0x86F01C                                   ; => [ String: TextureGetDef ]
006614F0    push 0x89
006614F5    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
006614FA    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
006614FF    jmp 0x006618EE
00661504    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0066152B    addsd xmm0, qword ptr ds:[eax*8+0x893660]       ; => [ Data: data_893660 ]
...
00661560    divss xmm1, xmm0                                ; => [ Data: data_893660 ]
00661564    movss dword ptr ss:[ebp-0x3C], xmm1
00661569    jz 0x00661584
0066156B    push 0x8752E0                                   ; => [ String: MyFontDrawMatrix ]
00661570    push 0x2E0D
00661575    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
0066157A    mov ecx, 0x8752F4                               ; => [ String: !pLayer->dontColorize ]
...
00661593    add edi, 0x124                                  ; => [ Data: data_147b06c ]
00661599    push eax
...
006615C4    call 0x00642E30                                 ; => [ Call: sub_642e30 ]
...
0066161F    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
006616AF    push edi
006616B0    call 0x006B3320                                 ; => [ Call: sub_6b3320 ]
...
006616C2    call 0x005A0DB0                                 ; => [ Call: sub_5a0db0 ]
...
006617CC    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
00661858    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
0066189C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006618A3    pop ecx
006618A4    pop edi
006618A5    pop esi
...
006618C3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006618C8    add esp, 0x0C
006618CB    call 0x0063BC30
006618D0    test al, al
006618D2    jz 0x006618D5                                   ; => [ Call: sub_63bc30 ]
006618D4    int3
006618D5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006618DA    push 0x825074                                   ; => [ String: Xutf8_peek_next ]
006618DF    push 0x21C
006618E4    mov ecx, 0x8250B0                               ; => [ String: !Xutf8_is_invalid_lead_char(str) ]
006618E9    push 0x825090                                   ; => [ String: C:\x\ax2017\Engine\Xutf8.cpp ]
006618EE    mov edx, 0x801800
006618F3    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006618F8    add esp, 0x0C
006618FB    call 0x0063BC30
00661900    test al, al
00661902    jz 0x00661905                                   ; => [ Call: sub_63bc30 ]
00661904    int3
00661905    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
