...
0060B435    push 0x76AE11                                   ; => [ Type: EHRegistrationNode | Call: sub_76ae11 ]
0060B43A    mov eax, dword ptr fs:[0x00000000]
0060B440    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060B452    push esi
0060B453    push edi
0060B454    push eax                                        ; => [ Data: __security_cookie ]
0060B455    lea eax, ss:[ebp-0x0C]
0060B458    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0060B45E    mov edi, ecx
0060B460    push 0x4AB1F0                                   ; => [ Call: sub_4ab1f0 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060B487    push ecx                                        ; => [ Call: `eh vector constructor iterator' | Call: sub_4ab1e0 ]
0060B488    mov ecx, dword ptr ds:[0x00CCF6B4]
0060B48E    call 0x0060A220                                 ; => [ Call: sub_60a220 | Data: data_ccf6b4 ]
...
0060B4A5    call 0x00666120                                 ; => [ Data: data_be5bdc | Call: sub_666120 ]
...
0060B52E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060B541    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060B546    mov dword ptr ss:[ebp-0xC8], 0x801800           ; => [ Data: data_801800 ]
0060B550    mov byte ptr ss:[ebp-0x04], 0x00
0060B554    mov ecx, dword ptr ds:[0x00CC8DC8]
0060B55A    mov ecx, dword ptr ds:[ecx+0x1E1A4]
0060B560    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
0060B576    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B57B    movss xmm3, dword ptr ds:[0x00890E18]
0060B583    mov edx, 0xBE5C00
0060B588    push 0x00
0060B58A    push esi
0060B58B    mov ecx, eax
0060B58D    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5c00 ]
...
0060B5A4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B5A9    movss xmm3, dword ptr ds:[0x00890E18]
0060B5B1    mov edx, 0xBE5C0C
0060B5B6    push 0x00
0060B5B8    push esi
0060B5B9    mov ecx, eax
0060B5BB    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5c0c ]
...
0060B658    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060B66B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060B670    mov dword ptr ss:[ebp-0xCC], 0x801800           ; => [ Data: data_801800 ]
0060B67A    mov byte ptr ss:[ebp-0x04], 0x00
0060B67E    jmp 0x0060B6C0
0060B680    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B685    push 0x00
0060B687    push 0x02
0060B689    mov edx, 0xBE5B7C
0060B68E    jmp 0x0060B6AE
0060B690    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B695    push 0x00
0060B697    push 0x01
0060B699    mov edx, 0xBE5B70
0060B69E    jmp 0x0060B6AE
0060B6A0    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B6A5    push 0x00
0060B6A7    push 0x00
0060B6A9    mov edx, 0xBE5B64
0060B6AE    movss xmm3, dword ptr ds:[0x00890E18]
0060B6B6    mov ecx, eax
0060B6B8    call 0x00665DB0                                 ; => [ Data: data_be5b64 | Call: sub_665db0 | Data: data_be5b70 | Call: sub_665db0 | Call: sub_665db0 | Data: data_be5b7c ]
...
0060B6E1    jnz 0x0060B6EF                                  ; => [ Data: data_ccf6b4 ]
0060B6E3    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B6E8    mov edx, 0xBE5D38                               ; => [ Data: data_be5d38 ]
0060B6ED    jmp 0x0060B6F9
0060B6EF    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060B6F4    mov edx, 0xBE5D44                               ; => [ Data: data_be5d44 ]
0060B6F9    movss xmm3, dword ptr ds:[0x00890E18]
0060B701    mov ecx, eax
0060B703    push 0x00
0060B705    push 0xFFFFFFFF
0060B707    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
0060B723    push 0x0C
0060B725    push eax
0060B726    call 0x007592FC                                 ; => [ Call: sub_4ab1f0 | Call: `eh vector vbase constructor iterator' ]
0060B72B    mov ecx, dword ptr ss:[ebp-0x0C]
0060B72E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060B735    pop ecx
0060B736    pop edi
0060B737    pop esi
0060B738    pop ebx
...
0060B73E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
