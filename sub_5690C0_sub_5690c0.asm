...
005690CC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005690E7    call 0x00573400                                 ; => [ Call: sub_573400 ]
005690EC    mov edi, eax
005690EE    mov edx, ebx
005690F0    mov ecx, dword ptr ds:[edi+0x04]
005690F3    call 0x0057DC30                                 ; => [ Call: sub_57dc30 ]
...
00569130    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00569158    mov dword ptr ss:[esp+0x1C], eax                ; => [ Call: nullptr ]
0056915C    call 0x00582DE0
00569161    add esp, 0x04
00569164    test al, al
00569166    jz 0x00569189                                   ; => [ Call: sub_582de0 ]
00569168    mov ecx, dword ptr ds:[edi+0x04]
0056916B    xor bl, bl
0056916D    call 0x00583350                                 ; => [ Call: sub_583350 ]
00569172    mov al, bl
00569174    pop edi
00569175    pop esi
00569176    pop ebx
...
00569180    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005691DF    call 0x005822E0                                 ; => [ Call: nullptr | Call: sub_5822e0 ]
005691E4    mov ecx, dword ptr ds:[edi+0x04]
005691E7    add esp, 0x34
005691EA    mov bl, 0x01
005691EC    call 0x00583350                                 ; => [ Call: sub_583350 ]
...
005691FF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
