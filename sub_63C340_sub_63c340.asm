...
0063C358    push 0x76C310                                   ; => [ Type: EHRegistrationNode | Call: sub_76c310 ]
0063C35D    mov eax, dword ptr fs:[0x00000000]
0063C363    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0063C364    push ebx
...
0063C375    push esi
0063C376    push edi
0063C377    push eax                                        ; => [ Data: __security_cookie ]
0063C378    lea eax, ss:[ebp-0x0C]
0063C37B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0063C381    mov dword ptr ss:[ebp-0xA8], ecx
0063C387    push 0x01
0063C389    call dword ptr ds:[0x00775290]
0063C38F    test eax, eax
0063C391    jz 0x0063C570                                   ; => [ Type: BOOL ]
0063C397    push 0x00
0063C399    call dword ptr ds:[0x00775370]
0063C39F    test eax, eax
0063C3A1    jz 0x0063C570                                   ; => [ Call: nullptr ]
0063C3A7    push 0x0D
0063C3A9    call dword ptr ds:[0x00775294]
0063C3AF    mov dword ptr ss:[ebp-0xA4], eax                ; => [ Type: BOOL ]
0063C3B5    test eax, eax
0063C3B7    jz 0x0063C570
0063C3BD    push eax
0063C3BE    call dword ptr ds:[0x007750EC]
0063C3C4    mov ecx, eax                                    ; => [ Type: BOOL ]
0063C3C6    mov dword ptr ss:[ebp-0xA0], ecx                ; => [ Type: BOOL ]
...
0063C3E7    movups xmmword ptr ss:[ebp-0x2C], xmm0          ; => [ Call: __builtin_memset ]
...
0063C420    push ecx
0063C421    push eax
0063C422    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0063C467    mov edi, eax                                    ; => [ Call: sub_63d480 ]
...
0063C47F    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0063C49A    call 0x0063CA90                                 ; => [ Call: sub_63ca90 ]
...
0063C4C6    call 0x0063CCA0                                 ; => [ Call: sub_63cca0 ]
...
0063C4E0    push eax
0063C4E1    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
0063C51E    push ecx
0063C51F    push edx
0063C520    call 0x00759661                                 ; => [ Call: operator new ]
0063C525    add esp, 0x08
0063C528    lea ecx, ss:[ebp-0x98]
0063C52E    call 0x0063CA10                                 ; => [ Call: sub_63ca10 ]
...
0063C562    push ecx
0063C563    push edi
0063C564    call 0x00759661                                 ; => [ Call: operator new ]
0063C569    add esp, 0x08
0063C56C    mov al, 0x01
0063C56E    jmp 0x0063C572
0063C570    xor al, al
0063C572    mov ecx, dword ptr ss:[ebp-0x0C]
0063C575    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063C57C    pop ecx
0063C57D    pop edi
0063C57E    pop esi
0063C57F    mov ecx, dword ptr ss:[ebp-0x14]
0063C582    xor ecx, ebp
0063C584    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0063C589    mov esp, ebp
0063C58B    pop ebp
0063C58C    mov esp, ebx
0063C58E    pop ebx
0063C58F    ret
0063C590    call 0x005B0860                                 ; => [ Call: sub_5b0860 ]
