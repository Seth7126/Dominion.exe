...
004C0941    mov dword ptr ds:[eax+0x18BC], 0x4C0290         ; => [ Call: sub_64e7a0 | Call: sub_4c0290 ]
004C094B    mov eax, dword ptr ds:[0x00CC8DC8]
004C0950    mov eax, dword ptr ds:[eax+0x1E1A0]             ; => [ Data: data_cc8dc8 ]
...
004C0968    push eax
004C0969    call 0x00666120                                 ; => [ Data: data_8dbca4 | Call: sub_666120 ]
004C096E    mov ecx, dword ptr ds:[0x00CC8DC8]
004C0974    add esp, 0x08
004C0977    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004C097D    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004C0982    xor ebx, ebx                                    ; => [ Call: nullptr ]
004C0984    mov dword ptr ss:[ebp-0x10], eax
004C0987    test edi, edi
004C0989    jle 0x004C0ABF
004C098F    xor edx, edx                                    ; => [ Call: nullptr ]
004C0991    mov edi, 0x19E55E4                              ; => [ Data: data_19e55e4 ]
004C0996    mov dword ptr ss:[ebp-0x08], edx                ; => [ Call: nullptr ]
...
004C09B6    jnz 0x004C09E1                                  ; => [ String: tbl_profiles ]
...
004C09CB    jnb 0x004C09E1                                  ; => [ Data: data_c23bac ]
004C09CD    imul eax, eax, 0x18D0
004C09D3    add eax, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
004C09D9    cmp dword ptr ds:[eax+0x18C8], ecx
004C09DF    jz 0x004C0A17
004C09E1    push ebx
004C09E2    mov edx, 0x80348C
004C09E7    mov ecx, esi
004C09E9    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
...
004C0A04    mov dword ptr ds:[edi], 0x80348C                ; => [ String: tbl_profiles ]
...
004C0A1F    mov eax, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
...
004C0AD5    call 0x004BBA60                                 ; => [ String: tbl_profiles | Call: sub_4bba60 | Data: data_19e55e0 ]
004C0ADA    test eax, eax
004C0ADC    jz 0x004C0B00
004C0ADE    mov ecx, eax
004C0AE0    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004C0AE5    movss xmm3, dword ptr ds:[0x00890E18]
004C0AED    mov edx, 0x8DBCC8
004C0AF2    push 0x00
004C0AF4    push 0xFFFFFFFF
004C0AF6    mov ecx, eax
004C0AF8    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dbcc8 ]
...
004C0B20    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp | Data: data_801800 | String: retval | String: GetProfileBySlot ]
004C0B25    add esp, 0x0C
004C0B28    call 0x0063BC30
004C0B2D    test al, al
004C0B2F    jz 0x004C0B32                                   ; => [ Call: sub_63bc30 ]
004C0B31    int3
004C0B32    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
