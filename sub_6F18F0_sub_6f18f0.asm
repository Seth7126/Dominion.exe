...
006F18FE    xor eax, ebp                                    ; => [ Data: __security_cookie ]
006F1900    mov dword ptr ss:[ebp-0x04], eax
006F1903    cmp byte ptr ds:[0x0147D488], 0x00
006F190A    push ebx
006F190B    push esi
006F190C    push edi
006F190D    jnz 0x006F1B0B                                  ; => [ Data: data_147d488 ]
006F1913    call 0x006EE800                                 ; => [ Call: sub_6ee800 ]
006F1918    test eax, eax
006F191A    jz 0x006F1B0B
006F1920    mov edi, dword ptr ds:[0x0147D474]              ; => [ Data: data_147d474 ]
...
006F1942    call 0x006EE800                                 ; => [ Call: sub_6ee800 ]
...
006F19CB    push eax
006F19CC    call 0x0064B6D0                                 ; => [ Type: va_list | Call: sub_64b6d0 | String: %f ]
...
006F19E3    push eax
006F19E4    call 0x0064B6D0                                 ; => [ Type: va_list | Call: sub_64b6d0 | String: %f ]
...
006F1A64    call esi                                        ; => [ Type: LRESULT ]
006F1A66    cmp eax, 0xFFFFFFFF
006F1A69    jnz 0x006F1A7F
006F1A6B    push 0x88B3A8                                   ; => [ String: EditorNodeDataChanged ]
006F1A70    push 0x7EC
006F1A75    mov ecx, 0x88B390                               ; => [ String: curveIndex != CB_ERR ]
...
006F1A9D    call ebx                                        ; => [ Data: data_147d470 | Type: HWND ]
006F1A9F    push 0x00
006F1AA1    push 0x00
...
006F1ADB    push 0x98
006F1AE0    setnz al                                        ; => [ Data: data_147d470 ]
006F1AE3    mov byte ptr ds:[ebx+0x14], al
006F1AE6    push dword ptr ds:[0x0147D470]
006F1AEC    call esi
006F1AEE    test eax, eax
006F1AF0    push 0x00
006F1AF2    setnz al                                        ; => [ Data: data_147d470 ]
006F1AF5    push 0x00
006F1AF7    mov byte ptr ds:[ebx+0x15], al
006F1AFA    push dword ptr ds:[0x0147D470]
006F1B00    call dword ptr ds:[0x00775314]
006F1B06    call 0x006EE530                                 ; => [ Call: nullptr | Call: sub_6ee530 | Data: data_147d470 ]
006F1B0B    mov ecx, dword ptr ss:[ebp-0x04]
006F1B0E    pop edi
006F1B0F    pop esi
006F1B10    xor ecx, ebp
006F1B12    pop ebx
006F1B13    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006F1B18    mov esp, ebp
006F1B1A    pop ebp
006F1B1B    ret
006F1B1C    push 0x88B3A8                                   ; => [ String: EditorNodeDataChanged ]
006F1B21    push 0x7F1
006F1B26    mov ecx, 0x88B3D4                               ; => [ String: distributionIndex != CB_ERR ]
006F1B2B    push 0x88AF54
006F1B30    mov edx, 0x801800
006F1B35    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: EditorNodeDataChanged | String: C:\x\ax2017\Engine\Windows\EditorWindow.cpp ]
006F1B3A    add esp, 0x0C
006F1B3D    call 0x0063BC30
006F1B42    test al, al
006F1B44    jz 0x006F1B47                                   ; => [ Call: sub_63bc30 ]
006F1B46    int3
006F1B47    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
