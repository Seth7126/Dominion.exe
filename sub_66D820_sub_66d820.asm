...
0066D825    push 0x76D4C0                                   ; => [ Type: EHRegistrationNode | Call: sub_76d4c0 ]
0066D82A    mov eax, dword ptr fs:[0x00000000]
0066D830    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0066D831    mov eax, 0x101C
0066D836    call 0x00761E50                                 ; => [ Call: __chkstk ]
0066D83B    mov eax, dword ptr ds:[0x008C4040]
0066D840    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0066D84C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0066D864    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0066D869    test eax, eax
0066D86B    cmovnz ecx, eax
0066D86E    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
0066D88F    xor eax, eax                                    ; => [ Call: nullptr | Call: nullptr ]
...
0066D8A2    call 0x00667870                                 ; => [ Call: sub_667870 ]
...
0066D902    jnz 0x0066D95C                                  ; => [ Call: sub_667680 ]
0066D904    lea edx, ss:[ebp-0x1014]
0066D90A    mov ecx, esi
0066D90C    call 0x00667680                                 ; => [ Call: sub_667680 ]
...
0066D91F    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
0066D93E    call 0x00687730                                 ; => [ Call: sub_687730 ]
0066D943    mov ecx, dword ptr ss:[ebp-0x101C]
0066D949    push esi
0066D94A    push ebx
0066D94B    push eax
0066D94C    mov dword ptr ds:[ecx], eax
0066D94E    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0066D96F    call 0x0066D750                                 ; => [ Call: sub_66d750 ]
0066D974    mov cl, 0x01
0066D976    call 0x00665770                                 ; => [ Call: sub_665770 ]
0066D97B    mov dword ptr ss:[ebp-0x04], 0x01
0066D982    cmp dword ptr ds:[0x00CF65BC], 0x00
0066D989    jz 0x0066D9B8                                   ; => [ Data: data_cf65bc ]
...
0066D9A0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0066D9B3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0066D9B8    mov ecx, dword ptr ss:[ebp-0x0C]
0066D9BB    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0066D9C2    pop ecx
0066D9C3    pop edi
0066D9C4    pop esi
0066D9C5    pop ebx
...
0066D9CB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0066D9ED    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
0066D9F2    add esp, 0x0C
0066D9F5    call 0x0063BC30
0066D9FA    test al, al
0066D9FC    jz 0x0066D9FF                                   ; => [ Call: sub_63bc30 ]
0066D9FE    int3
0066D9FF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
