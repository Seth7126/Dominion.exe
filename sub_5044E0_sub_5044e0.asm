...
005044EB    call 0x00761E50                                 ; => [ Call: __chkstk ]
005044F0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005044F5    xor eax, esp
005044F7    mov dword ptr ss:[esp+0x2604], eax
005044FE    push esi
005044FF    push edi
00504500    call 0x00573400                                 ; => [ Call: sub_573400 ]
00504505    mov esi, eax
00504507    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
0050450C    mov edx, dword ptr ds:[esi+0x0C]
0050450F    mov ecx, dword ptr ds:[esi+0x04]
00504512    push 0x01
00504514    push eax
00504515    call 0x00594010                                 ; => [ Call: sub_594010 ]
0050451A    xor edx, edx
0050451C    or ecx, 0xFFFFFFFF
0050451F    call 0x00561F60                                 ; => [ Call: sub_561f60 ]
00504524    call 0x00573400                                 ; => [ Call: sub_573400 ]
00504529    push 0x0C
0050452B    push 0x00
...
00504546    push 0x3EE
0050454B    push 0x03
0050454D    call 0x00588DB0                                 ; => [ Call: sub_588db0 ]
00504552    add esp, 0x2C
00504555    mov dword ptr ss:[esp+0xCF0], eax
0050455C    xorps xmm0, xmm0
0050455F    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
0050458D    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0050458F    push 0x05
...
005045FC    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
005045FE    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00504633    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
...
00504659    call 0x00569330                                 ; => [ Call: sub_569330 | Call: sub_56a0a0 ]
0050465E    mov ecx, dword ptr ss:[esp+0x2638]
00504665    add esp, 0x2C
00504668    pop edi
00504669    pop esi
0050466A    xor ecx, esp
0050466C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
