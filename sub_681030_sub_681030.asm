...
00681035    push 0x76DBFD                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0?$function@$$A6AXPAV?$message@I@Concurrency@@@Z@std@@QAE@ABV01@@Z ]
0068103A    mov eax, dword ptr fs:[0x00000000]
00681040    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00681041    push ecx
00681042    push ebx
00681043    push esi
00681044    push edi
...
00681050    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00681062    test al, al
00681064    jz 0x006810D4                                   ; => [ Data: __security_cookie ]
...
006810B0    jz 0x006810CD                                   ; => [ Data: data_cf65bc ]
006810B2    lea ecx, ss:[ebp-0x10]
006810B5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006810C8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00681132    jz 0x0068114F                                   ; => [ Data: data_cf65bc ]
00681134    lea ecx, ss:[ebp-0x10]
00681137    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068114A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068114F    push ebx
00681150    push edi
...
006811AC    jz 0x006811C9                                   ; => [ Data: data_cf65bc ]
006811AE    lea ecx, ss:[ebp+0x0C]
006811B1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006811C4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006811C9    mov ecx, dword ptr ss:[ebp-0x0C]
006811CC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006811D3    pop ecx
006811D4    pop edi
006811D5    pop esi
006811D6    pop ebx
