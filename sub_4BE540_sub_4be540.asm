...
004BE54C    mov eax, dword ptr ds:[0x008C4040]
...
004BE5A3    push 0x80314C
004BE5A8    push 0xB6D
004BE5AD    mov ecx, 0x80315C
...
004BE5CE    call 0x00571C40
004BE5D3    mov ecx, dword ptr ss:[esp+0x1C]
004BE5D7    mov esi, 0x780768
...
004BE5FF    mov eax, dword ptr ds:[0x00BF23B8]
...
004BE61C    mov ecx, dword ptr ds:[eax]
...
004BE6CA    jz 0x004BE6ED
004BE6CC    add eax, 0x10C
004BE6D1    inc ecx
004BE6D2    cmp eax, 0x28D4
004BE6D7    jb 0x004BE6C4
004BE6D9    mov dword ptr ss:[esp+0x14], 0x78087C
004BE6E1    mov ecx, 0x780884
004BE6E6    mov eax, 0x780880
004BE6EB    jmp 0x004BE709
004BE6ED    imul eax, ecx, 0x10C
004BE6F3    lea ecx, ds:[eax+0x78087C]
004BE6F9    mov dword ptr ss:[esp+0x14], ecx
004BE6FD    lea ecx, ds:[eax+0x780884]
004BE703    lea eax, ds:[eax+0x780880]
...
004BE88A    call 0x0075927A
004BE88F    mov esp, ebp
004BE891    pop ebp
004BE892    ret
004BE893    push 0x80314C
004BE898    push 0xB8B
004BE89D    mov ecx, 0x803184
004BE8A2    push 0x80292C
004BE8A7    mov edx, 0x801800
004BE8AC    call 0x0063B870
004BE8B1    add esp, 0x0C
004BE8B4    call 0x0063BC30
004BE8B9    test al, al
004BE8BB    jz 0x004BE8BE
004BE8BD    int3
004BE8BE    call 0x0063BB00
