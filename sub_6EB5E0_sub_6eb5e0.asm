...
006EB5E5    push 0x7717F7                                   ; => [ Call: sub_7717f7 | Type: EHRegistrationNode ]
006EB5EA    mov eax, dword ptr fs:[0x00000000]
006EB5F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006EB602    push esi
006EB603    push edi
006EB604    push eax                                        ; => [ Data: __security_cookie ]
006EB605    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006EB608    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006EB60E    mov ebx, edx
006EB610    mov dword ptr ss:[ebp-0x820], ecx
006EB616    mov esi, dword ptr ss:[ebp+0x08]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006EB619    test esi, esi
006EB61B    jnz 0x006EB6A3
006EB621    push 0x1D
006EB623    mov edx, 0x879C7C
006EB628    lea ecx, ss:[ebp-0x818]
006EB62E    call 0x0069FD50                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | String: !Null\Null | Call: sub_69fd50 ]
006EB633    add esp, 0x04
006EB636    mov dword ptr ss:[ebp-0x04], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006EB639    lea edx, ds:[esi+0x1D]
006EB63C    mov eax, dword ptr ss:[ebp-0x818]
006EB642    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006EB647    test eax, eax
006EB649    cmovnz ecx, eax
006EB64C    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
006EB651    mov esi, eax
006EB653    mov dword ptr ss:[ebp-0x04], 0x01
006EB65A    cmp dword ptr ds:[0x00CF65BC], 0x00
006EB661    jz 0x006EB69A                                   ; => [ Data: data_cf65bc ]
...
006EB678    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EB68B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EB690    mov dword ptr ss:[ebp-0x818], 0x801800          ; => [ Data: data_801800 ]
...
006EB6AF    mov dword ptr ss:[ebp-0x81C], esi               ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006EB6B5    cmp dword ptr ds:[edi], 0x00
006EB6B8    jnz 0x006EB6C8
006EB6BA    push 0x01
006EB6BC    xor dl, dl
006EB6BE    mov ecx, edi
006EB6C0    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
006EB6C5    add esp, 0x04
006EB6C8    mov eax, dword ptr ds:[edi]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006EB6CA    inc dword ptr ds:[edi+0x1C]                     ; => [ Field: Next ]
006EB6CD    mov edi, dword ptr ds:[eax]                     ; => [ Field: Next | Type: _EXCEPTION_REGISTRATION_RECORD ]
006EB6CF    lea edx, ss:[ebp-0x814]
006EB6D5    mov dword ptr ss:[ebp-0x04], 0x02
006EB6DC    mov ecx, edi
006EB6DE    call 0x006EB500                                 ; => [ Call: sub_6eb500 ]
...
006EB700    jle 0x006EB73E                                  ; => [ Data: data_1a9a340 | Field: ThreadLocalStoragePointer ]
006EB702    push 0x1A9A340
006EB707    call 0x0075970E                                 ; => [ Data: data_1a9a340 | Call: sub_75970e ]
006EB70C    add esp, 0x04
006EB70F    cmp dword ptr ds:[0x01A9A340], 0xFFFFFFFF
006EB716    jnz 0x006EB73E                                  ; => [ Data: data_1a9a340 ]
...
006EB731    mov dword ptr ds:[0x01A9A344], eax              ; => [ Call: sub_697540 | String: imgVisible | Data: data_1777584 | Data: data_1a9a344 ]
006EB736    call 0x007596BD                                 ; => [ Data: data_1a9a340 | Call: __Init_thread_footer ]
...
006EB754    jnz 0x006EB76A                                  ; => [ Data: data_1a9a344 ]
006EB756    imul ecx, dword ptr ss:[ebp+ebx*8-0x810], 0x58
006EB75E    add ecx, dword ptr ds:[edi]                     ; => [ Field: Next ]
...
006EB77B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006EB782    pop ecx
006EB783    pop edi
006EB784    pop esi
006EB785    pop ebx
...
006EB78B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006EB7AA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006EB7AF    add esp, 0x0C
006EB7B2    call 0x0063BC30
006EB7B7    test al, al
006EB7B9    jz 0x006EB7BC                                   ; => [ Call: sub_63bc30 ]
006EB7BB    int3
006EB7BC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006EB7C1    push 0x882C30
006EB7C6    push 0x143
006EB7CB    push 0x882BB8
006EB7D0    mov edx, 0x801800
006EB7D5    mov ecx, 0x882C1C
006EB7DA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\MaterialFnDef.cpp | Data: data_801800 | String: item < numLayers | String: MaterialFn_ItemClicked ]
006EB7DF    add esp, 0x0C
006EB7E2    call 0x0063BC30
006EB7E7    test al, al
006EB7E9    jz 0x006EB7EC                                   ; => [ Call: sub_63bc30 ]
006EB7EB    int3
006EB7EC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
