...
00509638    call 0x00509190                                 ; => [ Call: sub_509190 ]
0050963D    mov ecx, 0x02
00509642    mov esi, eax
00509644    call 0x00509190                                 ; => [ Call: sub_509190 ]
00509649    mov ebx, eax
0050964B    call 0x00573400
00509650    movzx esi, si
00509653    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00509656    cmp esi, 0x320
0050965C    jb 0x00509663
0050965E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050967B    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0050967E    cmp esi, 0x320
00509684    jb 0x0050968B
00509686    call 0x00591930                                 ; => [ Call: sub_591930 ]
