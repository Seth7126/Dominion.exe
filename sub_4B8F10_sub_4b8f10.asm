...
004B8F1B    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004B8F21    push esi
...
004B8F3A    mov dword ptr ss:[esp+0x08], eax                ; => [ Call: sub_4bb050 ]
004B8F3E    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B8F50    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004B8FB5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004B8FBA    add esp, 0x0C
004B8FBD    call 0x0063BC30
004B8FC2    test al, al
004B8FC4    jz 0x004B8FC7                                   ; => [ Call: sub_63bc30 ]
004B8FC6    int3
004B8FC7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
