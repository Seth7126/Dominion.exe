...
00501B21    push edi
00501B22    push ecx                                        ; => [ Call: __chkstk ]
00501B23    push 0x00
00501B25    lea ecx, ds:[edx+0x04]
00501B28    call 0x00561E00                                 ; => [ Data: __security_cookie | Call: sub_561e00 ]
00501B2D    call 0x00573400                                 ; => [ Call: sub_573400 ]
00501B32    push 0x00
00501B34    push 0x00
00501B36    push 0x01
...
00501B3E    push 0x01
00501B40    call 0x00590760                                 ; => [ Call: sub_590760 ]
00501B45    add esp, 0x18
00501B48    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00501B77    call 0x00568780                                 ; => [ Call: sub_568780 ]
00501B7C    xorps xmm0, xmm0
00501B7F    mov dword ptr ss:[esp+0x30], 0x00
00501B87    add esp, 0x04
00501B8A    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
00501BE0    push 0x00
00501BE2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00501BFD    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
00501C1D    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
00501C21    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00501C3A    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00501C7B    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
00501C80    add esp, 0x38
00501C83    lea eax, ss:[esp+0x88]
00501C8A    mov ecx, 0x3EA
00501C8F    push eax
00501C90    call 0x00568780                                 ; => [ Call: sub_568780 ]
00501C95    xorps xmm0, xmm0
00501C98    mov dword ptr ss:[esp+0x30], 0x00
00501CA0    add esp, 0x04
00501CA3    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
00501CF9    push 0x00
00501CFB    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00501D16    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
00501D3A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00501D53    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00501D94    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
00501D99    add esp, 0x38
00501D9C    mov ecx, dword ptr ss:[esp+0x199C]
00501DA3    pop edi
00501DA4    pop esi
00501DA5    xor ecx, esp
00501DA7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00501DC6    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00501DCB    add esp, 0x0C
00501DCE    call 0x0063BC30
00501DD3    test al, al
00501DD5    jz 0x00501DD8                                   ; => [ Call: sub_63bc30 ]
00501DD7    int3
00501DD8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
