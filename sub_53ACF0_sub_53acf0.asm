...
0053ACFB    call 0x00761E50
0053AD00    mov eax, dword ptr ds:[0x008C4040]
...
0053AD1E    call 0x005685F0
0053AD23    xorps xmm0, xmm0
0053AD26    mov dword ptr ss:[esp+0x28], 0x00
