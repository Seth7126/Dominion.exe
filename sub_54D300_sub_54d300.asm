...
0054D3BD    mov dword ptr ss:[ebp-0x1964], ecx
...
0054D571    mov dword ptr fs:[0x00000000], ecx
0054D578    pop ecx
0054D579    pop edi
0054D57A    pop esi
0054D57B    mov ecx, dword ptr ss:[ebp-0x14]
0054D57E    xor ecx, ebp
0054D580    call 0x0075927A
