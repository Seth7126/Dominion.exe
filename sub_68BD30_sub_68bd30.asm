...
0068BD35    push 0x76DF9E                                   ; => [ Call: sub_76df9e | Type: EHRegistrationNode ]
0068BD3A    mov eax, dword ptr fs:[0x00000000]
0068BD40    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0068BD41    sub esp, 0x14
0068BD44    push esi
0068BD45    push edi
0068BD46    mov eax, dword ptr ds:[0x008C4040]
0068BD4B    xor eax, ebp
0068BD4D    push eax                                        ; => [ Data: __security_cookie ]
0068BD4E    lea eax, ss:[ebp-0x0C]
0068BD51    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0068BD72    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
0068BD8F    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
0068BD94    mov eax, dword ptr ds:[esi]
0068BD96    lea ecx, ss:[ebp-0x10]
0068BD99    mov edi, 0x801800                               ; => [ Data: data_801800 ]
0068BD9E    test eax, eax
0068BDA0    mov edx, edi                                    ; => [ Data: data_801800 ]
...
0068BDC1    call 0x0063D850                                 ; => [ Data: data_86d2b0 | Call: sub_68bb10 | Call: sub_63d850 | String: {[p\rnm ]
0068BDC6    mov dword ptr ss:[ebp-0x04], 0x02
0068BDCD    cmp dword ptr ds:[0x00CF65BC], 0x00
0068BDD4    jz 0x0068BDFD                                   ; => [ Data: data_cf65bc ]
...
0068BDE5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068BE29    call 0x0063D850                                 ; => [ Data: data_86d2cc | Call: sub_68bb10 | Call: sub_63d850 | String: {[p\rnm ]
0068BE2E    mov dword ptr ss:[ebp-0x04], 0x04
0068BE35    cmp dword ptr ds:[0x00CF65BC], 0x00
0068BE3C    jz 0x0068BE65                                   ; => [ Data: data_cf65bc ]
...
0068BE4D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068BEBF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068BED2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068BEF1    call 0x0063DFA0                                 ; => [ Call: sub_63dfa0 | Data: data_808894 | Data: data_807454 ]
...
0068BF31    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068BF44    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068BF49    mov ecx, esi
0068BF4B    mov byte ptr ss:[ebp-0x04], 0x00
0068BF4F    call 0x0063E470                                 ; => [ Call: sub_63e470 ]
0068BF54    mov eax, esi
0068BF56    mov ecx, dword ptr ss:[ebp-0x0C]
0068BF59    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068BF60    pop ecx
0068BF61    pop edi
0068BF62    pop esi
...
0068BF80    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
0068BF85    add esp, 0x0C
0068BF88    call 0x0063BC30
0068BF8D    test al, al
0068BF8F    jz 0x0068BF92                                   ; => [ Call: sub_63bc30 ]
0068BF91    int3
0068BF92    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
