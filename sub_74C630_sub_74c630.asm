...
0074C639    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0074C63E    xor eax, esp
0074C640    mov dword ptr ss:[esp+0x20], eax
0074C644    mov eax, dword ptr ss:[ebp+0x14]
0074C647    push ebx
0074C648    mov ebx, dword ptr ss:[ebp+0x08]                ; => [ Type: HWND ]
0074C64B    push esi
...
0074C65B    call edi
0074C65D    push eax
0074C65E    call edi                                        ; => [ Type: HWND ]
0074C660    push 0x104
0074C665    push 0x1A9AF28
0074C66A    push ebx
0074C66B    mov dword ptr ss:[esp+0x24], eax
0074C66F    call dword ptr ds:[0x00775404]                  ; => [ Data: data_1a9af28 ]
0074C675    push 0x88FF38
0074C67A    push 0x1A9AF28
0074C67F    call dword ptr ds:[0x007755B0]                  ; => [ Data: data_1a9af28 | String: Edit ]
0074C685    add esp, 0x08
0074C688    mov dword ptr ss:[esp+0x14], eax
0074C68C    test eax, eax
0074C68E    jnz 0x0074C69E                                  ; => [ Type: HWND ]
0074C690    push dword ptr ss:[esp+0x18]
0074C694    call edi
0074C696    push 0x88FEDC                                   ; => [ String: lpInsData ]
0074C69B    push eax
0074C69C    jmp 0x0074C6A7
0074C69E    push 0x88FEDC                                   ; => [ String: lpInsData ]
0074C6A3    push dword ptr ss:[esp+0x1C]
0074C6A7    call dword ptr ds:[0x007753E0]                  ; => [ Type: HANDLE | String: lpInsData ]
0074C6AD    mov edi, dword ptr ss:[ebp+0x0C]
0074C6B0    mov dword ptr ds:[0x019E2778], eax              ; => [ Data: data_19e2778 ]
...
0074C6C9    push ebx
0074C6CA    call dword ptr ds:[0x007753D8]                  ; => [ String: Wprc ]
0074C6D0    push 0x88FEE8
0074C6D5    push ebx
0074C6D6    call dword ptr ds:[0x00775418]                  ; => [ String: Wprc ]
...
0074C6E7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074C717    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074C745    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074C75C    call dword ptr ds:[0x007753FC]                  ; => [ Call: nullptr ]
...
0074C775    push eax
0074C776    call dword ptr ds:[0x007753F0]                  ; => [ String: Wprc | Type: LRESULT ]
0074C77C    pop edi
0074C77D    pop esi
0074C77E    pop ebx
0074C77F    mov ecx, dword ptr ss:[esp+0x20]
0074C783    xor ecx, esp
0074C785    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074C7B3    push eax
0074C7B4    call dword ptr ds:[0x007753F0]                  ; => [ String: Wprc ]
0074C7BA    push ebx
0074C7BB    call dword ptr ds:[0x007753BC]                  ; => [ Type: HDC ]
...
0074C7E2    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074C7FF    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074C81D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074C83E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074C862    jnz 0x0074C762                                  ; => [ String: Wprc ]
0074C868    push 0x104
0074C86D    push 0x1A9AF28
0074C872    push dword ptr ss:[esp+0x18]
0074C876    call dword ptr ds:[0x00775404]                  ; => [ Data: data_1a9af28 ]
...
0074C891    jnz 0x0074C762                                  ; => [ Data: data_1a9af28 | String: Edit ]
...
0074C8AD    call dword ptr ds:[0x00775410]                  ; => [ String: Wprc ]
...
0074C8F2    push ebx
0074C8F3    call dword ptr ds:[0x007753EC]                  ; => [ Data: data_1a9af28 ]
0074C8F9    mov eax, dword ptr ds:[0x019E2778]
0074C8FE    mov eax, dword ptr ds:[eax+0x04]
0074C901    push dword ptr ds:[eax+0x10]
0074C904    call dword ptr ds:[0x00775528]                  ; => [ Data: data_19e2778 ]
0074C90A    add esp, 0x04
0074C90D    mov eax, 0x1A9AF28
0074C912    cmp byte ptr ds:[0x01A9AF28], 0x00
0074C919    mov edi, 0x801800                               ; => [ Data: data_801800 ]
0074C91E    cmovnz edi, eax                                 ; => [ Data: data_1a9af28 | Data: data_1a9af28 ]
...
0074C99F    call dword ptr ds:[0x0077539C]                  ; => [ Data: data_19e2778 ]
0074C9A5    call 0x00750570                                 ; => [ Call: sub_750570 ]
...
0074C9B8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074C9F5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074CA22    call dword ptr ds:[0x0077539C]                  ; => [ Data: data_19e2778 ]
0074CA28    mov eax, dword ptr ds:[0x019E2778]
0074CA2D    mov dword ptr ds:[eax+0x38], 0x00               ; => [ Data: data_19e2778 ]
0074CA34    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074CA4B    call dword ptr ds:[0x007753FC]                  ; => [ Call: nullptr ]
...
0074CA5F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0074CA9F    call dword ptr ds:[0x0077539C]                  ; => [ Data: data_19e2778 ]
...
0074CAB0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
