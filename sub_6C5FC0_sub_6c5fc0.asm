...
006C5FC5    push 0x7704D5                                   ; => [ Call: sub_7704d5 | Type: EHRegistrationNode ]
006C5FCA    mov eax, dword ptr fs:[0x00000000]
006C5FD0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C5FDE    push eax                                        ; => [ Data: __security_cookie ]
006C5FDF    lea eax, ss:[ebp-0x0C]
006C5FE2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C5FE8    mov edi, ecx
006C5FEA    mov eax, dword ptr ds:[0x0147AC2C]
006C5FEF    cmp dword ptr ds:[eax+0x24], 0x00
006C5FF3    jz 0x006C6071                                   ; => [ Type: MESSAGEBOX_RESULT | Data: data_147ac2c ]
006C5FF5    lea eax, ss:[ebp-0x18]
006C5FF8    push 0x87E1C0                                   ; => [ String: Can't save, current build settings elide data labels. ]
006C5FFD    push eax
006C5FFE    call 0x0063DF30
006C6003    add esp, 0x08
006C6006    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006C600B    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 ]
006C600D    test eax, eax
006C600F    cmovnz edi, eax
006C6012    call dword ptr ds:[0x007753B8]
006C6018    mov esi, eax                                    ; => [ Type: HWND ]
...
006C6030    push ecx                                        ; => [ Call: nullptr ]
006C6031    push 0x8767FC
006C6036    cmovnz esi, ecx                                 ; => [ Call: nullptr ]
006C6039    push edi
006C603A    push esi
006C603B    call dword ptr ds:[0x007753B0]                  ; => [ String: Can't save ]
006C6041    mov dword ptr ss:[ebp-0x04], 0x00
006C6048    cmp dword ptr ds:[0x00CF65BC], 0x00
006C604F    jz 0x006C61DB                                   ; => [ Data: data_cf65bc ]
...
006C60CE    xor ecx, ecx                                    ; => [ Call: nullptr | Call: nullptr ]
...
006C60EF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C612D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C6140    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C6145    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006C6171    test al, al
006C6173    jnz 0x006C6199                                  ; => [ Call: sub_6a6650 ]
006C6175    mov eax, dword ptr ss:[ebp-0x10]
006C6178    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006C617D    test eax, eax
006C617F    cmovnz ecx, eax
006C6182    push ecx
006C6183    push 0x87E218
006C6188    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: Failed to write xml file: '%s' ]
...
006C61C3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C61D6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C61DB    xor al, al
006C61DD    mov ecx, dword ptr ss:[ebp-0x0C]
006C61E0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C61E7    pop ecx
006C61E8    pop edi
006C61E9    pop esi
006C61EA    pop ebx
...
006C61FD    jz 0x006C6226                                   ; => [ Data: data_cf65bc ]
...
006C620E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C6221    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C6226    mov al, 0x01
006C6228    mov ecx, dword ptr ss:[ebp-0x0C]
006C622B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C6232    pop ecx
006C6233    pop edi
006C6234    pop esi
006C6235    pop ebx
...
006C6238    pop ebp
006C6239    ret
006C623A    push 0x87E238                                   ; => [ String: DefinitionSaveAsset ]
006C623F    push 0x2A6
006C6244    push 0x87DF78
006C6249    mov edx, esi
006C624B    mov ecx, 0x87A32C
006C6250    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Engine\DefLoad.cpp | Call: sub_63b870 | Data: data_801800 | String: pDefHeader->pParseTree ]
006C6255    add esp, 0x0C
006C6258    call 0x0063BC30
006C625D    test al, al
006C625F    jz 0x006C6262                                   ; => [ Call: sub_63bc30 ]
006C6261    int3
006C6262    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
