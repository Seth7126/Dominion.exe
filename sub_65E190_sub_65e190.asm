...
0065E1C9    push 0x874440                                   ; => [ String: UI2DefGet ]
0065E1CE    push 0xC16
0065E1D3    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
0065E1D8    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
0065E1DD    jmp 0x0065E2B7
0065E1E2    cmp dword ptr ds:[ecx+0x04], 0x22
0065E1E6    jz 0x0065E1FC
0065E1E8    push 0x874440                                   ; => [ String: UI2DefGet ]
0065E1ED    push 0xC17
0065E1F2    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
0065E1F7    jmp 0x0065E2B2
0065E1FC    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0065E212    push 0x874440                                   ; => [ String: UI2DefGet ]
0065E217    push 0xC16
0065E21C    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
0065E221    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
0065E226    jmp 0x0065E2B7
0065E22B    cmp dword ptr ds:[ecx+0x04], 0x22
0065E22F    jz 0x0065E242
0065E231    push 0x874440                                   ; => [ String: UI2DefGet ]
0065E236    push 0xC17
0065E23B    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
0065E240    jmp 0x0065E2B2
0065E242    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
0065E247    cmp dword ptr ds:[eax+0x08], 0x00
0065E24B    jnz 0x0065E256
0065E24D    movups xmm0, xmmword ptr ds:[0x007FF520]        ; => [ Data: data_7ff520 | Data: data_7ff520 ]
...
0065E260    call 0x0064F140                                 ; => [ Call: nullptr | Call: sub_64f140 | Call: sub_64f140 ]
...
0065E28C    call 0x005A0E40                                 ; => [ Call: sub_5a0e40 ]
...
0065E2A1    pop ebp
0065E2A2    ret
0065E2A3    push 0x874EC0                                   ; => [ String: FancyIconWidth ]
0065E2A8    push 0x28CC
0065E2AD    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0065E2B2    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0065E2B7    push 0x8739B4
0065E2BC    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp ]
0065E2C1    add esp, 0x0C
0065E2C4    call 0x0063BC30
0065E2C9    test al, al
0065E2CB    jz 0x0065E2CE                                   ; => [ Call: sub_63bc30 ]
0065E2CD    int3
0065E2CE    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
