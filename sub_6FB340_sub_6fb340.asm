...
006FB345    push 0x7722F6                                   ; => [ Call: __ehhandler$??$construct_environment_block@D@@YAHQBQBDQAPAD@Z | Type: EHRegistrationNode ]
006FB34A    mov eax, dword ptr fs:[0x00000000]
006FB350    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FB361    push esi
006FB362    push edi
006FB363    push eax                                        ; => [ Data: __security_cookie ]
006FB364    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006FB367    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006FB36D    cmp byte ptr ds:[0x0147D368], 0x00
006FB374    jz 0x006FB606                                   ; => [ Data: data_147d368 ]
006FB37A    mov esi, dword ptr ds:[0x0077534C]
006FB380    lea eax, ss:[ebp-0x68]
006FB383    push eax
006FB384    push dword ptr ds:[0x0147B084]
006FB38A    mov dword ptr ss:[ebp-0x68], 0x2C               ; => [ Type: WINDOWPLACEMENT | Field: length ]
006FB391    mov dword ptr ss:[ebp-0x3C], 0x2C               ; => [ Type: WINDOWPLACEMENT | Field: length ]
006FB398    call esi                                        ; => [ Data: data_147b084 ]
006FB39A    lea eax, ss:[ebp-0x3C]
006FB39D    push eax
006FB39E    push dword ptr ds:[0x0147D46C]
006FB3A4    call esi                                        ; => [ Data: data_147d46c ]
006FB3A6    mov eax, dword ptr ds:[0x0147DCB4]              ; => [ Data: data_147dcb4 ]
006FB3AB    lea ecx, ss:[ebp-0x84]
006FB3B1    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006FB3B6    test eax, eax
006FB3B8    jnz 0x006FB3C1
006FB3BA    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
006FB3BF    jmp 0x006FB3CE
006FB3C1    mov eax, dword ptr ds:[eax+0x20]
006FB3C4    test eax, eax
006FB3C6    cmovnz edx, eax
006FB3C9    call 0x006C4050                                 ; => [ Call: sub_6c4050 ]
...
006FB3DF    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006FB434    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FB447    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FB44C    mov dword ptr ss:[ebp-0x84], 0x801800           ; => [ Data: data_801800 ]
006FB456    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006FB45D    lea ecx, ss:[ebp-0x84]
006FB463    mov eax, dword ptr ds:[0x0147DCB8]              ; => [ Data: data_147dcb8 ]
006FB468    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006FB46D    test eax, eax
006FB46F    jnz 0x006FB478
006FB471    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
006FB476    jmp 0x006FB485
006FB478    mov eax, dword ptr ds:[eax+0x20]
006FB47B    test eax, eax
006FB47D    cmovnz edx, eax
006FB480    call 0x006C4050                                 ; => [ Call: sub_6c4050 ]
...
006FB496    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006FB4E4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FB4F7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FB4FC    mov dword ptr ss:[ebp-0x84], 0x801800           ; => [ Data: data_801800 ]
006FB506    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006FB50D    lea ecx, ss:[ebp-0x88]
006FB513    mov eax, dword ptr ds:[0x0147DCBC]              ; => [ Data: data_147dcbc ]
006FB518    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006FB51D    test eax, eax
006FB51F    jnz 0x006FB528
006FB521    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
006FB526    jmp 0x006FB535
006FB528    mov eax, dword ptr ds:[eax+0x20]
006FB52B    test eax, eax
006FB52D    cmovnz edx, eax
006FB530    call 0x006C4050                                 ; => [ Call: sub_6c4050 ]
...
006FB546    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006FB594    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FB5A7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FB5AC    mov dword ptr ss:[ebp-0x88], 0x801800           ; => [ Data: data_801800 ]
006FB5B6    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006FB5BD    mov esi, dword ptr ds:[0x0177758C]              ; => [ Data: data_177758c ]
006FB5C3    call 0x006A2FA0                                 ; => [ Call: sub_6a2fa0 ]
...
006FB5E4    call 0x006A6650                                 ; => [ Call: nullptr | Data: data_177758c | Call: sub_6a6290 | Data: data_147d368 | Call: sub_6a6650 ]
...
006FB5FC    push 0x00
006FB5FE    call 0x0069CE80                                 ; => [ Data: data_177758c | Call: sub_6a3220 | Call: sub_69ce80 ]
006FB603    add esp, 0x04
006FB606    mov ecx, dword ptr ss:[ebp-0x0C]
006FB609    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006FB610    pop ecx
006FB611    pop edi
006FB612    pop esi
006FB613    mov ecx, dword ptr ss:[ebp-0x10]
006FB616    xor ecx, ebp
006FB618    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
