...
00536115    push 0x765FE8                                   ; => [ Call: sub_765fe8 | Type: EHRegistrationNode ]
0053611A    mov eax, dword ptr fs:[0x00000000]
00536120    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00536121    mov eax, 0x19A8
00536126    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053612B    mov eax, dword ptr ds:[0x008C4040]
00536130    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00536132    mov dword ptr ss:[ebp-0x10], eax
00536135    push esi
00536136    push edi
00536137    push eax
00536138    lea eax, ss:[ebp-0x0C]
0053613B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00536141    mov dword ptr ss:[ebp-0xCFC], ecx
00536147    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00536165    push eax
00536166    call 0x00566240                                 ; => [ Data: data_7bf9d0 | Call: sub_566240 ]
0053616B    mov ecx, 0x321
00536170    lea edi, ss:[ebp-0xCF4]
00536176    mov esi, eax
00536178    add esp, 0x08
0053617B    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
005361BE    mov dword ptr ss:[ebp-0x40], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_7161c600b00559ea325e490f3f92a7db>, void>::VTable ]
005361C1    lea eax, ss:[ebp-0x70]
005361C4    movups xmm0, xmmword ptr ss:[ebp-0x40]
005361C8    mov dword ptr ss:[ebp-0x2C], 0x00               ; => [ Call: __builtin_memset ]
005361CF    mov dword ptr ss:[ebp-0x30], edx
005361D2    movups xmmword ptr ss:[ebp-0xD30], xmm0
005361D9    mov dword ptr ss:[ebp-0x4C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_15879144b295019a2a564834265dd546>, void>::VTable ]
...
005361FA    mov dword ptr ss:[ebp-0x70], 0x819D08           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_15879144b295019a2a564834265dd546>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
0053621A    mov dword ptr ss:[ebp-0x40], 0x819CEC           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_7161c600b00559ea325e490f3f92a7db>, void>::`vftable'{for `std::_Func_base<void>'} ]
00536221    mov dword ptr ss:[ebp-0x1C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_7161c600b00559ea325e490f3f92a7db>, void>::VTable ]
...
0053624E    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
00536267    push 0x30
00536269    push eax
0053626A    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
...
00536285    push 0x07
00536287    push 0x0B
00536289    call 0x005674C0                                 ; => [ Call: sub_5674c0 ]
0053628E    add esp, 0x0C
00536291    jmp 0x0053629D
00536293    push 0x18
00536295    call 0x00569330                                 ; => [ Call: sub_569330 ]
0053629A    add esp, 0x04
0053629D    mov ecx, dword ptr ss:[ebp-0x0C]
005362A0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005362A7    pop ecx
005362A8    pop edi
005362A9    pop esi
005362AA    mov ecx, dword ptr ss:[ebp-0x10]
005362AD    xor ecx, ebp
005362AF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
