...
004B3055    push 0x7629E0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Move@?$_Func_impl_no_alloc@P6A_NABW4agent_status@Concurrency@@@Z_NABW412@@std@@EAEPAV?$_Func_base@_NABW4agent_status@Concurrency@@@2@PAX@Z ]
004B305A    mov eax, dword ptr fs:[0x00000000]
004B3060    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004B3061    push ecx
004B3062    push esi
004B3063    push edi
004B3064    mov eax, dword ptr ds:[0x008C4040]
004B3069    xor eax, ebp
004B306B    push eax                                        ; => [ Data: __security_cookie ]
004B306C    lea eax, ss:[ebp-0x0C]
004B306F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004B3083    push eax
004B3084    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
004B3089    push 0x63D770
004B308E    push 0x08
004B3090    push 0x04
004B3092    lea eax, ds:[esi+0x08]
004B3095    push eax
004B3096    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
004B309B    mov dword ptr ss:[ebp-0x04], 0x00
004B30A2    cmp dword ptr ds:[0x00CF65BC], 0x00
004B30A9    jz 0x004B30D9                                   ; => [ Data: data_cf65bc ]
...
004B30BA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B30CD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B30D2    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
004B30D9    mov dword ptr ss:[ebp-0x04], 0x01
004B30E0    cmp dword ptr ds:[0x00CF65BC], 0x00
004B30E7    jz 0x004B3114                                   ; => [ Data: data_cf65bc ]
...
004B30F6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B3109    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B310E    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
004B3114    mov ecx, dword ptr ss:[ebp-0x0C]
004B3117    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B311E    pop ecx
004B311F    pop edi
004B3120    pop esi
