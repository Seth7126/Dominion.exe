...
00589E0C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00589E32    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00589E5E    cmovnz edx, ecx                                 ; => [ Call: sub_5754f0 ]
00589E61    mov ecx, esi
00589E63    call 0x00589700                                 ; => [ Call: sub_589700 ]
...
00589E7D    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00589EC8    setz cl
00589ECB    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
...
00589EEA    mov dword ptr ss:[esp+0x10], eax                ; => [ Call: nullptr ]
00589EEE    call 0x00582DE0                                 ; => [ Call: sub_582de0 ]
...
00589F4D    push edi
00589F4E    call 0x005822E0                                 ; => [ Call: nullptr | Call: sub_5822e0 ]
...
00589F62    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
