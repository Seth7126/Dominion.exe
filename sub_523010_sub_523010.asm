...
00523073    push 0x01
00523075    call 0x00590760
0052307A    add esp, 0x18
0052307D    call 0x00573400
00523082    mov ecx, dword ptr ds:[eax+0x0C]
00523085    cmp ecx, 0xFFFFFFFF
00523088    jnz 0x005230A0
0052308A    push 0x81EA64
0052308F    push 0x52
00523091    push 0x81EA70
00523096    mov ecx, 0x813C5C
...
00523157    mov dword ptr ss:[ebp-0x20], eax
...
00523334    push eax
00523335    call 0x00568780
0052333A    xorps xmm0, xmm0
0052333D    mov dword ptr ss:[ebp-0x1954], 0x00
00523347    movlpd qword ptr ss:[ebp-0x195C], xmm0
...
005233FD    push 0x3EA
00523402    push esi
00523403    call 0x00583720
00523408    add esp, 0x1C
0052340B    mov ecx, 0x01
00523410    call 0x0056E9C0
00523415    mov ecx, dword ptr ss:[ebp-0x0C]
00523418    mov dword ptr fs:[0x00000000], ecx
0052341F    pop ecx
00523420    pop edi
00523421    pop esi
00523422    mov ecx, dword ptr ss:[ebp-0x14]
00523425    xor ecx, ebp
00523427    call 0x0075927A
0052342C    mov esp, ebp
0052342E    pop ebp
0052342F    mov esp, ebx
00523431    pop ebx
00523432    ret
00523433    push 0x817838
00523438    push 0x2EA
0052343D    push 0x8177EC
00523442    mov ecx, 0x817824
00523447    mov edx, 0x801800
0052344C    call 0x0063B870
00523451    add esp, 0x0C
00523454    call 0x0063BC30
00523459    test al, al
0052345B    jz 0x0052345E
0052345D    int3
0052345E    call 0x0063BB00
