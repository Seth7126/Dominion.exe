...
005CFFDB    call 0x00761E50                                 ; => [ Call: __chkstk ]
005CFFE0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005CFFF6    call 0x005CBB20                                 ; => [ Call: sub_5cbb20 ]
005CFFFB    mov edx, eax
005CFFFD    mov ecx, 0x11
005D0002    call 0x005EE260                                 ; => [ Call: sub_5ee260 ]
005D0007    mov ecx, dword ptr ds:[0x0171E780]
005D000D    lea edx, ss:[esp+0xE0]
005D0014    call 0x006883D0                                 ; => [ Data: data_171e780 | Call: sub_6883d0 ]
005D0019    lea ecx, ss:[esp+0xE0]
005D0020    call 0x00688660                                 ; => [ Call: sub_688660 ]
005D0025    cmp dword ptr ds:[esi+0x2C], 0x01
005D0029    jnz 0x005D0056
005D002B    mov eax, dword ptr ds:[0x00B7D424]              ; => [ Data: data_b7d424 ]
005D0030    cmp eax, 0x04
005D0033    jz 0x005D004E
005D0035    cmp eax, 0x01
005D0038    jz 0x005D004E
005D003A    push 0x86F924                                   ; => [ String: DomZoom ]
005D003F    push 0x16E0
005D0044    mov ecx, 0x86F930                               ; => [ String: zoom.zoomState == ZOOMSTATE_EXTRAS_SELECTED || zoom.zoomState == ZOOMSTATE_CARD ]
...
005D00A2    push eax
005D00A3    call 0x005DE520                                 ; => [ Call: sub_5de520 ]
...
005D00CF    call 0x005CB6E0                                 ; => [ Call: sub_5cb6e0 ]
...
005D00EE    call 0x00571B30                                 ; => [ Call: sub_5cbb20 | Call: sub_571b30 | Call: sub_5cf7e0 ]
...
005D01EC    call 0x005CB7C0                                 ; => [ Call: sub_5cb7c0 ]
005D01F1    mov edx, dword ptr ds:[0x00B809E4]              ; => [ Data: data_b809e4 ]
005D01F7    add esp, 0x08
005D01FA    mov esi, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
005D0200    mov eax, esi
005D0202    imul ecx, edx, 0x1C30
005D0208    mov dword ptr ds:[0x00B7F4C0], 0x00             ; => [ Data: data_b7f4c0 ]
...
005D0254    call 0x005CB5A0                                 ; => [ Call: sub_5cb5a0 ]
005D0259    mov ecx, dword ptr ss:[esp+0x20]
005D025D    lea eax, ss:[esp+0x24]
005D0261    push eax
005D0262    call 0x006376D0                                 ; => [ Data: data_b809e0 | Call: sub_6376d0 ]
005D0267    mov eax, dword ptr ss:[esp+0x24]
005D026B    cmp eax, 0xFFFFFFFF
005D026E    jnz 0x005D0241
005D0270    mov edx, dword ptr ds:[0x00B809E4]              ; => [ Data: data_b809e4 ]
005D0276    mov esi, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
...
005D02BE    call 0x00633270                                 ; => [ Call: sub_633270 ]
005D02C3    cmp eax, edi
005D02C5    jnz 0x005D02D7
005D02C7    mov edx, eax
005D02C9    mov ecx, esi
005D02CB    call 0x005CD880                                 ; => [ Call: sub_5cd880 ]
005D02D0    mov ecx, esi
005D02D2    call 0x005CB5A0                                 ; => [ Call: sub_5cb5a0 ]
005D02D7    mov ecx, dword ptr ss:[esp+0x20]
005D02DB    lea eax, ss:[esp+0x24]
005D02DF    push eax
005D02E0    call 0x006376D0                                 ; => [ Data: data_b809e0 | Call: sub_6376d0 ]
...
005D02FD    push ecx
005D02FE    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: nullptr ]
005D0306    mov eax, dword ptr ds:[esi+0x1C28]
005D030C    mov dword ptr ds:[0x00B7D42C], eax              ; => [ Data: data_b7d42c ]
005D0311    mov eax, dword ptr ds:[edi+0x1C28]
005D0317    mov dword ptr ds:[0x00B7D434], eax              ; => [ Data: data_b7d434 ]
005D031C    mov eax, dword ptr ds:[edi+0x170]
005D0322    mov dword ptr ds:[0x00B7D430], eax              ; => [ Data: data_b7d430 ]
005D0327    lea eax, ss:[esp+0x1C]
005D032B    push eax
005D032C    lea eax, ss:[esp+0x9F8]
005D0333    mov dword ptr ds:[0x00B7D424], 0x01             ; => [ Data: data_b7d424 ]
005D033D    push eax
005D033E    push ecx
005D033F    mov ecx, esi
005D0341    mov dword ptr ds:[0x00B7F4C4], 0x00             ; => [ Data: data_b7f4c4 ]
005D034B    mov dword ptr ds:[0x00B7F4C8], 0x00             ; => [ Data: data_b7f4c8 ]
005D0355    mov dword ptr ds:[0x00B7D41C], 0x3F800000       ; => [ Data: data_b7d41c ]
005D035F    mov dword ptr ds:[0x00B7D420], 0x3F800000       ; => [ Data: data_b7d420 ]
005D0369    call 0x005CFDF0                                 ; => [ Call: sub_5cfdf0 ]
...
005D0390    call 0x005CBB20                                 ; => [ Call: sub_5cbb20 ]
005D0395    mov ecx, 0xB809E0
005D039A    mov esi, eax
005D039C    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
005D04B3    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
005D04CF    call 0x006372F0                                 ; => [ Call: sub_6372f0 ]
005D04D4    mov ecx, dword ptr ss:[esp+0x2C]
005D04D8    mov eax, dword ptr ds:[ecx+0x1C28]
005D04DE    mov dword ptr ds:[0x00B7F4CC], eax              ; => [ Data: data_b7f4cc ]
...
005D04FF    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
005D0530    call 0x005DE520                                 ; => [ Call: sub_5de520 ]
...
005D055C    call 0x005CB6E0                                 ; => [ Call: sub_5cb6e0 ]
...
005D06D9    mov dword ptr ds:[0x00B7F4BC], 0x00             ; => [ Data: data_b7f4bc ]
005D06E3    mov dword ptr ds:[0x00B7F4B8], 0x00             ; => [ Data: data_b7f4b8 ]
005D06ED    call 0x005CEC70                                 ; => [ Call: sub_5cec70 ]
...
005D0708    mov ecx, dword ptr ds:[0x00B7F4B8]              ; => [ Data: data_b7f4b8 ]
005D070E    lea edi, ss:[esp+0x5D8]
005D0715    mov dword ptr ss:[esp+0x18], ecx
005D0719    nop dword ptr ds:[eax], eax
005D0720    inc dword ptr ds:[0x00B7F4BC]                   ; => [ Data: data_b7f4bc ]
...
005D0762    mov dword ptr ds:[ecx+0xB7D438], eax            ; => [ Data: data_b7d438 ]
005D0768    inc edx
005D0769    mov eax, dword ptr ds:[edi+0x04]
005D076C    add edi, 0x408
005D0772    mov dword ptr ds:[ecx+0xB7D43C], eax
005D0778    mov ecx, dword ptr ds:[0x00B7F4B8]              ; => [ Data: data_b7f4b8 ]
...
005D078E    add ecx, 0x08                                   ; => [ Data: data_b7d438 ]
005D0791    mov dword ptr ss:[esp+0x18], ecx
005D0795    mov dword ptr ds:[0x00B7F4B8], ecx              ; => [ Data: data_b7f4b8 ]
...
005D07B1    call 0x005CF520                                 ; => [ Data: data_b7d438 | Call: sub_5cf520 ]
005D07B6    mov edi, dword ptr ds:[0x00B7F4B8]              ; => [ Data: data_b7f4b8 ]
005D07BC    xor eax, eax                                    ; => [ Call: nullptr ]
005D07BE    add esp, 0x04
005D07C1    mov ecx, 0xB7D438                               ; => [ Data: data_b7d438 ]
005D07C6    test edi, edi
005D07C8    cmovz ecx, eax                                  ; => [ Call: nullptr ]
...
005D0808    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
005D0946    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005D0948    lea ecx, ds:[edx+0x258]
005D094E    call 0x006372F0                                 ; => [ Call: sub_6372f0 ]
...
005D09B3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005D09B8    mov esp, ebp
005D09BA    pop ebp
005D09BB    ret
005D09BC    push 0x86F924                                   ; => [ String: DomZoom ]
005D09C1    push 0x16E7
005D09C6    mov ecx, 0x86F980                               ; => [ String: pZoomCard ]
005D09CB    push 0x86F1E8
005D09D0    mov edx, 0x801800
005D09D5    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 ]
005D09DA    add esp, 0x0C
005D09DD    call 0x0063BC30
005D09E2    test al, al
005D09E4    jz 0x005D09E7                                   ; => [ Call: sub_63bc30 ]
005D09E6    int3
005D09E7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
