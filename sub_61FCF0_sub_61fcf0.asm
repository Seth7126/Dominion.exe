...
0061FD0D    call 0x0051BCE0                                 ; => [ Call: sub_51bce0 ]
0061FD12    push dword ptr ss:[ebp+0x0C]
0061FD15    mov edx, 0xBF0104
0061FD1A    mov ecx, esi
0061FD1C    call 0x00666250                                 ; => [ Data: data_bf0104 | Call: sub_666250 ]
0061FD21    add esp, 0x08
0061FD24    call 0x0061DAD0                                 ; => [ Call: sub_61dad0 ]
...
0061FD39    mov al, byte ptr ds:[0x0171EFCC]                ; => [ Data: data_171efcc ]
0061FD3E    cmp ecx, 0x04
0061FD41    jz 0x0061FD48
0061FD43    cmp ecx, 0x05
0061FD46    jnz 0x0061FD4C
0061FD48    test al, al
0061FD4A    jz 0x0061FD84                                   ; => [ Data: data_1724034 | Data: data_171efc8 ]
...
0061FD5F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0061FD64    movss xmm3, dword ptr ds:[0x00890E18]
0061FD6C    mov edx, 0xBF00C8
0061FD71    push 0x00
0061FD73    push 0xFFFFFFFF
0061FD75    mov ecx, eax
0061FD77    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf00c8 ]
0061FD7C    mov al, byte ptr ds:[0x0171EFCC]                ; => [ Data: data_171efcc ]
...
0061FD93    jz 0x0061FDC9                                   ; => [ Data: data_1724034 ]
...
0061FDA4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0061FDA9    movss xmm3, dword ptr ds:[0x00890E18]
0061FDB1    mov edx, 0xBF0038
0061FDB6    push 0x00
0061FDB8    push 0xFFFFFFFF
0061FDBA    mov ecx, eax
0061FDBC    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf0038 ]
0061FDC1    mov al, byte ptr ds:[0x0171EFCC]                ; => [ Data: data_171efcc ]
...
0061FEDF    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0061FF03    pop ebp
0061FF04    ret                                             ; => [ Call: sub_665db0 | Data: data_bf0068 ]
0061FF05    mov ecx, esi
0061FF07    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0061FF2B    pop ebp
0061FF2C    ret                                             ; => [ Call: sub_665db0 | Data: data_bf0074 ]
0061FF2D    mov ecx, esi
0061FF2F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0061FF53    pop ebp
0061FF54    ret                                             ; => [ Data: data_bf0080 | Call: sub_665db0 ]
0061FF55    mov ecx, esi
0061FF57    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0061FF7B    pop ebp
0061FF7C    ret                                             ; => [ Call: sub_665db0 | Data: data_bf008c ]
0061FF7D    push 0x86ADE8                                   ; => [ String: DeclareMission ]
0061FF82    push 0xE23E
0061FF87    jmp 0x0061FF93
0061FF89    push 0x86ADE8                                   ; => [ String: DeclareMission ]
0061FF8E    push 0xE242
0061FF93    push 0x86F1E8
0061FF98    mov edx, 0x801800
0061FF9D    mov ecx, 0x801AA4
0061FFA2    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: DeclareMission | String: Halt ]
0061FFA7    add esp, 0x0C
0061FFAA    call 0x0063BC30
0061FFAF    test al, al
0061FFB1    jz 0x0061FFB4                                   ; => [ Call: sub_63bc30 ]
0061FFB3    int3
0061FFB4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
