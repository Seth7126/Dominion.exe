...
00712AB5    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00712ABA    push edi
...
00712AC9    push ebx
00712ACA    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00712ACC    add esp, 0x0C
00712ACF    jmp 0x00712ADB
00712AD1    push ebx
00712AD2    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00712AE2    push 0x00
00712AE4    push edi
00712AE5    call 0x00761FC4                                 ; => [ Call: memset ]
...
00712AF7    push edi
00712AF8    call 0x00761FBE                                 ; => [ Call: memcpy ]
00712AFD    push dword ptr ds:[esi+0x08]
00712B00    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
