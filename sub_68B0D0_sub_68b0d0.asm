...
0068B10E    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
0068B182    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068B187    mov ecx, 0x0C
0068B18C    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0068B19D    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0068B22E    call dword ptr ds:[edi+0x10]                    ; => [ Data: data_147abf8 ]
...
0068B258    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068B25D    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
0068B263    lea eax, ss:[ebp-0x08]
0068B266    push eax
0068B267    mov dword ptr ss:[ebp-0x08], edi
0068B26A    lea ecx, ds:[ecx+0x44]
0068B26D    call 0x0068B830                                 ; => [ Call: sub_68b830 ]
...
0068B285    call 0x0068AF60                                 ; => [ Call: sub_68af60 ]
0068B28A    pop edi
0068B28B    pop esi
0068B28C    pop ebx
...
0068B2A7    call 0x0063B870                                 ; => [ String: XList<struct NetBuffer *>::GetHead | Call: sub_63b870 | String: mpHead != NULL | String: C:\x\ax2017\Engine\xList.h | Data: data_801800 ]
0068B2AC    add esp, 0x0C
0068B2AF    call 0x0063BC30
0068B2B4    test al, al
0068B2B6    jz 0x0068B2B9                                   ; => [ Call: sub_63bc30 ]
0068B2B8    int3
0068B2B9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
