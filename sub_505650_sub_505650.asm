...
00505656    push ecx
00505657    push esi
00505658    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050565D    mov esi, eax
0050565F    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
00505664    mov edx, dword ptr ds:[esi+0x0C]
00505667    mov ecx, dword ptr ds:[esi+0x04]
0050566A    push 0x01
0050566C    push eax
0050566D    call 0x00594010                                 ; => [ Call: sub_594010 ]
00505672    xor edx, edx
00505674    or ecx, 0xFFFFFFFF
00505677    call 0x00561F60                                 ; => [ Call: sub_561f60 ]
0050567C    push 0x00
0050567E    push 0x04
00505680    mov ecx, 0xFB
00505685    call 0x005629E0                                 ; => [ Call: sub_5629e0 ]
...
0050569F    call 0x005636E0                                 ; => [ Call: sub_5636e0 ]
