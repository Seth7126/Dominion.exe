...
00599095    push 0x7678FE                                   ; => [ Call: __ehhandler$??1?$_Greedy_node@W4agent_status@Concurrency@@@Concurrency@@UAE@XZ | Type: EHRegistrationNode ]
0059909A    mov eax, dword ptr fs:[0x00000000]
005990A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005990A1    sub esp, 0x0C
005990A4    push esi
005990A5    push edi
005990A6    mov eax, dword ptr ds:[0x008C4040]
005990AB    xor eax, ebp
005990AD    push eax                                        ; => [ Data: __security_cookie ]
005990AE    lea eax, ss:[ebp-0x0C]
005990B1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005990CD    call 0x00598F00                                 ; => [ Call: sub_598f00 ]
005990D2    add esp, 0x04
005990D5    mov dword ptr ss:[ebp-0x04], 0x00
005990DC    mov edi, 0x801800                               ; => [ Data: data_801800 ]
005990E1    mov eax, dword ptr ss:[ebp+0x10]
005990E4    mov ecx, edi                                    ; => [ Data: data_801800 ]
005990E6    mov edx, edi                                    ; => [ Data: data_801800 ]
...
00599116    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
0059911B    mov dword ptr ss:[ebp-0x04], 0x02
00599122    cmp dword ptr ds:[0x00CF65BC], 0x00
00599129    jz 0x00599152                                   ; => [ Data: data_cf65bc ]
...
0059913A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059914D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00599152    mov eax, dword ptr ss:[ebp+0x18]
00599155    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
00599184    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
00599189    mov dword ptr ss:[ebp-0x04], 0x04
00599190    cmp dword ptr ds:[0x00CF65BC], 0x00
00599197    jz 0x005991C0                                   ; => [ Data: data_cf65bc ]
...
005991A8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005991BB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005991C0    mov eax, esi
005991C2    mov ecx, dword ptr ss:[ebp-0x0C]
005991C5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005991CC    pop ecx
005991CD    pop edi
005991CE    pop esi
