...
0050BD76    add eax, ecx                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
...
0050BDC5    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: CampaignAddExtra | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: Halt ]
0050BDCA    add esp, 0x0C
0050BDCD    call 0x0063BC30
0050BDD2    test al, al
0050BDD4    jz 0x0050BDD7                                   ; => [ Call: sub_63bc30 ]
0050BDD6    int3
0050BDD7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
