...
004C0B4D    push esi
004C0B4E    push edi
004C0B4F    call 0x0064E7A0
004C0B54    mov ecx, dword ptr ss:[ebp+0x08]
004C0B57    mov edx, 0x803570
004C0B5C    push 0xFFFFFFFF
004C0B5E    mov dword ptr ds:[eax+0x18BC], 0x4BFD90
004C0B68    call 0x0066B2B0
...
004C0BB6    mov esi, dword ptr ds:[eax*8+0xBF01D0]
004C0BBD    push edi
004C0BBE    call 0x0066B2B0
...
004C0C7A    pop ebp
004C0C7B    ret
004C0C7C    push 0x86B398
004C0C81    push 0xEAB2
004C0C86    mov ecx, 0x814428
004C0C8B    jmp 0x004C0C9C
004C0C8D    push 0x86B398
004C0C92    push 0xEAB1
004C0C97    mov ecx, 0x86B37C
004C0C9C    push 0x86F1E8
004C0CA1    mov edx, 0x801800
004C0CA6    call 0x0063B870
004C0CAB    add esp, 0x0C
004C0CAE    call 0x0063BC30
004C0CB3    test al, al
004C0CB5    jz 0x004C0CB8
004C0CB7    int3
004C0CB8    call 0x0063BB00
