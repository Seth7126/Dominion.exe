...
00734B5C    mov eax, dword ptr ds:[0x008C4040]
...
00734B78    push 0x00
00734B7A    push eax
00734B7B    call 0x00761FC4
00734B80    mov esi, dword ptr ss:[ebp+0x08]
00734B83    lea eax, ss:[esp+0x1C]
00734B87    inc dword ptr ss:[esp+0x24]
00734B8B    add esp, 0x0C
00734B8E    mov dword ptr ss:[esp+0x1C], esi
00734B92    mov dword ptr ss:[esp+0x10], 0x00
...
00734BAB    push eax
00734BAC    push esi
00734BAD    call dword ptr ds:[0x007754D0]
00734BB3    cmp eax, 0xFFFFFFFF
00734BB6    jnz 0x00734BCC
00734BB8    push 0x88EE38
00734BBD    push 0x135
00734BC2    mov ecx, 0x88ED64
...
00734BF7    push 0x88EE38
00734BFC    push 0x13B
00734C01    mov ecx, 0x88EE98
...
00734C37    call 0x0075927A
00734C3C    mov esp, ebp
00734C3E    pop ebp
00734C3F    ret 0x08
00734C42    push 0x88EE38
00734C47    push 0x13E
00734C4C    mov ecx, 0x88EE78
00734C51    push 0x88ECDC
00734C56    mov edx, 0x801800
00734C5B    call 0x0063B870
00734C60    add esp, 0x0C
00734C63    call 0x0063BC30
00734C68    test al, al
00734C6A    jz 0x00734C6D
00734C6C    int3
00734C6D    call 0x0063BB00
00734C72    push 0x88EE38
00734C77    push 0x143
00734C7C    mov ecx, 0x88EEBC
00734C81    push 0x88ECDC
00734C86    mov edx, 0x801800
00734C8B    call 0x0063B870
00734C90    add esp, 0x0C
00734C93    call 0x0063BC30
00734C98    test al, al
00734C9A    jz 0x00734C9D
00734C9C    int3
00734C9D    call 0x0063BB00
