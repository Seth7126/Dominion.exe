...
006CF69B    call 0x006D1370                                 ; => [ Call: sub_6d1370 ]
006CF6A0    mov ebx, eax
006CF6A2    cmp dword ptr ds:[ebx], 0x00
006CF6A5    jz 0x006CF71D
006CF6A7    lea ecx, ds:[ebx+0x40]
006CF6AA    call 0x0064B0D0                                 ; => [ Call: sub_64b0d0 ]
006CF6AF    test al, al
006CF6B1    jnz 0x006CF6C4
006CF6B3    push 0x87EEF4                                   ; => [ String: FabDraw ]
006CF6B8    push 0x4C9
006CF6BD    mov ecx, 0x87EE18                               ; => [ String: QuatIsValid(state.transform.t.r) ]
006CF6C2    jmp 0x006CF733
006CF6C4    lea eax, ss:[esp+0x0C]
006CF6C8    mov edx, esi
006CF6CA    push eax
006CF6CB    mov ecx, ebx
006CF6CD    call 0x006D03F0                                 ; => [ Call: sub_6d03f0 ]
...
006CF6E7    call 0x006D1370                                 ; => [ Call: sub_6d1370 ]
006CF6EC    mov dword ptr ss:[esp+0x14], eax
006CF6F0    lea ecx, ds:[eax+0x40]
006CF6F3    call 0x0064B0D0                                 ; => [ Call: sub_64b0d0 ]
006CF6F8    test al, al
...
006CF708    push eax
006CF709    call 0x006D03F0                                 ; => [ Call: sub_6d03f0 ]
006CF70E    inc esi
...
006CF722    pop ebp
006CF723    ret
006CF724    push 0x87EEF4                                   ; => [ String: FabDraw ]
006CF729    push 0x4CE
006CF72E    mov ecx, 0x87EECC                               ; => [ String: QuatIsValid(addedState.transform.t.r) ]
006CF733    push 0x87ED1C
006CF738    mov edx, 0x801800
006CF73D    call 0x0063B870                                 ; => [ String: FabDraw | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\FabDef.cpp ]
006CF742    add esp, 0x0C
006CF745    call 0x0063BC30
006CF74A    test al, al
006CF74C    jz 0x006CF74F                                   ; => [ Call: sub_63bc30 ]
006CF74E    int3
006CF74F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
