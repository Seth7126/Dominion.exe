...
00620CC5    push 0x76B5DF                                   ; => [ Call: __ehhandler$??$construct_command_line@D@@YAHQBQBDQAPAD@Z | Type: EHRegistrationNode ]
00620CCA    mov eax, dword ptr fs:[0x00000000]
00620CD0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00620CDE    push eax                                        ; => [ Data: __security_cookie ]
00620CDF    lea eax, ss:[ebp-0x0C]
00620CE2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00620CE8    mov ebx, dword ptr ss:[ebp+0x08]
00620CEB    mov dword ptr ss:[ebp-0x20], 0x00
00620CF2    mov eax, dword ptr ds:[0x0171EFD0]              ; => [ Data: data_171efd0 ]
00620CF7    test eax, eax
00620CF9    jz 0x00620D4C
00620CFB    movzx ecx, ax
00620CFE    cmp ecx, dword ptr ds:[0x00B4A5C4]
00620D04    jnb 0x00620D4C                                  ; => [ Data: data_b4a5c4 ]
00620D06    imul esi, ecx, 0x510C
00620D0C    add esi, dword ptr ds:[0x00B4A5C0]              ; => [ Data: data_b4a5c0 ]
...
00620D36    call 0x00666250                                 ; => [ Call: sub_666250 | Data: data_bf00ec ]
00620D3B    add esp, 0x04
00620D3E    mov edx, esi
00620D40    mov ecx, ebx
00620D42    call 0x006208C0                                 ; => [ Call: sub_6208c0 ]
00620D47    add esp, 0x04
00620D4A    jmp 0x00620D4E
00620D4C    xor esi, esi                                    ; => [ Call: nullptr | Call: nullptr | Call: nullptr ]
00620D4E    mov ecx, ebx
00620D50    call 0x0064E7A0
00620D55    mov dword ptr ds:[eax+0x18BC], 0x61EB90         ; => [ Call: sub_64e7a0 | Call: sub_61eb90 ]
00620D5F    cmp byte ptr ds:[0x01724030], 0x00
00620D66    jz 0x00620D8A                                   ; => [ Data: data_1724030 ]
00620D68    mov ecx, ebx
00620D6A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00620D6F    movss xmm3, dword ptr ds:[0x00890E18]
00620D77    mov edx, 0xBF00F8
00620D7C    push 0x00
00620D7E    push 0xFFFFFFFF
00620D80    mov ecx, eax
00620D82    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf00f8 ]
00620D87    add esp, 0x08
00620D8A    call 0x0061DAD0
00620D8F    mov eax, dword ptr ds:[eax+0x78]                ; => [ Call: sub_61dad0 ]
00620D92    cmp eax, 0x04
00620D95    jz 0x00620D9C
00620D97    cmp eax, 0x05
00620D9A    jnz 0x00620DBE
00620D9C    mov ecx, ebx
00620D9E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00620DA3    movss xmm3, dword ptr ds:[0x00890E18]
00620DAB    mov edx, 0xBF0110
00620DB0    push 0x00
00620DB2    push 0xFFFFFFFF
00620DB4    mov ecx, eax
00620DB6    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf0110 ]
00620DBB    add esp, 0x08
00620DBE    cmp dword ptr ds:[0x0171EFD4], 0x00
00620DC5    jnz 0x00620E41                                  ; => [ Data: data_171efd4 ]
00620DC7    mov ecx, dword ptr ds:[0x0171EFD8]              ; => [ Data: data_171efd8 ]
00620DCD    cmp ecx, 0x03
00620DD0    jnl 0x00620DEB
00620DD2    push 0x813640                                   ; => [ String: ExpansionCampaignDefGet ]
00620DD7    push 0x669
00620DDC    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
00620DE1    mov ecx, 0x813658                               ; => [ String: exp >= DOM_EXP_INTRIGUE ]
...
00620DFD    push 0x813640                                   ; => [ String: ExpansionCampaignDefGet ]
00620E02    push 0x672
00620E07    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
00620E0C    mov ecx, 0x813670                               ; => [ String: retval.exp == exp ]
00620E11    jmp 0x0062111B
00620E16    cmp dword ptr ds:[eax+0x8C], 0x00
00620E1D    jz 0x00620E41
00620E1F    mov ecx, ebx
00620E21    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00620E26    movss xmm3, dword ptr ds:[0x00890E18]
00620E2E    mov edx, 0xBF00E0
00620E33    push 0x00
00620E35    push 0xFFFFFFFF
00620E37    mov ecx, eax
00620E39    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_bf00e0 ]
00620E3E    add esp, 0x08
00620E41    cmp dword ptr ds:[0x01723FE0], 0x00
00620E48    jz 0x00621107                                   ; => [ Data: data_1723fe0 ]
00620E4E    mov edx, 0x171EFD4
00620E53    lea ecx, ss:[ebp-0x28]
00620E56    call 0x00620B70                                 ; => [ Call: sub_620b70 | Data: data_171efd4 ]
...
00620E6F    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_bf00d4 ]
00620E74    add esp, 0x08
00620E77    lea ecx, ss:[ebp-0x10]
00620E7A    mov edx, 0x171EFD4
00620E7F    call 0x00519F50                                 ; => [ Call: sub_519f50 | Data: data_171efd4 ]
...
00620EC9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00620EE0    mov eax, 0x801800                               ; => [ Data: data_801800 ]
00620EE5    cmovnz eax, edi
00620EE8    push eax
00620EE9    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
00620F58    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00620F6B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00620F84    jz 0x00620FA1                                   ; => [ Data: data_cf65bc ]
00620F86    lea ecx, ss:[ebp-0x18]
00620F89    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00620F9C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00620FB5    jz 0x00620FD2                                   ; => [ Data: data_cf65bc ]
00620FB7    lea ecx, ss:[ebp-0x2C]
00620FBA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00620FCD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00620FD2    mov byte ptr ss:[ebp-0x04], 0x09
00620FD6    cmp dword ptr ds:[0x00CF65BC], 0x00
00620FDD    jz 0x00621006                                   ; => [ Data: data_cf65bc ]
...
00620FEE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621001    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00621017    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_bf0098 ]
0062101C    push dword ptr ds:[0x0171EFC8]                  ; => [ Data: data_171efc8 ]
00621022    mov edx, 0x171EFD4
00621027    lea ecx, ss:[ebp-0x1C]
0062102A    call 0x0051A250                                 ; => [ Data: data_171efd4 | Call: sub_51a250 ]
...
00621064    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621077    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062107C    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
00621083    mov byte ptr ss:[ebp-0x04], 0x0C
00621087    cmp dword ptr ds:[0x00CF65BC], 0x00
0062108E    jz 0x006210BE                                   ; => [ Data: data_cf65bc ]
...
0062109F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006210B2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006210B7    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006210BE    mov dword ptr ss:[ebp-0x04], 0x0D
006210C5    cmp dword ptr ds:[0x00CF65BC], 0x00
006210CC    jz 0x006210F5                                   ; => [ Data: data_cf65bc ]
...
006210DD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006210F0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006210F5    mov ecx, dword ptr ss:[ebp-0x0C]
006210F8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006210FF    pop ecx
00621100    pop edi
00621101    pop esi
00621102    pop ebx
...
00621105    pop ebp
00621106    ret
00621107    push 0x86AEAC                                   ; => [ String: CampaignsDlgUpdate ]
0062110C    push 0xE396
00621111    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
00621116    mov ecx, 0x86AE84                               ; => [ String: setup.campaignBlueprint != CPIECE_NONE ]
0062111B    mov edx, 0x801800
00621120    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00621125    add esp, 0x0C
00621128    call 0x0063BC30
0062112D    test al, al
0062112F    jz 0x00621132                                   ; => [ Call: sub_63bc30 ]
00621131    int3
00621132    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
