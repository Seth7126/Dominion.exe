// ============================================================
// 函数名称: ??0ContextBase@details@Concurrency@@QAE@PAVSchedulerBase@12@_N@Z
// 起始地址: 0x4e6ed0
...
004E6ED5    push 0x764776                                   ; => [ Call: __ehhandler$??0?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QAE@QBG@Z | Type: EHRegistrationNode ]
004E6EDA    mov eax, dword ptr fs:[0x00000000]
004E6EE0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E6EE1    sub esp, 0x14
004E6EE4    push esi
004E6EE5    mov eax, dword ptr ds:[0x008C4040]
004E6EEA    xor eax, ebp
004E6EEC    push eax                                        ; => [ Data: __security_cookie ]
004E6EED    lea eax, ss:[ebp-0x0C]
004E6EF0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E6F09    push dword ptr ds:[eax+0x10]                    ; => [ Call: sub_4e3950 ]
...
004E6F24    mov edx, 0x801800                               ; => [ Data: data_801800 ]
004E6F29    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: dom_expansion_name_%s ]
004E6F2B    mov ecx, esi
004E6F2D    test eax, eax
004E6F2F    cmovnz edx, eax
004E6F32    call 0x004D47C0                                 ; => [ Call: sub_4d47c0 ]
004E6F37    mov dword ptr ss:[ebp-0x14], 0x03
004E6F3E    mov dword ptr ss:[ebp-0x04], 0x02
004E6F45    cmp dword ptr ds:[0x00CF65BC], 0x00
004E6F4C    jz 0x004E6F75                                   ; => [ Data: data_cf65bc ]
...
004E6F5D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E6F70    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E6F75    mov eax, esi
004E6F77    mov ecx, dword ptr ss:[ebp-0x0C]
004E6F7A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E6F81    pop ecx
004E6F82    pop esi
