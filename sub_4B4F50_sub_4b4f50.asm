...
004B4FE9    call 0x0063B870
004B4FEE    add esp, 0x0C
004B4FF1    call 0x0063BC30
004B4FF6    test al, al
004B4FF8    jz 0x004B4FFB
004B4FFA    int3
004B4FFB    call 0x0063BB00
