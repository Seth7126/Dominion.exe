...
0065CD09    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0065CD3C    call 0x006E5AB0                                 ; => [ Call: sub_6e5ab0 ]
...
0065CDA4    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0065CDD5    call 0x0064C550                                 ; => [ Call: sub_64c550 ]
...
0065CEB0    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0065CF2F    push ecx                                        ; => [ Call: sub_6e5cc0 ]
0065CF30    mov ecx, dword ptr ds:[edi+0x13A8]
0065CF36    lea edx, ss:[ebp-0x148]
0065CF3C    call 0x006E8B30                                 ; => [ Call: sub_6e8b30 ]
...
0065CFDD    call dword ptr ds:[eax+0x28]                    ; => [ Data: data_147abec ]
...
0065CFFB    call 0x006B8440                                 ; => [ Call: sub_6b8440 ]
...
0065D013    movups xmmword ptr ss:[ebp-0x1B4], xmm0         ; => [ Data: data_bf21e8 ]
0065D01A    movups xmm0, xmmword ptr ds:[0x00BF21F8]
0065D021    movups xmmword ptr ss:[ebp-0x1A4], xmm0         ; => [ Data: data_bf21f8 ]
...
0065D05C    call 0x006B80F0                                 ; => [ Call: sub_6b80f0 ]
...
0065D073    call 0x006B8440                                 ; => [ Call: sub_6b8440 ]
...
0065D095    pop ebx
0065D096    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0065D0B8    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: assetPtr->assetType == ASSET_TYPE_FLANIM | Data: data_801800 | String: FlanimGetDef | String: C:\x\ax2017\Engine\AssetUtils.cpp ]
0065D0BD    add esp, 0x0C
0065D0C0    call 0x0063BC30
0065D0C5    test al, al
0065D0C7    jz 0x0065D0CA                                   ; => [ Call: sub_63bc30 ]
0065D0C9    int3
0065D0CA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
