...
0053D2F1    push edi
0053D2F2    push ecx                                        ; => [ Call: __chkstk ]
0053D2F3    push 0x00
0053D2F5    lea ecx, ds:[edx+0x01]
0053D2F8    call 0x00561E00                                 ; => [ Data: __security_cookie | Call: sub_561e00 ]
0053D2FD    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053D302    push 0x00
0053D304    push 0x00
0053D306    push 0x01
...
0053D30E    push 0x01
0053D310    call 0x00590760                                 ; => [ Call: sub_590760 ]
0053D315    add esp, 0x18
0053D318    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053D33A    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053D33F    push 0x00
0053D341    push 0x00
0053D343    push 0x01
...
0053D34B    push 0x02
0053D34D    call 0x00590760                                 ; => [ Call: sub_590760 ]
0053D352    add esp, 0x10
0053D355    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053D381    call 0x00568780                                 ; => [ Call: sub_568780 ]
0053D386    xorps xmm0, xmm0
0053D389    mov dword ptr ss:[esp+0x20], 0x00               ; => [ Call: __builtin_memset ]
0053D391    push 0x00
0053D393    push 0x00
...
0053D3F2    push 0x1B
0053D3F4    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0053D43F    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053D468    call 0x00565FF0                                 ; => [ Call: nullptr | Call: sub_565ff0 ]
...
0053D497    call 0x0056F1A0                                 ; => [ Call: sub_56f1a0 ]
0053D49C    add esp, 0x04
0053D49F    mov ecx, dword ptr ss:[esp+0x198C]
0053D4A6    pop edi
0053D4A7    pop esi
0053D4A8    xor ecx, esp
0053D4AA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0053D4C9    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0053D4CE    add esp, 0x0C
0053D4D1    call 0x0063BC30
0053D4D6    test al, al
0053D4D8    jz 0x0053D4DB                                   ; => [ Call: sub_63bc30 ]
0053D4DA    int3
0053D4DB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
