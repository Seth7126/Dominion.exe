...
0064B536    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0064B55A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0064B56D    movlpd qword ptr ss:[ebp-0x28], xmm0            ; => [ Type: tm | Field: tm_sec | Field: tm_min ]
0064B572    mov dword ptr ss:[ebp-0x14], eax                ; => [ Field: tm_year ]
0064B575    mov eax, dword ptr ds:[ecx+0x04]
0064B578    dec eax
0064B579    mov dword ptr ss:[ebp-0x20], 0x00               ; => [ Field: tm_hour ]
0064B580    mov dword ptr ss:[ebp-0x18], eax                ; => [ Field: tm_mon ]
0064B583    mov eax, dword ptr ds:[ecx+0x08]
0064B586    add eax, edx
0064B588    movlpd qword ptr ss:[ebp-0x10], xmm0            ; => [ Field: tm_wday | Field: tm_yday ]
0064B58D    mov dword ptr ss:[ebp-0x1C], eax                ; => [ Field: tm_mday ]
0064B590    lea eax, ss:[ebp-0x28]
0064B593    push esi
0064B594    push eax
0064B595    mov dword ptr ss:[ebp-0x08], 0x00               ; => [ Field: tm_isdst ]
...
0064B5B3    mov edx, dword ptr ss:[ebp-0x1C]                ; => [ Field: tm_mday ]
0064B5B6    inc esi                                         ; => [ Field: tm_mon ]
0064B5B7    mov dword ptr ds:[ecx], eax                     ; => [ Field: tm_year ]
...
0064B5C6    pop esi
0064B5C7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
