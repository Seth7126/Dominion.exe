...
0067809D    movss xmm0, dword ptr ds:[0x00C27C48]
006780A5    mov ecx, dword ptr ds:[0x00CADDE4]
...
006780C7    movss dword ptr ds:[0x00C27C48], xmm0
006780CF    call 0x00666A40
006780D4    mov ecx, dword ptr ds:[0x00CADDE4]
...
006781AA    mulss xmm1, dword ptr ds:[0x00C27C48]
006781B2    movss dword ptr ds:[0x00C27C4C], xmm2
006781BA    movss xmm2, dword ptr ds:[0x00890E18]
006781C2    movss dword ptr ds:[0x00C27C50], xmm1
006781CA    mov eax, dword ptr ds:[esi]
006781CC    cmp eax, 0x01
006781CF    jnz 0x0067972F
006781D5    mov cl, byte ptr ds:[0x00C28C60]
006781DB    test cl, cl
...
006781ED    jz 0x00678377
006781F3    mov eax, dword ptr ds:[esi+0x04]
006781F6    cmp eax, 0x0D
006781F9    jnz 0x00678210
006781FB    mov word ptr ds:[0x00C28C60], 0x00
00678204    mov byte ptr ds:[0x00C28C62], 0x00
...
00678366    call 0x00667D10
0067836B    mov cl, 0x01
0067836D    call 0x00665770
...
00678386    jle 0x00679E8A
0067838C    mov edx, dword ptr ds:[0x00C28C5C]
00678392    mov esi, dword ptr ds:[0x00C27C18]
00678398    lea ecx, ds:[edx+0x01]
0067839B    cmp ecx, esi
0067839D    jnl 0x006783C2
0067839F    mov eax, ecx
006783A1    shl eax, 0x04
006783A4    add eax, 0xC23C24
...
006783C5    mov esi, dword ptr ds:[edx+0xC23C18]
006783CB    mov dword ptr ds:[0x00C28C58], 0x00
006783D5    mov ecx, dword ptr ds:[esi+0x18C8]
006783DB    call 0x0066C650
006783E0    mov ecx, esi
006783E2    call 0x0066B9A0
006783E7    mov dword ptr ds:[0x00C28C5C], eax
...
00678402    jle 0x00679E8A
00678408    mov esi, dword ptr ds:[0x00C27C18]
0067840E    xor eax, eax
00678410    mov edx, dword ptr ds:[0x00C28C5C]
00678416    test esi, esi
00678418    jle 0x00678430
0067841A    mov ecx, 0xC23C20
0067841F    nop
...
0067847C    jz 0x006784A6
0067847E    call dword ptr ds:[0x00775378]
00678484    cmp eax, dword ptr ds:[0x0147B084]
0067848A    jz 0x00678490
0067848C    test eax, eax
0067848E    jnz 0x006784A6
00678490    mov ecx, 0x01
00678495    call 0x006758C0
0067849A    xor cl, cl
0067849C    call 0x00665770
...
006784BE    jz 0x006784E6
006784C0    call dword ptr ds:[0x00775378]
006784C6    cmp eax, dword ptr ds:[0x0147B084]
006784CC    jz 0x006784D2
006784CE    test eax, eax
006784D0    jnz 0x006784E6
006784D2    or ecx, 0xFFFFFFFF
006784D5    call 0x006758C0
006784DA    xor cl, cl
006784DC    call 0x00665770
...
00678528    jle 0x00678669
0067852E    mov eax, 0xC23C18
00678533    mov dword ptr ss:[ebp-0x1070], eax
00678539    nop dword ptr ds:[eax], eax
00678540    mov esi, dword ptr ds:[eax]
00678542    mov ecx, esi
00678544    call 0x0064CC90
...
00678588    call 0x0064C080
0067858D    mov eax, dword ptr ss:[ebp-0x1064]
00678593    mov dword ptr ds:[esi+0x1720], 0x801800
0067859D    push 0x6F
0067859F    mov edx, eax
006785A1    mov ecx, 0x8CAE70
006785A6    call 0x006DCEC0
...
0067869A    push 0x87437C
0067869F    push 0xBA8
006786A4    push 0x8739B4
006786A9    mov ecx, 0x874310
006786AE    jmp 0x00679F09
006786B3    jle 0x00679E8A
006786B9    call 0x0066F4B0
006786BE    push eax
006786BF    push 0x00
006786C1    mov edx, 0x8B
006786C6    mov ecx, esi
006786C8    call 0x0066F200
...
00678805    jz 0x00678823
00678807    call dword ptr ds:[0x00775378]
0067880D    cmp eax, dword ptr ds:[0x0147B084]
00678813    jz 0x00678819
00678815    test eax, eax
00678817    jnz 0x00678823
00678819    call 0x006FA410
...
0067883B    jz 0x00678859
0067883D    call dword ptr ds:[0x00775378]
00678843    cmp eax, dword ptr ds:[0x0147B084]
00678849    jz 0x0067884F
0067884B    test eax, eax
0067884D    jnz 0x00678859
0067884F    call 0x006F9E80
...
00678866    inc eax
00678867    and eax, 0x80000003
0067886C    jns 0x00678873
0067886E    dec eax
0067886F    or eax, 0xFFFFFFFC
00678872    inc eax
00678873    mov dword ptr ds:[0x00CADDE4], eax
...
00678894    jz 0x006788CA
00678896    call dword ptr ds:[0x00775378]
0067889C    cmp eax, dword ptr ds:[0x0147B084]
006788A2    jz 0x006788A8
006788A4    test eax, eax
006788A6    jnz 0x006788CA
006788A8    cmp dword ptr ds:[0x00C28C58], 0x00
006788AF    mov word ptr ds:[0x00C28C61], 0x00
006788B8    jle 0x00679E8A
006788BE    mov byte ptr ds:[0x00C28C60], 0x01
...
00678A38    test al, al
00678A3A    jz 0x00679E8A
00678A40    mov eax, dword ptr ds:[0x0147DEC0]
00678A45    mov ecx, dword ptr ds:[0x00CF65B8]
00678A4B    mov dword ptr ds:[eax*4+0x147DCC0], esi
00678A52    mov eax, dword ptr ds:[0x0147DEC0]
00678A57    inc eax
00678A58    mov dword ptr ds:[0x0147DEC0], eax
00678A5D    mov dword ptr ds:[0x0147DEC4], eax
00678A62    mov eax, dword ptr ds:[ecx]
00678A64    call dword ptr ds:[eax+0x04]
00678A67    call 0x006FDA60
00678A6C    mov eax, dword ptr ds:[0x00CF65B4]
00678A71    push dword ptr ds:[0x0147B084]
...
00678DDF    setnz cl
00678DE2    inc ecx
00678DE3    call 0x006748C0
00678DE8    add esp, 0x04
00678DEB    jmp 0x00678DF4
00678DED    mov ecx, esi
00678DEF    call 0x006751A0
00678DF4    mov ecx, 0xC27C24
00678DF9    call 0x0064E810
00678DFE    mov cl, 0x01
00678E00    mov dword ptr ds:[0x00C27C24], 0x00
00678E0A    call 0x00665770
...
00678F1A    call 0x006748C0
00678F1F    add esp, 0x04
00678F22    mov ecx, 0xC27C24
00678F27    call 0x0064E810
00678F2C    mov cl, 0x01
00678F2E    mov dword ptr ds:[0x00C27C24], 0x00
00678F38    call 0x00665770
...
00678F5A    jz 0x00678F6E
00678F5C    call dword ptr ds:[0x00775378]
00678F62    cmp eax, dword ptr ds:[0x0147B084]
00678F68    jz 0x00678F90
00678F6A    test eax, eax
00678F6C    jz 0x00678F90
00678F6E    cmp dword ptr ds:[0x00C28C58], 0x01
00678F75    mov word ptr ds:[0x00C28C60], 0x00
00678F7E    jnz 0x00679E8A
00678F84    mov byte ptr ds:[0x00C28C62], 0x01
...
00679116    xorps xmm1, xmmword ptr ds:[0x008937C0]
0067911D    mov esi, dword ptr ds:[eax+0x1604]
00679123    push ecx
00679124    mov ecx, 0x01
00679129    movss dword ptr ss:[ebp-0x1060], xmm2
00679131    movss dword ptr ss:[ebp-0x105C], xmm1
00679139    call 0x006748C0
0067913E    add esp, 0x0C
00679141    mov dword ptr ds:[0x00C27C58], esi
00679147    mov cl, 0x01
00679149    mov dword ptr ds:[0x00C28C58], 0x01
00679153    call 0x00665770
00679158    mov ecx, 0xC27C24
0067915D    call 0x0064E810
...
0067917F    jz 0x0067919D
00679181    call dword ptr ds:[0x00775378]
00679187    cmp eax, dword ptr ds:[0x0147B084]
0067918D    jz 0x00679193
0067918F    test eax, eax
00679191    jnz 0x0067919D
00679193    call 0x0067C150
...
006791B5    jz 0x0067921A
006791B7    call dword ptr ds:[0x00775378]
006791BD    cmp eax, dword ptr ds:[0x0147B084]
006791C3    jz 0x006791C9
006791C5    test eax, eax
006791C7    jnz 0x0067921A
006791C9    cmp dword ptr ds:[0x00C28C58], 0x00
006791D0    jz 0x00679E8A
006791D6    push dword ptr ds:[0x00C23BB8]
006791DC    push 0x8766A4
006791E1    call 0x0063B5F0
006791E6    call 0x00673B80
006791EB    push dword ptr ds:[0x00C23BB8]
006791F1    push 0x87668C
006791F6    call 0x0063B5F0
006791FB    push dword ptr ds:[0x00C23BB8]
00679201    push 0x8766D8
00679206    call 0x0063B5F0
0067920B    add esp, 0x18
0067920E    mov cl, 0x01
00679210    call 0x00665770
00679215    jmp 0x00679E8A
0067921A    mov eax, dword ptr ds:[esi+0x04]
0067921D    cmp eax, 0x42
00679220    jnz 0x00679263
00679222    imul eax, dword ptr ds:[0x00CA9A6C], 0x101C
0067922C    push 0x1018
00679231    push 0xC27C54
00679236    mov dword ptr ds:[0x00C28C58], 0x00
00679240    add eax, 0xC27C50
00679245    push eax
00679246    call 0x00761FBE
0067924B    add esp, 0x0C
0067924E    mov word ptr ds:[0x00C28C61], 0x01
00679257    mov byte ptr ds:[0x00C28C60], 0x00
...
0067935E    jz 0x006793C1
00679360    call dword ptr ds:[0x00775378]
00679366    cmp eax, dword ptr ds:[0x0147B084]
0067936C    jz 0x00679372
0067936E    test eax, eax
00679370    jnz 0x006793C1
00679372    mov eax, dword ptr ds:[0x00CA9A6C]
00679377    cmp eax, dword ptr ds:[0x00CA9A70]
0067937D    jnl 0x00679E8A
00679383    mov byte ptr ds:[0x00CA9A76], 0x01
0067938A    call 0x006EE530
0067938F    mov eax, dword ptr ds:[0x00CA9A6C]
00679394    inc eax
00679395    imul ecx, eax, 0x101C
0067939B    mov dword ptr ds:[0x00CA9A6C], eax
006793A0    add ecx, 0xC27C50
006793A6    call 0x00666DB0
006793AB    mov ecx, 0xC27C24
006793B0    call 0x0064E810
006793B5    mov byte ptr ds:[0x00CA9A76], 0x00
...
00679413    jz 0x006794D4
00679419    call dword ptr ds:[0x00775378]
0067941F    cmp eax, dword ptr ds:[0x0147B084]
00679425    jz 0x0067942F
00679427    test eax, eax
00679429    jnz 0x006794D4
0067942F    mov eax, dword ptr ds:[0x0147AC2C]
...
00679492    jz 0x006794C6
00679494    mov eax, dword ptr ds:[esi+0x20]
00679497    mov ecx, edi
...
00679523    push dword ptr ds:[0x00C28C58]
00679529    mov ecx, dword ptr ds:[0x00C27C24]
0067952F    lea eax, ss:[ebp-0x1064]
00679535    push 0xC27C58
0067953A    push eax
0067953B    lea edx, ss:[ebp-0x1018]
00679541    mov dword ptr ss:[ebp-0x1064], 0x00
0067954B    call 0x006674E0
...
0067962A    jnz 0x006796B5
00679630    mov edi, dword ptr ds:[0x00C27C18]
00679636    xor edx, edx
00679638    test edi, edi
0067963A    jle 0x0067965D
0067963C    mov esi, 0xC23C18
...
0067968E    mov dword ptr ds:[ecx*4+0xC27C58], eax
00679695    mov ecx, dword ptr ds:[0x00C28C58]
0067969B    mov edi, dword ptr ds:[0x00C27C18]
006796A1    inc ecx
006796A2    mov dword ptr ds:[0x00C28C58], ecx
006796A8    inc edx
...
006796F8    jnz 0x00679E8A
006796FE    imul eax, dword ptr ds:[0x00CA9A6C], 0x101C
00679708    push 0x1018
0067970D    push 0xC27C54
00679712    mov dword ptr ds:[0x00C28C58], 0x00
0067971C    add eax, 0xC27C50
00679721    push eax
00679722    call 0x00761FBE
00679727    add esp, 0x0C
0067972A    jmp 0x00679E8A
0067972F    cmp eax, 0x07
00679732    jnz 0x0067973E
00679734    call 0x00676190
...
0067989C    addss xmm0, dword ptr ds:[0x00C27C50]
006798A4    movss dword ptr ss:[ebp-0x1080], xmm1
...
006798C7    movups xmm1, xmmword ptr ds:[eax]
...
00679954    mov ecx, dword ptr ds:[0x01777548]
...
00679AA5    call 0x0064C080
00679AAA    mov dword ptr ss:[ebp-0x106C], 0x801800
00679AB4    mov dword ptr ss:[ebp-0x04], 0x0B
00679ABB    cmp dword ptr ds:[0x00CF65BC], 0x00
00679AC2    jz 0x00679E8A
...
00679B3B    call 0x0064C080
00679B40    mov dword ptr ss:[ebp-0x106C], 0x801800
00679B4A    mov dword ptr ss:[ebp-0x04], 0x09
00679B51    cmp dword ptr ds:[0x00CF65BC], 0x00
00679B58    jz 0x00679B87
...
00679CF4    jz 0x00679D5F
00679CF6    call edi
00679CF8    cmp eax, dword ptr ds:[0x0147B084]
00679CFE    jz 0x00679D04
00679D00    test eax, eax
00679D02    jnz 0x00679D5F
00679D04    lea ecx, ss:[ebp-0x1020]
00679D0A    mov byte ptr ds:[0x00CA9A74], 0x01
00679D11    mov dword ptr ds:[0x00CA9A78], 0x01
00679D1B    call 0x0063C270
00679D20    movss xmm1, dword ptr ss:[ebp-0x1020]
00679D28    movss xmm0, dword ptr ss:[ebp-0x101C]
00679D30    movss dword ptr ds:[0x00CA9A7C], xmm1
00679D38    movss dword ptr ds:[0x00CA9A80], xmm0
00679D40    mov dword ptr ds:[0x00CA9A8C], 0x00
00679D4A    movss dword ptr ds:[0x00CA9A84], xmm1
00679D52    movss dword ptr ds:[0x00CA9A88], xmm0
...
00679DEE    jnb 0x00679FBD
00679DF4    mov eax, dword ptr ds:[0x00C23BA8]
...
00679E6B    jnle 0x00679E85
00679E6D    mov ecx, esi
00679E6F    call 0x00665A60
00679E74    mov edx, dword ptr ds:[0x00C28C58]
00679E7A    mov byte ptr ds:[0x00CA9A95], 0x01
00679E81    test edx, edx
00679E83    jle 0x00679E8A
00679E85    call 0x00674330
00679E8A    mov al, 0x01
00679E8C    mov ecx, dword ptr ss:[ebp-0x0C]
00679E8F    mov dword ptr fs:[0x00000000], ecx
00679E96    pop ecx
00679E97    pop edi
00679E98    pop esi
00679E99    mov ecx, dword ptr ss:[ebp-0x14]
00679E9C    xor ecx, ebp
00679E9E    call 0x0075927A
...
00679EBA    jz 0x00679ECA
00679EBC    call edi
00679EBE    cmp eax, dword ptr ds:[0x0147B084]
00679EC4    jz 0x00679E8A
00679EC6    test eax, eax
00679EC8    jz 0x00679E8A
00679ECA    imul eax, dword ptr ds:[0x00CA9A6C], 0x101C
00679ED4    push 0x1018
00679ED9    push 0xC27C54
00679EDE    mov dword ptr ds:[0x00C28C58], 0x00
00679EE8    add eax, 0xC27C50
00679EED    push eax
00679EEE    call 0x00761FBE
00679EF3    add esp, 0x0C
00679EF6    jmp 0x00679E8A
00679EF8    push 0x876B2C
00679EFD    push 0x6D
00679EFF    mov ecx, 0x802748
00679F04    push 0x80193C
00679F09    mov edx, 0x801800
00679F0E    call 0x0063B870
00679F13    add esp, 0x0C
00679F16    call 0x0063BC30
00679F1B    test al, al
00679F1D    jz 0x00679F20
00679F1F    int3
00679F20    call 0x0063BB00
00679F25    push 0x872E98
00679F2A    push 0xDB
00679F2F    push 0x801A00
00679F34    mov edx, 0x801800
00679F39    mov ecx, 0x872EA4
00679F3E    call 0x0063B870
00679F43    add esp, 0x0C
00679F46    call 0x0063BC30
00679F4B    test al, al
00679F4D    jz 0x00679F50
00679F4F    int3
00679F50    call 0x0063BB00
00679F55    push 0x876B2C
00679F5A    push 0x6D
00679F5C    mov ecx, 0x802748
00679F61    jmp 0x00679F6F
00679F63    push 0x876B2C
00679F68    push 0x6C
00679F6A    mov ecx, 0x802734
00679F6F    push 0x80193C
00679F74    mov edx, 0x801800
00679F79    call 0x0063B870
00679F7E    add esp, 0x0C
00679F81    call 0x0063BC30
00679F86    test al, al
00679F88    jz 0x00679F8B
00679F8A    int3
00679F8B    call 0x0063BB00
00679F90    push 0x874440
00679F95    push 0xC17
00679F9A    mov edx, edi
00679F9C    mov ecx, 0x87444C
00679FA1    push 0x8739B4
00679FA6    call 0x0063B870
00679FAB    add esp, 0x0C
00679FAE    call 0x0063BC30
00679FB3    test al, al
00679FB5    jz 0x00679FB8
00679FB7    int3
00679FB8    call 0x0063BB00
00679FBD    push 0x876B2C
00679FC2    push 0x6D
00679FC4    mov ecx, 0x802748
00679FC9    jmp 0x00679FD7
00679FCB    push 0x876B2C
00679FD0    push 0x6C
00679FD2    mov ecx, 0x802734
00679FD7    push 0x80193C
00679FDC    mov edx, 0x801800
00679FE1    call 0x0063B870
00679FE6    add esp, 0x0C
00679FE9    call 0x0063BC30
00679FEE    test al, al
00679FF0    jz 0x00679FF3
00679FF2    int3
00679FF3    call 0x0063BB00
