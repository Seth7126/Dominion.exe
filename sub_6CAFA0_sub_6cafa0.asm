...
006CAFB8    push 0x770A91                                   ; => [ Type: EHRegistrationNode | Call: sub_770a91 ]
006CAFBD    mov eax, dword ptr fs:[0x00000000]
006CAFC3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006CAFC4    push ebx
006CAFC5    sub esp, 0x78
006CAFC8    push esi
006CAFC9    push edi
006CAFCA    mov eax, dword ptr ds:[0x008C4040]
006CAFCF    xor eax, ebp                                    ; => [ Data: __security_cookie ]
006CAFD1    push eax
006CAFD2    lea eax, ss:[ebp-0x0C]
006CAFD5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006CAFDB    mov eax, dword ptr ds:[0x00CF65B8]
006CAFE0    movd xmm0, dword ptr ds:[eax+0x18]
006CAFE5    cvtdq2ps xmm0, xmm0
006CAFE8    movss dword ptr ss:[ebp-0x14], xmm0             ; => [ Data: data_cf65b8 ]
006CAFED    call 0x00646520
006CAFF2    test al, al
006CAFF4    jz 0x006CB005                                   ; => [ Call: sub_646520 ]
...
006CB042    call 0x00682F00                                 ; => [ Call: sub_682f00 ]
006CB047    movss xmm1, dword ptr ds:[0x00890F40]
006CB04F    xor ecx, ecx
006CB051    mov edi, dword ptr ds:[0x0147D19C]              ; => [ Data: data_147d19c ]
...
006CB0BC    mov ecx, dword ptr ds:[eax]                     ; => [ Field: ThreadLocalStoragePointer ]
006CB0BE    mov eax, dword ptr ds:[0x01A9A2D8]              ; => [ Data: data_1a9a2d8 ]
006CB0C3    cmp eax, dword ptr ds:[ecx+0x08]
006CB0C9    jle 0x006CB110
006CB0CB    push 0x1A9A2D8
006CB0D0    call 0x0075970E                                 ; => [ Data: data_1a9a2d8 | Call: sub_75970e ]
006CB0D5    add esp, 0x04
006CB0D8    cmp dword ptr ds:[0x01A9A2D8], 0xFFFFFFFF
006CB0DF    jnz 0x006CB110                                  ; => [ Data: data_1a9a2d8 ]
...
006CB0FC    mov dword ptr ds:[0x01A9A2DC], eax              ; => [ Data: data_1a9a2dc | String: sys/DebugFont.font | Call: sub_69f030 ]
006CB101    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006CB108    call 0x007596BD                                 ; => [ Data: data_1a9a2d8 | Call: __Init_thread_footer ]
...
006CB13D    call 0x006B3F10                                 ; => [ Data: data_1a9a2dc | String: Overflow | Call: sub_6b3f10 ]
...
006CB1BB    mov eax, dword ptr fs:[0x0000002C]              ; => [ Field: ThreadLocalStoragePointer ]
...
006CB1D1    jle 0x006CB225                                  ; => [ Data: data_1a98f58 ]
006CB1D3    push 0x1A98F58
006CB1D8    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a98f58 ]
006CB1DD    add esp, 0x04
006CB1E0    cmp dword ptr ds:[0x01A98F58], 0xFFFFFFFF
006CB1E7    jnz 0x006CB21F                                  ; => [ Data: data_1a98f58 ]
...
006CB20F    movss dword ptr ds:[0x01A98F5C], xmm1           ; => [ Data: data_1a98f5c | Call: __ultof3 ]
006CB217    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a98f58 ]
006CB21C    add esp, 0x04
006CB21F    mov edi, dword ptr ds:[0x0147D19C]              ; => [ Data: data_147d19c ]
...
006CB24B    mulss xmm0, dword ptr ds:[0x00890F40]           ; => [ Data: data_1a98f5c | Call: __ultof3 ]
...
006CB2B8    mov edx, dword ptr ds:[eax]                     ; => [ Field: ThreadLocalStoragePointer ]
...
006CB2E4    jle 0x006CB335                                  ; => [ Data: data_1a98f58 ]
006CB2E6    push 0x1A98F58
006CB2EB    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a98f58 ]
006CB2F0    add esp, 0x04
006CB2F3    cmp dword ptr ds:[0x01A98F58], 0xFFFFFFFF
006CB2FA    jnz 0x006CB332                                  ; => [ Data: data_1a98f58 ]
...
006CB322    movss dword ptr ds:[0x01A98F5C], xmm1           ; => [ Data: data_1a98f5c | Call: __ultof3 ]
006CB32A    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a98f58 ]
...
006CB347    mulss xmm0, dword ptr ds:[0x00891064]           ; => [ Call: __ultof3 ]
...
006CB36C    minss xmm1, xmm0                                ; => [ Data: data_1a98f5c ]
...
006CB39D    call 0x00682F00                                 ; => [ Call: sub_682f00 ]
...
006CB3C8    mov edi, dword ptr ds:[0x0147D19C]              ; => [ Data: data_147d19c ]
...
006CB430    call 0x00682F00                                 ; => [ Call: sub_682f00 ]
006CB435    mov ecx, dword ptr ss:[ebp-0x18]
006CB438    movss xmm1, dword ptr ds:[0x00890F40]
006CB440    mov edi, dword ptr ds:[0x0147D19C]              ; => [ Data: data_147d19c ]
006CB446    inc ecx
...
006CB45B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006CB462    pop ecx
006CB463    pop edi
006CB464    pop esi
