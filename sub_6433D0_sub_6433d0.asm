...
006433F2    cmovnle edi, dword ptr ds:[0x0147AB9C]          ; => [ Data: data_147ab9c | Data: data_147ab9c ]
006433F9    xor ebx, ebx
006433FB    mov dword ptr ss:[ebp-0x08], edi
006433FE    test edi, edi
00643400    jle 0x006434FE
00643406    lea edi, ds:[edx*4+0x1476B90]                   ; => [ Data: data_147ab98 | Data: data_1476b90 ]
...
00643420    jnle 0x00643529                                 ; => [ Data: data_e76b40 ]
...
00643479    call 0x00642AE0                                 ; => [ Data: data_cf6744 | Call: sub_642ae0 ]
...
006434BD    call 0x00642AE0                                 ; => [ Data: data_cf67c4 | Call: sub_642ae0 ]
...
00643505    pop ebp
00643506    ret
00643507    push 0x8726CC                                   ; => [ String: Draw3DGetInstanceMatrices ]
0064350C    push 0x14F
00643511    mov ecx, 0x8726E8                               ; => [ String: materialParam == MATERIAL_MATRIX_WORLD_VIEW_PROJ_INSTANCE ]
00643516    jmp 0x00643538
00643518    push 0x8726CC                                   ; => [ String: Draw3DGetInstanceMatrices ]
0064351D    push 0x13B
00643522    mov ecx, 0x872724                               ; => [ String: renderItem.renderType == RENDER_ITEM_MESH ]
00643527    jmp 0x00643538
00643529    push 0x8726CC                                   ; => [ String: Draw3DGetInstanceMatrices ]
0064352E    push 0x138
00643533    mov ecx, 0x872690                               ; => [ String: itemIndex >= 0 && itemIndex <= gDraw3DData.renderItemCount ]
00643538    push 0x872630
0064353D    mov edx, 0x801800
00643542    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Draw3d.cpp | String: Draw3DGetInstanceMatrices ]
00643547    add esp, 0x0C
0064354A    call 0x0063BC30
0064354F    test al, al
00643551    jz 0x00643554                                   ; => [ Call: sub_63bc30 ]
00643553    int3
00643554    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
