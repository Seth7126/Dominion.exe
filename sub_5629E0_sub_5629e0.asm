...
005629F8    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
005629FD    mov eax, dword ptr fs:[0x00000000]
00562A03    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00562A04    push ebx
00562A05    mov eax, 0x19A8
00562A0A    call 0x00761E50                                 ; => [ Call: __chkstk ]
00562A0F    mov eax, dword ptr ds:[0x008C4040]
00562A14    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00562A16    mov dword ptr ss:[ebp-0x14], eax
00562A19    push esi
00562A1A    push edi
00562A1B    push eax
00562A1C    lea eax, ss:[ebp-0x0C]
00562A1F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00562A25    mov dword ptr ss:[ebp-0xCA8], ecx
00562A2B    lea eax, ss:[ebp-0x19B8]
00562A31    mov ecx, 0x3EA
00562A36    push eax
00562A37    call 0x00568780                                 ; => [ Call: sub_568780 ]
00562A3C    mov esi, eax
00562A3E    mov dword ptr ss:[ebp-0xD00], 0x81F360          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_56241eccd0bca619279646f872935638>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_56241eccd0bca619279646f872935638>,bool,enum CardID>::VTable ]
...
00562A65    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00562A67    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_56241eccd0bca619279646f872935638>,bool,enum CardID>::VTable ]
...
00562AA8    call eax                                        ; => [ Field: vFunc_0 ]
...
00562ACB    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
00562AE2    push eax
00562AE3    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00562AFB    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
