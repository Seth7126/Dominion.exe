...
0067FB45    push 0x76DBBD                                   ; => [ Type: EHRegistrationNode | Call: sub_76dbbd ]
0067FB4A    mov eax, dword ptr fs:[0x00000000]
0067FB50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0067FB51    sub esp, 0x18
0067FB54    push ebx
0067FB55    push esi
0067FB56    push edi
0067FB57    mov eax, dword ptr ds:[0x008C4040]
0067FB5C    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0067FB5E    push eax
0067FB5F    lea eax, ss:[ebp-0x0C]
0067FB62    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0067FBB0    push eax
0067FBB1    call 0x00681030                                 ; => [ Call: sub_681030 ]
...
0067FBC3    call 0x00681030                                 ; => [ Call: sub_681030 ]
...
0067FBDF    call 0x00681030                                 ; => [ Call: sub_681030 ]
...
0067FBFA    call 0x00681030                                 ; => [ Call: sub_681030 ]
...
0067FCEE    jz 0x0067FD0B                                   ; => [ Data: data_cf65bc ]
0067FCF0    lea ecx, ss:[ebp-0x1C]
0067FCF3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FD06    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FD78    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FD8C    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0067FD91    mov ecx, dword ptr ss:[ebp-0x14]
0067FD94    lea eax, ss:[ebp-0x20]
0067FD97    push eax
0067FD98    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0067FDB4    jz 0x0067FDD1                                   ; => [ Data: data_cf65bc ]
0067FDB6    lea ecx, ss:[ebp-0x20]
0067FDB9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FDCC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FE22    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FE37    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0067FE3C    mov ecx, dword ptr ss:[ebp-0x10]
0067FE3F    lea eax, ss:[ebp-0x20]
0067FE42    push eax
0067FE43    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0067FE5F    jz 0x0067FE7C                                   ; => [ Data: data_cf65bc ]
0067FE61    lea ecx, ss:[ebp-0x20]
0067FE64    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FE77    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FED6    jz 0x0067FEF3                                   ; => [ Data: data_cf65bc ]
0067FED8    lea ecx, ss:[ebp-0x20]
0067FEDB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FEEE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FF35    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FF4A    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0067FF4F    lea eax, ss:[ebp-0x20]
0067FF52    mov ecx, edi
0067FF54    push eax
0067FF55    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0067FF71    jz 0x0067FF8E                                   ; => [ Data: data_cf65bc ]
0067FF73    lea ecx, ss:[ebp-0x20]
0067FF76    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FF89    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067FFAF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067FFC4    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0067FFC9    mov ecx, dword ptr ss:[ebp-0x10]
0067FFCC    lea eax, ss:[ebp-0x20]
0067FFCF    push eax
0067FFD0    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0067FFEC    jz 0x00680009                                   ; => [ Data: data_cf65bc ]
0067FFEE    lea ecx, ss:[ebp-0x20]
0067FFF1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00680004    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00680032    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00680047    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0068004C    mov ecx, dword ptr ss:[ebp-0x14]
0068004F    lea eax, ss:[ebp-0x20]
00680052    push eax
00680053    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0068006F    jz 0x0068008C                                   ; => [ Data: data_cf65bc ]
00680071    lea ecx, ss:[ebp-0x20]
00680074    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00680087    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006800B1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006800B8    pop ecx
006800B9    pop edi
006800BA    pop esi
006800BB    pop ebx
