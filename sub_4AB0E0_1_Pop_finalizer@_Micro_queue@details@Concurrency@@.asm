...
004AB126    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004AB139    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AB13E    mov dword ptr ds:[esi+0x30], 0x801800           ; => [ Data: data_801800 ]
004AB145    mov dword ptr ss:[ebp-0x04], 0x01
004AB14C    cmp dword ptr ds:[0x00CF65BC], 0x00
004AB153    jz 0x004AB183                                   ; => [ Data: data_cf65bc ]
...
004AB164    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004AB177    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AB17C    mov dword ptr ds:[esi+0x2C], 0x801800           ; => [ Data: data_801800 ]
004AB183    mov dword ptr ss:[ebp-0x04], 0x02
004AB18A    cmp dword ptr ds:[0x00CF65BC], 0x00
004AB191    jz 0x004AB1C1                                   ; => [ Data: data_cf65bc ]
...
004AB1A2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004AB1B5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AB1BA    mov dword ptr ds:[esi+0x28], 0x801800           ; => [ Data: data_801800 ]
004AB1C1    mov ecx, dword ptr ss:[ebp-0x0C]
004AB1C4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004AB1CB    pop ecx
004AB1CC    pop edi
004AB1CD    pop esi
