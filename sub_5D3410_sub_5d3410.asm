...
005D3418    call 0x005D3300                                 ; => [ Call: sub_5d3300 ]
005D341D    cmp eax, 0x06
005D3420    jnbe 0x005D39A9
005D3426    jmp dword ptr ds:[eax*4+0x5D39DC]
005D342D    mov ecx, esi
005D342F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D3434    mov edx, 0xBE2360
005D3439    jmp 0x005D347F
005D343B    mov ecx, esi
005D343D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D3442    mov edx, 0xBE236C
005D3447    jmp 0x005D347F
005D3449    mov ecx, esi
005D344B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D3450    mov edx, 0xBE2378
005D3455    jmp 0x005D347F
005D3457    mov ecx, esi
005D3459    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D345E    mov edx, 0xBE2384
005D3463    jmp 0x005D347F
005D3465    mov ecx, esi
005D3467    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D346C    mov edx, 0xBE2390
005D3471    jmp 0x005D347F
005D3473    mov ecx, esi
005D3475    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D347A    mov edx, 0xBE239C
005D347F    movss xmm3, dword ptr ds:[0x00890E18]
005D3487    mov ecx, eax
005D3489    push 0x00
005D348B    push 0xFFFFFFFF
005D348D    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be2360 | Data: data_be236c | Call: sub_665db0 | Data: data_be2378 | Call: sub_665db0 | Data: data_be2384 | Call: sub_665db0 | Data: data_be2390 | Call: sub_665db0 | Call: sub_665db0 | Data: data_be239c ]
005D3492    add esp, 0x08
005D3495    cmp edi, 0x8B
005D349B    jnbe 0x005D399D
005D34A1    movzx eax, byte ptr ds:[edi+0x5D3A14]           ; => [ Data: lookup_table_5d3a14 ]
005D34A8    jmp dword ptr ds:[eax*4+0x5D39F8]
005D34AF    mov ecx, esi
005D34B1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D34B6    mov edx, 0xBE23A8                               ; => [ Data: data_be23a8 ]
005D34BB    jmp 0x005D34F3
005D34BD    mov ecx, esi
005D34BF    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D34C4    mov edx, 0xBE23B4                               ; => [ Data: data_be23b4 ]
005D34C9    jmp 0x005D34F3
005D34CB    mov ecx, esi
005D34CD    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D34D2    mov edx, 0xBE23C0                               ; => [ Data: data_be23c0 ]
005D34D7    jmp 0x005D34F3
005D34D9    mov ecx, esi
005D34DB    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D34E0    mov edx, 0xBE23D8                               ; => [ Data: data_be23d8 ]
005D34E5    jmp 0x005D34F3
005D34E7    mov ecx, esi
005D34E9    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D34EE    mov edx, 0xBE23CC                               ; => [ Data: data_be23cc ]
005D34F3    movss xmm3, dword ptr ds:[0x00890E18]
005D34FB    mov ecx, eax
005D34FD    push 0x00
005D34FF    push 0xFFFFFFFF
005D3501    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
005D3506    add esp, 0x08
005D3509    call 0x005D20C0
005D350E    cmp eax, 0x08
005D3511    jle 0x005D360B                                  ; => [ Call: sub_5d20c0 ]
005D3517    movzx eax, byte ptr ds:[edi+0x5D3B04]           ; => [ Data: lookup_table_5d3b04 ]
...
005D35DC    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 | Call: sub_64e7a0 ]
...
005D35F9    pop edi
005D35FA    pop esi
005D35FB    ret                                             ; => [ Data: data_be2504 | Call: sub_665db0 | Data: data_be2510 | Call: sub_665db0 | Data: data_be251c | Call: sub_665db0 | Call: sub_665db0 | Data: data_be2528 | Call: sub_665db0 | Data: data_be2534 | Call: sub_665db0 | Data: data_be2540 | Call: sub_665db0 | Data: data_be254c | Data: data_be2558 | Call: sub_665db0 | Data: data_be2564 | Call: sub_665db0 | Data: data_be2570 | Call: sub_665db0 | Data: data_be257c | Call: sub_665db0 | Data: data_be2588 | Call: sub_665db0 | Call: sub_665db0 | Data: data_be2594 | Call: sub_665db0 | Data: data_be25a0 | Call: sub_665db0 | Data: data_be25ac | Data: data_be25b8 | Call: sub_665db0 | Call: sub_665db0 | Data: data_be25c4 | Call: sub_665db0 | Data: data_be25d0 | Data: data_be25dc | Call: sub_665db0 | Data: data_be25e8 | Call: sub_665db0 | Data: data_be25f4 | Call: sub_665db0 | Call: sub_665db0 | Data: data_be2600 | Call: sub_665db0 | Data: data_be260c | Data: data_be2618 | Call: sub_665db0 ]
005D35FC    push 0x86FF24                                   ; => [ String: LayoutUpdate ]
005D3601    push 0x2363
005D3606    jmp 0x005D39B3
005D360B    movzx eax, byte ptr ds:[edi+0x5D3BF4]           ; => [ Data: lookup_table_5d3bf4 ]
005D3612    jmp dword ptr ds:[eax*4+0x5D3B90]
005D3619    mov ecx, esi
005D361B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D363B    pop edi
005D363C    pop esi
005D363D    ret                                             ; => [ Data: data_be23e4 | Call: sub_665db0 ]
005D363E    mov ecx, esi
005D3640    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3660    pop edi
005D3661    pop esi
005D3662    ret                                             ; => [ Call: sub_665db0 | Data: data_be23f0 ]
005D3663    mov ecx, esi
005D3665    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3685    pop edi
005D3686    pop esi
005D3687    ret                                             ; => [ Call: sub_665db0 | Data: data_be23fc ]
005D3688    mov ecx, esi
005D368A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D36AA    pop edi
005D36AB    pop esi
005D36AC    ret                                             ; => [ Data: data_be2408 | Call: sub_665db0 ]
005D36AD    mov ecx, esi
005D36AF    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D36CF    pop edi
005D36D0    pop esi
005D36D1    ret                                             ; => [ Call: sub_665db0 | Data: data_be24d4 ]
005D36D2    mov ecx, esi
005D36D4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D36F4    pop edi
005D36F5    pop esi
005D36F6    ret                                             ; => [ Call: sub_665db0 | Data: data_be2414 ]
005D36F7    mov ecx, esi
005D36F9    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3719    pop edi
005D371A    pop esi
005D371B    ret                                             ; => [ Call: sub_665db0 | Data: data_be2420 ]
005D371C    mov ecx, esi
005D371E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D373E    pop edi
005D373F    pop esi
005D3740    ret                                             ; => [ Call: sub_665db0 | Data: data_be242c ]
005D3741    mov ecx, esi
005D3743    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3763    pop edi
005D3764    pop esi
005D3765    ret                                             ; => [ Call: sub_665db0 | Data: data_be2438 ]
005D3766    mov ecx, esi
005D3768    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3788    pop edi
005D3789    pop esi
005D378A    ret                                             ; => [ Data: data_be2444 | Call: sub_665db0 ]
005D378B    mov ecx, esi
005D378D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D37AD    pop edi
005D37AE    pop esi
005D37AF    ret                                             ; => [ Data: data_be2450 | Call: sub_665db0 ]
005D37B0    mov ecx, esi
005D37B2    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D37D2    pop edi
005D37D3    pop esi
005D37D4    ret                                             ; => [ Call: sub_665db0 | Data: data_be245c ]
005D37D5    mov ecx, esi
005D37D7    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D37F7    pop edi
005D37F8    pop esi
005D37F9    ret                                             ; => [ Call: sub_665db0 | Data: data_be2468 ]
005D37FA    mov ecx, esi
005D37FC    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D381C    pop edi
005D381D    pop esi
005D381E    ret                                             ; => [ Call: sub_665db0 | Data: data_be2474 ]
005D381F    mov ecx, esi
005D3821    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3841    pop edi
005D3842    pop esi
005D3843    ret                                             ; => [ Data: data_be2480 | Call: sub_665db0 ]
005D3844    mov ecx, esi
005D3846    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3866    pop edi
005D3867    pop esi
005D3868    ret                                             ; => [ Data: data_be248c | Call: sub_665db0 ]
005D3869    mov ecx, esi
005D386B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D388B    pop edi
005D388C    pop esi
005D388D    ret                                             ; => [ Data: data_be2498 | Call: sub_665db0 ]
005D388E    mov ecx, esi
005D3890    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D38B0    pop edi
005D38B1    pop esi
005D38B2    ret                                             ; => [ Call: sub_665db0 | Data: data_be24a4 ]
005D38B3    mov ecx, esi
005D38B5    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D38D5    pop edi
005D38D6    pop esi
005D38D7    ret                                             ; => [ Data: data_be24b0 | Call: sub_665db0 ]
005D38D8    mov ecx, esi
005D38DA    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D38FA    pop edi
005D38FB    pop esi
005D38FC    ret                                             ; => [ Call: sub_665db0 | Data: data_be24bc ]
005D38FD    mov ecx, esi
005D38FF    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D391F    pop edi
005D3920    pop esi
005D3921    ret                                             ; => [ Data: data_be24c8 | Call: sub_665db0 ]
005D3922    mov ecx, esi
005D3924    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3944    pop edi
005D3945    pop esi
005D3946    ret                                             ; => [ Call: sub_665db0 | Data: data_be24e0 ]
005D3947    mov ecx, esi
005D3949    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D3969    pop edi
005D396A    pop esi
005D396B    ret                                             ; => [ Call: sub_665db0 | Data: data_be24ec ]
005D396C    mov ecx, esi
005D396E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D398E    pop edi
005D398F    pop esi
005D3990    ret                                             ; => [ Call: sub_665db0 | Data: data_be24f8 ]
005D3991    push 0x86FF24                                   ; => [ String: LayoutUpdate ]
005D3996    push 0x240D
005D399B    jmp 0x005D39B3
005D399D    push 0x86FF24                                   ; => [ String: LayoutUpdate | String: LayoutUpdate ]
005D39A2    push 0x228E
005D39A7    jmp 0x005D39B3
005D39A9    push 0x86FF24                                   ; => [ String: LayoutUpdate ]
005D39AE    push 0x21B1
005D39B3    push 0x86F1E8
005D39B8    mov edx, 0x801800
005D39BD    mov ecx, 0x801AA4
005D39C2    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: LayoutUpdate | String: Halt ]
005D39C7    add esp, 0x0C
005D39CA    call 0x0063BC30
005D39CF    test al, al
005D39D1    jz 0x005D39D4                                   ; => [ Call: sub_63bc30 ]
005D39D3    int3
005D39D4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
