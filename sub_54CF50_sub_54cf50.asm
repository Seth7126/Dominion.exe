...
0054CF69    jnl 0x0054CFF8                                  ; => [ Call: sub_573400 ]
0054CF6F    call 0x0056D1F0                                 ; => [ Call: sub_56d1f0 ]
0054CF74    call 0x00573400
0054CF79    mov eax, dword ptr ds:[eax+0x04]
0054CF7C    mov esi, dword ptr ds:[eax+0x19C4]              ; => [ Call: sub_573400 ]
0054CF82    call 0x00573400
0054CF87    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0054CF8A    cmp esi, dword ptr ds:[eax+0x19CC]
0054CF90    jz 0x0054D056
0054CF96    xor esi, esi
0054CF98    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054CFAF    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0054CFB2    cmp esi, 0x320
0054CFB8    jb 0x0054CFBF
0054CFBA    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0054CFDE    push 0x00
0054CFE0    push 0x1F
0054CFE2    call 0x005911E0                                 ; => [ Call: sub_5911e0 ]
...
0054CFF6    pop ebp
0054CFF7    ret                                             ; => [ Call: sub_56b700 ]
0054CFF8    xor esi, esi
0054CFFA    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054D011    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0054D014    cmp esi, 0x320
0054D01A    jb 0x0054D021
0054D01C    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0054D040    push 0x00
0054D042    push 0x1F
0054D044    call 0x005911E0                                 ; => [ Call: sub_5911e0 ]
0054D049    add esp, 0x24
0054D04C    mov ecx, 0x04
0054D051    call 0x0056B700                                 ; => [ Call: sub_56b700 ]
0054D056    pop edi
0054D057    pop esi
0054D058    pop ebx
