...
0053F890    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053F891    sub esp, 0xC4
0053F897    mov eax, dword ptr ds:[0x008C4040]
0053F89C    xor eax, ebp
0053F89E    mov dword ptr ss:[ebp-0x10], eax
0053F8A1    push eax                                        ; => [ Data: __security_cookie ]
0053F8A2    lea eax, ss:[ebp-0x0C]
0053F8A5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053F8AB    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
0053F8B0    xorps xmm0, xmm0
0053F8B3    mov dword ptr ss:[ebp-0x94], 0x00
0053F8BD    movlpd qword ptr ss:[ebp-0x9C], xmm0
0053F8C5    movlpd qword ptr ss:[ebp-0x8C], xmm0            ; => [ Call: __builtin_memset ]
...
0053F902    mov dword ptr ss:[ebp-0x4C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_baf9a9e21d017a3638a08cc0709280f9>, void>::VTable ]
0053F905    lea eax, ss:[ebp-0x40]
0053F908    movups xmm0, xmmword ptr ss:[ebp-0x90]
0053F90F    mov dword ptr ss:[ebp-0x70], 0x81AD4C           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_baf9a9e21d017a3638a08cc0709280f9>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
0053F92F    mov dword ptr ss:[ebp-0x40], 0x81AD30           ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_45b0a4e3a4b2f43964e6574c97cb359c>, void>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_45b0a4e3a4b2f43964e6574c97cb359c>, void>::`vftable'{for `std::_Func_base<void>'} ]
0053F936    mov dword ptr ss:[ebp-0x1C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_45b0a4e3a4b2f43964e6574c97cb359c>, void>::VTable ]
...
0053F96D    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
0053F986    push 0x30
0053F988    push eax
0053F989    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
0053F98E    mov ecx, dword ptr ss:[ebp-0x0C]
0053F991    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053F998    pop ecx
0053F999    mov ecx, dword ptr ss:[ebp-0x10]
0053F99C    xor ecx, ebp
0053F99E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
