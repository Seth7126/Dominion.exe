...
004E6CF5    push 0x764726                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?message@_System_error_category@std@@UBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z ]
004E6CFA    mov eax, dword ptr fs:[0x00000000]
004E6D00    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E6D01    sub esp, 0x0C
004E6D04    push esi
004E6D05    push edi
004E6D06    mov eax, dword ptr ds:[0x008C4040]
004E6D0B    xor eax, ebp
004E6D0D    push eax                                        ; => [ Data: __security_cookie ]
004E6D0E    lea eax, ss:[ebp-0x0C]
004E6D11    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E6D35    mov eax, dword ptr ds:[eax+esi*4]               ; => [ Data: data_1597ddc | Data: data_1597de0 ]
...
004E6D4F    mov eax, 0x816630                               ; => [ String: none | String: none ]
004E6D54    push eax
004E6D55    lea eax, ss:[ebp-0x10]
004E6D58    push 0x8084E8
004E6D5D    push eax
004E6D5E    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: dom_category_%s ]
004E6D63    add esp, 0x0C
004E6D66    mov dword ptr ss:[ebp-0x04], 0x01
004E6D6D    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
004E6D89    push eax
004E6D8A    call 0x004E6BA0                                 ; => [ Call: sub_4e6ba0 ]
...
004E6DA7    jz 0x004E6DD0                                   ; => [ Data: data_cf65bc ]
...
004E6DB8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E6DCB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E6DD0    mov eax, edi
004E6DD2    mov ecx, dword ptr ss:[ebp-0x0C]
004E6DD5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E6DDC    pop ecx
004E6DDD    pop edi
004E6DDE    pop esi
