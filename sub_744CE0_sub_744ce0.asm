...
00744CEB    call 0x006EE530                                 ; => [ Call: sub_6ee530 ]
00744CF0    mov edi, dword ptr ds:[0x01593C64]              ; => [ Data: data_1593c64 ]
00744CF6    cmp edi, 0x80
00744CFC    jnz 0x00744D68
00744CFE    mov esi, dword ptr ds:[0x01514470]              ; => [ Data: data_1514470 ]
...
00744D46    call 0x00762362                                 ; => [ Call: memmove ]
00744D4B    mov edi, dword ptr ds:[0x01593C64]
00744D51    add esp, 0x0C
00744D54    mov eax, dword ptr ds:[0x01593C68]
00744D59    dec edi                                         ; => [ Data: data_1593c64 ]
00744D5A    dec eax                                         ; => [ Data: data_1593c68 ]
00744D5B    mov dword ptr ds:[0x01593C64], edi              ; => [ Data: data_1593c64 ]
00744D61    mov dword ptr ds:[0x01593C68], eax              ; => [ Data: data_1593c68 ]
00744D66    jmp 0x00744D6D
00744D68    mov eax, dword ptr ds:[0x01593C68]              ; => [ Data: data_1593c68 ]
00744D6D    cmp edi, eax
00744D6F    jnl 0x00744DD4
00744D71    imul ebx, edi, 0x1010
00744D77    add ebx, 0x1514470                              ; => [ Data: data_1514470 ]
...
00744DCC    jl 0x00744D80                                   ; => [ Data: data_1593c68 ]
00744DCE    mov edi, dword ptr ds:[0x01593C64]              ; => [ Data: data_1593c64 ]
...
00744DED    call 0x00761FBE                                 ; => [ Data: data_1512458 | Call: memcpy ]
00744DF2    mov eax, dword ptr ds:[0x01512450]
00744DF7    add esp, 0x0C
00744DFA    mov ebx, dword ptr ds:[0x017774DC]              ; => [ Data: data_17774dc ]
00744E00    mov ecx, 0x10
00744E05    mov esi, dword ptr ds:[eax]                     ; => [ Data: data_1512450 ]
00744E07    call 0x00687730                                 ; => [ Call: sub_687730 ]
00744E0C    mov edi, eax
00744E0E    xorps xmm0, xmm0
00744E11    mov edx, ebx
00744E13    movups xmmword ptr ds:[edi], xmm0               ; => [ String: 0 | String: zx ]
00744E16    mov ecx, dword ptr ds:[esi]
00744E18    call 0x0069D4C0
00744E1D    mov dword ptr ds:[edi], eax                     ; => [ Call: sub_69d4c0 ]
...
00744E33    push 0x88FCE8                                   ; => [ String: CreateUndoCheckpoint ]
00744E38    push 0xF2
00744E3D    mov ecx, 0x88FCA8                               ; => [ String: gUI.undoStack[i].def->pParseTree == NULL ]
00744E42    jmp 0x00744E6A
00744E44    mov eax, dword ptr ds:[0x01593C64]
00744E49    pop edi
00744E4A    inc eax                                         ; => [ Data: data_1593c64 ]
00744E4B    pop esi
00744E4C    mov dword ptr ds:[0x01593C64], eax              ; => [ Data: data_1593c64 ]
00744E51    mov dword ptr ds:[0x01593C68], eax              ; => [ Data: data_1593c68 ]
00744E56    pop ebx
00744E57    mov esp, ebp
00744E59    pop ebp
00744E5A    ret
00744E5B    push 0x88FC98                                   ; => [ String: SaveUndoState ]
00744E60    push 0xD8
00744E65    mov ecx, 0x8756A8                               ; => [ String: s.def->pParseTree == NULL ]
00744E6A    push 0x88FC60
00744E6F    mov edx, 0x801800
00744E74    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Editor\UIEditor.cpp ]
00744E79    add esp, 0x0C
00744E7C    call 0x0063BC30
00744E81    test al, al
00744E83    jz 0x00744E86                                   ; => [ Call: sub_63bc30 ]
00744E85    int3
00744E86    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
