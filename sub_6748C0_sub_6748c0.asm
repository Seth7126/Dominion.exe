...
006748C8    call 0x00761E50                                 ; => [ Call: __chkstk ]
006748CD    mov eax, dword ptr ds:[0x008C4040]
006748D2    xor eax, ebp
006748D4    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: __security_cookie ]
006748D7    push ebx
006748D8    push esi
006748D9    push edi
...
0067490C    call 0x006674E0                                 ; => [ Call: sub_6674e0 | Data: data_c28c58 | Data: data_c27c24 | Data: data_c27c58 ]
...
00674939    push eax
0067493A    call 0x004D4E30                                 ; => [ Call: sub_4d4e30 | Call: sub_667620 ]
0067493F    mov edi, dword ptr ds:[0x00C27C20]              ; => [ Data: data_c27c20 ]
00674945    add esp, 0x08
00674948    mov dword ptr ss:[ebp-0x1090], edi
0067494E    test edi, edi
00674950    jnz 0x0067496B
00674952    push 0x874440                                   ; => [ String: UI2DefGet ]
00674957    push 0xC16
0067495C    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
00674961    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
00674966    jmp 0x00674FAE
0067496B    cmp dword ptr ds:[edi+0x04], 0x22
0067496F    jz 0x00674985
00674971    push 0x874440                                   ; => [ String: UI2DefGet ]
00674976    push 0xC17
0067497B    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
00674980    jmp 0x00674FA9
00674985    mov ecx, edi
00674987    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0067499A    push 0x876590                                   ; => [ String: UI2Move ]
0067499F    push 0x4DA4
006749A4    mov ecx, 0x87657C                               ; => [ String: itemInsert == NULL ]
...
006749ED    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 | Data: data_c27c24 ]
...
00674A28    movss xmm0, dword ptr ds:[eax+0x2C]             ; => [ Data: data_147abe8 ]
...
00674A57    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00674A76    call 0x0064C550                                 ; => [ Call: sub_64c550 ]
...
00674AAC    divss xmm0, dword ptr ds:[0x00C27C48]           ; => [ Data: data_c27c48 ]
...
00674BF7    call 0x00667AE0                                 ; => [ Call: sub_667ae0 ]
...
00674C12    call 0x00667A60                                 ; => [ Call: sub_667a60 ]
00674C17    add esp, 0x04
00674C1A    mov ecx, ebx
00674C1C    call 0x0064CC90                                 ; => [ Call: sub_64cc90 ]
00674C21    push 0x69
00674C23    push dword ptr ds:[0x01724A80]                  ; => [ Data: data_1724a80 ]
00674C29    mov ecx, ebx
00674C2B    mov dword ptr ss:[ebp-0x1050], eax
00674C31    call 0x0064CC90                                 ; => [ Call: sub_64cc90 ]
00674C36    mov edx, eax
00674C38    mov ecx, 0x8CAE70
00674C3D    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Data: data_8cae70 ]
...
00674C99    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Data: data_8cae70 | Data: data_1777578 ]
...
00674D96    call 0x00667A60                                 ; => [ Call: sub_667a60 ]
...
00674DFC    test al, al
00674DFE    jz 0x00674F36                                   ; => [ Call: sub_674500 ]
...
00674E26    xor ecx, ecx                                    ; => [ Call: nullptr ]
00674E28    test ecx, ecx
00674E2A    jnz 0x00674E34
00674E2C    mov ecx, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
00674E32    jmp 0x00674E3A
00674E34    add ecx, 0x18D0
00674E3A    imul eax, dword ptr ds:[0x00C23BAC], 0x18D0
00674E44    add eax, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 | Data: data_c23bac ]
...
00674E6E    jle 0x00674F19                                  ; => [ Data: data_c28c58 ]
00674E74    mov ecx, dword ptr ds:[edx*4+0xC27C58]          ; => [ Data: data_c27c58 ]
...
00674F05    mov dword ptr ds:[edx*4+0xC27C58], eax          ; => [ Data: data_c27c58 | Data: data_c27c58 ]
00674F0C    inc edx
00674F0D    cmp edx, dword ptr ds:[0x00C28C58]
00674F13    jl 0x00674E74                                   ; => [ Data: data_c28c58 ]
...
00674F54    call 0x0064E810                                 ; => [ Data: data_c27c24 | Call: sub_64e810 ]
00674F59    mov ecx, dword ptr ss:[ebp-0x08]
00674F5C    pop edi
00674F5D    pop esi
00674F5E    xor ecx, ebp
00674F60    pop ebx
00674F61    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00674F83    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | String: AssignPropertyRect | Data: data_801800 | String: &attribMap ]
00674F88    add esp, 0x0C
00674F8B    call 0x0063BC30
00674F90    test al, al
00674F92    jz 0x00674F95                                   ; => [ Call: sub_63bc30 ]
00674F94    int3
00674F95    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00674F9A    push 0x876590                                   ; => [ String: UI2Move ]
00674F9F    push 0x4DA8
00674FA4    mov ecx, 0x8765A8                               ; => [ String: itemInsert->sourceAsset == sourceAsset ]
00674FA9    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00674FAE    push 0x8739B4
00674FB3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp ]
00674FB8    add esp, 0x0C
00674FBB    call 0x0063BC30
00674FC0    test al, al
00674FC2    jz 0x00674FC5                                   ; => [ Call: sub_63bc30 ]
00674FC4    int3
00674FC5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
