...
0068329C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006832C0    jle 0x0068332B                                  ; => [ Type: TEB | Field: ThreadLocalStoragePointer | Data: data_1a99fd0 ]
006832C2    push 0x1A99FD0
006832C7    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a99fd0 ]
006832CC    add esp, 0x04
006832CF    cmp dword ptr ds:[0x01A99FD0], 0xFFFFFFFF
006832D6    jnz 0x0068332B                                  ; => [ Data: data_1a99fd0 ]
...
0068331C    movups xmmword ptr ds:[0x01A99FD4], xmm0        ; => [ Call: sub_4ac840 | Data: data_7fef14 | Data: data_1a99fd4 | Data: data_7fef74 ]
00683323    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a99fd0 ]
00683328    add esp, 0x04
0068332B    movss xmm2, dword ptr ds:[esi+0x04]
00683330    mulss xmm2, dword ptr ds:[0x00890D84]
00683338    mov eax, dword ptr ds:[0x00CF6664]              ; => [ Data: data_cf6664 ]
0068333D    movss xmm3, dword ptr ds:[0x00CF65C0]
00683345    movups xmm6, xmmword ptr ds:[0x00CF664C]        ; => [ Data: data_cf664c ]
0068334C    mov dword ptr ss:[esp+0x78], eax
00683350    divss xmm3, xmm2                                ; => [ Data: data_cf65c0 ]
00683354    movq xmm0, qword ptr ds:[0x00CF665C]            ; => [ Data: data_cf665c ]
...
0068336D    mulss xmm1, dword ptr ds:[0x00890D84]           ; => [ Data: data_8937c0 ]
...
0068341D    mulss xmm2, dword ptr ss:[esp+0x50]             ; => [ Data: data_cf664c ]
...
00683500    movss xmm2, dword ptr ds:[0x01A99FDC]           ; => [ Data: data_1a99fdc ]
00683508    mulss xmm3, xmm0
0068350C    movaps xmm0, xmm5
0068350F    movss xmm5, dword ptr ds:[0x01A99FD4]           ; => [ Data: data_1a99fd4 ]
...
00683554    movss xmm4, dword ptr ds:[0x01A99FE0]           ; => [ Data: data_1a99fe0 ]
...
0068357C    movss xmm3, dword ptr ds:[0x01A99FD8]           ; => [ Data: data_1a99fd8 ]
...
0068359F    mulss xmm0, xmm4                                ; => [ Data: data_cf664c ]
006835A3    movss dword ptr ss:[esp+0x3C], xmm1             ; => [ Data: data_cf664c ]
...
00683614    movss dword ptr ss:[esp+0x34], xmm1             ; => [ Data: data_cf664c ]
...
0068363B    movss dword ptr ss:[esp+0x38], xmm0             ; => [ Data: data_cf664c ]
...
0068368F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
