...
00541E0B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00541E10    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00541E15    xor eax, esp
00541E17    mov dword ptr ss:[esp+0x1984], eax
00541E1E    push esi
00541E1F    push edi
00541E20    call 0x00573400
00541E25    mov esi, dword ptr ds:[eax+0x0C]                ; => [ Call: sub_573400 ]
00541E28    call 0x00573400
00541E2D    xor ecx, ecx
00541E2F    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
...
00541E65    call 0x0056E060                                 ; => [ Call: sub_56e060 ]
00541E6A    xor esi, esi                                    ; => [ Call: nullptr ]
00541E6C    mov dword ptr ss:[esp+0xCF8], esi               ; => [ Call: nullptr ]
00541E73    lea edi, ds:[esi+0x03]
00541E76    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00541EF2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00541EF4    jz 0x00541FE7
00541EFA    mov esi, dword ptr ss:[esp+0x1980]
00541F01    xorps xmm0, xmm0
00541F04    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
00541FA3    call 0x00589E00                                 ; => [ Call: sub_589e00 ]
00541FA8    add esp, 0x10
00541FAB    xor eax, eax                                    ; => [ Call: nullptr ]
...
00541FF2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
