...
006C5525    push 0x7703A8                                   ; => [ Call: sub_7703a8 | Type: EHRegistrationNode ]
006C552A    mov eax, dword ptr fs:[0x00000000]
006C5530    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C5542    push esi
006C5543    push edi
006C5544    push eax                                        ; => [ Data: __security_cookie ]
006C5545    lea eax, ss:[ebp-0x0C]
006C5548    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C555D    mov dword ptr ss:[ebp-0x160], 0x87E168          ; => [ String: .hlslinc ]
006C5567    mov dword ptr ss:[ebp-0x164], edx
006C556D    nop dword ptr ds:[eax], eax
006C5570    mov dword ptr ss:[ebp-0x15C], 0x801800          ; => [ Data: data_801800 ]
006C557A    mov byte ptr ss:[ebp-0x04], 0x01
006C557E    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006C560A    jz 0x006C55D0                                   ; => [ Type: HANDLE ]
...
006C5629    jz 0x006C5649                                   ; => [ Data: data_cf65bc ]
006C562B    lea ecx, ss:[ebp-0x15C]
006C5631    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5644    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C566F    jz 0x006C5698                                   ; => [ Data: data_cf65bc ]
...
006C5680    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5693    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5698    mov al, bl
006C569A    mov ecx, dword ptr ss:[ebp-0x0C]
006C569D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C56A4    pop ecx
006C56A5    pop edi
006C56A6    pop esi
006C56A7    pop ebx
...
006C56AD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006C56CA    jz 0x006C56EA                                   ; => [ Data: data_cf65bc ]
006C56CC    lea ecx, ss:[ebp-0x15C]
006C56D2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C56E5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C56EA    mov bl, 0x01
006C56EC    jmp 0x006C5661
