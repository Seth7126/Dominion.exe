...
0069FEB5    push 0x7636A6                                   ; => [ Call: __ehhandler$?AddVirtualProcessorRoots@SchedulerProxy@details@Concurrency@@QAEXPAPAUIVirtualProcessorRoot@3@I@Z | Type: EHRegistrationNode ]
0069FEBA    mov eax, dword ptr fs:[0x00000000]
0069FEC0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0069FEC1    sub esp, 0x10
0069FEC4    push esi
0069FEC5    push edi
0069FEC6    mov eax, dword ptr ds:[0x008C4040]
0069FECB    xor eax, ebp
0069FECD    push eax                                        ; => [ Data: __security_cookie ]
0069FECE    lea eax, ss:[ebp-0x0C]
0069FED1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0069FEE7    call 0x0069FCE0                                 ; => [ Call: sub_69fce0 ]
0069FEEC    test al, al
...
0069FF00    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
0069FF05    mov eax, edi
0069FF07    mov ecx, dword ptr ss:[ebp-0x0C]
0069FF0A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069FF11    pop ecx
0069FF12    pop edi
0069FF13    pop esi
...
0069FF2C    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0069FF33    sub eax, esi
0069FF35    mov dword ptr ss:[ebp-0x04], 0x01
0069FF3C    push eax
0069FF3D    push esi
0069FF3E    lea ecx, ss:[ebp-0x10]
0069FF41    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
0069FF56    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069FF7C    jz 0x0069FF99                                   ; => [ Data: data_cf65bc ]
0069FF7E    lea ecx, ss:[ebp-0x10]
0069FF81    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069FF94    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069FF99    mov eax, edi
0069FF9B    mov ecx, dword ptr ss:[ebp-0x0C]
0069FF9E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069FFA5    pop ecx
0069FFA6    pop edi
0069FFA7    pop esi
...
0069FFC5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\AssetCatalog.cpp | String: AssetNameFromPath | String: AssetPathIsValid(assetPath) | Data: data_801800 ]
0069FFCA    add esp, 0x0C
0069FFCD    call 0x0063BC30
0069FFD2    test al, al
0069FFD4    jz 0x0069FFD7                                   ; => [ Call: sub_63bc30 ]
0069FFD6    int3
0069FFD7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0069FFDC    push 0x879C34
0069FFE1    push 0x27C
0069FFE6    push 0x87982C
0069FFEB    mov edx, 0x801800
0069FFF0    mov ecx, 0x879C30
0069FFF5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\AssetCatalog.cpp | String: AssetNameFromPath | Data: data_801800 | String: ext ]
0069FFFA    add esp, 0x0C
0069FFFD    call 0x0063BC30
006A0002    test al, al
006A0004    jz 0x006A0007                                   ; => [ Call: sub_63bc30 ]
006A0006    int3
006A0007    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
