...
0053FFF7    movzx esi, si                                   ; => [ Call: sub_56b800 ]
0053FFFA    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0053FFFD    cmp esi, 0x320
00540003    jb 0x0054000A
00540005    call 0x00591930                                 ; => [ Call: sub_591930 ]
