...
0055F665    mov dword ptr fs:[0x00000000], eax
0055F66B    call 0x00573400
0055F670    push 0x401
0055F675    mov ecx, dword ptr ds:[eax+0x04]
0055F678    mov edx, dword ptr ds:[eax+0x0C]
0055F67B    call 0x00583FC0
...
0055F699    movlpd qword ptr ss:[ebp-0x2C], xmm0
...
0055F6B6    movups xmmword ptr ss:[ebp-0xA0], xmm0
0055F6BD    mov dword ptr ss:[ebp-0x4C], eax
0055F6C0    lea eax, ss:[ebp-0x40]
0055F6C3    movups xmm0, xmmword ptr ss:[ebp-0x30]
0055F6C7    mov dword ptr ss:[ebp-0x70], 0x80CC34
0055F6CE    mov dword ptr ss:[ebp-0x6C], 0x55F320
...
0055F6E7    mov dword ptr ss:[ebp-0x44], 0x00
0055F6EE    mov dword ptr ss:[ebp-0x40], 0x81E848
