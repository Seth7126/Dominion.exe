...
005FAD04    push 0x8614DC                                   ; => [ String: IsKingdomModifierActive ]
...
005FAD89    pop ebp
005FAD8A    ret
005FAD8B    push 0x8614DC                                   ; => [ String: IsKingdomModifierActive ]
005FAD90    push 0x89DC
005FAD95    push 0x86F1E8
005FAD9A    mov edx, 0x801800
005FAD9F    mov ecx, 0x801AA4
005FADA4    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: IsKingdomModifierActive | String: Halt ]
005FADA9    add esp, 0x0C
005FADAC    call 0x0063BC30
005FADB1    test al, al
005FADB3    jz 0x005FADB6                                   ; => [ Call: sub_63bc30 ]
005FADB5    int3
005FADB6    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
