...
00631F39    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00631F4F    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
00631F94    push 0x00
00631F96    push eax
00631F97    call 0x00761FC4                                 ; => [ Call: memset ]
...
00631FE8    push eax
00631FE9    call 0x00761FC4                                 ; => [ Call: memset ]
...
0063205A    movups xmmword ptr ss:[ebp-0x5C], xmm0          ; => [ String: 0 | String: zx ]
...
00632087    call 0x005CB630                                 ; => [ Call: sub_5cb630 ]
...
00632095    pop ebx
00632096    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006320B8    call 0x0063B870                                 ; => [ String: DomGfxCreate_Hint | Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: Halt ]
006320BD    add esp, 0x0C
006320C0    call 0x0063BC30
006320C5    test al, al
006320C7    jz 0x006320CA                                   ; => [ Call: sub_63bc30 ]
006320C9    int3
006320CA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
