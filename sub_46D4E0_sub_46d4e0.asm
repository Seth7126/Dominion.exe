...
0046D4EA    call 0x004ACB80
0046D4EF    push 0x90
0046D4F4    push 0x00
0046D4F6    push 0xB5BEF4
0046D4FB    mov dword ptr ds:[0x00B5BEEC], 0x02
0046D505    mov dword ptr ds:[0x00B5BEF0], 0x00
0046D50F    call 0x00761FC4
0046D514    add esp, 0x0C
0046D517    mov dword ptr ds:[0x00B5BF84], 0x801A9C
0046D521    mov ecx, 0xB5BF84
0046D526    push 0x8278D0
0046D52B    call 0x004ACB80
0046D530    movaps xmm0, xmmword ptr ds:[0x00892BC0]
0046D537    push 0x88
0046D53C    push 0x00
0046D53E    push 0xB5BFA0
0046D543    movups xmmword ptr ds:[0x00B5BF90], xmm0
0046D54A    call 0x00761FC4
0046D54F    add esp, 0x0C
0046D552    mov dword ptr ds:[0x00B5C028], 0x801A9C
0046D55C    mov ecx, 0xB5C028
0046D561    push 0x8278E4
0046D566    call 0x004ACB80
0046D56B    movaps xmm0, xmmword ptr ds:[0x00892BD0]
0046D572    push 0x88
0046D577    push 0x00
0046D579    push 0xB5C044
0046D57E    movups xmmword ptr ds:[0x00B5C034], xmm0
0046D585    call 0x00761FC4
0046D58A    add esp, 0x0C
0046D58D    mov dword ptr ds:[0x00B5C0CC], 0x801A9C
0046D597    mov ecx, 0xB5C0CC
0046D59C    push 0x8278F8
0046D5A1    call 0x004ACB80
0046D5A6    movaps xmm0, xmmword ptr ds:[0x00892BB0]
0046D5AD    push 0x7C
0046D5AF    push 0x00
0046D5B1    push 0xB5C0F0
0046D5B6    movups xmmword ptr ds:[0x00B5C0D8], xmm0
0046D5BD    mov dword ptr ds:[0x00B5C0E8], 0x02
0046D5C7    mov dword ptr ds:[0x00B5C0EC], 0xF19
0046D5D1    call 0x00761FC4
0046D5D6    add esp, 0x0C
0046D5D9    mov dword ptr ds:[0x00B5C16C], 0x00
0046D5E3    mov ecx, 0xB5C170
0046D5E8    mov dword ptr ds:[0x00B5C170], 0x801A9C
0046D5F2    push 0x82790C
0046D5F7    call 0x004ACB80
0046D5FC    movaps xmm0, xmmword ptr ds:[0x008919D0]
0046D603    push 0x7C
0046D605    push 0x00
0046D607    push 0xB5C194
0046D60C    movups xmmword ptr ds:[0x00B5C17C], xmm0
0046D613    mov dword ptr ds:[0x00B5C18C], 0x02
0046D61D    mov dword ptr ds:[0x00B5C190], 0x101
0046D627    call 0x00761FC4
0046D62C    add esp, 0x0C
0046D62F    mov dword ptr ds:[0x00B5C210], 0x00
0046D639    mov ecx, 0xB5C214
0046D63E    mov dword ptr ds:[0x00B5C214], 0x801A9C
0046D648    push 0x827920
0046D64D    call 0x004ACB80
0046D652    push 0x90
0046D657    push 0x00
0046D659    push 0xB5C228
0046D65E    mov dword ptr ds:[0x00B5C220], 0x02
0046D668    mov dword ptr ds:[0x00B5C224], 0x00
0046D672    call 0x00761FC4
0046D677    add esp, 0x0C
0046D67A    mov dword ptr ds:[0x00B5C2B8], 0x801A9C
0046D684    mov ecx, 0xB5C2B8
0046D689    push 0x827934
0046D68E    call 0x004ACB80
0046D693    movaps xmm0, xmmword ptr ds:[0x008920F0]
0046D69A    push 0x88
0046D69F    push 0x00
0046D6A1    push 0xB5C2D4
0046D6A6    movups xmmword ptr ds:[0x00B5C2C4], xmm0
0046D6AD    call 0x00761FC4
0046D6B2    add esp, 0x0C
0046D6B5    mov dword ptr ds:[0x00B5C35C], 0x801A9C
0046D6BF    mov ecx, 0xB5C35C
0046D6C4    push 0x827948
0046D6C9    call 0x004ACB80
0046D6CE    movups xmm0, xmmword ptr ds:[0x00891170]
0046D6D5    push 0x7C
0046D6D7    push 0x00
0046D6D9    push 0xB5C380
0046D6DE    movups xmmword ptr ds:[0x00B5C368], xmm0
0046D6E5    mov dword ptr ds:[0x00B5C378], 0x0B
0046D6EF    mov dword ptr ds:[0x00B5C37C], 0x101
0046D6F9    call 0x00761FC4
0046D6FE    add esp, 0x0C
0046D701    mov dword ptr ds:[0x00B5C3FC], 0x00
0046D70B    mov ecx, 0xB5C400
0046D710    mov dword ptr ds:[0x00B5C400], 0x801A9C
0046D71A    push 0x82795C
0046D71F    call 0x004ACB80
0046D724    movups xmm0, xmmword ptr ds:[0x00891170]
0046D72B    push 0x7C
0046D72D    push 0x00
0046D72F    push 0xB5C424
0046D734    movups xmmword ptr ds:[0x00B5C40C], xmm0
0046D73B    mov dword ptr ds:[0x00B5C41C], 0x0B
0046D745    mov dword ptr ds:[0x00B5C420], 0x101
0046D74F    call 0x00761FC4
0046D754    add esp, 0x0C
0046D757    mov dword ptr ds:[0x00B5C4A0], 0x00
0046D761    mov ecx, 0xB5C4A4
0046D766    mov dword ptr ds:[0x00B5C4A4], 0x801A9C
0046D770    push 0x827970
0046D775    call 0x004ACB80
0046D77A    push 0x90
0046D77F    push 0x00
0046D781    push 0xB5C4B8
0046D786    mov dword ptr ds:[0x00B5C4B0], 0x14
0046D790    mov dword ptr ds:[0x00B5C4B4], 0x1A
0046D79A    call 0x00761FC4
0046D79F    add esp, 0x0C
0046D7A2    mov dword ptr ds:[0x00B5C548], 0x801A9C
0046D7AC    mov ecx, 0xB5C548
0046D7B1    push 0x827984
0046D7B6    call 0x004ACB80
0046D7BB    movaps xmm0, xmmword ptr ds:[0x00892C30]
0046D7C2    push 0x78
0046D7C4    push 0x00
0046D7C6    push 0xB5C570
0046D7CB    movups xmmword ptr ds:[0x00B5C554], xmm0
...
0046DB70    call 0x00761FC4
0046DB75    add esp, 0x0C
0046DB78    mov dword ptr ds:[0x00B5CCF4], 0x00
0046DB82    mov ecx, 0xB5CCF8
0046DB87    mov dword ptr ds:[0x00B5CCF8], 0x801A9C
0046DB91    push 0x827A74
0046DB96    call 0x004ACB80
0046DB9B    movaps xmm0, xmmword ptr ds:[0x00892BF0]
0046DBA2    push 0x70
0046DBA4    movups xmmword ptr ds:[0x00B5CD04], xmm0
0046DBAB    push 0x00
...
0046DBCA    call 0x00761FC4
0046DBCF    add esp, 0x0C
0046DBD2    mov dword ptr ds:[0x00B5CD98], 0x00
0046DBDC    mov ecx, 0xB5CD9C
0046DBE1    mov dword ptr ds:[0x00B5CD9C], 0x801A9C
0046DBEB    push 0x827A88
0046DBF0    call 0x004ACB80
0046DBF5    movaps xmm0, xmmword ptr ds:[0x00892C00]
0046DBFC    push 0x7C
0046DBFE    push 0x00
0046DC00    push 0xB5CDC0
0046DC05    movups xmmword ptr ds:[0x00B5CDA8], xmm0
0046DC0C    mov dword ptr ds:[0x00B5CDB8], 0x02
0046DC16    mov dword ptr ds:[0x00B5CDBC], 0x200
0046DC20    call 0x00761FC4
0046DC25    add esp, 0x0C
0046DC28    mov dword ptr ds:[0x00B5CE3C], 0x00
0046DC32    mov ecx, 0xB5CE40
0046DC37    mov dword ptr ds:[0x00B5CE40], 0x801A9C
0046DC41    push 0x827A9C
0046DC46    call 0x004ACB80
0046DC4B    movups xmm0, xmmword ptr ds:[0x00891170]
0046DC52    push 0x7C
0046DC54    mov dword ptr ds:[0x00B5CE5C], 0x02
0046DC5E    movups xmmword ptr ds:[0x00B5CE4C], xmm0
0046DC65    mov dword ptr ds:[0x00B5CE60], 0x200
0046DC6F    push 0x00
0046DC71    push 0xB5CE64
0046DC76    call 0x00761FC4
0046DC7B    add esp, 0x0C
0046DC7E    mov dword ptr ds:[0x00B5CEE0], 0x00
0046DC88    mov ecx, 0xB5CEE4
0046DC8D    mov dword ptr ds:[0x00B5CEE4], 0x801A9C
0046DC97    push 0x827AB0
0046DC9C    call 0x004ACB80
0046DCA1    movaps xmm0, xmmword ptr ds:[0x00892BE0]
0046DCA8    push 0x7C
0046DCAA    push 0x00
0046DCAC    push 0xB5CF08
0046DCB1    movups xmmword ptr ds:[0x00B5CEF0], xmm0
0046DCB8    mov dword ptr ds:[0x00B5CF00], 0x03
0046DCC2    mov dword ptr ds:[0x00B5CF04], 0xF1D
0046DCCC    call 0x00761FC4
0046DCD1    add esp, 0x0C
0046DCD4    mov dword ptr ds:[0x00B5CF84], 0x00
0046DCDE    mov ecx, 0xB5CF88
0046DCE3    mov dword ptr ds:[0x00B5CF88], 0x801A9C
0046DCED    push 0x827AC4
0046DCF2    call 0x004ACB80
0046DCF7    movaps xmm0, xmmword ptr ds:[0x00891B00]
0046DCFE    push 0x88
0046DD03    push 0x00
0046DD05    push 0xB5CFA4
0046DD0A    movups xmmword ptr ds:[0x00B5CF94], xmm0
0046DD11    call 0x00761FC4
0046DD16    add esp, 0x0C
0046DD19    mov dword ptr ds:[0x00B5D02C], 0x801A9C
0046DD23    mov ecx, 0xB5D02C
0046DD28    push 0x827AD8
0046DD2D    call 0x004ACB80
0046DD32    movaps xmm0, xmmword ptr ds:[0x00891B00]
0046DD39    push 0x88
0046DD3E    push 0x00
0046DD40    push 0xB5D048
0046DD45    movups xmmword ptr ds:[0x00B5D038], xmm0
0046DD4C    call 0x00761FC4
0046DD51    add esp, 0x0C
0046DD54    mov dword ptr ds:[0x00B5D0D0], 0x801A9C
0046DD5E    mov ecx, 0xB5D0D0
0046DD63    push 0x827AEC
0046DD68    call 0x004ACB80
0046DD6D    push 0x8C
0046DD72    push 0x00
0046DD74    push 0xB5D0E8
0046DD79    mov dword ptr ds:[0x00B5D0DC], 0x02
0046DD83    mov dword ptr ds:[0x00B5D0E0], 0x00
0046DD8D    mov dword ptr ds:[0x00B5D0E4], 0x08
