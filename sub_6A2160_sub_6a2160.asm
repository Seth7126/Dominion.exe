...
006A217C    xor eax, ebp
006A217E    push eax
006A217F    lea eax, ss:[ebp-0x0C]
006A2182    mov dword ptr fs:[0x00000000], eax
...
006A219C    jnz 0x006A21B7
006A219E    push 0x87A384
006A21A3    push 0x179
006A21A8    push 0x87A2E0
006A21AD    mov ecx, 0x879BCC
...
006A21C7    mov dword ptr ss:[ebp-0x44], eax
...
006A22E4    call 0x0063D8D0
006A22E9    mov ecx, edi
006A22EB    call 0x006A1680
...
006A2303    call 0x0063D8D0
006A2308    mov ecx, edi
006A230A    call 0x006A1680
...
006A2345    push ebx
006A2346    push esi
006A2347    push 0x87A3B8
006A234C    call 0x0063B5F0
...
006A23E5    jz 0x006A2405
006A23E7    lea ecx, ss:[ebp-0x1C]
006A23EA    call 0x0063D4E0
...
006A2549    push esi
006A254A    push 0x87A438
006A254F    call 0x0063B5F0
...
006A2567    jz 0x006A2584
006A2569    lea ecx, ss:[ebp-0x14]
006A256C    call 0x0063D4E0
...
006A25F6    call 0x0069CEE0
006A25FB    mov dword ptr ds:[edi], 0x00
006A2601    mov ecx, dword ptr ds:[edi+0x04]
006A2604    test ecx, ecx
006A2606    jz 0x006A2614
006A2608    call 0x006A3220
...
006A2621    push 0x87A420
006A2626    call 0x0063B5F0
...
006A263E    jz 0x006A265B
006A2640    lea ecx, ss:[ebp-0x14]
006A2643    call 0x0063D4E0
...
006A2672    call 0x0069CEE0
006A2677    mov dword ptr ds:[edi], 0x00
006A267D    mov ecx, dword ptr ds:[edi+0x04]
006A2680    test ecx, ecx
006A2682    jz 0x006A2690
006A2684    call 0x006A3220
...
006A269D    push 0x87A3DC
006A26A2    call 0x0063B5F0
...
006A26BE    jz 0x006A26DB
006A26C0    lea ecx, ss:[ebp-0x14]
006A26C3    call 0x0063D4E0
...
006A272F    jz 0x006A274C
006A2731    lea ecx, ss:[ebp-0x14]
006A2734    call 0x0063D4E0
...
006A277E    call 0x0064C080
006A2783    xor al, al
006A2785    mov ecx, dword ptr ss:[ebp-0x0C]
006A2788    mov dword ptr fs:[0x00000000], ecx
006A278F    pop ecx
006A2790    pop edi
006A2791    pop esi
006A2792    pop ebx
...
006A279F    push eax
006A27A0    push ebx
006A27A1    push 0x87A46C
006A27A6    call 0x0063B5F0
...
006A27C2    jz 0x006A27DF
006A27C4    lea ecx, ss:[ebp-0x14]
006A27C7    call 0x0063D4E0
...
006A2811    call 0x0064C080
006A2816    mov al, 0x01
006A2818    mov ecx, dword ptr ss:[ebp-0x0C]
006A281B    mov dword ptr fs:[0x00000000], ecx
006A2822    pop ecx
006A2823    pop edi
006A2824    pop esi
006A2825    pop ebx
...
006A2828    pop ebp
006A2829    ret
006A282A    push 0x87CF18
006A282F    push 0xC3
006A2834    push 0x87CC50
006A2839    mov ecx, 0x87CF74
006A283E    mov edx, 0x801800
006A2843    call 0x0063B870
006A2848    add esp, 0x0C
006A284B    call 0x0063BC30
006A2850    test al, al
006A2852    jz 0x006A2855
006A2854    int3
006A2855    call 0x0063BB00
