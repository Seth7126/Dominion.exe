...
00565FF9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00566013    call 0x00573400                                 ; => [ Call: sub_573400 ]
00566018    push esi
