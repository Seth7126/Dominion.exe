...
0073A3D5    push 0x772F5C                                   ; => [ Type: EHRegistrationNode | Call: sub_772f5c ]
0073A3DA    mov eax, dword ptr fs:[0x00000000]
0073A3E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0073A3E1    sub esp, 0x29C
0073A3E7    mov eax, dword ptr ds:[0x008C4040]
0073A3EC    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0073A451    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073A464    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0073A489    test al, al
0073A48B    jz 0x0073A64D                                   ; => [ Type: WIN32_FIND_DATAA | Call: sub_63bd10 ]
...
0073A4AB    jnz 0x0073A61D                                  ; => [ Field: dwFileAttributes ]
0073A4B1    mov dword ptr ss:[ebp-0x29C], 0x801800          ; => [ Data: data_801800 ]
...
0073A51F    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0073A524    push 0x2E
...
0073A53B    push 0x88F558                                   ; => [ String: .atlasmaker ]
0073A540    push eax
...
0073A55A    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0073A55F    cmovnz edx, esi
0073A562    call 0x006C4220
0073A567    push ecx                                        ; => [ Call: sub_6c4220 ]
...
0073A5B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073A5CA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0073A5CF    mov dword ptr ss:[ebp-0x2A0], 0x801800          ; => [ Data: data_801800 ]
...
0073A5F0    jz 0x0073A610                                   ; => [ Data: data_cf65bc ]
0073A5F2    lea ecx, ss:[ebp-0x29C]
0073A5F8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073A60B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0073A633    jz 0x0073A4A0                                   ; => [ Type: BOOL ]
...
0073A658    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
0073A65D    lea eax, ss:[ebp-0x29C]
0073A663    mov dword ptr ss:[ebp-0x04], 0x06
0073A66A    mov ecx, dword ptr ds:[0x0147D094]              ; => [ Data: data_147d094 ]
0073A670    push eax
0073A671    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0073A676    mov dword ptr ss:[ebp-0x04], 0x07
0073A67D    cmp dword ptr ds:[0x00CF65BC], 0x00
0073A684    jz 0x0073A6B3                                   ; => [ Data: data_cf65bc ]
...
0073A69B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073A6AE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0073A6B3    lea edx, ss:[ebp-0x154]
0073A6B9    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0073A6C0    mov ecx, esi
0073A6C2    call 0x0063BD10                                 ; => [ Type: WIN32_FIND_DATAA | Call: sub_63bd10 ]
0073A6C7    test al, al
...
0073A6E8    jz 0x0073A774                                   ; => [ Field: dwFileAttributes | Field: cFileName ]
0073A6EE    mov dword ptr ss:[ebp-0x29C], 0x801800          ; => [ Data: data_801800 ]
...
0073A712    push eax
0073A713    call 0x0063DE70                                 ; => [ Call: sub_63de70 | String: %s%s/ ]
...
0073A747    jz 0x0073A767                                   ; => [ Data: data_cf65bc ]
0073A749    lea ecx, ss:[ebp-0x29C]
0073A74F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073A762    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0073A783    jz 0x0073A6D0                                   ; => [ Type: HANDLE | Type: BOOL ]
0073A789    push dword ptr ss:[ebp-0x14]
0073A78C    call edi
0073A78E    mov ecx, dword ptr ss:[ebp-0x0C]
0073A791    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0073A798    pop ecx
0073A799    pop edi
0073A79A    pop esi
0073A79B    pop ebx
...
0073A7A1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
