...
0053CB7A    mov edi, dword ptr ds:[eax+0x04]
0053CB7D    cmp esi, 0x320
0053CB83    jb 0x0053CB8A
0053CB85    call 0x00591930
...
0053CC2A    mov dword ptr ss:[ebp-0x1990], 0x81AEF0
0053CC34    mov dword ptr ss:[ebp-0x1988], esi
0053CC3A    mov dword ptr ss:[ebp-0x196C], eax
...
0053CC7B    call eax
0053CC7D    mov dword ptr ds:[edi+0x24], eax
...
0053CCA7    mov dword ptr ss:[ebp-0x20], eax
...
0053CCBE    push eax
0053CCBF    call dword ptr ds:[edx+0x10]
...
0053CCDA    movlpd qword ptr ss:[ebp-0x1954], xmm0
