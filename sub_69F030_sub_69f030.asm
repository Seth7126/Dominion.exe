...
0069F052    mov dword ptr fs:[0x00000000], eax
0069F058    mov ebx, edx
0069F05A    mov esi, ecx
0069F05C    call 0x0069EB30
0069F061    mov ecx, esi
0069F063    call 0x0069FCE0
0069F068    test al, al
0069F06A    jnz 0x0069F080
0069F06C    push 0x87989C
0069F071    push 0xB0
0069F076    mov ecx, 0x879880
...
0069F08A    mov dword ptr fs:[0x00000000], ecx
0069F091    pop ecx
0069F092    pop edi
0069F093    pop esi
0069F094    pop ebx
...
0069F0E6    push 0x87989C
0069F0EB    push 0xC1
0069F0F0    mov ecx, 0x8798DC
0069F0F5    jmp 0x0069F302
0069F0FA    mov ecx, esi
0069F0FC    call 0x006B7EF0
0069F101    cmp eax, ebx
0069F103    jz 0x0069F119
0069F105    push 0x87989C
0069F10A    push 0xC5
0069F10F    mov ecx, 0x8798B0
0069F114    jmp 0x0069F302
0069F119    mov edi, dword ptr ds:[0x0147AC2C]
...
0069F16A    mov dword ptr ds:[ecx+0x0C], 0x801800
0069F171    mov dword ptr ds:[ecx+0x04], ebx
0069F174    mov ecx, esp
0069F176    mov dword ptr ds:[edi], 0x801800
0069F17C    call 0x0063D720
...
0069F1CD    call 0x0064C080
0069F1D2    mov dword ptr ss:[ebp-0x10], 0x801800
...
0069F2CD    mov dword ptr fs:[0x00000000], ecx
0069F2D4    pop ecx
0069F2D5    pop edi
0069F2D6    pop esi
0069F2D7    pop ebx
...
0069F2E4    mov dword ptr fs:[0x00000000], ecx
0069F2EB    pop ecx
0069F2EC    pop edi
0069F2ED    pop esi
0069F2EE    pop ebx
...
0069F2F1    pop ebp
0069F2F2    ret
0069F2F3    push 0x87989C
0069F2F8    push 0xCD
0069F2FD    mov ecx, 0x879918
0069F302    push 0x87982C
0069F307    mov edx, 0x801800
0069F30C    call 0x0063B870
0069F311    add esp, 0x0C
0069F314    call 0x0063BC30
0069F319    test al, al
0069F31B    jz 0x0069F31E
0069F31D    int3
0069F31E    call 0x0063BB00
