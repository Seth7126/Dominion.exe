...
0053055A    push esi
0053055B    push 0xC00
00530560    call 0x00571FA0
00530565    mov ecx, 0x01
0053056A    call 0x0056E9C0
0053056F    mov esi, dword ptr ds:[ebx+0x0C]
00530572    call 0x00573400
00530577    mov edi, eax
00530579    call 0x0056B780
