...
0061801F    push esi
00618020    mov esi, dword ptr ds:[0x0171CB68]              ; => [ Data: data_171cb68 ]
00618026    push edi
00618027    mov edi, dword ptr ds:[0x0171D87C]              ; => [ Data: data_171d87c ]
0061802D    call 0x005AF880
00618032    mov dword ptr ss:[esp+0x2C], 0x00
0061803A    mov eax, dword ptr ds:[eax]                     ; => [ Data: data_171ce08 | Call: sub_5af880 ]
...
0061805C    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
0061806D    push 0x86F01C                                   ; => [ String: TextureGetDef ]
00618072    push 0x89
00618077    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
0061807C    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
00618081    jmp 0x006181D5
00618086    mov ecx, edi
00618088    call 0x005AF880
0061808D    mov edi, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
006180C9    push 0x868A3C                                   ; => [ String: FifoRectAllocatorInit ]
006180CE    push 0xCC69
006180D3    mov ecx, 0x868A1C                               ; => [ String: elSize.x <= RectIWidth(area) ]
006180D8    jmp 0x006181D0
006180DD    sub edi, edx
006180DF    cmp dword ptr ss:[esp+0x14], edi
006180E3    jle 0x006180F9
006180E5    push 0x868A3C                                   ; => [ String: FifoRectAllocatorInit ]
006180EA    push 0xCC6A
006180EF    mov ecx, 0x868A88                               ; => [ String: elSize.y <= RectIHeight(area) ]
...
0061812B    push 0x868A3C                                   ; => [ String: FifoRectAllocatorInit ]
00618130    push 0xCC6F
00618135    mov ecx, 0x868A54                               ; => [ String: allocator.dims.x * allocator.dims.y <= MAX_ELEMENTS ]
...
00618191    mov dword ptr ds:[esi+0x434], 0x00              ; => [ Call: __builtin_memset ]
...
006181BF    pop ebp
006181C0    ret
006181C1    push 0x868A3C                                   ; => [ String: FifoRectAllocatorInit ]
006181C6    push 0xCC72
006181CB    mov ecx, 0x868AB8                               ; => [ String: allocator.dimsReverse.x * allocator.dimsReverse.y <= MAX_ELEMENTS ]
006181D0    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
006181D5    mov edx, 0x801800
006181DA    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006181DF    add esp, 0x0C
006181E2    call 0x0063BC30
006181E7    test al, al
006181E9    jz 0x006181EC                                   ; => [ Call: sub_63bc30 ]
006181EB    int3
006181EC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
