...
0069EA75    push 0x7656A0                                   ; => [ Call: __ehhandler$?MainCppEH@@YGHPBGP6GHHQAPAG@ZH1@Z | Type: EHRegistrationNode ]
0069EA7A    mov eax, dword ptr fs:[0x00000000]
0069EA80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0069EA8E    push eax                                        ; => [ Data: __security_cookie ]
0069EA8F    lea eax, ss:[ebp-0x0C]
0069EA92    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0069EAB6    jz 0x0069EAE6                                   ; => [ Data: data_cf65bc ]
...
0069EAC7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069EADA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069EADF    mov dword ptr ds:[ebx+0x18], 0x801800           ; => [ Data: data_801800 ]
0069EAE6    mov edx, 0x28
0069EAEB    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0069EAF2    mov ecx, ebx
0069EAF4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0069EB17    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069EB1E    pop ecx
0069EB1F    pop edi
0069EB20    pop esi
0069EB21    pop ebx
