...
00525296    call 0x00761E50
0052529B    mov eax, dword ptr ds:[0x008C4040]
005252A0    xor eax, ebp
...
005252AC    mov dword ptr fs:[0x00000000], eax
005252B2    call 0x00573400
005252B7    lea ecx, ss:[ebp-0x1944]
005252BD    push ecx
005252BE    mov edx, dword ptr ds:[eax+0x0C]
005252C1    mov ecx, dword ptr ds:[eax+0x04]
005252C4    call 0x00590B50
005252C9    mov ebx, eax
005252CB    mov dword ptr ss:[ebp-0xCC0], 0x818768
...
005252F5    rep movsd
005252F7    mov dword ptr ss:[ebp-0xC9C], eax
...
00525367    push eax
00525368    call dword ptr ds:[esi+0x10]
...
0052537C    mov dword ptr fs:[0x00000000], ecx
00525383    pop ecx
00525384    pop edi
00525385    pop esi
00525386    pop ebx
