...
006FE2F9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006FE30A    push eax
006FE30B    call 0x006FE1D0                                 ; => [ Call: sub_6fe1d0 ]
...
006FE339    call 0x004EB600                                 ; => [ Call: sub_4eb600 ]
...
006FE365    mov ecx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
006FE39E    mov ecx, dword ptr ds:[0x00BF23B0]              ; => [ Data: data_bf23b0 ]
006FE3A4    mov dword ptr ds:[edx+0x60], eax                ; => [ Data: data_bf23ac ]
006FE3A7    lea eax, ss:[ebp-0x84]
006FE3AD    mov dword ptr ds:[edx+0x64], ecx
006FE3B0    lea ecx, ss:[ebp-0x28]
006FE3B3    push eax
006FE3B4    call 0x0064B1B0                                 ; => [ Call: sub_64b1b0 ]
...
006FE3D5    movss xmm1, dword ptr ds:[0x008C4634]           ; => [ Data: data_8c4634 ]
006FE3DD    movups xmmword ptr ds:[edx+0x40], xmm2
006FE3E1    movups xmmword ptr ds:[edx+0x50], xmm3
006FE3E5    call 0x006E5CC0                                 ; => [ Call: sub_6e5cc0 ]
...
006FE3F6    mov ecx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
006FE434    call 0x006BCA30                                 ; => [ Data: data_8c4634 | Call: sub_6bca30 ]
...
006FE46E    pop esi
006FE46F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006FE474    mov esp, ebp
006FE476    pop ebp
006FE477    ret
006FE478    push 0x88C2BC                                   ; => [ String: AttachPointUpdate ]
006FE47D    push 0x15C
006FE482    push 0x88C260                                   ; => [ String: C:\x\ax2017\Engine\Attachment.cpp ]
006FE487    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006FE48C    jmp 0x006FE49F
006FE48E    push 0x871F88                                   ; => [ String: GetGameData ]
006FE493    push 0x45
006FE495    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
006FE49A    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
006FE49F    mov edx, 0x801800
006FE4A4    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006FE4A9    add esp, 0x0C
006FE4AC    call 0x0063BC30
006FE4B1    test al, al
006FE4B3    jz 0x006FE4B6                                   ; => [ Call: sub_63bc30 ]
006FE4B5    int3
006FE4B6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
