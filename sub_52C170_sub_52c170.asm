...
0052C26F    push ebx
0052C270    call 0x00582D10
0052C275    add esp, 0x38
0052C278    call 0x00573400
0052C27D    push 0x00
0052C27F    push 0x00
0052C281    push 0x01
...
0052C289    push 0x01
0052C28B    call 0x00590760
0052C290    add esp, 0x10
0052C293    call 0x00573400
...
0052C2B9    mov esi, dword ptr ds:[eax+0x19CC]
0052C2BF    call 0x00573400
...
0052C303    call 0x0063B870
0052C308    add esp, 0x0C
0052C30B    call 0x0063BC30
0052C310    test al, al
0052C312    jz 0x0052C315
0052C314    int3
0052C315    call 0x0063BB00
