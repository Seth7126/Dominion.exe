...
005135F8    add esi, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 | Data: data_cca784 ]
005135FE    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
0051361A    call 0x00513590                                 ; => [ Call: sub_513590 ]
...
0051363A    and edx, 0x400                                  ; => [ Call: sub_571b30 ]
00513640    or eax, edx
00513642    jz 0x00513662
00513644    push 0x800
00513649    push 0x00
0051364B    lea ecx, ds:[esi+0x0C]
0051364E    call 0x00513590                                 ; => [ Call: sub_513590 ]
