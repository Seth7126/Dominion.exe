...
006A16E9    call 0x0063B870                                 ; => [ String: AssetTypeGetInfo | Call: sub_63b870 | String: assetType >= 0 && assetType < ASSET_TYPE_COUNT | Data: data_801800 | String: C:\x\ax2017\Engine\AssetTypeRegistry.cpp ]
006A16EE    add esp, 0x0C
006A16F1    call 0x0063BC30
006A16F6    test al, al
006A16F8    jz 0x006A16FB                                   ; => [ Call: sub_63bc30 ]
006A16FA    int3
006A16FB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
