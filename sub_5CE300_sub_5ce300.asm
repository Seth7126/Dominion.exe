...
005CE333    call 0x005C8E30                                 ; => [ Call: sub_5c8e30 ]
...
005CE346    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE34B    push 0x10E3
005CE350    mov ecx, 0x86F474                               ; => [ String: gfx.type == DOMGFX_CARD ]
...
005CE363    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE368    push 0x10E4
005CE36D    mov ecx, 0x86F710                               ; => [ String: gfxPile.pile.count >= 0 ]
...
005CE3A6    lea esi, ds:[eax+0x1B94]                        ; => [ Call: sub_5cba00 ]
...
005CE3CB    lea esi, ds:[eax+0x1B94]                        ; => [ Call: sub_5cba00 ]
...
005CE3E1    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE3E6    push 0x1115
005CE3EB    mov ecx, 0x86F734                               ; => [ String: slot == gfxPile.pile.count - 1 ]
005CE3F0    jmp 0x005CE520
005CE3F5    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE3FA    push 0x1120
005CE3FF    mov ecx, 0x86F770                               ; => [ String: *pCur != DOMGFX_NULL ]
005CE404    jmp 0x005CE520
005CE409    mov ecx, dword ptr ss:[ebp-0x04]
005CE40C    test ebx, ebx
005CE40E    jns 0x005CE424
005CE410    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE415    push 0x1129
005CE41A    mov ecx, 0x802AC8                               ; => [ String: slot >= 0 ]
...
005CE42C    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE431    push 0x112A
005CE436    mov ecx, 0x86F788                               ; => [ String: slot < gfxPile.pile.count ]
005CE43B    jmp 0x005CE520
005CE440    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE445    push 0x111B
005CE44A    mov ecx, 0x86F754                               ; => [ String: loc.type == DOMPILE_SLOT ]
...
005CE4A9    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
...
005CE4E7    call 0x005CBAA0                                 ; => [ Data: data_1000000 | Call: sub_5cbaa0 ]
...
005CE4FA    push 0x00
005CE4FC    call 0x005CDEE0                                 ; => [ Call: sub_5cdee0 ]
...
005CE50F    pop ebp
005CE510    ret
005CE511    push 0x86F728                                   ; => [ String: PileAddCard ]
005CE516    push 0x1135
005CE51B    mov ecx, 0x86F7A4                               ; => [ String: gfxId != *pCur ]
005CE520    push 0x86F1E8
005CE525    mov edx, 0x801800
005CE52A    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 | String: PileAddCard ]
005CE52F    add esp, 0x0C
005CE532    call 0x0063BC30
005CE537    test al, al
005CE539    jz 0x005CE53C                                   ; => [ Call: sub_63bc30 ]
005CE53B    int3
005CE53C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
