...
006EAE16    push edi
006EAE17    push eax
006EAE18    lea eax, ss:[ebp-0x0C]
006EAE1B    mov dword ptr fs:[0x00000000], eax
...
006EAE50    push 0x00
006EAE52    push 0x7FF520
006EAE57    push 0x01
006EAE59    push 0x00
006EAE5B    push 0x00
006EAE5D    push 0xBF23AC
...
006EAE95    mov eax, dword ptr ds:[0x0147ABE4]
...
006EAF63    call 0x006818C0
006EAF68    add esp, 0x08
006EAF6B    mov edi, 0x801800
...
006EB022    mov esi, dword ptr ds:[esi+0x38]
...
006EB0B9    movss dword ptr ss:[ebp-0x50], xmm0
...
006EB0DF    movss dword ptr ss:[ebp-0x48], xmm0
...
006EB2BE    movss dword ptr ss:[ebp-0x114], xmm1
...
006EB3C3    jz 0x006EB3E0
006EB3C5    lea ecx, ss:[ebp-0x38]
006EB3C8    call 0x0063D4E0
...
006EB498    call 0x00682F00
006EB49D    mov eax, dword ptr ds:[0x0147ABE4]
...
006EB4B6    mov dword ptr fs:[0x00000000], ecx
006EB4BD    pop ecx
006EB4BE    pop edi
006EB4BF    pop esi
006EB4C0    mov ecx, dword ptr ss:[ebp-0x14]
006EB4C3    xor ecx, ebp
006EB4C5    call 0x0075927A
...
006EB4E7    call 0x0063B870
006EB4EC    add esp, 0x0C
006EB4EF    call 0x0063BC30
006EB4F4    test al, al
006EB4F6    jz 0x006EB4F9
006EB4F8    int3
006EB4F9    call 0x0063BB00
