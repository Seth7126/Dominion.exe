...
004D0776    call 0x004C9D30                                 ; => [ Call: sub_4c9d30 ]
004D077B    pop edi
004D077C    pop esi
004D077D    mov ecx, dword ptr ss:[esp+0xAC]
004D0784    xor ecx, esp
004D0786    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004D078B    mov esp, ebp
004D078D    pop ebp
004D078E    ret
004D078F    mov eax, dword ptr ds:[0x00CC8D94]              ; => [ Data: data_cc8d94 ]
004D0794    test eax, eax
004D0796    jnz 0x004D07A2
004D0798    call 0x004ACC60                                 ; => [ Call: sub_4acc60 ]
004D079D    mov dword ptr ds:[0x00CC8D94], eax              ; => [ Data: data_cc8d94 ]
004D07A2    mov ecx, eax
004D07A4    mov dword ptr ds:[0x00CC8D98], esi              ; => [ Data: data_cc8d98 ]
004D07AA    mov dword ptr ds:[0x00CC8D9C], edi              ; => [ Data: data_cc8d9c ]
004D07B0    mov byte ptr ds:[0x00CC8D90], 0x00              ; => [ Data: data_cc8d90 ]
004D07B7    mov dword ptr ds:[0x00CC8DA0], 0x03             ; => [ Data: data_cc8da0 ]
004D07C1    mov dword ptr ds:[0x00CC8DA4], 0x00             ; => [ Data: data_cc8da4 ]
004D07CB    call 0x004ADD50                                 ; => [ Call: sub_4add50 ]
004D07D0    mov dword ptr ds:[0x008DB660], 0x16             ; => [ Data: data_8db660 ]
004D07DA    pop edi
004D07DB    pop esi
004D07DC    mov ecx, dword ptr ss:[esp+0xAC]
004D07E3    xor ecx, esp
004D07E5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004D07EA    mov esp, ebp
004D07EC    pop ebp
004D07ED    ret
004D07EE    lea ecx, ss:[esp+0x10]
004D07F2    call 0x0060F080
004D07F7    mov ecx, eax                                    ; => [ Call: sub_60f080 ]
...
004D0838    mov ecx, dword ptr ds:[ecx+0x1E1A4]             ; => [ Data: data_cc8dc8 ]
004D083E    jnle 0x004D089D
004D0840    call 0x004D8F30
004D0845    mov dword ptr ds:[eax+0x3508], 0x00             ; => [ Call: sub_4d8f30 ]
004D084F    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004D0855    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004D085A    jmp 0x004D08AC
004D085C    dec ecx
004D085D    test ecx, ecx
004D085F    jnz 0x004D082F
004D0861    mov dword ptr ds:[0x00CC8D80], 0x00             ; => [ Data: data_cc8d80 ]
004D086B    mov dword ptr ds:[0x00CC8D84], 0x03             ; => [ Data: data_cc8d84 ]
004D0875    mov dword ptr ds:[0x00CC8D88], 0x00             ; => [ Data: data_cc8d88 ]
004D087F    mov dword ptr ds:[0x008DB660], 0x15             ; => [ Data: data_8db660 ]
004D0889    pop edi
004D088A    pop esi
004D088B    mov ecx, dword ptr ss:[esp+0xAC]
004D0892    xor ecx, esp
004D0894    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004D0899    mov esp, ebp
004D089B    pop ebp
004D089C    ret
004D089D    call 0x004D8F30
004D08A2    mov dword ptr ds:[eax+0x3508], 0x01             ; => [ Call: sub_4d8f30 ]
004D08AC    call 0x0061DCE0                                 ; => [ Call: sub_61dce0 ]
004D08B1    mov ecx, dword ptr ss:[esp+0xB4]
004D08B8    pop edi
004D08B9    pop esi
004D08BA    xor ecx, esp
004D08BC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004D08DE    call 0x0063B870                                 ; => [ String: TitleBannerClick | Call: sub_63b870 | String: result | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D08E3    add esp, 0x0C
004D08E6    call 0x0063BC30
004D08EB    test al, al
004D08ED    jz 0x004D08F0                                   ; => [ Call: sub_63bc30 ]
004D08EF    int3
004D08F0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
