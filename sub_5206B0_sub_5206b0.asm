...
005206BC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005206C1    xor eax, esp
005206C3    mov dword ptr ss:[esp+0xC98], eax
005206CA    push ebx
005206CB    push esi
005206CC    push edi
005206CD    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
...
005206E2    mov dword ptr ss:[esp+0x10], eax                ; => [ Call: nullptr ]
005206E6    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005206FF    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00520737    push 0x3EA
0052073C    push edi
0052073D    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
00520742    push 0x02
...
0052075A    call 0x0056BBA0                                 ; => [ Call: sub_520780 | Call: sub_56bba0 ]
...
0052076E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
