...
004DF8F5    push 0x763F9E                                   ; => [ Call: __ehhandler$??0ResourceManager@details@Concurrency@@AAE@XZ | Type: EHRegistrationNode ]
004DF8FA    mov eax, dword ptr fs:[0x00000000]
004DF900    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004DF90E    push eax                                        ; => [ Data: __security_cookie ]
004DF90F    lea eax, ss:[ebp-0x0C]
004DF912    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DF927    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
004DF955    call 0x004DF350                                 ; => [ Call: nullptr | Call: sub_4df350 ]
...
004DF985    call 0x004DF350                                 ; => [ Call: sub_4df350 ]
...
004DF99E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DF9A5    pop ecx
004DF9A6    pop edi
004DF9A7    pop esi
004DF9A8    pop ebx
