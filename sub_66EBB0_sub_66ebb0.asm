...
0066EBD5    mov dword ptr fs:[0x00000000], eax
0066EBDB    mov esi, ecx
0066EBDD    call 0x00667870
...
0066ECE0    movups xmmword ptr ss:[ebp-0x2C], xmm0
...
0066ED1F    mov dword ptr fs:[0x00000000], ecx
0066ED26    pop ecx
0066ED27    pop edi
0066ED28    pop esi
0066ED29    pop ebx
...
0066ED2F    call 0x0075927A
0066ED34    mov esp, ebp
0066ED36    pop ebp
0066ED37    ret
0066ED38    push 0x876020
0066ED3D    push 0x45C7
0066ED42    mov ecx, 0x876058
0066ED47    push 0x8739B4
0066ED4C    mov edx, 0x801800
0066ED51    call 0x0063B870
0066ED56    add esp, 0x0C
0066ED59    call 0x0063BC30
0066ED5E    test al, al
0066ED60    jz 0x0066ED63
0066ED62    int3
0066ED63    call 0x0063BB00
