...
006FF25A    mov dword ptr ds:[esi], 0x00
...
006FF289    push 0x00
006FF28B    push 0x00
006FF28D    call dword ptr ds:[0x007751F4]
006FF293    push dword ptr ds:[edi+0x04]
006FF296    call dword ptr ds:[0x007751F8]
006FF29C    push dword ptr ds:[edi+0x08]
...
006FF2B6    mov ecx, dword ptr ds:[0x0147DED4]
006FF2BC    pop edi
006FF2BD    pop esi
006FF2BE    test ecx, ecx
006FF2C0    jz 0x006FF2D6
006FF2C2    mov edx, 0x5048
006FF2C7    call 0x0064C080
006FF2CC    mov dword ptr ds:[0x0147DED4], 0x00
006FF2D6    ret
