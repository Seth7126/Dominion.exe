...
004B4CCB    xor eax, ebp
004B4CCD    mov dword ptr ss:[ebp-0x08], eax
004B4CD0    push esi
004B4CD1    push edi
004B4CD2    mov edi, dword ptr ds:[0x00CC8D5C]
...
004B4D4D    cmovnz eax, edx
004B4D50    test eax, eax
004B4D52    jz 0x004B4DD3
004B4D58    call 0x004B9480
004B4D5D    cmp eax, esi
004B4D5F    jnz 0x004B4DCD
004B4D61    mov eax, dword ptr ds:[0x00CC8D5C]
...
004B4E0B    pop edi
004B4E0C    movups xmmword ptr ds:[eax], xmm0
004B4E0F    xor ecx, ebp
004B4E11    movq qword ptr ds:[eax+0x10], xmm0
004B4E16    pop esi
004B4E17    call 0x0075927A
004B4E1C    mov esp, ebp
004B4E1E    pop ebp
004B4E1F    ret
004B4E20    push 0x801E94
004B4E25    push 0x7A5
004B4E2A    push 0x801AF8
004B4E2F    mov ecx, 0x801AA4
004B4E34    mov edx, 0x801800
004B4E39    call 0x0063B870
004B4E3E    add esp, 0x0C
004B4E41    call 0x0063BC30
004B4E46    test al, al
004B4E48    jz 0x004B4E4B
004B4E4A    int3
004B4E4B    call 0x0063BB00
