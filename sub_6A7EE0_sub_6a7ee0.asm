...
006A7FFF    call 0x0064C080
006A8004    mov dword ptr ss:[ebp-0x10], 0x801800
006A800B    mov eax, dword ptr ss:[ebp+0x0C]
006A800E    mov ebx, 0x801800
006A8013    mov byte ptr ss:[ebp-0x04], 0x07
006A8017    mov ecx, ebx
...
006A809A    push 0x871DD4
006A809F    push 0x9A
006A80A4    push 0x871D5C
006A80A9    mov edx, 0x801800
006A80AE    mov ecx, 0x871E0C
...
006A80CE    call 0x006A7E20
006A80D3    jmp 0x006A81BE
006A80D8    test esi, esi
006A80DA    mov eax, ebx
006A80DC    mov ecx, 0x87AEC0
...
006A81ED    call 0x0064C080
006A81F2    mov dword ptr ss:[ebp-0x14], 0x801800
...
006A820D    jz 0x006A822A
006A820F    lea ecx, ss:[ebp-0x20]
006A8212    call 0x0063D4E0
...
006A8290    call 0x0064C080
006A8295    mov al, 0x01
006A8297    mov ecx, dword ptr ss:[ebp-0x0C]
006A829A    mov dword ptr fs:[0x00000000], ecx
006A82A1    pop ecx
006A82A2    pop edi
006A82A3    pop esi
006A82A4    pop ebx
...
006A82A7    pop ebp
006A82A8    ret
006A82A9    push 0x87AE80
006A82AE    push 0x16E
006A82B3    mov ecx, 0x87AE94
006A82B8    push 0x87ADA4
006A82BD    mov edx, ebx
006A82BF    call 0x0063B870
006A82C4    add esp, 0x0C
006A82C7    call 0x0063BC30
006A82CC    test al, al
006A82CE    jz 0x006A82D1
006A82D0    int3
006A82D1    call 0x0063BB00
