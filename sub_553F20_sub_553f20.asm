...
00553F4C    mov dword ptr fs:[0x00000000], eax
00553F52    lea eax, ss:[ebp-0xC98]
00553F58    mov ecx, 0x3E9
00553F5D    push eax
00553F5E    call 0x00568780
...
00553FE9    push esi
00553FEA    call dword ptr ds:[eax]
...
0055402C    push eax
0055402D    call dword ptr ds:[edx+0x10]
00554030    call 0x00573400
...
00554061    push esi
00554062    push eax
00554063    call 0x00590DE0
00554068    add esp, 0x14
0055406B    mov ecx, dword ptr ss:[ebp-0x0C]
0055406E    mov dword ptr fs:[0x00000000], ecx
00554075    pop ecx
00554076    pop edi
00554077    pop esi
00554078    pop ebx
