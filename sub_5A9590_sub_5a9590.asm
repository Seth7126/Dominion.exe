...
005A959D    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: __security_cookie ]
005A95A0    push ebx
005A95A1    push esi
005A95A2    push edi
...
005A95E2    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
005A95E7    test eax, eax
005A95E9    jnz 0x005A9604
005A95EB    push 0x806A44                                   ; => [ String: GetLocalSettings ]
005A95F0    push 0x5FB
005A95F5    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
005A95FA    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
...
005A9635    call 0x005A93D0                                 ; => [ Call: sub_5a93d0 ]
...
005A9645    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005A965D    call 0x005A93D0                                 ; => [ Call: sub_5a93d0 ]
...
005A9674    call 0x005A9030                                 ; => [ Call: sub_5a9030 ]
...
005A968B    call 0x005A9030                                 ; => [ Call: sub_5a9030 ]
...
005A969B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005A96D9    call 0x00682F00                                 ; => [ Call: sub_682f00 ]
005A96DE    mov ecx, dword ptr ss:[ebp-0x08]
005A96E1    pop edi
005A96E2    pop esi
005A96E3    xor ecx, ebp
005A96E5    pop ebx
005A96E6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005A96EB    mov esp, ebp
005A96ED    pop ebp
005A96EE    ret
005A96EF    push 0x82552C                                   ; => [ String: CapsuleDraw ]
005A96F4    push 0xDBF
005A96F9    push 0x8250E0                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomMap.cpp ]
005A96FE    mov ecx, 0x825538                               ; => [ String: c0 == c1 ]
005A9703    mov edx, 0x801800
005A9708    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005A970D    add esp, 0x0C
005A9710    call 0x0063BC30
005A9715    test al, al
005A9717    jz 0x005A971A                                   ; => [ Call: sub_63bc30 ]
005A9719    int3
005A971A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
