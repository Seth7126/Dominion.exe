...
005C9C85    push 0x76998D                                   ; => [ Type: EHRegistrationNode | Call: sub_76998d ]
005C9C8A    mov eax, dword ptr fs:[0x00000000]
005C9C90    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005C9D11    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005C9D16    xor al, al
...
005C9D2C    mov dword ptr ss:[ebp-0x118], edi               ; => [ Type: FILE ]
005C9D32    call edi
...
005C9D7E    jz 0x005C9F13                                   ; => [ String: %s | Call: _fprintf ]
005C9D84    push esi
005C9D85    call edi
...
005C9DBC    movups xmmword ptr ds:[edi-0x28], xmm0          ; => [ Call: __builtin_memset ]
...
005C9DED    jz 0x005C9F13                                   ; => [ String: %d | Call: _fprintf ]
...
005C9E02    mov ecx, eax                                    ; => [ Call: sub_687730 ]
...
005C9E39    jz 0x005C9F0D                                   ; => [ String: %d | Call: _fprintf ]
...
005C9E69    mov dword ptr ds:[edi-0x10], eax                ; => [ Call: sub_687730 ]
...
005C9E8D    jz 0x005C9F0D                                   ; => [ String: %f | Call: _fprintf ]
005C9E8F    inc esi
...
005C9EEB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005C9EF0    mov al, 0x01
005C9EF2    mov ecx, dword ptr ss:[ebp-0x0C]
005C9EF5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005C9EFC    pop ecx
005C9EFD    pop edi
005C9EFE    pop esi
005C9EFF    mov ecx, dword ptr ss:[ebp-0x10]
005C9F02    xor ecx, ebp
005C9F04    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
