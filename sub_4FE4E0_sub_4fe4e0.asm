...
004FE4EB    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FE4F0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004FE50E    push 0x02
004FE510    push ecx
004FE511    mov ecx, dword ptr ds:[eax+0x40]                ; => [ Call: sub_573400 ]
004FE514    call 0x0056F370                                 ; => [ Call: sub_56f370 ]
004FE519    xorps xmm0, xmm0
004FE51C    mov dword ptr ss:[esp+0x38], 0x00
004FE524    movlpd qword ptr ss:[esp+0x30], xmm0            ; => [ Call: __builtin_memset ]
...
004FE57A    push 0x00
004FE57C    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
004FE59A    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
004FE5BA    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
004FE5BE    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FE5D7    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FE618    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
004FE61D    add esp, 0x38
004FE620    mov ecx, dword ptr ss:[esp+0x199C]
004FE627    pop edi
004FE628    pop esi
004FE629    xor ecx, esp
004FE62B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
