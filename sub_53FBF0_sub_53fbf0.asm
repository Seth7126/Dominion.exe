...
0053FBF8    call 0x00761E50
0053FBFD    mov eax, dword ptr ds:[0x008C4040]
0053FC02    xor eax, ebp
0053FC04    mov dword ptr ss:[ebp-0x04], eax
0053FC07    call 0x00573400
0053FC0C    push 0x00
0053FC0E    push 0x00
0053FC10    push 0x01
...
0053FC18    push 0x01
0053FC1A    call 0x00590760
0053FC1F    add esp, 0x10
0053FC22    call 0x00573400
...
0053FCB0    call 0x0063B870
0053FCB5    add esp, 0x0C
0053FCB8    call 0x0063BC30
0053FCBD    test al, al
0053FCBF    jz 0x0053FCC2
0053FCC1    int3
0053FCC2    call 0x0063BB00
