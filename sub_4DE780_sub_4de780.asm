...
004DE785    push 0x763E4B                                   ; => [ Call: sub_763e4b | Type: EHRegistrationNode ]
004DE78A    mov eax, dword ptr fs:[0x00000000]
004DE790    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DE791    mov eax, 0x1CB0
004DE796    call 0x00761E50                                 ; => [ Call: __chkstk ]
004DE79B    mov eax, dword ptr ds:[0x008C4040]
004DE7A0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
004DE7AC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DE7CA    push eax
004DE7CB    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
004DE7EC    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004DE8A6    movzx eax, byte ptr ds:[eax+0x4DEBDC]           ; => [ Data: lookup_table_4debdc ]
004DE8AD    jmp dword ptr ds:[eax*4+0x4DEBBC]
004DE8B4    push 0x8073CC                                   ; => [ String: ToEntries ]
004DE8B9    push 0xBD5
004DE8BE    mov ecx, 0x8073D8                               ; => [ String: numEntries < 64 ]
004DE8C3    jmp 0x004DEB68
004DE8C8    push dword ptr ss:[ebp-0x1CAC]
004DE8CE    lea edx, ds:[ecx+0x01]
004DE8D1    lea ecx, ss:[ebp-0x1CA0]
004DE8D7    call 0x004DDD90                                 ; => [ Call: sub_4ddd90 ]
...
004DE8F4    call 0x004DD810                                 ; => [ Call: sub_4dd810 ]
004DE8F9    add esp, 0x04
004DE8FC    jmp 0x004DEAFD
004DE901    lea eax, ds:[ecx+0x01]
004DE904    xor edi, edi                                    ; => [ Call: nullptr ]
004DE906    push 0x807234
004DE90B    push eax
004DE90C    call dword ptr ds:[0x0077566C]                  ; => [ Data: data_807234 ]
...
004DE963    call 0x004DD260                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_4dd260 ]
...
004DE988    push 0x00
004DE98A    call dword ptr ds:[0x0077566C]                  ; => [ Call: nullptr | Data: data_807234 ]
...
004DEA42    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DEA55    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DEA5A    mov dword ptr ss:[ebp-0x1CA4], 0x801800         ; => [ Data: data_801800 ]
...
004DEA7C    call 0x004E5FF0                                 ; => [ Call: sub_4e5ff0 ]
...
004DEABD    jz 0x004DEAF6                                   ; => [ Data: data_cf65bc ]
...
004DEAD4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DEAE7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DEAEC    mov dword ptr ss:[ebp-0x1CA8], 0x801800         ; => [ Data: data_801800 ]
...
004DEB50    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004DEB55    mov esp, ebp
004DEB57    pop ebp
004DEB58    ret
004DEB59    push 0x8073E8                                   ; => [ String: ParseSetupString ]
004DEB5E    push 0xC0A
004DEB63    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004DEB68    push 0x806FE4
004DEB6D    mov edx, 0x801800
004DEB72    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameShared.cpp | Call: sub_63b870 | Data: data_801800 ]
004DEB77    add esp, 0x0C
004DEB7A    call 0x0063BC30
004DEB7F    test al, al
004DEB81    jz 0x004DEB84                                   ; => [ Call: sub_63bc30 ]
004DEB83    int3
004DEB84    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004DEB89    push 0x871DD4
004DEB8E    push 0x94
004DEB93    push 0x871D5C
004DEB98    mov edx, 0x801800
004DEB9D    mov ecx, 0x871E0C
004DEBA2    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
004DEBA7    add esp, 0x0C
004DEBAA    call 0x0063BC30
004DEBAF    test al, al
004DEBB1    jz 0x004DEBB4                                   ; => [ Call: sub_63bc30 ]
004DEBB3    int3
004DEBB4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
