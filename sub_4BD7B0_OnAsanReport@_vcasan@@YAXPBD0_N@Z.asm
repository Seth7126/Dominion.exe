...
004BD7B5    push 0x762CF5                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?OnAsanReport@__vcasan@@YAXPBD0_N@Z ]
004BD7BA    mov eax, dword ptr fs:[0x00000000]
004BD7C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004BD7CF    push esi
004BD7D0    push edi
004BD7D1    push eax                                        ; => [ Data: __security_cookie ]
004BD7D2    lea eax, ss:[ebp-0x0C]
004BD7D5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004BD868    mov dword ptr ss:[ebp-0x2C], eax                ; => [ Call: sub_4d8f30 ]
004BD86B    lea ecx, ss:[ebp-0x28]
004BD86E    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004BD889    call 0x004DB700                                 ; => [ Call: sub_4db700 ]
004BD88E    test al, al
...
004BD8C1    call 0x004BC100                                 ; => [ Call: sub_4bc100 ]
004BD8C6    xor edx, edx                                    ; => [ Call: nullptr ]
004BD8C8    mov dword ptr ss:[ebp-0x5C], eax
004BD8CB    mov dword ptr ss:[ebp-0x58], edx                ; => [ Call: nullptr ]
004BD8CE    nop
...
004BD915    mov dword ptr ds:[ebx*4+0xCB4498], 0xFFFFFFFF   ; => [ Data: data_cb4498 ]
004BD920    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004BD925    movss xmm3, dword ptr ds:[0x00890E18]
004BD92D    mov edx, 0x8DB880
004BD932    push 0x00
004BD934    push ebx
004BD935    mov ecx, eax
004BD937    call 0x00665DB0                                 ; => [ Data: data_8db880 | Call: sub_665db0 ]
...
004BD988    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004BD98D    push 0x10
...
004BD9BE    push edi
004BD9BF    call 0x004BBB30                                 ; => [ Data: data_19e4cc0 | String: tblPlayers | Call: sub_4bbb30 ]
...
004BDA85    call 0x004B06C0                                 ; => [ Call: sub_4b06c0 ]
...
004BDA9C    mov dword ptr ds:[ebx*4+0xCB4498], eax          ; => [ Data: data_cb4498 ]
004BDAA3    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
004BDAE1    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
004BDB1B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BDB2E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BDB33    mov dword ptr ss:[ebp-0x48], 0x801800           ; => [ Data: data_801800 ]
...
004BDFE5    xor esi, esi                                    ; => [ Call: nullptr ]
...
004BDFFE    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004BE003    movss xmm3, dword ptr ds:[0x00890E18]
004BE00B    mov edx, 0x8DBA60
004BE010    push 0x00
004BE012    push 0xFFFFFFFF
004BE014    mov ecx, eax
004BE016    call 0x00665DB0                                 ; => [ Data: data_8dba60 | Call: sub_665db0 ]
004BE01B    mov ecx, esi
004BE01D    call 0x004B3F80                                 ; => [ Call: sub_4b3f80 ]
...
004BE034    mov dword ptr ds:[eax*4+0x8DBF54], esi          ; => [ Data: data_8dbf54 ]
004BE03B    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8db910 ]
004BE040    add esp, 0x10
004BE043    call 0x004BBDB0
004BE048    xor edx, edx
004BE04A    lea ecx, ds:[eax+0x58]                          ; => [ Call: sub_4bbdb0 ]
...
004BE07B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004BE080    movss xmm3, dword ptr ds:[0x00890E18]
004BE088    mov edx, 0x8DBB20
004BE08D    push 0x00
004BE08F    push esi
004BE090    mov ecx, eax
004BE092    call 0x00665DB0                                 ; => [ Data: data_8dbb20 | Call: sub_665db0 ]
...
004BE0A6    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004BE0C0    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dba30 ]
...
004BE1E8    call 0x00666120                                 ; => [ Data: data_8dbb08 | Call: sub_665db0 | Data: data_8dbb74 | Call: sub_666120 ]
004BE1ED    add esp, 0x30
004BE1F0    jmp 0x004BE356
004BE1F5    cmp ecx, 0x01
004BE1F8    jnz 0x004BE356
004BE1FE    mov ecx, edi
004BE200    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004BE205    movss xmm3, dword ptr ds:[0x00890E18]
004BE20D    mov edx, 0x8DBAB4
004BE212    push 0x00
004BE214    push 0x01
004BE216    mov ecx, eax
004BE218    call 0x00665DB0                                 ; => [ Data: data_8dbab4 | Call: sub_665db0 ]
004BE21D    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004BE223    add esp, 0x08
004BE226    xor ebx, ebx                                    ; => [ Call: nullptr ]
...
004BE23B    xor eax, eax                                    ; => [ Call: nullptr ]
004BE23D    mov dword ptr ss:[ebp-0x28], eax                ; => [ Call: nullptr ]
...
004BE2E4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004BE2E9    movss xmm3, dword ptr ds:[0x00890E18]
004BE2F1    mov edx, 0x8DBA30
004BE2F6    push 0x00
004BE2F8    push ebx
004BE2F9    mov ecx, eax
004BE2FB    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dba30 ]
004BE300    add esp, 0x08
004BE303    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004BE309    inc ebx
...
004BE3AD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004BE3C0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004BE3C5    mov dword ptr ss:[ebp-0x40], 0x801800           ; => [ Data: data_801800 ]
...
004BE3EC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004BE3F3    pop ecx
004BE3F4    pop edi
004BE3F5    pop esi
004BE3F6    pop ebx
...
004BE3FC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004BE41E    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: PlayerIndexToSlot | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: Halt ]
004BE423    add esp, 0x0C
004BE426    call 0x0063BC30
004BE42B    test al, al
004BE42D    jz 0x004BE430                                   ; => [ Call: sub_63bc30 ]
004BE42F    int3
004BE430    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004BE435    push 0x77EB90                                   ; => [ String: GetClient ]
004BE43A    push 0x7B
004BE43C    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004BE441    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004BE446    jmp 0x004BE488
004BE448    push 0x8069D4                                   ; => [ String: GetProfileBySlot ]
004BE44D    push 0x544
004BE452    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004BE457    mov ecx, 0x803BE4                               ; => [ String: retval ]
004BE45C    jmp 0x004BE488
004BE45E    push 0x803134                                   ; => [ String: GameCreateUpdatePlayers ]
004BE463    push 0x96F
004BE468    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004BE46D    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004BE472    jmp 0x004BE488
004BE474    push 0x871DD4                                   ; => [ String: XString::XString ]
004BE479    push 0x94
004BE47E    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
004BE483    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
004BE488    mov edx, 0x801800
004BE48D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004BE492    add esp, 0x0C
004BE495    call 0x0063BC30
004BE49A    test al, al
004BE49C    jz 0x004BE49F                                   ; => [ Call: sub_63bc30 ]
004BE49E    int3
004BE49F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
