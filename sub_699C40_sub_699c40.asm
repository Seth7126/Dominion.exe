...
00699C4B    call 0x00761E50
00699C50    mov eax, dword ptr ds:[0x008C4040]
...
00699CE0    push 0x8790A8
00699CE5    push 0x127
00699CEA    push 0x878EA8
00699CEF    mov ecx, 0x8790C8
00699CF4    jmp 0x0069A938
00699CF9    call 0x005AF880
00699CFE    push 0x189C
00699D03    mov dword ptr ss:[esp+0x98], eax
00699D0A    lea eax, ss:[esp+0x308]
00699D11    push 0x00
00699D13    push eax
00699D14    call 0x00761FC4
...
00699D51    mov dword ptr ss:[esp+0x58], edx
...
00699F83    movss dword ptr ds:[esi+0x10], xmm0
00699F88    jmp 0x0069A6A8
00699F8D    lea eax, ss:[esp+0x180]
00699F94    push eax
00699F95    call 0x00698FB0
...
0069A0D5    movups xmm0, xmmword ptr ds:[eax]
...
0069A32E    mov eax, dword ptr ds:[0x0147ABE8]
...
0069A37A    call 0x006E5CC0
0069A37F    jmp 0x0069A657
0069A384    mov eax, dword ptr ds:[0x0147ABE8]
...
0069A46D    mov dword ptr ss:[esp+0xB4], 0x00
0069A478    movaps xmm0, xmmword ptr ss:[esp+0xA0]
0069A480    movaps xmmword ptr ss:[esp+0xD0], xmm0
0069A488    mov dword ptr ss:[esp+0xB8], 0x00
0069A493    mov dword ptr ss:[esp+0xBC], 0x00
0069A49E    movaps xmm0, xmmword ptr ss:[esp+0xB0]
0069A4A6    movaps xmmword ptr ss:[esp+0xE0], xmm0
0069A4AE    call 0x006B80F0
0069A4B3    mov edx, eax
...
0069A735    push 0x8792A0
0069A73A    push 0x87E
0069A73F    push 0x878EA8
0069A744    mov ecx, 0x879228
0069A749    jmp 0x0069A90B
0069A74E    push 0x8792A0
0069A753    push 0x87D
0069A758    push 0x878EA8
0069A75D    mov ecx, 0x87924C
0069A762    jmp 0x0069A90B
0069A767    push 0x8792A0
0069A76C    push 0x878
0069A771    push 0x878EA8
0069A776    mov ecx, 0x801AA4
...
0069A840    movups xmm0, xmmword ptr ds:[0x007FFCB8]
...
0069A883    call 0x0063B870
0069A888    add esp, 0x0C
0069A88B    call 0x0063BC30
0069A890    test al, al
0069A892    jz 0x0069A895
0069A894    int3
0069A895    call 0x0063BB00
0069A89A    push 0x8792A0
0069A89F    push 0x8E3
0069A8A4    push 0x878EA8
0069A8A9    mov edx, 0x801800
0069A8AE    mov ecx, 0x879290
0069A8B3    call 0x0063B870
0069A8B8    add esp, 0x0C
0069A8BB    call 0x0063BC30
0069A8C0    test al, al
0069A8C2    jz 0x0069A8C5
0069A8C4    int3
0069A8C5    call 0x0063BB00
0069A8CA    push 0x8792A0
0069A8CF    push 0x918
0069A8D4    push 0x878EA8
0069A8D9    mov edx, 0x801800
0069A8DE    mov ecx, 0x879290
0069A8E3    call 0x0063B870
0069A8E8    add esp, 0x0C
0069A8EB    call 0x0063BC30
0069A8F0    test al, al
0069A8F2    jz 0x0069A8F5
0069A8F4    int3
0069A8F5    call 0x0063BB00
0069A8FA    push 0x871F88
0069A8FF    push 0x45
0069A901    push 0x871FA0
0069A906    mov ecx, 0x871F94
0069A90B    mov edx, 0x801800
0069A910    call 0x0063B870
0069A915    add esp, 0x0C
0069A918    call 0x0063BC30
0069A91D    test al, al
0069A91F    jz 0x0069A922
0069A921    int3
0069A922    call 0x0063BB00
0069A927    push 0x8793D8
0069A92C    push 0x6D
0069A92E    push 0x80193C
0069A933    mov ecx, 0x802748
0069A938    mov edx, 0x801800
0069A93D    call 0x0063B870
0069A942    add esp, 0x0C
0069A945    call 0x0063BC30
0069A94A    test al, al
0069A94C    jz 0x0069A94F
0069A94E    int3
0069A94F    call 0x0063BB00
