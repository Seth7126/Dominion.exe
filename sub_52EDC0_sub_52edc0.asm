...
0052EDDE    jz 0x0052EDE8                                   ; => [ Call: sub_573400 ]
0052EDE0    xor al, al
0052EDE2    pop edi
0052EDE3    pop esi
...
0052EDF1    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0052EDF4    cmp esi, 0x320
0052EDFA    jb 0x0052EE01
0052EDFC    call 0x00591930                                 ; => [ Call: sub_591930 ]
