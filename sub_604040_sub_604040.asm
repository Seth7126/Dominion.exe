...
00604045    push 0x7631ED                                   ; => [ Call: __ehhandler$??2@YAPAXIABUnothrow_t@std@@@Z | Type: EHRegistrationNode ]
0060404A    mov eax, dword ptr fs:[0x00000000]
00604050    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00604051    sub esp, 0x10
00604054    push esi
00604055    push edi
00604056    mov eax, dword ptr ds:[0x008C4040]
0060405B    xor eax, ebp
0060405D    push eax                                        ; => [ Data: __security_cookie ]
0060405E    lea eax, ss:[ebp-0x0C]
00604061    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00604087    push edi
00604088    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
0060408D    add esp, 0x0C
00604090    mov eax, edi
00604092    mov ecx, dword ptr ss:[ebp-0x0C]
00604095    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060409C    pop ecx
0060409D    pop edi
0060409E    pop esi
...
006040A6    call 0x005CAB10                                 ; => [ Call: ___std_fs_get_file_id@8 ]
006040AB    mov eax, edi
006040AD    mov ecx, dword ptr ss:[ebp-0x0C]
006040B0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006040B7    pop ecx
006040B8    pop edi
006040B9    pop esi
...
006040C5    mov edx, 0x8642D4                               ; => [ String: *missing card* ]
006040CA    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006040CF    mov eax, edi
006040D1    mov ecx, dword ptr ss:[ebp-0x0C]
006040D4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
006040DB    pop ecx
006040DC    pop edi
006040DD    pop esi
...
006040F3    call 0x004E3FA0                                 ; => [ Call: nullptr | Call: sub_4e3fa0 ]
006040F8    add esp, 0x0C
006040FB    mov dword ptr ss:[ebp-0x04], 0x00
00604102    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
...
00604114    call 0x00692C20                                 ; => [ Call: sub_692c20 ]
...
0060412C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060414E    jz 0x006040CF                                   ; => [ Data: data_cf65bc ]
00604154    lea ecx, ss:[ebp-0x10]
00604157    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060416E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00604173    mov eax, edi
00604175    mov ecx, dword ptr ss:[ebp-0x0C]
00604178    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060417F    pop ecx
00604180    pop edi
00604181    pop esi
...
006041E5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: ComputeReplacement | String: Halt ]
006041EA    add esp, 0x0C
006041ED    call 0x0063BC30
006041F2    test al, al
006041F4    jz 0x006041F7                                   ; => [ Call: sub_63bc30 ]
006041F6    int3
006041F7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
