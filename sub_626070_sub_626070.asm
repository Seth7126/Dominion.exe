...
0062619C    call 0x0064C080
006261A1    mov ecx, dword ptr ss:[ebp-0x0C]
006261A4    mov dword ptr fs:[0x00000000], ecx
006261AB    pop ecx
006261AC    pop edi
006261AD    pop esi
006261AE    pop ebx
...
006261CC    call 0x0063B870
006261D1    add esp, 0x0C
006261D4    call 0x0063BC30
006261D9    test al, al
006261DB    jz 0x006261DE
006261DD    int3
006261DE    call 0x0063BB00
