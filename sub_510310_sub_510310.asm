...
0051031A    push esi
0051031B    push edi
0051031C    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
00510321    mov esi, eax
00510323    call 0x00573400                                 ; => [ Call: sub_573400 ]
00510328    push 0x00
...
00510351    imul edx                                        ; => [ Call: sub_5727e0 ]
...
0051037B    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0051041C    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
00510444    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: cs.numContexts > 0 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: DomPopContext ]
00510449    add esp, 0x0C
0051044C    call 0x0063BC30
00510451    test al, al
00510453    jz 0x00510456                                   ; => [ Call: sub_63bc30 ]
00510455    int3
00510456    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
