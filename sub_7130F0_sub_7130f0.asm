...
007130F6    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
007130FB    push ebx
007130FC    push esi
...
0071310E    push 0x74
00713110    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
00713112    add esp, 0x0C
00713115    jmp 0x00713122
00713117    push 0x74
00713119    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0071312D    push 0x00
0071312F    push eax
00713130    call 0x00761FC4                                 ; => [ Call: memset ]
00713135    add esp, 0x0C
00713138    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00713154    push eax
00713155    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
00713157    add esp, 0x0C
0071315A    jmp 0x00713166
0071315C    push eax
0071315D    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00713163    add esp, 0x04
00713166    mov esi, dword ptr ds:[edi+0x04]
00713169    mov dword ptr ds:[edi+0x08], eax
0071316C    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071317F    push esi
00713180    call eax
00713182    mov edx, eax                                    ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
00713184    add esp, 0x0C
00713187    mov dword ptr ss:[ebp-0x04], edx
0071318A    jmp 0x0071319B
0071318C    push esi
0071318D    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007131A0    push 0x00
007131A2    push edx
007131A3    call 0x00761FC4                                 ; => [ Call: memset ]
...
007131D6    mov ecx, eax                                    ; => [ Call: sub_7101b0 ]
...
007131EC    mov ecx, eax                                    ; => [ Call: sub_7101b0 ]
...
00713213    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00713237    push eax
00713238    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
0071323A    add esp, 0x0C
0071323D    jmp 0x00713249
0071323F    push eax
00713240    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00713291    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007132AE    push eax
007132AF    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
007132B1    add esp, 0x0C
007132B4    jmp 0x007132C0
007132B6    push eax
007132B7    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007132E7    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
007132EC    test eax, eax
007132EE    jz 0x00713300
007132F0    push 0x27
007132F2    push 0x89068C
007132F7    push 0x30
007132F9    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Slot.c ]
007132FB    add esp, 0x0C
007132FE    jmp 0x0071330B
00713300    push 0x30
00713302    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00713308    add esp, 0x04
0071330B    mov esi, eax
0071330D    test esi, esi
0071330F    jz 0x00713350
00713311    mov dword ptr ds:[esi+0x0C], 0x00               ; => [ Call: __builtin_memset ]
...
007133CB    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007133DF    push eax
007133E0    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
007133E2    add esp, 0x0C
007133E5    jmp 0x007133F1
007133E7    push eax
007133E8    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00713400    push ecx
00713401    call 0x00761FBE                                 ; => [ Call: memcpy ]
00713406    mov eax, dword ptr ds:[esi+0x4C]
00713409    add esp, 0x0C
0071340C    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00713423    push eax
00713424    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
00713426    add esp, 0x0C
00713429    jmp 0x00713435
0071342B    push eax
0071342C    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00713456    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
0071345B    test eax, eax
0071345D    jz 0x0071346F
0071345F    push 0x26
00713461    push 0x890710
00713466    push 0x28
00713468    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\IkConstraint.c ]
0071346A    add esp, 0x0C
0071346D    jmp 0x0071347A
0071346F    push 0x28
00713471    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00713477    add esp, 0x04
0071347A    mov esi, eax
0071347C    test esi, esi
0071347E    jz 0x0071348F
00713480    xorps xmm0, xmm0
00713483    movups xmmword ptr ds:[esi], xmm0               ; => [ Call: __builtin_memset ]
00713486    movups xmmword ptr ds:[esi+0x10], xmm0
0071348A    movq qword ptr ds:[esi+0x20], xmm0
0071348F    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007134C9    push eax
007134CA    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\IkConstraint.c ]
007134CC    add esp, 0x0C
007134CF    jmp 0x007134DB
007134D1    push eax
007134D2    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007134FA    mov dword ptr ds:[ecx+ebx*4], eax               ; => [ Call: sub_714700 ]
007134FD    inc ebx
...
00713515    mov dword ptr ds:[esi+0x0C], eax                ; => [ Call: sub_714700 ]
...
00713533    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071354A    push eax
0071354B    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
0071354D    add esp, 0x0C
00713550    jmp 0x0071355C
00713552    push eax
00713553    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00713578    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
0071357D    test eax, eax
0071357F    jz 0x0071358F
00713581    push 0x8906C8
00713586    push 0x24
00713588    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\TransformConstraint.c ]
0071358A    add esp, 0x0C
0071358D    jmp 0x00713598
0071358F    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00713595    add esp, 0x04
00713598    mov esi, eax
0071359A    test esi, esi
0071359C    jz 0x007135D6
0071359E    mov dword ptr ds:[esi+0x04], 0x00               ; => [ Call: __builtin_memset ]
...
007135D6    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071360A    push eax
0071360B    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\TransformConstraint.c ]
0071360D    add esp, 0x0C
00713610    jmp 0x0071361C
00713612    push eax
00713613    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0071363B    mov dword ptr ds:[ecx+ebx*4], eax               ; => [ Call: sub_714700 ]
0071363E    inc ebx
...
00713656    mov dword ptr ds:[esi+0x0C], eax                ; => [ Call: sub_714700 ]
...
00713674    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071368B    push eax
0071368C    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skeleton.c ]
0071368E    add esp, 0x0C
00713691    jmp 0x0071369D
00713693    push eax
00713694    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007136B6    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007136C9    push 0x74
007136CB    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\PathConstraint.c ]
007136CD    add esp, 0x0C
007136D0    jmp 0x007136DD
007136D2    push 0x74
007136D4    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007136E8    push 0x00
007136EA    push eax
007136EB    call 0x00761FC4                                 ; => [ Call: memset ]
007136F0    add esp, 0x0C
007136F3    mov ecx, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071370F    push eax
00713710    call ecx                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\PathConstraint.c ]
00713712    add esp, 0x0C
00713715    jmp 0x00713721
00713717    push eax
00713718    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00713745    mov dword ptr ds:[ecx+ebx*4], eax               ; => [ Call: sub_714700 ]
00713748    inc ebx
...
007137D2    mov dword ptr ds:[esi+0x20], 0x00               ; => [ Call: __builtin_memset ]
