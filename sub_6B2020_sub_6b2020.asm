...
006B2033    call 0x006B0430                                 ; => [ Call: std::money_get<uint16_t,class std::istreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Getmfld ]
...
006B204A    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006B2061    mov edx, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B2067    test ecx, ecx
006B2069    jnz 0x006B206F
006B206B    xor esi, esi                                    ; => [ Call: nullptr ]
006B206D    jmp 0x006B208F
006B206F    movzx eax, cx
006B2072    cmp eax, dword ptr ds:[edx+0x3C]
006B2075    jb 0x006B207B
006B2077    xor esi, esi                                    ; => [ Call: nullptr ]
006B2079    jmp 0x006B208F
006B207B    imul esi, eax, 0x24C
006B2081    xor eax, eax                                    ; => [ Call: nullptr ]
006B2083    add esi, dword ptr ds:[edx+0x38]
006B2086    cmp dword ptr ds:[esi+0x248], ecx
006B208C    cmovnz esi, eax                                 ; => [ Call: nullptr ]
006B208F    cmp dword ptr ds:[esi], 0x00
006B2092    jz 0x006B20A8
006B2094    push 0x87C4AC                                   ; => [ String: Dx11GraphicsInterface::DrawPrimitive ]
006B2099    push 0x942
006B209E    mov ecx, 0x87C53C                               ; => [ String: vertexBufferData->mBufferType == DX11BUFFER_VERTEX ]
006B20A3    jmp 0x006B21FF
006B20A8    mov ecx, ebx
006B20AA    mov dword ptr ss:[ebp+0x14], 0x00
006B20B1    call 0x00731EA0
006B20B6    mov eax, dword ptr ds:[eax+0x0C]                ; => [ Call: sub_731ea0 ]
006B20B9    test eax, eax
006B20BB    jnz 0x006B20D3
006B20BD    push 0x87943C                                   ; => [ String: DefinitionGetSize ]
006B20C2    push 0x6D
006B20C4    push 0x879400                                   ; => [ String: C:\x\ax2017\Engine\Definition.cpp ]
006B20C9    mov ecx, 0x87948C                               ; => [ String: pDefMap->definitionSize != 0 ]
...
006B20FD    mov edx, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B2103    movzx eax, cx
006B2106    cmp eax, dword ptr ds:[edx+0x3C]
006B2109    jb 0x006B210F
006B210B    xor eax, eax                                    ; => [ Call: nullptr ]
...
006B2120    cmovnz eax, edx                                 ; => [ Call: nullptr ]
006B2123    cmp dword ptr ds:[eax], 0x01
006B2126    jz 0x006B213C
006B2128    push 0x87C4AC                                   ; => [ String: Dx11GraphicsInterface::DrawPrimitive ]
006B212D    push 0x94B
006B2132    mov ecx, 0x87C508                               ; => [ String: indexBufferData->mBufferType == DX11BUFFER_INDEX ]
...
006B216B    mov edi, ebx                                    ; => [ Call: nullptr ]
...
006B21D3    mov eax, dword ptr ds:[0x0147B06C]              ; => [ Data: data_147b06c ]
...
006B21EC    pop ebp
006B21ED    ret 0x20
006B21F0    push 0x87C4AC                                   ; => [ String: Dx11GraphicsInterface::DrawPrimitive ]
006B21F5    push 0x95F
006B21FA    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006B21FF    push 0x87B990                                   ; => [ String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp ]
006B2204    mov edx, 0x801800
006B2209    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006B220E    add esp, 0x0C
006B2211    call 0x0063BC30
006B2216    test al, al
006B2218    jz 0x006B221B                                   ; => [ Call: sub_63bc30 ]
006B221A    int3
006B221B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
