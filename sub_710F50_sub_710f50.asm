...
00710F6C    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00710F71    push esi
...
00710F7D    push ebx
00710F7E    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\AnimationState.c ]
00710F80    add esp, 0x0C
00710F83    jmp 0x00710F8F
00710F85    push ebx
00710F86    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00710F96    push 0x00
00710F98    push esi
00710F99    call 0x00761FC4                                 ; => [ Call: memset ]
...
00710FAB    push esi
00710FAC    call 0x00761FBE                                 ; => [ Call: memcpy ]
00710FB1    push dword ptr ds:[edi+0x04]
00710FB4    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
