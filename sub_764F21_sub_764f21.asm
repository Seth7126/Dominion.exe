...
00764F32    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00764F37    mov ecx, dword ptr ds:[edx-0x08]
00764F3A    xor ecx, eax
00764F3C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00764F41    mov eax, 0x8B1198
00764F46    jmp 0x00761FA6                                  ; => [ Data: data_8b1198 | Call: __CxxFrameHandler3 ]
