...
005F5345    push 0x76A370                                   ; => [ Type: EHRegistrationNode | Call: sub_76a370 ]
005F534A    mov eax, dword ptr fs:[0x00000000]
005F5350    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005F535E    push eax                                        ; => [ Data: __security_cookie ]
005F535F    lea eax, ss:[ebp-0x0C]
005F5362    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005F53EE    jz 0x005F541B                                   ; => [ Data: data_cf65bc ]
...
005F53FC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005F540F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005F5414    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
...
005F5435    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005F543C    pop ecx
005F543D    pop edi
005F543E    pop esi
005F543F    pop ebx
...
005F545E    jz 0x005F547B                                   ; => [ Data: data_cf65bc ]
005F5460    lea ecx, ss:[ebp+0x08]
005F5463    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005F5476    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005F547B    mov eax, edi
005F547D    mov ecx, dword ptr ss:[ebp-0x0C]
005F5480    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005F5487    pop ecx
005F5488    pop edi
005F5489    pop esi
005F548A    pop ebx
