...
0056FB18    push 0x76744B                                   ; => [ Call: sub_76744b | Type: EHRegistrationNode ]
0056FB1D    mov eax, dword ptr fs:[0x00000000]
0056FB23    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0056FB24    push ebx
0056FB25    mov eax, 0x19B8
0056FB2A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0056FB2F    mov eax, dword ptr ds:[0x008C4040]
0056FB34    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0056FB36    mov dword ptr ss:[ebp-0x14], eax
0056FB39    push esi
0056FB3A    push edi
0056FB3B    push eax
0056FB3C    lea eax, ss:[ebp-0x0C]
0056FB3F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0056FB45    mov esi, ecx
0056FB47    call 0x00573400                                 ; => [ Call: sub_573400 ]
0056FB4C    mov edi, eax
0056FB4E    call 0x00573400
0056FB53    movzx esi, si
0056FB56    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056FB59    mov dword ptr ss:[ebp-0xCA8], eax
0056FB5F    cmp esi, 0x320
0056FB65    jb 0x0056FB72
0056FB67    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056FBB8    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056FBDB    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
0056FBE0    add esp, 0x0C
0056FBE3    call 0x00573400                                 ; => [ Call: sub_573400 ]
0056FBE8    lea ecx, ss:[ebp-0x19C8]
0056FBEE    push 0x04
0056FBF0    push ecx
0056FBF1    mov edx, dword ptr ds:[eax+0x0C]
0056FBF4    mov ecx, dword ptr ds:[eax+0x04]
0056FBF7    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0056FBFC    mov ecx, 0x321
0056FC01    mov dword ptr ss:[ebp-0xD48], eax
0056FC07    lea esi, ss:[ebp-0x19C8]
0056FC0D    mov dword ptr ss:[ebp-0xD10], 0x81EF70          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_4eece438e92ac9e8b17aff836b808f4f>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_4eece438e92ac9e8b17aff836b808f4f>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0056FC17    lea edi, ss:[ebp-0xCA0]
0056FC1D    add esp, 0x08
0056FC20    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0056FC40    mov dword ptr ss:[ebp-0xCEC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_4eece438e92ac9e8b17aff836b808f4f>,bool,enum CardID>::VTable ]
...
0056FCC2    push eax
0056FCC3    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
0056FD9C    xor ecx, ecx                                    ; => [ Call: nullptr ]
0056FD9E    add esp, 0x1C
0056FDA1    test al, al
0056FDA3    cmovnz ecx, esi                                 ; => [ Call: nullptr | Call: sub_583720 ]
0056FDA6    mov eax, ecx
0056FDA8    jmp 0x0056FDAC
0056FDAA    xor eax, eax                                    ; => [ Call: nullptr ]
0056FDAC    mov ecx, dword ptr ss:[ebp-0x0C]
0056FDAF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0056FDB6    pop ecx
0056FDB7    pop edi
0056FDB8    pop esi
0056FDB9    mov ecx, dword ptr ss:[ebp-0x14]
0056FDBC    xor ecx, ebp
0056FDBE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
