...
006F699B    call 0x00761E50                                 ; => [ Call: __chkstk ]
006F69A0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006F69D7    push eax
006F69D8    push esi
006F69D9    call dword ptr ds:[0x00775338]                  ; => [ Type: LRESULT ]
006F69DF    pop edi
006F69E0    pop esi
006F69E1    pop ebx
006F69E2    mov ecx, dword ptr ss:[esp+0x1048]
006F69E9    xor ecx, esp
006F69EB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006F6A15    push eax
006F6A16    push esi
006F6A17    call dword ptr ds:[0x007752FC]                  ; => [ Type: HWND ]
...
006F6A2E    push esi
006F6A2F    call edi
006F6A31    mov ebx, eax                                    ; => [ Type: LRESULT ]
...
006F6A5A    jnz 0x006F6A8D                                  ; => [ Data: data_1512420 ]
006F6A5C    test ebx, ebx
006F6A5E    jle 0x006F6A6D
006F6A60    mov ecx, ebx
006F6A62    lea esi, ss:[esp+0x50]
006F6A66    mov edi, 0x147DF94
006F6A6B    rep movsd                                       ; => [ Call: __builtin_memcpy | Data: data_147df94 ]
006F6A6D    mov dword ptr ds:[0x0147EF94], ebx              ; => [ Data: data_147ef94 ]
006F6A73    jmp 0x006F6A88
006F6A75    cmp dword ptr ds:[0x01512420], 0x00
006F6A7C    jnz 0x006F6A8D                                  ; => [ Data: data_1512420 ]
006F6A7E    mov dword ptr ds:[0x0147EF94], 0x00             ; => [ Data: data_147ef94 ]
006F6A88    call 0x0073E3E0                                 ; => [ Call: sub_73e3e0 | Call: sub_73e3e0 ]
006F6A8D    call 0x006F7240                                 ; => [ Call: sub_6f7240 ]
006F6A92    push dword ptr ds:[0x0147B084]
006F6A98    call dword ptr ds:[0x0077539C]                  ; => [ Data: data_147b084 ]
...
006F6AB6    call 0x006F5580                                 ; => [ Call: sub_6f5580 ]
...
006F6ACB    call 0x006F1800                                 ; => [ Call: sub_6f1800 ]
...
006F6AEA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
