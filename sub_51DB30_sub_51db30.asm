...
0051DB36    mov eax, dword ptr ds:[0x008C4040]
...
0051DB58    push 0x813640
0051DB5D    push 0x669
0051DB62    mov ecx, 0x813658
...
0051DB7E    push 0x813640
0051DB83    push 0x672
0051DB88    mov ecx, 0x813670
...
0051DC87    push 0x816A00
0051DC8C    push 0x2F9E
0051DC91    mov ecx, 0x816A38
0051DC96    jmp 0x0051DDC4
0051DC9B    push 0x816A00
0051DCA0    push 0x2F9D
0051DCA5    mov ecx, 0x816A30
0051DCAA    jmp 0x0051DDC4
0051DCAF    push 0x816A00
0051DCB4    push 0x2F9C
0051DCB9    mov ecx, 0x816A28
0051DCBE    jmp 0x0051DDC4
0051DCC3    push 0x816A00
0051DCC8    push 0x2F9A
0051DCCD    mov ecx, 0x816A20
...
0051DD58    movups xmmword ptr ss:[ebp-0x48], xmm0
...
0051DDAB    pop ebx
0051DDAC    call 0x0075927A
0051DDB1    mov esp, ebp
0051DDB3    pop ebp
0051DDB4    ret
0051DDB5    push 0x816A00
0051DDBA    push 0x2FC2
0051DDBF    mov ecx, 0x816A14
0051DDC4    push 0x80CD80
0051DDC9    mov edx, 0x801800
0051DDCE    call 0x0063B870
0051DDD3    add esp, 0x0C
0051DDD6    call 0x0063BC30
0051DDDB    test al, al
0051DDDD    jz 0x0051DDE0
0051DDDF    int3
0051DDE0    call 0x0063BB00
