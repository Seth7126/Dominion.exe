...
0055BD70    push esi
0055BD71    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055BD76    mov esi, eax
0055BD78    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
...
0055BD86    push 0x01
0055BD88    push 0x02
0055BD8A    call 0x00590760                                 ; => [ Call: sub_590760 ]
0055BD8F    add esp, 0x10
0055BD92    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055BD97    pop esi
...
0055BDBF    pop ecx
0055BDC0    ret                                             ; => [ Call: sub_561af0 ]
0055BDC1    push 0x81EA64
0055BDC6    push 0x52
0055BDC8    push 0x81EA70
0055BDCD    mov edx, 0x801800
0055BDD2    mov ecx, 0x813C5C
0055BDD7    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0055BDDC    add esp, 0x0C
0055BDDF    call 0x0063BC30
0055BDE4    test al, al
0055BDE6    jz 0x0055BDE9                                   ; => [ Call: sub_63bc30 ]
0055BDE8    int3
0055BDE9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
