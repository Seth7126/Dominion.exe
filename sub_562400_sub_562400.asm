...
00562409    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0056241A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00562430    jnz 0x00562445                                  ; => [ Call: sub_582de0 ]
00562432    xor al, al
00562434    pop edi
00562435    pop esi
00562436    pop ebx
...
0056243C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0056247C    call 0x00590DE0                                 ; => [ Call: sub_590de0 ]
...
0056248C    pop esi
0056248D    pop ebx
0056248E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
