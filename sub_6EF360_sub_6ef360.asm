...
006EF365    push 0x764776                                   ; => [ Call: __ehhandler$??0?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QAE@QBG@Z | Type: EHRegistrationNode ]
006EF36A    mov eax, dword ptr fs:[0x00000000]
006EF370    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006EF371    sub esp, 0x10
006EF374    push esi
006EF375    push edi
006EF376    mov eax, dword ptr ds:[0x008C4040]
006EF37B    xor eax, ebp
006EF37D    push eax                                        ; => [ Data: __security_cookie ]
006EF37E    lea eax, ss:[ebp-0x0C]
006EF381    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006EF387    mov esi, ecx
006EF389    mov dword ptr ss:[ebp-0x18], esi
006EF38C    mov dword ptr ss:[ebp-0x04], 0x00
006EF393    mov eax, 0x800338                               ; => [ Data: data_800338 ]
...
006EF3AF    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006EF3D6    call 0x006A1F50                                 ; => [ Data: data_147ded0 | Call: sub_6a1f50 ]
006EF3DB    add esp, 0x04
006EF3DE    mov dword ptr ss:[ebp-0x04], 0x01
006EF3E5    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
006EF444    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EF457    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EF45C    mov eax, esi
006EF45E    mov ecx, dword ptr ss:[ebp-0x0C]
006EF461    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006EF468    pop ecx
006EF469    pop edi
006EF46A    pop esi
