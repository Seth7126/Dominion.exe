...
00691E15    push 0x76EDDE                                   ; => [ Call: sub_76edde | Type: EHRegistrationNode ]
00691E1A    mov eax, dword ptr fs:[0x00000000]
00691E20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00691E2E    push eax                                        ; => [ Data: __security_cookie ]
00691E2F    lea eax, ss:[ebp-0x0C]
00691E32    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00691EAB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00691EE6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00691F3F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00691F5D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00691F80    jz 0x00691F9D                                   ; => [ Data: data_cf65bc ]
00691F82    lea ecx, ss:[ebp-0x10]
00691F85    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00691FCC    jz 0x00692174                                   ; => [ Data: data_cf65bc ]
...
00691FEA    push eax                                        ; => [ Call: sub_68ec70 ]
00691FEB    lea ecx, ds:[esi+0x04]
00691FEE    mov dword ptr ss:[ebp-0x04], 0x06
00691FF5    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
00692010    push eax                                        ; => [ Call: sub_68dd90 ]
00692011    lea ecx, ds:[esi+0x04]
00692014    mov dword ptr ss:[ebp-0x04], 0x08
0069201B    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
00692036    push eax                                        ; => [ Call: sub_68d790 ]
00692037    lea ecx, ds:[esi+0x04]
0069203A    mov dword ptr ss:[ebp-0x04], 0x0A
00692041    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
00692065    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0069207A    push eax                                        ; => [ Call: sub_68f520 ]
0069207B    lea ecx, ds:[esi+0x04]
0069207E    mov dword ptr ss:[ebp-0x04], 0x0C
00692085    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
00692155    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00692168    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0069216D    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
...
0069218B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
00692190    inc dword ptr ds:[eax+0x04]
00692193    mov eax, ebx
00692195    mov ecx, dword ptr ss:[ebp-0x0C]
00692198    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0069219F    pop ecx
006921A0    pop edi
006921A1    pop esi
006921A2    pop ebx
