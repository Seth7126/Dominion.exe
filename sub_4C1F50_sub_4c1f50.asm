...
004C1F55    push 0x762F95                                   ; => [ Call: __ehhandler$??0?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QAE@QBGI@Z | Type: EHRegistrationNode ]
004C1F5A    mov eax, dword ptr fs:[0x00000000]
004C1F60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004C1F61    sub esp, 0x18
004C1F64    mov eax, dword ptr ds:[0x008C4040]
004C1F69    xor eax, ebp
004C1F6B    push eax                                        ; => [ Data: __security_cookie ]
004C1F6C    lea eax, ss:[ebp-0x0C]
004C1F6F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004C1FAD    call 0x004D48C0                                 ; => [ String: [username] | Call: sub_4d48c0 | Data: data_8db800 | String: dom_msg_add_friend_error_header | String: dom_msg_add_friend_error_blocked_body | Call: sub_4d47c0 ]
004C1FB2    add esp, 0x08
004C1FB5    mov edx, 0x801800
004C1FBA    mov byte ptr ss:[ebp-0x04], 0x01
004C1FBE    lea ecx, ss:[ebp-0x18]
004C1FC1    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C1FC6    mov edx, 0x801800
004C1FCB    mov byte ptr ss:[ebp-0x04], 0x02
004C1FCF    lea ecx, ss:[ebp-0x14]
004C1FD2    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C1FD7    lea eax, ss:[ebp-0x1C]
004C1FDA    mov byte ptr ss:[ebp-0x04], 0x03
004C1FDE    push eax
004C1FDF    mov ecx, 0x8DB750
004C1FE4    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004C1FEE    call 0x0063D850                                 ; => [ Data: data_8db750 | Call: sub_63d850 ]
004C1FF3    lea eax, ss:[ebp-0x10]
004C1FF6    mov ecx, 0x8DB754
004C1FFB    push eax
004C1FFC    call 0x0063D850                                 ; => [ Data: data_8db754 | Call: sub_63d850 ]
004C2001    lea eax, ss:[ebp-0x14]
004C2004    mov ecx, 0x8DB758
004C2009    push eax
004C200A    call 0x0063D850                                 ; => [ Data: data_8db758 | Call: sub_63d850 ]
004C200F    lea eax, ss:[ebp-0x18]
004C2012    mov ecx, 0x8DB75C
004C2017    push eax
004C2018    call 0x0063D850                                 ; => [ Data: data_8db75c | Call: sub_63d850 ]
004C201D    mov dword ptr ds:[0x008DB760], 0x00             ; => [ Data: data_8db760 ]
004C2027    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004C2031    mov byte ptr ss:[ebp-0x04], 0x04
004C2035    cmp dword ptr ds:[0x00CF65BC], 0x00
004C203C    jz 0x004C2065                                   ; => [ Data: data_cf65bc ]
...
004C204D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2060    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C2065    mov byte ptr ss:[ebp-0x04], 0x05
004C2069    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2070    jz 0x004C2099                                   ; => [ Data: data_cf65bc ]
...
004C2081    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2094    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C2099    mov byte ptr ss:[ebp-0x04], 0x06
004C209D    cmp dword ptr ds:[0x00CF65BC], 0x00
004C20A4    jz 0x004C20D4                                   ; => [ Data: data_cf65bc ]
...
004C20B5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C20C8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C20CD    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004C20D4    mov dword ptr ss:[ebp-0x04], 0x07
004C20DB    cmp dword ptr ds:[0x00CF65BC], 0x00
004C20E2    jz 0x004C210B                                   ; => [ Data: data_cf65bc ]
...
004C20F3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2106    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C210B    mov ecx, dword ptr ss:[ebp-0x0C]
004C210E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004C2115    pop ecx
...
004C2140    call 0x004D48C0                                 ; => [ String: [username] | Call: sub_4d48c0 | Data: data_8db800 | String: dom_msg_add_friend_error_already_friends_body | String: dom_msg_add_friend_error_header | Call: sub_4d47c0 ]
004C2145    add esp, 0x08
004C2148    mov edx, 0x801800
004C214D    mov byte ptr ss:[ebp-0x04], 0x09
004C2151    lea ecx, ss:[ebp-0x18]
004C2154    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C2159    mov edx, 0x801800
004C215E    mov byte ptr ss:[ebp-0x04], 0x0A
004C2162    lea ecx, ss:[ebp-0x1C]
004C2165    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C216A    lea eax, ss:[ebp-0x20]
004C216D    mov byte ptr ss:[ebp-0x04], 0x0B
004C2171    push eax
004C2172    mov ecx, 0x8DB750
004C2177    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004C2181    call 0x0063D850                                 ; => [ Data: data_8db750 | Call: sub_63d850 ]
004C2186    lea eax, ss:[ebp-0x10]
004C2189    mov ecx, 0x8DB754
004C218E    push eax
004C218F    call 0x0063D850                                 ; => [ Data: data_8db754 | Call: sub_63d850 ]
004C2194    lea eax, ss:[ebp-0x1C]
004C2197    mov ecx, 0x8DB758
004C219C    push eax
004C219D    call 0x0063D850                                 ; => [ Data: data_8db758 | Call: sub_63d850 ]
004C21A2    lea eax, ss:[ebp-0x18]
004C21A5    mov ecx, 0x8DB75C
004C21AA    push eax
004C21AB    call 0x0063D850                                 ; => [ Data: data_8db75c | Call: sub_63d850 ]
004C21B0    mov dword ptr ds:[0x008DB760], 0x00             ; => [ Data: data_8db760 ]
004C21BA    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004C21C4    mov byte ptr ss:[ebp-0x04], 0x0C
004C21C8    cmp dword ptr ds:[0x00CF65BC], 0x00
004C21CF    jz 0x004C21F8                                   ; => [ Data: data_cf65bc ]
...
004C21E0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C21F3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C21F8    mov byte ptr ss:[ebp-0x04], 0x0D
004C21FC    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2203    jz 0x004C222C                                   ; => [ Data: data_cf65bc ]
...
004C2214    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2227    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C222C    mov byte ptr ss:[ebp-0x04], 0x0E
004C2230    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2237    jz 0x004C2267                                   ; => [ Data: data_cf65bc ]
...
004C2248    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C225B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C2260    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004C2267    mov dword ptr ss:[ebp-0x04], 0x0F
004C226E    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2275    jz 0x004C210B                                   ; => [ Data: data_cf65bc ]
...
004C229F    call 0x004D47C0                                 ; => [ String: dom_msg_add_friend_error_header | Call: sub_4d47c0 ]
004C22A4    mov edx, 0x80385C
004C22A9    mov dword ptr ss:[ebp-0x04], 0x10
004C22B0    lea ecx, ss:[ebp-0x10]
004C22B3    call 0x004D47C0                                 ; => [ Call: sub_4d47c0 | String: dom_msg_add_friend_error_self_body ]
004C22B8    mov edx, 0x801800
004C22BD    mov byte ptr ss:[ebp-0x04], 0x11
004C22C1    lea ecx, ss:[ebp-0x1C]
004C22C4    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C22C9    mov edx, 0x801800
004C22CE    mov byte ptr ss:[ebp-0x04], 0x12
004C22D2    lea ecx, ss:[ebp-0x20]
004C22D5    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C22DA    lea eax, ss:[ebp-0x18]
004C22DD    mov byte ptr ss:[ebp-0x04], 0x13
004C22E1    push eax
004C22E2    mov ecx, 0x8DB750
004C22E7    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004C22F1    call 0x0063D850                                 ; => [ Data: data_8db750 | Call: sub_63d850 ]
004C22F6    lea eax, ss:[ebp-0x10]
004C22F9    mov ecx, 0x8DB754
004C22FE    push eax
004C22FF    call 0x0063D850                                 ; => [ Data: data_8db754 | Call: sub_63d850 ]
004C2304    lea eax, ss:[ebp-0x20]
004C2307    mov ecx, 0x8DB758
004C230C    push eax
004C230D    call 0x0063D850                                 ; => [ Data: data_8db758 | Call: sub_63d850 ]
004C2312    lea eax, ss:[ebp-0x1C]
004C2315    mov ecx, 0x8DB75C
004C231A    push eax
004C231B    call 0x0063D850                                 ; => [ Data: data_8db75c | Call: sub_63d850 ]
004C2320    mov dword ptr ds:[0x008DB760], 0x00             ; => [ Data: data_8db760 ]
004C232A    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004C2334    mov byte ptr ss:[ebp-0x04], 0x14
004C2338    cmp dword ptr ds:[0x00CF65BC], 0x00
004C233F    jz 0x004C2368                                   ; => [ Data: data_cf65bc ]
...
004C2350    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2363    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C2368    mov byte ptr ss:[ebp-0x04], 0x15
004C236C    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2373    jz 0x004C239C                                   ; => [ Data: data_cf65bc ]
...
004C2384    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2397    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C239C    mov byte ptr ss:[ebp-0x04], 0x16
004C23A0    cmp dword ptr ds:[0x00CF65BC], 0x00
004C23A7    jz 0x004C23D7                                   ; => [ Data: data_cf65bc ]
...
004C23B8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C23CB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C23D0    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004C23D7    mov dword ptr ss:[ebp-0x04], 0x17
004C23DE    cmp dword ptr ds:[0x00CF65BC], 0x00
004C23E5    jz 0x004C210B                                   ; => [ Data: data_cf65bc ]
...
004C242D    call 0x004D48C0                                 ; => [ String: dom_msg_add_friend_error_not_found_body | String: [username] | Call: sub_4d48c0 | Data: data_8db800 | String: dom_msg_add_friend_error_header | Call: sub_4d47c0 ]
004C2432    add esp, 0x08
004C2435    mov edx, 0x801800
004C243A    mov byte ptr ss:[ebp-0x04], 0x19
004C243E    lea ecx, ss:[ebp-0x1C]
004C2441    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C2446    mov edx, 0x801800
004C244B    mov byte ptr ss:[ebp-0x04], 0x1A
004C244F    lea ecx, ss:[ebp-0x20]
004C2452    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004C2457    lea eax, ss:[ebp-0x24]
004C245A    mov byte ptr ss:[ebp-0x04], 0x1B
004C245E    push eax
004C245F    mov ecx, 0x8DB750
004C2464    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
004C246E    call 0x0063D850                                 ; => [ Data: data_8db750 | Call: sub_63d850 ]
004C2473    lea eax, ss:[ebp-0x14]
004C2476    mov ecx, 0x8DB754
004C247B    push eax
004C247C    call 0x0063D850                                 ; => [ Data: data_8db754 | Call: sub_63d850 ]
004C2481    lea eax, ss:[ebp-0x20]
004C2484    mov ecx, 0x8DB758
004C2489    push eax
004C248A    call 0x0063D850                                 ; => [ Data: data_8db758 | Call: sub_63d850 ]
004C248F    lea eax, ss:[ebp-0x1C]
004C2492    mov ecx, 0x8DB75C
004C2497    push eax
004C2498    call 0x0063D850                                 ; => [ Data: data_8db75c | Call: sub_63d850 ]
004C249D    mov dword ptr ds:[0x008DB760], 0x00             ; => [ Data: data_8db760 ]
004C24A7    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
004C24B1    mov byte ptr ss:[ebp-0x04], 0x1C
004C24B5    cmp dword ptr ds:[0x00CF65BC], 0x00
004C24BC    jz 0x004C24E5                                   ; => [ Data: data_cf65bc ]
...
004C24CD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C24E0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C24E5    mov byte ptr ss:[ebp-0x04], 0x1D
004C24E9    cmp dword ptr ds:[0x00CF65BC], 0x00
004C24F0    jz 0x004C2519                                   ; => [ Data: data_cf65bc ]
...
004C2501    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2514    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C2519    mov byte ptr ss:[ebp-0x04], 0x1E
004C251D    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2524    jz 0x004C2554                                   ; => [ Data: data_cf65bc ]
...
004C2535    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004C2548    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004C254D    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
004C2554    mov dword ptr ss:[ebp-0x04], 0x1F
004C255B    cmp dword ptr ds:[0x00CF65BC], 0x00
004C2562    jz 0x004C210B                                   ; => [ Data: data_cf65bc ]
...
004C259D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: Halt | String: GameDialogAddFriendResponse ]
004C25A2    add esp, 0x0C
004C25A5    call 0x0063BC30
004C25AA    test al, al
004C25AC    jz 0x004C25AF                                   ; => [ Call: sub_63bc30 ]
004C25AE    int3
004C25AF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
