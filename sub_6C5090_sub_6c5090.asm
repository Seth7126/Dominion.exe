...
006C5095    push 0x7702C6                                   ; => [ Type: EHRegistrationNode | Call: sub_7702c6 ]
006C509A    mov eax, dword ptr fs:[0x00000000]
006C50A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C50A1    sub esp, 0x18
006C50A4    push esi
006C50A5    mov eax, dword ptr ds:[0x008C4040]
006C50AA    xor eax, ebp
006C50AC    push eax                                        ; => [ Data: __security_cookie ]
006C50AD    lea eax, ss:[ebp-0x0C]
006C50B0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C50D0    jz 0x006C5217                                   ; => [ Data: data_8c4157 ]
...
006C5108    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
...
006C5128    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: .xml ]
...
006C517B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C518E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5193    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C519A    mov byte ptr ss:[ebp-0x04], 0x05
006C519E    cmp dword ptr ds:[0x00CF65BC], 0x00
006C51A5    jz 0x006C51CE                                   ; => [ Data: data_cf65bc ]
...
006C51B6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C51ED    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5200    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5205    mov eax, esi
006C5207    mov ecx, dword ptr ss:[ebp-0x0C]
006C520A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C5211    pop ecx
006C5212    pop esi
...
006C5230    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: gCompilingMode | String: C:\x\ax2017\Engine\DefLoad.cpp | String: AssetSideCarMakeFullPath ]
006C5235    add esp, 0x0C
006C5238    call 0x0063BC30
006C523D    test al, al
006C523F    jz 0x006C5242                                   ; => [ Call: sub_63bc30 ]
006C5241    int3
006C5242    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
