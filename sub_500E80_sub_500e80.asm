...
00500F62    mov dword ptr ss:[ebp-0x40], 0x80AB74
...
00500FC2    mov dword ptr ss:[ebp-0xAC], eax
00500FC8    lea eax, ss:[ebp-0xA0]
00500FCE    mov dword ptr ss:[ebp-0xD0], 0x80AB58
