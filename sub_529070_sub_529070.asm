...
00529133    test al, al
00529135    jnz 0x00529176
00529137    call 0x00573400
0052913C    mov edi, dword ptr ds:[eax+0x04]
0052913F    cmp esi, 0x320
00529145    jb 0x0052914C
00529147    call 0x00591930
