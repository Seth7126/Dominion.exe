...
004B018C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004B01DE    call 0x00694540                                 ; => [ Call: sub_694540 | Data: data_7ffb70 ]
...
004B01F0    call 0x00694540                                 ; => [ Call: sub_694540 | Data: data_7ffb70 ]
004B01F5    mov edx, dword ptr ds:[edi+0x10]
004B01F8    jmp 0x004B0201
004B01FA    call 0x00694540                                 ; => [ Call: sub_694540 | Data: data_7ffb70 ]
004B01FF    xor edx, edx
004B0201    push 0x00
004B0203    push 0x01
004B0205    lea ecx, ss:[esp+0x20]
004B0209    call 0x0067B3B0                                 ; => [ Call: sub_67b3b0 ]
...
004B0224    mov dword ptr ds:[0x00B7D410], 0x00             ; => [ Data: data_b7d410 ]
004B022E    mov dword ptr ds:[0x00B7D414], 0x00             ; => [ Data: data_b7d414 ]
004B0238    jmp 0x004B0242
004B023A    mov edx, dword ptr ds:[edi+0x08]
004B023D    call 0x00627EA0                                 ; => [ Call: sub_627ea0 ]
...
004B0266    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004B028E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004B02A5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004B02C7    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: ClientMouseoverAction | Data: data_801800 | String: Halt | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
004B02CC    add esp, 0x0C
004B02CF    call 0x0063BC30
004B02D4    test al, al
004B02D6    jz 0x004B02D9                                   ; => [ Call: sub_63bc30 ]
004B02D8    int3
004B02D9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
