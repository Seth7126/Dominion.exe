...
0064D0C5    push 0x76C8FE                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0_TaskCollection@details@Concurrency@@AAE@PAV012@_N@Z ]
0064D0CA    mov eax, dword ptr fs:[0x00000000]
0064D0D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0064D0D1    sub esp, 0x08
0064D0D4    push esi
0064D0D5    push edi
0064D0D6    mov eax, dword ptr ds:[0x008C4040]
0064D0DB    xor eax, ebp
0064D0DD    push eax                                        ; => [ Data: __security_cookie ]
0064D0DE    lea eax, ss:[ebp-0x0C]
0064D0E1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0064D0E7    mov esi, edx
0064D0E9    mov edi, ecx
0064D0EB    mov dword ptr ss:[ebp-0x10], edi
0064D0EE    push 0x64CA90                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_64ca90 ]
...
0064D10E    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_64ca70 ]
...
0064D13B    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0064D188    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064D18F    pop ecx
0064D190    pop edi
0064D191    pop esi
