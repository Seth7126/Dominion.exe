...
00548387    push 0x01
00548389    call 0x00590760
0054838E    add esp, 0x10
00548391    call 0x00573400
...
005483B4    call 0x0063B870
005483B9    add esp, 0x0C
005483BC    call 0x0063BC30
005483C1    test al, al
005483C3    jz 0x005483C6
005483C5    int3
005483C6    jmp 0x0063BB00
