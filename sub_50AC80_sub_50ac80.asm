...
0050ACA8    push 0x80CF1C
0050ACAD    push 0x232
0050ACB2    mov ecx, 0x80CF30
0050ACB7    jmp 0x0050ACFB
0050ACB9    xor eax, eax
0050ACBB    add ecx, esi
...
0050ACEA    pop ebp
0050ACEB    ret
0050ACEC    push 0x80CF1C
0050ACF1    push 0x242
0050ACF6    mov ecx, 0x801AA4
0050ACFB    push 0x80CD80
0050AD00    mov edx, 0x801800
0050AD05    call 0x0063B870
0050AD0A    add esp, 0x0C
0050AD0D    call 0x0063BC30
0050AD12    test al, al
0050AD14    jz 0x0050AD17
0050AD16    int3
0050AD17    call 0x0063BB00
