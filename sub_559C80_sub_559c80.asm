...
00559C98    push 0x766CEB                                   ; => [ Call: sub_766ceb | Type: EHRegistrationNode ]
00559C9D    mov eax, dword ptr fs:[0x00000000]
00559CA3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00559CA4    push ebx
00559CA5    mov eax, 0x19F8
00559CAA    call 0x00761E50                                 ; => [ Call: __chkstk ]
00559CAF    mov eax, dword ptr ds:[0x008C4040]
00559CB4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00559CB6    mov dword ptr ss:[ebp-0x14], eax
00559CB9    push esi
00559CBA    push edi
00559CBB    push eax
00559CBC    lea eax, ss:[ebp-0x0C]
00559CBF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00559CC5    call 0x00573400                                 ; => [ Call: sub_573400 ]
00559CCA    push 0x06
00559CCC    mov edx, dword ptr ds:[eax+0x0C]
00559CCF    mov ecx, dword ptr ds:[eax+0x04]
00559CD2    call 0x00589F70                                 ; => [ Call: sub_589f70 ]
00559CD7    add esp, 0x04
00559CDA    call 0x00573400                                 ; => [ Call: sub_573400 ]
00559CDF    push 0xC00
00559CE4    mov ecx, dword ptr ds:[eax+0x04]
00559CE7    mov edx, dword ptr ds:[eax+0x0C]
00559CEA    call 0x00583FC0                                 ; => [ Call: sub_583fc0 ]
...
00559D3F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00559D92    call 0x00573400                                 ; => [ Call: sub_573400 ]
00559D97    lea ecx, ss:[ebp-0x1A08]
00559D9D    push 0x04
00559D9F    push ecx
00559DA0    mov edx, dword ptr ds:[eax+0x0C]
00559DA3    mov ecx, dword ptr ds:[eax+0x04]
00559DA6    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00559DAB    mov ecx, 0x321
00559DB0    mov dword ptr ss:[ebp-0xD88], eax
00559DB6    lea esi, ss:[ebp-0x1A08]
00559DBC    mov dword ptr ss:[ebp-0xD38], 0x81E350          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_ea0696adb05067b74b57a1183068653b>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ea0696adb05067b74b57a1183068653b>,bool,enum CardID>::VTable ]
00559DC6    lea edi, ss:[ebp-0xCA0]
00559DCC    add esp, 0x10
00559DCF    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00559DD1    mov edi, dword ptr ss:[ebp-0xCC8]
00559DD7    lea ecx, ss:[ebp-0xD38]
00559DDD    mov dword ptr ss:[ebp-0xD34], edi
00559DE3    mov dword ptr ss:[ebp-0xD14], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ea0696adb05067b74b57a1183068653b>,bool,enum CardID>::VTable ]
...
00559E1E    call eax
00559E20    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00559E35    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
00559E63    push eax
00559E64    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00559E87    movlpd qword ptr ss:[ebp-0xCE4], xmm0           ; => [ Call: __builtin_memset ]
...
00559F23    push 0x476
00559F28    push esi
00559F29    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00559F2E    add esp, 0x1C
00559F31    test al, al
00559F33    jz 0x0055A012
00559F39    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00559F56    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00559F79    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
...
00559F96    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: sub_576c00 ]
00559F99    movups xmmword ptr ss:[ebp-0xCC8], xmm0
00559FA0    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00559FBC    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00559FDC    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
...
0055A006    cdq                                             ; => [ Call: sub_576c00 ]
0055A007    xor eax, edx
0055A009    sub eax, edx
0055A00B    mov ecx, eax
0055A00D    call 0x00562240                                 ; => [ Call: sub_562240 ]
0055A012    mov ecx, dword ptr ss:[ebp-0x0C]
0055A015    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055A01C    pop ecx
0055A01D    pop edi
0055A01E    pop esi
0055A01F    mov ecx, dword ptr ss:[ebp-0x14]
0055A022    xor ecx, ebp
0055A024    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
