...
005EE5A4    push 0x8603F4
005EE5A9    push 0x6BA9
005EE5AE    mov ecx, 0x860428
...
005EE5E3    call 0x00591930
005EE5E8    imul eax, edi, 0x64
005EE5EB    cmp dword ptr ds:[eax+0xB82524], 0xE11
005EE5F5    jz 0x005EE5FE
005EE5F7    mov byte ptr ds:[0x00B7FCF8], 0x00
005EE5FE    mov byte ptr ds:[0x00B7FCFA], 0x00
...
005EE634    mov edx, dword ptr ds:[0x00B604E0]
...
005EE66D    mov edx, dword ptr ds:[0x00B604E0]
...
005EE794    pop ebp
005EE795    ret
005EE796    push 0x86F4D8
005EE79B    push 0x9B0
005EE7A0    mov ecx, 0x86F4E4
005EE7A5    push 0x86F1E8
005EE7AA    mov edx, 0x801800
005EE7AF    call 0x0063B870
005EE7B4    add esp, 0x0C
005EE7B7    call 0x0063BC30
005EE7BC    test al, al
005EE7BE    jz 0x005EE7C1
005EE7C0    int3
005EE7C1    call 0x0063BB00
