...
0052C878    push 0x765D0B                                   ; => [ Type: EHRegistrationNode | Call: sub_765d0b ]
0052C87D    mov eax, dword ptr fs:[0x00000000]
0052C883    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0052C884    push ebx
0052C885    mov eax, 0x2630
0052C88A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0052C88F    mov eax, dword ptr ds:[0x008C4040]
0052C894    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0052C896    mov dword ptr ss:[ebp-0x14], eax
0052C899    push esi
0052C89A    push edi
0052C89B    push eax
0052C89C    lea eax, ss:[ebp-0x0C]
0052C89F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0052C8A5    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052C8AA    mov esi, eax
0052C8AC    cmp dword ptr ds:[esi+0x40], 0x00
0052C8B0    jnz 0x0052C8B7
0052C8B2    call 0x00591930                                 ; => [ Call: sub_591930 ]
0052C8B7    mov eax, dword ptr ds:[esi+0x40]
0052C8BA    mov dword ptr ss:[ebp-0xCA8], eax
0052C8C0    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052C8C5    lea ecx, ss:[ebp-0x19B8]
0052C8CB    push 0x04
0052C8CD    push ecx
0052C8CE    mov edx, dword ptr ds:[eax+0x0C]
0052C8D1    mov ecx, dword ptr ds:[eax+0x04]
0052C8D4    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0052C8D9    mov ecx, 0x321
0052C8DE    mov dword ptr ss:[ebp-0xD38], eax
0052C8E4    lea esi, ss:[ebp-0x19B8]
0052C8EA    mov dword ptr ss:[ebp-0xD00], 0x819348          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_fdcf1fbf17b78d68d793bbb44b0bd92f>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_fdcf1fbf17b78d68d793bbb44b0bd92f>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0052C8F4    lea edi, ss:[ebp-0xCA0]
0052C8FA    add esp, 0x08
0052C8FD    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0052C8FF    lea ecx, ss:[ebp-0xCA8]
0052C905    mov dword ptr ss:[ebp-0xCFC], ecx
0052C90B    lea ecx, ss:[ebp-0xD00]
0052C911    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_fdcf1fbf17b78d68d793bbb44b0bd92f>,bool,enum CardID>::VTable ]
...
0052C952    call eax
0052C954    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
0052C97A    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0052C991    push eax
0052C992    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0052C995    mov esi, dword ptr ss:[ebp-0xCA8]
0052C99B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052C9B7    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052C9D7    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
...
0052CA0C    movlpd qword ptr ss:[ebp-0xCC4], xmm0           ; => [ Call: __builtin_memset ]
...
0052CA9D    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052CAA2    push 0x04
0052CAA4    push 0x00
0052CAA6    push 0x00
...
0052CAB5    push 0x476
0052CABA    push esi
0052CABB    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0052CAC0    add esp, 0x1C
0052CAC3    mov ecx, dword ptr ss:[ebp-0x0C]
0052CAC6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0052CACD    pop ecx
0052CACE    pop edi
0052CACF    pop esi
0052CAD0    mov ecx, dword ptr ss:[ebp-0x14]
0052CAD3    xor ecx, ebp
0052CAD5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
