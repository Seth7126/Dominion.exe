...
0056E305    push esi
0056E306    push edi
0056E307    call 0x00573400                                 ; => [ Call: sub_573400 ]
0056E30C    mov ebx, eax
0056E30E    call 0x0056B800
0056E313    mov esi, eax
0056E315    call 0x00573400
0056E31A    movzx esi, si                                   ; => [ Call: sub_56b800 ]
0056E31D    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056E320    cmp esi, 0x320
0056E326    jb 0x0056E32D
0056E328    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056E341    push edi
0056E342    push 0x07
0056E344    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
0056E354    push eax
0056E355    push edi
0056E356    call 0x00574A80                                 ; => [ Call: sub_574a80 ]
