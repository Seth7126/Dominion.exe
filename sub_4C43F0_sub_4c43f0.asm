...
004C43F6    push esi
004C43F7    push edi
004C43F8    call 0x004B9480
004C43FD    mov esi, dword ptr ds:[0x00CC8D5C]
...
004C4468    call 0x00618820
004C446D    mov ecx, edi
004C446F    call 0x004C3A40
...
004C44CB    call 0x0063B870
004C44D0    add esp, 0x0C
004C44D3    call 0x0063BC30
004C44D8    test al, al
004C44DA    jz 0x004C44DD
004C44DC    int3
004C44DD    call 0x0063BB00
