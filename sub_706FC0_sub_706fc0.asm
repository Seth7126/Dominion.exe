...
00706FCE    push 0x88D848                                   ; => [ String: XmlWriteAttributeString ]
00706FD3    push 0x99
00706FD8    mov ecx, 0x88D868                               ; => [ String: pXmlWriter->mWriterState == XML_WRITE_OPEN_TAG ]
...
00707020    call 0x00706CF0                                 ; => [ Call: sub_706cf0 ]
00707025    push dword ptr ds:[esi]
00707027    push 0x01
00707029    push 0x01
0070702B    push 0x88D8B0
00707030    call edi                                        ; => [ Data: data_88d8b0 ]
...
0070703D    pop ebp
0070703E    ret
0070703F    push 0x88D7E8                                   ; => [ String: sXmlEmit ]
00707044    push 0x29
00707046    mov ecx, 0x88D804                               ; => [ String: resultCount == len ]
0070704B    push 0x88D7C4
00707050    mov edx, 0x801800
00707055    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\XmlWriter.cpp ]
0070705A    add esp, 0x0C
0070705D    call 0x0063BC30
00707062    test al, al
00707064    jz 0x00707067                                   ; => [ Call: sub_63bc30 ]
00707066    int3
00707067    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
