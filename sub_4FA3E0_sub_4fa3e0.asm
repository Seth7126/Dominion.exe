...
004FA3ED    push esi
004FA3EE    push edi
004FA3EF    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FA3F4    push 0x00
004FA3F6    push 0x00
004FA3F8    push 0x01
...
004FA400    push 0x01
004FA402    call 0x00590760                                 ; => [ Call: sub_590760 ]
004FA407    add esp, 0x10
004FA40A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FA42E    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FA445    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
004FA448    cmp esi, 0x320
004FA44E    jb 0x004FA455
004FA450    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FA474    push 0x00
004FA476    push 0x00
004FA478    call 0x005911E0                                 ; => [ Call: sub_5911e0 ]
...
004FA4AD    pop ebp
004FA4AE    ret                                             ; => [ Call: sub_4fa4e0 | Call: sub_4fa550 | Call: sub_56c680 ]
004FA4AF    push 0x81EA64
004FA4B4    push 0x52
004FA4B6    push 0x81EA70
004FA4BB    mov edx, 0x801800
004FA4C0    mov ecx, 0x813C5C
004FA4C5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
004FA4CA    add esp, 0x0C
004FA4CD    call 0x0063BC30
004FA4D2    test al, al
004FA4D4    jz 0x004FA4D7                                   ; => [ Call: sub_63bc30 ]
004FA4D6    int3
004FA4D7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
