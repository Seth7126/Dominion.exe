...
0054EAFB    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054EB00    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0054EB5B    movlpd qword ptr ss:[esp+0x34], xmm0            ; => [ Call: __builtin_memset ]
...
0054EBC1    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
0054EBC6    add esp, 0x0C
0054EBC9    mov edi, eax
0054EBCB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054EBEC    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0054EC1F    push eax
0054EC20    call 0x00586320                                 ; => [ Call: sub_586320 ]
0054EC25    add esp, 0x10
0054EC28    xor eax, eax                                    ; => [ Call: nullptr ]
...
0054EC71    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
