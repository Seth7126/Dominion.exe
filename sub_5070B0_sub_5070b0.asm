...
005070C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005070C1    sub esp, 0xC8C
005070C7    mov eax, dword ptr ds:[0x008C4040]
005070CC    xor eax, ebp
005070CE    mov dword ptr ss:[ebp-0x10], eax
005070D1    push esi
005070D2    push eax                                        ; => [ Data: __security_cookie ]
005070D3    lea eax, ss:[ebp-0x0C]
005070D6    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005070DC    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
005070E1    push 0xC80
005070E6    mov esi, eax
005070E8    lea eax, ss:[ebp-0xC90]
005070EE    push 0x00
005070F0    push eax
005070F1    call 0x00761FC4                                 ; => [ Call: memset ]
...
0050710C    call 0x00566370                                 ; => [ Call: sub_566370 ]
...
00507136    call 0x005697D0                                 ; => [ Call: nullptr | Call: sub_5697d0 | Call: sub_56ef50 ]
0050713B    add esp, 0x18
0050713E    lea ecx, ss:[ebp-0xC95]
00507144    call 0x0056EFB0                                 ; => [ Call: sub_56efb0 ]
00507149    mov ecx, dword ptr ss:[ebp-0x0C]
0050714C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00507153    pop ecx
00507154    pop esi
00507155    mov ecx, dword ptr ss:[ebp-0x10]
00507158    xor ecx, ebp
0050715A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
