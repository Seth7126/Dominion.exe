...
00532A7B    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
00532A80    sub esp, 0x24
00532A83    xor ecx, ecx
00532A85    mov eax, esp
00532A87    mov dword ptr ds:[eax], 0x819D78                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_cd8d48f7971db916a08b3b9fa2e3c4bf>, void>::`vftable'{for `std::_Func_base<void>'} ]
00532A8D    mov dword ptr ds:[eax+0x24], eax
00532A90    call 0x00569B30
00532A95    add esp, 0x28
00532A98    mov esp, ebp
00532A9A    pop ebp
00532A9B    ret                                             ; => [ Call: sub_569b30 ]
