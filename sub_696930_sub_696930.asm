...
00696952    mov dword ptr fs:[0x00000000], eax
...
006969FA    call 0x0064C080
006969FF    xor al, al
00696A01    mov ecx, dword ptr ss:[ebp-0x0C]
00696A04    mov dword ptr fs:[0x00000000], ecx
00696A0B    pop ecx
00696A0C    pop edi
00696A0D    pop esi
00696A0E    pop ebx
...
00696A63    call 0x0064C080
00696A68    mov al, bl
00696A6A    mov ecx, dword ptr ss:[ebp-0x0C]
00696A6D    mov dword ptr fs:[0x00000000], ecx
00696A74    pop ecx
00696A75    pop edi
00696A76    pop esi
00696A77    pop ebx
