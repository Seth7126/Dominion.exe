...
004B5DDD    push eax
004B5DDE    lea eax, ss:[ebp-0x0C]
004B5DE1    mov dword ptr fs:[0x00000000], eax
004B5DE7    mov edi, ecx
004B5DE9    mov dword ptr ss:[ebp-0x1C], edi
004B5DEC    mov esi, dword ptr ds:[0x00CC8D5C]
004B5DF2    test esi, esi
004B5DF4    jnz 0x004B5E0C
004B5DF6    push 0x77EB90
004B5DFB    push 0x7B
004B5DFD    push 0x77EB50
004B5E02    mov ecx, 0x77EB9C
004B5E07    jmp 0x004B7ABA
004B5E0C    mov eax, dword ptr ds:[edi]
004B5E0E    mov edx, dword ptr ds:[0x0147ABF4]
...
004B5E92    call 0x006892C0
004B5E97    mov al, 0x01
004B5E99    mov ecx, dword ptr ss:[ebp-0x0C]
004B5E9C    mov dword ptr fs:[0x00000000], ecx
004B5EA3    pop ecx
004B5EA4    pop edi
004B5EA5    pop esi
...
004B5F4D    mov dword ptr fs:[0x00000000], ecx
004B5F54    pop ecx
004B5F55    pop edi
004B5F56    pop esi
...
004B5F67    mov dword ptr fs:[0x00000000], ecx
004B5F6E    pop ecx
004B5F6F    pop edi
004B5F70    pop esi
...
004B5F8B    mov dword ptr fs:[0x00000000], ecx
004B5F92    pop ecx
004B5F93    pop edi
004B5F94    pop esi
...
004B5FF5    mov dword ptr fs:[0x00000000], ecx
004B5FFC    pop ecx
004B5FFD    pop edi
004B5FFE    pop esi
...
004B600F    mov dword ptr fs:[0x00000000], ecx
004B6016    pop ecx
004B6017    pop edi
004B6018    pop esi
...
004B6029    mov dword ptr fs:[0x00000000], ecx
004B6030    pop ecx
004B6031    pop edi
004B6032    pop esi
...
004B6043    mov dword ptr fs:[0x00000000], ecx
004B604A    pop ecx
004B604B    pop edi
004B604C    pop esi
...
004B604F    pop ebp
004B6050    ret
004B6051    mov dword ptr ds:[esi+0x1C], 0x06
004B6058    mov al, 0x01
004B605A    mov ecx, dword ptr ss:[ebp-0x0C]
004B605D    mov dword ptr fs:[0x00000000], ecx
004B6064    pop ecx
004B6065    pop edi
004B6066    pop esi
...
004B6079    jmp dword ptr ds:[eax*4+0x4B7AF0]
004B6080    lea ecx, ds:[edi+0x0C]
004B6083    call 0x004B5230
004B6088    mov al, 0x01
004B608A    mov ecx, dword ptr ss:[ebp-0x0C]
004B608D    mov dword ptr fs:[0x00000000], ecx
004B6094    pop ecx
004B6095    pop edi
004B6096    pop esi
...
004B610C    mov dword ptr ds:[eax+0x08], esi
...
004B61CB    mov dword ptr ds:[eax+0x63DC], esi
...
004B628A    mov dword ptr ds:[eax+0x58E8], esi
...
004B62FE    test al, al
004B6300    jz 0x004B747C
004B6306    mov ecx, dword ptr ds:[esi]
004B6308    call 0x004B50B0
004B630D    test eax, eax
004B630F    jz 0x004B747C
004B6315    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004B6378    mov dword ptr fs:[0x00000000], ecx
004B637F    pop ecx
004B6380    pop edi
004B6381    pop esi
...
004B63EA    mov dword ptr fs:[0x00000000], ecx
004B63F1    pop ecx
004B63F2    pop edi
004B63F3    pop esi
...
004B6460    xor ecx, ecx
004B6462    mov dword ptr ss:[ebp-0x18], ecx
004B6465    add ecx, dword ptr ds:[edx+0x08]
004B6468    mov dword ptr ss:[ebp-0x3C], 0x00
004B646F    mov dword ptr ss:[ebp-0x38], 0x801800
...
004B6553    call 0x0063D4E0
004B6558    inc dword ptr ds:[eax+0x04]
004B655B    mov ecx, dword ptr ss:[ebp-0x1C]
...
004B657E    inc dword ptr ds:[esi+0x75CC]
...
004B659B    jz 0x004B65BF
004B659D    lea ecx, ss:[ebp-0x38]
004B65A0    call 0x0063D4E0
...
004B65B3    call 0x0064C080
004B65B8    mov dword ptr ss:[ebp-0x38], 0x801800
...
004B65E7    mov dword ptr fs:[0x00000000], ecx
004B65EE    pop ecx
004B65EF    pop edi
004B65F0    pop esi
...
004B676C    cmp dword ptr ss:[ebp-0x1C], ecx
...
004B67E8    call 0x0064C080
004B67ED    mov dword ptr ss:[ebp-0x48], 0x801800
...
004B681C    mov dword ptr fs:[0x00000000], ecx
004B6823    pop ecx
004B6824    pop edi
004B6825    pop esi
...
004B6830    push 0x00
004B6832    push dword ptr ds:[0x01597D38]
...
004B6945    push 0x8022E0
004B694A    push 0xEDD
004B694F    mov ecx, 0x802360
...
004B6A1A    mov dword ptr fs:[0x00000000], ecx
004B6A21    pop ecx
004B6A22    pop edi
004B6A23    pop esi
...
004B6A52    mov dword ptr fs:[0x00000000], ecx
004B6A59    pop ecx
004B6A5A    pop edi
004B6A5B    pop esi
...
004B6A97    push 0x802288
004B6A9C    push 0xDC2
004B6AA1    jmp 0x004B7AB0
004B6AA6    mov edi, dword ptr ds:[0x00CC8D5C]
...
004B6ACD    lea edi, ds:[eax+0x721C]
004B6AD3    jmp 0x004B6AE9
004B6AD5    mov edi, dword ptr ds:[0x00CC8D5C]
...
004B6AF6    mov dword ptr ss:[ebp-0x28], 0x00
004B6AFD    cmp dword ptr ds:[edx+0x08], 0x00
004B6B01    jle 0x004B747C
004B6B07    mov dword ptr ss:[ebp-0x20], 0x00
004B6B0E    nop
...
004B6B1F    mov ecx, dword ptr ss:[ebp-0x20]
...
004B6B38    call 0x0063D8D0
004B6B3D    mov edx, dword ptr ss:[ebp-0x2C]
004B6B40    mov ecx, dword ptr ss:[ebp-0x20]
...
004B6B63    mov dword ptr fs:[0x00000000], ecx
004B6B6A    pop ecx
004B6B6B    pop edi
004B6B6C    pop esi
...
004B6B87    mov dword ptr ds:[0x008DB700], 0x26
004B6B91    mov ecx, dword ptr ss:[ebp-0x0C]
004B6B94    mov dword ptr fs:[0x00000000], ecx
004B6B9B    pop ecx
004B6B9C    pop edi
004B6B9D    pop esi
...
004B6BA5    mov ecx, dword ptr ds:[0x0171E6BC]
004B6BAB    mov dword ptr ds:[esi+0x7694], 0x02
004B6BB5    mov dword ptr ds:[esi+0x7698], eax
004B6BBB    mov dword ptr ds:[0x008DB700], 0x26
004B6BC5    call 0x006889D0
004B6BCA    mov al, 0x01
004B6BCC    mov ecx, dword ptr ss:[ebp-0x0C]
004B6BCF    mov dword ptr fs:[0x00000000], ecx
004B6BD6    pop ecx
004B6BD7    pop edi
004B6BD8    pop esi
...
004B6C4C    mov ecx, dword ptr ds:[0x00CC8DC8]
004B6C52    call 0x004D8AD0
004B6C57    mov al, 0x01
004B6C59    mov ecx, dword ptr ss:[ebp-0x0C]
004B6C5C    mov dword ptr fs:[0x00000000], ecx
004B6C63    pop ecx
004B6C64    pop edi
004B6C65    pop esi
...
004B6CBD    push eax
004B6CBE    call 0x0063D850
004B6CC3    mov ecx, dword ptr ds:[0x00CC8DC8]
004B6CC9    call 0x004D8AD0
004B6CCE    mov al, 0x01
004B6CD0    mov ecx, dword ptr ss:[ebp-0x0C]
004B6CD3    mov dword ptr fs:[0x00000000], ecx
004B6CDA    pop ecx
004B6CDB    pop edi
004B6CDC    pop esi
...
004B6D2B    mov dword ptr fs:[0x00000000], ecx
004B6D32    pop ecx
004B6D33    pop edi
004B6D34    pop esi
...
004B6D45    mov dword ptr fs:[0x00000000], ecx
004B6D4C    pop ecx
004B6D4D    pop edi
004B6D4E    pop esi
...
004B6D5F    call 0x004D8F30
004B6D64    mov edi, eax
004B6D66    mov eax, dword ptr ss:[ebp-0x1C]
...
004B6E07    jz 0x004B6E23
004B6E09    mov ecx, esi
004B6E0B    call 0x0063D4E0
...
004B6E1E    call 0x0064C080
004B6E23    mov dword ptr ds:[esi], 0x801800
004B6E29    mov ecx, dword ptr ds:[0x00CC8DC8]
004B6E2F    call 0x004D8AD0
004B6E34    call 0x004BA8F0
004B6E39    call 0x004B97C0
004B6E3E    mov al, 0x01
004B6E40    mov ecx, dword ptr ss:[ebp-0x0C]
004B6E43    mov dword ptr fs:[0x00000000], ecx
004B6E4A    pop ecx
004B6E4B    pop edi
004B6E4C    pop esi
...
004B6EC2    call 0x004B06C0
004B6EC7    mov dword ptr ss:[ebp-0x04], 0x04
004B6ECE    mov dword ptr ss:[ebp-0x18], 0x801800
004B6ED5    mov dword ptr ss:[ebp-0x14], 0x801800
004B6EDC    mov dl, byte ptr ss:[ebp-0x0D]
004B6EDF    mov ecx, 0x801800
004B6EE4    mov byte ptr ss:[ebp-0x04], 0x06
004B6EE8    mov eax, dword ptr ss:[ebp-0x24]
004B6EEB    test eax, eax
004B6EED    mov esi, dword ptr ss:[ebp-0x1C]
...
004B7159    call 0x0064C080
004B715E    mov al, 0x01
004B7160    mov ecx, dword ptr ss:[ebp-0x0C]
004B7163    mov dword ptr fs:[0x00000000], ecx
004B716A    pop ecx
004B716B    pop edi
004B716C    pop esi
...
004B7174    call 0x004C1F50
004B7179    mov al, 0x01
004B717B    mov ecx, dword ptr ss:[ebp-0x0C]
004B717E    mov dword ptr fs:[0x00000000], ecx
004B7185    pop ecx
004B7186    pop edi
004B7187    pop esi
...
004B7241    call 0x0064C080
004B7246    mov dword ptr ds:[esi+0x04], 0x801800
004B724D    and dword ptr ds:[esi+0x425C], 0xFFFFFFFE
004B7254    mov ecx, dword ptr ds:[0x00CC8DC8]
004B725A    call 0x004D8AD0
004B725F    mov al, 0x01
004B7261    mov ecx, dword ptr ss:[ebp-0x0C]
004B7264    mov dword ptr fs:[0x00000000], ecx
004B726B    pop ecx
004B726C    pop edi
004B726D    pop esi
...
004B72FA    push 0x8033D4
004B72FF    push 0x1083
004B7304    push 0x80292C
004B7309    mov ecx, 0x801AA4
004B730E    jmp 0x004B7ABA
004B7313    mov dword ptr ds:[0x008DBC4C], 0x04
004B731D    mov al, 0x01
004B731F    mov ecx, dword ptr ss:[ebp-0x0C]
004B7322    mov dword ptr fs:[0x00000000], ecx
004B7329    pop ecx
004B732A    pop edi
004B732B    pop esi
...
004B7415    mov dword ptr fs:[0x00000000], ecx
004B741C    pop ecx
004B741D    pop edi
004B741E    pop esi
...
004B7481    mov dword ptr fs:[0x00000000], ecx
004B7488    pop ecx
004B7489    pop edi
004B748A    pop esi
...
004B7498    mov edx, dword ptr ds:[0x00CC8D5C]
...
004B74D2    mov dword ptr fs:[0x00000000], ecx
004B74D9    pop ecx
004B74DA    pop edi
004B74DB    pop esi
...
004B750C    call 0x004B4440
004B7511    mov al, 0x01
004B7513    mov ecx, dword ptr ss:[ebp-0x0C]
004B7516    mov dword ptr fs:[0x00000000], ecx
004B751D    pop ecx
004B751E    pop edi
004B751F    pop esi
...
004B752F    mov dword ptr fs:[0x00000000], ecx
004B7536    pop ecx
004B7537    pop edi
004B7538    pop esi
...
004B75EF    mov dword ptr fs:[0x00000000], ecx
004B75F6    pop ecx
004B75F7    pop edi
004B75F8    pop esi
...
004B761C    mov dword ptr fs:[0x00000000], ecx
004B7623    pop ecx
004B7624    pop edi
004B7625    pop esi
...
004B7628    pop ebp
004B7629    ret
004B762A    push 0x802160
004B762F    push 0xC03
004B7634    jmp 0x004B7AB0
004B7639    mov ecx, dword ptr ds:[edi+0x0C]
004B763C    call 0x004B50B0
004B7641    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004B766E    mov dword ptr fs:[0x00000000], ecx
004B7675    pop ecx
004B7676    pop edi
004B7677    pop esi
...
004B7696    test al, al
004B7698    jz 0x004B747C
004B769E    mov ecx, dword ptr ds:[esi]
004B76A0    call 0x004B50B0
004B76A5    mov dword ptr ss:[ebp-0x2C], eax
004B76A8    test eax, eax
004B76AA    jz 0x004B747C
004B76B0    mov ecx, dword ptr ds:[0x00CC8D5C]
004B76B6    test ecx, ecx
004B76B8    jz 0x004B5DF6
004B76BE    add ecx, 0x507C
004B76C4    push eax
004B76C5    call 0x004BB050
...
004B7709    mov edx, dword ptr ds:[edi+0x1C]
...
004B7769    mov dword ptr fs:[0x00000000], ecx
004B7770    pop ecx
004B7771    pop edi
004B7772    pop esi
...
004B777C    call 0x004B5010
004B7781    mov al, 0x01
004B7783    mov ecx, dword ptr ss:[ebp-0x0C]
004B7786    mov dword ptr fs:[0x00000000], ecx
004B778D    pop ecx
004B778E    pop edi
004B778F    pop esi
...
004B785A    jnl 0x004B7863
004B785C    mov eax, dword ptr ds:[0x00CC8D5C]
...
004B78C3    mov eax, dword ptr ds:[0x00CC8D5C]
...
004B7904    mov dword ptr fs:[0x00000000], ecx
004B790B    pop ecx
004B790C    pop edi
004B790D    pop esi
...
004B7910    pop ebp
004B7911    ret
004B7912    push 0x8021BC
004B7917    push 0xC74
004B791C    mov ecx, 0x80218C
004B7921    jmp 0x004B7AB5
004B7926    lea ecx, ds:[edi+0x0C]
004B7929    call 0x004C5B90
004B792E    mov al, 0x01
004B7930    mov ecx, dword ptr ss:[ebp-0x0C]
004B7933    mov dword ptr fs:[0x00000000], ecx
004B793A    pop ecx
004B793B    pop edi
004B793C    pop esi
...
004B795A    test al, al
004B795C    jz 0x004B747C
004B7962    lea ecx, ds:[edi+0x0C]
004B7965    call 0x004B48F0
004B796A    mov al, 0x01
004B796C    mov ecx, dword ptr ss:[ebp-0x0C]
004B796F    mov dword ptr fs:[0x00000000], ecx
004B7976    pop ecx
004B7977    pop edi
004B7978    pop esi
...
004B7980    call 0x004B5140
004B7985    mov al, 0x01
004B7987    mov ecx, dword ptr ss:[ebp-0x0C]
004B798A    mov dword ptr fs:[0x00000000], ecx
004B7991    pop ecx
004B7992    pop edi
004B7993    pop esi
...
004B799B    call 0x004BA570
004B79A0    mov al, 0x01
004B79A2    mov ecx, dword ptr ss:[ebp-0x0C]
004B79A5    mov dword ptr fs:[0x00000000], ecx
004B79AC    pop ecx
004B79AD    pop edi
004B79AE    pop esi
...
004B79B1    pop ebp
004B79B2    ret
004B79B3    mov eax, dword ptr ds:[0x00CC8D68]
...
004B79D1    mov eax, dword ptr ds:[0x00CC8D68]
...
004B7A01    call 0x004BB1D0
004B7A06    mov al, 0x01
004B7A08    mov ecx, dword ptr ss:[ebp-0x0C]
004B7A0B    mov dword ptr fs:[0x00000000], ecx
004B7A12    pop ecx
004B7A13    pop edi
004B7A14    pop esi
...
004B7A34    mov dword ptr ds:[eax+0x42B4], 0x02
004B7A3E    mov ecx, dword ptr ds:[0x00CC8DC8]
004B7A44    call 0x004D8AD0
004B7A49    mov cl, 0x01
004B7A4B    call 0x004AEB40
004B7A50    mov al, 0x01
004B7A52    mov ecx, dword ptr ss:[ebp-0x0C]
004B7A55    mov dword ptr fs:[0x00000000], ecx
004B7A5C    pop ecx
004B7A5D    pop edi
004B7A5E    pop esi
...
004B7A68    mov dword ptr fs:[0x00000000], ecx
004B7A6F    pop ecx
004B7A70    pop edi
004B7A71    pop esi
...
004B7A8F    call 0x0063B870
004B7A94    add esp, 0x0C
004B7A97    call 0x0063BC30
004B7A9C    test al, al
004B7A9E    jz 0x004B7AA1
004B7AA0    int3
004B7AA1    call 0x0063BB00
004B7AA6    push 0x801B64
004B7AAB    push 0x87
004B7AB0    mov ecx, 0x801AA4
004B7AB5    push 0x801AF8
004B7ABA    mov edx, 0x801800
004B7ABF    call 0x0063B870
004B7AC4    add esp, 0x0C
004B7AC7    call 0x0063BC30
004B7ACC    test al, al
004B7ACE    jz 0x004B7AD1
004B7AD0    int3
004B7AD1    call 0x0063BB00
