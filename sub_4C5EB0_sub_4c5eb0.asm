...
004C5EC9    push eax
004C5ECA    call 0x0063D850
004C5ECF    mov eax, dword ptr ds:[0x008DC144]
004C5ED4    mov esi, 0x801800
004C5ED9    test eax, eax
004C5EDB    mov ecx, esi
004C5EDD    cmovnz ecx, eax
004C5EE0    call 0x004C5E40
004C5EE5    test al, al
004C5EE7    jz 0x004C5F1F
004C5EE9    cmp byte ptr ds:[edi+0x10], 0x00
004C5EED    jz 0x004C5F1F
004C5EEF    mov eax, dword ptr ds:[0x008DC144]
004C5EF4    mov ecx, esi
004C5EF6    test eax, eax
004C5EF8    cmovnz ecx, eax
004C5EFB    call 0x004C5E40
004C5F00    test al, al
004C5F02    jz 0x004C5F1F
004C5F04    mov eax, dword ptr ds:[0x008DC144]
004C5F09    test eax, eax
004C5F0B    cmovnz esi, eax
004C5F0E    mov ecx, esi
004C5F10    call 0x004B8FD0
004C5F15    mov dword ptr ds:[0x008DC148], 0x01
004C5F1F    pop edi
004C5F20    pop esi
004C5F21    pop ebp
004C5F22    ret
