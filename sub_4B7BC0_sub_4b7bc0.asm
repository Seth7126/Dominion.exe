...
004B7BCC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
004B7BD1    xor eax, esp
004B7BD3    mov dword ptr ss:[esp+0x84], eax
004B7BDA    cmp byte ptr ds:[0x0147ABA1], 0x00              ; => [ Data: data_147aba1 ]
004B7BE1    mov eax, dword ptr ds:[0x007E43E4]
004B7BE6    push esi
004B7BE7    push edi
004B7BE8    mov dword ptr ds:[0x00CF65F8], eax              ; => [ Data: data_cf65f8 ]
004B7BED    byte 75
004B7BEE    byte F
004B7BEF    push 0x8728FC                                   ; => [ String: Draw3DAmbientLight ]
004B7BF4    push 0x336
004B7BF9    byte E9
...
004B7C09    mov dword ptr ds:[0x00CF6AA0], 0x3F333333       ; => [ String: 333? | Call: __builtin_strncpy | Data: data_cf6aa0 ]
004B7C13    push eax
004B7C14    movups xmmword ptr ds:[0x00CF6A90], xmm0        ; => [ Data: data_cf6a90 ]
004B7C1B    call 0x006836A0                                 ; => [ Call: sub_6836a0 ]
...
004B7C38    call 0x00683220                                 ; => [ Call: sub_683220 ]
004B7C3D    cmp byte ptr ds:[0x00CC8D6C], 0x00
004B7C44    jz 0x004B7E6A                                   ; => [ Data: data_cc8d6c ]
004B7C4A    mov eax, dword ptr fs:[0x0000002C]
004B7C50    mov esi, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
004B7C52    mov eax, dword ptr ds:[0x019E3CA0]
004B7C57    cmp eax, dword ptr ds:[esi+0x08]
004B7C5D    jle 0x004B7C90                                  ; => [ Data: data_19e3ca0 ]
004B7C5F    push 0x19E3CA0
004B7C64    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_19e3ca0 ]
004B7C69    add esp, 0x04
004B7C6C    cmp dword ptr ds:[0x019E3CA0], 0xFFFFFFFF
004B7C73    jnz 0x004B7C90                                  ; => [ Data: data_19e3ca0 ]
004B7C75    movaps xmm0, xmmword ptr ds:[0x00893690]
004B7C7C    push 0x19E3CA0
004B7C81    movups xmmword ptr ds:[0x019E3CA4], xmm0        ; => [ Data: data_893690 | Data: data_19e3ca4 ]
004B7C88    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_19e3ca0 ]
004B7C8D    add esp, 0x04
004B7C90    mov eax, dword ptr ds:[0x019E3CB4]
004B7C95    cmp eax, dword ptr ds:[esi+0x08]
004B7C9B    jle 0x004B7CD4                                  ; => [ Data: data_19e3cb4 ]
004B7C9D    push 0x19E3CB4
004B7CA2    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_19e3cb4 ]
004B7CA7    add esp, 0x04
004B7CAA    cmp dword ptr ds:[0x019E3CB4], 0xFFFFFFFF
004B7CB1    jnz 0x004B7CD4                                  ; => [ Data: data_19e3cb4 ]
004B7CB3    push 0x19E3CB4
004B7CB8    mov dword ptr ds:[0x019E3CB8], 0x3FC00000       ; => [ Data: data_19e3cb8 ]
004B7CC2    mov dword ptr ds:[0x019E3CBC], 0x00             ; => [ Data: data_19e3cbc ]
004B7CCC    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_19e3cb4 ]
...
004B7D06    addss xmm2, dword ptr ds:[0x019E3CBC]           ; => [ Data: data_8c4634 | Data: data_19e3cbc ]
004B7D0E    movss dword ptr ss:[esp+0x10], xmm0             ; => [ Data: data_19e3ca4 | Data: data_19e3cb8 ]
004B7D14    movss xmm0, dword ptr ds:[0x019E3CA8]
004B7D1C    addss xmm0, xmm2                                ; => [ Data: data_19e3ca8 ]
004B7D20    movss dword ptr ds:[0x019E3CBC], xmm2           ; => [ Data: data_19e3cbc ]
...
004B7D3E    movss dword ptr ss:[esp+0x18], xmm0             ; => [ Data: data_19e3cac | Data: data_19e3cb8 ]
004B7D44    movss xmm0, dword ptr ds:[0x019E3CB0]
004B7D4C    addss xmm0, xmm2
004B7D50    movss dword ptr ss:[esp+0x1C], xmm0             ; => [ Data: data_19e3cb0 ]
004B7D56    movups xmm0, xmmword ptr ss:[esp+0x10]
004B7D5B    movups xmmword ptr ds:[0x019E3CA4], xmm0        ; => [ Data: data_19e3ca4 ]
004B7D62    call 0x00682F00                                 ; => [ Data: data_19e3ca4 | Call: sub_682f00 | Data: data_7e5d1c ]
004B7D67    movss xmm3, dword ptr ds:[0x00890E18]
004B7D6F    lea ecx, ss:[esp+0x30]
004B7D73    movss xmm5, dword ptr ds:[0x019E3CA4]           ; => [ Data: data_19e3ca4 ]
004B7D7B    mov edx, 0x7E43E4
004B7D80    movss xmm2, dword ptr ds:[0x019E3CA8]           ; => [ Data: data_19e3ca8 ]
004B7D88    movss xmm4, dword ptr ds:[0x019E3CB0]           ; => [ Data: data_19e3cb0 ]
...
004B7DB6    movss xmm0, dword ptr ds:[0x019E3CAC]           ; => [ Data: data_19e3cac ]
...
004B7E36    call 0x00682F00                                 ; => [ Call: sub_682f00 | Data: data_7e43e4 ]
004B7E3B    mov edx, 0x7E43E4
004B7E40    lea ecx, ss:[esp+0x40]
004B7E44    call 0x00682F00                                 ; => [ Call: sub_682f00 | Data: data_7e43e4 ]
004B7E49    mov edx, 0x7E43E4
004B7E4E    lea ecx, ss:[esp+0x60]
004B7E52    call 0x00682F00                                 ; => [ Call: sub_682f00 | Data: data_7e43e4 ]
004B7E57    mov edx, 0x7E43E4
004B7E5C    lea ecx, ss:[esp+0x10]
004B7E60    call 0x00682F00                                 ; => [ Call: sub_682f00 | Data: data_7e43e4 ]
004B7E65    jmp 0x004B7F81
004B7E6A    cmp dword ptr ds:[0x019E3984], 0x00
004B7E71    jnz 0x004B7F01                                  ; => [ Data: data_19e3984 ]
004B7E77    cmp dword ptr ds:[0x01597CD4], 0x02
004B7E7E    jnz 0x004B7E8A                                  ; => [ Data: data_1597cd4 ]
004B7E80    mov dword ptr ds:[0x01597CD4], 0x01             ; => [ Data: data_1597cd4 ]
004B7E8A    xor esi, esi
004B7E8C    nop dword ptr ds:[eax], eax
004B7E90    mov ecx, dword ptr ds:[esi+0x8DB5B0]            ; => [ Data: data_8db5b0 ]
004B7E96    test ecx, ecx
004B7E98    jz 0x004B7EC3
004B7E9A    call 0x0064E7A0
004B7E9F    mov ecx, eax
004B7EA1    call 0x00664D00                                 ; => [ Call: sub_64e7a0 | Call: sub_664d00 ]
004B7EA6    mov ecx, dword ptr ds:[esi+0x8DB5AC]
004B7EAC    call 0x004D3B00
004B7EB1    mov eax, dword ptr ds:[eax+0x10]                ; => [ Data: data_8db5ac | Call: sub_4d3b00 ]
004B7EB4    test eax, eax
004B7EB6    jz 0x004B7EC3
004B7EB8    push dword ptr ds:[esi+0x8DB5B0]
004B7EBE    call eax                                        ; => [ Data: data_8db5b0 ]
004B7EC0    add esp, 0x04
004B7EC3    mov ecx, dword ptr ds:[esi+0x8DB5A0]            ; => [ Data: data_8db5a0 ]
004B7EC9    test ecx, ecx
004B7ECB    jz 0x004B7EF6
004B7ECD    call 0x0064E7A0
004B7ED2    mov ecx, eax
004B7ED4    call 0x00664D00                                 ; => [ Call: sub_64e7a0 | Call: sub_664d00 ]
004B7ED9    mov ecx, dword ptr ds:[esi+0x8DB59C]
004B7EDF    call 0x004D3B00
004B7EE4    mov eax, dword ptr ds:[eax+0x10]                ; => [ Data: data_8db59c | Call: sub_4d3b00 ]
004B7EE7    test eax, eax
004B7EE9    jz 0x004B7EF6
004B7EEB    push dword ptr ds:[esi+0x8DB5A0]
004B7EF1    call eax                                        ; => [ Data: data_8db5a0 ]
...
004B7FCF    call 0x00649D30                                 ; => [ Call: sub_649d30 ]
004B7FD4    mov al, byte ptr ds:[0x0147ABA1]                ; => [ Data: data_147aba1 ]
004B7FD9    test al, al
004B7FDB    jz 0x004B8082
004B7FE1    mov ecx, dword ptr ds:[0x00CF6B14]              ; => [ Data: data_cf6b14 ]
004B7FE7    xor esi, esi
004B7FE9    mov dword ptr ss:[esp+0x2C], ecx
004B7FED    mov dword ptr ds:[0x00CF6B14], 0x2DE60000       ; => [ Data: data_cf6b14 ]
004B7FF7    cmp dword ptr ds:[0x00B80A70], esi
004B7FFD    jle 0x004B804F                                  ; => [ Data: data_b80a70 ]
004B7FFF    mov edx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
004B8005    test edx, edx
004B8007    jz 0x004B8055
004B8009    mov eax, dword ptr ds:[esi*4+0xB80A30]          ; => [ Data: data_b80a30 ]
...
004B8032    call 0x006C24D0                                 ; => [ Data: data_bf21e8 | Call: sub_6c24d0 ]
004B8037    mov edx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
004B803D    inc esi
004B803E    cmp esi, dword ptr ds:[0x00B80A70]
004B8044    jl 0x004B8005                                   ; => [ Data: data_b80a70 ]
004B8046    mov al, byte ptr ds:[0x0147ABA1]                ; => [ Data: data_147aba1 ]
004B804B    mov ecx, dword ptr ss:[esp+0x2C]
004B804F    test al, al
004B8051    jz 0x004B8082
004B8053    jmp 0x004B8068
004B8055    push 0x871F88                                   ; => [ String: GetGameData ]
004B805A    push 0x45
004B805C    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
004B8061    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
004B8066    jmp 0x004B8096
004B8068    mov dword ptr ds:[0x00CF6B14], ecx              ; => [ Data: data_cf6b14 ]
004B806E    mov ecx, dword ptr ss:[esp+0x8C]
004B8075    pop edi
004B8076    pop esi
004B8077    xor ecx, esp
004B8079    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004B807E    mov esp, ebp
004B8080    pop ebp
004B8081    ret
004B8082    push 0x8728D8                                   ; => [ String: Draw3DLayer ]
004B8087    push 0x32C
004B808C    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
004B8091    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
004B8096    mov edx, 0x801800
004B809B    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004B80A0    add esp, 0x0C
004B80A3    call 0x0063BC30
004B80A8    test al, al
004B80AA    jz 0x004B80AD                                   ; => [ Call: sub_63bc30 ]
004B80AC    int3
004B80AD    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
