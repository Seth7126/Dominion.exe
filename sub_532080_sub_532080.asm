...
0053208B    call 0x00761E50
00532090    mov eax, dword ptr ds:[0x008C4040]
...
0053217A    mov eax, dword ptr ds:[eax+0x1504]
...
005321B2    setz cl
005321B5    call 0x0061B1B0
005321BA    add esp, 0x2C
005321BD    mov edx, 0x3EE
005321C2    lea ecx, ss:[esp+0xCA0]
005321C9    call 0x00569500
005321CE    call 0x00573400
