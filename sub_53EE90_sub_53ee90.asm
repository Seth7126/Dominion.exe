...
0053EF12    movlpd qword ptr ss:[esp+0x34], xmm0
...
0053EFA2    mov eax, dword ptr ds:[eax+0x0C]
0053EFA5    mov dword ptr ss:[esp+0x2C], eax
0053EFA9    call 0x00573400
...
0053EFC4    call 0x00591930
0053EFC9    push dword ptr ss:[esp+0x1C]
...
0053EFF7    call 0x00565FF0
0053EFFC    add esp, 0x1C
0053EFFF    call 0x00573400
...
0053F067    setz cl
0053F06A    call 0x0061B1B0
0053F06F    add esp, 0x2C
0053F072    call 0x00573400
