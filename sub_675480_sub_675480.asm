...
00675485    push 0x76D79E                                   ; => [ Type: EHRegistrationNode | Call: sub_76d79e ]
0067548A    mov eax, dword ptr fs:[0x00000000]
00675490    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00675491    sub esp, 0x10
00675494    push esi
00675495    push edi
00675496    mov eax, dword ptr ds:[0x008C4040]
0067549B    xor eax, ebp
0067549D    push eax                                        ; => [ Data: __security_cookie ]
0067549E    lea eax, ss:[ebp-0x0C]
006754A1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006754C3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006754C8    inc dword ptr ds:[eax+0x04]
006754CB    lea ecx, ss:[ebp-0x10]
006754CE    call 0x0063E330                                 ; => [ Call: sub_63e330 ]
006754D3    add esp, 0x04
006754D6    mov dword ptr ss:[ebp-0x04], 0x01
006754DD    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0067550B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067552B    jz 0x006755E3                                   ; => [ Data: data_cf65bc ]
00675531    jmp 0x006755BF
00675536    test eax, eax
00675538    jnz 0x006755F6
0067553E    mov eax, 0x801800                               ; => [ Data: data_801800 ]
00675543    mov edx, eax                                    ; => [ Data: data_801800 ]
00675545    sub ecx, eax
00675547    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
0067554E    push ecx
0067554F    push edx
00675550    lea ecx, ss:[ebp-0x14]
00675553    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
0067556C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067558F    jz 0x006755AC                                   ; => [ Data: data_cf65bc ]
00675591    lea ecx, ss:[ebp-0x14]
00675594    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006755CB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006755DE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006755E3    mov eax, edi
006755E5    mov ecx, dword ptr ss:[ebp-0x0C]
006755E8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006755EF    pop ecx
006755F0    pop edi
006755F1    pop esi
...
00675600    push 0x871DD4                                   ; => [ String: XString::XString ]
00675605    push 0x9A
0067560A    push 0x871D5C
0067560F    mov edx, 0x801800
00675614    mov ecx, 0x871E0C
00675619    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: str | String: C:\x\ax2017\Engine\xString.cpp ]
0067561E    add esp, 0x0C
00675621    call 0x0063BC30
00675626    test al, al
00675628    jz 0x0067562B                                   ; => [ Call: sub_63bc30 ]
0067562A    int3
0067562B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
