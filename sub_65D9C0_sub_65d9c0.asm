...
0065D9C5    push 0x76CFD5                                   ; => [ Call: __ehhandler$??1?$source_block@V?$multi_link_registry@V?$ITarget@W4agent_status@Concurrency@@@Concurrency@@@Concurrency@@V?$ordered_message_processor@W4agent_status@Concurrency@@@2@@Concurrency@@UAE@XZ | Type: EHRegistrationNode ]
0065D9CA    mov eax, dword ptr fs:[0x00000000]
0065D9D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0065D9D1    sub esp, 0x08
0065D9D4    push esi
0065D9D5    mov eax, dword ptr ds:[0x008C4040]
0065D9DA    xor eax, ebp
0065D9DC    push eax                                        ; => [ Data: __security_cookie ]
0065D9DD    lea eax, ss:[ebp-0x0C]
0065D9E0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0065D9F9    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
0065DA0E    push eax
0065DA0F    call 0x0063DDE0                                 ; => [ Call: sub_63dde0 ]
0065DA14    mov byte ptr ss:[ebp-0x04], 0x03
0065DA18    cmp dword ptr ds:[0x00CF65BC], 0x00
0065DA1F    jz 0x0065DA48                                   ; => [ Data: data_cf65bc ]
...
0065DA30    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DA43    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065DA48    mov byte ptr ss:[ebp-0x04], 0x02
0065DA4C    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0065DA51    mov eax, dword ptr ss:[ebp+0x08]
0065DA54    mov ecx, esi                                    ; => [ Data: data_801800 ]
0065DA56    test eax, eax
0065DA58    push 0x00
0065DA5A    cmovnz ecx, eax
0065DA5D    xor edx, edx
0065DA5F    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 ]
...
0065DA80    jz 0x0065DAA9                                   ; => [ Data: data_cf65bc ]
...
0065DA91    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DAA4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065DAA9    mov eax, esi
0065DAAB    mov ecx, dword ptr ss:[ebp-0x0C]
0065DAAE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0065DAB5    pop ecx
0065DAB6    pop esi
...
0065DAC9    jz 0x0065DAF2                                   ; => [ Data: data_cf65bc ]
...
0065DADA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0065DAED    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0065DAF2    xor eax, eax
0065DAF4    mov ecx, dword ptr ss:[ebp-0x0C]
0065DAF7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0065DAFE    pop ecx
0065DAFF    pop esi
...
0065DB1D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
0065DB22    add esp, 0x0C
0065DB25    call 0x0063BC30
0065DB2A    test al, al
0065DB2C    jz 0x0065DB2F                                   ; => [ Call: sub_63bc30 ]
0065DB2E    int3
0065DB2F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
