...
0054417C    mov eax, dword ptr ds:[0x008C4040]
00544181    xor eax, esp
00544183    mov dword ptr ss:[esp+0xC94], eax
0054418A    call 0x00573400
0054418F    sub esp, 0x28
00544192    mov ecx, dword ptr ds:[eax+0x0C]
00544195    mov eax, esp
00544197    mov dword ptr ds:[eax], 0x81B9A8
0054419D    mov dword ptr ds:[eax+0x04], ecx
005441A0    mov dword ptr ds:[eax+0x24], eax
005441A3    call 0x005699B0
005441A8    push 0x02
