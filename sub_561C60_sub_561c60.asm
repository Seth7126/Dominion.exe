...
00561CD0    call 0x0063B870
00561CD5    add esp, 0x0C
00561CD8    call 0x0063BC30
00561CDD    test al, al
00561CDF    jz 0x00561CE2
00561CE1    int3
00561CE2    call 0x0063BB00
