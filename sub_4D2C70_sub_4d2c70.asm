...
004D2C75    push 0x76360B                                   ; => [ Type: EHRegistrationNode | Call: sub_76360b ]
004D2C7A    mov eax, dword ptr fs:[0x00000000]
004D2C80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D2C92    push esi
004D2C93    push edi
004D2C94    push eax                                        ; => [ Data: __security_cookie ]
004D2C95    lea eax, ss:[ebp-0x0C]
004D2C98    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D2C9E    mov ebx, dword ptr ss:[ebp+0x08]
004D2CA1    mov ecx, ebx
004D2CA3    call 0x0064E7A0
004D2CA8    mov dword ptr ds:[eax+0x18BC], 0x4D0900         ; => [ Call: sub_64e7a0 | Call: sub_4d0900 ]
004D2CB2    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D2CD1    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004D2CEE    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D2CF3    movss xmm3, dword ptr ds:[0x00890E18]
004D2CFB    mov edx, 0x8DB9E8
004D2D00    push 0x00
004D2D02    push 0xFFFFFFFF
004D2D04    mov ecx, eax
004D2D06    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8db9e8 ]
004D2D0B    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D2DE4    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004D2E05    test al, al
004D2E07    jnz 0x004D2EE0                                  ; => [ Call: sub_4db700 ]
004D2E0D    inc esi
...
004D2E31    jl 0x004D2DC8                                   ; => [ Data: data_77fea0 ]
...
004D2ED9    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8db9c4 ]
...
004D3073    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D3078    movss xmm3, dword ptr ds:[0x00890E18]
004D3080    mov edx, 0x8DBA48
004D3085    push 0x00
004D3087    push 0xFFFFFFFF
004D3089    mov ecx, eax
004D308B    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dba48 ]
004D3090    add esp, 0x08
004D3093    mov dword ptr ss:[ebp-0x158], 0x801800          ; => [ Data: data_801800 ]
004D309D    mov byte ptr ss:[ebp-0x04], 0x01
004D30A1    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004D30A7    mov dword ptr ds:[0x019E3988], 0x00             ; => [ Data: data_19e3988 ]
004D30B1    test esi, esi
004D30B3    jnz 0x004D30CB
004D30B5    push 0x77EB90                                   ; => [ String: GetClient ]
004D30BA    push 0x7B
004D30BC    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004D30C1    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004D30C6    jmp 0x004D37A2
004D30CB    lea eax, ds:[esi+0x20]
004D30CE    push eax
004D30CF    lea ecx, ss:[ebp-0x158]
004D30D5    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
004D3105    jnz 0x004D310E                                  ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004D3107    mov eax, 0x8DC840                               ; => [ Data: data_8dc840 ]
...
004D3126    jnz 0x004D312F                                  ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004D3128    mov eax, 0x8DC84C                               ; => [ Data: data_8dc84c ]
...
004D313F    mov eax, 0x8DC858                               ; => [ Data: data_8dc858 ]
004D3144    jmp 0x004D316B
004D3146    mov eax, 0x8DC864                               ; => [ Data: data_8dc864 ]
004D314B    jmp 0x004D316B
004D314D    mov eax, 0x8DC870                               ; => [ Data: data_8dc870 ]
004D3152    jmp 0x004D316B
004D3154    mov eax, 0x8DC87C                               ; => [ Data: data_8dc87c ]
004D3159    jmp 0x004D316B
004D315B    mov eax, 0x8DC888                               ; => [ Data: data_8dc888 ]
004D3160    jmp 0x004D316B
004D3162    mov eax, 0x8DC894                               ; => [ Data: data_8dc894 ]
004D3167    jmp 0x004D316B
004D3169    xor eax, eax                                    ; => [ Call: nullptr ]
004D316B    mov dword ptr ss:[ebp-0x154], eax
004D3171    mov edx, 0x8DB9A0
004D3176    mov dword ptr ds:[0x019E3988], eax              ; => [ Data: data_19e3988 ]
004D317B    mov ecx, ebx
004D317D    lea eax, ss:[ebp-0x158]
004D3183    push 0xFFFFFFFF
004D3185    push eax
004D3186    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8db9a0 ]
004D318B    mov esi, dword ptr ss:[ebp-0x158]
004D3191    add esp, 0x08
004D3194    test esi, esi
004D3196    mov eax, 0x801800                               ; => [ Data: data_801800 ]
004D319B    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
004D324E    test al, al
004D3250    jz 0x004D32F7                                   ; => [ Call: sub_4be9d0 ]
...
004D3275    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004D32EF    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
004D33B2    push eax
004D33B3    call 0x0060A040                                 ; => [ Call: sub_60a040 ]
...
004D36A6    jz 0x004D36C6                                   ; => [ Data: data_cf65bc ]
004D36A8    lea ecx, ss:[ebp-0x158]
004D36AE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D36C1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004D36DD    jz 0x004D36FD                                   ; => [ Data: data_cf65bc ]
004D36DF    lea ecx, ss:[ebp-0x160]
004D36E5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D36F8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D36FD    mov ecx, dword ptr ss:[ebp-0x0C]
004D3700    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D3707    pop ecx
004D3708    pop edi
004D3709    pop esi
004D370A    pop ebx
...
004D3710    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004D3732    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: TitleUpdate | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp | String: Halt ]
004D3737    add esp, 0x0C
004D373A    call 0x0063BC30
004D373F    test al, al
004D3741    jz 0x004D3744                                   ; => [ Call: sub_63bc30 ]
004D3743    int3
004D3744    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004D3749    push 0x77EB90
004D374E    push 0x7B
004D3750    push 0x77EB50
004D3755    mov edx, 0x801800
004D375A    mov ecx, 0x77EB9C
004D375F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004D3764    add esp, 0x0C
004D3767    call 0x0063BC30
004D376C    test al, al
004D376E    jz 0x004D3771                                   ; => [ Call: sub_63bc30 ]
004D3770    int3
004D3771    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004D3776    push 0x8053E4                                   ; => [ String: TitleUpdate ]
004D377B    push 0x2DBB
004D3780    jmp 0x004D3798
004D3782    push 0x803214                                   ; => [ String: ShouldShowNewProductBanner ]
004D3787    push 0xCD4
004D378C    jmp 0x004D3798
004D378E    push 0x8051E8                                   ; => [ String: ServerStatusMsg ]
004D3793    push 0x2B69
004D3798    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D379D    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004D37A2    mov edx, 0x801800
004D37A7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004D37AC    add esp, 0x0C
004D37AF    call 0x0063BC30
004D37B4    test al, al
004D37B6    jz 0x004D37B9                                   ; => [ Call: sub_63bc30 ]
004D37B8    int3
004D37B9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
