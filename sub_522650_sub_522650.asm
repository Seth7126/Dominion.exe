...
00522660    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00522661    mov eax, 0x1938
00522666    call 0x00761E50                                 ; => [ Call: __chkstk ]
0052266B    mov eax, dword ptr ds:[0x008C4040]
00522670    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00522672    mov dword ptr ss:[ebp-0x10], eax
00522675    push esi
00522676    push edi
00522677    push eax
00522678    lea eax, ss:[ebp-0x0C]
0052267B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00522681    lea eax, ss:[ebp-0x1944]
00522687    mov ecx, 0x3EA
0052268C    push eax
0052268D    call 0x00568780                                 ; => [ Call: sub_568780 ]
00522692    mov esi, eax
00522694    mov dword ptr ss:[ebp-0xCC0], 0x817CA0          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_1c979890a6dcb4cbed41b22840785eed>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_1c979890a6dcb4cbed41b22840785eed>,bool,enum CardID>::VTable ]
0052269E    mov ecx, 0x321
005226A3    lea edi, ss:[ebp-0xC94]
005226A9    lea eax, ss:[ebp-0xCC0]
005226AF    add esp, 0x04
005226B2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005226B4    mov dword ptr ss:[ebp-0xC9C], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_1c979890a6dcb4cbed41b22840785eed>,bool,enum CardID>::VTable ]
...
005226F2    push esi
005226F3    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0052270F    mov edi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00522725    push eax
00522726    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
00522729    test edi, edi
0052272B    setnle al
0052272E    mov ecx, dword ptr ss:[ebp-0x0C]
00522731    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00522738    pop ecx
00522739    pop edi
0052273A    pop esi
0052273B    mov ecx, dword ptr ss:[ebp-0x10]
0052273E    xor ecx, ebp
00522740    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
