...
004E9E85    push 0x762A80                                   ; => [ Call: __ehhandler$??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBDI@Z | Type: EHRegistrationNode ]
004E9E8A    mov eax, dword ptr fs:[0x00000000]
004E9E90    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E9E9E    push eax                                        ; => [ Data: __security_cookie ]
004E9E9F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004E9EA2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E9EE3    jz 0x004E9F10                                   ; => [ Data: data_cf65bc ]
...
004E9EF2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E9F05    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E9F0A    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
004E9F10    mov edx, 0x0C
004E9F15    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004E9F1C    mov ecx, edi
004E9F1E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E9F55    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E9F5A    mov dword ptr ds:[ebx], 0x00
004E9F60    mov ecx, dword ptr ss:[ebp-0x0C]
004E9F63    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E9F6A    pop ecx
004E9F6B    pop edi
004E9F6C    pop esi
004E9F6D    pop ebx
