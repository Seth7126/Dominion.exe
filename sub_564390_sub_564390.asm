...
0056439B    call 0x00761E50                                 ; => [ Call: __chkstk ]
005643A0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005643A5    xor eax, esp
005643A7    mov dword ptr ss:[esp+0x190C], eax
005643AE    push esi
005643AF    push edi
005643B0    call 0x00573400                                 ; => [ Call: sub_573400 ]
005643B5    mov edi, eax
005643B7    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005643D1    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
005643EB    mov esi, eax                                    ; => [ Call: sub_593ca0 ]
005643ED    add esp, 0x10
005643F0    test esi, esi
005643F2    jnz 0x00564435
005643F4    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056440E    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00564428    mov esi, eax                                    ; => [ Call: sub_593ca0 ]
...
00564473    call 0x00623B70                                 ; => [ Call: nullptr | Call: sub_623b70 | Data: data_cce9d8 ]
...
005644C6    push 0x1C
005644C8    push eax
005644C9    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
005644DE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00564527    push 0x1C
00564529    push eax
0056452A    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
00564541    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
