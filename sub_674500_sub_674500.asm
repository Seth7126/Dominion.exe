...
00674508    call 0x00761E50                                 ; => [ Call: __chkstk ]
0067450D    mov eax, dword ptr ds:[0x008C4040]
00674512    xor eax, ebp
00674514    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
...
00674561    push 0x87650C                                   ; => [ String: AttribTreeItemGetByIndex ]
00674566    push 0x4CA2
0067456B    mov ecx, 0x814428                               ; => [ String: idx >= 0 ]
00674570    jmp 0x0067489B
00674575    cmp ebx, dword ptr ds:[esi+0x08]
00674578    jl 0x0067458E
0067457A    push 0x87650C                                   ; => [ String: AttribTreeItemGetByIndex ]
0067457F    push 0x4CA3
00674584    mov ecx, 0x8764F8                               ; => [ String: idx < tree.numItems ]
...
006745B3    push 0x87654C                                   ; => [ String: AttribTreeItemMove ]
006745B8    push 0x4CC5
006745BD    mov ecx, 0x876528                               ; => [ String: source - tree.items == sourceIdx ]
006745C2    jmp 0x0067489B
006745C7    mov edx, ebx
006745C9    mov ecx, esi
006745CB    call 0x00666FD0                                 ; => [ Call: sub_666fd0 ]
...
0067460F    call 0x006744C0                                 ; => [ Call: sub_6744c0 ]
...
00674638    push 0x87650C                                   ; => [ String: AttribTreeItemGetByIndex ]
0067463D    push 0x4CA2
00674642    mov ecx, 0x814428                               ; => [ String: idx >= 0 ]
...
00674657    push 0x87650C                                   ; => [ String: AttribTreeItemGetByIndex ]
0067465C    push 0x4CA3
00674661    mov ecx, 0x8764F8                               ; => [ String: idx < tree.numItems ]
...
00674682    call 0x00666FD0                                 ; => [ Call: sub_666fd0 ]
...
006746AE    push 0x87654C                                   ; => [ String: AttribTreeItemMove ]
006746B3    push 0x4CD7
006746B8    mov ecx, 0x876560                               ; => [ String: sourceCount < MAX_SELECTED ]
...
006746D5    push eax
006746D6    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
00674703    push 0x87650C                                   ; => [ String: AttribTreeItemGetByIndex ]
00674708    push 0x4CA2
0067470D    mov ecx, 0x814428                               ; => [ String: idx >= 0 ]
...
00674722    push 0x87650C                                   ; => [ String: AttribTreeItemGetByIndex ]
00674727    push 0x4CA3
0067472C    mov ecx, 0x8764F8                               ; => [ String: idx < tree.numItems ]
...
0067476F    call 0x006744C0                                 ; => [ Call: sub_6744c0 ]
...
0067484D    push eax
0067484E    call 0x00762362                                 ; => [ Call: memmove ]
...
00674870    push eax
00674871    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
00674881    pop esi
00674882    pop ebx
00674883    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00674888    mov esp, ebp
0067488A    pop ebp
0067488B    ret
0067488C    push 0x87654C                                   ; => [ String: AttribTreeItemMove ]
00674891    push 0x4CE4
00674896    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0067489B    push 0x8739B4
006748A0    mov edx, 0x801800
006748A5    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\UI2.cpp ]
006748AA    add esp, 0x0C
006748AD    call 0x0063BC30
006748B2    test al, al
006748B4    jz 0x006748B7                                   ; => [ Call: sub_63bc30 ]
006748B6    int3
006748B7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
