...
005448B8    push 0x76506B                                   ; => [ Call: sub_76506b | Type: EHRegistrationNode ]
005448BD    mov eax, dword ptr fs:[0x00000000]
005448C3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005448C4    push ebx
005448C5    mov eax, 0x19C0
005448CA    call 0x00761E50                                 ; => [ Call: __chkstk ]
005448CF    mov eax, dword ptr ds:[0x008C4040]
005448D4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
005448D6    mov dword ptr ss:[ebp-0x14], eax
005448D9    push esi
005448DA    push edi
005448DB    push eax
005448DC    lea eax, ss:[ebp-0x0C]
005448DF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005448E5    xor edx, edx
005448E7    push ecx
005448E8    push 0x00
005448EA    lea ecx, ds:[edx+0x02]
005448ED    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
005448F2    push 0x00
005448F4    push 0x00
005448F6    push 0x00
...
005448FE    push 0x04
00544900    push eax
00544901    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
00544906    mov esi, eax
00544908    mov dword ptr ss:[ebp-0xD18], 0x81B98C          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_b07f2382f367be6b04c00ae49dd9a99f>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_b07f2382f367be6b04c00ae49dd9a99f>,bool,enum CardID>::VTable ]
00544912    mov ecx, 0x321
00544917    lea edi, ss:[ebp-0xCA0]
0054491D    lea eax, ss:[ebp-0xD18]
00544923    add esp, 0x1C
00544926    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00544928    mov dword ptr ss:[ebp-0xCF4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_b07f2382f367be6b04c00ae49dd9a99f>,bool,enum CardID>::VTable ]
...
00544969    call eax                                        ; => [ Field: vFunc_0 ]
...
0054498C    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
005449A3    push eax
005449A4    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
005449A7    xorps xmm0, xmm0
005449AA    mov dword ptr ss:[ebp-0xCE4], 0x00
005449B4    movlpd qword ptr ss:[ebp-0xCEC], xmm0           ; => [ Call: __builtin_memset ]
...
00544A67    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00544A89    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00544AD9    push eax
00544ADA    call 0x00586320                                 ; => [ Call: sub_586320 ]
00544ADF    add esp, 0x10
00544AE2    mov ecx, dword ptr ss:[ebp-0x0C]
00544AE5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00544AEC    pop ecx
00544AED    pop edi
00544AEE    pop esi
00544AEF    mov ecx, dword ptr ss:[ebp-0x14]
00544AF2    xor ecx, ebp
00544AF4    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
