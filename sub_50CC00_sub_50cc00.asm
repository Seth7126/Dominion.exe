...
0050CC09    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0050CC29    add eax, 0x174C                                 ; => [ Call: sub_573400 ]
0050CC2E    nop
...
0050CC51    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0050CC66    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050CC8D    pop ebx
0050CC8E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0050CCB0    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: LookupLandscape | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: Halt ]
0050CCB5    add esp, 0x0C
0050CCB8    call 0x0063BC30
0050CCBD    test al, al
0050CCBF    jz 0x0050CCC2                                   ; => [ Call: sub_63bc30 ]
0050CCC1    int3
0050CCC2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
