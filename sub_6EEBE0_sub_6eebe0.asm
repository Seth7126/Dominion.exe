...
006EEBED    call 0x006EE800
006EEBF2    test eax, eax
006EEBF4    jnz 0x006EEC0A
006EEBF6    push 0x88B1D0
006EEBFB    push 0x2E6
006EEC00    mov ecx, 0x88B1B4
...
006EEC52    push ecx
006EEC53    push eax
006EEC54    call dword ptr ds:[0x007753C4]
...
006EECE1    pop ebp
006EECE2    ret
006EECE3    push 0x88B1D0
006EECE8    push 0x2E8
006EECED    mov ecx, 0x88B210
006EECF2    push 0x88AF54
006EECF7    mov edx, 0x801800
006EECFC    call 0x0063B870
006EED01    add esp, 0x0C
006EED04    call 0x0063BC30
006EED09    test al, al
006EED0B    jz 0x006EED0E
006EED0D    int3
006EED0E    call 0x0063BB00
