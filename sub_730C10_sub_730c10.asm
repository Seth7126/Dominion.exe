...
00730C8E    movss dword ptr ss:[ebp-0x90], xmm0
...
00730CB7    movups xmmword ptr ss:[ebp-0x80], xmm0
...
00730DB8    call 0x00683220
00730DBD    movss xmm0, dword ptr ss:[ebp-0x50]
00730DC2    lea edx, ss:[ebp-0x28]
00730DC5    push dword ptr ds:[0x01A9A3DC]
00730DCB    mov ecx, dword ptr ds:[0x01A9A3D4]
...
00730DFB    call 0x00682A60
00730E00    mov eax, dword ptr ds:[0x0147B06C]
00730E05    add esp, 0x0C
00730E08    mov dword ptr ds:[eax+0x2DC], 0x00
00730E12    movups xmm0, xmmword ptr ds:[0x00800890]
00730E19    movups xmmword ptr ds:[eax+0x124], xmm0
...
00730F1B    call 0x0064C080
00730F20    mov dword ptr ss:[ebp-0x3C], 0x801800
...
00730F3B    jz 0x00730F5F
00730F3D    lea ecx, ss:[ebp-0x48]
00730F40    call 0x0063D4E0
...
00730F53    call 0x0064C080
00730F58    mov dword ptr ss:[ebp-0x48], 0x801800
...
00730F73    jz 0x00730F97
00730F75    lea ecx, ss:[ebp-0x4C]
00730F78    call 0x0063D4E0
...
00730F8B    call 0x0064C080
00730F90    mov dword ptr ss:[ebp-0x4C], 0x801800
00730F97    mov byte ptr ss:[ebp-0x04], 0x0E
00730F9B    cmp dword ptr ds:[0x00CF65BC], 0x00
00730FA2    jz 0x00730FD2
...
00730FC6    call 0x0064C080
00730FCB    mov dword ptr ss:[ebp-0x44], 0x801800
00730FD2    mov edi, dword ptr ss:[ebp-0x58]
00730FD5    mov edx, 0x801800
...
00730FF1    call 0x006A1230
00730FF6    mov ecx, dword ptr ds:[0x01A9A3E0]
00730FFC    mov esi, eax
00730FFE    mov eax, dword ptr fs:[0x0000002C]
00731004    add esp, 0x0C
00731007    mov dword ptr ds:[0x019E2774], esi
0073100D    mov edx, dword ptr ds:[eax]
0073100F    cmp ecx, dword ptr ds:[edx+0x08]
00731015    jle 0x00731060
00731017    push 0x1A9A3E0
0073101C    call 0x0075970E
00731021    add esp, 0x04
00731024    cmp dword ptr ds:[0x01A9A3E0], 0xFFFFFFFF
0073102B    jnz 0x0073105A
0073102D    push 0x00
...
00731044    mov dword ptr ds:[0x01A9A3E4], eax
00731049    mov byte ptr ss:[ebp-0x04], 0x0D
0073104D    push 0x1A9A3E0
00731052    call 0x007596BD
00731057    add esp, 0x04
0073105A    mov esi, dword ptr ds:[0x019E2774]
00731060    mov eax, dword ptr ds:[0x00CF65B8]
00731065    cmp dword ptr ds:[eax+0x1C], 0x00
00731069    jnz 0x0073117E
0073106F    mov ecx, dword ptr ds:[0x0147B06C]
00731075    mov edx, dword ptr ds:[0x01A9A3E4]
0073107B    push 0x00
...
007310AF    call 0x006AD5D0
007310B4    mov ecx, dword ptr ds:[0x0147B070]
007310BA    add esp, 0x04
007310BD    mov eax, dword ptr ds:[ecx]
007310BF    push 0x00
007310C1    push dword ptr ds:[0x00CF65F8]
007310C7    call dword ptr ds:[eax+0x90]
007310CD    call 0x00645E30
007310D2    call 0x00649120
007310D7    mov ecx, 0x02
007310DC    call 0x006494F0
007310E1    call 0x00649C60
007310E6    call dword ptr ds:[0x00775228]
007310EC    call 0x006ADB80
007310F1    mov esi, dword ptr ds:[0x019E2774]
007310F7    mov dword ptr ss:[ebp-0x04], 0x10
007310FE    cmp dword ptr ds:[0x00CF65BC], 0x00
00731105    jz 0x0073112E
