...
005FD8FB    call 0x00761E50                                 ; => [ Call: __chkstk ]
005FD900    mov eax, dword ptr ds:[0x008C4040]
005FD905    xor eax, esp
005FD907    mov dword ptr ss:[esp+0x3488], eax              ; => [ Data: __security_cookie ]
005FD90E    push ebx
...
005FD91B    mov dword ptr ds:[eax+0x18BC], 0x5FB080         ; => [ Call: sub_5fb080 | Call: sub_64e7a0 ]
005FD925    call 0x004BBDB0                                 ; => [ Call: sub_4bbdb0 ]
...
005FD946    push eax
005FD947    call 0x00761FBE                                 ; => [ Call: memcpy | Call: sub_4e49d0 ]
005FD94C    add esp, 0x0C
005FD94F    mov dword ptr ss:[esp+0x19C8], 0xBE49E4         ; => [ Data: data_be49e4 ]
005FD95A    xor esi, esi
005FD95C    mov dword ptr ss:[esp+0x19CC], 0xBE468C         ; => [ Data: data_be468c ]
005FD967    lea eax, ss:[esp+0x19C8]
005FD96E    mov dword ptr ss:[esp+0x19D0], 0xBE49F0         ; => [ Data: data_be49f0 ]
005FD979    mov dword ptr ss:[esp+0x19D4], 0xBE468C         ; => [ Data: data_be468c ]
005FD984    mov dword ptr ss:[esp+0x19D8], 0xBE49FC         ; => [ Data: data_be49fc ]
005FD98F    mov dword ptr ss:[esp+0x19DC], 0xBE4698         ; => [ Data: data_be4698 ]
005FD99A    mov dword ptr ss:[esp+0x19E0], 0xBE4A08         ; => [ Data: data_be4a08 ]
005FD9A5    mov dword ptr ss:[esp+0x19E4], 0xBE4680         ; => [ Data: data_be4680 ]
005FD9B0    mov dword ptr ss:[esp+0x19E8], 0xBE4A14         ; => [ Data: data_be4a14 ]
005FD9BB    mov dword ptr ss:[esp+0x19EC], 0xBE4680         ; => [ Data: data_be4680 ]
005FD9C6    mov dword ptr ss:[esp+0x19F0], 0xBE4A20         ; => [ Data: data_be4a20 ]
005FD9D1    mov dword ptr ss:[esp+0x19F4], 0xBE4680         ; => [ Data: data_be4680 ]
005FD9DC    mov dword ptr ss:[esp+0x19F8], 0xBE4A2C         ; => [ Data: data_be4a2c ]
005FD9E7    mov dword ptr ss:[esp+0x19FC], 0xBE4680         ; => [ Data: data_be4680 ]
...
005FDA0E    jnz 0x005FDA5C                                  ; => [ String: tbl_modifiers ]
...
005FDA58    jnz 0x005FDA60                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
...
005FDA6E    mov edi, eax                                    ; => [ Call: sub_67be20 ]
...
005FDA85    mov dword ptr ss:[esp+esi*4+0x1A04], 0x861478   ; => [ String: tbl_modifiers ]
...
005FDAAB    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005FDAC4    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
005FDAC9    mov ecx, edi
005FDACB    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005FDAE1    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
005FDAE6    imul esi, ebx, 0x6C
005FDAE9    add esp, 0x10
005FDAEC    mov ebx, dword ptr ds:[0x00BE46F8]              ; => [ Data: data_be46f8 ]
...
005FDB36    jz 0x005FDB67                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005FDB38    mov edx, ebx
005FDB3A    mov ecx, edi
005FDB3C    call 0x0067BD70
005FDB41    mov ecx, eax                                    ; => [ Call: sub_67bd70 ]
...
005FDB67    mov ebx, dword ptr ds:[0x00BE46FC]              ; => [ Data: data_be46fc ]
...
005FDBB5    jz 0x005FDBE6                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005FDBB7    mov edx, ebx
005FDBB9    mov ecx, edi
005FDBBB    call 0x0067BD70
005FDBC0    mov ecx, eax                                    ; => [ Call: sub_67bd70 ]
...
005FDBE6    mov ebx, dword ptr ds:[0x00BE4700]              ; => [ Data: data_be4700 ]
...
005FDC34    jz 0x005FDC65                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005FDC36    mov edx, ebx
005FDC38    mov ecx, edi
005FDC3A    call 0x0067BD70
005FDC3F    mov ecx, eax                                    ; => [ Call: sub_67bd70 ]
...
005FDD6F    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
005FDD88    call 0x004DB700                                 ; => [ Call: sub_4db700 ]
005FDD8D    test al, al
...
005FDDA5    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
005FDDC8    call 0x004DB700                                 ; => [ Call: sub_4db700 ]
005FDDCD    test al, al
...
005FDE45    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005FDE4A    mov esp, ebp
005FDE4C    pop ebp
005FDE4D    ret
005FDE4E    push 0x861268                                   ; => [ String: GetModfierDef ]
005FDE53    push 0x85BD
005FDE58    mov ecx, 0x861234                               ; => [ String: DOM_MODIFIER_DEFS[modifier].modifier == modifier ]
005FDE5D    jmp 0x005FDE6E
005FDE5F    push 0x861654                                   ; => [ String: GetModifierFromButton ]
005FDE64    push 0x8CC4
005FDE69    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005FDE6E    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005FDE73    mov edx, 0x801800
005FDE78    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005FDE7D    add esp, 0x0C
005FDE80    call 0x0063BC30
005FDE85    test al, al
005FDE87    jz 0x005FDE8A                                   ; => [ Call: sub_63bc30 ]
005FDE89    int3
005FDE8A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
