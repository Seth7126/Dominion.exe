...
004BE9D9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
004BE9DE    xor eax, esp
004BE9E0    mov dword ptr ss:[esp+0x48], eax
004BE9E4    push ebx
004BE9E5    push esi
004BE9E6    mov esi, ecx
004BE9E8    mov ecx, 0x77F08C                               ; => [ Data: data_77f08c ]
004BE9ED    push edi
004BE9EE    nop
...
004BEA12    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004BEA17    mov esp, ebp
004BEA19    pop ebp
004BEA1A    ret
004BEA1B    mov ecx, dword ptr ds:[0x00CC8DC8]
004BEA21    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004BEA27    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004BEAC1    jnz 0x004BEA07                                  ; => [ Call: sub_4be8d0 ]
004BEAC7    mov ecx, dword ptr ds:[0x00CC8DC8]
004BEACD    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004BEAD3    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
004BEAF1    call 0x004BB260                                 ; => [ Call: sub_4bb260 ]
004BEAF6    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
004BEAFC    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
004BEB01    xor al, al
004BEB03    pop edi
004BEB04    pop esi
004BEB05    pop ebx
...
004BEB0C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004BEB11    mov esp, ebp
004BEB13    pop ebp
004BEB14    ret
004BEB15    lea edx, ss:[esp+0x14]
004BEB19    lea ecx, ss:[esp+0x10]
004BEB1D    call 0x004DAF40                                 ; => [ Call: sub_4daf40 ]
...
004BEB3E    test al, al
004BEB40    jnz 0x004BEA07                                  ; => [ Call: sub_4db560 ]
004BEB46    inc edi
...
004BEB5C    pop ebx
004BEB5D    setz al                                         ; => [ Call: sub_4be8d0 ]
004BEB60    xor ecx, esp
004BEB62    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
