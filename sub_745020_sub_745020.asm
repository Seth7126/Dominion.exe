...
00745034    xorps xmm1, xmmword ptr ds:[0x008937C0]         ; => [ Data: data_8937c0 | Data: data_1593c74 ]
0074503B    movss xmm2, dword ptr ds:[0x01593C70]
00745043    xorps xmm2, xmmword ptr ds:[0x008937C0]         ; => [ Data: data_8937c0 | Data: data_1593c70 ]
0074504A    movups xmmword ptr ds:[eax+0x10], xmm0          ; => [ Call: __builtin_memset ]
0074504E    movq qword ptr ds:[eax+0x20], xmm0
00745053    movss xmm0, dword ptr ds:[0x01593C6C]           ; => [ Data: data_1593c6c ]
...
0074507D    movups xmm0, xmmword ptr ds:[0x007FF530]        ; => [ Data: data_7ff530 ]
00745084    movss dword ptr ds:[eax+0x04], xmm1
00745089    movaps xmm1, xmmword ptr ds:[0x00893730]        ; => [ Data: data_893730 ]
