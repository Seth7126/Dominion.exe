...
004E49D5    push 0x7643CD                                   ; => [ Call: sub_7643cd | Type: EHRegistrationNode ]
004E49DA    mov eax, dword ptr fs:[0x00000000]
004E49E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004E49E1    mov eax, 0x4CC0
004E49E6    call 0x00761E50                                 ; => [ Call: __chkstk ]
004E49EB    push esi
004E49EC    mov eax, dword ptr ds:[0x008C4040]
004E49F1    xor eax, ebp
004E49F3    push eax                                        ; => [ Data: __security_cookie ]
004E49F4    lea eax, ss:[ebp-0x0C]
004E49F7    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E4A0F    call 0x004E4830                                 ; => [ Call: sub_4e4830 ]
...
004E4A90    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
