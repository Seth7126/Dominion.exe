...
0064BE7B    push 0x873670                                   ; => [ String: XAllocator::Grow ]
0064BE80    push 0x4F
0064BE82    mov ecx, 0x825818                               ; => [ String: mGrowCount > 0 ]
...
0064BE97    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
0064BEBF    pop esi
0064BEC0    ret
0064BEC1    push 0x873670                                   ; => [ String: XAllocator::Grow ]
0064BEC6    push 0x50
0064BEC8    mov ecx, 0x8736A4                               ; => [ String: mItemSize >= sizeof(void*) ]
0064BECD    push 0x873638
0064BED2    mov edx, 0x801800
0064BED7    call 0x0063B870                                 ; => [ String: XAllocator::Grow | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xAlloc.cpp ]
0064BEDC    add esp, 0x0C
0064BEDF    call 0x0063BC30
0064BEE4    test al, al
0064BEE6    jz 0x0064BEE9                                   ; => [ Call: sub_63bc30 ]
0064BEE8    int3
0064BEE9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
