...
005BEDC8    push 0x7694F0                                   ; => [ Type: EHRegistrationNode | Call: sub_7694f0 ]
005BEDCD    mov eax, dword ptr fs:[0x00000000]
005BEDD3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005BEDD4    push ebx
...
005BEDE4    push eax                                        ; => [ Data: __security_cookie ]
005BEDE5    lea eax, ss:[ebp-0x0C]
005BEDE8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005BEE42    mov dword ptr ss:[ebp-0x34], ecx                ; => [ Call: nullptr ]
005BEE45    mov dword ptr ss:[ebp-0x30], ecx                ; => [ Call: nullptr ]
005BEE48    mov dword ptr ss:[ebp-0x60], ecx                ; => [ Call: __builtin_memset ]
...
005BEE6B    mov dword ptr ss:[ebp-0x1C], ecx                ; => [ Call: nullptr ]
...
005BEE96    mov edi, eax                                    ; => [ Call: sub_5c0320 ]
005BEE98    mov eax, dword ptr ss:[ebp-0x24]
005BEE9B    jmp 0x005BEE9F
005BEE9D    xor edi, edi                                    ; => [ Call: nullptr ]
...
005BEEC7    xor eax, eax                                    ; => [ Call: nullptr ]
005BEEC9    and ecx, 0xFFFFFFFC
005BEECC    mov dword ptr ss:[ebp-0x18], eax                ; => [ Call: nullptr ]
...
005BEEFD    call 0x005C8A00                                 ; => [ Call: sub_5c8a00 ]
...
005BEF29    push eax
005BEF2A    call 0x005C8640                                 ; => [ Call: sub_5c8640 ]
...
005BEF9B    mov dword ptr ss:[ebp-0x60], eax                ; => [ Call: sub_5c0320 ]
005BEF9E    jmp 0x005BEFA7
005BEFA0    mov dword ptr ss:[ebp-0x60], 0x00               ; => [ Call: nullptr ]
...
005BF013    call 0x005C8AF0                                 ; => [ Call: sub_5c8af0 ]
...
005BF039    call 0x005C8740                                 ; => [ Call: sub_5c8740 ]
...
005BF084    mov dword ptr ss:[ebp-0x58], eax                ; => [ Call: sub_5c0320 ]
005BF087    jmp 0x005BF090
005BF089    mov dword ptr ss:[ebp-0x58], 0x00               ; => [ Call: nullptr ]
...
005BF0FB    call 0x005C88B0                                 ; => [ Call: sub_5c88b0 ]
...
005BF160    mov dword ptr ss:[ebp-0x50], eax                ; => [ Call: sub_5c0320 ]
005BF163    jmp 0x005BF16C
005BF165    mov dword ptr ss:[ebp-0x50], 0x00               ; => [ Call: nullptr ]
...
005BF1A8    movaps xmm6, xmmword ptr ds:[0x00893280]        ; => [ Data: data_893280 ]
005BF1AF    xorps xmm5, xmm5
005BF1B2    movaps xmm7, xmmword ptr ds:[0x00893850]        ; => [ Data: data_893850 ]
...
005BF21B    cmpps xmm3, xmm5, 0x01                          ; => [ String: 0 | String: zx ]
...
005BF244    movups xmmword ptr ds:[ecx+edi*4], xmm3         ; => [ Data: data_893610 ]
...
005BF3A8    push ecx
005BF3A9    push edx
005BF3AA    call 0x00759661                                 ; => [ Call: operator new ]
005BF3AF    add esp, 0x08
005BF3B2    mov ecx, dword ptr ss:[ebp-0x0C]
005BF3B5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005BF3BC    pop ecx
005BF3BD    pop edi
005BF3BE    pop esi
