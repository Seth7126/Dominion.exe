...
004F4453    add ecx, 0x1779FB0
004F4459    mov dword ptr ss:[ebp-0x04], ecx
004F445C    mov eax, dword ptr ds:[esi*4+0x1839FB0]
004F4463    cmp eax, dword ptr ds:[esi*4+0x1839FE0]
004F446A    jnl 0x004F4575
004F4470    mov edx, dword ptr ds:[ecx+eax*4]
004F4473    inc eax
004F4474    mov dword ptr ds:[esi*4+0x1839FB0], eax
...
004F4493    call 0x004F7F30
004F4498    add esp, 0x0C
004F449B    mov ecx, 0x801AA4
004F44A0    push 0x808980
004F44A5    push 0x317
004F44AA    jmp 0x004F4640
004F44AF    mov dword ptr ds:[edi+0x04], edx
004F44B2    mov eax, dword ptr ds:[esi*4+0x1839FB0]
004F44B9    mov edx, dword ptr ds:[ecx+eax*4]
004F44BC    inc eax
004F44BD    mov dword ptr ds:[esi*4+0x1839FB0], eax
...
004F44DF    nop
004F44E0    mov eax, dword ptr ds:[esi*4+0x1839FB0]
004F44E7    lea edx, ds:[edx+0x04]
004F44EA    inc ebx
004F44EB    mov ecx, dword ptr ds:[ecx+eax*4]
004F44EE    inc eax
004F44EF    mov dword ptr ds:[esi*4+0x1839FB0], eax
...
004F4520    mov eax, dword ptr ds:[esi*4+0x1839FB0]
004F4527    lea ebx, ds:[ebx+0x04]
004F452A    inc edx
004F452B    mov ecx, dword ptr ds:[ecx+eax*4]
004F452E    inc eax
004F452F    mov dword ptr ds:[esi*4+0x1839FB0], eax
...
004F4541    mov eax, dword ptr ds:[esi*4+0x1839FB0]
004F4548    mov edx, dword ptr ss:[ebp-0x04]
004F454B    mov ecx, dword ptr ds:[edx+eax*4]
004F454E    inc eax
004F454F    mov dword ptr ds:[esi*4+0x1839FB0], eax
004F4556    mov dword ptr ds:[edi+0x40], ecx
004F4559    mov eax, dword ptr ds:[esi*4+0x1839FB0]
004F4560    mov ecx, dword ptr ds:[edx+eax*4]
004F4563    inc eax
004F4564    mov dword ptr ds:[esi*4+0x1839FB0], eax
...
004F4585    push 0x808E40
004F458A    push 0x157E
004F458F    mov ecx, 0x808928
