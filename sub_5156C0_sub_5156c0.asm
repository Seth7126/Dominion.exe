...
005156DA    push 0x813640
005156DF    push 0x669
005156E4    mov ecx, 0x813658
...
00515700    push 0x813640
00515705    push 0x672
0051570A    mov ecx, 0x813670
0051570F    jmp 0x005157BC
00515714    mov ebx, dword ptr ds:[0x00CCA784]
...
00515752    mov ebx, dword ptr ds:[0x00CCA784]
...
0051579B    pop edi
0051579C    pop esi
0051579D    mov eax, dword ptr ss:[ebp+eax*4-0x48]
005157A1    xor ecx, ebp
005157A3    pop ebx
005157A4    call 0x0075927A
005157A9    mov esp, ebp
005157AB    pop ebp
005157AC    ret
005157AD    push 0x8141F4
005157B2    push 0x198B
005157B7    mov ecx, 0x814204
005157BC    push 0x80CD80
005157C1    mov edx, 0x801800
005157C6    call 0x0063B870
005157CB    add esp, 0x0C
005157CE    call 0x0063BC30
005157D3    test al, al
005157D5    jz 0x005157D8
005157D7    int3
005157D8    call 0x0063BB00
