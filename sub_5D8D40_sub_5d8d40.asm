...
005D8D49    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005D8D9A    jnz 0x005D8EDC                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005D8DA0    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D8DF5    movups xmmword ptr ss:[esp+0x30], xmm0          ; => [ Call: sub_655430 ]
...
005D8E13    jnb 0x005D8EDC                                  ; => [ Data: data_b809e4 ]
005D8E19    imul ecx, ecx, 0x1C30
005D8E1F    add ecx, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
...
005D8E44    push 0x00
005D8E46    call 0x0066B2B0                                 ; => [ String: rootContent | Call: sub_66b2b0 ]
005D8E4B    add esp, 0x04
005D8E4E    test eax, eax
005D8E50    jnz 0x005D8E5B
005D8E52    movups xmm0, xmmword ptr ds:[0x007FF520]        ; => [ Data: data_7ff520 ]
005D8E59    jmp 0x005D8EB2
005D8E5B    mov ecx, eax
005D8E5D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D8EAF    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: sub_655430 ]
...
005D8EC5    call 0x005D8A80                                 ; => [ Call: sub_5d8a80 ]
...
005D8EF6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005D8F18    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: ToTransform | String: Halt ]
005D8F1D    add esp, 0x0C
005D8F20    call 0x0063BC30
005D8F25    test al, al
005D8F27    jz 0x005D8F2A                                   ; => [ Call: sub_63bc30 ]
005D8F29    int3
005D8F2A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
