...
004FACE6    push 0x02
004FACE8    call 0x00590760
004FACED    add esp, 0x10
004FACF0    call 0x00573400
...
004FAD6E    call 0x00561AF0
004FAD73    add esp, 0x04
004FAD76    mov ecx, 0xB08
004FAD7B    pop esi
004FAD7C    jmp 0x0056CE60
004FAD81    pop esi
004FAD82    ret
...
004FAD99    call 0x0063B870
004FAD9E    add esp, 0x0C
004FADA1    call 0x0063BC30
004FADA6    test al, al
004FADA8    jz 0x004FADAB
004FADAA    int3
004FADAB    call 0x0063BB00
