...
00674336    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00674346    mov byte ptr ds:[0x00CA9A74], 0x01              ; => [ Data: data_ca9a74 ]
0067434D    mov dword ptr ds:[0x00CA9A78], 0x00             ; => [ Data: data_ca9a78 ]
00674357    call 0x0063C270                                 ; => [ Call: sub_63c270 ]
0067435C    movss xmm1, dword ptr ss:[ebp-0x1C]
00674361    lea ecx, ss:[ebp-0x1C]
00674364    movss xmm0, dword ptr ss:[ebp-0x18]
00674369    movss dword ptr ds:[0x00CA9A7C], xmm1           ; => [ Data: data_ca9a7c ]
00674371    movss dword ptr ds:[0x00CA9A80], xmm0           ; => [ Data: data_ca9a80 ]
00674379    mov dword ptr ds:[0x00CA9A8C], 0x00             ; => [ Data: data_ca9a8c ]
00674383    movss dword ptr ds:[0x00CA9A84], xmm1           ; => [ Data: data_ca9a84 ]
0067438B    movss dword ptr ds:[0x00CA9A88], xmm0           ; => [ Data: data_ca9a88 ]
00674393    call 0x0063C270                                 ; => [ Call: sub_63c270 ]
00674398    push dword ptr ss:[ebp-0x18]
0067439B    push dword ptr ss:[ebp-0x1C]
0067439E    call 0x00669C00                                 ; => [ Call: sub_669c00 ]
006743A3    mov dword ptr ds:[0x00CA9A90], eax              ; => [ Data: data_ca9a90 ]
006743A8    xor cl, cl
006743AA    lea eax, ss:[ebp-0x30]
006743AD    push eax
006743AE    call 0x00674000                                 ; => [ Call: sub_674000 ]
006743B3    add esp, 0x0C
006743B6    mov cl, 0x01
006743B8    movups xmm0, xmmword ptr ds:[eax]
006743BB    lea eax, ss:[ebp-0x30]
006743BE    push eax
006743BF    movups xmmword ptr ds:[0x00CA9A98], xmm0        ; => [ Data: data_ca9a98 ]
006743C6    call 0x00674000
006743CB    add esp, 0x04
006743CE    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: sub_674000 ]
006743D1    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006743D6    mov byte ptr ds:[0x00CA9A94], 0x00              ; => [ Data: data_ca9a94 ]
006743DD    movups xmmword ptr ds:[0x00CA9AA8], xmm0        ; => [ Data: data_ca9aa8 ]
...
006744A8    jl 0x00674404                                   ; => [ Data: data_c28c58 ]
006744AE    mov ecx, dword ptr ss:[ebp-0x04]
006744B1    pop edi
006744B2    pop esi
006744B3    xor ecx, ebp
006744B5    pop ebx
006744B6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
