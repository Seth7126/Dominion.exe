...
0075ABA9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0075ABAE    xor eax, ebp
0075ABB0    mov dword ptr ss:[ebp-0x04], eax
0075ABB3    push esi
0075ABB4    mov esi, ecx
0075ABB6    mov eax, dword ptr ds:[esi+0x04]                ; => [ Type: CRITICAL_SECTION ]
0075ABB9    test eax, eax
0075ABBB    jz 0x0075ABC6
0075ABBD    push eax
0075ABBE    call 0x00761D70                                 ; => [ Call: sub_761d70 ]
0075ABC3    add esp, 0x04
0075ABC6    cmp byte ptr ds:[esi+0x08], 0x00
0075ABCA    jz 0x0075ABFD
0075ABCC    push 0x77E8E4                                   ; => [ String: !mInsideAudioThreadMutex ]
0075ABD1    push 0x902
0075ABD6    push 0x77E900                                   ; => [ String: D:\soloud\src\core\soloud.cpp ]
0075ABDB    lea eax, ss:[ebp-0xCC]
0075ABE1    push 0x77E920
0075ABE6    push eax
0075ABE7    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
0075ABEC    add esp, 0x14
0075ABEF    lea eax, ss:[ebp-0xCC]
0075ABF5    push eax
0075ABF6    call dword ptr ds:[0x007750A8]
0075ABFC    int3
0075ABFD    mov eax, dword ptr ds:[esi+0x04]                ; => [ Type: CRITICAL_SECTION ]
0075AC00    mov byte ptr ds:[esi+0x08], 0x00
0075AC04    test eax, eax
0075AC06    jz 0x0075AC11
0075AC08    push eax
0075AC09    call 0x00761DD0                                 ; => [ Call: sub_761dd0 ]
0075AC0E    add esp, 0x04
0075AC11    cmp byte ptr ds:[esi+0x08], 0x00
0075AC15    jz 0x0075AC48
0075AC17    push 0x77E8E4                                   ; => [ String: !mInsideAudioThreadMutex ]
0075AC1C    push 0xC5
0075AC21    push 0x77E900                                   ; => [ String: D:\soloud\src\core\soloud.cpp ]
0075AC26    lea eax, ss:[ebp-0xCC]
0075AC2C    push 0x77E920
0075AC31    push eax
0075AC32    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | String: %s(%d): assert(%s) failed.\n ]
...
0075AC4A    call 0x0075F5E0                                 ; => [ Call: sub_75f5e0 ]
