...
00534E05    mov dword ptr ss:[ebp-0xCDC], eax
...
00534E41    mov eax, dword ptr ds:[ecx]
00534E43    push esi
00534E44    mov eax, dword ptr ds:[eax]
00534E46    call eax
00534E48    mov dword ptr ds:[esi+0x24], eax
...
00534EAF    movlpd qword ptr ss:[ebp-0xCC4], xmm0
