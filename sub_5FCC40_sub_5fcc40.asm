...
005FCC4A    call 0x0064E7A0
005FCC4F    mov esi, dword ptr ds:[0x00CCF6DC]
005FCC55    xor ecx, ecx
005FCC57    mov dword ptr ds:[eax+0x18BC], 0x5FBBD0
...
005FCCB8    call 0x0060DE40
005FCCBD    add esp, 0x04
005FCCC0    test al, al
005FCCC2    jz 0x005FCCD2
005FCCC4    pop edi
005FCCC5    mov dword ptr ds:[0x008DBF64], 0x00
005FCCCF    pop esi
005FCCD0    pop ebp
005FCCD1    ret
005FCCD2    mov ecx, edi
005FCCD4    mov dword ptr ds:[0x008DBF64], 0x01
005FCCDE    call 0x0064E7A0
