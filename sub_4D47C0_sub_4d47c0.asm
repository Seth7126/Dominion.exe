...
004D47C5    push 0x7636A6                                   ; => [ Call: __ehhandler$?AddVirtualProcessorRoots@SchedulerProxy@details@Concurrency@@QAEXPAPAUIVirtualProcessorRoot@3@I@Z | Type: EHRegistrationNode ]
004D47CA    mov eax, dword ptr fs:[0x00000000]
004D47D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D47D1    sub esp, 0x10
004D47D4    push esi
004D47D5    push edi
004D47D6    mov eax, dword ptr ds:[0x008C4040]
004D47DB    xor eax, ebp
004D47DD    push eax                                        ; => [ Data: __security_cookie ]
004D47DE    lea eax, ss:[ebp-0x0C]
004D47E1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D4805    call 0x0068C730                                 ; => [ Call: sub_68c730 | Call: sub_4c89a0 ]
004D480A    test eax, eax
004D480C    jnz 0x004D4818
004D480E    lea edx, ds:[eax+0x01]
004D4811    mov ecx, edi
004D4813    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
004D4818    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
004D484C    call 0x0063D850                                 ; => [ String: *%s* | Call: sub_63df30 | Call: sub_63d850 ]
004D4851    mov dword ptr ss:[ebp-0x04], 0x02
004D4858    cmp dword ptr ds:[0x00CF65BC], 0x00
004D485F    jz 0x004D48A3                                   ; => [ Data: data_cf65bc ]
...
004D4870    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4883    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D4888    mov eax, esi
004D488A    mov ecx, dword ptr ss:[ebp-0x0C]
004D488D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D4894    pop ecx
004D4895    pop edi
004D4896    pop esi
...
004D489E    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
004D48A3    mov eax, esi
004D48A5    mov ecx, dword ptr ss:[ebp-0x0C]
004D48A8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D48AF    pop ecx
004D48B0    pop edi
004D48B1    pop esi
