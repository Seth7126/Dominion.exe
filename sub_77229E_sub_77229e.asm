...
007722AF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007722B4    mov ecx, dword ptr ds:[edx-0x08]
007722B7    xor ecx, eax
007722B9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007722BE    mov eax, 0x8BEE58
007722C3    jmp 0x00761FA6                                  ; => [ Data: data_8bee58 | Call: __CxxFrameHandler3 ]
