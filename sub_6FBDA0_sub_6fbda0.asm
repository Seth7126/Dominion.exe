...
006FBDA9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006FBDBA    push 0x00
006FBDBC    push esi
006FBDBD    call 0x00761FC4                                 ; => [ Call: memset ]
006FBDC2    movsd xmm0, qword ptr ds:[0x00890E88]
006FBDCA    add esp, 0x0C
006FBDCD    call 0x00762398                                 ; => [ Call: _libm_sse2_tan_precise ]
006FBDD2    cmp dword ptr ds:[0x0147DF8C], 0x02             ; => [ Data: data_147df8c ]
006FBDD9    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
006FBE40    mov edx, 0x7FEF98                               ; => [ Data: data_7fef98 ]
006FBE45    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006FBE6F    movq qword ptr ds:[esi+0x24], xmm0              ; => [ Data: data_147df0c ]
006FBE74    mov eax, dword ptr ds:[0x0147DF14]
006FBE79    mov dword ptr ds:[esi+0x2C], eax                ; => [ Data: data_147df14 ]
006FBE7C    movss xmm1, dword ptr ds:[0x0147DF1C]
006FBE84    subss xmm1, dword ptr ds:[0x0147DF10]           ; => [ Data: data_147df10 | Data: data_147df1c ]
006FBE8C    movss xmm2, dword ptr ds:[0x0147DF18]
006FBE94    subss xmm2, dword ptr ds:[0x0147DF0C]           ; => [ Data: data_147df0c | Data: data_147df18 ]
006FBE9C    movss xmm3, dword ptr ds:[0x0147DF20]
006FBEA4    subss xmm3, dword ptr ds:[0x0147DF14]           ; => [ Data: data_147df14 | Data: data_147df20 ]
...
006FBEE8    mov edx, 0x7FEF8C                               ; => [ Data: data_7fef8c ]
006FBEED    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006FBF35    movups xmmword ptr ds:[esi+0x14], xmm0          ; => [ Call: sub_4ac9c0 ]
006FBF39    pop esi
006FBF3A    xor ecx, esp
006FBF3C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
