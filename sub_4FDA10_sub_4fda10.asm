...
004FDA2E    push 0x01
004FDA30    call 0x00590760                                 ; => [ Call: sub_590760 ]
004FDA35    add esp, 0x18
004FDA38    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FDA5B    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
004FDA60    add esp, 0x0C
004FDA63    call 0x0063BC30
004FDA68    test al, al
004FDA6A    jz 0x004FDA6D                                   ; => [ Call: sub_63bc30 ]
004FDA6C    int3
004FDA6D    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
