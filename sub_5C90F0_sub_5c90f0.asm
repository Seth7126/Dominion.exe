...
005C90FF    call 0x005C9240                                 ; => [ Call: sub_5c9240 ]
005C9104    mov eax, dword ptr ds:[0x00CCEA0C]              ; => [ Data: data_ccea0c ]
005C9109    add esp, 0x04
005C910C    test eax, eax
005C910E    jnz 0x005C9121
005C9110    push 0x82854C                                   ; => [ String: GetPileData ]
005C9115    push 0x34
005C9117    mov ecx, 0x828558                               ; => [ String: gPile.fnGetPileData ]
...
005C9147    jz 0x005C91E2                                   ; => [ Data: data_ccea08 ]
005C914D    push edi
005C914E    call dword ptr ds:[0x00CCEA10]                  ; => [ Data: data_ccea10 ]
005C9154    add esp, 0x04
005C9157    mov esi, edi
005C9159    nop dword ptr ds:[eax], eax
005C9160    cmp dword ptr ds:[0x00CCEA08], 0x00
005C9167    jz 0x005C91E2                                   ; => [ Data: data_ccea08 ]
005C9169    mov eax, dword ptr ds:[0x00CCEA10]
005C916E    push esi
005C916F    call eax                                        ; => [ Data: data_ccea10 ]
...
005C91A5    jz 0x005C91E2                                   ; => [ Data: data_ccea08 ]
005C91A7    mov eax, dword ptr ds:[0x00CCEA10]
005C91AC    push esi
005C91AD    call eax                                        ; => [ Data: data_ccea10 ]
...
005C91C0    jz 0x005C91E2                                   ; => [ Data: data_ccea08 ]
005C91C2    mov eax, dword ptr ds:[0x00CCEA10]
005C91C7    push edi
005C91C8    call eax                                        ; => [ Data: data_ccea10 ]
...
005C91E2    push 0x82856C                                   ; => [ String: GetItemData ]
005C91E7    push 0x3A
005C91E9    mov ecx, 0x828538                               ; => [ String: gPile.fnItemCompare ]
005C91EE    jmp 0x005C9217
005C91F0    push 0x828628                                   ; => [ String: PileUpdateStacking ]
005C91F5    push 0x147
005C91FA    mov ecx, 0x82863C                               ; => [ String: idxStack < pileData.numStacks ]
...
005C9206    pop ebp
005C9207    ret
005C9208    push 0x828628                                   ; => [ String: PileUpdateStacking ]
005C920D    push 0x152
005C9212    mov ecx, 0x82865C                               ; => [ String: idxStack == pileData.numStacks ]
005C9217    push 0x828508
005C921C    mov edx, 0x801800
005C9221    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\PileLayout.cpp ]
005C9226    add esp, 0x0C
005C9229    call 0x0063BC30
005C922E    test al, al
005C9230    jz 0x005C9233                                   ; => [ Call: sub_63bc30 ]
005C9232    int3
005C9233    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
