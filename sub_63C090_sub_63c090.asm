...
0063C099    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0063C09E    xor eax, ebp
0063C0A0    mov dword ptr ss:[ebp-0x04], eax
0063C0A3    cmp byte ptr ds:[0x008C4157], 0x00
0063C0AA    jnz 0x0063C105                                  ; => [ Data: data_8c4157 ]
0063C0AC    cmp byte ptr ds:[0x019E3A98], 0x00
0063C0B3    jnz 0x0063C0F2                                  ; => [ Data: data_19e3a98 ]
...
0063C0C5    push 0x00
0063C0C7    call dword ptr ds:[0x00775288]                  ; => [ Type: HRESULT | Call: nullptr ]
0063C0CD    test eax, eax
0063C0CF    js 0x0063C118
0063C0D1    mov eax, dword ptr ds:[0x00CF65B8]
0063C0D6    push dword ptr ds:[eax+0x08]                    ; => [ Data: data_cf65b8 ]
0063C0D9    lea eax, ss:[ebp-0x108]
0063C0DF    push eax
0063C0E0    push 0x871CC4
0063C0E5    push 0x19E3A98
0063C0EA    call 0x0063BB20                                 ; => [ Call: sub_63bb20 | Data: data_19e3a98 | String: %s\TempleGates\%s\ ]
0063C0EF    add esp, 0x10
0063C0F2    mov eax, 0x19E3A98
0063C0F7    mov ecx, dword ptr ss:[ebp-0x04]
0063C0FA    xor ecx, ebp
0063C0FC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction | Data: data_19e3a98 ]
0063C101    mov esp, ebp
0063C103    pop ebp
0063C104    ret                                             ; => [ Data: data_19e3a98 ]
0063C105    mov ecx, dword ptr ss:[ebp-0x04]
0063C108    mov eax, 0x871CBC
0063C10D    xor ecx, ebp
0063C10F    call 0x0075927A                                 ; => [ String: xsave\ | Call: CookieCheckFunction ]
0063C114    mov esp, ebp
0063C116    pop ebp
0063C117    ret                                             ; => [ String: xsave\ ]
0063C118    push 0x871CA8
0063C11D    push 0x140
0063C122    push 0x871C84
0063C127    mov edx, 0x801800
0063C12C    mov ecx, 0x801AA4
0063C131    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xPlatformPC.cpp | String: Halt | String: XGetSaveGameFolder ]
0063C136    add esp, 0x0C
0063C139    call 0x0063BC30
0063C13E    test al, al
0063C140    jz 0x0063C143                                   ; => [ Call: sub_63bc30 ]
0063C142    int3
0063C143    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
