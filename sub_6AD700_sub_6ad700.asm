...
006AD736    mov dword ptr fs:[0x00000000], eax
006AD73C    mov ecx, dword ptr ds:[0x0147B070]
006AD742    mov eax, dword ptr ds:[ecx]
006AD744    call dword ptr ds:[eax+0x98]
006AD74A    mov eax, dword ptr ds:[0x0147B06C]
...
006AD772    call 0x006AD680
006AD777    mov eax, dword ptr ds:[0x0147ABE8]
...
006AD7A1    call dword ptr ds:[eax+0x90]
...
006AD7ED    mov dword ptr ds:[0x01A9A2AC], eax
006AD7F2    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006AD7F9    call 0x007596BD
006AD7FE    add esp, 0x04
006AD801    mov eax, dword ptr ds:[0x0147D2C4]
...
006AD826    movups xmmword ptr ss:[ebp-0x24], xmm0
006AD82A    jnz 0x006AD837
006AD82C    movaps xmm0, xmmword ptr ds:[0x00891340]
006AD833    movups xmmword ptr ss:[ebp-0x24], xmm0
006AD837    mov eax, dword ptr ds:[0x0147D1D4]
006AD83C    movss xmm2, dword ptr ds:[0x00890D84]
006AD844    mov ecx, dword ptr ds:[eax*4+0x147D1BC]
006AD84B    test ecx, ecx
006AD84D    jz 0x006AD8AF
006AD84F    mov eax, dword ptr ds:[0x00CF65B8]
006AD854    lea edx, ss:[ebp-0x40]
006AD857    push dword ptr ds:[0x01A9A2AC]
...
006AD89A    call 0x00682A60
006AD89F    mov eax, dword ptr ds:[0x0147D1D4]
006AD8A4    add esp, 0x0C
006AD8A7    movss xmm2, dword ptr ds:[0x00890D84]
006AD8AF    mov ecx, dword ptr ds:[eax*4+0x147D1C0]
006AD8B6    test ecx, ecx
006AD8B8    jz 0x006ADB0E
006AD8BE    mov eax, dword ptr ds:[0x00CF65B8]
006AD8C3    lea edx, ss:[ebp-0x40]
006AD8C6    push dword ptr ds:[0x01A9A2AC]
...
006AD9AF    addss xmm5, dword ptr ds:[0x0147D200]
006AD9B7    mulss xmm3, xmm6
006AD9BB    addss xmm7, dword ptr ds:[0x0147D1F8]
006AD9C3    mulss xmm4, xmm6
006AD9C7    addss xmm3, dword ptr ds:[0x0147D1FC]
006AD9CF    movaps xmm2, xmm5
006AD9D2    addss xmm4, dword ptr ds:[0x0147D1F4]
...
006ADA15    movss xmm2, dword ptr ds:[0x00CF65C8]
...
006ADA85    movq qword ptr ss:[ebp-0x1C], xmm2
006ADA8A    movups xmmword ptr ss:[ebp-0x2C], xmm1
006ADA8E    call 0x00645A20
006ADA93    jmp 0x006ADAFF
006ADA95    mov eax, dword ptr ds:[0x00CF65B8]
006ADA9A    cmp byte ptr ds:[eax+0x2B], 0x00
006ADA9E    jz 0x006ADAC1
006ADAA0    mov ecx, 0x01
006ADAA5    call 0x006E1520
006ADAAA    mov ecx, dword ptr ds:[0x00CF65B8]
006ADAB0    mov dword ptr ds:[0x0147ABB4], 0x02
...
006ADAC7    mov eax, dword ptr ds:[0x0147B06C]
...
006ADB65    call 0x0063B870
006ADB6A    add esp, 0x0C
006ADB6D    call 0x0063BC30
006ADB72    test al, al
006ADB74    jz 0x006ADB77
006ADB76    int3
006ADB77    call 0x0063BB00
