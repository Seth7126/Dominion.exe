...
00510EB1    call 0x0063B870
00510EB6    add esp, 0x0C
00510EB9    call 0x0063BC30
00510EBE    test al, al
00510EC0    jz 0x00510EC3
00510EC2    int3
00510EC3    call 0x0063BB00
