...
0052A23E    push 0x01
0052A240    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052A245    add esp, 0x18
0052A248    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052A26B    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052A270    add esp, 0x0C
0052A273    call 0x0063BC30
0052A278    test al, al
0052A27A    jz 0x0052A27D                                   ; => [ Call: sub_63bc30 ]
0052A27C    int3
0052A27D    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
