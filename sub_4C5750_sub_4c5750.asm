...
004C5756    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004C580A    call 0x0063B870
004C580F    add esp, 0x0C
004C5812    call 0x0063BC30
004C5817    test al, al
004C5819    jz 0x004C581C
004C581B    int3
004C581C    call 0x0063BB00
