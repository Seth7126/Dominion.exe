...
006A73C5    push 0x76F6C0                                   ; => [ Call: sub_76f6c0 | Type: EHRegistrationNode ]
006A73CA    mov eax, dword ptr fs:[0x00000000]
006A73D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A73DE    push eax                                        ; => [ Data: __security_cookie ]
006A73DF    lea eax, ss:[ebp-0x0C]
006A73E2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A73FC    push 0x87AD74                                   ; => [ String: _spAtlasPage_createTexture ]
006A7401    push 0x1C
006A7403    push 0x87ADA4                                   ; => [ String: C:\x\ax2017\Engine\Spine.cpp ]
006A7408    mov ecx, 0x879C30                               ; => [ Data: data_879c30 ]
006A740D    jmp 0x006A7556
006A7412    test esi, esi
006A7414    jz 0x006A7542
006A741A    sub eax, esi
006A741C    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006A7423    push eax
006A7424    push esi
006A7425    lea ecx, ss:[ebp-0x14]
006A7428    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006A742D    mov esi, dword ptr ss:[ebp-0x14]
006A7430    lea ecx, ss:[ebp-0x10]
006A7433    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006A7438    test esi, esi
006A743A    mov edx, edi                                    ; => [ Data: data_801800 ]
006A743C    cmovnz edx, esi
006A743F    push 0x03
006A7441    call 0x0069FD50                                 ; => [ Call: sub_69fd50 ]
...
006A7458    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
006A745D    mov ecx, eax
006A745F    mov dword ptr ds:[ebx+0x1C], eax
006A7462    call 0x005AF880
006A7467    mov ecx, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
006A7480    addsd xmm0, qword ptr ds:[eax*8+0x893660]       ; => [ Data: data_893660 ]
...
006A74AC    cvtpd2ps xmm0, xmm0                             ; => [ Data: data_893660 ]
...
006A74CC    jz 0x006A74FC                                   ; => [ Data: data_cf65bc ]
...
006A74DD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A74F0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A74F5    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006A7513    jz 0x006A7530                                   ; => [ Data: data_cf65bc ]
006A7515    lea ecx, ss:[ebp-0x14]
006A7518    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A752B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A7530    mov ecx, dword ptr ss:[ebp-0x0C]
006A7533    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A753A    pop ecx
006A753B    pop edi
006A753C    pop esi
006A753D    pop ebx
...
006A7540    pop ebp
006A7541    ret
006A7542    push 0x871DD4                                   ; => [ String: XString::XString ]
006A7547    push 0x9A
006A754C    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
006A7551    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
006A7556    mov edx, 0x801800
006A755B    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006A7560    add esp, 0x0C
006A7563    call 0x0063BC30
006A7568    test al, al
006A756A    jz 0x006A756D                                   ; => [ Call: sub_63bc30 ]
006A756C    int3
006A756D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
