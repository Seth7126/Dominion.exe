...
005F6DA5    push 0x76A460                                   ; => [ Type: EHRegistrationNode | Call: sub_76a460 ]
005F6DAA    mov eax, dword ptr fs:[0x00000000]
005F6DB0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005F6DB1    mov eax, 0x7530
005F6DB6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005F6DBB    mov eax, dword ptr ds:[0x008C4040]
005F6DC0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
005F6DCC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005F6DFA    push eax
005F6DFB    call 0x00761FBE                                 ; => [ Call: memcpy | Call: sub_4e49d0 ]
005F6E00    add esp, 0x0C
005F6E03    lea edx, ss:[ebp-0x4214]
005F6E09    lea ecx, ss:[ebp-0x5BA4]
005F6E0F    call 0x005F69B0                                 ; => [ Call: sub_5f69b0 ]
005F6E14    mov edi, eax
005F6E16    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
005F6E1B    mov ecx, dword ptr ds:[ebx+0x08]
005F6E1E    mov esi, 0x801800                               ; => [ Data: data_801800 ]
005F6E23    push eax
...
005F6F57    jz 0x005F6F77                                   ; => [ Data: data_cf65bc ]
005F6F59    lea ecx, ss:[ebp-0x7538]
005F6F5F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005F6F72    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005F6F77    mov ecx, dword ptr ss:[ebp-0x0C]
005F6F7A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005F6F81    pop ecx
005F6F82    pop edi
005F6F83    pop esi
005F6F84    pop ebx
...
005F6F8A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
