...
005052F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005052F1    mov eax, 0x1938
005052F6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005052FB    mov eax, dword ptr ds:[0x008C4040]
00505300    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0050530C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00505312    call 0x00573400                                 ; => [ Call: sub_573400 ]
00505317    lea ecx, ss:[ebp-0x1944]
0050531D    push ecx
0050531E    mov edx, dword ptr ds:[eax+0x0C]
00505321    mov ecx, dword ptr ds:[eax+0x04]
00505324    call 0x00590B50                                 ; => [ Call: sub_590b50 ]
00505329    mov ebx, eax
0050532B    mov dword ptr ss:[ebp-0xCC0], 0x80A880          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2567c938d1de4add11001e46261d79fb>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_2567c938d1de4add11001e46261d79fb>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
...
00505355    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00505357    mov dword ptr ss:[ebp-0xC9C], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2567c938d1de4add11001e46261d79fb>,bool,enum CardID>::VTable ]
...
005053CE    push eax
005053CF    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
005053D2    mov dword ptr ss:[ebp-0xC9C], 0x00
005053DC    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005053F6    jnl 0x005053FD                                  ; => [ Call: sub_583fc0 ]
005053F8    lea eax, ds:[esi+esi*1]
005053FB    jmp 0x00505417
005053FD    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00505415    add eax, eax                                    ; => [ Call: sub_583fc0 ]
00505417    mov ecx, dword ptr ss:[ebp-0x0C]
0050541A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00505421    pop ecx
00505422    pop edi
00505423    pop esi
00505424    pop ebx
...
0050542A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
