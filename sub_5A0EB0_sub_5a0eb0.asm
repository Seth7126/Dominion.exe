...
005A0EF0    call 0x004D5CB0                                 ; => [ Call: sub_4d5cb0 ]
...
005A0F17    push 0x825168                                   ; => [ String: BinGetCoordX ]
005A0F1C    push 0x66
005A0F1E    mov ecx, 0x825178                               ; => [ String: ix >= 0 ]
005A0F23    jmp 0x005A0F36
005A0F25    cmp eax, dword ptr ds:[esi+0x34]
005A0F28    jl 0x005A0ECE
005A0F2A    push 0x825168                                   ; => [ String: BinGetCoordX ]
005A0F2F    push 0x67
005A0F31    mov ecx, 0x825180                               ; => [ String: ix < bin.dims.x ]
005A0F36    push 0x8250E0
005A0F3B    mov edx, 0x801800
005A0F40    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: BinGetCoordX | String: C:\x\ax2017\Jams\Dominion\code\DomMap.cpp ]
005A0F45    add esp, 0x0C
005A0F48    call 0x0063BC30
005A0F4D    test al, al
005A0F4F    jz 0x005A0F52                                   ; => [ Call: sub_63bc30 ]
005A0F51    int3
005A0F52    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
