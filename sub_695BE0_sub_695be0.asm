...
00695BF1    xor eax, esp                                    ; => [ Type: FILE | Data: __security_cookie ]
...
00695C20    push esi
00695C21    call 0x006958C0                                 ; => [ Call: sub_6958c0 ]
...
00695C59    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00695C70    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
