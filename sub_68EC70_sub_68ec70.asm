...
0068EC75    push 0x76E716                                   ; => [ Type: EHRegistrationNode | Call: sub_76e716 ]
0068EC7A    mov eax, dword ptr fs:[0x00000000]
0068EC80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068EC8E    push eax                                        ; => [ Data: __security_cookie ]
0068EC8F    lea eax, ss:[ebp-0x0C]
0068EC92    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0068EC98    mov esi, edx
0068EC9A    mov ebx, ecx
0068EC9C    mov dword ptr ss:[ebp-0x20], ebx
0068EC9F    mov dword ptr ss:[ebp-0x14], 0x00
0068ECA6    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
0068ECC9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068ECEB    test al, al
0068ECED    jnz 0x0068F3E3                                  ; => [ Call: sub_68cbb0 | String: nis ]
...
0068ED06    test al, al
0068ED08    jnz 0x0068F3E3                                  ; => [ Call: sub_68cbb0 | String: ling ]
...
0068ED21    test al, al
0068ED23    jnz 0x0068F3E3                                  ; => [ Call: sub_68cbb0 | String: ich ]
...
0068ED3C    test al, al
0068ED3E    jnz 0x0068F3E3                                  ; => [ String: ig | Call: sub_68cbb0 ]
...
0068ED57    test al, al
0068ED59    jz 0x0068EE37                                   ; => [ String: tum | Call: sub_68cbb0 ]
0068ED5F    mov edx, 0x877FEC
0068ED64    lea ecx, ss:[ebp-0x1C]
0068ED67    call 0x0063D720                                 ; => [ String: er | Call: sub_63d720 ]
...
0068ED7E    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_68e9e0 ]
...
0068EDCA    jz 0x0068EDFA                                   ; => [ Data: data_cf65bc ]
...
0068EDDB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068EDEE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068EDF3    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
0068EE0E    jz 0x0068EE2B                                   ; => [ Data: data_cf65bc ]
0068EE10    lea ecx, ss:[ebp-0x1C]
0068EE13    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068EE26    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068EE4A    test al, al
0068EE4C    jnz 0x0068F3B9                                  ; => [ Call: sub_68cbb0 | String: en ]
...
0068EE65    test al, al
0068EE67    jnz 0x0068F3B9                                  ; => [ Call: sub_68cbb0 | String: chen ]
...
0068EE80    test al, al
0068EE82    jnz 0x0068F3B9                                  ; => [ Call: sub_68cbb0 | String: lein ]
...
0068EE9B    call 0x0068CBB0                                 ; => [ Call: sub_68cbb0 | String: el ]
...
0068EEB2    call 0x0068CBB0                                 ; => [ String: er | Call: sub_68cbb0 ]
...
0068EED1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068EF00    call 0x0068CBB0                                 ; => [ Call: sub_68cbb0 | String: el ]
...
0068EF1B    call 0x0068CBB0                                 ; => [ String: er | Call: sub_68cbb0 ]
...
0068EF3E    test al, al
0068EF40    jz 0x0068EFD5                                   ; => [ Call: sub_68cbb0 | String: in ]
0068EF46    mov edx, 0x878000
0068EF4B    lea ecx, ss:[ebp-0x1C]
0068EF4E    call 0x0063D720                                 ; => [ String: nen | Call: sub_63d720 ]
...
0068EFAC    jz 0x0068EFC9                                   ; => [ Data: data_cf65bc ]
0068EFAE    lea ecx, ss:[ebp-0x1C]
0068EFB1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068EFC4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068EFE8    test al, al
0068EFEA    jz 0x0068F127                                   ; => [ Call: sub_68cbb0 | String: sal ]
0068EFF0    mov edx, 0x824DB0
0068EFF5    lea ecx, ss:[ebp-0x1C]
0068EFF8    call 0x0063D720                                 ; => [ String: es | Call: sub_63d720 ]
...
0068F056    jz 0x0068F073                                   ; => [ Data: data_cf65bc ]
0068F058    lea ecx, ss:[ebp-0x1C]
0068F05B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F0E6    jz 0x0068F103                                   ; => [ Data: data_cf65bc ]
0068F0E8    lea ecx, ss:[ebp-0x1C]
0068F0EB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F0FE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068F119    jz 0x0068F49D                                   ; => [ Data: data_cf65bc ]
...
0068F12D    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
0068F146    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
0068F170    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: {[p\rnm ]
...
0068F1CE    jz 0x0068F1EB                                   ; => [ Data: data_cf65bc ]
0068F1D0    lea ecx, ss:[ebp-0x1C]
0068F1D3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F25D    jz 0x0068F27A                                   ; => [ Data: data_cf65bc ]
0068F25F    lea ecx, ss:[ebp-0x1C]
0068F262    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F275    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068F2A3    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: en ]
...
0068F301    jz 0x0068F31E                                   ; => [ Data: data_cf65bc ]
0068F303    lea ecx, ss:[ebp-0x1C]
0068F306    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F390    jz 0x0068F3AD                                   ; => [ Data: data_cf65bc ]
0068F392    lea ecx, ss:[ebp-0x1C]
0068F395    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F3A8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068F3C8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F3EB    call 0x0063D720                                 ; => [ String: es | Call: sub_63d720 ]
...
0068F449    jz 0x0068F466                                   ; => [ Data: data_cf65bc ]
0068F44B    lea ecx, ss:[ebp-0x1C]
0068F44E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F485    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068F498    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068F49D    mov eax, ebx
0068F49F    mov ecx, dword ptr ss:[ebp-0x0C]
0068F4A2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068F4A9    pop ecx
0068F4AA    pop edi
0068F4AB    pop esi
0068F4AC    pop ebx
...
0068F4CA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\Localization.cpp | String: DefaultPlural_de | Data: data_801800 | String: name.Length() > 0 ]
0068F4CF    add esp, 0x0C
0068F4D2    call 0x0063BC30
0068F4D7    test al, al
0068F4D9    jz 0x0068F4DC                                   ; => [ Call: sub_63bc30 ]
0068F4DB    int3
0068F4DC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
