...
004B3975    push 0x762A80                                   ; => [ Call: __ehhandler$??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@QBDI@Z | Type: EHRegistrationNode ]
004B397A    mov eax, dword ptr fs:[0x00000000]
004B3980    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004B398E    push eax                                        ; => [ Data: __security_cookie ]
004B398F    lea eax, ss:[ebp-0x0C]
004B3992    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004B3998    mov esi, ecx
004B399A    lea edx, ss:[ebp-0x0D]
004B399D    call 0x00675640
004B39A2    test al, al
004B39A4    jz 0x004B39BB                                   ; => [ Call: sub_675640 ]
004B39A6    mov al, byte ptr ss:[ebp-0x0D]
004B39A9    mov ecx, dword ptr ss:[ebp-0x0C]
004B39AC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B39B3    pop ecx
004B39B4    pop edi
004B39B5    pop esi
004B39B6    pop ebx
...
004B39CE    call 0x004AED40                                 ; => [ Call: sub_4aed40 ]
004B39D3    mov al, 0x01
004B39D5    mov ecx, dword ptr ss:[ebp-0x0C]
004B39D8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B39DF    pop ecx
004B39E0    pop edi
004B39E1    pop esi
004B39E2    pop ebx
...
004B39EC    call 0x004AEDF0                                 ; => [ Call: sub_4aedf0 ]
004B39F1    mov al, 0x01
004B39F3    mov ecx, dword ptr ss:[ebp-0x0C]
004B39F6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B39FD    pop ecx
004B39FE    pop edi
004B39FF    pop esi
004B3A00    pop ebx
...
004B3A0C    test al, al
004B3A0E    jnz 0x004B39D3                                  ; => [ Call: sub_624890 ]
...
004B3A22    jnz 0x004B3B5F                                  ; => [ Data: data_147abe8 ]
...
004B3A39    setz byte ptr ds:[0x00CC8D6C]                   ; => [ Data: data_cc8d6c ]
004B3A40    mov ecx, dword ptr ss:[ebp-0x0C]
004B3A43    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B3A4A    pop ecx
004B3A4B    pop edi
004B3A4C    pop esi
004B3A4D    pop ebx
...
004B3A5B    mov ecx, dword ptr ds:[0x019E3980]              ; => [ Data: data_19e3980 ]
004B3A61    push ecx
004B3A62    push 0x801F64
004B3A67    lea eax, ds:[ecx+0x01]
004B3A6A    mov dword ptr ds:[0x019E3980], eax              ; => [ Data: data_19e3980 ]
004B3A6F    lea eax, ss:[ebp-0x14]
004B3A72    push eax
004B3A73    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: New Notification %d ]
004B3A78    mov eax, dword ptr ss:[ebp-0x14]
004B3A7B    add esp, 0x0C
004B3A7E    test eax, eax
004B3A80    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004B3A85    cmovnz esi, eax
004B3A88    mov eax, dword ptr ds:[0x0147AC20]
004B3A8D    add eax, 0x902C
004B3A92    push eax
004B3A93    call dword ptr ds:[0x00775138]                  ; => [ Data: data_147ac20 ]
004B3A99    mov edi, dword ptr ds:[0x0147AC20]              ; => [ Data: data_147ac20 ]
...
004B3AB5    call 0x0063B5F0                                 ; => [ String: too many queued notifications | Call: sub_63b5f0 ]
004B3ABA    mov edi, dword ptr ds:[0x0147AC20]              ; => [ Data: data_147ac20 ]
...
004B3ADE    inc eax
004B3ADF    mov ecx, 0x801F78                               ; => [ Data: data_801f78 ]
...
004B3AF5    mov byte ptr ds:[ecx+edx*1-0x01], al            ; => [ Data: data_801f78 ]
004B3AF9    test al, al
...
004B3B36    jz 0x004B3B5F                                   ; => [ Data: data_cf65bc ]
...
004B3B47    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B3B5A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B3B5F    xor al, al
004B3B61    mov ecx, dword ptr ss:[ebp-0x0C]
004B3B64    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B3B6B    pop ecx
004B3B6C    pop edi
004B3B6D    pop esi
004B3B6E    pop ebx
