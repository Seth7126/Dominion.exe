...
00598515    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
0059851A    mov eax, dword ptr fs:[0x00000000]
00598520    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00598521    sub esp, 0x08
00598524    push esi
00598525    push edi
00598526    mov eax, dword ptr ds:[0x008C4040]
0059852B    xor eax, ebp
0059852D    push eax                                        ; => [ Data: __security_cookie ]
0059852E    lea eax, ss:[ebp-0x0C]
00598531    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00598537    mov esi, edx
00598539    mov edi, ecx
0059853B    call 0x005CF7E0
00598540    mov edx, eax
00598542    mov ecx, esi
00598544    call 0x00571B30                                 ; => [ Call: sub_571b30 | Call: sub_5cf7e0 ]
...
00598572    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
...
005985C4    jz 0x005985ED                                   ; => [ Data: data_cf65bc ]
...
005985D5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005985E8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005985ED    mov eax, esi
005985EF    mov ecx, dword ptr ss:[ebp-0x0C]
005985F2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005985F9    pop ecx
005985FA    pop edi
005985FB    pop esi
...
00598619    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp | Call: sub_63b870 | String: t | String: CardnameTranslation | Data: data_801800 ]
0059861E    add esp, 0x0C
00598621    call 0x0063BC30
00598626    test al, al
00598628    jz 0x0059862B                                   ; => [ Call: sub_63bc30 ]
0059862A    int3
0059862B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00598630    push 0x8248C0
00598635    push 0x347
0059863A    push 0x82487C
0059863F    mov edx, 0x801800
00598644    mov ecx, 0x8248D4
00598649    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp | Call: sub_63b870 | String: t | String: CardnameTranslation | Data: data_801800 ]
0059864E    add esp, 0x0C
00598651    call 0x0063BC30
00598656    test al, al
00598658    jz 0x0059865B                                   ; => [ Call: sub_63bc30 ]
0059865A    int3
0059865B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
