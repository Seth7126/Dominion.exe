...
00551B49    push esi
00551B4A    push edi
00551B4B    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
00551B50    push ecx
00551B51    push 0x00
00551B53    push 0x00
...
00551B60    call 0x00568960                                 ; => [ Call: sub_568960 ]
...
00551BBA    mov dword ptr ss:[esp+0x30], 0x00               ; => [ Call: __builtin_memset ]
...
00551BDA    xor eax, eax                                    ; => [ Call: nullptr ]
00551BDC    jmp 0x00551C23
00551BDE    call 0x00573400                                 ; => [ Call: sub_573400 ]
