...
00567A5B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00567A60    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00567A7D    push 0x06
00567A7F    push eax
00567A80    call 0x005678E0                                 ; => [ Call: sub_5678e0 ]
...
00567A9D    movlpd qword ptr ss:[esp+0x34], xmm0            ; => [ Call: __builtin_memset ]
...
00567AF4    push 0x01
00567AF6    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00567B2D    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
...
00567B46    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00567B5A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00567B78    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00567BB6    push eax
00567BB7    call 0x00586320                                 ; => [ Call: sub_586320 ]
...
00567BCC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
