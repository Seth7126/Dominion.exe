...
005E17B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005E17C2    push esi
005E17C3    push edi
005E17C4    push eax                                        ; => [ Data: __security_cookie ]
005E17C5    lea eax, ss:[ebp-0x0C]
005E17C8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005E17CE    mov edi, dword ptr ss:[ebp+0x08]
005E17D1    mov ecx, dword ptr ds:[edi+0x1C]
005E17D4    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
005E17D9    mov ebx, eax
005E17DB    call 0x005CB070                                 ; => [ Call: sub_5cb070 ]
...
005E17F4    push 0x85E97C                                   ; => [ String: AbilityClick ]
005E17F9    push 0x4398
005E17FE    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1803    mov ecx, 0x85E960                               ; => [ String: gfx.type == DOMGFX_ABILITY ]
005E1808    jmp 0x005E1C2D
005E180D    mov esi, dword ptr ds:[edi+0x04]
005E1810    lea ecx, ss:[ebp-0xC94]
005E1816    mov edx, 0x85E9E0
005E181B    call 0x0063D720                                 ; => [ String: btn_item | Call: sub_63d720 ]
005E1820    mov eax, dword ptr ss:[ebp-0xC94]
005E1826    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E186C    jz 0x005E1896                                   ; => [ Data: data_cf65bc ]
005E186E    lea ecx, ss:[ebp-0xC94]
005E1874    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E1887    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E188C    mov dword ptr ss:[ebp-0xC94], 0x801800          ; => [ Data: data_801800 ]
...
005E18BC    call 0x005DE8B0                                 ; => [ Call: sub_5de8b0 ]
005E18C1    test eax, eax
005E18C3    jnz 0x005E18FE
005E18C5    push 0x871958                                   ; => [ String: LookupCard ]
005E18CA    push 0x3D96
005E18CF    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E18D4    mov ecx, 0x871964                               ; => [ Data: data_871964 ]
...
005E18EE    call 0x005916D0                                 ; => [ Call: sub_5916d0 ]
...
005E1902    call 0x005D0AB0                                 ; => [ Call: sub_5d0ab0 ]
005E1907    jmp 0x005E196F
005E1909    push 0x85E97C                                   ; => [ String: AbilityClick ]
005E190E    push 0x43AE
005E1913    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1918    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005E191D    jmp 0x005E1C2D
005E1922    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
005E193D    call 0x0063B7F0                                 ; => [ String: failed to submit ability click, waiting | Call: sub_63b7f0 ]
005E1942    add esp, 0x04
005E1945    jmp 0x005E1BFE
005E194A    mov eax, dword ptr ds:[ebx+0x1F4]
005E1950    mov edx, 0xB80AF8
005E1955    mov dword ptr ds:[0x00B80B68], eax              ; => [ Data: data_b80b68 ]
005E195A    mov dword ptr ds:[0x00B80B64], 0x01             ; => [ Data: data_b80b64 ]
005E1964    mov ecx, dword ptr ds:[ecx+0x7590]
005E196A    call 0x005EE590                                 ; => [ Data: data_b80af8 | Call: sub_5ee590 ]
005E196F    mov esi, dword ptr ds:[edi+0x04]
005E1972    lea ecx, ss:[ebp-0xC94]
005E1978    mov edx, 0x85E9F4
005E197D    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_card ]
005E1982    mov eax, dword ptr ss:[ebp-0xC94]
005E1988    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E19CE    jz 0x005E19F8                                   ; => [ Data: data_cf65bc ]
005E19D0    lea ecx, ss:[ebp-0xC94]
005E19D6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E19E9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E19EE    mov dword ptr ss:[ebp-0xC94], 0x801800          ; => [ Data: data_801800 ]
...
005E1A09    push 0x85E948                                   ; => [ String: AbilityAssociatedCard ]
005E1A0E    push 0x438B
005E1A13    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1A18    mov ecx, 0x85E960                               ; => [ String: gfx.type == DOMGFX_ABILITY ]
005E1A1D    jmp 0x005E1C2D
005E1A22    mov ecx, dword ptr ds:[ebx+0x218]
005E1A28    test ecx, ecx
005E1A2A    jnz 0x005E1A45
005E1A2C    push 0x85E948                                   ; => [ String: AbilityAssociatedCard ]
005E1A31    push 0x438C
005E1A36    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1A3B    mov ecx, 0x85E98C                               ; => [ String: gfx.ability.assocCardHead != DOMGFX_NULL ]
005E1A40    jmp 0x005E1C2D
005E1A45    call 0x005CBA00
005E1A4A    xor dl, dl
005E1A4C    mov ecx, eax
005E1A4E    call 0x005D0AB0                                 ; => [ Call: sub_5cba00 | Call: sub_5d0ab0 ]
005E1A53    mov esi, dword ptr ds:[edi+0x04]
005E1A56    lea ecx, ss:[ebp-0xC94]
005E1A5C    mov edx, 0x85E9EC
005E1A61    call 0x0063D720                                 ; => [ String: btn_all | Call: sub_63d720 ]
005E1A66    mov eax, dword ptr ss:[ebp-0xC94]
005E1A6C    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E1AB2    jz 0x005E1ADC                                   ; => [ Data: data_cf65bc ]
005E1AB4    lea ecx, ss:[ebp-0xC94]
005E1ABA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E1ACD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E1AD2    mov dword ptr ss:[ebp-0xC94], 0x801800          ; => [ Data: data_801800 ]
005E1ADC    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005E1AE3    test esi, esi
005E1AE5    jnz 0x005E1BFE
005E1AEB    mov edi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
005E1B06    call 0x0063B7F0                                 ; => [ String: failed to submit ability all click, waiting | Call: sub_63b7f0 ]
005E1B0B    add esp, 0x04
005E1B0E    jmp 0x005E1BFE
005E1B13    cmp dword ptr ds:[ebx+0x21C], 0x01
005E1B1A    jnle 0x005E1B35
005E1B1C    push 0x85E97C                                   ; => [ String: AbilityClick ]
005E1B21    push 0x43D0
005E1B26    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1B2B    mov ecx, 0x85EA00                               ; => [ String: gfx.ability.count > 1 ]
005E1B30    jmp 0x005E1C2D
005E1B35    cmp dword ptr ds:[ebx+0x214], 0x00
005E1B3C    jnz 0x005E1B57
005E1B3E    push 0x85E97C                                   ; => [ String: AbilityClick ]
005E1B43    push 0x43D1
005E1B48    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1B4D    mov ecx, 0x85EA64                               ; => [ String: gfx.ability.stackNext != DOMGFX_NULL ]
...
005E1B65    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
...
005E1B88    mov edi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
005E1B8E    mov eax, dword ptr ds:[ebx+0x21C]
005E1B94    cmp esi, eax
005E1B96    jz 0x005E1BC7
005E1B98    push 0x85E97C                                   ; => [ String: AbilityClick ]
005E1B9D    push 0x43E0
005E1BA2    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1BA7    mov ecx, 0x85EA9C                               ; => [ String: numIds == gfx.ability.count ]
005E1BAC    jmp 0x005E1C2D
005E1BB1    push 0x85E97C                                   ; => [ String: AbilityClick ]
005E1BB6    push 0x43DA
005E1BBB    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005E1BC0    mov ecx, 0x85EA44                               ; => [ String: gfxCur.type == DOMGFX_ABILITY ]
...
005E1BD7    call 0x00761FBE                                 ; => [ Data: data_b80b68 | Call: memcpy ]
005E1BDC    mov eax, dword ptr ds:[ebx+0x21C]
005E1BE2    add esp, 0x0C
005E1BE5    mov dword ptr ds:[0x00B80B64], eax              ; => [ Data: data_b80b64 ]
005E1BEA    test edi, edi
005E1BEC    jz 0x005E1C1C
005E1BEE    mov ecx, dword ptr ds:[edi+0x7590]
005E1BF4    mov edx, 0xB80AF8
005E1BF9    call 0x005EE590                                 ; => [ Data: data_b80af8 | Call: sub_5ee590 ]
005E1BFE    xor al, al
005E1C00    mov ecx, dword ptr ss:[ebp-0x0C]
005E1C03    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E1C0A    pop ecx
005E1C0B    pop edi
005E1C0C    pop esi
005E1C0D    pop ebx
...
005E1C13    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005E1C18    mov esp, ebp
005E1C1A    pop ebp
005E1C1B    ret
005E1C1C    push 0x77EB90                                   ; => [ String: GetClient ]
005E1C21    push 0x7B
005E1C23    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
005E1C28    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
005E1C2D    mov edx, 0x801800
005E1C32    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005E1C37    add esp, 0x0C
005E1C3A    call 0x0063BC30
005E1C3F    test al, al
005E1C41    jz 0x005E1C44                                   ; => [ Call: sub_63bc30 ]
005E1C43    int3
005E1C44    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
