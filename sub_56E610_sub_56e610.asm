...
0056E616    byte 0
0056E617    byte 0
0056E618    call 0x00761E50                                 ; => [ Call: __chkstk ]
0056E61D    mov eax, dword ptr ds:[0x008C4040]
0056E622    xor eax, ebp
0056E624    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: __security_cookie ]
0056E627    push ebx
0056E628    push esi
0056E629    push edi
0056E62A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056E63E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056E674    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
...
0056E68E    nop
0056E690    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056E6A8    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056E6D4    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0056E6E6    pop ebx
0056E6E7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
