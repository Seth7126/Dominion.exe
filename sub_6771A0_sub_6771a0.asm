...
006771A5    push 0x76D8D7                                   ; => [ Call: __ehhandler$?tzset_from_environment_nolock@@YAXPA_W@Z | Type: EHRegistrationNode ]
006771AA    mov eax, dword ptr fs:[0x00000000]
006771B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006771B1    sub esp, 0x38
006771B4    push ebx
006771B5    push esi
006771B6    push edi
006771B7    mov eax, dword ptr ds:[0x008C4040]
006771BC    xor eax, ebp                                    ; => [ Data: __security_cookie ]
006771BE    push eax
006771BF    lea eax, ss:[ebp-0x0C]
006771C2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006771C8    mov eax, edx
006771CA    mov dword ptr ss:[ebp-0x34], eax
006771CD    mov dword ptr ss:[ebp-0x38], ecx
006771D0    xor ebx, ebx
006771D2    xor dl, dl
006771D4    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006771E5    mov dword ptr ss:[ebp-0x18], edi                ; => [ Data: data_801800 ]
006771E8    mov esi, edi                                    ; => [ Data: data_801800 ]
006771EA    mov dword ptr ss:[ebp-0x04], ebx
006771ED    mov dword ptr ss:[ebp-0x24], esi                ; => [ Data: data_801800 ]
006771F0    mov byte ptr ss:[ebp-0x04], 0x01
006771F4    mov dword ptr ss:[ebp-0x20], ebx                ; => [ Call: nullptr ]
...
00677222    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
00677235    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
0067725F    mov eax, 0x801800                               ; => [ Data: data_801800 ]
00677264    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0067728C    xor eax, eax                                    ; => [ Call: nullptr | Call: nullptr ]
...
006772CE    push eax
006772CF    push 0xDC
006772D4    call 0x006DCE10                                 ; => [ Data: data_8cae70 | Call: sub_6dce10 ]
...
006772F0    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006772F5    test al, al
006772F7    jz 0x00677319
006772F9    test esi, esi
006772FB    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
0067730F    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: NEW\t%s\t%s ]
...
0067732A    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0067732F    test eax, eax
00677331    mov eax, ecx                                    ; => [ Data: data_801800 ]
00677333    jz 0x00677350                                   ; => [ Call: nullptr | Call: sub_68caf0 ]
...
00677346    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: \t%s\t%s ]
...
00677361    call 0x0063B5F0                                 ; => [ String: MISS\t%s\t%s | Call: sub_63b5f0 ]
...
0067738A    xor esi, esi                                    ; => [ Call: nullptr ]
0067738C    mov dword ptr ss:[ebp-0x34], esi                ; => [ Call: nullptr ]
0067738F    nop
...
006773A5    jnz 0x00677564                                  ; => [ String: lang_jpn ]
006773AB    mov edx, 0x804D68
006773B0    lea ecx, ss:[ebp-0x30]
006773B3    call 0x0063D720                                 ; => [ String: _- | Call: sub_63d720 ]
...
006773CF    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
006773F2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677405    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0067740A    cmovnz ecx, eax
0067740D    push ecx
0067740E    lea ecx, ss:[ebp-0x1C]
00677411    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
0067742C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067743F    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00677444    cmovnz ecx, eax
00677447    push ecx
00677448    lea ecx, ss:[ebp-0x14]
0067744B    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
0067747C    jz 0x006774AC                                   ; => [ Data: data_cf65bc ]
...
0067748D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006774A0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006774A5    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006774C3    jz 0x006774E7                                   ; => [ Data: data_cf65bc ]
006774C5    lea ecx, ss:[ebp-0x1C]
006774C8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006774DB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006774E0    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
006774E7    mov byte ptr ss:[ebp-0x04], 0x08
006774EB    cmp dword ptr ds:[0x00CF65BC], 0x00
006774F2    jz 0x00677522                                   ; => [ Data: data_cf65bc ]
...
00677503    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677516    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067751B    mov dword ptr ss:[ebp-0x2C], 0x801800           ; => [ Data: data_801800 ]
00677522    mov byte ptr ss:[ebp-0x04], 0x09
00677526    cmp dword ptr ds:[0x00CF65BC], 0x00
0067752D    jz 0x0067755D                                   ; => [ Data: data_cf65bc ]
...
0067753E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00677551    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00677556    mov dword ptr ss:[ebp-0x30], 0x801800           ; => [ Data: data_801800 ]
...
00677594    jz 0x006775B1                                   ; => [ Data: data_cf65bc ]
00677596    lea ecx, ss:[ebp-0x24]
00677599    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006775AC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006775C8    jz 0x006775E5                                   ; => [ Data: data_cf65bc ]
006775CA    lea ecx, ss:[ebp-0x18]
006775CD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006775E0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006775E5    mov ecx, dword ptr ss:[ebp-0x0C]
006775E8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006775EF    pop ecx
006775F0    pop edi
006775F1    pop esi
006775F2    pop ebx
...
00677610    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
00677615    add esp, 0x0C
00677618    call 0x0063BC30
0067761D    test al, al
0067761F    jz 0x00677622                                   ; => [ Call: sub_63bc30 ]
00677621    int3
00677622    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
