...
006A17E5    push 0x76F4C0                                   ; => [ Type: EHRegistrationNode | Call: sub_76f4c0 ]
006A17EA    mov eax, dword ptr fs:[0x00000000]
006A17F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A17FE    push eax                                        ; => [ Data: __security_cookie ]
006A17FF    lea eax, ss:[ebp-0x0C]
006A1802    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A189F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A18BF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A18D9    push ebx
006A18DA    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
006A1901    jz 0x006A191E                                   ; => [ Data: data_cf65bc ]
006A1903    lea ecx, ss:[ebp-0x18]
006A1906    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1919    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A1932    jz 0x006A194F                                   ; => [ Data: data_cf65bc ]
006A1934    lea ecx, ss:[ebp-0x1C]
006A1937    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A196E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1981    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A1986    mov edi, dword ptr ss:[ebp-0x14]
006A1989    mov eax, edi
006A198B    mov ecx, dword ptr ss:[ebp-0x0C]
006A198E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A1995    pop ecx
006A1996    pop edi
006A1997    pop esi
006A1998    pop ebx
...
006A19A5    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006A19B9    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006A19CF    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006A19EB    jz 0x006A1B1F                                   ; => [ String: sys ]
006A19F1    mov eax, dword ptr ss:[ebp+0x08]
006A19F4    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006A1A0A    jz 0x006A1B1F                                   ; => [ String: res ]
006A1A10    mov eax, dword ptr ss:[ebp+0x08]
006A1A13    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
006A1A29    jz 0x006A1B1F                                   ; => [ String: xbin ]
006A1A2F    mov esi, dword ptr ds:[0x0147D094]
006A1A35    mov esi, dword ptr ds:[esi]                     ; => [ Data: data_147d094 ]
...
006A1A46    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1A66    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1A7F    push ebx
006A1A80    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
006A1AA7    jz 0x006A1AC4                                   ; => [ Data: data_cf65bc ]
006A1AA9    lea ecx, ss:[ebp-0x1C]
006A1AAC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1AEF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1B06    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A1B0B    mov eax, edi
006A1B0D    mov ecx, dword ptr ss:[ebp-0x0C]
006A1B10    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A1B17    pop ecx
006A1B18    pop edi
006A1B19    pop esi
006A1B1A    pop ebx
...
006A1B2F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1B60    jz 0x006A1989                                   ; => [ Data: data_cf65bc ]
006A1B66    lea ecx, ss:[ebp+0x08]
006A1B69    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1B80    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A1B85    mov eax, edi
006A1B87    mov ecx, dword ptr ss:[ebp-0x0C]
006A1B8A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A1B91    pop ecx
006A1B92    pop edi
006A1B93    pop esi
006A1B94    pop ebx
...
006A1BA6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A1BD7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006A1BDC    add esp, 0x0C
006A1BDF    call 0x0063BC30
006A1BE4    test al, al
006A1BE6    jz 0x006A1BE9                                   ; => [ Call: sub_63bc30 ]
006A1BE8    int3
006A1BE9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
