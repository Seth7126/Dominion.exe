...
005BF6A8    push 0x7695AB                                   ; => [ Call: sub_7695ab | Type: EHRegistrationNode ]
005BF6AD    mov eax, dword ptr fs:[0x00000000]
005BF6B3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005BF6B4    push ebx
...
005BF6C4    push eax                                        ; => [ Data: __security_cookie ]
005BF6C5    lea eax, ss:[ebp-0x0C]
005BF6C8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005BF6ED    mov dword ptr ss:[ebp-0x38], 0x00               ; => [ Call: nullptr ]
...
005BF715    call 0x005C83D0                                 ; => [ Call: sub_5c83d0 ]
...
005BF74A    mov dword ptr ss:[ebp-0x38], eax                ; => [ Call: sub_5c0320 ]
005BF74D    jmp 0x005BF756
005BF74F    mov dword ptr ss:[ebp-0x38], 0x00               ; => [ Call: nullptr ]
...
005BF77D    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005BF7B1    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005BF7CB    push eax
005BF7CC    call 0x005BC1C0                                 ; => [ Call: sub_5bc1c0 ]
...
005BF7EF    mov dword ptr ss:[ebp-0x6C], eax                ; => [ Call: sub_5bbe40 ]
...
005BF807    mov dword ptr ss:[ebp-0x60], eax                ; => [ Call: sub_5bbe40 ]
005BF80A    mov ecx, esi
005BF80C    mov byte ptr ss:[ebp-0x04], 0x0E
005BF810    call 0x005C5C60                                 ; => [ Call: sub_5c5c60 ]
005BF815    push eax
...
005BF83A    movups xmmword ptr ds:[eax+ecx*1], xmm0         ; => [ Call: sub_5c8a00 ]
...
005BF851    call 0x005C8640                                 ; => [ Call: sub_5c8640 ]
...
005BF8A7    jle 0x005BF929                                  ; => [ Call: sub_5c5c60 ]
...
005BF8C2    jle 0x005BF8FC                                  ; => [ Call: sub_5c1b00 ]
...
005BF8F0    call 0x005C1B00                                 ; => [ Call: sub_5c1b00 ]
