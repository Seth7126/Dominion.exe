...
00528B0B    call 0x00761E50
00528B10    mov eax, dword ptr ds:[0x008C4040]
...
00528B4B    call 0x00561940
00528B50    xorps xmm0, xmm0
00528B53    mov dword ptr ss:[esp+0x20], 0x00
