...
006960B5    push 0x76F005                                   ; => [ Call: sub_76f005 | Type: EHRegistrationNode ]
006960BA    mov eax, dword ptr fs:[0x00000000]
006960C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006960CE    push eax                                        ; => [ Data: __security_cookie ]
006960CF    lea eax, ss:[ebp-0x0C]
006960D2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006960D8    mov edi, ecx
006960DA    mov dword ptr ss:[ebp-0x20], 0x00               ; => [ Call: nullptr ]
...
006960FB    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0069610C    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00696124    mov esi, 0x801800                               ; => [ Data: data_801800 ]
00696129    mov dword ptr ds:[ecx], edi
0069612B    mov edx, esi                                    ; => [ Data: data_801800 ]
...
00696146    call 0x006C48E0                                 ; => [ Call: sub_6c48e0 ]
...
0069616B    mov ecx, esi                                    ; => [ Data: data_801800 ]
0069616D    push 0x00
0069616F    cmovnz ecx, eax
00696172    call 0x00695FB0
00696177    mov bl, al                                      ; => [ Call: sub_695fb0 ]
...
0069618E    call 0x0063B5F0                                 ; => [ String: Failed to write xbin file: '%s' | Call: sub_63b5f0 ]
00696193    add esp, 0x08
00696196    mov byte ptr ss:[ebp-0x04], 0x02
0069619A    cmp dword ptr ds:[0x00CF65BC], 0x00
006961A1    jz 0x006961D1                                   ; => [ Data: data_cf65bc ]
...
006961B2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006961C5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006961CA    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006961EA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006961EF    test esi, esi
006961F1    jnz 0x006961E0
006961F3    mov al, bl
006961F5    mov ecx, dword ptr ss:[ebp-0x0C]
006961F8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006961FF    pop ecx
00696200    pop edi
00696201    pop esi
00696202    pop ebx
...
0069621D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: assetPtr->pAssetData && !TEST_BIT(assetPtr->pAssetData->defFlags, DEF_FLAGS_CONTIGUOUS) | String: C:\x\ax2017\Engine\DefBin.cpp | Data: data_801800 | String: DefBinWriteXbinFile ]
00696222    add esp, 0x0C
00696225    call 0x0063BC30
0069622A    test al, al
0069622C    jz 0x0069622F                                   ; => [ Call: sub_63bc30 ]
0069622E    int3
0069622F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
