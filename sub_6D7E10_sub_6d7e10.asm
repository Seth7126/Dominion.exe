...
006D7E15    push 0x770CD5                                   ; => [ Type: EHRegistrationNode | Call: sub_770cd5 ]
006D7E1A    mov eax, dword ptr fs:[0x00000000]
006D7E20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006D7E2E    push eax                                        ; => [ Data: __security_cookie ]
006D7E2F    lea eax, ss:[ebp-0x0C]
006D7E32    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006D7E38    mov dword ptr ss:[ebp-0x14], edx
006D7E3B    mov eax, ecx
006D7E3D    mov dword ptr ss:[ebp-0x18], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006D7E89    jz 0x006D7EB9                                   ; => [ Data: data_cf65bc ]
...
006D7E9A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006D7EAD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006D7EB2    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006D7EE3    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006D7F01    call 0x006D8ED0                                 ; => [ Call: sub_6d8ed0 ]
...
006D7F6A    call 0x006D7AF0                                 ; => [ Call: sub_6d7af0 ]
...
006D7F87    mov eax, dword ptr ds:[0x01777550]              ; => [ Data: data_1777550 ]
...
006D7FA4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006D7FAB    pop ecx
006D7FAC    pop edi
006D7FAD    pop esi
006D7FAE    pop ebx
...
006D7FC9    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006D7FCE    add esp, 0x0C
006D7FD1    call 0x0063BC30
006D7FD6    test al, al
006D7FD8    jz 0x006D7FDB                                   ; => [ Call: sub_63bc30 ]
006D7FDA    int3
006D7FDB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
