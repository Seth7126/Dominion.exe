...
005D9057    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
...
005D909B    jl 0x005D90AC                                   ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
005D909D    mov ecx, edi
005D909F    call 0x004D63A0                                 ; => [ Call: sub_4d63a0 ]
005D90A4    test al, al
...
005D90CC    call 0x004D63A0                                 ; => [ Call: sub_4d63a0 ]
005D90D1    test al, al
...
005D90E7    mov dword ptr ds:[0x00CF64A0], ebx              ; => [ Data: data_cf64a0 ]
005D90ED    mov ecx, 0x870CE8
005D90F2    mov dword ptr ds:[0x00CF64A4], esi              ; => [ Data: data_cf64a4 ]
005D90F8    mov dword ptr ds:[0x008DB6B0], 0x20             ; => [ Data: data_8db6b0 ]
005D9102    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_ui_daily_difficulty_confirm_header ]
005D9107    add esp, 0x04
005D910A    mov esi, 0x801800                               ; => [ Data: data_801800 ]
005D910F    test eax, eax
005D9111    jnz 0x005D911A
005D9113    mov ecx, 0x870CE8                               ; => [ String: dom_ui_daily_difficulty_confirm_header ]
005D9118    jmp 0x005D9123
005D911A    mov eax, dword ptr ds:[eax]
005D911C    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
005D9137    call 0x0068CAF0                                 ; => [ Call: nullptr | String: dom_ui_daily_difficulty_confirm_body | Call: sub_63d8d0 | Call: sub_68caf0 | Data: data_8db750 ]
005D913C    add esp, 0x04
005D913F    test eax, eax
005D9141    jnz 0x005D914A
005D9143    mov esi, 0x870CC0                               ; => [ String: dom_ui_daily_difficulty_confirm_body ]
...
005D9157    call 0x0063D8D0                                 ; => [ Data: data_8db754 | Call: sub_63d8d0 ]
005D915C    push 0x801800
005D9161    mov ecx, 0x8DB758
005D9166    call 0x0063D8D0                                 ; => [ Data: data_8db758 | Data: data_801800 | Call: sub_63d8d0 ]
005D916B    push 0x801800
005D9170    mov ecx, 0x8DB75C
005D9175    call 0x0063D8D0                                 ; => [ Data: data_801800 | Data: data_8db75c | Call: sub_63d8d0 ]
005D917A    mov dword ptr ds:[0x008DB760], 0x5D91F0         ; => [ Data: data_8db760 ]
005D9184    mov dword ptr ds:[0x008DB764], 0x00             ; => [ Data: data_8db764 ]
005D918E    pop edi
005D918F    pop esi
005D9190    pop ebx
005D9191    ret
...
005D9196    call 0x005D8F30                                 ; => [ Call: sub_5d8f30 ]
005D919B    mov ecx, dword ptr ds:[0x00BE232C]              ; => [ Data: data_be232c ]
005D91A1    cmp ecx, 0x06
005D91A4    jnl 0x005D91BD
005D91A6    lea eax, ds:[ecx*8+0xBE22FC]
005D91AD    inc ecx
005D91AE    mov dword ptr ds:[0x00BE232C], ecx              ; => [ Data: data_be232c ]
005D91B4    pop edi
005D91B5    mov dword ptr ds:[eax+0x04], esi                ; => [ Data: data_be2300 ]
005D91B8    pop esi
005D91B9    mov dword ptr ds:[eax], ebx                     ; => [ Data: data_be22fc ]
005D91BB    pop ebx
005D91BC    ret                                             ; => [ Data: data_be22fc ]
005D91BD    push 0x870D10
005D91C2    push 0x31F3
005D91C7    push 0x86F1E8
005D91CC    mov edx, 0x801800
005D91D1    mov ecx, 0x870D1C
005D91D6    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: TryModifyAI | String: gDomClient.numAIMods < MAX_PLAYERS_DOM ]
005D91DB    add esp, 0x0C
005D91DE    call 0x0063BC30
005D91E3    test al, al
005D91E5    jz 0x005D91E8                                   ; => [ Call: sub_63bc30 ]
005D91E7    int3
005D91E8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
