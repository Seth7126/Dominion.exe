...
00624088    push 0x76B7FD                                   ; => [ Call: __ehhandler$?_Process_message_helper@?$ordered_message_processor@I@Concurrency@@AAEJXZ | Type: EHRegistrationNode ]
0062408D    mov eax, dword ptr fs:[0x00000000]
00624093    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00624094    push ebx
...
006240A1    push eax                                        ; => [ Data: __security_cookie ]
006240A2    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006240A5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006240AB    mov edi, edx
006240AD    mov esi, ecx
006240AF    cmp dword ptr ds:[esi+0x30], 0x0B
006240B3    jnl 0x006240CE
006240B5    push 0x86B194                                   ; => [ String: GameSpecific_Load ]
006240BA    push 0xE92B
006240BF    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
006240C4    mov ecx, 0x86B1C8                               ; => [ String: save.setup.config.version >= GameMinimumVersion(GameSpecific_GameType(), false) ]
006240C9    jmp 0x00624431
006240CE    call 0x005D0E60                                 ; => [ Call: sub_5d0e60 ]
006240D3    test byte ptr ds:[ebx+0x0C], 0x01
006240D7    mov dword ptr ds:[0x00CF64A8], 0xFFFFFFFF       ; => [ Data: data_cf64a8 ]
006240E1    jnz 0x006240FF
006240E3    cmp dword ptr ds:[0x00CC8D5C], 0x00
006240EA    jz 0x00624420                                   ; => [ Data: data_cc8d5c ]
006240F0    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
006240F5    mov dword ptr ds:[eax+0x7594], 0xFFFFFFFF
006240FF    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
00624106    mov dword ptr ds:[0x00B604DC], 0xFFFFFFFF       ; => [ Data: data_b604dc ]
00624110    mov dword ptr ds:[0x00B809B4], 0x00             ; => [ Data: data_b809b4 ]
0062411A    jnz 0x00624143
0062411C    mov ecx, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
00624122    test ecx, ecx
00624124    jz 0x00624143
00624126    mov edx, 0x8054A8
0062412B    call 0x0067BD70
00624130    mov ecx, eax
00624132    call 0x0064E7A0                                 ; => [ String: tbl_center_holder | Call: sub_67bd70 | Call: sub_64e7a0 ]
00624137    mov ecx, eax
00624139    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
0062413E    call 0x0065BF40                                 ; => [ Call: sub_65bf40 ]
...
00624163    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
0062418B    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
006241B3    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
006241C6    mov dword ptr ds:[0x00B809D4], 0x00             ; => [ Data: data_b809d4 ]
006241D0    mov dword ptr ds:[0x008DB610], 0x24             ; => [ Data: data_8db610 ]
006241DA    xor eax, eax                                    ; => [ Call: nullptr ]
...
00624202    cmp dword ptr ds:[0x00CC8D5C], 0x00             ; => [ Data: data_cc8d5c ]
00624209    mov dword ptr ds:[0x00B809CC], 0xFFFFFFFF       ; => [ Data: data_b809cc ]
00624213    mov dword ptr ds:[0x00B809D0], 0xFFFFFFFF       ; => [ Data: data_b809d0 ]
0062421D    jz 0x00624420
00624223    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
00624240    push eax
00624241    mov dword ptr ds:[0x00B604E0], 0xFFFFFFFF       ; => [ Data: data_b604e0 ]
0062424B    call 0x005E9C80                                 ; => [ Call: sub_5e9c80 ]
...
0062426F    xor eax, eax                                    ; => [ Call: nullptr ]
00624271    mov dword ptr ss:[ebp-0x14], eax                ; => [ Call: nullptr ]
...
0062428D    jz 0x006242B1                                   ; => [ Data: data_cc8d6d ]
...
006242A6    call 0x005CA510                                 ; => [ Call: sub_5ca510 ]
...
006242C6    mov byte ptr ds:[0x00B809DC], 0x01              ; => [ Data: data_b809dc ]
...
006242E5    call 0x004B0B30                                 ; => [ Data: data_b80b44 | Call: sub_4b0b30 | Call: sub_5e99a0 ]
006242EA    imul ecx, dword ptr ds:[0x00B809E4], 0x1C30
006242F4    mov edi, 0xB809E0                               ; => [ Data: data_b809e0 ]
006242F9    mov eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
006242FE    mov dword ptr ss:[ebp-0x1C], edi                ; => [ Data: data_b809e0 ]
00624301    add ecx, eax                                    ; => [ Data: data_b809e4 ]
...
00624346    call 0x005CDEE0                                 ; => [ Call: sub_5cdee0 ]
0062434B    add esp, 0x04
0062434E    lea eax, ss:[ebp-0x18]
00624351    mov ecx, edi
00624353    push eax
00624354    call 0x006376D0                                 ; => [ Call: sub_6376d0 ]
...
00624378    jz 0x00624384                                   ; => [ Call: sub_4b9680 | Data: data_b80b48 ]
0062437A    mov ecx, 0xB80AF8
0062437F    call 0x005EAB70                                 ; => [ Data: data_b80af8 | Call: sub_5eab70 ]
00624384    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
0062438A    mov dword ptr ds:[0x00B8099C], 0x02             ; => [ Data: data_b8099c ]
...
006243AC    jnz 0x00624409                                  ; => [ Call: sub_4d8f30 ]
006243AE    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006243B5    lea ecx, ss:[ebp-0x14]
006243B8    mov dword ptr ss:[ebp-0x04], 0x00
006243BF    call 0x00621360
006243C4    test al, al
006243C6    jz 0x006243D2                                   ; => [ Call: sub_621360 ]
006243C8    mov dword ptr ds:[0x008DB660], 0x7E4            ; => [ Data: data_8db660 ]
006243D2    mov dword ptr ss:[ebp-0x04], 0x01
006243D9    cmp dword ptr ds:[0x00CF65BC], 0x00
006243E0    jz 0x00624409                                   ; => [ Data: data_cf65bc ]
...
006243F1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00624404    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00624409    mov eax, dword ptr ds:[ebx+0x08]
0062440C    mov ecx, dword ptr ss:[ebp-0x0C]
0062440F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00624416    pop ecx
00624417    pop edi
00624418    pop esi
...
0062441E    pop ebx
0062441F    ret
00624420    push 0x77EB90                                   ; => [ String: GetClient ]
00624425    push 0x7B
00624427    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
0062442C    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
00624431    mov edx, 0x801800
00624436    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0062443B    add esp, 0x0C
0062443E    call 0x0063BC30
00624443    test al, al
00624445    jz 0x00624448                                   ; => [ Call: sub_63bc30 ]
00624447    int3
00624448    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
