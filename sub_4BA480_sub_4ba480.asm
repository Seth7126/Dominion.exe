...
004BA4AC    movlpd qword ptr ss:[ebp-0x20], xmm0
...
004BA4C7    mov eax, dword ptr ds:[0x00CC8D5C]
...
004BA4E1    mov ecx, dword ptr ds:[0x0147ABF4]
...
004BA54F    call 0x0063B870
004BA554    add esp, 0x0C
004BA557    call 0x0063BC30
004BA55C    test al, al
004BA55E    jz 0x004BA561
004BA560    int3
004BA561    call 0x0063BB00
