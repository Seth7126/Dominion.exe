...
00521131    mov dword ptr ss:[ebp-0xCA8], eax
...
0052114B    push eax
0052114C    call dword ptr ds:[edx+0x10]
0052114F    xorps xmm0, xmm0
00521152    mov dword ptr ss:[ebp-0x1954], 0x00
0052115C    movlpd qword ptr ss:[ebp-0x195C], xmm0
...
0052120D    call 0x0056E9C0
00521212    push 0xC80
00521217    lea eax, ss:[ebp-0xC9C]
0052121D    push 0x00
0052121F    push eax
00521220    call 0x00761FC4
