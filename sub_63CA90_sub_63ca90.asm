...
0063CAA8    push 0x76C375                                   ; => [ Type: EHRegistrationNode | Call: sub_76c375 ]
0063CAAD    mov eax, dword ptr fs:[0x00000000]
0063CAB3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0063CAB4    push ebx
...
0063CAC1    push eax                                        ; => [ Data: __security_cookie ]
0063CAC2    lea eax, ss:[ebp-0x0C]
0063CAC5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0063CACB    mov esi, ecx
0063CACD    mov dword ptr ss:[ebp-0x20], esi
0063CAD0    mov dword ptr ds:[esi], 0x871D1C                ; => [ Data: data_871d1c ]
0063CAD6    push 0x01
...
0063CAF5    movups xmmword ptr ds:[esi+0x10], xmm0          ; => [ String: 0 | String: zx ]
0063CAF9    mov dword ptr ds:[esi+0x20], 0x00
0063CB00    mov dword ptr ds:[esi+0x24], 0x0F
0063CB07    mov byte ptr ds:[esi+0x10], 0x00
0063CB0B    movups xmmword ptr ds:[esi+0x28], xmm0          ; => [ String: 0 | String: zx ]
...
0063CB30    call 0x00759772                                 ; => [ Call: operator new ]
...
0063CB4B    mov dword ptr ds:[edi], 0x871CF4                ; => [ Data: data_871cf4 ]
0063CB51    mov byte ptr ss:[ebp-0x04], 0x03
0063CB55    push dword ptr ds:[esi+0x0C]                    ; => [ Type: std::locale::_Locimp ]
0063CB58    mov dword ptr ds:[esi+0x40], 0x00
0063CB5F    mov dword ptr ds:[esi+0x44], 0x00
0063CB66    mov dword ptr ds:[esi+0x04], edi
0063CB69    call dword ptr ds:[0x007751C0]                  ; => [ Type: std::locale::_Locimp ]
0063CB6F    mov edi, eax
0063CB71    add esp, 0x04
0063CB74    mov eax, dword ptr ds:[0x007751C4]              ; => [ Type: std::locale::id ]
0063CB79    mov dword ptr ss:[ebp-0x14], eax                ; => [ Type: std::locale::id ]
0063CB7C    cmp dword ptr ds:[eax], 0x00
0063CB7F    jnz 0x0063CBAB
0063CB81    push 0x00
0063CB83    lea ecx, ss:[ebp-0x18]
0063CB86    call dword ptr ds:[0x007751B4]                  ; => [ Type: std::_Lockit ]
...
0063CBC0    mov dword ptr ds:[edi+0x10], 0x00               ; => [ Field: _Catmask ]
0063CBC7    call dword ptr ds:[0x007751CC]                  ; => [ Field: _Name | String: * ]
...
0063CBEE    call dword ptr ds:[eax+0x04]                    ; => [ Field: _Incref | Field: vtable ]
0063CBF1    mov eax, dword ptr ds:[edi]
0063CBF3    mov ecx, edi
0063CBF5    mov eax, dword ptr ds:[eax+0x08]
0063CBF8    call eax                                        ; => [ Field: _Decref | Field: vtable ]
...
0063CC12    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063CC19    pop ecx
0063CC1A    pop edi
0063CC1B    pop esi
