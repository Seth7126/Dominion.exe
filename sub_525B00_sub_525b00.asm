...
00525B27    call 0x00561AF0
00525B2C    xorps xmm0, xmm0
00525B2F    mov dword ptr ss:[esp+0x30], 0x00
00525B37    movlpd qword ptr ss:[esp+0x28], xmm0
