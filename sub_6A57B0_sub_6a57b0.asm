...
006A57CE    push 0x87943C                                   ; => [ String: DefinitionGetSize ]
006A57D3    push 0x6D
006A57D5    push 0x879400                                   ; => [ String: C:\x\ax2017\Engine\Definition.cpp ]
006A57DA    mov ecx, 0x87948C                               ; => [ String: pDefMap->definitionSize != 0 ]
006A57DF    jmp 0x006A58AA
006A57E4    xor esi, esi                                    ; => [ Call: nullptr ]
006A57E6    mov dword ptr ss:[ebp+0x08], esi                ; => [ Call: nullptr ]
006A57E9    cmp dword ptr ss:[ebp+0x0C], esi
006A57EC    jle 0x006A587C
006A57F2    mov ecx, dword ptr ds:[edi+0x18]
006A57F5    call 0x0069C590                                 ; => [ Call: sub_69c590 ]
006A57FA    mov edx, dword ptr ds:[edi+0x04]
006A57FD    test al, al
006A57FF    jz 0x006A5818
006A5801    mov ecx, dword ptr ss:[ebp-0x04]
006A5804    push 0x00                                       ; => [ Call: nullptr ]
006A5806    push 0x00
006A5808    push edx
006A5809    push dword ptr ds:[edi+0x18]
006A580C    mov edx, ebx
006A580E    call 0x006A4D40                                 ; => [ Call: sub_6a4d40 ]
...
006A581F    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006A5824    mov ecx, dword ptr ss:[ebp-0x04]
006A5827    call 0x006A4C00                                 ; => [ Call: sub_6a4c00 ]
...
006A5864    call 0x006A6290                                 ; => [ Call: sub_6a6290 ]
...
006A5881    pop ebp
006A5882    ret
006A5883    push 0x87AB3C                                   ; => [ String: XList<struct DefParseItem *>::GetTail ]
006A5888    push 0x5A
006A588A    push 0x86E34C                                   ; => [ String: C:\x\ax2017\Engine\xList.h ]
006A588F    mov ecx, 0x877B90                               ; => [ String: mpTail != NULL ]
006A5894    jmp 0x006A58AA
006A5896    push 0x871DD4                                   ; => [ String: XString::XString ]
006A589B    push 0x94
006A58A0    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
006A58A5    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
006A58AA    mov edx, 0x801800
006A58AF    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006A58B4    add esp, 0x0C
006A58B7    call 0x0063BC30
006A58BC    test al, al
006A58BE    jz 0x006A58C1                                   ; => [ Call: sub_63bc30 ]
006A58C0    int3
006A58C1    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
