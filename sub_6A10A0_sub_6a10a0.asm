...
006A10BC    call dword ptr ds:[eax+0x14]                    ; => [ Data: data_147b070 ]
...
006A10F0    push eax
006A10F1    call dword ptr ds:[0x00775138]                  ; => [ Data: data_147ac30 ]
...
006A1110    mov esi, dword ptr ds:[0x0147AC30]              ; => [ Data: data_147ac30 ]
...
006A112B    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006A1142    xor bh, bh
006A1144    call 0x006A0DE0                                 ; => [ Call: sub_6a0de0 ]
...
006A1177    push eax
006A1178    call esi                                        ; => [ Data: data_147ac30 ]
006A117A    pop edi
006A117B    pop esi
006A117C    pop ebx
...
006A118F    push eax
006A1190    call esi                                        ; => [ Data: data_147ac30 ]
006A1192    push 0x64
006A1194    call dword ptr ds:[0x00775128]
006A119A    mov eax, dword ptr ds:[0x0147AC30]
006A119F    add eax, 0x04
006A11A2    push eax
006A11A3    call dword ptr ds:[0x00775138]                  ; => [ Data: data_147ac30 ]
006A11A9    jmp 0x006A116B
006A11AB    push 0x86F01C                                   ; => [ String: TextureGetDef ]
006A11B0    push 0x89
006A11B5    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
006A11BA    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
006A11BF    jmp 0x006A11D5
006A11C1    push 0x87A150                                   ; => [ String: TextureUnbindGraphicsBuffers ]
006A11C6    push 0x36E
006A11CB    push 0x879E98                                   ; => [ String: C:\x\ax2017\Engine\Texture.cpp ]
006A11D0    mov ecx, 0x87A148                               ; => [ String: foundIt ]
006A11D5    mov edx, 0x801800
006A11DA    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006A11DF    add esp, 0x0C
006A11E2    call 0x0063BC30
006A11E7    test al, al
006A11E9    jz 0x006A11EC                                   ; => [ Call: sub_63bc30 ]
006A11EB    int3
006A11EC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
