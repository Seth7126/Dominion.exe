...
00645E3C    mov eax, dword ptr ds:[0x008C4040]
00645E41    xor eax, esp
00645E43    mov dword ptr ss:[esp+0xCC], eax
00645E4A    mov eax, dword ptr ds:[0x0147B06C]
00645E4F    mov byte ptr ds:[eax+0x166], 0x00
00645E56    cmp byte ptr ds:[0x0147ABA1], 0x00
00645E5D    jz 0x00645E78
00645E5F    push 0x87EB48
00645E64    push 0x1F5
00645E69    push 0x87E9F4
00645E6E    mov ecx, 0x872928
00645E73    jmp 0x006461FD
00645E78    cmp byte ptr ds:[0x0147D2B0], 0x00
00645E7F    jz 0x00645F8F
00645E85    mov eax, dword ptr ds:[0x0147D214]
...
00645EB9    movss dword ptr ss:[esp+0x10], xmm0
...
00645EDB    movss dword ptr ss:[esp+0x18], xmm0
...
00645EFD    movss dword ptr ss:[esp+0x14], xmm0
...
00645F8F    movss xmm5, dword ptr ds:[0x00CF65C0]
00645F97    lea ecx, ss:[esp+0x10]
00645F9B    movaps xmm4, xmm5
00645F9E    xorps xmm1, xmm1
00645FA1    divss xmm4, dword ptr ds:[0x00CF65C4]
...
00646004    movss dword ptr ss:[esp+0x20], xmm0
0064600A    movss xmm0, dword ptr ds:[0x00CF65CC]
00646012    movss dword ptr ss:[esp+0x24], xmm0
00646018    call 0x00645A20
...
0064603A    movups xmmword ptr ss:[esp+0xA0], xmm0
00646042    movq xmm0, qword ptr ds:[eax*4+0xCF6624]
0064604B    mov eax, dword ptr ds:[eax*4+0xCF662C]
00646052    mov dword ptr ss:[esp+0xB8], eax
00646059    lea eax, ss:[esp+0x80]
00646060    push eax
00646061    movq qword ptr ss:[esp+0xB4], xmm0
0064606A    call 0x006DC9A0
...
006461CD    movups xmmword ptr ss:[esp+0x70], xmm0
006461D2    call 0x00645940
006461D7    mov ecx, dword ptr ss:[esp+0xCC]
006461DE    xor ecx, esp
006461E0    call 0x0075927A
006461E5    mov esp, ebp
006461E7    pop ebp
006461E8    ret
006461E9    push 0x87295C
006461EE    push 0x3BC
006461F3    push 0x872630
006461F8    mov ecx, 0x801AA4
006461FD    mov edx, 0x801800
00646202    call 0x0063B870
00646207    add esp, 0x0C
0064620A    call 0x0063BC30
0064620F    test al, al
00646211    jz 0x00646214
00646213    int3
00646214    call 0x0063BB00
