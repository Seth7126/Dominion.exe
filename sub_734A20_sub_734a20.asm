...
00734A2B    xor eax, ebp                                    ; => [ Type: SOCKET | Data: __security_cookie ]
00734A2D    mov dword ptr ss:[ebp-0x04], eax                ; => [ Type: SOCKET ]
00734A30    cmp word ptr ss:[ebp+0x08], 0x00
00734A35    push ebx
00734A36    mov ebx, dword ptr ss:[ebp+0x0C]
00734A39    push esi
00734A3A    jnz 0x00734A50
00734A3C    push 0x88EDF0                                   ; => [ String: WinsockNetworkInterface::TCPListenStart ]
00734A41    push 0x10C
00734A46    mov ecx, 0x88EDE4                               ; => [ String: port != 0 ]
00734A4B    jmp 0x00734B1F
00734A50    mov edx, 0x02
00734A55    lea ecx, ds:[edx-0x01]
00734A58    call 0x00734530                                 ; => [ Call: sub_734530 ]
...
00734A79    mov dword ptr ss:[ebp-0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
00734AB2    call 0x0063B5F0                                 ; => [ String: tcp bind failed\n | Call: sub_63b5f0 ]
...
00734AC3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00734AE0    call 0x0063B5F0                                 ; => [ String: tcp listen failed\n | Call: sub_63b5f0 ]
...
00734AF1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00734B04    pop ebx
00734B05    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00734B0A    mov esp, ebp
00734B0C    pop ebp
00734B0D    ret 0x08
00734B10    push 0x88EDF0                                   ; => [ String: WinsockNetworkInterface::TCPListenStart ]
00734B15    push 0x111
00734B1A    mov ecx, 0x88EE2C                               ; => [ String: socket != 0 ]
00734B1F    push 0x88ECDC
00734B24    mov edx, 0x801800
00734B29    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\WindowsNetwork.cpp | String: WinsockNetworkInterface::TCPListenStart ]
00734B2E    add esp, 0x0C
00734B31    call 0x0063BC30
00734B36    test al, al
00734B38    jz 0x00734B3B                                   ; => [ Call: sub_63bc30 ]
00734B3A    int3
00734B3B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
