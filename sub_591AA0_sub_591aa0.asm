...
00591AA9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00591AE0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00591AFC    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
00591B68    pop esi
00591B69    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
