...
00522A06    call 0x00761E50
00522A0B    mov eax, dword ptr ds:[0x008C4040]
00522A10    xor eax, ebp
...
00522A1C    mov dword ptr fs:[0x00000000], eax
00522A22    call 0x00573400
00522A27    lea ecx, ss:[ebp-0x1944]
00522A2D    push ecx
00522A2E    mov edx, dword ptr ds:[eax+0x0C]
00522A31    mov ecx, dword ptr ds:[eax+0x04]
00522A34    call 0x00590B50
00522A39    mov ebx, eax
00522A3B    mov dword ptr ss:[ebp-0xCC0], 0x817C84
...
00522A65    rep movsd
00522A67    mov dword ptr ss:[ebp-0xC9C], eax
...
00522AD7    push edx
00522AD8    call dword ptr ds:[esi+0x10]
00522ADB    mov eax, edi
00522ADD    mov ecx, dword ptr ss:[ebp-0x0C]
00522AE0    mov dword ptr fs:[0x00000000], ecx
00522AE7    pop ecx
00522AE8    pop edi
00522AE9    pop esi
00522AEA    pop ebx
