...
00616159    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00616175    jnz 0x006161A5                                  ; => [ Data: data_b80980 ]
00616177    mov ecx, dword ptr ds:[0x0171E6CC]
0061617D    call 0x006883D0                                 ; => [ Data: data_171e6cc | Call: sub_6883d0 ]
00616182    lea ecx, ss:[esp+0x04]
00616186    call 0x00688660                                 ; => [ Call: sub_688660 ]
0061618B    mov dword ptr ds:[0x00B80980], 0x00             ; => [ Data: data_b80980 ]
00616195    pop esi
00616196    mov ecx, dword ptr ss:[esp+0x30]
0061619A    xor ecx, esp
0061619C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006161A1    mov esp, ebp
006161A3    pop ebp
006161A4    ret
006161A5    mov ecx, dword ptr ds:[0x0171E6C8]
006161AB    call 0x006883D0                                 ; => [ Data: data_171e6c8 | Call: sub_6883d0 ]
006161B0    lea ecx, ss:[esp+0x04]
006161B4    call 0x00688660                                 ; => [ Call: sub_688660 ]
006161B9    mov eax, dword ptr ds:[esi+0x98]
006161BF    mov ecx, esi
006161C1    mov dword ptr ds:[0x00B80980], eax              ; => [ Data: data_b80980 ]
006161C6    call 0x005CBB20
006161CB    mov edx, eax
006161CD    mov ecx, 0x10
006161D2    call 0x005CB4F0                                 ; => [ Call: sub_5cbb20 | Call: sub_5cb4f0 ]
006161D7    mov ecx, dword ptr ss:[esp+0x34]
006161DB    pop esi
006161DC    xor ecx, esp
006161DE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
