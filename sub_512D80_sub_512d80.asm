...
00512DC7    mov dword ptr ss:[esp+0x14], eax
00512DCB    call 0x00573400
00512DD0    mov ecx, dword ptr ds:[eax+0x04]
...
00512EC9    call 0x0063B870
00512ECE    add esp, 0x0C
00512ED1    call 0x0063BC30
00512ED6    test al, al
00512ED8    jz 0x00512EDB
00512EDA    int3
00512EDB    call 0x0063BB00
