...
0053C885    push 0x765B71                                   ; => [ Call: sub_765b71 | Type: EHRegistrationNode ]
0053C88A    mov eax, dword ptr fs:[0x00000000]
0053C890    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053C891    mov eax, 0x1974
0053C896    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053C89B    mov eax, dword ptr ds:[0x008C4040]
0053C8A0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0053C8AC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053C8B2    mov ecx, 0x100
0053C8B7    call 0x0053AF70                                 ; => [ Call: sub_53af70 ]
...
0053C92E    mov dword ptr ss:[ebp-0xCD4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable ]
...
0053CA54    push eax
0053CA55    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
0053CA73    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0053CA75    test ebx, ebx
0053CA77    jz 0x0053CABB
0053CA79    mov ecx, 0x01
0053CA7E    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
0053CA83    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053CAB3    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
0053CAB8    add esp, 0x28
0053CABB    mov ecx, dword ptr ss:[ebp-0x0C]
0053CABE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053CAC5    pop ecx
0053CAC6    pop edi
0053CAC7    pop esi
0053CAC8    pop ebx
...
0053CACE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
