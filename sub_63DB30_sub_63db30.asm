...
0063DB46    push 0x871DF4                                   ; => [ String: XString::AppendLength ]
0063DB4B    push 0x131
0063DB50    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
...
0063DB67    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063DB87    push 0x01
0063DB89    call 0x0063D5E0                                 ; => [ Call: sub_63d5e0 ]
0063DB8E    add esp, 0x04
0063DB91    jmp 0x0063DBA1
0063DB93    mov edx, edi
0063DB95    call 0x0063D540                                 ; => [ Call: sub_63d540 ]
...
0063DBA7    push ebx
0063DBA8    push eax
0063DBA9    call 0x00761FBE                                 ; => [ Call: memcpy | Call: memcpy ]
...
0063DBBD    pop ebp
0063DBBE    ret 0x08
0063DBC1    push 0x871DF4                                   ; => [ String: XString::AppendLength ]
0063DBC6    push 0x145
0063DBCB    mov ecx, 0x871E28                               ; => [ String: mMagicDataPtr + originalLength < str || str + length < mMagicDataPtr ]
0063DBD0    push 0x871D5C
0063DBD5    mov edx, 0x801800
0063DBDA    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: XString::AppendLength | String: C:\x\ax2017\Engine\xString.cpp ]
0063DBDF    add esp, 0x0C
0063DBE2    call 0x0063BC30
0063DBE7    test al, al
0063DBE9    jz 0x0063DBEC                                   ; => [ Call: sub_63bc30 ]
0063DBEB    int3
0063DBEC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
