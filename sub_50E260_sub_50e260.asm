...
0050E26C    mov eax, dword ptr ds:[0x008C4040]
0050E271    xor eax, esp
0050E273    mov dword ptr ss:[esp+0xC8C], eax
0050E27A    mov ecx, 0x32
0050E27F    call 0x00513D60
0050E284    call 0x00573400
...
0050E2F6    call 0x0063B870
0050E2FB    add esp, 0x0C
0050E2FE    call 0x0063BC30
0050E303    test al, al
0050E305    jz 0x0050E308
0050E307    int3
0050E308    call 0x0063BB00
