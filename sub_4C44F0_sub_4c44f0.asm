...
004C45B2    mov dword ptr ds:[0x00CF649C], edi
004C45B8    mov dword ptr ds:[0x008DB660], 0x29
004C45C2    pop edi
004C45C3    pop esi
004C45C4    pop ebx
...
004C45F2    call 0x0063B870
004C45F7    add esp, 0x0C
004C45FA    call 0x0063BC30
004C45FF    test al, al
004C4601    jz 0x004C4604
004C4603    int3
004C4604    call 0x0063BB00
