...
0051C7B6    push 0x8167C4                                   ; => [ String: RandomDoodadFromCampaignTheme ]
0051C7BB    push 0x2BC3
0051C7C0    push 0x80CD80                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0051C7C5    mov ecx, 0x8167E4                               ; => [ String: numThemes <= 2 ]
0051C7CA    jmp 0x0051C99D
0051C7CF    test ebx, ebx
0051C7D1    jle 0x0051C980
0051C7D7    lea edi, ds:[edx+0x04]
0051C7DA    mov edx, dword ptr ds:[0x01597E1C]              ; => [ Data: data_1597e1c ]
...
0051C817    mov eax, dword ptr ds:[edx+eax*4]               ; => [ Data: data_1597e18 ]
0051C81A    mov edx, dword ptr ds:[0x01597E1C]              ; => [ Data: data_1597e1c ]
...
0051C845    xor eax, eax                                    ; => [ Call: nullptr ]
...
0051C87A    mov eax, dword ptr ds:[edx+eax*4]               ; => [ Data: data_1597e18 ]
0051C87D    mov edx, dword ptr ds:[0x01597E1C]              ; => [ Data: data_1597e1c ]
...
0051C8A9    xor eax, eax                                    ; => [ Call: nullptr ]
...
0051C8C9    call 0x0051C520                                 ; => [ Call: sub_51c520 ]
0051C8CE    test al, al
0051C8D0    jz 0x0051C920
0051C8D2    mov ecx, dword ptr ss:[ebp+0x08]
0051C8D5    xor eax, eax                                    ; => [ Call: nullptr ]
...
0051C8F9    call 0x0051C520                                 ; => [ Call: sub_51c520 ]
0051C8FE    test al, al
0051C900    jz 0x0051C920
0051C902    mov ecx, dword ptr ss:[ebp+0x08]
0051C905    xor eax, eax                                    ; => [ Call: nullptr ]
...
0051C91F    inc esi
0051C920    mov edx, dword ptr ds:[0x01597E1C]              ; => [ Data: data_1597e1c | Data: data_1597e1c | Data: data_1597e1c ]
...
0051C94A    push edi
0051C94B    push ebx
0051C94C    call 0x007621D0                                 ; => [ Call: __allmul ]
...
0051C987    pop ebp
0051C988    ret
0051C989    push 0x871EF0                                   ; => [ String: RandomInt ]
0051C98E    push 0x107
0051C993    push 0x871ED0                                   ; => [ String: C:\x\ax2017\Engine\Random.cpp ]
0051C998    mov ecx, 0x871F0C                               ; => [ String: maxPlusOne > 0 ]
0051C99D    mov edx, 0x801800
0051C9A2    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0051C9A7    add esp, 0x0C
0051C9AA    call 0x0063BC30
0051C9AF    test al, al
0051C9B1    jz 0x0051C9B4                                   ; => [ Call: sub_63bc30 ]
0051C9B3    int3
0051C9B4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
