...
006E06E5    push 0x771065                                   ; => [ Type: EHRegistrationNode | Call: sub_771065 ]
006E06EA    mov eax, dword ptr fs:[0x00000000]
006E06F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006E06FE    push eax                                        ; => [ Data: __security_cookie ]
006E06FF    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E0702    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006E0708    mov dword ptr ss:[ebp-0x1C], edx
006E070B    mov ebx, ecx
006E070D    mov esi, dword ptr ds:[ebx]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E070F    test esi, esi
006E0711    jnz 0x006E0789                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E0713    push 0x02
006E0715    mov edx, 0x879C7C
006E071A    lea ecx, ss:[ebp-0x14]
006E071D    call 0x0069FD50                                 ; => [ String: !Null\Null | Call: sub_69fd50 ]
006E0722    add esp, 0x04
006E0725    mov dword ptr ss:[ebp-0x04], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E0728    lea edx, ds:[esi+0x02]
006E072B    mov eax, dword ptr ss:[ebp-0x14]
006E072E    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006E0733    test eax, eax
006E0735    cmovnz ecx, eax
006E0738    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
006E073D    mov esi, eax
006E073F    mov dword ptr ss:[ebp-0x04], 0x01
006E0746    cmp dword ptr ds:[0x00CF65BC], 0x00
006E074D    jz 0x006E0780                                   ; => [ Data: data_cf65bc ]
...
006E075E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E0774    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E0779    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006E0795    mov dword ptr ss:[ebp-0x18], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E0798    cmp dword ptr ds:[edi], 0x00
006E079B    jnz 0x006E07AB
006E079D    push 0x01
006E079F    xor dl, dl
006E07A1    mov ecx, edi
006E07A3    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
006E07A8    add esp, 0x04
006E07AB    mov eax, dword ptr ds:[edi]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E07AD    inc dword ptr ds:[edi+0x1C]                     ; => [ Field: Next ]
006E07B0    mov eax, dword ptr ds:[eax]
006E07B2    mov dword ptr ss:[ebp-0x04], 0x02
006E07B9    xor cl, cl
006E07BB    mov edx, dword ptr ds:[eax]                     ; => [ Field: Next | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E07BD    xor eax, eax                                    ; => [ Call: nullptr | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E07BF    mov dword ptr ss:[ebp-0x20], edx                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006E07C2    mov byte ptr ss:[ebp-0x0D], cl
006E07C5    mov dword ptr ss:[ebp-0x14], eax                ; => [ Call: nullptr ]
...
006E07FF    push edi
006E0800    push ecx
006E0801    call 0x006DF0F0                                 ; => [ Call: sub_6df0f0 ]
...
006E0830    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E0837    pop ecx
006E0838    pop edi
006E0839    pop esi
006E083A    pop ebx
...
006E0855    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006E085A    add esp, 0x0C
006E085D    call 0x0063BC30
006E0862    test al, al
006E0864    jz 0x006E0867                                   ; => [ Call: sub_63bc30 ]
006E0866    int3
006E0867    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006E086C    push 0x872E14
006E0871    push 0xB5
006E0876    push 0x816BDC
006E087B    mov edx, 0x801800
006E0880    mov ecx, 0x824FD0
006E0885    call 0x0063B870                                 ; => [ String: index >= 0 && index < mSize | Call: sub_63b870 | String: C:\x\ax2017\Engine\xArray.h | String: XArray<struct Mat4>::operator [] | Data: data_801800 ]
006E088A    add esp, 0x0C
006E088D    call 0x0063BC30
006E0892    test al, al
006E0894    jz 0x006E0897                                   ; => [ Call: sub_63bc30 ]
006E0896    int3
006E0897    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
