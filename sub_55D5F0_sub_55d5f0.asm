...
0055D6C3    mov dword ptr ss:[ebp-0x1964], ecx
...
0055D704    call eax
0055D706    mov dword ptr ds:[esi+0x24], eax
...
0055D72C    mov dword ptr ss:[ebp-0xCA0], eax
...
0055D746    push eax
0055D747    call dword ptr ds:[edx+0x10]
...
0055D76D    movlpd qword ptr ss:[ebp-0x194C], xmm0
...
0055D87F    mov dword ptr fs:[0x00000000], ecx
0055D886    pop ecx
0055D887    pop edi
0055D888    pop esi
0055D889    mov ecx, dword ptr ss:[ebp-0x14]
0055D88C    xor ecx, ebp
0055D88E    call 0x0075927A
