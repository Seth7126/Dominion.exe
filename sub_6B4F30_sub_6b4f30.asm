...
006B4F70    mulss xmm0, dword ptr ds:[esi+0x20]             ; => [ Call: sub_5a0e40 ]
...
006B4FB7    push 0x874440                                   ; => [ String: UI2DefGet ]
006B4FBC    push 0xC16
006B4FC1    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
006B4FC6    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
006B4FCB    jmp 0x006B5070
006B4FD0    cmp dword ptr ds:[ecx+0x04], 0x22
006B4FD4    jnz 0x006B505C
006B4FDA    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006B4FF0    push 0x874440                                   ; => [ String: UI2DefGet ]
006B4FF5    push 0xC16
006B4FFA    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
006B4FFF    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
006B5004    jmp 0x006B5070
006B5006    cmp dword ptr ds:[ecx+0x04], 0x22
006B500A    jnz 0x006B505C
006B500C    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
006B5011    cmp dword ptr ds:[eax+0x08], 0x00
006B5015    jnz 0x006B5020
006B5017    movups xmm0, xmmword ptr ds:[0x007FF520]        ; => [ Data: data_7ff520 ]
006B501E    jmp 0x006B5035
006B5020    push 0x00
006B5022    xor edx, edx                                    ; => [ Call: nullptr ]
006B5024    lea ecx, ss:[ebp-0x10]
006B5027    push ecx
006B5028    mov ecx, dword ptr ds:[eax]
006B502A    call 0x0064F140
006B502F    add esp, 0x08
006B5032    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: sub_64f140 ]
...
006B505A    pop ebp
006B505B    ret
006B505C    push 0x874440                                   ; => [ String: UI2DefGet ]
006B5061    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
006B5066    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006B506B    push 0xC17
006B5070    push 0x8739B4
006B5075    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: UI2DefGet | String: C:\x\ax2017\Engine\UI2.cpp ]
006B507A    add esp, 0x0C
006B507D    call 0x0063BC30
006B5082    test al, al
006B5084    jz 0x006B5087                                   ; => [ Call: sub_63bc30 ]
006B5086    int3
006B5087    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
