...
00524C7C    mov eax, dword ptr ds:[0x008C4040]
00524C81    xor eax, esp
00524C83    mov dword ptr ss:[esp+0xC98], eax
00524C8A    push ebx
00524C8B    push esi
00524C8C    push edi
00524C8D    call 0x00573400
00524C92    push 0x00
00524C94    push 0x00
00524C96    push 0x01
...
00524C9E    push 0x01
00524CA0    call 0x00590760
00524CA5    add esp, 0x10
00524CA8    call 0x00573400
...
00524CD5    push eax
00524CD6    call 0x00761FC4
00524CDB    add esp, 0x0C
00524CDE    mov edx, 0x7BF980
00524CE3    call 0x00566920
...
00524D4E    mov dword ptr ss:[esp+0x10], eax
00524D52    call 0x00573400
...
00524DA3    push 0x3EE
00524DA8    push esi
00524DA9    call 0x00582D10
00524DAE    add esp, 0x38
00524DB1    call 0x00573400
...
00524E16    call 0x0063B870
00524E1B    add esp, 0x0C
00524E1E    call 0x0063BC30
00524E23    test al, al
00524E25    jz 0x00524E28
00524E27    int3
00524E28    call 0x0063BB00
