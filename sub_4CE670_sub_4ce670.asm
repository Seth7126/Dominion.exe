...
004CE690    mov dword ptr fs:[0x00000000], eax
...
004CE6A4    call 0x0063D720
004CE6A9    mov eax, dword ptr ss:[ebp+0x08]
004CE6AC    mov ecx, 0x801800
...
004CE702    jz 0x004CE71F
004CE704    lea ecx, ss:[ebp+0x08]
004CE707    call 0x0063D4E0
...
004CE71A    call 0x0064C080
004CE71F    xor al, al
004CE721    test bl, bl
004CE723    jz 0x004CE72F
004CE725    mov dword ptr ds:[0x008DB660], 0x0C
004CE72F    mov ecx, dword ptr ss:[ebp-0x0C]
004CE732    mov dword ptr fs:[0x00000000], ecx
004CE739    pop ecx
004CE73A    pop edi
004CE73B    pop esi
004CE73C    pop ebx
