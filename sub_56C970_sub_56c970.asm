...
0056C987    jz 0x0056C98D                                   ; => [ Call: sub_573400 ]
0056C989    xor al, al
0056C98B    pop esi
0056C98C    ret
0056C98D    call 0x00573400
0056C992    mov eax, dword ptr ds:[eax+0x64]                ; => [ Call: sub_573400 ]
0056C995    test eax, eax
0056C997    jnz 0x0056C9AA
0056C999    push 0x81ED48                                   ; => [ String: IsYourBuyPhaseWhenGained ]
0056C99E    push 0x1461
0056C9A3    mov ecx, 0x81A5D8                               ; => [ String: c.triggerInfo ]
...
0056C9BE    pop esi
0056C9BF    ret
0056C9C0    push 0x81ED48                                   ; => [ String: IsYourBuyPhaseWhenGained ]
0056C9C5    push 0x1462
0056C9CA    mov ecx, 0x81A5E8                               ; => [ String: c.triggerInfo->type == TRIGGERINFO_GAIN ]
0056C9CF    push 0x81EA70
0056C9D4    mov edx, 0x801800
0056C9D9    call 0x0063B870                                 ; => [ String: IsYourBuyPhaseWhenGained | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0056C9DE    add esp, 0x0C
0056C9E1    call 0x0063BC30
0056C9E6    test al, al
0056C9E8    jz 0x0056C9EB                                   ; => [ Call: sub_63bc30 ]
0056C9EA    int3
0056C9EB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
