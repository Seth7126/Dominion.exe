...
0053FF3C    call 0x00591930                                 ; => [ Call: sub_591930 ]
0053FF41    mov ecx, dword ptr ss:[ebp-0xC84]
0053FF47    mov edx, 0x100
0053FF4C    call 0x00566BB0                                 ; => [ Call: sub_566bb0 ]
0053FF51    mov ecx, dword ptr ss:[ebp-0x04]
0053FF54    xor ecx, ebp
0053FF56    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
