...
00645A2C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00645A31    xor eax, esp
00645A33    mov dword ptr ss:[esp+0xDC], eax
00645A3A    cmp byte ptr ds:[0x00CF65F0], 0x00              ; => [ Data: data_cf65f0 ]
00645A41    movups xmm0, xmmword ptr ds:[ecx]
00645A44    movups xmmword ptr ds:[0x00CF65FC], xmm0        ; => [ Data: data_cf65fc ]
00645A4B    movq xmm0, qword ptr ds:[ecx+0x10]
00645A50    movss xmm4, dword ptr ds:[0x00CF6604]           ; => [ Data: data_cf65fc ]
00645A58    movss xmm3, dword ptr ds:[0x00CF6608]           ; => [ Data: data_cf65fc ]
00645A60    movq qword ptr ds:[0x00CF660C], xmm0            ; => [ Data: data_cf660c ]
00645A68    jz 0x00645C2C
00645A6E    movss xmm0, dword ptr ds:[0x00890E18]
00645A76    lea eax, ss:[esp+0x90]
00645A7D    divss xmm0, dword ptr ds:[0x00CF65F4]           ; => [ Data: data_cf65f0 ]
...
00645ABF    movss xmm2, dword ptr ds:[0x00CF660C]           ; => [ Data: data_cf660c ]
...
00645AE5    mulss xmm7, dword ptr ds:[0x00890D84]           ; => [ Data: data_cf65fc ]
00645AED    divss xmm5, xmm4                                ; => [ Data: data_cf65fc ]
00645AF1    movaps xmm4, xmm1
00645AF4    mulss xmm6, dword ptr ds:[0x00890D84]           ; => [ Data: data_cf65fc ]
00645AFC    divss xmm1, xmm0                                ; => [ Data: data_cf660c ]
00645B00    movups xmm0, xmmword ptr ds:[0x00800850]
00645B07    divss xmm4, xmm3                                ; => [ Data: data_cf65fc ]
00645B0B    movups xmmword ptr ss:[esp+0x04], xmm0          ; => [ Call: __builtin_memset ]
...
00645B52    movss dword ptr ss:[esp+0x30], xmm2             ; => [ Data: data_8937c0 ]
...
00645BB8    call 0x006C3C80                                 ; => [ Call: sub_6c3c80 ]
...
00645BF5    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
00645C2C    cmp dword ptr ds:[0x0147B074], 0x01             ; => [ Data: data_147b074 ]
...
00645C69    mulss xmm6, dword ptr ds:[0x00890D84]           ; => [ Data: data_cf65fc ]
00645C71    divss xmm2, xmm4                                ; => [ Data: data_cf65fc ]
00645C75    movss xmm4, dword ptr ds:[0x00CF6610]           ; => [ Data: data_cf660c ]
00645C7D    addss xmm6, xmm6
00645C81    divss xmm1, xmm3                                ; => [ Data: data_cf65fc ]
00645C85    movss xmm3, dword ptr ds:[0x00CF660C]           ; => [ Data: data_cf660c ]
00645C8D    movaps xmm0, xmm4
00645C90    subss xmm0, xmm3
00645C94    mulss xmm5, dword ptr ds:[0x00890D84]           ; => [ Data: data_cf65fc ]
...
00645CB3    movups xmmword ptr ss:[esp], xmm0               ; => [ Call: __builtin_memset ]
...
00645D46    movss dword ptr ss:[esp+0x28], xmm0             ; => [ Data: data_8937c0 ]
00645D4C    lea eax, ss:[esp+0x90]
00645D53    mov edx, 0xCB2030
00645D58    push eax
00645D59    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
00645D5E    add esp, 0x04
00645D61    cmp dword ptr ds:[0x0147B074], 0x01             ; => [ Data: data_147b074 ]
...
00645D93    jz 0x00645E0A                                   ; => [ Data: data_cf69dc ]
00645D95    movups xmm0, xmmword ptr ds:[0x00800890]
00645D9C    lea eax, ss:[esp+0x90]
00645DA3    push eax
00645DA4    movups xmmword ptr ss:[esp+0x54], xmm0          ; => [ Call: __builtin_memcpy | String: \x00\x00\x80\x3f\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x3f\x00\x00\x00\x00\x00\x00\x00\x00 ]
...
00645DCC    movups xmmword ptr ss:[esp+0x74], xmm0          ; => [ String: \x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x3f\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x3f | Call: __builtin_memcpy ]
00645DD1    movups xmm0, xmmword ptr ds:[0x008008C0]
00645DD8    movups xmmword ptr ss:[esp+0x84], xmm0
00645DE0    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
00645E0D    call 0x006459B0                                 ; => [ Call: sub_6459b0 ]
00645E12    mov ecx, dword ptr ss:[esp+0xDC]
00645E19    xor ecx, esp
00645E1B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
