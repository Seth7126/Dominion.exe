...
0071FFCC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0072001E    call 0x0071FDF0                                 ; => [ Call: sub_71fdf0 ]
...
00720032    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
