...
0076C321    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C326    mov ecx, dword ptr ds:[edx-0x08]
0076C329    xor ecx, eax
0076C32B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C330    mov eax, 0x8B85C4
0076C335    jmp 0x00761FA6                                  ; => [ Data: data_8b85c4 | Call: __CxxFrameHandler3 ]
