...
004D40F8    push 0x76365D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$_send@I@_Originator@details@Concurrency@@SA_NPAV?$ITarget@I@2@ABI@Z ]
004D40FD    mov eax, dword ptr fs:[0x00000000]
004D4103    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D4104    push ebx
004D4105    sub esp, 0x70
004D4108    push esi
004D4109    push edi
004D410A    mov eax, dword ptr ds:[0x008C4040]
004D410F    xor eax, ebp                                    ; => [ Data: __security_cookie ]
004D4111    push eax
004D4112    lea eax, ss:[ebp-0x0C]
004D4115    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D411B    movaps xmm1, xmm0
004D411E    movss dword ptr ss:[ebp-0x18], xmm1
004D4123    mov eax, dword ptr ds:[0x007750AC]
004D4128    mov edi, 0x8DB5A0                               ; => [ Data: data_8db5a0 ]
004D412D    mov dword ptr ss:[ebp-0x1C], edi                ; => [ Data: data_8db5a0 ]
004D4130    mov dword ptr ss:[ebp-0x20], eax                ; => [ Type: BOOL ]
...
004D4150    call 0x0067CF00                                 ; => [ Call: sub_67cf00 ]
...
004D417F    mov eax, dword ptr ds:[eax+0x18]                ; => [ Call: sub_4d3b00 ]
...
004D41B4    jle 0x004D41FB                                  ; => [ Data: data_1a98f24 | Field: ThreadLocalStoragePointer ]
004D41B6    push 0x1A98F24
004D41BB    call 0x0075970E                                 ; => [ Data: data_1a98f24 | Call: sub_75970e ]
004D41C0    add esp, 0x04
004D41C3    cmp dword ptr ds:[0x01A98F24], 0xFFFFFFFF
004D41CA    jnz 0x004D41FB                                  ; => [ Data: data_1a98f24 ]
...
004D41E7    mov dword ptr ds:[0x01A98F28], eax              ; => [ String: xbin/atlases/res/atlas-box_art-0.texture | Data: data_1a98f28 | Call: sub_69f030 ]
004D41EC    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004D41F3    call 0x007596BD                                 ; => [ Data: data_1a98f24 | Call: __Init_thread_footer ]
004D41F8    add esp, 0x04
004D41FB    mov ecx, dword ptr ds:[0x01A98F28]
004D4201    call 0x0069EC60                                 ; => [ Data: data_1a98f28 | Call: sub_69ec60 ]
...
004D4221    jle 0x004D4268                                  ; => [ Data: data_1a98f2c | Field: ThreadLocalStoragePointer ]
004D4223    push 0x1A98F2C
004D4228    call 0x0075970E                                 ; => [ Data: data_1a98f2c | Call: sub_75970e ]
004D422D    add esp, 0x04
004D4230    cmp dword ptr ds:[0x01A98F2C], 0xFFFFFFFF
004D4237    jnz 0x004D4268                                  ; => [ Data: data_1a98f2c ]
...
004D4254    mov dword ptr ds:[0x01A98F30], eax              ; => [ String: xbin/atlases/res/atlas-campaign-0.texture | Call: sub_69f030 | Data: data_1a98f30 ]
004D4259    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004D4260    call 0x007596BD                                 ; => [ Data: data_1a98f2c | Call: __Init_thread_footer ]
004D4265    add esp, 0x04
004D4268    mov ecx, dword ptr ds:[0x01A98F30]
004D426E    call 0x0069EC60                                 ; => [ Call: sub_69ec60 | Data: data_1a98f30 ]
004D4273    lea ecx, ds:[edi+0x10]
004D4276    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
...
004D42C5    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
004D42CA    jmp 0x004D42D3
004D42CC    mov dl, 0x01
004D42CE    call 0x004D3C40                                 ; => [ Call: sub_4d3c40 ]
004D42D3    mov ecx, dword ptr ds:[edi-0x04]
004D42D6    test ecx, ecx
004D42D8    jz 0x004D45FC
004D42DE    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
004D4336    call 0x004D3B00                                 ; => [ Call: sub_4d3b00 ]
...
004D4374    push eax
004D4375    push esi
004D4376    call 0x00654CE0                                 ; => [ Call: nullptr | String: dialog (retired) | Call: sub_654ce0 ]
004D437B    mov ecx, dword ptr ds:[edi]
004D437D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D4382    movss xmm3, dword ptr ds:[0x00890E18]
004D438A    mov edx, 0x8DBA78
004D438F    push 0x00
004D4391    push 0xFFFFFFFF
004D4393    mov ecx, eax
004D4395    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dba78 ]
004D439A    mov ecx, dword ptr ds:[edi]
004D439C    add esp, 0x20
004D439F    xorps xmm1, xmm1
004D43A2    call 0x0065D6E0                                 ; => [ String: 0 | Call: sub_65d6e0 | String: zx ]
...
004D43BB    mov eax, dword ptr ds:[eax+0x0C]                ; => [ Call: sub_4d3b00 ]
004D43BE    push 0x00
004D43C0    push 0x00
004D43C2    push eax
...
004D43D1    push eax
004D43D2    push esi
004D43D3    call 0x00654CE0                                 ; => [ Call: nullptr | Call: sub_654ce0 | String: dialog ]
004D43D8    mov ecx, dword ptr ds:[edi]
004D43DA    add esp, 0x18
004D43DD    call 0x004D3B70                                 ; => [ Call: sub_4d3b70 ]
004D43E2    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
...
004D4403    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D4408    mov edx, 0x8DC9F8
004D440D    jmp 0x004D4425
004D440F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D4414    mov edx, 0x8DC9EC
004D4419    jmp 0x004D4425
004D441B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D4420    mov edx, 0x8DC9E0
004D4425    movss xmm3, dword ptr ds:[0x00890E18]
004D442D    mov ecx, eax
004D442F    push 0x00
004D4431    push 0xFFFFFFFF
004D4433    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc9e0 | Call: sub_665db0 | Data: data_8dc9ec | Call: sub_665db0 | Data: data_8dc9f8 ]
004D4438    add esp, 0x08
004D443B    mov ecx, dword ptr ds:[edi]
004D443D    call 0x004D2030                                 ; => [ Call: sub_4d2030 ]
004D4442    mov ecx, dword ptr ds:[edi-0x04]
004D4445    call 0x004D3B00
004D444A    mov eax, dword ptr ds:[eax+0x14]                ; => [ Call: sub_4d3b00 ]
...
004D4560    push eax
004D4561    push ecx
004D4562    call 0x0063C000                                 ; => [ Call: sub_63c000 ]
...
004D4574    call 0x0065D6E0                                 ; => [ Call: sub_65d6e0 ]
...
004D458D    push eax
004D458E    push ecx
004D458F    call 0x0063C000                                 ; => [ Call: sub_63c000 ]
...
004D45BD    jnz 0x004D45FC                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
004D45BF    call 0x0064E7A0
004D45C4    mov ecx, eax                                    ; => [ Call: sub_64e7a0 ]
...
004D45F7    call 0x0064E7A0                                 ; => [ Call: nullptr | Call: sub_64e7a0 | Call: sub_64c870 ]
004D45FC    cmp byte ptr ss:[ebp-0x11], 0x00
004D4600    jz 0x004D4609
004D4602    mov ecx, dword ptr ds:[edi]
004D4604    call 0x0067CF00                                 ; => [ Call: sub_67cf00 ]
004D4609    add edi, 0x28
004D460C    mov dword ptr ss:[ebp-0x1C], edi
004D460F    cmp edi, 0x8DB758
004D4615    jnl 0x004D4621                                  ; => [ Data: data_8db758 ]
004D4617    movss xmm1, dword ptr ss:[ebp-0x18]
004D461C    jmp 0x004D4133
004D4621    mov eax, dword ptr ds:[0x008DB6B8]              ; => [ Data: data_8db6b8 ]
004D4626    test eax, eax
004D4628    jnz 0x004D463D
004D462A    mov eax, dword ptr ds:[0x008DB668]              ; => [ Data: data_8db668 ]
004D462F    mov dword ptr ds:[0x00C23BE8], eax              ; => [ Data: data_c23be8 ]
004D4634    test eax, eax
004D4636    jnz 0x004D4642
004D4638    mov eax, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
004D463D    mov dword ptr ds:[0x00C23BE8], eax              ; => [ Data: data_c23be8 | Data: data_c23be8 ]
004D4642    mov ecx, dword ptr ss:[ebp-0x0C]
004D4645    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D464C    pop ecx
004D464D    pop edi
004D464E    pop esi
...
004D4654    pop ebx
004D4655    ret
004D4656    push 0x80541C                                   ; => [ String: GetDlgAsset ]
004D465B    push 0x2E31
004D4660    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D4665    mov ecx, 0x805428                               ; => [ String: def.uiPages ]
004D466A    jmp 0x004D46BF
004D466C    push 0x87437C                                   ; => [ String: UI2::countChildren ]
004D4671    push 0xBA8
004D4676    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
004D467B    mov ecx, 0x874310                               ; => [ String: numChildren >= 0 ]
004D4680    jmp 0x004D46BF
004D4682    push 0x805434                                   ; => [ String: GetDlgUpdate ]
004D4687    push 0x2E45
004D468C    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D4691    mov ecx, 0x805444                               ; => [ String: def.updateFn ]
004D4696    jmp 0x004D46BF
004D4698    push 0x77EB90                                   ; => [ String: GetClient ]
004D469D    push 0x7B
004D469F    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004D46A4    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004D46A9    jmp 0x004D46BF
004D46AB    push 0x806A44                                   ; => [ String: GetLocalSettings ]
004D46B0    push 0x5FB
004D46B5    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
004D46BA    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
004D46BF    mov edx, 0x801800
004D46C4    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004D46C9    add esp, 0x0C
004D46CC    call 0x0063BC30
004D46D1    test al, al
004D46D3    jz 0x004D46D6                                   ; => [ Call: sub_63bc30 ]
004D46D5    int3
004D46D6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
