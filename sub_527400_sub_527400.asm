...
0052740C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00527411    xor eax, esp
00527413    mov dword ptr ss:[esp+0xC98], eax
0052741A    push ebx
0052741B    push esi
0052741C    push edi
0052741D    call 0x00573400                                 ; => [ Call: sub_573400 ]
00527422    push 0x00
00527424    push 0x00
00527426    push 0x01
...
0052742E    push 0x01
00527430    call 0x00590760                                 ; => [ Call: sub_590760 ]
00527435    add esp, 0x10
00527438    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00527464    call 0x00563FA0                                 ; => [ Call: sub_563fa0 | Data: data_cce9d8 ]
...
0052747C    push ebx
0052747D    push eax
0052747E    call 0x00761FC4                                 ; => [ Call: memset ]
00527483    add esp, 0x0C
00527486    mov edx, 0x7BF980
0052748B    call 0x00566920
00527490    mov esi, eax                                    ; => [ Call: sub_566920 ]
...
005274A8    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005274AB    mov dword ptr ss:[esp+0x0C], eax
005274AF    cmp edi, 0x320
005274B5    jb 0x005274C0
005274B7    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00527523    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00527544    mov esi, eax                                    ; => [ Call: sub_566920 ]
...
00527558    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
00527590    setz cl
00527593    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
00527598    add esp, 0x2C
0052759B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005275CD    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
005275D2    add esp, 0x28
005275D5    test ebx, ebx
005275D7    jz 0x00527646
005275D9    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005275F3    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052763B    push 0x08
0052763D    push eax
0052763E    call 0x005657E0                                 ; => [ Call: sub_5657e0 ]
...
00527652    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0052767C    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00527681    add esp, 0x0C
00527684    call 0x0063BC30
00527689    test al, al
0052768B    jz 0x0052768E                                   ; => [ Call: sub_63bc30 ]
0052768D    int3
0052768E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
