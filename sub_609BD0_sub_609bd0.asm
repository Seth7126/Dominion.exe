...
00609BF2    mov dword ptr fs:[0x00000000], eax
...
00609C16    mov esi, dword ptr ds:[eax]
...
00609C43    call 0x00666380
00609C48    mov eax, dword ptr ds:[0x00B809B4]
...
00609D16    jz 0x00609D33
00609D18    lea ecx, ss:[ebp-0x10]
00609D1B    call 0x0063D4E0
...
00609D2E    call 0x0064C080
00609D33    mov ecx, dword ptr ss:[ebp-0x0C]
00609D36    mov dword ptr fs:[0x00000000], ecx
00609D3D    pop ecx
00609D3E    pop edi
00609D3F    pop esi
00609D40    pop ebx
...
00609D43    pop ebp
00609D44    ret
00609D45    push 0x77EB90
00609D4A    push 0x7B
00609D4C    push 0x77EB50
00609D51    mov ecx, 0x77EB9C
00609D56    mov edx, 0x801800
00609D5B    call 0x0063B870
00609D60    add esp, 0x0C
00609D63    call 0x0063BC30
00609D68    test al, al
00609D6A    jz 0x00609D6D
00609D6C    int3
00609D6D    call 0x0063BB00
