...
004DF635    push 0x763F4B                                   ; => [ Call: sub_763f4b | Type: EHRegistrationNode ]
004DF63A    mov eax, dword ptr fs:[0x00000000]
004DF640    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DF641    sub esp, 0xC8C
004DF647    mov eax, dword ptr ds:[0x008C4040]
004DF64C    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
004DF658    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DF6D2    push eax
004DF6D3    call 0x0063D960                                 ; => [ Call: sub_63d960 | Call: sub_571b30 ]
004DF6D8    test ebx, ebx
004DF6DA    jz 0x004DF763
004DF6E0    cmp dword ptr ds:[ebx], 0x00
004DF6E3    jz 0x004DF763
004DF6E9    mov eax, 0x801800                               ; => [ Data: data_801800 ]
004DF6EE    mov dword ptr ss:[ebp-0xC94], eax               ; => [ Data: data_801800 ]
...
004DF7F9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DF80C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DF811    mov ecx, dword ptr ss:[ebp-0x0C]
004DF814    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DF81B    pop ecx
004DF81C    pop edi
004DF81D    pop esi
004DF81E    pop ebx
...
004DF824    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
