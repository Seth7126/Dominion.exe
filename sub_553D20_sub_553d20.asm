...
00553D2B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00553D30    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00553D50    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
00553D55    add esp, 0x0C
00553D58    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Call: __builtin_memset ]
...
00553DC4    push 0x20
00553DC6    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00553E1A    push 0x00
00553E1C    push eax
00553E1D    call 0x00761FC4                                 ; => [ Call: memset ]
...
00553E3F    push 0x00
00553E41    call 0x00566370                                 ; => [ Call: sub_566370 ]
00553E46    add esp, 0x04
00553E49    mov ecx, esi
00553E4B    call 0x005638E0                                 ; => [ Call: sub_5638e0 ]
00553E50    mov ecx, dword ptr ss:[esp+0x198C]
00553E57    pop edi
00553E58    pop esi
00553E59    xor ecx, esp
00553E5B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
