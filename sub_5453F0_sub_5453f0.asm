...
005453F8    call 0x00761E50                                 ; => [ Call: __chkstk ]
...
00545453    push 0x476
00545458    push esi
00545459    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
