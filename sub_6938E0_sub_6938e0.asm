...
00693945    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: ControllerCursorPosition | Data: data_801800 | String: C:\x\ax2017\Engine\Controller.cpp | String: Halt ]
0069394A    add esp, 0x0C
0069394D    call 0x0063BC30
00693952    test al, al
00693954    jz 0x00693957                                   ; => [ Call: sub_63bc30 ]
00693956    int3
00693957    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
