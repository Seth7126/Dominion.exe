...
00660A19    mov eax, dword ptr ds:[0x008C4040]
...
00660A31    mov edx, 0x801800
00660A36    mov eax, dword ptr ds:[eax]
00660A38    mov ecx, 0x801800
...
00660B17    jz 0x00660B39
00660B19    mov ecx, ebx
00660B1B    call 0x0063D4E0
...
00660B2E    call 0x0064C080
00660B33    mov dword ptr ds:[ebx], 0x801800
...
00660B83    movaps xmm0, xmmword ptr ds:[0x00893940]
00660B8A    lea edi, ss:[ebp-0x128]
00660B90    mov ecx, 0x1E
00660B95    mov dword ptr ss:[ebp-0x50], 0x00
...
00660C81    push 0x876A2C
00660C86    push 0xD4
00660C8B    push 0x824FB0
00660C90    mov ecx, 0x824FD0
...
00660D10    call 0x0065E4E0
00660D15    mov ecx, dword ptr ss:[ebp-0x6C]
00660D18    mov eax, dword ptr ds:[0x00CF65B8]
00660D1D    push 0x01
00660D1F    push 0x00
...
00660E55    movups xmmword ptr ss:[ebp-0x20], xmm0
...
00661015    mov dword ptr ds:[eax+0x20], esi
...
0066107D    push 0x875294
00661082    push 0x2CD8
00661087    mov ecx, 0x87501C
...
0066111C    movzx eax, byte ptr ds:[ecx+0x6612F4]
00661123    jmp dword ptr ds:[eax*4+0x6612EC]
0066112A    or dword ptr ds:[esi+0x04], 0x01
...
006611DC    movzx eax, byte ptr ds:[eax+0x661338]
006611E3    jmp dword ptr ds:[eax*4+0x661330]
...
006611FA    call 0x0065F3D0
006611FF    add esp, 0x08
00661202    jmp 0x0066119A
00661204    push 0x875294
00661209    push 0x2C83
0066120E    mov ecx, 0x8752B8
00661213    jmp 0x006612CB
00661218    push 0x874F5C
0066121D    push 0x295D
00661222    mov ecx, 0x801AA4
00661227    jmp 0x006612CB
0066122C    push 0x874F5C
00661231    push 0x2947
00661236    mov ecx, 0x801AA4
0066123B    jmp 0x006612CB
00661240    push 0x875294
00661245    push 0x2C6B
0066124A    mov ecx, 0x874F7C
0066124F    jmp 0x006612CB
00661251    push 0x825084
00661256    push 0x222
0066125B    push 0x825090
00661260    mov ecx, 0x8250B0
00661265    jmp 0x006612D0
00661267    push 0x875294
0066126C    push 0x2CCE
00661271    mov ecx, 0x875118
...
006612B2    pop ebx
006612B3    call 0x0075927A
006612B8    mov esp, ebp
006612BA    pop ebp
006612BB    ret
006612BC    push 0x875294
006612C1    push 0x2CD9
006612C6    mov ecx, 0x874FFC
006612CB    push 0x8739B4
006612D0    mov edx, 0x801800
006612D5    call 0x0063B870
006612DA    add esp, 0x0C
006612DD    call 0x0063BC30
006612E2    test al, al
006612E4    jz 0x006612E7
006612E6    int3
006612E7    call 0x0063BB00
