...
005DA15B    push 0x871018                                   ; => [ String: GetLogStyleFlag ]
005DA160    push 0x3359
005DA165    jmp 0x005DA177
005DA167    mov eax, 0x01
005DA16C    ret
005DA16D    push 0x871018                                   ; => [ String: GetLogStyleFlag ]
005DA172    push 0x3368
005DA177    push 0x86F1E8
005DA17C    mov edx, 0x801800
005DA181    mov ecx, 0x801AA4
005DA186    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetLogStyleFlag | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: Halt ]
005DA18B    add esp, 0x0C
005DA18E    call 0x0063BC30
005DA193    test al, al
005DA195    jz 0x005DA198                                   ; => [ Call: sub_63bc30 ]
005DA197    int3
005DA198    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
