...
0052367B    push 0x02
0052367D    call 0x00590760
00523682    add esp, 0x10
00523685    call 0x00573400
...
005236BC    mov ebx, dword ptr ds:[eax+0x04]
005236BF    cmp esi, 0x320
005236C5    jb 0x005236CC
005236C7    call 0x00591930
...
00523714    call 0x0063B870
00523719    add esp, 0x0C
0052371C    call 0x0063BC30
00523721    test al, al
00523723    jz 0x00523726
00523725    int3
00523726    call 0x0063BB00
