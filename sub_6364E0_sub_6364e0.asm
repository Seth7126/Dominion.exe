...
0063668D    mov dword ptr ss:[ebp-0x20FC], eax
...
006366E6    jnl 0x006366EF
006366E8    mov eax, 0x04
006366ED    jmp 0x006366FC
006366EF    mov ecx, 0x01
006366F4    call 0x006A9450
006366F9    imul eax, edi
006366FC    mov ecx, dword ptr ss:[ebp-0x2100]
00636702    mov dword ptr ds:[0x00BF17C8], edi
00636708    mov dword ptr ds:[0x00BF17CC], ecx
0063670E    mov dword ptr ds:[0x00BF17D0], eax
00636713    mov dword ptr ds:[0x00BF17D4], 0x01
0063671D    test esi, esi
0063671F    jnle 0x00636732
00636721    push 0x8770A0
00636726    push 0x3D
00636728    mov ecx, 0x8770BC
0063672D    jmp 0x0063682A
00636732    cmp esi, 0x77359400
00636738    jl 0x0063674B
0063673A    push 0x8770A0
0063673F    push 0x3E
00636741    mov ecx, 0x8770A8
...
0063675F    cmp byte ptr ds:[0x00BF17A4], 0x00
00636766    mov dword ptr ds:[0x00BF17C4], eax
0063676B    jnz 0x00636784
0063676D    push 0x400
00636772    push 0xBF17A8
00636777    call dword ptr ds:[0x00775130]
0063677D    mov byte ptr ds:[0x00BF17A4], 0x01
00636784    push 0xBF17A8
00636789    call dword ptr ds:[0x00775138]
0063678F    mov ecx, dword ptr ds:[0x0147B070]
00636795    mov esi, dword ptr ss:[ebp-0x20FC]
0063679B    push 0xBF17C4
006367A0    push esi
006367A1    mov eax, dword ptr ds:[ecx]
006367A3    call dword ptr ds:[eax+0x84]
006367A9    mov ecx, esi
006367AB    call 0x0069EC60
006367B0    push dword ptr ss:[ebp-0x210C]
006367B6    mov ecx, 0xBF17C0
006367BB    call 0x0063D8D0
006367C0    push 0x00
006367C2    push 0x00
006367C4    push 0x00
006367C6    push 0x635AB0
006367CB    push 0x100000
006367D0    push 0x00
006367D2    mov byte ptr ds:[0x00BF17A5], 0x01
006367D9    call dword ptr ds:[0x00775114]
006367DF    mov dword ptr ds:[0x00BF17D8], eax
