...
0054BCA7    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
0054BCAC    call 0x00573400                                 ; => [ Call: sub_573400 ]
0054BCB1    push 0x00
0054BCB3    push 0x00
0054BCB5    push 0x01
...
0054BCBD    push 0x02
0054BCBF    call 0x00590760                                 ; => [ Call: sub_590760 ]
0054BCC4    add esp, 0x14
0054BCC7    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054BCEA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0054BCEF    add esp, 0x0C
0054BCF2    call 0x0063BC30
0054BCF7    test al, al
0054BCF9    jz 0x0054BCFC                                   ; => [ Call: sub_63bc30 ]
0054BCFB    int3
0054BCFC    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
