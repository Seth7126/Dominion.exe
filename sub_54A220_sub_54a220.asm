...
0054A282    call 0x00561A00
0054A287    lea eax, ss:[ebp-0xCC8]
0054A28D    mov dword ptr ss:[ebp-0xCC8], 0x81C928
0054A297    mov dword ptr ss:[ebp-0xCA4], eax
...
0054A2D5    push esi
0054A2D6    call dword ptr ds:[eax]
