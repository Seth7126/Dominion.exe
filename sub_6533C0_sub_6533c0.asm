...
006533D8    push 0x76CEE1                                   ; => [ Type: EHRegistrationNode | Call: sub_76cee1 ]
006533DD    mov eax, dword ptr fs:[0x00000000]
006533E3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006533E4    push ebx
...
006533F5    push esi
006533F6    push edi
006533F7    push eax                                        ; => [ Data: __security_cookie ]
006533F8    lea eax, ss:[ebp-0x0C]
006533FB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00653428    push 0x87437C                                   ; => [ String: UI2::countChildren ]
0065342D    push 0xBA8
00653432    mov ecx, 0x874310                               ; => [ String: numChildren >= 0 ]
00653437    jmp 0x00653A14
0065343C    jz 0x00653452
0065343E    push 0x87492C                                   ; => [ String: UI2ItemReset ]
00653443    push 0x1622
00653448    mov ecx, 0x874978                               ; => [ String: ui.countChildren() == 0 ]
0065344D    jmp 0x00653A14
00653452    mov eax, dword ptr fs:[0x0000002C]
00653458    mov esi, dword ptr ds:[eax]                     ; => [ Field: ThreadLocalStoragePointer ]
0065345A    mov eax, dword ptr ds:[0x01A98FCC]
0065345F    mov dword ptr ss:[ebp-0x20], esi
00653462    cmp eax, dword ptr ds:[esi+0x08]
00653468    jle 0x006534BB                                  ; => [ Data: data_1a98fcc ]
0065346A    push 0x1A98FCC
0065346F    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a98fcc ]
00653474    add esp, 0x04
00653477    cmp dword ptr ds:[0x01A98FCC], 0xFFFFFFFF
0065347E    jnz 0x006534BB                                  ; => [ Data: data_1a98fcc ]
00653480    push 0x88
00653485    lea eax, ss:[ebp-0xB0]
0065348B    push 0x00
0065348D    push eax
0065348E    call 0x00761FC4                                 ; => [ Call: memset ]
00653493    add esp, 0x0C
00653496    lea esi, ss:[ebp-0xB0]
0065349C    mov ecx, 0x22
006534A1    mov edi, 0x1A98FD0
006534A6    rep movsd                                       ; => [ Call: __builtin_memcpy ]
006534A8    push 0x1A98FCC
006534AD    call 0x007596BD                                 ; => [ Data: data_1a98fcc | Call: __Init_thread_footer ]
...
0065353D    jz 0x00653570                                   ; => [ Data: data_801800 ]
0065353F    cmp dword ptr ds:[0x00CF65BC], 0x00
00653546    jz 0x0065356A
00653548    cmp byte ptr ds:[eax], 0x00
0065354B    jz 0x0065356A                                   ; => [ Data: data_cf65bc ]
0065354D    mov ecx, esi
0065354F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00653562    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00653567    mov edx, dword ptr ss:[ebp-0x18]
0065356A    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
00653592    movlpd qword ptr ss:[ebp-0x5C], xmm0            ; => [ Call: __builtin_memset ]
...
006535FF    movlpd qword ptr ss:[ebp-0x64], xmm0            ; => [ Call: __builtin_memset ]
...
0065366F    movlpd qword ptr ss:[ebp-0x64], xmm0            ; => [ Call: __builtin_memset ]
...
006536D8    call 0x00761FC4                                 ; => [ Call: memset ]
...
00653708    movups xmmword ptr ss:[ebp-0xB0], xmm0          ; => [ Data: data_7ff520 ]
0065370F    mov ecx, 0x21
00653714    lea eax, ss:[ebp-0x68]
00653717    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00653719    push dword ptr ds:[0x007E5D1C]
0065371F    push eax
00653720    call 0x0067DB20                                 ; => [ Call: sub_67db20 ]
...
00653767    push eax
00653768    call 0x0067DB20                                 ; => [ Call: sub_67db20 ]
...
006537AC    push eax
006537AD    call 0x0067DB20                                 ; => [ Call: sub_67db20 ]
...
006537F1    push eax
006537F2    call 0x0067DB20                                 ; => [ Call: sub_67db20 ]
...
00653836    push eax
00653837    call 0x0067DB20                                 ; => [ Call: sub_67db20 ]
...
0065387B    push eax
0065387C    call 0x0067DB20                                 ; => [ Call: sub_67db20 ]
...
006538BC    push eax
006538BD    call 0x0067DC00                                 ; => [ Call: sub_67dc00 ]
...
006538FE    push eax
006538FF    call 0x0067DC00                                 ; => [ Call: sub_67dc00 ]
...
00653943    push eax
00653944    call 0x00761FC4                                 ; => [ Call: memset ]
...
006539EA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006539F1    pop ecx
006539F2    pop edi
006539F3    pop esi
006539F4    mov ecx, dword ptr ss:[ebp-0x14]
006539F7    xor ecx, ebp
006539F9    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006539FE    mov esp, ebp
00653A00    pop ebp
00653A01    mov esp, ebx
00653A03    pop ebx
00653A04    ret
00653A05    push 0x87492C                                   ; => [ String: UI2ItemReset ]
00653A0A    push 0x162F
00653A0F    mov ecx, 0x874950                               ; => [ String: propsStatic.itemAlignment != TA_NONE ]
00653A14    push 0x8739B4
00653A19    mov edx, 0x801800
00653A1E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\UI2.cpp ]
00653A23    add esp, 0x0C
00653A26    call 0x0063BC30
00653A2B    test al, al
00653A2D    jz 0x00653A30                                   ; => [ Call: sub_63bc30 ]
00653A2F    int3
00653A30    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
