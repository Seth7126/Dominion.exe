...
0073E043    jnz 0x0073E0C3
0073E049    mov edx, dword ptr ds:[0x0147ABE8]
0073E04F    test edx, edx
0073E051    jnz 0x0073E069
0073E053    push 0x871F88
0073E058    push 0x45
0073E05A    push 0x871FA0
0073E05F    mov ecx, 0x871F94
0073E064    jmp 0x0073E165
0073E069    mov edx, dword ptr ds:[edx+0x10]
0073E06C    xor ecx, ecx
...
0073E117    movss dword ptr ds:[0x0147DF84], xmm0
0073E11F    pop esi
0073E120    xor al, al
0073E122    pop ebx
0073E123    ret
...
0073E141    pop esi
0073E142    pop ebx
0073E143    movss dword ptr ds:[0x0147DF84], xmm0
0073E14B    ret
0073E14C    pop esi
0073E14D    mov al, bl
0073E14F    pop ebx
0073E150    ret
0073E151    push 0x88FA60
0073E156    push 0x553
0073E15B    push 0x88F938
0073E160    mov ecx, 0x801AA4
0073E165    mov edx, 0x801800
0073E16A    call 0x0063B870
0073E16F    add esp, 0x0C
0073E172    call 0x0063BC30
0073E177    test al, al
0073E179    jz 0x0073E17C
0073E17B    int3
0073E17C    call 0x0063BB00
