...
004E5375    push 0x7644EE                                   ; => [ Call: __ehhandler$?_Getcat@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@SAIPAPBVfacet@locale@2@PBV42@@Z | Type: EHRegistrationNode ]
004E537A    mov eax, dword ptr fs:[0x00000000]
004E5380    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E538E    push eax                                        ; => [ Data: __security_cookie ]
004E538F    lea eax, ss:[ebp-0x0C]
004E5392    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E53A7    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
004E5426    call 0x004E50E0                                 ; => [ Call: sub_4e50e0 ]
004E542B    add esp, 0x08
004E542E    mov dword ptr ss:[ebp-0x04], 0x01
004E5435    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
004E5448    mov eax, 0x816630                               ; => [ String: none ]
004E544D    jmp 0x004E5457
004E544F    call 0x00516F30
004E5454    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E5457    push esi
004E5458    push eax
...
004E546E    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E5473    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: %s(%s) ]
004E5475    test eax, eax
004E5477    cmovnz ecx, eax
004E547A    push ecx
004E547B    mov ecx, ebx
004E547D    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E5482    mov byte ptr ss:[ebp-0x04], 0x03
004E5486    cmp dword ptr ds:[0x00CF65BC], 0x00
004E548D    jz 0x004E54BD                                   ; => [ Data: data_cf65bc ]
...
004E549E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E54B1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E54B6    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
004E54BD    mov dword ptr ss:[ebp-0x04], 0x04
004E54C4    cmp dword ptr ds:[0x00CF65BC], 0x00
004E54CB    jz 0x004E58C0                                   ; => [ Data: data_cf65bc ]
...
004E54E8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E54FF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5504    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
004E552B    call 0x004E50E0                                 ; => [ Call: sub_4e50e0 ]
004E5530    add esp, 0x08
004E5533    mov dword ptr ss:[ebp-0x04], 0x05
004E553A    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
004E554D    mov eax, 0x816630                               ; => [ String: none ]
004E5552    jmp 0x004E555C
004E5554    call 0x00516F30
004E5559    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E555C    push esi
004E555D    push eax
...
004E5573    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E5578    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: %s(%s) ]
004E557A    test eax, eax
004E557C    cmovnz ecx, eax
004E557F    push ecx
004E5580    mov ecx, ebx
004E5582    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E5587    mov byte ptr ss:[ebp-0x04], 0x07
004E558B    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5592    jz 0x004E55C2                                   ; => [ Data: data_cf65bc ]
...
004E55A3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E55B6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E55BB    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
004E55C2    mov dword ptr ss:[ebp-0x04], 0x08
004E55C9    cmp dword ptr ds:[0x00CF65BC], 0x00
004E55D0    jz 0x004E58C0                                   ; => [ Data: data_cf65bc ]
...
004E55ED    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5604    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5609    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
004E5630    mov eax, 0x816630                               ; => [ String: none ]
004E5635    jmp 0x004E563F
004E5637    call 0x00516F30
004E563C    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E563F    push eax
...
004E5658    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E565D    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: %s ]
004E565F    test eax, eax
004E5661    cmovnz ecx, eax
004E5664    push ecx
004E5665    mov ecx, ebx
004E5667    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E566C    mov dword ptr ss:[ebp-0x04], 0x0A
004E5673    cmp dword ptr ds:[0x00CF65BC], 0x00
004E567A    jz 0x004E58C0                                   ; => [ Data: data_cf65bc ]
...
004E5697    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E56AE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E56B3    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
...
004E56E8    mov esi, dword ptr ds:[eax+0x58]                ; => [ Call: sub_571b30 ]
004E56EB    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
004E56FC    mov eax, 0x816630                               ; => [ String: none ]
004E5701    jmp 0x004E570B
004E5703    call 0x00516F30
004E5708    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E570B    push esi
...
004E5728    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E572D    mov eax, dword ptr ds:[eax]                     ; => [ String: %s(%s,%s) | Call: sub_63df30 ]
004E572F    test eax, eax
004E5731    cmovnz ecx, eax
004E5734    push ecx
004E5735    mov ecx, ebx
004E5737    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E573C    mov dword ptr ss:[ebp-0x04], 0x0C
004E5743    cmp dword ptr ds:[0x00CF65BC], 0x00
004E574A    jz 0x004E58C0                                   ; => [ Data: data_cf65bc ]
...
004E5767    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E577E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5783    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
004E578A    jmp 0x004E58C0
004E578F    mov ecx, eax
004E5791    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
004E5796    mov ecx, dword ptr ds:[edi]
004E5798    mov esi, dword ptr ds:[eax+0x58]
004E579B    test ecx, ecx
004E579D    jnz 0x004E57A6
004E579F    mov eax, 0x816630                               ; => [ String: none ]
004E57A4    jmp 0x004E57AE
004E57A6    call 0x00516F30
004E57AB    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E57AE    push esi
004E57AF    push eax
...
004E57C8    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E57CD    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: %s(%s) ]
004E57CF    test eax, eax
004E57D1    cmovnz ecx, eax
004E57D4    push ecx
004E57D5    mov ecx, ebx
004E57D7    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E57DC    mov dword ptr ss:[ebp-0x04], 0x0E
004E57E3    cmp dword ptr ds:[0x00CF65BC], 0x00
004E57EA    jz 0x004E58C0                                   ; => [ Data: data_cf65bc ]
...
004E5807    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E581E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5823    mov dword ptr ss:[ebp-0x28], 0x801800           ; => [ Data: data_801800 ]
004E582A    jmp 0x004E58C0
004E582F    mov ecx, eax
004E5831    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
004E5842    mov eax, 0x816630                               ; => [ String: none ]
004E5847    jmp 0x004E5851
004E5849    call 0x00516F30
004E584E    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E5851    push esi
...
004E586E    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
004E5873    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: %s(%s,%d) ]
004E5875    test eax, eax
004E5877    cmovnz ecx, eax
004E587A    push ecx
004E587B    mov ecx, ebx
004E587D    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
004E5882    mov dword ptr ss:[ebp-0x04], 0x10
004E5889    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5890    jz 0x004E58C0                                   ; => [ Data: data_cf65bc ]
...
004E58A1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E58B4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E58B9    mov dword ptr ss:[ebp-0x2C], 0x801800           ; => [ Data: data_801800 ]
...
004E58DD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E58E4    pop ecx
004E58E5    pop edi
004E58E6    pop esi
004E58E7    pop ebx
...
004E5905    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: ToExtrasString | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameShared.cpp | String: missionExtras[i].piece != CSTART_REPLACE_COPPER ]
004E590A    add esp, 0x0C
004E590D    call 0x0063BC30
004E5912    test al, al
004E5914    jz 0x004E5917                                   ; => [ Call: sub_63bc30 ]
004E5916    int3
004E5917    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
