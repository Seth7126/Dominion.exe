...
00766F6C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00766F71    mov ecx, dword ptr ds:[edx-0x08]
00766F74    xor ecx, eax
00766F76    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00766F7B    mov eax, 0x8B2A34
00766F80    jmp 0x00761FA6                                  ; => [ Data: data_8b2a34 | Call: __CxxFrameHandler3 ]
