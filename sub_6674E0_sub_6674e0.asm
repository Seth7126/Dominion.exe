...
00667547    jnz 0x006675E5                                  ; => [ Data: data_c23ba8 ]
0066754D    mov ecx, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
...
00667565    call 0x006655E0                                 ; => [ Call: sub_6655e0 ]
0066756A    test al, al
...
0066757B    push 0x8758EC                                   ; => [ String: FilterParentsOnly ]
00667580    push 0x398D
00667585    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
0066758A    mov ecx, 0x875948                               ; => [ String: !IsTemplate(UI2Get(parentsOnly[i])) ]
0066758F    jmp 0x006675F6
00667591    mov edx, dword ptr ds:[0x00C23BAC]              ; => [ Data: data_c23bac ]
...
006675A5    push 0x876B2C                                   ; => [ String: DataArray<struct UI2>::DataArrayGet ]
006675AA    push 0x6C
006675AC    mov ecx, 0x802734                               ; => [ String: id != DATAID_NULL ]
006675B1    jmp 0x006675F1
006675B3    movzx eax, si
006675B6    cmp eax, edx
006675B8    jnb 0x006675E5
006675BA    imul eax, eax, 0x18D0
006675C0    add eax, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
...
006675E3    pop ebp
006675E4    ret                                             ; => [ Call: sub_6673f0 ]
006675E5    push 0x876B2C                                   ; => [ String: DataArray<struct UI2>::DataArrayGet ]
006675EA    push 0x6D
006675EC    mov ecx, 0x802748                               ; => [ String: DataArrayTryToGet(id) != NULL ]
006675F1    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h ]
006675F6    mov edx, 0x801800
006675FB    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00667600    add esp, 0x0C
00667603    call 0x0063BC30
00667608    test al, al
0066760A    jz 0x0066760D                                   ; => [ Call: sub_63bc30 ]
0066760C    int3
0066760D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
