...
006EC695    push 0x7719F0                                   ; => [ Type: EHRegistrationNode | Call: sub_7719f0 ]
006EC69A    mov eax, dword ptr fs:[0x00000000]
006EC6A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006EC6AE    push eax                                        ; => [ Data: __security_cookie ]
006EC6AF    lea eax, ss:[ebp-0x0C]
006EC6B2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006EC6D4    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: samplerFn_layer%d ]
...
006EC6F6    push eax
006EC6F7    call 0x006EC490                                 ; => [ Call: sub_6ec490 ]
...
006EC737    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: texDiffuse ]
006EC73C    mov byte ptr ss:[ebp-0x04], 0x02
006EC740    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
006EC75F    mov ecx, ebx                                    ; => [ Data: data_801800 ]
006EC761    mov eax, dword ptr ds:[eax]                     ; => [ String: %d | Call: sub_63df30 ]
006EC763    test eax, eax
006EC765    cmovnz ecx, eax
006EC768    push ecx
006EC769    lea ecx, ss:[ebp+0x08]
006EC76C    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006EC771    mov byte ptr ss:[ebp-0x04], 0x04
006EC775    cmp dword ptr ds:[0x00CF65BC], 0x00
006EC77C    jz 0x006EC7A8                                   ; => [ Data: data_cf65bc ]
...
006EC78D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC7A0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EC7A5    mov dword ptr ss:[ebp-0x18], ebx                ; => [ Data: data_801800 ]
006EC7A8    mov byte ptr ss:[ebp-0x04], 0x02
006EC7AC    mov edx, edi
006EC7AE    lea ecx, ss:[ebp-0x1C]
006EC7B1    call 0x006EC520                                 ; => [ Call: sub_6ec520 ]
006EC7B6    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006EC827    jz 0x006EC844                                   ; => [ Data: data_cf65bc ]
006EC829    lea ecx, ss:[ebp-0x2C]
006EC82C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC873    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC887    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: \tfloat2 duv = uv - float2(.5, .5);\n\tfloat dist = duv.x*duv.x + duv.y*duv.y;\n\tfloat alpha = 1.0 - smoothstep(0.24, 0.25, dist);\n\treturn float4(1.0, 1.0, 1.0, alpha);\n ]
...
006EC8A7    jz 0x006EC8C4                                   ; => [ Data: data_cf65bc ]
006EC8A9    lea ecx, ss:[ebp-0x2C]
006EC8AC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC8F7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC90A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EC90F    mov byte ptr ss:[ebp-0x04], 0x06
006EC913    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006EC918    mov edi, dword ptr ss:[ebp-0x18]
006EC91B    mov edx, ecx                                    ; => [ Data: data_801800 ]
006EC91D    mov eax, dword ptr ss:[ebp-0x1C]
006EC920    test edi, edi
006EC922    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
006EC94D    push eax
006EC94E    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: float4 %s(float2 arg_uv, float4 diffuse)\n{\n%s\n%s\n%s}\n ]
...
006EC9A3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC9B6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EC9BB    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006EC9D6    jz 0x006EC9F3                                   ; => [ Data: data_cf65bc ]
006EC9D8    lea ecx, ss:[ebp-0x18]
006EC9DB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EC9EE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EC9F3    mov byte ptr ss:[ebp-0x04], 0x12
006EC9F7    cmp dword ptr ds:[0x00CF65BC], 0x00
006EC9FE    jz 0x006ECA2E                                   ; => [ Data: data_cf65bc ]
...
006ECA0F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECA22    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECA27    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
006ECA42    jz 0x006ECA5F                                   ; => [ Data: data_cf65bc ]
006ECA44    lea ecx, ss:[ebp+0x08]
006ECA47    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECA7E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECA91    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECA96    mov eax, dword ptr ss:[ebp-0x28]
006ECA99    mov ecx, dword ptr ss:[ebp-0x0C]
006ECA9C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006ECAA3    pop ecx
006ECAA4    pop edi
006ECAA5    pop esi
006ECAA6    pop ebx
...
006ECAC1    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\MaterialFnDef.cpp | Data: data_801800 | String: EmitTextureFn | String: Halt ]
006ECAC6    add esp, 0x0C
006ECAC9    call 0x0063BC30
006ECACE    test al, al
006ECAD0    jz 0x006ECAD3                                   ; => [ Call: sub_63bc30 ]
006ECAD2    int3
006ECAD3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
