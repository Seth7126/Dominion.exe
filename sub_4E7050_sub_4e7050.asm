...
004E7055    push 0x764806                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0?$ListArray@U?$ListArrayInlineLink@VWorkQueue@details@Concurrency@@@details@Concurrency@@@details@Concurrency@@QAE@PAVSchedulerBase@12@HH@Z ]
004E705A    mov eax, dword ptr fs:[0x00000000]
004E7060    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E706E    push eax                                        ; => [ Data: __security_cookie ]
004E706F    lea eax, ss:[ebp-0x0C]
004E7072    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004E7078    mov ebx, edx
004E707A    mov esi, ecx
004E707C    mov dword ptr ss:[ebp-0x28], esi
004E707F    mov dword ptr ss:[ebp-0x20], 0x00
004E7086    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
004E70AF    push eax
004E70B0    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: [%s] ]
...
004E70D4    push eax
004E70D5    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: [%s] ]
...
004E70EF    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
004E70F4    mov edx, dword ptr ss:[ebp+0x0C]
004E70F7    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004E70FC    mov byte ptr ss:[ebp-0x04], 0x03
004E7100    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004E7118    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
004E7149    call 0x0063D850                                 ; => [ Call: sub_4d4980 | Call: sub_63d850 ]
004E714E    mov byte ptr ss:[ebp-0x04], 0x06
004E7152    cmp dword ptr ds:[0x00CF65BC], 0x00
004E7159    jz 0x004E7189                                   ; => [ Data: data_cf65bc ]
...
004E716A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E717D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E7182    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004E7189    mov byte ptr ss:[ebp-0x04], 0x07
004E718D    cmp dword ptr ds:[0x00CF65BC], 0x00
004E7194    jz 0x004E71BD                                   ; => [ Data: data_cf65bc ]
...
004E71A5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E71B8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E71BD    mov byte ptr ss:[ebp-0x04], 0x08
004E71C1    cmp dword ptr ds:[0x00CF65BC], 0x00
004E71C8    jz 0x004E71F1                                   ; => [ Data: data_cf65bc ]
...
004E71D9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E71EC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E71F1    mov byte ptr ss:[ebp-0x04], 0x09
004E71F5    cmp dword ptr ds:[0x00CF65BC], 0x00
004E71FC    jz 0x004E72CF                                   ; => [ Data: data_cf65bc ]
...
004E722C    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
004E7231    mov byte ptr ss:[ebp-0x04], 0x0A
004E7235    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
004E725B    call 0x0063D850                                 ; => [ Call: sub_4d48c0 | Call: sub_63d850 ]
004E7260    mov byte ptr ss:[ebp-0x04], 0x0C
004E7264    cmp dword ptr ds:[0x00CF65BC], 0x00
004E726B    jz 0x004E729B                                   ; => [ Data: data_cf65bc ]
...
004E727C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E728F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E7294    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
004E729B    mov byte ptr ss:[ebp-0x04], 0x0D
004E729F    cmp dword ptr ds:[0x00CF65BC], 0x00
004E72A6    jz 0x004E72CF                                   ; => [ Data: data_cf65bc ]
...
004E72B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E731A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E7383    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: %c%s | Call: sub_63d850 ]
004E7388    mov dword ptr ss:[ebp-0x04], 0x12
004E738F    cmp dword ptr ds:[0x00CF65BC], 0x00
004E7396    jz 0x004E73BF                                   ; => [ Data: data_cf65bc ]
...
004E73A7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E73BA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E73BF    mov eax, esi
004E73C1    mov ecx, dword ptr ss:[ebp-0x0C]
004E73C4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E73CB    pop ecx
004E73CC    pop edi
004E73CD    pop esi
004E73CE    pop ebx
...
004E73EC    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
004E73F1    add esp, 0x0C
004E73F4    call 0x0063BC30
004E73F9    test al, al
004E73FB    jz 0x004E73FE                                   ; => [ Call: sub_63bc30 ]
004E73FD    int3
004E73FE    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004E7403    push 0x871DD4
004E7408    push 0x94
004E740D    push 0x871D5C
004E7412    mov edx, edi
004E7414    mov ecx, 0x871E0C
004E7419    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
004E741E    add esp, 0x0C
004E7421    call 0x0063BC30
004E7426    test al, al
004E7428    jz 0x004E742B                                   ; => [ Call: sub_63bc30 ]
004E742A    int3
004E742B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004E7430    push 0x871DD4
004E7435    push 0x94
004E743A    push 0x871D5C
004E743F    mov edx, 0x801800
004E7444    mov ecx, 0x871E0C
004E7449    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
004E744E    add esp, 0x0C
004E7451    call 0x0063BC30
004E7456    test al, al
004E7458    jz 0x004E745B                                   ; => [ Call: sub_63bc30 ]
004E745A    int3
004E745B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
