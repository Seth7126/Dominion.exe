...
0056A889    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0056A8A4    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056A8F8    push eax
0056A8F9    push 0x09
0056A8FB    movlpd qword ptr ss:[ebp-0xCD0], xmm0           ; => [ Call: __builtin_memset ]
...
0056A920    push 0x00
0056A922    push 0x01
0056A924    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0056A972    call 0x005869D0                                 ; => [ Call: sub_5869d0 ]
...
0056A9C0    call 0x00591930                                 ; => [ Call: sub_591930 ]
0056A9C5    push ecx
...
0056A9D2    test al, al
0056A9D4    jz 0x0056A9E9                                   ; => [ Call: sub_5624a0 ]
...
0056A9E0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0056A9F2    pop ebx
0056A9F3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
