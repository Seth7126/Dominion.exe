...
00536B6B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00536B70    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00536B75    xor eax, esp
00536B77    mov dword ptr ss:[esp+0x1994], eax
00536B7E    push esi
00536B7F    push edi
00536B80    call 0x00573400                                 ; => [ Call: sub_573400 ]
00536B85    push 0x00
00536B87    push 0x00
00536B89    push 0x00
...
00536B91    push 0x04
00536B93    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
00536BAE    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
00536C1F    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
...
00536C36    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
00536C3B    add esp, 0x0C
00536C3E    mov dword ptr ss:[esp+0x10], eax
00536C42    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00536C6B    jnle 0x00536C93                                 ; => [ Call: sub_576b30 ]
...
00536C87    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
00536C8C    add esp, 0x10
00536C8F    test eax, eax
00536C91    jle 0x00536C70
00536C93    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00536CBB    mov dword ptr ss:[esp+0x18], eax                ; => [ Call: nullptr ]
00536CBF    call 0x00582DE0
00536CC4    add esp, 0x04
00536CC7    test al, al
00536CC9    jnz 0x00536D38                                  ; => [ Call: sub_582de0 ]
00536CCB    lea eax, ss:[esp+0xD10]
00536CD2    or edx, 0xFFFFFFFF
00536CD5    push eax
00536CD6    push 0x05
00536CD8    mov ecx, edi
00536CDA    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00536D2D    push 0x10
00536D2F    push eax
00536D30    call 0x005822E0                                 ; => [ Call: nullptr | Call: sub_5822e0 ]
...
00536D47    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00536D65    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
