...
0055E63D    mov edi, dword ptr ds:[eax+0x04]
0055E640    cmp esi, 0x320
0055E646    jb 0x0055E64D
0055E648    call 0x00591930
0055E64D    imul eax, esi, 0x64
0055E650    mov dword ptr ss:[ebp-0xD08], 0x81E928
...
0055E679    mov dword ptr ss:[ebp-0xCE4], eax
...
0055E6DD    mov dword ptr ss:[ebp-0x20], eax
...
0055E6F4    push eax
0055E6F5    call dword ptr ds:[edx+0x10]
0055E6F8    xorps xmm0, xmm0
0055E6FB    mov dword ptr ss:[ebp-0xCD4], 0x00
0055E705    movlpd qword ptr ss:[ebp-0xCDC], xmm0
...
0055E7AA    call 0x00568F20
0055E7AF    sub esp, 0x28
0055E7B2    lea ecx, ss:[ebp-0xCA8]
0055E7B8    mov eax, esp
0055E7BA    mov dword ptr ds:[eax], 0x81E90C
0055E7C0    mov dword ptr ds:[eax+0x04], ecx
0055E7C3    mov dword ptr ds:[eax+0x24], eax
0055E7C6    call 0x005699B0
0055E7CB    add esp, 0x28
0055E7CE    call 0x00573400
...
0055E7EB    mov dword ptr fs:[0x00000000], ecx
0055E7F2    pop ecx
0055E7F3    pop edi
0055E7F4    pop esi
0055E7F5    mov ecx, dword ptr ss:[ebp-0x14]
0055E7F8    xor ecx, ebp
0055E7FA    call 0x0075927A
