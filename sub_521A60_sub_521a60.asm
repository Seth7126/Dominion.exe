...
00521A65    push 0x7657D8                                   ; => [ Call: sub_7657d8 | Type: EHRegistrationNode ]
00521A6A    mov eax, dword ptr fs:[0x00000000]
00521A70    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00521A81    push esi
00521A82    push edi
00521A83    push eax                                        ; => [ Data: __security_cookie ]
00521A84    lea eax, ss:[ebp-0x0C]
00521A87    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00521A8D    mov dword ptr ss:[ebp-0x78], ecx
00521A90    call 0x00573400                                 ; => [ Call: sub_573400 ]
00521A95    push 0x00
00521A97    mov edx, dword ptr ds:[eax+0x0C]
00521A9A    mov ecx, dword ptr ds:[eax+0x04]
00521A9D    call 0x005887C0                                 ; => [ Call: sub_5887c0 ]
...
00521ABB    call 0x00566DC0                                 ; => [ Call: sub_566dc0 ]
00521AC0    push 0x00
00521AC2    push 0x08
...
00521ACE    test al, al
00521AD0    jz 0x00521B11                                   ; => [ Call: sub_5696d0 ]
00521AD2    mov ecx, 0x100
00521AD7    call 0x00563590                                 ; => [ Call: sub_563590 ]
00521ADC    mov esi, eax
00521ADE    test esi, esi
00521AE0    jz 0x00521C52
00521AE6    call 0x00573400                                 ; => [ Call: sub_573400 ]
00521AEB    push 0x04
00521AED    push 0x00
00521AEF    push 0x00
...
00521B3E    call 0x00563820                                 ; => [ Call: sub_563820 ]
00521B43    test al, al
00521B45    jz 0x00521C52
00521B4B    call 0x00573400
00521B50    mov esi, dword ptr ds:[eax+0x0C]                ; => [ Call: sub_573400 ]
...
00521B6B    mov eax, dword ptr ds:[eax+0x0C]                ; => [ Call: sub_573400 ]
...
00521BC1    mov dword ptr ss:[ebp-0x4C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_92955b226a3f12dcc930e98709c3c720>, void>::VTable ]
00521BC4    lea eax, ss:[ebp-0x40]
00521BC7    mov dword ptr ss:[ebp-0x70], 0x817DB8           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_92955b226a3f12dcc930e98709c3c720>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
00521BF7    mov dword ptr ss:[ebp-0x40], 0x817D9C           ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_0ad9a55f0365eb85a416a0b6e114fdb7>, void>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_0ad9a55f0365eb85a416a0b6e114fdb7>, void>::`vftable'{for `std::_Func_base<void>'} ]
00521BFE    mov dword ptr ss:[ebp-0x3C], esi
00521C01    mov dword ptr ss:[ebp-0x38], edi
00521C04    mov dword ptr ss:[ebp-0x1C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_0ad9a55f0365eb85a416a0b6e114fdb7>, void>::VTable ]
...
00521C31    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
00521C4A    push 0x30
00521C4C    push eax
00521C4D    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
00521C52    mov ecx, dword ptr ss:[ebp-0x0C]
00521C55    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00521C5C    pop ecx
00521C5D    pop edi
00521C5E    pop esi
00521C5F    mov ecx, dword ptr ss:[ebp-0x10]
00521C62    xor ecx, ebp
00521C64    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
