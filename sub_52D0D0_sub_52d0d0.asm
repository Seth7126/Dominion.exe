...
0052D0E5    jnz 0x0052D119                                  ; => [ Call: sub_573400 ]
0052D0E7    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052D0EC    mov ebx, dword ptr ss:[ebp+0x08]
0052D0EF    mov edi, eax
0052D0F1    mov esi, 0x819480                               ; => [ String: candlestick_maker ]
...
0052D103    push ebx
0052D104    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
0052D109    add esp, 0x0C
0052D10C    cmp esi, 0x819460
0052D112    jnle 0x0052D0F6                                 ; => [ Data: data_819460 ]
0052D114    pop edi
0052D115    pop esi
0052D116    pop ebx
0052D117    pop ebp
0052D118    ret
0052D119    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052D11E    mov ebx, dword ptr ss:[ebp+0x08]
0052D121    mov edi, eax
0052D123    mov esi, 0x819460                               ; => [ Data: data_819460 ]
...
0052D13D    push ebx
0052D13E    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
