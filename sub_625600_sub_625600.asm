...
00625628    mov dword ptr fs:[0x00000000], eax
...
0062566C    push 0x104
00625671    push ecx
00625672    call dword ptr ds:[0x00775198]
...
006256B9    jz 0x006256D9
006256BB    lea ecx, ss:[ebp-0x11C]
006256C1    call 0x0063D4E0
...
006256D4    call 0x0064C080
006256D9    mov eax, 0x801800
006256DE    mov dword ptr ss:[ebp-0x11C], eax
006256E4    jmp 0x00625717
006256E6    push 0x00
006256E8    mov edx, esi
006256EA    lea ecx, ss:[ebp-0x11C]
006256F0    call 0x0063D5E0
...
0062578C    call 0x0064C080
00625791    mov ecx, dword ptr ss:[ebp-0x0C]
00625794    mov dword ptr fs:[0x00000000], ecx
0062579B    pop ecx
0062579C    pop edi
0062579D    pop esi
0062579E    pop ebx
...
006257C3    call 0x0063B870
006257C8    add esp, 0x0C
006257CB    call 0x0063BC30
006257D0    test al, al
006257D2    jz 0x006257D5
006257D4    int3
006257D5    call 0x0063BB00
