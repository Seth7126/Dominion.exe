...
004AC125    push 0x7626C0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?GetResourceForNewSubscription@SchedulerProxy@details@Concurrency@@QAEPAVExecutionResource@23@PAV423@@Z ]
004AC12A    mov eax, dword ptr fs:[0x00000000]
004AC130    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004AC13E    push eax                                        ; => [ Data: __security_cookie ]
004AC13F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004AC142    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004AC183    jz 0x004AC1B3                                   ; => [ Data: data_cf65bc ]
...
004AC194    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004AC1A7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AC1AC    mov dword ptr ds:[ebx+0x10], 0x801800           ; => [ Data: data_801800 ]
004AC1B3    mov edx, 0x20
004AC1B8    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004AC1BF    mov ecx, ebx
004AC1C1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004AC1FB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004AC200    mov dword ptr ds:[ebx], 0x00
004AC206    mov ecx, dword ptr ss:[ebp-0x0C]
004AC209    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004AC210    pop ecx
004AC211    pop edi
004AC212    pop esi
004AC213    pop ebx
