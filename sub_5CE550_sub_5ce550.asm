...
005CE559    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005CE579    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
005CE57E    add esp, 0x08
005CE581    test eax, eax
005CE583    jz 0x005CE58C
005CE585    mov ecx, eax
005CE587    call 0x005CB5A0                                 ; => [ Call: sub_5cb5a0 ]
005CE58C    mov ecx, 0xB809E0
005CE591    call 0x00637730                                 ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
005CE5C2    push 0x86F7B4                                   ; => [ String: DomCreatePile_Board ]
005CE5C7    push 0x117E
005CE5CC    mov ecx, 0x86F7C8                               ; => [ String: where != CW_PLAYER_AREA ]
...
005CE5EE    push 0x00
005CE5F0    push eax
005CE5F1    call 0x00761FC4                                 ; => [ Call: memset ]
...
005CE67D    call 0x005CB630                                 ; => [ Call: sub_5cb630 ]
...
005CE68B    pop ebx
005CE68C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005CE691    mov esp, ebp
005CE693    pop ebp
005CE694    ret
005CE695    push 0x86F4EC                                   ; => [ String: DomLocSet ]
005CE69A    push 0xA6D
005CE69F    mov ecx, 0x817824                               ; => [ String: where != CW_NONE ]
005CE6A4    push 0x86F1E8
005CE6A9    mov edx, 0x801800
005CE6AE    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 ]
005CE6B3    add esp, 0x0C
005CE6B6    call 0x0063BC30
005CE6BB    test al, al
005CE6BD    jz 0x005CE6C0                                   ; => [ Call: sub_63bc30 ]
005CE6BF    int3
005CE6C0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
