...
00772DFF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00772E04    mov ecx, dword ptr ds:[edx-0x08]
00772E07    xor ecx, eax
00772E09    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00772E0E    mov eax, 0x8BFCE0
00772E13    jmp 0x00761FA6                                  ; => [ Call: __CxxFrameHandler3 | Data: data_8bfce0 ]
