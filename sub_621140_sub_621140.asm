...
00621150    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00621151    push ecx
00621152    push ebx
00621153    push esi
00621154    push edi
...
0062115C    push eax                                        ; => [ Data: __security_cookie ]
0062115D    lea eax, ss:[ebp-0x0C]
00621160    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00621166    mov edx, 0x802BCC
0062116B    lea ecx, ss:[ebp-0x10]
0062116E    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
00621173    mov edi, dword ptr ss:[ebp+0x08]
00621176    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0062117B    mov eax, dword ptr ss:[ebp-0x10]
0062117E    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
006211D4    jz 0x006211F1                                   ; => [ Data: data_cf65bc ]
006211D6    lea ecx, ss:[ebp-0x10]
006211D9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062125E    jz 0x0062127B                                   ; => [ Data: data_cf65bc ]
00621260    lea ecx, ss:[ebp-0x10]
00621263    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006212EC    jz 0x00621309                                   ; => [ Data: data_cf65bc ]
006212EE    lea ecx, ss:[ebp-0x10]
006212F1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621304    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00621320    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
00621325    cmp byte ptr ds:[eax+0x4240], 0x00
0062132C    setz cl
0062132F    mov byte ptr ds:[eax+0x4240], cl
00621335    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
0062133B    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 ]
00621340    xor al, al
00621342    mov ecx, dword ptr ss:[ebp-0x0C]
00621345    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0062134C    pop ecx
0062134D    pop edi
0062134E    pop esi
0062134F    pop ebx
