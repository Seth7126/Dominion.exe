...
004C89A9    mov eax, dword ptr ds:[0x008C4040]
004C89AE    xor eax, ebp
004C89B0    mov dword ptr ss:[ebp-0x04], eax
004C89B3    mov eax, dword ptr ds:[0x00CC8DC0]
004C89B8    push esi
...
004C8AA1    call 0x0063B870
004C8AA6    add esp, 0x0C
004C8AA9    call 0x0063BC30
004C8AAE    test al, al
004C8AB0    jz 0x004C8AB3
004C8AB2    int3
004C8AB3    call 0x0063BB00
