...
004DF835    push 0x763F9E                                   ; => [ Call: __ehhandler$??0ResourceManager@details@Concurrency@@AAE@XZ | Type: EHRegistrationNode ]
004DF83A    mov eax, dword ptr fs:[0x00000000]
004DF840    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004DF84E    push eax                                        ; => [ Data: __security_cookie ]
004DF84F    lea eax, ss:[ebp-0x0C]
004DF852    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004DF858    mov edi, edx
004DF85A    mov ebx, ecx
004DF85C    mov dword ptr ss:[ebp-0x18], ebx
004DF85F    mov dword ptr ss:[ebp-0x14], 0x00
004DF866    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
004DF890    call 0x004DF630                                 ; => [ Call: nullptr | Call: sub_4df630 ]
004DF895    inc esi
...
004DF8B7    call 0x004DF630                                 ; => [ Call: sub_4df630 ]
...
004DF8D3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DF8DA    pop ecx
004DF8DB    pop edi
004DF8DC    pop esi
004DF8DD    pop ebx
