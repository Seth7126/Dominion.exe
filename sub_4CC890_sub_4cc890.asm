...
004CC895    push 0x76334E                                   ; => [ Call: __ehhandler$?_Getfmt@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@IBE?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AAVios_base@2@AAHPAUtm@@PBD@Z | Type: EHRegistrationNode ]
004CC89A    mov eax, dword ptr fs:[0x00000000]
004CC8A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004CC8A1    sub esp, 0x14
004CC8A4    push esi
004CC8A5    push edi
004CC8A6    mov eax, dword ptr ds:[0x008C4040]
004CC8AB    xor eax, ebp
004CC8AD    push eax                                        ; => [ Data: __security_cookie ]
004CC8AE    lea eax, ss:[ebp-0x0C]
004CC8B1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004CC8B7    mov esi, edx
004CC8B9    mov edi, ecx
004CC8BB    mov dword ptr ss:[ebp-0x18], 0x00
004CC8C2    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CC8C7    movss xmm3, dword ptr ds:[0x00890E18]
004CC8CF    mov edx, 0x8DC518
004CC8D4    push 0x00
004CC8D6    push 0xFFFFFFFF
004CC8D8    mov ecx, eax
004CC8DA    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc518 ]
...
004CC8F1    push eax
004CC8F2    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
004CC90B    push eax
004CC90C    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
004CC936    call 0x004D4980                                 ; => [ String: dom_ui_store_bundle_owned_expansions | Call: sub_4d4980 ]
...
004CC950    jz 0x004CC980                                   ; => [ Data: data_cf65bc ]
...
004CC961    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CC974    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CC979    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004CC980    mov byte ptr ss:[ebp-0x04], 0x04
004CC984    cmp dword ptr ds:[0x00CF65BC], 0x00
004CC98B    jz 0x004CC9BB                                   ; => [ Data: data_cf65bc ]
...
004CC99C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CC9AF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CC9B4    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
004CC9F3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CCA06    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CCA0B    mov ecx, dword ptr ss:[ebp-0x0C]
004CCA0E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CCA15    pop ecx
004CCA16    pop edi
004CCA17    pop esi
