...
0061B8F6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0061B8FB    xor eax, ebp
0061B8FD    mov dword ptr ss:[ebp-0x08], eax
0061B900    push esi
0061B901    push edi
0061B902    mov esi, ecx
0061B904    mov byte ptr ds:[0x00C23BF8], 0x01              ; => [ Data: data_c23bf8 ]
0061B90B    call 0x005DDDA0                                 ; => [ Call: sub_5ddda0 ]
...
0061B995    call 0x005DE520                                 ; => [ Call: sub_5de520 ]
...
0061B9B5    call 0x005CB6E0                                 ; => [ Call: sub_5cb6e0 ]
0061B9BA    mov eax, dword ptr ds:[0x00B80B08]              ; => [ Data: data_b80b08 ]
...
0061B9D6    mov dword ptr ds:[0x00B7FCF0], eax              ; => [ Data: data_b7fcf0 ]
0061B9DB    mov ecx, dword ptr ss:[ebp-0x08]
0061B9DE    pop edi
0061B9DF    xor ecx, ebp
0061B9E1    pop esi
0061B9E2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
