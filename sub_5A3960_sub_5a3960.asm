...
005A3A4E    mov dword ptr ds:[0x00B4A61C], eax
...
005A3A69    pop ecx
005A3A6A    ret
005A3A6B    push 0x8257C0
005A3A70    push 0x6D
005A3A72    mov ecx, 0x802748
005A3A77    push 0x80193C
005A3A7C    mov edx, 0x801800
005A3A81    call 0x0063B870
005A3A86    add esp, 0x0C
005A3A89    call 0x0063BC30
005A3A8E    test al, al
005A3A90    jz 0x005A3A93
005A3A92    int3
005A3A93    call 0x0063BB00
