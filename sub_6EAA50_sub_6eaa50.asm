...
006EAA55    push 0x77176D                                   ; => [ Call: __ehhandler$??$__acrt_lowio_lock_fh_and_call@V<lambda_66567acadc90904ea62d5b5218c83326>@@@@YAHH$$QAV<lambda_66567acadc90904ea62d5b5218c83326>@@@Z | Type: EHRegistrationNode ]
006EAA5A    mov eax, dword ptr fs:[0x00000000]
006EAA60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006EAA6E    push eax                                        ; => [ Data: __security_cookie ]
006EAA6F    lea eax, ss:[ebp-0x0C]
006EAA72    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006EAA78    mov edi, ecx
006EAA7A    mov edx, dword ptr ds:[edi]
006EAA7C    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
006EAA81    mov esi, dword ptr ss:[ebp+0x08]
006EAA84    test edx, edx
006EAA86    mov eax, ebx                                    ; => [ Data: data_801800 ]
...
006EAAAF    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
006EAAB6    test edx, edx
006EAAB8    mov dword ptr ss:[ebp-0x04], 0x00
006EAABF    mov eax, ebx                                    ; => [ Data: data_801800 ]
006EAAC1    lea ecx, ss:[ebp+0x08]
006EAAC4    cmovnz eax, edx
006EAAC7    push esi
006EAAC8    push eax
006EAAC9    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006EAACE    mov ecx, edi
006EAAD0    call 0x006EA9D0
006EAAD5    dec eax                                         ; => [ Call: sub_6ea9d0 ]
006EAAD6    cmp eax, 0x07
006EAAD9    jnbe 0x006EACA8
006EAADF    movzx eax, byte ptr ds:[eax+0x6EAD10]           ; => [ Data: lookup_table_6ead10 ]
...
006EAB08    push ecx
006EAB09    call 0x006417E0                                 ; => [ Call: sub_6417e0 ]
...
006EAB20    call 0x006B43A0                                 ; => [ Call: sub_6b43a0 ]
...
006EAB5C    jz 0x006EAB7E                                   ; => [ Data: data_cf65bc ]
006EAB5E    lea ecx, ss:[ebp+0x08]
006EAB61    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EAB74    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EAB79    movss xmm0, dword ptr ss:[ebp-0x10]
006EAB7E    mov ecx, dword ptr ss:[ebp-0x0C]
006EAB81    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006EAB88    pop ecx
006EAB89    pop edi
006EAB8A    pop esi
006EAB8B    pop ebx
...
006EAB94    mov edx, ebx                                    ; => [ Data: data_801800 ]
...
006EABBC    mulss xmm0, dword ptr ss:[ebp-0x10]             ; => [ Call: sub_6417e0 ]
...
006EABD8    mulss xmm0, dword ptr ds:[edi+0x48]             ; => [ Call: sub_6b43a0 ]
...
006EABFD    push ecx
006EABFE    call 0x006417E0                                 ; => [ Call: sub_6417e0 ]
...
006EAC15    call 0x006B43A0                                 ; => [ Call: sub_6b43a0 ]
...
006EAC6F    jz 0x006EAC91                                   ; => [ Data: data_cf65bc ]
006EAC71    lea ecx, ss:[ebp+0x08]
006EAC74    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EAC87    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EAC8C    movss xmm1, dword ptr ss:[ebp-0x10]
006EAC91    movaps xmm0, xmm1
006EAC94    mov ecx, dword ptr ss:[ebp-0x0C]
006EAC97    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006EAC9E    pop ecx
006EAC9F    pop edi
006EACA0    pop esi
006EACA1    pop ebx
...
006EACBE    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\UITextBox.cpp | String: UITextBox::GetCharacterX | String: Halt ]
006EACC3    add esp, 0x0C
006EACC6    call 0x0063BC30
006EACCB    test al, al
006EACCD    jz 0x006EACD0                                   ; => [ Call: sub_63bc30 ]
006EACCF    int3
006EACD0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006EACD5    push 0x882A74
006EACDA    push 0x2B1
006EACDF    push 0x882988
006EACE4    mov edx, ebx
006EACE6    mov ecx, 0x882A44
006EACEB    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: !Xutf8_is_invalid_lead_char(mText + charIndex) | String: C:\x\ax2017\Engine\UITextBox.cpp | String: UITextBox::GetCharacterX ]
006EACF0    add esp, 0x0C
006EACF3    call 0x0063BC30
006EACF8    test al, al
006EACFA    jz 0x006EACFD                                   ; => [ Call: sub_63bc30 ]
006EACFC    int3
006EACFD    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
