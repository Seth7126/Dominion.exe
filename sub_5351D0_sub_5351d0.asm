...
005351E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005351E1    mov eax, 0x19C8
005351E6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005351EB    mov eax, dword ptr ds:[0x008C4040]
005351F0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
005351F2    mov dword ptr ss:[ebp-0x10], eax
005351F5    push esi
005351F6    push edi
005351F7    push eax
005351F8    lea eax, ss:[ebp-0x0C]
005351FB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00535201    call 0x00573400                                 ; => [ Call: sub_573400 ]
00535206    lea ecx, ss:[ebp-0x19D4]
0053520C    push 0x04
0053520E    push ecx
0053520F    mov edx, dword ptr ds:[eax+0x0C]
00535212    mov ecx, dword ptr ds:[eax+0x04]
00535215    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0053521A    mov ecx, 0x321
0053521F    mov dword ptr ss:[ebp-0xD54], eax
00535225    lea esi, ss:[ebp-0x19D4]
0053522B    mov dword ptr ss:[ebp-0xD20], 0x819B48          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_93c529755b426a103f858f84bde6bd23>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_93c529755b426a103f858f84bde6bd23>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00535235    lea edi, ss:[ebp-0xCF4]
0053523B    add esp, 0x08
0053523E    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00535240    lea ecx, ss:[ebp-0xD20]
00535246    mov dword ptr ss:[ebp-0xCFC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_93c529755b426a103f858f84bde6bd23>,bool,enum CardID>::VTable ]
...
005352BC    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_93c529755b426a103f858f84bde6bd23>,bool,enum CardID>::VTable ]
005352BF    push eax
005352C0    call edx                                        ; => [ Field: vFunc_4 ]
...
005352DE    movlpd qword ptr ss:[ebp-0x28], xmm0            ; => [ Call: nullptr | Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_34c4f8dfa9b29bc3cd955b45309ee974>, void>::VTable ]
...
0053530D    mov dword ptr ss:[ebp-0x4C], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_34c4f8dfa9b29bc3cd955b45309ee974>, void>::VTable ]
00535310    lea eax, ss:[ebp-0x40]
00535313    movups xmm0, xmmword ptr ss:[ebp-0x30]
00535317    mov dword ptr ss:[ebp-0x70], 0x819B2C           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_34c4f8dfa9b29bc3cd955b45309ee974>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
00535337    mov dword ptr ss:[ebp-0x40], 0x819B10           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_90ef4ec242acbd541d636d82e1132ab0>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
00535375    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
0053538E    push 0x30
00535390    push eax
00535391    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
00535396    mov ecx, dword ptr ss:[ebp-0x0C]
00535399    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005353A0    pop ecx
005353A1    pop edi
005353A2    pop esi
005353A3    mov ecx, dword ptr ss:[ebp-0x10]
005353A6    xor ecx, ebp
005353A8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
