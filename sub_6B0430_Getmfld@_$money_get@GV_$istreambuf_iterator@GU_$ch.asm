// ============================================================
// 函数名称: ?_Getmfld@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@ABE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@0_NAAVios_base@2@AAY0M@G@Z
// 起始地址: 0x6b0430
...
006B0435    push 0x76FCDB                                   ; => [ Call: sub_76fcdb | Type: EHRegistrationNode ]
006B043A    mov eax, dword ptr fs:[0x00000000]
006B0440    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006B0452    push esi
006B0453    push edi
006B0454    push eax                                        ; => [ Data: __security_cookie ]
006B0455    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006B0458    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006B045E    mov esi, ecx
006B0460    cmp esi, 0x10
006B0463    jnbe 0x006B0937
006B0469    mov eax, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B046E    mov ecx, dword ptr ds:[eax+0x54]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006B0471    test ecx, ecx
006B0473    jnz 0x006B0489
006B0475    push 0x87BF90                                   ; => [ String: Dx11GetInputLayout ]
006B047A    push 0x51C
006B047F    mov ecx, 0x87BFD0                               ; => [ String: gDx11Interface->boundVertexShader ]
006B0484    jmp 0x006B0946
006B0489    xor edx, edx
006B048B    call 0x006D8ED0                                 ; => [ Call: sub_6d8ed0 ]
...
006B04A2    add eax, 0x204                                  ; => [ Call: sub_6b2ec0 | Data: data_147b078 ]
006B04A7    mov dword ptr ss:[ebp-0x1F0], eax
006B04AD    mov eax, dword ptr ds:[eax]
006B04AF    test eax, eax
006B04B1    jnz 0x006B0917
006B04B7    mov eax, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B04BC    mov ecx, dword ptr ds:[eax+0x54]
006B04BF    cmp dword ptr ds:[ecx+0x04], 0x04
006B04C3    jz 0x006B04DE
006B04C5    push 0x880BB4                                   ; => [ String: ShaderGetDef ]
006B04CA    push 0x8A
006B04CF    push 0x880B94                                   ; => [ String: C:\x\ax2017\Engine\Shader.cpp ]
006B04D4    mov ecx, 0x880BC4                               ; => [ String: assetPtr->assetType == ASSET_TYPE_SHADER ]
006B04D9    jmp 0x006B094B
006B04DE    call 0x005AF880
006B04E3    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_5af880 ]
...
006B0502    call 0x00731EA0                                 ; => [ Call: sub_731ea0 ]
006B0507    xor bh, bh
...
006B0717    push esi
006B0718    mov eax, dword ptr ds:[eax+0x04]                ; => [ Data: data_147b078 ]
006B071B    push ebx
...
006B0737    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006B073C    mov eax, dword ptr ds:[eax+0x54]
006B073F    mov eax, dword ptr ds:[eax+0x20]                ; => [ Data: data_147b078 ]
006B0742    test eax, eax
006B0744    cmovnz ecx, eax
006B0747    push ecx
006B0748    push 0x87C084
006B074D    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: dx11 CreateInputLayout failed on %s ]
006B0752    add esp, 0x08
006B0755    mov dword ptr ss:[ebp-0x1D8], 0x00              ; => [ Call: nullptr ]
006B075F    lea eax, ss:[ebp-0x1D8]
006B0765    push eax
006B0766    push 0x77E8C4
006B076B    push ebx
006B076C    push dword ptr ss:[ebp-0x1EC]
006B0772    call dword ptr ds:[0x0077502C]                  ; => [ Type: HRESULT | Data: data_77e8c4 ]
006B0778    test eax, eax
006B077A    js 0x006B0967
006B0780    jmp 0x006B07D6
006B0782    push 0x87BF90                                   ; => [ String: Dx11GetInputLayout ]
006B0787    push 0x5AE
006B078C    mov ecx, 0x87C0A8                               ; => [ String: element < MAX_DESC_ELEMENTS - 1 ]
...
006B07AC    jz 0x006B07C2                                   ; => [ Data: data_177760c | Data: data_1777610 | Data: data_1777614 ]
006B07AE    push 0x87BF90                                   ; => [ String: Dx11GetInputLayout ]
006B07B3    push 0x5AA
006B07B8    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006B07BD    jmp 0x006B0946
006B07C2    push 0x87BF90                                   ; => [ String: Dx11GetInputLayout ]
006B07C7    push 0x5A6
006B07CC    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
006B07E9    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006B07EE    mov dword ptr ss:[ebp-0x1E0], esi               ; => [ Data: data_801800 ]
...
006B0850    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006B0855    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: %s%d ]
006B0857    test eax, eax
006B0859    cmovnz ecx, eax
006B085C    push ecx
006B085D    lea ecx, ss:[ebp-0x1E0]
006B0863    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006B0868    mov byte ptr ss:[ebp-0x04], 0x02
006B086C    cmp dword ptr ds:[0x00CF65BC], 0x00
006B0873    jz 0x006B08AC                                   ; => [ Data: data_cf65bc ]
...
006B088A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B089D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B08A2    mov dword ptr ss:[ebp-0x1DC], 0x801800          ; => [ Data: data_801800 ]
006B08AC    inc edi
...
006B08C7    mov eax, 0x801800                               ; => [ Data: data_801800 ]
006B08CC    jmp 0x006B08D0
006B08CE    mov eax, esi
006B08D0    push eax
006B08D1    push 0x87C0C8
006B08D6    call 0x0063B5F0                                 ; => [ String: shader need params: %s | Call: sub_63b5f0 ]
...
006B08F5    jz 0x006B0915                                   ; => [ Data: data_cf65bc ]
006B08F7    lea ecx, ss:[ebp-0x1E0]
006B08FD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006B0910    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006B0915    xor eax, eax
006B0917    mov ecx, dword ptr ss:[ebp-0x0C]
006B091A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006B0921    pop ecx
006B0922    pop edi
006B0923    pop esi
006B0924    pop ebx
...
006B092A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006B092F    mov esp, ebp
006B0931    pop ebp
006B0932    ret
006B0933    mov eax, dword ptr ds:[esi]
006B0935    jmp 0x006B0917
006B0937    push 0x87BF90                                   ; => [ String: Dx11GetInputLayout ]
006B093C    push 0x51A
006B0941    mov ecx, 0x87BFF4                               ; => [ String: vertexFormat >= 0 && vertexFormat < VERTEX_FORMAT_COUNT ]
006B0946    push 0x87B990                                   ; => [ String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp ]
006B094B    mov edx, 0x801800
006B0950    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006B0955    add esp, 0x0C
006B0958    call 0x0063BC30
006B095D    test al, al
006B095F    jz 0x006B0962                                   ; => [ Call: sub_63bc30 ]
006B0961    int3
006B0962    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006B0967    push 0x87BF90
006B096C    push 0x5B9
006B0971    push 0x87B990
006B0976    mov edx, 0x801800
006B097B    mov ecx, 0x87BA34
006B0980    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SUCCEEDED(hr) | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: Dx11GetInputLayout ]
006B0985    add esp, 0x0C
006B0988    call 0x0063BC30
006B098D    test al, al
006B098F    jz 0x006B0992                                   ; => [ Call: sub_63bc30 ]
006B0991    int3
006B0992    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006B0997    push 0x87BF90
006B099C    push 0x5C4
006B09A1    push 0x87B990
006B09A6    mov edx, 0x801800
006B09AB    mov ecx, 0x87BA34
006B09B0    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SUCCEEDED(hr) | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: Dx11GetInputLayout ]
006B09B5    add esp, 0x0C
006B09B8    call 0x0063BC30
006B09BD    test al, al
006B09BF    jz 0x006B09C2                                   ; => [ Call: sub_63bc30 ]
006B09C1    int3
006B09C2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
