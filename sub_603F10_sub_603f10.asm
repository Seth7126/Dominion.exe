...
00603F15    push 0x76324D                                   ; => [ Call: __ehhandler$?_Tidy@ios_base@std@@AAEXXZ | Type: EHRegistrationNode ]
00603F1A    mov eax, dword ptr fs:[0x00000000]
00603F20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00603F2E    push eax                                        ; => [ Data: __security_cookie ]
00603F2F    lea eax, ss:[ebp-0x0C]
00603F32    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00603F38    mov edi, ecx
00603F3A    mov dword ptr ss:[ebp-0x14], edi
00603F3D    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
00603F6C    lea esi, ds:[eax+0x08]                          ; => [ Call: sub_4b9480 ]
00603F6F    mov ecx, esi
00603F71    call 0x004B9680                                 ; => [ Call: sub_4b9680 ]
00603F76    lea ecx, ss:[ebp-0x1C]
00603F79    mov edx, esi
00603F7B    push ecx
00603F7C    push eax
00603F7D    lea ecx, ss:[ebp-0x10]
00603F80    call 0x004B06C0                                 ; => [ Call: sub_4b06c0 ]
...
00603F9C    call 0x004D48C0                                 ; => [ String: [player] | String: dom_prompt_possession_prefix | Call: sub_4d48c0 ]
00603FA1    add esp, 0x10
00603FA4    mov dword ptr ss:[ebp-0x04], 0x01
00603FAB    cmp dword ptr ds:[0x00CF65BC], 0x00
00603FB2    jz 0x00603FFB                                   ; => [ Data: data_cf65bc ]
...
00603FC3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00603FD6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00603FDB    mov eax, edi
00603FDD    mov ecx, dword ptr ss:[ebp-0x0C]
00603FE0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00603FE7    pop ecx
00603FE8    pop edi
00603FE9    pop esi
00603FEA    pop ebx
...
00603FF6    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
00603FFB    mov eax, edi
00603FFD    mov ecx, dword ptr ss:[ebp-0x0C]
00604000    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00604007    pop ecx
00604008    pop edi
00604009    pop esi
0060400A    pop ebx
...
00604025    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
0060402A    add esp, 0x0C
0060402D    call 0x0063BC30
00604032    test al, al
00604034    jz 0x00604037                                   ; => [ Call: sub_63bc30 ]
00604036    int3
00604037    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
