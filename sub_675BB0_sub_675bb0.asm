...
00675BB3    mov eax, dword ptr ds:[0x00C28C58]              ; => [ Data: data_c28c58 ]
...
00675BC9    movups xmmword ptr ds:[eax], xmm0               ; => [ Data: data_7ff530 ]
00675BCC    mov esp, ebp
00675BCE    pop ebp
00675BCF    ret
00675BD0    cmp eax, 0x01
00675BD3    jnz 0x00675C30
00675BD5    mov ecx, dword ptr ds:[0x00C27C20]              ; => [ Data: data_c27c20 ]
00675BDB    test ecx, ecx
00675BDD    jnz 0x00675BF5
00675BDF    push 0x874440                                   ; => [ String: UI2DefGet ]
00675BE4    push 0xC16
00675BE9    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
00675BEE    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
00675BF3    jmp 0x00675C73
00675BF5    cmp dword ptr ds:[ecx+0x04], 0x22
00675BF9    jnz 0x00675C5F
00675BFB    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
00675C58    movups xmmword ptr ds:[eax], xmm0               ; => [ Call: sub_64c550 | Call: sub_665600 | Data: data_147abe8 | Data: data_c27c58 ]
00675C5B    mov esp, ebp
00675C5D    pop ebp
00675C5E    ret
00675C5F    push 0x874440                                   ; => [ String: UI2DefGet ]
00675C64    push 0xC17
00675C69    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00675C6E    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
00675C73    push 0x8739B4
00675C78    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: UI2DefGet | String: C:\x\ax2017\Engine\UI2.cpp ]
00675C7D    add esp, 0x0C
00675C80    call 0x0063BC30
00675C85    test al, al
00675C87    jz 0x00675C8A                                   ; => [ Call: sub_63bc30 ]
00675C89    int3
00675C8A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
