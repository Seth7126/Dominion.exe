...
004B8CC6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004B8CDD    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004B8CF8    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
...
004B8D64    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004B8D69    add esp, 0x0C
004B8D6C    call 0x0063BC30
004B8D71    test al, al
004B8D73    jz 0x004B8D76                                   ; => [ Call: sub_63bc30 ]
004B8D75    int3
004B8D76    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
