...
00628190    mov dword ptr fs:[0x00000000], eax
...
006281A4    call 0x0063D720
006281A9    mov eax, dword ptr ss:[ebp+0x08]
006281AC    mov edi, 0x801800
006281B1    test eax, eax
006281B3    mov ecx, edi
...
006281F4    jz 0x00628211
006281F6    lea ecx, ss:[ebp+0x08]
006281F9    call 0x0063D4E0
...
0062827C    jz 0x00628299
0062827E    lea ecx, ss:[ebp+0x08]
00628281    call 0x0063D4E0
...
0062830E    jz 0x0062832B
00628310    lea ecx, ss:[ebp+0x08]
00628313    call 0x0063D4E0
...
00628341    mov dword ptr ds:[0x008DB660], eax
00628346    xor al, al
00628348    mov ecx, dword ptr ss:[ebp-0x0C]
0062834B    mov dword ptr fs:[0x00000000], ecx
00628352    pop ecx
00628353    pop edi
00628354    pop esi
00628355    pop ebx
