...
00503838    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
0050383D    mov eax, dword ptr fs:[0x00000000]
00503843    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00503844    push ebx
00503845    mov eax, 0x19A8
0050384A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0050384F    mov eax, dword ptr ds:[0x008C4040]
00503854    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00503856    mov dword ptr ss:[ebp-0x14], eax
00503859    push esi
0050385A    push edi
0050385B    push eax
0050385C    lea eax, ss:[ebp-0x0C]
0050385F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00503865    call 0x00573400                                 ; => [ Call: sub_573400 ]
0050386A    mov esi, eax
0050386C    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
00503871    mov edx, dword ptr ds:[esi+0x0C]
00503874    mov ecx, dword ptr ds:[esi+0x04]
00503877    push 0x02
00503879    push eax
0050387A    call 0x00594010                                 ; => [ Call: sub_594010 ]
0050387F    xor edx, edx
00503881    add esp, 0x08
00503884    lea ecx, ds:[edx-0x02]
00503887    call 0x00561F60                                 ; => [ Call: sub_561f60 ]
0050388C    call 0x00573400                                 ; => [ Call: sub_573400 ]
00503891    mov esi, eax
00503893    cmp dword ptr ds:[esi+0x40], 0x00
00503897    jnz 0x0050389E
00503899    call 0x00591930                                 ; => [ Call: sub_591930 ]
0050389E    mov eax, dword ptr ds:[esi+0x40]
005038A1    mov dword ptr ss:[ebp-0xCA8], eax
005038A7    call 0x00573400                                 ; => [ Call: sub_573400 ]
005038AC    lea ecx, ss:[ebp-0x19B8]
005038B2    push 0x04
005038B4    push ecx
005038B5    mov edx, dword ptr ds:[eax+0x0C]
005038B8    mov ecx, dword ptr ds:[eax+0x04]
005038BB    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
...
005038DA    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005038DC    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005038FE    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0050391E    call 0x00576E90                                 ; => [ Call: sub_576e90 ]
00503923    mov esi, dword ptr ss:[ebp-0xCA4]
00503929    lea eax, ss:[ebp-0xD00]
0050392F    add esp, 0x0C
00503932    mov dword ptr ss:[ebp-0xD00], 0x80A944          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_7ce5ca5ab40da0ec2d4dc68dc714695d>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_7ce5ca5ab40da0ec2d4dc68dc714695d>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0050393C    mov dword ptr ss:[ebp-0xCFC], esi
00503942    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_7ce5ca5ab40da0ec2d4dc68dc714695d>,bool,enum CardID>::VTable ]
...
00503983    call eax
00503985    mov dword ptr ds:[edi+0x24], eax                ; => [ Field: _Move ]
...
005039AF    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
005039C6    push eax
005039C7    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
005039E5    movlpd qword ptr ss:[ebp-0xCC4], xmm0           ; => [ Call: __builtin_memset ]
...
00503A77    push 0x476
00503A7C    push esi
00503A7D    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00503A82    add esp, 0x1C
00503A85    mov ecx, dword ptr ss:[ebp-0x0C]
00503A88    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00503A8F    pop ecx
00503A90    pop edi
00503A91    pop esi
00503A92    mov ecx, dword ptr ss:[ebp-0x14]
00503A95    xor ecx, ebp
00503A97    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
