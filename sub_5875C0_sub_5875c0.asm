...
005875C8    call 0x00761E50                                 ; => [ Call: __chkstk ]
005875CD    mov eax, dword ptr ds:[0x008C4040]
005875D2    xor eax, ebp
005875D4    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: __security_cookie ]
...
00587600    push edi
00587601    xor edi, edi                                    ; => [ Call: nullptr ]
00587603    mov dword ptr ss:[ebp-0x3A48], ecx
00587609    mov dword ptr ss:[ebp-0x149C], edi              ; => [ Call: nullptr ]
...
00587639    mov dword ptr ss:[ebp-0x149C], eax              ; => [ Call: sub_575c40 ]
...
00587650    push eax
00587651    call 0x0058AC40                                 ; => [ Call: sub_58ac40 ]
...
00587699    push 0x00
0058769B    push 0x00
0058769D    push 0x00                                       ; => [ Call: __builtin_memset ]
0058769F    push 0x03
...
005876AB    push esi
005876AC    setz cl
005876AF    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
...
005876F2    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
0058773C    call 0x00590CE0                                 ; => [ Call: sub_590ce0 ]
00587741    mov edx, dword ptr ss:[ebp-0x3A3C]
00587747    mov ecx, ebx
00587749    push 0x105
0058774E    push 0x3EA
00587753    mov esi, eax
00587755    call 0x00590CE0                                 ; => [ Call: sub_590ce0 ]
...
00587770    call 0x00593B10                                 ; => [ Call: sub_593b10 ]
...
00587785    call 0x00593B10                                 ; => [ Call: sub_593b10 ]
...
00587844    call 0x00587160                                 ; => [ Call: sub_587160 ]
...
00587880    inc eax                                         ; => [ Data: data_19e39a0 ]
00587881    mov dword ptr ds:[0x019E39A0], eax              ; => [ Data: data_19e39a0 ]
00587886    cmp eax, 0x01
00587889    jz 0x0058789F
0058788B    push 0x820264                                   ; => [ String: DoBuy ]
00587890    push 0x3455
00587895    mov ecx, 0x82026C                               ; => [ String: depth == 1 ]
0058789A    jmp 0x00588313
0058789F    push esi
005878A0    mov edx, ebx
005878A2    mov ecx, 0x1A22630
005878A7    call 0x004EBD20                                 ; => [ Call: sub_4ebd20 ]
005878AC    mov eax, dword ptr ds:[0x01A39B5C]              ; => [ Data: data_1a39b5c ]
005878B1    add esp, 0x04
005878B4    cmp eax, dword ptr ds:[ebx+0x1752C]
005878BA    jz 0x005878D0
005878BC    push 0x820264                                   ; => [ String: DoBuy ]
005878C1    push 0x3459
005878C6    mov ecx, 0x820278                               ; => [ String: sim.players[0].numCardsPlayedThisTurn == g.players[0].numCardsPlayedThisTurn ]
005878CB    jmp 0x00588313
005878D0    mov eax, dword ptr ds:[0x01A2401C]              ; => [ Data: data_1a2401c ]
005878D5    cmp eax, dword ptr ds:[ebx+0x19EC]
005878DB    jnz 0x00588304
005878E1    push 0x04
005878E3    mov edx, esi
005878E5    mov dword ptr ds:[0x01A23B34], 0x06             ; => [ Data: data_1a23b34 ]
005878EF    mov ecx, 0x1A22630
005878F4    call 0x00587020                                 ; => [ Call: sub_587020 ]
...
00587949    call 0x00587160                                 ; => [ Call: sub_587160 ]
...
0058796B    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
005879DC    dec dword ptr ds:[0x019E39A0]                   ; => [ Data: data_19e39a0 ]
...
005879FD    call 0x00583FC0                                 ; => [ Call: sub_583fc0 ]
...
00587A25    call 0x00583FC0                                 ; => [ Call: sub_583fc0 ]
...
00587A39    push 0x00
00587A3B    push 0x29
00587A3D    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
00587A60    add ecx, eax                                    ; => [ Call: sub_583fc0 ]
...
00587AF7    call 0x00586AE0                                 ; => [ Call: sub_586ae0 | Call: sub_5ee870 ]
00587AFC    add esp, 0x04
00587AFF    mov edx, esi
00587B01    mov ecx, ebx
00587B03    push eax
00587B04    call 0x00574780                                 ; => [ Call: sub_574780 ]
...
00587B28    jnle 0x005882C1                                 ; => [ Call: sub_583fc0 ]
00587B2E    xor al, al
00587B30    pop edi
00587B31    pop esi
00587B32    pop ebx
...
00587B38    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00587BB5    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00587C0E    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00587C4A    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00587C4C    push 0x00
...
00587C7C    call 0x005874F0                                 ; => [ Call: sub_5874f0 ]
00587C81    xor ecx, ecx                                    ; => [ Call: nullptr ]
...
00587D33    mov dword ptr ss:[ebp-0x3A80], 0x00             ; => [ Call: __builtin_memset ]
...
00587D93    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00587DCF    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00587E58    call 0x00623300                                 ; => [ Call: sub_623300 ]
...
00587E6D    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00587E8D    push 0x820264                                   ; => [ String: DoBuy ]
00587E92    push 0x34F4
00587E97    mov ecx, 0x8202E0                               ; => [ String: g.yld.choice != CHOICE_NUMBER ]
...
00587F0B    push 0x00
00587F0D    push 0x00
00587F0F    push 0x00                                       ; => [ Call: __builtin_memset ]
00587F11    push 0x03
...
00587F1D    push edi
00587F1E    setz cl
00587F21    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
...
00587F3D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00587F50    call 0x00586650                                 ; => [ Call: sub_586650 ]
...
00587F6C    push 0x820264                                   ; => [ String: DoBuy ]
00587F71    push 0x350A
00587F76    mov ecx, 0x820300                               ; => [ String: g.yld.numChoices == 1 ]
00587F7B    jmp 0x005882E3
00587F80    push 0xC00
00587F85    mov edx, edi
00587F87    mov ecx, ebx
00587F89    call 0x00583FC0                                 ; => [ Call: sub_583fc0 ]
...
00587FB1    call 0x00583FC0                                 ; => [ Call: sub_583fc0 ]
...
00587FC1    push 0x00
00587FC3    push 0x29
00587FC5    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
00587FE2    add esi, eax                                    ; => [ Call: sub_583fc0 ]
...
00587FFF    call 0x00575C40                                 ; => [ Call: sub_575c40 ]
...
00588030    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005880AF    call 0x00576C70                                 ; => [ Call: sub_576c70 ]
005880B4    cmp dword ptr ss:[ebp-0x3A54], 0x320
005880BE    jb 0x005880C5
005880C0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0058810C    rep movsd                                       ; => [ Call: sub_5840a0 | Call: __builtin_memcpy ]
...
00588129    push eax
0058812A    call 0x00586880                                 ; => [ Call: sub_586880 ]
...
0058814C    push 0x820264                                   ; => [ String: DoBuy ]
00588151    push 0x3513
00588156    mov ecx, 0x820300                               ; => [ String: g.yld.numChoices == 1 ]
...
00588176    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005881FE    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00588223    call 0x00586880                                 ; => [ Call: sub_586880 ]
00588228    add esp, 0x0C
0058822B    mov ecx, ebx
0058822D    call 0x00583350                                 ; => [ Call: sub_583350 ]
...
00588278    call 0x00586880                                 ; => [ Call: sub_586880 ]
...
0058828D    call 0x00587020                                 ; => [ Call: sub_587020 ]
...
005882B4    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005882CA    pop ebx
005882CB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005882D0    mov esp, ebp
005882D2    pop ebp
005882D3    ret
005882D4    push 0x820264                                   ; => [ String: DoBuy ]
005882D9    push 0x3560
005882DE    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005882E3    push 0x81F4B8
005882E8    mov edx, 0x801800
005882ED    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
005882F2    add esp, 0x0C
005882F5    call 0x0063BC30
005882FA    test al, al
005882FC    jz 0x005882FF                                   ; => [ Call: sub_63bc30 ]
005882FE    int3
005882FF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00588304    push 0x820264                                   ; => [ String: DoBuy ]
00588309    push 0x345A
0058830E    mov ecx, 0x8202C8                               ; => [ String: sim.phase == g.phase ]
00588313    push 0x81F4B8
00588318    mov edx, 0x801800
0058831D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
00588322    add esp, 0x0C
00588325    call 0x0063BC30
0058832A    test al, al
0058832C    jz 0x0058832F                                   ; => [ Call: sub_63bc30 ]
0058832E    int3
0058832F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
