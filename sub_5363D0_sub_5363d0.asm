...
005363DB    call 0x00761E50
005363E0    mov eax, dword ptr ds:[0x008C4040]
...
00536444    movlpd qword ptr ss:[esp+0x24], xmm0
...
005364A3    jnz 0x005364FC
005364A5    call 0x00573400
005364AA    push 0xC80
005364AF    mov esi, eax
005364B1    lea eax, ss:[esp+0xD08]
005364B8    push 0x00
005364BA    push eax
005364BB    call 0x00761FC4
