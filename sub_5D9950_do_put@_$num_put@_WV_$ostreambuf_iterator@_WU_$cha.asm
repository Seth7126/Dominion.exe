// ============================================================
// 函数名称: ?do_put@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MBE?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AAVios_base@2@_W_N@Z
// 起始地址: 0x5d9950
...
005D9955    push 0x769B6D                                   ; => [ Type: EHRegistrationNode | Call: sub_769b6d ]
005D995A    mov eax, dword ptr fs:[0x00000000]
005D9960    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005D9971    push esi
005D9972    push edi
005D9973    push eax                                        ; => [ Data: __security_cookie ]
005D9974    lea eax, ss:[ebp-0x0C]
005D9977    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005D997D    mov edi, dword ptr ss:[ebp+0x08]
005D9980    mov ecx, edi
005D9982    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9987    mov dword ptr ds:[eax+0x18BC], 0x5D92D0         ; => [ Call: sub_5d92d0 ]
...
005D99A6    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: sub_64f350 | Data: data_171e97c ]
...
005D99D1    mov esi, dword ptr ds:[0x00CF64A8]              ; => [ Data: data_cf64a8 ]
...
005D99F3    mov dword ptr ds:[0x00CB4514], esi              ; => [ Data: data_cb4514 ]
005D99F9    jmp 0x005D9A01
005D99FB    mov esi, dword ptr ds:[0x00CB4514]              ; => [ Data: data_cb4514 ]
005D9A01    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
005D9A06    xor ecx, ecx
005D9A08    cmp eax, 0xFFFFFFFF
005D9A0B    cmovz eax, ecx
005D9A0E    sub esi, eax
005D9A10    call 0x004B95E0
005D9A15    add eax, esi                                    ; => [ Call: sub_4b95e0 ]
...
005D9A27    jnz 0x005D9A30                                  ; => [ Data: data_8db5c4 ]
005D9A29    mov eax, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
005D9A2E    jmp 0x005D9A40
005D9A30    xor eax, eax
005D9A32    cmp dword ptr ds:[0x008DB5D4], 0x27
005D9A39    cmovz eax, dword ptr ds:[0x008DB5D8]            ; => [ Data: data_8db5d4 | Data: data_8db5d8 ]
005D9A40    push 0x870FA8
005D9A45    push eax
005D9A46    mov ecx, 0x1A8C708
005D9A4B    call 0x004BB9F0                                 ; => [ String: btn_playerAvatar | Data: data_1a8c708 | Call: sub_4bb9f0 ]
...
005D9A72    jnz 0x005D9A7C                                  ; => [ Data: data_8db5c4 ]
005D9A74    mov esi, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
005D9A7A    jmp 0x005D9A8C
005D9A7C    xor esi, esi
005D9A7E    cmp dword ptr ds:[0x008DB5D4], 0x27
005D9A85    cmovz esi, dword ptr ds:[0x008DB5D8]            ; => [ Data: data_8db5d4 | Data: data_8db5d8 ]
005D9A8C    dec eax
...
005D9AC8    jnz 0x005D9AD1                                  ; => [ String: btn_avatar | Data: data_1a8c718 | Data: data_1a8c708 | Data: data_1a8c71c | Data: data_1a8c70c | Data: data_1a8c710 | String: tbl_opponents | Data: data_1a8c714 ]
005D9ACA    mov eax, dword ptr ds:[0x01A8C728]              ; => [ Data: data_1a8c728 ]
005D9ACF    jmp 0x005D9B32
005D9AD1    push eax
005D9AD2    mov edx, 0x86FA90
005D9AD7    mov ecx, esi
005D9AD9    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
005D9ADE    add esp, 0x04
005D9AE1    mov dword ptr ds:[0x01A8C728], eax              ; => [ Data: data_1a8c728 ]
...
005D9AF9    mov dword ptr ds:[0x01A8C728], eax              ; => [ Call: sub_67bd70 | String: btn_avatar | Data: data_1a8c728 ]
005D9AFE    mov dword ptr ds:[0x01A8C708], esi              ; => [ Data: data_1a8c708 ]
005D9B04    mov dword ptr ds:[0x01A8C70C], 0x86FA90         ; => [ Data: data_1a8c70c | String: tbl_opponents ]
005D9B0E    mov dword ptr ds:[0x01A8C710], ecx              ; => [ Data: data_1a8c710 ]
005D9B14    mov dword ptr ds:[0x01A8C714], 0x870FE4         ; => [ Data: data_1a8c714 | String: btn_avatar ]
005D9B1E    mov dword ptr ds:[0x01A8C718], 0xFFFFFFFF       ; => [ Data: data_1a8c718 ]
005D9B28    mov dword ptr ds:[0x01A8C71C], 0x00             ; => [ Data: data_1a8c71c ]
005D9B32    lea ecx, ss:[ebp-0x50]
005D9B35    push ecx
005D9B36    mov ecx, eax
005D9B38    call 0x0067BE80                                 ; => [ Call: sub_67be80 ]
005D9B3D    add esp, 0x04
005D9B40    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
005D9B47    movups xmm0, xmmword ptr ds:[eax]
005D9B4A    movups xmmword ptr ss:[ebp-0x50], xmm0
005D9B4E    jnz 0x005D9B58
005D9B50    mov ecx, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
005D9B56    jmp 0x005D9B67
005D9B58    cmp dword ptr ds:[0x008DB5D4], 0x27
005D9B5F    jnz 0x005D9BA3                                  ; => [ Data: data_8db5d4 ]
005D9B61    mov ecx, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
...
005D9B88    jnz 0x005D9BA3                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
005D9B8A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D9BAA    movups xmmword ptr ss:[ebp-0x40], xmm0          ; => [ Data: data_bf21e8 | Data: data_bf21e8 | Data: data_bf21e8 ]
005D9BAE    movups xmm0, xmmword ptr ds:[0x00BF21F8]        ; => [ Data: data_bf21f8 | Data: data_bf21f8 | Data: data_bf21f8 ]
...
005D9C06    push eax
005D9C07    movups xmmword ptr ss:[ebp-0x20], xmm0          ; => [ String: 0 | String: zx ]
005D9C0B    call 0x00658160                                 ; => [ Call: sub_658160 ]
...
005D9C27    call 0x00666060                                 ; => [ Call: sub_666060 ]
005D9C2C    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
005D9C31    mov edx, dword ptr ds:[0x00CB4514]              ; => [ Data: data_cb4514 ]
005D9C37    mov dword ptr ss:[ebp-0x68], eax
005D9C3A    add eax, 0x08
005D9C3D    mov ecx, eax
005D9C3F    mov dword ptr ss:[ebp-0x70], eax
005D9C42    call 0x004B9680                                 ; => [ Call: sub_4b9680 ]
...
005D9CB6    jmp dword ptr ds:[eax*4+0x5DA018]               ; => [ Call: nullptr ]
...
005D9CD7    jz 0x005D9D3D                                   ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
005D9CD9    mov edx, dword ptr ss:[ebp-0x64]
005D9CDC    xor ecx, ecx
005D9CDE    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
005D9D07    push 0x77EB90                                   ; => [ String: GetClient ]
005D9D0C    push 0x7B
005D9D0E    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
005D9D13    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
005D9D18    jmp 0x005D9FFB
005D9D1D    cmp eax, 0x3E9
005D9D22    jz 0x005D9D3D
005D9D24    push 0x805BD4                                   ; => [ String: GameCanBlock ]
005D9D29    push 0xDB
005D9D2E    push 0x805AF8                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSave.cpp ]
005D9D33    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005D9D38    jmp 0x005D9FFB
005D9D3D    mov ecx, edi
005D9D3F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9D44    movss xmm3, dword ptr ds:[0x00890E18]
005D9D4C    mov edx, 0xBE2D28
005D9D51    push 0x00
005D9D53    push 0xFFFFFFFF
005D9D55    mov ecx, eax
005D9D57    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be2d28 ]
...
005D9D71    jnz 0x005D9EAA                                  ; => [ Data: data_cb4514 | Call: sub_4b9680 ]
...
005D9D8D    mov esi, 0xBE2D4C                               ; => [ Data: data_be2d4c ]
005D9D92    jmp 0x005D9DA7
005D9D94    mov esi, 0xBE2D58                               ; => [ Call: nullptr | Data: data_be2d58 ]
005D9D99    jmp 0x005D9DA7
005D9D9B    mov esi, 0xBE2D64                               ; => [ Data: data_be2d64 ]
005D9DA0    jmp 0x005D9DA7
005D9DA2    mov esi, 0xBE2D70                               ; => [ Data: data_be2d70 ]
005D9DA7    mov ecx, edi
005D9DA9    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9DAE    movss xmm3, dword ptr ds:[0x00890E18]
005D9DB6    mov edx, esi
005D9DB8    push 0x00
005D9DBA    push 0xFFFFFFFF
005D9DBC    mov ecx, eax
005D9DBE    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
005D9DF3    mov dword ptr ss:[ebp-0x6C], eax                ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
005D9DF6    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9DFB    movss xmm3, dword ptr ds:[0x00890E18]
005D9E03    mov edx, 0xBE2D7C
005D9E08    push 0x00
005D9E0A    push 0xFFFFFFFF
005D9E0C    mov ecx, eax
005D9E0E    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be2d7c ]
...
005D9E2C    jz 0x005D9E38                                   ; => [ Call: sub_61dad0 ]
...
005D9E51    mov dword ptr ss:[ebp-0x6C], eax                ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
005D9E54    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9E59    movss xmm3, dword ptr ds:[0x00890E18]
005D9E61    mov edx, 0xBE2D7C
005D9E66    push 0x00
005D9E68    push 0xFFFFFFFF
005D9E6A    mov ecx, eax
005D9E6C    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be2d7c ]
...
005D9E8A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9E8F    movss xmm3, dword ptr ds:[0x00890E18]
005D9E97    mov edx, 0xBE2D88
005D9E9C    push 0x00
005D9E9E    push 0xFFFFFFFF
005D9EA0    mov ecx, eax
005D9EA2    call 0x00665DB0                                 ; => [ Data: data_be2d94 | Call: sub_665db0 | Call: sub_665db0 | Data: data_be2da0 | Data: data_be2dac | Call: sub_665db0 | Call: sub_665db0 | Data: data_be2d88 ]
...
005D9F2A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9F3D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005D9F42    mov ecx, dword ptr ss:[ebp-0x0C]
005D9F45    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005D9F4C    pop ecx
005D9F4D    pop edi
005D9F4E    pop esi
005D9F4F    mov ecx, dword ptr ss:[ebp-0x10]
005D9F52    xor ecx, ebp
005D9F54    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
005D9F59    mov esp, ebp
005D9F5B    pop ebp
005D9F5C    ret
005D9F5D    mov ecx, edi
005D9F5F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D9F7C    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
005D9F99    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
005D9F9E    movss xmm3, dword ptr ds:[0x00890E18]
005D9FA6    mov edx, 0xBE2DAC
005D9FAB    push 0x00
005D9FAD    push 0xFFFFFFFF
005D9FAF    jmp 0x005D9EA0
005D9FB4    push 0x870F68                                   ; => [ String: PlayerInfoFloatingUpdate ]
005D9FB9    push 0x32E6
005D9FBE    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005D9FC3    jmp 0x005D9FF6
005D9FC5    push 0x870F68                                   ; => [ String: PlayerInfoFloatingUpdate ]
005D9FCA    push 0x32C4
005D9FCF    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005D9FD4    jmp 0x005D9FF6
005D9FD6    push 0x870F68                                   ; => [ String: PlayerInfoFloatingUpdate ]
005D9FDB    push 0x3293
005D9FE0    mov ecx, 0x870FBC                               ; => [ String: seat != SEAT_LOCAL && seat != SEAT_NONE ]
005D9FE5    jmp 0x005D9FF6
005D9FE7    push 0x870F68                                   ; => [ String: PlayerInfoFloatingUpdate ]
005D9FEC    push 0x327E
005D9FF1    mov ecx, 0x870F84                               ; => [ String: RectTopLeft(taptipBoundary) == V20 ]
005D9FF6    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
005D9FFB    mov edx, 0x801800
005DA000    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005DA005    add esp, 0x0C
005DA008    call 0x0063BC30
005DA00D    test al, al
005DA00F    jz 0x005DA012                                   ; => [ Call: sub_63bc30 ]
005DA011    int3
005DA012    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
