...
004D216D    mov dword ptr fs:[0x00000000], eax
...
004D2181    call 0x0063D720
004D2186    mov eax, dword ptr ss:[ebp+0x08]
004D2189    mov ecx, 0x801800
...
004D21CF    jz 0x004D21F3
004D21D1    lea ecx, ss:[ebp+0x08]
004D21D4    call 0x0063D4E0
...
004D21E7    call 0x0064C080
004D21EC    mov dword ptr ss:[ebp+0x08], 0x801800
...
004D2208    call 0x004B50B0
004D220D    mov esi, eax
004D220F    test esi, esi
004D2211    jz 0x004D229D
004D2217    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004D2235    jnz 0x004D2250
004D2237    mov ecx, esi
004D2239    call 0x004B0E60
004D223E    xor al, al
004D2240    mov ecx, dword ptr ss:[ebp-0x0C]
004D2243    mov dword ptr fs:[0x00000000], ecx
004D224A    pop ecx
004D224B    pop esi
...
004D2259    call 0x00761FC4
004D225E    add esp, 0x0C
004D2261    mov dword ptr ds:[0x008DBF48], esi
004D2267    mov dword ptr ds:[0x008DBF38], 0x02
004D2271    mov dword ptr ds:[0x008DBF40], 0x00
004D227B    call 0x004BBDB0
004D2280    mov edx, eax
004D2282    mov ecx, 0x8DBF38
004D2287    mov dword ptr ds:[eax+0x28], 0x17
004D228E    call 0x0062B4E0
004D2293    mov dword ptr ds:[0x008DB660], 0x10
004D229D    xor al, al
004D229F    mov ecx, dword ptr ss:[ebp-0x0C]
004D22A2    mov dword ptr fs:[0x00000000], ecx
004D22A9    pop ecx
004D22AA    pop esi
...
004D22C5    call 0x0063B870
004D22CA    add esp, 0x0C
004D22CD    call 0x0063BC30
004D22D2    test al, al
004D22D4    jz 0x004D22D7
004D22D6    int3
004D22D7    call 0x0063BB00
