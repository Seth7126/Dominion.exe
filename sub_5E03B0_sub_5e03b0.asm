...
005E03B5    push 0x769E6D                                   ; => [ Type: EHRegistrationNode | Call: sub_769e6d ]
005E03BA    mov eax, dword ptr fs:[0x00000000]
005E03C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005E03CE    push eax                                        ; => [ Data: __security_cookie ]
005E03CF    lea eax, ss:[ebp-0x0C]
005E03D2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005E03D8    mov edi, edx
005E03DA    mov ebx, ecx
005E03DC    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
005E0416    push eax
005E0417    call 0x0063DF30                                 ; => [ String: dom_card_ability_%s | Call: sub_63df30 ]
...
005E0464    call 0x0063D850                                 ; => [ String: missing:%d_%s | Call: sub_63df30 | Call: sub_63d850 ]
005E0469    mov byte ptr ss:[ebp-0x04], 0x07
005E046D    cmp dword ptr ds:[0x00CF65BC], 0x00
005E0474    jz 0x005E049D                                   ; => [ Data: data_cf65bc ]
...
005E0485    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E04EF    mov ecx, esi                                    ; => [ Data: data_801800 ]
005E04F1    mov eax, dword ptr ds:[eax]                     ; => [ String: __%s | Call: sub_63df30 ]
005E04F3    test eax, eax
005E04F5    cmovnz ecx, eax
005E04F8    push ecx
005E04F9    lea ecx, ss:[ebp+0x08]
005E04FC    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
005E0501    mov byte ptr ss:[ebp-0x04], 0x09
005E0505    cmp dword ptr ds:[0x00CF65BC], 0x00
005E050C    jz 0x005E0535                                   ; => [ Data: data_cf65bc ]
...
005E051D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E0530    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E0535    mov byte ptr ss:[ebp-0x04], 0x05
005E0539    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
005E053E    mov edx, dword ptr ss:[ebp+0x08]
005E0541    mov ecx, esi                                    ; => [ Data: data_801800 ]
005E0543    test edx, edx
005E0545    cmovnz ecx, edx
005E0548    mov edx, eax
005E054A    call 0x0068C730                                 ; => [ Call: sub_68c730 | Data: data_801800 ]
...
005E0562    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
...
005E0587    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: **missing:%s** | Call: sub_63d850 ]
005E058C    mov byte ptr ss:[ebp-0x04], 0x0B
005E0590    cmp dword ptr ds:[0x00CF65BC], 0x00
005E0597    jz 0x005E05CB                                   ; => [ Data: data_cf65bc ]
...
005E05A8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E05BB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E05C0    jmp 0x005E05CB
005E05C2    push eax
005E05C3    lea ecx, ss:[ebp-0x10]
005E05C6    call 0x0063D850                                 ; => [ Call: sub_63d850 | Call: sub_63d850 ]
...
005E05DF    push eax
005E05E0    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: dom_ability_%s ]
005E05E5    add esp, 0x0C
005E05E8    mov byte ptr ss:[ebp-0x04], 0x01
005E05EC    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
005E05F1    mov edx, dword ptr ss:[ebp+0x08]
005E05F4    mov esi, 0x801800                               ; => [ Data: data_801800 ]
005E05F9    test edx, edx
005E05FB    mov ecx, esi                                    ; => [ Data: data_801800 ]
005E05FD    cmovnz ecx, edx
005E0600    mov edx, eax
005E0602    call 0x0068C730                                 ; => [ Call: sub_68c730 | Data: data_801800 ]
005E0607    test eax, eax
005E0609    jnz 0x005E0680
005E060B    mov eax, dword ptr ss:[ebp+0x08]
005E060E    mov ecx, esi                                    ; => [ Data: data_801800 ]
005E0610    test eax, eax
005E0612    mov edx, 0x01
005E0617    cmovnz ecx, eax
005E061A    call 0x0068C730                                 ; => [ Call: sub_68c730 | Data: data_801800 ]
...
005E0645    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: **missing:%s** | Call: sub_63d850 ]
005E064A    mov byte ptr ss:[ebp-0x04], 0x03
005E064E    cmp dword ptr ds:[0x00CF65BC], 0x00
005E0655    jz 0x005E0689                                   ; => [ Data: data_cf65bc ]
...
005E0666    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E0679    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E067E    jmp 0x005E0689
005E0680    push eax
005E0681    lea ecx, ss:[ebp-0x10]
005E0684    call 0x0063D850                                 ; => [ Call: sub_63d850 | Call: sub_63d850 ]
005E0689    mov byte ptr ss:[ebp-0x04], 0x04
005E068D    cmp dword ptr ds:[0x00CF65BC], 0x00
005E0694    jz 0x005E06BD                                   ; => [ Data: data_cf65bc ]
...
005E06A5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E06B8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005E06F5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E0708    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E070D    mov ecx, dword ptr ss:[ebp-0x0C]
005E0710    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E0717    pop ecx
005E0718    pop edi
005E0719    pop esi
005E071A    pop ebx
