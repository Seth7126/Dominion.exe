...
006DCFFF    call 0x006DD320
006DD004    cmp dword ptr ds:[eax+0x10], 0x0A
006DD008    jz 0x006DD01B
006DD00A    push 0x8813CC
006DD00F    push 0x195
006DD014    mov ecx, 0x8813E0
...
006DD05D    pop ebp
006DD05E    ret
006DD05F    push 0x88131C
006DD064    push 0x8B
006DD069    mov ecx, 0x881344
006DD06E    push 0x8812F8
006DD073    mov edx, 0x801800
006DD078    call 0x0063B870
006DD07D    add esp, 0x0C
006DD080    call 0x0063BC30
006DD085    test al, al
006DD087    jz 0x006DD08A
006DD089    int3
006DD08A    call 0x0063BB00
