...
00694966    call 0x0069C520                                 ; => [ Call: sub_69c520 ]
...
0069498C    push 0x87943C                                   ; => [ String: DefinitionGetSize ]
00694991    push 0x6D
00694993    push 0x879400                                   ; => [ String: C:\x\ax2017\Engine\Definition.cpp ]
00694998    mov ecx, 0x87948C                               ; => [ String: pDefMap->definitionSize != 0 ]
0069499D    jmp 0x00694A44
006949A2    mov dword ptr ss:[ebp-0x04], 0x00               ; => [ Call: nullptr ]
...
00694A0B    call 0x00694DA0                                 ; => [ Call: sub_694da0 ]
...
00694A2E    pop ebp
00694A2F    ret
00694A30    push 0x878980                                   ; => [ String: DefBinSerializeArray ]
00694A35    push 0x1AA
00694A3A    push 0x878868                                   ; => [ String: C:\x\ax2017\Engine\DefBin.cpp ]
00694A3F    mov ecx, 0x878958                               ; => [ String: !DefTypeIsBuiltIn(pField->pSubDefMap) ]
00694A44    mov edx, 0x801800
00694A49    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00694A4E    add esp, 0x0C
00694A51    call 0x0063BC30
00694A56    test al, al
00694A58    jz 0x00694A5B                                   ; => [ Call: sub_63bc30 ]
00694A5A    int3
00694A5B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
