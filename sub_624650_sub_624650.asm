...
00624656    test al, al
00624658    jz 0x006246F1
0062465E    cmp byte ptr ds:[0x00B824DC], 0x00
00624665    jnz 0x006246A9
00624667    call 0x004B9480
...
006246A2    mov eax, dword ptr ds:[0x00CC8D5C]
006246A7    jmp 0x006246D3
006246A9    call 0x004B9480
006246AE    mov eax, dword ptr ds:[0x00CC8D5C]
006246B3    test eax, eax
006246B5    jnz 0x006246CA
006246B7    push 0x77EB90
006246BC    push 0x7B
006246BE    push 0x77EB50
006246C3    mov ecx, 0x77EB9C
...
006246F3    pop esi
006246F4    ret
006246F5    push 0x871028
006246FA    push 0x33B6
006246FF    push 0x86F1E8
00624704    mov ecx, 0x871038
00624709    mov edx, 0x801800
0062470E    call 0x0063B870
00624713    add esp, 0x0C
00624716    call 0x0063BC30
0062471B    test al, al
0062471D    jz 0x00624720
0062471F    int3
00624720    call 0x0063BB00
