...
0074DC36    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0074DC58    mov eax, dword ptr ds:[edx+0x14]                ; => [ Type: HWND ]
0074DC5B    mov dword ptr ss:[ebp+0x0C], edi
0074DC5E    movups xmmword ptr ss:[ebp-0x14], xmm0          ; => [ Type: SYSTEMTIME | Call: __builtin_memset ]
0074DC62    cmp eax, 0x0A
0074DC65    jnz 0x0074DCFC
0074DC6B    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074DC87    mov dword ptr ds:[esi+0x1C], eax                ; => [ Call: sub_74c590 ]
0074DC8A    add esp, 0x08
0074DC8D    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074DCA9    call dword ptr ds:[0x00775304]                  ; => [ Type: va_list ]
0074DCAF    lea eax, ss:[ebp-0x14]
0074DCB2    push eax                                        ; => [ Type: SYSTEMTIME ]
0074DCB3    lea eax, ss:[ebp-0x0E]
0074DCB6    push eax                                        ; => [ Field: wDay ]
0074DCB7    lea eax, ss:[ebp-0x12]
0074DCBA    push eax                                        ; => [ Field: wMonth ]
0074DCBB    mov eax, dword ptr ss:[ebp-0x1C]
0074DCBE    push 0x8901E4
0074DCC3    push dword ptr ds:[eax+0x10]
0074DCC6    call 0x0064B6D0                                 ; => [ String: %hd/%hd/%hd | Call: sub_64b6d0 ]
...
0074DCE1    call dword ptr ds:[0x00775308]                  ; => [ Data: data_19e2778 ]
0074DCE7    mov eax, dword ptr ds:[0x019E2778]
0074DCEC    push 0x05
0074DCEE    push dword ptr ds:[eax+0x1C]
0074DCF1    call dword ptr ds:[0x007752BC]                  ; => [ Data: data_19e2778 ]
0074DCF7    jmp 0x0074DF06
0074DCFC    cmp eax, 0x0B
0074DCFF    jnz 0x0074DDA8
0074DD05    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 | Type: HINSTANCE ]
...
0074DD21    mov dword ptr ds:[esi+0x1C], eax                ; => [ Call: sub_74c590 ]
0074DD24    add esp, 0x08
0074DD27    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074DD87    jnz 0x0074DCCE                                  ; => [ Data: data_890204 ]
0074DD8D    mov ax, word ptr ss:[ebp-0x0C]                  ; => [ Field: wHour ]
0074DD91    cmp ax, 0x0C
0074DD95    jz 0x0074DCCE
0074DD9B    add ax, 0x0C
0074DD9F    mov word ptr ss:[ebp-0x0C], ax                  ; => [ Field: wHour ]
0074DDA3    jmp 0x0074DCCE
0074DDA8    cmp eax, 0x0C
0074DDAB    jnz 0x0074DF14
0074DDB1    movups xmm1, xmmword ptr ss:[ebp+0x08]
0074DDB5    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074DDFA    mov dword ptr ds:[esi+0x1C], eax                ; => [ Call: sub_74c590 ]
0074DDFD    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074DE1C    call edi                                        ; => [ Type: BOOL ]
0074DE1E    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 | Type: HINSTANCE ]
...
0074DE3A    mov dword ptr ds:[esi+0x20], eax                ; => [ Call: sub_74c590 ]
0074DE3D    add esp, 0x08
0074DE40    mov esi, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074DEA4    jnz 0x0074DEB8                                  ; => [ Data: data_890204 ]
0074DEA6    mov ax, word ptr ss:[ebp-0x0C]                  ; => [ Field: wHour ]
0074DEAA    cmp ax, 0x0C
0074DEAE    jz 0x0074DEB8
0074DEB0    add ax, 0x0C
0074DEB4    mov word ptr ss:[ebp-0x0C], ax                  ; => [ Field: wHour ]
...
0074DED1    call esi                                        ; => [ Data: data_19e2778 ]
