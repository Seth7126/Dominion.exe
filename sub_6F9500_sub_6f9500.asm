...
006F9505    push 0x7631ED                                   ; => [ Call: __ehhandler$??2@YAPAXIABUnothrow_t@std@@@Z | Type: EHRegistrationNode ]
006F950A    mov eax, dword ptr fs:[0x00000000]
006F9510    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006F951E    push eax                                        ; => [ Data: __security_cookie ]
006F951F    lea eax, ss:[ebp-0x0C]
006F9522    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006F9528    mov eax, dword ptr ds:[0x0147D470]              ; => [ Data: data_147d470 | Type: BOOL ]
006F952D    test eax, eax
006F952F    jz 0x006F9542
006F9531    push eax
006F9532    call dword ptr ds:[0x007752D8]
006F9538    mov dword ptr ds:[0x0147D470], 0x00             ; => [ Data: data_147d470 ]
006F9542    cmp dword ptr ds:[0x0147D46C], 0x00
006F9549    jz 0x006F99E6                                   ; => [ Data: data_147d46c ]
006F954F    mov ebx, dword ptr ds:[0x0147DED0]              ; => [ Data: data_147ded0 ]
...
006F9581    push 0xAA
006F9586    push eax
006F9587    call dword ptr ds:[0x0077533C]                  ; => [ Call: nullptr | Data: data_147d46c | Type: HWND | Call: sub_6f6590 ]
006F958D    mov ecx, eax
006F958F    mov dword ptr ds:[0x0147D470], eax              ; => [ Data: data_147d470 ]
006F9594    call 0x007504D0                                 ; => [ Type: HWND | Call: sub_7504d0 ]
006F9599    push 0x00
006F959B    mov dword ptr ss:[ebp-0x14], eax
006F959E    call dword ptr ds:[0x00775414]                  ; => [ Call: nullptr | Type: HDC ]
...
006F95BD    call dword ptr ds:[0x007752A8]                  ; => [ Call: nullptr ]
...
006F9632    call esi
006F9634    call 0x006F7F40                                 ; => [ Call: sub_6f7f40 ]
006F9639    mov ecx, dword ptr ds:[0x0147DED0]
006F963F    call 0x006F6E30                                 ; => [ Data: data_147ded0 | Call: sub_6f6e30 ]
006F9644    push 0x05
006F9646    push dword ptr ds:[0x0147D470]
006F964C    call esi                                        ; => [ Data: data_147d470 ]
...
006F9671    push 0xAA
006F9676    push eax
006F9677    call dword ptr ds:[0x0077533C]                  ; => [ Call: nullptr | Call: sub_6f6990 | Data: data_147d46c | Type: HWND ]
006F967D    mov ecx, eax
006F967F    mov dword ptr ds:[0x0147D470], eax              ; => [ Data: data_147d470 ]
006F9684    call 0x007504D0                                 ; => [ Type: HWND | Call: sub_7504d0 ]
006F9689    push 0x00
006F968B    mov dword ptr ss:[ebp-0x14], eax
006F968E    call dword ptr ds:[0x00775414]                  ; => [ Call: nullptr | Type: HDC ]
...
006F96AD    call dword ptr ds:[0x007752A8]                  ; => [ Call: nullptr ]
...
006F9722    call esi
006F9724    call 0x006F7240                                 ; => [ Call: sub_6f7240 ]
006F9729    mov ecx, dword ptr ds:[0x0147DED0]
006F972F    call 0x006F6B00                                 ; => [ Data: data_147ded0 | Call: sub_6f6b00 ]
006F9734    push 0x05
006F9736    push dword ptr ds:[0x0147D470]
006F973C    call esi                                        ; => [ Data: data_147d470 ]
...
006F9778    push 0x75
006F977A    push eax
006F977B    call dword ptr ds:[0x0077533C]                  ; => [ Call: nullptr | Call: sub_6f3550 | Data: data_147d46c | Type: HWND ]
006F9781    push 0x05
006F9783    push eax
006F9784    mov dword ptr ds:[0x0147D470], eax              ; => [ Data: data_147d470 ]
006F9789    call dword ptr ds:[0x007752BC]
006F978F    push 0x8C
006F9794    push dword ptr ds:[0x0147D470]
006F979A    call dword ptr ds:[0x007752FC]                  ; => [ Data: data_147d470 | Type: HWND ]
...
006F97AF    push 0x180
006F97B4    push esi
006F97B5    call edi                                        ; => [ String: True ]
006F97B7    push 0x88BE14
006F97BC    push 0x00
006F97BE    push 0x180
006F97C3    push esi
006F97C4    call edi                                        ; => [ String: False ]
006F97C6    push 0x91
006F97CB    push dword ptr ds:[0x0147D470]
006F97D1    call dword ptr ds:[0x007752FC]                  ; => [ Data: data_147d470 | Type: HWND ]
006F97D7    mov ecx, dword ptr ds:[0x00800ADC]              ; => [ String: Constant ]
006F97DD    mov esi, 0x800AD8                               ; => [ Data: data_800ad8 ]
006F97E2    mov dword ptr ss:[ebp-0x14], eax                ; => [ Type: HWND ]
...
006F981E    call dword ptr ds:[0x007752FC]                  ; => [ Data: data_147d470 | Type: HWND ]
006F9824    mov ecx, dword ptr ds:[0x00800B1C]              ; => [ String: Uniform ]
006F982A    mov esi, 0x800B18                               ; => [ Data: data_800b18 ]
006F982F    mov dword ptr ss:[ebp-0x14], eax                ; => [ Type: HWND ]
...
006F986B    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 | Call: sub_69ec60 ]
006F9870    add esp, 0x04
006F9873    test al, al
006F9875    jnz 0x006F9890
006F9877    push 0x879A88                                   ; => [ String: AssetCatalogReloadAsWritable ]
006F987C    push 0x149
006F9881    push 0x87982C                                   ; => [ String: C:\x\ax2017\Engine\AssetCatalog.cpp ]
006F9886    mov ecx, 0x8027A0                               ; => [ String: result ]
...
006F990D    call 0x006F2C70                                 ; => [ Call: sub_6f2c70 ]
006F9912    mov dword ptr ss:[ebp-0x04], 0x00
006F9919    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006F9957    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F996A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F996F    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006F99A0    mov dword ptr ds:[eax*8+0x147D4B4], eax         ; => [ Data: data_147d4b4 ]
006F99A7    mov byte ptr ds:[eax*8+0x147D4B8], 0x00         ; => [ Data: data_147d4b8 ]
006F99AF    inc eax
006F99B0    cmp eax, 0x100
006F99B5    jl 0x006F99A0
006F99B7    mov eax, dword ptr ds:[0x0147DED0]              ; => [ Data: data_147ded0 ]
...
006F99CB    or ecx, edx
006F99CD    call 0x006F0170                                 ; => [ Call: sub_6f0170 ]
006F99D2    jmp 0x006F99E1
006F99D4    cmp eax, 0x1B
006F99D7    jnz 0x006F99E1
006F99D9    or ecx, 0xFFFFFFFF
006F99DC    call 0x006F0970                                 ; => [ Call: sub_6f0970 ]
006F99E1    call 0x006EE5C0                                 ; => [ Call: sub_6ee5c0 | Call: sub_6ee5c0 | Call: sub_6ee5c0 ]
006F99E6    mov ecx, dword ptr ss:[ebp-0x0C]
006F99E9    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F99F0    pop ecx
006F99F1    pop edi
006F99F2    pop esi
006F99F3    pop ebx
...
006F99F6    pop ebp
006F99F7    ret
006F99F8    push 0x88B7C4                                   ; => [ String: MakeSureAllEmittersHaveNames ]
006F99FD    push 0xD9D
006F9A02    push 0x88AF54                                   ; => [ String: C:\x\ax2017\Engine\Windows\EditorWindow.cpp ]
006F9A07    mov ecx, 0x88B258                               ; => [ String: pParticleDef ]
006F9A0C    mov edx, 0x801800
006F9A11    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006F9A16    add esp, 0x0C
006F9A19    call 0x0063BC30
006F9A1E    test al, al
006F9A20    jz 0x006F9A23                                   ; => [ Call: sub_63bc30 ]
006F9A22    int3
006F9A23    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
