...
0056360B    call 0x00591930                                 ; => [ Call: sub_591930 ]
00563610    cmp esi, 0x48
00563613    jl 0x0056361A
00563615    call 0x00591930                                 ; => [ Call: sub_591930 ]
