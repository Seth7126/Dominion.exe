...
005333CB    call 0x00761E50                                 ; => [ Call: __chkstk ]
005333D0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005333EE    push 0x04
005333F0    push ecx
005333F1    mov ecx, dword ptr ds:[eax+0x40]                ; => [ Call: sub_573400 ]
005333F4    call 0x0056F370                                 ; => [ Call: sub_56f370 ]
005333F9    xorps xmm0, xmm0
005333FC    mov dword ptr ss:[esp+0x38], 0x00
00533404    add esp, 0x0C
00533407    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
0053345D    push 0x00
0053345F    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0053347A    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
00533498    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0053349B    cmp esi, 0x320
005334A1    jb 0x005334A8
005334A3    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005334F7    push 0x00
005334F9    push 0x00
005334FB    push 0x00                                       ; => [ Call: __builtin_memset ]
...
0053354C    push 0x00
0053354E    push 0x00
00533550    push 0x00                                       ; => [ Call: __builtin_memset ]
...
0053357B    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
00533580    add esp, 0x38
00533583    mov ecx, dword ptr ss:[esp+0x199C]
0053358A    pop edi
0053358B    pop esi
0053358C    xor ecx, esp
0053358E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
