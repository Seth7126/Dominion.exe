...
005529B7    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005529BA    mov dword ptr ss:[esp+0x0C], eax
005529BE    cmp esi, 0x320
005529C4    jb 0x005529CF
005529C6    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005529DF    call 0x005754F0                                 ; => [ Call: sub_5754f0 ]
...
00552A02    test al, al
00552A04    jz 0x00552A73                                   ; => [ Call: sub_568470 ]
00552A06    call 0x00573400                                 ; => [ Call: sub_573400 ]
00552A0B    mov edi, dword ptr ds:[eax+0x04]
00552A0E    cmp esi, 0x320
00552A14    jb 0x00552A1B
00552A16    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00552A33    test al, al
00552A35    jnz 0x00552A73                                  ; => [ Call: sub_5754f0 ]
00552A37    call 0x00573400                                 ; => [ Call: sub_573400 ]
00552A3C    mov edi, dword ptr ds:[eax+0x04]
00552A3F    cmp esi, 0x320
00552A45    jb 0x00552A4C
00552A47    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00552A64    test al, al
00552A66    jnz 0x00552A73                                  ; => [ Call: sub_5754f0 ]
