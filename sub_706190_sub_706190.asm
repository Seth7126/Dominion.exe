...
00706196    push ebx
00706197    push esi
00706198    mov esi, dword ptr ss:[ebp+0x08]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0070619B    mov ecx, esi
0070619D    push edi
0070619E    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
007061A3    mov ecx, dword ptr ss:[ebp+0x0C]
007061A6    mov edi, eax
007061A8    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
007061AD    mov ebx, dword ptr ds:[0x0147DED4]              ; => [ Data: data_147ded4 ]
007061B3    mov ecx, eax                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
007061B5    test edi, edi
007061B7    jnz 0x007061CA
007061B9    push 0x88D514                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayGet ]
007061BE    push 0x6C
007061C0    mov ecx, 0x802734                               ; => [ String: id != DATAID_NULL ]
...
007061DB    mov ebx, dword ptr ds:[ebx+0x424C]              ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
007061FF    push 0x88D514                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayGet ]
00706204    push 0x6C
00706206    mov ecx, 0x802734                               ; => [ String: id != DATAID_NULL ]
...
0070623C    push 0x88D394                                   ; => [ String: OpenGLInterface::ResolveMSAA ]
00706241    push 0x15FA
00706246    push 0x88C504                                   ; => [ String: C:\x\ax2017\Engine\OpenGLGraphics.cpp ]
0070624B    mov ecx, 0x88D378                               ; => [ String: bufferSource->mFrameBuffer ]
00706250    jmp 0x00706362
00706255    cmp dword ptr ds:[eax+0xE0], 0x00
0070625C    jnz 0x00706277
0070625E    push 0x88D394                                   ; => [ String: OpenGLInterface::ResolveMSAA ]
00706263    push 0x15FB
00706268    push 0x88C504                                   ; => [ String: C:\x\ax2017\Engine\OpenGLGraphics.cpp ]
0070626D    mov ecx, 0x88D3E0                               ; => [ String: bufferDest->mFrameBuffer ]
...
0070628C    push 0x86F01C                                   ; => [ String: TextureGetDef ]
00706291    push 0x89
00706296    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
0070629B    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
007062A0    jmp 0x00706362
007062A5    mov ecx, esi
007062A7    call 0x005AF880                                 ; => [ Call: sub_5af880 | Type: _EXCEPTION_REGISTRATION_RECORD ]
007062AC    mov esi, eax
007062AE    mov eax, dword ptr ss:[ebp+0x0C]
007062B1    cmp dword ptr ds:[eax+0x04], 0x03
007062B5    jz 0x007062D0
007062B7    push 0x86F01C                                   ; => [ String: TextureGetDef ]
007062BC    push 0x89
007062C1    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
007062C6    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
007062CB    jmp 0x00706362
007062D0    mov ecx, eax
007062D2    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
007062D7    mov ecx, dword ptr ds:[esi]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
007062D9    mov eax, dword ptr ds:[eax]
007062DB    mov edx, dword ptr ds:[ecx]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0070634D    pop ebp
0070634E    ret 0x08
00706351    push 0x88D514                                   ; => [ String: DataArray<struct OpenGLBufferData>::DataArrayGet ]
00706356    mov ecx, 0x802748                               ; => [ String: DataArrayTryToGet(id) != NULL ]
0070635B    push 0x6D
0070635D    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h | String: C:\x\ax2017\Engine\DataArray.h | String: C:\x\ax2017\Engine\DataArray.h ]
00706362    mov edx, 0x801800
00706367    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0070636C    add esp, 0x0C
0070636F    call 0x0063BC30
00706374    test al, al
00706376    jz 0x00706379                                   ; => [ Call: sub_63bc30 ]
00706378    int3
00706379    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
