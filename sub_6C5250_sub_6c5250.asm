...
006C5271    mov dword ptr fs:[0x00000000], eax
...
006C52C4    push 0x87E128
006C52C9    push 0x180
006C52CE    push 0x87DF78
006C52D3    mov ecx, 0x8656AC
...
006C5329    call 0x0064C080
006C532E    mov eax, edi
006C5330    mov ecx, dword ptr ss:[ebp-0x0C]
006C5333    mov dword ptr fs:[0x00000000], ecx
006C533A    pop ecx
006C533B    pop edi
006C533C    pop esi
...
006C533F    pop ebp
006C5340    ret
006C5341    push 0x871DD4
006C5346    push 0x9A
006C534B    push 0x871D5C
006C5350    mov ecx, 0x871E0C
006C5355    mov edx, 0x801800
006C535A    call 0x0063B870
006C535F    add esp, 0x0C
006C5362    call 0x0063BC30
006C5367    test al, al
006C5369    jz 0x006C536C
006C536B    int3
006C536C    call 0x0063BB00
