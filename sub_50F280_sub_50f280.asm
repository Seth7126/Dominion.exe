...
0050F289    mov edi, dword ptr ds:[0x00CC8DE4]
0050F28F    push 0x5851F42D
0050F294    push 0x4C957F2D
0050F299    push edi
0050F29A    push ebx
0050F29B    call 0x007621D0
0050F2A0    add eax, dword ptr ds:[0x00CC8DE8]
0050F2A6    mov ecx, edi
0050F2A8    mov esi, edi
0050F2AA    mov dword ptr ds:[0x00CC8DE0], eax
...
0050F2C4    mov dword ptr ds:[0x00CC8DE4], edx
