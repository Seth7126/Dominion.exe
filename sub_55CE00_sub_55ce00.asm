...
0055CEA5    mov dword ptr ss:[ebp-0xCF4], ecx
...
0055CF27    push eax
0055CF28    call dword ptr ds:[edx+0x10]
0055CF2B    mov dword ptr ss:[ebp-0xCF4], 0x00
0055CF35    xor esi, esi
...
0055CF5F    movlpd qword ptr ss:[ebp-0xCDC], xmm0
...
0055D121    push eax
0055D122    call 0x00586320
0055D127    add esp, 0x10
0055D12A    call 0x00573400
0055D12F    push 0x00
0055D131    push 0x00
0055D133    push 0x01
...
0055D13B    push 0x01
0055D13D    call 0x00590760
0055D142    add esp, 0x10
0055D145    call 0x00573400
...
0055D174    push 0x02
0055D176    call 0x00590760
0055D17B    add esp, 0x10
0055D17E    call 0x00573400
...
0055D19F    mov dword ptr fs:[0x00000000], ecx
0055D1A6    pop ecx
0055D1A7    pop edi
0055D1A8    pop esi
0055D1A9    mov ecx, dword ptr ss:[ebp-0x14]
0055D1AC    xor ecx, ebp
0055D1AE    call 0x0075927A
...
0055D1D0    call 0x0063B870
0055D1D5    add esp, 0x0C
0055D1D8    call 0x0063BC30
0055D1DD    test al, al
0055D1DF    jz 0x0055D1E2
0055D1E1    int3
0055D1E2    call 0x0063BB00
