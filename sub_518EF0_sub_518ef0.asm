...
00518F06    mov dword ptr ds:[eax], 0x816DB4                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_efab13753dd2d9714d6b0c413bdf33e9>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
00518F0C    mov dword ptr ds:[eax+0x24], eax
00518F0F    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
00518F14    mov esi, eax
00518F16    push 0x00
00518F18    push 0x00
00518F1A    mov ecx, esi
00518F1C    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
00518F21    add esp, 0x30
00518F24    test al, al
00518F26    jz 0x00518FB2
00518F2C    mov edx, 0x18
00518F31    mov ecx, esi
00518F33    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
00518F53    push 0x814808                                   ; => [ String: Theme_PileChanges ]
00518F58    push 0x2075
00518F5D    mov ecx, 0x80CEE4                               ; => [ String: !IsLandscape(what) ]
...
00518F7C    add eax, ecx                                    ; => [ Data: data_cca780 | Data: data_cca784 ]
00518F7E    nop
...
00518FB2    mov edi, dword ptr ds:[0x00CCB414]              ; => [ Data: data_ccb414 ]
...
00518FD0    mov ecx, dword ptr ds:[esi*4+0xCCA794]          ; => [ Data: data_cca794 ]
...
00518FEE    mov eax, dword ptr ds:[edx+eax*4]               ; => [ Data: data_1597e0c | Data: data_1597e10 ]
...
0051900B    xor eax, eax                                    ; => [ Call: nullptr ]
...
00519037    mov dword ptr ds:[eax], 0x81708C                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_feef0b129ef09c484028e146a8fa87fb>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
0051903D    mov dword ptr ds:[eax+0x04], 0x40
00519044    mov dword ptr ds:[eax+0x24], eax
00519047    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
...
00519065    pop ebp
00519066    ret                                             ; => [ String: out of category cards! | Call: sub_63b5f0 ]
00519067    push 0x00
00519069    push 0x02
0051906B    mov ecx, eax
0051906D    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
...
0051907A    pop ebp
0051907B    ret
0051907C    push 0x80CF1C                                   ; => [ String: CampaignAddExtra ]
00519081    push 0x242
00519086    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0051908B    push 0x80CD80
00519090    mov edx, 0x801800
00519095    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0051909A    add esp, 0x0C
0051909D    call 0x0063BC30
005190A2    test al, al
005190A4    jz 0x005190A7                                   ; => [ Call: sub_63bc30 ]
005190A6    int3
005190A7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
