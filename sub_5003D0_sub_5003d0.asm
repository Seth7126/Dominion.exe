...
005003D0    push esi
005003D1    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005003EB    call 0x00568240                                 ; => [ Call: sub_568240 ]
...
00500401    call 0x00568240                                 ; => [ Call: sub_568240 ]
...
0050042C    call 0x0063B870                                 ; => [ String: c.triggerInfo->type == TRIGGERINFO_GAIN | Call: sub_63b870 | Data: data_801800 | String: CostAtGainMoment | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00500431    add esp, 0x0C
00500434    call 0x0063BC30
00500439    test al, al
0050043B    jz 0x0050043E                                   ; => [ Call: sub_63bc30 ]
0050043D    int3
0050043E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
