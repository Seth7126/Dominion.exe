...
004DFB25    push 0x76400E                                   ; => [ Call: __ehhandler$?GetSubAllocator@SchedulerBase@details@Concurrency@@SAPAVSubAllocator@23@_N@Z | Type: EHRegistrationNode ]
004DFB2A    mov eax, dword ptr fs:[0x00000000]
004DFB30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004DFB3E    push eax                                        ; => [ Data: __security_cookie ]
004DFB3F    lea eax, ss:[ebp-0x0C]
004DFB42    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DFB5D    call 0x004DF830                                 ; => [ Call: sub_4df830 ]
...
004DFBBD    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004DFBCE    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
004DFBD3    mov ecx, dword ptr ds:[esi]
004DFBD5    mov edx, 0x807478                               ; => [ Data: data_807478 ]
...
004DFC51    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004DFC62    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
004DFC67    mov ecx, dword ptr ds:[esi]
004DFC69    mov edx, 0x807180                               ; => [ String: colonies ]
...
004DFCED    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004DFCFE    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
004DFD03    mov ecx, dword ptr ds:[esi]
004DFD05    mov edx, 0x807478                               ; => [ Data: data_807478 ]
...
004DFD7F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DFD86    pop ecx
004DFD87    pop edi
004DFD88    pop esi
004DFD89    pop ebx
...
004DFD93    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
004DFDA4    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
004DFDA9    mov ecx, dword ptr ds:[esi]
004DFDAB    mov edx, 0x80718C                               ; => [ String: shelters ]
...
004DFDE7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DFDEE    pop ecx
004DFDEF    pop edi
004DFDF0    pop esi
004DFDF1    pop ebx
