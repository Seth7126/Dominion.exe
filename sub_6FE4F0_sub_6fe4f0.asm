...
006FE50C    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006FE529    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
006FE52E    push 0x19
006FE530    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
006FE535    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
...
006FE546    pop esi
006FE547    ret
006FE548    push 0x88C350                                   ; => [ String: SoundOggReaderGetSoundData ]
006FE54D    push 0x104
006FE552    push 0x88C304                                   ; => [ String: C:\x\ax2017\Engine\SoundOgg.cpp ]
006FE557    mov ecx, 0x87736C                               ; => [ String: pSoundData ]
006FE55C    mov edx, 0x801800
006FE561    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006FE566    add esp, 0x0C
006FE569    call 0x0063BC30
006FE56E    test al, al
006FE570    jz 0x006FE573                                   ; => [ Call: sub_63bc30 ]
006FE572    int3
006FE573    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
