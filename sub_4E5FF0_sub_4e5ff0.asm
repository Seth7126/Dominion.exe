...
004E5FF5    push 0x7645CD                                   ; => [ Call: __ehhandler$?_Getcat@?$money_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@SAIPAPBVfacet@locale@2@PBV42@@Z | Type: EHRegistrationNode ]
004E5FFA    mov eax, dword ptr fs:[0x00000000]
004E6000    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E600E    push eax                                        ; => [ Data: __security_cookie ]
004E600F    lea eax, ss:[ebp-0x0C]
004E6012    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004E6018    mov edi, ecx
004E601A    push 0x280
004E601F    xor esi, esi
004E6021    push esi
004E6022    push edi
004E6023    call 0x00761FC4                                 ; => [ Call: memset ]
...
004E605A    call 0x004DC550                                 ; => [ Call: sub_4dc550 ]
004E605F    lea eax, ss:[ebp-0x4C]
004E6062    push eax
004E6063    call 0x004DC900                                 ; => [ Call: sub_4dc900 ]
...
004E6077    call 0x004E5DB0                                 ; => [ Call: sub_4e5db0 ]
...
004E60C7    call 0x004E5EE0                                 ; => [ Call: sub_4e5ee0 ]
...
004E60E7    call 0x004E5EE0                                 ; => [ Call: sub_4e5ee0 ]
...
004E60F8    push 0x2C
004E60FA    push esi
004E60FB    call 0x00761FB8                                 ; => [ Call: memchr ]
...
004E6148    mov dword ptr ds:[ebx+0x04], eax                ; => [ Call: sub_4dd260 ]
...
004E6163    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004E616A    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
004E616F    mov dword ptr ss:[ebp-0x04], 0x00
004E6176    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
004E6196    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
004E61BD    mov dword ptr ds:[ebx+0x10], eax                ; => [ Call: sub_4dd260 ]
...
004E61D7    jz 0x004E61FB                                   ; => [ Data: data_cf65bc ]
004E61D9    lea ecx, ss:[ebp-0x10]
004E61DC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E61EF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E61F4    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
004E620B    call 0x004DC8E0                                 ; => [ Call: sub_4dc8e0 ]
...
004E621F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E6226    pop ecx
004E6227    pop edi
004E6228    pop esi
004E6229    pop ebx
...
004E622C    pop ebp
004E622D    ret
004E622E    push 0x871DD4                                   ; => [ String: XString::XString ]
004E6233    push 0x9A
004E6238    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
004E623D    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
004E6242    jmp 0x004E6269
004E6244    push 0x80844C                                   ; => [ String: FromExtrasStr ]
004E6249    push 0x169F
004E624E    mov ecx, 0x808474                               ; => [ String: strCard.len ]
004E6253    jmp 0x004E6264
004E6255    push 0x80844C                                   ; => [ String: FromExtrasStr ]
004E625A    push 0x1683
004E625F    mov ecx, 0x80845C                               ; => [ String: numExtras < maxExtras ]
004E6264    push 0x806FE4                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameShared.cpp ]
004E6269    mov edx, 0x801800
004E626E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004E6273    add esp, 0x0C
004E6276    call 0x0063BC30
004E627B    test al, al
004E627D    jz 0x004E6280                                   ; => [ Call: sub_63bc30 ]
004E627F    int3
004E6280    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
