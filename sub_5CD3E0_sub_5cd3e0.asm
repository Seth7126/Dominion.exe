...
005CD3E9    mov eax, dword ptr ds:[0x008C4040]
...
005CD41F    mov edx, dword ptr ds:[0x00B809E0]
...
005CD465    push 0x86E294
005CD46A    push 0x6D
005CD46C    push 0x80193C
005CD471    mov ecx, 0x802748
005CD476    jmp 0x005CD5AD
005CD47B    push 0x86E294
005CD480    push 0x6C
005CD482    push 0x80193C
005CD487    mov ecx, 0x802734
...
005CD4B9    jnb 0x005CD465
005CD4BB    imul edi, eax, 0x1C30
005CD4C1    add edi, dword ptr ds:[0x00B809E0]
...
005CD50C    mov dword ptr ss:[ebp-0xC0], eax
...
005CD58F    pop ebx
005CD590    call 0x0075927A
005CD595    mov esp, ebp
005CD597    pop ebp
005CD598    ret
005CD599    push 0x86F634
005CD59E    push 0xCCB
005CD5A3    push 0x86F1E8
005CD5A8    mov ecx, 0x801AA4
005CD5AD    mov edx, 0x801800
005CD5B2    call 0x0063B870
005CD5B7    add esp, 0x0C
005CD5BA    call 0x0063BC30
005CD5BF    test al, al
005CD5C1    jz 0x005CD5C4
005CD5C3    int3
005CD5C4    call 0x0063BB00
