...
005C07E8    push 0x769664                                   ; => [ Type: EHRegistrationNode | Call: sub_769664 ]
005C07ED    mov eax, dword ptr fs:[0x00000000]
005C07F3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005C07F4    push ebx
...
005C0804    push eax                                        ; => [ Data: __security_cookie ]
005C0805    lea eax, ss:[ebp-0x0C]
005C0808    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005C0833    jle 0x005C111F                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005C0861    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C088A    mov dword ptr ss:[ebp-0x190], eax               ; => [ Call: sub_5bbe40 ]
...
005C08B3    mov dword ptr ss:[ebp-0x9C], eax                ; => [ Call: sub_5bbe40 ]
...
005C08E9    call 0x004ACC50                                 ; => [ Call: sub_4acc50 ]
...
005C0919    jle 0x005C0B4F                                  ; => [ Call: sub_5bbe40 ]
005C091F    nop
...
005C0936    call 0x005BC1C0                                 ; => [ Call: sub_5bc1c0 ]
...
005C096F    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C0987    call 0x005C03B0                                 ; => [ Call: sub_5c03b0 ]
...
005C09C6    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C0A7A    jnz 0x005C0A84                                  ; => [ Call: sub_5c3ca0 ]
005C0A7C    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
...
005C0A93    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C0AB5    mov dword ptr ss:[ebp-0x6C], eax                ; => [ Call: sub_5bbe40 ]
...
005C0ADB    jle 0x005C0B16                                  ; => [ Call: sub_5c3ca0 ]
...
005C0B0F    cmp esi, eax                                    ; => [ Call: sub_5c3ca0 ]
...
005C0B3E    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C0B8A    mov esi, eax                                    ; => [ Call: sub_5bbe40 | Type: _EXCEPTION_REGISTRATION_RECORD ]
005C0B8C    mov dword ptr ss:[ebp-0x8C], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
005C0B92    mov byte ptr ss:[ebp-0x04], 0x06
005C0B96    mov ecx, dword ptr ss:[ebp-0x34]
005C0B99    call 0x004ACC50                                 ; => [ Call: sub_4acc50 ]
...
005C0BAF    and eax, 0x80000003                             ; => [ Call: sub_5c7580 ]
...
005C0BCB    and ecx, 0x03                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
005C0BCE    mov dword ptr ss:[ebp-0x20], 0x00
005C0BD5    cmp ecx, esi
005C0BD7    mov eax, esi
005C0BD9    cmovl eax, ecx
005C0BDC    mov dword ptr ss:[ebp-0x24], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005C0C16    call 0x005BC1C0                                 ; => [ Call: sub_5bc1c0 ]
...
005C0C52    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C0C6A    call 0x005C03B0                                 ; => [ Call: sub_5c03b0 ]
...
005C0CA9    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C0D60    jnz 0x005C0D6A                                  ; => [ Call: sub_5c3ca0 ]
005C0D62    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
...
005C0D8A    mov dword ptr ss:[ebp-0x60], eax                ; => [ Call: sub_5bbe40 ]
005C0D8D    mov dword ptr ss:[ebp-0x2C], edx
005C0D90    mov dword ptr ss:[ebp-0x58], edx
005C0D93    call 0x005BBE40
005C0D98    mov dword ptr ss:[ebp-0x50], eax                ; => [ Call: sub_5bbe40 ]
...
005C0DBE    jle 0x005C0DF6                                  ; => [ Call: sub_5c3ca0 ]
...
005C0DEF    cmp esi, eax                                    ; => [ Call: sub_5c3ca0 ]
...
005C0E2E    mov dword ptr ss:[ebp-0x14], eax                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
005C0E31    mov edi, eax                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
005C0E33    cmp eax, edx
005C0E35    jnl 0x005C0EAB
005C0E37    mov eax, dword ptr ss:[ebp-0x3C]
005C0E3A    xorps xmm2, xmm2                                ; => [ String: 0 | String: zx ]
...
005C0EC8    push eax
005C0EC9    call 0x005BC1C0                                 ; => [ Call: sub_5bc1c0 ]
...
005C0F0A    imul eax, dword ptr ss:[ebp-0x20]               ; => [ Call: sub_5bbe40 ]
005C0F0E    mov ecx, dword ptr ds:[edi+0x04]
005C0F11    lea eax, ds:[ecx+eax*4]
005C0F14    push eax
005C0F15    lea ecx, ss:[ebp-0xD8]
005C0F1B    call 0x005C03B0                                 ; => [ Call: sub_5c03b0 ]
...
005C0F5D    call 0x005BBE40                                 ; => [ Call: sub_5bbe40 ]
...
005C1014    jnz 0x005C101E                                  ; => [ Call: sub_5c3ca0 ]
005C1016    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
...
005C1041    mov dword ptr ss:[ebp-0x60], eax                ; => [ Call: sub_5bbe40 ]
005C1044    mov dword ptr ss:[ebp-0x1C], edx
005C1047    mov dword ptr ss:[ebp-0x58], edx
005C104A    call 0x005BBE40
005C104F    mov dword ptr ss:[ebp-0x50], eax                ; => [ Call: sub_5bbe40 ]
...
005C1075    jle 0x005C10AF                                  ; => [ Call: sub_5c3ca0 ]
...
005C10A5    cmp esi, eax                                    ; => [ Call: sub_5c3ca0 ]
...
005C110E    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005C1115    pop ecx
005C1116    pop edi
005C1117    pop esi
...
005C1189    call 0x005C8250                                 ; => [ Call: sub_5c8250 ]
...
005C11C2    push edi
005C11C3    call 0x005C8250                                 ; => [ Call: sub_5c8250 ]
...
005C11DF    call 0x005C1C70                                 ; => [ Call: sub_5c1c70 ]
005C11E4    add esp, 0x08
005C11E7    mov ecx, dword ptr ss:[ebp-0x0C]
005C11EA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005C11F1    pop ecx
005C11F2    pop edi
005C11F3    pop esi
