...
006E80F0    mov dword ptr ss:[ebp-0x04], 0x00               ; => [ Call: nullptr ]
...
006E8115    push esi
006E8116    call 0x006E7DB0                                 ; => [ Call: sub_6e7db0 ]
...
006E8159    call 0x00687730                                 ; => [ Call: sub_687730 ]
006E815E    push ebx
006E815F    push 0x00
006E8161    push eax
006E8162    mov dword ptr ss:[ebp-0x04], eax
006E8165    call 0x00761FC4                                 ; => [ Call: memset ]
...
006E8184    mov dword ptr ss:[ebp-0x0C], 0x00               ; => [ Call: nullptr ]
...
006E81A3    push 0x882808                                   ; => [ String: FlanimCompressConstantInt ]
006E81A8    push 0x5F2
006E81AD    mov ecx, 0x8827C4                               ; => [ String: pMayaVertex->mFrameCount < MAXUINT16 ]
...
006E81C8    push esi
006E81C9    call 0x006E7DB0                                 ; => [ Call: sub_6e7db0 ]
...
006E8206    xor eax, eax                                    ; => [ Call: nullptr ]
006E8208    jmp 0x006E8223
006E820A    mov ecx, ebx
006E820C    call 0x00687730                                 ; => [ Call: sub_687730 ]
006E8211    push ebx
006E8212    push 0x00
006E8214    push eax
006E8215    mov dword ptr ss:[ebp-0x14], eax
006E8218    call 0x00761FC4                                 ; => [ Call: memset ]
...
006E8241    call 0x006E7DB0                                 ; => [ Call: sub_6e7db0 ]
...
006E8259    pop ebp
006E825A    ret
006E825B    push 0x882808                                   ; => [ String: FlanimCompressConstantInt ]
006E8260    push 0x601
006E8265    mov ecx, 0x882824                               ; => [ String: dataIndex == numValues ]
006E826A    push 0x882314
006E826F    mov edx, 0x801800
006E8274    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Flanim.cpp | String: FlanimCompressConstantInt ]
006E8279    add esp, 0x0C
006E827C    call 0x0063BC30
006E8281    test al, al
006E8283    jz 0x006E8286                                   ; => [ Call: sub_63bc30 ]
006E8285    int3
006E8286    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
