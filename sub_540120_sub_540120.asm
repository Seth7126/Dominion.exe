...
0054012C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00540131    xor eax, esp
00540133    mov dword ptr ss:[esp+0xC98], eax
0054013A    push ebx
0054013B    push esi
0054013C    push edi
0054013D    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
...
00540152    mov dword ptr ss:[esp+0x0C], eax                ; => [ Call: nullptr ]
00540156    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054016F    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005401A7    push 0x3E9
005401AC    push edi
005401AD    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
...
005401D4    call 0x0056BBA0                                 ; => [ Call: sub_56bba0 | Call: sub_540200 ]
...
005401E8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
