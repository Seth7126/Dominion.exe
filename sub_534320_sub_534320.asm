...
00534338    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
0053433D    mov eax, dword ptr fs:[0x00000000]
00534343    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00534344    push ebx
00534345    mov eax, 0x19A8
0053434A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053434F    mov eax, dword ptr ds:[0x008C4040]
00534354    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00534356    mov dword ptr ss:[ebp-0x14], eax
00534359    push esi
0053435A    push edi
0053435B    push eax
0053435C    lea eax, ss:[ebp-0x0C]
0053435F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00534365    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053436A    mov esi, eax
0053436C    cmp dword ptr ds:[esi+0x40], 0x00
00534370    jnz 0x00534377
00534372    call 0x00591930                                 ; => [ Call: sub_591930 ]
00534377    mov esi, dword ptr ds:[esi+0x40]
0053437A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00534396    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0053444A    call eax
0053444C    mov dword ptr ds:[edi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00534476    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0053448D    push eax
0053448E    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
005344AC    movlpd qword ptr ss:[ebp-0xCC4], xmm0           ; => [ Call: __builtin_memset ]
...
0053453E    push 0x476
00534543    push esi
00534544    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00534549    add esp, 0x1C
0053454C    mov ecx, dword ptr ss:[ebp-0x0C]
0053454F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00534556    pop ecx
00534557    pop edi
00534558    pop esi
00534559    mov ecx, dword ptr ss:[ebp-0x14]
0053455C    xor ecx, ebp
0053455E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
