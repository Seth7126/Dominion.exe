...
00511236    push ebx
00511237    push esi
00511238    mov esi, dword ptr ds:[0x00CCA790]              ; => [ Data: data_cca790 ]
0051123E    push edi
0051123F    mov edi, edx
00511241    cmp esi, ecx
00511243    jz 0x00511259
00511245    push 0x813CBC                                   ; => [ String: RollMissionBlueprint ]
0051124A    push 0x122B
0051124F    mov ecx, 0x813CD4                               ; => [ String: gCampaignSetup.currentThemeIndex == themeIndex ]
...
005112C0    call 0x0050AF00                                 ; => [ Call: sub_516f30 | Call: sub_50af00 ]
005112C5    mov edx, dword ptr ss:[ebp-0x08]
005112C8    push eax
005112C9    mov ecx, 0xCC8DE0
005112CE    call 0x0050AF60                                 ; => [ Call: sub_50af60 | Data: data_cc8de0 ]
005112D3    add esp, 0x04
005112D6    mov dword ptr ds:[esi], eax
005112D8    mov ecx, eax
005112DA    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
005112F7    push 0x80CF80                                   ; => [ String: CampaignPieceDefGetFn ]
005112FC    push 0x30A
00511301    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
00511319    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
00511351    push 0x813CBC                                   ; => [ String: RollMissionBlueprint ]
00511356    push 0x1241
0051135B    mov ecx, 0x813D04                               ; => [ String: themeLetter >= 0 ]
00511360    jmp 0x00511406
00511365    cmp edi, eax
00511367    jl 0x0051137D
00511369    push 0x813CBC                                   ; => [ String: RollMissionBlueprint ]
0051136E    push 0x1242
00511373    mov ecx, 0x813D18                               ; => [ String: themeLetter < numPieces ]
00511378    jmp 0x00511406
0051137D    mov esi, dword ptr ds:[esi+edi*4]
00511380    mov ecx, esi
00511382    call 0x00516F30
00511387    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_516f30 ]
...
0051139F    push 0x813CBC                                   ; => [ String: RollMissionBlueprint ]
005113A4    push 0x1249
005113A9    mov ecx, 0x813D30                               ; => [ String: defTheme.type == CTHEME_BLUEPRINT_TABLE ]
005113AE    jmp 0x00511406
005113B0    mov ecx, esi
005113B2    call 0x00516F30
005113B7    lea edx, ss:[ebp-0x0C]
005113BA    mov ecx, eax
005113BC    call 0x0050AF00                                 ; => [ Call: sub_516f30 | Call: sub_50af00 ]
005113C1    mov edx, dword ptr ss:[ebp-0x0C]
005113C4    mov ecx, 0xCC8DE0
005113C9    push eax
005113CA    call 0x0050AF60
005113CF    add esp, 0x04
005113D2    mov esi, eax                                    ; => [ Call: sub_50af60 | Data: data_cc8de0 ]
005113D4    mov ecx, esi
005113D6    call 0x00516F30                                 ; => [ Call: sub_516f30 ]
...
005113F5    pop ebp
005113F6    ret
005113F7    push 0x813CBC                                   ; => [ String: RollMissionBlueprint ]
005113FC    push 0x124D
00511401    mov ecx, 0x813D58                               ; => [ String: defThemeFinal.type == CTHEME_BLUEPRINT || defThemeFinal.type == CTHEME_BLUEPRINT_FN ]
00511406    push 0x80CD80
0051140B    mov edx, 0x801800
00511410    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
00511415    add esp, 0x0C
00511418    call 0x0063BC30
0051141D    test al, al
0051141F    jz 0x00511422                                   ; => [ Call: sub_63bc30 ]
00511421    int3
00511422    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
