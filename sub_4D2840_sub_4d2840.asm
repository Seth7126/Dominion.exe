...
004D285C    push eax                                        ; => [ Data: __security_cookie ]
004D285D    lea eax, ss:[ebp-0x0C]
004D2860    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D2874    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
004D2879    mov eax, dword ptr ss:[ebp-0x10]
004D287C    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004D2881    test eax, eax
004D2883    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004D28D4    jz 0x004D28F1                                   ; => [ Data: data_cf65bc ]
004D28D6    lea ecx, ss:[ebp-0x10]
004D28D9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D28EC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D28F1    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004D28F8    test bl, bl
004D28FA    jz 0x004D2906
004D28FC    mov dword ptr ds:[0x008DB660], 0x03             ; => [ Data: data_8db660 ]
...
004D2914    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_store ]
...
004D295D    jz 0x004D297A                                   ; => [ Data: data_cf65bc ]
004D295F    lea ecx, ss:[ebp+0x08]
004D2962    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D2975    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D297A    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004D2981    test esi, esi
004D2983    jnz 0x004D29B9
004D2985    mov dword ptr ds:[0x00CC8D80], esi              ; => [ Data: data_cc8d80 ]
004D298B    mov al, 0x01
004D298D    mov dword ptr ds:[0x00CC8D84], 0x04             ; => [ Data: data_cc8d84 ]
004D2997    mov dword ptr ds:[0x00CC8D88], esi              ; => [ Data: data_cc8d88 ]
004D299D    mov dword ptr ds:[0x008DB660], 0x15             ; => [ Data: data_8db660 ]
004D29A7    mov ecx, dword ptr ss:[ebp-0x0C]
004D29AA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D29B1    pop ecx
004D29B2    pop edi
004D29B3    pop esi
004D29B4    pop ebx
...
004D29B8    ret
004D29B9    push ebx
004D29BA    call 0x004D0900                                 ; => [ Call: sub_4d0900 ]
004D29BF    add esp, 0x04
004D29C2    xor al, al
004D29C4    mov ecx, dword ptr ss:[ebp-0x0C]
004D29C7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D29CE    pop ecx
004D29CF    pop edi
004D29D0    pop esi
004D29D1    pop ebx
