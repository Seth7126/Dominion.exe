...
00603165    push 0x76A933                                   ; => [ Call: sub_76a933 | Type: EHRegistrationNode ]
0060316A    mov eax, dword ptr fs:[0x00000000]
00603170    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00603182    push esi
00603183    push edi
00603184    push eax                                        ; => [ Data: __security_cookie ]
00603185    lea eax, ss:[ebp-0x0C]
00603188    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006031BE    call 0x00603100                                 ; => [ Call: sub_603100 ]
...
006031D3    call 0x0063D720                                 ; => [ String: invalid_cardtype | Call: sub_63d720 ]
006031D8    mov eax, esi
006031DA    jmp 0x00603411
006031DF    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006031E4    mov dword ptr ss:[ebp-0x118], esi               ; => [ Data: data_801800 ]
...
00603227    call 0x00602F90                                 ; => [ Call: sub_602f90 ]
...
00603244    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0060328F    call 0x0063D850                                 ; => [ String: [list] | String: dom_prompt_cardtype_final_separator | Call: sub_63d850 | String: [last] | Call: sub_4d4980 ]
00603294    mov byte ptr ss:[ebp-0x04], 0x04
00603298    cmp dword ptr ds:[0x00CF65BC], 0x00
0060329F    jz 0x0060335C                                   ; => [ Data: data_cf65bc ]
...
006032C2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006032D9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006032DE    mov dword ptr ss:[ebp-0x124], 0x801800          ; => [ Data: data_801800 ]
...
00603313    call 0x0063D850                                 ; => [ String: dom_prompt_cardtype_separator | Call: sub_63d850 | Call: sub_4d4980 | String: [rest] | String: [first] ]
00603318    mov byte ptr ss:[ebp-0x04], 0x06
0060331C    cmp dword ptr ds:[0x00CF65BC], 0x00
00603323    jz 0x0060335C                                   ; => [ Data: data_cf65bc ]
...
0060333A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060334D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00603352    mov dword ptr ss:[ebp-0x120], 0x801800          ; => [ Data: data_801800 ]
0060335C    mov byte ptr ss:[ebp-0x04], 0x07
00603360    cmp dword ptr ds:[0x00CF65BC], 0x00
00603367    jz 0x006033A0                                   ; => [ Data: data_cf65bc ]
...
0060337E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00603391    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00603396    mov dword ptr ss:[ebp-0x11C], 0x801800          ; => [ Data: data_801800 ]
006033A0    inc edi
...
006033C6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006033EF    jz 0x0060340F                                   ; => [ Data: data_cf65bc ]
006033F1    lea ecx, ss:[ebp-0x118]
006033F7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060340A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060340F    mov eax, edi
00603411    mov ecx, dword ptr ss:[ebp-0x0C]
00603414    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060341B    pop ecx
0060341C    pop edi
0060341D    pop esi
0060341E    pop ebx
...
00603424    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
