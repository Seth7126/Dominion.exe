...
005A0C44    call 0x0064C080
005A0C49    mov dword ptr ds:[esi], 0x801800
005A0C4F    mov ecx, dword ptr ss:[ebp-0x0C]
005A0C52    mov dword ptr fs:[0x00000000], ecx
005A0C59    pop ecx
005A0C5A    pop esi
