...
006462AA    call 0x0064B0D0
006462AF    test al, al
006462B1    jnz 0x006462C7
006462B3    push 0x8729AC
006462B8    push 0x3D9
006462BD    mov ecx, 0x872988
006462C2    jmp 0x006464F3
006462C7    mov eax, dword ptr ds:[0x00CF65B8]
006462CC    movaps xmm1, xmmword ptr ss:[esp+0x20]
006462D1    movq xmm0, qword ptr ss:[esp+0x10]
006462D7    movups xmmword ptr ds:[0x00CF664C], xmm1
006462DE    mov dword ptr ds:[0x00CF6664], esi
006462E4    movq qword ptr ds:[0x00CF665C], xmm0
006462EC    cmp byte ptr ds:[eax+0x28], 0x00
006462F0    jz 0x00646492
006462F6    movq xmm0, qword ptr ds:[0x0147D21C]
006462FE    lea ecx, ss:[esp+0x40]
00646302    mov eax, dword ptr ds:[0x0147D224]
00646307    movq qword ptr ss:[esp+0x50], xmm0
0064630D    movups xmm0, xmmword ptr ds:[0x0147D234]
...
00646322    call 0x0064B0D0
00646327    test al, al
00646329    jnz 0x0064633F
0064632B    push 0x8729AC
00646330    push 0x3E2
00646335    mov ecx, 0x8729E0
0064633A    jmp 0x006464F3
0064633F    movq xmm0, qword ptr ds:[0x0147D228]
00646347    lea ecx, ss:[esp+0x60]
0064634B    mov eax, dword ptr ds:[0x0147D230]
...
00646361    movups xmmword ptr ss:[esp+0x60], xmm0
00646366    call 0x0064B0D0
0064636B    test al, al
...
006463F5    call 0x006DC740
006463FA    add esp, 0x04
006463FD    lea ecx, ss:[esp+0x60]
00646401    movups xmm0, xmmword ptr ds:[eax]
00646404    movups xmmword ptr ds:[0x00CF6614], xmm0
0064640B    movq xmm0, qword ptr ds:[eax+0x10]
00646410    movq qword ptr ds:[0x00CF6624], xmm0
00646418    mov eax, dword ptr ds:[eax+0x18]
0064641B    mov dword ptr ds:[0x00CF662C], eax
00646420    lea eax, ss:[esp+0x40]
00646424    push eax
00646425    call 0x006DC740
0064642A    add esp, 0x04
0064642D    lea ecx, ss:[esp+0xA0]
00646434    movups xmm0, xmmword ptr ds:[eax]
00646437    movups xmmword ptr ds:[0x00CF6630], xmm0
0064643E    movq xmm0, qword ptr ds:[eax+0x10]
00646443    movq qword ptr ds:[0x00CF6640], xmm0
0064644B    mov eax, dword ptr ds:[eax+0x18]
0064644E    mov dword ptr ds:[0x00CF6648], eax
00646453    lea eax, ss:[esp+0x60]
00646457    push eax
00646458    call 0x006DC740
0064645D    add esp, 0x04
00646460    movups xmm0, xmmword ptr ds:[eax]
00646463    movups xmmword ptr ds:[0x00CF6668], xmm0
0064646A    movq xmm0, qword ptr ds:[eax+0x10]
0064646F    movq qword ptr ds:[0x00CF6678], xmm0
00646477    mov eax, dword ptr ds:[eax+0x18]
0064647A    mov dword ptr ds:[0x00CF6680], eax
0064647F    pop esi
00646480    mov ecx, dword ptr ss:[esp+0xB8]
00646487    xor ecx, esp
00646489    call 0x0075927A
0064648E    mov esp, ebp
00646490    pop ebp
00646491    ret
00646492    mov ecx, dword ptr ss:[esp+0xBC]
00646499    mov dword ptr ds:[0x00CF662C], esi
0064649F    mov dword ptr ds:[0x00CF6648], esi
006464A5    mov dword ptr ds:[0x00CF6680], esi
006464AB    pop esi
006464AC    xor ecx, esp
006464AE    movq qword ptr ds:[0x00CF6624], xmm0
006464B6    movups xmmword ptr ds:[0x00CF6614], xmm1
006464BD    movups xmmword ptr ds:[0x00CF6630], xmm1
006464C4    movq qword ptr ds:[0x00CF6640], xmm0
006464CC    movups xmmword ptr ds:[0x00CF6668], xmm1
006464D3    movq qword ptr ds:[0x00CF6678], xmm0
006464DB    call 0x0075927A
006464E0    mov esp, ebp
006464E2    pop ebp
006464E3    ret
006464E4    push 0x8729AC
006464E9    push 0x3E7
006464EE    mov ecx, 0x8729BC
006464F3    push 0x872630
006464F8    mov edx, 0x801800
006464FD    call 0x0063B870
00646502    add esp, 0x0C
00646505    call 0x0063BC30
0064650A    test al, al
0064650C    jz 0x0064650F
0064650E    int3
0064650F    call 0x0063BB00
