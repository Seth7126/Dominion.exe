...
00520E49    movlpd qword ptr ss:[ebp-0xCD4], xmm0
...
00520ECE    mov dword ptr fs:[0x00000000], ecx
00520ED5    pop ecx
00520ED6    pop edi
00520ED7    pop esi
00520ED8    mov ecx, dword ptr ss:[ebp-0x14]
00520EDB    xor ecx, ebp
00520EDD    call 0x0075927A
