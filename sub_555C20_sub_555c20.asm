...
00555C28    call 0x00761E50                                 ; => [ Call: __chkstk ]
...
00555C65    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
