...
0063B3F9    mov eax, dword ptr ds:[0x008C4040]
...
0063B40E    jz 0x0063B422
0063B410    push 0x871A3C
0063B415    call 0x0063B6F0
0063B41A    add esp, 0x04
0063B41D    jmp 0x0063B5B9
0063B422    push ebx
0063B423    push edi
0063B424    push 0x871A98
0063B429    mov byte ptr ds:[0x00CC8D6E], 0x01
0063B430    call 0x0063B6F0
0063B435    add esp, 0x04
0063B438    mov ecx, esi
0063B43A    call 0x0063B2A0
0063B43F    mov eax, dword ptr ds:[0x00CF65B8]
0063B444    mov ebx, 0x871A84
0063B449    mov dword ptr ss:[ebp-0xB0], ebx
...
0063B4CE    mov dword ptr ss:[ebp-0x90], eax
0063B4D4    mov eax, dword ptr ds:[ebx+0xC4]
0063B4DA    mov dword ptr ss:[ebp-0xA8], ecx
0063B4E0    mov dword ptr ss:[ebp-0xA0], 0x03
0063B4EA    mov dword ptr ss:[ebp-0x88], 0x03
0063B4F4    mov dword ptr ss:[ebp-0x84], eax
0063B4FA    mov dword ptr ss:[ebp-0x7C], 0x03
0063B501    push 0x00
...
0063B55E    call 0x006C6270
0063B563    mov eax, dword ptr ds:[0x00CF64AC]
0063B568    pop edi
0063B569    pop ebx
...
0063B5A3    cmovnz esi, ecx
0063B5A6    push 0x871AE8
0063B5AB    push esi
0063B5AC    call dword ptr ds:[0x007753B0]
0063B5B2    mov byte ptr ds:[0x00CC8D6E], 0x00
0063B5B9    mov ecx, dword ptr ss:[ebp-0x04]
0063B5BC    mov eax, 0x01
0063B5C1    xor ecx, ebp
0063B5C3    pop esi
0063B5C4    call 0x0075927A
