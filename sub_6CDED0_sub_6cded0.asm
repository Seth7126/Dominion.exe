...
006CDEFB    push 0x87ED90
006CDF00    push 0x1C4
006CDF05    mov ecx, 0x87ED74
006CDF0A    jmp 0x006CE124
006CDF0F    lea eax, ss:[ebp-0xCC]
006CDF15    push eax
006CDF16    call 0x006CD460
...
006CE00B    movups xmm0, xmmword ptr ds:[0x00800560]
006CE012    movups xmm1, xmmword ptr ds:[0x00800570]
...
006CE029    push 0x87ECE4
006CE02E    push 0xEB
006CE033    mov ecx, 0x87ECF8
006CE038    jmp 0x006CE124
006CE03D    call 0x005AF880
006CE042    movups xmm0, xmmword ptr ds:[eax]
...
006CE0F1    push 0x87ED90
006CE0F6    push 0x1DF
006CE0FB    mov ecx, 0x87EDA4
...
006CE10B    pop ebx
006CE10C    call 0x0075927A
006CE111    mov esp, ebp
006CE113    pop ebp
006CE114    ret
006CE115    push 0x87ED90
006CE11A    push 0x1CB
006CE11F    mov ecx, 0x87EDC0
006CE124    push 0x87ED1C
006CE129    mov edx, 0x801800
006CE12E    call 0x0063B870
006CE133    add esp, 0x0C
006CE136    call 0x0063BC30
006CE13B    test al, al
006CE13D    jz 0x006CE140
006CE13F    int3
006CE140    call 0x0063BB00
