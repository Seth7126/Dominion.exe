...
00545ECA    mov eax, dword ptr ds:[eax+0x1504]
...
0054600C    push 0x81B0A8
00546011    push 0x407
00546016    mov ecx, 0x81B0B0
...
00546036    mov dword ptr ss:[ebp-0xD10], 0x81B900
...
00546058    mov dword ptr ss:[ebp-0xCEC], eax
...
005460BF    mov dword ptr ss:[ebp-0x20], eax
