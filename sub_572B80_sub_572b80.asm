...
00572B88    call 0x00761E50                                 ; => [ Call: __chkstk ]
00572B8D    mov eax, dword ptr ds:[0x008C4040]
00572B92    xor eax, ebp
00572B94    mov dword ptr ss:[ebp-0x08], eax                ; => [ Data: __security_cookie ]
00572B97    push ebx
...
00572BBD    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00572C6B    call 0x00581AB0                                 ; => [ Call: sub_581ab0 ]
...
00572C8A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00572C9C    call 0x00572AC0                                 ; => [ Call: sub_572ac0 ]
...
00572CAE    push eax
00572CAF    push 0x44D
00572CB4    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00572CC9    call 0x00761FC4                                 ; => [ Call: memset ]
...
00572CF8    push 0x01
00572CFA    push eax
00572CFB    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
00572D00    add esp, 0x1C
00572D03    lea eax, ss:[ebp-0x196C]
00572D09    push 0x48
00572D0B    push 0x00
00572D0D    push eax
00572D0E    call 0x00761FC4                                 ; => [ Call: memset ]
...
00572D3F    push 0x01
00572D41    push eax
00572D42    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
...
00572D54    push eax
00572D55    push 0x44D
00572D5A    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00572D87    mov ecx, 0x1777938                              ; => [ Data: data_1777938 ]
00572D8C    jnz 0x00572D90
00572D8E    mov ecx, esi
00572D90    mov edx, edi
00572D92    call 0x0063ED10                                 ; => [ Call: sub_63ed10 ]
00572D97    push eax
00572D98    push ebx
00572D99    mov edx, 0x44D
00572D9E    mov ecx, esi
00572DA0    call 0x00572A00                                 ; => [ Call: sub_572a00 ]
00572DA5    push ebx
...
00572E10    call 0x00581AB0                                 ; => [ Call: sub_581ab0 ]
00572E15    dec edi
...
00572E58    push ebx
00572E59    push 0x450
00572E5E    call 0x00572AC0                                 ; => [ Call: sub_572ac0 ]
...
00572E70    push eax
00572E71    push 0x44E
00572E76    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
00572E8E    call 0x00761FC4                                 ; => [ Call: memset ]
...
00572EBD    push 0x01
00572EBF    push eax
00572EC0    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
...
00572ECF    pop ebx
00572ED0    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
