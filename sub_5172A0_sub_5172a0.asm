...
005172A8    call 0x00761E50
005172AD    mov eax, dword ptr ds:[0x008C4040]
005172B2    xor eax, ebp
005172B4    mov dword ptr ss:[ebp-0x04], eax
005172B7    mov ecx, dword ptr ds:[0x00CCA790]
005172BD    push ebx
005172BE    push esi
005172BF    push edi
...
00517322    mov eax, dword ptr ds:[eax+ecx*4]
...
005173FF    mov esi, dword ptr ds:[0x00CC8DE4]
00517405    mov edi, dword ptr ds:[0x00CC8DE0]
0051740B    push 0x5851F42D
00517410    push 0x4C957F2D
00517415    push esi
00517416    push edi
00517417    call 0x007621D0
0051741C    add eax, dword ptr ds:[0x00CC8DE8]
00517422    mov ecx, esi
00517424    mov dword ptr ds:[0x00CC8DE0], eax
...
0051743D    mov dword ptr ds:[0x00CC8DE4], edx
00517443    ror eax, cl
00517445    xor edx, edx
00517447    div ebx
00517449    mov ecx, dword ptr ss:[ebp+edx*4-0x1008]
00517450    call 0x0050B2A0
00517455    mov ecx, dword ptr ss:[ebp-0x04]
00517458    pop edi
00517459    pop esi
0051745A    xor ecx, ebp
0051745C    pop ebx
0051745D    call 0x0075927A
00517462    mov esp, ebp
00517464    pop ebp
00517465    ret
00517466    push 0x871EF0
0051746B    push 0x107
00517470    push 0x871ED0
00517475    mov ecx, 0x871F0C
0051747A    mov edx, 0x801800
0051747F    call 0x0063B870
00517484    add esp, 0x0C
00517487    call 0x0063BC30
0051748C    test al, al
0051748E    jz 0x00517491
00517490    int3
00517491    call 0x0063BB00
