...
0068ADF1    call dword ptr ds:[esi+0x14]
...
0068AE2D    push 0x877A1C
0068AE32    push 0x52E
0068AE37    mov ecx, 0x8774D8
0068AE3C    jmp 0x0068AF3E
0068AE41    mov dword ptr ds:[edi+0x04], 0x3E9
0068AE48    mov ebx, dword ptr ds:[0x0147ABF4]
0068AE4E    mov ecx, 0x0C
0068AE53    call 0x0064BFD0
...
0068AEBF    call dword ptr ds:[edx+0x14]
...
0068AF07    call 0x0064C080
0068AF0C    mov dword ptr ds:[edi+0xED40], 0x801800
...
0068AF2D    pop ebp
0068AF2E    ret
0068AF2F    push 0x877A1C
0068AF34    push 0x51F
0068AF39    mov ecx, 0x8779F0
0068AF3E    push 0x8773A8
0068AF43    mov edx, 0x801800
0068AF48    call 0x0063B870
0068AF4D    add esp, 0x0C
0068AF50    call 0x0063BC30
0068AF55    test al, al
0068AF57    jz 0x0068AF5A
0068AF59    int3
0068AF5A    call 0x0063BB00
