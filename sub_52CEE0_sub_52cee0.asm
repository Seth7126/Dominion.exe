...
0052CEF0    call 0x00561AF0
0052CEF5    xorps xmm0, xmm0
0052CEF8    mov dword ptr ss:[esp+0x20], 0x00
0052CF00    movlpd qword ptr ss:[esp+0x18], xmm0
...
0052CF5A    call 0x00566540
0052CF5F    test eax, eax
0052CF61    jz 0x0052CF83
0052CF63    mov ecx, 0x01
0052CF68    call 0x0056E9C0
0052CF6D    sub esp, 0x28
0052CF70    mov eax, esp
0052CF72    mov dword ptr ds:[eax], 0x8192F4
0052CF78    mov dword ptr ds:[eax+0x24], eax
0052CF7B    call 0x005699B0
