...
005125F0    push esi
005125F1    call 0x00573400                                 ; => [ Call: sub_573400 ]
005125F6    mov esi, eax
005125F8    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
...
00512606    push 0x01
00512608    push 0x02
0051260A    call 0x00590760                                 ; => [ Call: sub_590760 ]
0051260F    add esp, 0x10
00512612    call 0x00573400                                 ; => [ Call: sub_573400 ]
00512617    pop esi
...
00512648    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0051264D    add esp, 0x0C
00512650    call 0x0063BC30
00512655    test al, al
00512657    jz 0x0051265A                                   ; => [ Call: sub_63bc30 ]
00512659    int3
0051265A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
