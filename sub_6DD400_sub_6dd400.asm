...
006DD405    push 0x770F8B                                   ; => [ Call: sub_770f8b | Type: EHRegistrationNode ]
006DD40A    mov eax, dword ptr fs:[0x00000000]
006DD410    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006DD41E    push eax                                        ; => [ Data: __security_cookie ]
006DD41F    lea eax, ss:[ebp-0x0C]
006DD422    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006DD428    mov eax, ecx
006DD42A    mov dword ptr ss:[ebp-0x1C], eax
006DD42D    mov ecx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006DD433    test ecx, ecx
006DD435    jnz 0x006DD44D
006DD437    push 0x871F88                                   ; => [ String: GetGameData ]
006DD43C    push 0x45
006DD43E    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
006DD443    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
...
006DD4A5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006DD4B8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006DD4BD    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006DD4EB    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006DD525    call 0x006E0A60                                 ; => [ Call: sub_6e0a60 ]
...
006DD53A    mov dword ptr ds:[edi+0x04], 0x00               ; => [ Call: __builtin_memset ]
...
006DD564    push 0x6E0980                                   ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_6e0980 ]
...
006DD579    push eax
006DD57A    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: PDBStream::PDBStream ]
...
006DD621    pop ebp
006DD622    ret
006DD623    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
006DD628    push 0x19
006DD62A    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
006DD62F    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
006DD634    mov edx, 0x801800
006DD639    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006DD63E    add esp, 0x0C
006DD641    call 0x0063BC30
006DD646    test al, al
006DD648    jz 0x006DD64B                                   ; => [ Call: sub_63bc30 ]
006DD64A    int3
006DD64B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
