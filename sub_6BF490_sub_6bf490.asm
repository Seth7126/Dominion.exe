...
006BF4A8    push 0x770080                                   ; => [ Call: sub_770080 | Type: EHRegistrationNode ]
006BF4AD    mov eax, dword ptr fs:[0x00000000]
006BF4B3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006BF4B4    push ebx
...
006BF4C5    push esi
006BF4C6    push edi
006BF4C7    push eax                                        ; => [ Data: __security_cookie ]
006BF4C8    lea eax, ss:[ebp-0x0C]
006BF4CB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006BF4ED    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006BF536    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006BF53B    test eax, eax
006BF53D    jnz 0x006BF555
006BF53F    push 0x871F88                                   ; => [ String: GetGameData ]
006BF544    push 0x45
006BF546    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
006BF54B    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
...
006BF58F    call 0x006BE480                                 ; => [ Call: sub_6be480 ]
...
006BF5A9    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
...
006BF5DF    call 0x00682F00                                 ; => [ Call: sub_682f00 ]
006BF5E4    mov ecx, dword ptr ss:[ebp-0x0C]
006BF5E7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006BF5EE    pop ecx
006BF5EF    pop edi
006BF5F0    pop esi
006BF5F1    mov ecx, dword ptr ss:[ebp-0x14]
006BF5F4    xor ecx, ebp
006BF5F6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006BF6D2    call 0x00639970                                 ; => [ Call: sub_639970 ]
006BF6D7    test al, al
006BF6D9    jz 0x006BF6FD
006BF6DB    push ecx
006BF6DC    lea edx, ss:[ebp-0x120]
006BF6E2    lea ecx, ss:[ebp-0x78]
006BF6E5    call 0x004EB600                                 ; => [ Call: sub_4eb600 ]
...
006BF70D    push eax
006BF70E    call 0x006BDE50                                 ; => [ Call: sub_6bde50 ]
...
006BF826    push 0x01
006BF828    xor dl, dl
006BF82A    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006BF852    mov edx, eax                                    ; => [ Call: sub_6edec0 ]
...
006BF86D    xorps xmm3, xmm3                                ; => [ String: 0 | String: zx ]
...
006BF8BC    movss dword ptr ds:[0x00CF6B18], xmm0           ; => [ Data: data_cf6b18 | Data: data_147abe8 ]
006BF8C4    cmp byte ptr ds:[eax+0x74], 0x00
006BF8C8    jnz 0x006BF8D4
006BF8CA    mov dword ptr ds:[0x00CF6B18], 0x00             ; => [ Data: data_cf6b18 ]
...
006BF8F8    jle 0x006BF942                                  ; => [ Data: data_1a9a2b8 | Field: ThreadLocalStoragePointer ]
006BF8FA    push 0x1A9A2B8
006BF8FF    call 0x0075970E                                 ; => [ Data: data_1a9a2b8 | Call: sub_75970e ]
006BF904    add esp, 0x04
006BF907    cmp dword ptr ds:[0x01A9A2B8], 0xFFFFFFFF
006BF90E    jnz 0x006BF93F                                  ; => [ Data: data_1a9a2b8 ]
...
006BF92B    mov dword ptr ds:[0x01A9A2BC], eax              ; => [ Data: data_1a9a2bc | String: sys/draw3d.material | Call: sub_69f030 ]
006BF930    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006BF937    call 0x007596BD                                 ; => [ Data: data_1a9a2b8 | Call: __Init_thread_footer ]
006BF93C    add esp, 0x04
006BF93F    xorps xmm3, xmm3                                ; => [ String: 0 | String: zx ]
006BF942    mov eax, dword ptr ds:[0x01A9A2BC]
006BF947    mov dword ptr ss:[ebp-0x174], eax               ; => [ Data: data_1a9a2bc ]
...
006BF961    movups xmm1, xmmword ptr ds:[0x00CF6668]        ; => [ Data: data_cf6668 ]
006BF968    movss xmm4, dword ptr ds:[0x00890E18]
006BF970    jmp dword ptr ds:[eax*4+0x6C2110]
006BF977    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
006BF97C    push 0x19
006BF97E    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
006BF983    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
006BF988    jmp 0x006C20F4
006BF98D    movq xmm0, qword ptr ds:[0x00CF6678]            ; => [ Data: data_cf6678 ]
006BF995    mov eax, dword ptr ds:[0x00CF6680]              ; => [ Data: data_cf6680 ]
...
006BFA0A    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
006BFA0F    movss xmm1, dword ptr ds:[0x00890C78]
006BFA17    comiss xmm1, xmm0
006BFA1A    jbe 0x006BFA2A
006BFA1C    xorps xmm3, xmm3                                ; => [ String: 0 | String: zx ]
006BFA1F    xorps xmm5, xmm5                                ; => [ String: 0 | String: zx ]
006BFA22    xorps xmm2, xmm2                                ; => [ String: 0 | String: zx ]
...
006BFA9A    divss xmm2, xmm0                                ; => [ Call: sub_4ac580 ]
...
006BFB31    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006BFB50    mov edx, 0x7FEF98                               ; => [ Data: data_7fef98 ]
...
006BFBE4    mov edx, 0x7FEF98                               ; => [ Data: data_7fef98 ]
006BFBE9    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006BFC30    call 0x004AE0F0                                 ; => [ Call: sub_4ae0f0 ]
...
006BFC57    call 0x004AE0D0                                 ; => [ Call: sub_4ae0d0 ]
...
006BFCC3    jbe 0x006BFCCB                                  ; => [ String: 0 | String: zx ]
...
006BFD4D    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006BFDCB    movq qword ptr ss:[ebp-0x10C], xmm0             ; => [ Data: data_cf6678 ]
...
006BFDEB    mov dword ptr ss:[ebp-0x104], eax               ; => [ Data: data_cf6680 ]
...
006BFEB7    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
006BFEBC    movaps xmm1, xmm0
006BFEBF    movss xmm0, dword ptr ds:[0x00890C78]
006BFEC7    comiss xmm0, xmm1
006BFECA    jbe 0x006BFEDA
006BFECC    xorps xmm6, xmm6                                ; => [ String: 0 | String: zx ]
006BFECF    xorps xmm7, xmm7                                ; => [ String: 0 | String: zx ]
006BFED2    xorps xmm4, xmm4                                ; => [ String: 0 | String: zx ]
...
006BFF4A    divss xmm4, xmm0                                ; => [ Call: sub_4ac580 ]
...
006BFFE9    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C0092    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C00CC    mov edx, 0x7FEF8C                               ; => [ Data: data_7fef8c ]
...
006C0106    push eax
006C0107    call 0x004AC840                                 ; => [ Call: sub_4ac840 | Data: data_7fef74 ]
006C010C    add esp, 0x0C
006C010F    movups xmm0, xmmword ptr ds:[eax]
006C0112    movups xmmword ptr ss:[ebp-0x34], xmm0
006C0116    movups xmm1, xmmword ptr ds:[0x00CF6668]        ; => [ Data: data_cf6668 | Data: data_cf6668 | Data: data_cf6668 ]
...
006C0146    mov dword ptr ss:[ebp-0x104], eax               ; => [ Data: data_cf6680 ]
006C014C    mov eax, dword ptr ss:[ebp-0x154]
006C0152    movq qword ptr ss:[ebp-0x10C], xmm0             ; => [ Data: data_cf6678 ]
...
006C01DC    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
006C01E1    movaps xmm1, xmm0
006C01E4    movss xmm0, dword ptr ds:[0x00890C78]
006C01EC    comiss xmm0, xmm1
006C01EF    jbe 0x006C01FF
006C01F1    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
006C01F4    xorps xmm4, xmm4                                ; => [ String: 0 | String: zx ]
006C01F7    xorps xmm2, xmm2                                ; => [ String: 0 | String: zx ]
...
006C0262    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C02D0    call 0x0064B1B0                                 ; => [ Call: sub_64b1b0 ]
...
006C0300    call 0x006C3C80                                 ; => [ Call: sub_6c3c80 ]
...
006C0343    call 0x00642E30                                 ; => [ Call: sub_642e30 ]
...
006C03A2    cmp byte ptr ds:[0x0147ABA1], 0x00              ; => [ Data: data_147aba1 ]
...
006C03CF    push 0x8728B4                                   ; => [ String: Draw3DSetMaterialColor ]
006C03D4    push 0x304
006C03D9    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
006C03DE    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
006C03E3    jmp 0x006C20F4
006C03E8    push 0x00
006C03EA    push dword ptr ss:[ebp-0x178]
006C03F0    movss dword ptr ds:[0x00CF6A70], xmm1           ; => [ Data: data_cf6a70 ]
006C03F8    lea edx, ss:[ebp-0xB8]
006C03FE    push dword ptr ss:[ebp-0x174]
006C0404    movss dword ptr ds:[0x00CF6A74], xmm2           ; => [ Data: data_cf6a70 ]
006C040C    movss dword ptr ds:[0x00CF6A78], xmm3           ; => [ Data: data_cf6a70 ]
006C0414    movss dword ptr ds:[0x00CF6A7C], xmm4           ; => [ Data: data_cf6a70 ]
006C041C    mov ecx, dword ptr ds:[esi+0x140]
006C0422    call 0x00648470                                 ; => [ Call: sub_648470 ]
006C0427    add esp, 0x0C
006C042A    cmp byte ptr ds:[0x0147ABA1], 0x00
006C0431    jnz 0x006C044C                                  ; => [ Data: data_147aba1 ]
006C0433    push 0x8728B4                                   ; => [ String: Draw3DSetMaterialColor ]
006C0438    push 0x304
006C043D    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
006C0442    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
006C0447    jmp 0x006C20F4
006C044C    movups xmm0, xmmword ptr ds:[0x007FEFB0]        ; => [ Data: data_7fefb0 ]
006C0453    mov dword ptr ds:[0x00CF6B18], 0x00             ; => [ Data: data_cf6b18 ]
006C045D    movups xmmword ptr ds:[0x00CF6A70], xmm0        ; => [ Data: data_cf6a70 ]
006C0464    jmp 0x006BF5E4
006C0469    push 0x87DCF8                                   ; => [ String: ParticleSpotDraw ]
006C046E    push 0x8A7
006C0473    push 0x87DBAC                                   ; => [ String: C:\x\ax2017\Engine\Particle.cpp ]
006C0478    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
006C049A    mov ecx, dword ptr ds:[eax]                     ; => [ Field: ThreadLocalStoragePointer ]
...
006C04AF    jle 0x006C04F6                                  ; => [ Data: data_1a9a2c0 ]
006C04B1    push 0x1A9A2C0
006C04B6    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a9a2c0 ]
006C04BB    add esp, 0x04
006C04BE    cmp dword ptr ds:[0x01A9A2C0], 0xFFFFFFFF
006C04C5    jnz 0x006C04F6                                  ; => [ Data: data_1a9a2c0 ]
...
006C04E2    mov dword ptr ds:[0x01A9A2C4], eax              ; => [ Data: data_1a9a2c4 | String: sys/particle_3d_additive.material | Call: sub_69f030 ]
006C04E7    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006C04EE    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a9a2c0 ]
006C04F3    add esp, 0x04
006C04F6    mov eax, dword ptr ds:[0x01A9A2C4]              ; => [ Data: data_1a9a2c4 ]
006C04FB    jmp 0x006C0554
006C04FD    mov eax, dword ptr ds:[0x01A9A2C8]
006C0502    cmp eax, dword ptr ds:[ecx+0x08]
006C0508    jle 0x006C054F                                  ; => [ Data: data_1a9a2c8 ]
006C050A    push 0x1A9A2C8
006C050F    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a9a2c8 ]
006C0514    add esp, 0x04
006C0517    cmp dword ptr ds:[0x01A9A2C8], 0xFFFFFFFF
006C051E    jnz 0x006C054F                                  ; => [ Data: data_1a9a2c8 ]
...
006C053B    mov dword ptr ds:[0x01A9A2CC], eax              ; => [ String: sys/particle_3d.material | Data: data_1a9a2cc | Call: sub_69f030 ]
006C0540    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006C0547    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a9a2c8 ]
006C054C    add esp, 0x04
006C054F    mov eax, dword ptr ds:[0x01A9A2CC]              ; => [ Data: data_1a9a2cc ]
...
006C07B6    call 0x00649CC0                                 ; => [ Call: sub_649cc0 ]
006C07BB    mov ecx, dword ptr ds:[edi+0x284]
006C07C1    cmp ecx, 0x10
006C07C4    jle 0x006C07DF
006C07C6    push 0x87DCF8                                   ; => [ String: ParticleSpotDraw ]
006C07CB    push 0x8DF
006C07D0    push 0x87DBAC                                   ; => [ String: C:\x\ax2017\Engine\Particle.cpp ]
006C07D5    mov ecx, 0x87DCC8                               ; => [ String: pSpot->numTrailSegments <= MAX_TRAIL_SEGMENTS ]
...
006C081E    xor ecx, ecx                                    ; => [ Call: nullptr ]
006C0820    neg edx
...
006C0891    push 0x04
006C0893    call 0x00648A50                                 ; => [ Call: sub_6beef0 | Call: sub_648a50 ]
...
006C08B6    push eax
006C08B7    call 0x00646BB0                                 ; => [ Call: sub_646bb0 ]
...
006C08EE    call 0x00649D30                                 ; => [ Call: sub_649d30 ]
006C08F3    mov dword ptr ds:[0x00CF6B18], 0x00             ; => [ Data: data_cf6b18 ]
...
006C0925    movups xmmword ptr ss:[ebp-0xA8], xmm0          ; => [ String: \x00\x00\x00\xbf\x00\x00\x00\xbf\x00\x00\x00\x00\x00\x00\x00\x3f\x00\x00\x00\xbf\x00\x00\x00\x00\x00\x00\x00\xbf\x00\x00\x00\x3f\x00\x00\x00\x00\x00\x00\x00\x3f\x00\x00\x00\x3f\x00\x00\x00\x00 | Call: __builtin_memcpy ]
...
006C09A1    call 0x005A0E40                                 ; => [ Call: sub_5a0e40 ]
...
006C0A14    movups xmm1, xmmword ptr ds:[0x00CF6668]        ; => [ Data: data_cf6668 ]
...
006C0B3F    movq xmm0, qword ptr ds:[0x00CF6678]            ; => [ Data: data_cf6678 ]
006C0B47    movaps xmm3, xmm7
006C0B4A    movss xmm2, dword ptr ss:[ebp-0x24]
006C0B4F    mov eax, dword ptr ds:[0x00CF6680]              ; => [ Data: data_cf6680 ]
...
006C0BBB    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
006C0BC0    movss xmm1, dword ptr ds:[0x00890C78]
006C0BC8    comiss xmm1, xmm0
006C0BCB    jbe 0x006C0BDB
006C0BCD    xorps xmm3, xmm3                                ; => [ String: 0 | String: zx ]
006C0BD0    xorps xmm4, xmm4                                ; => [ String: 0 | String: zx ]
006C0BD3    xorps xmm2, xmm2                                ; => [ String: 0 | String: zx ]
...
006C0C4B    divss xmm2, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C0CE2    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C0D8A    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C0DCA    mov edx, 0x7FEF8C                               ; => [ Data: data_7fef8c ]
...
006C0DFC    xorps xmm3, xmm3                                ; => [ String: 0 | String: zx ]
...
006C0E57    jbe 0x006C0E5F                                  ; => [ String: 0 | String: zx ]
...
006C0EE1    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C0F49    movups xmmword ptr ss:[ebp-0x34], xmm0          ; => [ Data: data_800248 ]
...
006C0F6F    movq qword ptr ss:[ebp-0x10C], xmm0             ; => [ Data: data_cf6678 ]
...
006C0F8F    mov dword ptr ss:[ebp-0x104], eax               ; => [ Data: data_cf6680 ]
...
006C105B    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
006C1060    movaps xmm1, xmm0
006C1063    movss xmm0, dword ptr ds:[0x00890C78]
006C106B    comiss xmm0, xmm1
006C106E    jbe 0x006C107E
006C1070    xorps xmm7, xmm7                                ; => [ String: 0 | String: zx ]
006C1073    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
006C1076    xorps xmm4, xmm4                                ; => [ String: 0 | String: zx ]
...
006C10EE    divss xmm4, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C1196    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C123E    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C12D5    push eax
006C12D6    call 0x004AC840                                 ; => [ Call: sub_4ac840 | Data: data_7fef74 ]
006C12DB    add esp, 0x0C
006C12DE    movups xmm0, xmmword ptr ds:[eax]
006C12E1    movups xmmword ptr ss:[ebp-0x34], xmm0
006C12E5    movups xmm1, xmmword ptr ds:[0x00CF6668]        ; => [ Data: data_cf6668 | Data: data_cf6668 | Data: data_cf6668 ]
...
006C1315    mov dword ptr ss:[ebp-0x104], eax               ; => [ Data: data_cf6680 ]
006C131B    mov eax, dword ptr ss:[ebp-0x154]
006C1321    movq qword ptr ss:[ebp-0x10C], xmm0             ; => [ Data: data_cf6678 ]
...
006C13AB    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
006C13B0    movaps xmm1, xmm0
006C13B3    movss xmm0, dword ptr ds:[0x00890C78]
006C13BB    comiss xmm0, xmm1
006C13BE    jbe 0x006C13CE
006C13C0    xorps xmm3, xmm3                                ; => [ String: 0 | String: zx ]
006C13C3    xorps xmm4, xmm4                                ; => [ String: 0 | String: zx ]
006C13C6    xorps xmm2, xmm2                                ; => [ String: 0 | String: zx ]
...
006C1431    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C14C6    call 0x006BE800                                 ; => [ Call: sub_6be800 ]
006C14CB    add esp, 0x10
006C14CE    lea edx, ss:[ebp-0x140]
006C14D4    lea ecx, ss:[ebp-0xA8]
006C14DA    call 0x006BCC60                                 ; => [ Call: sub_6bcc60 ]
...
006C1577    movq qword ptr ss:[ebp-0x10C], xmm0             ; => [ Data: data_cf6678 ]
...
006C15C3    divss xmm3, xmm0                                ; => [ Call: sub_4ac580 ]
006C15C7    xorps xmm0, xmm0
006C15CA    comiss xmm0, xmm3
006C15CD    jb 0x006C15D4
006C15CF    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
...
006C15F4    movaps xmm1, xmm0                               ; => [ String: 0 | String: zx | Call: sub_4ae110 ]
006C15F7    movaps xmm2, xmm1
006C15FA    lea ecx, ss:[ebp-0x190]
006C1600    mov edx, 0xCF65F8
006C1605    call 0x005AF6F0
006C160A    mov dword ptr ss:[ebp-0x144], eax               ; => [ Call: sub_5af6f0 | Data: data_cf65f8 ]
...
006C174E    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C17FA    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C186D    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_5af880 ]
006C1870    mov edx, dword ptr ds:[eax+0x08]
006C1873    add edx, 0x08
006C1876    call 0x006DD280                                 ; => [ Call: sub_6dd280 | Data: data_8ce7bc ]
006C187B    add esp, 0x04
006C187E    test eax, eax
006C1880    cmovz eax, dword ptr ds:[0x01724A58]            ; => [ Data: data_1724a58 ]
006C1887    mov dword ptr ss:[ebp-0x178], eax
006C188D    mov ecx, esi
006C188F    call 0x005AF880
006C1894    push 0x54
006C1896    mov ecx, 0x8CE7BC
006C189B    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_5af880 ]
...
006C18CE    call 0x00646580                                 ; => [ Call: sub_646580 | Call: sub_6dd280 | Data: data_8ce7bc ]
006C18D3    add esp, 0x20
006C18D6    mov dword ptr ds:[0x00CF6B18], 0x00             ; => [ Data: data_cf6b18 ]
006C18E0    jmp 0x006BF5E4
006C18E5    push 0x87DCF8                                   ; => [ String: ParticleSpotDraw ]
006C18EA    push 0x94E
006C18EF    push 0x87DBAC                                   ; => [ String: C:\x\ax2017\Engine\Particle.cpp ]
006C18F4    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
006C191D    jle 0x006C1967                                  ; => [ Field: ThreadLocalStoragePointer | Data: data_1a9a2d0 ]
006C191F    push 0x1A9A2D0
006C1924    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a9a2d0 ]
006C1929    add esp, 0x04
006C192C    cmp dword ptr ds:[0x01A9A2D0], 0xFFFFFFFF
006C1933    jnz 0x006C1964                                  ; => [ Data: data_1a9a2d0 ]
...
006C1950    mov dword ptr ds:[0x01A9A2D4], eax              ; => [ String: sys\SpriteAdditive.material | Data: data_1a9a2d4 | Call: sub_69f030 ]
006C1955    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006C195C    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a9a2d0 ]
006C1961    add esp, 0x04
006C1964    xorps xmm3, xmm3
006C1967    mov eax, dword ptr ds:[0x01A9A2D4]
006C196C    mov dword ptr ss:[ebp-0x174], eax               ; => [ Data: data_1a9a2d4 ]
006C1972    movss xmm0, dword ptr ds:[edi+0x24]
006C1977    ucomiss xmm0, xmm3
006C197A    lahf
006C197B    test ah, 0x44
006C197E    jp 0x006C19C0
006C1980    movups xmm1, xmmword ptr ds:[0x00800248]        ; => [ Data: data_800248 ]
...
006C19D0    call 0x004AE0F0                                 ; => [ Call: sub_4ae0f0 ]
...
006C1A20    movss dword ptr ss:[ebp-0xDC], xmm0             ; => [ Call: sub_4ae0d0 ]
...
006C1A81    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
006C1B1D    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006C1B90    movups xmmword ptr ss:[ebp-0x34], xmm0          ; => [ Call: sub_4ac9c0 | Data: data_7fef8c ]
...
006C1E31    call 0x006818C0                                 ; => [ Call: sub_6818c0 ]
...
006C1E6B    call 0x0064B1B0                                 ; => [ Call: sub_64b1b0 ]
...
006C1EA2    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
006C1F9D    call 0x006818C0                                 ; => [ Call: sub_6818c0 ]
...
006C1FDD    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
006C207C    call 0x00682AD0                                 ; => [ Call: sub_682ad0 ]
...
006C20A4    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_5af880 ]
006C20A7    mov edx, dword ptr ds:[eax+0x08]
006C20AA    add edx, 0x08
006C20AD    call 0x006DD280                                 ; => [ Call: sub_6dd280 | Data: data_8ce7bc ]
...
006C20C9    call 0x00682AD0                                 ; => [ Call: sub_682ad0 ]
006C20CE    add esp, 0x0C
006C20D1    mov dword ptr ds:[0x00CF6B18], 0x00             ; => [ Data: data_cf6b18 | Data: data_cf6b18 ]
006C20DB    jmp 0x006BF5E4
006C20E0    push 0x876EE4                                   ; => [ String: SpriteUVFromStrip ]
006C20E5    push 0x581
006C20EA    push 0x876CB0                                   ; => [ String: C:\x\ax2017\Engine\Sprite.cpp ]
006C20EF    mov ecx, 0x876F1C                               ; => [ String: x >= 0 && x < numCols && y >= 0 && y < numRows ]
006C20F4    mov edx, 0x801800
006C20F9    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006C20FE    add esp, 0x0C
006C2101    call 0x0063BC30
006C2106    test al, al
006C2108    jz 0x006C210B                                   ; => [ Call: sub_63bc30 ]
006C210A    int3
006C210B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
