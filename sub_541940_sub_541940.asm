...
00541958    push 0x76572B                                   ; => [ Call: sub_76572b | Type: EHRegistrationNode ]
0054195D    mov eax, dword ptr fs:[0x00000000]
00541963    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00541964    push ebx
00541965    mov eax, 0x2630
0054196A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054196F    mov eax, dword ptr ds:[0x008C4040]
00541974    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00541976    mov dword ptr ss:[ebp-0x14], eax
00541979    push esi
0054197A    push edi
0054197B    push eax
0054197C    lea eax, ss:[ebp-0x0C]
0054197F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00541985    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
0054198A    push ecx
0054198B    mov edx, 0x3E9
00541990    mov ecx, eax
00541992    call 0x005624A0                                 ; => [ Call: sub_5624a0 ]
00541997    add esp, 0x04
0054199A    call 0x00573400                                 ; => [ Call: sub_573400 ]
0054199F    lea ecx, ss:[ebp-0xCA0]
005419A5    push 0x04
005419A7    push ecx
005419A8    mov edx, dword ptr ds:[eax+0x0C]
005419AB    mov ecx, dword ptr ds:[eax+0x04]
005419AE    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
005419B3    mov ecx, 0x321
005419B8    mov dword ptr ss:[ebp-0x20], eax
005419BB    lea esi, ss:[ebp-0xCA0]
005419C1    mov dword ptr ss:[ebp-0x1988], 0x81B8E4         ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<bool (__cdecl *)(enum CardID), bool, enum CardID>::VTable | Data: std::_Func_impl_no_alloc<bool (__cdecl *)(enum CardID), bool, enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
005419CB    lea edi, ss:[ebp-0x1928]
005419D1    mov dword ptr ss:[ebp-0x1984], 0x56E610         ; => [ Call: sub_56e610 ]
005419DB    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005419DD    lea ecx, ss:[ebp-0x1988]
005419E3    add esp, 0x08
005419E6    mov dword ptr ss:[ebp-0x1964], ecx              ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<bool (__cdecl *)(enum CardID), bool, enum CardID>::VTable ]
...
00541A66    push eax
00541A67    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00541A91    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
00541A93    lea ecx, ss:[ebp-0x2640]
00541A99    call 0x0056CA00
00541A9E    cmp eax, dword ptr ss:[ebp-0xCA8]               ; => [ Call: sub_56ca00 ]
00541AA4    lea ecx, ss:[ebp-0x1928]
00541AAA    xorps xmm0, xmm0
00541AAD    mov dword ptr ss:[ebp-0x1954], 0x00
00541AB7    movlpd qword ptr ss:[ebp-0x195C], xmm0          ; => [ Call: __builtin_memset ]
...
00541B91    push 0x476
00541B96    push esi
00541B97    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00541B9C    add esp, 0x1C
00541B9F    mov ecx, dword ptr ss:[ebp-0x0C]
00541BA2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00541BA9    pop ecx
00541BAA    pop edi
00541BAB    pop esi
00541BAC    mov ecx, dword ptr ss:[ebp-0x14]
00541BAF    xor ecx, ebp
00541BB1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
