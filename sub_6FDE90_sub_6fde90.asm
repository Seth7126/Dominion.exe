...
006FDE99    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006FDF1C    divss xmm1, xmm0                                ; => [ Call: sub_4ac580 ]
...
006FDF52    call 0x004AC9C0                                 ; => [ Call: sub_4ac9c0 ]
...
006FDF69    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
