...
006A3285    push 0x76F6FD                                   ; => [ Type: EHRegistrationNode | Call: sub_76f6fd ]
006A328A    mov eax, dword ptr fs:[0x00000000]
006A3290    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A329E    push eax                                        ; => [ Data: __security_cookie ]
006A329F    lea eax, ss:[ebp-0x0C]
006A32A2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A3367    call 0x006B7EF0                                 ; => [ Call: sub_6b7ef0 ]
...
006A337B    jz 0x006A33A4                                   ; => [ Data: data_cf65bc ]
...
006A338C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A339F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A33B6    mov edx, edi                                    ; => [ Data: data_801800 ]
...
006A33F2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A3434    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A3447    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A3478    mov edx, eax                                    ; => [ Call: sub_6b7ef0 ]
006A347A    mov ecx, edi
006A347C    call 0x0069F030
006A3481    mov ecx, eax                                    ; => [ Call: sub_69f030 | Call: sub_69f030 ]
...
006A34A1    jz 0x006A34BE                                   ; => [ Data: data_cf65bc ]
006A34A3    lea ecx, ss:[ebp-0x10]
006A34A6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A34B9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A34BE    mov al, bl
006A34C0    mov ecx, dword ptr ss:[ebp-0x0C]
006A34C3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A34CA    pop ecx
006A34CB    pop edi
006A34CC    pop esi
006A34CD    pop ebx
