...
006293A0    mov dword ptr fs:[0x00000000], eax
...
006293B4    call 0x0063D720
006293B9    mov eax, dword ptr ss:[ebp+0x08]
006293BC    mov ecx, 0x801800
...
00629412    jz 0x00629436
00629414    lea ecx, ss:[ebp+0x08]
00629417    call 0x0063D4E0
...
0062942A    call 0x0064C080
0062942F    mov dword ptr ss:[ebp+0x08], 0x801800
00629436    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062943D    test bl, bl
0062943F    jz 0x00629491
00629441    call 0x004BA7C0
00629446    mov ecx, dword ptr ds:[0x00CC8D5C]
0062944C    test ecx, ecx
0062944E    jnz 0x00629466
00629450    push 0x77EB90
00629455    push 0x7B
00629457    push 0x77EB50
0062945C    mov ecx, 0x77EB9C
00629461    jmp 0x00629696
00629466    add ecx, 0x7754
0062946C    call 0x004BB0C0
00629471    xor dl, dl
00629473    mov dword ptr ds:[0x008DB598], 0x02
0062947D    mov ecx, 0x01
00629482    call 0x004D46E0
00629487    mov dword ptr ds:[0x008DB660], 0x03
00629491    mov esi, dword ptr ds:[edi+0x04]
00629494    lea ecx, ss:[ebp+0x08]
00629497    mov edx, 0x861DA8
0062949C    call 0x0063D720
006294A1    mov eax, dword ptr ss:[ebp+0x08]
006294A4    mov ecx, 0x801800
...
006294EC    jz 0x00629510
006294EE    lea ecx, ss:[ebp+0x08]
006294F1    call 0x0063D4E0
...
00629504    call 0x0064C080
00629509    mov dword ptr ss:[ebp+0x08], 0x801800
00629510    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00629517    test esi, esi
00629519    jnz 0x00629671
0062951F    mov edx, dword ptr ds:[0x00CCEA14]
...
00629539    call 0x00761FC4
0062953E    add esp, 0x0C
00629541    call 0x004BBDB0
00629546    mov edx, eax
00629548    mov ecx, 0x8DBF38
0062954D    mov dword ptr ds:[eax+0x28], 0x17
00629554    call 0x0062B4E0
00629559    mov ecx, dword ptr ds:[0x00C23BE0]
0062955F    cmp esi, 0x03
00629562    mov edi, 0x0A
00629567    mov dword ptr ds:[0x008DB660], 0x10
00629571    mov eax, 0x07
00629576    mov dword ptr ds:[0x008DBF3C], 0x01
00629580    cmovnz edi, eax
00629583    mov byte ptr ds:[0x008DBFA8], 0x01
0062958A    test ecx, ecx
0062958C    jz 0x0062959A
0062958E    push 0x01
00629590    xor dl, dl
00629592    call 0x0066CA90
00629597    add esp, 0x04
0062959A    mov dword ptr ds:[0x00CCF6F4], 0x00
006295A4    mov dword ptr ds:[0x00CCF6E8], 0x00
006295AE    mov dword ptr ds:[0x00CCF6EC], 0x01
006295B8    mov dword ptr ds:[0x008DB6B0], 0x7E6
006295C2    mov dword ptr ds:[0x00CCF6F0], edi
006295C8    jmp 0x00629653
006295CD    mov eax, dword ptr ds:[0x00CC8D5C]
006295D2    test eax, eax
006295D4    jz 0x00629450
006295DA    test edx, edx
006295DC    jnz 0x006295EF
006295DE    push 0x80281C
006295E3    push 0x6C
006295E5    mov ecx, 0x802734
...
00629629    call 0x00761FC4
0062962E    add esp, 0x0C
00629631    call 0x004BBDB0
00629636    mov edx, eax
00629638    mov ecx, 0x8DBF38
0062963D    mov dword ptr ds:[eax+0x28], 0x17
00629644    call 0x0062B4E0
00629649    mov dword ptr ds:[0x008DB660], 0x10
00629653    call 0x004BA7C0
00629658    mov ecx, dword ptr ds:[0x00CC8D5C]
0062965E    test ecx, ecx
00629660    jz 0x00629450
00629666    add ecx, 0x7754
0062966C    call 0x004BB0C0
00629671    xor al, al
00629673    mov ecx, dword ptr ss:[ebp-0x0C]
00629676    mov dword ptr fs:[0x00000000], ecx
0062967D    pop ecx
0062967E    pop edi
0062967F    pop esi
00629680    pop ebx
...
00629683    pop ebp
00629684    ret
00629685    push 0x80281C
0062968A    push 0x6D
0062968C    mov ecx, 0x802748
00629691    push 0x80193C
00629696    mov edx, 0x801800
0062969B    call 0x0063B870
006296A0    add esp, 0x0C
006296A3    call 0x0063BC30
006296A8    test al, al
006296AA    jz 0x006296AD
006296AC    int3
006296AD    call 0x0063BB00
