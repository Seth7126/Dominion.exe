...
00773BDC    mov dword ptr fs:[0x00000000], eax
00773BE2    mov dword ptr ss:[ebp-0x04], 0x00
00773BE9    mov eax, dword ptr ds:[0x00CF65BC]
00773BEE    test eax, eax
00773BF0    jz 0x00773C2B
00773BF2    mov ecx, dword ptr ds:[0x00B80A20]
00773BF8    test ecx, ecx
00773BFA    jz 0x00773C2B
00773BFC    mov eax, dword ptr ds:[0x00B80A28]
00773C01    mov dword ptr ds:[0x00B80A24], 0x00
00773C0B    lea edx, ds:[eax*8]
00773C12    sub edx, eax
00773C14    shl edx, 0x03
00773C17    call 0x0064C080
00773C1C    mov eax, dword ptr ds:[0x00CF65BC]
00773C21    mov dword ptr ds:[0x00B80A28], 0x00
00773C2B    mov dword ptr ss:[ebp-0x04], 0x01
00773C32    test eax, eax
00773C34    jz 0x00773C67
00773C36    mov ecx, dword ptr ds:[0x00B80A10]
00773C3C    test ecx, ecx
00773C3E    jz 0x00773C67
00773C40    mov edx, dword ptr ds:[0x00B80A18]
00773C46    shl edx, 0x06
00773C49    mov dword ptr ds:[0x00B80A14], 0x00
00773C53    call 0x0064C080
00773C58    mov eax, dword ptr ds:[0x00CF65BC]
00773C5D    mov dword ptr ds:[0x00B80A18], 0x00
00773C67    mov dword ptr ss:[ebp-0x04], 0x02
00773C6E    test eax, eax
00773C70    jz 0x00773C97
00773C72    mov ecx, dword ptr ds:[0x00B809FC]
00773C78    test ecx, ecx
00773C7A    jz 0x00773C97
00773C7C    mov eax, dword ptr ds:[0x00B80A04]
00773C81    mov dword ptr ds:[0x00B80A00], 0x00
00773C8B    lea edx, ds:[eax*8]
00773C92    call 0x0064C080
00773C97    mov ecx, dword ptr ss:[ebp-0x0C]
00773C9A    mov dword ptr fs:[0x00000000], ecx
00773CA1    pop ecx
