...
00504701    jle 0x00504779
00504703    lea eax, ss:[ebp-0x70]
00504706    mov dword ptr ss:[ebp-0x70], 0x80A8B8
0050470D    mov dword ptr ss:[ebp-0x4C], eax
00504710    lea eax, ss:[ebp-0x40]
00504713    mov dword ptr ss:[ebp-0x48], 0x93
0050471A    mov dword ptr ss:[ebp-0x44], 0x00
00504721    mov dword ptr ss:[ebp-0x40], 0x80A89C
00504728    mov dword ptr ss:[ebp-0x1C], eax
