...
00530F76    call 0x00761E50
00530F7B    mov eax, dword ptr ds:[0x008C4040]
00530F80    xor eax, ebp
...
00530F8C    mov dword ptr fs:[0x00000000], eax
00530F92    mov ecx, 0x1D
00530F97    call 0x005641D0
...
00530FCE    mov eax, dword ptr ds:[eax+0x1504]
...
00531006    setz cl
00531009    call 0x0061B1B0
0053100E    add esp, 0x2C
00531011    lea eax, ss:[ebp-0x25D8]
00531017    mov dword ptr ss:[ebp-0x25D8], 0x819738
00531021    mov dword ptr ss:[ebp-0x25D4], ebx
00531027    mov dword ptr ss:[ebp-0x25B4], eax
...
0053106A    push esi
0053106B    call dword ptr ds:[eax]
...
005310AD    push eax
005310AE    call dword ptr ds:[edx+0x10]
005310B1    xor ecx, ecx
005310B3    test esi, esi
005310B5    setnz cl
005310B8    call 0x0056E9C0
005310BD    call 0x00573400
...
00531103    push 0x18
00531105    call 0x00569330
0053110A    add esp, 0x04
0053110D    mov ecx, dword ptr ss:[ebp-0x0C]
00531110    mov dword ptr fs:[0x00000000], ecx
00531117    pop ecx
00531118    pop edi
00531119    pop esi
0053111A    pop ebx
