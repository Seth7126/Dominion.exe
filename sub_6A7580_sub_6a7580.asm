...
006A7585    push 0x76F886                                   ; => [ Type: EHRegistrationNode | Call: sub_76f886 ]
006A758A    mov eax, dword ptr fs:[0x00000000]
006A7590    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A759E    push eax                                        ; => [ Data: __security_cookie ]
006A759F    lea eax, ss:[ebp-0x0C]
006A75A2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A75BB    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
006A75FA    mov eax, 0x801800                               ; => [ Data: data_801800 ]
006A75FF    mov ecx, eax                                    ; => [ Data: data_801800 ]
006A7601    sub esi, eax
006A7603    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
006A7609    push esi
006A760A    push ecx
006A760B    mov ecx, edi
006A760D    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
006A765C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A766F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A7674    mov eax, edi
006A7676    mov ecx, dword ptr ss:[ebp-0x0C]
006A7679    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A7680    pop ecx
006A7681    pop edi
006A7682    pop esi
006A7683    pop ebx
...
006A76A1    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006A76A6    add esp, 0x0C
006A76A9    call 0x0063BC30
006A76AE    test al, al
006A76B0    jz 0x006A76B3                                   ; => [ Call: sub_63bc30 ]
006A76B2    int3
006A76B3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
