...
006A49C2    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006A4A20    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
006A4A26    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
006A4A2D    mov dword ptr ds:[esi+0x08], 0x801800           ; => [ Data: data_801800 ]
006A4A34    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
006A4A45    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
006A4AB3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A4AB8    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
006A4ABF    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
006A4AC6    mov eax, dword ptr ds:[esi+0x08]
006A4AC9    test eax, eax
006A4ACB    jz 0x006A4B0B
006A4ACD    cmp eax, 0x801800
006A4AD2    jz 0x006A4B0B                                   ; => [ Data: data_801800 ]
006A4AD4    cmp dword ptr ds:[0x00CF65BC], 0x00
006A4ADB    jz 0x006A4B04
006A4ADD    cmp byte ptr ds:[eax], 0x00
006A4AE0    jz 0x006A4B04                                   ; => [ Data: data_cf65bc ]
006A4AE2    lea ecx, ds:[esi+0x08]
006A4AE5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A4AF8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A4AFD    mov dword ptr ds:[esi+0x08], 0x801800           ; => [ Data: data_801800 ]
006A4B04    mov dword ptr ds:[esi+0x08], 0x801800           ; => [ Data: data_801800 ]
006A4B0B    mov ecx, dword ptr ds:[esi+0x0C]
006A4B0E    test ecx, ecx
006A4B10    jz 0x006A4B39
006A4B12    call 0x006A3220                                 ; => [ Call: sub_6a3220 ]
006A4B17    push dword ptr ss:[ebp-0x04]
006A4B1A    mov ecx, esi
006A4B1C    mov dword ptr ds:[esi+0x0C], 0x00
006A4B23    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
006A4B3E    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
006A4B43    pop edi
