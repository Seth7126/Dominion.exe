...
00604215    push 0x76AADF                                   ; => [ Call: __ehhandler$??$initialize_environment_by_cloning_nolock@_W@@YAHXZ | Type: EHRegistrationNode ]
0060421A    mov eax, dword ptr fs:[0x00000000]
00604220    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060422E    push eax                                        ; => [ Data: __security_cookie ]
0060422F    lea eax, ss:[ebp-0x0C]
00604232    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00604263    jnz 0x0060476F                                  ; => [ Data: data_7fcdc8 ]
00604269    mov esi, dword ptr ds:[edi*8+0x7FCDCC]          ; => [ Data: data_7fcdcc ]
00604270    test esi, esi
00604272    jnz 0x00604294
00604274    mov edx, 0x801800
00604279    mov ecx, ebx
0060427B    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
00604280    mov eax, ebx
00604282    mov ecx, dword ptr ss:[ebp-0x0C]
00604285    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060428C    pop ecx
0060428D    pop edi
0060428E    pop esi
0060428F    pop ebx
...
006042A0    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
006042A5    mov eax, ebx
006042A7    mov ecx, dword ptr ss:[ebp-0x0C]
006042AA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006042B1    pop ecx
006042B2    pop edi
006042B3    pop esi
006042B4    pop ebx
...
006042C8    cmovz eax, dword ptr ss:[ebp+0x10]              ; => [ Data: data_7fcdd4 ]
006042CC    mov dword ptr ss:[ebp-0x20], eax
006042CF    cmp ecx, 0xBE
006042D5    jnz 0x006042E6
006042D7    test eax, eax
006042D9    mov esi, 0x864368                               ; => [ String: dom_prompt_way_reconsider ]
006042DE    mov ecx, 0x864350
006042E3    cmovz esi, ecx                                  ; => [ String: dom_prompt_way_consider ]
006042E6    call 0x004C89A0
006042EB    mov dword ptr ss:[ebp+0x08], eax                ; => [ Call: sub_4c89a0 ]
006042EE    call 0x004DAD50                                 ; => [ Call: sub_4dad50 ]
...
00604348    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060435B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00604360    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
00604377    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
...
00604387    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
0060438C    mov eax, ebx
0060438E    mov ecx, dword ptr ss:[ebp-0x0C]
00604391    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00604398    pop ecx
00604399    pop edi
0060439A    pop esi
0060439B    pop ebx
...
006043B1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006043B6    inc dword ptr ds:[eax+0x04]
006043B9    mov dword ptr ss:[ebp-0x04], 0x03
006043C0    cmp dword ptr ds:[edi*8+0x7FCDD4], 0x04
006043C8    jnz 0x00604492                                  ; => [ Data: data_7fcdd4 ]
006043CE    push dword ptr ss:[ebp-0x20]
006043D1    lea eax, ss:[ebp-0x1C]
006043D4    push 0x8643A0
006043D9    push eax
006043DA    call 0x0063DF30                                 ; => [ String: N=%d | Call: sub_63df30 ]
006043DF    add esp, 0x0C
006043E2    mov eax, 0x801800                               ; => [ Data: data_801800 ]
006043E7    mov dword ptr ss:[ebp-0x10], eax                ; => [ Data: data_801800 ]
006043EA    mov byte ptr ss:[ebp-0x04], 0x05
006043EE    mov edx, eax                                    ; => [ Data: data_801800 ]
...
00604413    test al, al
00604415    jz 0x00604426                                   ; => [ Call: sub_62e860 ]
00604417    lea eax, ss:[ebp-0x10]
0060441A    push eax
0060441B    lea ecx, ss:[ebp+0x08]
0060441E    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0060443D    jz 0x0060445A                                   ; => [ Data: data_cf65bc ]
0060443F    lea ecx, ss:[ebp-0x10]
00604442    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00604455    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060445A    mov byte ptr ss:[ebp-0x04], 0x07
0060445E    cmp dword ptr ds:[0x00CF65BC], 0x00
00604465    jz 0x0060448E                                   ; => [ Data: data_cf65bc ]
...
00604476    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00604489    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060448E    mov byte ptr ss:[ebp-0x04], 0x03
00604492    mov ecx, dword ptr ss:[ebp-0x14]
00604495    mov edx, 0x01
0060449A    call 0x0059A910                                 ; => [ Call: sub_59a910 ]
0060449F    cmp dword ptr ds:[edi*8+0x7FCDD0], 0x00         ; => [ Data: data_7fcdd0 ]
...
006044BE    call 0x00604040                                 ; => [ Data: data_7fcdd4 | Call: sub_604040 ]
006044C3    mov byte ptr ss:[ebp-0x04], 0x08
006044C7    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006044CC    mov eax, dword ptr ss:[ebp-0x20]
006044CF    mov ecx, edx                                    ; => [ Data: data_801800 ]
...
006044F6    call 0x0063D850                                 ; => [ Data: data_7fcdd0 | Call: sub_63dfa0 | Call: sub_63d850 ]
006044FB    mov byte ptr ss:[ebp-0x04], 0x0A
006044FF    cmp dword ptr ds:[0x00CF65BC], 0x00
00604506    jz 0x0060452F                                   ; => [ Data: data_cf65bc ]
...
00604517    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060452A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060452F    mov byte ptr ss:[ebp-0x04], 0x0B
00604533    cmp dword ptr ds:[0x00CF65BC], 0x00
0060453A    jz 0x00604563                                   ; => [ Data: data_cf65bc ]
...
0060454B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060455E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00604575    jz 0x0060470B                                   ; => [ Data: data_7fcdd8 ]
0060457B    mov edx, dword ptr ds:[edi*8+0x7FCDDC]          ; => [ Data: data_7fcddc ]
00604582    mov byte ptr ss:[ebp-0x04], 0x0C
00604586    lea ecx, ss:[ebp-0x20]
00604589    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006045B0    call 0x0063D850                                 ; => [ Call: sub_604040 | Call: sub_63d850 ]
006045B5    mov byte ptr ss:[ebp-0x04], 0x10
006045B9    cmp dword ptr ds:[0x00CF65BC], 0x00
006045C0    jz 0x006045E9                                   ; => [ Data: data_cf65bc ]
...
006045D1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006045E4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00604607    call 0x0063D850                                 ; => [ Call: sub_63d850 | Call: sub_603160 ]
0060460C    mov byte ptr ss:[ebp-0x04], 0x0E
00604610    cmp dword ptr ds:[0x00CF65BC], 0x00
00604617    jz 0x00604640                                   ; => [ Data: data_cf65bc ]
...
00604628    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060463B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00604640    mov byte ptr ss:[ebp-0x04], 0x0C
00604644    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
...
00604656    call 0x00692C20                                 ; => [ Call: sub_692c20 ]
0060465B    add esp, 0x04
0060465E    mov edi, dword ptr ss:[ebp-0x14]
00604661    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00604666    mov ecx, dword ptr ss:[ebp-0x28]
00604669    mov eax, edx                                    ; => [ Data: data_801800 ]
...
00604693    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 | Data: data_7fcdd8 ]
00604698    mov byte ptr ss:[ebp-0x04], 0x12
0060469C    cmp dword ptr ds:[0x00CF65BC], 0x00
006046A3    jz 0x006046CC                                   ; => [ Data: data_cf65bc ]
...
006046B4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006046C7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006046E7    jz 0x00604704                                   ; => [ Data: data_cf65bc ]
006046E9    lea ecx, ss:[ebp-0x14]
006046EC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006046FF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00604718    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060473E    jz 0x0060475B                                   ; => [ Data: data_cf65bc ]
00604740    lea ecx, ss:[ebp+0x08]
00604743    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00604756    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060475B    mov eax, ebx
0060475D    mov ecx, dword ptr ss:[ebp-0x0C]
00604760    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00604767    pop ecx
00604768    pop edi
00604769    pop esi
0060476A    pop ebx
...
00604788    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: def.type == style | String: GetPromptCustom ]
0060478D    add esp, 0x0C
00604790    call 0x0063BC30
00604795    test al, al
00604797    jz 0x0060479A                                   ; => [ Call: sub_63bc30 ]
00604799    int3
0060479A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
