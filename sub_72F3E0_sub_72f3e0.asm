...
0072F3E5    push 0x772716                                   ; => [ Type: EHRegistrationNode | Call: sub_772716 ]
0072F3EA    mov eax, dword ptr fs:[0x00000000]
0072F3F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0072F4AE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0072F4C1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0072F4C6    mov dword ptr ss:[ebp-0x10], edi                ; => [ Data: data_801800 ]
...
0072F4DD    jz 0x0072F501                                   ; => [ Data: data_cf65bc ]
0072F4DF    lea ecx, ss:[ebp-0x18]
0072F4E2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0072F4F5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0072F4FA    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
0072F501    mov byte ptr ss:[ebp-0x04], 0x09
0072F505    cmp dword ptr ds:[0x00CF65BC], 0x00
0072F50C    jz 0x0072F53C                                   ; => [ Data: data_cf65bc ]
...
0072F51D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0072F530    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0072F535    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
0072F53C    mov byte ptr ss:[ebp-0x04], 0x08
0072F540    mov ecx, edi                                    ; => [ Data: data_801800 ]
0072F542    mov eax, dword ptr ss:[ebp-0x1C]
0072F545    mov edx, 0x03
0072F54A    test eax, eax
0072F54C    cmovnz ecx, eax
0072F54F    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
...
0072F5C8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0072F5DB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0072F5E0    mov eax, esi
0072F5E2    mov ecx, dword ptr ss:[ebp-0x0C]
0072F5E5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0072F5EC    pop ecx
0072F5ED    pop edi
0072F5EE    pop esi
0072F5EF    pop ebx
...
0072F5F2    pop ebp
0072F5F3    ret
0072F5F4    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
0072F5F9    push 0x19
0072F5FB    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
0072F600    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
...
0072F620    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 | Call: sub_69ec60 ]
0072F625    add esp, 0x04
0072F628    test al, al
0072F62A    jnz 0x0072F593
0072F630    push 0x879A88                                   ; => [ String: AssetCatalogReloadAsWritable ]
0072F635    push 0x149
0072F63A    push 0x87982C                                   ; => [ String: C:\x\ax2017\Engine\AssetCatalog.cpp ]
0072F63F    mov ecx, 0x8027A0                               ; => [ String: result ]
0072F644    mov edx, edi
0072F646    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0072F64B    add esp, 0x0C
0072F64E    call 0x0063BC30
0072F653    test al, al
0072F655    jz 0x0072F658                                   ; => [ Call: sub_63bc30 ]
0072F657    int3
0072F658    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0072F65D    push 0x871DD4
0072F662    push 0x94
0072F667    push 0x871D5C
0072F66C    mov edx, 0x801800
0072F671    mov ecx, 0x871E0C
0072F676    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
0072F67B    add esp, 0x0C
0072F67E    call 0x0063BC30
0072F683    test al, al
0072F685    jz 0x0072F688                                   ; => [ Call: sub_63bc30 ]
0072F687    int3
0072F688    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
