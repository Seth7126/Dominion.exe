...
006761A9    mov eax, dword ptr ds:[0x008C4040]
...
006761C3    push eax
006761C4    call dword ptr ds:[0x00775394]
006761CA    call esi
...
00676BBD    call 0x0063B870
00676BC2    add esp, 0x0C
00676BC5    call 0x0063BC30
00676BCA    test al, al
00676BCC    jz 0x00676BCF
00676BCE    int3
00676BCF    call 0x0063BB00
