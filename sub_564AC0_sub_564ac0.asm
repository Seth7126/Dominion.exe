...
00564AD8    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
00564ADD    mov eax, dword ptr fs:[0x00000000]
00564AE3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00564AE4    push ebx
00564AE5    mov eax, 0x19A8
00564AEA    call 0x00761E50                                 ; => [ Call: __chkstk ]
00564AEF    mov eax, dword ptr ds:[0x008C4040]
00564AF4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00564AF6    mov dword ptr ss:[ebp-0x14], eax
00564AF9    push esi
00564AFA    push edi
00564AFB    push eax
00564AFC    lea eax, ss:[ebp-0x0C]
00564AFF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00564B05    mov dword ptr ss:[ebp-0xCA8], ecx
00564B0B    call 0x00573400                                 ; => [ Call: sub_573400 ]
00564B10    lea ecx, ss:[ebp-0x19B8]
00564B16    push 0x04
00564B18    push ecx
00564B19    mov edx, dword ptr ds:[eax+0x0C]
00564B1C    mov ecx, dword ptr ds:[eax+0x04]
00564B1F    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00564B24    mov ecx, 0x321
00564B29    mov dword ptr ss:[ebp-0xD38], eax
00564B2F    lea esi, ss:[ebp-0x19B8]
00564B35    mov dword ptr ss:[ebp-0xD00], 0x81F2B8          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_0ddb585d263783132cd3ba43c0d7763b>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_0ddb585d263783132cd3ba43c0d7763b>,bool,enum CardID>::VTable ]
00564B3F    lea edi, ss:[ebp-0xCA0]
00564B45    add esp, 0x08
00564B48    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00564B4A    lea ecx, ds:[ebx+0x08]
00564B4D    mov dword ptr ss:[ebp-0xCFC], ecx
00564B53    lea ecx, ss:[ebp-0xD00]
00564B59    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_0ddb585d263783132cd3ba43c0d7763b>,bool,enum CardID>::VTable ]
...
00564BDB    push eax
00564BDC    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00564C0A    movlpd qword ptr ss:[ebp-0xCC4], xmm0           ; => [ Call: __builtin_memset ]
...
00564C76    mov esi, eax                                    ; => [ Call: sub_563c40 ]
00564C78    add esp, 0x0C
00564C7B    test esi, esi
00564C7D    jz 0x00564CB4
00564C7F    call 0x00573400                                 ; => [ Call: sub_573400 ]
00564C84    push 0x04
00564C86    push 0x00
00564C88    push 0x00
...
00564CAB    test al, al
00564CAD    cmovz esi, ecx                                  ; => [ Call: sub_583720 | Call: nullptr ]
00564CB0    mov eax, esi
00564CB2    jmp 0x00564CB6
00564CB4    xor eax, eax                                    ; => [ Call: nullptr ]
00564CB6    mov ecx, dword ptr ss:[ebp-0x0C]
00564CB9    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00564CC0    pop ecx
00564CC1    pop edi
00564CC2    pop esi
00564CC3    mov ecx, dword ptr ss:[ebp-0x14]
00564CC6    xor ecx, ebp
00564CC8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
