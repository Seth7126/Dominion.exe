...
00561B1D    push 0x81EAA0
00561B22    push 0x63
00561B24    mov ecx, 0x81EAAC
00561B29    jmp 0x00561C32
00561B2E    call 0x00573400
...
00561B6B    push 0x3EA
00561B70    push edi
00561B71    call 0x00588DB0
00561B76    add esp, 0x24
00561B79    call 0x00573400
...
00561BA7    call 0x0075927A
00561BAC    mov esp, ebp
00561BAE    pop ebp
00561BAF    ret
00561BB0    call 0x00573400
00561BB5    push 0x00
00561BB7    push ebx
00561BB8    push edi
...
00561C1D    call 0x0075927A
00561C22    mov esp, ebp
00561C24    pop ebp
00561C25    ret
00561C26    push 0x81EA64
00561C2B    mov ecx, 0x813C5C
00561C30    push 0x52
00561C32    push 0x81EA70
00561C37    mov edx, 0x801800
00561C3C    call 0x0063B870
00561C41    add esp, 0x0C
00561C44    call 0x0063BC30
00561C49    test al, al
00561C4B    jz 0x00561C4E
00561C4D    int3
00561C4E    call 0x0063BB00
