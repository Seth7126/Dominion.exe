...
004FD1DB    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FD1E0    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004FD211    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_562730 ]
...
004FD240    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FD258    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FD279    test al, al
004FD27B    jz 0x004FD2B3                                   ; => [ Call: sub_5754f0 ]
004FD27D    mov ecx, 0x102
004FD282    call 0x00563590                                 ; => [ Call: sub_563590 ]
004FD287    mov ebx, eax
004FD289    test ebx, ebx
004FD28B    jz 0x004FD2B3
004FD28D    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FD292    push 0x04
004FD294    push 0x00
004FD296    push 0x00
...
004FD2A5    push 0x476
004FD2AA    push ebx
004FD2AB    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
004FD2B0    add esp, 0x1C
004FD2B3    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FD2B8    mov ebx, dword ptr ds:[eax+0x04]
004FD2BB    cmp esi, 0x320
004FD2C1    jb 0x004FD2C8
004FD2C3    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FD2E1    test al, al
004FD2E3    jz 0x004FD31B                                   ; => [ Call: sub_5754f0 ]
004FD2E5    mov ecx, 0x501
004FD2EA    call 0x00563590                                 ; => [ Call: sub_563590 ]
004FD2EF    mov ebx, eax
004FD2F1    test ebx, ebx
004FD2F3    jz 0x004FD31B
004FD2F5    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FD2FA    push 0x04
004FD2FC    push 0x00
004FD2FE    push 0x00
...
004FD375    push 0x476
004FD37A    push esi
004FD37B    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
...
004FD39C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
