...
0052347B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00523480    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005234A8    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_56ca80 ]
005234AA    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005234DF    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
005234E4    mov ecx, dword ptr ss:[esp+0x1948]
005234EB    add esp, 0x2C
005234EE    pop edi
005234EF    pop esi
005234F0    xor ecx, esp
005234F2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
