...
004C0D72    mov dword ptr fs:[0x00000000], eax
...
004C0D86    call 0x0063D720
004C0D8B    mov eax, dword ptr ss:[ebp-0x10]
004C0D8E    mov ebx, 0x801800
004C0D93    test eax, eax
004C0D95    mov ecx, ebx
...
004C0DEE    jz 0x004C0E12
004C0DF0    lea ecx, ss:[ebp-0x10]
004C0DF3    call 0x0063D4E0
...
004C0E06    call 0x0064C080
004C0E0B    mov dword ptr ss:[ebp-0x10], 0x801800
...
004C0E30    cmovz eax, ecx
004C0E33    mov dword ptr ds:[0x008DB660], eax
004C0E38    xor al, al
004C0E3A    mov ecx, dword ptr ss:[ebp-0x0C]
004C0E3D    mov dword ptr fs:[0x00000000], ecx
004C0E44    pop ecx
004C0E45    pop edi
004C0E46    pop esi
004C0E47    pop ebx
...
004C0E57    call 0x0063D720
004C0E5C    mov eax, dword ptr ss:[ebp+0x08]
004C0E5F    mov ecx, ebx
...
004C0EA2    jz 0x004C0EC6
004C0EA4    lea ecx, ss:[ebp+0x08]
004C0EA7    call 0x0063D4E0
...
004C0EBA    call 0x0064C080
004C0EBF    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C0F3F    jz 0x004C0F63
004C0F41    lea ecx, ss:[ebp+0x08]
004C0F44    call 0x0063D4E0
...
004C0F57    call 0x0064C080
004C0F5C    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C0FDC    jz 0x004C1000
004C0FDE    lea ecx, ss:[ebp+0x08]
004C0FE1    call 0x0063D4E0
...
004C0FF4    call 0x0064C080
004C0FF9    mov dword ptr ss:[ebp+0x08], 0x801800
004C1000    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C1007    test esi, esi
004C1009    jnz 0x004C1018
004C100B    mov dword ptr ds:[0x008DB7F8], esi
...
004C1023    call 0x0063D720
004C1028    mov eax, dword ptr ss:[ebp+0x08]
004C102B    mov ecx, ebx
...
004C106E    jz 0x004C1092
004C1070    lea ecx, ss:[ebp+0x08]
004C1073    call 0x0063D4E0
...
004C1086    call 0x0064C080
004C108B    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C10AC    call 0x0063D720
004C10B1    mov eax, dword ptr ss:[ebp+0x08]
004C10B4    mov ecx, ebx
...
004C10FC    jz 0x004C1120
004C10FE    lea ecx, ss:[ebp+0x08]
004C1101    call 0x0063D4E0
...
004C1114    call 0x0064C080
004C1119    mov dword ptr ss:[ebp+0x08], 0x801800
004C1120    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C1127    test esi, esi
004C1129    jnz 0x004C113D
004C112B    mov dword ptr ds:[0x008DB7F8], 0x02
...
004C1148    call 0x0063D720
004C114D    mov eax, dword ptr ss:[ebp+0x08]
004C1150    mov ecx, ebx
...
004C1193    jz 0x004C11B7
004C1195    lea ecx, ss:[ebp+0x08]
004C1198    call 0x0063D4E0
...
004C11AB    call 0x0064C080
004C11B0    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C11D1    call 0x0063D720
004C11D6    mov eax, dword ptr ss:[ebp+0x08]
004C11D9    mov ecx, ebx
...
004C121C    jz 0x004C1240
004C121E    lea ecx, ss:[ebp+0x08]
004C1221    call 0x0063D4E0
...
004C1234    call 0x0064C080
004C1239    mov dword ptr ss:[ebp+0x08], 0x801800
004C1240    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C1247    test esi, esi
004C1249    jnz 0x004C125D
004C124B    mov dword ptr ds:[0x008DB7F8], 0x03
...
004C1268    call 0x0063D720
004C126D    mov eax, dword ptr ss:[ebp+0x08]
004C1270    mov ecx, ebx
...
004C12B3    jz 0x004C12D7
004C12B5    lea ecx, ss:[ebp+0x08]
004C12B8    call 0x0063D4E0
...
004C12CB    call 0x0064C080
004C12D0    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C12F7    mov eax, dword ptr ds:[eax+0x4254]
...
004C1311    push esi
004C1312    push 0x02
004C1314    call dword ptr ds:[0x007750D4]
004C131A    push esi
...
004C1325    push eax
004C1326    call 0x00761FBE
004C132B    add esp, 0x0C
004C132E    push edi
004C132F    call dword ptr ds:[0x007750F8]
004C1335    push 0x00
004C1337    call dword ptr ds:[0x00775370]
...
004C1357    mov dword ptr fs:[0x00000000], ecx
004C135E    pop ecx
004C135F    pop edi
004C1360    pop esi
004C1361    pop ebx
...
004C1371    call 0x0063D720
004C1376    mov eax, dword ptr ss:[ebp+0x08]
004C1379    mov ecx, ebx
...
004C13BC    jz 0x004C13E0
004C13BE    lea ecx, ss:[ebp+0x08]
004C13C1    call 0x0063D4E0
...
004C13D4    call 0x0064C080
004C13D9    mov dword ptr ss:[ebp+0x08], 0x801800
004C13E0    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004C13E7    test esi, esi
004C13E9    jnz 0x004C1546
004C13EF    mov edx, dword ptr ds:[0x008DB7FC]
...
004C140B    call 0x0063D720
004C1410    mov dword ptr ss:[ebp-0x04], 0x0A
004C1417    lea eax, ss:[ebp+0x08]
004C141A    push eax
004C141B    mov ecx, 0x8DB76C
004C1420    mov dword ptr ds:[0x008DB6B0], 0x22
004C142A    mov dword ptr ds:[0x008DB768], 0x8DBC6C
004C1434    mov dword ptr ds:[0x008DB770], 0x4C1EB0
004C143E    mov dword ptr ds:[0x008DB774], 0x4BFB50
004C1448    call 0x0063D850
004C144D    mov dword ptr ds:[0x008DB778], 0x04
004C1457    mov dword ptr ss:[ebp-0x04], 0x0B
004C145E    cmp dword ptr ds:[0x00CF65BC], esi
004C1464    jz 0x004C1E32
...
004C1484    jnz 0x004C1E32
004C148A    push dword ptr ds:[edi+0x08]
004C148D    mov ecx, dword ptr ds:[0x008DB7F8]
004C1493    call 0x004C0CC0
004C1498    mov esi, dword ptr ds:[0x00CC8D5C]
...
004C14AF    call 0x004BBDB0
004C14B4    imul edi, dword ptr ds:[0x008DBF50], 0x22C
...
004C1523    call 0x004B40B0
004C1528    mov dword ptr ds:[0x008DB660], 0x10
004C1532    xor al, al
004C1534    mov ecx, dword ptr ss:[ebp-0x0C]
004C1537    mov dword ptr fs:[0x00000000], ecx
004C153E    pop ecx
004C153F    pop edi
004C1540    pop esi
004C1541    pop ebx
...
004C1551    call 0x0063D720
004C1556    mov eax, dword ptr ss:[ebp+0x08]
004C1559    mov ecx, ebx
...
004C159C    jz 0x004C15C0
004C159E    lea ecx, ss:[ebp+0x08]
004C15A1    call 0x0063D4E0
...
004C15B4    call 0x0064C080
004C15B9    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C15DA    call 0x004C0CC0
004C15DF    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004C15FA    call 0x004B40B0
004C15FF    xor al, al
004C1601    mov ecx, dword ptr ss:[ebp-0x0C]
004C1604    mov dword ptr fs:[0x00000000], ecx
004C160B    pop ecx
004C160C    pop edi
004C160D    pop esi
004C160E    pop ebx
...
004C161E    call 0x0063D720
004C1623    mov eax, dword ptr ss:[ebp+0x08]
004C1626    mov ecx, ebx
...
004C166C    jz 0x004C1690
004C166E    lea ecx, ss:[ebp+0x08]
004C1671    call 0x0063D4E0
...
004C1684    call 0x0064C080
004C1689    mov dword ptr ss:[ebp+0x08], 0x801800
...
004C16AE    call 0x004C0CC0
004C16B3    mov ecx, dword ptr ds:[0x00CC8D5C]
...
004C16D0    mov dword ptr ds:[0x008DB804], eax
...
004C1AD2    call 0x0064C080
004C1AD7    mov dword ptr ss:[ebp-0x14], 0x801800
004C1ADE    mov byte ptr ss:[ebp-0x04], 0x26
004C1AE2    cmp dword ptr ds:[0x00CF65BC], 0x00
004C1AE9    jz 0x004C1DCE
...
004C1D8E    call 0x0064C080
004C1D93    mov dword ptr ss:[ebp-0x14], 0x801800
004C1D9A    mov byte ptr ss:[ebp-0x04], 0x36
004C1D9E    cmp dword ptr ds:[0x00CF65BC], 0x00
004C1DA5    jz 0x004C1DCE
...
004C1DFD    call 0x0064C080
004C1E02    xor al, al
004C1E04    mov ecx, dword ptr ss:[ebp-0x0C]
004C1E07    mov dword ptr fs:[0x00000000], ecx
004C1E0E    pop ecx
004C1E0F    pop edi
004C1E10    pop esi
004C1E11    pop ebx
...
004C1E14    pop ebp
004C1E15    ret
004C1E16    mov dword ptr ds:[0x008DB7F8], 0x01
004C1E20    mov ecx, 0x01
004C1E25    xor edx, edx
004C1E27    mov dword ptr ds:[0x008DB7FC], edx
004C1E2D    call 0x004C2AC0
004C1E32    xor al, al
004C1E34    mov ecx, dword ptr ss:[ebp-0x0C]
004C1E37    mov dword ptr fs:[0x00000000], ecx
004C1E3E    pop ecx
004C1E3F    pop edi
004C1E40    pop esi
004C1E41    pop ebx
