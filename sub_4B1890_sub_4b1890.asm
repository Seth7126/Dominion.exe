...
004B18A8    push 0x76281B                                   ; => [ Call: sub_76281b | Type: EHRegistrationNode ]
004B18AD    mov eax, dword ptr fs:[0x00000000]
004B18B3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004B18B4    push ebx
004B18B5    mov eax, 0x11C0
004B18BA    call 0x00761E50                                 ; => [ Call: __chkstk ]
004B18BF    mov eax, dword ptr ds:[0x008C4040]
004B18C4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
004B18C6    mov dword ptr ss:[ebp-0x14], eax
004B18C9    push esi
004B18CA    push edi
004B18CB    push eax
004B18CC    lea eax, ss:[ebp-0x0C]
004B18CF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004B18F9    movq qword ptr ss:[ebp-0x11C0], xmm0            ; => [ Call: __builtin_memset ]
004B1901    push 0x00
004B1903    push eax
004B1904    movups xmmword ptr ss:[ebp-0x11B8], xmm0
004B190B    mov dword ptr ss:[ebp-0x1190], 0x801800         ; => [ Data: data_801800 ]
004B1915    movups xmmword ptr ss:[ebp-0x11A8], xmm0
004B191C    mov dword ptr ss:[ebp-0x118C], 0x801800         ; => [ Data: data_801800 ]
004B1926    movq qword ptr ss:[ebp-0x1198], xmm0
004B192E    mov dword ptr ss:[ebp-0x1188], 0x801800         ; => [ Data: data_801800 ]
004B1938    mov dword ptr ss:[ebp-0x1184], 0x00
004B1942    call 0x00761FC4                                 ; => [ Call: memset ]
...
004B1986    mov dword ptr ss:[ebp-0x1168], eax              ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004B198C    call 0x004D8F30
004B1991    lea edx, ss:[ebp-0x1180]
004B1997    mov ecx, dword ptr ds:[eax]                     ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004B1999    test ecx, ecx
004B199B    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
004B19B2    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004B19B8    mov edi, dword ptr ds:[ebx+0x08]
004B19BB    mov dword ptr ss:[ebp-0xF40], 0x03
004B19C5    mov dword ptr ss:[ebp-0xF3C], edi
004B19CB    mov dword ptr ss:[ebp-0xF54], 0x64726148        ; => [ String: Hard AI | Call: __builtin_strcpy ]
...
004B1A0E    mov esi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_4badc0 ]
...
004B1A26    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B1A3F    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
004B1A58    jz 0x004B1A78                                   ; => [ Data: data_cf65bc ]
004B1A5A    lea ecx, ss:[ebp-0x11C4]
004B1A60    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B1A73    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004B1AB4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B1AB9    mov dword ptr ss:[ebp-0x118C], 0x801800         ; => [ Data: data_801800 ]
...
004B1ADE    push eax
004B1ADF    call 0x004B1B50                                 ; => [ Call: sub_4b1b50 ]
004B1AE4    lea ecx, ss:[ebp-0x11B8]
004B1AEA    call 0x004AB0E0                                 ; => [ Call: Concurrency::details::_Micro_queue::_Pop_finalizer::~_Pop_finalizer ]
004B1AEF    mov eax, dword ptr ss:[ebp-0x11C8]
004B1AF5    mov ecx, dword ptr ss:[ebp-0x0C]
004B1AF8    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B1AFF    pop ecx
004B1B00    pop edi
004B1B01    pop esi
004B1B02    mov ecx, dword ptr ss:[ebp-0x14]
004B1B05    xor ecx, ebp
004B1B07    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004B1B29    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004B1B2E    add esp, 0x0C
004B1B31    call 0x0063BC30
004B1B36    test al, al
004B1B38    jz 0x004B1B3B                                   ; => [ Call: sub_63bc30 ]
004B1B3A    int3
004B1B3B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
