...
004E6295    push 0x76461D                                   ; => [ Call: __ehhandler$??1?$ListArray@VScheduleGroupSegmentBase@details@Concurrency@@@details@Concurrency@@QAE@XZ | Type: EHRegistrationNode ]
004E629A    mov eax, dword ptr fs:[0x00000000]
004E62A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E6323    push 0x871DD4                                   ; => [ String: XString::XString ]
004E6328    push 0x9A
004E632D    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
004E6332    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
004E6337    jmp 0x004E653C
004E633C    mov eax, edi
004E633E    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004E6345    sub eax, ebx
004E6347    sub eax, 0x03
004E634A    push eax
004E634B    push ecx
004E634C    lea ecx, ss:[ebp-0x10]
004E634F    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
004E6354    lea eax, ss:[ebp-0x10]
004E6357    mov byte ptr ss:[ebp-0x04], 0x02
004E635B    push eax
004E635C    lea ecx, ss:[ebp-0x14]
004E635F    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
004E6364    mov byte ptr ss:[ebp-0x04], 0x03
004E6368    cmp dword ptr ds:[0x00CF65BC], 0x00
004E636F    jz 0x004E639F                                   ; => [ Data: data_cf65bc ]
...
004E6380    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E6393    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E6398    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004E639F    lea edx, ds:[edi+0x03]
004E63A2    mov byte ptr ss:[ebp-0x04], 0x01
004E63A6    test edx, edx
004E63A8    jnz 0x004E63C3
004E63AA    push 0x871DD4                                   ; => [ String: XString::XString ]
004E63AF    push 0x94
004E63B4    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
004E63B9    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
004E63BE    jmp 0x004E653C
004E63C3    lea ecx, ss:[ebp-0x10]
004E63C6    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
004E63CB    lea eax, ss:[ebp-0x10]
004E63CE    mov byte ptr ss:[ebp-0x04], 0x04
004E63D2    push eax
004E63D3    lea ecx, ss:[ebp-0x18]
004E63D6    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
004E63DB    mov byte ptr ss:[ebp-0x04], 0x05
004E63DF    cmp dword ptr ds:[0x00CF65BC], 0x00
004E63E6    jz 0x004E640F                                   ; => [ Data: data_cf65bc ]
...
004E63F7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E640A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E641F    push 0x871DD4                                   ; => [ String: XString::XString ]
004E6424    push 0x94
004E6429    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
004E642E    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
004E6433    jmp 0x004E653C
004E6438    lea ecx, ss:[ebp-0x10]
004E643B    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
004E6440    lea eax, ss:[ebp-0x10]
004E6443    mov byte ptr ss:[ebp-0x04], 0x06
004E6447    push eax
004E6448    lea ecx, ss:[ebp-0x14]
004E644B    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
004E6450    mov byte ptr ss:[ebp-0x04], 0x07
004E6454    cmp dword ptr ds:[0x00CF65BC], 0x00
004E645B    jz 0x004E6484                                   ; => [ Data: data_cf65bc ]
...
004E646C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E647F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E64A6    call 0x004E5FF0                                 ; => [ Call: sub_4e5e30 | Call: sub_4e5ff0 ]
...
004E64C2    jz 0x004E64DF                                   ; => [ Data: data_cf65bc ]
004E64C4    lea ecx, ss:[ebp-0x18]
004E64C7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E64FE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E6511    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E6516    mov ecx, dword ptr ss:[ebp-0x0C]
004E6519    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E6520    pop ecx
004E6521    pop edi
004E6522    pop esi
004E6523    pop ebx
...
004E6526    pop ebp
004E6527    ret
004E6528    push 0x808488                                   ; => [ String: FromCampaignMissionString ]
004E652D    push 0x16C4
004E6532    push 0x806FE4                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameShared.cpp ]
004E6537    mov ecx, 0x8084A4                               ; => [ String: strK ]
004E653C    mov edx, 0x801800
004E6541    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004E6546    add esp, 0x0C
004E6549    call 0x0063BC30
004E654E    test al, al
004E6550    jz 0x004E6553                                   ; => [ Call: sub_63bc30 ]
004E6552    int3
004E6553    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
