...
0068CF55    push 0x76E13D                                   ; => [ Type: EHRegistrationNode | Call: sub_76e13d ]
0068CF5A    mov eax, dword ptr fs:[0x00000000]
0068CF60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068CFE1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068D04E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068D07E    dec eax
0068D07F    push eax
0068D080    call 0x0063E9E0                                 ; => [ Call: sub_63e9e0 ]
...
0068D0BC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068D0CF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068D0D4    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0068D0DB    mov eax, dword ptr ss:[ebp-0x18]
0068D0DE    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
0068D0F3    test al, al
0068D0F5    jz 0x0068D12E                                   ; => [ Call: sub_68cd20 ]
0068D0F7    mov eax, dword ptr ds:[ebx]
0068D0F9    mov ecx, esi                                    ; => [ Data: data_801800 ]
0068D0FB    test eax, eax
0068D0FD    cmovnz ecx, eax
0068D100    call 0x0068CD20
0068D105    test al, al
0068D107    jz 0x0068D12E                                   ; => [ Call: sub_68cd20 ]
...
0068D117    test al, al
0068D119    setz al                                         ; => [ Call: sub_68cd20 ]
0068D11C    mov ecx, dword ptr ss:[ebp-0x0C]
0068D11F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068D126    pop ecx
0068D127    pop edi
0068D128    pop esi
0068D129    pop ebx
...
0068D133    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068D13A    pop ecx
0068D13B    pop edi
0068D13C    pop esi
0068D13D    pop ebx
