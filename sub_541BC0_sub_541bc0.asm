...
00541BC9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00541BCE    xor eax, esp
00541BD0    mov dword ptr ss:[esp+0x74], eax
00541BD4    push esi
00541BD5    push edi
00541BD6    call 0x00573400
00541BDB    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
...
00541BF0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00541C0A    jz 0x00541D10                                   ; => [ Call: sub_565de0 ]
...
00541C29    mov eax, dword ptr ds:[eax+0x64]                ; => [ Call: sub_573400 ]
...
00541C42    push 0x03
00541C44    movups xmm1, xmmword ptr ds:[eax]               ; => [ Call: sub_576c00 ]
00541C47    lea eax, ss:[esp+0x6C]
00541C4B    push eax
00541C4C    movaps xmmword ptr ss:[esp+0x50], xmm1
00541C51    call 0x00576C00                                 ; => [ Call: sub_576c00 ]
...
00541C98    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00541C9B    mov dword ptr ss:[esp+0x14], eax
00541C9F    cmp esi, 0x320
00541CA5    jb 0x00541CB0
00541CA7    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00541CCB    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00541CCE    mov dword ptr ss:[esp+0x14], eax
00541CD2    cmp esi, 0x320
00541CD8    jb 0x00541CE3
00541CDA    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00541D07    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00541D1A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00541D3C    call 0x0063B870                                 ; => [ String: c.triggerInfo->type == TRIGGERINFO_GAIN | Call: sub_63b870 | Data: data_801800 | String: CostAtGainMoment | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00541D41    add esp, 0x0C
00541D44    call 0x0063BC30
00541D49    test al, al
00541D4B    jz 0x00541D4E                                   ; => [ Call: sub_63bc30 ]
00541D4D    int3
00541D4E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
