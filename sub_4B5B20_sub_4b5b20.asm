...
004B5B25    push 0x762BA5                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??0?$propagator_block@V?$single_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@V?$multi_link_registry@V?$ISource@W4agent_status@Concurrency@@@Concurrency@@@2@V?$ordered_message_processor@I@2@@Concurrency@@QAE@XZ ]
004B5B2A    mov eax, dword ptr fs:[0x00000000]
004B5B30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004B5B31    sub esp, 0x08
004B5B34    push esi
004B5B35    push edi
004B5B36    mov eax, dword ptr ds:[0x008C4040]
004B5B3B    xor eax, ebp
004B5B3D    push eax                                        ; => [ Data: __security_cookie ]
004B5B3E    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
004B5B41    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004B5B69    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_msg_time_expired_header ]
004B5B6E    add esp, 0x04
004B5B71    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004B5B76    test eax, eax
004B5B78    jnz 0x004B5B81
004B5B7A    mov ecx, 0x802238                               ; => [ String: dom_msg_time_expired_header ]
004B5B7F    jmp 0x004B5B8A
004B5B81    mov eax, dword ptr ds:[eax]
004B5B83    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004B5B9C    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_msg_time_expired_body | Call: sub_63d8d0 ]
...
004B5BB0    push edi
004B5BB1    call 0x0063D8D0                                 ; => [ String: dom_msg_time_expired_body | Call: sub_63d8d0 ]
004B5BB6    mov ecx, dword ptr ss:[ebp-0x0C]
004B5BB9    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B5BC0    pop ecx
004B5BC1    pop edi
004B5BC2    pop esi
...
004B5BD1    push edi
004B5BD2    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
004B5BD7    mov ecx, dword ptr ss:[ebp-0x0C]
004B5BDA    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B5BE1    pop ecx
004B5BE2    pop edi
004B5BE3    pop esi
...
004B5BEF    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_msg_opponent_forfeit_header ]
004B5BF4    add esp, 0x04
004B5BF7    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004B5BFC    test eax, eax
004B5BFE    jnz 0x004B5C07
004B5C00    mov ecx, 0x8021EC                               ; => [ String: dom_msg_opponent_forfeit_header ]
004B5C05    jmp 0x004B5C10
004B5C07    mov eax, dword ptr ds:[eax]
004B5C09    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004B5C22    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | Call: sub_63d8d0 | String: dom_msg_opponent_forfeit_body ]
004B5C27    add esp, 0x04
004B5C2A    test eax, eax
004B5C2C    jnz 0x004B5C35
004B5C2E    mov ecx, 0x80220C                               ; => [ String: dom_msg_opponent_forfeit_body ]
004B5C33    jmp 0x004B5C3E
004B5C35    mov eax, dword ptr ds:[eax]
004B5C37    mov ecx, edi                                    ; => [ Data: data_801800 ]
004B5C39    test eax, eax
004B5C3B    cmovnz ecx, eax
004B5C3E    mov esi, dword ptr ss:[ebp+0x10]
004B5C41    push ecx
004B5C42    mov ecx, esi
004B5C44    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
004B5C6F    call 0x0063D850                                 ; => [ String: [player] | Call: sub_63dfa0 | Call: sub_63d850 ]
004B5C74    mov dword ptr ss:[ebp-0x04], 0x03
004B5C7B    cmp dword ptr ds:[0x00CF65BC], 0x00
004B5C82    jz 0x004B5D69                                   ; => [ Data: data_cf65bc ]
...
004B5CAD    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | String: dom_msg_opponent_forfeit_header ]
004B5CB2    add esp, 0x04
004B5CB5    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004B5CBA    test eax, eax
004B5CBC    jnz 0x004B5CC5
004B5CBE    mov ecx, 0x8021EC                               ; => [ String: dom_msg_opponent_forfeit_header ]
004B5CC3    jmp 0x004B5CCE
004B5CC5    mov eax, dword ptr ds:[eax]
004B5CC7    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004B5CE0    call 0x0068CAF0                                 ; => [ Call: nullptr | Call: sub_68caf0 | Call: sub_63d8d0 | String: dom_msg_opponent_forfeit_body ]
004B5CE5    add esp, 0x04
004B5CE8    test eax, eax
004B5CEA    jnz 0x004B5CF3
004B5CEC    mov ecx, 0x80220C                               ; => [ String: dom_msg_opponent_forfeit_body ]
004B5CF1    jmp 0x004B5CFC
004B5CF3    mov eax, dword ptr ds:[eax]
004B5CF5    mov ecx, edi                                    ; => [ Data: data_801800 ]
004B5CF7    test eax, eax
004B5CF9    cmovnz ecx, eax
004B5CFC    mov esi, dword ptr ss:[ebp+0x10]
004B5CFF    push ecx
004B5D00    mov ecx, esi
004B5D02    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
004B5D2D    call 0x0063D850                                 ; => [ String: [player] | Call: sub_63dfa0 | Call: sub_63d850 ]
004B5D32    mov dword ptr ss:[ebp-0x04], 0x01
004B5D39    cmp dword ptr ds:[0x00CF65BC], 0x00
004B5D40    jz 0x004B5D69                                   ; => [ Data: data_cf65bc ]
...
004B5D51    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004B5D64    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004B5D69    mov ecx, dword ptr ss:[ebp-0x0C]
004B5D6C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004B5D73    pop ecx
004B5D74    pop edi
004B5D75    pop esi
...
004B5D93    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: GameDismissDlgStrings | String: Halt | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
004B5D98    add esp, 0x0C
004B5D9B    call 0x0063BC30
004B5DA0    test al, al
004B5DA2    jz 0x004B5DA5                                   ; => [ Call: sub_63bc30 ]
004B5DA4    int3
004B5DA5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
