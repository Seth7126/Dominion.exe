...
0065855C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00658589    xor eax, eax                                    ; => [ Call: nullptr ]
0065858B    jmp 0x00658592
0065858D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
006585B7    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
006585BC    cmp dword ptr ds:[0x00C23BD4], 0x400            ; => [ Data: data_c23bd4 ]
...
006585D8    push 0x874440                                   ; => [ String: UI2DefGet ]
006585DD    push 0xC16
006585E2    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
006585E7    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
006585EC    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
006585F1    jmp 0x00658D58
006585F6    cmp dword ptr ds:[ecx+0x04], 0x22
006585FA    jz 0x00658615
006585FC    push 0x874440                                   ; => [ String: UI2DefGet ]
00658601    push 0xC17
00658606    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
0065860B    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
00658610    jmp 0x00658D53
00658615    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
00658634    call 0x006653B0                                 ; => [ Call: sub_6653b0 ]
...
0065868B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00658690    mov ecx, dword ptr ss:[esp+0x0C]
00658694    mov dword ptr ds:[edi+0x15D8], 0x801800         ; => [ Data: data_801800 ]
0065869E    sub ecx, 0x01
006586A1    mov dword ptr ds:[edi+0x158C], 0x801800         ; => [ Data: data_801800 ]
...
00658730    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00658735    mov dword ptr ds:[edi+0x15FC], 0x801800         ; => [ Data: data_801800 ]
0065873F    mov ecx, dword ptr ds:[edi+0x13A4]
00658745    test ecx, ecx
00658747    jz 0x00658783
00658749    call 0x006A82E0                                 ; => [ Call: sub_6a82e0 ]
0065874E    mov esi, eax
00658750    mov ecx, dword ptr ds:[esi+0x08]
00658753    call 0x007112E0                                 ; => [ Call: sub_7112e0 ]
00658758    mov ecx, dword ptr ds:[esi+0x04]
0065875B    call 0x00713890                                 ; => [ Call: sub_713890 ]
00658760    movzx ecx, word ptr ds:[esi+0x14]
00658764    mov edx, dword ptr ds:[0x00CAF778]              ; => [ Data: data_caf778 ]
0065876A    mov dword ptr ds:[0x00CAF778], ecx              ; => [ Data: data_caf778 ]
00658770    mov dword ptr ds:[esi+0x14], edx
00658773    dec dword ptr ds:[0x00CAF77C]                   ; => [ Data: data_caf77c ]
...
0065879C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006587A1    mov eax, dword ptr ss:[esp+0x0C]
006587A5    mov dword ptr ds:[eax+0x68], 0x00
006587AC    mov esi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006587B2    test esi, esi
006587B4    jnz 0x006587CC
006587B6    push 0x871F88                                   ; => [ String: GetGameData ]
006587BB    push 0x45
006587BD    push 0x871FA0                                   ; => [ String: C:\x\ax2017\Engine\Game.h ]
006587C2    mov ecx, 0x871F94                               ; => [ String: gpGameData ]
...
006587F5    mov esi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006587FB    mov eax, dword ptr ds:[edi+0x13B8]
00658801    test eax, eax
00658803    jz 0x0065883F
00658805    mov ecx, dword ptr ds:[0x0147ABF0]              ; => [ Data: data_147abf0 ]
...
0065882E    call dword ptr ds:[eax+0x28]                    ; => [ Data: data_147abec ]
00658831    mov eax, dword ptr ss:[esp+0x14]
00658835    mov esi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
0065886A    call 0x006B8440                                 ; => [ Call: sub_6b8440 ]
0065886F    mov esi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
0065889F    call 0x006DA670                                 ; => [ Call: sub_6da670 ]
006588A4    mov eax, dword ptr ds:[edi+0x13B8]
006588AA    test eax, eax
006588AC    jz 0x006588DA
006588AE    mov ecx, dword ptr ds:[0x0147ABF0]              ; => [ Data: data_147abf0 ]
...
006588D3    call dword ptr ds:[eax+0x28]                    ; => [ Data: data_147abec ]
...
00658915    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
...
0065895F    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
00658964    inc esi
...
00658987    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
...
006589B1    call 0x0064E810                                 ; => [ Call: sub_64e810 ]
006589B6    mov dword ptr ds:[edi+0x18A0], 0x00
006589C0    mov ecx, edi
006589C2    call 0x0067E6E0                                 ; => [ Call: sub_67e6e0 ]
006589C7    movzx eax, word ptr ds:[edi+0x18C8]
006589CE    mov ecx, dword ptr ds:[0x00C23BB4]              ; => [ Data: data_c23bb4 ]
006589D4    mov esi, dword ptr ss:[esp+0x1C]
006589D8    mov dword ptr ds:[0x00C23BB4], eax              ; => [ Data: data_c23bb4 ]
006589DD    mov dword ptr ds:[edi+0x18C8], ecx
006589E3    dec dword ptr ds:[0x00C23BB8]                   ; => [ Data: data_c23bb8 ]
006589E9    mov dword ptr ds:[esi+0x18A4], 0x00
006589F3    pop edi
006589F4    pop esi
006589F5    mov ecx, dword ptr ss:[esp+0x134]
006589FC    xor ecx, esp
006589FE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00658ABF    push 0x874440                                   ; => [ String: UI2DefGet ]
00658AC4    push 0xC16
00658AC9    mov edx, 0x874424                               ; => [ String: UI2DefGet on null pointer ]
00658ACE    mov ecx, 0x874470                               ; => [ Data: data_874470 ]
00658AD3    jmp 0x00658D83
00658AD8    cmp dword ptr ds:[ecx+0x04], 0x22
00658ADC    jnz 0x00658D6F
00658AE2    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
00658AE7    cmp dword ptr ds:[eax+0x08], 0x00
00658AEB    jnz 0x00658AF6
00658AED    movups xmm0, xmmword ptr ds:[0x007FF520]        ; => [ Data: data_7ff520 ]
...
00658B0C    movups xmm0, xmmword ptr ds:[eax]               ; => [ Call: nullptr | Call: sub_64f140 ]
...
00658B2F    call 0x0067D460                                 ; => [ Call: sub_67d460 | Data: data_147abe8 ]
...
00658BD2    call 0x00655430                                 ; => [ Call: sub_655430 ]
...
00658BFA    call 0x006580F0                                 ; => [ Call: sub_6580f0 ]
...
00658C37    call 0x00658160                                 ; => [ Data: data_7ff530 | Call: sub_658160 ]
...
00658C73    xor esi, esi                                    ; => [ Call: nullptr ]
...
00658C9D    jz 0x00658CDD                                   ; => [ String: mouse_over ]
...
00658CBC    jz 0x00658CDD                                   ; => [ String: mouse_down ]
...
00658CDB    jnz 0x00658CEC                                  ; => [ String: mouse_clicked ]
...
00658D0B    call 0x00666610                                 ; => [ Call: sub_666610 ]
...
00658D20    push 0x00
00658D22    push eax
00658D23    call 0x0065D0F0                                 ; => [ Call: sub_65d0f0 ]
00658D28    add esp, 0x08
00658D2B    mov ecx, dword ptr ss:[esp+0x13C]
00658D32    pop edi
00658D33    pop esi
00658D34    xor ecx, esp
00658D36    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00658D3B    mov esp, ebp
00658D3D    pop ebp
00658D3E    ret
00658D3F    push 0x876A2C                                   ; => [ String: XDynArray<struct TextEntry>::operator [] ]
00658D44    push 0xD4
00658D49    push 0x824FB0                                   ; => [ String: C:\x\ax2017\Engine\xDynArray.h ]
00658D4E    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
00658D53    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00658D58    call 0x0063B870                                 ; => [ Call: sub_63b870 ]
00658D5D    add esp, 0x0C
00658D60    call 0x0063BC30
00658D65    test al, al
00658D67    jz 0x00658D6A                                   ; => [ Call: sub_63bc30 ]
00658D69    int3
00658D6A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00658D6F    push 0x874440                                   ; => [ String: UI2DefGet ]
00658D74    push 0xC17
00658D79    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00658D7E    mov ecx, 0x87444C                               ; => [ String: ptr->assetType == ASSET_TYPE_UI2 ]
00658D83    push 0x8739B4
00658D88    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp ]
00658D8D    add esp, 0x0C
00658D90    call 0x0063BC30
00658D95    test al, al
00658D97    jz 0x00658D9A                                   ; => [ Call: sub_63bc30 ]
00658D99    int3
00658D9A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
