...
00628F35    mov dword ptr ds:[eax+0x18BC], 0x628BC0         ; => [ Call: sub_64e7a0 | Call: sub_628bc0 ]
00628F3F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00628F44    movss xmm3, dword ptr ds:[0x00890E18]
00628F4C    mov edx, 0xCADF48
00628F51    push 0x00
00628F53    push 0xFFFFFFFF
00628F55    mov ecx, eax
00628F57    call 0x00665DB0                                 ; => [ Data: data_cadf48 | Call: sub_665db0 ]
00628F5C    mov ecx, ebx
00628F5E    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
00628F63    movss xmm3, dword ptr ds:[0x00890E18]
00628F6B    mov edx, 0xBE41AC
00628F70    push 0x00
00628F72    push 0xFFFFFFFF
00628F74    mov ecx, eax
00628F76    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be41ac ]
00628F7B    mov esi, dword ptr ds:[0x00CCF698]              ; => [ Data: data_ccf698 ]
00628F81    mov eax, 0x66666667
00628F86    mov ecx, dword ptr ds:[0x00CCF69C]              ; => [ Data: data_ccf69c ]
...
00629026    call 0x00666120                                 ; => [ Data: data_be435c | Data: data_be4350 | Call: sub_666120 ]
0062902B    add esp, 0x10
0062902E    xor ebx, ebx                                    ; => [ Call: nullptr ]
00629030    test esi, esi
00629032    jle 0x0062918E
00629038    mov eax, dword ptr ss:[ebp-0x08]
0062903B    mov esi, 0x1A9727C                              ; => [ Data: data_1a9727c ]
00629040    lea eax, ds:[eax*4+0xCCEA18]                    ; => [ Data: data_ccea18 ]
...
00629058    call 0x00571B30                                 ; => [ Call: sub_571b30 | Data: data_b81820 ]
...
00629079    jnz 0x006290A1                                  ; => [ String: tbl_names ]
...
0062909F    jz 0x006290D2                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
006290A1    push ebx
006290A2    mov edx, 0x86FAAC
006290A7    call 0x0067BE20
006290AC    mov edi, eax                                    ; => [ Call: sub_67be20 ]
...
006290BF    mov dword ptr ds:[esi], 0x86FAAC                ; => [ String: tbl_names ]
...
006290D4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
