...
004D236C    push eax                                        ; => [ Data: __security_cookie ]
004D236D    lea eax, ss:[ebp-0x0C]
004D2370    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D2376    mov edx, 0x80525C
004D237B    lea ecx, ss:[ebp-0x10]
004D237E    call 0x0063D720                                 ; => [ String: btnContinue | Call: sub_63d720 ]
004D2383    mov edx, dword ptr ss:[ebp+0x08]
004D2386    mov esi, 0x801800                               ; => [ Data: data_801800 ]
004D238B    mov eax, dword ptr ss:[ebp-0x10]
004D238E    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
004D23D4    jz 0x004D23F1                                   ; => [ Data: data_cf65bc ]
004D23D6    lea ecx, ss:[ebp-0x10]
004D23D9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D246C    jz 0x004D2489                                   ; => [ Data: data_cf65bc ]
004D246E    lea ecx, ss:[ebp-0x10]
004D2471    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D2484    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004D24A1    call 0x00600670                                 ; => [ Call: sub_5a0c70 | Call: sub_600670 ]
004D24A6    xor dl, dl
004D24A8    lea ecx, ds:[esi+0x06]
004D24AB    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
004D24B0    xor dl, dl
004D24B2    lea ecx, ds:[esi+0x07]
004D24B5    call 0x004D46E0                                 ; => [ Call: sub_4d46e0 ]
004D24BA    xor al, al
004D24BC    mov ecx, dword ptr ss:[ebp-0x0C]
004D24BF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D24C6    pop ecx
004D24C7    pop edi
004D24C8    pop esi
004D24C9    pop ebx
