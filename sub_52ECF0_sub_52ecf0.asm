...
0052ED01    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0052ED04    cmp esi, 0x320
0052ED0A    jb 0x0052ED11
0052ED0C    call 0x00591930                                 ; => [ Call: sub_591930 ]
0052ED11    imul eax, esi, 0x64
0052ED14    push 0x00
0052ED16    push 0x04
0052ED18    mov esi, dword ptr ds:[eax+edi*1+0x1A4C]
0052ED1F    call 0x0056E820                                 ; => [ Call: sub_56e820 ]
...
0052ED47    setnle al                                       ; => [ Call: sub_568960 ]
0052ED4A    pop edi
0052ED4B    pop esi
