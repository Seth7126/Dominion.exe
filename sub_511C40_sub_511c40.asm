...
00511C51    add ebx, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 | Data: data_cca784 ]
00511C57    push esi
00511C58    push edi
...
00511C6B    mov dword ptr ds:[eax], 0x817054                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_4ce17992127bdcf5bd171802b7ced1a7>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
00511C71    mov dword ptr ds:[eax+0x24], eax
00511C74    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
00511C79    push 0x00
00511C7B    push 0x00
00511C7D    mov ecx, eax
00511C7F    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
...
00511C9E    mov eax, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
00511CA3    shl ecx, 0x0B
00511CA6    cmp dword ptr ds:[ecx+eax*1+0x30], edi
00511CAA    jnz 0x00511D1A                                  ; => [ Data: data_cca784 ]
00511CAC    sub esp, 0x28
00511CAF    xor edx, edx
00511CB1    mov eax, esp
00511CB3    mov ecx, 0xCCA794
00511CB8    mov dword ptr ds:[eax], 0x817038                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_a391d0f63133739a9242830e51bdd297>,bool,enum DomCardEnum>::`vftable'{for `std::_Func_base<bool,enum DomCardEnum>'} ]
00511CBE    mov dword ptr ds:[eax+0x24], eax
00511CC1    call 0x0050AD20                                 ; => [ Call: sub_50ad20 | Data: data_cca794 ]
...
00511CD5    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
00511CDA    add esp, 0x08
00511CDD    mov edx, dword ptr ds:[0x00CCA784]
00511CE3    mov eax, dword ptr ds:[0x00CCA780]              ; => [ Data: data_cca780 ]
00511CE8    shl edx, 0x0B
00511CEB    cmp dword ptr ds:[edx+eax*1+0x30], 0x00
00511CF0    jnz 0x00511D1A                                  ; => [ Data: data_cca784 ]
00511CF2    mov ecx, edi
00511CF4    call 0x00511A60                                 ; => [ Call: sub_511a60 ]
00511CF9    test eax, eax
00511CFB    jz 0x00511D10
00511CFD    push 0x00
00511CFF    push 0x02
00511D01    mov ecx, eax
00511D03    call 0x0050A6A0                                 ; => [ Call: sub_50a6a0 ]
...
00511D3A    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: what | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: Surprise_Combo::<lambda_6fbe01b24876e0525cfaa766eef76ee8>::operator () ]
00511D3F    add esp, 0x0C
00511D42    call 0x0063BC30
00511D47    test al, al
00511D49    jz 0x00511D4C                                   ; => [ Call: sub_63bc30 ]
00511D4B    int3
00511D4C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
