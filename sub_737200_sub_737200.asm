...
00737218    push 0x772CD5                                   ; => [ Type: EHRegistrationNode | Call: sub_772cd5 ]
0073721D    mov eax, dword ptr fs:[0x00000000]
00737223    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00737224    push ebx
...
00737231    push eax                                        ; => [ Data: __security_cookie ]
00737232    lea eax, ss:[ebp-0x0C]
00737235    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00737282    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
007372DD    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
00737330    xor edx, edx                                    ; => [ Call: nullptr ]
...
00737371    movq qword ptr ds:[ecx+0x10], xmm0              ; => [ String: 0 | String: zx ]
...
007373A1    movups xmmword ptr ss:[ebp-0x38], xmm0          ; => [ String: 0 | String: zx ]
...
007373ED    push 0x88F628                                   ; => [ String: XArray<struct PackAsset>::Append ]
007373F2    push 0x96
007373F7    mov ecx, 0x816BF8                               ; => [ String: mSize < mSizeReserved ]
007373FC    jmp 0x0073744A
007373FE    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
00737403    push 0x19
00737405    push 0x82829C                                   ; => [ String: C:\x\ax2017\Engine\DefLoad.h ]
0073740A    mov ecx, 0x8282BC                               ; => [ String: assetPtr && assetPtr->assetType == assetType ]
0073740F    jmp 0x0073744F
00737411    push 0x88F1F0                                   ; => [ String: AtlasMakerCalcImages ]
00737416    push 0x45C
0073741B    push 0x88F010                                   ; => [ String: C:\x\ax2017\Engine\Editor\AtlasMaker.cpp ]
00737420    mov ecx, 0x801AA4                               ; => [ String: Halt ]
00737425    jmp 0x0073744F
00737427    mov ecx, dword ptr ss:[ebp-0x0C]
0073742A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00737431    pop ecx
00737432    pop edi
00737433    pop esi
...
00737439    pop ebx
0073743A    ret
0073743B    push 0x88F584                                   ; => [ String: XArray<struct XAsset *>::operator [] ]
00737440    push 0xC3
00737445    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
0073744A    push 0x816BDC                                   ; => [ String: C:\x\ax2017\Engine\xArray.h | String: C:\x\ax2017\Engine\xArray.h ]
0073744F    mov edx, 0x801800
00737454    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00737459    add esp, 0x0C
0073745C    call 0x0063BC30
00737461    test al, al
00737463    jz 0x00737466                                   ; => [ Call: sub_63bc30 ]
00737465    int3
00737466    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0073746B    push 0x88F1C8
00737470    push 0x41C
00737475    push 0x88F010
0073747A    mov edx, 0x801800
0073747F    mov ecx, 0x88F1D8
00737484    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: pDefFont->layerCount | String: C:\x\ax2017\Engine\Editor\AtlasMaker.cpp | Data: data_801800 | String: GlyphLayerCount ]
00737489    add esp, 0x0C
0073748C    call 0x0063BC30
00737491    test al, al
00737493    jz 0x00737496                                   ; => [ Call: sub_63bc30 ]
00737495    int3
00737496    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0073749B    push 0x88F18C
007374A0    push 0x414
007374A5    push 0x88F010
007374AA    mov edx, 0x801800
007374AF    mov ecx, 0x88F1D8
007374B4    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: pDefFont->layerCount | Data: data_801800 | String: GlyphCount | String: C:\x\ax2017\Engine\Editor\AtlasMaker.cpp ]
007374B9    add esp, 0x0C
007374BC    call 0x0063BC30
007374C1    test al, al
007374C3    jz 0x007374C6                                   ; => [ Call: sub_63bc30 ]
007374C5    int3
007374C6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
