...
00763A51    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00763A56    mov ecx, dword ptr ds:[edx-0x08]
00763A59    xor ecx, eax
00763A5B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00763A60    mov eax, 0x8AF9C4
00763A65    jmp 0x00761FA6                                  ; => [ Data: data_8af9c4 | Call: __CxxFrameHandler3 ]
