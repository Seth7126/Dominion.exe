...
0074AC82    call dword ptr ds:[0x007752FC]                  ; => [ Data: data_147d470 | Type: HWND ]
0074AC88    mov ecx, dword ptr ds:[0x01512450]              ; => [ Data: data_1512450 ]
0074AC8E    mov esi, eax
0074AC90    mov dword ptr ss:[ebp-0x04], esi
0074AC93    cmp dword ptr ds:[ecx+0x04], 0x1E
0074AC97    jnz 0x0074AD29
0074AC9D    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0074ACC1    mov edx, dword ptr ds:[0x0151345C]              ; => [ Data: data_151345c ]
0074ACC7    xor edi, edi                                    ; => [ Call: nullptr ]
...
0074ACE7    jz 0x0074ACF0                                   ; => [ Data: data_151245c ]
0074ACE9    inc eax
...
0074AD0B    mov edx, dword ptr ds:[0x0151345C]              ; => [ Data: data_151345c ]
0074AD11    inc esi
...
0074AD27    pop ebp
0074AD28    ret                                             ; => [ Call: sub_6f7f40 ]
0074AD29    push 0x8790A8
0074AD2E    push 0x127
0074AD33    push 0x878EA8
0074AD38    mov edx, 0x801800
0074AD3D    mov ecx, 0x8790C8
0074AD42    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: ptr->assetType == ASSET_TYPE_UI | Data: data_801800 | String: C:\x\ax2017\Engine\UIDef.cpp | String: UIDefGet ]
0074AD47    add esp, 0x0C
0074AD4A    call 0x0063BC30
0074AD4F    test al, al
0074AD51    jz 0x0074AD54                                   ; => [ Call: sub_63bc30 ]
0074AD53    int3
0074AD54    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
