...
0055B31C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0055B321    xor eax, esp
0055B323    mov dword ptr ss:[esp+0xC90], eax
0055B32A    push esi
0055B32B    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055B330    mov esi, eax
0055B332    cmp dword ptr ds:[esi+0x40], 0x00
0055B336    jnz 0x0055B33D
0055B338    call 0x00591930                                 ; => [ Call: sub_591930 ]
0055B33D    mov esi, dword ptr ds:[esi+0x40]
0055B340    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055B345    push 0x01
0055B347    push 0x00
0055B349    mov ecx, dword ptr ds:[eax+0x04]
0055B34C    push ecx
0055B34D    push esi
0055B34E    call 0x00578D90                                 ; => [ Call: nullptr | Call: sub_578d90 ]
...
0055B386    call 0x0056C010                                 ; => [ Call: sub_549d50 | Call: sub_56c010 | Call: sub_549d70 ]
0055B38B    mov ecx, dword ptr ss:[esp+0xCBC]
0055B392    add esp, 0x28
0055B395    pop esi
0055B396    xor ecx, esp
0055B398    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
