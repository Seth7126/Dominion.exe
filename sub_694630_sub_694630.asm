...
0069470C    call 0x0064C080
00694711    xor al, al
00694713    mov ecx, dword ptr ss:[ebp-0x0C]
00694716    mov dword ptr fs:[0x00000000], ecx
0069471D    pop ecx
0069471E    pop edi
0069471F    pop esi
00694720    pop ebx
...
00694757    call 0x0064C080
0069475C    mov al, 0x01
0069475E    mov ecx, dword ptr ss:[ebp-0x0C]
00694761    mov dword ptr fs:[0x00000000], ecx
00694768    pop ecx
00694769    pop edi
0069476A    pop esi
0069476B    pop ebx
