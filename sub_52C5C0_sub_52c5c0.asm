...
0052C5CC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0052C5D1    xor eax, esp
0052C5D3    mov dword ptr ss:[esp+0xCA0], eax
0052C5DA    push ebx
0052C5DB    push esi
0052C5DC    push edi
0052C5DD    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052C5E2    push 0x00
0052C5E4    push 0x00
0052C5E6    push 0x01
...
0052C5EE    push 0x01
0052C5F0    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052C5F5    add esp, 0x10
0052C5F8    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052C5FD    mov ecx, dword ptr ds:[eax+0x0C]
0052C600    cmp ecx, 0xFFFFFFFF
0052C603    jnz 0x0052C61B
0052C605    push 0x81EA64                                   ; => [ String: SetGainFlag ]
0052C60A    push 0x52
0052C60C    push 0x81EA70                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052C611    mov ecx, 0x813C5C                               ; => [ String: c.activePlayer != PLAYER_NONE ]
...
0052C637    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052C63C    push 0x00
0052C63E    mov edx, dword ptr ds:[eax+0x0C]
0052C641    mov ecx, dword ptr ds:[eax+0x04]
0052C644    call 0x005887C0                                 ; => [ Call: sub_5887c0 ]
...
0052C664    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
0052C668    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052C687    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052C6C7    push 0x3EB
0052C6CC    push edi
0052C6CD    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
0052C6D2    add esp, 0x38
0052C6D5    cmp esi, 0x320
0052C6DB    jl 0x0052C6E2
0052C6DD    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052C703    mov eax, dword ptr fs:[0x0000002C]              ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
0052C76C    push 0x3C
0052C76E    push eax
0052C76F    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
0052C774    add esp, 0x24
0052C777    lea ecx, ss:[esp+0x20]
0052C77B    call 0x0052C320                                 ; => [ Call: sub_52c320 ]
0052C780    mov ecx, dword ptr ss:[esp+0xCAC]
0052C787    pop edi
0052C788    pop esi
0052C789    pop ebx
0052C78A    xor ecx, esp
0052C78C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction | Call: CookieCheckFunction ]
0052C791    mov esp, ebp
0052C793    pop ebp
0052C794    ret
0052C795    push 0x81FA04                                   ; => [ String: DomGetContext ]
0052C79A    push 0x7B9
0052C79F    push 0x81F4B8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
0052C7A4    mov ecx, 0x81F9F0                               ; => [ String: cs.numContexts > 0 ]
0052C7A9    mov edx, 0x801800
0052C7AE    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0052C7B3    add esp, 0x0C
0052C7B6    call 0x0063BC30
0052C7BB    test al, al
0052C7BD    jz 0x0052C7C0                                   ; => [ Call: sub_63bc30 ]
0052C7BF    int3
0052C7C0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
