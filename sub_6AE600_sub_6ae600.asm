...
006AE60C    call 0x006B2EC0                                 ; => [ Call: sub_6b2ec0 ]
...
006AE644    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: Dx11GraphicsInterface::UnlockIndexBuffer | Data: data_801800 | String: bufferData->mBufferType == DX11BUFFER_INDEX | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp ]
006AE649    add esp, 0x0C
006AE64C    call 0x0063BC30
006AE651    test al, al
006AE653    jz 0x006AE656                                   ; => [ Call: sub_63bc30 ]
006AE655    int3
006AE656    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
