...
00510569    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0051056E    xor eax, esp
00510570    mov dword ptr ss:[esp+0x58], eax
00510574    push ebx
00510575    push esi
00510576    push edi
00510577    call 0x0056B780                                 ; => [ Call: sub_56b780 ]
0051057C    mov ebx, eax
0051057E    call 0x00573400                                 ; => [ Call: sub_573400 ]
00510583    push 0x50
00510585    mov edi, eax
00510587    lea eax, ss:[esp+0x14]
0051058B    push 0x00
0051058D    push eax
0051058E    call 0x00761FC4                                 ; => [ Call: memset ]
...
00510625    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
00510636    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
