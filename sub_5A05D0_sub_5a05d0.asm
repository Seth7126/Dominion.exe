...
005A05D5    push 0x768465                                   ; => [ Call: __ehhandler$??$initialize_environment_by_cloning_nolock@D@@YAHXZ | Type: EHRegistrationNode ]
005A05DA    mov eax, dword ptr fs:[0x00000000]
005A05E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005A05EE    push eax                                        ; => [ Data: __security_cookie ]
005A05EF    lea eax, ss:[ebp-0x0C]
005A05F2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005A0611    mov edx, dword ptr ds:[0x01597E30]              ; => [ Data: data_1597e30 ]
005A0617    xor ebx, ebx
005A0619    mov eax, dword ptr ds:[0x01597E2C]              ; => [ Data: data_1597e2c ]
...
005A0653    xor ecx, ecx                                    ; => [ Call: nullptr ]
005A0655    mov dword ptr ss:[ebp-0x14], ecx                ; => [ Call: nullptr ]
...
005A067E    add eax, ecx                                    ; => [ Data: data_1597e2c ]
005A0680    push eax
...
005A06A0    call 0x0063D850                                 ; => [ Call: sub_59ded0 | Call: sub_63d850 ]
005A06A5    mov dword ptr ss:[ebp-0x04], 0x01
005A06AC    cmp dword ptr ds:[0x00CF65BC], 0x00
005A06B3    jz 0x005A06E3                                   ; => [ Data: data_cf65bc ]
...
005A06C4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005A06D7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005A06DC    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
005A070C    jnl 0x005A0762                                  ; => [ Data: data_1597e3c ]
005A070E    shl edx, 0x04
005A0711    add edx, dword ptr ds:[0x01597E38]              ; => [ Data: data_1597e38 ]
...
005A0735    setle cl                                        ; => [ Data: data_1597e50 ]
005A0738    inc ecx
...
005A0757    mov edx, dword ptr ds:[0x01597E30]              ; => [ Data: data_1597e30 ]
005A075D    jmp 0x005A0660
005A0762    push 0x825014                                   ; => [ String: XDynArray<struct DomLogDecision>::operator [] ]
005A0767    push 0xD4
005A076C    push 0x824FB0                                   ; => [ String: C:\x\ax2017\Engine\xDynArray.h ]
005A0771    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
005A0776    jmp 0x005A090F
005A077B    push 0x824F84                                   ; => [ String: XDynArray<struct DomLogEvent>::operator [] ]
005A0780    push 0xD4
005A0785    push 0x824FB0                                   ; => [ String: C:\x\ax2017\Engine\xDynArray.h ]
005A078A    mov ecx, 0x824FD0                               ; => [ String: index >= 0 && index < mSize ]
005A078F    jmp 0x005A090F
005A0794    mov eax, ebx
005A0796    mov ecx, dword ptr ss:[ebp-0x0C]
005A0799    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005A07A0    pop ecx
005A07A1    pop edi
005A07A2    pop esi
005A07A3    pop ebx
...
005A07AA    call 0x005A04D0                                 ; => [ Call: sub_5a04d0 ]
005A07AF    mov edx, dword ptr ds:[0x01597E30]              ; => [ Data: data_1597e30 ]
...
005A07C0    mov ebx, dword ptr ss:[ebp+0x10]                ; => [ Call: nullptr ]
005A07C3    mov edx, dword ptr ds:[0x01597E30]              ; => [ Data: data_1597e30 ]
...
005A0809    add eax, ebx                                    ; => [ Data: data_1597e2c ]
005A080B    push eax
...
005A0828    call 0x0063D850                                 ; => [ Call: sub_59ded0 | Call: sub_63d850 ]
005A082D    mov dword ptr ss:[ebp-0x04], 0x03
005A0834    cmp dword ptr ds:[0x00CF65BC], 0x00
005A083B    jz 0x005A086B                                   ; => [ Data: data_cf65bc ]
...
005A084C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005A085F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005A0864    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005A0888    jnl 0x005A0762                                  ; => [ Data: data_1597e3c ]
005A088E    shl edx, 0x04
005A0891    add edx, dword ptr ds:[0x01597E38]              ; => [ Data: data_1597e38 ]
...
005A08B5    setle cl                                        ; => [ Data: data_1597e50 ]
005A08B8    inc ecx
...
005A08D7    mov edx, dword ptr ds:[0x01597E30]              ; => [ Data: data_1597e30 ]
...
005A08EC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005A08F3    pop ecx
005A08F4    pop edi
005A08F5    pop esi
005A08F6    pop ebx
...
005A08F9    pop ebp
005A08FA    ret
005A08FB    push 0x824F68                                   ; => [ String: DomLogGetLines ]
005A0900    push 0x13E3
005A0905    push 0x82487C                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomLog.cpp ]
005A090A    mov ecx, 0x801AA4                               ; => [ String: Halt ]
005A090F    mov edx, 0x801800
005A0914    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
005A0919    add esp, 0x0C
005A091C    call 0x0063BC30
005A0921    test al, al
005A0923    jz 0x005A0926                                   ; => [ Call: sub_63bc30 ]
005A0925    int3
005A0926    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
