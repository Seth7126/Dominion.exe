...
006DB575    push 0x770F40                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$__acrt_lowio_lock_fh_and_call@V<lambda_1d74b0778ed2581c9b4779447ec1f929>@@@@YAHH$$QAV<lambda_1d74b0778ed2581c9b4779447ec1f929>@@@Z ]
006DB57A    mov eax, dword ptr fs:[0x00000000]
006DB580    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006DB58E    push eax                                        ; => [ Data: __security_cookie ]
006DB58F    lea eax, ss:[ebp-0x0C]
006DB592    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006DB5B6    jz 0x006DB5E6                                   ; => [ Data: data_cf65bc ]
...
006DB5C7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006DB5DA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006DB5DF    mov dword ptr ds:[ebx+0x04], 0x801800           ; => [ Data: data_801800 ]
006DB5E6    mov edx, 0x18
006DB5EB    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006DB5F2    mov ecx, ebx
006DB5F4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006DB617    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006DB61E    pop ecx
006DB61F    pop edi
006DB620    pop esi
006DB621    pop ebx
