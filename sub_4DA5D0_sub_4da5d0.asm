...
004DA5D5    push 0x763C0D                                   ; => [ Call: __ehhandler$??0?$_Source_link_iterator@V?$multi_link_registry@V?$ISource@W4agent_status@Concurrency@@@Concurrency@@@Concurrency@@@Concurrency@@QAE@PAV?$source_link_manager@V?$multi_link_registry@V?$ISource@W4agent_status@Concurrency@@@Concurrency@@@Concurrency@@@1@I@Z | Type: EHRegistrationNode ]
004DA5DA    mov eax, dword ptr fs:[0x00000000]
004DA5E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004DA5E1    sub esp, 0x10
004DA5E4    mov eax, dword ptr ds:[0x008C4040]
004DA5E9    xor eax, ebp
004DA5EB    push eax                                        ; => [ Data: __security_cookie ]
004DA5EC    lea eax, ss:[ebp-0x0C]
004DA5EF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004DA604    call 0x004D8D70                                 ; => [ Call: sub_4d8d70 ]
004DA609    push 0x00
...
004DA656    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DA65B    xor al, al
004DA65D    mov ecx, dword ptr ss:[ebp-0x0C]
004DA660    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DA667    pop ecx
...
004DA686    jz 0x004DA6AF                                   ; => [ Data: data_cf65bc ]
...
004DA697    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004DA6AA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004DA6AF    mov al, 0x01
004DA6B1    mov ecx, dword ptr ss:[ebp-0x0C]
004DA6B4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004DA6BB    pop ecx
...
004DA6D9    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp | Data: data_801800 | String: LocalGameExists | String: handle.gameType == GAME_LOCAL ]
004DA6DE    add esp, 0x0C
004DA6E1    call 0x0063BC30
004DA6E6    test al, al
004DA6E8    jz 0x004DA6EB                                   ; => [ Call: sub_63bc30 ]
004DA6EA    int3
004DA6EB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
