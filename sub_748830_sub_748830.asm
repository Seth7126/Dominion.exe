...
0074888D    mov byte ptr ds:[0x01593C78], 0x01
00748894    mov dword ptr ds:[0x01593C7C], 0x01
0074889E    call 0x0063C270
007488A3    movss xmm1, dword ptr ss:[ebp-0x38]
007488A8    movss xmm0, dword ptr ss:[ebp-0x34]
007488AD    movss dword ptr ds:[0x01593C80], xmm1
007488B5    movss dword ptr ds:[0x01593C84], xmm0
007488BD    mov dword ptr ds:[0x01593C90], 0x00
007488C7    movss dword ptr ds:[0x01593C88], xmm1
007488CF    movss dword ptr ds:[0x01593C8C], xmm0
...
007488F0    jnz 0x00748BBA
007488F6    cmp byte ptr ds:[0x01513461], 0x00
007488FD    jz 0x007489AC
00748903    lea ecx, ss:[ebp-0x38]
00748906    mov byte ptr ds:[0x01593C78], 0x01
0074890D    mov dword ptr ds:[0x01593C7C], 0x02
00748917    call 0x0063C270
0074891C    movss xmm1, dword ptr ss:[ebp-0x38]
00748921    lea ecx, ss:[ebp-0x38]
00748924    movss xmm0, dword ptr ss:[ebp-0x34]
00748929    movss dword ptr ds:[0x01593C80], xmm1
00748931    movss dword ptr ds:[0x01593C84], xmm0
00748939    mov dword ptr ds:[0x01593C90], 0x00
00748943    movss dword ptr ds:[0x01593C88], xmm1
0074894B    movss dword ptr ds:[0x01593C8C], xmm0
00748953    call 0x0063C270
00748958    push dword ptr ss:[ebp-0x34]
0074895B    push dword ptr ss:[ebp-0x38]
0074895E    call 0x00747970
00748963    mov dword ptr ds:[0x01593C94], eax
00748968    mov cl, 0x01
0074896A    lea eax, ss:[ebp-0x40]
0074896D    push eax
0074896E    call 0x00748080
00748973    mov ecx, dword ptr ds:[0x01512450]
00748979    add esp, 0x0C
0074897C    movups xmm0, xmmword ptr ds:[eax]
0074897F    mov byte ptr ds:[0x01593C98], 0x01
00748986    movups xmmword ptr ds:[0x01593C9C], xmm0
0074898D    cmp dword ptr ds:[ecx+0x04], 0x1E
00748991    jnz 0x007496D5
00748997    call 0x005AF880
0074899C    movups xmm0, xmmword ptr ds:[eax+0x0C]
007489A0    movups xmmword ptr ds:[0x01593CBC], xmm0
007489A7    jmp 0x00749687
007489AC    mov ecx, dword ptr ds:[0x01512450]
007489B2    cmp dword ptr ds:[ecx+0x04], 0x1E
007489B6    jnz 0x007496D5
007489BC    call 0x005AF880
007489C1    lea ecx, ss:[ebp-0x38]
007489C4    mov esi, eax
007489C6    call 0x0063C270
007489CB    movss xmm0, dword ptr ds:[0x00890E18]
007489D3    divss xmm0, dword ptr ds:[0x01593C6C]
...
007489F3    addss xmm6, dword ptr ds:[0x01593C70]
007489FB    addss xmm5, dword ptr ds:[0x01593C74]
...
00748AB7    mov dword ptr ds:[0x0151345C], 0x00
00748AC1    call 0x0074AC70
...
00748B51    jnle 0x00748B7D
00748B53    mov dword ptr ds:[0x0151245C], esi
00748B59    mov dword ptr ds:[0x0151345C], 0x01
00748B63    call 0x0074AC70
00748B68    mov ecx, dword ptr ds:[0x0151345C]
00748B6E    mov byte ptr ds:[0x01593C99], 0x01
...
00748B86    call 0x007484A0
00748B8B    mov cl, byte ptr ss:[ebp-0x2C]
00748B8E    call 0x007482A0
00748B93    jmp 0x00749687
00748B98    mov byte ptr ds:[0x01593C99], 0x00
00748B9F    jmp 0x00748B75
00748BA1    push 0x8019F0
00748BA6    push 0xA4
00748BAB    push 0x801A00
00748BB0    mov ecx, 0x801A1C
00748BB5    jmp 0x007496E9
00748BBA    mov cl, 0x01
00748BBC    call 0x007482A0
...
00748C12    mov eax, dword ptr ds:[0x01512458]
00748C17    mov ecx, dword ptr ds:[0x01512450]
00748C1D    mov dword ptr ss:[ebp-0x2C], eax
00748C20    inc eax
00748C21    mov dword ptr ds:[0x01512458], eax
00748C26    cmp dword ptr ds:[ecx+0x04], 0x1E
00748C2A    jnz 0x007496A5
00748C30    call 0x005AF880
...
00748D3D    addss xmm2, dword ptr ds:[0x01593C70]
00748D45    addss xmm1, dword ptr ds:[0x01593C74]
...
00748D6A    movups xmm2, xmmword ptr ds:[eax]
...
00748E26    mov dword ptr ds:[0x0151245C], eax
00748E2B    mov dword ptr ds:[0x0151345C], 0x01
00748E35    call 0x0074AC70
00748E3A    mov cl, 0x01
00748E3C    call 0x00744CE0
00748E41    mov ecx, dword ptr ds:[0x01512450]
00748E47    call 0x006F6E30
00748E4C    call 0x0074AC70
00748E51    mov dword ptr ss:[ebp-0x04], 0x04
00748E58    cmp dword ptr ds:[0x00CF65BC], 0x00
00748E5F    jz 0x00749687
...
00748EC2    movss dword ptr ds:[0x01593C6C], xmm0
...
00748EE8    jnz 0x00748EF3
00748EEA    cmp byte ptr ds:[0x01513461], 0x00
00748EF1    jz 0x00748F0E
00748EF3    cmp dword ptr ds:[esi+0x04], 0x0D
00748EF7    jnz 0x00748F0E
00748EF9    mov word ptr ds:[0x01513460], 0x00
00748F02    mov byte ptr ds:[0x01513462], 0x00
...
00749024    jz 0x00749687
0074902A    xor ecx, ecx
0074902C    call 0x0074AE80
00749031    mov cl, 0x01
00749033    call 0x00744CE0
...
0074905F    jz 0x00749687
00749065    or ecx, 0xFFFFFFFF
00749068    call 0x0074AE80
0074906D    mov cl, 0x01
0074906F    call 0x00744CE0
...
007491E4    push 0x8793D8
007491E9    push 0x6D
007491EB    push 0x80193C
007491F0    mov ecx, 0x802748
...
00749208    call 0x007484A0
0074920D    mov cl, 0x01
0074920F    call 0x00744CE0
...
0074922F    mov byte ptr ds:[0x01513461], 0x00
00749236    jle 0x00749687
0074923C    mov byte ptr ds:[0x01513460], 0x01
00749243    jmp 0x00749687
00749248    mov eax, dword ptr ds:[esi+0x04]
0074924B    cmp eax, 0x42
0074924E    jnz 0x0074926D
00749250    mov dword ptr ds:[0x0151345C], 0x00
0074925A    call 0x0074AC70
0074925F    mov word ptr ds:[0x01513460], 0x100
...
0074928D    movss dword ptr ds:[0x01593C6C], xmm0
...
007492BC    movss dword ptr ds:[0x01593C6C], xmm0
...
007492DF    jle 0x00749687
007492E5    call 0x006EE530
007492EA    mov eax, dword ptr ds:[0x01593C64]
007492EF    dec eax
007492F0    imul esi, eax, 0x1010
007492F6    push 0x100C
007492FB    add esi, 0x1512454
00749301    push esi
00749302    push 0x1512458
...
00749318    mov eax, dword ptr ds:[0x01593C64]
0074931D    cmp eax, dword ptr ds:[0x01593C68]
00749323    jnl 0x00749687
00749329    call 0x006EE530
0074932E    mov eax, dword ptr ds:[0x01593C64]
00749333    inc eax
00749334    imul esi, eax, 0x1010
0074933A    push 0x100C
0074933F    add esi, 0x1512454
00749345    push esi
00749346    push 0x1512458
0074934B    mov dword ptr ds:[0x01593C64], eax
00749350    call 0x00761FBE
00749355    mov eax, dword ptr ds:[0x01512450]
...
007493F2    call 0x0069DD00
007493F7    mov edx, eax
007493F9    mov ecx, esi
007493FB    call 0x006FB870
...
00749410    jl 0x007493B0
00749412    mov ecx, dword ptr ds:[0x01512450]
00749418    mov dword ptr ds:[0x0151345C], 0x00
00749422    call 0x006F6E30
00749427    call 0x0074AC70
0074942C    mov cl, 0x01
0074942E    call 0x00744CE0
00749433    jmp 0x00749687
00749438    push 0x88FD9C
0074943D    push 0x57E
00749442    push 0x88FC60
00749447    mov ecx, 0x801AA4
...
0074951F    cmp dword ptr ds:[0x0151345C], esi
00749525    mov dword ptr ds:[0x0151345C], 0x00
...
007496BE    call 0x0063B870
007496C3    add esp, 0x0C
007496C6    call 0x0063BC30
007496CB    test al, al
007496CD    jz 0x007496D0
007496CF    int3
007496D0    call 0x0063BB00
007496D5    push 0x8790A8
007496DA    push 0x127
007496DF    mov ecx, 0x8790C8
007496E4    push 0x878EA8
007496E9    mov edx, 0x801800
007496EE    call 0x0063B870
007496F3    add esp, 0x0C
007496F6    call 0x0063BC30
007496FB    test al, al
007496FD    jz 0x00749700
007496FF    int3
00749700    call 0x0063BB00
