004BBDB0    mov ecx, dword ptr ds:[0x008DBF38]
004BBDB6    push esi
...
004BBDE3    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004BBDE9    jz 0x004BBE68
...
004BBE04    pop esi
004BBE05    ret
004BBE06    mov eax, dword ptr ds:[0x00CC8D5C]
004BBE0B    test eax, eax
004BBE0D    jnz 0x004BBE22
004BBE0F    push 0x77EB90
004BBE14    push 0x7B
004BBE16    push 0x77EB50
004BBE1B    mov ecx, 0x77EB9C
004BBE20    jmp 0x004BBE88
004BBE22    mov edx, dword ptr ds:[0x008DBF48]
...
004BBE62    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004BBE68    call 0x004D8F30
004BBE6D    add eax, 0x11B8
004BBE72    pop esi
004BBE73    ret
004BBE74    push 0x802918
004BBE79    push 0xEC
004BBE7E    push 0x80292C
004BBE83    mov ecx, 0x802964
004BBE88    mov edx, 0x801800
004BBE8D    call 0x0063B870
004BBE92    add esp, 0x0C
004BBE95    call 0x0063BC30
004BBE9A    test al, al
004BBE9C    jz 0x004BBE9F
004BBE9E    int3
004BBE9F    call 0x0063BB00
