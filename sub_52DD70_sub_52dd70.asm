...
0052DD79    mov eax, dword ptr ds:[0x008C4040]
...
0052DE9C    call 0x0063B870
0052DEA1    add esp, 0x0C
0052DEA4    call 0x0063BC30
0052DEA9    test al, al
0052DEAB    jz 0x0052DEAE
0052DEAD    int3
0052DEAE    call 0x0063BB00
