...
005B0333    call 0x00571B30                                 ; => [ Call: sub_571b30 | Call: sub_5cf7e0 ]
...
005B0354    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
005B0383    pop ebx
005B0384    pop ebp
005B0385    ret                                             ; => [ Call: sub_5af930 | Data: data_171e74c ]
...
005B039C    pop ebx
005B039D    pop ebp
005B039E    ret                                             ; => [ Data: data_171e71c | Call: sub_5af930 ]
005B039F    lea eax, ds:[edi-0xC32]
005B03A5    cmp eax, 0x14
005B03A8    jnbe 0x005B0419
005B03AA    movzx eax, byte ptr ds:[eax+0x5B0494]           ; => [ Data: lookup_table_5b0494 ]
005B03B1    jmp dword ptr ds:[eax*4+0x5B0468]
005B03B8    mov edx, dword ptr ds:[0x0171DC54]              ; => [ Data: data_171dc54 ]
005B03BE    jmp 0x005B040E
005B03C0    mov edx, dword ptr ds:[0x0171DC58]              ; => [ Data: data_171dc58 ]
005B03C6    jmp 0x005B040E
005B03C8    mov edx, dword ptr ds:[0x0171DC5C]              ; => [ Data: data_171dc5c ]
005B03CE    jmp 0x005B040E
005B03D0    mov edx, dword ptr ds:[0x0171DC74]              ; => [ Data: data_171dc74 ]
005B03D6    jmp 0x005B040E
005B03D8    mov edx, dword ptr ds:[0x0171DC64]              ; => [ Data: data_171dc64 ]
005B03DE    jmp 0x005B040E
005B03E0    mov edx, dword ptr ds:[0x0171DC6C]              ; => [ Data: data_171dc6c ]
005B03E6    jmp 0x005B040E
005B03E8    mov edx, dword ptr ds:[0x0171DC50]              ; => [ Data: data_171dc50 ]
005B03EE    jmp 0x005B040E
005B03F0    mov edx, dword ptr ds:[0x0171DC60]              ; => [ Data: data_171dc60 ]
005B03F6    jmp 0x005B040E
005B03F8    mov edx, dword ptr ds:[0x0171DC68]              ; => [ Data: data_171dc68 ]
005B03FE    jmp 0x005B040E
005B0400    mov edx, dword ptr ds:[0x0171DC70]              ; => [ Data: data_171dc70 ]
005B0406    jmp 0x005B040E
005B0408    mov edx, dword ptr ds:[0x0171E718]              ; => [ Data: data_171e718 ]
005B040E    push 0x00
005B0410    push ecx
005B0411    call 0x005AF930                                 ; => [ Call: sub_5af930 ]
...
005B0438    pop ebx
005B0439    pop ebp
005B043A    ret                                             ; => [ Call: sub_5af930 | Data: data_171e754 ]
...
005B044E    pop ebx
005B044F    pop ebp
005B0450    ret                                             ; => [ Call: sub_5af930 | Data: data_171e750 ]
005B0451    mov edx, dword ptr ds:[0x0171E758]
005B0457    push 0x00
005B0459    push ecx
005B045A    call 0x005AF930                                 ; => [ Data: data_171e758 | Call: sub_5af930 ]
