...
005E4044    byte FF
005E4045    push 0x769FF0                                   ; => [ Type: EHRegistrationNode | Call: sub_769ff0 ]
005E404A    mov eax, dword ptr fs:[0x00000000]
005E4050    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005E405E    push eax                                        ; => [ Data: __security_cookie ]
005E405F    lea eax, ss:[ebp-0x0C]
005E4062    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005E4068    mov edx, 0x85F5EC
005E406D    lea ecx, ss:[ebp-0x14]
005E4070    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_way ]
005E4075    mov edi, dword ptr ss:[ebp+0x08]
005E4078    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E40C4    jz 0x005E40E8                                   ; => [ Data: data_cf65bc ]
005E40C6    lea ecx, ss:[ebp-0x14]
005E40C9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E40DC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E40E1    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E40F6    call 0x005CBA00                                 ; => [ Call: sub_5cba00 ]
005E40FB    push 0x01
005E40FD    push ecx
005E40FE    push 0x01
005E4100    mov edx, 0x7FFB14
005E4105    mov ecx, eax
005E4107    call 0x00617BB0                                 ; => [ Data: data_7ffb14 | Call: sub_617bb0 ]
005E410C    add esp, 0x0C
005E410F    mov al, 0x01
005E4111    mov ecx, dword ptr ss:[ebp-0x0C]
005E4114    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E411B    pop ecx
005E411C    pop edi
005E411D    pop esi
005E411E    pop ebx
...
005E412B    call 0x0063D720                                 ; => [ String: btn_settings | Call: sub_63d720 ]
005E4130    mov eax, dword ptr ss:[ebp-0x14]
005E4133    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E417C    jz 0x005E41A0                                   ; => [ Data: data_cf65bc ]
005E417E    lea ecx, ss:[ebp-0x14]
005E4181    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E4194    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E4199    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E41B2    setz byte ptr ds:[0x00B7D418]                   ; => [ Data: data_b7d418 ]
005E41B9    mov edx, 0x871498
005E41BE    lea ecx, ss:[ebp-0x14]
005E41C1    call 0x0063D720                                 ; => [ String: btnItem | Call: sub_63d720 ]
005E41C6    mov eax, dword ptr ss:[ebp-0x14]
005E41C9    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E4212    jz 0x005E4236                                   ; => [ Data: data_cf65bc ]
005E4214    lea ecx, ss:[ebp-0x14]
005E4217    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E422A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E422F    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E4258    call 0x0061CE00                                 ; => [ Call: sub_5cbb20 | Call: sub_5cba00 | Data: data_b7d434 | Call: sub_61ce00 ]
005E425D    mov ecx, dword ptr ds:[edi+0x08]
005E4260    cmp ecx, eax
005E4262    jl 0x005E4273
005E4264    push 0x85F620                                   ; => [ String: CardClick ]
...
005E427E    call 0x005E3EC0                                 ; => [ Call: sub_5e3ec0 ]
005E4283    mov edx, 0x8714A0
005E4288    lea ecx, ss:[ebp-0x14]
005E428B    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_apply_allgames ]
005E4290    mov eax, dword ptr ss:[ebp-0x14]
005E4293    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
005E42DC    jz 0x005E4300                                   ; => [ Data: data_cf65bc ]
005E42DE    lea ecx, ss:[ebp-0x14]
005E42E1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E42F4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005E42F9    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005E4322    call 0x0061CE00                                 ; => [ Call: sub_5cbb20 | Call: sub_5cba00 | Data: data_b7d434 | Call: sub_61ce00 ]
...
005E4337    call 0x005E3C60                                 ; => [ Call: sub_5e3c60 ]
005E433C    mov ecx, edi
005E433E    mov ebx, eax
005E4340    call 0x0061CEE0                                 ; => [ Call: sub_61cee0 ]
...
005E4370    call 0x005E3E50                                 ; => [ Call: sub_5e3e50 ]
005E4375    add esp, 0x04
005E4378    xor al, al
005E437A    mov ecx, dword ptr ss:[ebp-0x0C]
005E437D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E4384    pop ecx
005E4385    pop edi
005E4386    pop esi
005E4387    pop ebx
...
005E438A    pop ebp
005E438B    ret
005E438C    push 0x85F620                                   ; => [ String: CardClick ]
005E4391    push 0x4C95
005E4396    push 0x86F1E8
005E439B    mov edx, 0x801800
005E43A0    mov ecx, 0x85F604
005E43A5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: info.index < numSettings | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: CardClick ]
005E43AA    add esp, 0x0C
005E43AD    call 0x0063BC30
005E43B2    test al, al
005E43B4    jz 0x005E43B7                                   ; => [ Call: sub_63bc30 ]
005E43B6    int3
005E43B7    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
