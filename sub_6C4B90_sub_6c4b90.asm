...
006C4B95    push 0x770267                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?consume@?$source_block@V?$multi_link_registry@V?$ITarget@W4agent_status@Concurrency@@@Concurrency@@@Concurrency@@V?$ordered_message_processor@W4agent_status@Concurrency@@@2@@Concurrency@@UAEPAV?$message@W4agent_status@Concurrency@@@2@HPAV?$ITarget@W4agent_status@Concurrency@@@2@@Z ]
006C4B9A    mov eax, dword ptr fs:[0x00000000]
006C4BA0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C4BF8    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: .xml ]
...
006C4C4D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4C60    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4C65    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
006C4C6C    mov byte ptr ss:[ebp-0x04], 0x05
006C4C70    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4C77    jz 0x006C4CA0                                   ; => [ Data: data_cf65bc ]
...
006C4C88    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4C9B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C4CB2    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006C4CB7    test eax, eax
006C4CB9    mov edx, edi                                    ; => [ Data: data_801800 ]
006C4CBB    cmovnz edx, eax
006C4CBE    call 0x0069FEB0                                 ; => [ Call: sub_69feb0 ]
...
006C4CE3    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
006C4D1C    push eax
006C4D1D    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006C4D22    mov esi, dword ptr ss:[ebp-0x18]
006C4D25    lea ecx, ss:[ebp-0x10]
006C4D28    test esi, esi
006C4D2A    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006C4D2F    cmovnz edx, esi
006C4D32    call 0x006C4050                                 ; => [ Call: sub_6c4050 ]
...
006C4D57    jz 0x006C4D7B                                   ; => [ Data: data_cf65bc ]
006C4D59    lea ecx, ss:[ebp-0x18]
006C4D5C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4D6F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4D74    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006C4D8F    jz 0x006C4DB3                                   ; => [ Data: data_cf65bc ]
006C4D91    lea ecx, ss:[ebp-0x24]
006C4D94    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4DA7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4DAC    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
006C4DB3    mov byte ptr ss:[ebp-0x04], 0x0D
006C4DB7    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006C4DBC    mov eax, dword ptr ss:[ebp-0x10]
006C4DBF    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
006C4DDD    jz 0x006C4E09                                   ; => [ Data: data_cf65bc ]
...
006C4DEE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4E01    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4E06    mov dword ptr ss:[ebp-0x10], edi                ; => [ Data: data_801800 ]
...
006C4E3F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4E67    jz 0x006C4E8B                                   ; => [ Data: data_cf65bc ]
006C4E69    lea ecx, ss:[ebp-0x10]
006C4E6C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4E7F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4E84    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C4E8B    mov byte ptr ss:[ebp-0x04], 0x10
006C4E8F    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4E96    jz 0x006C4EC6                                   ; => [ Data: data_cf65bc ]
...
006C4EA7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4EBA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4EBF    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006C4EC6    mov dword ptr ss:[ebp-0x04], 0x11
006C4ECD    jmp 0x006C4FBC
006C4ED2    lea ecx, ss:[ebp-0x24]
006C4ED5    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
006C4EF2    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63dde0 ]
...
006C4F00    call 0x006C4050                                 ; => [ Call: sub_6c4050 ]
...
006C4F16    jz 0x006C4F46                                   ; => [ Data: data_cf65bc ]
...
006C4F27    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4F3A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4F3F    mov dword ptr ss:[ebp-0x28], 0x801800           ; => [ Data: data_801800 ]
006C4F46    mov byte ptr ss:[ebp-0x04], 0x16
006C4F4A    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4F51    jz 0x006C4F7A                                   ; => [ Data: data_cf65bc ]
...
006C4F62    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4F75    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4F7A    mov byte ptr ss:[ebp-0x04], 0x17
006C4F7E    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4F85    jz 0x006C4FB5                                   ; => [ Data: data_cf65bc ]
...
006C4F96    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4FA9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4FAE    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
006C4FB5    mov dword ptr ss:[ebp-0x04], 0x18
006C4FBC    cmp dword ptr ds:[0x00CF65BC], 0x00
006C4FC3    jz 0x006C4FEC                                   ; => [ Data: data_cf65bc ]
...
006C4FD4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C4FE7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C4FEC    mov eax, edi
006C4FEE    mov ecx, dword ptr ss:[ebp-0x0C]
006C4FF1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C4FF8    pop ecx
006C4FF9    pop edi
006C4FFA    pop esi
006C4FFB    pop ebx
...
006C5019    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: gCompilingMode | String: C:\x\ax2017\Engine\DefLoad.cpp | String: AssetSourceGetFullPath ]
006C501E    add esp, 0x0C
006C5021    call 0x0063BC30
006C5026    test al, al
006C5028    jz 0x006C502B                                   ; => [ Call: sub_63bc30 ]
006C502A    int3
006C502B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006C5030    push 0x871DD4
006C5035    push 0x94
006C503A    push 0x871D5C
006C503F    mov edx, edi
006C5041    mov ecx, 0x871E0C
006C5046    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006C504B    add esp, 0x0C
006C504E    call 0x0063BC30
006C5053    test al, al
006C5055    jz 0x006C5058                                   ; => [ Call: sub_63bc30 ]
006C5057    int3
006C5058    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006C505D    push 0x871DD4
006C5062    push 0x94
006C5067    push 0x871D5C
006C506C    mov edx, edi
006C506E    mov ecx, 0x871E0C
006C5073    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xString.cpp | String: XString::XString | String: str ]
006C5078    add esp, 0x0C
006C507B    call 0x0063BC30
006C5080    test al, al
006C5082    jz 0x006C5085                                   ; => [ Call: sub_63bc30 ]
006C5084    int3
006C5085    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
