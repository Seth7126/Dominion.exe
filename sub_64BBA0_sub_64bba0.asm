...
0064BBA5    push 0x76C7ED                                   ; => [ Call: __ehhandler$?tzset_from_system_nolock@@YAXXZ | Type: EHRegistrationNode ]
0064BBAA    mov eax, dword ptr fs:[0x00000000]
0064BBB0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064BBBE    push eax                                        ; => [ Data: __security_cookie ]
0064BBBF    lea eax, ss:[ebp-0x0C]
0064BBC2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0064BBC8    mov dword ptr ss:[ebp-0x14], edx
0064BBCB    mov eax, dword ptr ds:[0x00BF23B8]              ; => [ Data: data_bf23b8 ]
...
0064BC02    call dword ptr ds:[0x00775138]                  ; => [ Data: data_bf23e8 ]
0064BC08    mov dword ptr ss:[ebp-0x04], 0x00
0064BC0F    xor esi, esi
0064BC11    mov ebx, dword ptr ds:[0x00C21008]              ; => [ Data: data_c21008 ]
0064BC17    test ebx, ebx
0064BC19    jle 0x0064BC59
0064BC1B    mov edi, 0xC1C808                               ; => [ Data: data_c1c808 ]
...
0064BC41    xor eax, eax                                    ; => [ Call: nullptr | Call: nullptr ]
...
0064BC62    jz 0x0064BC6F                                   ; => [ Data: data_bf23b8 ]
0064BC64    push 0xBF23E8
0064BC69    call dword ptr ds:[0x00775144]                  ; => [ Data: data_bf23e8 ]
0064BC6F    mov al, bl
0064BC71    mov ecx, dword ptr ss:[ebp-0x0C]
0064BC74    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064BC7B    pop ecx
0064BC7C    pop edi
0064BC7D    pop esi
0064BC7E    pop ebx
...
0064BC91    push eax
0064BC92    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
0064BC97    mov bl, 0x01
0064BC99    jmp 0x0064BC5B
0064BC9B    xor al, al
0064BC9D    mov ecx, dword ptr ss:[ebp-0x0C]
0064BCA0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064BCA7    pop ecx
0064BCA8    pop edi
0064BCA9    pop esi
0064BCAA    pop ebx
...
0064BCC8    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: GamecenterGetDLCSku | String: C:\x\ax2017\Engine\GameCenter.cpp | String: Halt ]
0064BCCD    add esp, 0x0C
0064BCD0    call 0x0063BC30
0064BCD5    test al, al
0064BCD7    jz 0x0064BCDA                                   ; => [ Call: sub_63bc30 ]
0064BCD9    int3
0064BCDA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
