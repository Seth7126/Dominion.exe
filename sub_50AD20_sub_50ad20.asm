...
0050AD25    push 0x76545D                                   ; => [ Call: __ehhandler$?_mbstowcs_l_helper@@YAIPA_WPBDIAAV__crt_cached_ptd_host@@@Z | Type: EHRegistrationNode ]
0050AD2A    mov eax, dword ptr fs:[0x00000000]
0050AD30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0050AD3E    push eax                                        ; => [ Data: __security_cookie ]
0050AD3F    lea eax, ss:[ebp-0x0C]
0050AD42    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0050AD48    mov ebx, edx
0050AD4A    mov esi, ecx
0050AD4C    push 0x00
0050AD4E    mov edx, 0xCC8DE0
0050AD53    mov dword ptr ss:[ebp-0x04], 0x00
0050AD5A    call 0x0058DCC0                                 ; => [ Call: sub_58dcc0 | Data: data_cc8de0 ]
...
0050AD87    call eax
0050AD89    test al, al
0050AD8B    jz 0x0050ADD0                                   ; => [ Call: sub_571b30 ]
...
0050ADC7    or eax, ecx
0050ADC9    jz 0x0050AE12                                   ; => [ Call: sub_571b30 ]
...
0050ADFB    push 0x00
0050ADFD    call 0x0058DCC0                                 ; => [ Call: sub_58dcc0 | Data: data_cc8de0 ]
...
0050AE14    call 0x0058DD90                                 ; => [ Call: sub_58dd90 ]
...
0050AE36    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0050AE3D    pop ecx
0050AE3E    pop edi
0050AE3F    pop esi
0050AE40    pop ebx
...
0050AE64    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: RandomizerDeck_Reject | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: deck.numRejects < MAX_CARDS ]
0050AE69    add esp, 0x0C
0050AE6C    call 0x0063BC30
0050AE71    test al, al
0050AE73    jz 0x0050AE76                                   ; => [ Call: sub_63bc30 ]
0050AE75    int3
0050AE76    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
