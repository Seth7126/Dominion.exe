...
0054C730    dword 20ABBE8                                   ; => [ Call: sub_56d1f0 ]
0054C734    add al, ch
...
0054C742    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
0054C747    call 0x00573400                                 ; => [ Call: sub_573400 ]
0054C74C    push 0x00
0054C74E    push 0x00
0054C750    push 0x01
...
0054C758    push 0x01
0054C75A    call 0x00590760                                 ; => [ Call: sub_590760 ]
0054C75F    add esp, 0x18
0054C762    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054C780    call 0x00573400                                 ; => [ Call: sub_573400 ]
0054C785    push 0x00
0054C787    push 0x00
0054C789    push 0x01
...
0054C791    push 0x02
0054C793    call 0x00590760                                 ; => [ Call: sub_590760 ]
0054C798    add esp, 0x10
0054C79B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054C7BE    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0054C7C3    add esp, 0x0C
0054C7C6    call 0x0063BC30
0054C7CB    test al, al
0054C7CD    jz 0x0054C7D0                                   ; => [ Call: sub_63bc30 ]
0054C7CF    int3
0054C7D0    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
