...
00557E6B    call 0x00761E50
00557E70    mov eax, dword ptr ds:[0x008C4040]
...
00557F33    mov dword ptr ss:[esp+0x14], eax
00557F37    call 0x00573400
