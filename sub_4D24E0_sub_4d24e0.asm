...
004D24E5    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
004D24EA    mov eax, dword ptr fs:[0x00000000]
004D24F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004D24FE    push eax                                        ; => [ Data: __security_cookie ]
004D24FF    lea eax, ss:[ebp-0x0C]
004D2502    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D2508    mov edi, dword ptr ss:[ebp+0x08]
004D250B    mov ecx, edi
004D250D    call 0x0064E7A0
004D2512    mov dword ptr ds:[eax+0x18BC], 0x4D2350         ; => [ Call: sub_64e7a0 | Call: sub_4d2350 ]
004D251C    call 0x004B9370
004D2521    test al, al
004D2523    jz 0x004D2651                                   ; => [ Call: sub_4b9370 ]
004D2529    cmp byte ptr ds:[0x00B824DC], 0x00
004D2530    jnz 0x004D256A                                  ; => [ Data: data_b824dc ]
004D2532    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
...
004D256A    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
004D256F    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
004D2574    test eax, eax
004D2576    jnz 0x004D258E
004D2578    push 0x77EB90                                   ; => [ String: GetClient ]
004D257D    push 0x7B
004D257F    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004D2584    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
...
004D25A9    jz 0x004D2651                                   ; => [ Call: sub_5a0c70 ]
004D25AF    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
004D25B4    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D25C9    push 0x871028                                   ; => [ String: GetActiveConfig ]
004D25CE    push 0x33B6
004D25D3    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
004D25D8    mov ecx, 0x871038                               ; => [ String: c.activeGame.gameType != GAME_NONE ]
004D25DD    jmp 0x004D2820
004D25E2    mov ecx, 0xBDFB60
004D25E7    call 0x004E3A30                                 ; => [ Call: sub_4e3a30 ]
...
004D269C    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D26A1    movss xmm3, dword ptr ds:[0x00890E18]
004D26A9    mov edx, 0x8DC8E4
004D26AE    push 0x00
004D26B0    push 0xFFFFFFFF
004D26B2    mov ecx, eax
004D26B4    call 0x00665DB0                                 ; => [ Data: data_8dc8e4 | Call: sub_665db0 ]
004D26B9    add esp, 0x08
004D26BC    jmp 0x004D277B
004D26C1    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
004D26C6    mov edx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004D26E3    call 0x004B9680                                 ; => [ Call: sub_4b9680 ]
004D26E8    push eax
004D26E9    lea edx, ds:[esi+0x08]
004D26EC    lea ecx, ss:[ebp-0x10]
004D26EF    call 0x004B06C0                                 ; => [ Call: sub_4b06c0 ]
...
004D2755    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D2768    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D276D    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004D2774    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004D277B    mov eax, dword ptr ds:[0x00CC8D70]              ; => [ Data: data_cc8d70 ]
...
004D2791    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D2796    mov edx, 0x8DC920                               ; => [ Data: data_8dc920 ]
004D279B    jmp 0x004D27B7
004D279D    mov ecx, edi
004D279F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D27A4    mov edx, 0x8DC914                               ; => [ Data: data_8dc914 ]
004D27A9    jmp 0x004D27B7
004D27AB    mov ecx, edi
004D27AD    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004D27B2    mov edx, 0x8DC908                               ; => [ Data: data_8dc908 ]
004D27B7    movss xmm3, dword ptr ds:[0x00890E18]
004D27BF    mov ecx, eax
004D27C1    push 0x00
004D27C3    push 0xFFFFFFFF
004D27C5    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
004D27CA    add esp, 0x08
004D27CD    mov ecx, dword ptr ss:[ebp-0x0C]
004D27D0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D27D7    pop ecx
004D27D8    pop edi
004D27D9    pop esi
004D27DA    pop ebx
...
004D27F5    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004D27FA    add esp, 0x0C
004D27FD    call 0x0063BC30
004D2802    test al, al
004D2804    jz 0x004D2807                                   ; => [ Call: sub_63bc30 ]
004D2806    int3
004D2807    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004D280C    push 0x8052E4                                   ; => [ String: NextPlayerScreenUpdate ]
004D2811    push 0x2C86
004D2816    push 0x80292C                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameDialogs.cpp ]
004D281B    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004D2820    mov edx, 0x801800
004D2825    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004D282A    add esp, 0x0C
004D282D    call 0x0063BC30
004D2832    test al, al
004D2834    jz 0x004D2837                                   ; => [ Call: sub_63bc30 ]
004D2836    int3
004D2837    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
