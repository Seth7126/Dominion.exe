...
006ECAE5    push 0x771A56                                   ; => [ Call: sub_771a56 | Type: EHRegistrationNode ]
006ECAEA    mov eax, dword ptr fs:[0x00000000]
006ECAF0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006ECAFE    push eax                                        ; => [ Data: __security_cookie ]
006ECAFF    lea eax, ss:[ebp-0x0C]
006ECB02    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006ECB24    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: samplerFn_layer%d ]
...
006ECB47    call 0x006EC490                                 ; => [ Call: sub_6ec490 ]
...
006ECB87    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: texDiffuse ]
006ECB8C    mov byte ptr ss:[ebp-0x04], 0x02
006ECB90    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
006ECBAF    mov ecx, edi                                    ; => [ Data: data_801800 ]
006ECBB1    mov eax, dword ptr ds:[eax]                     ; => [ String: %d | Call: sub_63df30 ]
006ECBB3    test eax, eax
006ECBB5    cmovnz ecx, eax
006ECBB8    push ecx
006ECBB9    lea ecx, ss:[ebp-0x18]
006ECBBC    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006ECBC1    mov byte ptr ss:[ebp-0x04], 0x04
006ECBC5    cmp dword ptr ds:[0x00CF65BC], 0x00
006ECBCC    jz 0x006ECBF5                                   ; => [ Data: data_cf65bc ]
...
006ECBDD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECC20    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
006ECC3F    push eax
006ECC40    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: float4 %s(float2 arg_uv, float4 diffuse)\n{\n%s%s\treturn tex2D(%s, uv);\n}\n ]
...
006ECC93    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECCA6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECCAB    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006ECCB2    mov byte ptr ss:[ebp-0x04], 0x08
006ECCB6    cmp dword ptr ds:[0x00CF65BC], 0x00
006ECCBD    jz 0x006ECCED                                   ; => [ Data: data_cf65bc ]
...
006ECCCE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECCE1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECCE6    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006ECD01    jz 0x006ECD1E                                   ; => [ Data: data_cf65bc ]
006ECD03    lea ecx, ss:[ebp-0x18]
006ECD06    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECD3D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ECD50    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ECD55    mov eax, ebx
006ECD57    mov ecx, dword ptr ss:[ebp-0x0C]
006ECD5A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006ECD61    pop ecx
006ECD62    pop edi
006ECD63    pop esi
006ECD64    pop ebx
