...
006A5C85    push 0x76F786                                   ; => [ Type: EHRegistrationNode | Call: sub_76f786 ]
006A5C8A    mov eax, dword ptr fs:[0x00000000]
006A5C90    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A5CA2    push esi
006A5CA3    push edi
006A5CA4    push eax                                        ; => [ Data: __security_cookie ]
006A5CA5    lea eax, ss:[ebp-0x0C]
006A5CA8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A5CED    call 0x006A5A40                                 ; => [ Call: sub_6a5a40 ]
006A5CF2    test al, al
...
006A5D09    call 0x0069C590                                 ; => [ Call: sub_69c590 ]
006A5D0E    test al, al
...
006A5D25    call 0x006A4D40                                 ; => [ Call: sub_6a4d40 ]
...
006A5D47    movzx eax, byte ptr ds:[eax+0x6A6210]           ; => [ Data: lookup_table_6a6210 ]
...
006A5DA9    call 0x006A48E0                                 ; => [ Call: sub_6a48e0 | String: mFreeListHead ]
006A5DAE    push esi
006A5DAF    lea ecx, ds:[eax+0x04]
006A5DB2    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
006A5DB7    mov dword ptr ss:[ebp-0x04], 0x01
006A5DBE    cmp dword ptr ds:[0x00CF65BC], 0x00
006A5DC5    jz 0x006A5DF4                                   ; => [ Data: data_cf65bc ]
...
006A5DDC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A5DEF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A5DF4    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006A5DFB    lea eax, ss:[ebp-0x818]
006A5E01    push dword ptr ds:[ebx+0x10]
006A5E04    push 0x808880                                   ; => [ Data: data_808880 ]
006A5E09    push eax
006A5E0A    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
006A5E0F    add esp, 0x0C
006A5E12    mov ecx, dword ptr ss:[ebp-0x81C]
006A5E18    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
006A5E34    call 0x006A48E0                                 ; => [ Call: sub_6a48e0 | String: mUsedCount ]
006A5E39    push esi
006A5E3A    lea ecx, ds:[eax+0x04]
006A5E3D    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
006A5E42    mov dword ptr ss:[ebp-0x04], 0x03
006A5E49    cmp dword ptr ds:[0x00CF65BC], 0x00
006A5E50    jz 0x006A5E7F                                   ; => [ Data: data_cf65bc ]
...
006A5E67    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A5E7A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A5E7F    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006A5E86    lea eax, ss:[ebp-0x818]
006A5E8C    push dword ptr ds:[ebx+0x14]
006A5E8F    push 0x808880                                   ; => [ Data: data_808880 ]
006A5E94    push eax
006A5E95    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
006A5E9A    add esp, 0x0C
006A5E9D    mov ecx, dword ptr ss:[ebp-0x81C]
006A5EA3    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
006A5EBF    call 0x006A48E0                                 ; => [ Call: sub_6a48e0 | String: mNextKey ]
006A5EC4    push esi
006A5EC5    lea ecx, ds:[eax+0x04]
006A5EC8    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
006A5ECD    mov dword ptr ss:[ebp-0x04], 0x05
006A5ED4    cmp dword ptr ds:[0x00CF65BC], 0x00
006A5EDB    jz 0x006A5F0A                                   ; => [ Data: data_cf65bc ]
...
006A5EF2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A5F05    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A5F1C    push edi
006A5F1D    call 0x006A58D0                                 ; => [ Call: sub_6a58d0 ]
006A5F22    add esp, 0x08
006A5F25    jmp 0x006A61A1
006A5F2A    mov eax, dword ptr ds:[edi+0x10]                ; => [ Call: nullptr ]
...
006A5F40    push edi
006A5F41    call 0x006A57B0                                 ; => [ Call: sub_6a57b0 ]
...
006A5F5E    push edi
006A5F5F    call 0x006A57B0                                 ; => [ Call: sub_6a57b0 ]
...
006A5F91    call 0x006A48E0                                 ; => [ Call: sub_6a48e0 ]
006A5F96    push ebx
006A5F97    lea ecx, ds:[eax+0x04]
006A5F9A    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
006A5FC6    push 0x871DD4                                   ; => [ String: XString::XString ]
006A5FCB    push 0x94
006A5FD0    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
006A5FD5    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
006A5FDA    jmp 0x006A61D1
006A5FDF    mov edx, eax
006A5FE1    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006A5FE6    mov ecx, esi
006A5FE8    call 0x006A4C00                                 ; => [ Call: sub_6a4c00 ]
...
006A6015    push eax
006A6016    call 0x006A5650                                 ; => [ Call: sub_6a5650 ]
...
006A605D    push 0x00
006A605F    push eax
006A6060    call 0x00761FC4                                 ; => [ Call: memset ]
...
006A6079    push 0x00
006A607B    push eax
006A607C    call 0x00761FC4                                 ; => [ Call: memset ]
006A6081    xor esi, esi
006A6083    add esp, 0x0C
006A6086    mov dword ptr ss:[ebp-0x824], esi               ; => [ Call: nullptr ]
006A608C    cmp dword ptr ds:[ebx+0x08], esi
006A608F    jle 0x006A61A1
006A6095    xor ecx, ecx                                    ; => [ Call: nullptr ]
006A6097    mov dword ptr ss:[ebp-0x818], ecx               ; => [ Call: nullptr ]
...
006A60C5    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006A60CA    mov ecx, dword ptr ss:[ebp+esi*4-0x818]
006A60D1    call 0x006A4C00
006A60D6    mov ecx, eax                                    ; => [ Call: sub_6a4c00 ]
...
006A60FC    push eax
006A60FD    call 0x006A5650                                 ; => [ Call: sub_6a5650 ]
...
006A6174    call 0x006A48E0                                 ; => [ Call: sub_6a48e0 ]
006A6179    mov esi, eax
006A617B    mov dword ptr ds:[esi+0x10], edi
006A617E    call 0x006A2FA0                                 ; => [ Call: sub_6a2fa0 ]
...
006A6199    call 0x006A6220                                 ; => [ Call: sub_6a6220 | Call: sub_6a6220 ]
006A619E    add esp, 0x0C
006A61A1    mov ecx, dword ptr ss:[ebp-0x0C]
006A61A4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A61AB    pop ecx
006A61AC    pop edi
006A61AD    pop esi
006A61AE    pop ebx
...
006A61B4    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006A61B9    mov esp, ebp
006A61BB    pop ebp
006A61BC    ret
006A61BD    push 0x87AB64                                   ; => [ String: DefParseTreeMakeFromDefinitionSubField ]
006A61C2    push 0x820
006A61C7    push 0x87A6C8                                   ; => [ String: C:\x\ax2017\Engine\DefParseTree.cpp ]
006A61CC    mov ecx, 0x878A5C                               ; => [ String: !DefTypeIsBuiltIn(pDefMap) ]
006A61D1    mov edx, 0x801800
006A61D6    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006A61DB    add esp, 0x0C
006A61DE    call 0x0063BC30
006A61E3    test al, al
006A61E5    jz 0x006A61E8                                   ; => [ Call: sub_63bc30 ]
006A61E7    int3
006A61E8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
