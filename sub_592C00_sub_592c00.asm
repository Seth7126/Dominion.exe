...
00592C20    call 0x00591930                                 ; => [ Call: sub_591930 ]
00592C25    imul eax, ebx, 0x64
00592C28    add eax, esi
00592C2A    xor esi, esi                                    ; => [ Call: nullptr ]
...
00592C4B    call 0x00591930                                 ; => [ Call: sub_591930 ]
00592C50    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00592CA4    test al, al
00592CA6    jz 0x00592CE8                                   ; => [ Call: sub_5754f0 ]
00592CA8    cmp ebx, 0x320
00592CAE    jb 0x00592CB5
00592CB0    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00592CCD    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00592DB7    movups xmmword ptr ds:[esi], xmm0               ; => [ Call: __builtin_memset ]
...
00592DCE    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00592DE7    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
