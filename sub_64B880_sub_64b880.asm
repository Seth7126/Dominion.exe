...
0064B885    push 0x76C785                                   ; => [ Type: EHRegistrationNode | Call: sub_76c785 ]
0064B88A    mov eax, dword ptr fs:[0x00000000]
0064B890    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0064B891    sub esp, 0x14
0064B894    push ebx
0064B895    push esi
0064B896    push edi
0064B897    mov eax, dword ptr ds:[0x008C4040]
0064B89C    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0064B89E    push eax
0064B89F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0064B8A2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0064B8A8    xor esi, esi
0064B8AA    mov dword ptr ds:[0x00C1C800], 0x00             ; => [ Data: data_c1c800 ]
0064B8B4    cmp dword ptr ds:[0x00BF23BC], esi
0064B8BA    jle 0x0064B9EA                                  ; => [ Data: data_bf23bc ]
0064B8C0    xor edi, edi
0064B8C2    mov ebx, dword ptr ds:[0x00BF23C0]              ; => [ Data: data_bf23c0 ]
0064B8C8    push 0xCB4518
0064B8CD    call dword ptr ds:[0x0077583C]
0064B8D3    add esp, 0x04
0064B8D6    mov ecx, dword ptr ds:[eax]                     ; => [ Data: data_cb4518 ]
...
0064B92A    push eax
0064B92B    call 0x0063DF30                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | String: %d | Call: sub_63df30 ]
0064B930    mov byte ptr ss:[ebp-0x04], 0x01
0064B934    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0064B939    mov eax, dword ptr ss:[ebp-0x14]
0064B93C    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0064B941    test eax, eax
0064B943    cmovnz edx, eax
0064B946    mov eax, dword ptr ss:[ebp-0x10]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0064B949    test eax, eax
0064B94B    cmovnz ecx, eax
0064B94E    add esp, 0x18
0064B951    push edx
0064B952    call 0x0064BA00                                 ; => [ Call: sub_64ba00 ]
0064B957    add esp, 0x08
0064B95A    mov byte ptr ss:[ebp-0x04], 0x02
0064B95E    cmp dword ptr ds:[0x00CF65BC], 0x00
0064B965    jz 0x0064B995                                   ; => [ Data: data_cf65bc ]
...
0064B976    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0064B989    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0064B98E    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0064B995    mov dword ptr ss:[ebp-0x04], 0x03
0064B99C    cmp dword ptr ds:[0x00CF65BC], 0x00
0064B9A3    jz 0x0064B9D3                                   ; => [ Data: data_cf65bc ]
...
0064B9B4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0064B9C7    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0064B9CC    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
0064B9D3    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0064B9DA    inc esi
0064B9DB    add edi, 0x20
0064B9DE    cmp esi, dword ptr ds:[0x00BF23BC]
0064B9E4    jl 0x0064B8C2                                   ; => [ Data: data_bf23bc ]
0064B9EA    mov ecx, dword ptr ss:[ebp-0x0C]
0064B9ED    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064B9F4    pop ecx
0064B9F5    pop edi
0064B9F6    pop esi
0064B9F7    pop ebx
