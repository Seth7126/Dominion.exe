...
00666628    push 0x76D35A                                   ; => [ Call: sub_76d35a | Type: EHRegistrationNode ]
0066662D    mov eax, dword ptr fs:[0x00000000]
00666633    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00666634    push ebx
...
00666642    push esi
00666643    push edi
00666644    push eax                                        ; => [ Data: __security_cookie ]
00666645    lea eax, ss:[ebp-0x0C]
00666648    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00666680    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00666697    push ecx                                        ; => [ Call: `eh vector constructor iterator' ]
00666698    lea edx, ss:[ebp-0x58]
0066669B    mov dword ptr ss:[ebp-0x04], 0x00
006666A2    mov ecx, esi
006666A4    call 0x0064C230                                 ; => [ Call: sub_64c230 ]
...
006666C2    mov dword ptr ds:[edi+0x16F0], eax              ; => [ Call: sub_64c020 ]
...
006666F4    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006666F9    mov esi, dword ptr ds:[0x0147ABD8]              ; => [ Data: data_147abd8 ]
...
00666711    movups xmmword ptr ss:[ebp-0x78], xmm0          ; => [ String: 0 | String: zx ]
...
00666770    mov dword ptr ss:[ebp-0x80], eax                ; => [ Call: sub_64c140 ]
...
006667DC    push eax
006667DD    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
006667E2    mov ecx, dword ptr ss:[ebp-0x0C]
006667E5    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006667EC    pop ecx
006667ED    pop edi
006667EE    pop esi
006667EF    mov ecx, dword ptr ss:[ebp-0x14]
006667F2    xor ecx, ebp
006667F4    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0066682C    call 0x0063B870                                 ; => [ String: mSize < mSizeReserved | Call: sub_63b870 | String: C:\x\ax2017\Engine\xArray.h | Data: data_801800 | String: XArray<struct UI2State>::Append ]
00666831    add esp, 0x0C
00666834    call 0x0063BC30
00666839    test al, al
0066683B    jz 0x0066683E                                   ; => [ Call: sub_63bc30 ]
0066683D    int3
0066683E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
