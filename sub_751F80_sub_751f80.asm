...
00751F9C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00751FA1    xor eax, ebp
00751FA3    mov dword ptr ss:[ebp-0x04], eax
00751FA6    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
00751FAB    lea edx, ss:[ebp-0x20]
00751FAE    movaps xmm0, xmmword ptr ds:[0x00893730]
00751FB5    lea ecx, ss:[ebp-0x30]
00751FB8    movaps xmmword ptr ss:[ebp-0x20], xmm0          ; => [ Data: data_893730 ]
...
00751FF3    call 0x0069C260                                 ; => [ Call: sub_69c260 ]
...
00752033    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
