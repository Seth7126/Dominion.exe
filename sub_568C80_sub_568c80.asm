...
00568C85    push 0x767297                                   ; => [ Call: sub_767297 | Type: EHRegistrationNode ]
00568C8A    mov eax, dword ptr fs:[0x00000000]
00568C90    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00568CA2    push esi
00568CA3    push edi
00568CA4    push eax                                        ; => [ Data: __security_cookie ]
00568CA5    lea eax, ss:[ebp-0x0C]
00568CA8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00568CCD    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00568CE6    mov esi, eax                                    ; => [ Call: sub_590ad0 ]
...
00568D06    mov dword ptr ss:[ebp-0xD00], 0x81F0DC          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00568D10    mov dword ptr ss:[ebp-0xCFC], eax
00568D16    lea eax, ss:[ebp-0xD00]
00568D1C    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::VTable ]
...
00568D5D    mov dword ptr ds:[edi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00568D83    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00568D99    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::VTable ]
00568D9C    push eax
00568D9D    call edx                                        ; => [ Field: vFunc_4 ]
00568D9F    cmp dword ptr ss:[ebp-0xCA0], 0x00
00568DA6    jz 0x00568E4B
00568DAC    lea eax, ss:[ebp-0xCA0]
00568DB2    mov dword ptr ss:[ebp-0xD28], 0x81F0C0          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::VTable ]
00568DBC    mov dword ptr ss:[ebp-0xD24], eax
00568DC2    lea eax, ss:[ebp-0xD28]
00568DC8    mov dword ptr ss:[ebp-0xD04], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::VTable ]
...
00568E09    mov dword ptr ds:[edi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00568E2F    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00568E45    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::VTable ]
00568E48    push eax
00568E49    call edx                                        ; => [ Field: vFunc_4 ]
00568E4B    cmp dword ptr ss:[ebp-0xCA4], 0xFFFFFFFF
00568E52    jz 0x00568EF2
00568E58    lea eax, ss:[ebp-0xCA4]
00568E5E    mov dword ptr ss:[ebp-0xCD8], 0x81F0A4          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5f04a67bc0ce9eeb7ea37f393bba7b95>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_5f04a67bc0ce9eeb7ea37f393bba7b95>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00568E68    mov dword ptr ss:[ebp-0xCD0], eax
00568E6E    lea eax, ss:[ebp-0xCD8]
00568E74    mov dword ptr ss:[ebp-0xCD4], ebx
00568E7A    mov dword ptr ss:[ebp-0xCB4], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5f04a67bc0ce9eeb7ea37f393bba7b95>,bool,enum CardID>::VTable ]
...
00568EEA    push edx
00568EEB    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
00568EEE    mov eax, edi
00568EF0    jmp 0x00568EF4
00568EF2    mov eax, esi
00568EF4    mov ecx, dword ptr ss:[ebp-0x0C]
00568EF7    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00568EFE    pop ecx
00568EFF    pop edi
00568F00    pop esi
00568F01    pop ebx
...
00568F07    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
