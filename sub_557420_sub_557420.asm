...
00557438    push 0x765A11                                   ; => [ Call: sub_765a11 | Type: EHRegistrationNode ]
0055743D    mov eax, dword ptr fs:[0x00000000]
00557443    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00557444    push ebx
00557445    mov eax, 0x19D0
0055744A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055744F    mov eax, dword ptr ds:[0x008C4040]
00557454    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00557456    mov dword ptr ss:[ebp-0x14], eax
00557459    push esi
0055745A    push edi
0055745B    push eax
0055745C    lea eax, ss:[ebp-0x0C]
0055745F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00557465    push 0x00
...
00557477    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
0055747C    mov esi, eax
0055747E    mov dword ptr ss:[ebp-0xD00], 0x81DA98          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_bc6275d112fdb7bdbd8e74251ed772fd>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_bc6275d112fdb7bdbd8e74251ed772fd>,bool,enum CardID>::VTable ]
00557488    mov ecx, 0x321
0055748D    lea edi, ss:[ebp-0xCA0]
00557493    lea eax, ss:[ebp-0xD00]
00557499    add esp, 0x0C
0055749C    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0055749E    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_bc6275d112fdb7bdbd8e74251ed772fd>,bool,enum CardID>::VTable ]
...
005574DF    call eax                                        ; => [ Field: vFunc_0 ]
...
005574ED    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
00557518    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_bc6275d112fdb7bdbd8e74251ed772fd>,bool,enum CardID>::VTable ]
0055751B    push eax
0055751C    call edx                                        ; => [ Field: vFunc_4 ]
0055751E    call 0x00573400
00557523    mov eax, dword ptr ds:[eax+0x04]
00557526    cmp dword ptr ds:[eax+0xD48], 0x16
0055752D    jl 0x005575C7                                   ; => [ Call: sub_573400 ]
00557533    lea eax, ss:[ebp-0xD28]
00557539    mov dword ptr ss:[ebp-0xD28], 0x81DA7C          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_76b8b0a711052c6ac65c418033bad621>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_76b8b0a711052c6ac65c418033bad621>,bool,enum CardID>::VTable ]
00557543    mov dword ptr ss:[ebp-0xD04], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_76b8b0a711052c6ac65c418033bad621>,bool,enum CardID>::VTable ]
...
00557584    call eax
00557586    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
005575AC    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
005575C3    push eax
005575C4    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
005575C7    xorps xmm0, xmm0
005575CA    mov dword ptr ss:[ebp-0xCCC], 0x00
005575D4    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
00557652    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
00557660    push 0x00
00557662    push ecx
00557663    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
00557668    add esp, 0x04
0055766B    mov edx, eax
0055766D    mov ecx, esi
0055766F    call 0x00566A70                                 ; => [ Call: sub_566a70 ]
00557674    add esp, 0x04
00557677    mov ecx, dword ptr ss:[ebp-0x0C]
0055767A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00557681    pop ecx
00557682    pop edi
00557683    pop esi
00557684    mov ecx, dword ptr ss:[ebp-0x14]
00557687    xor ecx, ebp
00557689    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
