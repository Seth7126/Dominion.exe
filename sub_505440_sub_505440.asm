...
00505450    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00505451    mov eax, 0x1938
00505456    call 0x00761E50                                 ; => [ Call: __chkstk ]
0050545B    mov eax, dword ptr ds:[0x008C4040]
00505460    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0050546C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00505472    call 0x00573400                                 ; => [ Call: sub_573400 ]
00505477    lea ecx, ss:[ebp-0x1944]
0050547D    push ecx
0050547E    mov edx, dword ptr ds:[eax+0x0C]
00505481    mov ecx, dword ptr ds:[eax+0x04]
00505484    call 0x00590B50                                 ; => [ Call: sub_590b50 ]
00505489    mov ebx, eax
0050548B    mov dword ptr ss:[ebp-0xCC0], 0x80A864          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_0b61238ecfdfffcfb3cd1496a7dcc9c9>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_0b61238ecfdfffcfb3cd1496a7dcc9c9>,bool,enum CardID>::VTable ]
...
005054B5    rep movsd                                       ; => [ Call: __builtin_memcpy ]
005054B7    mov dword ptr ss:[ebp-0xC9C], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_0b61238ecfdfffcfb3cd1496a7dcc9c9>,bool,enum CardID>::VTable ]
...
0050552E    push eax
0050552F    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00505532    mov dword ptr ss:[ebp-0xC9C], 0x00
0050553C    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00505556    jnl 0x0050555D                                  ; => [ Call: sub_583fc0 ]
00505558    lea eax, ds:[esi+esi*1]
0050555B    jmp 0x00505577
0050555D    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00505575    add eax, eax                                    ; => [ Call: sub_583fc0 ]
00505577    mov ecx, dword ptr ss:[ebp-0x0C]
0050557A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00505581    pop ecx
00505582    pop edi
00505583    pop esi
00505584    pop ebx
...
0050558A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
