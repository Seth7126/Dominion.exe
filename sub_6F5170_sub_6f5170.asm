...
006F5175    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
006F517A    mov eax, dword ptr fs:[0x00000000]
006F5180    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006F518E    push eax                                        ; => [ Data: __security_cookie ]
006F518F    lea eax, ss:[ebp-0x0C]
006F5192    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006F5198    mov ebx, edx
006F519A    mov esi, ecx
006F519C    mov edx, dword ptr ds:[ebx]
006F519E    lea ecx, ss:[ebp-0x10]
006F51A1    call 0x006C4220                                 ; => [ Call: sub_6c4220 ]
006F51A6    mov dword ptr ss:[ebp-0x04], 0x00
006F51AD    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006F51B2    mov eax, dword ptr ss:[ebp-0x10]
006F51B5    mov ecx, edi                                    ; => [ Data: data_801800 ]
006F51B7    test eax, eax
006F51B9    cmovnz ecx, eax
006F51BC    call 0x006FB0D0                                 ; => [ Call: sub_6fb0d0 ]
...
006F51D2    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006F51EE    jz 0x006F5217                                   ; => [ Data: data_cf65bc ]
...
006F51FF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F5212    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F5217    mov ecx, dword ptr ss:[ebp-0x0C]
006F521A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F5221    pop ecx
006F5222    pop edi
006F5223    pop esi
006F5224    pop ebx
