...
006A67A5    push 0x76F7C5                                   ; => [ Call: sub_76f7c5 | Type: EHRegistrationNode ]
006A67AA    mov eax, dword ptr fs:[0x00000000]
006A67B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A67BE    push eax                                        ; => [ Data: __security_cookie ]
006A67BF    lea eax, ss:[ebp-0x0C]
006A67C2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006A67C8    mov ebx, edx
006A67CA    mov edi, ecx
006A67CC    mov esi, dword ptr ds:[0x0147AC64]              ; => [ Data: data_147ac64 ]
006A67D2    inc dword ptr ds:[esi+0x0C]
006A67D5    cmp dword ptr ds:[esi], 0x00
006A67D8    jnz 0x006A67E1
006A67DA    mov ecx, esi
006A67DC    call 0x006A64C0                                 ; => [ Call: sub_6a64c0 ]
...
006A67FF    mov dword ptr ds:[ecx], 0x801800                ; => [ Data: data_801800 ]
006A6805    mov dword ptr ds:[ecx+0x04], 0x801800           ; => [ Data: data_801800 ]
006A680C    mov dword ptr ds:[ecx+0x08], 0x801800           ; => [ Data: data_801800 ]
006A6813    mov ecx, 0x0C
006A6818    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
006A6829    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
006A686F    test al, al
006A6871    jz 0x006A6C38                                   ; => [ Call: sub_7076e0 ]
...
006A6898    jz 0x006A68D1                                   ; => [ Data: data_801800 ]
006A689A    cmp dword ptr ds:[0x00CF65BC], 0x00
006A68A1    jz 0x006A68C5
006A68A3    cmp byte ptr ds:[eax], 0x00
006A68A6    jz 0x006A68C5                                   ; => [ Data: data_cf65bc ]
006A68A8    mov ecx, edx
006A68AA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A68BD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A68C2    mov edx, dword ptr ss:[ebp-0x10]
006A68C5    lea ecx, ds:[ebx+0x0C]
006A68C8    mov dword ptr ds:[edx], 0x801800                ; => [ Data: data_801800 ]
...
006A68DD    call 0x0063DA70                                 ; => [ Call: sub_63da70 ]
006A68E2    mov ecx, ebx
006A68E4    call 0x007076E0
006A68E9    test al, al
006A68EB    jz 0x006A6C38                                   ; => [ Call: sub_7076e0 ]
006A68F1    mov eax, dword ptr ds:[ebx+0x04]
006A68F4    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
006A6919    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006A691E    cmp eax, 0x04
006A6921    jz 0x006A6B3B
006A6927    cmp eax, 0x02
006A692A    jnz 0x006A6B26
006A6930    mov dword ptr ss:[ebp-0x1C], esi                ; => [ Data: data_801800 ]
...
006A6952    call 0x0063DA70                                 ; => [ Call: sub_63da70 ]
006A6957    mov esi, dword ptr ss:[ebp-0x1C]
006A695A    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006A695F    mov dword ptr ss:[ebp-0x14], edi                ; => [ Data: data_801800 ]
006A6962    test esi, esi
006A6964    mov byte ptr ss:[ebp-0x04], 0x01
006A6968    mov edx, edi                                    ; => [ Data: data_801800 ]
006A696A    mov ecx, ebx
006A696C    cmovnz edx, esi
006A696F    call 0x007077C0
006A6974    test al, al
006A6976    jz 0x006A6A9D                                   ; => [ Call: sub_7077c0 ]
...
006A698C    call 0x0063DA70                                 ; => [ Call: sub_63da70 ]
006A6991    mov edi, dword ptr ss:[ebp-0x14]
006A6994    mov ecx, ebx
006A6996    call 0x007076E0
006A699B    test al, al
006A699D    jz 0x006A6A9D                                   ; => [ Call: sub_7076e0 ]
006A69A3    test esi, esi
006A69A5    mov eax, 0x801800                               ; => [ Data: data_801800 ]
006A69AA    mov ecx, 0x87AC3C                               ; => [ String: label ]
...
006A69E1    push eax
006A69E2    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006A69FB    jz 0x006A6A18                                   ; => [ Data: data_cf65bc ]
006A69FD    lea ecx, ss:[ebp-0x14]
006A6A00    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A6A13    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A6A2F    jz 0x006A6A4C                                   ; => [ Data: data_cf65bc ]
006A6A31    lea ecx, ss:[ebp-0x1C]
006A6A34    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A6A47    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A6AB1    jz 0x006A6ACE                                   ; => [ Data: data_cf65bc ]
006A6AB3    lea ecx, ss:[ebp-0x14]
006A6AB6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A6AC9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006A6AED    jz 0x006A6C53                                   ; => [ Data: data_cf65bc ]
006A6AF3    lea ecx, ss:[ebp-0x1C]
006A6AF6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A6B0D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A6B12    xor al, al
006A6B14    mov ecx, dword ptr ss:[ebp-0x0C]
006A6B17    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A6B1E    pop ecx
006A6B1F    pop edi
006A6B20    pop esi
006A6B21    pop ebx
...
006A6B30    push esi
006A6B31    push 0x87ACF8                                   ; => [ String: bad block '%s' ]
006A6B36    jmp 0x006A6C4A
006A6B3B    mov eax, dword ptr ss:[ebp-0x10]
006A6B3E    mov edi, esi                                    ; => [ Data: data_801800 ]
...
006A6B4E    call 0x007076E0                                 ; => [ Call: sub_7076e0 ]
006A6B53    test al, al
006A6B55    jz 0x006A6B80
006A6B57    cmp dword ptr ds:[ebx+0x04], 0x04
006A6B5B    jnz 0x006A6B80                                  ; => [ Call: sub_7076e0 ]
...
006A6B8A    push esi
006A6B8B    push 0x87ACBC                                   ; => [ String: failed to read close tag '%s' ]
...
006A6BCF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A6BD4    mov dword ptr ds:[edi+0x04], 0x801800           ; => [ Data: data_801800 ]
...
006A6C3A    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006A6C3F    test eax, eax
006A6C41    cmovnz ecx, eax
006A6C44    push ecx
006A6C45    push 0x87AC9C                                   ; => [ String: failed to read open block '%s' ]
006A6C4A    push ebx
006A6C4B    call 0x006A6740                                 ; => [ Call: sub_6a6740 ]
006A6C50    add esp, 0x0C
006A6C53    xor al, al
006A6C55    mov ecx, dword ptr ss:[ebp-0x0C]
006A6C58    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A6C5F    pop ecx
006A6C60    pop edi
006A6C61    pop esi
006A6C62    pop ebx
