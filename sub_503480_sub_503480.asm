...
00503500    call 0x00582EB0
00503505    add esp, 0x28
00503508    call 0x0056B800
0050350D    mov esi, eax
0050350F    call 0x00573400
...
0050355E    push eax
0050355F    call 0x00568780
00503564    mov esi, eax
00503566    mov dword ptr ss:[ebp-0xD00], 0x80A97C
...
00503590    rep movsd
00503592    mov dword ptr ss:[ebp-0xCDC], eax
...
0050360F    push eax
00503610    call dword ptr ds:[edx+0x10]
...
00503641    movlpd qword ptr ss:[ebp-0xCC4], xmm0
