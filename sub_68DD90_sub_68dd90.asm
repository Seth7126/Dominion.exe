...
0068DDB2    mov dword ptr fs:[0x00000000], eax
...
0068DE83    mov eax, dword ptr ds:[eax+0x08]
...
0068DF0C    jz 0x0068DF29
0068DF0E    lea ecx, ss:[ebp-0x18]
0068DF11    call 0x0063D4E0
...
0068DFDD    jz 0x0068DFFA
0068DFDF    lea ecx, ss:[ebp-0x18]
0068DFE2    call 0x0063D4E0
...
0068E06D    jz 0x0068E08A
0068E06F    lea ecx, ss:[ebp-0x18]
0068E072    call 0x0063D4E0
...
0068E0B9    call 0x0064C080
0068E0BE    mov eax, ebx
0068E0C0    mov ecx, dword ptr ss:[ebp-0x0C]
0068E0C3    mov dword ptr fs:[0x00000000], ecx
0068E0CA    pop ecx
0068E0CB    pop edi
0068E0CC    pop esi
0068E0CD    pop ebx
...
0068E0EB    call 0x0063B870
0068E0F0    add esp, 0x0C
0068E0F3    call 0x0063BC30
0068E0F8    test al, al
0068E0FA    jz 0x0068E0FD
0068E0FC    int3
0068E0FD    call 0x0063BB00
