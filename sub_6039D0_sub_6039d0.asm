...
006039F2    mov dword ptr fs:[0x00000000], eax
...
00603A17    call 0x0063D720
00603A1C    mov eax, edi
00603A1E    mov ecx, dword ptr ss:[ebp-0x0C]
00603A21    mov dword ptr fs:[0x00000000], ecx
00603A28    pop ecx
00603A29    pop edi
00603A2A    pop esi
00603A2B    pop ebx
...
00603A5A    call 0x00571B30
00603A5F    push 0x00
00603A61    push ecx
00603A62    push 0x00
00603A64    mov edx, eax
00603A66    lea ecx, ss:[ebp+0x08]
00603A69    call 0x004E3FA0
...
00603A81    call 0x00571910
00603A86    push ecx
00603A87    mov edx, eax
00603A89    lea ecx, ss:[ebp+0x08]
00603A8C    call 0x004E3CC0
...
00603B86    call 0x0064C080
00603B8B    mov dword ptr ss:[ebp+0x08], 0x801800
00603B92    mov byte ptr ss:[ebp-0x04], 0x08
00603B96    cmp dword ptr ds:[0x00CF65BC], 0x00
00603B9D    jz 0x00603BD0
...
00603BC4    call 0x0064C080
00603BC9    mov dword ptr ss:[ebp-0x10], 0x801800
...
00603C3F    call 0x0064C080
00603C44    mov dword ptr ss:[ebp-0x14], 0x801800
00603C4B    mov dword ptr ss:[ebp-0x04], 0x0B
00603C52    cmp dword ptr ds:[0x00CF65BC], 0x00
00603C59    jz 0x00603A1C
...
00603D36    call 0x0064C080
00603D3B    mov dword ptr ss:[ebp-0x14], 0x801800
00603D42    mov dword ptr ss:[ebp-0x04], 0x0F
00603D49    cmp dword ptr ds:[0x00CF65BC], 0x00
00603D50    jz 0x00603A1C
...
00603DEF    call 0x00571910
00603DF4    push ecx
00603DF5    mov edx, eax
00603DF7    lea ecx, ss:[ebp-0x1C]
00603DFA    call 0x004E3CC0
...
00603E43    jz 0x00603A1C
00603E49    lea ecx, ss:[ebp-0x1C]
00603E4C    call 0x0063D4E0
...
00603E63    call 0x0064C080
00603E68    mov eax, edi
00603E6A    mov ecx, dword ptr ss:[ebp-0x0C]
00603E6D    mov dword ptr fs:[0x00000000], ecx
00603E74    pop ecx
00603E75    pop edi
00603E76    pop esi
00603E77    pop ebx
...
00603EC7    call 0x0063B870
00603ECC    add esp, 0x0C
00603ECF    call 0x0063BC30
00603ED4    test al, al
00603ED6    jz 0x00603ED9
00603ED8    int3
00603ED9    call 0x0063BB00
