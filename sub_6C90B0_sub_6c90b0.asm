...
006C90B5    push 0x7706C6                                   ; => [ Call: sub_7706c6 | Type: EHRegistrationNode ]
006C90BA    mov eax, dword ptr fs:[0x00000000]
006C90C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C90D2    push esi
006C90D3    push edi
006C90D4    push eax                                        ; => [ Data: __security_cookie ]
006C90D5    lea eax, ss:[ebp-0x0C]
006C90D8    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006C912D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9140    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C915C    test al, al
006C915E    jz 0x006C923F                                   ; => [ Type: WIN32_FIND_DATAA | Call: sub_63bd10 ]
006C9164    mov eax, dword ptr ss:[ebp-0x298]
006C916A    shr eax, 0x04
006C916D    test al, 0x01
006C916F    jnz 0x006C9217                                  ; => [ Field: dwFileAttributes ]
006C9175    push edi
...
006C9186    test al, al
006C9188    jnz 0x006C9217                                  ; => [ Call: sub_6c8de0 ]
006C918E    mov dword ptr ss:[ebp-0x29C], 0x801800          ; => [ Data: data_801800 ]
...
006C91B2    push eax
006C91B3    call 0x0063DE70                                 ; => [ Call: sub_63de70 | String: %s%s ]
006C91B8    mov esi, dword ptr ss:[ebp-0x29C]
006C91BE    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006C91C3    test esi, esi
006C91C5    cmovnz ecx, esi
006C91C8    add esp, 0x08
006C91CB    call 0x006C8C70                                 ; => [ Call: sub_6c8c70 ]
...
006C91EA    jz 0x006C920A                                   ; => [ Data: data_cf65bc ]
006C91EC    lea ecx, ss:[ebp-0x29C]
006C91F2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C9205    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C9275    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C927A    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
006C9280    mov esi, dword ptr ss:[ebp-0x2A0]
006C9286    lea edx, ss:[ebp-0x154]
006C928C    mov ecx, esi
006C928E    call 0x0063BD10                                 ; => [ Type: WIN32_FIND_DATAA | Call: sub_63bd10 ]
006C9293    test al, al
...
006C92AB    jz 0x006C9360                                   ; => [ Field: dwFileAttributes ]
006C92B1    push edi
...
006C92D1    jz 0x006C9360                                   ; => [ Call: sub_6c8de0 ]
006C92D7    mov dword ptr ss:[ebp-0x29C], 0x801800          ; => [ Data: data_801800 ]
...
006C92FB    push eax
006C92FC    call 0x0063DE70                                 ; => [ Call: sub_63de70 | String: %s%s/ ]
...
006C9333    jz 0x006C9353                                   ; => [ Data: data_cf65bc ]
006C9335    lea ecx, ss:[ebp-0x29C]
006C933B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C934E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C9373    jz 0x006C92A0                                   ; => [ Type: HANDLE | Type: BOOL ]
006C9379    push dword ptr ss:[ebp-0x14]
006C937C    call dword ptr ds:[0x007750B8]
006C9382    mov ecx, dword ptr ss:[ebp-0x0C]
006C9385    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C938C    pop ecx
006C938D    pop edi
006C938E    pop esi
006C938F    pop ebx
...
006C9395    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
