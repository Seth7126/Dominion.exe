...
006F2C75    push 0x771F2E                                   ; => [ Type: EHRegistrationNode | Call: sub_771f2e ]
006F2C7A    mov eax, dword ptr fs:[0x00000000]
006F2C80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006F2C8E    push eax                                        ; => [ Data: __security_cookie ]
006F2C8F    lea eax, ss:[ebp-0x0C]
006F2C92    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006F2D1C    push 0x01
006F2D1E    call 0x006DD140                                 ; => [ Data: data_8cc5f8 | Call: sub_6dd140 ]
...
006F2D4C    xor eax, eax                                    ; => [ Call: nullptr | Call: nullptr ]
...
006F2D6B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F2D72    pop ecx
006F2D73    pop edi
006F2D74    pop esi
006F2D75    pop ebx
...
006F2D9A    jz 0x006F2DCA                                   ; => [ Data: data_cf65bc ]
...
006F2DAC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F2DBF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F2DC4    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
006F2DFF    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: pParticleDef | Data: data_801800 | String: EmitterIsNameUsed | String: C:\x\ax2017\Engine\Windows\EditorWindow.cpp ]
006F2E04    add esp, 0x0C
006F2E07    call 0x0063BC30                                 ; => [ Call: sub_63bc30 ]
006F2E0C    test al, al
006F2E0E    jz 0x006F2E11
006F2E10    int3
006F2E11    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006F2E16    push 0x88B69C
006F2E1B    push 0xB02
006F2E20    push 0x88AF54
006F2E25    mov edx, 0x801800
006F2E2A    mov ecx, 0x801AA4
006F2E2F    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\EditorWindow.cpp | String: EmitterGetUniqueName | String: Halt ]
006F2E34    add esp, 0x0C
006F2E37    call 0x0063BC30
006F2E3C    test al, al
006F2E3E    jz 0x006F2E41                                   ; => [ Call: sub_63bc30 ]
006F2E40    int3
006F2E41    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
