...
00521C78    call 0x00761E50                                 ; => [ Call: __chkstk ]
00521C7D    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00521C9F    imul ecx                                        ; => [ Call: sub_56d830 ]
...
00521CB1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
