...
006FB956    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006FB99B    push 0x88BFC0                                   ; => [ String: DefinitionVariableArrayMoveItem ]
006FB9A0    push 0xB2
006FB9A5    mov ecx, 0x88C05C                               ; => [ String: newPosition != currentPosition ]
...
006FB9B9    push 0x87943C                                   ; => [ String: DefinitionGetSize ]
006FB9BE    push 0x6D
006FB9C0    push 0x879400                                   ; => [ String: C:\x\ax2017\Engine\Definition.cpp ]
006FB9C5    mov ecx, 0x87948C                               ; => [ String: pDefMap->definitionSize != 0 ]
...
006FB9E1    call 0x00762210                                 ; => [ Call: __alloca_probe_16 ]
006FB9E6    mov eax, esp
006FB9E8    push ebx
006FB9E9    push esi
006FB9EA    push eax
006FB9EB    mov dword ptr ss:[ebp-0x08], eax
006FB9EE    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
006FBA0C    push eax
006FBA0D    push esi
006FBA0E    call 0x00761FBE                                 ; => [ Call: memcpy ]
006FBA13    add esp, 0x0C
006FBA16    push ebx
006FBA17    push dword ptr ss:[ebp-0x08]
006FBA1A    push edi
006FBA1B    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
006FBA2E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006FBA33    mov esp, ebp
006FBA35    pop ebp
006FBA36    ret
006FBA37    push 0x88BFC0                                   ; => [ String: DefinitionVariableArrayMoveItem ]
006FBA3C    push 0xB1
006FBA41    mov ecx, 0x88C004                               ; => [ String: newPosition >= 0 && newPosition < count ]
006FBA46    jmp 0x006FBA57
006FBA48    push 0x88BFC0                                   ; => [ String: DefinitionVariableArrayMoveItem ]
006FBA4D    push 0xB0
006FBA52    mov ecx, 0x88C02C                               ; => [ String: currentPosition >= 0 && currentPosition < count ]
006FBA57    push 0x88BF0C                                   ; => [ String: C:\x\ax2017\Engine\DefEditor.cpp | String: C:\x\ax2017\Engine\DefEditor.cpp | String: C:\x\ax2017\Engine\DefEditor.cpp ]
006FBA5C    mov edx, 0x801800
006FBA61    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006FBA66    add esp, 0x0C
006FBA69    call 0x0063BC30
006FBA6E    test al, al
006FBA70    jz 0x006FBA73                                   ; => [ Call: sub_63bc30 ]
006FBA72    int3
006FBA73    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
