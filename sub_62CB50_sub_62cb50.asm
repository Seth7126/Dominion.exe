...
0062CB6E    push eax                                        ; => [ Data: __security_cookie ]
0062CB6F    lea eax, ss:[ebp-0x0C]
0062CB72    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0062CB8D    jz 0x0062CBBD                                   ; => [ Data: data_801800 ]
0062CB8F    cmp dword ptr ds:[0x00CF65BC], 0x00
0062CB96    jz 0x0062CBB7
0062CB98    cmp byte ptr ds:[eax], 0x00
0062CB9B    jz 0x0062CBB7                                   ; => [ Data: data_cf65bc ]
0062CB9D    mov ecx, ebx
0062CB9F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062CBB2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062CBB7    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
0062CBCB    jz 0x0062CBFB                                   ; => [ Data: data_801800 ]
0062CBCD    cmp dword ptr ds:[0x00CF65BC], 0x00
0062CBD4    jz 0x0062CBF5
0062CBD6    cmp byte ptr ds:[eax], 0x00
0062CBD9    jz 0x0062CBF5                                   ; => [ Data: data_cf65bc ]
0062CBDB    mov ecx, ebx
0062CBDD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062CBF0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062CBF5    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
...
0062CC09    jz 0x0062CC39                                   ; => [ Data: data_801800 ]
0062CC0B    cmp dword ptr ds:[0x00CF65BC], 0x00
0062CC12    jz 0x0062CC33
0062CC14    cmp byte ptr ds:[eax], 0x00
0062CC17    jz 0x0062CC33                                   ; => [ Data: data_cf65bc ]
0062CC19    mov ecx, ebx
0062CC1B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062CC2E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062CC33    mov dword ptr ds:[ebx], 0x801800                ; => [ Data: data_801800 ]
0062CC39    mov eax, dword ptr ds:[edi]
0062CC3B    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0062CCE8    mov edi, eax                                    ; => [ Data: data_86d2c8 ]
...
0062CCF8    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
0062CD23    jz 0x0062CD2C                                   ; => [ String: | ]
0062CD25    dec esi
0062CD26    cmp esi, ebx
0062CD28    jnb 0x0062CD10
0062CD2A    xor esi, esi                                    ; => [ Call: nullptr ]
0062CD2C    inc edi
0062CD2D    jmp 0x0062CDBC
0062CD32    test ecx, ecx
0062CD34    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0062CD39    push 0x86D2D8
0062CD3E    cmovnz eax, ecx
0062CD41    push eax
0062CD42    call ebx                                        ; => [ Data: data_86d2d8 ]
...
0062CD5E    push edi
0062CD5F    call ebx                                        ; => [ Data: data_86d2d8 ]
0062CD61    add esp, 0x08
0062CD64    test eax, eax
0062CD66    jnz 0x0062CD50
0062CD68    xor al, al
0062CD6A    mov ecx, dword ptr ss:[ebp-0x0C]
0062CD6D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0062CD74    pop ecx
0062CD75    pop edi
0062CD76    pop esi
0062CD77    pop ebx
...
0062CD7F    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
0062CDA7    push esi
0062CDA8    call dword ptr ds:[0x00775670]                  ; => [ String: | ]
...
0062CDBA    xor esi, esi                                    ; => [ Call: nullptr ]
...
0062CDD8    cmovnz ecx, edi                                 ; => [ String: //---// ]
0062CDDB    push 0x04
...
0062CDEC    jnz 0x0062CDF3                                  ; => [ String: //// ]
...
0062CE56    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062CE69    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062CE6E    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
0062CED9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062CEEC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062CEF1    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
0062CF08    mov esi, 0x801800                               ; => [ Data: data_801800 ]
...
0062CF73    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062CF86    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062CF8B    mov al, 0x01
0062CF8D    mov ecx, dword ptr ss:[ebp-0x0C]
0062CF90    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0062CF97    pop ecx
0062CF98    pop edi
0062CF99    pop esi
0062CF9A    pop ebx
...
0062CF9D    pop ebp
0062CF9E    ret
0062CF9F    push 0x871DD4                                   ; => [ String: XString::XString ]
0062CFA4    push 0x9A
0062CFA9    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
0062CFAE    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
0062CFB3    mov edx, 0x801800
0062CFB8    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0062CFBD    add esp, 0x0C
0062CFC0    call 0x0063BC30
0062CFC5    test al, al
0062CFC7    jz 0x0062CFCA                                   ; => [ Call: sub_63bc30 ]
0062CFC9    int3
0062CFCA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
