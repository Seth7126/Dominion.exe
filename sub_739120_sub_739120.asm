...
0073912D    call 0x005AF880
00739132    mov ebx, eax
00739134    mov dword ptr ss:[ebp-0x04], 0x00
...
00739156    mov dword ptr ds:[eax+0x30], 0x01
0073915D    mov ecx, dword ptr ds:[esi+edi*1]
00739160    call 0x00735FB0
...
00739194    call 0x0063B870
00739199    add esp, 0x0C
0073919C    call 0x0063BC30
007391A1    test al, al
007391A3    jz 0x007391A6
007391A5    int3
007391A6    call 0x0063BB00
