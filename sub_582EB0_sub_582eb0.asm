...
00582EB8    call 0x00761E50                                 ; => [ Call: __chkstk ]
00582EBD    mov eax, dword ptr ds:[0x008C4040]
00582EC2    xor eax, ebp
00582EC4    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
...
00582EF2    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00582F1C    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00582F69    cmovz edi, ecx                                  ; => [ Call: sub_582040 ]
...
00582FE7    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
00583034    push 0x00
00583036    push 0x00
00583038    push 0x00                                       ; => [ Call: __builtin_memset ]
0058303A    push 0x3C
0058303C    push eax
0058303D    or edx, 0xFFFFFFFF
00583040    mov ecx, esi
00583042    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
005830B8    push eax
005830B9    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
...
005830EE    call 0x00582DE0                                 ; => [ Call: sub_582de0 ]
...
00583141    call 0x00582DE0                                 ; => [ Call: sub_582de0 ]
...
005831BD    call 0x005822E0                                 ; => [ Call: nullptr | Call: sub_5822e0 ]
...
00583267    call 0x00581A00                                 ; => [ Call: sub_581a00 ]
0058326C    inc edi
...
005832B5    push eax
005832B6    call 0x00580700                                 ; => [ Call: nullptr | Call: sub_580700 ]
...
005832C8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005832DA    pop ebx
005832DB    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005832FD    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: who != PLAYER_NONE | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: GetPileHead ]
00583302    add esp, 0x0C
00583305    call 0x0063BC30
0058330A    test al, al
0058330C    jz 0x0058330F                                   ; => [ Call: sub_63bc30 ]
0058330E    int3
0058330F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
