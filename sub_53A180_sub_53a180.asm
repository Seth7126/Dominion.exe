...
0053A18B    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053A190    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0053A1B2    call 0x00566240                                 ; => [ Data: data_7bf9e4 | Call: sub_566240 ]
0053A1B7    mov ecx, 0x321
0053A1BC    lea edi, ss:[esp+0xCA0]
0053A1C3    mov esi, eax
0053A1C5    add esp, 0x08
0053A1C8    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0053A1E0    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
0053A204    push 0x00
0053A206    push 0x00
0053A208    push 0x00                                       ; => [ Call: __builtin_memset ]
0053A20A    push 0x01
0053A20C    cmp eax, 0x02
0053A20F    mov edx, 0x07
0053A214    push 0x00                                       ; => [ Call: nullptr ]
0053A216    push 0xFFFFFFFF
0053A218    setz cl
0053A21B    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
0053A220    add esp, 0x2C
0053A223    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053A228    push dword ptr ds:[0x007BFAD4]                  ; => [ Call: nullptr ]
...
0053A258    call 0x00582EB0                                 ; => [ Call: sub_582eb0 ]
...
0053A27B    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0053A27E    cmp esi, 0x320
0053A284    jb 0x0053A28B
0053A286    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0053A2A7    mov dword ptr ss:[esp+0x0C], eax                ; => [ Call: sub_573400 ]
0053A2AB    cmp esi, 0x320
0053A2B1    jb 0x0053A2B8
0053A2B3    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0053A2EF    mov dword ptr ds:[eax], 0x81A1F4                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_fc37d54027b2048d9411f3567529d64d>, void>::`vftable'{for `std::_Func_base<void>'} ]
0053A2F5    mov dword ptr ds:[eax+0x04], edx
0053A2F8    mov dword ptr ds:[eax+0x24], eax
0053A2FB    call 0x005698B0                                 ; => [ Call: sub_5698b0 ]
0053A300    inc esi
...
0053A319    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
