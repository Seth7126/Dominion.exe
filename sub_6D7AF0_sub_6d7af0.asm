...
006D7B38    movzx eax, byte ptr ds:[eax+0x6D7DA0]
...
006D7BD8    call 0x006DD1E0
006D7BDD    mov ecx, eax
006D7BDF    add esp, 0x08
006D7BE2    test ecx, ecx
006D7BE4    jnz 0x006D7BFF
006D7BE6    push 0x8804E8
006D7BEB    push 0x1EB
006D7BF0    push 0x88052C
006D7BF5    mov ecx, 0x880524
...
006D7CAD    jnl 0x006D7D5A
006D7CB3    mov eax, dword ptr ds:[0x008CE7C8]
006D7CB8    mov eax, dword ptr ds:[eax+esi*4]
...
006D7D01    jnl 0x006D7D5A
006D7D03    mov eax, dword ptr ds:[0x008CE7C8]
006D7D08    mov eax, dword ptr ds:[eax+esi*4]
...
006D7D58    pop ebp
006D7D59    ret
006D7D5A    push 0x88131C
006D7D5F    push 0x8B
006D7D64    push 0x8812F8
006D7D69    mov ecx, 0x881344
006D7D6E    mov edx, 0x801800
006D7D73    call 0x0063B870
006D7D78    add esp, 0x0C
006D7D7B    call 0x0063BC30
006D7D80    test al, al
006D7D82    jz 0x006D7D85
006D7D84    int3
006D7D85    call 0x0063BB00
