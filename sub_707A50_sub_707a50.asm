...
00707A50    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00707A55    push esi
00707A56    push edi
...
00707A64    push 0xA0
00707A69    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\RegionAttachment.c ]
00707A6B    add esp, 0x0C
00707A6E    jmp 0x00707A7E
00707A70    push 0xA0
00707A75    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00707A89    push 0x00
00707A8B    push esi
00707A8C    call 0x00761FC4                                 ; => [ Call: memset ]
...
00707AC0    call 0x00752330                                 ; => [ Call: sub_752330 ]
00707AC5    push 0x707950
00707ACA    push 0x707900
00707ACF    push 0x00
00707AD1    mov edx, edi
00707AD3    mov ecx, esi
00707AD5    call 0x00752290                                 ; => [ Call: sub_752290 | Call: sub_707950 | Call: sub_707900 ]
