...
006D8A5D    mov dword ptr fs:[0x00000000], eax
...
006D8A74    push 0x8808B8
006D8A79    push 0x398
006D8A7E    mov ecx, 0x880920
...
006D8AA2    mov byte ptr ds:[esi+0x10], al
...
006D8AF2    call 0x0064C080
006D8AF7    mov al, 0x01
006D8AF9    mov ecx, dword ptr ss:[ebp-0x0C]
006D8AFC    mov dword ptr fs:[0x00000000], ecx
006D8B03    pop ecx
006D8B04    pop esi
006D8B05    mov esp, ebp
006D8B07    pop ebp
006D8B08    ret
006D8B09    push 0x8808B8
006D8B0E    push 0x399
006D8B13    mov ecx, 0x8808F0
006D8B18    push 0x88052C
006D8B1D    mov edx, 0x801800
006D8B22    call 0x0063B870
006D8B27    add esp, 0x0C
006D8B2A    call 0x0063BC30
006D8B2F    test al, al
006D8B31    jz 0x006D8B34
006D8B33    int3
006D8B34    call 0x0063BB00
