...
006A02A5    push 0x76F325                                   ; => [ Call: sub_76f325 | Type: EHRegistrationNode ]
006A02AA    mov eax, dword ptr fs:[0x00000000]
006A02B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A0327    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A033A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A033F    mov dword ptr ss:[ebp-0x10], ebx                ; => [ Data: data_801800 ]
...
006A0369    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
006A038D    push 0x879EB8                                   ; => [ String: TextureGetImageData ]
006A0392    push 0xC9
006A0397    mov ecx, 0x879EEC                               ; => [ String: pDefTexture->pTextureImportData->atlasTexture == NULL ]
006A039C    jmp 0x006A0517
006A03A1    cmp dword ptr ds:[edx+0x3C], 0x01
006A03A5    jz 0x006A03BB
006A03A7    push 0x879EB8                                   ; => [ String: TextureGetImageData ]
006A03AC    push 0xCB
006A03B1    mov ecx, 0x879ECC                               ; => [ String: pTextureData->imageCount == 1 ]
...
006A03E2    imul eax, edi                                   ; => [ Call: sub_6a9450 ]
...
006A03F4    call 0x006A9660                                 ; => [ Call: sub_6a9660 ]
...
006A040F    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
006A0438    call 0x0069F3E0                                 ; => [ Call: sub_69f3e0 ]
...
006A044F    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
006A0463    push 0x00
006A0465    call 0x0069F3E0                                 ; => [ Call: sub_69f3e0 ]
...
006A0488    test al, al
006A048A    jnz 0x006A04A2                                  ; => [ Call: sub_6ab1b0 ]
006A048C    mov eax, dword ptr ds:[edi+0x20]
006A048F    test eax, eax
006A0491    cmovnz ebx, eax
006A0494    push ebx
006A0495    push 0x879F24
006A049A    call 0x0063B5F0                                 ; => [ String: Failed to read texture %s | Call: sub_63b5f0 ]
...
006A04CC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A04D3    pop ecx
006A04D4    pop edi
006A04D5    pop esi
006A04D6    pop ebx
...
006A04F1    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006A04F6    add esp, 0x0C
006A04F9    call 0x0063BC30
006A04FE    test al, al
006A0500    jz 0x006A0503                                   ; => [ Call: sub_63bc30 ]
006A0502    int3
006A0503    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006A0508    push 0x879EB8                                   ; => [ String: TextureGetImageData ]
006A050D    push 0xDA
006A0512    mov ecx, 0x879F40                               ; => [ String: imageSize == pImage->imageSize ]
006A0517    push 0x879E98
006A051C    mov edx, ebx
006A051E    call 0x0063B870                                 ; => [ String: TextureGetImageData | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Texture.cpp ]
006A0523    add esp, 0x0C
006A0526    call 0x0063BC30
006A052B    test al, al
006A052D    jz 0x006A0530                                   ; => [ Call: sub_63bc30 ]
006A052F    int3
006A0530    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
