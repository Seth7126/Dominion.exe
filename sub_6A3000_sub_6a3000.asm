...
006A301E    push eax
006A301F    lea eax, ss:[ebp-0x0C]
006A3022    mov dword ptr fs:[0x00000000], eax
006A3028    mov esi, ecx
006A302A    cmp dword ptr ds:[esi+0x0C], 0x00
006A302E    jz 0x006A3046
006A3030    push 0x87A6EC
006A3035    push 0x3C
006A3037    push 0x87A6C8
006A303C    mov ecx, 0x87A700
006A3041    jmp 0x006A311C
006A3046    mov ebx, dword ptr ds:[0x0147AC64]
...
006A3058    mov dword ptr ss:[ebp-0x10], eax
...
006A3085    mov ebx, dword ptr ds:[0x0147AC64]
...
006A30E3    call 0x0064C080
006A30E8    mov dword ptr ds:[esi], 0x801800
...
006A30F9    mov dword ptr fs:[0x00000000], ecx
006A3100    pop ecx
006A3101    pop edi
006A3102    pop esi
006A3103    pop ebx
...
006A3106    pop ebp
006A3107    ret
006A3108    push 0x87AB8C
006A310D    push 0x112
006A3112    push 0x825828
006A3117    mov ecx, 0x8736D4
006A311C    mov edx, 0x801800
006A3121    call 0x0063B870
006A3126    add esp, 0x0C
006A3129    call 0x0063BC30
006A312E    test al, al
006A3130    jz 0x006A3133
006A3132    int3
006A3133    call 0x0063BB00
