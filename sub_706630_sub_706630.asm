...
00706639    mov eax, dword ptr ds:[0x008C4040]
...
0070664F    mov ecx, dword ptr ds:[edi+0x0C]
00706652    jz 0x0070670A
...
0070666E    call dword ptr ds:[0x007753C4]
00706674    push 0x9C
00706679    lea eax, ss:[ebp-0xA0]
0070667F    push 0x00
00706681    push eax
00706682    call 0x00761FC4
00706687    mov ecx, dword ptr ds:[0x00CF65B8]
0070668D    mov eax, 0x9C
00706692    mov word ptr ss:[ebp-0x7C], ax
00706696    add esp, 0x0C
00706699    mov eax, dword ptr ds:[ecx+0x14]
0070669C    mov dword ptr ss:[ebp-0x34], eax
0070669F    mov eax, dword ptr ds:[ecx+0x18]
007066A2    mov dword ptr ss:[ebp-0x30], eax
007066A5    lea eax, ss:[ebp-0xA0]
007066AB    push 0x04
007066AD    push eax
007066AE    mov dword ptr ss:[ebp-0x38], 0x20
007066B5    mov dword ptr ss:[ebp-0x78], 0x1C0000
007066BC    call dword ptr ds:[0x00775354]
007066C2    test eax, eax
007066C4    mov eax, dword ptr ds:[0x00CF65B8]
007066C9    jz 0x007066E4
007066CB    push 0x88D468
007066D0    push dword ptr ds:[eax+0x0C]
007066D3    call 0x0063B5F0
007066D8    mov eax, dword ptr ds:[0x00CF65B8]
...
007066F5    call dword ptr ds:[0x007753D4]
007066FB    pop edi
007066FC    mov ecx, dword ptr ss:[ebp-0x04]
007066FF    xor ecx, ebp
00706701    call 0x0075927A
...
00706766    call dword ptr ds:[0x007753D4]
0070676C    mov ecx, dword ptr ss:[ebp-0x04]
0070676F    pop esi
00706770    xor ecx, ebp
00706772    pop edi
00706773    call 0x0075927A
