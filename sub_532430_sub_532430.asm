...
0053243C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00532441    xor eax, esp
00532443    mov dword ptr ss:[esp+0xC8C], eax
0053244A    call 0x00573400
0053244F    mov eax, dword ptr ds:[eax+0x5C]                ; => [ Call: sub_573400 ]
...
0053247A    call 0x0056BD60                                 ; => [ Call: sub_56bd60 | Call: sub_5324a0 ]
0053247F    add esp, 0x08
00532482    mov ecx, dword ptr ss:[esp+0xC8C]
00532489    xor ecx, esp
0053248B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
