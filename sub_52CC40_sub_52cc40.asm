...
0052CC55    jnz 0x0052CC6B                                  ; => [ Call: sub_573400 ]
0052CC57    mov edx, 0x22
0052CC5C    push 0x00
0052CC5E    push 0x00
0052CC60    lea ecx, ds:[edx-0x20]
0052CC63    call 0x00567BE0                                 ; => [ Call: sub_567be0 ]
0052CC68    add esp, 0x08
0052CC6B    call 0x00573400
0052CC70    mov eax, dword ptr ds:[eax+0x04]
0052CC73    mov eax, dword ptr ds:[eax+0x19EC]              ; => [ Call: sub_573400 ]
...
0052CC8D    call 0x00567DD0                                 ; => [ Call: sub_567dd0 ]
