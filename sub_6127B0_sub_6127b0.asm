...
006127B6    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
006127BB    xor ecx, ecx
006127BD    cmp eax, 0xFFFFFFFF
006127C0    cmovz eax, ecx
006127C3    cmp dword ptr ds:[0x00B80B48], eax
006127C9    jnz 0x00612807                                  ; => [ Data: data_b80b48 ]
006127CB    mov ecx, dword ptr ds:[0x00B80B08]
006127D1    call 0x005CDA30                                 ; => [ Call: sub_5cda30 | Data: data_b80b08 ]
