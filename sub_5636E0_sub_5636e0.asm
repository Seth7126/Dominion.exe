...
00563738    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0056373A    lea ecx, ss:[ebp-0xC90]
00563740    call 0x00561880                                 ; => [ Call: sub_561880 ]
00563745    xorps xmm0, xmm0
00563748    mov dword ptr ss:[ebp-0xCBC], 0x00
00563752    movlpd qword ptr ss:[ebp-0xCC4], xmm0           ; => [ Call: __builtin_memset ]
...
005637F8    push esi
005637F9    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
...
0056380A    pop ebx
0056380B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
