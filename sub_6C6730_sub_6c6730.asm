...
006C673C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
006C6753    call dword ptr ds:[0x00775414]                  ; => [ Call: nullptr | Type: HDC ]
...
006C6778    call dword ptr ds:[0x007752A8]                  ; => [ Call: nullptr ]
006C677E    mov esi, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
006C6784    cmp byte ptr ds:[esi+0x24], 0x00
006C6788    mov dword ptr ss:[esp+0x1C], 0x00               ; => [ Type: RECT | Field: left ]
006C6790    mov dword ptr ss:[esp+0x20], 0x00               ; => [ Field: top ]
006C6798    jz 0x006C67E1                                   ; => [ Type: WINDOW_STYLE ]
006C679A    mov esi, dword ptr ds:[0x007752AC]
006C67A0    mov ebx, 0x80000000
006C67A5    push 0x00
006C67A7    call esi
006C67A9    push 0x01
006C67AB    mov dword ptr ss:[esp+0x28], eax                ; => [ Field: right ]
006C67AF    call esi
006C67B1    mov dword ptr ss:[esp+0x28], eax                ; => [ Field: bottom ]
006C67B5    mov eax, dword ptr ss:[esp+0x24]
006C67B9    mov ecx, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
006C67BF    lea eax, ds:[eax+eax*2]
006C67C2    shl eax, 0x05
006C67C5    cdq
006C67C6    idiv dword ptr ss:[esp+0x14]
006C67CA    mov dword ptr ds:[ecx+0x14], eax                ; => [ Field: right ]
...
006C67DC    mov dword ptr ds:[ecx+0x18], eax                ; => [ Field: bottom ]
...
006C6802    mov dword ptr ss:[esp+0x24], ecx                ; => [ Field: right ]
...
006C681A    mov dword ptr ss:[esp+0x28], eax                ; => [ Field: bottom ]
...
006C6830    or ebx, 0x1000000                               ; => [ Data: data_1000000 ]
006C6836    push 0x00
006C6838    push ebx
...
006C685F    call dword ptr ds:[0x00775160]                  ; => [ Data: data_cf65b8 ]
006C6865    test eax, eax
006C6867    jnz 0x006C687D
006C6869    push 0x87E2D4                                   ; => [ String: CreateMainWindow ]
006C686E    push 0x8C
006C6873    mov ecx, 0x8027A0                               ; => [ String: result ]
006C6878    jmp 0x006C6986
006C687D    mov eax, dword ptr ds:[0x0147B074]              ; => [ Data: data_147b074 ]
...
006C68B1    mov dword ptr ds:[ecx], eax                     ; => [ String: (opengl) | Call: __builtin_memcpy ]
...
006C68F6    rep movsd                                       ; => [ Call: __builtin_memcpy | String: (no graphics) ]
006C68F8    movsw
...
006C692C    push 0x00
006C692E    call dword ptr ds:[0x007752B4]                  ; => [ Call: nullptr | Field: top | Field: left | Data: data_147cc8c | Type: HWND | Field: bottom | Field: right | String: GameWindowClass ]
006C6934    push 0x0C
006C6936    mov esi, eax
006C6938    mov dword ptr ss:[esp+0x30], 0x00               ; => [ Type: GESTURECONFIG | Field: dwID ]
006C6940    lea eax, ss:[esp+0x30]
006C6944    mov dword ptr ss:[esp+0x34], 0x00               ; => [ Field: dwWant ]
006C694C    push eax
006C694D    push 0x01
006C694F    push 0x00
006C6951    push esi
006C6952    mov dword ptr ss:[esp+0x48], 0x01               ; => [ Field: dwBlock ]
...
006C696E    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006C6973    mov esp, ebp
006C6975    pop ebp
006C6976    ret
006C6977    push 0x87E2D4                                   ; => [ String: CreateMainWindow ]
006C697C    push 0x9D
006C6981    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006C6986    push 0x87E2E8
006C698B    mov edx, 0x801800
006C6990    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Windows\WindowsApp.cpp | String: CreateMainWindow ]
006C6995    add esp, 0x0C
006C6998    call 0x0063BC30
006C699D    test al, al
006C699F    jz 0x006C69A2                                   ; => [ Call: sub_63bc30 ]
006C69A1    int3
006C69A2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
