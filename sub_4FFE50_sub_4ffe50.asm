...
004FFE71    push edi
004FFE72    push ecx                                        ; => [ Call: __chkstk ]
004FFE73    push 0x00
004FFE75    lea ecx, ds:[edx+0x01]
004FFE78    call 0x00561E00                                 ; => [ Data: __security_cookie | Call: sub_561e00 ]
004FFE7D    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FFE82    push 0x00
004FFE84    push 0x00
004FFE86    push 0x02
...
004FFE8E    push 0x01
004FFE90    call 0x00590760                                 ; => [ Call: sub_590760 ]
004FFE95    add esp, 0x18
004FFE98    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FFF15    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FFF1A    push 0xA00
...
004FFF2D    lea edi, ds:[esi+eax*1]                         ; => [ Call: sub_583fc0 ]
004FFF30    cmp esi, 0x02
004FFF33    jl 0x004FFF4A                                   ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_aae700c6d5522858c5a68e2c36d4037a>, void>::VTable ]
004FFF35    sub esp, 0x28
004FFF38    mov dword ptr ss:[esp+0x38], 0xD9
004FFF40    mov eax, esp
004FFF42    mov dword ptr ds:[eax], 0x80AC1C                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_aae700c6d5522858c5a68e2c36d4037a>, void>::`vftable'{for `std::_Func_base<void>'} ]
004FFF48    jmp 0x004FFF89
004FFF4A    call 0x00573400
004FFF4F    mov eax, dword ptr ds:[eax+0x04]
004FFF52    mov esi, dword ptr ds:[eax+0x19CC]              ; => [ Call: sub_573400 ]
004FFF58    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FFF80    mov dword ptr ds:[eax], 0x80AC00                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_5e032e53b8fa90d0778beb1137902fc1>, void>::`vftable'{for `std::_Func_base<void>'} ]
004FFF86    mov dword ptr ds:[eax+0x04], ecx
004FFF89    xorps xmm0, xmm0
004FFF8C    mov dword ptr ss:[esp+0x44], 0x00               ; => [ Call: __builtin_memset ]
...
004FFFE9    mov dword ptr ds:[eax+0x24], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_aae700c6d5522858c5a68e2c36d4037a>, void>::VTable ]
004FFFEC    call 0x0056A310                                 ; => [ Call: sub_56a310 ]
004FFFF1    add esp, 0x28
004FFFF4    mov ecx, dword ptr ss:[esp+0x199C]
004FFFFB    pop edi
004FFFFC    pop esi
004FFFFD    xor ecx, esp
004FFFFF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0050001E    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00500023    add esp, 0x0C
00500026    call 0x0063BC30
0050002B    test al, al
0050002D    jz 0x00500030                                   ; => [ Call: sub_63bc30 ]
0050002F    int3
00500030    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
