...
0053DD46    call 0x00761E50
0053DD4B    mov eax, dword ptr ds:[0x008C4040]
0053DD50    xor eax, ebp
...
0053DD5C    mov dword ptr fs:[0x00000000], eax
0053DD62    call 0x00573400
0053DD67    push 0x00
0053DD69    push 0x00
0053DD6B    push 0x01
...
0053DD73    push 0x02
0053DD75    call 0x00590760
0053DD7A    add esp, 0x10
0053DD7D    call 0x00573400
...
0053DDE7    rep movsd
0053DDE9    mov dword ptr ss:[ebp-0x192C], eax
...
0053DE2C    push esi
0053DE2D    call dword ptr ds:[eax]
...
0053DECD    call 0x00582EB0
0053DED2    add esp, 0x28
0053DED5    mov ecx, dword ptr ss:[ebp-0x0C]
0053DED8    mov dword ptr fs:[0x00000000], ecx
0053DEDF    pop ecx
0053DEE0    pop edi
0053DEE1    pop esi
0053DEE2    pop ebx
...
0053DF07    call 0x0063B870
0053DF0C    add esp, 0x0C
0053DF0F    call 0x0063BC30
0053DF14    test al, al
0053DF16    jz 0x0053DF19
0053DF18    int3
0053DF19    call 0x0063BB00
