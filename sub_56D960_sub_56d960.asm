...
0056D978    push 0x765D0B                                   ; => [ Type: EHRegistrationNode | Call: sub_765d0b ]
0056D97D    mov eax, dword ptr fs:[0x00000000]
0056D983    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0056D984    push ebx
0056D985    mov eax, 0x2630
0056D98A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0056D98F    mov eax, dword ptr ds:[0x008C4040]
0056D994    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0056D996    mov dword ptr ss:[ebp-0x14], eax
0056D999    push esi
0056D99A    push edi
0056D99B    push eax
0056D99C    lea eax, ss:[ebp-0x0C]
0056D99F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0056D9BA    push 0x00
0056D9BC    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
0056DA69    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056DA80    call 0x00591930                                 ; => [ Call: sub_591930 ]
0056DA85    imul eax, edi, 0x64
0056DA88    mov ecx, 0x321
0056DA8D    lea edi, ss:[ebp-0xCA0]
0056DA93    mov dword ptr ss:[ebp-0xD00], 0x81F018          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2f9aee706be1beb7f994cc598fe05904>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_2f9aee706be1beb7f994cc598fe05904>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
...
0056DAB6    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0056DAB8    mov dword ptr ss:[ebp-0xCDC], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2f9aee706be1beb7f994cc598fe05904>,bool,enum CardID>::VTable ]
...
0056DAF9    call eax                                        ; => [ Field: vFunc_0 ]
...
0056DB07    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0056DB35    push eax
0056DB36    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0056DB39    xorps xmm0, xmm0
0056DB3C    mov dword ptr ss:[ebp-0xCCC], 0x00
0056DB46    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
0056DBCD    call 0x00563960                                 ; => [ Call: sub_563960 ]
...
0056DBE1    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0056DBE3    mov ecx, dword ptr ss:[ebp-0x0C]
0056DBE6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0056DBED    pop ecx
0056DBEE    pop edi
0056DBEF    pop esi
0056DBF0    mov ecx, dword ptr ss:[ebp-0x14]
0056DBF3    xor ecx, ebp
0056DBF5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
