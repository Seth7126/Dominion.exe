...
0058E899    mov eax, dword ptr ds:[0x00CCE9C0]
0058E89E    push esi
...
0058E8B0    call 0x0058DD90
0058E8B5    mov eax, 0x820E90
0058E8BA    mov dword ptr ss:[esp+0x44], eax
0058E8BE    nop
...
0058E930    mov ecx, dword ptr ds:[0x00CCE9C4]
...
0058E970    mov ecx, dword ptr ds:[0x00CCE9C4]
...
0058E9D0    mov ecx, dword ptr ds:[0x00CCE9C4]
...
0058EA43    pop ebp
0058EA44    ret
0058EA45    mov eax, dword ptr ds:[0x00CCE9C4]
...
0058EAE1    test al, al
0058EAE3    jnz 0x0058EB02
0058EAE5    push edi
0058EAE6    push esi
0058EAE7    call 0x0058E330
...
0058EBA8    mov eax, dword ptr ds:[0x00CCE9C4]
...
0058ECA9    mov dword ptr ds:[eax+ecx*4], esi
0058ECAC    mov ecx, esi
0058ECAE    inc dword ptr ds:[0x00CCE9B4]
0058ECB4    call 0x0058E890
0058ECB9    test al, al
0058ECBB    jnz 0x0058EB02
0058ECC1    mov ecx, dword ptr ds:[0x00CCE9B4]
0058ECC7    mov eax, dword ptr ds:[0x00CCE9C4]
0058ECCC    dec ecx
0058ECCD    mov dword ptr ds:[0x00CCE9B4], ecx
...
0058ECE0    pop ebp
0058ECE1    ret
0058ECE2    push 0x820604
0058ECE7    push 0x44DE
0058ECEC    mov ecx, 0x820640
0058ECF1    jmp 0x0058EF98
0058ECF6    push 0x820604
0058ECFB    push 0x44DD
0058ED00    mov ecx, 0x82061C
0058ED05    jmp 0x0058EF98
0058ED0A    push 0x8206B0
0058ED0F    push 0x45A1
0058ED14    mov ecx, 0x8206CC
...
0058ED5D    mov eax, dword ptr ds:[0x00CCE9D4]
0058ED62    cmp eax, 0x01
0058ED65    jl 0x0058ED7B
0058ED67    push 0x820604
0058ED6C    push 0x4517
0058ED71    mov ecx, 0x820688
0058ED76    jmp 0x0058EF98
0058ED7B    mov ecx, dword ptr ss:[esp+0x14]
0058ED7F    mov dword ptr ds:[eax*4+0xCCE9D0], ecx
0058ED86    inc dword ptr ds:[0x00CCE9D4]
...
0058EE2A    mov edx, dword ptr ds:[eax*8+0x7BFAEC]
...
0058EE4B    mov edi, dword ptr ds:[edi+eax*4]
0058EE4E    push edi
...
0058EED1    push 0x82050C
0058EED6    push 0x4140
0058EEDB    mov ecx, 0x820524
...
0058EF18    mov eax, dword ptr ds:[0x00CCE9D4]
0058EF1D    cmp eax, 0x01
0058EF20    jl 0x0058EF33
0058EF22    push 0x820604
0058EF27    push 0x454D
0058EF2C    mov ecx, 0x820688
0058EF31    jmp 0x0058EF98
0058EF33    mov ecx, dword ptr ss:[esp+0x14]
0058EF37    mov dword ptr ds:[eax*4+0xCCE9D0], ecx
0058EF3E    mov al, 0x01
0058EF40    inc dword ptr ds:[0x00CCE9D4]
0058EF46    pop edi
0058EF47    pop esi
...
0058EF87    pop ebp
0058EF88    ret
0058EF89    push 0x820604
0058EF8E    push 0x44FA
0058EF93    mov ecx, 0x82065C
0058EF98    push 0x81F4B8
0058EF9D    mov edx, 0x801800
0058EFA2    call 0x0063B870
0058EFA7    add esp, 0x0C
0058EFAA    call 0x0063BC30
0058EFAF    test al, al
0058EFB1    jz 0x0058EFB4
0058EFB3    int3
0058EFB4    call 0x0063BB00
