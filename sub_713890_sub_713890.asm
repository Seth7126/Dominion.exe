...
00713898    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071389E    push dword ptr ds:[edi+0x70]
007138A1    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
007138BC    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007138C2    push esi
007138C3    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007138C9    inc ebx
...
007138DA    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
007138F9    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007138FF    push dword ptr ds:[esi+0x18]
00713902    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00713908    push esi
00713909    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071390F    inc ebx
00713910    add esp, 0x0C
00713913    cmp ebx, dword ptr ds:[edi+0x10]
00713916    jl 0x007138F0
00713918    push dword ptr ds:[edi+0x14]
0071391B    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
00713939    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071393F    push esi
00713940    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00713946    inc ebx
00713947    add esp, 0x08
0071394A    cmp ebx, dword ptr ds:[edi+0x1C]
0071394D    jl 0x00713930
0071394F    push dword ptr ds:[edi+0x20]
00713952    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
0071396B    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00713971    push esi
00713972    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00713978    inc ebx
00713979    add esp, 0x08
0071397C    cmp ebx, dword ptr ds:[edi+0x24]
0071397F    jl 0x00713962
00713981    push dword ptr ds:[edi+0x28]
00713984    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
