...
00688DF5    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
00688DFA    mov eax, dword ptr fs:[0x00000000]
00688E00    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00688E51    push eax
00688E52    push edi
00688E53    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
00688E6D    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
00688ED9    jz 0x00688EF6                                   ; => [ Data: data_cf65bc ]
00688EDB    lea ecx, ss:[ebp-0x10]
00688EDE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00688EF1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00688EF6    mov al, bl
00688EF8    mov ecx, dword ptr ss:[ebp-0x0C]
00688EFB    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00688F02    pop ecx
00688F03    pop edi
00688F04    pop esi
00688F05    pop ebx
