...
0050163B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00501640    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00501645    xor eax, esp
00501647    mov dword ptr ss:[esp+0x19A4], eax
0050164E    push esi
0050164F    push edi
00501650    call 0x00573400                                 ; => [ Call: sub_573400 ]
00501655    push 0x00
00501657    push 0x00
00501659    push 0x01
...
00501661    push 0x02
00501663    call 0x00590760                                 ; => [ Call: sub_590760 ]
00501668    add esp, 0x10
0050166B    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00501698    call 0x0056A3F0                                 ; => [ Call: sub_56a3f0 ]
0050169D    push 0x00
...
005016B0    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
...
005016CD    movlpd qword ptr ss:[esp+0x34], xmm0            ; => [ Call: __builtin_memset ]
...
00501724    push 0x01
00501726    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0050175D    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
...
00501774    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00501792    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005017D0    push eax
005017D1    call 0x00586320                                 ; => [ Call: sub_586320 ]
005017D6    add esp, 0x10
005017D9    mov ecx, 0x1019
005017DE    call 0x004FEBE0                                 ; => [ Call: sub_4febe0 ]
005017E3    mov ecx, dword ptr ss:[esp+0x19AC]
005017EA    pop edi
005017EB    pop esi
005017EC    xor ecx, esp
005017EE    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0050180D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00501812    add esp, 0x0C
00501815    call 0x0063BC30
0050181A    test al, al
0050181C    jz 0x0050181F                                   ; => [ Call: sub_63bc30 ]
0050181E    int3
0050181F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
