...
0074479B    call 0x006EE530                                 ; => [ Call: sub_6ee530 ]
007447A0    mov edi, dword ptr ds:[0x014FF398]              ; => [ Data: data_14ff398 ]
007447A6    cmp edi, 0x80
007447AC    jnz 0x00744818
007447AE    mov esi, dword ptr ds:[0x0147FF9C]              ; => [ Data: data_147ff9c ]
...
007447F6    call 0x00762362                                 ; => [ Call: memmove ]
007447FB    mov edi, dword ptr ds:[0x014FF398]
00744801    add esp, 0x0C
00744804    mov eax, dword ptr ds:[0x014FF39C]
00744809    dec edi                                         ; => [ Data: data_14ff398 ]
0074480A    dec eax                                         ; => [ Data: data_14ff39c ]
0074480B    mov dword ptr ds:[0x014FF398], edi              ; => [ Data: data_14ff398 ]
00744811    mov dword ptr ds:[0x014FF39C], eax              ; => [ Data: data_14ff39c ]
00744816    jmp 0x0074481D
00744818    mov eax, dword ptr ds:[0x014FF39C]              ; => [ Data: data_14ff39c ]
0074481D    cmp edi, eax
0074481F    jnl 0x00744884
00744821    imul ebx, edi, 0x1008
00744827    add ebx, 0x147FF9C                              ; => [ Data: data_147ff9c ]
...
0074487C    jl 0x00744830                                   ; => [ Data: data_14ff39c ]
0074487E    mov edi, dword ptr ds:[0x014FF398]              ; => [ Data: data_14ff398 ]
...
0074489D    call 0x00761FBE                                 ; => [ Data: data_147df94 | Call: memcpy ]
007448A2    mov eax, dword ptr ds:[0x0147DF90]
007448A7    add esp, 0x0C
007448AA    mov ebx, dword ptr ds:[0x01777518]              ; => [ Data: data_1777518 ]
007448B0    mov ecx, 0x10
007448B5    mov esi, dword ptr ds:[eax]                     ; => [ Data: data_147df90 ]
007448B7    call 0x00687730                                 ; => [ Call: sub_687730 ]
007448BC    mov edi, eax
007448BE    xorps xmm0, xmm0
007448C1    mov edx, ebx
007448C3    movups xmmword ptr ds:[edi], xmm0               ; => [ String: 0 | String: zx ]
007448C6    mov ecx, dword ptr ds:[esi]
007448C8    call 0x0069D4C0
007448CD    mov dword ptr ds:[edi], eax                     ; => [ Call: sub_69d4c0 ]
...
007448E3    push 0x88FC48                                   ; => [ String: FabCreateUndoCheckpoint ]
007448E8    push 0x902
007448ED    mov ecx, 0x88FAC4                               ; => [ String: gFab.undoStack[i].def->pParseTree == NULL ]
007448F2    jmp 0x0074491A
007448F4    mov eax, dword ptr ds:[0x014FF398]
007448F9    pop edi
007448FA    inc eax                                         ; => [ Data: data_14ff398 ]
007448FB    pop esi
007448FC    mov dword ptr ds:[0x014FF398], eax              ; => [ Data: data_14ff398 ]
00744901    mov dword ptr ds:[0x014FF39C], eax              ; => [ Data: data_14ff39c ]
00744906    pop ebx
00744907    mov esp, ebp
00744909    pop ebp
0074490A    ret
0074490B    push 0x88FC2C                                   ; => [ String: FabSaveUndoState ]
00744910    push 0x8E8
00744915    mov ecx, 0x8756A8                               ; => [ String: s.def->pParseTree == NULL ]
0074491A    push 0x88FA7C
0074491F    mov edx, 0x801800
00744924    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Editor\FabEditor.cpp ]
00744929    add esp, 0x0C
0074492C    call 0x0063BC30
00744931    test al, al
00744933    jz 0x00744936                                   ; => [ Call: sub_63bc30 ]
00744935    int3
00744936    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
