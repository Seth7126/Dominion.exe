...
0073CC6C    mov eax, dword ptr ds:[0x008C4040]
...
0073CD24    movss xmm0, dword ptr ds:[0x0147DF0C]
0073CD2C    movss xmm1, dword ptr ds:[0x0147DF10]
0073CD34    subss xmm3, xmm0
0073CD38    movss xmm2, dword ptr ds:[0x0147DF20]
0073CD40    subss xmm2, dword ptr ds:[0x0147DF14]
0073CD48    movss dword ptr ss:[esp+0x34], xmm0
0073CD4E    movss xmm0, dword ptr ds:[0x0147DF1C]
0073CD56    subss xmm0, xmm1
...
0073CDED    call 0x004AC9C0
0073CDF2    mov esi, eax
0073CDF4    mov dword ptr ss:[esp+0x9C], 0x00
0073CDFF    mov eax, dword ptr ds:[0x00CF65B8]
...
0073CE3C    call 0x00762398
0073CE41    mov eax, dword ptr ds:[0x00CF65B8]
...
0073CE5F    mov dword ptr ss:[esp+0xC0], eax
...
0073CE8D    movss dword ptr ss:[esp+0x120], xmm0
0073CE96    movaps xmm0, xmm1
0073CE99    xorps xmm0, xmmword ptr ds:[0x008937C0]
...
0073CEC8    movq qword ptr ds:[0x0147DF0C], xmm1
...
0073CF72    andps xmm0, xmmword ptr ds:[0x008937A0]
...
0073CFF8    divss xmm1, dword ptr ss:[esp+0x30]
0073CFFE    mov ecx, dword ptr ss:[esp+0x28]
0073D002    mov dword ptr ss:[esp+0x60], 0x3F800000
0073D00A    movups xmm0, xmmword ptr ds:[0x00800248]
...
0073D0DD    movss xmm3, dword ptr ds:[0x0147DF10]
0073D0E5    movss xmm1, dword ptr ds:[0x0147DF0C]
0073D0ED    movups xmmword ptr ss:[esp+0x40], xmm0
...
0073D12E    subss xmm0, xmm3
0073D132    movss xmm3, dword ptr ds:[0x0147DF20]
0073D13A    subss xmm2, xmm1
0073D13E    subss xmm3, dword ptr ds:[0x0147DF14]
...
0073D1D3    call 0x004AC9C0
0073D1D8    mov edi, dword ptr ds:[0x00CF65B8]
...
0073D240    mov dword ptr ss:[esp+0xFC], eax
...
0073D27B    movss dword ptr ss:[esp+0x134], xmm0
0073D284    movaps xmm0, xmm1
0073D287    xorps xmm0, xmmword ptr ds:[0x008937C0]
...
0073D3B4    movss dword ptr ss:[esp+0x28], xmm1
0073D3BA    call 0x006DA310
...
0073D417    mov dword ptr ds:[0x0147DF70], eax
...
0073D4E7    fldz
0073D4E9    fxch st1
0073D4EB    mov dword ptr ds:[0x0147DF18], 0x00
0073D4F5    mov dword ptr ds:[0x0147DF1C], 0x00
0073D4FF    mov dword ptr ds:[0x0147DF20], 0x00
0073D509    mov dword ptr ds:[0x0147DF0C], 0x00
0073D513    mov dword ptr ds:[0x0147DF10], 0x41000000
0073D51D    mov dword ptr ds:[0x0147DF14], 0x40800000
0073D527    call 0x00762368
...
0073D54D    movss dword ptr ds:[0x0147DF24], xmm0
0073D555    call 0x00762368
...
0073D56F    movss dword ptr ds:[0x0147DF28], xmm0
0073D577    mov ecx, dword ptr ss:[esp+0x1AC]
0073D57E    pop edi
0073D57F    pop esi
0073D580    xor ecx, esp
0073D582    call 0x0075927A
...
0073D5A4    call 0x0063B870
0073D5A9    add esp, 0x0C
0073D5AC    call 0x0063BC30
0073D5B1    test al, al
0073D5B3    jz 0x0073D5B6
0073D5B5    int3
0073D5B6    call 0x0063BB00
