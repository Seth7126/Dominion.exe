...
00513479    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005134D2    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
005134D7    add esp, 0x24
005134DA    mov edx, ebx
005134DC    mov ecx, edi
005134DE    call 0x00570370                                 ; => [ Call: sub_570370 ]
005134E3    mov ecx, edi
005134E5    call 0x005704D0                                 ; => [ Call: sub_5704d0 ]
005134EA    push 0x50
005134EC    lea eax, ss:[esp+0x0C]
005134F0    push 0x00
005134F2    push eax
005134F3    call 0x00761FC4                                 ; => [ Call: memset ]
...
00513574    setz cl
00513577    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
0051357C    add esp, 0x2C
0051357F    mov ecx, dword ptr ss:[esp+0x5C]
00513583    pop edi
00513584    pop ebx
00513585    xor ecx, esp
00513587    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
