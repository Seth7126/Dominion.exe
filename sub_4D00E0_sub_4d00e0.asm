...
004D0100    mov dword ptr fs:[0x00000000], eax
...
004D0114    call 0x0063D720
004D0119    mov eax, dword ptr ss:[ebp-0x10]
004D011C    mov edi, 0x801800
004D0121    test eax, eax
004D0123    mov ecx, edi
...
004D0174    jz 0x004D0191
004D0176    lea ecx, ss:[ebp-0x10]
004D0179    call 0x0063D4E0
...
004D01B4    call 0x0063D720
004D01B9    mov eax, dword ptr ss:[ebp-0x10]
004D01BC    mov ecx, edi
...
004D01FF    jz 0x004D021C
004D0201    lea ecx, ss:[ebp-0x10]
004D0204    call 0x0063D4E0
...
004D0283    jz 0x004D02A0
004D0285    lea ecx, ss:[ebp-0x10]
004D0288    call 0x0063D4E0
...
004D030C    jz 0x004D0329
004D030E    lea ecx, ss:[ebp-0x10]
004D0311    call 0x0063D4E0
...
004D03AC    jz 0x004D03C9
004D03AE    lea ecx, ss:[ebp+0x08]
004D03B1    call 0x0063D4E0
...
004D03E3    mov dword ptr fs:[0x00000000], ecx
004D03EA    pop ecx
004D03EB    pop edi
004D03EC    pop esi
004D03ED    pop ebx
