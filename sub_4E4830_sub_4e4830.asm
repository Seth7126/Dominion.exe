...
004E483B    call 0x00761E50                                 ; => [ Call: __chkstk ]
004E4840    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004E4894    jnz 0x004E4990                                  ; => [ Data: data_783370 ]
...
004E4920    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E4935    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004E493A    mov esp, ebp
004E493C    pop ebp
004E493D    ret
004E493E    mov edx, 0x801800
004E4943    mov ecx, esi
004E4945    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
004E494A    mov ecx, dword ptr ss:[esp+0x3334]
004E4951    mov eax, esi
004E4953    pop edi
004E4954    pop esi
004E4955    xor ecx, esp
004E4957    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004E4979    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: ToKingdomString | Data: data_801800 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameShared.cpp | String: Halt ]
004E497E    add esp, 0x0C
004E4981    call 0x0063BC30
004E4986    test al, al
004E4988    jz 0x004E498B                                   ; => [ Call: sub_63bc30 ]
004E498A    int3
004E498B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
004E4990    push 0x81F500
004E4995    push 0xB1
004E499A    push 0x81F4B8
004E499F    mov edx, 0x801800
004E49A4    mov ecx, 0x81F50C
004E49A9    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: EXP_BASE_SETS[idx - 1].id == idx | Data: data_801800 | String: DomSetGet | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp ]
004E49AE    add esp, 0x0C
004E49B1    call 0x0063BC30
004E49B6    test al, al
004E49B8    jz 0x004E49BB                                   ; => [ Call: sub_63bc30 ]
004E49BA    int3
004E49BB    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
