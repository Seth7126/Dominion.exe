...
0064E8F8    call 0x0064C080
0064E8FD    mov dword ptr ds:[edi+0x15D8], 0x801800
0064E907    mov dword ptr ds:[edi+0x158C], 0x801800
...
0064E993    call 0x0064C080
0064E998    mov dword ptr ds:[edi+0x15FC], 0x801800
0064E9A2    mov ecx, dword ptr ds:[edi+0x13A4]
0064E9A8    test ecx, ecx
0064E9AA    jz 0x0064E9E6
0064E9AC    call 0x006A82E0
0064E9B1    mov esi, eax
0064E9B3    mov ecx, dword ptr ds:[esi+0x08]
0064E9B6    call 0x007112E0
0064E9BB    mov ecx, dword ptr ds:[esi+0x04]
0064E9BE    call 0x00713890
0064E9C3    movzx ecx, word ptr ds:[esi+0x14]
0064E9C7    mov edx, dword ptr ds:[0x00CAF778]
0064E9CD    mov dword ptr ds:[0x00CAF778], ecx
0064E9D3    mov dword ptr ds:[esi+0x14], edx
0064E9D6    dec dword ptr ds:[0x00CAF77C]
...
0064EA09    mov ecx, dword ptr ds:[0x0147ABF0]
...
0064EA77    call 0x006B8440
0064EA7C    mov eax, dword ptr ds:[0x0147ABE8]
...
0064EADB    call dword ptr ds:[eax+0x28]
...
0064EB99    call 0x0067E6E0
0064EB9E    movzx eax, word ptr ds:[edi+0x18C8]
0064EBA5    mov ecx, dword ptr ds:[0x00C23BB4]
0064EBAB    mov dword ptr ds:[0x00C23BB4], eax
0064EBB0    mov eax, dword ptr ss:[esp+0x14]
0064EBB4    mov dword ptr ds:[edi+0x18C8], ecx
0064EBBA    dec dword ptr ds:[0x00C23BB8]
...
0064EBCB    pop ebp
0064EBCC    ret
0064EBCD    push 0x876A2C
0064EBD2    push 0xD4
0064EBD7    push 0x824FB0
0064EBDC    mov ecx, 0x824FD0
0064EBE1    mov edx, 0x801800
0064EBE6    call 0x0063B870
0064EBEB    add esp, 0x0C
0064EBEE    call 0x0063BC30
0064EBF3    test al, al
0064EBF5    jz 0x0064EBF8
0064EBF7    int3
0064EBF8    call 0x0063BB00
