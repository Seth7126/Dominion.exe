...
004ABBEB    mov edi, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
...
004ABC12    mov ecx, dword ptr ds:[ecx+0x18]                ; => [ Data: data_cf65b8 ]
...
004ABC25    call 0x004D6A20                                 ; => [ Call: sub_4d6a20 ]
004ABC2A    pop esi
004ABC2B    jmp 0x004ABC44
004ABC2D    cmp eax, 0x02
004ABC30    jnz 0x004ABC44
004ABC32    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
004ABC37    test eax, eax
004ABC39    jz 0x004ABC79
004ABC3B    mov byte ptr ds:[eax+0x20], 0x01
004ABC3F    call 0x004D6A20                                 ; => [ Call: sub_4d6a20 ]
004ABC44    cmp dword ptr ds:[0x008DB5C4], 0x27
004ABC4B    jnz 0x004ABC74                                  ; => [ Data: data_8db5c4 ]
004ABC4D    mov ecx, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
004ABC53    test ecx, ecx
004ABC55    jz 0x004ABC74
004ABC57    mov edx, 0x8054A8
004ABC5C    call 0x0067BD70
004ABC61    mov ecx, eax
004ABC63    call 0x0064E7A0                                 ; => [ String: tbl_center_holder | Call: sub_67bd70 | Call: sub_64e7a0 ]
004ABC68    mov ecx, eax
004ABC6A    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
004ABC6F    call 0x0065BF40                                 ; => [ Call: sub_65bf40 ]
004ABC74    pop edi
004ABC75    pop ebp
004ABC76    ret 0x04
...
004ABC92    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetLocalSettings | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp | Data: data_801800 | String: gGameSettings.localSettings ]
004ABC97    add esp, 0x0C
004ABC9A    call 0x0063BC30
004ABC9F    test al, al
004ABCA1    jz 0x004ABCA4                                   ; => [ Call: sub_63bc30 ]
004ABCA3    int3
004ABCA4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
