...
004E5AC5    push 0x764595                                   ; => [ Call: __ehhandler$?Initialize@ScheduleGroupSegmentBase@details@Concurrency@@IAEXPAVScheduleGroupBase@23@PAVSchedulingRing@23@PAVlocation@3@@Z | Type: EHRegistrationNode ]
004E5ACA    mov eax, dword ptr fs:[0x00000000]
004E5AD0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004E5ADE    push eax                                        ; => [ Data: __security_cookie ]
004E5ADF    lea eax, ss:[ebp-0x0C]
004E5AE2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004E5AF9    push dword ptr ds:[eax+0x10]                    ; => [ Call: sub_4e3950 ]
...
004E5B1A    call 0x0063D850                                 ; => [ String: -c expansion:%d, %s | Call: sub_63df30 | Call: sub_63d850 ]
004E5B1F    mov dword ptr ss:[ebp-0x04], 0x01
004E5B26    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5B2D    jz 0x004E5D70                                   ; => [ Data: data_cf65bc ]
...
004E5B4A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5B61    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
004E5B93    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_519d00 ]
004E5B95    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
004E5B9A    test eax, eax
004E5B9C    mov ecx, ebx                                    ; => [ Data: data_801800 ]
...
004E5BB0    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_519d00 ]
...
004E5BC1    mov eax, 0x816630                               ; => [ String: none ]
004E5BC6    jmp 0x004E5BD0
004E5BC8    call 0x00516F30
004E5BCD    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
...
004E5BF0    call 0x0063D850                                 ; => [ String: -c general:%d, %s, %s, %s | Call: sub_63df30 | Call: sub_63d850 ]
004E5BF5    mov byte ptr ss:[ebp-0x04], 0x05
004E5BF9    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5C00    jz 0x004E5C30                                   ; => [ Data: data_cf65bc ]
...
004E5C11    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5C24    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5C29    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
004E5C30    mov byte ptr ss:[ebp-0x04], 0x06
004E5C34    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5C3B    jz 0x004E5C6B                                   ; => [ Data: data_cf65bc ]
...
004E5C4C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5C5F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5C64    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
004E5C6B    mov dword ptr ss:[ebp-0x04], 0x07
004E5C72    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5C79    jz 0x004E5D70                                   ; => [ Data: data_cf65bc ]
...
004E5CB0    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
004E5CB5    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_519d00 ]
...
004E5CC6    mov eax, 0x816630                               ; => [ String: none ]
004E5CCB    jmp 0x004E5CD5
004E5CCD    call 0x00516F30
004E5CD2    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_516f30 ]
004E5CD5    push ebx
004E5CD6    push eax
...
004E5CF2    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: -c general:%d, %s, %s | Call: sub_63d850 ]
004E5CF7    mov byte ptr ss:[ebp-0x04], 0x0A
004E5CFB    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5D02    jz 0x004E5D32                                   ; => [ Data: data_cf65bc ]
...
004E5D13    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5D26    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5D2B    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
004E5D32    mov dword ptr ss:[ebp-0x04], 0x0B
004E5D39    cmp dword ptr ds:[0x00CF65BC], 0x00
004E5D40    jz 0x004E5D70                                   ; => [ Data: data_cf65bc ]
...
004E5D51    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004E5D64    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004E5D69    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
004E5D86    call 0x004E5920                                 ; => [ Call: sub_4e5920 ]
...
004E5D9C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004E5DA3    pop ecx
004E5DA4    pop edi
004E5DA5    pop esi
004E5DA6    pop ebx
