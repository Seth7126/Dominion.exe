...
005CCEF3    push ecx
005CCEF4    mov eax, dword ptr ds:[0x00B7FCEC]
005CCEF9    mov edx, 0xB7FCEC
...
005CCF18    mov esi, dword ptr ds:[0x00B809E0]
005CCF1E    nop
...
005CCF54    push 0x86E294
005CCF59    push 0x6D
005CCF5B    push 0x80193C
005CCF60    mov ecx, 0x802748
005CCF65    jmp 0x005CCFE9
005CCF6A    push 0x86E294
005CCF6F    push 0x6C
005CCF71    push 0x80193C
005CCF76    mov ecx, 0x802734
...
005CCF9F    jnb 0x005CCF54
005CCFA1    mov edx, dword ptr ds:[0x00B809E0]
...
005CCFBD    mov ecx, 0x817824
005CCFC2    push 0x86F4EC
005CCFC7    push 0xA6D
...
005CCFD3    pop ebp
005CCFD4    ret
005CCFD5    push 0x86F57C
005CCFDA    push 0xC2D
005CCFDF    mov ecx, 0x801AA4
005CCFE4    push 0x86F1E8
005CCFE9    mov edx, 0x801800
005CCFEE    call 0x0063B870
005CCFF3    add esp, 0x0C
005CCFF6    call 0x0063BC30
005CCFFB    test al, al
005CCFFD    jz 0x005CD000
005CCFFF    int3
005CD000    call 0x0063BB00
