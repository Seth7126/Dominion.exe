...
00637202    call 0x00633AA0                                 ; => [ Call: sub_633aa0 ]
...
0063723E    pop ebp
0063723F    ret 0x10                                        ; => [ Call: sub_6372f0 ]
...
00637253    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
00637290    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00637292    pop edi
00637293    pop esi
00637294    pop ebx
...
006372A9    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
006372D3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\CardMotion.h | Data: data_801800 | String: &callback.gfx->move == this | String: MoveComponent<struct DomLoc,struct DomMoveCallback>::QueueMove ]
006372D8    add esp, 0x0C
006372DB    call 0x0063BC30
006372E0    test al, al
006372E2    jz 0x006372E5                                   ; => [ Call: sub_63bc30 ]
006372E4    int3
006372E5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
