...
0053192B    call 0x00761E50                                 ; => [ Call: __chkstk ]
00531930    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
00531935    xor eax, esp
00531937    mov dword ptr ss:[esp+0x1994], eax
0053193E    push esi
0053193F    push edi
00531940    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053196C    push eax
0053196D    call 0x00568780                                 ; => [ Call: sub_568780 ]
00531972    xorps xmm0, xmm0
00531975    mov dword ptr ss:[esp+0x30], 0x00
0053197D    add esp, 0x04
00531980    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
005319D6    push 0x00
005319D8    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
005319F3    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
00531A13    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
00531A17    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00531A30    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00531A71    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
...
00531A8F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
