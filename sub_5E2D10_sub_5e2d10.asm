...
005E2D19    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005E2D1E    xor eax, ebp
005E2D20    mov dword ptr ss:[ebp-0x04], eax
005E2D23    mov eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
005E2D28    push ebx
005E2D29    push esi
...
005E2D40    add esi, eax                                    ; => [ Data: data_b809e4 ]
...
005E2D73    mov esi, eax                                    ; => [ Data: data_b809e0 | Call: sub_637730 ]
...
005E2DB1    mov esi, 0xB8206C                               ; => [ Data: data_b8206c ]
005E2DB6    cmp edi, 0x48
005E2DB9    jl 0x005E2DC0
005E2DBB    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
005E2DE7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005E2E62    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005E2E79    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005E2E8B    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
005E2EA7    call 0x005CD7D0                                 ; => [ Call: sub_5cd7d0 ]
...
005E2EC1    push 0x00
005E2EC3    push eax
005E2EC4    call 0x005CC540                                 ; => [ Call: sub_5cc540 ]
...
005E2F08    push 0x00
005E2F0A    push eax
005E2F0B    call 0x00761FC4                                 ; => [ Call: memset ]
...
005E2F32    mov dword ptr ss:[ebp-0x5C], eax                ; => [ Call: sub_5cd0a0 ]
...
005E2F96    call 0x005CB630                                 ; => [ Call: sub_5cb630 ]
...
005E2FA4    pop ebx
005E2FA5    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005E2FC7    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: retval | String: DomCreateTokenIcon ]
005E2FCC    add esp, 0x0C
005E2FCF    call 0x0063BC30
005E2FD4    test al, al
005E2FD6    jz 0x005E2FD9                                   ; => [ Call: sub_63bc30 ]
005E2FD8    int3
005E2FD9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
