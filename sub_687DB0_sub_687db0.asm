...
00687E25    mov dword ptr ds:[0x00CAF770], 0x00
00687E2F    mov dword ptr ds:[0x00CAF778], 0x00
00687E39    test esi, esi
00687E3B    jz 0x00687E43
00687E3D    push esi
00687E3E    call ebx
00687E40    add esp, 0x04
00687E43    mov dword ptr ds:[0x00CAF76C], 0x00
...
00687E75    mov dword ptr ds:[0x00CAF784], 0x00
00687E7F    call 0x006E5880
00687E84    call 0x006FE070
00687E89    call 0x006B7F40
00687E8E    call 0x006D93F0
00687E93    mov edi, dword ptr ds:[0x0147ABE8]
00687E99    test edi, edi
00687E9B    jz 0x00687FE1
00687EA1    jmp 0x00687EC5
00687EA3    mov ecx, dword ptr ds:[0x00CAF778]
00687EA9    movzx eax, ax
00687EAC    mov dword ptr ds:[0x00CAF778], eax
00687EB1    mov dword ptr ds:[edx+0x14], ecx
00687EB4    dec dword ptr ds:[0x00CAF77C]
00687EBA    mov esi, dword ptr ds:[0x00CAF76C]
...
00687F2A    call 0x0064C080
00687F2F    mov edx, dword ptr ds:[0x0147ABEC]
00687F35    test edx, edx
00687F37    jz 0x00687FB0
00687F39    xor esi, esi
00687F3B    nop dword ptr ds:[eax+eax*1], eax
00687F40    mov ecx, dword ptr ds:[0x0147ABF0]
...
00687F82    mov edx, dword ptr ds:[0x0147ABEC]
...
00687FB0    mov ecx, dword ptr ds:[0x0147ABE8]
00687FB6    test ecx, ecx
00687FB8    jz 0x00687FCE
00687FBA    mov edx, 0x38
00687FBF    call 0x0064C080
00687FC4    mov dword ptr ds:[0x0147ABE8], 0x00
00687FCE    pop edi
00687FCF    pop esi
00687FD0    pop ebx
00687FD1    ret
00687FD2    mov ecx, esi
00687FD4    call 0x00688260
00687FD9    mov ecx, dword ptr ds:[0x0147ABF0]
00687FDF    jmp 0x00687F72
00687FE1    push 0x871F88
00687FE6    push 0x45
00687FE8    push 0x871FA0
00687FED    mov edx, 0x801800
00687FF2    mov ecx, 0x871F94
00687FF7    call 0x0063B870
00687FFC    add esp, 0x0C
00687FFF    call 0x0063BC30
00688004    test al, al
00688006    jz 0x00688009
00688008    int3
00688009    call 0x0063BB00
