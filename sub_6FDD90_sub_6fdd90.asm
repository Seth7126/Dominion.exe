...
006FDD95    push 0x7626C0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?GetResourceForNewSubscription@SchedulerProxy@details@Concurrency@@QAEPAVExecutionResource@23@PAV423@@Z ]
006FDD9A    mov eax, dword ptr fs:[0x00000000]
006FDDA0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006FDDAE    push eax                                        ; => [ Data: __security_cookie ]
006FDDAF    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006FDDB2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006FDDF3    jz 0x006FDE23                                   ; => [ Data: data_cf65bc ]
...
006FDE04    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FDE17    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FDE1C    mov dword ptr ds:[ebx+0x08], 0x801800           ; => [ Data: data_801800 ]
006FDE23    mov edx, 0x18
006FDE28    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006FDE2F    mov ecx, ebx
006FDE31    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006FDE6B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FDE70    mov dword ptr ds:[ebx], 0x00
006FDE76    mov ecx, dword ptr ss:[ebp-0x0C]
006FDE79    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006FDE80    pop ecx
006FDE81    pop edi
006FDE82    pop esi
006FDE83    pop ebx
