...
006B2BFB    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
006B2C0D    push 0x86F01C                                   ; => [ String: TextureGetDef ]
006B2C12    push 0x89
006B2C17    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
006B2C1C    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
006B2C21    jmp 0x006B2DD5
006B2C26    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006B2C5B    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: sub_6aea20 ]
...
006B2C89    mov eax, dword ptr ds:[eax+0x04]                ; => [ Data: data_147b078 ]
006B2C8C    push edx
006B2C8D    push 0x00
...
006B2C9D    push 0x87C6A0                                   ; => [ String: Dx11GetTextureBits ]
006B2CA2    push 0xAC3
006B2CA7    mov ecx, 0x87BA34                               ; => [ String: SUCCEEDED(hr) ]
006B2CAC    jmp 0x006B2DD0
006B2CB1    mov ecx, edi
006B2CB3    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
006B2CB8    mov ecx, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
006B2CBE    test eax, eax
006B2CC0    jnz 0x006B2CC6
006B2CC2    xor edx, edx                                    ; => [ Call: nullptr ]
006B2CC4    jmp 0x006B2CE6
006B2CC6    movzx edx, ax
006B2CC9    cmp edx, dword ptr ds:[ecx+0x3C]
006B2CCC    jb 0x006B2CD2
006B2CCE    xor edx, edx                                    ; => [ Call: nullptr ]
...
006B2CE3    cmovnz edx, edi                                 ; => [ Call: nullptr ]
...
006B2CF8    mov eax, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
...
006B2D26    push 0x87C6A0                                   ; => [ String: Dx11GetTextureBits ]
006B2D2B    push 0xACC
006B2D30    mov ecx, 0x87BA34                               ; => [ String: SUCCEEDED(hr) ]
...
006B2D5E    push 0x87C6A0                                   ; => [ String: Dx11GetTextureBits ]
006B2D63    push 0xAD5
006B2D68    mov ecx, 0x87C6F8                               ; => [ String: destSpec->pImage ]
006B2D6D    jmp 0x006B2DD0
006B2D6F    cmp dword ptr ds:[esi+0x04], edi
006B2D72    jz 0x006B2D85
006B2D74    push 0x87C6A0                                   ; => [ String: Dx11GetTextureBits ]
006B2D79    push 0xAD6
006B2D7E    mov ecx, 0x87C6D4                               ; => [ String: destSpec->width == sourceSpec.width ]
...
006B2D8F    call 0x006A9DE0                                 ; => [ Call: sub_6a9de0 ]
006B2D94    mov eax, dword ptr ds:[0x0147B078]
006B2D99    push 0x00
006B2D9B    push dword ptr ss:[ebp-0x34]
006B2D9E    mov eax, dword ptr ds:[eax+0x08]                ; => [ Data: data_147b078 ]
006B2DA1    push eax
...
006B2DB7    pop ebx
006B2DB8    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006B2DBD    mov esp, ebp
006B2DBF    pop ebp
006B2DC0    ret
006B2DC1    push 0x87C6A0                                   ; => [ String: Dx11GetTextureBits ]
006B2DC6    push 0xAD7
006B2DCB    mov ecx, 0x87C70C                               ; => [ String: destSpec->height == sourceSpec.height ]
006B2DD0    push 0x87B990                                   ; => [ String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp ]
006B2DD5    mov edx, 0x801800
006B2DDA    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006B2DDF    add esp, 0x0C
006B2DE2    call 0x0063BC30
006B2DE7    test al, al
006B2DE9    jz 0x006B2DEC                                   ; => [ Call: sub_63bc30 ]
006B2DEB    int3
006B2DEC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
