...
0073D5C6    mov ecx, dword ptr ds:[0x0147DF48]              ; => [ Data: data_147df48 ]
0073D5CC    sub esp, 0x4C
0073D5CF    mov eax, dword ptr ds:[ecx+0x04]
0073D5D2    push esi
0073D5D3    cmp eax, 0x19
0073D5D6    jnz 0x0073D691
0073D5DC    movups xmm0, xmmword ptr ds:[0x00800248]        ; => [ Data: data_800248 ]
...
0073D620    call 0x006B80F0                                 ; => [ Call: sub_6b80f0 ]
...
0073D637    movups xmm0, xmmword ptr ds:[0x00800248]        ; => [ Data: data_800248 ]
0073D63E    mov eax, dword ptr ds:[0x007FEFAC]
0073D643    mov ecx, dword ptr ds:[0x0147DF48]              ; => [ Data: data_147df48 ]
...
0073D67C    call 0x006B80F0                                 ; => [ Call: sub_6b80f0 ]
0073D681    mov ecx, dword ptr ds:[0x0147DF48]
0073D687    call 0x0073DE00                                 ; => [ Data: data_147df48 | Call: sub_73de00 ]
0073D68C    pop esi
...
0073D6A9    pop ebp
0073D6AA    ret                                             ; => [ Call: sub_73def0 ]
0073D6AB    cmp eax, 0x02
0073D6AE    jnz 0x0073D705
0073D6B0    call 0x006DA310                                 ; => [ Call: sub_6da310 ]
0073D6B5    mov esi, eax
0073D6B7    mov ecx, dword ptr ds:[esi+0x68]
0073D6BA    mov dword ptr ds:[0x0147DF70], ecx              ; => [ Data: data_147df70 ]
...
0073D6CE    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
0073D6DD    mov dword ptr ds:[0x0147DF74], 0x00             ; => [ Data: data_147df74 ]
...
0073D6F9    pop ebp
0073D6FA    ret                                             ; => [ Call: sub_6def90 ]
0073D6FB    mov dword ptr ds:[0x0147DF74], 0xFFFFFFFF       ; => [ Data: data_147df74 ]
0073D705    pop esi
...
0073D723    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: assetPtr->assetType == ASSET_TYPE_STRUCTURE | String: StructureDefGet | String: C:\x\ax2017\Engine\AssetUtils.cpp ]
0073D728    add esp, 0x0C
0073D72B    call 0x0063BC30
0073D730    test al, al
0073D732    jz 0x0073D735                                   ; => [ Call: sub_63bc30 ]
0073D734    int3
0073D735    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
