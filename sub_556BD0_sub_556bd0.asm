...
00556BEA    call 0x00564CE0                                 ; => [ Call: sub_564ce0 ]
00556BEF    add esp, 0x04
00556BF2    xor esi, esi
00556BF4    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00556C0B    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00556C0E    cmp esi, 0x320
00556C14    jb 0x00556C1B
00556C16    call 0x00591930                                 ; => [ Call: sub_591930 ]
