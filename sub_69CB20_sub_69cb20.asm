...
0069CB2D    call 0x0069C520                                 ; => [ Call: sub_69c520 ]
0069CB32    test al, al
...
0069CB47    push 0x879548                                   ; => [ String: DefinitionDeleteString ]
0069CB4C    push 0x17C
0069CB51    mov ecx, 0x87953C                               ; => [ String: *pString ]
...
0069CB80    call 0x0069CE80                                 ; => [ Call: sub_69ce80 ]
...
0069CB8B    pop ebp
0069CB8C    ret
0069CB8D    push 0x879580                                   ; => [ String: DefinitionDeleteVariableArrayField ]
0069CB92    push 0x191
0069CB97    mov ecx, 0x878958                               ; => [ String: !DefTypeIsBuiltIn(pField->pSubDefMap) ]
0069CB9C    push 0x879400
0069CBA1    mov edx, 0x801800
0069CBA6    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Definition.cpp ]
0069CBAB    add esp, 0x0C
0069CBAE    call 0x0063BC30
0069CBB3    test al, al
0069CBB5    jz 0x0069CBB8                                   ; => [ Call: sub_63bc30 ]
0069CBB7    int3
0069CBB8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
