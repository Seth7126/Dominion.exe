...
005531AC    mov eax, dword ptr ds:[0x008C4040]
...
00553202    push 0x00
00553204    push 0x08
00553206    call 0x005754F0
0055320B    add esp, 0x08
0055320E    test al, al
00553210    jz 0x0055325B
00553212    call 0x00573400
