...
006D8ED5    push 0x76DE05                                   ; => [ Type: EHRegistrationNode | Call: sub_76de05 ]
006D8EDA    mov eax, dword ptr fs:[0x00000000]
006D8EE0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006D8EEE    push eax                                        ; => [ Data: __security_cookie ]
006D8EEF    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8EF2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006D8EF8    mov ebx, edx
006D8EFA    mov edi, ecx
006D8EFC    test edi, edi
006D8EFE    jnz 0x006D8F75                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8F00    push 0x04
006D8F02    mov edx, 0x879C7C
006D8F07    lea ecx, ss:[ebp-0x10]
006D8F0A    call 0x0069FD50                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | String: !Null\Null | Call: sub_69fd50 ]
006D8F0F    add esp, 0x04
006D8F12    mov dword ptr ss:[ebp-0x04], edi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8F15    lea edx, ds:[edi+0x04]
006D8F18    mov eax, dword ptr ss:[ebp-0x10]
006D8F1B    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006D8F20    test eax, eax
006D8F22    cmovnz ecx, eax
006D8F25    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
006D8F2A    mov esi, eax
006D8F2C    mov dword ptr ss:[ebp-0x04], 0x01
006D8F33    cmp dword ptr ds:[0x00CF65BC], edi
006D8F39    jz 0x006D8F69                                   ; => [ Data: data_cf65bc ]
...
006D8F4A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006D8F5D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006D8F62    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006D8F69    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006D8F70    mov dword ptr ss:[ebp-0x14], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8F73    jmp 0x006D8F80
006D8F75    cmp dword ptr ds:[edi+0x04], 0x04
006D8F79    jnz 0x006D8FDD
006D8F7B    mov dword ptr ss:[ebp-0x14], edi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006D8F8B    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
006D8F90    add esp, 0x04
006D8F93    mov eax, dword ptr ds:[esi]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8F95    inc dword ptr ds:[esi+0x1C]                     ; => [ Field: Next ]
...
006D8FAA    lea eax, ds:[ecx+eax*8]                         ; => [ Field: Next ]
...
006D8FC0    call dword ptr ds:[eax+0x48]                    ; => [ Data: data_147b070 ]
...
006D8FCE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006D8FD5    pop ecx
006D8FD6    pop edi
006D8FD7    pop esi
006D8FD8    pop ebx
...
006D8FF3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006D8FF8    add esp, 0x0C
006D8FFB    call 0x0063BC30
006D9000    test al, al
006D9002    jz 0x006D9005                                   ; => [ Call: sub_63bc30 ]
006D9004    int3
006D9005    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
