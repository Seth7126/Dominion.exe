...
0068CBB5    push 0x76E0B5                                   ; => [ Type: EHRegistrationNode | Call: sub_76e0b5 ]
0068CBBA    mov eax, dword ptr fs:[0x00000000]
0068CBC0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068CBCE    push eax                                        ; => [ Data: __security_cookie ]
0068CBCF    lea eax, ss:[ebp-0x0C]
0068CBD2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0068CBE2    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
0068CBE7    test eax, eax
0068CBE9    mov edi, ebx                                    ; => [ Data: data_801800 ]
0068CBEB    mov ecx, edx
0068CBED    cmovnz edi, eax
0068CBF0    call 0x0063E960                                 ; => [ Call: sub_63e960 ]
0068CBF5    mov ecx, edi
0068CBF7    mov esi, eax
0068CBF9    call 0x0063E960
0068CBFE    sub eax, esi                                    ; => [ Call: sub_63e960 ]
0068CC00    lea ecx, ss:[ebp-0x10]
0068CC03    push esi
0068CC04    push eax
0068CC05    mov edx, edi
0068CC07    call 0x0063E9E0                                 ; => [ Call: sub_63e9e0 ]
...
0068CC53    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0068CC58    mov edi, ecx                                    ; => [ Data: data_801800 ]
0068CC5A    jmp 0x0068CC5E
0068CC5C    mov ecx, edi
0068CC5E    call 0x0063E960                                 ; => [ Call: sub_63e960 ]
0068CC63    mov ecx, dword ptr ss:[ebp-0x14]
0068CC66    mov esi, eax
0068CC68    call 0x0063E960                                 ; => [ Call: sub_63e960 ]
...
0068CC87    call 0x0063D850                                 ; => [ Call: sub_63e9e0 | Call: sub_63d850 ]
0068CC8C    mov byte ptr ss:[ebp-0x04], 0x02
0068CC90    cmp dword ptr ds:[0x00CF65BC], 0x00
0068CC97    jz 0x0068CCC0                                   ; => [ Data: data_cf65bc ]
...
0068CCA8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068CCBB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068CCE0    jz 0x0068CCFD                                   ; => [ Data: data_cf65bc ]
0068CCE2    lea ecx, ss:[ebp-0x10]
0068CCE5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068CCF8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068CCFD    mov al, bl
0068CCFF    mov ecx, dword ptr ss:[ebp-0x0C]
0068CD02    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068CD09    pop ecx
0068CD0A    pop edi
0068CD0B    pop esi
0068CD0C    pop ebx
