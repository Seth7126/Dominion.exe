...
0052D669    push esi
0052D66A    call 0x00566800                                 ; => [ Call: sub_566800 ]
0052D66F    push ecx
0052D670    push 0x00
0052D672    push 0x08
0052D674    xor edx, edx
0052D676    mov ecx, 0x3EA
0052D67B    call 0x00568960                                 ; => [ Call: sub_568960 ]
...
0052D693    mov dword ptr ds:[ecx], 0x8191F8                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_0ee9c1d9d3f2e659ea2ef5922ab1b9ba>, void>::`vftable'{for `std::_Func_base<void>'} ]
0052D699    mov dword ptr ds:[ecx+0x04], eax
0052D69C    mov dword ptr ds:[ecx+0x24], ecx
0052D69F    xor ecx, ecx
0052D6A1    call 0x00569B30                                 ; => [ Call: sub_569b30 ]
...
0052D6B9    call 0x0056E9C0                                 ; => [ Call: sub_56e9c0 ]
