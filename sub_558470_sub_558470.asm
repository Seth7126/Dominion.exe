...
0055847B    call 0x00761E50
00558480    mov eax, dword ptr ds:[0x008C4040]
...
005584A0    call 0x005685F0
005584A5    xorps xmm0, xmm0
005584A8    mov dword ptr ss:[esp+0x28], 0x00
