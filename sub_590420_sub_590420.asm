...
00590426    mov eax, dword ptr ds:[eax+0xBFC]               ; => [ Data: data_cce9c8 ]
...
0059043C    call 0x0063ED10                                 ; => [ Data: data_cce9bc | Data: data_cce9b4 | Call: sub_63ed10 ]
00590441    mov ecx, dword ptr ds:[0x00CCE9C4]              ; => [ Data: data_cce9c4 ]
...
00590467    setz cl
0059046A    mov byte ptr ds:[eax+0x31C], cl                 ; => [ Data: data_cce9c4 ]
00590470    mov eax, dword ptr ds:[0x00CCE9C8]
00590475    mov eax, dword ptr ds:[eax+0xC00]               ; => [ Data: data_cce9c8 ]
...
0059048B    call 0x0063ED10                                 ; => [ Data: data_cce9bc | Data: data_cce9b4 | Call: sub_63ed10 ]
00590490    mov ecx, dword ptr ds:[0x00CCE9C4]              ; => [ Data: data_cce9c4 ]
...
005904B1    mov eax, dword ptr ds:[0x00CCE9C4]              ; => [ Data: data_cce9c4 ]
005904B6    setz cl
