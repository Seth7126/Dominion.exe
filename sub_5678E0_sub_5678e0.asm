...
005678E5    push 0x767155                                   ; => [ Type: EHRegistrationNode | Call: sub_767155 ]
005678EA    mov eax, dword ptr fs:[0x00000000]
005678F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
005678F1    mov eax, 0x1948
005678F6    call 0x00761E50                                 ; => [ Call: __chkstk ]
005678FB    mov eax, dword ptr ds:[0x008C4040]
00567900    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0056790C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00567938    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
...
0056795E    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_5685f0 ]
...
005679B2    mov dword ptr ss:[ebp-0x44], 0x81F130           ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_c6b562f6b099682192088b3c677d835a>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_c6b562f6b099682192088b3c677d835a>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
005679B9    mov dword ptr ss:[ebp-0x30], ecx
005679BC    mov dword ptr ss:[ebp-0x20], eax                ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_c6b562f6b099682192088b3c677d835a>,bool,enum CardID>::VTable ]
...
00567A08    mov dword ptr ds:[ebx+0xC80], eax               ; => [ Call: GSI1::OffForSym ]
...
00567A2C    call 0x00567690                                 ; => [ Call: sub_567690 ]
00567A31    mov eax, ebx
00567A33    mov ecx, dword ptr ss:[ebp-0x0C]
00567A36    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00567A3D    pop ecx
00567A3E    pop edi
00567A3F    pop esi
00567A40    pop ebx
...
00567A46    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
