...
006B4B4E    jnz 0x006B4BA1                                  ; => [ Call: sub_5a0d00 ]
...
006B4B77    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
006B4B90    pop ebp
006B4B91    ret
006B4B92    push 0x825074                                   ; => [ String: Xutf8_peek_next ]
006B4B97    push 0x21C
...
006B4BC4    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
006B4BE3    test al, al
006B4BE5    jz 0x006B4BEB                                   ; => [ Call: sub_6b48d0 ]
...
006B4C10    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
006B4C28    push 0x825084                                   ; => [ String: Xutf8_next ]
006B4C2D    push 0x222
006B4C32    push 0x825090
006B4C37    mov edx, 0x801800
006B4C3C    mov ecx, 0x8250B0
006B4C41    call 0x0063B870                                 ; => [ String: !Xutf8_is_invalid_lead_char(str) | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Xutf8.cpp ]
006B4C46    add esp, 0x0C
006B4C49    call 0x0063BC30
006B4C4E    test al, al
006B4C50    jz 0x006B4C53                                   ; => [ Call: sub_63bc30 ]
006B4C52    int3
006B4C53    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
