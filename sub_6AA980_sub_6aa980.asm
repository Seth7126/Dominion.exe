...
006AA985    push 0x76FA25                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$initialize_tmpfile_buffer_nolock@_W@@YA_NW4buffer_id@?A0x5b9a7937@@@Z ]
006AA98A    mov eax, dword ptr fs:[0x00000000]
006AA990    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006AA991    sub esp, 0x34
006AA994    push esi
006AA995    push edi
006AA996    mov eax, dword ptr ds:[0x008C4040]
006AA99B    xor eax, ebp
006AA99D    push eax                                        ; => [ Data: __security_cookie ]
006AA99E    lea eax, ss:[ebp-0x0C]
006AA9A1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006AA9BE    movups xmmword ptr ss:[ebp-0x40], xmm0          ; => [ Call: __builtin_memset ]
006AA9C2    call 0x006AACF0                                 ; => [ Call: sub_6aacf0 ]
006AA9C7    test al, al
006AA9C9    jnz 0x006AA9DC
006AA9CB    mov ecx, dword ptr ss:[ebp-0x0C]
006AA9CE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AA9D5    pop ecx
006AA9D6    pop edi
006AA9D7    pop esi
...
006AA9FE    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006AAA03    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_6c48e0 ]
006AAA05    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
006AAA3A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AAA4D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AAA52    mov dword ptr ss:[ebp-0x18], edi                ; => [ Data: data_801800 ]
006AAA55    push 0x147D098
006AAA5A    lea eax, ss:[ebp-0x20]
006AAA5D    mov byte ptr ss:[ebp-0x04], 0x02
006AAA61    push 0x87B47C
006AAA66    push eax
006AAA67    call 0x0063DF30                                 ; => [ String: %s/ExternalCode/astc/astcenc.exe | Call: sub_63df30 ]
006AAA6C    mov byte ptr ss:[ebp-0x04], 0x04
006AAA70    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
006AAB5D    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
006AAB97    push dword ptr ss:[ebp+0x0C]                    ; => [ Type: FILE ]
006AAB9A    push 0x87B450
006AAB9F    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: failed to read: %s ]
...
006AAC2B    jz 0x006AAC5B                                   ; => [ Data: data_cf65bc ]
...
006AAC3C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AAC4F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AAC54    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
006AAC5B    mov byte ptr ss:[ebp-0x04], 0x07
006AAC5F    cmp dword ptr ds:[0x00CF65BC], 0x00
006AAC66    jz 0x006AAC96                                   ; => [ Data: data_cf65bc ]
...
006AAC77    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AAC8A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AAC8F    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
006AAC96    mov dword ptr ss:[ebp-0x04], 0x08
006AAC9D    cmp dword ptr ds:[0x00CF65BC], 0x00
006AACA4    jz 0x006AACCD                                   ; => [ Data: data_cf65bc ]
...
006AACB5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AACC8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AACCD    mov al, byte ptr ss:[ebp-0x0D]
006AACD0    mov ecx, dword ptr ss:[ebp-0x0C]
006AACD3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AACDA    pop ecx
006AACDB    pop edi
006AACDC    pop esi
