...
006E65F1    xor eax, esp                                    ; => [ Data: __security_cookie ]
...
006E660D    push 0x87A4EC                                   ; => [ String: FlanimGetDef ]
006E6612    push 0x2ED
006E6617    push 0x87A2E0                                   ; => [ String: C:\x\ax2017\Engine\AssetUtils.cpp ]
006E661C    mov ecx, 0x87A4C0                               ; => [ String: assetPtr->assetType == ASSET_TYPE_FLANIM ]
006E6621    jmp 0x006E686C
006E6626    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
006E662B    mov dword ptr ss:[esp+0x1C], eax
006E662F    mov ecx, esi
006E6631    lea eax, ss:[esp+0x30]
006E6635    push eax
006E6636    call 0x0064B1B0                                 ; => [ Call: sub_64b1b0 ]
...
006E667F    push eax
006E6680    call 0x006E7C30                                 ; => [ Call: sub_6e7c30 ]
...
006E669A    movups xmmword ptr ss:[esp+0x30], xmm0          ; => [ Call: __builtin_memcpy | String:  ]
...
006E66D7    movss dword ptr ss:[esp+0x40], xmm0             ; => [ Data: data_8937c0 ]
006E66DD    movss xmm0, dword ptr ss:[esp+0xC8]
006E66E6    xorps xmm0, xmmword ptr ds:[0x008937C0]
006E66ED    movss dword ptr ss:[esp+0x50], xmm0             ; => [ Data: data_8937c0 ]
006E66F3    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
006E673B    call 0x00642AE0                                 ; => [ Call: sub_642ae0 ]
...
006E6797    push eax
006E6798    call 0x006E62B0                                 ; => [ Call: sub_6e62b0 ]
...
006E67AF    push eax
006E67B0    call 0x006FE1D0                                 ; => [ Call: sub_6fe1d0 ]
...
006E67E7    jz 0x006E680D                                   ; => [ Call: sub_6e5bf0 ]
006E67E9    push esi
...
006E67FB    call 0x006B83A0                                 ; => [ Call: sub_6b83a0 ]
006E6800    test eax, eax
006E6802    jz 0x006E680D
006E6804    mov edx, esi
006E6806    mov ecx, eax
006E6808    call 0x006C24D0                                 ; => [ Call: sub_6c24d0 ]
006E680D    lea ecx, ss:[esp+0x24]
006E6811    call 0x006FE250                                 ; => [ Call: sub_6fe250 ]
...
006E684F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006E6854    mov esp, ebp
006E6856    pop ebp
006E6857    ret
006E6858    push 0x88C2A8                                   ; => [ String: AttachmentDrawOne ]
006E685D    push 0x17A
006E6862    push 0x88C260                                   ; => [ String: C:\x\ax2017\Engine\Attachment.cpp ]
006E6867    mov ecx, 0x801AA4                               ; => [ String: Halt ]
006E686C    mov edx, 0x801800
006E6871    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006E6876    add esp, 0x0C
006E6879    call 0x0063BC30
006E687E    test al, al
006E6880    jz 0x006E6883                                   ; => [ Call: sub_63bc30 ]
006E6882    int3
006E6883    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
