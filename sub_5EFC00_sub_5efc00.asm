...
005EFC0C    jnz 0x005EFC2F                                  ; => [ Data: data_b824dc ]
...
005EFC33    pop ebx
005EFC34    ret
005EFC35    mov edx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
005EFC3B    test edx, edx
005EFC3D    jz 0x005EFC9D
005EFC3F    mov edx, dword ptr ds:[edx+0x7590]
005EFC45    mov ecx, 0x16
005EFC4A    push 0x04
005EFC4C    call 0x00622830                                 ; => [ Call: sub_622830 ]
005EFC51    add esp, 0x04
005EFC54    test al, al
005EFC56    jnz 0x005EFC7B
005EFC58    mov edx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
005EFC77    test al, al
005EFC79    jz 0x005EFC90                                   ; => [ Call: sub_622830 ]
...
005EFCB3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
005EFCB8    add esp, 0x0C
005EFCBB    call 0x0063BC30
005EFCC0    test al, al
005EFCC2    jz 0x005EFCC5                                   ; => [ Call: sub_63bc30 ]
005EFCC4    int3
005EFCC5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
