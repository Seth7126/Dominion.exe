...
004FB27B    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FB280    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
004FB285    xor eax, esp
004FB287    mov dword ptr ss:[esp+0x1994], eax
004FB28E    push esi
004FB28F    push edi
004FB290    call 0x0056D1F0                                 ; => [ Call: sub_56d1f0 ]
004FB295    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FB29A    push 0x00
004FB29C    push 0x00
004FB29E    push 0x01
...
004FB2A6    push 0x02
004FB2A8    call 0x00590760                                 ; => [ Call: sub_590760 ]
004FB2AD    add esp, 0x10
004FB2B0    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FB2CD    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
004FB34E    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
...
004FB365    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
004FB389    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
004FB38D    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FB3A6    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FB439    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
004FB43E    add esp, 0x0C
004FB441    call 0x0063BC30
004FB446    test al, al
004FB448    jz 0x004FB44B                                   ; => [ Call: sub_63bc30 ]
004FB44A    int3
004FB44B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
