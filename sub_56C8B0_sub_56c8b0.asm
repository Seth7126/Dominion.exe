...
0056C8B8    call 0x00761E50
0056C8BD    mov eax, dword ptr ds:[0x008C4040]
0056C8C2    xor eax, ebp
0056C8C4    mov dword ptr ss:[ebp-0x04], eax
0056C8C7    push ebx
0056C8C8    push esi
