...
005BC4A0    movaps xmm6, xmmword ptr ds:[0x00893890]        ; => [ Data: data_893890 ]
005BC4A7    minps xmm1, xmm0                                ; => [ Data: data_893680 ]
005BC4AA    movaps xmm5, xmmword ptr ds:[0x008935F0]        ; => [ Data: data_8935f0 ]
005BC4B1    movaps xmm2, xmmword ptr ds:[0x00893770]        ; => [ Data: data_893770 ]
005BC4B8    maxps xmm6, xmm1
005BC4BB    movaps xmmword ptr ss:[ebp-0x10], xmm0
005BC4BF    xorps xmm0, xmm0
005BC4C2    mulps xmm5, xmm6
005BC4C5    movaps xmm7, xmmword ptr ds:[0x00893860]        ; => [ Data: data_893860 ]
005BC4CC    addps xmm5, xmmword ptr ds:[0x008934E0]         ; => [ Data: data_8934e0 ]
005BC4D3    movaps xmm4, xmm5
005BC4D6    movaps xmm1, xmm5
005BC4D9    andps xmm4, xmmword ptr ds:[0x008937A0]         ; => [ Data: data_8937a0 ]
005BC4E0    cmpps xmm1, xmm0, 0x01                          ; => [ String: 0 | String: zx ]
005BC4E4    movaps xmm3, xmm4
005BC4E7    movaps xmm0, xmmword ptr ds:[0x00893370]        ; => [ Data: data_893370 ]
...
005BC508    orps xmm2, xmm1                                 ; => [ Data: data_8937c0 ]
005BC50B    movaps xmm3, xmmword ptr ds:[0x00893360]        ; => [ String: giP9giP9giP9giP9 ]
005BC512    andps xmm2, xmm4
005BC515    movaps xmm1, xmmword ptr ds:[0x008937C0]        ; => [ Data: data_8937c0 ]
...
005BC52D    subps xmm2, xmm5                                ; => [ Data: data_8935b0 ]
005BC530    mulps xmm0, xmm2
005BC533    mulps xmm7, xmm2
005BC536    addps xmm7, xmm6
005BC539    addps xmm7, xmm0
005BC53C    movaps xmm0, xmmword ptr ds:[0x008936D0]        ; => [ Data: data_8936d0 ]
...
005BC552    addps xmm3, xmmword ptr ds:[0x008933A0]         ; => [ Data: data_8933a0 ]
...
005BC56B    addps xmm3, xmmword ptr ds:[0x008933E0]         ; => [ Data: data_8933e0 ]
005BC572    movaps xmm1, xmm2
005BC575    psubd xmm5, xmm2
005BC579    movaps xmm0, xmm4
005BC57C    paddd xmm1, xmmword ptr ds:[0x00891970]         ; => [ Data: data_891970 ]
...
005BC59C    pslld xmm5, 0x17                                ; => [ Data: data_891970 ]
...
005BC5BF    addps xmm3, xmm0                                ; => [ Data: data_893460 | Data: data_8934e0 | Data: data_893410 ]
005BC5C2    movaps xmm0, xmmword ptr ds:[0x008935B0]
005BC5C9    addps xmm0, xmm7                                ; => [ Data: data_8935b0 ]
