...
005466E1    call 0x00573400                                 ; => [ Call: sub_573400 ]
005466E6    mov ebx, dword ptr ds:[eax+0x04]
005466E9    test ebx, ebx
005466EB    jnz 0x00546706
005466ED    push 0x81EDE0                                   ; => [ String: GameRNG ]
005466F2    push 0x1577
005466F7    push 0x81EA70                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
005466FC    mov ecx, 0x81EDE8                               ; => [ Data: data_81ede8 ]
...
00546719    call 0x0063ED10                                 ; => [ Call: sub_63ed10 ]
...
00546737    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00546752    call 0x005727E0                                 ; => [ Call: sub_5727e0 ]
...
00546769    pop ebx
0054676A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0054676F    mov esp, ebp
00546771    pop ebp
00546772    ret
00546773    push 0x871F38                                   ; => [ String: RandomPCGIntRange ]
00546778    push 0x120
0054677D    push 0x871ED0                                   ; => [ String: C:\x\ax2017\Engine\Random.cpp ]
00546782    mov ecx, 0x871F28                               ; => [ String: mmin <= mmax ]
00546787    mov edx, 0x801800
0054678C    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00546791    add esp, 0x0C
00546794    call 0x0063BC30
00546799    test al, al
0054679B    jz 0x0054679E                                   ; => [ Call: sub_63bc30 ]
0054679D    int3
0054679E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
