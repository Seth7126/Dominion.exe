...
0059D275    push 0x767F36                                   ; => [ Call: __ehhandler$??1ResourceManager@details@Concurrency@@AAE@XZ | Type: EHRegistrationNode ]
0059D27A    mov eax, dword ptr fs:[0x00000000]
0059D280    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0059D28E    push eax                                        ; => [ Data: __security_cookie ]
0059D28F    lea eax, ss:[ebp-0x0C]
0059D292    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0059D2A5    push 0x00                                       ; => [ Call: nullptr ]
0059D2A7    push 0x01
...
0059D2B5    push esi
0059D2B6    push 0x00
0059D2B8    call 0x0059AAE0                                 ; => [ Call: sub_59aae0 | Call: nullptr ]
...
0059D2DF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059D2FF    jz 0x0059D414                                   ; => [ Data: data_cf65bc ]
...
0059D31E    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0059D323    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_599ce0 ]
...
0059D358    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059D36B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059D370    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
0059D393    call 0x00599090                                 ; => [ Call: sub_599090 | String: [entry] | String: [help] ]
...
0059D3AD    jz 0x0059D3DD                                   ; => [ Data: data_cf65bc ]
...
0059D3BE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059D3D1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059D3D6    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
0059D3DD    mov dword ptr ss:[ebp-0x04], 0x08
0059D3E4    cmp dword ptr ds:[0x00CF65BC], 0x00
0059D3EB    jz 0x0059D414                                   ; => [ Data: data_cf65bc ]
...
0059D3FC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0059D40F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0059D414    mov eax, edi
0059D416    mov ecx, dword ptr ss:[ebp-0x0C]
0059D419    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0059D420    pop ecx
0059D421    pop edi
0059D422    pop esi
0059D423    pop ebx
