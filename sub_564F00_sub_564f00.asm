...
00564F18    push 0x76646B                                   ; => [ Call: sub_76646b | Type: EHRegistrationNode ]
00564F1D    mov eax, dword ptr fs:[0x00000000]
00564F23    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00564F24    push ebx
00564F25    mov eax, 0x19B0
00564F2A    call 0x00761E50                                 ; => [ Call: __chkstk ]
00564F2F    mov eax, dword ptr ds:[0x008C4040]
00564F34    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00564F36    mov dword ptr ss:[ebp-0x14], eax
00564F39    push esi
00564F3A    push edi
00564F3B    push eax
00564F3C    lea eax, ss:[ebp-0x0C]
00564F3F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00564F45    mov dword ptr ss:[ebp-0xCA8], edx
00564F4B    mov dword ptr ss:[ebp-0xCAC], ecx
00564F51    call 0x00573400                                 ; => [ Call: sub_573400 ]
00564F56    lea ecx, ss:[ebp-0x19C0]
00564F5C    push 0x04
00564F5E    push ecx
00564F5F    mov edx, dword ptr ds:[eax+0x0C]
00564F62    mov ecx, dword ptr ds:[eax+0x04]
00564F65    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00564F6A    mov ecx, 0x321
00564F6F    mov dword ptr ss:[ebp-0xD40], eax
00564F75    lea esi, ss:[ebp-0x19C0]
00564F7B    mov dword ptr ss:[ebp-0xD08], 0x81F280          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_2e415c4bd163efc1f0f4ed696abf70e3>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2e415c4bd163efc1f0f4ed696abf70e3>,bool,enum CardID>::VTable ]
00564F85    lea edi, ss:[ebp-0xCA0]
00564F8B    add esp, 0x08
00564F8E    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00564F90    lea ecx, ds:[ebx+0x08]
00564F93    mov dword ptr ss:[ebp-0xD04], ecx
00564F99    lea ecx, ss:[ebp-0xD08]
00564F9F    mov dword ptr ss:[ebp-0xCE4], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_2e415c4bd163efc1f0f4ed696abf70e3>,bool,enum CardID>::VTable ]
...
00565021    push eax
00565022    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
00565056    movlpd qword ptr ss:[ebp-0xCCC], xmm0           ; => [ Call: __builtin_memset ]
...
005650C0    mov esi, eax                                    ; => [ Call: sub_563c40 ]
005650C2    add esp, 0x0C
005650C5    test esi, esi
005650C7    jz 0x005650FB
005650C9    call 0x00573400                                 ; => [ Call: sub_573400 ]
005650CE    push 0x04
005650D0    push 0x00
005650D2    push 0x00
...
005650F2    test al, al
005650F4    cmovz esi, ecx                                  ; => [ Call: nullptr | Call: sub_583720 | Call: nullptr ]
005650F7    mov eax, esi
005650F9    jmp 0x005650FD
005650FB    xor eax, eax                                    ; => [ Call: nullptr ]
005650FD    mov ecx, dword ptr ss:[ebp-0x0C]
00565100    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00565107    pop ecx
00565108    pop edi
00565109    pop esi
0056510A    mov ecx, dword ptr ss:[ebp-0x14]
0056510D    xor ecx, ebp
0056510F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
