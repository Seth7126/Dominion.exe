...
006A1715    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
006A171A    mov eax, dword ptr fs:[0x00000000]
006A1720    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006A1721    sub esp, 0x08
006A1724    push esi
006A1725    push edi
006A1726    mov eax, dword ptr ds:[0x008C4040]
006A172B    xor eax, ebp
006A172D    push eax                                        ; => [ Data: __security_cookie ]
006A172E    lea eax, ss:[ebp-0x0C]
006A1731    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006A1737    mov edx, ecx
006A1739    lea ecx, ss:[ebp-0x10]
006A173C    push 0x03
006A173E    call 0x0069FD50                                 ; => [ Call: sub_69fd50 ]
006A1743    mov dword ptr ss:[ebp-0x04], 0x00
006A174A    mov edi, 0x801800
006A174F    mov eax, dword ptr ss:[ebp-0x10]
006A1752    mov ecx, edi                                    ; => [ Data: data_801800 ]
006A1754    test eax, eax
006A1756    cmovnz ecx, eax
006A1759    push ecx
006A175A    push 0x87A344
006A175F    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: Creating %s ]
...
006A17B3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006A17C6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A17CB    mov eax, esi
006A17CD    mov ecx, dword ptr ss:[ebp-0x0C]
006A17D0    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A17D7    pop ecx
006A17D8    pop edi
006A17D9    pop esi
