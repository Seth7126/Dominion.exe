...
0064F875    push 0x76CCF8                                   ; => [ Type: EHRegistrationNode | Call: sub_76ccf8 ]
0064F87A    mov eax, dword ptr fs:[0x00000000]
0064F880    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064F88F    push esi
0064F890    push edi
0064F891    push eax                                        ; => [ Data: __security_cookie ]
0064F892    lea eax, ss:[ebp-0x0C]
0064F895    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0064F8B2    mov ecx, eax                                    ; => [ Call: sub_6dd1e0 | Data: data_8cae70 | Data: data_1724a80 ]
...
0064F8D3    xor eax, eax                                    ; => [ Call: nullptr ]
0064F8D5    mov dword ptr ss:[ebp-0x54], eax                ; => [ Call: nullptr ]
0064F8D8    nop dword ptr ds:[eax+eax*1], eax
0064F8E0    mov esi, dword ptr ds:[ecx]
0064F8E2    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064F954    push eax
0064F955    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
...
0064F975    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0064F97C    pop ecx
0064F97D    pop edi
0064F97E    pop esi
0064F97F    pop ebx
...
0064F985    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0064F9A1    push eax
0064F9A2    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
0064F9A7    mov al, 0x01
0064F9A9    jmp 0x0064F972
