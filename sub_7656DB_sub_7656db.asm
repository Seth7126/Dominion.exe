...
007656EC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007656F1    mov ecx, dword ptr ds:[edx-0x08]
007656F4    xor ecx, eax
007656F6    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
007656FB    mov eax, 0x8B1828
00765700    jmp 0x00761FA6                                  ; => [ Data: data_8b1828 | Call: __CxxFrameHandler3 ]
