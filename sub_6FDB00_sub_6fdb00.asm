...
006FDB05    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
006FDB0A    mov eax, dword ptr fs:[0x00000000]
006FDB10    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006FDB11    sub esp, 0x0C
006FDB14    push esi
006FDB15    mov eax, dword ptr ds:[0x008C4040]
006FDB1A    xor eax, ebp
006FDB1C    push eax                                        ; => [ Data: __security_cookie ]
006FDB1D    lea eax, ss:[ebp-0x0C]
006FDB20    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006FDB26    mov esi, ecx
006FDB28    mov ecx, dword ptr ds:[0x0147DED0]              ; => [ Data: data_147ded0 ]
...
006FDB59    mov dword ptr ds:[0x0147DED0], esi              ; => [ Data: data_147ded0 ]
006FDB5F    push ecx
...
006FDB6D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006FDB72    inc dword ptr ds:[eax+0x04]
006FDB75    lea ecx, ss:[ebp-0x10]
006FDB78    call 0x006C5250                                 ; => [ Call: sub_6c5250 ]
006FDB7D    add esp, 0x04
006FDB80    mov dword ptr ss:[ebp-0x04], 0x00
006FDB87    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006FDB9E    call 0x006C9590                                 ; => [ Call: sub_6c9590 ]
...
006FDBCF    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
006FDBD4    add esp, 0x04
006FDBD7    inc dword ptr ds:[esi+0x1C]
006FDBDA    cmp dword ptr ds:[0x0147DEC8], 0x00
006FDBE1    jz 0x006FDC35                                   ; => [ Data: data_147dec8 ]
006FDBE3    push 0x9C
006FDBE8    push 0x00
006FDBEA    push 0x147DEF0
006FDBEF    mov dword ptr ds:[0x0147DF8C], 0x02             ; => [ Data: data_147df8c ]
006FDBF9    call 0x00761FC4                                 ; => [ Call: memset | Data: data_147def0 ]
006FDBFE    movss xmm0, dword ptr ds:[0x008C4634]           ; => [ Data: data_8c4634 ]
006FDC06    add esp, 0x0C
006FDC09    mov dword ptr ds:[0x0147DF0C], 0x43C80000       ; => [ Data: data_147df0c ]
006FDC13    mov dword ptr ds:[0x0147DF10], 0x44160000       ; => [ Data: data_147df10 ]
006FDC1D    mov dword ptr ds:[0x0147DF44], 0x3F800000       ; => [ Data: data_147df44 ]
006FDC27    mov dword ptr ds:[0x0147DF48], esi              ; => [ Data: data_147df48 ]
006FDC2D    movss dword ptr ds:[0x0147DF84], xmm0           ; => [ Data: data_147df84 ]
006FDC35    mov dword ptr ss:[ebp-0x04], 0x01
006FDC3C    cmp dword ptr ds:[0x00CF65BC], 0x00
006FDC43    jz 0x006FDC6C                                   ; => [ Data: data_cf65bc ]
...
006FDC54    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006FDC67    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006FDC6C    mov ecx, dword ptr ss:[ebp-0x0C]
006FDC6F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006FDC76    pop ecx
006FDC77    pop esi
