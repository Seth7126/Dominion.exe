...
0052A368    jz 0x0052A3E5
0052A36A    lea eax, ss:[ebp-0x1C]
0052A36D    mov dword ptr ss:[ebp-0x48], 0x81F114
0052A374    mov dword ptr ss:[ebp-0x44], eax
0052A377    lea eax, ss:[ebp-0x48]
0052A37A    mov dword ptr ss:[ebp-0x24], eax
...
0052A3EE    mov dword ptr ss:[ebp-0x70], 0x81F0F8
...
0052A496    mov dword ptr fs:[0x00000000], ecx
0052A49D    pop ecx
0052A49E    pop edi
0052A49F    pop esi
0052A4A0    pop ebx
...
0052A4AA    mov dword ptr fs:[0x00000000], ecx
0052A4B1    pop ecx
0052A4B2    pop edi
0052A4B3    pop esi
0052A4B4    pop ebx
