...
0064F9B9    mov eax, dword ptr ds:[0x008C4040]
...
0064FAFB    push 0x8747B0
0064FB00    push 0x1278
0064FB05    mov ecx, 0x8747D4
...
0064FB82    push 0x8747B0
0064FB87    push 0x1273
0064FB8C    jmp 0x0064FBFC
0064FB8E    push 0x8747B0
0064FB93    push 0x1272
0064FB98    mov ecx, 0x8747D4
...
0064FBE7    pop esi
0064FBE8    pop ebx
0064FBE9    call 0x0075927A
0064FBEE    mov esp, ebp
0064FBF0    pop ebp
0064FBF1    ret
0064FBF2    push 0x8747B0
0064FBF7    push 0x1279
0064FBFC    mov ecx, 0x8747FC
0064FC01    push 0x8739B4
0064FC06    mov edx, 0x801800
0064FC0B    call 0x0063B870
0064FC10    add esp, 0x0C
0064FC13    call 0x0063BC30
0064FC18    test al, al
0064FC1A    jz 0x0064FC1D
0064FC1C    int3
0064FC1D    call 0x0063BB00
