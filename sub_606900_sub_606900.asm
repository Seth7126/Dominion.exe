...
00606909    mov eax, dword ptr ds:[0x008C4040]
...
00606968    call 0x00654CE0
0060696D    mov eax, dword ptr ss:[esp+0x34]
00606971    add esp, 0x18
00606974    mov ecx, dword ptr ds:[0x01A94E80]
0060697A    xor edx, edx
0060697C    xor esi, esi
...
00606992    inc edx
00606993    cmp dword ptr ds:[0x01A94E64], 0x865440
...
006069FA    mov ecx, eax
006069FC    add esp, 0x04
006069FF    mov dword ptr ds:[0x01A94E80], ecx
00606A05    test ecx, ecx
00606A07    jz 0x00606A44
00606A09    mov eax, dword ptr ss:[esp+0x14]
00606A0D    mov dword ptr ds:[0x01A94E64], 0x865440
00606A17    mov dword ptr ds:[0x01A94E60], eax
00606A1C    mov dword ptr ds:[0x01A94E68], esi
00606A22    mov dword ptr ds:[0x01A94E6C], 0x00
00606A2C    mov eax, dword ptr ss:[esp+0x18]
00606A30    mov edx, dword ptr ss:[esp+0x1C]
00606A34    push dword ptr ds:[eax]
00606A36    call 0x005E03B0
00606A3B    mov ecx, dword ptr ds:[0x01A94E80]
...
00606AAD    push dword ptr ds:[0x0171E830]
00606AB3    jmp 0x00606ABB
00606AB5    push dword ptr ds:[0x0171E7F0]
00606ABB    call 0x00654CE0
...
00606C11    call 0x0064E7A0
00606C16    mov edx, 0xBE3220
00606C1B    jmp 0x00606CB5
00606C20    mov al, 0x01
00606C22    jmp 0x00606B41
00606C27    mov eax, dword ptr ds:[0x019E2724]
00606C2C    cmp eax, 0x03
00606C2F    jnbe 0x00606FF1
00606C35    jmp dword ptr ds:[eax*4+0x607024]
00606C3C    call 0x004C89A0
00606C41    cmp eax, 0x10
00606C44    jz 0x00606CCB
00606C4A    mov eax, dword ptr ds:[0x00CC8DC0]
00606C4F    test eax, eax
00606C51    jnz 0x00606C6C
00606C53    push 0x806A44
00606C58    push 0x5FB
00606C5D    push 0x806734
00606C62    mov ecx, 0x806A58
...
00606DDA    mov dword ptr ds:[eax+0x1694], esi
