...
007183A6    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007183C4    push 0x24
007183C6    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
007183C8    add esp, 0x0C
007183CB    jmp 0x007183D8
007183CD    push 0x24
007183CF    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
007183D5    add esp, 0x04
007183D8    mov esi, eax
007183DA    test esi, esi
007183DC    jz 0x00718416
007183DE    mov dword ptr ds:[esi+0x04], 0x00               ; => [ Call: __builtin_memset ]
...
00718416    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0071842C    push 0x0C
0071842E    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00718430    add esp, 0x0C
00718433    jmp 0x00718440
00718435    push 0x0C
00718437    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00718454    mov dword ptr ds:[eax+0x08], 0x718330           ; => [ Call: sub_718330 ]
0071845B    mov eax, dword ptr ds:[esi+0x04]
0071845E    imul ebx, ebx, 0x4C
00718461    mov dword ptr ds:[eax], 0x716300                ; => [ Call: sub_716300 ]
00718467    mov eax, dword ptr ds:[esi+0x04]
0071846A    add ebx, 0xFFFFFFB4
0071846D    mov dword ptr ds:[eax+0x04], 0x718310           ; => [ Call: sub_718310 ]
00718474    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00718479    test eax, eax
0071847B    jz 0x0071848C
0071847D    push 0x75
0071847F    push 0x88DCF8
00718484    push ebx
00718485    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00718487    add esp, 0x0C
0071848A    jmp 0x00718496
0071848C    push ebx
0071848D    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0071849D    push 0x00
0071849F    push edi
007184A0    call 0x00761FC4                                 ; => [ Call: memset ]
007184A5    add esp, 0x0C
007184A8    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007184C7    push edi
007184C8    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
007184CA    add esp, 0x0C
007184CD    jmp 0x007184D9
007184CF    push edi
007184D0    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007184E0    push 0x00
007184E2    push ebx
007184E3    call 0x00761FC4                                 ; => [ Call: memset ]
007184E8    add esp, 0x0C
007184EB    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00718501    push edi
00718502    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\spAnimation.c ]
00718504    add esp, 0x0C
00718507    jmp 0x00718513
00718509    push edi
0071850A    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
0071851A    push 0x00
0071851C    push ebx
0071851D    call 0x00761FC4                                 ; => [ Call: memset ]
