...
00732F25    push 0x772B05                                   ; => [ Type: EHRegistrationNode | Call: sub_772b05 ]
00732F2A    mov eax, dword ptr fs:[0x00000000]
00732F30    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00732F41    push eax                                        ; => [ Data: __security_cookie ]
00732F42    lea eax, ss:[ebp-0x0C]
00732F45    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00732F4B    mov dword ptr ss:[ebp-0x04], 0x00
00732F52    mov ebx, dword ptr ds:[edx]
00732F54    mov dword ptr ss:[ebp-0x14], ebx
00732F57    mov dword ptr ss:[ebp-0x2C], 0x00               ; => [ Call: nullptr ]
...
00732F79    call 0x00732E10                                 ; => [ String: HAVE_VERTEX_SHADER | Call: sub_732e10 ]
00732F7E    mov edx, 0x88EB84
00732F83    lea ecx, ss:[ebp-0x2C]
00732F86    call 0x00732E10                                 ; => [ Call: sub_732e10 | String: HAVE_PIXEL_SHADER ]
00732F8B    add esp, 0x04
00732F8E    xor esi, esi
00732F90    push 0x10
00732F92    push 0x50
00732F94    call dword ptr ds:[0x00775518]                  ; => [ Type: HRESULT ]
...
00732FAF    call 0x0069CA80                                 ; => [ Data: data_1777524 | Call: sub_69ca80 ]
...
00732FC7    mov edx, 0x88EB7C                               ; => [ String: MainPS ]
00732FCC    jmp 0x00732FDA
00732FCE    test esi, esi
00732FD0    mov eax, 0x88EBC4                               ; => [ String: MainVS ]
00732FD5    cmovnz eax, edx
00732FD8    mov edx, eax
00732FDA    cmp byte ptr ss:[ebp+0x0C], 0x00
00732FDE    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00732FE3    mov eax, dword ptr ss:[ebp+0x08]                ; => [ Type: HRESULT ]
...
00733008    test al, al
0073300A    jnz 0x00733046                                  ; => [ Call: sub_6b2780 ]
0073300C    mov eax, dword ptr ss:[ebp+0x08]                ; => [ Type: HRESULT ]
0073300F    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00733014    test eax, eax
00733016    cmovnz ecx, eax
00733019    mov eax, 0x8007FC                               ; => [ Data: data_8007fc ]
0073301E    nop
...
0073302D    mov eax, 0x801800                               ; => [ Data: data_801800 ]
00733032    jmp 0x00733037
00733034    mov eax, dword ptr ds:[eax+0x04]
00733037    push ecx
00733038    push eax
00733039    push 0x88EB98
0073303E    call 0x0063B5F0                                 ; => [ String: dx11 shader %s reimport failed to read '%s' | Call: sub_63b5f0 ]
00733043    add esp, 0x0C
00733046    mov eax, dword ptr ss:[ebp+0x08]
00733049    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0073304E    test eax, eax
00733050    mov edx, edi
00733052    cmovnz ecx, eax
00733055    call 0x00705F00
0073305A    test al, al
0073305C    jnz 0x007330EB                                  ; => [ Call: sub_705f00 ]
00733062    mov eax, dword ptr ss:[ebp+0x08]                ; => [ Type: HRESULT ]
00733065    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0073306A    test eax, eax
0073306C    cmovnz ecx, eax
0073306F    mov eax, 0x8007FC                               ; => [ Data: data_8007fc ]
...
00733087    push eax                                        ; => [ Data: data_801800 ]
00733088    push 0x88EC00
0073308D    call 0x0063B5F0                                 ; => [ String: shader %s opengl reimport failed to read '%s' | Call: sub_63b5f0 ]
...
007330A1    call 0x0063B5F0                                 ; => [ String: shader %s opengl reimport failed to read '%s' | Call: sub_63b5f0 ]
...
007330BD    push eax
007330BE    push esi
007330BF    call 0x006B2780                                 ; => [ Call: sub_6b2780 ]
007330C4    add esp, 0x14
007330C7    test al, al
007330C9    jz 0x007332C0
007330CF    mov eax, dword ptr ss:[ebp+0x08]                ; => [ Type: HRESULT ]
007330D2    mov ecx, 0x801800                               ; => [ Type: HRESULT | Data: data_801800 ]
007330D7    test eax, eax
007330D9    mov edx, edi
007330DB    cmovnz ecx, eax
007330DE    call 0x00705D70                                 ; => [ Call: sub_705d70 ]
007330E3    test al, al
...
00733110    mov dword ptr ss:[ebp-0x10], 0x00               ; => [ Call: nullptr ]
...
00733125    jns 0x0073315A                                  ; => [ Data: data_77e8c4 ]
...
00733139    call 0x004D6960                                 ; => [ Call: sub_4d6960 ]
0073313E    mov edx, 0x10
00733143    mov ecx, esi
00733145    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
007331C4    jle 0x0073320E                                  ; => [ Data: data_8ce7c4 ]
007331C6    xor edi, edi
007331C8    nop dword ptr ds:[eax+eax*1], eax
007331D0    mov ebx, dword ptr ds:[0x008CE7C0]              ; => [ Data: data_8ce7c0 ]
007331D6    push ecx
...
007331F5    jl 0x007331D0                                   ; => [ Data: data_8ce7c4 ]
...
0073324A    call 0x004D6960                                 ; => [ Call: sub_4d6960 ]
0073324F    mov edx, 0x10
00733254    mov ecx, esi
00733256    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0073326D    jz 0x00733296                                   ; => [ Type: HRESULT | Data: data_cf65bc ]
...
0073327E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00733291    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00733296    mov al, 0x01
00733298    mov ecx, dword ptr ss:[ebp-0x0C]
0073329B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
007332A2    pop ecx
007332A3    pop edi
007332A4    pop esi
007332A5    pop ebx
...
007332A8    pop ebp
007332A9    ret
007332AA    push 0x88EBF0                                   ; => [ String: ShaderImport ]
007332AF    push 0xB1
007332B4    push 0x88EBCC                                   ; => [ String: C:\x\ax2017\Engine\ShaderImport.cpp ]
007332B9    mov ecx, 0x801AA4                               ; => [ String: Halt ]
007332BE    jmp 0x007332E7
007332C0    push 0x88EBF0                                   ; => [ String: ShaderImport ]
007332C5    push 0x98
007332CA    push 0x88EBCC                                   ; => [ String: C:\x\ax2017\Engine\ShaderImport.cpp ]
007332CF    mov ecx, 0x801AA4                               ; => [ String: Halt ]
007332D4    jmp 0x007332E7
007332D6    push 0x8770A0                                   ; => [ String: XMalloc ]
007332DB    push 0x57
007332DD    push 0x877080                                   ; => [ String: C:\x\ax2017\Engine\xMemory.cpp ]
007332E2    mov ecx, 0x8770C8                               ; => [ String: pBuffer ]
007332E7    mov edx, 0x801800
007332EC    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
007332F1    add esp, 0x0C
007332F4    call 0x0063BC30
007332F9    test al, al
007332FB    jz 0x007332FE                                   ; => [ Call: sub_63bc30 ]
007332FD    int3
007332FE    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00733303    push 0x88EBF0
00733308    push 0xE2
0073330D    push 0x88EBCC
00733312    mov edx, 0x801800
00733317    mov ecx, 0x87BA34
0073331C    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SUCCEEDED(hr) | Data: data_801800 | String: ShaderImport | String: C:\x\ax2017\Engine\ShaderImport.cpp ]
00733321    add esp, 0x0C
00733324    call 0x0063BC30
00733329    test al, al
0073332B    jz 0x0073332E                                   ; => [ Call: sub_63bc30 ]
0073332D    int3
0073332E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
