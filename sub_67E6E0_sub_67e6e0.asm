...
0067E6E5    push 0x76DB20                                   ; => [ Call: __ehhandler$??_EGlobalCore@details@Concurrency@@QAEPAXI@Z | Type: EHRegistrationNode ]
0067E6EA    mov eax, dword ptr fs:[0x00000000]
0067E6F0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0067E6F1    push ecx
0067E6F2    push esi
0067E6F3    push edi
0067E6F4    mov eax, dword ptr ds:[0x008C4040]
0067E6F9    xor eax, ebp
0067E6FB    push eax                                        ; => [ Data: __security_cookie ]
0067E6FC    lea eax, ss:[ebp-0x0C]
0067E6FF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0067E705    mov esi, ecx
0067E707    mov dword ptr ss:[ebp-0x04], 0x00
0067E70E    cmp dword ptr ds:[0x00CF65BC], 0x00
0067E715    jz 0x0067E74E                                   ; => [ Data: data_cf65bc ]
...
0067E72C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067E73F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067E744    mov dword ptr ds:[esi+0x1720], 0x801800         ; => [ Data: data_801800 ]
0067E74E    mov dword ptr ss:[ebp-0x04], 0x01
0067E755    cmp dword ptr ds:[0x00CF65BC], 0x00
0067E75C    jz 0x0067E783                                   ; => [ Data: data_cf65bc ]
...
0067E81E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067E831    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067E836    mov dword ptr ds:[esi+0x15FC], 0x801800         ; => [ Data: data_801800 ]
...
0067E859    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067E88A    jz 0x0067E8C3                                   ; => [ Data: data_cf65bc ]
...
0067E8A1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067E8B4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0067E8B9    mov dword ptr ds:[esi+0x15E0], 0x801800         ; => [ Data: data_801800 ]
0067E8C3    lea ecx, ds:[esi+0x13F8]
0067E8C9    call 0x006532F0                                 ; => [ Call: sub_6532f0 ]
0067E8CE    lea ecx, ds:[esi+0x1344]
0067E8D4    call 0x0067E610                                 ; => [ Call: sub_67e610 ]
0067E8D9    mov ecx, dword ptr ss:[ebp-0x0C]
0067E8DC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0067E8E3    pop ecx
0067E8E4    pop edi
0067E8E5    pop esi
