...
0061DAD0    mov eax, dword ptr ds:[0x01723FF4]              ; => [ Data: data_1723ff4 ]
0061DAD5    push esi
0061DAD6    sub eax, 0x00
0061DAD9    jz 0x0061DB54
0061DADB    sub eax, 0x01
0061DADE    jz 0x0061DAF4
0061DAE0    push 0x86AADC                                   ; => [ String: CampaignGetStatus ]
0061DAE5    push 0xDEF3
0061DAEA    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0061DAEF    jmp 0x0061DB7B
0061DAF4    mov ecx, dword ptr ds:[0x00CC8DC8]
0061DAFA    mov ecx, dword ptr ds:[ecx+0x1E1A4]
0061DB00    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
0061DB05    mov edx, dword ptr ds:[0x01723FF8]              ; => [ Data: data_1723ff8 ]
...
0061DB47    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: using local status ]
...
0061DB6A    pop esi
0061DB6B    ret                                             ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
0061DB6C    push 0x86AADC                                   ; => [ String: CampaignGetStatus ]
0061DB71    push 0xDEE9
0061DB76    mov ecx, 0x86AACC                               ; => [ String: weeklyStatus ]
0061DB7B    push 0x86F1E8
0061DB80    mov edx, 0x801800
0061DB85    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 | String: CampaignGetStatus ]
0061DB8A    add esp, 0x0C
0061DB8D    call 0x0063BC30
0061DB92    test al, al
0061DB94    jz 0x0061DB97                                   ; => [ Call: sub_63bc30 ]
0061DB96    int3
0061DB97    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
