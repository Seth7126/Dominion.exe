...
004D6D15    push 0x7639D0                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?Dequeue@?$SafeSQueue@VRealizedChore@details@Concurrency@@V_HyperNonReentrantLock@23@@details@Concurrency@@QAEPAVRealizedChore@23@XZ ]
004D6D1A    mov eax, dword ptr fs:[0x00000000]
004D6D20    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D6D21    push ecx
004D6D22    push esi
004D6D23    push edi
004D6D24    mov eax, dword ptr ds:[0x008C4040]
004D6D29    xor eax, ebp
004D6D2B    push eax                                        ; => [ Data: __security_cookie ]
004D6D2C    lea eax, ss:[ebp-0x0C]
004D6D2F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004D6D35    mov esi, ecx
004D6D37    lea ecx, ds:[esi+0x7304]
004D6D3D    call 0x004DB4C0                                 ; => [ Call: sub_4db4c0 ]
...
004D6DD2    push eax
004D6DD3    call 0x007592FC                                 ; => [ Call: sub_4ab1f0 | Call: `eh vector vbase constructor iterator' ]
...
004D6E68    push eax
004D6E69    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4d6960 ]
...
004D6EC4    push eax
004D6EC5    call 0x007592FC                                 ; => [ Call: sub_4d6880 | Call: `eh vector vbase constructor iterator' ]
004D6ECA    lea ecx, ds:[esi+0x4290]
004D6ED0    call 0x004D67D0                                 ; => [ Call: sub_4d67d0 ]
004D6ED5    mov dword ptr ss:[ebp-0x04], 0x07
004D6EDC    cmp dword ptr ds:[0x00CF65BC], 0x00
004D6EE3    jz 0x004D6F1C                                   ; => [ Data: data_cf65bc ]
...
004D6EFA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D6F0D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D6F12    mov dword ptr ds:[esi+0x4258], 0x801800         ; => [ Data: data_801800 ]
004D6F1C    mov dword ptr ss:[ebp-0x04], 0x08
004D6F23    cmp dword ptr ds:[0x00CF65BC], 0x00
004D6F2A    jz 0x004D6F63                                   ; => [ Data: data_cf65bc ]
...
004D6F41    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D6F54    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D6F59    mov dword ptr ds:[esi+0x4254], 0x801800         ; => [ Data: data_801800 ]
004D6F63    mov dword ptr ss:[ebp-0x04], 0x09
004D6F6A    cmp dword ptr ds:[0x00CF65BC], 0x00
004D6F71    jz 0x004D6FAA                                   ; => [ Data: data_cf65bc ]
...
004D6F88    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D6F9B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D6FA0    mov dword ptr ds:[esi+0x4248], 0x801800         ; => [ Data: data_801800 ]
004D6FAA    mov dword ptr ss:[ebp-0x04], 0x0A
004D6FB1    cmp dword ptr ds:[0x00CF65BC], 0x00
004D6FB8    jz 0x004D6FF1                                   ; => [ Data: data_cf65bc ]
...
004D6FCF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D6FE2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D6FE7    mov dword ptr ds:[esi+0x4244], 0x801800         ; => [ Data: data_801800 ]
...
004D7007    push eax
004D7008    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
004D700D    mov dword ptr ss:[ebp-0x04], 0x0B
004D7014    cmp dword ptr ds:[0x00CF65BC], 0x00
004D701B    jz 0x004D7054                                   ; => [ Data: data_cf65bc ]
...
004D7032    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D7045    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D704A    mov dword ptr ds:[esi+0x350C], 0x801800         ; => [ Data: data_801800 ]
...
004D706A    push eax
004D706B    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4ab080 ]
004D7070    mov dword ptr ss:[ebp-0x04], 0x0C
004D7077    cmp dword ptr ds:[0x00CF65BC], 0x00
004D707E    jz 0x004D70AE                                   ; => [ Data: data_cf65bc ]
...
004D708F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D70A2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D70A7    mov dword ptr ds:[esi+0x04], 0x801800           ; => [ Data: data_801800 ]
004D70AE    mov dword ptr ss:[ebp-0x04], 0x0D
004D70B5    cmp dword ptr ds:[0x00CF65BC], 0x00
004D70BC    jz 0x004D70E9                                   ; => [ Data: data_cf65bc ]
...
004D70CB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D70DE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D70E3    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
004D70E9    mov ecx, dword ptr ss:[ebp-0x0C]
004D70EC    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D70F3    pop ecx
004D70F4    pop edi
004D70F5    pop esi
