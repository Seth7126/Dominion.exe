...
0061E6E8    push 0x76B41B                                   ; => [ Call: sub_76b41b | Type: EHRegistrationNode ]
0061E6ED    mov eax, dword ptr fs:[0x00000000]
0061E6F3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0061E6F4    push ebx
0061E6F5    mov eax, 0x13F8
0061E6FA    call 0x00761E50                                 ; => [ Call: __chkstk ]
0061E6FF    mov eax, dword ptr ds:[0x008C4040]
0061E704    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0061E706    mov dword ptr ss:[ebp-0x14], eax
0061E709    push esi
0061E70A    push edi
0061E70B    push eax
0061E70C    lea eax, ss:[ebp-0x0C]
0061E70F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0061E715    call 0x004B9370                                 ; => [ Call: sub_4b9370 ]
0061E71A    test al, al
0061E71C    jnz 0x0061EB10
0061E722    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
0061E727    test eax, eax
0061E729    jz 0x0061EB5B
0061E72F    cmp dword ptr ds:[eax+0x5044], 0x00
0061E736    jnz 0x0061EB10
0061E73C    call 0x0061DAD0                                 ; => [ Call: sub_61dad0 ]
0061E741    mov edi, eax
0061E743    lea edx, ss:[ebp-0x11D0]
0061E749    mov ecx, edi
0061E74B    call 0x0061DBA0                                 ; => [ Call: sub_61dba0 ]
0061E750    mov ecx, dword ptr ds:[0x0171EFC8]              ; => [ Data: data_171efc8 ]
0061E756    test al, al
...
0061E7C1    push eax
0061E7C2    movq qword ptr ss:[ebp-0x11C0], xmm0            ; => [ Call: __builtin_memset ]
0061E7CA    movups xmmword ptr ss:[ebp-0x11B8], xmm0
0061E7D1    mov dword ptr ss:[ebp-0x1190], 0x801800         ; => [ Data: data_801800 ]
0061E7DB    movups xmmword ptr ss:[ebp-0x11A8], xmm0
0061E7E2    mov dword ptr ss:[ebp-0x118C], 0x801800         ; => [ Data: data_801800 ]
0061E7EC    movq qword ptr ss:[ebp-0x1198], xmm0
0061E7F4    mov dword ptr ss:[ebp-0x1188], 0x801800         ; => [ Data: data_801800 ]
0061E7FE    mov dword ptr ss:[ebp-0x1184], 0x00
0061E808    call 0x00761FC4                                 ; => [ Call: memset ]
...
0061E846    mov dword ptr ss:[ebp-0x1168], eax              ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
0061E860    mov dword ptr ss:[ebp-0x1170], eax              ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
0061E866    mov ecx, dword ptr ds:[ecx+0x1E1A4]
0061E86C    call 0x004D8F30
0061E871    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0061E876    push 0x10
0061E878    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
...
0061E892    mov ecx, dword ptr ds:[0x0171EFC8]              ; => [ Data: data_171efc8 ]
...
0061E95C    call 0x0063D850                                 ; => [ Call: sub_61d910 | Call: sub_63d850 ]
0061E961    mov byte ptr ss:[ebp-0x04], 0x02
0061E965    cmp dword ptr ds:[0x00CF65BC], 0x00
0061E96C    jz 0x0061E9A5                                   ; => [ Data: data_cf65bc ]
...
0061E983    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0061E996    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061E99B    mov dword ptr ss:[ebp-0x11C4], 0x801800         ; => [ Data: data_801800 ]
...
0061EA1B    push eax
0061EA1C    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0061EA21    lea eax, ss:[ebp-0x118C]
0061EA27    push eax
0061EA28    lea ecx, ds:[esi+0x3C]
0061EA2B    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0061EA30    lea eax, ss:[ebp-0x1188]
0061EA36    push eax
0061EA37    lea ecx, ds:[esi+0x40]
0061EA3A    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0061EA61    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0061EA97    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0061EAD1    call 0x004B3C70                                 ; => [ Call: sub_4b3c70 ]
0061EAD6    lea ecx, ss:[ebp-0x11B8]
0061EADC    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0061EAE3    call 0x004AB0E0                                 ; => [ Call: Concurrency::details::_Micro_queue::_Pop_finalizer::~_Pop_finalizer ]
0061EAE8    mov eax, dword ptr ss:[ebp-0x11D4]
0061EAEE    mov ecx, eax
0061EAF0    call 0x004B0E60                                 ; => [ Call: sub_4b0e60 ]
0061EAF5    jmp 0x0061EB10
0061EAF7    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
0061EB13    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0061EB1A    pop ecx
0061EB1B    pop edi
0061EB1C    pop esi
0061EB1D    mov ecx, dword ptr ss:[ebp-0x14]
0061EB20    xor ecx, ebp
0061EB22    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0061EB44    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
0061EB49    add esp, 0x0C
0061EB4C    call 0x0063BC30
0061EB51    test al, al
0061EB53    jz 0x0061EB56                                   ; => [ Call: sub_63bc30 ]
0061EB55    int3
0061EB56    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0061EB5B    push 0x77EB90
0061EB60    push 0x7B
0061EB62    push 0x77EB50
0061EB67    mov edx, 0x801800
0061EB6C    mov ecx, 0x77EB9C
0061EB71    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
0061EB76    add esp, 0x0C
0061EB79    call 0x0063BC30
0061EB7E    test al, al
0061EB80    jz 0x0061EB83                                   ; => [ Call: sub_63bc30 ]
0061EB82    int3
0061EB83    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
