...
0071939C    call 0x00714A40                                 ; => [ Call: sub_714a40 ]
...
007193B8    xorps xmm1, xmm1                                ; => [ String: 0 | String: zx ]
...
007193FD    xorps xmm4, xmm4                                ; => [ String: 0 | String: zx ]
...
007194C4    movaps xmm3, xmm1                               ; => [ String: 0 | String: zx ]
