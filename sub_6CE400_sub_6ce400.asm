...
006CE405    push 0x770B8D                                   ; => [ Call: sub_770b8d | Type: EHRegistrationNode ]
006CE40A    mov eax, dword ptr fs:[0x00000000]
006CE410    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006CE421    push esi
006CE422    push edi
006CE423    push eax                                        ; => [ Data: __security_cookie ]
006CE424    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006CE427    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006CE440    push 0x8811E4                                   ; => [ String: StructureGetDef ]
006CE445    push 0x559
006CE44A    push 0x880FE4                                   ; => [ String: C:\x\ax2017\Engine\Structure.cpp ]
006CE44F    mov ecx, 0x87A4FC                               ; => [ String: assetPtr->assetType == ASSET_TYPE_STRUCTURE ]
006CE454    jmp 0x006CE97F
006CE459    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006CE4D4    push eax
006CE4D5    movups xmmword ptr ss:[ebp-0xA8], xmm0          ; => [ Call: sub_4eb2f0 ]
...
006CE50E    call 0x004EB600                                 ; => [ Call: sub_4eb600 ]
...
006CE52F    call 0x0064B0D0                                 ; => [ Call: sub_64b0d0 ]
006CE534    test al, al
006CE536    jnz 0x006CE551
006CE538    push 0x87EE3C                                   ; => [ String: FabModelDraw ]
006CE53D    push 0x280
006CE542    push 0x87ED1C                                   ; => [ String: C:\x\ax2017\Engine\FabDef.cpp ]
006CE547    mov ecx, 0x87EE18                               ; => [ String: QuatIsValid(state.transform.t.r) ]
006CE54C    jmp 0x006CE97F
006CE551    lea ecx, ss:[ebp-0x2C]
006CE554    call 0x0064B0D0                                 ; => [ Call: sub_64b0d0 ]
006CE559    test al, al
006CE55B    jnz 0x006CE576
006CE55D    push 0x87EE3C                                   ; => [ String: FabModelDraw ]
006CE562    push 0x281
006CE567    push 0x87ED1C                                   ; => [ String: C:\x\ax2017\Engine\FabDef.cpp ]
006CE56C    mov ecx, 0x87EE4C                               ; => [ String: QuatIsValid(transform.r) ]
...
006CE5D3    jz 0x006CE96B                                   ; => [ Data: data_147aba1 ]
006CE5D9    movups xmmword ptr ds:[0x00CF6A70], xmm1        ; => [ Data: data_cf6a70 ]
...
006CE608    push 0x87EE3C                                   ; => [ String: FabModelDraw ]
006CE60D    push 0x28E
006CE612    push 0x87ED1C                                   ; => [ String: C:\x\ax2017\Engine\FabDef.cpp ]
006CE617    mov ecx, 0x87EE68                               ; => [ String: el.model != NULL ]
006CE61C    jmp 0x006CE97F
006CE621    call 0x006DA310                                 ; => [ Call: sub_6da310 ]
...
006CE63E    push 0x8811E4                                   ; => [ String: StructureGetDef ]
006CE643    push 0x559
006CE648    push 0x880FE4                                   ; => [ String: C:\x\ax2017\Engine\Structure.cpp ]
006CE64D    mov ecx, 0x87A4FC                               ; => [ String: assetPtr->assetType == ASSET_TYPE_STRUCTURE ]
006CE652    jmp 0x006CE97F
006CE657    call 0x005AF880
006CE65C    xor esi, esi
006CE65E    mov edi, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
006CE673    mov ecx, dword ptr ss:[ebp-0x74]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006CE6B1    push dword ptr ss:[ebp-0x74]                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006CE6B4    push 0x88195C
006CE6B9    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: can't find anim clip: %s ]
...
006CE6D0    call 0x006DB490                                 ; => [ Call: sub_6db490 ]
006CE6D5    mov edi, eax                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006CE6D7    mov dword ptr ss:[ebp-0x74], edi
006CE6DA    mov ecx, dword ptr ds:[edi+0x2C]
006CE6DD    test ecx, ecx
006CE6DF    jz 0x006CE6E6
006CE6E1    call 0x006DEE00                                 ; => [ Call: sub_6dee00 ]
...
006CE6F7    call 0x006DA1F0                                 ; => [ Call: sub_6da1f0 ]
...
006CE70C    push 0x8811E4                                   ; => [ String: StructureGetDef ]
006CE711    push 0x559
006CE716    push 0x880FE4                                   ; => [ String: C:\x\ax2017\Engine\Structure.cpp ]
006CE71B    mov ecx, 0x87A4FC                               ; => [ String: assetPtr->assetType == ASSET_TYPE_STRUCTURE ]
...
006CE739    call 0x006DEF90                                 ; => [ Call: sub_6def90 ]
006CE73E    add esp, 0x14
006CE741    jmp 0x006CE6C4
006CE746    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006CE7AA    jnz 0x006CE811                                  ; => [ Data: data_cafe88 ]
006CE7AC    lea eax, ss:[ebp-0x10C]
006CE7B2    push eax
006CE7B3    lea ecx, ss:[ebp-0x30]
006CE7B6    call 0x0064B1B0                                 ; => [ Call: sub_64b1b0 ]
006CE7BB    push ecx
...
006CE7E8    call 0x00648580                                 ; => [ Call: sub_648580 ]
...
006CE824    jle 0x006CE86B                                  ; => [ Data: data_1a9a2f0 | Field: ThreadLocalStoragePointer ]
006CE826    push 0x1A9A2F0
006CE82B    call 0x0075970E                                 ; => [ Data: data_1a9a2f0 | Call: sub_75970e ]
006CE830    add esp, 0x04
006CE833    cmp dword ptr ds:[0x01A9A2F0], 0xFFFFFFFF
006CE83A    jnz 0x006CE86B                                  ; => [ Data: data_1a9a2f0 ]
...
006CE857    mov dword ptr ds:[0x01A9A2F4], eax              ; => [ Data: data_1a9a2f4 | String: sys/draw3d.material | Call: sub_69f030 ]
006CE85C    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006CE863    call 0x007596BD                                 ; => [ Data: data_1a9a2f0 | Call: __Init_thread_footer ]
...
006CE88B    jle 0x006CE8D2                                  ; => [ Field: ThreadLocalStoragePointer | Data: data_1a9a2f8 ]
006CE88D    push 0x1A9A2F8
006CE892    call 0x0075970E                                 ; => [ Call: sub_75970e | Data: data_1a9a2f8 ]
006CE897    add esp, 0x04
006CE89A    cmp dword ptr ds:[0x01A9A2F8], 0xFFFFFFFF
006CE8A1    jnz 0x006CE8D2                                  ; => [ Data: data_1a9a2f8 ]
...
006CE8BE    mov dword ptr ds:[0x01A9A2FC], eax              ; => [ String: sys/draw3d.material | Data: data_1a9a2fc | Call: sub_69f030 ]
006CE8C3    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006CE8CA    call 0x007596BD                                 ; => [ Call: __Init_thread_footer | Data: data_1a9a2f8 ]
...
006CE8E6    call 0x00648920                                 ; => [ Data: data_1a9a2fc | Call: sub_648920 | Data: data_1a9a2f4 | Call: sub_648920 ]
...
006CE940    jz 0x006CE96B                                   ; => [ Data: data_147aba1 ]
006CE942    movaps xmm0, xmmword ptr ds:[0x008935B0]
006CE949    movups xmmword ptr ds:[0x00CF6A70], xmm0        ; => [ Data: data_cf6a70 | Data: data_8935b0 ]
006CE950    mov ecx, dword ptr ss:[ebp-0x0C]
006CE953    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006CE95A    pop ecx
006CE95B    pop edi
006CE95C    pop esi
006CE95D    mov ecx, dword ptr ss:[ebp-0x10]
006CE960    xor ecx, ebp
006CE962    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006CE967    mov esp, ebp
006CE969    pop ebp
006CE96A    ret
006CE96B    push 0x8728B4                                   ; => [ String: Draw3DSetMaterialColor ]
006CE970    push 0x304
006CE975    mov ecx, 0x8727F0                               ; => [ String: gDraw3DData.submittingRenderItems ]
006CE97A    push 0x872630                                   ; => [ String: C:\x\ax2017\Engine\Draw3d.cpp ]
006CE97F    mov edx, 0x801800
006CE984    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006CE989    add esp, 0x0C
006CE98C    call 0x0063BC30
006CE991    test al, al
006CE993    jz 0x006CE996                                   ; => [ Call: sub_63bc30 ]
006CE995    int3
006CE996    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
