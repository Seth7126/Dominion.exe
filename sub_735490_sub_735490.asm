...
00735495    push 0x772C5D                                   ; => [ Call: sub_772c5d | Type: EHRegistrationNode ]
0073549A    mov eax, dword ptr fs:[0x00000000]
007354A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
007354AE    push eax                                        ; => [ Data: __security_cookie ]
007354AF    lea eax, ss:[ebp-0x0C]
007354B2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
007354B8    mov dword ptr ss:[ebp-0x14], edx
007354BB    mov edi, ecx
007354BD    mov esi, 0x801800                               ; => [ Data: data_801800 ]
007354C2    mov dword ptr ss:[ebp-0x10], esi                ; => [ Data: data_801800 ]
007354C5    push 0x2A
007354C7    push edi
...
007354DA    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
00735518    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0073552A    sub ecx, dword ptr ss:[ebp-0x18]                ; => [ Data: data_801801 ]
0073552D    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
0073556B    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
00735570    mov esi, dword ptr ss:[ebp-0x10]
00735573    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00735578    test esi, esi
0073557A    mov edi, ecx                                    ; => [ Data: data_801800 ]
...
00735593    mov bl, al                                      ; => [ Call: sub_7353d0 ]
...
007355AC    jz 0x007355C9                                   ; => [ Data: data_cf65bc ]
007355AE    lea ecx, ss:[ebp-0x10]
007355B1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
007355C4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
007355C9    mov al, bl
007355CB    mov ecx, dword ptr ss:[ebp-0x0C]
007355CE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
007355D5    pop ecx
007355D6    pop edi
007355D7    pop esi
007355D8    pop ebx
