...
00568965    push 0x767217                                   ; => [ Type: EHRegistrationNode | Call: sub_767217 ]
0056896A    mov eax, dword ptr fs:[0x00000000]
00568970    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00568982    push esi
00568983    push edi
00568984    push eax                                        ; => [ Data: __security_cookie ]
00568985    lea eax, ss:[ebp-0x0C]
00568988    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0056898E    mov dword ptr ss:[ebp-0xCA4], edx
00568994    mov esi, ecx
00568996    mov dword ptr ss:[ebp-0xCA8], 0xFFFFFFFF
005689A0    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005689B8    call 0x00590AD0                                 ; => [ Call: sub_590ad0 ]
...
005689D0    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
005689EC    mov dword ptr ss:[ebp-0xCFC], 0x81F0DC          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
005689F6    mov dword ptr ss:[ebp-0xCF8], eax
005689FC    lea eax, ss:[ebp-0xCFC]
00568A02    mov dword ptr ss:[ebp-0xCD8], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::VTable ]
...
00568A43    mov dword ptr ds:[ebx+0x24], eax                ; => [ Field: vFunc_0 ]
...
00568A69    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00568A7F    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5d5378003ea5811a434182a0e3a72bad>,bool,enum CardID>::VTable ]
00568A82    push eax
00568A83    call edx                                        ; => [ Field: vFunc_4 ]
00568A85    cmp dword ptr ss:[ebp-0xCA4], 0x00
00568A8C    jz 0x00568B31
00568A92    lea eax, ss:[ebp-0xCA4]
00568A98    mov dword ptr ss:[ebp-0xD24], 0x81F0C0          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::VTable ]
00568AA2    mov dword ptr ss:[ebp-0xD20], eax
00568AA8    lea eax, ss:[ebp-0xD24]
00568AAE    mov dword ptr ss:[ebp-0xD00], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::VTable ]
...
00568AEF    mov dword ptr ds:[ebx+0x24], eax                ; => [ Field: vFunc_0 ]
...
00568B15    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00568B2B    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_026e6266d12f1313706006cc45988d72>,bool,enum CardID>::VTable ]
00568B2E    push eax
00568B2F    call edx                                        ; => [ Field: vFunc_4 ]
00568B31    cmp dword ptr ss:[ebp-0xCA8], 0xFFFFFFFF
00568B38    jz 0x00568BD8
00568B3E    lea eax, ss:[ebp-0xCA8]
00568B44    mov dword ptr ss:[ebp-0xCD4], 0x81F0A4          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5f04a67bc0ce9eeb7ea37f393bba7b95>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_5f04a67bc0ce9eeb7ea37f393bba7b95>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00568B4E    mov dword ptr ss:[ebp-0xCCC], eax
00568B54    lea eax, ss:[ebp-0xCD4]
00568B5A    mov dword ptr ss:[ebp-0xCD0], edi
00568B60    mov dword ptr ss:[ebp-0xCB0], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5f04a67bc0ce9eeb7ea37f393bba7b95>,bool,enum CardID>::VTable ]
...
00568BD0    push edx
00568BD1    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
00568BD4    mov eax, edi
00568BD6    jmp 0x00568BDA
00568BD8    mov eax, esi
00568BDA    mov ecx, dword ptr ss:[ebp-0x0C]
00568BDD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00568BE4    pop ecx
00568BE5    pop edi
00568BE6    pop esi
00568BE7    pop ebx
...
00568BED    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
