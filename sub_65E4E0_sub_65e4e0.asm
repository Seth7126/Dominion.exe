...
0065E501    mov dword ptr fs:[0x00000000], eax
...
0065E534    mov dword ptr fs:[0x00000000], ecx
0065E53B    pop ecx
0065E53C    pop edi
0065E53D    pop esi
...
0065E5A9    call 0x0064C080
0065E5AE    mov dword ptr ss:[ebp-0x10], 0x801800
...
0065E603    mov dword ptr fs:[0x00000000], ecx
0065E60A    pop ecx
0065E60B    pop edi
0065E60C    pop esi
...
0065E627    call 0x0063B870
0065E62C    add esp, 0x0C
0065E62F    call 0x0063BC30
0065E634    test al, al
0065E636    jz 0x0065E639
0065E638    int3
0065E639    call 0x0063BB00
