...
006E9795    push 0x76314D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_comp_ellint_3@16 ]
006E979A    mov eax, dword ptr fs:[0x00000000]
006E97A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006E97A1    push ecx
006E97A2    push ebx
006E97A3    push esi
006E97A4    push edi
...
006E97AC    push eax                                        ; => [ Data: __security_cookie ]
006E97AD    lea eax, ss:[ebp-0x0C]
006E97B0    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006E97D1    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006E97D8    cmovnl edi, ecx
006E97DB    mov dword ptr ss:[ebp-0x04], 0x00
006E97E2    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
006E97F3    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
006E980A    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
006E980D    jmp 0x006E9811
006E980F    xor ecx, ecx
006E9811    mov eax, dword ptr ds:[esi]
006E9813    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
006E982A    push eax
006E982B    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
006E9830    lea eax, ss:[ebp-0x10]
006E9833    mov ecx, esi
006E9835    push eax
006E9836    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006E984F    jz 0x006E9878                                   ; => [ Data: data_cf65bc ]
...
006E9860    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006E9873    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006E9878    mov ecx, dword ptr ss:[ebp-0x0C]
006E987B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006E9882    pop ecx
006E9883    pop edi
006E9884    pop esi
006E9885    pop ebx
