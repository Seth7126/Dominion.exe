...
0063E635    push 0x76C526                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$copy_wide_to_narrow_find_data@U_wfinddata64_t@@U__finddata64_t@@@@YA_NABU_wfinddata64_t@@AAU__finddata64_t@@I@Z ]
0063E63A    mov eax, dword ptr fs:[0x00000000]
0063E640    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0063E64E    push eax                                        ; => [ Data: __security_cookie ]
0063E64F    lea eax, ss:[ebp-0x0C]
0063E652    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0063E6F6    call 0x005A0D00                                 ; => [ Call: sub_5a0d00 ]
...
0063E719    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0063E71E    mov ecx, eax                                    ; => [ Data: data_801800 ]
0063E720    jmp 0x0063E724
0063E722    mov ecx, eax
0063E724    sub edi, eax
0063E726    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0063E72D    push edi
0063E72E    push ecx
0063E72F    lea ecx, ss:[ebp-0x10]
0063E732    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
...
0063E74E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063E774    jz 0x0063E7BF                                   ; => [ Data: data_cf65bc ]
0063E776    lea ecx, ss:[ebp-0x10]
0063E779    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0063E78C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0063E791    mov eax, ebx
0063E793    mov ecx, dword ptr ss:[ebp-0x0C]
0063E796    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063E79D    pop ecx
0063E79E    pop edi
0063E79F    pop esi
0063E7A0    pop ebx
...
0063E7B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0063E7BC    inc dword ptr ds:[eax+0x04]
0063E7BF    mov eax, ebx
0063E7C1    mov ecx, dword ptr ss:[ebp-0x0C]
0063E7C4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0063E7CB    pop ecx
0063E7CC    pop edi
0063E7CD    pop esi
0063E7CE    pop ebx
...
0063E7D1    pop ebp
0063E7D2    ret
0063E7D3    push 0x825074                                   ; => [ String: Xutf8_peek_next ]
0063E7D8    push 0x21C
0063E7DD    jmp 0x0063E7E9
0063E7DF    push 0x825084                                   ; => [ String: Xutf8_next ]
0063E7E4    push 0x222
0063E7E9    push 0x825090
0063E7EE    mov edx, 0x801800
0063E7F3    mov ecx, 0x8250B0
0063E7F8    call 0x0063B870                                 ; => [ String: !Xutf8_is_invalid_lead_char(str) | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Xutf8.cpp ]
0063E7FD    add esp, 0x0C
0063E800    call 0x0063BC30
0063E805    test al, al
0063E807    jz 0x0063E80A                                   ; => [ Call: sub_63bc30 ]
0063E809    int3
0063E80A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
