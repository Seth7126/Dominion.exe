...
0059F9B9    mov eax, dword ptr ds:[0x01597E68]
0059F9BE    push ebx
0059F9BF    push esi
...
0059F9D2    mov dword ptr ds:[0x01597E28], eax
...
0059F9EF    push 0x824EF0
0059F9F4    push 0x1183
0059F9F9    mov ecx, 0x824F00
...
0059FA21    mov esi, dword ptr ds:[0x01597E3C]
0059FA27    mov eax, dword ptr ds:[0x01597E40]
...
0059FA4F    mov ebx, eax
0059FA51    mov eax, dword ptr ds:[0x01597E38]
0059FA56    test eax, eax
0059FA58    jz 0x0059FA79
0059FA5A    push esi
0059FA5B    push eax
0059FA5C    push ebx
0059FA5D    call 0x00761FBE
...
0059FA74    call 0x0064C080
0059FA79    mov eax, dword ptr ss:[esp+0x1C]
0059FA7D    mov esi, dword ptr ds:[0x01597E3C]
0059FA83    mov dword ptr ds:[0x01597E38], ebx
0059FA89    mov dword ptr ds:[0x01597E40], eax
0059FA8E    jmp 0x0059FA96
0059FA90    mov ebx, dword ptr ds:[0x01597E38]
0059FA96    mov eax, dword ptr ss:[ebp+0x1C]
0059FA99    inc esi
0059FA9A    mov edx, dword ptr ss:[ebp+0x08]
0059FA9D    mov dword ptr ds:[0x01597E3C], esi
...
0059FAB2    mov dword ptr ds:[ebx+esi*8-0x04], eax
0059FAB6    mov eax, dword ptr ds:[0x01597E30]
0059FABB    mov dword ptr ds:[ebx+esi*8-0x08], eax
0059FABF    mov eax, dword ptr ds:[0x01597E28]
...
0059FADC    mov dword ptr ds:[ecx*4+0x1597E50], eax
0059FAE3    mov eax, dword ptr ds:[0x01597E28]
0059FAE8    inc ecx
...
0059FAF6    pop ebp
0059FAF7    ret
0059FAF8    push 0x824EF0
0059FAFD    push 0x11A0
0059FB02    mov ecx, 0x824F20
...
0059FB1B    push 0x824EF0
0059FB20    push 0x11AB
0059FB25    mov ecx, 0x824F00
0059FB2A    jmp 0x005A04A3
0059FB2F    mov dword ptr ds:[edx*4+0x1597E50], eax
0059FB36    mov eax, dword ptr ds:[0x01597E28]
0059FB3B    mov dword ptr ds:[ebx*4+0x1597E50], eax
0059FB42    pop edi
0059FB43    pop esi
0059FB44    pop ebx
...
0059FBDE    mov dword ptr ds:[edx*4+0x1597E50], eax
0059FBE5    mov eax, dword ptr ds:[0x01597E28]
0059FBEA    inc edx
...
0059FC00    push 0x824EF0
0059FC05    push 0x11D2
0059FC0A    mov ecx, 0x801AA4
...
0059FC48    mov dword ptr ds:[edx*4+0x1597E50], eax
0059FC4F    mov eax, dword ptr ds:[0x01597E28]
0059FC54    inc edx
...
0059FC8D    mov dword ptr ds:[edx*4+0x1597E50], eax
0059FC94    mov eax, dword ptr ds:[0x01597E28]
0059FC99    inc edx
...
0059FD54    mov dword ptr ds:[ecx*4+0x1597E50], eax
0059FD5B    mov eax, dword ptr ds:[0x01597E28]
0059FD60    inc ecx
...
0059FD7C    mov dword ptr ds:[ebx*4+0x1597E50], eax
0059FD83    mov eax, dword ptr ds:[0x01597E28]
0059FD88    mov dword ptr ds:[ecx*4+0x1597E50], eax
...
0059FDA6    inc dword ptr ds:[0x01597E68]
0059FDAC    pop edi
0059FDAD    pop esi
0059FDAE    pop ebx
...
0059FDC6    inc dword ptr ds:[0x01597E68]
...
0059FDDC    push 0x824EF0
0059FDE1    push 0x124A
0059FDE6    mov ecx, 0x80AE74
...
0059FE54    mov ebx, dword ptr ds:[0x01597E30]
0059FE5A    mov edx, dword ptr ds:[0x01597E2C]
...
0059FEC4    push 0x824F84
0059FEC9    push 0xD4
0059FECE    push 0x824FB0
0059FED3    mov ecx, 0x824FD0
...
0059FF43    mov eax, dword ptr ds:[0x01597E30]
...
0059FFA2    add ecx, dword ptr ds:[0x01597E2C]
0059FFA8    shl edx, 0x06
0059FFAB    push edx
0059FFAC    lea eax, ds:[ecx+0x40]
0059FFAF    push eax
0059FFB0    push ecx
0059FFB1    call 0x00762362
0059FFB6    mov eax, dword ptr ds:[0x01597E30]
0059FFBB    add esp, 0x0C
0059FFBE    dec eax
0059FFBF    mov dword ptr ds:[0x01597E30], eax
0059FFC4    pop edi
0059FFC5    pop esi
0059FFC6    pop ebx
...
0059FFC9    pop ebp
0059FFCA    ret
0059FFCB    push 0x824FEC
0059FFD0    push 0xFE
0059FFD5    push 0x824FB0
0059FFDA    mov ecx, 0x824FD0
...
005A000E    mov eax, dword ptr ds:[0x01597E34]
...
005A0031    call 0x0064C020
005A0036    mov ecx, dword ptr ds:[0x01597E2C]
...
005A005E    call 0x0064C080
005A0063    mov eax, dword ptr ss:[esp+0x18]
005A0067    mov ebx, dword ptr ds:[0x01597E30]
005A006D    mov dword ptr ds:[0x01597E2C], eax
005A0072    mov eax, dword ptr ss:[esp+0x20]
005A0076    mov dword ptr ds:[0x01597E34], eax
005A007B    mov eax, dword ptr ss:[esp+0x1C]
005A007F    inc ebx
005A0080    mov edx, dword ptr ss:[ebp+0x08]
005A0083    mov dword ptr ds:[0x01597E30], ebx
...
005A00C4    mov dword ptr ds:[ebx-0x04], eax
005A00C7    mov eax, dword ptr ds:[0x01597E3C]
005A00CC    dec eax
005A00CD    mov dword ptr ds:[ebx-0x10], eax
005A00D0    mov ecx, dword ptr ds:[0x01597E3C]
...
005A00FC    mov eax, dword ptr ds:[0x01597E38]
...
005A01BA    mov eax, dword ptr ds:[0x01597E30]
...
005A01DE    add edx, dword ptr ds:[0x01597E2C]
...
005A020D    call 0x0059D570
005A0212    add esp, 0x08
005A0215    dec dword ptr ds:[0x01597E30]
005A021B    pop edi
005A021C    pop esi
005A021D    pop ebx
...
005A0368    pop ebp
005A0369    ret
005A036A    push 0x825014
005A036F    push 0xD4
005A0374    push 0x824FB0
005A0379    mov ecx, 0x824FD0
...
005A03AB    pop ebp
005A03AC    ret
005A03AD    mov eax, dword ptr ds:[0x01597E48]
...
005A03D0    mov ecx, dword ptr ds:[0x01597E48]
005A03D6    mov eax, dword ptr ds:[0x01597E4C]
...
005A0402    mov esi, eax
005A0404    mov eax, dword ptr ds:[0x01597E44]
005A0409    test eax, eax
005A040B    jz 0x005A0432
005A040D    push dword ptr ss:[esp+0x20]
005A0411    push eax
005A0412    push esi
005A0413    call 0x00761FBE
...
005A042D    call 0x0064C080
005A0432    mov ecx, dword ptr ds:[0x01597E48]
005A0438    mov edx, dword ptr ss:[esp+0x24]
005A043C    mov dword ptr ds:[0x01597E44], esi
005A0442    mov dword ptr ds:[0x01597E4C], edi
005A0448    jmp 0x005A0450
005A044A    mov esi, dword ptr ds:[0x01597E44]
005A0450    mov eax, dword ptr ss:[ebp+0x14]
005A0453    inc ecx
005A0454    mov dword ptr ds:[0x01597E48], ecx
...
005A047F    pop ebp
005A0480    ret
005A0481    mov eax, dword ptr ds:[0x01597E68]
005A0486    sub eax, 0x01
005A0489    mov dword ptr ds:[0x01597E68], eax
005A048E    jns 0x0059FAF1
005A0494    push 0x824EF0
005A0499    push 0x1236
005A049E    mov ecx, 0x824F34
005A04A3    push 0x82487C
005A04A8    mov edx, 0x801800
005A04AD    call 0x0063B870
005A04B2    add esp, 0x0C
005A04B5    call 0x0063BC30
005A04BA    test al, al
005A04BC    jz 0x005A04BF
005A04BE    int3
005A04BF    call 0x0063BB00
