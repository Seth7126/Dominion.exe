...
0053A9BC    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053A9C1    push 0x00
0053A9C3    mov edx, dword ptr ds:[eax+0x0C]
0053A9C6    mov ecx, dword ptr ds:[eax+0x04]
0053A9C9    call 0x005887C0                                 ; => [ Call: sub_5887c0 ]
...
0053A9E2    call 0x00562400                                 ; => [ Call: sub_562400 ]
0053A9E7    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053AA03    mov dword ptr ds:[eax], 0x81A3D0                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_437465a1ebcd8474b2cc2f384abb2b4d>, void>::`vftable'{for `std::_Func_base<void>'} ]
0053AA09    mov dword ptr ds:[eax+0x04], edx
0053AA0C    mov dword ptr ds:[eax+0x08], esi
0053AA0F    mov dword ptr ds:[eax+0x24], eax
0053AA12    call 0x005698B0                                 ; => [ Call: sub_5698b0 ]
