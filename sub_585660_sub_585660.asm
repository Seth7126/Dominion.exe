...
00585666    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
00585678    mov ebx, 0x820EC0                               ; => [ Data: data_820ec0 ]
...
00585693    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
0058574B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0058579C    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
...
005857F1    call 0x0059F9B0                                 ; => [ Call: sub_59f9b0 ]
...
00585860    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00585874    call 0x005853C0                                 ; => [ Call: sub_5853c0 ]
...
00585882    pop esi
00585883    pop ebx
00585884    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
005858A6    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: Halt | String: GetReplacementTestFn ]
005858AB    add esp, 0x0C
005858AE    call 0x0063BC30
005858B3    test al, al
005858B5    jz 0x005858B8                                   ; => [ Call: sub_63bc30 ]
005858B7    int3
005858B8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
