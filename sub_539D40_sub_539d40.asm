...
00539D44    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00539DFA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DomAchievementDataGet | Data: data_801800 | String: c.contextType == CONTEXT_ACHIEVEMENT | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00539DFF    add esp, 0x0C
00539E02    call 0x0063BC30
00539E07    test al, al
00539E09    jz 0x00539E0C                                   ; => [ Call: sub_63bc30 ]
00539E0B    int3
00539E0C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
