...
0054C6B8    call 0x00761E50
0054C6BD    mov eax, dword ptr ds:[0x008C4040]
0054C6C2    xor eax, ebp
0054C6C4    mov dword ptr ss:[ebp-0x04], eax
0054C6C7    push esi
0054C6C8    push edi
0054C6C9    push 0x05
