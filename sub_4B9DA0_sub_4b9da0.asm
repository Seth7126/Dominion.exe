...
004B9DAC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004B9DCE    mov ebx, eax                                    ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004B9DD0    lea ecx, ss:[esp+0x2E0]
004B9DD7    mov dword ptr ss:[esp+0x1C], ebx
004B9DDB    call 0x004B9B40                                 ; => [ Call: sub_4b9b40 ]
...
004B9DFC    call 0x004E4260                                 ; => [ Call: sub_4e4260 ]
...
004B9E22    push 0x00
004B9E24    push eax
004B9E25    call 0x00761FC4                                 ; => [ Call: memset ]
...
004B9E46    push 0x8024E0                                   ; => [ String: ClientMatchmakingQueue ]
004B9E4B    push 0x1579
004B9E50    push 0x801AF8                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
004B9E55    mov ecx, 0x801AA4                               ; => [ String: Halt ]
004B9E5A    jmp 0x004BA114
004B9E5F    push 0x280
004B9E64    lea eax, ss:[esp+0x564]
004B9E6B    push 0x00
004B9E6D    push eax
004B9E6E    call 0x00761FC4                                 ; => [ Call: memset ]
004B9E73    add esp, 0x0C
004B9E76    lea ecx, ss:[esp+0x560]
004B9E7D    call 0x004B9B40
004B9E82    mov dword ptr ss:[esp+0x38], eax                ; => [ Call: sub_4b9b40 ]
...
004B9E9E    push 0x00
004B9EA0    push eax
004B9EA1    call 0x00761FC4                                 ; => [ Call: memset ]
004B9EA6    add esp, 0x0C
004B9EA9    lea ecx, ss:[esp+0x7E0]
004B9EB0    call 0x004B9B40                                 ; => [ Call: sub_4b9b40 ]
...
004B9EFC    push 0x00
004B9EFE    push eax
004B9EFF    call 0x00761FC4                                 ; => [ Call: memset ]
...
004B9F21    mov ecx, 0x77FEA0                               ; => [ Data: data_77fea0 ]
...
004B9F67    jnz 0x004B9F26                                  ; => [ Data: data_77fee8 ]
...
004B9FDE    xor ecx, dword ptr ds:[eax*4+0x7FFD70]          ; => [ Data: data_7ffd70 ]
...
004BA01E    xor ecx, dword ptr ds:[eax*4+0x7FFD70]          ; => [ Data: data_7ffd70 ]
...
004BA043    push 0x8024C4                                   ; => [ String: CalcMatchmakingPoolFlags ]
004BA048    push 0x151E
004BA04D    push 0x801AF8                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
004BA052    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
004BA06F    call 0x004B9D20                                 ; => [ Call: sub_4b9d20 ]
004BA074    test al, al
...
004BA08C    push 0x8024E0                                   ; => [ String: ClientMatchmakingQueue ]
004BA091    push 0x1583
004BA096    push 0x801AF8                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameClient.cpp ]
004BA09B    mov ecx, 0x8024F8                               ; => [ String: msg.numSmartplays >= 0 ]
004BA0A0    jmp 0x004BA114
004BA0A2    mov ecx, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004BA0BF    call 0x0068B720                                 ; => [ Call: sub_68b720 | Data: data_1597d40 ]
004BA0C4    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004BA0F0    mov dword ptr ds:[0x008DB700], 0x26             ; => [ Data: data_8db700 ]
004BA0FA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
004BA0FF    mov esp, ebp
004BA101    pop ebp
004BA102    ret
004BA103    push 0x77EB90                                   ; => [ String: GetClient ]
004BA108    push 0x7B
004BA10A    mov ecx, 0x77EB9C                               ; => [ String: gClient ]
004BA10F    push 0x77EB50                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp ]
004BA114    mov edx, 0x801800
004BA119    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
004BA11E    add esp, 0x0C
004BA121    call 0x0063BC30
004BA126    test al, al
004BA128    jz 0x004BA12B                                   ; => [ Call: sub_63bc30 ]
004BA12A    int3
004BA12B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
