...
0055C3EC    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0055C3EF    mov dword ptr ss:[esp+0x0C], eax
0055C3F3    cmp esi, 0x320
0055C3F9    jb 0x0055C404
0055C3FB    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0055C458    mov esi, eax                                    ; => [ Call: sub_573400 ]
0055C45A    mov eax, dword ptr ds:[esi+0x04]
0055C45D    mov dword ptr ss:[esp+0x10], eax
0055C461    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0055C47B    mov esi, eax                                    ; => [ Call: sub_573400 ]
...
0055C4B4    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
