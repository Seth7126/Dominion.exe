...
00731AB5    push 0x77298D                                   ; => [ Call: sub_77298d | Type: EHRegistrationNode ]
00731ABA    mov eax, dword ptr fs:[0x00000000]
00731AC0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00731AC1    sub esp, 0x1C
00731AC4    push esi
00731AC5    push edi
00731AC6    mov eax, dword ptr ds:[0x008C4040]
00731ACB    xor eax, ebp
00731ACD    push eax                                        ; => [ Data: __security_cookie ]
00731ACE    lea eax, ss:[ebp-0x0C]
00731AD1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00731AD7    push 0x10
00731AD9    push 0x40
...
00731AFB    mov edx, dword ptr ds:[0x01777520]              ; => [ Data: data_1777520 ]
00731B01    mov dword ptr ds:[eax], ecx
00731B03    call 0x0069CA80                                 ; => [ Call: sub_69ca80 ]
...
00731B24    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
00731B2B    push eax
00731B2C    push edx
00731B2D    lea ecx, ss:[ebp-0x24]
00731B30    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
00731B35    mov edx, 0x87A2D4
00731B3A    mov byte ptr ss:[ebp-0x04], 0x01
00731B3E    lea ecx, ss:[ebp-0x14]
00731B41    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: .texture ]
...
00731B55    call 0x0063DDE0                                 ; => [ Call: sub_63dde0 ]
00731B5A    mov byte ptr ss:[ebp-0x04], 0x05
00731B5E    cmp dword ptr ds:[0x00CF65BC], 0x00
00731B65    jz 0x00731B95                                   ; => [ Data: data_cf65bc ]
...
00731B76    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00731BEE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00731C03    mov eax, edi                                    ; => [ Data: data_801800 ]
00731C05    push ecx
00731C06    cmovnz eax, esi
00731C09    push eax
00731C0A    call 0x006AC740                                 ; => [ Call: sub_6ac740 ]
...
00731C30    call 0x0069F810                                 ; => [ Call: sub_69f810 ]
...
00731C87    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00731C9A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00731C9F    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
00731CC3    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
...
00731CE0    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
00731CF7    mov edx, edi                                    ; => [ Data: data_801800 ]
00731CF9    cmovnz edx, esi
00731CFC    call 0x00730240                                 ; => [ Call: sub_730240 ]
00731D01    add esp, 0x04
00731D04    mov dword ptr ss:[ebp-0x14], eax
00731D07    mov ecx, eax
00731D09    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 | Type: _EXCEPTION_REGISTRATION_RECORD ]
00731D0E    mov ecx, dword ptr ds:[0x0147B070]              ; => [ Data: data_147b070 ]
00731D14    push eax
...
00731D54    mov dword ptr ds:[ecx+0x38], eax                ; => [ Call: sub_7311b0 ]
00731D57    mov byte ptr ss:[ebp-0x04], 0x08
00731D5B    cmp dword ptr ds:[0x00CF65BC], 0x00
00731D62    jz 0x00731D92                                   ; => [ Data: data_cf65bc ]
...
00731D73    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00731D86    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00731D8B    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
...
00731DA6    jz 0x00731DC3                                   ; => [ Data: data_cf65bc ]
00731DA8    lea ecx, ss:[ebp-0x24]
00731DAB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00731DE2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00731DF5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00731DFA    mov al, byte ptr ss:[ebp-0x0D]
00731DFD    mov ecx, dword ptr ss:[ebp-0x0C]
00731E00    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00731E07    pop ecx
00731E08    pop edi
00731E09    pop esi
...
00731E0C    pop ebp
00731E0D    ret
00731E0E    push 0x828280                                   ; => [ String: DefAutoLock::DefAutoLock ]
00731E13    push 0x19
00731E15    push 0x82829C
00731E1A    mov edx, edi
00731E1C    mov ecx, 0x8282BC
00731E21    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Engine\DefLoad.h | Call: sub_63b870 | Data: data_801800 | String: assetPtr && assetPtr->assetType == assetType ]
00731E26    add esp, 0x0C
00731E29    call 0x0063BC30
00731E2E    test al, al
00731E30    jz 0x00731E33                                   ; => [ Call: sub_63bc30 ]
00731E32    int3
00731E33    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00731E38    push 0x8770A0                                   ; => [ String: XMalloc ]
00731E3D    push 0x57
00731E3F    push 0x877080
00731E44    mov edx, 0x801800
00731E49    mov ecx, 0x8770C8
00731E4E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xMemory.cpp | String: pBuffer ]
00731E53    add esp, 0x0C
00731E56    call 0x0063BC30
00731E5B    test al, al
00731E5D    jz 0x00731E60                                   ; => [ Call: sub_63bc30 ]
00731E5F    int3
00731E60    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
00731E65    push 0x871DD4                                   ; => [ String: XString::XString ]
00731E6A    push 0x9A
00731E6F    push 0x871D5C
00731E74    mov edx, 0x801800
00731E79    mov ecx, 0x871E0C
00731E7E    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: str | String: C:\x\ax2017\Engine\xString.cpp ]
00731E83    add esp, 0x0C
00731E86    call 0x0063BC30
00731E8B    test al, al
00731E8D    jz 0x00731E90                                   ; => [ Call: sub_63bc30 ]
00731E8F    int3
00731E90    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
