...
0053B68B    call eax
0053B68D    mov dword ptr ds:[esi+0x24], eax
...
0053B6B3    mov dword ptr ss:[ebp-0x20], eax
...
0053B6CA    push eax
0053B6CB    call dword ptr ds:[edx+0x10]
0053B6CE    xorps xmm0, xmm0
0053B6D1    mov dword ptr ss:[ebp-0x1954], 0x00
0053B6DB    movlpd qword ptr ss:[ebp-0x195C], xmm0
