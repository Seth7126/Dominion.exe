...
00667875    push 0x76B1DD                                   ; => [ Call: __ehhandler$?common_flush_all@@YAH_N@Z | Type: EHRegistrationNode ]
0066787A    mov eax, dword ptr fs:[0x00000000]
00667880    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0066788E    push eax                                        ; => [ Data: __security_cookie ]
0066788F    lea eax, ss:[ebp-0x0C]
00667892    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00667898    mov esi, ecx
0066789A    mov dword ptr ss:[ebp-0x10], esi
0066789D    call 0x0064CC90                                 ; => [ Call: sub_64cc90 ]
...
006678CE    mov ebx, eax                                    ; => [ Call: sub_667720 ]
006678D0    jnz 0x00667918
006678D2    xor eax, eax                                    ; => [ Call: nullptr ]
006678D4    jmp 0x00667930
006678D6    test esi, esi
006678D8    jz 0x006678BD
006678DA    mov edx, 0x6F
006678DF    mov ecx, 0x8CAE70
006678E4    call 0x006DD320                                 ; => [ Call: sub_6dd320 | Data: data_8cae70 ]
006678E9    cmp dword ptr ds:[eax+0x10], 0x08
006678ED    jz 0x00667908
006678EF    push 0x874584                                   ; => [ String: AttribAsString ]
006678F4    push 0xC6B
006678F9    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
006678FE    mov ecx, 0x8745F0                               ; => [ String: AttribTagGetDefMap((AttribTable *)table, tag)->defType == DT_STRING ]
...
0066791A    call 0x0064CC90                                 ; => [ Call: sub_64cc90 ]
0066791F    push 0x6F
00667921    mov edx, eax
00667923    mov ecx, 0x8CAE70
00667928    call 0x006DD140                                 ; => [ Data: data_8cae70 | Call: sub_6dd140 ]
...
0066793E    call 0x0064CC90                                 ; => [ Call: sub_64cc90 ]
00667943    push 0x69
00667945    push dword ptr ds:[0x01724A80]
0066794B    mov edx, eax
0066794D    mov ecx, 0x8CAE70
00667952    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Data: data_8cae70 | Data: data_1724a80 ]
...
00667994    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0066799B    pop ecx
0066799C    pop edi
0066799D    pop esi
0066799E    pop ebx
...
006679FB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00667A0E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00667A13    mov eax, esi
00667A15    mov ecx, dword ptr ss:[ebp-0x0C]
00667A18    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00667A1F    pop ecx
00667A20    pop edi
00667A21    pop esi
00667A22    pop ebx
...
00667A25    pop ebp
00667A26    ret
00667A27    push 0x871DD4                                   ; => [ String: XString::XString ]
00667A2C    push 0x94
00667A31    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
00667A36    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
00667A3B    mov edx, 0x801800
00667A40    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
00667A45    add esp, 0x0C
00667A48    call 0x0063BC30
00667A4D    test al, al
00667A4F    jz 0x00667A52                                   ; => [ Call: sub_63bc30 ]
00667A51    int3
00667A52    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
