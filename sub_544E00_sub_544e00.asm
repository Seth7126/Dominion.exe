...
00544E0B    call 0x00761E50
00544E10    mov eax, dword ptr ds:[0x008C4040]
...
00544EB7    mov eax, dword ptr ds:[eax+0x1504]
...
00544EEF    setz cl
00544EF2    call 0x0061B1B0
00544EF7    add esp, 0x2C
00544EFA    call 0x00573400
