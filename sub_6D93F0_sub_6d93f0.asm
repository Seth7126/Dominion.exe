...
006D93F5    push 0x7656A0                                   ; => [ Call: __ehhandler$?MainCppEH@@YGHPBGP6GHHQAPAG@ZH1@Z | Type: EHRegistrationNode ]
006D93FA    mov eax, dword ptr fs:[0x00000000]
006D9400    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006D940E    push eax                                        ; => [ Data: __security_cookie ]
006D940F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D9412    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006D9418    mov edi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006D941E    test edi, edi
006D9420    jz 0x006D958D
006D9426    mov edi, dword ptr ds:[edi]
006D9428    xor esi, esi                                    ; => [ Call: nullptr ]
...
006D9455    mov esi, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
006D946A    call 0x006DA670                                 ; => [ Call: sub_6da670 ]
...
006D947F    xor esi, esi                                    ; => [ Call: nullptr ]
006D9481    mov ecx, eax
006D9483    lea edx, ds:[ebx+0x0C]
006D9486    mov edi, edx                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006D950C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006D9511    mov dword ptr ds:[esi], 0x00
006D9517    mov ecx, dword ptr ss:[ebp-0x0C]
006D951A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006D9521    pop ecx
006D9522    pop edi
006D9523    pop esi
006D9524    pop ebx
...
006D954E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006D9561    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006D9566    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
...
006D95A3    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
006D95A8    add esp, 0x0C
006D95AB    call 0x0063BC30
006D95B0    test al, al
006D95B2    jz 0x006D95B5                                   ; => [ Call: sub_63bc30 ]
006D95B4    int3
006D95B5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
