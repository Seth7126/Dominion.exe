...
0065D6F7    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0065D6FC    mov edi, eax
0065D6FE    mov ecx, edi
0065D700    mov edx, dword ptr ds:[edi+0x1600]
0065D706    call 0x00654960                                 ; => [ Call: sub_654960 ]
...
0065D725    jnbe 0x0065D73B                                 ; => [ Data: data_8937a0 ]
0065D727    push 0x874EB0                                   ; => [ String: UI2UpdateRoot ]
0065D72C    push 0x27A6
0065D731    mov ecx, 0x874E0C                               ; => [ String: Abs(ui.worldInfo.transform.t.x) < 1000000.0f ]
0065D736    jmp 0x0065D884
0065D73B    mov eax, dword ptr ds:[0x00C23BE0]              ; => [ Data: data_c23be0 ]
0065D740    test eax, eax
0065D742    jz 0x0065D76C
0065D744    movzx ecx, ax
0065D747    cmp ecx, dword ptr ds:[0x00C23BAC]
0065D74D    jnb 0x0065D76C                                  ; => [ Data: data_c23bac ]
0065D74F    imul ecx, ecx, 0x18D0
0065D755    add ecx, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
0065D75B    cmp dword ptr ds:[ecx+0x18C8], eax
0065D761    jnz 0x0065D76C
0065D763    test ecx, ecx
0065D765    jz 0x0065D76C
0065D767    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
...
0065D807    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0065D81E    call 0x0065D0F0                                 ; => [ Call: sub_65d0f0 ]
0065D823    inc esi
...
0065D866    call 0x0067CF00                                 ; => [ Call: sub_67cf00 ]
...
0065D873    pop ebp
0065D874    ret
0065D875    push 0x874EB0                                   ; => [ String: UI2UpdateRoot ]
0065D87A    push 0x27BE
0065D87F    mov ecx, 0x874E9C                               ; => [ String: ui.type != UI_TABLE ]
0065D884    push 0x8739B4
0065D889    mov edx, 0x801800
0065D88E    call 0x0063B870                                 ; => [ String: UI2UpdateRoot | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\UI2.cpp ]
0065D893    add esp, 0x0C
0065D896    call 0x0063BC30
0065D89B    test al, al
0065D89D    jz 0x0065D8A0                                   ; => [ Call: sub_63bc30 ]
0065D89F    int3
0065D8A0    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
