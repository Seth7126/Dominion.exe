...
0056D146    movzx esi, si                                   ; => [ Call: sub_56b800 ]
0056D149    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056D14C    cmp esi, 0x320
0056D152    jb 0x0056D159
0056D154    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056D16F    movzx esi, si                                   ; => [ Call: sub_56b800 ]
0056D172    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056D175    cmp esi, 0x320
0056D17B    jb 0x0056D182
0056D17D    call 0x00591930                                 ; => [ Call: sub_591930 ]
0056D182    imul eax, esi, 0x64
0056D185    mov eax, dword ptr ds:[eax+edi*1+0x1A4C]
0056D18C    mov dword ptr ss:[esp+0x0C], eax
0056D190    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0056D1AB    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056D1AE    cmp esi, 0x320
0056D1B4    jb 0x0056D1BB
0056D1B6    call 0x00591930                                 ; => [ Call: sub_591930 ]
