...
005D7A42    mov eax, dword ptr ds:[0x00B7D424]              ; => [ Data: data_b7d424 ]
...
005D7A63    jz 0x005D7A89                                   ; => [ Data: data_b7d434 ]
005D7A65    cmp dword ptr ds:[ebx+0x2C], 0x02
005D7A69    jnz 0x005D7A75
005D7A6B    call 0x005D79D0                                 ; => [ Call: sub_5d79d0 ]
...
005D7A7F    test al, al
005D7A81    jz 0x005D7ADA                                   ; => [ Call: sub_5d7940 ]
...
005D7A96    mov esi, dword ptr ds:[0x00B7F4C4]              ; => [ Data: data_b7f4c4 ]
005D7A9C    jnz 0x005D7ADA
005D7A9E    call 0x005D79D0                                 ; => [ Call: sub_5d79d0 ]
...
005D7AEB    mov edx, 0xB7D438                               ; => [ Data: data_b7d438 ]
005D7AF0    cmp dword ptr ds:[0x00B7F4B8], eax
005D7AF6    cmovz edx, eax                                  ; => [ Data: data_b7f4b8 | Call: nullptr ]
...
005D7B33    jz 0x005D7B39                                   ; => [ Data: data_b7f4b8 | Data: data_b7d438 ]
005D7B35    test edx, edx
005D7B37    jnz 0x005D7B00
005D7B39    xor edx, edx                                    ; => [ Call: nullptr ]
005D7B3B    cmp edx, dword ptr ds:[0x00B7F4C0]
005D7B41    pop edi
005D7B42    pop esi
005D7B43    setz al                                         ; => [ Data: data_b7f4c0 ]
005D7B46    pop ebx
...
005D7B64    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: IsPlaceholderVisible | String: Halt ]
005D7B69    add esp, 0x0C
005D7B6C    call 0x0063BC30
005D7B71    test al, al
005D7B73    jz 0x005D7B76                                   ; => [ Call: sub_63bc30 ]
005D7B75    int3
005D7B76    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
