...
0050D9B8    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: kingdom.piles[i] != CARD_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp | String: TraitTargetPiles ]
0050D9BD    add esp, 0x0C
0050D9C0    call 0x0063BC30
0050D9C5    test al, al
0050D9C7    jz 0x0050D9CA                                   ; => [ Call: sub_63bc30 ]
0050D9C9    int3
0050D9CA    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
