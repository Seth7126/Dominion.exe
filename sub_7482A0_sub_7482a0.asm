...
007482A6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
007482AB    xor eax, ebp
007482AD    mov dword ptr ss:[ebp-0x04], eax
007482B0    push ebx
007482B1    push esi
007482B2    mov bl, cl
007482B4    mov byte ptr ds:[0x01593C78], 0x01              ; => [ Data: data_1593c78 ]
007482BB    push edi
007482BC    lea ecx, ss:[ebp-0x10]
007482BF    mov dword ptr ds:[0x01593C7C], 0x00             ; => [ Data: data_1593c7c ]
007482C9    call 0x0063C270                                 ; => [ Call: sub_63c270 ]
007482CE    movss xmm1, dword ptr ss:[ebp-0x10]
007482D3    lea ecx, ss:[ebp-0x10]
007482D6    movss xmm0, dword ptr ss:[ebp-0x0C]
007482DB    movss dword ptr ds:[0x01593C80], xmm1           ; => [ Data: data_1593c80 ]
007482E3    movss dword ptr ds:[0x01593C84], xmm0           ; => [ Data: data_1593c84 ]
007482EB    mov dword ptr ds:[0x01593C90], 0x00             ; => [ Data: data_1593c90 ]
007482F5    movss dword ptr ds:[0x01593C88], xmm1           ; => [ Data: data_1593c88 ]
007482FD    movss dword ptr ds:[0x01593C8C], xmm0           ; => [ Data: data_1593c8c ]
00748305    call 0x0063C270                                 ; => [ Call: sub_63c270 ]
0074830A    push dword ptr ss:[ebp-0x0C]
0074830D    push dword ptr ss:[ebp-0x10]
00748310    call 0x00747370                                 ; => [ Call: sub_747370 ]
00748315    mov dword ptr ds:[0x01593C94], eax              ; => [ Data: data_1593c94 ]
0074831A    xor cl, cl
0074831C    lea eax, ss:[ebp-0x18]
0074831F    push eax
00748320    call 0x00748080                                 ; => [ Call: sub_748080 ]
00748325    add esp, 0x0C
00748328    mov cl, 0x01
0074832A    movups xmm0, xmmword ptr ds:[eax]
0074832D    lea eax, ss:[ebp-0x18]
00748330    push eax
00748331    movups xmmword ptr ds:[0x01593C9C], xmm0        ; => [ Data: data_1593c9c ]
00748338    call 0x00748080                                 ; => [ Call: sub_748080 ]
0074833D    xor edi, edi
0074833F    add esp, 0x04
00748342    movups xmm0, xmmword ptr ds:[eax]
00748345    mov byte ptr ds:[0x01593C98], bl                ; => [ Data: data_1593c98 ]
0074834B    movups xmmword ptr ds:[0x01593CAC], xmm0        ; => [ Data: data_1593cac ]
00748352    cmp dword ptr ds:[0x0151345C], edi
00748358    jle 0x007483FB                                  ; => [ Data: data_151345c ]
0074835E    mov esi, 0x1593CBC                              ; => [ Data: data_1593cbc ]
...
00748379    call 0x00744F10                                 ; => [ Call: sub_744f10 | Call: nullptr | Data: data_151245c ]
0074837E    inc edi
...
007483F5    jl 0x00748370                                   ; => [ Data: data_151345c ]
007483FB    mov ecx, dword ptr ss:[ebp-0x04]
007483FE    pop edi
007483FF    pop esi
00748400    xor ecx, ebp
00748402    pop ebx
00748403    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
