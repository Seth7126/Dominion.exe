...
00609370    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060937E    push eax                                        ; => [ Data: __security_cookie ]
0060937F    lea eax, ss:[ebp-0x0C]
00609382    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00609396    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
0060939B    mov eax, dword ptr ss:[ebp-0x10]
0060939E    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006093A3    test eax, eax
006093A5    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
006093FC    jz 0x00609420                                   ; => [ Data: data_cf65bc ]
006093FE    lea ecx, ss:[ebp-0x10]
00609401    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00609414    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00609419    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00609420    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00609427    test bl, bl
00609429    jz 0x00609435
0060942B    mov dword ptr ds:[0x008DB660], 0x04             ; => [ Data: data_8db660 ]
...
00609443    call 0x0063D720                                 ; => [ String: btnExp | Call: sub_63d720 ]
00609448    mov eax, dword ptr ss:[ebp+0x08]
0060944B    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0060948E    jz 0x006094B2                                   ; => [ Data: data_cf65bc ]
00609490    lea ecx, ss:[ebp+0x08]
00609493    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006094A6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006094AB    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
...
006094C4    push 0x807ECC                                   ; => [ String: DomExpDefGetByIndex ]
006094C9    push 0x118B
006094CE    mov ecx, 0x807EE0                               ; => [ String: i >= 0 ]
006094D3    jmp 0x00609628
006094D8    cmp ecx, 0x12
006094DB    jnb 0x00609619
006094E1    lea eax, ds:[ecx*8]
006094E8    mov dword ptr ds:[0x00CCF6D0], 0x00             ; => [ Data: data_ccf6d0 ]
006094F2    sub eax, ecx
006094F4    mov eax, dword ptr ds:[eax*4+0x77FCA8]
006094FB    mov dword ptr ds:[0x00CCF6CC], eax              ; => [ Data: data_77fca8 | Data: data_ccf6cc ]
00609500    mov esi, dword ptr ds:[ebx+0x04]
00609503    lea ecx, ss:[ebp+0x08]
00609506    mov edx, 0x8033B8
0060950B    call 0x0063D720                                 ; => [ String: btnRight | Call: sub_63d720 ]
00609510    mov eax, dword ptr ss:[ebp+0x08]
00609513    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0060955C    jz 0x00609579                                   ; => [ Data: data_cf65bc ]
0060955E    lea ecx, ss:[ebp+0x08]
00609561    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006095DE    jz 0x006095FB                                   ; => [ Data: data_cf65bc ]
006095E0    lea ecx, ss:[ebp+0x08]
006095E3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006095F6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006095FB    test esi, esi
006095FD    jnz 0x00609605
006095FF    dec dword ptr ds:[0x00CCF6D0]                   ; => [ Data: data_ccf6d0 ]
00609605    xor al, al
00609607    mov ecx, dword ptr ss:[ebp-0x0C]
0060960A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00609611    pop ecx
00609612    pop edi
00609613    pop esi
00609614    pop ebx
...
00609617    pop ebp
00609618    ret
00609619    push 0x807ECC                                   ; => [ String: DomExpDefGetByIndex ]
0060961E    push 0x118C
00609623    mov ecx, 0x807EE8                               ; => [ String: i < ARRAYSIZE(DOM_EXP_DEFS) ]
00609628    push 0x806FE4
0060962D    mov edx, edi
0060962F    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameShared.cpp | Call: sub_63b870 | Data: data_801800 | String: DomExpDefGetByIndex ]
00609634    add esp, 0x0C
00609637    call 0x0063BC30
0060963C    test al, al
0060963E    jz 0x00609641                                   ; => [ Call: sub_63bc30 ]
00609640    int3
00609641    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
