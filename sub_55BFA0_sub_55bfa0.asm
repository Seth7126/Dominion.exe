...
0055C052    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055C057    push esi
0055C058    push 0xC00
0055C05D    mov ecx, dword ptr ds:[eax+0x04]
0055C060    call 0x00583F70
0055C065    add esp, 0x08
0055C068    mov edi, eax                                    ; => [ Call: sub_583f70 ]
0055C06A    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055C06F    test edi, edi
0055C071    jz 0x0055C119
0055C077    mov ebx, eax
0055C079    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055C07E    push esi
0055C07F    push 0xC00
...
0055C091    jl 0x0055C0B3                                   ; => [ Call: sub_583f70 ]
0055C093    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055C098    push esi
0055C099    push 0xC00
0055C09E    mov ecx, dword ptr ds:[eax+0x04]
0055C0A1    call 0x00583F70                                 ; => [ Call: sub_583f70 ]
...
0055C0C5    call 0x00591930                                 ; => [ Call: sub_591930 ]
0055C0CA    push 0x00
...
0055C0DF    push eax
0055C0E0    push 0xC00
0055C0E5    call 0x00571FA0                                 ; => [ Call: sub_571fa0 | Call: nullptr ]
...
0055C117    pop ebp
0055C118    ret                                             ; => [ Call: sub_571fa0 | Call: nullptr ]
...
0055C12C    push 0x02
0055C12E    push 0xC00
0055C133    call 0x00571FA0                                 ; => [ Call: sub_571fa0 | Call: nullptr ]
