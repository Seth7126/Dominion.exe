...
006ED045    push 0x771B8F                                   ; => [ Type: EHRegistrationNode | Call: sub_771b8f ]
006ED04A    mov eax, dword ptr fs:[0x00000000]
006ED050    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006ED05E    push eax                                        ; => [ Data: __security_cookie ]
006ED05F    lea eax, ss:[ebp-0x0C]
006ED062    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006ED07F    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006ED0AA    push 0x883140                                   ; => [ String: group%d ]
006ED0AF    push eax
006ED0B0    call 0x0063DF30                                 ; => [ String: group%d | Call: sub_63df30 ]
006ED0B5    mov ebx, dword ptr ss:[ebp+0x08]
006ED0B8    lea ecx, ss:[ebp-0x18]
006ED0BB    mov byte ptr ss:[ebp-0x04], 0x01
006ED0BF    mov edx, esi                                    ; => [ Data: data_801800 ]
...
006ED0E3    call 0x0063D850                                 ; => [ Call: sub_6ed680 | Call: sub_63d850 ]
006ED0E8    mov byte ptr ss:[ebp-0x04], 0x03
006ED0EC    cmp dword ptr ds:[0x00CF65BC], 0x00
006ED0F3    jz 0x006ED123                                   ; => [ Data: data_cf65bc ]
...
006ED104    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED117    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED11C    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006ED136    jz 0x006ED3F6                                   ; => [ Data: data_cf65bc ]
...
006ED153    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED16A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED16F    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006ED176    jmp 0x006ED3F6
006ED17B    push eax
006ED17C    lea eax, ss:[ebp-0x10]
006ED17F    mov byte ptr ss:[ebp-0x04], 0x05
006ED183    push 0x882D4C                                   ; => [ String: samplerFn_layer%d ]
006ED188    push eax
006ED189    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: samplerFn_layer%d ]
006ED18E    mov ebx, dword ptr ss:[ebp+0x08]
006ED191    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
006ED1D2    push eax
006ED1D3    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: float4 %s(float2 arg_uv, float4 color)\n{\n\treturn color;\n}\n ]
...
006ED223    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED236    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED23B    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006ED242    lea eax, ss:[ebp-0x10]
006ED245    mov byte ptr ss:[ebp-0x04], 0x05
006ED249    push eax
006ED24A    lea ecx, ss:[ebp-0x14]
006ED24D    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
006ED252    mov byte ptr ss:[ebp-0x04], 0x08
006ED256    cmp dword ptr ds:[0x00CF65BC], 0x00
006ED25D    jz 0x006ED28D                                   ; => [ Data: data_cf65bc ]
...
006ED26E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED281    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED286    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006ED28D    mov esi, 0x801800
006ED292    jmp 0x006ED3F6
006ED297    push eax
006ED298    lea eax, ss:[ebp-0x10]
006ED29B    mov byte ptr ss:[ebp-0x04], 0x09
006ED29F    push 0x882D4C                                   ; => [ String: samplerFn_layer%d ]
006ED2A4    push eax
006ED2A5    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: samplerFn_layer%d ]
006ED2AA    mov ebx, dword ptr ss:[ebp+0x08]
006ED2AD    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
006ED2EE    push eax
006ED2EF    call 0x0063DF30                                 ; => [ String: float4 %s(float2 arg_uv, float4 color)\n{\n\treturn gMaterialColor%d;\n}\n | Call: sub_63df30 ]
...
006ED33F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED352    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED357    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006ED35E    lea eax, ss:[ebp-0x10]
006ED361    mov byte ptr ss:[ebp-0x04], 0x09
006ED365    push eax
006ED366    lea ecx, ss:[ebp-0x14]
006ED369    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
006ED391    call 0x0063D850                                 ; => [ Call: sub_6ecae0 | Call: sub_63d850 ]
...
006ED3B6    call 0x0063D850                                 ; => [ Call: sub_6ec690 | Call: sub_63d850 ]
006ED3BB    mov byte ptr ss:[ebp-0x04], 0x10
006ED3BF    cmp dword ptr ds:[0x00CF65BC], 0x00
006ED3C6    jz 0x006ED3F6                                   ; => [ Data: data_cf65bc ]
...
006ED3D7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED3EA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED3EF    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006ED406    mov edx, 0x801800                               ; => [ Data: data_801800 ]
...
006ED427    call 0x006ECD70                                 ; => [ Call: sub_6ecd70 | Call: sub_63df30 | String: \tvec4 retval = %s(uv, diffuse);\n ]
...
006ED44A    push eax
006ED44B    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: %f ]
...
006ED471    mov edx, 0x8830A0                               ; => [ String: BlendAlpha ]
006ED476    jmp 0x006ED4A7
006ED478    mov edx, 0x8830CC                               ; => [ String: BlendMultiply ]
006ED47D    jmp 0x006ED4A7
006ED47F    mov edx, 0x8830C0                               ; => [ String: BlendAdd ]
006ED484    jmp 0x006ED4A7
006ED486    mov edx, 0x8830E8                               ; => [ String: BlendOverlay ]
006ED48B    jmp 0x006ED4A7
006ED48D    mov edx, 0x8830DC                               ; => [ String: BlendMask ]
006ED492    jmp 0x006ED4A7
006ED494    mov edx, 0x883104                               ; => [ String: BlendFade ]
006ED499    jmp 0x006ED4A7
006ED49B    mov edx, 0x8830F8                               ; => [ String: BlendColor ]
006ED4A0    jmp 0x006ED4A7
006ED4A2    mov edx, 0x88311C                               ; => [ String: BlendColorHSL ]
006ED4A7    lea ecx, ss:[ebp-0x10]
006ED4AA    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006ED4AF    mov byte ptr ss:[ebp-0x04], 0x14
006ED4B3    mov ecx, esi                                    ; => [ Data: data_801800 ]
006ED4B5    mov eax, dword ptr ss:[ebp-0x20]
006ED4B8    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006ED4BD    mov edi, dword ptr ss:[ebp-0x10]
006ED4C0    test eax, eax
006ED4C2    cmovnz ecx, eax
006ED4C5    mov eax, esi                                    ; => [ Data: data_801800 ]
...
006ED4F0    call 0x006ECD70                                 ; => [ Call: sub_6ecd70 | String: \tretval = %s(retval, %s(uv, diffuse), %s);\n | Call: sub_63df30 ]
006ED4F5    mov byte ptr ss:[ebp-0x04], 0x16
006ED4F9    cmp dword ptr ds:[0x00CF65BC], 0x00
006ED500    jz 0x006ED530                                   ; => [ Data: data_cf65bc ]
...
006ED511    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED524    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED529    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
...
006ED544    jz 0x006ED561                                   ; => [ Data: data_cf65bc ]
006ED546    lea ecx, ss:[ebp-0x10]
006ED549    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED55C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED561    mov byte ptr ss:[ebp-0x04], 0x18
006ED565    cmp dword ptr ds:[0x00CF65BC], 0x00
006ED56C    jz 0x006ED595                                   ; => [ Data: data_cf65bc ]
...
006ED57D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED590    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006ED5B1    jz 0x006ED5CE                                   ; => [ Data: data_cf65bc ]
006ED5B3    lea ecx, ss:[ebp-0x14]
006ED5B6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006ED5C9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006ED5CE    mov ecx, dword ptr ss:[ebp-0x0C]
006ED5D1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006ED5D8    pop ecx
006ED5D9    pop edi
006ED5DA    pop esi
006ED5DB    pop ebx
...
006ED5F9    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\MaterialFnDef.cpp | Data: data_801800 | String: EmitItemFunction | String: Halt ]
006ED5FE    add esp, 0x0C
006ED601    call 0x0063BC30
006ED606    test al, al
006ED608    jz 0x006ED60B                                   ; => [ Call: sub_63bc30 ]
006ED60A    int3
006ED60B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006ED610    push 0x883110
006ED615    push 0x3CA
006ED61A    push 0x882BB8
006ED61F    mov edx, esi
006ED621    mov ecx, 0x801AA4
006ED626    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\MaterialFnDef.cpp | Data: data_801800 | String: EmitBlendFn | String: Halt ]
006ED62B    byte 83
006ED62C    byte C4
006ED62D    byte C
006ED62E    byte E8
