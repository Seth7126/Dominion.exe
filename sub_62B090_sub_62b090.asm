...
0062B093    mov eax, dword ptr ds:[0x00CC8DC0]              ; => [ Data: data_cc8dc0 ]
...
0062B0A5    push 0x806A44                                   ; => [ String: GetLocalSettings ]
0062B0AA    push 0x5FB
0062B0AF    push 0x806734                                   ; => [ String: C:\x\ax2017\Jams\Shared\TggGame\code\GameSettings.cpp ]
0062B0B4    mov ecx, 0x806A58                               ; => [ String: gGameSettings.localSettings ]
...
0062B0F5    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0062B0FA    movss xmm1, dword ptr ds:[esi]
0062B0FE    movss xmm0, dword ptr ss:[ebp-0x04]
0062B103    mulss xmm0, dword ptr ds:[0x008C4634]           ; => [ Data: data_8c4634 ]
...
0062B153    call 0x004AC580                                 ; => [ Call: sub_4ac580 ]
...
0062B1B2    mov eax, dword ptr ds:[0x00B8099C]              ; => [ Data: data_b8099c ]
...
0062B1D9    mov dword ptr ds:[0x00B8099C], eax              ; => [ Data: data_b8099c ]
...
0062B1F2    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0062B217    call 0x0067A770                                 ; => [ Call: nullptr | Call: sub_67a770 ]
0062B21C    mov ecx, esi
0062B21E    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
0062B223    pop edi
0062B224    pop esi
0062B225    mov esp, ebp
0062B227    pop ebp
0062B228    ret
0062B229    push 0x86CEA4                                   ; => [ String: AutoScrollUpdate ]
0062B22E    push 0xFF2B
0062B233    push 0x86F1E8                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp ]
0062B238    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0062B23D    mov edx, 0x801800
0062B242    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0062B247    add esp, 0x0C
0062B24A    call 0x0063BC30
0062B24F    test al, al
0062B251    jz 0x0062B254                                   ; => [ Call: sub_63bc30 ]
0062B253    int3
0062B254    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
