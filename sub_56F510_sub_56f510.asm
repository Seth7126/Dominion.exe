...
0056F519    mov eax, dword ptr ds:[0x008C4040]
...
0056F5DE    xor ecx, ecx
0056F5E0    cmp esi, dword ptr ds:[eax+0x0C]
0056F5E3    cmovz ecx, edi
...
0056F6A2    mov dword ptr ss:[ebp-0xCC4], 0x00
...
0056F808    push 0x81EEB0
0056F80D    push 0x1B26
0056F812    push 0x81EA70
0056F817    mov ecx, 0x81EEC8
...
0056F887    pop ebx
0056F888    call 0x0075927A
0056F88D    mov esp, ebp
0056F88F    pop ebp
0056F890    ret
0056F891    push 0x81F9E0
0056F896    push 0x792
0056F89B    push 0x81F4B8
0056F8A0    mov ecx, 0x81F9F0
0056F8A5    mov edx, 0x801800
0056F8AA    call 0x0063B870
0056F8AF    add esp, 0x0C
0056F8B2    call 0x0063BC30
0056F8B7    test al, al
0056F8B9    jz 0x0056F8BC
0056F8BB    int3
0056F8BC    call 0x0063BB00
