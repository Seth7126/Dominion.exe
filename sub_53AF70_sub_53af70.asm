...
0053AF7C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0053AF81    xor eax, esp
0053AF83    mov dword ptr ss:[esp+0xC90], eax
0053AF8A    push esi
0053AF8B    call 0x00563590                                 ; => [ Call: sub_563590 ]
0053AF90    mov esi, eax
0053AF92    test esi, esi
0053AF94    jz 0x0053AFF2
0053AF96    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0053AFBF    call 0x00565FF0                                 ; => [ Call: nullptr | Call: sub_565ff0 ]
