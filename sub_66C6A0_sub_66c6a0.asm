0066C6A0    mov edx, dword ptr ds:[0x00C28C58]
0066C6A6    push ebx
0066C6A7    mov ebx, dword ptr ds:[0x00C23BAC]
0066C6AD    push esi
...
0066C750    mov dword ptr ds:[0x00C28C5C], eax
0066C755    imul eax, dword ptr ds:[0x00CA9A6C], 0x101C
0066C75F    push 0x1018
0066C764    push 0xC27C54
0066C769    add eax, 0xC27C50
0066C76E    push eax
0066C76F    call 0x00761FBE
0066C774    add esp, 0x0C
0066C777    mov ecx, esi
0066C779    pop edi
0066C77A    pop esi
0066C77B    pop ebx
0066C77C    jmp 0x0066BA80
0066C781    dec edx
0066C782    pop edi
0066C783    mov dword ptr ds:[0x00C28C58], edx
0066C789    pop esi
0066C78A    mov eax, dword ptr ds:[edx*4+0xC27C58]
0066C791    mov dword ptr ds:[ecx*4+0xC27C58], eax
0066C798    pop ebx
0066C799    ret
...
0066C7A7    push 0x876B2C
0066C7AC    push 0x6C
0066C7AE    mov ecx, 0x802734
0066C7B3    jmp 0x0066C7C1
0066C7B5    push 0x876B2C
0066C7BA    mov ecx, 0x802748
0066C7BF    push 0x6D
0066C7C1    push 0x80193C
0066C7C6    mov edx, 0x801800
0066C7CB    call 0x0063B870
0066C7D0    add esp, 0x0C
0066C7D3    call 0x0063BC30
0066C7D8    test al, al
0066C7DA    jz 0x0066C7DD
0066C7DC    int3
0066C7DD    call 0x0063BB00
