...
0051402C    jz 0x00514032                                   ; => [ Call: sub_573400 ]
0051402E    xor al, al
00514030    pop ebp
00514031    ret
00514032    push ebx
00514033    push esi
00514034    push edi
00514035    call 0x0050EDF0                                 ; => [ Call: sub_50edf0 ]
0051403A    mov ebx, eax
0051403C    call 0x00573400
00514041    movzx esi, word ptr ss:[ebp+0x08]
00514045    mov edi, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00514048    cmp esi, 0x320
0051404E    jb 0x00514055
00514050    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00514069    pop esi
0051406A    setz al                                         ; => [ Call: sub_57da30 ]
0051406D    pop ebx
0051406E    pop ebp
0051406F    ret
