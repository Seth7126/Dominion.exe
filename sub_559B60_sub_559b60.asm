...
00559B9F    push 0x01
00559BA1    call 0x00590760                                 ; => [ Call: sub_590760 ]
00559BA6    add esp, 0x10
00559BA9    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00559BF0    pop ebp
00559BF1    ret                                             ; => [ Call: sub_561af0 ]
00559BF2    call 0x00573400                                 ; => [ Call: sub_573400 ]
00559BF7    push 0x00
00559BF9    push 0x00
00559BFB    push 0x03
...
00559C03    push 0x02
00559C05    call 0x00590760                                 ; => [ Call: sub_590760 ]
00559C0A    add esp, 0x10
00559C0D    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00559C30    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
00559C35    add esp, 0x0C
00559C38    call 0x0063BC30
00559C3D    test al, al
00559C3F    jz 0x00559C42                                   ; => [ Call: sub_63bc30 ]
00559C41    int3
00559C42    jmp 0x0063BB00                                  ; => [ Call: sub_63bb00 ]
