...
00752440    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00752445    push esi
...
00752454    push 0x1A8
00752459    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
0075245B    add esp, 0x0C
0075245E    jmp 0x0075246E
00752460    push 0x1A8
00752465    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00752479    push 0x00
0075247B    push edi
0075247C    call 0x00761FC4                                 ; => [ Call: memset ]
...
00752497    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007524AA    push ecx
007524AB    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
007524AD    add esp, 0x0C
007524B0    jmp 0x007524BC
007524B2    push ecx
007524B3    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007524CF    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
007524D4    test eax, eax
007524D6    jz 0x007524E8
007524D8    push 0x22
007524DA    push 0x890384
007524DF    push 0x0C
007524E1    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
007524E3    add esp, 0x0C
007524E6    jmp 0x007524F3
007524E8    push 0x0C
007524EA    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00752500    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0075251D    push 0x10
0075251F    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
00752521    add esp, 0x0C
00752524    jmp 0x00752531
00752526    push 0x10
00752528    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
0075252E    add esp, 0x04
00752531    test eax, eax
00752533    jz 0x0075253B
00752535    xorps xmm0, xmm0
00752538    movups xmmword ptr ds:[eax], xmm0               ; => [ String: 0 | String: zx ]
0075253B    mov dword ptr ds:[esi+0x08], eax
0075253E    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00752551    push 0x0C
00752553    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
00752555    add esp, 0x0C
00752558    jmp 0x00752565
0075255A    push 0x0C
0075255C    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00752572    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
0075258F    push 0x10
00752591    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
00752593    add esp, 0x0C
00752596    jmp 0x007525A3
00752598    push 0x10
0075259A    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
007525A0    add esp, 0x04
007525A3    test eax, eax
007525A5    jz 0x007525AD
007525A7    xorps xmm0, xmm0
007525AA    movups xmmword ptr ds:[eax], xmm0               ; => [ String: 0 | String: zx ]
007525AD    mov dword ptr ds:[esi+0x08], eax
007525B0    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
007525C3    push 0x0C
007525C5    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
007525C7    add esp, 0x0C
007525CA    jmp 0x007525D7
007525CC    push 0x0C
007525CE    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
007525E4    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00752601    push 0x10
00752603    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
00752605    add esp, 0x0C
00752608    jmp 0x00752615
0075260A    push 0x10
0075260C    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00752612    add esp, 0x04
00752615    test eax, eax
00752617    jz 0x0075261F
00752619    xorps xmm0, xmm0
0075261C    movups xmmword ptr ds:[eax], xmm0               ; => [ String: 0 | String: zx ]
0075261F    mov dword ptr ds:[esi+0x08], eax
00752622    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00752635    push 0x0C
00752637    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
00752639    add esp, 0x0C
0075263C    jmp 0x00752649
0075263E    push 0x0C
00752640    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
...
00752656    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
...
00752673    push 0x10
00752675    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\Skin.c ]
00752677    add esp, 0x0C
0075267A    jmp 0x00752687
0075267C    push 0x10
0075267E    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00752684    add esp, 0x04
00752687    test eax, eax
00752689    jz 0x00752691
0075268B    xorps xmm0, xmm0
0075268E    movups xmmword ptr ds:[eax], xmm0               ; => [ String: 0 | String: zx ]
