...
0063C280    jle 0x0063C28F                                  ; => [ Data: data_147cc88 ]
0063C282    mov eax, dword ptr ds:[0x0147CC94]              ; => [ Data: data_147cc94 ]
0063C287    mov edx, dword ptr ds:[0x0147CC98]              ; => [ Data: data_147cc98 ]
0063C28D    jmp 0x0063C2E4
0063C28F    lea eax, ss:[ebp-0x1C]
0063C292    mov dword ptr ss:[ebp-0x1C], 0x14               ; => [ Type: CURSORINFO | Field: cbSize ]
0063C299    xorps xmm0, xmm0
0063C29C    push eax
0063C29D    movups xmmword ptr ss:[ebp-0x18], xmm0          ; => [ Field: flags | Field: hCursor | Field: x | Field: ptScreenPos | Field: y | Field: ptScreenPos ]
...
0063C2B6    jz 0x0063C324                                   ; => [ Type: POINT | Data: data_cf65b4 | Field: flags ]
...
0063C2D0    call dword ptr ds:[0x00775390]                  ; => [ Data: data_147b084 ]
0063C2D6    push dword ptr ss:[ebp-0x04]
0063C2D9    push dword ptr ss:[ebp-0x08]
0063C2DC    call 0x006C8420                                 ; => [ Call: sub_6c8420 | Field: x | Field: y ]
...
0063C2F5    mov eax, dword ptr ds:[0x00CF65B8]              ; => [ Data: data_cf65b8 ]
