...
0050E31C    mov eax, dword ptr ds:[0x008C4040]
0050E321    xor eax, esp
0050E323    mov dword ptr ss:[esp+0xC8C], eax
0050E32A    mov ecx, 0x31
0050E32F    call 0x00513D60
0050E334    call 0x00573400
...
0050E3A6    call 0x0063B870
0050E3AB    add esp, 0x0C
0050E3AE    call 0x0063BC30
0050E3B3    test al, al
0050E3B5    jz 0x0050E3B8
0050E3B7    int3
0050E3B8    call 0x0063BB00
