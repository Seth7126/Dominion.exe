...
004CB070    mov dword ptr fs:[0x00000000], eax
...
004CB084    call 0x0063D720
004CB089    mov eax, dword ptr ss:[ebp-0x10]
004CB08C    mov edi, 0x801800
004CB091    test eax, eax
004CB093    mov ecx, edi
...
004CB0E4    jz 0x004CB108
004CB0E6    lea ecx, ss:[ebp-0x10]
004CB0E9    call 0x0063D4E0
...
004CB170    call 0x0063D720
004CB175    mov eax, dword ptr ss:[ebp+0x08]
004CB178    mov ecx, edi
...
004CB1BC    jz 0x004CB1E0
004CB1BE    lea ecx, ss:[ebp+0x08]
004CB1C1    call 0x0063D4E0
...
004CB24C    jz 0x004CB270
004CB24E    lea ecx, ss:[ebp+0x08]
004CB251    call 0x0063D4E0
...
004CB264    call 0x0064C080
004CB269    mov dword ptr ss:[ebp+0x08], 0x801800
...
004CB281    mov ecx, dword ptr ds:[eax*8+0x7E7678]
...
004CB29C    mov dword ptr ds:[0x008DB660], eax
...
004CB313    jz 0x004CB330
004CB315    lea ecx, ss:[ebp+0x08]
004CB318    call 0x0063D4E0
...
004CB39C    jz 0x004CB3B9
004CB39E    lea ecx, ss:[ebp+0x08]
004CB3A1    call 0x0063D4E0
...
004CB3B4    call 0x0064C080
004CB3B9    test esi, esi
004CB3BB    jnz 0x004CB3C7
004CB3BD    mov dword ptr ds:[0x008DB660], 0x18
004CB3C7    xor al, al
004CB3C9    mov ecx, dword ptr ss:[ebp-0x0C]
004CB3CC    mov dword ptr fs:[0x00000000], ecx
004CB3D3    pop ecx
004CB3D4    pop edi
004CB3D5    pop esi
004CB3D6    pop ebx
...
004CB3F1    call 0x0063B870
004CB3F6    add esp, 0x0C
004CB3F9    call 0x0063BC30
004CB3FE    test al, al
004CB400    jz 0x004CB403
004CB402    int3
004CB403    call 0x0063BB00
