...
0055AAE8    push esi
0055AAE9    push edi
0055AAEA    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055AAEF    push 0x00
0055AAF1    push 0x00
0055AAF3    push 0x01
...
0055AAFB    push 0x01
0055AAFD    call 0x00590760                                 ; => [ Call: sub_590760 ]
0055AB02    add esp, 0x10
0055AB05    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055ABB5    call 0x00561E00                                 ; => [ Call: sub_561e00 ]
...
0055ABDA    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0055ABDF    add esp, 0x0C
0055ABE2    call 0x0063BC30
0055ABE7    test al, al
0055ABE9    jz 0x0055ABEC                                   ; => [ Call: sub_63bc30 ]
0055ABEB    int3
0055ABEC    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
