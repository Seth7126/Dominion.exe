...
0060BD47    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BD60    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5c48 ]
0060BD65    add esp, 0x08
0060BD68    pop edi
0060BD69    pop esi
0060BD6A    pop ebp
0060BD6B    ret
0060BD6C    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BD85    call 0x00665DB0                                 ; => [ Data: data_be5c54 | Call: sub_665db0 ]
0060BD8A    add esp, 0x08
0060BD8D    pop edi
0060BD8E    pop esi
0060BD8F    pop ebp
0060BD90    ret
0060BD91    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BDAA    call 0x00665DB0                                 ; => [ Data: data_be5c60 | Call: sub_665db0 ]
0060BDAF    add esp, 0x08
0060BDB2    pop edi
0060BDB3    pop esi
0060BDB4    pop ebp
0060BDB5    ret
0060BDB6    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BDCF    call 0x00665DB0                                 ; => [ Data: data_be5c6c | Call: sub_665db0 ]
0060BDD4    add esp, 0x08
0060BDD7    pop edi
0060BDD8    pop esi
0060BDD9    pop ebp
0060BDDA    ret
0060BDDB    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BDF4    call 0x00665DB0                                 ; => [ Data: data_be5c78 | Call: sub_665db0 ]
0060BDF9    add esp, 0x08
0060BDFC    pop edi
0060BDFD    pop esi
0060BDFE    pop ebp
0060BDFF    ret
0060BE00    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BE19    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5c84 ]
0060BE1E    add esp, 0x08
0060BE21    pop edi
0060BE22    pop esi
0060BE23    pop ebp
0060BE24    ret
0060BE25    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BE3E    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5c90 ]
0060BE43    add esp, 0x08
0060BE46    pop edi
0060BE47    pop esi
0060BE48    pop ebp
0060BE49    ret
0060BE4A    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BE63    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5cc0 ]
0060BE68    add esp, 0x08
0060BE6B    pop edi
0060BE6C    pop esi
0060BE6D    pop ebp
0060BE6E    ret
0060BE6F    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BE74    mov edx, 0xBE5CC0                               ; => [ Data: data_be5cc0 ]
0060BE79    mov esi, dword ptr ss:[ebp+0x08]
0060BE7C    mov ecx, eax
0060BE7E    movss xmm3, dword ptr ds:[0x00890E18]
0060BE86    push 0x00
0060BE88    push esi
0060BE89    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
0060BE8E    mov ecx, edi
0060BE90    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BE95    movss xmm3, dword ptr ds:[0x00890E18]
0060BE9D    mov edx, 0xBE5CCC
0060BEA2    push 0x00
0060BEA4    push esi
0060BEA5    mov ecx, eax
0060BEA7    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5ccc ]
0060BEAC    add esp, 0x10
0060BEAF    pop edi
0060BEB0    pop esi
0060BEB1    pop ebp
0060BEB2    ret
0060BEB3    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BECC    call 0x00665DB0                                 ; => [ Data: data_be5cb4 | Call: sub_665db0 ]
0060BED1    add esp, 0x08
0060BED4    pop edi
0060BED5    pop esi
0060BED6    pop ebp
0060BED7    ret
0060BED8    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BEDD    mov edx, 0xBE5CB4                               ; => [ Data: data_be5cb4 ]
0060BEE2    jmp 0x0060BE79
0060BEE4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BEFD    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_be5ca8 ]
0060BF02    add esp, 0x08
0060BF05    pop edi
0060BF06    pop esi
0060BF07    pop ebp
0060BF08    ret
0060BF09    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BF0E    mov edx, 0xBE5CA8                               ; => [ Data: data_be5ca8 ]
0060BF13    jmp 0x0060BE79
0060BF18    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BF31    call 0x00665DB0                                 ; => [ Data: data_be5c9c | Call: sub_665db0 ]
0060BF36    add esp, 0x08
0060BF39    pop edi
0060BF3A    pop esi
0060BF3B    pop ebp
0060BF3C    ret
0060BF3D    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BF42    mov edx, 0xBE5C9C                               ; => [ Data: data_be5c9c ]
0060BF47    jmp 0x0060BE79
0060BF4C    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BF65    call 0x00665DB0                                 ; => [ Data: data_be5ce4 | Call: sub_665db0 ]
0060BF6A    add esp, 0x08
0060BF6D    pop edi
0060BF6E    pop esi
0060BF6F    pop ebp
0060BF70    ret
0060BF71    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0060BF8A    call 0x00665DB0                                 ; => [ Data: data_be5cd8 | Call: sub_665db0 ]
...
0060BFAF    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: DeclareCalendarDay | String: Halt ]
0060BFB4    add esp, 0x0C
0060BFB7    call 0x0063BC30
0060BFBC    test al, al
0060BFBE    jz 0x0060BFC1                                   ; => [ Call: sub_63bc30 ]
0060BFC0    int3
0060BFC1    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
