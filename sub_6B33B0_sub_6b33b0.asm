...
006B33BB    push 0x87A4B4                                   ; => [ String: FontGetDef ]
006B33C0    push 0x2E6
006B33C5    push 0x87A2E0                                   ; => [ String: C:\x\ax2017\Engine\AssetUtils.cpp ]
006B33CA    mov ecx, 0x87A48C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_FONT ]
006B33CF    jmp 0x006B3442
006B33D1    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
006B33F3    mov ecx, dword ptr ds:[eax]                     ; => [ Call: sub_5af880 ]
...
006B3400    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006B3405    test eax, eax
006B3407    cmovnz ecx, eax
006B340A    push ecx
006B340B    push 0x87A2A0
006B3410    call 0x0063B5F0                                 ; => [ String: didn't find asset in atlas forcing a reimport %s | Call: sub_63b5f0 ]
006B3415    mov ecx, esi
006B3417    call 0x0069EC60
006B341C    push 0x00
006B341E    mov dl, 0x01
006B3420    mov ecx, esi
006B3422    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 | Call: sub_69ec60 ]
006B3427    add esp, 0x0C
006B342A    pop edi
006B342B    pop esi
006B342C    pop ecx
006B342D    ret
006B342E    push 0x86F01C                                   ; => [ String: TextureGetDef ]
006B3433    push 0x89
006B3438    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
006B343D    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
006B3442    mov edx, 0x801800
006B3447    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006B344C    add esp, 0x0C
006B344F    call 0x0063BC30
006B3454    test al, al
006B3456    jz 0x006B3459                                   ; => [ Call: sub_63bc30 ]
006B3458    int3
006B3459    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
