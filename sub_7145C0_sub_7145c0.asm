...
007145C3    xor edx, edx                                    ; => [ Call: nullptr ]
007145C5    push esi
007145C6    push edi
...
0071461B    mov ecx, dword ptr ds:[ecx+edi*8+0x04]          ; => [ Call: nullptr ]
...
00714639    call 0x00710240                                 ; => [ Call: sub_710240 ]
...
0071468E    call 0x007564E0                                 ; => [ Call: sub_7564e0 ]
