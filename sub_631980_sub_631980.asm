...
00631986    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
...
006319B8    mov edi, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
006319BE    jmp 0x006319D3
006319C0    cmp dword ptr ds:[0x008DB5D4], 0x27
006319C7    jnz 0x00631C06                                  ; => [ Data: data_8db5d4 ]
006319CD    mov edi, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
...
00631A14    jnz 0x00631A21                                  ; => [ String: tbl_opponent_pods | Data: data_1a98ce4 | Data: data_1a98cd8 | Data: data_1a98cdc | Data: data_1a98ce0 | String: tbl_opponents | Data: data_1a98cd0 | Data: data_1a98cd4 ]
00631A16    mov edx, dword ptr ds:[0x01A98CF0]
00631A1C    jmp 0x00631ABC
00631A21    mov edx, 0x86FA90
00631A26    mov ecx, edi
00631A28    call 0x0067BD70                                 ; => [ Call: sub_67bd70 | String: tbl_opponents ]
00631A2D    test eax, eax
00631A2F    jnz 0x00631A38
00631A31    mov dword ptr ds:[0x01A98CF0], eax              ; => [ Data: data_1a98cf0 ]
00631A36    jmp 0x00631A51
00631A38    mov ecx, eax
00631A3A    call 0x0064E7A0
00631A3F    push 0x00
00631A41    mov ecx, eax
00631A43    call 0x0064C870                                 ; => [ Call: nullptr | Call: sub_64c870 | Call: sub_64e7a0 ]
00631A48    mov dword ptr ds:[0x01A98CF0], eax              ; => [ Data: data_1a98cf0 ]
...
00631A77    mov edx, eax                                    ; => [ String: tbl_opponent_pods | Call: sub_67bd70 ]
00631A79    mov eax, dword ptr ds:[0x007FFB1C]
00631A7E    mov dword ptr ds:[0x01A98CF0], edx              ; => [ Data: data_1a98cf0 ]
00631A84    mov dword ptr ds:[0x01A98CD0], edi              ; => [ Data: data_1a98cd0 ]
00631A8A    mov dword ptr ds:[0x01A98CD4], 0x86FA90         ; => [ Data: data_1a98cd4 | String: tbl_opponents ]
00631A94    mov dword ptr ds:[0x01A98CD8], 0x00             ; => [ Data: data_1a98cd8 ]
00631A9E    mov dword ptr ds:[0x01A98CDC], 0x86FAC8         ; => [ String: tbl_opponent_pods | Data: data_1a98cdc ]
00631AA8    mov dword ptr ds:[0x01A98CE0], 0xFFFFFFFF       ; => [ Data: data_1a98ce0 ]
00631AB2    mov dword ptr ds:[0x01A98CE4], 0x00             ; => [ Data: data_1a98ce4 ]
00631ABC    mov dword ptr ss:[ebp-0x04], edx                ; => [ Data: data_1a98cf0 ]
...
00631AF8    jnz 0x00631B05                                  ; => [ String: tbl_opponent_pods | Data: data_1a98cfc | Data: data_1a98cf8 | Data: data_1a98d04 | Data: data_1a98d00 | Data: data_1a98cf4 | String: tbl_opponents | Data: data_1a98d08 ]
00631AFA    mov esi, dword ptr ds:[0x01A98D14]              ; => [ Data: data_1a98d14 ]
00631B00    jmp 0x00631BAA
00631B05    mov edx, 0x86FA90
00631B0A    mov ecx, edi
00631B0C    call 0x0067BD70                                 ; => [ Call: sub_67bd70 | String: tbl_opponents ]
...
00631B20    call 0x0064C870                                 ; => [ Call: nullptr | Call: sub_64c870 | Call: sub_64e7a0 ]
00631B25    test eax, eax
00631B27    jz 0x00631B93
00631B29    mov edx, 0x86FAC8
00631B2E    mov ecx, eax
00631B30    call 0x0067BD70                                 ; => [ String: tbl_opponent_pods | Call: sub_67bd70 ]
...
00631B4D    mov esi, eax                                    ; => [ Call: nullptr | Call: sub_64c870 | Call: sub_64e7a0 ]
00631B4F    mov dword ptr ds:[0x01A98D14], esi              ; => [ Data: data_1a98d14 ]
00631B55    test esi, esi
00631B57    jz 0x00631B9D
00631B59    mov dword ptr ds:[0x01A98CF4], edi              ; => [ Data: data_1a98cf4 ]
00631B5F    mov dword ptr ds:[0x01A98CF8], 0x86FA90         ; => [ Data: data_1a98cf8 | String: tbl_opponents ]
00631B69    mov dword ptr ds:[0x01A98CFC], 0x00             ; => [ Data: data_1a98cfc ]
00631B73    mov dword ptr ds:[0x01A98D00], 0x86FAC8         ; => [ Data: data_1a98d00 | String: tbl_opponent_pods ]
00631B7D    mov dword ptr ds:[0x01A98D04], 0x00             ; => [ Data: data_1a98d04 ]
00631B87    mov dword ptr ds:[0x01A98D08], 0x00             ; => [ Data: data_1a98d08 ]
00631B91    jmp 0x00631B9F
00631B93    mov dword ptr ds:[0x01A98D14], 0x00             ; => [ Data: data_1a98d14 ]
...
00631BB3    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
00631BE1    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
