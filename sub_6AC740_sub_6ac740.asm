...
006AC745    push 0x76FA65                                   ; => [ Call: __ehhandler$??$__acrt_lock_and_call@V<lambda_76b7ce3881063c72d9d9c3f590a24f96>@@@@YAHW4__acrt_lock_id@@$$QAV<lambda_76b7ce3881063c72d9d9c3f590a24f96>@@@Z | Type: EHRegistrationNode ]
006AC74A    mov eax, dword ptr fs:[0x00000000]
006AC750    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006AC75E    push eax                                        ; => [ Data: __security_cookie ]
006AC75F    lea eax, ss:[ebp-0x0C]
006AC762    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006AC768    push 0x10
006AC76A    push 0x50
...
006AC78E    call 0x0069CA80                                 ; => [ Call: sub_69ca80 | Data: data_17774e8 ]
006AC793    mov ecx, dword ptr ss:[ebp+0x0C]
006AC796    mov edx, dword ptr ds:[0x017774E4]
006AC79C    mov ecx, dword ptr ds:[ecx+0x04]
006AC79F    call 0x006A4880                                 ; => [ Call: sub_6a4880 | Data: data_17774e4 ]
...
006AC7B6    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
006AC7BB    lea ecx, ss:[ebp-0x10]
006AC7BE    call 0x0063E330                                 ; => [ Call: sub_63e330 ]
006AC7C3    mov byte ptr ss:[ebp-0x04], 0x01
006AC7C7    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
006AC7CC    mov eax, dword ptr ss:[ebp-0x10]
006AC7CF    mov ecx, ebx                                    ; => [ Data: data_801800 ]
006AC7D1    test eax, eax
006AC7D3    push 0x07
006AC7D5    cmovnz ecx, eax
006AC7D8    push 0x87B728                                   ; => [ String: skybox_ ]
006AC7DD    push ecx
...
006AC7F5    push 0x87B71C                                   ; => [ String: cubemap_ ]
006AC7FA    push ebx
...
006AC822    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AC83D    mov bl, al                                      ; => [ Call: sub_6ac5c0 ]
006AC83F    call 0x0069CEE0                                 ; => [ Call: sub_69cee0 | Data: data_17774e4 ]
006AC844    test bl, bl
...
006AC868    jz 0x006AC898                                   ; => [ Data: data_cf65bc ]
...
006AC879    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AC88C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AC891    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006AC898    mov dword ptr ss:[ebp-0x04], 0x03
006AC89F    cmp dword ptr ds:[0x00CF65BC], 0x00
006AC8A6    jz 0x006AC8CF                                   ; => [ Data: data_cf65bc ]
...
006AC8B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006AC8CA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006AC8CF    mov al, bl
006AC8D1    mov ecx, dword ptr ss:[ebp-0x0C]
006AC8D4    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006AC8DB    pop ecx
006AC8DC    pop edi
006AC8DD    pop esi
006AC8DE    pop ebx
...
006AC8E1    pop ebp
006AC8E2    ret
006AC8E3    push 0x8770A0                                   ; => [ String: XMalloc ]
006AC8E8    push 0x57
006AC8EA    push 0x877080                                   ; => [ String: C:\x\ax2017\Engine\xMemory.cpp ]
006AC8EF    mov edx, 0x801800
006AC8F4    mov ecx, 0x8770C8
006AC8F9    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: pBuffer ]
006AC8FE    add esp, 0x0C
006AC901    call 0x0063BC30
006AC906    test al, al
006AC908    jz 0x006AC90B                                   ; => [ Call: sub_63bc30 ]
006AC90A    int3
006AC90B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006AC910    push 0x871DD4                                   ; => [ String: XString::XString ]
006AC915    push 0x94
006AC91A    push 0x871D5C
006AC91F    mov edx, 0x801800
006AC924    mov ecx, 0x871E0C
006AC929    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: str | String: C:\x\ax2017\Engine\xString.cpp ]
006AC92E    add esp, 0x0C
006AC931    call 0x0063BC30
006AC936    test al, al
006AC938    jz 0x006AC93B                                   ; => [ Call: sub_63bc30 ]
006AC93A    int3
006AC93B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
