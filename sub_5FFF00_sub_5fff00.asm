...
005FFF08    call 0x00761E50
005FFF0D    mov eax, dword ptr ds:[0x008C4040]
005FFF12    xor eax, ebp
005FFF14    mov dword ptr ss:[ebp-0x08], eax
005FFF17    push ebx
005FFF18    push esi
005FFF19    push edi
