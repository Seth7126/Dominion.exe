...
00758BD0    mov eax, dword ptr ds:[0x0147DED8]              ; => [ Data: data_147ded8 ]
00758BD5    push esi
00758BD6    push edi
...
00758BE4    push 0x30
00758BE6    call eax                                        ; => [ String: C:\x\ax2017\Engine\ExternalCode\spine-c\src\spine\BoundingBoxAttachment.c ]
00758BE8    add esp, 0x0C
00758BEB    jmp 0x00758BF8
00758BED    push 0x30
00758BEF    call dword ptr ds:[0x00800B4C]                  ; => [ Call: malloc ]
00758BF5    add esp, 0x04
00758BF8    mov esi, eax
00758BFA    test esi, esi
00758BFC    jz 0x00758C43
00758BFE    mov dword ptr ds:[esi], 0x00                    ; => [ Call: __builtin_memset ]
