...
004FD48B    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FD490    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
004FD4B3    call 0x005685F0                                 ; => [ Call: sub_5685f0 ]
004FD4B8    xorps xmm0, xmm0
004FD4BB    mov dword ptr ss:[esp+0x38], 0x00
004FD4C3    add esp, 0x0C
004FD4C6    movlpd qword ptr ss:[esp+0x24], xmm0            ; => [ Call: __builtin_memset ]
...
004FD51C    push 0x00
004FD51E    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
004FD539    call 0x00563C40                                 ; => [ Call: sub_563c40 ]
...
004FD559    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: nullptr ]
004FD55D    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FD576    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FD5B7    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
004FD5BC    add esp, 0x38
004FD5BF    mov ecx, dword ptr ss:[esp+0x199C]
004FD5C6    pop edi
004FD5C7    pop esi
004FD5C8    xor ecx, esp
004FD5CA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
