...
0076BED3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076BED8    mov ecx, dword ptr ds:[edx-0x08]
0076BEDB    xor ecx, eax
0076BEDD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076BEE2    mov eax, 0x8B7EB8
0076BEE7    jmp 0x00761FA6                                  ; => [ Data: data_8b7eb8 | Call: __CxxFrameHandler3 ]
