...
0052DA90    dword 4596BE8                                   ; => [ Call: sub_573400 ]
...
0052DAA1    push 0x02
0052DAA3    call 0x00590760                                 ; => [ Call: sub_590760 ]
0052DAA8    add esp, 0x10
0052DAAB    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0052DACF    call 0x00563590                                 ; => [ Call: sub_563590 ]
0052DAD4    mov esi, eax
0052DAD6    test esi, esi
0052DAD8    jz 0x0052DB00
0052DADA    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052DADF    push 0x04
0052DAE1    push 0x00
0052DAE3    push 0x00
...
0052DAF2    push 0x476
0052DAF7    push esi
0052DAF8    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
...
0052DB18    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0052DB1D    add esp, 0x0C
0052DB20    call 0x0063BC30
0052DB25    test al, al
0052DB27    jz 0x0052DB2A                                   ; => [ Call: sub_63bc30 ]
0052DB29    int3
0052DB2A    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
