...
00693375    push 0x7656A0                                   ; => [ Call: __ehhandler$?MainCppEH@@YGHPBGP6GHHQAPAG@ZH1@Z | Type: EHRegistrationNode ]
0069337A    mov eax, dword ptr fs:[0x00000000]
00693380    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0069338E    push eax                                        ; => [ Data: __security_cookie ]
0069338F    lea eax, ss:[ebp-0x0C]
00693392    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006933DA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006933ED    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006933F2    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
006933F8    mov edx, 0x24
006933FD    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00693404    mov ecx, esi
00693406    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0069342F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00693436    pop ecx
00693437    pop edi
00693438    pop esi
00693439    pop ebx
