...
00666A57    mov ecx, dword ptr ds:[0x00C27C20]
00666A5D    test ecx, ecx
00666A5F    jnz 0x00666A7A
00666A61    push 0x874440
00666A66    push 0xC16
00666A6B    mov edx, 0x874424
00666A70    mov ecx, 0x874470
00666A75    jmp 0x00666B61
00666A7A    cmp dword ptr ds:[ecx+0x04], 0x22
00666A7E    jz 0x00666A94
00666A80    push 0x874440
00666A85    push 0xC17
00666A8A    mov ecx, 0x87444C
00666A8F    jmp 0x00666B5C
00666A94    call 0x005AF880
...
00666AEE    movss dword ptr ds:[esi+0x0C], xmm0
...
00666B17    movss dword ptr ds:[esi+0x08], xmm0
...
00666B4B    pop ebp
00666B4C    ret
00666B4D    push 0x8757FC
00666B52    push 0x3841
00666B57    mov ecx, 0x801AA4
00666B5C    mov edx, 0x801800
00666B61    push 0x8739B4
00666B66    call 0x0063B870
00666B6B    add esp, 0x0C
00666B6E    call 0x0063BC30
00666B73    test al, al
00666B75    jz 0x00666B78
00666B77    int3
00666B78    call 0x0063BB00
