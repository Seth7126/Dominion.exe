...
006EDED8    push 0x771CCB                                   ; => [ Type: EHRegistrationNode | Call: sub_771ccb ]
006EDEDD    mov eax, dword ptr fs:[0x00000000]
006EDEE3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006EDEE4    push ebx
...
006EDEF5    push esi
006EDEF6    push edi
006EDEF7    push eax                                        ; => [ Data: __security_cookie ]
006EDEF8    lea eax, ss:[ebp-0x0C]
006EDEFB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006EDF13    mov dword ptr ss:[ebp-0x2F0], 0x801800          ; => [ Data: data_801800 ]
006EDF1D    push 0x100
006EDF22    lea eax, ss:[ebp-0x2EC]
006EDF28    mov dword ptr ss:[ebp-0x04], 0x00
006EDF2F    push 0x00
006EDF31    push eax
006EDF32    call 0x00761FC4                                 ; => [ Call: memset ]
006EDF37    add esp, 0x0C
006EDF3A    lea eax, ss:[ebp-0x2EC]
006EDF40    push 0x4D6960                                   ; => [ Call: sub_4d6960 | Type: _EXCEPTION_REGISTRATION_RECORD ]
006EDF45    push 0x4D6950
006EDF4A    push 0x20
006EDF4C    push 0x08
006EDF4E    push eax
006EDF4F    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' | Call: sub_4d6950 ]
006EDF54    push 0x40
006EDF56    lea eax, ss:[ebp-0x1E8]
006EDF5C    mov dword ptr ss:[ebp-0x1EC], 0x00
006EDF66    push 0x00
006EDF68    push eax
006EDF69    call 0x00761FC4                                 ; => [ Call: memset ]
006EDF6E    add esp, 0x0C
006EDF71    mov dword ptr ss:[ebp-0x1A8], 0x00              ; => [ Call: __builtin_memset ]
...
006EDF9A    push 0x00
006EDF9C    push eax
006EDF9D    call 0x00761FC4                                 ; => [ Call: memset ]
006EDFA2    add esp, 0x0C
006EDFA5    lea eax, ss:[ebp-0xD0]
006EDFAB    push 0x80
006EDFB0    push 0x00
006EDFB2    push eax
006EDFB3    call 0x00761FC4                                 ; => [ Call: memset ]
006EDFB8    xorps xmm0, xmm0
006EDFBB    mov dword ptr ss:[ebp-0x50], 0x00               ; => [ Call: __builtin_memset ]
...
006EE029    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EE03C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EE041    mov dword ptr ss:[ebp-0x2F8], 0x801800          ; => [ Data: data_801800 ]
006EE04B    lea ecx, ss:[ebp-0x2F0]
006EE051    mov byte ptr ss:[ebp-0x04], 0x01
006EE055    call 0x006ED9A0                                 ; => [ Call: sub_6ed9a0 ]
...
006EE075    movups xmmword ptr ss:[ebp-0x34], xmm0          ; => [ Call: __builtin_memset ]
...
006EE08C    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
006EE0BC    mov dword ptr ds:[esi+0x10], eax                ; => [ Call: sub_6d8b40 ]
...
006EE0D5    push eax
006EE0D6    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4d6960 ]
006EE0DB    mov byte ptr ss:[ebp-0x04], 0x04
006EE0DF    cmp dword ptr ds:[0x00CF65BC], 0x00
006EE0E6    jz 0x006EE115                                   ; => [ Data: data_cf65bc ]
...
006EE0FD    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EE110    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EE115    mov eax, dword ptr ds:[esi+0x10]
006EE118    mov ecx, dword ptr ss:[ebp-0x0C]
006EE11B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006EE122    pop ecx
006EE123    pop edi
006EE124    pop esi
006EE125    mov ecx, dword ptr ss:[ebp-0x14]
006EE128    xor ecx, ebp
006EE12A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006EE14F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: results.numSamplers <= NUM_DIFFUSE | String: C:\x\ax2017\Engine\MaterialFnDef.cpp | String: MakeMaterial | Data: data_801800 ]
006EE154    add esp, 0x0C
006EE157    call 0x0063BC30
006EE15C    test al, al
006EE15E    jz 0x006EE161                                   ; => [ Call: sub_63bc30 ]
006EE160    int3
006EE161    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
