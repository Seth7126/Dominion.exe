...
00528376    call 0x00761E50
0052837B    mov eax, dword ptr ds:[0x008C4040]
00528380    xor eax, ebp
...
0052838C    mov dword ptr fs:[0x00000000], eax
00528392    lea eax, ss:[ebp-0xC98]
00528398    mov ecx, 0x3EC
0052839D    push eax
0052839E    call 0x00568780
...
00528416    mov dword ptr ss:[ebp-0x1950], 0x818458
00528420    mov dword ptr ss:[ebp-0x192C], eax
...
00528497    setnz al
0052849A    push eax
0052849B    call dword ptr ds:[edx+0x10]
...
005284BF    mov ebx, dword ptr ds:[eax+0x04]
005284C2    cmp esi, 0x320
005284C8    jb 0x005284CF
005284CA    call 0x00591930
...
00528526    call 0x0056C1B0
0052852B    add esp, 0x0C
0052852E    mov ecx, dword ptr ss:[ebp-0x0C]
00528531    mov dword ptr fs:[0x00000000], ecx
00528538    pop ecx
00528539    pop edi
0052853A    pop esi
0052853B    pop ebx
