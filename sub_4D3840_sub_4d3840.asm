...
004D3861    mov dword ptr fs:[0x00000000], eax
...
004D3875    call 0x0063D720
004D387A    mov eax, dword ptr ss:[ebp+0x08]
004D387D    mov ecx, 0x801800
...
004D38C3    jz 0x004D38E7
004D38C5    lea ecx, ss:[ebp+0x08]
004D38C8    call 0x0063D4E0
...
004D38DB    call 0x0064C080
004D38E0    mov dword ptr ss:[ebp+0x08], 0x801800
004D38E7    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004D38EE    test esi, esi
004D38F0    jnz 0x004D3A35
004D38F6    mov esi, dword ptr ds:[0x00CC8D5C]
...
004D3918    push 0x8053FC
004D391D    push 0x2DDC
004D3922    push 0x80292C
004D3927    mov ecx, 0x801AA4
...
004D3970    call 0x004B0E60
004D3975    mov esi, dword ptr ds:[0x00CC8D5C]
...
004D399E    call 0x004D46E0
004D39A3    xor al, al
004D39A5    mov ecx, dword ptr ss:[ebp-0x0C]
004D39A8    mov dword ptr fs:[0x00000000], ecx
004D39AF    pop ecx
004D39B0    pop edi
004D39B1    pop esi
...
004D39D1    call 0x004D46E0
004D39D6    mov eax, dword ptr ds:[0x00CC8D5C]
004D39DB    mov dword ptr ss:[ebp+0x08], 0x00
...
004D39EF    mov ecx, dword ptr ds:[0x0147ABF4]
...
004D3A46    pop ebp
004D3A47    ret
004D3A48    push 0x77EB90
004D3A4D    push 0x7B
004D3A4F    mov ecx, 0x77EB9C
004D3A54    push 0x77EB50
004D3A59    mov edx, 0x801800
004D3A5E    call 0x0063B870
004D3A63    add esp, 0x0C
004D3A66    call 0x0063BC30
004D3A6B    test al, al
004D3A6D    jz 0x004D3A70
004D3A6F    int3
004D3A70    call 0x0063BB00
