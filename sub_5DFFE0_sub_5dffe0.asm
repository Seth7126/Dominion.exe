...
005DFFE5    push 0x769E10                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?_Handle_message@?$source_block@V?$multi_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@V?$ordered_message_processor@I@2@@Concurrency@@AAEXPAV?$message@I@2@@Z ]
005DFFEA    mov eax, dword ptr fs:[0x00000000]
005DFFF0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005DFFFE    push eax                                        ; => [ Data: __security_cookie ]
005DFFFF    lea eax, ss:[ebp-0x0C]
005E0002    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
005E0022    mov eax, dword ptr ds:[eax+edx*4]               ; => [ Data: data_be3598 | Data: data_be359c ]
...
005E004B    call 0x005DFEB0                                 ; => [ Call: sub_5dfeb0 ]
...
005E006A    lea edx, ds:[eax*4]                             ; => [ Data: data_be359c ]
005E0071    mov eax, dword ptr ds:[0x00BE3598]
005E0076    mov dword ptr ss:[ebp-0x10], edx
005E0079    mov esi, dword ptr ds:[edx+eax*1]               ; => [ Data: data_be3598 ]
...
005E0094    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
005E00A5    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
005E00CE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E00EB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E010E    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005E0121    mov dword ptr ds:[edi+0x14], eax                ; => [ Data: data_be3598 ]
005E0124    mov eax, dword ptr ds:[0x00BE3598]
005E0129    mov dword ptr ds:[ecx+eax*1], edi               ; => [ Data: data_be3598 ]
005E012C    inc dword ptr ds:[0x00BE35A0]                   ; => [ Data: data_be35a0 ]
...
005E014A    mov eax, dword ptr ds:[eax+ecx*4]               ; => [ Data: data_be3598 | Data: data_be359c ]
...
005E015C    xor esi, esi                                    ; => [ Call: nullptr ]
005E015E    lea ecx, ss:[ebp-0x24]
005E0161    call 0x005DFDB0                                 ; => [ Call: sub_5dfdb0 ]
005E0166    mov eax, esi
005E0168    mov ecx, dword ptr ss:[ebp-0x0C]
005E016B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005E0172    pop ecx
005E0173    pop edi
005E0174    pop esi
005E0175    pop ebx
...
005E0181    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
005E0186    lea eax, ss:[ebp-0x20]
005E0189    push eax
005E018A    lea ecx, ds:[esi+0x08]
005E018D    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
005E019E    push eax
005E019F    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
005E01A4    jmp 0x005E0132
005E01A6    lea esi, ds:[eax+0x04]
005E01A9    jmp 0x005E015E
