...
0053EC38    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
0053EC3D    mov eax, dword ptr fs:[0x00000000]
0053EC43    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053EC44    push ebx
0053EC45    mov eax, 0x19A8
0053EC4A    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053EC4F    mov eax, dword ptr ds:[0x008C4040]
0053EC54    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0053EC56    mov dword ptr ss:[ebp-0x14], eax
0053EC59    push esi
0053EC5A    push edi
0053EC5B    push eax
0053EC5C    lea eax, ss:[ebp-0x0C]
0053EC5F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053EC65    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053EC6A    lea ecx, ss:[ebp-0x19B8]
0053EC70    push 0x04
0053EC72    push ecx
0053EC73    mov edx, dword ptr ds:[eax+0x0C]
0053EC76    mov ecx, dword ptr ds:[eax+0x04]
0053EC79    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
0053EC7E    mov ecx, 0x321
0053EC83    mov dword ptr ss:[ebp-0xD38], eax
0053EC89    lea esi, ss:[ebp-0x19B8]
0053EC8F    mov dword ptr ss:[ebp-0xD00], 0x81ADA0          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ea00ec32309e4126f9025a45d9b3c850>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_ea00ec32309e4126f9025a45d9b3c850>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0053EC99    lea edi, ss:[ebp-0xCA0]
0053EC9F    add esp, 0x08
0053ECA2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0053ECA4    lea ecx, ss:[ebp-0xD00]
0053ECAA    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_ea00ec32309e4126f9025a45d9b3c850>,bool,enum CardID>::VTable ]
...
0053ECEB    call eax
0053ECED    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
0053ED13    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
0053ED2A    push eax
0053ED2B    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0053ED2E    xorps xmm0, xmm0
0053ED31    mov dword ptr ss:[ebp-0xCCC], 0x00
0053ED3B    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
0053EDDF    push 0x476
0053EDE4    push esi
0053EDE5    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
0053EDEA    add esp, 0x1C
0053EDED    sub esp, 0x28
0053EDF0    mov eax, esp
0053EDF2    mov dword ptr ds:[eax], 0x81AD84                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_a7c8a1f8a9b1c26d873d0449c05ce8b7>, void>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_a7c8a1f8a9b1c26d873d0449c05ce8b7>, void>::`vftable'{for `std::_Func_base<void>'} ]
0053EDF8    mov dword ptr ds:[eax+0x24], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_a7c8a1f8a9b1c26d873d0449c05ce8b7>, void>::VTable ]
0053EDFB    call 0x005699B0                                 ; => [ Call: sub_5699b0 ]
0053EE00    add esp, 0x28
0053EE03    mov ecx, dword ptr ss:[ebp-0x0C]
0053EE06    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053EE0D    pop ecx
0053EE0E    pop edi
0053EE0F    pop esi
0053EE10    mov ecx, dword ptr ss:[ebp-0x14]
0053EE13    xor ecx, ebp
0053EE15    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
