...
006F4FB5    push 0x771FFD                                   ; => [ Call: sub_771ffd | Type: EHRegistrationNode ]
006F4FBA    mov eax, dword ptr fs:[0x00000000]
006F4FC0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006F4FCF    push esi
006F4FD0    push edi
006F4FD1    push eax                                        ; => [ Data: __security_cookie ]
006F4FD2    lea eax, ss:[ebp-0x0C]
006F4FD5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006F4FED    push eax
006F4FEE    push 0x875F38                                   ; => [ String: %f %f %f ]
006F4FF3    push dword ptr ds:[ebx]
006F4FF5    call 0x0064B6D0                                 ; => [ Call: sub_64b6d0 ]
...
006F5098    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006F50AB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006F50B0    mov eax, dword ptr ds:[edi]
006F50B2    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006F50B7    test eax, eax
006F50B9    cmovnz ecx, eax
006F50BC    mov dword ptr ds:[ebx], ecx
006F50BE    mov ecx, dword ptr ss:[ebp-0x0C]
006F50C1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006F50C8    pop ecx
006F50C9    pop edi
006F50CA    pop esi
006F50CB    pop ebx
...
006F50D1    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
