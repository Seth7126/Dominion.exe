...
0069EB38    push esi
0069EB39    push edi
0069EB3A    jnz 0x0069EC28                                  ; => [ Data: data_147ac2c ]
0069EB40    mov ecx, 0x28
0069EB45    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0069EB56    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0069EB90    mov dword ptr ds:[esi], 0x00                    ; => [ Call: __builtin_memset ]
0069EB96    mov dword ptr ds:[esi+0x04], 0x00
0069EB9D    mov dword ptr ds:[esi+0x08], 0x00
0069EBA4    mov dword ptr ds:[0x0147AC2C], esi              ; => [ Data: data_147ac2c ]
...
0069EBC6    call 0x00687730                                 ; => [ Call: sub_687730 ]
...
0069EBF0    mov esi, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
0069EBF6    cmp dword ptr ds:[esi], 0x00
0069EBF9    jnz 0x0069EC2C
0069EBFB    mov ecx, 0x1000
0069EC00    call 0x0064C020
0069EC05    mov dword ptr ds:[esi], eax                     ; => [ Call: sub_64c020 ]
0069EC07    mov eax, dword ptr ds:[0x0147AC2C]              ; => [ Data: data_147ac2c ]
...
0069EC42    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\xMap.h | String: mNodeBuckets == NULL | String: XMap<class XString,struct XAsset *>::SetNumBuckets ]
0069EC47    add esp, 0x0C
0069EC4A    call 0x0063BC30
0069EC4F    test al, al
0069EC51    jz 0x0069EC54                                   ; => [ Call: sub_63bc30 ]
0069EC53    int3
0069EC54    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
