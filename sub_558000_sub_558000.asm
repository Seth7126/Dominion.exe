...
00558010    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00558011    mov eax, 0x25FC
00558016    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055801B    mov eax, dword ptr ds:[0x008C4040]
00558020    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
0055802C    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00558032    xorps xmm0, xmm0
00558035    mov dword ptr ss:[ebp-0xCA0], 0x104
0055803F    movlpd qword ptr ss:[ebp-0xCA8], xmm0
00558047    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005580DA    push esi
005580DB    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
005580FD    mov ebx, eax                                    ; => [ Call: GSI1::OffForSym ]
...
00558183    push esi
00558184    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
005581A6    mov ebx, eax                                    ; => [ Call: GSI1::OffForSym ]
...
005581C2    push eax
005581C3    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
005581C6    push 0x3C
005581C8    push 0x06
005581CA    push 0x0F
...
0055822C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
