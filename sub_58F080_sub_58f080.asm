...
0058F08D    mov edi, dword ptr ds:[0x00CCE9C4]
...
0058F0FD    mov edx, dword ptr ds:[0x00CCE9B8]
...
0058F113    mov dword ptr ds:[0x00CCE9B8], eax
...
0058F127    mov dword ptr ds:[eax+ecx*4+0x28], ebx
0058F12B    mov eax, dword ptr ds:[0x00CCE9C4]
0058F130    movups xmmword ptr ds:[eax+ecx*4+0x2C], xmm0
0058F135    movups xmmword ptr ds:[eax+ecx*4+0x3C], xmm0
0058F13A    movups xmmword ptr ds:[eax+ecx*4+0x4C], xmm0
0058F13F    movq qword ptr ds:[eax+ecx*4+0x5C], xmm0
0058F145    mov ecx, ebx
0058F147    call 0x0058E890
0058F14C    pop edi
0058F14D    pop esi
0058F14E    mov al, 0x01
0058F150    pop ebx
0058F151    ret
0058F152    push 0x820720
0058F157    push 0x45E3
0058F15C    mov ecx, 0x82073C
0058F161    push 0x81F4B8
0058F166    mov edx, 0x801800
0058F16B    call 0x0063B870
0058F170    add esp, 0x0C
0058F173    call 0x0063BC30
0058F178    test al, al
0058F17A    jz 0x0058F17D
0058F17C    int3
0058F17D    call 0x0063BB00
