...
00555F86    call 0x00761E50
00555F8B    mov eax, dword ptr ds:[0x008C4040]
00555F90    xor eax, ebp
00555F92    mov dword ptr ss:[ebp-0x10], eax
00555F95    push esi
00555F96    push edi
00555F97    push eax
00555F98    lea eax, ss:[ebp-0x0C]
00555F9B    mov dword ptr fs:[0x00000000], eax
00555FA1    call 0x00573400
00555FA6    push 0x00
00555FA8    push 0x00
00555FAA    push 0x01
...
00555FB2    push 0x01
00555FB4    call 0x00590760
00555FB9    add esp, 0x10
00555FBC    call 0x00573400
...
00556083    movlpd qword ptr ss:[ebp-0xD78], xmm0
...
005561AE    mov edi, dword ptr ds:[eax+0x0C]
005561B1    call 0x00573400
005561B6    xor ecx, ecx
005561B8    mov eax, dword ptr ds:[eax+0x04]
...
00556215    mov dword ptr ss:[ebp-0x70], 0x81DB78
0055621C    mov dword ptr ss:[ebp-0x40], 0x81DB5C
00556223    mov dword ptr ss:[ebp-0x18], 0x8D
0055622A    mov dword ptr ss:[ebp-0x04], ecx
0055622D    push 0x200
00556232    push 0xCCE9D8
00556237    push 0x01
00556239    push 0x01
0055623B    push 0x02
0055623D    lea edx, ss:[ebp-0x70]
00556240    or ecx, 0xFFFFFFFF
00556243    call 0x0056A100
00556248    lea eax, ss:[ebp-0x70]
0055624B    jmp 0x005562E4
00556250    mov dword ptr ss:[ebp-0x70], 0x81DB40
00556257    mov dword ptr ss:[ebp-0x40], 0x81DB24
...
0055627C    mov dword ptr ss:[ebp-0xD0], 0x81DB08
00556286    mov dword ptr ss:[ebp-0xAC], eax
0055628C    lea eax, ss:[ebp-0xA0]
00556292    mov dword ptr ss:[ebp-0xA8], 0x8E
0055629C    mov dword ptr ss:[ebp-0xA4], ecx
005562A2    mov dword ptr ss:[ebp-0xA0], 0x81DAEC
005562AC    mov dword ptr ss:[ebp-0x7C], eax
005562AF    mov dword ptr ss:[ebp-0x78], 0x8D
005562B6    mov dword ptr ss:[ebp-0x74], ecx
005562B9    push 0x200
005562BE    push 0xCCE9D8
005562C3    push 0x01
005562C5    push 0x01
005562C7    push 0x02
...
0055632E    call 0x0063B870
00556333    add esp, 0x0C
00556336    call 0x0063BC30
0055633B    test al, al
0055633D    jz 0x00556340
0055633F    int3
00556340    call 0x0063BB00
