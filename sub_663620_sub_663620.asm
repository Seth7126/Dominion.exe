...
00663625    push 0x763980                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$___std_smf_legendref@8 ]
0066362A    mov eax, dword ptr fs:[0x00000000]
00663630    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00663631    push ecx
00663632    push esi
00663633    mov eax, dword ptr ds:[0x008C4040]
00663638    xor eax, ebp
0066363A    push eax                                        ; => [ Data: __security_cookie ]
0066363B    lea eax, ss:[ebp-0x0C]
0066363E    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00663644    mov esi, ecx
00663646    mov dword ptr ss:[ebp-0x04], 0x00
0066364D    mov eax, dword ptr ds:[0x00CF65BC]              ; => [ Data: data_cf65bc ]
...
00663668    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0066366D    mov eax, dword ptr ds:[0x00CF65BC]              ; => [ Data: data_cf65bc ]
...
00663691    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006636A4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006636A9    mov dword ptr ds:[esi], 0x801800                ; => [ Data: data_801800 ]
006636AF    mov ecx, dword ptr ss:[ebp-0x0C]
006636B2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006636B9    pop ecx
006636BA    pop esi
