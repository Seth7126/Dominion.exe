...
0062CFD5    push 0x76BBED                                   ; => [ Call: sub_76bbed | Type: EHRegistrationNode ]
0062CFDA    mov eax, dword ptr fs:[0x00000000]
0062CFE0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0062CFEE    push eax                                        ; => [ Data: __security_cookie ]
0062CFEF    lea eax, ss:[ebp-0x0C]
0062CFF2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0062D00F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0062D014    inc dword ptr ds:[eax+0x04]
0062D017    mov dword ptr ss:[ebp-0x04], 0x00
0062D01E    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
0062D025    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
0062D02C    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
0062D04D    test al, al
0062D04F    jz 0x0062D1D5                                   ; => [ Call: sub_62cb50 ]
...
0062D079    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D09E    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0062D0B3    jz 0x0062D0D7                                   ; => [ Data: data_cf65bc ]
0062D0B5    lea ecx, ss:[ebp-0x2C]
0062D0B8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D0CB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062D0D0    mov dword ptr ss:[ebp-0x2C], 0x801800           ; => [ Data: data_801800 ]
...
0062D0ED    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D112    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0062D12B    jz 0x0062D14F                                   ; => [ Data: data_cf65bc ]
0062D12D    lea ecx, ss:[ebp-0x34]
0062D130    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D143    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062D148    mov dword ptr ss:[ebp-0x34], 0x801800           ; => [ Data: data_801800 ]
0062D14F    test esi, esi
0062D151    mov byte ptr ss:[ebp-0x04], 0x03
0062D155    mov edi, dword ptr ss:[ebp-0x14]
0062D158    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0062D15D    cmovnz ecx, esi
0062D160    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
0062D17E    jz 0x0062D19B                                   ; => [ Data: data_cf65bc ]
0062D180    lea ecx, ss:[ebp-0x10]
0062D183    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D196    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0062D1AC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D1C2    call 0x0062CB50                                 ; => [ Call: sub_62cb50 ]
...
0062D1EB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D207    inc ebx
0062D208    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0062D21D    jz 0x0062D23A                                   ; => [ Data: data_cf65bc ]
0062D21F    lea ecx, ss:[ebp-0x34]
0062D222    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D235    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062D23A    mov byte ptr ss:[ebp-0x04], 0x0A
0062D23E    cmp dword ptr ds:[0x00CF65BC], 0x00
0062D245    jz 0x0062D26E                                   ; => [ Data: data_cf65bc ]
...
0062D256    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D269    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062D26E    mov byte ptr ss:[ebp-0x04], 0x0B
0062D272    cmp dword ptr ds:[0x00CF65BC], 0x00
0062D279    jz 0x0062D2A2                                   ; => [ Data: data_cf65bc ]
...
0062D28A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D29D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062D2A2    mov byte ptr ss:[ebp-0x04], 0x0C
0062D2A6    cmp dword ptr ds:[0x00CF65BC], 0x00
0062D2AD    jz 0x0062D2D6                                   ; => [ Data: data_cf65bc ]
...
0062D2BE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D2D1    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0062D2ED    jz 0x0062D30A                                   ; => [ Data: data_cf65bc ]
0062D2EF    lea ecx, ss:[ebp-0x10]
0062D2F2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0062D305    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062D30A    mov eax, ebx
0062D30C    mov ecx, dword ptr ss:[ebp-0x0C]
0062D30F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0062D316    pop ecx
0062D317    pop edi
0062D318    pop esi
0062D319    pop ebx
