...
00544117    call 0x00589750
0054411C    push ecx
0054411D    mov ecx, esp
0054411F    mov esi, eax
00544121    mov dword ptr ds:[ecx], 0x81B9FC
00544127    mov dword ptr ds:[ecx+0x04], esi
0054412A    mov dword ptr ds:[ecx+0x24], ecx
0054412D    call 0x005699B0
00544132    add esp, 0x28
00544135    mov dword ptr ss:[esp+0x04], esi
00544139    call 0x00573400
0054413E    push 0x08
00544140    push 0x3E9
00544145    push ecx
