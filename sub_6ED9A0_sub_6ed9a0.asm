...
006ED9A5    push 0x771C85                                   ; => [ Type: EHRegistrationNode | Call: sub_771c85 ]
006ED9AA    mov eax, dword ptr fs:[0x00000000]
006ED9B0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006ED9BE    push eax                                        ; => [ Data: __security_cookie ]
006ED9BF    lea eax, ss:[ebp-0x0C]
006ED9C2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006ED9C8    mov edi, ecx
006ED9CA    mov dword ptr ss:[ebp-0x14], edi
006ED9CD    mov dword ptr ss:[ebp-0x20], 0x801800           ; => [ Data: data_801800 ]
006ED9D4    mov dword ptr ss:[ebp-0x04], 0x00
006ED9DB    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
...
006EDA4A    mov ecx, ebx                                    ; => [ Data: data_801800 ]
006EDA4C    mov eax, dword ptr ds:[eax]                     ; => [ String: uniform sampler texDiffuse;\n | Call: sub_63df30 ]
006EDA4E    test eax, eax
006EDA50    cmovnz ecx, eax
006EDA53    push ecx
006EDA54    lea ecx, ss:[ebp-0x10]
006EDA57    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006EDA5C    mov byte ptr ss:[ebp-0x04], 0x03
006EDA60    cmp dword ptr ds:[0x00CF65BC], esi
006EDA66    jz 0x006EDB07                                   ; => [ Data: data_cf65bc ]
...
006EDA83    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDA96    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDA9B    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
...
006EDABA    mov ecx, ebx                                    ; => [ Data: data_801800 ]
006EDABC    mov eax, dword ptr ds:[eax]                     ; => [ String: uniform sampler texDiffuse%d;\n | Call: sub_63df30 ]
006EDABE    test eax, eax
006EDAC0    cmovnz ecx, eax
006EDAC3    push ecx
006EDAC4    lea ecx, ss:[ebp-0x10]
006EDAC7    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006EDACC    mov byte ptr ss:[ebp-0x04], 0x05
006EDAD0    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDAD7    jz 0x006EDB07                                   ; => [ Data: data_cf65bc ]
...
006EDAE8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDAFB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDB00    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
006EDB07    inc esi
006EDB08    mov byte ptr ss:[ebp-0x04], 0x01
006EDB0C    cmp esi, dword ptr ds:[edi+0x15C]
006EDB12    jl 0x006EDA30
006EDB18    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006EDB1D    mov dword ptr ss:[ebp-0x1C], edi                ; => [ Data: data_801800 ]
...
006EDB47    mov ecx, ebx                                    ; => [ Data: data_801800 ]
006EDB49    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: uniform float3x3 gTexAnim%d;\n ]
006EDB4B    test eax, eax
006EDB4D    cmovnz ecx, eax
006EDB50    push ecx
006EDB51    lea ecx, ss:[ebp-0x1C]
006EDB54    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006EDB59    mov byte ptr ss:[ebp-0x04], 0x08
006EDB5D    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDB64    jz 0x006EDB94                                   ; => [ Data: data_cf65bc ]
...
006EDB75    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDB88    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDB8D    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
...
006EDBA7    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006EDBAC    mov dword ptr ss:[ebp-0x2C], esi                ; => [ Data: data_801800 ]
...
006EDBD6    mov ecx, ebx                                    ; => [ Data: data_801800 ]
006EDBD8    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: uniform float4 gMaterialColor%d;\n ]
006EDBDA    test eax, eax
006EDBDC    cmovnz ecx, eax
006EDBDF    push ecx
006EDBE0    lea ecx, ss:[ebp-0x2C]
006EDBE3    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
006EDBE8    mov byte ptr ss:[ebp-0x04], 0x0B
006EDBEC    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDBF3    jz 0x006EDC23                                   ; => [ Data: data_cf65bc ]
...
006EDC04    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDC17    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDC1C    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
...
006EDCB1    push ecx
006EDCB2    mov eax, 0x801800                               ; => [ Data: data_801800 ]
...
006EDD06    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDD19    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDD1E    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
006EDD25    mov byte ptr ss:[ebp-0x04], 0x11
006EDD29    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDD30    jz 0x006EDD59                                   ; => [ Data: data_cf65bc ]
...
006EDD41    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDD54    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDD59    mov byte ptr ss:[ebp-0x04], 0x12
006EDD5D    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDD64    jz 0x006EDD8D                                   ; => [ Data: data_cf65bc ]
...
006EDD75    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDD88    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDD8D    mov byte ptr ss:[ebp-0x04], 0x13
006EDD91    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDD98    jz 0x006EDDC1                                   ; => [ Data: data_cf65bc ]
...
006EDDA9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDDBC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006EDDD5    jz 0x006EDDF2                                   ; => [ Data: data_cf65bc ]
006EDDD7    lea ecx, ss:[ebp-0x2C]
006EDDDA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDDED    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006EDE06    jz 0x006EDE23                                   ; => [ Data: data_cf65bc ]
006EDE08    lea ecx, ss:[ebp-0x1C]
006EDE0B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDE1E    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDE23    mov byte ptr ss:[ebp-0x04], 0x16
006EDE27    cmp dword ptr ds:[0x00CF65BC], 0x00
006EDE2E    jz 0x006EDE57                                   ; => [ Data: data_cf65bc ]
...
006EDE3F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDE76    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006EDE89    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006EDE8E    mov eax, ebx
006EDE90    mov ecx, dword ptr ss:[ebp-0x0C]
006EDE93    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006EDE9A    pop ecx
006EDE9B    pop edi
006EDE9C    pop esi
006EDE9D    pop ebx
