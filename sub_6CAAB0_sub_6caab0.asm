...
006CAACF    mov esi, dword ptr ds:[0x0147D19C]
...
006CAB4C    mov byte ptr ds:[esi+eax*4+0xB9B69C], 0x01
...
006CAB7D    mov byte ptr ds:[esi+ecx*4+0xB9B69C], 0x01
...
006CABBE    pop ebx
006CABBF    call 0x0075927A
006CABC4    mov esp, ebp
006CABC6    pop ebp
006CABC7    ret
006CABC8    push 0x87E8A8
006CABCD    push 0x1D7
006CABD2    mov ecx, 0x87E8E0
006CABD7    jmp 0x006CAC1B
006CABD9    push 0x87E8A8
006CABDE    push 0x1E0
006CABE3    mov ecx, 0x87E8E0
006CABE8    jmp 0x006CAC1B
006CABEA    push 0x87E8A8
006CABEF    push 0x1E7
006CABF4    mov ecx, 0x87E77C
006CABF9    jmp 0x006CAC1B
006CABFB    push 0x87E8A8
006CAC00    push 0x1ED
006CAC05    mov ecx, 0x87E7F8
006CAC0A    jmp 0x006CAC1B
006CAC0C    push 0x87E8A8
006CAC11    push 0x1C2
006CAC16    mov ecx, 0x87E7A0
006CAC1B    push 0x87E740
006CAC20    mov edx, 0x801800
006CAC25    call 0x0063B870
006CAC2A    add esp, 0x0C
006CAC2D    call 0x0063BC30
006CAC32    test al, al
006CAC34    jz 0x006CAC37
006CAC36    int3
006CAC37    call 0x0063BB00
