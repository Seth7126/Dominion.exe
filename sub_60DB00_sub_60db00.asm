...
0060DB05    push 0x76AFC6                                   ; => [ Call: __ehhandler$??$common_set_report_hook@DP6AHHPADPAH@Z@@YAHHQ6AHHPADPAH@Z@Z | Type: EHRegistrationNode ]
0060DB0A    mov eax, dword ptr fs:[0x00000000]
0060DB10    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060DB6B    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060DB9C    call 0x0060DA10                                 ; => [ Call: sub_60da10 | String: dom_expansion_with1E ]
0060DBA1    mov byte ptr ss:[ebp-0x04], 0x03
0060DBA5    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0060DBAA    mov edi, dword ptr ss:[ebp-0x10]
0060DBAD    mov eax, edx                                    ; => [ Data: data_801800 ]
...
0060DBC4    call 0x0063DFA0                                 ; => [ Call: sub_63dfa0 | String: [expansion] ]
...
0060DBE7    jz 0x0060DC04                                   ; => [ Data: data_cf65bc ]
0060DBE9    lea ecx, ss:[ebp+0x0C]
0060DBEC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060DBFF    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0060DC1A    jz 0x0060DD0D                                   ; => [ Data: data_cf65bc ]
...
0060DC33    call 0x004DC4A0                                 ; => [ Call: sub_4dc4a0 ]
...
0060DC46    call 0x0060DA10                                 ; => [ Call: sub_60da10 | String: dom_expansion_only1E ]
0060DC4B    mov byte ptr ss:[ebp-0x04], 0x06
0060DC4F    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0060DC54    mov edi, dword ptr ss:[ebp-0x10]
0060DC57    mov eax, edx                                    ; => [ Data: data_801800 ]
...
0060DC6E    call 0x0063DFA0                                 ; => [ Call: sub_63dfa0 | String: [expansion] ]
...
0060DC91    jz 0x0060DCAE                                   ; => [ Data: data_cf65bc ]
0060DC93    lea ecx, ss:[ebp+0x0C]
0060DC96    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060DCA9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0060DCCA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060DD08    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060DD0D    mov eax, ebx
0060DD0F    mov ecx, dword ptr ss:[ebp-0x0C]
0060DD12    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060DD19    pop ecx
0060DD1A    pop edi
0060DD1B    pop esi
0060DD1C    pop ebx
