...
006F1397    mov dword ptr ss:[ebp-0x04], ecx                ; => [ Type: POINT | Field: y ]
006F139A    call dword ptr ds:[0x007752FC]
006F13A0    lea ecx, ss:[ebp-0x18]
006F13A3    push ecx
006F13A4    push eax
006F13A5    call dword ptr ds:[0x007753C4]                  ; => [ Data: data_147d470 ]
006F13AB    lea eax, ss:[ebp-0x18]
006F13AE    push eax
006F13AF    push dword ptr ds:[0x0147D470]
006F13B5    call dword ptr ds:[0x00775390]                  ; => [ Data: data_147d470 ]
006F13BB    lea eax, ss:[ebp-0x10]
006F13BE    push eax
006F13BF    push dword ptr ds:[0x0147D470]
006F13C5    call dword ptr ds:[0x00775390]                  ; => [ Type: POINT | Data: data_147d470 ]
...
006F13E5    mov dword ptr ss:[ebp-0x08], eax                ; => [ Field: x | Field: y ]
006F13E8    lea eax, ss:[ebp-0x08]
006F13EB    push eax
006F13EC    push dword ptr ds:[0x0147D470]
006F13F2    mov dword ptr ss:[ebp-0x04], edx                ; => [ Field: y ]
006F13F5    call dword ptr ds:[0x0077538C]                  ; => [ Data: data_147d470 ]
006F13FB    push dword ptr ss:[ebp-0x04]
006F13FE    push dword ptr ss:[ebp-0x08]
006F1401    call dword ptr ds:[0x00775388]                  ; => [ Field: x | Field: y ]
006F1407    movaps xmm0, xmmword ptr ds:[0x00893640]
006F140E    xor eax, eax
006F1410    movss xmm1, dword ptr ds:[0x0147D480]
006F1418    addss xmm1, dword ptr ds:[0x00890D84]           ; => [ Data: data_147d480 ]
006F1420    movss xmm2, dword ptr ds:[0x008910A8]
006F1428    movups xmmword ptr ss:[ebp-0x48], xmm0          ; => [ String: \x00\x00\x00\x00\x00\x00\x80\x3f\x00\x00\xa0\x40\x00\x00\x20\x41\x00\x00\x48\x42\x00\x00\xc8\x42\x00\x00\xfa\x43\x00\x00\x7a\x44\x00\x40\x9c\x45\x00\x40\x1c\x46\x00\x50\x43\x47\x00\x50\xc3\x47 | Call: __builtin_memcpy ]
...
006F1453    movss dword ptr ds:[0x0147D480], xmm2           ; => [ Data: data_147d480 ]
006F145B    pop edi
...
006F147B    movss dword ptr ds:[0x0147D480], xmm2           ; => [ Data: data_147d480 ]
006F1483    pop edi
...
006F1489    pop ebx
006F148A    ret
006F148B    lea eax, ds:[ecx+0x14]                          ; => [ Field: y ]
006F148E    cmp edi, eax
006F1490    jle 0x006F1531
006F1496    mov eax, dword ptr ss:[ebp-0x04]
006F1499    mov dword ptr ss:[ebp-0x08], eax                ; => [ Field: x | Field: y ]
006F149C    lea eax, ss:[ebp-0x08]
006F149F    push eax
006F14A0    push dword ptr ds:[0x0147D470]
006F14A6    mov dword ptr ss:[ebp-0x04], ecx                ; => [ Field: y ]
006F14A9    call dword ptr ds:[0x0077538C]                  ; => [ Data: data_147d470 ]
006F14AF    push dword ptr ss:[ebp-0x04]
006F14B2    push dword ptr ss:[ebp-0x08]
006F14B5    call dword ptr ds:[0x00775388]                  ; => [ Field: x | Field: y ]
006F14BB    movaps xmm0, xmmword ptr ds:[0x00893640]
006F14C2    xor eax, eax
006F14C4    movss xmm1, dword ptr ds:[0x0147D484]
006F14CC    subss xmm1, dword ptr ds:[0x00890D84]           ; => [ Data: data_147d484 ]
006F14D4    movss xmm3, dword ptr ds:[0x008937C0]
006F14DC    movss xmm2, dword ptr ds:[0x008910A8]
006F14E4    movups xmmword ptr ss:[ebp-0x48], xmm0          ; => [ String: \x00\x00\x00\x00\x00\x00\x80\x3f\x00\x00\xa0\x40\x00\x00\x20\x41\x00\x00\x48\x42\x00\x00\xc8\x42\x00\x00\xfa\x43\x00\x00\x7a\x44\x00\x40\x9c\x45\x00\x40\x1c\x46\x00\x50\x43\x47\x00\x50\xc3\x47 | Call: __builtin_memcpy ]
...
006F1517    xorps xmm0, xmm0                                ; => [ String: 0 | String: zx ]
...
006F1529    movss dword ptr ds:[0x0147D484], xmm0           ; => [ Data: data_147d484 ]
006F1531    pop edi
