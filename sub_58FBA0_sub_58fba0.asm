...
0058FBA9    mov eax, dword ptr ds:[0x008C4040]
0058FBAE    xor eax, ebp
0058FBB0    mov dword ptr ss:[ebp-0x04], eax
0058FBB3    mov eax, dword ptr ds:[0x00CCE9BC]
0058FBB8    push ebx
0058FBB9    push esi
...
0058FD8B    mov eax, dword ptr ss:[ebp+eax*4-0x88]
...
0058FDAB    dec ecx
0058FDAC    mov dword ptr ds:[0x00CCE9B8], ecx
...
0058FEC5    mov eax, dword ptr ss:[ebp+eax*4-0x108]
...
0058FEEA    mov dword ptr ds:[0x00CCE9B8], ecx
...
0058FF39    mov dword ptr ds:[esi+ecx*4+0x28], 0x00
