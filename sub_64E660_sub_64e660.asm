...
0064E670    jnz 0x0064E71D                                  ; => [ Data: data_c23bb8 | Data: data_c23bb0 ]
0064E676    push 0x8746FC
0064E67B    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: dump ui ]
0064E680    imul eax, dword ptr ds:[0x00C23BAC], 0x18D0
0064E68A    add esp, 0x04
0064E68D    mov esi, dword ptr ds:[0x00C23BA8]              ; => [ Data: data_c23ba8 ]
0064E693    add eax, esi                                    ; => [ Data: data_c23bac ]
...
0064E722    call 0x0067D6D0                                 ; => [ Data: data_c23ba8 | Call: sub_67d6d0 ]
0064E727    mov ecx, eax
0064E729    movups xmm0, xmmword ptr ds:[0x007FEFB0]        ; => [ Data: data_7fefb0 ]
...
0064E775    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
...
0064E788    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
0064E78D    pop edi
