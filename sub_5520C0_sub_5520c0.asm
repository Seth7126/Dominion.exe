...
005520D0    movzx edi, si                                   ; => [ Call: sub_573400 ]
005520D3    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005520D6    cmp edi, 0x320
005520DC    jb 0x005520E3
005520DE    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0055212A    pop esi
0055212B    setz al                                         ; => [ Call: sub_56b800 ]
0055212E    pop ebx
0055212F    ret
...
00552149    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: card.where == CW_CARD | String: CardWhereCard | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
0055214E    add esp, 0x0C
00552151    call 0x0063BC30
00552156    test al, al
00552158    jz 0x0055215B                                   ; => [ Call: sub_63bc30 ]
0055215A    int3
0055215B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
