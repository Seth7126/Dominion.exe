...
0062F121    movups xmmword ptr ds:[ecx], xmm0
...
0062FB5F    movups xmmword ptr ds:[edx], xmm0
...
0062FBBA    movups xmmword ptr ds:[ecx], xmm0
...
0062FC00    movups xmmword ptr ds:[ecx], xmm0
...
0062FC46    movups xmmword ptr ds:[ecx], xmm0
...
0062FC89    movups xmmword ptr ds:[ecx], xmm0
...
00631047    jz 0x00631064
00631049    lea ecx, ss:[ebp-0x14]
0063104C    call 0x0063D4E0
...
0063105F    call 0x0064C080
00631064    lea ecx, ss:[ebp-0x78]
00631067    call 0x006310C0
0063106C    mov eax, edi
0063106E    mov ecx, dword ptr ss:[ebp-0x0C]
00631071    mov dword ptr fs:[0x00000000], ecx
00631078    pop ecx
00631079    pop edi
0063107A    pop esi
