...
005326DC    mov dword ptr fs:[0x00000000], eax
...
0053270C    push eax
0053270D    call 0x00568780
00532712    mov esi, eax
00532714    mov dword ptr ss:[ebp-0xCC8], 0x81971C
...
0053273B    rep movsd
0053273D    mov dword ptr ss:[ebp-0xCA4], eax
...
0053277B    push esi
0053277C    call dword ptr ds:[eax]
...
005327D7    call 0x00573400
005327DC    push dword ptr ds:[0x007BFAD4]
...
00532806    call 0x00582EB0
0053280B    add esp, 0x28
0053280E    jmp 0x0053281C
00532810    xor ecx, ecx
00532812    call 0x0056E9C0
00532817    call 0x00566800
0053281C    mov ecx, dword ptr ss:[ebp-0x0C]
0053281F    mov dword ptr fs:[0x00000000], ecx
00532826    pop ecx
00532827    pop edi
00532828    pop esi
00532829    pop ebx
