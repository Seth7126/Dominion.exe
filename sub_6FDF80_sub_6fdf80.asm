...
006FDF9A    push 0x88C240
006FDF9F    push 0x3F
006FDFA1    push 0x88C260
006FDFA6    mov ecx, 0x801AA4
006FDFAB    jmp 0x006FE048
006FDFB0    mov edx, dword ptr ds:[0x0147ABE8]
...
006FDFE0    call 0x006E5C50
006FDFE5    jmp 0x006FE016
006FDFE7    mov edx, dword ptr ds:[0x0147ABE8]
...
006FE011    call 0x006B8440
006FE016    mov edx, dword ptr ds:[0x0147ABE8]
...
006FE035    pop ecx
006FE036    ret
006FE037    push 0x871F88
006FE03C    push 0x45
006FE03E    push 0x871FA0
006FE043    mov ecx, 0x871F94
006FE048    mov edx, 0x801800
006FE04D    call 0x0063B870
006FE052    add esp, 0x0C
006FE055    call 0x0063BC30
006FE05A    test al, al
006FE05C    jz 0x006FE05F
006FE05E    int3
006FE05F    call 0x0063BB00
