...
00528810    push esi
00528811    push edi
00528812    mov dword ptr ss:[esp+0x08], ecx                ; => [ Call: __chkstk ]
00528816    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052881B    push ecx
0052881C    push 0x00
0052881E    push 0x00
...
0052882E    call 0x00568960                                 ; => [ Call: sub_568960 ]
...
0052885F    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
00528861    cmp dword ptr ss:[esp+0xCF0], 0x00
00528869    jz 0x0052889C
0052886B    call 0x00573400                                 ; => [ Call: sub_573400 ]
00528870    push 0x00
...
0052888F    push 0x3EA
00528894    call 0x00579560                                 ; => [ Call: sub_579560 | Data: data_7bfad0 ]
...
005288C9    push ecx                                        ; => [ Call: __builtin_memcpy ]
005288CA    movlpd qword ptr ss:[esp+0x18], xmm0
005288D0    lea eax, ss:[esp+0x44]
005288D4    movlpd qword ptr ss:[esp+0x28], xmm0            ; => [ Call: __builtin_memset ]
...
00528922    call 0x00563B20                                 ; => [ Call: sub_563b20 ]
00528927    add esp, 0x10
0052892A    test eax, eax
0052892C    jz 0x00528967
0052892E    mov dword ptr ss:[esp+0x08], eax
00528932    call 0x00573400                                 ; => [ Call: sub_573400 ]
00528937    push dword ptr ds:[0x007BFAD4]                  ; => [ Call: nullptr ]
...
00528952    push 0x0B
00528954    push 0x3EE
00528959    push 0x01                                       ; => [ Call: __builtin_memcpy | String: \x01\x00\x00\x00\xee\x03\x00\x00\x0b\x00\x00\x00\x07\x00\x00\x00\x00 ]
0052895B    push ecx
0052895C    mov ecx, dword ptr ds:[eax+0x04]
0052895F    call 0x00582EB0                                 ; => [ Call: sub_582eb0 ]
00528964    add esp, 0x28
00528967    mov edx, 0x3EA
0052896C    push 0x00
0052896E    push ecx
0052896F    lea ecx, ds:[edx+0x04]
00528972    call 0x0056A3F0                                 ; => [ Call: sub_56a3f0 ]
