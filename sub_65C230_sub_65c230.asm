...
0065C23C    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0065C254    mov ecx, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
0065C293    cmovnz esi, edx                                 ; => [ Call: nullptr ]
...
0065C2F8    movss dword ptr ss:[esp+0x20], xmm0             ; => [ Call: sub_67f6b0 ]
0065C2FE    call 0x0067F6B0                                 ; => [ Call: sub_67f6b0 ]
...
0065C32B    addss xmm2, dword ptr ss:[esp+0x20]             ; => [ Call: sub_64c3c0 ]
...
0065C345    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0065C36B    push 0x08
0065C36D    call 0x006DD280                                 ; => [ Call: sub_6dd280 | Data: data_8cc5f8 ]
...
0065C5B9    call 0x0065BFE0                                 ; => [ Call: sub_65bfe0 ]
...
0065C674    movups xmm0, xmmword ptr ds:[0x00800248]        ; => [ Data: data_800248 ]
...
0065C6C9    call 0x006B80F0                                 ; => [ Call: sub_6b80f0 ]
...
0065C71A    movss xmm3, dword ptr ds:[eax+0xA0]             ; => [ Data: data_147b06c ]
...
0065C779    movss dword ptr ss:[esp+0x4C], xmm0             ; => [ Call: sub_4ae0d0 ]
0065C77F    movss xmm0, dword ptr ss:[esp+0x2C]
0065C785    call 0x004AE0F0                                 ; => [ Call: sub_4ae0f0 ]
...
0065C7B8    call 0x006BCA30                                 ; => [ Call: sub_6bca30 ]
0065C7BD    mov ecx, edi
0065C7BF    call 0x0065BF00                                 ; => [ Call: sub_65bf00 ]
0065C7C4    mov ecx, dword ptr ss:[esp+0xCC]
0065C7CB    pop edi
0065C7CC    pop esi
0065C7CD    xor ecx, esp
0065C7CF    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0065C7EA    call 0x006B8440                                 ; => [ Call: sub_6b8440 ]
0065C7EF    mov ecx, dword ptr ss:[esp+0x34]
0065C7F3    movups xmm0, xmmword ptr ds:[0x00800248]        ; => [ Data: data_800248 ]
...
0065C848    call 0x006B80F0                                 ; => [ Call: sub_6b80f0 ]
...
0065C894    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
0065C899    add esp, 0x0C
0065C89C    call 0x0063BC30
0065C8A1    test al, al
0065C8A3    jz 0x0065C8A6                                   ; => [ Call: sub_63bc30 ]
0065C8A5    int3
0065C8A6    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
