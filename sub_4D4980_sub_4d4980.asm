...
004D4985    push 0x76374E                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?CancelStealers@ContextBase@details@Concurrency@@QAEXPAV_TaskCollectionBase@23@@Z ]
004D498A    mov eax, dword ptr fs:[0x00000000]
004D4990    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D4991    sub esp, 0x10
004D4994    push esi
004D4995    push edi
004D4996    mov eax, dword ptr ds:[0x008C4040]
004D499B    xor eax, ebp
004D499D    push eax                                        ; => [ Data: __security_cookie ]
004D499E    lea eax, ss:[ebp-0x0C]
004D49A1    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D49BA    call 0x004D47C0                                 ; => [ Call: sub_4d47c0 ]
004D49BF    mov dword ptr ss:[ebp-0x04], 0x00
004D49C6    mov edi, 0x801800                               ; => [ Data: data_801800 ]
004D49CB    mov eax, dword ptr ss:[ebp+0x0C]
004D49CE    mov ecx, edi                                    ; => [ Data: data_801800 ]
004D49D0    mov edx, edi                                    ; => [ Data: data_801800 ]
...
004D4A00    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
004D4A05    mov dword ptr ss:[ebp-0x04], 0x02
004D4A0C    cmp dword ptr ds:[0x00CF65BC], 0x00
004D4A13    jz 0x004D4A3C                                   ; => [ Data: data_cf65bc ]
...
004D4A24    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4A37    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D4A3C    mov eax, dword ptr ss:[ebp+0x14]
004D4A3F    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
004D4A6E    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
004D4A73    mov dword ptr ss:[ebp-0x04], 0x04
004D4A7A    cmp dword ptr ds:[0x00CF65BC], 0x00
004D4A81    jz 0x004D4AAA                                   ; => [ Data: data_cf65bc ]
...
004D4A92    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D4AA5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D4AAA    mov eax, esi
004D4AAC    mov ecx, dword ptr ss:[ebp-0x0C]
004D4AAF    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D4AB6    pop ecx
004D4AB7    pop edi
004D4AB8    pop esi
