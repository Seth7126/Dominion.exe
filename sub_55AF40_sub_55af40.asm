...
0055AF50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0055AF51    mov eax, 0x1938
0055AF56    call 0x00761E50                                 ; => [ Call: __chkstk ]
0055AF5B    mov eax, dword ptr ds:[0x008C4040]
0055AF60    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0055AF62    mov dword ptr ss:[ebp-0x10], eax
0055AF65    push esi
0055AF66    push edi
0055AF67    push eax
0055AF68    lea eax, ss:[ebp-0x0C]
0055AF6B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0055AF71    lea eax, ss:[ebp-0x1944]
0055AF77    mov ecx, 0x44D
0055AF7C    push eax
0055AF7D    call 0x00568780                                 ; => [ Call: sub_568780 ]
0055AF82    mov esi, eax
0055AF84    mov dword ptr ss:[ebp-0xCC0], 0x81E254          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_1e1ed30e853cdfe4e362fa8492d1fc9e>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_1e1ed30e853cdfe4e362fa8492d1fc9e>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0055AF8E    mov ecx, 0x321
0055AF93    lea edi, ss:[ebp-0xC94]
0055AF99    lea eax, ss:[ebp-0xCC0]
0055AF9F    add esp, 0x04
0055AFA2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0055AFA4    mov dword ptr ss:[ebp-0xC9C], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_1e1ed30e853cdfe4e362fa8492d1fc9e>,bool,enum CardID>::VTable ]
...
0055AFE2    push esi
0055AFE3    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0055AFFF    mov edi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
0055B015    push eax
0055B016    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
0055B019    test edi, edi
0055B01B    setnle al
0055B01E    mov ecx, dword ptr ss:[ebp-0x0C]
0055B021    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055B028    pop ecx
0055B029    pop edi
0055B02A    pop esi
0055B02B    mov ecx, dword ptr ss:[ebp-0x10]
0055B02E    xor ecx, ebp
0055B030    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
