...
0065AAB9    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0065AABE    xor eax, ebp
0065AAC0    mov dword ptr ss:[ebp-0x08], eax
0065AAC3    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
...
0065AAF9    push esi
0065AAFA    call 0x00658550                                 ; => [ Call: sub_658550 ]
...
0065AB48    call 0x00659B10                                 ; => [ Call: sub_659b10 ]
...
0065AB58    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0065ABB4    call 0x00655430                                 ; => [ Call: sub_655430 ]
...
0065ACA6    call 0x0067F6B0                                 ; => [ Call: sub_67f6b0 ]
...
0065AD57    call 0x0067F6B0                                 ; => [ Call: sub_67f6b0 ]
...
0065AD7B    movss dword ptr ss:[ebp-0x10], xmm0             ; => [ Call: sub_67f6b0 ]
...
0065AD9E    addss xmm2, dword ptr ss:[ebp-0x20]             ; => [ Call: sub_64c3c0 ]
...
0065ADD5    mov dword ptr ds:[ebx+0x1764], eax              ; => [ Call: sub_67d3c0 ]
...
0065ADF3    mov dword ptr ds:[ebx+0x1774], eax              ; => [ Call: sub_67d3c0 ]
...
0065AE11    call 0x006EA940                                 ; => [ Data: data_7ffb14 | Call: sub_6ea940 ]
...
0065AE37    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
0065AEA2    call 0x0065A660                                 ; => [ Call: sub_65a660 ]
...
0065AED3    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0065AF60    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0065AF89    call 0x0065D0F0                                 ; => [ Call: sub_65d0f0 ]
...
0065AFDD    call 0x00657FC0                                 ; => [ Call: sub_657fc0 ]
...
0065B010    cmp dword ptr ds:[0x0147ABD0], 0x00             ; => [ Data: data_147abd0 ]
0065B017    lea esi, ds:[ebx+0x1620]
0065B01D    mov ecx, 0x34
0065B022    lea edi, ss:[ebp-0x10C]
0065B028    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0065B02A    jz 0x0065AF62
0065B030    mov esi, dword ptr ss:[ebp-0x110]
0065B036    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0065B03B    push dword ptr ds:[ebx+0x1694]
0065B041    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0065B063    call 0x0063B5F0                                 ; => [ String: %s %s layer %d | Call: sub_63b5f0 ]
...
0065B083    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0065B0A1    push eax
0065B0A2    call 0x00656980                                 ; => [ Call: sub_656980 ]
0065B0A7    add esp, 0x10
0065B0AA    cmp dword ptr ds:[0x0147ABD0], 0x00             ; => [ Data: data_147abd0 ]
...
0065B0D2    mov edx, 0x801800                               ; => [ Data: data_801800 ]
0065B0D7    push dword ptr ds:[ebx+0x1694]
0065B0DD    test eax, eax
0065B0DF    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0065B0F9    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: %s %s tbl layer %d ]
...
0065B12F    call 0x00658DA0                                 ; => [ Call: sub_658da0 ]
...
0065B13E    pop ebx
0065B13F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0065B161    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | Data: data_801800 | String: UI2TextUpdateScrollbar | String: Halt ]
0065B166    add esp, 0x0C
0065B169    call 0x0063BC30
0065B16E    test al, al
0065B170    jz 0x0065B173                                   ; => [ Call: sub_63bc30 ]
0065B172    int3
0065B173    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0065B178    push 0x874DF8
0065B17D    push 0x22BE
0065B182    push 0x8739B4
0065B187    mov edx, 0x801800
0065B18C    mov ecx, 0x874A48
0065B191    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\UI2.cpp | String: UI2UpdateChildren | Data: data_801800 | String: child.parent == &ui ]
0065B196    add esp, 0x0C
0065B199    call 0x0063BC30
0065B19E    test al, al
0065B1A0    jz 0x0065B1A3                                   ; => [ Call: sub_63bc30 ]
0065B1A2    int3
0065B1A3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
