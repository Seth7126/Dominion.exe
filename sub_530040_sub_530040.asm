...
0053004C    mov eax, dword ptr ds:[0x008C4040]
...
005300B4    call 0x0056A3F0
005300B9    call 0x00573400
005300BE    mov edx, dword ptr ds:[eax+0x0C]
005300C1    mov ecx, dword ptr ds:[eax+0x04]
005300C4    call 0x00588340
005300C9    call 0x00573400
005300CE    push 0x0C
005300D0    push 0x00
