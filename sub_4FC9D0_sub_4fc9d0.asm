...
004FC9E7    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
004FC9EA    mov dword ptr ss:[esp+0x0C], eax
004FC9EE    cmp esi, 0x320
004FC9F4    jb 0x004FC9FF
004FC9F6    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FCA0F    call 0x005754F0                                 ; => [ Call: sub_5754f0 ]
...
004FCA32    test al, al
004FCA34    jz 0x004FCAA3                                   ; => [ Call: sub_568470 ]
004FCA36    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FCA3B    mov edi, dword ptr ds:[eax+0x04]
004FCA3E    cmp esi, 0x320
004FCA44    jb 0x004FCA4B
004FCA46    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FCA63    test al, al
004FCA65    jnz 0x004FCAA3                                  ; => [ Call: sub_5754f0 ]
004FCA67    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FCA6C    mov edi, dword ptr ds:[eax+0x04]
004FCA6F    cmp esi, 0x320
004FCA75    jb 0x004FCA7C
004FCA77    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
004FCA94    test al, al
004FCA96    jnz 0x004FCAA3                                  ; => [ Call: sub_5754f0 ]
