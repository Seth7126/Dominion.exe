...
0051CC75    push 0x76567F                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$use_facet@V?$time_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAABV?$time_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@ABVlocale@0@@Z ]
0051CC7A    mov eax, dword ptr fs:[0x00000000]
0051CC80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0051CC8E    push eax                                        ; => [ Data: __security_cookie ]
0051CC8F    lea eax, ss:[ebp-0x0C]
0051CC92    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0051CC98    mov esi, edx
0051CC9A    mov dword ptr ss:[ebp-0x14], esi
0051CC9D    mov dword ptr ss:[ebp-0x18], ecx
0051CCA0    mov eax, 0x801800                               ; => [ Data: data_801800 ]
0051CCA5    mov dword ptr ss:[ebp-0x1C], 0x00
0051CCAC    mov dword ptr ss:[ebp-0x10], eax                ; => [ Data: data_801800 ]
...
0051CD0B    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
0051CD10    inc ebx
...
0051CD1E    push 0x8168AC                                   ; => [ String: FlavorThemeDefGet ]
0051CD23    push 0x2D49
0051CD28    mov edx, 0x801800
0051CD2D    mov ecx, 0x8168C0                               ; => [ String: def.theme == theme ]
...
0051CD4C    mov ecx, dword ptr ds:[eax+0x7C161C]            ; => [ Data: data_7c161c ]
...
0051CD64    push ecx
0051CD65    push dword ptr ds:[eax+0x7C161C]                ; => [ Data: data_7c161c ]
...
0051CD80    mov ebx, 0x801800                               ; => [ Data: data_801800 ]
0051CD85    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: {br}%s - %s{br} ]
0051CD87    mov ecx, ebx                                    ; => [ Data: data_801800 ]
0051CD89    test eax, eax
0051CD8B    cmovnz ecx, eax
0051CD8E    push ecx
0051CD8F    lea ecx, ss:[ebp-0x10]
0051CD92    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
0051CD97    mov byte ptr ss:[ebp-0x04], 0x03
0051CD9B    cmp dword ptr ds:[0x00CF65BC], 0x00
0051CDA2    jz 0x0051CDCE                                   ; => [ Data: data_cf65bc ]
...
0051CDB3    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0051CDC6    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0051CDCB    mov dword ptr ss:[ebp-0x14], ebx                ; => [ Data: data_801800 ]
...
0051CDE5    mov edx, 0x8168D4                               ; => [ String: archipelago ]
0051CDEA    jmp 0x0051CE14
0051CDEC    mov edx, 0x8168E0                               ; => [ String: bleak ]
0051CDF1    jmp 0x0051CE14
0051CDF3    mov edx, 0x8168E8                               ; => [ String: land ]
0051CDF8    jmp 0x0051CE14
0051CDFA    mov edx, 0x8168F0                               ; => [ String: lake ]
0051CDFF    jmp 0x0051CE14
0051CE01    mov edx, 0x8168F8                               ; => [ String: beach ]
0051CE06    jmp 0x0051CE14
0051CE08    mov edx, 0x816900                               ; => [ String: shore ]
0051CE0D    jmp 0x0051CE14
0051CE0F    mov edx, 0x816908                               ; => [ String: island ]
0051CE14    lea ecx, ss:[ebp-0x14]
0051CE17    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
0051CE33    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0051CE4F    push ebx
0051CE50    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
0051CE77    jz 0x0051CE94                                   ; => [ Data: data_cf65bc ]
0051CE79    lea ecx, ss:[ebp-0x14]
0051CE7C    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0051CE8F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0051CEAB    jz 0x0051CEC8                                   ; => [ Data: data_cf65bc ]
0051CEAD    lea ecx, ss:[ebp-0x10]
0051CEB0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0051CEC3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0051CEC8    mov eax, dword ptr ss:[ebp-0x18]
0051CECB    mov ecx, dword ptr ss:[ebp-0x0C]
0051CECE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0051CED5    pop ecx
0051CED6    pop edi
0051CED7    pop esi
0051CED8    pop ebx
...
0051CEDB    pop ebp
0051CEDC    ret
0051CEDD    push 0x816910                                   ; => [ String: DumpMapStyle ]
0051CEE2    push 0x2D68
0051CEE7    mov edx, ebx
0051CEE9    mov ecx, 0x801AA4                               ; => [ String: Halt ]
0051CEEE    push 0x80CD80
0051CEF3    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCards_Campaign.cpp ]
0051CEF8    add esp, 0x0C
0051CEFB    call 0x0063BC30
0051CF00    test al, al
0051CF02    jz 0x0051CF05                                   ; => [ Call: sub_63bc30 ]
0051CF04    int3
0051CF05    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
0051CF0A    push 0x82555C
0051CF0F    push 0xF17
0051CF14    push 0x8250E0
0051CF19    mov edx, 0x801800
0051CF1E    mov ecx, 0x825570
0051CF23    call 0x0063B870                                 ; => [ String: style != TERRAINSTYLE_NONE | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomMap.cpp | String: TerrainStyleDefGet ]
0051CF28    add esp, 0x0C
0051CF2B    call 0x0063BC30
0051CF30    test al, al
0051CF32    jz 0x0051CF35                                   ; => [ Call: sub_63bc30 ]
0051CF34    int3
0051CF35    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
