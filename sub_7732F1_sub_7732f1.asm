...
00773302    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00773307    mov ecx, dword ptr ds:[edx-0x04]
0077330A    xor ecx, eax
0077330C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
00773311    mov eax, 0x8C034C
00773316    jmp 0x00761FA6                                  ; => [ Call: __CxxFrameHandler3 | Data: data_8c034c ]
