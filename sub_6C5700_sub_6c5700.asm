...
006C5705    push 0x7703F5                                   ; => [ Call: __ehhandler$??0?$ThreadProxyFactory@VFreeThreadProxy@details@Concurrency@@@details@Concurrency@@IAE@PAVThreadProxyFactoryManager@12@@Z | Type: EHRegistrationNode ]
006C570A    mov eax, dword ptr fs:[0x00000000]
006C5710    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006C5711    sub esp, 0x0C
006C5714    push ebx
006C5715    mov eax, dword ptr ds:[0x008C4040]
006C571A    xor eax, ebp
006C571C    push eax                                        ; => [ Data: __security_cookie ]
006C571D    lea eax, ss:[ebp-0x0C]
006C5720    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C5726    push 0x147CF90                                  ; => [ Data: data_147cf90 ]
006C572B    lea eax, ss:[ebp-0x14]
006C572E    push 0x87E17C                                   ; => [ String: %s/res/ ]
006C5733    push eax
006C5734    call 0x0063DF30                                 ; => [ Call: sub_63df30 ]
...
006C57D6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C57E9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C57EE    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006C57F5    mov bl, bh
006C57F7    mov dword ptr ss:[ebp-0x04], 0x03
006C57FE    cmp dword ptr ds:[0x00CF65BC], 0x00
006C5805    jz 0x006C582E                                   ; => [ Data: data_cf65bc ]
...
006C5816    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5829    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C582E    mov al, bl
006C5830    mov ecx, dword ptr ss:[ebp-0x0C]
006C5833    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C583A    pop ecx
006C583B    pop ebx
