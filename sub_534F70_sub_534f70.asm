...
00534F86    call 0x00568960                                 ; => [ Call: sub_568960 ]
...
00534FA3    add edi, eax                                    ; => [ Call: sub_568960 ]
00534FA5    call 0x0056B800
00534FAA    mov esi, eax
00534FAC    call 0x00573400
00534FB1    movzx esi, si                                   ; => [ Call: sub_56b800 ]
00534FB4    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00534FB7    mov dword ptr ss:[esp+0x0C], eax
00534FBB    cmp esi, 0x320
00534FC1    jb 0x00534FC8
00534FC3    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00534FEB    call 0x00568960                                 ; => [ Call: sub_568960 ]
