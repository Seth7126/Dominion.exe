...
0066EF45    push 0x76D5E0                                   ; => [ Type: EHRegistrationNode | Call: sub_76d5e0 ]
0066EF4A    mov eax, dword ptr fs:[0x00000000]
0066EF50    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0066EF62    push esi
0066EF63    push edi
0066EF64    push eax                                        ; => [ Data: __security_cookie ]
0066EF65    lea eax, ss:[ebp-0x0C]
0066EF68    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0066EF6E    mov ebx, edx
0066EF70    mov esi, ecx
0066EF72    call 0x00667870                                 ; => [ Call: sub_667870 ]
...
0066EF8B    call 0x00667790                                 ; => [ Call: sub_667790 ]
...
0066EFA3    push 0x871DD4                                   ; => [ String: XString::XString ]
0066EFA8    push 0x94
0066EFAD    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
0066EFB2    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
0066EFB7    jmp 0x0066F10F
0066EFBC    lea ecx, ss:[ebp-0xA14]
0066EFC2    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
0066EFC7    lea edx, ss:[ebp-0xA14]
0066EFCD    mov dword ptr ss:[ebp-0x04], 0x00
0066EFD4    mov ecx, esi
0066EFD6    call 0x00667680                                 ; => [ Call: sub_667680 ]
0066EFDB    mov edi, eax
0066EFDD    mov dword ptr ss:[ebp-0x04], 0x01
0066EFE4    cmp dword ptr ds:[0x00CF65BC], 0x00
0066EFEB    jz 0x0066F024                                   ; => [ Data: data_cf65bc ]
...
0066F002    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0066F015    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0066F01A    mov dword ptr ss:[ebp-0xA14], 0x801800          ; => [ Data: data_801800 ]
...
0066F072    push 0x876084                                   ; => [ String: UI2DeleteTransition ]
0066F077    push 0x45EE
0066F07C    mov ecx, 0x876074                               ; => [ String: animIdx >= 0 ]
0066F081    jmp 0x0066F10A
0066F086    push 0x71
0066F088    push dword ptr ds:[0x01724A88]
0066F08E    mov edx, edi
0066F090    mov ecx, 0x8CAE70
0066F095    call 0x006DD1E0                                 ; => [ Call: sub_6dd1e0 | Data: data_1724a88 | Data: data_8cae70 ]
0066F09A    mov esi, eax
0066F09C    add esp, 0x08
0066F09F    test esi, esi
0066F0A1    jnz 0x0066F0B4
0066F0A3    push 0x876084                                   ; => [ String: UI2DeleteTransition ]
0066F0A8    push 0x45F1
0066F0AD    mov ecx, 0x876068                               ; => [ String: transition ]
...
0066F0C4    push 0x00
0066F0C6    push ebx
0066F0C7    call 0x0069DD00                                 ; => [ Call: sub_69dd00 | Data: data_1724a88 ]
0066F0CC    mov edx, eax
0066F0CE    mov ecx, esi
0066F0D0    call 0x006FB870                                 ; => [ Call: sub_6fb870 ]
0066F0D5    add esp, 0x08
0066F0D8    mov cl, 0x01
0066F0DA    call 0x00665770                                 ; => [ Call: sub_665770 ]
0066F0DF    mov ecx, dword ptr ss:[ebp-0x0C]
0066F0E2    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0066F0E9    pop ecx
0066F0EA    pop edi
0066F0EB    pop esi
0066F0EC    pop ebx
...
0066F0F2    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0066F0F7    mov esp, ebp
0066F0F9    pop ebp
0066F0FA    ret
0066F0FB    push 0x876084                                   ; => [ String: UI2DeleteTransition ]
0066F100    push 0x45F2
0066F105    mov ecx, 0x8760A4                               ; => [ String: transition->numItems > animIdx ]
0066F10A    push 0x8739B4                                   ; => [ String: C:\x\ax2017\Engine\UI2.cpp ]
0066F10F    mov edx, 0x801800
0066F114    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0066F119    add esp, 0x0C
0066F11C    call 0x0063BC30
0066F121    test al, al
0066F123    jz 0x0066F126                                   ; => [ Call: sub_63bc30 ]
0066F125    int3
0066F126    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
