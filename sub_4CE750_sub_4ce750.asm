...
004CE755    push 0x763475                                   ; => [ Call: __ehhandler$?add@?$source_link_manager@V?$multi_link_registry@V?$ISource@I@Concurrency@@@Concurrency@@@Concurrency@@QAEXPAV?$ISource@I@2@@Z | Type: EHRegistrationNode ]
004CE75A    mov eax, dword ptr fs:[0x00000000]
004CE760    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004CE76E    push eax                                        ; => [ Data: __security_cookie ]
004CE76F    lea eax, ss:[ebp-0x0C]
004CE772    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004CE778    mov edi, dword ptr ss:[ebp+0x08]
004CE77B    mov ecx, edi
004CE77D    call 0x0064E7A0
004CE782    mov byte ptr ss:[ebp-0x0D], 0x00
004CE786    mov dword ptr ds:[eax+0x18BC], 0x4CE670         ; => [ Call: sub_64e7a0 | Call: sub_4ce670 ]
004CE790    mov ecx, dword ptr ds:[0x00CC8DC8]
004CE796    mov ecx, dword ptr ds:[ecx+0x1E1A4]
004CE79C    call 0x004D8F30
004CE7A1    mov edx, eax                                    ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004CE7A3    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004CE810    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CE815    movss xmm3, dword ptr ds:[0x00890E18]
004CE81D    mov edx, 0x8DC7B8
004CE822    push 0x00
004CE824    push ebx
004CE825    mov ecx, eax
004CE827    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc7b8 ]
004CE82C    mov edx, 0x801800
004CE831    lea ecx, ss:[ebp-0x14]
004CE834    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
...
004CE873    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CE886    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CE88B    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
004CE892    mov edx, 0x801800
004CE897    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CE89E    lea ecx, ss:[ebp-0x18]
004CE8A1    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
...
004CE8EC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CE903    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CE908    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
004CE90F    jmp 0x004CEA1B
004CE914    test bl, 0x01
004CE917    jz 0x004CE93D
004CE919    mov ecx, edi
004CE91B    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CE920    movss xmm3, dword ptr ds:[0x00890E18]
004CE928    mov edx, 0x8DC7B8
004CE92D    push 0x00
004CE92F    push ebx
004CE930    mov ecx, eax
004CE932    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc7b8 ]
...
004CE958    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CE95D    movss xmm3, dword ptr ds:[0x00890E18]
004CE965    mov edx, 0x8DC7C4
004CE96A    push 0x00
004CE96C    push ebx
004CE96D    mov ecx, eax
004CE96F    call 0x00665DB0                                 ; => [ Data: data_8dc7c4 | Call: sub_665db0 ]
...
004CE9A4    push eax
004CE9A5    call 0x00666380                                 ; => [ Call: sub_666380 | Data: data_8dc7a0 ]
...
004CE9BC    push eax
004CE9BD    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
...
004CE9FC    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CEA0F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CEA14    mov dword ptr ss:[ebp-0x1C], 0x801800           ; => [ Data: data_801800 ]
004CEA1B    inc ebx
...
004CEA67    call 0x004D5CB0                                 ; => [ Call: sub_4d5cb0 ]
...
004CEB04    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004CEB17    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004CEB1C    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
004CEB23    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
004CEB2A    mov ecx, dword ptr ss:[ebp-0x0C]
004CEB2D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004CEB34    pop ecx
004CEB35    pop edi
004CEB36    pop esi
004CEB37    pop ebx
...
004CEB52    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004CEB57    add esp, 0x0C
004CEB5A    call 0x0063BC30
004CEB5F    test al, al
004CEB61    jz 0x004CEB64                                   ; => [ Call: sub_63bc30 ]
004CEB63    int3
004CEB64    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
