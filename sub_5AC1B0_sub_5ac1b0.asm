...
005AC1C6    jnb 0x005AC2AB                                  ; => [ Data: data_b4a5c4 ]
005AC1CC    imul edi, eax, 0x510C
005AC1D2    add edi, dword ptr ds:[0x00B4A5C0]              ; => [ Data: data_b4a5c0 ]
005AC1D8    cmp dword ptr ds:[edi+0x5108], edx
005AC1DE    jnz 0x005AC2AB                                  ; => [ Data: data_b4a5c4 ]
005AC1E4    mov eax, dword ptr ds:[edi]
005AC1E6    test eax, eax
005AC1E8    jnz 0x005AC246
005AC1EA    mov ecx, dword ptr ds:[0x00B4A5DC]              ; => [ Data: data_b4a5dc ]
...
005AC21B    mov dword ptr ds:[0x00B4A5DC], eax              ; => [ Data: data_b4a5dc ]
...
005AC22F    mov dword ptr ds:[0x00B4A5E0], eax              ; => [ Data: data_b4a5e0 ]
005AC234    dec dword ptr ds:[0x00B4A5E4]                   ; => [ Data: data_b4a5e4 ]
005AC23A    mov edx, 0x0C
005AC23F    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005AC244    jmp 0x005AC289
005AC246    cmp eax, 0x01
005AC249    jnz 0x005AC26D
005AC24B    mov esi, dword ptr ds:[0x00B4A61C]              ; => [ Type: HANDLE | Data: data_b4a61c ]
005AC251    push 0xFFFFFFFF
005AC253    push esi
005AC254    call dword ptr ds:[0x00775108]
005AC25A    push esi
005AC25B    call dword ptr ds:[0x007750D8]
005AC261    mov dword ptr ds:[0x00B4A61C], 0x00             ; => [ Data: data_b4a61c ]
005AC26B    jmp 0x005AC27D
005AC26D    cmp eax, 0x02
005AC270    jnz 0x005AC289
005AC272    mov ecx, dword ptr ds:[edi+0x507C]
005AC278    call 0x0069EC60                                 ; => [ Call: sub_69ec60 ]
005AC27D    mov eax, dword ptr ds:[0x00B4A618]
005AC282    mov dword ptr ds:[eax+0x04], 0x00               ; => [ Data: data_b4a618 | Data: data_b4a618 ]
005AC289    movzx eax, word ptr ds:[edi+0x5108]
005AC290    mov ecx, dword ptr ds:[0x00B4A5CC]              ; => [ Data: data_b4a5cc ]
005AC296    mov dword ptr ds:[0x00B4A5CC], eax              ; => [ Data: data_b4a5cc ]
005AC29B    mov dword ptr ds:[edi+0x5108], ecx
005AC2A1    dec dword ptr ds:[0x00B4A5D0]                   ; => [ Data: data_b4a5d0 ]
005AC2A7    pop edi
005AC2A8    pop esi
005AC2A9    pop ecx
005AC2AA    ret
...
005AC2C1    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Engine\DataArray.h | String: DataArrayTryToGet(id) != NULL | Data: data_801800 | String: DataArray<struct CampaignMapTask>::DataArrayGet ]
005AC2C6    add esp, 0x0C
005AC2C9    call 0x0063BC30
005AC2CE    test al, al
005AC2D0    jz 0x005AC2D3                                   ; => [ Call: sub_63bc30 ]
005AC2D2    int3
005AC2D3    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
