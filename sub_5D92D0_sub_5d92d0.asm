...
005D92D4    byte FF
005D92D5    push 0x769B40                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?push_back@TokenRegistrationContainer@_CancellationTokenState@details@Concurrency@@QAEXPAV_CancellationTokenRegistration@34@@Z ]
005D92DA    mov eax, dword ptr fs:[0x00000000]
005D92E0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005D92EE    push eax                                        ; => [ Data: __security_cookie ]
005D92EF    lea eax, ss:[ebp-0x0C]
005D92F2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005D92F8    mov eax, dword ptr ds:[0x00CF64A8]              ; => [ Data: data_cf64a8 ]
005D92FD    lea ecx, ss:[ebp-0x14]
005D9300    mov edx, 0x870D58
005D9305    mov dword ptr ss:[ebp-0x10], eax
005D9308    call 0x0063D720                                 ; => [ String: btn_add_friend | Call: sub_63d720 ]
005D930D    mov edx, dword ptr ss:[ebp+0x08]
005D9310    mov edi, 0x801800                               ; => [ Data: data_801800 ]
005D9315    mov eax, dword ptr ss:[ebp-0x14]
005D9318    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D933E    xor esi, esi                                    ; => [ Call: nullptr | Call: nullptr ]
...
005D935E    jz 0x005D9382                                   ; => [ Data: data_cf65bc ]
005D9360    lea ecx, ss:[ebp-0x14]
005D9363    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9376    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005D937B    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005D9398    call 0x004B9680                                 ; => [ Call: sub_4b9680 | Call: sub_4b9480 ]
005D939D    mov esi, eax
005D939F    cmp dword ptr ds:[esi+0x14], 0x01
005D93A3    jz 0x005D93B4
005D93A5    push 0x870D68                                   ; => [ String: PlayerInfoFloatingClick ]
005D93AA    push 0x3227
005D93AF    jmp 0x005D991A
005D93B4    mov ecx, esi
005D93B6    call 0x004D6250                                 ; => [ Call: sub_4d6250 ]
005D93BB    test al, al
005D93BD    jnz 0x005D93D3
005D93BF    push 0x870D68                                   ; => [ String: PlayerInfoFloatingClick ]
005D93C4    push 0x3229
005D93C9    mov ecx, 0x870DB4                               ; => [ String: GameCanAddFriend(playerConfig) ]
005D93CE    jmp 0x005D991F
005D93D3    mov ecx, dword ptr ds:[esi+0x18]
005D93D6    xor edx, edx
005D93D8    call 0x004B40B0                                 ; => [ Call: sub_4b40b0 ]
005D93DD    mov edx, 0x870DD4
005D93E2    lea ecx, ss:[ebp-0x14]
005D93E5    call 0x0063D720                                 ; => [ String: btn_block | Call: sub_63d720 ]
005D93EA    mov eax, dword ptr ss:[ebp+0x08]
005D93ED    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D943C    jz 0x005D9460                                   ; => [ Data: data_cf65bc ]
005D943E    lea ecx, ss:[ebp-0x14]
005D9441    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9454    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005D9459    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
005D9476    call 0x004B9680                                 ; => [ Call: sub_4b9680 | Call: sub_4b9480 ]
...
005D948B    call 0x004B40B0                                 ; => [ Call: sub_4b40b0 ]
005D9490    mov edx, 0x870DE0
005D9495    lea ecx, ss:[ebp-0x14]
005D9498    call 0x0063D720                                 ; => [ String: btn_ai_very_easy | Call: sub_63d720 ]
005D949D    mov eax, dword ptr ss:[ebp+0x08]
005D94A0    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D94EC    jz 0x005D9509                                   ; => [ Data: data_cf65bc ]
005D94EE    lea ecx, ss:[ebp-0x14]
005D94F1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9504    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D951A    call 0x005D9050                                 ; => [ Call: sub_5d9050 ]
005D951F    mov edx, 0x870DF4
005D9524    lea ecx, ss:[ebp-0x14]
005D9527    call 0x0063D720                                 ; => [ String: btn_ai_easy | Call: sub_63d720 ]
005D952C    mov eax, dword ptr ss:[ebp+0x08]
005D952F    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D957C    jz 0x005D9599                                   ; => [ Data: data_cf65bc ]
005D957E    lea ecx, ss:[ebp-0x14]
005D9581    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9594    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D95A9    call 0x005D9050                                 ; => [ Call: sub_5d9050 ]
005D95AE    mov edx, 0x870E00
005D95B3    lea ecx, ss:[ebp-0x14]
005D95B6    call 0x0063D720                                 ; => [ String: btn_ai_medium | Call: sub_63d720 ]
005D95BB    mov eax, dword ptr ss:[ebp+0x08]
005D95BE    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D960C    jz 0x005D9629                                   ; => [ Data: data_cf65bc ]
005D960E    lea ecx, ss:[ebp-0x14]
005D9611    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9624    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D963A    call 0x005D9050                                 ; => [ Call: sub_5d9050 ]
005D963F    mov edx, 0x870E10
005D9644    lea ecx, ss:[ebp-0x14]
005D9647    call 0x0063D720                                 ; => [ String: btn_ai_hard | Call: sub_63d720 ]
005D964C    mov eax, dword ptr ss:[ebp+0x08]
005D964F    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D969C    jz 0x005D96B9                                   ; => [ Data: data_cf65bc ]
005D969E    lea ecx, ss:[ebp-0x14]
005D96A1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D96B4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D96CA    call 0x005D9050                                 ; => [ Call: sub_5d9050 ]
005D96CF    mov edx, 0x870E1C
005D96D4    lea ecx, ss:[ebp-0x14]
005D96D7    call 0x0063D720                                 ; => [ String: img_checkbox_veryeasy | Call: sub_63d720 ]
005D96DC    mov eax, dword ptr ss:[ebp+0x08]
005D96DF    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D972C    jz 0x005D9749                                   ; => [ Data: data_cf65bc ]
005D972E    lea ecx, ss:[ebp-0x14]
005D9731    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D9744    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D9764    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: img_checkbox_easy ]
005D9769    mov eax, dword ptr ss:[ebp+0x08]
005D976C    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D97BC    jz 0x005D97D9                                   ; => [ Data: data_cf65bc ]
005D97BE    lea ecx, ss:[ebp-0x14]
005D97C1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D97D4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D97F3    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: img_checkbox_medium ]
005D97F8    mov eax, dword ptr ss:[ebp+0x08]
005D97FB    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
005D9844    jz 0x005D9861                                   ; => [ Data: data_cf65bc ]
005D9846    lea ecx, ss:[ebp-0x14]
005D9849    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D985C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
005D987C    call 0x0063D720                                 ; => [ String: img_checkbox_hard | Call: sub_63d720 ]
...
005D98CC    jz 0x005D98E9                                   ; => [ Data: data_cf65bc ]
005D98CE    lea ecx, ss:[ebp-0x14]
005D98D1    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
005D98E4    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
005D98E9    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
005D98F0    test esi, esi
005D98F2    jnz 0x005D98FC
005D98F4    lea ecx, ds:[esi+0x02]
005D98F7    call 0x005D9210                                 ; => [ Call: sub_5d9210 | Call: sub_5d9210 | Call: sub_5d9210 | Call: sub_5d9210 ]
005D98FC    xor al, al
005D98FE    mov ecx, dword ptr ss:[ebp-0x0C]
005D9901    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005D9908    pop ecx
005D9909    pop edi
005D990A    pop esi
005D990B    pop ebx
...
005D990E    pop ebp
005D990F    ret
005D9910    push 0x870D68                                   ; => [ String: PlayerInfoFloatingClick ]
005D9915    push 0x3231
005D991A    mov ecx, 0x870D80                               ; => [ String: playerConfig.playerType == DBGAMEPLAYERTYPE_ACCOUNT | String: playerConfig.playerType == DBGAMEPLAYERTYPE_ACCOUNT ]
005D991F    push 0x86F1E8
005D9924    mov edx, edi
005D9926    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 | String: PlayerInfoFloatingClick ]
005D992B    add esp, 0x0C
005D992E    call 0x0063BC30
005D9933    test al, al
005D9935    jz 0x005D9938                                   ; => [ Call: sub_63bc30 ]
005D9937    int3
005D9938    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
