...
00543E68    push 0x7651FB                                   ; => [ Call: sub_7651fb | Type: EHRegistrationNode ]
00543E6D    mov eax, dword ptr fs:[0x00000000]
00543E73    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00543E74    push ebx
00543E75    mov eax, 0x19A8
00543E7A    call 0x00761E50                                 ; => [ Call: __chkstk ]
00543E7F    mov eax, dword ptr ds:[0x008C4040]
00543E84    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00543E86    mov dword ptr ss:[ebp-0x14], eax
00543E89    push esi
00543E8A    push edi
00543E8B    push eax
00543E8C    lea eax, ss:[ebp-0x0C]
00543E8F    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00543E95    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00543EC3    call 0x00589750                                 ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_05432a2c8c3fb2896d129de02d2c38d4>, void>::VTable | Call: sub_589750 | Call: nullptr ]
00543EC8    push ecx                                        ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_05432a2c8c3fb2896d129de02d2c38d4>, void>::VTable ]
00543EC9    mov ecx, esp
00543ECB    mov esi, eax
00543ECD    mov dword ptr ds:[ecx], 0x81BA34                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_05432a2c8c3fb2896d129de02d2c38d4>, void>::`vftable'{for `std::_Func_base<void>'} ]
00543ED3    mov dword ptr ds:[ecx+0x04], esi
00543ED6    mov dword ptr ds:[ecx+0x24], ecx                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_05432a2c8c3fb2896d129de02d2c38d4>, void>::VTable ]
00543ED9    call 0x005699B0                                 ; => [ Call: sub_5699b0 ]
00543EDE    add esp, 0x28
00543EE1    mov dword ptr ss:[ebp-0xCA4], esi
00543EE7    call 0x00573400                                 ; => [ Call: sub_573400 ]
00543EEC    push 0x08
00543EEE    push 0x3E9
00543EF3    push ecx
...
00543EFE    call 0x00589E00                                 ; => [ Call: sub_589e00 ]
00543F03    call 0x00573400                                 ; => [ Call: sub_573400 ]
00543F08    lea ecx, ss:[ebp-0x19B8]
00543F0E    push 0x04
00543F10    push ecx
00543F11    mov edx, dword ptr ds:[eax+0x0C]
00543F14    mov ecx, dword ptr ds:[eax+0x04]
00543F17    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
00543F1C    mov ecx, 0x321
00543F21    mov dword ptr ss:[ebp-0xD38], eax
00543F27    lea esi, ss:[ebp-0x19B8]
00543F2D    mov dword ptr ss:[ebp-0xD00], 0x81BA18          ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_9c32fced5af2d37687ba73ff3e767de8>,bool,enum CardID>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_9c32fced5af2d37687ba73ff3e767de8>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
00543F37    lea edi, ss:[ebp-0xCA0]
00543F3D    add esp, 0x18
00543F40    rep movsd                                       ; => [ Call: __builtin_memcpy ]
00543F42    lea ecx, ss:[ebp-0xD00]
00543F48    mov dword ptr ss:[ebp-0xCDC], ecx               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_9c32fced5af2d37687ba73ff3e767de8>,bool,enum CardID>::VTable ]
...
00543F89    call eax
00543F8B    mov dword ptr ds:[esi+0x24], eax                ; => [ Field: vFunc_0 ]
...
00543FB1    mov dword ptr ss:[ebp-0x20], eax                ; => [ Call: GSI1::OffForSym ]
...
00543FC8    push eax
00543FC9    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
00543FCC    xorps xmm0, xmm0
00543FCF    mov dword ptr ss:[ebp-0xCCC], 0x00
00543FD9    movlpd qword ptr ss:[ebp-0xCD4], xmm0           ; => [ Call: __builtin_memset ]
...
0054407D    push 0x476
00544082    push esi
00544083    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
00544088    add esp, 0x1C
0054408B    push 0xD2A
00544090    push ecx
00544091    call 0x0056B800                                 ; => [ Call: sub_56b800 ]
00544096    add esp, 0x04
00544099    mov edx, 0x3E9
0054409E    mov ecx, eax
005440A0    call 0x00565E40                                 ; => [ Call: sub_565e40 ]
005440A5    add esp, 0x04
005440A8    mov ecx, dword ptr ss:[ebp-0x0C]
005440AB    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
005440B2    pop ecx
005440B3    pop edi
005440B4    pop esi
005440B5    mov ecx, dword ptr ss:[ebp-0x14]
005440B8    xor ecx, ebp
005440BA    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
