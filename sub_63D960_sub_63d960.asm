...
0063D982    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
0063D9A0    call 0x0063D5E0                                 ; => [ Call: sub_63d5e0 ]
...
0063D9AE    push ebx
0063D9AF    push eax
0063D9B0    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
0063D9C1    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
0063D9C6    pop edi
0063D9C7    pop ebx
0063D9C8    pop ebp
0063D9C9    ret 0x04
