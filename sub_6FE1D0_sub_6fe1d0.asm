...
006FE1D6    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006FE1DB    push esi
...
006FE20E    cmovnz eax, esi                                 ; => [ Call: nullptr ]
...
006FE22E    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
006FE233    add esp, 0x0C
006FE236    call 0x0063BC30
006FE23B    test al, al
006FE23D    jz 0x006FE240                                   ; => [ Call: sub_63bc30 ]
006FE23F    int3
006FE240    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
