...
00621365    push 0x76B648                                   ; => [ Call: sub_76b648 | Type: EHRegistrationNode ]
0062136A    mov eax, dword ptr fs:[0x00000000]
00621370    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
00621382    push esi
00621383    push edi
00621384    push eax                                        ; => [ Data: __security_cookie ]
00621385    lea eax, ss:[ebp-0x0C]
00621388    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0062138E    mov dword ptr ss:[ebp-0xA0], ecx
00621394    xor edi, edi
00621396    mov dword ptr ss:[ebp-0xA4], edi
0062139C    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
006213A1    push 0x63D770                                   ; => [ Call: sub_63d770 | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006213B5    push 0x04
006213B7    push eax
006213B8    call 0x00759288                                 ; => [ Call: `eh vector constructor iterator' ]
006213BD    mov dword ptr ss:[ebp-0x04], edi
006213C0    mov esi, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
006213C6    test esi, esi
006213C8    jz 0x00621589
006213CE    mov esi, dword ptr ds:[esi+0x7590]
006213D4    call 0x004B9480                                 ; => [ Call: sub_4b9480 ]
006213D9    push esi
...
006213EA    call 0x005A0940                                 ; => [ Call: sub_5a0940 ]
...
00621411    push eax
00621412    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0062143B    call 0x0063D720                                 ; => [ String: {br_power_sml} | Call: sub_63d720 ]
...
0062145F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006214D8    jz 0x006214F8                                   ; => [ Data: data_cf65bc ]
006214DA    lea ecx, ss:[ebp-0x94]
006214E0    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006214F3    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0062150C    jz 0x00621536                                   ; => [ Data: data_cf65bc ]
0062150E    lea ecx, ss:[ebp-0x98]
00621514    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621527    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0062152C    mov dword ptr ss:[ebp-0x98], 0x801800           ; => [ Data: data_801800 ]
00621536    inc ebx
...
00621565    push eax
00621566    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_63d770 ]
0062156B    mov al, bl
0062156D    mov ecx, dword ptr ss:[ebp-0x0C]
00621570    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00621577    pop ecx
00621578    pop edi
00621579    pop esi
0062157A    pop ebx
...
00621580    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
0062159F    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
006215A4    add esp, 0x0C
006215A7    call 0x0063BC30
006215AC    test al, al
006215AE    jz 0x006215B1                                   ; => [ Call: sub_63bc30 ]
006215B0    int3
006215B1    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
