...
006D8678    push 0x770D15                                   ; => [ Call: sub_770d15 | Type: EHRegistrationNode ]
006D867D    mov eax, dword ptr fs:[0x00000000]
006D8683    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8684    push ebx
...
006D8691    push eax                                        ; => [ Data: __security_cookie ]
006D8692    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8695    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006D869B    mov esi, edx                                    ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D869D    mov dword ptr ss:[ebp-0x18], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D86A0    mov edi, ecx
006D86A2    mov dword ptr ss:[ebp-0x24], edi
006D86A5    test esi, esi
006D86A7    jnz 0x006D8722                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D86A9    push 0x05
006D86AB    mov edx, 0x879C7C
006D86B0    lea ecx, ss:[ebp-0x14]
006D86B3    call 0x0069FD50                                 ; => [ String: !Null\Null | Call: sub_69fd50 ]
006D86B8    add esp, 0x04
006D86BB    mov dword ptr ss:[ebp-0x04], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D86BE    lea edx, ds:[esi+0x05]
006D86C1    mov eax, dword ptr ss:[ebp-0x14]
006D86C4    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
006D86C9    test eax, eax
006D86CB    cmovnz ecx, eax
006D86CE    call 0x0069F030                                 ; => [ Call: sub_69f030 ]
...
006D86E6    jz 0x006D8719                                   ; => [ Data: data_cf65bc ]
...
006D86F7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006D870D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006D8712    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
006D872F    mov dword ptr ss:[ebp-0x1C], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8732    jnz 0x006D8742
006D8734    push 0x01
006D8736    xor dl, dl
006D8738    mov ecx, esi
006D873A    call 0x0069F4A0                                 ; => [ Call: sub_69f4a0 ]
006D873F    add esp, 0x04
006D8742    mov eax, dword ptr ds:[esi]                     ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8744    inc dword ptr ds:[esi+0x1C]                     ; => [ Field: Next ]
006D8747    mov eax, dword ptr ds:[eax]                     ; => [ Field: Next | Type: _EXCEPTION_REGISTRATION_RECORD ]
006D8749    mov dword ptr ss:[ebp-0x04], 0x02
006D8750    cmp dword ptr ds:[eax], 0x01
006D8753    jz 0x006D8769                                   ; => [ Field: Next ]
006D8755    push 0x880644                                   ; => [ String: MaterialSimpleStateBind ]
006D875A    push 0x2DE
006D875F    mov ecx, 0x880624                               ; => [ String: pDefMaterial->passCount == 1 ]
006D8764    jmp 0x006D8833
006D8769    mov eax, dword ptr ds:[eax+0x08]
006D876C    cmp dword ptr ds:[eax], 0x01
006D876F    jnz 0x006D8824                                  ; => [ Field: Next ]
...
006D8787    call 0x006D8320                                 ; => [ Call: sub_6d8320 ]
...
006D87A3    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
006D87E6    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006D87ED    pop ecx
006D87EE    pop edi
006D87EF    pop esi
...
006D880D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DefAutoLock::DefAutoLock | String: assetPtr && assetPtr->assetType == assetType | Data: data_801800 | String: C:\x\ax2017\Engine\DefLoad.h ]
006D8812    add esp, 0x0C
006D8815    call 0x0063BC30
006D881A    test al, al
006D881C    jz 0x006D881F                                   ; => [ Call: sub_63bc30 ]
006D881E    int3
006D881F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006D8824    push 0x880644                                   ; => [ String: MaterialSimpleStateBind ]
006D8829    push 0x2E3
006D882E    mov ecx, 0x880678                               ; => [ String: materialPass.variationCount == 1 ]
006D8833    push 0x88052C
006D8838    mov edx, 0x801800
006D883D    call 0x0063B870                                 ; => [ String: MaterialSimpleStateBind | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Material.cpp ]
006D8842    add esp, 0x0C
006D8845    call 0x0063BC30
006D884A    test al, al
006D884C    jz 0x006D884F                                   ; => [ Call: sub_63bc30 ]
006D884E    int3
006D884F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
