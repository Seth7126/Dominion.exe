...
00591F80    push ecx
00591F81    xor eax, eax                                    ; => [ Call: nullptr ]
...
00591FAF    push 0x8209AC                                   ; => [ String: GetObeliskPile ]
00591FB4    push 0x4F34
00591FB9    mov ecx, 0x8209BC                               ; => [ String: piles[0] != CARD_NONE ]
...
00591FC8    pop ecx
00591FC9    ret
00591FCA    push 0x8209AC                                   ; => [ String: GetObeliskPile ]
00591FCF    push 0x4F35
00591FD4    mov ecx, 0x8209D4                               ; => [ String: piles[1] == CARD_NONE ]
00591FD9    push 0x81F4B8
00591FDE    mov edx, 0x801800
00591FE3    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: GetObeliskPile ]
00591FE8    add esp, 0x0C
00591FEB    call 0x0063BC30
00591FF0    test al, al
00591FF2    jz 0x00591FF5                                   ; => [ Call: sub_63bc30 ]
00591FF4    int3
00591FF5    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
