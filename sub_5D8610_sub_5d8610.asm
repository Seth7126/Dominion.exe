...
005D862F    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
005D864E    cmp eax, dword ptr ds:[0x00B604E4]              ; => [ Data: data_b604e4 ]
005D8654    jmp 0x005D86B6
005D8656    cmp eax, 0x01
005D8659    jz 0x005D8736
005D865F    push 0x8707DC                                   ; => [ String: GetTokenLayer ]
005D8664    push 0x2FC9
005D8669    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
005D8699    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
005D86B0    cmp ecx, dword ptr ds:[0x00B604E4]              ; => [ Data: data_b604e4 ]
...
005D86D9    call 0x005DE8B0                                 ; => [ Call: sub_5de8b0 ]
...
005D8704    mov eax, dword ptr ds:[0x00B604E0]              ; => [ Data: data_b604e0 ]
...
005D872A    setz al                                         ; => [ Data: data_b604e4 ]
...
005D873B    pop ecx
005D873C    ret
005D873D    push 0x871958                                   ; => [ String: LookupCard ]
005D8742    push 0x3D96
005D8747    mov ecx, 0x871964                               ; => [ Data: data_871964 ]
005D874C    push 0x86F1E8
005D8751    mov edx, 0x801800
005D8756    call 0x0063B870                                 ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Call: sub_63b870 | Data: data_801800 ]
005D875B    add esp, 0x0C
005D875E    call 0x0063BC30
005D8763    test al, al
005D8765    jz 0x005D8768                                   ; => [ Call: sub_63bc30 ]
005D8767    int3
005D8768    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
