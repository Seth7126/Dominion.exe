...
004F8B3B    call 0x00761E50                                 ; => [ Call: __chkstk ]
004F8B40    push esi
004F8B41    lea eax, ss:[esp+0xC8C]
004F8B48    push edi
004F8B49    push eax
004F8B4A    call 0x0056CA80                                 ; => [ Call: sub_56ca80 ]
004F8B4F    push dword ptr ds:[0x0078316C]                  ; => [ Call: nullptr ]
...
004F8B6B    push 0x0B
004F8B6D    push 0x00
004F8B6F    rep movsd                                       ; => [ Call: __builtin_memcpy ]
004F8B71    push 0x03
004F8B73    push 0x3EA
