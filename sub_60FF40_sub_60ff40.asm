...
0060FFFC    call 0x0060DE40
00610001    lea ecx, ss:[ebp-0xD0]
00610007    call 0x0060F100
...
006100D0    mov eax, dword ptr ds:[0x00CCF6AC]
...
006101E0    call 0x00666120
006101E5    xor ebx, ebx
006101E7    add esp, 0x1C
006101EA    mov dword ptr ss:[ebp-0x19CC], ebx
...
00610288    call 0x0064C080
0061028D    mov dword ptr ss:[ebp-0x19DC], 0x801800
...
006102B1    lea ecx, ds:[eax+0x6EDC]
...
00610313    jnz 0x0061034C
00610315    mov edi, dword ptr ds:[esi*4+0x1A958A0]
...
0061046F    call 0x0064C080
00610474    mov dword ptr ss:[ebp-0x19E0], 0x801800
...
0061062F    jnz 0x0061065B
00610631    mov edi, dword ptr ds:[esi*4+0x1A95930]
...
00610659    jz 0x006106AA
0061065B    mov ecx, dword ptr ss:[ebp-0x19C8]
00610661    mov edx, 0x85EF44
00610666    push ebx
00610667    call 0x0067BE20
0061066C    mov edi, eax
0061066E    add esp, 0x04
00610671    mov dword ptr ds:[esi*4+0x1A95930], edi
00610678    test edi, edi
0061067A    jz 0x0061073F
00610680    mov eax, dword ptr ss:[ebp-0x19C8]
00610686    mov dword ptr ds:[esi*4+0x1A95914], 0x85EF44
00610691    mov dword ptr ds:[esi*4+0x1A95910], eax
00610698    mov dword ptr ds:[esi*4+0x1A95918], ebx
0061069F    mov dword ptr ds:[esi*4+0x1A9591C], 0x00
006106AA    mov ecx, dword ptr ss:[ebp-0x19C4]
006106B0    mov edx, 0x18
006106B5    mov ecx, dword ptr ds:[ecx]
006106B7    call 0x00571B30
...
00610796    mov eax, 0x86EC94
0061079B    imul edi, esi, 0x6C
0061079E    add ecx, 0x48
006107A1    mov dword ptr ss:[ebp-0x19D0], eax
006107A7    mov dword ptr ss:[ebp-0x19C4], ecx
006107AD    add edi, 0x1A960F4
...
006108D1    mov dword ptr fs:[0x00000000], ecx
006108D8    pop ecx
006108D9    pop edi
006108DA    pop esi
006108DB    pop ebx
...
006109A9    mov eax, dword ptr ds:[ecx*4+0x86EC94]
...
006109D6    jnz 0x00610A18
006109D8    mov ebx, dword ptr ds:[esi*4+0x1A96110]
...
00610A10    jz 0x00610A57
00610A12    mov eax, dword ptr ss:[ebp-0x19D0]
00610A18    mov edx, eax
00610A1A    call 0x0067BD70
00610A1F    mov ebx, eax
00610A21    mov dword ptr ds:[esi*4+0x1A96110], ebx
...
00610A38    mov dword ptr ds:[esi*4+0x1A960F4], eax
00610A3F    mov eax, dword ptr ss:[ebp-0x19C8]
00610A45    mov dword ptr ds:[esi*4+0x1A960F0], eax
00610A4C    mov dword ptr ds:[esi*4+0x1A960F8], 0xFFFFFFFF
00610A57    cmp edi, edx
00610A59    jl 0x00610A69
00610A5B    mov ecx, ebx
00610A5D    call 0x0064E7A0
00610A62    mov edx, 0xBE4948
...
00610AF9    push 0x00
00610AFB    push ebx
00610AFC    call 0x00665DB0
00610B01    add esp, 0x10
00610B04    jmp 0x006108BB
00610B09    push 0x871DD4
00610B0E    push 0x94
00610B13    push 0x871D5C
00610B18    mov ecx, 0x871E0C
00610B1D    jmp 0x00610B94
00610B1F    push 0x8662FC
00610B24    push 0xB4C3
00610B29    mov ecx, 0x801AA4
00610B2E    jmp 0x00610B8F
00610B30    push 0x8662FC
00610B35    push 0xB4F3
00610B3A    mov ecx, 0x801AA4
00610B3F    jmp 0x00610B8F
00610B41    push 0x8662FC
00610B46    push 0xB564
00610B4B    mov ecx, 0x801AA4
00610B50    jmp 0x00610B8F
00610B52    push 0x8662FC
00610B57    push 0xB533
00610B5C    mov ecx, 0x86631C
00610B61    jmp 0x00610B8F
00610B63    push 0x8662FC
00610B68    push 0xB532
00610B6D    jmp 0x00610B8A
00610B6F    push 0x8662FC
00610B74    push 0xB4BD
00610B79    mov ecx, 0x86631C
00610B7E    jmp 0x00610B8F
00610B80    push 0x8662FC
00610B85    push 0xB4BC
00610B8A    mov ecx, 0x866340
00610B8F    push 0x86F1E8
00610B94    mov edx, 0x801800
00610B99    call 0x0063B870
00610B9E    add esp, 0x0C
00610BA1    call 0x0063BC30
00610BA6    test al, al
00610BA8    jz 0x00610BAB
00610BAA    int3
00610BAB    call 0x0063BB00
