...
004D8E55    push 0x763AD6                                   ; => [ Call: __ehhandler$?Initialize@GlobalCore@details@Concurrency@@QAEXPAUGlobalNode@23@IE@Z | Type: EHRegistrationNode ]
004D8E5A    mov eax, dword ptr fs:[0x00000000]
004D8E60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004D8E61    sub esp, 0x10
004D8E64    push esi
004D8E65    push edi
004D8E66    mov eax, dword ptr ds:[0x008C4040]
004D8E6B    xor eax, ebp
004D8E6D    push eax                                        ; => [ Data: __security_cookie ]
004D8E6E    lea eax, ss:[ebp-0x0C]
004D8E71    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
004D8E91    call 0x004D8F30                                 ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
004D8E96    push esi
004D8E97    push dword ptr ds:[eax+0x42B0]
004D8E9D    lea eax, ss:[ebp-0x10]
004D8EA0    push 0x8069C0
004D8EA5    push eax
004D8EA6    call 0x0063DF30                                 ; => [ String: gamelocal_%d_%d.bin | Call: sub_63df30 ]
...
004D8EC5    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
004D8ECA    inc dword ptr ds:[eax+0x04]
004D8ECD    xor edx, edx
004D8ECF    mov ecx, edi
004D8ED1    call 0x0069E000                                 ; => [ Call: sub_69e000 ]
...
004D8EEE    jz 0x004D8F17                                   ; => [ Data: data_cf65bc ]
...
004D8EFF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
004D8F12    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
004D8F17    mov eax, edi
004D8F19    mov ecx, dword ptr ss:[ebp-0x0C]
004D8F1C    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004D8F23    pop ecx
004D8F24    pop edi
004D8F25    pop esi
