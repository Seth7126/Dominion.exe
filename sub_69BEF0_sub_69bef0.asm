...
0069BEFF    push 0x8793D8                                   ; => [ String: DataArray<struct UIState>::DataArrayGet ]
0069BF04    push 0x6C
0069BF06    mov ecx, 0x802734                               ; => [ String: id != DATAID_NULL ]
0069BF0B    jmp 0x0069C170
0069BF10    movzx eax, dx
0069BF13    cmp eax, dword ptr ds:[0x00CAF264]
0069BF19    jnb 0x0069C164                                  ; => [ Data: data_caf264 ]
0069BF1F    imul ecx, eax, 0x438
0069BF25    mov eax, dword ptr ds:[0x00CAF260]              ; => [ Data: data_caf260 ]
...
0069BF41    push 0x8790A8                                   ; => [ String: UIDefGet ]
0069BF46    push 0x127
0069BF4B    push 0x878EA8                                   ; => [ String: C:\x\ax2017\Engine\UIDef.cpp ]
0069BF50    mov ecx, 0x8790C8                               ; => [ String: ptr->assetType == ASSET_TYPE_UI ]
0069BF55    jmp 0x0069C175
0069BF5A    call 0x005AF880                                 ; => [ Call: sub_5af880 ]
...
0069BF7E    jl 0x0069C130                                   ; => [ Data: data_cc8d30 ]
...
0069BF96    xorps xmm6, xmm6                                ; => [ String: 0 | String: zx ]
0069BF99    sub esi, eax
0069BF9B    xorps xmm7, xmm7                                ; => [ String: 0 | String: zx ]
...
0069C00D    pcmpeqd xmm5, xmmword ptr ds:[0x008914B0]       ; => [ Data: data_8914b0 ]
...
0069C0B1    pcmpeqd xmm5, xmmword ptr ds:[0x008914B0]       ; => [ Data: data_8914b0 ]
...
0069C12E    jnl 0x0069C15B                                  ; => [ Data: data_cc8d30 ]
...
0069C162    pop ebp
0069C163    ret
0069C164    push 0x8793D8                                   ; => [ String: DataArray<struct UIState>::DataArrayGet ]
0069C169    push 0x6D
0069C16B    mov ecx, 0x802748                               ; => [ String: DataArrayTryToGet(id) != NULL ]
0069C170    push 0x80193C                                   ; => [ String: C:\x\ax2017\Engine\DataArray.h | String: C:\x\ax2017\Engine\DataArray.h ]
0069C175    mov edx, 0x801800
0069C17A    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0069C17F    add esp, 0x0C
0069C182    call 0x0063BC30
0069C187    test al, al
0069C189    jz 0x0069C18C                                   ; => [ Call: sub_63bc30 ]
0069C18B    int3
0069C18C    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
