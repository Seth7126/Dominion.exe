...
00698F26    call 0x006987E0                                 ; => [ Call: sub_6987e0 ]
00698F2B    mov edx, eax
00698F2D    test edx, edx
00698F2F    jnz 0x00698F3F
00698F31    push 0x8793D8                                   ; => [ String: DataArray<struct UIState>::DataArrayGet ]
00698F36    push 0x6C
00698F38    mov ecx, 0x802734                               ; => [ String: id != DATAID_NULL ]
00698F3D    jmp 0x00698F81
00698F3F    movzx eax, dx
00698F42    cmp eax, dword ptr ds:[0x00CAF264]
00698F48    jnb 0x00698F75                                  ; => [ Data: data_caf264 ]
00698F4A    imul esi, eax, 0x438
00698F50    add esi, dword ptr ds:[0x00CAF260]              ; => [ Data: data_caf260 ]
...
00698F73    pop ebp
00698F74    ret
00698F75    push 0x8793D8                                   ; => [ String: DataArray<struct UIState>::DataArrayGet ]
00698F7A    push 0x6D
00698F7C    mov ecx, 0x802748                               ; => [ String: DataArrayTryToGet(id) != NULL ]
00698F81    push 0x80193C
00698F86    mov edx, 0x801800
00698F8B    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\DataArray.h | String: DataArray<struct UIState>::DataArrayGet ]
00698F90    add esp, 0x0C
00698F93    call 0x0063BC30
00698F98    test al, al
00698F9A    jz 0x00698F9D                                   ; => [ Call: sub_63bc30 ]
00698F9C    int3
00698F9D    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
