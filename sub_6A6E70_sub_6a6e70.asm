...
006A6E75    push 0x76F800                                   ; => [ Call: __ehhandler$??$common_chdir@D@@YAHQBD@Z | Type: EHRegistrationNode ]
006A6E7A    mov eax, dword ptr fs:[0x00000000]
006A6E80    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006A6E92    push esi
006A6E93    push edi
006A6E94    push eax                                        ; => [ Data: __security_cookie ]
006A6E95    lea eax, ss:[ebp-0x0C]
006A6E98    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
006A6EAD    push 0x00
006A6EAF    push eax
006A6EB0    call 0x00761FC4                                 ; => [ Call: memset ]
...
006A6ECC    test al, al
006A6ECE    jz 0x006A6F48                                   ; => [ Call: sub_7070e0 ]
006A6ED0    call 0x006A2FA0
006A6ED5    push dword ptr ds:[ebx]
006A6ED7    mov edi, eax                                    ; => [ Call: sub_6a2fa0 ]
006A6ED9    mov ecx, edi
006A6EDB    call 0x0063D8D0                                 ; => [ Call: sub_63d8d0 ]
...
006A6EF8    test al, al
006A6EFA    jz 0x006A6F41                                   ; => [ Call: sub_7076e0 ]
...
006A6F2C    test al, al
006A6F2E    jz 0x006A6F41                                   ; => [ Call: sub_7076e0 ]
006A6F30    lea edx, ss:[ebp-0x138]
006A6F36    mov ecx, edi
006A6F38    call 0x006A6C70
006A6F3D    test al, al
006A6F3F    jnz 0x006A6F4A                                  ; => [ Call: sub_6a6c70 ]
006A6F41    mov ecx, edi
006A6F43    call 0x006A3220                                 ; => [ Call: sub_6a3220 | Call: sub_6a3220 | Call: sub_6a3220 | Call: sub_6a3220 | Call: sub_6a3220 ]
006A6F48    xor edi, edi                                    ; => [ Call: nullptr | Call: nullptr | Call: nullptr | Call: nullptr | Call: nullptr | Call: nullptr ]
...
006A6F7A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006A6F7F    test esi, esi
006A6F81    jnz 0x006A6F70
006A6F83    mov dword ptr ss:[ebp-0x14], 0x00
006A6F8A    mov dword ptr ss:[ebp-0x1C], 0x00               ; => [ Call: nullptr ]
006A6F91    mov dword ptr ss:[ebp-0x18], 0x00
006A6F98    mov dword ptr ss:[ebp-0x138], 0x00              ; => [ Call: nullptr ]
006A6FA2    lea ecx, ss:[ebp-0x1C]
006A6FA5    mov byte ptr ss:[ebp-0x04], 0x02
006A6FA9    call 0x007078C0                                 ; => [ Call: sub_7078c0 ]
006A6FAE    mov eax, edi
006A6FB0    mov ecx, dword ptr ss:[ebp-0x0C]
006A6FB3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006A6FBA    pop ecx
006A6FBB    pop edi
006A6FBC    pop esi
006A6FBD    pop ebx
...
006A6FC3    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
