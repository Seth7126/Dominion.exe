...
005010F3    push 0x01
005010F5    call 0x00590760
005010FA    add esp, 0x18
005010FD    call 0x00573400
...
005011B6    mov dword ptr ss:[ebp-0x20], eax
...
005011DD    movlpd qword ptr ss:[ebp-0x195C], xmm0
...
005012F1    mov dword ptr ss:[ebp-0x20], eax
...
00501317    mov dword ptr ss:[ebp-0x1988], 0x80AB04
00501321    add esp, 0x08
00501324    mov dword ptr ss:[ebp-0x1964], eax
0050132A    rep movsd
...
0050138A    mov dword ptr ss:[ebp-0xCA8], eax
...
005013A4    push eax
005013A5    call dword ptr ds:[edx+0x10]
005013A8    xorps xmm0, xmm0
005013AB    mov dword ptr ss:[ebp-0x1954], 0x00
005013B5    movlpd qword ptr ss:[ebp-0x195C], xmm0
...
0050149B    call 0x0063B870
005014A0    add esp, 0x0C
005014A3    call 0x0063BC30
005014A8    test al, al
005014AA    jz 0x005014AD
005014AC    int3
005014AD    call 0x0063BB00
