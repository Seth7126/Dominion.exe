...
0065BF9B    pop ebp
0065BF9C    ret
0065BF9D    push 0x876B2C
0065BFA2    push 0x6D
0065BFA4    mov ecx, 0x802748
0065BFA9    jmp 0x0065BFB7
0065BFAB    push 0x876B2C
0065BFB0    push 0x6C
0065BFB2    mov ecx, 0x802734
0065BFB7    push 0x80193C
0065BFBC    mov edx, 0x801800
0065BFC1    call 0x0063B870
0065BFC6    add esp, 0x0C
0065BFC9    call 0x0063BC30
0065BFCE    test al, al
0065BFD0    jz 0x0065BFD3
0065BFD2    int3
0065BFD3    call 0x0063BB00
