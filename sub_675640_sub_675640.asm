...
00675658    push 0x76D7CD                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?consume@?$source_block@V?$multi_link_registry@V?$ITarget@I@Concurrency@@@Concurrency@@V?$ordered_message_processor@I@2@@Concurrency@@UAEPAV?$message@I@2@HPAV?$ITarget@I@2@@Z ]
0067565D    mov eax, dword ptr fs:[0x00000000]
00675663    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
00675664    push ebx
00675665    sub esp, 0x28
00675668    push esi
00675669    push edi
0067566A    mov eax, dword ptr ds:[0x008C4040]
0067566F    xor eax, ebp                                    ; => [ Data: __security_cookie ]
00675671    push eax
00675672    lea eax, ss:[ebp-0x0C]
00675675    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0067567B    mov eax, edx
0067567D    mov dword ptr ss:[ebp-0x14], eax
00675680    mov edi, ecx
00675682    mov byte ptr ds:[eax], 0x00
00675685    mov ecx, dword ptr ds:[0x00C23BE0]              ; => [ Data: data_c23be0 ]
...
006756B4    jnz 0x0067589E                                  ; => [ Data: data_c23ba8 | Data: data_c23bac ]
006756BA    call 0x0064E7A0
006756BF    mov esi, eax                                    ; => [ Call: sub_64e7a0 ]
...
00675704    movups xmmword ptr ss:[ebp-0x38], xmm0          ; => [ Call: __builtin_memset ]
00675708    push 0x00
0067570A    movups xmmword ptr ss:[ebp-0x28], xmm0
0067570E    push 0x01
00675710    mov ecx, esi
00675712    mov dword ptr ss:[ebp-0x34], 0x801800           ; => [ Data: data_801800 ]
...
0067572F    test al, al
00675731    jnz 0x00675882                                  ; => [ Call: sub_67ad40 ]
00675737    jmp 0x006757A4
00675739    mov dword ptr ds:[0x01777484], 0x00             ; => [ Data: data_1777484 ]
00675743    mov byte ptr ds:[0x0177748E], 0x00              ; => [ Data: data_177748e ]
...
00675769    push 0x01
0067576B    setz dl
0067576E    call 0x0066CA90                                 ; => [ Call: sub_66ca90 | Data: data_c23be0 ]
...
00675781    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00675788    pop ecx
00675789    pop edi
0067578A    pop esi
...
006757AE    push edi
006757AF    call 0x006EA1D0                                 ; => [ Call: sub_6ea1d0 ]
...
006757D0    mov dword ptr ss:[ebp-0x24], 0x801800           ; => [ Data: data_801800 ]
006757D7    mov dword ptr ss:[ebp-0x04], 0x00
006757DE    mov eax, dword ptr ds:[0x00C23BE0]
006757E3    mov dword ptr ss:[ebp-0x2C], eax                ; => [ Data: data_c23be0 ]
...
006757FB    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
00675812    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
...
0067583B    call 0x0066CA60                                 ; => [ Call: sub_66ca60 ]
...
00675859    jz 0x00675882                                   ; => [ Data: data_cf65bc ]
...
0067586A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0067587D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0067588D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00675894    pop ecx
00675895    pop edi
00675896    pop esi
...
006758A3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006758AA    pop ecx
006758AB    pop edi
006758AC    pop esi
