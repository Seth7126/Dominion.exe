...
0054AD5B    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054AD60    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0054AD7E    push 0x02
0054AD80    push ecx
0054AD81    mov ecx, dword ptr ds:[eax+0x40]                ; => [ Call: sub_573400 ]
0054AD84    call 0x0056F370                                 ; => [ Call: sub_56f370 ]
0054AD89    xorps xmm0, xmm0
0054AD8C    mov dword ptr ss:[esp+0x38], 0x00
0054AD94    push 0x00
0054AD96    push 0x00
0054AD98    mov esi, eax
0054AD9A    movlpd qword ptr ss:[esp+0x38], xmm0            ; => [ Call: __builtin_memset ]
...
0054ADF5    push 0x14
0054ADF7    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0054AE5F    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0054AE7B    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0054AE98    push 0x00
0054AE9A    push 0x00
0054AE9C    push 0x00                                       ; => [ Call: __builtin_memset ]
...
0054AEB7    push 0x3E9
0054AEBC    push esi
0054AEBD    call 0x00582D10                                 ; => [ Call: nullptr | Call: sub_582d10 ]
0054AEC2    push 0x00
0054AEC4    push 0x39
...
0054AEEF    call 0x0056BD60                                 ; => [ Call: sub_56bd60 | Call: sub_54acc0 ]
0054AEF4    add esp, 0x40
0054AEF7    mov ecx, dword ptr ss:[esp+0x199C]
0054AEFE    pop edi
0054AEFF    pop esi
0054AF00    xor ecx, esp
0054AF02    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
