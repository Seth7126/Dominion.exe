...
0060D595    push 0x76AF6D                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$??$common_stat@U_stat64i32@@@@YAHQBDQAU_stat64i32@@@Z ]
0060D59A    mov eax, dword ptr fs:[0x00000000]
0060D5A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060D5AE    push eax                                        ; => [ Data: __security_cookie ]
0060D5AF    lea eax, ss:[ebp-0x0C]
0060D5B2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0060D5B8    mov edi, edx
0060D5BA    mov ebx, ecx
0060D5BC    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060D5C1    movss xmm3, dword ptr ds:[0x00890E18]
0060D5C9    lea edx, ds:[edi+0x74]
0060D5CC    push 0x00
0060D5CE    push 0xFFFFFFFF
0060D5D0    mov ecx, eax
0060D5D2    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
0060D5D7    mov edx, edi
0060D5D9    lea ecx, ss:[ebp-0x18]
0060D5DC    call 0x0060D3C0                                 ; => [ Call: sub_60d3c0 ]
...
0060D6A2    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060D6A7    movss xmm3, dword ptr ds:[0x00890E18]
0060D6AF    mov edx, 0xBE5FE4
0060D6B4    push 0x00
0060D6B6    push 0xFFFFFFFF
0060D6B8    mov ecx, eax
0060D6BA    call 0x00665DB0                                 ; => [ Data: data_be5fe4 | Call: sub_665db0 ]
0060D6BF    mov esi, 0xBE49A8                               ; => [ Data: data_be49a8 ]
...
0060D6D5    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060D6DA    movss xmm3, dword ptr ds:[0x00890E18]
0060D6E2    mov edx, 0xBE5FE4
0060D6E7    push 0x00
0060D6E9    push 0xFFFFFFFF
0060D6EB    mov ecx, eax
0060D6ED    call 0x00665DB0                                 ; => [ Data: data_be5fe4 | Call: sub_665db0 ]
0060D6F2    mov esi, 0xBE4978                               ; => [ Data: data_be4978 ]
0060D6F7    jmp 0x0060D7B4
0060D6FC    mov ecx, ebx
0060D6FE    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060D703    movss xmm3, dword ptr ds:[0x00890E18]
0060D70B    mov edx, 0xBE5FE4
0060D710    push 0x00
0060D712    push 0xFFFFFFFF
0060D714    mov ecx, eax
0060D716    call 0x00665DB0                                 ; => [ Data: data_be5fe4 | Call: sub_665db0 ]
0060D71B    mov esi, 0xBE4984                               ; => [ Data: data_be4984 ]
