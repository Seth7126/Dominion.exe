...
00500DF5    push eax
00500DF6    call 0x00761FBE                                 ; => [ Call: memcpy ]
...
00500E0D    mov dword ptr ds:[eax], 0x80ABAC                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_dacc3e749dc66277cee47a3f4934abc7>, void>::`vftable'{for `std::_Func_base<void>'} ]
00500E13    mov dword ptr ds:[eax+0x24], eax
00500E16    call 0x005698B0                                 ; => [ Call: sub_5698b0 ]
00500E1B    inc esi
...
00500E29    pop esi
00500E2A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
