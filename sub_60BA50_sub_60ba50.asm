...
0060BA55    push 0x7635CD                                   ; => [ Call: __ehhandler$??0?$clone_impl@U?$error_info_injector@Vrounding_error@math@boost@@@exception_detail@boost@@@exception_detail@boost@@QAE@ABV012@@Z | Type: EHRegistrationNode ]
0060BA5A    mov eax, dword ptr fs:[0x00000000]
0060BA60    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060BA6E    push eax                                        ; => [ Data: __security_cookie ]
0060BA6F    lea eax, ss:[ebp-0x0C]                          ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
0060BA72    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0060BA88    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BA8D    movss xmm3, dword ptr ds:[0x00890E18]
0060BA95    mov edx, 0xBE5ED0
0060BA9A    push 0x00
0060BA9C    push edi
0060BA9D    mov ecx, eax
0060BA9F    call 0x00665DB0                                 ; => [ Data: data_be5ed0 | Call: sub_665db0 ]
...
0060BAB8    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BABD    mov edx, 0xBE5EDC                               ; => [ Data: data_be5edc ]
0060BAC2    jmp 0x0060BAEC
0060BAC4    mov ecx, esi
0060BAC6    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BACB    mov edx, 0xBE5EE8                               ; => [ Data: data_be5ee8 ]
0060BAD0    jmp 0x0060BAEC
0060BAD2    mov ecx, esi
0060BAD4    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BAD9    mov edx, 0xBE5EF4                               ; => [ Data: data_be5ef4 ]
0060BADE    jmp 0x0060BAEC
0060BAE0    mov ecx, esi
0060BAE2    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
0060BAE7    mov edx, 0xBE5F00                               ; => [ Data: data_be5f00 ]
0060BAEC    movss xmm3, dword ptr ds:[0x00890E18]
0060BAF4    mov ecx, eax
0060BAF6    push 0x00
0060BAF8    push edi
0060BAF9    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
0060BB78    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060BB8B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060BB90    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
