...
0069AAEF    push 0x8790A8
0069AAF4    push 0x127
0069AAF9    push 0x878EA8
0069AAFE    mov ecx, 0x8790C8
0069AB03    jmp 0x0069AC69
0069AB08    call 0x005AF880
...
0069AB29    xor eax, eax
0069AB2B    mov dword ptr ss:[ebp-0x10], edi
...
0069AC56    pop ebp
0069AC57    ret
0069AC58    push 0x8793D8
0069AC5D    push 0x6D
0069AC5F    push 0x80193C
0069AC64    mov ecx, 0x802748
0069AC69    mov edx, 0x801800
0069AC6E    call 0x0063B870
0069AC73    add esp, 0x0C
0069AC76    call 0x0063BC30
0069AC7B    test al, al
0069AC7D    jz 0x0069AC80
0069AC7F    int3
0069AC80    call 0x0063BB00
