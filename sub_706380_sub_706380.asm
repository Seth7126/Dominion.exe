...
007063A0    mov edx, dword ptr ds:[eax]
...
007063B9    addsd xmm0, qword ptr ds:[eax*8+0x893660]
...
007063D8    addsd xmm0, qword ptr ds:[eax*8+0x893660]
...
0070643D    mov dword ptr ss:[esp+0x28], esi
00706441    mov dword ptr ss:[esp+0x2C], eax
...
00706455    call 0x006A0F60
0070645A    mov ecx, dword ptr ds:[0x0147DED4]
00706460    mov edx, eax
00706462    test edx, edx
00706464    jnz 0x00706477
00706466    push 0x88D514
0070646B    push 0x6C
0070646D    mov ecx, 0x802734
...
007064FD    call 0x006A0F60
00706502    mov edi, dword ptr ds:[0x0147DED4]
00706508    test eax, eax
0070650A    jnz 0x0070651D
0070650C    push 0x88D514
00706511    push 0x6C
00706513    mov ecx, 0x802734
...
007065E0    pop ebp
007065E1    ret 0x08
007065E4    push 0x88D3B4
007065E9    push 0x1654
007065EE    push 0x88C504
007065F3    mov ecx, 0x88C954
007065F8    jmp 0x0070660B
007065FA    push 0x88D514
007065FF    mov ecx, 0x802748
00706604    push 0x6D
00706606    push 0x80193C
0070660B    mov edx, 0x801800
00706610    call 0x0063B870
00706615    add esp, 0x0C
00706618    call 0x0063BC30
0070661D    test al, al
0070661F    jz 0x00706622
00706621    int3
00706622    call 0x0063BB00
