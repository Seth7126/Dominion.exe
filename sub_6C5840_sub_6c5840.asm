...
006C5845    push 0x770445                                   ; => [ Call: sub_770445 | Type: EHRegistrationNode ]
006C584A    mov eax, dword ptr fs:[0x00000000]
006C5850    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C585F    push esi
006C5860    push edi
006C5861    push eax                                        ; => [ Data: __security_cookie ]
006C5862    lea eax, ss:[ebp-0x0C]
006C5865    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
006C586B    mov ebx, ecx
006C586D    cmp byte ptr ds:[0x008C4157], 0x00
006C5874    jnz 0x006C587D                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Data: data_8c4157 ]
006C5876    xor al, al
006C5878    jmp 0x006C5B2A
006C587D    mov eax, dword ptr ds:[ebx+0x20]
006C5880    lea ecx, ss:[ebp-0x40]
006C5883    mov edi, 0x801800                               ; => [ Data: data_801800 ]
006C5888    test eax, eax
006C588A    mov edx, edi                                    ; => [ Data: data_801800 ]
006C588C    cmovnz edx, eax
006C588F    call 0x006C48E0                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_6c48e0 ]
006C5894    mov dword ptr ss:[ebp-0x04], 0x00
006C589B    mov dword ptr ss:[ebp-0x58], 0x00               ; => [ Call: nullptr ]
...
006C58B7    mov eax, dword ptr ss:[ebp-0x40]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006C58BA    mov ecx, edi                                    ; => [ Data: data_801800 ]
006C58BC    test eax, eax
006C58BE    push 0x01
006C58C0    cmovnz ecx, eax
006C58C3    call 0x00696930                                 ; => [ Call: sub_696930 ]
...
006C5939    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
006C5967    jnz 0x006C5A55                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C5984    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
006C5989    inc dword ptr ds:[eax+0x04]
006C598C    mov edx, dword ptr ss:[ebp-0x4C]
006C598F    lea ecx, ss:[ebp-0x38]
006C5992    call 0x006C5090                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_6c5090 ]
...
006C59B9    jnz 0x006C59CB                                  ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
006C59BB    xorps xmm0, xmm0
006C59BE    movlpd qword ptr ss:[ebp-0x48], xmm0
006C59C3    mov eax, dword ptr ss:[ebp-0x44]                ; => [ Call: nullptr ]
006C59C6    mov ecx, dword ptr ss:[ebp-0x48]                ; => [ Call: nullptr ]
...
006C59E4    mov eax, dword ptr ss:[ebp-0x40]                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
006C5A0B    test al, al
006C5A0D    jnz 0x006C5A4E                                  ; => [ Call: sub_6c5700 ]
...
006C5A28    jz 0x006C5A57                                   ; => [ Data: data_cf65bc ]
006C5A2A    lea ecx, ss:[ebp-0x38]
006C5A2D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5A40    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5A45    mov dword ptr ss:[ebp-0x38], 0x801800           ; => [ Data: data_801800 ]
...
006C5A62    jz 0x006C5A96                                   ; => [ Data: data_cf65bc ]
...
006C5A73    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5A86    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5A8B    mov dword ptr ss:[ebp-0x3C], 0x801800           ; => [ Data: data_801800 ]
...
006C5AB0    jz 0x006C5ADD                                   ; => [ Data: data_cf65bc ]
...
006C5ABF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5AD2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5AD7    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
006C5ADD    mov edx, 0x30
006C5AE2    mov byte ptr ss:[ebp-0x04], 0x16
006C5AE6    mov ecx, edi
006C5AE8    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
006C5AFF    jz 0x006C5B28                                   ; => [ Data: data_cf65bc ]
...
006C5B10    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006C5B23    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006C5B28    mov al, bl
006C5B2A    mov ecx, dword ptr ss:[ebp-0x0C]
006C5B2D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006C5B34    pop ecx
006C5B35    pop edi
006C5B36    pop esi
006C5B37    pop ebx
...
006C5B3D    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
006C5B42    mov esp, ebp
006C5B44    pop ebp
006C5B45    ret
006C5B46    push 0x87E254                                   ; => [ String: XList<struct PackLocation>::GetHead ]
006C5B4B    push 0x53
006C5B4D    push 0x86E34C
006C5B52    mov edx, edi
006C5B54    mov ecx, 0x876FD4
006C5B59    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: mpHead != NULL | String: C:\x\ax2017\Engine\xList.h ]
006C5B5E    add esp, 0x0C
006C5B61    call 0x0063BC30
006C5B66    test al, al
006C5B68    jz 0x006C5B6B                                   ; => [ Call: sub_63bc30 ]
006C5B6A    int3
006C5B6B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
