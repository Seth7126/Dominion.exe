...
005B0D07    minps xmm0, xmmword ptr ds:[ecx]                ; => [ Data: data_893680 ]
005B0D0A    movaps xmm6, xmmword ptr ds:[0x00893890]
005B0D11    movaps xmm5, xmmword ptr ds:[0x008935F0]        ; => [ Data: data_8935f0 ]
005B0D18    maxps xmm6, xmm0                                ; => [ Data: data_893890 ]
005B0D1B    movaps xmm2, xmmword ptr ds:[0x00893770]        ; => [ Data: data_893770 ]
005B0D22    xorps xmm0, xmm0
005B0D25    mulps xmm5, xmm6
005B0D28    movaps xmm7, xmmword ptr ds:[0x00893860]        ; => [ Data: data_893860 ]
005B0D2F    addps xmm5, xmmword ptr ds:[0x008934E0]         ; => [ Data: data_8934e0 ]
005B0D36    movaps xmm4, xmm5
005B0D39    movaps xmm1, xmm5
005B0D3C    andps xmm4, xmmword ptr ds:[0x008937A0]         ; => [ Data: data_8937a0 ]
005B0D43    cmpps xmm1, xmm0, 0x01                          ; => [ String: 0 | String: zx ]
005B0D47    movaps xmm3, xmm4
005B0D4A    movaps xmm0, xmmword ptr ds:[0x00893370]        ; => [ Data: data_893370 ]
...
005B0D6B    orps xmm2, xmm1                                 ; => [ Data: data_8937c0 ]
005B0D6E    movaps xmm3, xmmword ptr ds:[0x00893360]        ; => [ String: giP9giP9giP9giP9 ]
005B0D75    andps xmm2, xmm4
005B0D78    movaps xmm1, xmmword ptr ds:[0x008937C0]        ; => [ Data: data_8937c0 ]
...
005B0D90    subps xmm2, xmm5                                ; => [ Data: data_8935b0 ]
005B0D93    mulps xmm0, xmm2
005B0D96    mulps xmm7, xmm2
005B0D99    addps xmm7, xmm6
005B0D9C    addps xmm7, xmm0
005B0D9F    movaps xmm0, xmmword ptr ds:[0x008936D0]        ; => [ Data: data_8936d0 ]
...
005B0DB5    addps xmm3, xmmword ptr ds:[0x008933A0]         ; => [ Data: data_8933a0 ]
...
005B0DCE    addps xmm3, xmmword ptr ds:[0x008933E0]         ; => [ Data: data_8933e0 ]
005B0DD5    movaps xmm1, xmm2
005B0DD8    psubd xmm5, xmm2
005B0DDC    movaps xmm0, xmm4
005B0DDF    paddd xmm1, xmmword ptr ds:[0x00891970]         ; => [ Data: data_891970 ]
...
005B0DFF    pslld xmm5, 0x17                                ; => [ Data: data_891970 ]
...
005B0E22    addps xmm3, xmm0                                ; => [ Data: data_893460 | Data: data_8934e0 | Data: data_893410 ]
005B0E25    movaps xmm0, xmmword ptr ds:[0x008935B0]
005B0E2C    addps xmm0, xmm7                                ; => [ Data: data_8935b0 ]
