...
004FEF98    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FEF9D    call 0x00573400                                 ; => [ Call: sub_573400 ]
004FEFA2    push 0x00
004FEFA4    push 0x00
004FEFA6    push 0x01
...
004FEFAE    push 0x01
004FEFB0    call 0x00590760                                 ; => [ Call: sub_590760 ]
004FEFB5    add esp, 0x10
004FEFB8    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FF013    call 0x00561AF0                                 ; => [ Call: sub_561af0 ]
...
004FF035    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: SetGainFlag | String: c.activePlayer != PLAYER_NONE | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
004FF03A    add esp, 0x0C
004FF03D    call 0x0063BC30
004FF042    test al, al
004FF044    jz 0x004FF047                                   ; => [ Call: sub_63bc30 ]
004FF046    int3
004FF047    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
