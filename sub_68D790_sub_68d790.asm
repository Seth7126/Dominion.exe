...
0068D795    push 0x76E2E0                                   ; => [ Type: EHRegistrationNode | Call: sub_76e2e0 ]
0068D79A    mov eax, dword ptr fs:[0x00000000]
0068D7A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068D7AE    push eax                                        ; => [ Data: __security_cookie ]
0068D7AF    lea eax, ss:[ebp-0x0C]
0068D7B2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0068D7CC    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
0068D7E5    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
0068D816    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
0068D81B    inc dword ptr ds:[eax+0x04]
0068D81E    mov eax, ebx
0068D820    mov ecx, dword ptr ss:[ebp-0x0C]
0068D823    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068D82A    pop ecx
0068D82B    pop edi
0068D82C    pop esi
0068D82D    pop ebx
...
0068D83F    jz 0x0068D90B                                   ; => [ Call: sub_63d4e0 ]
...
0068D85C    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
0068D875    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
0068D88E    jz 0x0068D90B                                   ; => [ String: aeiou ]
0068D890    mov edx, 0x824DB4
0068D895    lea ecx, ss:[ebp-0x14]
0068D898    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: s ]
...
0068D8FD    jz 0x0068DD4B                                   ; => [ Data: data_cf65bc ]
0068D903    lea ecx, ss:[ebp-0x14]
0068D906    jmp 0x0068DD33
0068D90B    mov dword ptr ss:[ebp-0x14], 0x801800           ; => [ Data: data_801800 ]
...
0068D92B    mov edx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
0068D92E    jmp 0x0068D932
0068D930    xor edx, edx
0068D932    mov eax, dword ptr ds:[esi]
0068D934    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
...
0068D946    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
0068D94B    mov edx, 0x824E90
0068D950    lea ecx, ss:[ebp-0x18]
0068D953    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: ies ]
...
0068D9B2    jz 0x0068D9CF                                   ; => [ Data: data_cf65bc ]
0068D9B4    lea ecx, ss:[ebp-0x18]
0068D9B7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068D9CA    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068DA33    mov edx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
0068DA36    jmp 0x0068DA3A
0068DA38    xor edx, edx
0068DA3A    mov eax, dword ptr ds:[esi]
0068DA3C    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0068DA52    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: s ]
...
0068DA6D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068DABF    mov edx, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
0068DAC2    jmp 0x0068DAC6
0068DAC4    xor edx, edx
0068DAC6    mov eax, dword ptr ds:[esi]
0068DAC8    mov ecx, edi                                    ; => [ Data: data_801800 ]
...
0068DAD7    call 0x0063DB30                                 ; => [ Call: sub_63db30 ]
0068DADC    mov edx, 0x824E94
0068DAE1    lea ecx, ss:[ebp-0x18]
0068DAE4    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: ves ]
...
0068DB43    jz 0x0068DB60                                   ; => [ Data: data_cf65bc ]
0068DB45    lea ecx, ss:[ebp-0x18]
0068DB48    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068DB5B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068DB8A    jl 0x0068DC18                                   ; => [ Call: sub_63d4e0 ]
0068DB90    mov edi, dword ptr ds:[esi]
0068DB92    test edi, edi
0068DB94    jnz 0x0068DB9F
0068DB96    mov edi, 0x801800                               ; => [ Data: data_801800 ]
...
0068DBAF    mov eax, dword ptr ds:[eax+0x08]                ; => [ Call: sub_63d4e0 ]
...
0068DBC6    call 0x0063D720                                 ; => [ String: es | Call: sub_63d720 ]
...
0068DC20    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: s ]
...
0068DC7A    call 0x0063D720                                 ; => [ String: es | Call: sub_63d720 ]
...
0068DCD1    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: s ]
...
0068DD2E    jz 0x0068DD4B                                   ; => [ Data: data_cf65bc ]
0068DD30    lea ecx, ss:[ebp-0x18]
0068DD33    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068DD46    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068DD4B    mov eax, ebx
0068DD4D    mov ecx, dword ptr ss:[ebp-0x0C]
0068DD50    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
0068DD57    pop ecx
0068DD58    pop edi
0068DD59    pop esi
0068DD5A    pop ebx
