...
006E98AB    push eax
006E98AC    lea eax, ss:[ebp-0x0C]
006E98AF    mov dword ptr fs:[0x00000000], eax
006E98B5    mov esi, ecx
...
006E994B    mov dword ptr ss:[ebp+0x08], 0x801800
006E9952    mov dword ptr ss:[ebp-0x04], 0x00
006E9959    mov eax, 0x801800
006E995E    mov ecx, dword ptr ds:[esi]
006E9960    test ecx, ecx
006E9962    push edi
006E9963    cmovnz eax, ecx
006E9966    lea ecx, ss:[ebp+0x08]
006E9969    push eax
006E996A    call 0x0063DB30
006E996F    mov eax, dword ptr ds:[esi]
...
006E9981    mov ecx, dword ptr ds:[eax+0x08]
006E9984    jmp 0x006E9988
006E9986    xor ecx, ecx
006E9988    mov eax, dword ptr ds:[esi]
006E998A    mov edx, 0x801800
...
006E99E4    call 0x0064C080
006E99E9    mov ecx, dword ptr ss:[ebp-0x0C]
006E99EC    mov dword ptr fs:[0x00000000], ecx
006E99F3    pop ecx
006E99F4    pop edi
006E99F5    pop esi
006E99F6    pop ebx
...
006E9A11    call 0x0063B870
006E9A16    add esp, 0x0C
006E9A19    call 0x0063BC30
006E9A1E    test al, al
006E9A20    jz 0x006E9A23
006E9A22    int3
006E9A23    call 0x0063BB00
