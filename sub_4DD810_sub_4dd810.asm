...
004DD823    mov dword ptr ss:[esp+0xF4], eax                ; => [ Data: __security_cookie ]
004DD82A    push esi
004DD82B    push edi
...
004DD86A    call 0x004DC550                                 ; => [ Call: sub_4dc550 ]
...
004DD887    call 0x004DC830                                 ; => [ Call: sub_4dc830 ]
...
004DD8C2    jnz 0x004DD8D3                                  ; => [ String: colonies ]
...
004DD8E0    call esi                                        ; => [ String: shelters ]
...
004DD903    call 0x004DD260                                 ; => [ Type: _EXCEPTION_REGISTRATION_RECORD | Call: sub_4dd260 ]
...
004DD91B    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
...
004DD963    inc eax
004DD964    mov dword ptr ss:[esp+0x44], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004DD97E    movups xmmword ptr ds:[edi+0x10], xmm0          ; => [ Call: __builtin_memset ]
...
004DD9A7    call 0x004DD660                                 ; => [ Call: sub_4dd660 | Call: sub_4dd660 ]
...
004DDA0F    movaps xmmword ptr ss:[esp+0xB8], xmm0          ; => [ Call: __builtin_memset ]
004DDA17    call 0x004DD440                                 ; => [ Call: sub_4dd440 ]
...
004DDAB0    push 0x00
004DDAB2    push eax
004DDAB3    call 0x00761FC4                                 ; => [ Call: memset ]
...
004DDADA    call 0x004DD440                                 ; => [ Call: sub_4dd440 ]
...
004DDB28    call 0x004DC830                                 ; => [ Call: sub_4dc830 ]
...
004DDB49    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004DDB73    mov dword ptr ss:[esp+0x74], esi                ; => [ Type: _EXCEPTION_REGISTRATION_RECORD ]
...
004DDB93    push esi
004DDB94    call 0x004DD660                                 ; => [ Call: sub_4dd660 ]
004DDB99    add esp, 0x08
004DDB9C    jmp 0x004DDB16
