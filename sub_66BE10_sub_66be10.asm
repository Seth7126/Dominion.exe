...
0066BE1C    push ebx
0066BE1D    push esi
0066BE1E    mov dword ptr ds:[eax], 0x801800
0066BE24    mov esi, 0x01
0066BE29    push edi
0066BE2A    test ecx, ecx
0066BE2C    jnz 0x0066BE47
0066BE2E    push 0x874440
0066BE33    push 0xC16
0066BE38    mov edx, 0x874424
0066BE3D    mov ecx, 0x874470
0066BE42    jmp 0x0066BEFE
0066BE47    cmp dword ptr ds:[ecx+0x04], 0x22
0066BE4B    jz 0x0066BE61
0066BE4D    push 0x874440
0066BE52    push 0xC17
0066BE57    mov ecx, 0x87444C
0066BE5C    jmp 0x0066BEF9
0066BE61    call 0x005AF880
...
0066BEE8    pop ebp
0066BEE9    ret
0066BEEA    push 0x875ED4
0066BEEF    push 0x40A0
0066BEF4    mov ecx, 0x801AA4
0066BEF9    mov edx, 0x801800
0066BEFE    push 0x8739B4
0066BF03    call 0x0063B870
0066BF08    add esp, 0x0C
0066BF0B    call 0x0063BC30
0066BF10    test al, al
0066BF12    jz 0x0066BF15
0066BF14    int3
0066BF15    call 0x0063BB00
