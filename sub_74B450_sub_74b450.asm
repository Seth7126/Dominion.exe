...
0074B459    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
0074B46B    push ebx
0074B46C    call dword ptr ds:[0x007753BC]                  ; => [ Type: HDC ]
...
0074B488    push eax
0074B489    call dword ptr ds:[0x007753F0]                  ; => [ String: Wprc ]
...
0074B4A2    push ebx
0074B4A3    push 0x00
0074B4A5    call dword ptr ds:[0x007753E8]                  ; => [ Call: nullptr ]
...
0074B4C8    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074B4ED    call 0x0074B280                                 ; => [ Call: sub_74b280 ]
...
0074B50B    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
