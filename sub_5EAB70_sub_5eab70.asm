005EAB70    push ecx
005EAB71    mov eax, dword ptr ds:[0x00B604E0]
005EAB76    push esi
005EAB77    push edi
...
005EABB1    mov ecx, dword ptr ds:[0x00CC8D5C]
005EABB7    test ecx, ecx
005EABB9    jnz 0x005EABD1
005EABBB    push 0x77EB90
005EABC0    push 0x7B
005EABC2    push 0x77EB50
005EABC7    mov ecx, 0x77EB9C
...
005EAC26    mov edx, dword ptr ds:[0x00B80B08]
005EAC2C    mov ecx, dword ptr ds:[0x00B80B58]
005EAC32    mov esi, dword ptr ds:[0x00B80B18]
005EAC38    mov dword ptr ds:[0x008DB5E8], 0x3E9
005EAC42    mov dword ptr ds:[0x00B80984], eax
005EAC47    mov dword ptr ds:[0x00B8098C], ecx
005EAC4D    cmp edx, 0x9F
005EAC53    jnz 0x005EAC5D
005EAC55    mov ecx, esi
005EAC57    mov dword ptr ds:[0x00B8098C], ecx
005EAC5D    mov eax, dword ptr ds:[0x00B80B54]
005EAC62    mov byte ptr ds:[0x00B80994], 0x00
005EAC69    mov dword ptr ds:[0x00B80990], eax
005EAC6E    mov dword ptr ds:[0x00B80988], ecx
005EAC74    cmp edx, 0x06
005EAC77    jnz 0x005EAC83
005EAC79    mov dword ptr ds:[0x00B80988], esi
005EAC7F    pop edi
005EAC80    pop esi
005EAC81    pop ecx
005EAC82    ret
...
005EAC88    mov eax, dword ptr ds:[0x00B80B20]
005EAC8D    mov dword ptr ds:[0x00B80988], eax
005EAC92    pop edi
005EAC93    pop esi
005EAC94    pop ecx
005EAC95    ret
...
005EADDE    mov esi, 0xB8206C
005EADE3    cmp edi, 0x48
005EADE6    jl 0x005EADED
005EADE8    call 0x00591930
...
005EAE3A    pop ecx
005EAE3B    ret
005EAE3C    push 0x85FCE0
005EAE41    push 0x603A
005EAE46    push 0x86F1E8
005EAE4B    mov ecx, 0x801AA4
005EAE50    mov edx, 0x801800
005EAE55    call 0x0063B870
005EAE5A    add esp, 0x0C
005EAE5D    call 0x0063BC30
005EAE62    test al, al
005EAE64    jz 0x005EAE67
005EAE66    int3
005EAE67    call 0x0063BB00
