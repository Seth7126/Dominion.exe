...
0068C735    push 0x76E035                                   ; => [ Call: sub_76e035 | Type: EHRegistrationNode ]
0068C73A    mov eax, dword ptr fs:[0x00000000]
0068C740    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0068C74E    push eax                                        ; => [ Data: __security_cookie ]
0068C74F    lea eax, ss:[ebp-0x0C]
0068C752    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0068C758    mov edi, edx
0068C75A    mov ebx, ecx
0068C75C    cmp dword ptr ds:[0x0147ABFC], 0x00
0068C763    jz 0x0068C9DC                                   ; => [ Data: data_147abfc ]
0068C769    push 0x00
0068C76B    mov edx, ebx
0068C76D    lea ecx, ss:[ebp-0x10]
0068C770    call 0x0068BD30
0068C775    add esp, 0x04
0068C778    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0068C77D    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_68bd30 | Call: nullptr ]
...
0068C7B9    jz 0x0068C7E9                                   ; => [ Data: data_cf65bc ]
...
0068C7CA    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C7DD    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068C7E2    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0068C7E9    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0068C7F0    test esi, esi
0068C7F2    jz 0x0068C80D
0068C7F4    push 0x877DEC                                   ; => [ String: LookupTranslationSafe ]
0068C7F9    push 0x14B
0068C7FE    push 0x877D0C                                   ; => [ String: C:\x\ax2017\Engine\Localization.cpp ]
0068C803    mov ecx, 0x877DD4                               ; => [ String: ToKey(key, NULL) == key ]
0068C808    jmp 0x0068CA04
0068C80D    test edi, edi
0068C80F    jnz 0x0068C81C
0068C811    mov eax, dword ptr ds:[0x0147ABFC]              ; => [ Data: data_147abfc ]
...
0068C829    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
0068C846    mov esi, eax                                    ; => [ Data: data_147abfc | Call: sub_6931d0 ]
0068C848    mov dword ptr ss:[ebp-0x04], 0x01
0068C84F    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C856    jz 0x0068C87F                                   ; => [ Data: data_cf65bc ]
...
0068C867    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C87A    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0068C8D4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C914    call 0x0063D720                                 ; => [ Call: sub_63d720 ]
...
0068C931    call 0x00693230                                 ; => [ Call: sub_693230 | Data: data_147abfc ]
0068C936    mov byte ptr ss:[ebp-0x04], 0x05
0068C93A    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C941    jz 0x0068C96A                                   ; => [ Data: data_cf65bc ]
...
0068C952    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C98A    mov esi, eax                                    ; => [ Data: data_147abfc | Call: sub_6931d0 ]
0068C98C    mov byte ptr ss:[ebp-0x04], 0x06
0068C990    cmp dword ptr ds:[0x00CF65BC], 0x00
0068C997    jz 0x0068C9C0                                   ; => [ Data: data_cf65bc ]
...
0068C9A8    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0068C9BB    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068C9C0    lea ecx, ss:[ebp-0x30]
0068C9C3    call 0x004E3EA0                                 ; => [ Call: sub_4e3ea0 ]
0068C9C8    mov eax, esi
0068C9CA    mov ecx, dword ptr ss:[ebp-0x0C]
0068C9CD    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib | Field: ExceptionList | Field: NtTib ]
0068C9D4    pop ecx
0068C9D5    pop edi
0068C9D6    pop esi
0068C9D7    pop ebx
...
0068C9E1    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0068C9E8    pop ecx
0068C9E9    pop edi
0068C9EA    pop esi
0068C9EB    pop ebx
...
0068C9EE    pop ebp
0068C9EF    ret
0068C9F0    push 0x871DD4                                   ; => [ String: XString::XString ]
0068C9F5    push 0x94
0068C9FA    push 0x871D5C                                   ; => [ String: C:\x\ax2017\Engine\xString.cpp ]
0068C9FF    mov ecx, 0x871E0C                               ; => [ Data: data_871e0c ]
0068CA04    mov edx, 0x801800
0068CA09    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0068CA0E    add esp, 0x0C
0068CA11    call 0x0063BC30
0068CA16    test al, al
0068CA18    jz 0x0068CA1B                                   ; => [ Call: sub_63bc30 ]
0068CA1A    int3
0068CA1B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
