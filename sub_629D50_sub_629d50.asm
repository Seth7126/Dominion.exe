...
00629D70    mov dword ptr fs:[0x00000000], eax
...
00629D84    call 0x0063D720
00629D89    mov eax, dword ptr ss:[ebp-0x10]
00629D8C    mov edi, 0x801800
00629D91    test eax, eax
00629D93    mov ecx, edi
...
00629DE4    jz 0x00629E08
00629DE6    lea ecx, ss:[ebp-0x10]
00629DE9    call 0x0063D4E0
...
00629DFC    call 0x0064C080
00629E01    mov dword ptr ss:[ebp-0x10], 0x801800
00629E08    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00629E0F    test bl, bl
00629E11    jz 0x00629E1F
00629E13    xor dl, dl
00629E15    mov ecx, 0x05
00629E1A    call 0x004D46E0
...
00629E2D    call 0x0063D720
00629E32    mov eax, dword ptr ss:[ebp+0x08]
00629E35    mov ecx, edi
...
00629E7C    jz 0x00629EA0
00629E7E    lea ecx, ss:[ebp+0x08]
00629E81    call 0x0063D4E0
...
00629E94    call 0x0064C080
00629E99    mov dword ptr ss:[ebp+0x08], 0x801800
...
00629EB3    call 0x00761FC4
00629EB8    add esp, 0x0C
00629EBB    mov dword ptr ds:[0x008DBF38], 0x03
00629EC5    mov dword ptr ds:[0x008DBF40], esi
00629ECB    call 0x004BBDB0
00629ED0    mov edx, eax
00629ED2    mov ecx, 0x8DBF38
00629ED7    mov dword ptr ds:[eax+0x28], 0x17
00629EDE    call 0x0062B4E0
00629EE3    mov dword ptr ds:[0x008DB660], 0x10
00629EED    mov esi, dword ptr ds:[ebx+0x04]
00629EF0    lea ecx, ss:[ebp+0x08]
00629EF3    mov edx, 0x861920
00629EF8    call 0x0063D720
00629EFD    mov eax, dword ptr ss:[ebp+0x08]
00629F00    mov ecx, edi
...
00629F43    jz 0x00629F67
00629F45    lea ecx, ss:[ebp+0x08]
00629F48    call 0x0063D4E0
...
00629FBB    call 0x0064C080
00629FC0    mov dword ptr ds:[0x00BE4A38], 0x801800
00629FCA    mov dword ptr ds:[0x008DB6B0], 0x7F0
00629FD4    mov esi, dword ptr ds:[ebx+0x04]
00629FD7    lea ecx, ss:[ebp+0x08]
00629FDA    mov edx, 0x86CB10
00629FDF    call 0x0063D720
00629FE4    mov eax, dword ptr ss:[ebp+0x08]
00629FE7    mov ecx, edi
...
0062A02C    jz 0x0062A050
0062A02E    lea ecx, ss:[ebp+0x08]
0062A031    call 0x0063D4E0
...
0062A101    jz 0x0062A11E
0062A103    lea ecx, ss:[ebp+0x08]
0062A106    call 0x0063D4E0
...
0062A119    call 0x0064C080
0062A11E    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062A125    test esi, esi
0062A127    jnz 0x0062A154
0062A129    mov dword ptr ds:[0x01724A54], 0x01
0062A133    mov byte ptr ds:[0x01724A4C], 0x01
0062A13A    mov dword ptr ds:[0x01724A40], esi
0062A140    mov dword ptr ds:[0x01724A48], 0xFFFFFFFF
0062A14A    mov dword ptr ds:[0x01724A50], 0xFFFFFFFF
0062A154    mov esi, dword ptr ds:[ebx+0x04]
0062A157    lea ecx, ss:[ebp+0x08]
0062A15A    mov edx, 0x86CB28
0062A15F    call 0x0063D720
...
0062A1AC    jz 0x0062A1C9
0062A1AE    lea ecx, ss:[ebp+0x08]
0062A1B1    call 0x0063D4E0
...
0062A1C4    call 0x0064C080
0062A1C9    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0062A1D0    test esi, esi
0062A1D2    jnz 0x0062A1F5
0062A1D4    mov dword ptr ds:[0x01724A54], esi
0062A1DA    mov byte ptr ds:[0x01724A4C], 0x00
0062A1E1    mov dword ptr ds:[0x01724A48], 0xFFFFFFFF
0062A1EB    mov dword ptr ds:[0x01724A50], 0xFFFFFFFF
0062A1F5    mov ecx, ebx
0062A1F7    call 0x00629B70
0062A1FC    xor al, al
0062A1FE    mov ecx, dword ptr ss:[ebp-0x0C]
0062A201    mov dword ptr fs:[0x00000000], ecx
0062A208    pop ecx
0062A209    pop edi
0062A20A    pop esi
0062A20B    pop ebx
...
0062A226    call 0x0063B870
0062A22B    add esp, 0x0C
0062A22E    call 0x0063BC30
0062A233    test al, al
0062A235    jz 0x0062A238
0062A237    int3
0062A238    call 0x0063BB00
