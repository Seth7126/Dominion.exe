...
0073BFA0    mov dword ptr ds:[0x01A9A3FC], eax
0073BFA5    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0073BFAC    call 0x007596BD
0073BFB1    add esp, 0x04
0073BFB4    cmp dword ptr ds:[0x0147ABE8], 0x00
0073BFBB    mov ecx, dword ptr ds:[0x0147DF54]
0073BFC1    jnz 0x0073BFCD
...
0073BFDA    mov edx, dword ptr ds:[eax+0x10]
...
0073C025    movups xmmword ptr ss:[ebp-0x54], xmm0
0073C029    mov dword ptr ss:[ebp-0x40], 0x3D4CCCCD
0073C030    call 0x00643E80
...
0073C086    call 0x00682FE0
0073C08B    cmp dword ptr ds:[0x0147DF8C], 0x01
0073C092    jnz 0x0073C099
0073C094    call 0x00683CC0
0073C099    movss xmm0, dword ptr ds:[0x0147DF84]
0073C0A1    mov esi, 0x801800
0073C0A6    movss xmm1, dword ptr ds:[0x008C4634]
...
0073C0D2    push eax
0073C0D3    call 0x0063DF30
0073C0D8    mov dword ptr ss:[ebp-0x04], 0x01
0073C0DF    mov ecx, esi
...
0073C14B    call 0x0064C080
0073C150    mov dword ptr ss:[ebp-0x24], esi
0073C153    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0073C15A    mov edx, dword ptr ds:[0x0147DF48]
...
0073C17E    call 0x006A1F50
0073C183    mov dword ptr ss:[ebp-0x04], 0x03
0073C18A    mov ecx, esi
...
0073C19D    push eax
0073C19E    call 0x0063DF30
0073C1A3    mov byte ptr ss:[ebp-0x04], 0x04
0073C1A7    mov ecx, esi
...
0073C210    call 0x0064C080
0073C215    mov dword ptr ss:[ebp-0x14], 0x801800
0073C21C    mov byte ptr ss:[ebp-0x04], 0x03
0073C220    mov ecx, dword ptr ds:[0x0147DF48]
0073C226    cmp dword ptr ds:[ecx+0x04], 0x02
0073C22A    jnz 0x0073C941
0073C230    call 0x005AF880
...
0073C281    mov ecx, dword ptr ds:[0x0147DF70]
0073C287    mov dword ptr ss:[ebp-0x18], eax
0073C28A    call 0x006DB510
...
0073C2AF    push 0x88FA3C
0073C2B4    push 0x53
0073C2B6    push 0x86E34C
0073C2BB    mov ecx, 0x876FD4
0073C2C0    jmp 0x0073C982
0073C2C5    mov ecx, dword ptr ds:[0x0147DF48]
...
0073C2D6    push 0x87A528
0073C2DB    push 0x313
0073C2E0    push 0x87A2E0
0073C2E5    mov ecx, 0x87A4FC
0073C2EA    jmp 0x0073C982
0073C2EF    call 0x005AF880
0073C2F4    mov edx, dword ptr ds:[0x0147DF74]
...
0073C323    mov edx, dword ptr ds:[0x0147DF74]
0073C329    xorps xmm0, xmm0
...
0073C3A3    call 0x0064C080
0073C3A8    mov dword ptr ss:[ebp-0x1C], 0x801800
...
0073C3FE    call 0x0064C080
0073C403    mov dword ptr ss:[ebp-0x18], 0x801800
0073C40A    mov byte ptr ss:[ebp-0x04], 0x06
0073C40E    mov ecx, esi
...
0073C45A    jz 0x0073C47E
0073C45C    lea ecx, ss:[ebp-0x14]
0073C45F    call 0x0063D4E0
...
0073C4B5    call 0x0064C080
0073C4BA    mov dword ptr ss:[ebp-0x28], 0x801800
0073C4C1    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0073C4C8    mov edx, dword ptr ds:[0x0147DF48]
...
0073C4E4    call 0x006A1F50
0073C4E9    mov dword ptr ss:[ebp-0x04], 0x0D
0073C4F0    mov ecx, esi
...
0073C503    push eax
0073C504    call 0x0063DF30
0073C509    mov byte ptr ss:[ebp-0x04], 0x0E
0073C50D    mov ecx, esi
...
0073C576    call 0x0064C080
0073C57B    mov dword ptr ss:[ebp-0x14], 0x801800
0073C582    mov dword ptr ss:[ebp-0x04], 0x10
0073C589    cmp dword ptr ds:[0x00CF65BC], 0x00
0073C590    jz 0x0073C5C0
...
0073C5B4    call 0x0064C080
0073C5B9    mov dword ptr ss:[ebp-0x2C], 0x801800
0073C5C0    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
0073C5C7    cmp dword ptr ds:[0x0147ABE8], 0x00
0073C5CE    mov ecx, dword ptr ds:[0x0147DF4C]
0073C5D4    jz 0x0073C99B
0073C5DA    mov eax, dword ptr ds:[0x0147ABE8]
0073C5DF    mov eax, dword ptr ds:[eax+0x0C]
...
0073C61E    call 0x005AF880
0073C623    mov esi, 0x801800
0073C628    mov dword ptr ss:[ebp-0x28], eax
0073C62B    mov dword ptr ss:[ebp-0x24], esi
0073C62E    xor ecx, ecx
0073C630    mov dword ptr ss:[ebp-0x04], 0x11
0073C637    mov dword ptr ss:[ebp-0x34], 0xFFFFFFFF
0073C63E    mov dword ptr ss:[ebp-0x2C], ecx
0073C641    cmp dword ptr ds:[eax+0x08], ecx
0073C644    jle 0x0073C6B5
0073C646    mov dword ptr ss:[ebp-0x14], ecx
...
0073C6ED    push eax
0073C6EE    call 0x0063DF30
0073C6F3    mov byte ptr ss:[ebp-0x04], 0x13
0073C6F7    mov ecx, 0x801800
...
0073C80D    call 0x0064C080
0073C812    mov dword ptr ss:[ebp-0x30], 0x801800
0073C819    mov byte ptr ss:[ebp-0x04], 0x16
0073C81D    cmp dword ptr ds:[0x00CF65BC], 0x00
0073C824    jz 0x0073C854
...
0073C848    call 0x0064C080
0073C84D    mov dword ptr ss:[ebp-0x18], 0x801800
0073C854    mov byte ptr ss:[ebp-0x04], 0x17
0073C858    cmp dword ptr ds:[0x00CF65BC], 0x00
0073C85F    jz 0x0073C88F
...
0073C883    call 0x0064C080
0073C888    mov dword ptr ss:[ebp-0x1C], 0x801800
...
0073C8A6    jz 0x0073C8C3
0073C8A8    lea ecx, ss:[ebp-0x24]
0073C8AB    call 0x0063D4E0
