...
00615BCA    push edi
00615BCB    call 0x005CC5E0                                 ; => [ Call: sub_5cc5e0 ]
...
00615BE3    jnz 0x00615BED                                  ; => [ Data: data_8db5c4 ]
00615BE5    mov edi, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
00615BEB    jmp 0x00615BFD
00615BED    xor edi, edi
00615BEF    cmp dword ptr ds:[0x008DB5D4], 0x27
00615BF6    cmovz edi, dword ptr ds:[0x008DB5D8]            ; => [ Data: data_8db5d4 | Data: data_8db5d8 ]
...
00615C1D    mov edx, dword ptr ds:[0x0171E738]              ; => [ Data: data_171e738 ]
00615C23    jmp 0x00615C3B
00615C25    mov edx, dword ptr ds:[0x0171E72C]              ; => [ Data: data_171e72c ]
00615C2B    jmp 0x00615C3B
00615C2D    mov edx, dword ptr ds:[0x0171E730]              ; => [ Data: data_171e730 ]
00615C33    jmp 0x00615C3B
00615C35    mov edx, dword ptr ds:[0x0171E73C]              ; => [ Data: data_171e73c ]
00615C3B    push 0x00
00615C3D    push ecx
00615C3E    call 0x005AF930                                 ; => [ Call: sub_5af930 ]
...
00615C56    mov eax, 0x868768                               ; => [ String: anim_coin ]
00615C5B    jmp 0x00615C70
00615C5D    mov eax, 0x86875C                               ; => [ String: anim_action ]
00615C62    jmp 0x00615C70
00615C64    mov eax, 0x868780                               ; => [ String: anim_buy ]
00615C69    jmp 0x00615C70
00615C6B    mov eax, 0x868774                               ; => [ String: anim_potion ]
00615C70    mov ecx, 0x1A96580
00615C75    push eax
00615C76    lea eax, ds:[esi+esi*8]
00615C79    push edi
00615C7A    lea ecx, ds:[ecx+eax*4]
00615C7D    call 0x004BB9F0                                 ; => [ Call: sub_4bb9f0 ]
00615C82    test eax, eax
00615C84    jz 0x00615CA1
00615C86    mov edx, 0x86879C                               ; => [ String: gain_resource ]
00615C8B    push 0x01
00615C8D    push ecx
00615C8E    mov ecx, eax
00615C90    test ebx, ebx
00615C92    jnle 0x00615C99
00615C94    mov edx, 0x86878C                               ; => [ String: lose_resource ]
00615C99    call 0x0067CD20                                 ; => [ Call: sub_67cd20 ]
...
00615CC0    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DomGainResource | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: pgui.resources[resource] >= 0 ]
00615CC5    add esp, 0x0C
00615CC8    call 0x0063BC30
00615CCD    test al, al
00615CCF    jz 0x00615CD2                                   ; => [ Call: sub_63bc30 ]
00615CD1    int3
00615CD2    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
