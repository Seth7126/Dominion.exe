...
004AF749    mov eax, dword ptr ds:[0x008C4040]
...
004AF7AA    mov eax, dword ptr ds:[0x00CC8D5C]
...
004AF8E1    push 0x801C00
004AF8E6    push 0x317
004AF8EB    push 0x801AF8
004AF8F0    mov ecx, 0x801AA4
004AF8F5    jmp 0x004AFAC9
004AF8FA    mov eax, dword ptr ds:[0x00CC8D5C]
004AF8FF    test eax, eax
004AF901    jz 0x004AFAB8
004AF907    cmp dword ptr ds:[eax+0x5068], 0x00
004AF90E    jz 0x004AFA96
004AF914    call 0x004B9480
004AF919    cmp dword ptr ds:[0x008DB664], 0x7EC
004AF923    jnz 0x004AF936
004AF925    xor dl, dl
004AF927    mov ecx, 0x05
004AF92C    call 0x004D46E0
004AF931    jmp 0x004AFA96
004AF936    cmp dword ptr ds:[0x00BE220C], 0x00
004AF93D    jz 0x004AF94F
004AF93F    mov dword ptr ds:[0x00BE220C], 0x00
004AF949    mov byte ptr ds:[0x00B7D418], bl
004AF94F    call 0x005CB070
...
004AFAAD    pop esi
004AFAAE    pop ebx
004AFAAF    call 0x0075927A
004AFAB4    mov esp, ebp
004AFAB6    pop ebp
004AFAB7    ret
004AFAB8    push 0x77EB90
004AFABD    push 0x7B
004AFABF    mov ecx, 0x77EB9C
004AFAC4    push 0x77EB50
004AFAC9    mov edx, 0x801800
004AFACE    call 0x0063B870
004AFAD3    add esp, 0x0C
004AFAD6    call 0x0063BC30
004AFADB    test al, al
004AFADD    jz 0x004AFAE0
004AFADF    int3
004AFAE0    call 0x0063BB00
