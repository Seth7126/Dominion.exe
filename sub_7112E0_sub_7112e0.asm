...
00711353    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00711359    push edi
0071135A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00711360    mov edi, dword ptr ds:[esi+0x70]
00711363    push dword ptr ds:[edi+0x08]
00711366    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071136C    push edi
0071136D    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00711373    push dword ptr ds:[esi+0x74]
00711376    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071137C    push esi
0071137D    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
007113BE    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007113C4    push esi
007113C5    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007113CB    mov esi, dword ptr ds:[edi+0x70]
007113CE    push dword ptr ds:[esi+0x08]
007113D1    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007113D7    push esi
007113D8    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007113DE    push dword ptr ds:[edi+0x74]
007113E1    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
007113E7    push edi
007113E8    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
...
00711415    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071141B    mov esi, dword ptr ds:[ebx+0x24]
0071141E    push dword ptr ds:[esi+0x04]
00711421    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00711427    push esi
00711428    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
0071142E    push dword ptr ds:[ebx+0x20]
00711431    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00711437    push dword ptr ds:[ebx+0x28]
0071143A    call dword ptr ds:[0x00800B48]                  ; => [ Call: free ]
00711440    push ebx
