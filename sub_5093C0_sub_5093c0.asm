...
005093C4    call 0x00573400                                 ; => [ Call: sub_573400 ]
005093C9    cmp dword ptr ds:[eax], 0x05
005093CC    jz 0x005093E4
005093CE    push 0x81EF48                                   ; => [ String: DomAchievementDataGet ]
005093D3    push 0x1CB1
005093D8    push 0x81EA70                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCardUtils.cpp ]
005093DD    mov ecx, 0x80AEA0                               ; => [ String: c.contextType == CONTEXT_ACHIEVEMENT ]
...
005093FC    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
005093FF    cmp esi, 0x320
00509405    jb 0x0050940C
00509407    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00509424    call 0x00509340                                 ; => [ Call: sub_509340 ]
...
0050943A    pop ebp
0050943B    ret
0050943C    push 0x80AF14                                   ; => [ String: Remodel_Achievement_OnTrash ]
00509441    push 0x2E7
00509446    push 0x80AE10                                   ; => [ String: C:\x\ax2017\Jams\Dominion\code\DomCards_Base.cpp ]
0050944B    mov ecx, 0x80AE74                               ; => [ String: numCards == 1 ]
00509450    mov edx, 0x801800
00509455    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0050945A    add esp, 0x0C
0050945D    call 0x0063BC30
00509462    test al, al
00509464    jz 0x00509467                                   ; => [ Call: sub_63bc30 ]
00509466    int3
00509467    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
