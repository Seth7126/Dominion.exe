...
005E0E15    mov dword ptr fs:[0x00000000], eax
005E0E1B    mov ebx, edx
005E0E1D    mov dword ptr ss:[ebp-0x50], ecx
005E0E20    cmp byte ptr ds:[0x00B809DC], 0x00
...
005E0F02    push eax
005E0F03    call 0x00759288
005E0F08    mov dword ptr ss:[ebp-0x04], ebx
005E0F0B    mov edx, 0xBE3678
...
005E0FB1    mov eax, dword ptr ds:[eax]
005E0FB3    mov edx, 0x801800
005E0FB8    test eax, eax
005E0FBA    cmovnz edx, eax
005E0FBD    call 0x004D47C0
...
005E0FD1    mov edx, 0x801800
005E0FD6    mov ecx, 0x801800
...
005E1047    jz 0x005E106B
005E1049    lea ecx, ss:[ebp-0x3C]
005E104C    call 0x0063D4E0
...
005E105F    call 0x0064C080
005E1064    mov dword ptr ss:[ebp-0x3C], 0x801800
005E106B    mov byte ptr ss:[ebp-0x04], 0x04
005E106F    cmp dword ptr ds:[0x00CF65BC], 0x00
005E1076    jz 0x005E10A6
...
005E109A    call 0x0064C080
005E109F    mov dword ptr ss:[ebp-0x44], 0x801800
005E10A6    inc edi
005E10A7    mov byte ptr ss:[ebp-0x04], 0x00
005E10AB    cmp edi, ebx
005E10AD    jl 0x005E0F70
005E10B3    mov esi, 0x801800
005E10B8    mov dword ptr ss:[ebp-0x3C], esi
...
005E110E    mov eax, dword ptr ds:[eax]
005E1110    mov edx, 0x801800
005E1115    test eax, eax
005E1117    cmovnz edx, eax
005E111A    call 0x004D47C0
...
005E115D    jz 0x005E1181
005E115F    lea ecx, ss:[ebp-0x44]
005E1162    call 0x0063D4E0
...
005E1175    call 0x0064C080
005E117A    mov dword ptr ss:[ebp-0x44], 0x801800
005E1181    mov byte ptr ss:[ebp-0x04], 0x09
005E1185    cmp dword ptr ds:[0x00CF65BC], 0x00
005E118C    jz 0x005E11B5
...
005E11F7    mov ecx, 0x801800
005E11FC    mov eax, dword ptr ds:[eax]
005E11FE    mov edx, 0x801800
...
005E1227    mov edi, 0x801800
005E122C    cmovnz edi, esi
005E122F    mov edx, 0x801800
...
005E124D    jz 0x005E126A
005E124F    lea ecx, ss:[ebp-0x3C]
005E1252    call 0x0063D4E0
...
005E12B5    call 0x0064C080
005E12BA    mov dword ptr ss:[ebp-0x44], 0x801800
005E12C1    mov byte ptr ss:[ebp-0x04], 0x0D
005E12C5    cmp dword ptr ds:[0x00CF65BC], 0x00
005E12CC    jz 0x005E12FC
...
005E12F0    call 0x0064C080
005E12F5    mov dword ptr ss:[ebp-0x48], 0x801800
...
005E1339    jz 0x005E1356
005E133B    lea ecx, ss:[ebp-0x3C]
005E133E    call 0x0063D4E0
...
005E1369    push eax
005E136A    call 0x007592FC
005E136F    mov ecx, dword ptr ss:[ebp-0x0C]
005E1372    mov dword ptr fs:[0x00000000], ecx
005E1379    pop ecx
005E137A    pop edi
005E137B    pop esi
005E137C    pop ebx
...
005E13A4    call 0x0063B870
005E13A9    add esp, 0x0C
005E13AC    call 0x0063BC30
005E13B1    test al, al
005E13B3    jz 0x005E13B6
005E13B5    int3
005E13B6    call 0x0063BB00
