...
0056E388    push 0x7673F8                                   ; => [ Type: EHRegistrationNode | Call: sub_7673f8 ]
0056E38D    mov eax, dword ptr fs:[0x00000000]
0056E393    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0056E394    push ebx
...
0056E3A5    push esi
0056E3A6    push edi
0056E3A7    push eax                                        ; => [ Data: __security_cookie ]
0056E3A8    lea eax, ss:[ebp-0x0C]
0056E3AB    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0056E3B1    mov esi, edx
0056E3B3    mov edi, ecx
0056E3B5    call 0x00573400                                 ; => [ Call: sub_573400 ]
0056E3BA    push 0x00
0056E3BC    push 0x00
0056E3BE    push 0x00
...
0056E3C6    push 0x2A
0056E3C8    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
0056E3FD    movlpd qword ptr ss:[ebp-0xAC], xmm0            ; => [ Call: __builtin_memset ]
...
0056E459    mov dword ptr ss:[ebp-0x54], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_e8c79b90763ca2c426eadc8fe5725b23>, void>::VTable ]
...
0056E46C    mov dword ptr ss:[ebp-0x78], 0x81EFFC           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_e8c79b90763ca2c426eadc8fe5725b23>, void>::`vftable'{for `std::_Func_base<void>'} ]
...
0056E48F    mov dword ptr ss:[ebp-0x48], 0x81EFE0           ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_154e1df5e7a9985a98aae7f00e5d7048>, void>::VTable | Data: std::_Func_impl_no_alloc<class <lambda_154e1df5e7a9985a98aae7f00e5d7048>, void>::`vftable'{for `std::_Func_base<void>'} ]
0056E496    mov dword ptr ss:[ebp-0x24], eax                ; => [ Type: std::_Func_base<void>::std::_Func_impl_no_alloc<class <lambda_154e1df5e7a9985a98aae7f00e5d7048>, void>::VTable ]
...
0056E4C6    call 0x0056A100                                 ; => [ Call: sub_56a100 ]
...
0056E4DF    push 0x30
0056E4E1    push eax
0056E4E2    call 0x007592FC                                 ; => [ Call: `eh vector vbase constructor iterator' | Call: sub_4f8780 ]
0056E4E7    sub esi, 0x01
0056E4EA    jnz 0x0056E3F0
0056E4F0    jmp 0x0056E507
0056E4F2    call 0x00573400                                 ; => [ Call: sub_573400 ]
0056E4F7    push esi
0056E4F8    push edi
0056E4F9    mov edx, dword ptr ds:[eax+0x0C]
0056E4FC    mov ecx, dword ptr ds:[eax+0x04]
0056E4FF    call 0x00589340                                 ; => [ Call: sub_589340 ]
0056E504    add esp, 0x08
0056E507    mov ecx, dword ptr ss:[ebp-0x0C]
0056E50A    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0056E511    pop ecx
0056E512    pop edi
0056E513    pop esi
0056E514    mov ecx, dword ptr ss:[ebp-0x14]
0056E517    xor ecx, ebp
0056E519    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
