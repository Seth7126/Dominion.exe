...
004DE14D    call 0x004DC550                                 ; => [ Call: sub_4dc550 ]
...
004DE167    call 0x004DC830                                 ; => [ Call: sub_4dc830 ]
...
004DE18A    push edi
004DE18B    call dword ptr ds:[0x00775674]                  ; => [ String: Landscapes ]
...
004DE1AC    call 0x004DE040                                 ; => [ Call: sub_4de040 ]
...
004DE1C8    push edi
004DE1C9    call dword ptr ds:[0x00775674]                  ; => [ String: Events ]
...
004DE1EA    call 0x004DE040                                 ; => [ Call: sub_4de040 ]
...
004DE206    push edi
004DE207    call dword ptr ds:[0x00775674]                  ; => [ String: Landmarks ]
...
004DE228    call 0x004DE040                                 ; => [ Call: sub_4de040 ]
...
004DE244    push edi
004DE245    call dword ptr ds:[0x00775674]                  ; => [ String: Projects ]
...
004DE266    call 0x004DE040                                 ; => [ Call: sub_4de040 ]
...
004DE282    push edi
004DE283    call dword ptr ds:[0x00775674]                  ; => [ String: Ways ]
...
004DE2A4    call 0x004DE040                                 ; => [ Call: sub_4de040 ]
...
004DE2C0    push edi
004DE2C1    call dword ptr ds:[0x00775674]                  ; => [ String: Traits ]
...
004DE2E2    call 0x004DE040                                 ; => [ Call: sub_4de040 ]
...
004DE30A    jnz 0x004DE318                                  ; => [ String: Ally ]
...
004DE32A    jnz 0x004DE338                                  ; => [ String: Prophecy ]
...
004DE34A    jnz 0x004DE35B                                  ; => [ String: Colonies ]
...
004DE36D    jnz 0x004DE37E                                  ; => [ String: NoColonies ]
...
004DE390    jnz 0x004DE3A1                                  ; => [ String: Shelters ]
...
004DE3B3    jnz 0x004DE3C4                                  ; => [ String: NoShelters ]
...
004DE3D6    jnz 0x004DE3EF                                  ; => [ String: Attacks ]
...
004DE401    jnz 0x004DE41A                                  ; => [ String: NoAttacks ]
...
004DE42C    jnz 0x004DE442                                  ; => [ String: AttackReaction ]
...
004DE454    jnz 0x004DE45F                                  ; => [ String: ExtraActions ]
...
004DE471    jnz 0x004DE47C                                  ; => [ String: ExtraCards ]
...
004DE48E    jnz 0x004DE499                                  ; => [ String: ExtraBuys ]
...
004DE4AB    jnz 0x004DE4B4                                  ; => [ String: Trashing ]
...
004DE4C0    call 0x004DC830                                 ; => [ Call: sub_4dc830 ]
