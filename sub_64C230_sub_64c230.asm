...
0064C252    mov dword ptr fs:[0x00000000], eax
...
0064C293    mov dword ptr ss:[ebp-0x10], 0x801800
0064C29A    push eax
0064C29B    push esi
0064C29C    lea ecx, ss:[ebp-0x10]
0064C29F    call 0x0063DB30
0064C2A4    mov dword ptr ss:[ebp-0x04], 0x00
0064C2AB    mov ecx, 0x801800
0064C2B0    mov edx, dword ptr ds:[edi]
0064C2B2    mov eax, 0x801800
...
0064C2D8    jz 0x0064C2F4
0064C2DA    mov ecx, edi
0064C2DC    call 0x0063D4E0
...
0064C320    jz 0x0064C344
0064C322    lea ecx, ss:[ebp-0x10]
0064C325    call 0x0063D4E0
...
0064C338    call 0x0064C080
0064C33D    mov dword ptr ss:[ebp-0x10], 0x801800
...
0064C374    inc ebx
0064C375    push esi
0064C376    call 0x0063D8D0
0064C37B    mov eax, ebx
0064C37D    mov ecx, dword ptr ss:[ebp-0x0C]
0064C380    mov dword ptr fs:[0x00000000], ecx
0064C387    pop ecx
0064C388    pop edi
0064C389    pop esi
0064C38A    pop ebx
...
0064C3A8    call 0x0063B870
0064C3AD    add esp, 0x0C
0064C3B0    call 0x0063BC30
0064C3B5    test al, al
0064C3B7    jz 0x0064C3BA
0064C3B9    int3
0064C3BA    call 0x0063BB00
