...
0069F745    call 0x0064C080
0069F74A    mov dword ptr ds:[esi+0x0C], 0x801800
0069F751    mov byte ptr ss:[ebp-0x04], 0x02
0069F755    cmp dword ptr ds:[0x00CF65BC], 0x00
0069F75C    jz 0x0069F78C
...
0069F780    call 0x0064C080
0069F785    mov dword ptr ss:[ebp-0x10], 0x801800
0069F78C    mov dword ptr ss:[ebp-0x04], 0x03
0069F793    cmp dword ptr ds:[0x00CF65BC], 0x00
0069F79A    jz 0x0069F7C3
...
0069F7BE    call 0x0064C080
0069F7C3    mov eax, esi
0069F7C5    mov ecx, dword ptr ss:[ebp-0x0C]
0069F7C8    mov dword ptr fs:[0x00000000], ecx
0069F7CF    pop ecx
0069F7D0    pop edi
0069F7D1    pop esi
...
0069F7EF    call 0x0063B870
0069F7F4    add esp, 0x0C
0069F7F7    call 0x0063BC30
0069F7FC    test al, al
0069F7FE    jz 0x0069F801
0069F800    int3
0069F801    call 0x0063BB00
