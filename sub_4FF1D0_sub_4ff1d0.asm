...
004FF1DB    call 0x00761E50
004FF1E0    mov eax, dword ptr ds:[0x008C4040]
004FF1E5    xor eax, esp
004FF1E7    mov dword ptr ss:[esp+0x2604], eax
004FF1EE    push esi
004FF1EF    push edi
004FF1F0    call 0x00573400
004FF1F5    push 0x0C
004FF1F7    push 0x00
