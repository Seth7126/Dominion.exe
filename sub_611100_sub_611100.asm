...
00611105    push 0x76B155                                   ; => [ Call: __ehhandler$??$common_set_report_hook@_WP6AHHPA_WPAH@Z@@YAHHQ6AHHPA_WPAH@Z@Z | Type: EHRegistrationNode ]
0061110A    mov eax, dword ptr fs:[0x00000000]
00611110    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0061111E    push eax                                        ; => [ Data: __security_cookie ]
0061111F    lea eax, ss:[ebp-0x0C]
00611122    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
00611156    call 0x004C89A0                                 ; => [ Call: sub_4c89a0 ]
0061115B    mov ecx, dword ptr ds:[esi+0x04]
0061115E    mov edx, eax
00611160    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
00611165    test eax, eax
00611167    jnz 0x00611174
00611169    mov ecx, dword ptr ds:[esi+0x04]
0061116C    lea edx, ds:[eax+0x01]
0061116F    call 0x0068C730                                 ; => [ Call: sub_68c730 ]
00611174    mov dword ptr ss:[ebp+0x08], 0x801800           ; => [ Data: data_801800 ]
...
006111A6    call 0x0063D850                                 ; => [ Call: sub_63df30 | String: missing{br}%s | Call: sub_63d850 ]
006111AB    mov byte ptr ss:[ebp-0x04], 0x02
006111AF    cmp dword ptr ds:[0x00CF65BC], 0x00
006111B6    jz 0x006111DF                                   ; => [ Data: data_cf65bc ]
...
006111C7    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00611221    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00611226    mov eax, dword ptr ds:[eax]                     ; => [ String: {coin_%d_ok} | Call: sub_63df30 ]
00611228    mov ecx, edx                                    ; => [ Data: data_801800 ]
...
0061124E    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
00611253    mov byte ptr ss:[ebp-0x04], 0x05
00611257    cmp dword ptr ds:[0x00CF65BC], 0x00
0061125E    jz 0x0061128E                                   ; => [ Data: data_cf65bc ]
...
0061126F    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00611282    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00611287    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006112A6    mov edx, 0x801800                               ; => [ Data: data_801800 ]
006112AB    mov eax, dword ptr ds:[eax]                     ; => [ String: %d{coin_N_ok} | Call: sub_63df30 ]
006112AD    mov ecx, edx                                    ; => [ Data: data_801800 ]
...
006112D3    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
006112D8    mov byte ptr ss:[ebp-0x04], 0x09
006112DC    cmp dword ptr ds:[0x00CF65BC], 0x00
006112E3    jz 0x00611313                                   ; => [ Data: data_cf65bc ]
...
006112F4    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00611307    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0061130C    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
00611327    push eax
00611328    call 0x0063DF30                                 ; => [ String: %d | Call: sub_63df30 ]
0061132D    mov byte ptr ss:[ebp-0x04], 0x0B
00611331    mov edx, 0x801800                               ; => [ Data: data_801800 ]
00611336    mov eax, dword ptr ss:[ebp-0x14]
00611339    mov ecx, edx                                    ; => [ Data: data_801800 ]
...
0061135F    call 0x0063D850                                 ; => [ Call: sub_63dfa0 | Call: sub_63d850 ]
00611364    mov byte ptr ss:[ebp-0x04], 0x0D
00611368    cmp dword ptr ds:[0x00CF65BC], 0x00
0061136F    jz 0x0061139F                                   ; => [ Data: data_cf65bc ]
...
00611380    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00611393    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00611398    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0061139F    mov byte ptr ss:[ebp-0x04], 0x0E
006113A3    cmp dword ptr ds:[0x00CF65BC], 0x00
006113AA    jz 0x006113D3                                   ; => [ Data: data_cf65bc ]
...
006113BB    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006113CE    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0061140A    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0061141D    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00611422    mov ecx, dword ptr ss:[ebp-0x0C]
00611425    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0061142C    pop ecx
0061142D    pop edi
0061142E    pop esi
0061142F    pop ebx
...
0061144D    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: DeclareOkButton | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: def.type == okType ]
00611452    add esp, 0x0C
00611455    call 0x0063BC30
0061145A    test al, al
0061145C    jz 0x0061145F                                   ; => [ Call: sub_63bc30 ]
0061145E    int3
0061145F    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
