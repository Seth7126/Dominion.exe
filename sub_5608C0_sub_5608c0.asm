...
005608D4    test al, al
005608D6    jnz 0x0056095F                                  ; => [ Call: sub_567520 ]
005608DC    call 0x00573400                                 ; => [ Call: sub_573400 ]
005608E1    movzx esi, si
005608E4    mov ebx, dword ptr ds:[eax+0x04]
005608E7    cmp esi, 0x320
005608ED    jb 0x005608F4
005608EF    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0056090F    test al, al
00560911    jz 0x0056095F                                   ; => [ Call: sub_5754f0 ]
00560913    call 0x00573400
00560918    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0056091B    cmp esi, 0x320
00560921    jb 0x0056093E
00560923    call 0x00591930                                 ; => [ Call: sub_591930 ]
00560928    mov esi, dword ptr ds:[ebx+edi*1+0x1A58]
0056092F    call 0x00573400
00560934    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
00560937    call 0x00591930                                 ; => [ Call: sub_591930 ]
0056093C    jmp 0x0056094D
0056093E    mov esi, dword ptr ds:[ebx+edi*1+0x1A58]
00560945    call 0x00573400
0056094A    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
