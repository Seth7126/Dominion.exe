...
005849C6    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005849E3    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
00584A0C    call 0x00571B30                                 ; => [ Call: sub_571b30 ]
00584A11    push ecx
...
00584A22    call 0x00576C00                                 ; => [ Call: sub_576c00 ]
00584A27    add esp, 0x08
00584A2A    mov byte ptr ss:[ebp-0x09], 0x00
00584A2E    mov ecx, esi
00584A30    call 0x00576CE0                                 ; => [ Call: sub_576ce0 ]
...
00584A4B    call 0x00573050                                 ; => [ Call: sub_573050 ]
...
00584A63    push eax
00584A64    call 0x00576C00                                 ; => [ Call: sub_576c00 ]
00584A69    mov eax, dword ptr fs:[0x0000002C]
00584A6F    add esp, 0x10
00584A72    mov ecx, dword ptr ds:[eax]                     ; => [ Type: TEB | Field: ThreadLocalStoragePointer ]
...
00584A8F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00584AA1    call 0x00590C70                                 ; => [ Call: sub_590c70 ]
00584AA6    add esp, 0x04
00584AA9    test eax, eax
00584AAB    jnz 0x00584A85                                  ; => [ Call: sub_590c70 ]
00584AAD    push 0x3EC
...
00584ACB    pop ebx
00584ACC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
00584AEE    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: cs.numContexts > 0 | Data: data_801800 | String: C:\x\ax2017\Jams\Dominion\code\DomGame.cpp | String: DomPopContext ]
00584AF3    add esp, 0x0C
00584AF6    call 0x0063BC30
00584AFB    test al, al
00584AFD    jz 0x00584B00                                   ; => [ Call: sub_63bc30 ]
00584AFF    int3
00584B00    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
