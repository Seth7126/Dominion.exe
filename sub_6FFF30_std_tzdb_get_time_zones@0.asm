...
006FFF51    mov dword ptr fs:[0x00000000], eax
...
006FFF67    push 0x88C880
006FFF6C    push 0x602
006FFF71    push 0x88C504
006FFF76    mov ecx, 0x87BD38
...
006FFF8B    push 0x88C880
006FFF90    push 0x603
006FFF95    push 0x88C504
006FFF9A    mov ecx, 0x87BD14
...
0070000F    call 0x0064C080
00700014    mov dword ptr ss:[ebp+0x0C], 0x801800
...
00700076    push 0x88C880
0070007B    push 0x60A
00700080    mov ecx, 0x88C90C
...
007000A4    mov dword ptr ss:[ebp-0x1C], 0x00
...
007000BC    movups xmm0, xmmword ptr ds:[eax]
...
00700195    call 0x006FF830
0070019A    mov ecx, dword ptr ds:[0x0147DED4]
...
0070021C    mov dword ptr fs:[0x00000000], ecx
00700223    pop ecx
00700224    pop edi
00700225    pop esi
...
00700228    pop ebp
00700229    ret 0x0C
0070022C    push 0x828280
00700231    push 0x19
00700233    push 0x82829C
00700238    mov ecx, 0x8282BC
0070023D    mov edx, 0x801800
00700242    call 0x0063B870
00700247    add esp, 0x0C
0070024A    call 0x0063BC30
0070024F    test al, al
00700251    jz 0x00700254
00700253    int3
00700254    call 0x0063BB00
00700259    push 0x88D514
0070025E    push 0x6D
00700260    push 0x80193C
00700265    mov ecx, 0x802748
0070026A    jmp 0x00700280
0070026C    push 0x88C880
00700271    push 0x60D
00700276    mov ecx, 0x87BD84
0070027B    push 0x88C504
00700280    mov edx, 0x801800
00700285    call 0x0063B870
0070028A    add esp, 0x0C
0070028D    call 0x0063BC30
00700292    test al, al
00700294    jz 0x00700297
00700296    int3
00700297    call 0x0063BB00
