...
00704DA4    call dword ptr ds:[0x007753C0]
...
00704DBF    mov dword ptr ss:[esp+0x2C], eax
00704DC3    mov eax, esp
00704DC5    mov dword ptr ss:[esp+0x28], ecx
00704DC9    mov ecx, edi
00704DCB    mov dword ptr ss:[esp+0x20], 0x00
00704DD3    mov dword ptr ss:[esp+0x24], 0x00
00704DDB    movups xmm0, xmmword ptr ss:[esp+0x20]
...
00704DEC    call dword ptr ds:[0x007751F4]
