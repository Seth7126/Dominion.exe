...
0054C648    call 0x00761E50                                 ; => [ Call: __chkstk ]
0054C64D    mov eax, dword ptr ds:[0x008C4040]
0054C652    xor eax, ebp
0054C654    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
0054C657    push esi
...
0054C67A    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_568780 ]
0054C67C    xor edx, edx
0054C67E    lea ecx, ss:[ebp-0xC88]
0054C684    call 0x00561A00                                 ; => [ Call: nullptr | Call: sub_561a00 ]
...
0054C698    pop esi
0054C699    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
