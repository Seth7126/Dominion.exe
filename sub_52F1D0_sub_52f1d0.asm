...
0052F1E1    mov dword ptr ss:[esp+0x14], eax                ; => [ Call: sub_56b800 ]
0052F1E5    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052F1EA    mov esi, dword ptr ss:[esp+0x14]
0052F1EE    mov edi, eax
0052F1F0    call 0x00573400
0052F1F5    movzx esi, si
0052F1F8    mov ebx, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
0052F1FB    cmp esi, 0x320
0052F201    jb 0x0052F208
0052F203    call 0x00591930                                 ; => [ Call: sub_591930 ]
...
0052F22B    call 0x005716D0                                 ; => [ Call: sub_5716d0 ]
...
0052F255    mov dword ptr ds:[eax], 0x8191C0                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_0f13ddf92200a284c2ed65f792062fab>, void>::`vftable'{for `std::_Func_base<void>'} ]
0052F25B    mov dword ptr ds:[eax+0x08], edx
0052F25E    mov dword ptr ds:[eax+0x24], eax
0052F261    call 0x00569B30                                 ; => [ Call: sub_569b30 ]
0052F266    add esp, 0x28
0052F269    call 0x00573400
0052F26E    mov eax, dword ptr ds:[eax+0x04]
0052F271    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
0052F2A5    push 0x00                                       ; => [ Call: __builtin_memset ]
0052F2A7    push 0xFFFFFFFF
0052F2A9    setz cl
0052F2AC    call 0x0061B1B0                                 ; => [ Call: sub_61b1b0 ]
0052F2B1    add esp, 0x2C
0052F2B4    cmp dword ptr ss:[esp+0x10], 0xFFFFFFFF
0052F2B9    jz 0x0052F31A
0052F2BB    call 0x00573400                                 ; => [ Call: sub_573400 ]
0052F2C0    push 0x00
0052F2C2    push 0x00
0052F2C4    push 0xC3D
...
0052F2CF    push 0x2D
0052F2D1    call 0x00576B30                                 ; => [ Call: sub_576b30 ]
...
0052F306    mov dword ptr ds:[eax], 0x8191A4                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_745907079bf92016103870c34dab2cf8>, void>::`vftable'{for `std::_Func_base<void>'} ]
0052F30C    mov dword ptr ds:[eax+0x0C], edx
0052F30F    mov dword ptr ds:[eax+0x24], eax
0052F312    call 0x005698B0                                 ; => [ Call: sub_5698b0 ]
0052F317    add esp, 0x28
0052F31A    call 0x00573400
0052F31F    pop edi
0052F320    pop esi
0052F321    pop ebx
0052F322    mov eax, dword ptr ds:[eax+0x04]                ; => [ Call: sub_573400 ]
