...
005904D8    call 0x00761E50
005904DD    mov eax, dword ptr ds:[0x008C4040]
005904E2    xor eax, ebp
005904E4    mov dword ptr ss:[ebp-0x04], eax
005904E7    push ebx
005904E8    push esi
005904E9    push edi
...
0059055B    movlpd qword ptr ds:[0x00CCE9CC], xmm0
00590563    mov dword ptr ds:[0x00CCE9D4], 0x00
0059056D    mov dword ptr ds:[0x00CCE9C4], edi
00590573    mov dword ptr ds:[0x00CCE9C8], ebx
00590579    mov dword ptr ds:[0x00CCE9BC], eax
0059057E    mov dword ptr ds:[0x00CCE9C0], 0x00
...
00590599    inc edx
0059059A    mov dword ptr ds:[0x00CCE9B4], edx
...
005905C6    mov ecx, dword ptr ds:[0x00CCE9B8]
005905CC    lea eax, ds:[ecx+0x01]
005905CF    mov dword ptr ds:[0x00CCE9B8], eax
...
00590657    mov dword ptr ds:[0x00CCE9C0], eax
0059065C    call 0x00590090
...
00590702    pop esi
00590703    pop ebx
00590704    call 0x0075927A
00590709    mov esp, ebp
0059070B    pop ebp
0059070C    ret
0059070D    push 0x820758
00590712    push 0x4600
00590717    mov ecx, 0x820778
0059071C    jmp 0x0059073E
0059071E    push 0x820758
00590723    push 0x460A
00590728    mov ecx, 0x8207A4
0059072D    jmp 0x0059073E
0059072F    push 0x820758
00590734    push 0x4612
00590739    mov ecx, 0x8207DC
0059073E    push 0x81F4B8
00590743    mov edx, 0x801800
00590748    call 0x0063B870
0059074D    add esp, 0x0C
00590750    call 0x0063BC30
00590755    test al, al
00590757    jz 0x0059075A
00590759    int3
0059075A    call 0x0063BB00
