...
0068ABD2    mov dword ptr ss:[ebp-0x0C], eax                ; => [ Call: sub_688f10 ]
0068ABD5    mov ecx, edi
0068ABD7    lea eax, ss:[ebp-0x0C]
0068ABDA    push eax
0068ABDB    call 0x0068B830                                 ; => [ Call: sub_68b830 ]
...
0068AC13    mov dword ptr ss:[ebp-0x10], eax                ; => [ Call: sub_688f10 ]
0068AC16    mov ecx, edi
0068AC18    lea eax, ss:[ebp-0x10]
0068AC1B    push eax
0068AC1C    call 0x0068B830                                 ; => [ Call: sub_68b830 ]
...
0068AC79    call dword ptr ds:[edx+0x30]                    ; => [ Data: data_147abf8 ]
...
0068AC9D    call 0x00688F10                                 ; => [ Call: sub_688f10 ]
0068ACA2    mov ecx, 0x0C
0068ACA7    mov ebx, eax
0068ACA9    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
0068ACBA    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
0068ACFC    push 0x8779F8                                   ; => [ String: NetLocTCPReceive ]
0068AD01    push 0x4FC
0068AD06    push 0x8773A8                                   ; => [ String: C:\x\ax2017\Engine\Network.cpp ]
0068AD0B    mov ecx, 0x8779F0                               ; => [ String: len > 0 ]
...
0068AD47    mov dword ptr ds:[edi], 0x00                    ; => [ Call: nullptr ]
0068AD4D    mov esi, dword ptr ds:[ecx]
0068AD4F    mov edx, 0x0C
0068AD54    dec dword ptr ds:[edi+0x08]
0068AD57    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0068AD5C    mov ecx, dword ptr ds:[0x0147ABF4]              ; => [ Data: data_147abf4 ]
0068AD62    lea eax, ss:[ebp-0x14]
0068AD65    push eax
0068AD66    mov dword ptr ss:[ebp-0x14], esi
0068AD69    lea ecx, ds:[ecx+0x44]
0068AD6C    call 0x0068B830                                 ; => [ Call: sub_68b830 ]
0068AD71    pop edi
0068AD72    pop esi
0068AD73    pop ebx
...
0068AD85    pop ebp
0068AD86    ret                                             ; => [ Call: sub_689230 | Call: sub_689230 ]
0068AD87    push 0x877BA0                                   ; => [ String: XList<struct NetBuffer *>::GetTail ]
0068AD8C    push 0x5A
0068AD8E    mov ecx, 0x877B90                               ; => [ String: mpTail != NULL ]
0068AD93    push 0x86E34C                                   ; => [ String: C:\x\ax2017\Engine\xList.h ]
0068AD98    mov edx, 0x801800
0068AD9D    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
0068ADA2    add esp, 0x0C
0068ADA5    call 0x0063BC30
0068ADAA    test al, al
0068ADAC    jz 0x0068ADAF                                   ; => [ Call: sub_63bc30 ]
0068ADAE    int3
0068ADAF    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
