...
004CB789    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
004CB78E    xor eax, ebp
004CB790    mov dword ptr ss:[ebp-0x04], eax
004CB793    mov ecx, dword ptr ss:[ebp+0x08]
004CB796    call 0x0064E7A0
004CB79B    mov dword ptr ds:[eax+0x18BC], 0x4CB050         ; => [ Call: sub_64e7a0 | Call: sub_4cb050 ]
004CB7A5    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
004CB7C3    mov edi, 0xB8212C                               ; => [ Data: data_b8212c ]
...
004CB808    jnz 0x004CB82B                                  ; => [ Data: data_be0760 ]
...
004CB832    jnz 0x004CB85B                                  ; => [ Data: data_be075c ]
...
004CB85A    inc esi
004CB85B    xor ecx, ecx                                    ; => [ Call: nullptr ]
004CB85D    mov dword ptr ss:[ebp-0x8C], 0x7E7670           ; => [ Data: data_7e7670 ]
004CB867    mov dword ptr ss:[ebp-0x88], ecx                ; => [ Call: nullptr ]
004CB86D    mov edi, 0x19E5A1C                              ; => [ Data: data_19e5a1c ]
...
004CB88B    jnz 0x004CB8B3                                  ; => [ String: tblRulesItem ]
...
004CB8B1    jz 0x004CB8E9                                   ; => [ Data: data_c23ba8 | Data: data_c23bac ]
004CB8B3    push ecx
004CB8B4    mov ecx, dword ptr ss:[ebp+0x08]
004CB8B7    mov edx, 0x8048A4
004CB8BC    call 0x0067BE20                                 ; => [ Call: sub_67be20 ]
...
004CB8D6    mov dword ptr ds:[edi], 0x8048A4                ; => [ String: tblRulesItem ]
...
004CB940    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004CB959    call 0x00665DB0                                 ; => [ Call: sub_665db0 ]
...
004CB970    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
...
004CB98C    call 0x00665DB0                                 ; => [ Call: sub_665db0 | Data: data_8dc41c ]
...
004CB9C6    call 0x00666120                                 ; => [ Data: data_8dc404 | Call: sub_666120 ]
004CB9CB    add esp, 0x08
004CB9CE    cmp dword ptr ds:[0x008DB5C4], 0x27
004CB9D5    jnz 0x004CB9DE                                  ; => [ Data: data_8db5c4 ]
004CB9D7    mov eax, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
004CB9DC    jmp 0x004CB9EC
004CB9DE    cmp dword ptr ds:[0x008DB5D4], 0x27
004CB9E5    jnz 0x004CBA12                                  ; => [ Data: data_8db5d4 ]
004CB9E7    mov eax, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
004CB9EC    test eax, eax
004CB9EE    jz 0x004CBA12
004CB9F0    mov ecx, ebx
004CB9F2    call 0x0064E7A0                                 ; => [ Call: sub_64e7a0 ]
004CB9F7    movss xmm3, dword ptr ds:[0x00890E18]
004CB9FF    mov edx, 0x8DC428
004CBA04    push 0x00
004CBA06    push 0xFFFFFFFF
004CBA08    mov ecx, eax
004CBA0A    call 0x00665DB0                                 ; => [ Data: data_8dc428 | Call: sub_665db0 ]
...
004CBA19    pop ebx
004CBA1A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
004CBA39    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
004CBA3E    add esp, 0x0C
004CBA41    call 0x0063BC30
004CBA46    test al, al
004CBA48    jz 0x004CBA4B                                   ; => [ Call: sub_63bc30 ]
004CBA4A    int3
004CBA4B    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
