...
0055EE35    push 0x764D35                                   ; => [ Call: sub_764d35 | Type: EHRegistrationNode ]
0055EE3A    mov eax, dword ptr fs:[0x00000000]
0055EE40    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0055EE51    push eax                                        ; => [ Data: __security_cookie ]
0055EE52    lea eax, ss:[ebp-0x0C]
0055EE55    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0055EE5B    xorps xmm0, xmm0
0055EE5E    mov dword ptr ss:[ebp-0x14], 0x104
0055EE65    movlpd qword ptr ss:[ebp-0x1C], xmm0
0055EE6A    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
0055EE8F    mov esi, eax                                    ; => [ Call: sub_590990 ]
...
0055EEA6    mov dword ptr ss:[ebp-0x24], eax                ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable ]
...
0055EED8    push edi
0055EED9    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0055EEF8    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
0055EF59    push edi
0055EF5A    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0055EF79    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
0055EF8C    push eax
0055EF8D    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
0055EF90    test esi, esi
0055EF92    jnz 0x0055EFA8
0055EF94    xor al, al
0055EF96    mov ecx, dword ptr ss:[ebp-0x0C]
0055EF99    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055EFA0    pop ecx
0055EFA1    pop edi
0055EFA2    pop esi
0055EFA3    pop ebx
...
0055EFB5    call 0x00573400                                 ; => [ Call: sub_573400 ]
0055EFBA    push dword ptr ds:[0x007BFAD4]                  ; => [ Call: nullptr ]
...
0055EFD4    push 0x0B
0055EFD6    push 0x3EA
0055EFDB    push 0x01                                       ; => [ Call: __builtin_memcpy | String: \x01\x00\x00\x00\xea\x03\x00\x00\x0b\x00\x00\x00\x07\x00\x00\x00\x00 ]
0055EFDD    push ecx
0055EFDE    mov ecx, dword ptr ds:[eax+0x04]
0055EFE1    call 0x00582EB0                                 ; => [ Call: sub_582eb0 ]
0055EFE6    add esp, 0x28
0055EFE9    mov al, 0x01
0055EFEB    mov ecx, dword ptr ss:[ebp-0x0C]
0055EFEE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0055EFF5    pop ecx
0055EFF6    pop edi
0055EFF7    pop esi
0055EFF8    pop ebx
