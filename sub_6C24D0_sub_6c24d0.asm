...
006C24DC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
006C24E1    xor eax, esp
006C24E3    mov dword ptr ss:[esp+0x90], eax
006C24EA    mov eax, dword ptr ds:[0x0147ABE8]              ; => [ Data: data_147abe8 ]
006C24EF    push ebx
...
006C250F    push eax
006C2510    call 0x00761FC4                                 ; => [ Call: memset ]
...
006C253A    movups xmmword ptr ss:[esp+0x34], xmm0          ; => [ Call: __builtin_memcpy | String: \x00\x00\x80\x3f\x00\x00\x80\x3f\x00\x00\x80\x3f\x00\x00\x80\x3f\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x3f\x00\x00\x80\x3f ]
...
006C256F    call 0x00649CC0                                 ; => [ Call: sub_649cc0 ]
006C2574    xor esi, esi                                    ; => [ Call: nullptr ]
...
006C2590    call 0x006C2170                                 ; => [ Call: sub_6c2170 ]
...
006C25A6    call 0x00649D30                                 ; => [ Call: sub_649d30 ]
006C25AB    mov ecx, dword ptr ss:[esp+0x9C]
006C25B2    pop edi
006C25B3    pop esi
006C25B4    pop ebx
006C25B5    xor ecx, esp
006C25B7    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
...
006C25D6    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: GetGameData | Data: data_801800 | String: gpGameData | String: C:\x\ax2017\Engine\Game.h ]
006C25DB    add esp, 0x0C
006C25DE    call 0x0063BC30
006C25E3    test al, al
006C25E5    jz 0x006C25E8                                   ; => [ Call: sub_63bc30 ]
006C25E7    int3
006C25E8    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
