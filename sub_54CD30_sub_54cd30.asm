...
0054CDD2    push esi
0054CDD3    call dword ptr ds:[eax]
...
0054CE02    setnz al
0054CE05    push eax
0054CE06    call dword ptr ds:[edx+0x10]
0054CE09    test esi, esi
0054CE0B    jnz 0x0054CE5E
0054CE0D    lea eax, ss:[ebp-0x70]
0054CE10    mov dword ptr ss:[ebp-0x70], 0x81C6F8
0054CE17    mov dword ptr ss:[ebp-0x4C], eax
0054CE1A    lea eax, ss:[ebp-0x40]
0054CE1D    mov dword ptr ss:[ebp-0x48], 0xCD
0054CE24    mov dword ptr ss:[ebp-0x44], esi
0054CE27    mov dword ptr ss:[ebp-0x40], 0x81C6DC
...
0054CE54    call 0x0056A100
0054CE59    lea eax, ss:[ebp-0x70]
0054CE5C    jmp 0x0054CED1
0054CE5E    lea eax, ss:[ebp-0xD0]
0054CE64    mov dword ptr ss:[ebp-0xD0], 0x81C6A4
0054CE6E    mov dword ptr ss:[ebp-0xAC], eax
0054CE74    lea eax, ss:[ebp-0xA0]
0054CE7A    mov dword ptr ss:[ebp-0xA8], 0xCD
0054CE84    mov dword ptr ss:[ebp-0xA4], 0x00
0054CE8E    mov dword ptr ss:[ebp-0xA0], 0x81C688
0054CE98    mov dword ptr ss:[ebp-0x7C], eax
