...
0053E220    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053E221    mov eax, 0x1938
0053E226    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053E22B    mov eax, dword ptr ds:[0x008C4040]
0053E230    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0053E232    mov dword ptr ss:[ebp-0x10], eax
0053E235    push esi
0053E236    push edi
0053E237    push eax
0053E238    lea eax, ss:[ebp-0x0C]
0053E23B    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053E241    lea eax, ss:[ebp-0x1944]
0053E247    mov ecx, 0x3EA
0053E24C    push eax
0053E24D    call 0x00568780                                 ; => [ Call: sub_568780 ]
0053E252    mov esi, eax
0053E254    mov dword ptr ss:[ebp-0xCC0], 0x81AE48          ; => [ Data: std::_Func_impl_no_alloc<class <lambda_c37ac98cca1aeead4d1ee362e226686b>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_c37ac98cca1aeead4d1ee362e226686b>,bool,enum CardID>::VTable ]
0053E25E    mov ecx, 0x321
0053E263    lea edi, ss:[ebp-0xC94]
0053E269    lea eax, ss:[ebp-0xCC0]
0053E26F    add esp, 0x04
0053E272    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0053E274    mov dword ptr ss:[ebp-0xC9C], eax               ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_c37ac98cca1aeead4d1ee362e226686b>,bool,enum CardID>::VTable ]
...
0053E2B2    push esi
0053E2B3    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0053E2C1    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0053E2E5    push eax
0053E2E6    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
0053E2E9    xor eax, eax
0053E2EB    test edi, edi
0053E2ED    setz al
0053E2F0    mov ecx, dword ptr ss:[ebp-0x0C]
0053E2F3    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053E2FA    pop ecx
0053E2FB    pop edi
0053E2FC    pop esi
0053E2FD    mov ecx, dword ptr ss:[ebp-0x10]
0053E300    xor ecx, ebp
0053E302    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
