...
0053F5D8    push 0x766526                                   ; => [ Type: EHRegistrationNode | Call: sub_766526 ]
0053F5DD    mov eax, dword ptr fs:[0x00000000]
0053F5E3    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0053F5E4    push ebx
0053F5E5    mov eax, 0x2720
0053F5EA    call 0x00761E50                                 ; => [ Call: __chkstk ]
0053F5EF    mov eax, dword ptr ds:[0x008C4040]
0053F5F4    xor eax, ebp                                    ; => [ Data: __security_cookie ]
0053F5F6    mov dword ptr ss:[ebp-0x14], eax
0053F5F9    push esi
0053F5FA    push edi
0053F5FB    push eax
0053F5FC    lea eax, ss:[ebp-0x0C]
0053F5FF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0053F605    mov dword ptr ss:[ebp-0xD90], 0x00
0053F60F    mov byte ptr ss:[ebp-0xD89], 0x00
0053F616    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053F61B    lea ecx, ss:[ebp-0x1AA8]
0053F621    push 0x04
0053F623    push ecx
0053F624    mov edx, dword ptr ds:[eax+0x0C]
0053F627    mov ecx, dword ptr ds:[eax+0x04]
0053F62A    call 0x005777B0                                 ; => [ Call: sub_5777b0 ]
...
0053F656    rep movsd                                       ; => [ Call: __builtin_memcpy ]
0053F658    mov ecx, 0x1C
0053F65D    lea esi, ss:[ebp-0x88]
0053F663    lea edi, ss:[ebp-0x100]
0053F669    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0053F686    call 0x00759772                                 ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_fbc658b812884ab7d798d98c6b94c951>,bool,enum CardID>::VTable | Call: operator new ]
0053F68B    mov ecx, 0x1D
0053F690    lea esi, ss:[ebp-0x100]
0053F696    add esp, 0x0C
0053F699    lea edi, ds:[eax+0x04]
0053F69C    mov dword ptr ds:[eax], 0x81AD68                ; => [ Data: std::_Func_impl_no_alloc<class <lambda_fbc658b812884ab7d798d98c6b94c951>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} ]
0053F6A2    rep movsd                                       ; => [ Call: __builtin_memcpy ]
...
0053F6E5    call eax                                        ; => [ Field: vFunc_0 ]
...
0053F6F6    call 0x0057EB70                                 ; => [ Call: GSI1::OffForSym ]
...
0053F727    push eax
0053F728    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
...
0053F74D    movlpd qword ptr ss:[ebp-0xDC4], xmm0           ; => [ Call: __builtin_memset ]
...
0053F7EA    rep movsd                                       ; => [ Call: __builtin_memcpy | Call: sub_563960 ]
...
0053F802    call 0x00573400                                 ; => [ Call: sub_573400 ]
0053F807    push 0x04
0053F809    push 0x00
0053F80B    push 0x00
...
0053F81A    push 0x476
0053F81F    push esi
0053F820    call 0x00583720                                 ; => [ Call: nullptr | Call: sub_583720 ]
...
0053F83D    mov dword ptr ss:[ebp+ecx*4-0x88], eax          ; => [ Call: sub_57dc30 | Call: sub_573400 ]
0053F844    inc ecx
...
0053F85B    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0053F862    pop ecx
0053F863    pop edi
0053F864    pop esi
0053F865    mov ecx, dword ptr ss:[ebp-0x14]
0053F868    xor ecx, ebp
0053F86A    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
