...
005463CC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
005463D1    xor eax, esp
005463D3    mov dword ptr ss:[esp+0xC90], eax
005463DA    push esi
005463DB    mov edx, 0x7BFA0C
005463E0    mov dword ptr ss:[esp+0xC88], 0x00              ; => [ Call: nullptr ]
005463EB    call 0x00566920                                 ; => [ Call: sub_566920 ]
...
0054643F    call 0x00566920                                 ; => [ Call: sub_566920 ]
...
00546454    mov eax, dword ptr ds:[eax+0x1504]              ; => [ Call: sub_573400 ]
...
0054648C    setz cl
0054648F    call 0x0061B1B0                                 ; => [ Call: nullptr | Call: sub_61b1b0 ]
00546494    add esp, 0x2C
00546497    push 0x00
00546499    mov edx, 0x3EE
0054649E    mov ecx, esi
005464A0    call 0x00562400                                 ; => [ Call: sub_562400 ]
005464A5    add esp, 0x04
005464A8    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
005464DA    call 0x00582EB0                                 ; => [ Call: nullptr | Call: sub_582eb0 ]
005464DF    mov ecx, dword ptr ss:[esp+0xCBC]
005464E6    add esp, 0x28
005464E9    pop esi
005464EA    xor ecx, esp
005464EC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
