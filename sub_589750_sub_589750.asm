...
0058987D    push 0x820344
00589882    push 0x363B
00589887    mov ecx, 0x801AA4
...
00589940    call 0x00590990
00589945    mov ebx, eax
00589947    mov dword ptr ss:[ebp-0x195C], 0x820E24
...
00589966    mov dword ptr ss:[ebp-0x1938], eax
...
005899A7    mov dword ptr ds:[edi+0x24], eax
...
005899E9    push eax
005899EA    call dword ptr ds:[edx+0x10]
...
00589BEB    mov dword ptr ss:[ebp-0x1928], eax
