...
005476B5    push 0x7666D5                                   ; => [ Type: EHRegistrationNode | Call: sub_7666d5 ]
005476BA    mov eax, dword ptr fs:[0x00000000]
005476C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
005476CF    push esi
005476D0    push edi
005476D1    push eax                                        ; => [ Data: __security_cookie ]
005476D2    lea eax, ss:[ebp-0x0C]
005476D5    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
005476DB    xorps xmm0, xmm0
005476DE    mov dword ptr ss:[ebp-0x1C], 0x00
005476E5    movlpd qword ptr ss:[ebp-0x24], xmm0
005476EA    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
00547715    push eax
00547716    push 0x3E9
0054771B    call 0x00590990                                 ; => [ Call: sub_590990 ]
...
0054774B    mov dword ptr ss:[ebp-0x4C], 0x81CA08           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_e24c5f996840e57a8f69038479b0803a>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_e24c5f996840e57a8f69038479b0803a>,bool,enum CardID>::VTable ]
00547752    mov dword ptr ss:[ebp-0x48], eax
00547755    lea eax, ss:[ebp-0x4C]
00547758    mov dword ptr ss:[ebp-0x28], eax                ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_e24c5f996840e57a8f69038479b0803a>,bool,enum CardID>::VTable ]
...
00547784    push esi
00547785    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
005477A4    mov dword ptr ds:[edi+0xC80], eax               ; => [ Call: GSI1::OffForSym ]
...
005477B8    setnz al                                        ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_e24c5f996840e57a8f69038479b0803a>,bool,enum CardID>::VTable ]
005477BB    push eax
005477BC    call edx                                        ; => [ Field: vFunc_4 ]
005477BE    cmp dword ptr ss:[ebp-0x1C], 0x00
005477C2    jz 0x0054783A
005477C4    lea eax, ss:[ebp-0x1C]
005477C7    mov dword ptr ss:[ebp-0x74], 0x81C9EC           ; => [ Data: std::_Func_impl_no_alloc<class <lambda_775e5c88632ae5d08ab97eaccaaaba15>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'} | Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_775e5c88632ae5d08ab97eaccaaaba15>,bool,enum CardID>::VTable ]
005477CE    mov dword ptr ss:[ebp-0x70], eax
005477D1    lea eax, ss:[ebp-0x74]
005477D4    mov dword ptr ss:[ebp-0x50], eax                ; => [ Type: std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_775e5c88632ae5d08ab97eaccaaaba15>,bool,enum CardID>::VTable ]
...
00547806    push esi
00547807    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
0054781F    mov dword ptr ds:[edi+0xC80], eax               ; => [ Call: GSI1::OffForSym ]
...
00547836    push edx
00547837    call dword ptr ds:[esi+0x10]                    ; => [ Field: vFunc_4 ]
0054783A    mov eax, edi
0054783C    mov ecx, dword ptr ss:[ebp-0x0C]
0054783F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00547846    pop ecx
00547847    pop edi
00547848    pop esi
00547849    pop ebx
...
0054784F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
