...
005395AB    inc ebx
005395AC    test al, al
005395AE    cmovz ebx, dword ptr ss:[esp+0x14]
005395B3    call 0x00573400
005395B8    movzx esi, si
005395BB    mov edi, dword ptr ds:[eax+0x04]
005395BE    cmp esi, 0x320
005395C4    jb 0x005395CB
005395C6    call 0x00591930
...
00539611    call 0x0063B870
00539616    add esp, 0x0C
00539619    call 0x0063BC30
0053961E    test al, al
00539620    jz 0x00539623
00539622    int3
00539623    call 0x0063BB00
