...
005D8A47    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | Data: data_801800 | String: DeclarePlayerColor | String: Halt ]
005D8A4C    add esp, 0x0C
005D8A4F    call 0x0063BC30
005D8A54    test al, al
005D8A56    jz 0x005D8A59                                   ; => [ Call: sub_63bc30 ]
005D8A58    int3
005D8A59    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
