...
004AB247    call 0x0064C080
004AB24C    mov dword ptr ds:[esi], 0x801800
004AB252    mov ecx, dword ptr ss:[ebp-0x0C]
004AB255    mov dword ptr fs:[0x00000000], ecx
004AB25C    pop ecx
004AB25D    pop esi
