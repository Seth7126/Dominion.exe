...
004F8B98    call 0x00761E50                                 ; => [ Call: __chkstk ]
004F8B9D    mov eax, dword ptr ds:[0x008C4040]
004F8BA2    xor eax, ebp
004F8BA4    mov dword ptr ss:[ebp-0x04], eax                ; => [ Data: __security_cookie ]
004F8BA7    push esi
004F8BA8    push edi
...
004F8BB9    push eax
004F8BBA    call 0x00568780                                 ; => [ Call: sub_56cdd0 | Call: sub_568780 ]
004F8BBF    mov esi, eax
004F8BC1    lea edi, ss:[ebp-0xC88]
004F8BC7    push 0x00
004F8BC9    mov ecx, 0x321
004F8BCE    mov edx, 0x3EA
004F8BD3    rep movsd                                       ; => [ Call: __builtin_memcpy ]
004F8BD5    push 0x07
004F8BD7    push 0x0B
...
004F8BEE    call 0x00561E00                                 ; => [ Call: sub_5674c0 | Call: sub_561e00 ]
004F8BF3    mov ecx, dword ptr ss:[ebp-0x04]
004F8BF6    add esp, 0x08
004F8BF9    xor ecx, ebp
004F8BFB    pop edi
004F8BFC    pop esi
004F8BFD    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
