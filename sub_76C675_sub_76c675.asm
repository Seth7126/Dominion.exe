...
0076C686    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C68B    mov ecx, dword ptr ds:[edx-0x08]
0076C68E    xor ecx, eax
0076C690    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
0076C695    mov eax, 0x8B8888
0076C69A    jmp 0x00761FA6                                  ; => [ Data: data_8b8888 | Call: __CxxFrameHandler3 ]
