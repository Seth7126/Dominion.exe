...
004FC2A0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
004FC2A1    mov eax, 0x25FC
004FC2A6    call 0x00761E50                                 ; => [ Call: __chkstk ]
004FC2AB    mov eax, dword ptr ds:[0x008C4040]
004FC2B0    xor eax, ebp                                    ; => [ Data: __security_cookie ]
...
004FC2BC    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
004FC2C2    xorps xmm0, xmm0
004FC2C5    mov dword ptr ss:[ebp-0xCA0], 0x104
004FC2CF    movlpd qword ptr ss:[ebp-0xCA8], xmm0
004FC2D7    call 0x00573400                                 ; => [ Call: sub_573400 ]
...
004FC36A    push edi
004FC36B    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
004FC38D    mov esi, eax                                    ; => [ Call: GSI1::OffForSym ]
...
004FC413    push edi
004FC414    call dword ptr ds:[eax]                         ; => [ Field: vFunc_0 ]
...
004FC436    mov dword ptr ss:[ebp-0xD00], eax               ; => [ Call: GSI1::OffForSym ]
...
004FC450    push eax
004FC451    call dword ptr ds:[edx+0x10]                    ; => [ Field: vFunc_4 ]
004FC454    push 0x00
004FC456    push 0x00
004FC458    push 0x13
...
004FC470    rep movsd                                       ; => [ Call: __builtin_memcpy ]
004FC472    lea eax, ss:[ebp-0x2608]
004FC478    push 0x3E9
004FC47D    push eax
004FC47E    lea ecx, ss:[ebp-0xC98]
004FC484    call 0x00562540                                 ; => [ Call: sub_562540 ]
004FC489    add esp, 0x14
004FC48C    mov ecx, dword ptr ss:[ebp-0x0C]
004FC48F    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
004FC496    pop ecx
004FC497    pop edi
004FC498    pop esi
004FC499    pop ebx
...
004FC49F    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
