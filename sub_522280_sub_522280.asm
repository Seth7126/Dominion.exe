...
0052235C    mov dword ptr ss:[ebp-0x20], eax
...
00522373    push eax
00522374    call dword ptr ds:[edx+0x10]
00522377    xorps xmm0, xmm0
0052237A    mov dword ptr ss:[ebp-0x1954], 0x00
00522384    movlpd qword ptr ss:[ebp-0x195C], xmm0
