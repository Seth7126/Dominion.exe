...
0074494C    call 0x00744B30
00744951    push 0x01
00744953    push dword ptr ds:[0x0147B084]
00744959    call dword ptr ds:[0x00775284]
0074495F    mov ecx, esi
00744961    mov dword ptr ds:[0x01512450], esi
00744967    call 0x006987E0
0074496C    mov ecx, dword ptr ds:[0x01512450]
00744972    mov dword ptr ds:[0x01512454], eax
00744977    mov dword ptr ds:[0x0151345C], 0x00
00744981    mov word ptr ds:[0x01513460], 0x00
0074498A    mov byte ptr ds:[0x01513462], 0x00
00744991    cmp dword ptr ds:[ecx+0x04], 0x1E
00744995    jnz 0x00744AFF
0074499B    call 0x005AF880
...
007449D9    xorps xmm4, xmm4
007449DC    sub esi, eax
007449DE    xorps xmm5, xmm5
...
00744AA7    mov dword ptr ds:[0x01593C6C], 0x3F000000
00744AB1    mov ecx, dword ptr ds:[0x01512450]
00744AB7    mov dword ptr ds:[0x01512458], eax
00744ABC    cmp dword ptr ds:[ecx+0x04], 0x1E
00744AC0    jnz 0x00744AFF
00744AC2    call 0x005AF880
00744AC7    xor cl, cl
...
00744AE3    movss dword ptr ds:[0x01593C70], xmm1
00744AEB    movss dword ptr ds:[0x01593C74], xmm2
...
00744B18    call 0x0063B870
00744B1D    add esp, 0x0C
00744B20    call 0x0063BC30
00744B25    test al, al
00744B27    jz 0x00744B2A
00744B29    int3
00744B2A    call 0x0063BB00
