...
006B153A    call 0x0069F030                                 ; => [ String: !DX11\MissingTexture.texture | Call: sub_69f030 ]
006B153F    mov esi, eax
006B1541    test esi, esi
006B1543    jnz 0x006B1559
006B1545    push 0x87C324                                   ; => [ String: Dx11GraphicsSetGenericRenderState ]
006B154A    push 0x80E
006B154F    mov ecx, 0x87C38C                               ; => [ String: assetTexture ]
006B1554    jmp 0x006B176D
006B1559    cmp dword ptr ds:[esi+0x04], 0x03
006B155D    jz 0x006B1578
006B155F    push 0x86F01C                                   ; => [ String: TextureGetDef ]
006B1564    push 0x89
006B1569    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
006B156E    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
006B1573    jmp 0x006B1772
006B1578    mov ecx, esi
006B157A    call 0x005AF880
006B157F    mov eax, dword ptr ds:[eax]
006B1581    mov eax, dword ptr ds:[eax+0x1C]                ; => [ Call: sub_5af880 ]
006B1584    cmp eax, 0x05
006B1587    jz 0x006B175E
006B158D    cmp eax, 0x06
006B1590    jz 0x006B175E
006B1596    mov ecx, esi
006B1598    call 0x006A0F60                                 ; => [ Call: sub_6a0f60 ]
006B159D    mov ecx, eax
006B159F    test ecx, ecx
006B15A1    jnz 0x006B15B7
006B15A3    push 0x87C324                                   ; => [ String: Dx11GraphicsSetGenericRenderState ]
006B15A8    push 0x814
006B15AD    mov ecx, 0x87C3D4                               ; => [ String: textureHandle ]
006B15B2    jmp 0x006B176D
006B15B7    mov edx, dword ptr ds:[0x0147B078]              ; => [ Data: data_147b078 ]
...
006B15ED    push 0x87C324                                   ; => [ String: Dx11GraphicsSetGenericRenderState ]
006B15F2    push 0x816
006B15F7    mov ecx, 0x87C39C                               ; => [ String: bufferDataTexture->mBufferType == DX11BUFFER_TEXTURE ]
...
006B162E    cmovnz edi, ecx                                 ; => [ Call: nullptr ]
006B1631    cmp dword ptr ds:[edi], 0x05
006B1634    jz 0x006B164A
006B1636    push 0x87C324                                   ; => [ String: Dx11GraphicsSetGenericRenderState ]
006B163B    push 0x819
006B1640    mov ecx, 0x87C3F8                               ; => [ String: bufferDataMaterial->mBufferType == DX11BUFFER_MATERIAL ]
...
006B1655    push 0x86F01C                                   ; => [ String: TextureGetDef ]
006B165A    push 0x89
006B165F    push 0x86F02C                                   ; => [ String: C:\x\ax2017\Engine\Texture.h ]
006B1664    mov ecx, 0x86F04C                               ; => [ String: assetPtr->assetType == ASSET_TYPE_TEXTURE ]
006B1669    jmp 0x006B1772
006B166E    mov ecx, esi
006B1670    call 0x005AF880
006B1675    mov eax, dword ptr ds:[eax]
006B1677    mov eax, dword ptr ds:[eax+0x1C]                ; => [ Call: sub_5af880 ]
...
006B1693    push 0x87C310                                   ; => [ String: Dx11GetSamplerIndex ]
006B1698    push 0x7F6
006B169D    mov ecx, 0x87C2D4                               ; => [ String: samplerIndex >= 0 && samplerIndex <= NUM_SAMPLER_STATES - 1 ]
006B16A2    jmp 0x006B176D
006B16A7    push 0x87C310                                   ; => [ String: Dx11GetSamplerIndex ]
006B16AC    push 0x7FC
006B16B1    mov ecx, 0x801AA4                               ; => [ String: Halt ]
...
006B16E8    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Data: data_147b078 ]
006B16EB    push ecx
006B16EC    mov eax, dword ptr ds:[ecx]
006B16EE    call dword ptr ds:[eax+0x68]
006B16F1    mov eax, dword ptr ds:[0x0147B078]
006B16F6    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Data: data_147b078 ]
...
006B1724    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Data: data_147b078 ]
006B1727    push ecx
006B1728    mov eax, dword ptr ds:[ecx]
006B172A    call dword ptr ds:[eax+0x28]
006B172D    mov eax, dword ptr ds:[0x0147B078]
006B1732    mov ecx, dword ptr ds:[eax+0x08]                ; => [ Data: data_147b078 ]
...
006B174B    pop ebp
006B174C    ret
006B174D    push 0x87C310                                   ; => [ String: Dx11GetSamplerIndex ]
006B1752    push 0x7E2
006B1757    mov ecx, 0x87C2D4                               ; => [ String: samplerIndex >= 0 && samplerIndex <= NUM_SAMPLER_STATES - 1 ]
006B175C    jmp 0x006B176D
006B175E    push 0x87C324                                   ; => [ String: Dx11GraphicsSetGenericRenderState ]
006B1763    push 0x811
006B1768    mov ecx, 0x87C368                               ; => [ String: !Dx11TextureIsView(assetTexture) ]
006B176D    push 0x87B990                                   ; => [ String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp ]
006B1772    mov edx, 0x801800
006B1777    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 ]
006B177C    add esp, 0x0C
006B177F    call 0x0063BC30
006B1784    test al, al
006B1786    jz 0x006B1789                                   ; => [ Call: sub_63bc30 ]
006B1788    int3
006B1789    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
006B178E    push 0x87C324
006B1793    push 0x82C
006B1798    push 0x87B990
006B179D    mov edx, 0x801800
006B17A2    mov ecx, 0x801AA4
006B17A7    call 0x0063B870                                 ; => [ Call: sub_63b870 | Data: data_801800 | String: Dx11GraphicsSetGenericRenderState | String: C:\x\ax2017\Engine\Windows\WindowsDx11.cpp | String: Halt ]
006B17AC    add esp, 0x0C
006B17AF    call 0x0063BC30
006B17B4    test al, al
006B17B6    jz 0x006B17B9                                   ; => [ Call: sub_63bc30 ]
006B17B8    int3
006B17B9    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
