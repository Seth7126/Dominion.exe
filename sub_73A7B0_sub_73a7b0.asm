...
0073A7B5    push 0x76D3BD                                   ; => [ Type: EHRegistrationNode | Call: __ehhandler$?Enqueue@?$SafeSQueue@VInternalContextBase@details@Concurrency@@V_HyperNonReentrantLock@23@@details@Concurrency@@QAEXPAVInternalContextBase@23@@Z ]
0073A7BA    mov eax, dword ptr fs:[0x00000000]
0073A7C0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
0073A7C1    sub esp, 0x08
0073A7C4    mov eax, dword ptr ds:[0x008C4040]
0073A7C9    xor eax, ebp
0073A7CB    push eax                                        ; => [ Data: __security_cookie ]
0073A7CC    lea eax, ss:[ebp-0x0C]
0073A7CF    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
0073A7D5    push 0x88F53C
0073A7DA    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: AtlasMaker: searching... ]
...
0073A7F6    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0073A7FB    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_6c4050 | String: res/ ]
0073A7FD    test eax, eax
0073A7FF    cmovnz ecx, eax
0073A802    call 0x0073A3D0                                 ; => [ Call: sub_73a3d0 ]
0073A807    mov dword ptr ss:[ebp-0x04], 0x01
0073A80E    cmp dword ptr ds:[0x00CF65BC], 0x00
0073A815    jz 0x0073A83E                                   ; => [ Data: data_cf65bc ]
...
0073A826    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0073A839    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0073A83E    mov ecx, dword ptr ss:[ebp-0x0C]
0073A841    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0073A848    pop ecx
