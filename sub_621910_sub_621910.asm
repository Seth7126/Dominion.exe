...
0062192C    push eax                                        ; => [ Data: __security_cookie ]
0062192D    lea eax, ss:[ebp-0x0C]
00621930    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00621936    mov edx, 0x802BCC
0062193B    lea ecx, ss:[ebp-0x10]
0062193E    call 0x0063D720                                 ; => [ String: btnBack | Call: sub_63d720 ]
00621943    mov edi, dword ptr ss:[ebp+0x08]
00621946    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0062194B    mov eax, dword ptr ss:[ebp-0x10]
0062194E    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
006219A4    jz 0x006219C8                                   ; => [ Data: data_cf65bc ]
006219A6    lea ecx, ss:[ebp-0x10]
006219A9    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006219BC    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006219C1    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
006219C8    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006219CF    test bl, bl
006219D1    jz 0x006219DD
006219D3    mov dword ptr ds:[0x008DB660], 0x03             ; => [ Data: data_8db660 ]
006219DD    mov edx, 0x86AF90
006219E2    lea ecx, ss:[ebp-0x10]
006219E5    call 0x0063D720                                 ; => [ String: btn_tabGrand | Call: sub_63d720 ]
006219EA    mov eax, dword ptr ss:[ebp-0x10]
006219ED    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
00621A33    jz 0x00621A57                                   ; => [ Data: data_cf65bc ]
00621A35    lea ecx, ss:[ebp-0x10]
00621A38    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621A4B    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00621A50    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
00621A73    mov dword ptr ds:[eax+0x3508], 0x01             ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
00621A7D    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
00621A83    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 | Data: data_801800 ]
00621A88    mov edx, 0x86AF7C
00621A8D    lea ecx, ss:[ebp-0x10]
00621A90    call 0x0063D720                                 ; => [ String: btn_grand_campaign | Call: sub_63d720 ]
00621A95    mov eax, dword ptr ss:[ebp+0x08]
00621A98    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
00621AE1    jz 0x00621B05                                   ; => [ Data: data_cf65bc ]
00621AE3    lea ecx, ss:[ebp-0x10]
00621AE6    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621AF9    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00621AFE    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
00621B05    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
00621B0C    test edi, edi
00621B0E    jnz 0x00621B21
00621B10    xor ecx, ecx
00621B12    call 0x0061E070                                 ; => [ Call: sub_61e070 ]
00621B17    mov dword ptr ds:[0x008DB660], 0x7E3            ; => [ Data: data_8db660 ]
00621B21    mov edx, 0x8615AC
00621B26    lea ecx, ss:[ebp-0x10]
00621B29    call 0x0063D720                                 ; => [ String: btnExp | Call: sub_63d720 ]
00621B2E    mov eax, dword ptr ss:[ebp+0x08]
00621B31    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
00621B7C    jz 0x00621BA0                                   ; => [ Data: data_cf65bc ]
00621B7E    lea ecx, ss:[ebp-0x10]
00621B81    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621B94    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00621B99    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
00621BC6    mov ecx, dword ptr ds:[ecx*4+0x77FCC4]          ; => [ Data: data_77fcc4 ]
00621BCD    call 0x0061E1A0                                 ; => [ Call: sub_61e1a0 ]
00621BD2    mov dword ptr ds:[0x008DB660], 0x7E3            ; => [ Data: data_8db660 ]
00621BDC    mov edx, 0x86AFEC
00621BE1    lea ecx, ss:[ebp-0x10]
00621BE4    call 0x0063D720                                 ; => [ String: btn_tabExpansions | Call: sub_63d720 ]
00621BE9    mov eax, dword ptr ss:[ebp+0x08]
00621BEC    mov ecx, esi                                    ; => [ Data: data_801800 ]
...
00621C3C    jz 0x00621C59                                   ; => [ Data: data_cf65bc ]
00621C3E    lea ecx, ss:[ebp-0x10]
00621C41    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621C54    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
00621C75    mov dword ptr ds:[eax+0x3508], edi              ; => [ Call: sub_4d8f30 | Data: data_cc8dc8 ]
00621C7B    mov ecx, dword ptr ds:[0x00CC8DC8]              ; => [ Data: data_cc8dc8 ]
00621C81    call 0x004D8AD0                                 ; => [ Call: sub_4d8ad0 | Data: data_801800 ]
00621C86    mov edx, 0x86AFD4
00621C8B    lea ecx, ss:[ebp-0x10]
00621C8E    call 0x0063D720                                 ; => [ Call: sub_63d720 | String: btn_campaign_settings ]
...
00621CDD    jz 0x00621CFA                                   ; => [ Data: data_cf65bc ]
00621CDF    lea ecx, ss:[ebp-0x10]
00621CE2    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00621CF5    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00621CFA    test esi, esi
00621CFC    jnz 0x00621D12
00621CFE    mov dword ptr ds:[0x00CCF6DC], 0x03             ; => [ Data: data_ccf6dc ]
00621D08    mov dword ptr ds:[0x008DB6B0], 0x7EE            ; => [ Data: data_8db6b0 ]
00621D12    xor al, al
00621D14    mov ecx, dword ptr ss:[ebp-0x0C]
00621D17    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
00621D1E    pop ecx
00621D1F    pop edi
00621D20    pop esi
00621D21    pop ebx
...
00621D3C    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: CampaignHomeDlgClick | String: C:\x\ax2017\Jams\Dominion\code\DomClient.cpp | String: info.index + 1 < numDefs | Data: data_801800 ]
00621D41    add esp, 0x0C
00621D44    call 0x0063BC30
00621D49    test al, al
00621D4B    jz 0x00621D4E                                   ; => [ Call: sub_63bc30 ]
00621D4D    int3
00621D4E    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
