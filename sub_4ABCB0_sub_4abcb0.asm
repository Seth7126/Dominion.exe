...
004ABCBE    call 0x0063B7F0                                 ; => [ String: app resume | Call: sub_63b7f0 ]
...
004ABCE3    push eax
004ABCE4    push ecx
004ABCE5    call 0x0063C000                                 ; => [ Data: data_cc8d60 | Call: sub_63c000 | Data: data_cc8d64 ]
...
004ABCFE    mov dword ptr ds:[0x00CC8D64], ecx              ; => [ Data: data_cc8d64 ]
004ABD04    mov ecx, dword ptr ds:[0x0171D908]              ; => [ Data: data_171d908 ]
004ABD0A    mov dword ptr ds:[0x00CC8D60], eax              ; => [ Data: data_cc8d60 ]
004ABD0F    call 0x004B80C0
004ABD14    mov esp, ebp
004ABD16    pop ebp
004ABD17    ret                                             ; => [ Call: sub_4b80c0 ]
