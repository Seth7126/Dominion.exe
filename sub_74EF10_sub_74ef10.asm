...
0074EF16    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
0074EF1B    xor eax, ebp
0074EF1D    mov dword ptr ss:[ebp-0x04], eax
0074EF20    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074EF25    push ebx
0074EF26    push esi
...
0074EF34    mov edx, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074EF3A    push 0x16                                       ; => [ Type: SET_WINDOW_POS_FLAGS ]
0074EF3C    cmp dword ptr ds:[edx+0x10], 0x00
0074EF40    jz 0x0074EF73                                   ; => [ Type: HWND ]
...
0074EF56    call dword ptr ds:[0x007753D4]                  ; => [ Call: nullptr ]
0074EF5C    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074EF61    push 0x14
...
0074EF80    call dword ptr ds:[0x007753D4]                  ; => [ Call: nullptr ]
0074EF86    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074EFA1    movups xmmword ptr ss:[ebp-0x2C], xmm0          ; => [ String: 0 | String: zx ]
0074EFA5    movups xmmword ptr ss:[ebp-0x1C], xmm0          ; => [ Call: __builtin_memset ]
...
0074EFD9    call esi                                        ; => [ Data: data_19e2778 ]
0074EFDB    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
...
0074EFED    mov dword ptr ds:[ecx+0x08], 0x88FF00           ; => [ Data: data_88ff00 ]
0074EFF4    mov eax, dword ptr ds:[0x019E2778]              ; => [ Data: data_19e2778 ]
0074EFF9    mov eax, dword ptr ds:[eax+0x14]                ; => [ Type: LPARAM ]
0074EFFC    push eax
0074EFFD    push eax
...
0074F00D    push 0x111
0074F012    push ebx
0074F013    call esi                                        ; => [ Type: LRESULT ]
0074F015    mov ecx, dword ptr ss:[ebp-0x04]
0074F018    pop esi
0074F019    xor ecx, ebp
0074F01B    pop ebx
0074F01C    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
