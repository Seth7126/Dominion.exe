...
00618820    push ecx
00618821    mov eax, dword ptr ds:[0x00B81FDC]              ; => [ Data: data_b81fdc ]
00618826    push esi
...
0061884B    jnz 0x0061887F                                  ; => [ Data: data_b81fd8 ]
0061884D    cmp esi, dword ptr ds:[0x00B824A4]
00618853    mov eax, esi
00618855    push 0x00
00618857    cmovz eax, dword ptr ds:[0x00B824A8]            ; => [ Data: data_b824a4 | Data: data_b824a8 ]
...
0061886F    push 0x07
00618871    push eax
00618872    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
00618877    mov eax, dword ptr ds:[0x00B81FDC]              ; => [ Data: data_b81fdc ]
...
0061889A    jnz 0x006188CA                                  ; => [ Data: data_b81fd8 ]
0061889C    cmp esi, dword ptr ds:[0x00B824A4]
006188A2    mov eax, esi
006188A4    push 0x00
006188A6    cmovz eax, dword ptr ds:[0x00B824A8]            ; => [ Data: data_b824a4 | Data: data_b824a8 ]
...
006188C2    call 0x0059F9B0                                 ; => [ Call: nullptr | Call: sub_59f9b0 ]
006188C7    add esp, 0x24
006188CA    mov eax, dword ptr ds:[0x00CC8D5C]              ; => [ Data: data_cc8d5c ]
...
006188E1    push 0x00
006188E3    push ecx
006188E4    call 0x005AF930                                 ; => [ Call: sub_5af930 | Data: data_171e70c ]
...
00618906    call 0x0063B870                                 ; => [ Call: sub_63b870 | String: C:\x\ax2017\Jams\Shared\TggGame\code\GameApp.cpp | Data: data_801800 | String: gClient | String: GetClient ]
0061890B    add esp, 0x0C
0061890E    call 0x0063BC30
00618913    test al, al
00618915    jz 0x00618918                                   ; => [ Call: sub_63bc30 ]
00618917    int3
00618918    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
