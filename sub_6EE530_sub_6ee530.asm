...
006EE540    push esi
006EE541    push edi
006EE542    jnz 0x006EE56B                                  ; => [ Data: data_147d49c ]
006EE544    push 0x8E
006EE549    push dword ptr ds:[0x0147D470]                  ; => [ Data: data_147d470 | Type: HWND ]
006EE54F    mov byte ptr ds:[0x0147D49C], 0x01              ; => [ Data: data_147d49c ]
006EE556    call dword ptr ds:[0x007752FC]                  ; => [ Type: HWND ]
006EE55C    movzx ecx, byte ptr ds:[0x0147D49C]
006EE563    push ecx                                        ; => [ Data: data_147d49c ]
006EE564    push eax
006EE565    call dword ptr ds:[0x00775300]                  ; => [ Type: BOOL ]
006EE56B    mov edi, dword ptr ds:[0x0147DED0]              ; => [ Data: data_147ded0 ]
006EE571    test edi, edi
006EE573    jz 0x006EE5B4
006EE575    cmp dword ptr ds:[edi+0x04], 0x19
006EE579    jnz 0x006EE5B4
006EE57B    push ecx
006EE57C    mov esi, 0x801800                               ; => [ Data: data_801800 ]
006EE581    mov ecx, esp
006EE583    mov edx, esi
006EE585    call 0x0063D720                                 ; => [ Data: data_801800 | Call: sub_63d720 ]
006EE58A    mov eax, dword ptr ds:[edi+0x20]
006EE58D    mov ecx, esi                                    ; => [ Data: data_801800 ]
006EE58F    push dword ptr ds:[edi]
006EE591    test eax, eax
006EE593    cmovnz ecx, eax
006EE596    push ecx
006EE597    call 0x006C25F0                                 ; => [ Call: sub_6c25f0 ]
...
006EE5AB    push esi
006EE5AC    call 0x006C32A0                                 ; => [ Call: sub_6c32a0 ]
