...
005CBFEC    mov eax, dword ptr ds:[0x008C4040]              ; => [ Data: __security_cookie ]
...
005CC006    call 0x005CB070                                 ; => [ Call: sub_5cb070 ]
...
005CC03A    mov eax, dword ptr ds:[0x00B7FCF4]              ; => [ Data: data_b7fcf4 ]
...
005CC052    call 0x005CBF20                                 ; => [ Call: sub_5cbf20 ]
...
005CC06E    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
005CC091    call 0x005CC410                                 ; => [ Call: sub_5cc410 ]
...
005CC0B5    call 0x005CB4F0                                 ; => [ Call: sub_5cb4f0 ]
005CC0BA    cmp dword ptr ds:[0x008DB5C4], 0x27             ; => [ Data: data_8db5c4 ]
005CC0C1    mov ecx, dword ptr ds:[esi+0x1C28]
005CC0C7    mov dword ptr ss:[esp+0x1C], ecx
005CC0CB    mov dword ptr ds:[0x00B7FCF4], ecx              ; => [ Data: data_b7fcf4 ]
005CC0D1    jnz 0x005CC0DA
005CC0D3    mov eax, dword ptr ds:[0x008DB5C8]              ; => [ Data: data_8db5c8 ]
005CC0D8    jmp 0x005CC0EC
005CC0DA    cmp dword ptr ds:[0x008DB5D4], 0x27
005CC0E1    jnz 0x005CC2A7                                  ; => [ Data: data_8db5d4 ]
005CC0E7    mov eax, dword ptr ds:[0x008DB5D8]              ; => [ Data: data_8db5d8 ]
005CC0EC    test eax, eax
005CC0EE    jz 0x005CC2A7
005CC0F4    imul edx, dword ptr ds:[0x00B809E4], 0x1C30     ; => [ Data: data_b809e4 ]
005CC0FE    mov eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
005CC103    mov dword ptr ss:[esp+0x10], 0xB809E0           ; => [ Data: data_b809e0 ]
...
005CC172    push 0x00
005CC174    push eax
005CC175    call 0x00761FC4                                 ; => [ Call: memset ]
...
005CC2A7    imul edx, dword ptr ds:[0x00B809E4], 0x1C30     ; => [ Data: data_b809e4 ]
005CC2B1    mov eax, dword ptr ds:[0x00B809E0]              ; => [ Data: data_b809e0 ]
005CC2B6    mov dword ptr ss:[esp+0x10], 0xB809E0           ; => [ Data: data_b809e0 ]
...
005CC322    push 0x00
005CC324    push eax
005CC325    call 0x00761FC4                                 ; => [ Call: memset ]
...
005CC3C8    call 0x005CB630                                 ; => [ Call: sub_5cb630 ]
005CC3CD    mov ecx, dword ptr ss:[esp+0x10]
005CC3D1    lea eax, ss:[esp+0x14]
005CC3D5    push eax
005CC3D6    call 0x006376D0                                 ; => [ Call: sub_6376d0 ]
...
005CC3FC    call 0x0075927A                                 ; => [ Call: CookieCheckFunction ]
