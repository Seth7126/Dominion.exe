...
00649125    push 0x76C6FD                                   ; => [ Call: sub_76c6fd | Type: EHRegistrationNode ]
0064912A    mov eax, dword ptr fs:[0x00000000]
00649130    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0064913E    push eax                                        ; => [ Data: __security_cookie ]
0064913F    lea eax, ss:[ebp-0x0C]
00649142    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
00649148    mov ecx, dword ptr ds:[0x00E76B40]              ; => [ Data: data_e76b40 ]
...
00649160    mov dword ptr ds:[eax*4+0x1476B90], eax         ; => [ Data: data_1476b90 ]
00649167    inc eax
00649168    mov ecx, dword ptr ds:[0x00E76B40]              ; => [ Data: data_e76b40 ]
...
0064918C    push eax
0064918D    call 0x004D4E30                                 ; => [ Call: sub_649040 | Call: sub_4d4e30 | Data: data_1476b90 ]
00649192    mov eax, dword ptr ds:[0x0147ABB8]              ; => [ Data: data_147abb8 ]
00649197    add esp, 0x08
0064919A    test eax, eax
0064919C    jle 0x006494DB
006491A2    dec eax
006491A3    xor ebx, ebx
006491A5    mov dword ptr ds:[0x0147ABB8], eax              ; => [ Data: data_147abb8 ]
006491AA    cmp dword ptr ds:[0x00E76B40], ebx
006491B0    jle 0x006494DB                                  ; => [ Data: data_e76b40 ]
006491B6    nop word ptr ds:[eax+eax*1], ax
006491C0    mov eax, dword ptr ds:[ebx*4+0x1476B90]         ; => [ Data: data_1476b90 ]
006491C7    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
...
006491EA    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
006491FB    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00649224    mov ecx, 0x872BE0                               ; => [ String: Mesh ]
...
0064925F    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00649264    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: QuadGroup count:%d ]
00649266    test eax, eax
00649268    cmovnz ecx, eax
0064926B    push ecx
0064926C    lea ecx, ss:[ebp-0x10]
0064926F    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
00649274    mov byte ptr ss:[ebp-0x04], 0x02
00649278    cmp dword ptr ds:[0x00CF65BC], 0x00
0064927F    jz 0x006492AF                                   ; => [ Data: data_cf65bc ]
...
00649290    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
00649306    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
00649317    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
00649340    mov ecx, 0x807454                               ; => [ Data: data_807454 ]
...
00649355    mov byte ptr ds:[ecx+edx*1-0x01], al            ; => [ String: 0 ]
00649359    test al, al
...
0064936B    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
00649370    test eax, eax
00649372    cmovnz ecx, eax
00649375    push ecx
00649376    lea ecx, ss:[ebp-0x10]
00649379    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
...
006493B8    call 0x0064BFD0                                 ; => [ Call: sub_64bfd0 ]
...
006493C9    call 0x0064BE70                                 ; => [ Call: sub_64be70 ]
...
006493F2    mov ecx, 0x807454                               ; => [ Data: data_807454 ]
...
00649405    mov byte ptr ds:[ecx+edx*1-0x01], al            ; => [ String: 0 ]
00649409    test al, al
...
00649428    mov ecx, 0x801800                               ; => [ Data: data_801800 ]
0064942D    mov eax, dword ptr ds:[eax]                     ; => [ Call: sub_63df30 | String: layer:%d ]
0064942F    test eax, eax
00649431    cmovnz ecx, eax
00649434    push ecx
00649435    lea ecx, ss:[ebp-0x10]
00649438    call 0x0063D960                                 ; => [ Call: sub_63d960 ]
0064943D    mov byte ptr ss:[ebp-0x04], 0x04
00649441    cmp dword ptr ds:[0x00CF65BC], 0x00
00649448    jz 0x00649478                                   ; => [ Data: data_cf65bc ]
...
00649459    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0064946C    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
00649471    mov dword ptr ss:[ebp-0x18], 0x801800           ; => [ Data: data_801800 ]
00649478    mov esi, dword ptr ss:[ebp-0x10]
0064947B    mov eax, 0x801800                               ; => [ Data: data_801800 ]
00649480    test esi, esi
00649482    cmovnz eax, esi
00649485    push eax
00649486    push 0x808058
0064948B    call 0x0063B5F0                                 ; => [ Call: sub_63b5f0 | String: %s ]
...
006494AA    jz 0x006494C7                                   ; => [ Data: data_cf65bc ]
006494AC    lea ecx, ss:[ebp-0x10]
006494AF    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
006494C2    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
006494C7    inc ebx
006494C8    mov dword ptr ss:[ebp-0x04], 0xFFFFFFFF
006494CF    cmp ebx, dword ptr ds:[0x00E76B40]
006494D5    jl 0x006491C0                                   ; => [ Data: data_e76b40 ]
006494DB    mov ecx, dword ptr ss:[ebp-0x0C]
006494DE    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
006494E5    pop ecx
006494E6    pop edi
006494E7    pop esi
006494E8    pop ebx
