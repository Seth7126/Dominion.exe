...
006C95B8    mov dword ptr fs:[0x00000000], eax
...
006C9767    mov ecx, edi
006C9769    cmovnz ecx, eax
006C976C    push ecx
006C976D    lea ecx, ss:[ebp-0x11C]
006C9773    call 0x0063D960
006C9778    mov eax, edi
...
006C97B0    jz 0x006C97D3
006C97B2    lea ecx, ss:[ebp-0x11C]
006C97B8    call 0x0063D4E0
...
006C995C    jz 0x006C997C
006C995E    lea ecx, ss:[ebp-0x120]
006C9964    call 0x0063D4E0
...
006C9A12    jz 0x006C9A32
006C9A14    lea ecx, ss:[ebp-0x11C]
006C9A1A    call 0x0063D4E0
...
006C9B40    jz 0x006C9B60
006C9B42    lea ecx, ss:[ebp-0x120]
006C9B48    call 0x0063D4E0
...
006C9BF6    jz 0x006C9C19
006C9BF8    lea ecx, ss:[ebp-0x11C]
006C9BFE    call 0x0063D4E0
...
006C9DA2    jz 0x006C9DC2
006C9DA4    lea ecx, ss:[ebp-0x120]
006C9DAA    call 0x0063D4E0
...
006C9E58    jz 0x006C9E78
006C9E5A    lea ecx, ss:[ebp-0x11C]
006C9E60    call 0x0063D4E0
...
006C9F86    jz 0x006C9FA6
006C9F88    lea ecx, ss:[ebp-0x120]
006C9F8E    call 0x0063D4E0
...
006CA03C    jz 0x006CA05F
006CA03E    lea ecx, ss:[ebp-0x11C]
006CA044    call 0x0063D4E0
...
006CA1E8    jz 0x006CA208
006CA1EA    lea ecx, ss:[ebp-0x120]
006CA1F0    call 0x0063D4E0
...
006CA29E    jz 0x006CA2BE
006CA2A0    lea ecx, ss:[ebp-0x11C]
006CA2A6    call 0x0063D4E0
...
006CA3CC    jz 0x006CA3EC
006CA3CE    lea ecx, ss:[ebp-0x120]
006CA3D4    call 0x0063D4E0
...
006CA478    jz 0x006CA498
006CA47A    lea ecx, ss:[ebp-0x11C]
006CA480    call 0x0063D4E0
...
006CA4ED    jz 0x006CA567
006CA4EF    mov edi, 0x147CF90
...
006CA510    jz 0x006CA530
006CA512    lea ecx, ss:[ebp-0x130]
006CA518    call 0x0063D4E0
...
006CA52B    call 0x0064C080
006CA530    mov ebx, 0x801800
006CA535    mov dword ptr ss:[ebp-0x130], ebx
006CA53B    jmp 0x006CA567
006CA53D    push 0x00
006CA53F    mov edx, edi
006CA541    lea ecx, ss:[ebp-0x130]
006CA547    call 0x0063D5E0
...
006CA55E    push ebx
006CA55F    call 0x00761FBE
006CA564    add esp, 0x0C
006CA567    push 0x147CF90
006CA56C    push 0x87E720
006CA571    call 0x0063B7F0
006CA576    add esp, 0x08
006CA579    test esi, esi
006CA57B    mov ecx, 0x801800
...
006CA5B0    jz 0x006CA5D0
006CA5B2    lea ecx, ss:[ebp-0x12C]
006CA5B8    call 0x0063D4E0
...
006CA5E7    jz 0x006CA623
006CA5E9    lea ecx, ss:[ebp-0x130]
006CA5EF    call 0x0063D4E0
