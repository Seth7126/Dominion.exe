...
0060D3C5    push 0x76AF3E                                   ; => [ Call: __ehhandler$?unlink_sources@?$target_block@V?$multi_link_registry@V?$ISource@I@Concurrency@@@Concurrency@@V?$ordered_message_processor@I@2@@Concurrency@@MAEXXZ | Type: EHRegistrationNode ]
0060D3CA    mov eax, dword ptr fs:[0x00000000]
0060D3D0    push eax                                        ; => [ Type: TEB | Field: ExceptionList | Field: NtTib | Type: _EXCEPTION_REGISTRATION_RECORD ]
...
0060D3DE    push eax                                        ; => [ Data: __security_cookie ]
0060D3DF    lea eax, ss:[ebp-0x0C]
0060D3E2    mov dword ptr fs:[0x00000000], eax              ; => [ Field: ExceptionList | Field: NtTib ]
...
0060D408    push eax
0060D409    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: dom_card_achievement_title_%s ]
...
0060D423    push eax
0060D424    call 0x0063DF30                                 ; => [ Call: sub_63df30 | String: dom_card_achievement_%s ]
0060D429    add esp, 0x0C
0060D42C    mov byte ptr ss:[ebp-0x04], 0x02
0060D430    mov dword ptr ds:[edi], 0x801800                ; => [ Data: data_801800 ]
0060D436    mov dword ptr ds:[edi+0x04], 0x801800           ; => [ Data: data_801800 ]
0060D43D    mov eax, dword ptr ss:[ebp-0x1C]
0060D440    lea ecx, ss:[ebp-0x14]
0060D443    mov esi, 0x801800                               ; => [ Data: data_801800 ]
0060D448    mov dword ptr ss:[ebp-0x18], 0x01
0060D44F    test eax, eax
0060D451    mov edx, esi                                    ; => [ Data: data_801800 ]
0060D453    cmovnz edx, eax
0060D456    call 0x004D47C0                                 ; => [ Call: sub_4d47c0 ]
...
0060D46C    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0060D471    mov byte ptr ss:[ebp-0x04], 0x04
0060D475    cmp dword ptr ds:[0x00CF65BC], 0x00
0060D47C    jz 0x0060D4A5                                   ; => [ Data: data_cf65bc ]
...
0060D48D    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060D4A0    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
...
0060D4B6    call 0x004D47C0                                 ; => [ Call: sub_4d47c0 ]
...
0060D4CD    call 0x0063D850                                 ; => [ Call: sub_63d850 ]
0060D4D2    mov byte ptr ss:[ebp-0x04], 0x06
0060D4D6    cmp dword ptr ds:[0x00CF65BC], 0x00
0060D4DD    jz 0x0060D506                                   ; => [ Data: data_cf65bc ]
...
0060D4EE    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060D501    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060D506    mov byte ptr ss:[ebp-0x04], 0x07
0060D50A    cmp dword ptr ds:[0x00CF65BC], 0x00
0060D511    jz 0x0060D541                                   ; => [ Data: data_cf65bc ]
...
0060D522    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060D535    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060D53A    mov dword ptr ss:[ebp-0x10], 0x801800           ; => [ Data: data_801800 ]
0060D541    mov dword ptr ss:[ebp-0x04], 0x08
0060D548    cmp dword ptr ds:[0x00CF65BC], 0x00
0060D54F    jz 0x0060D578                                   ; => [ Data: data_cf65bc ]
...
0060D560    call 0x0063D4E0                                 ; => [ Call: sub_63d4e0 ]
...
0060D573    call 0x0064C080                                 ; => [ Call: sub_64c080 ]
0060D578    mov eax, edi
0060D57A    mov ecx, dword ptr ss:[ebp-0x0C]
0060D57D    mov dword ptr fs:[0x00000000], ecx              ; => [ Field: ExceptionList | Field: NtTib ]
0060D584    pop ecx
0060D585    pop edi
0060D586    pop esi
0060D587    pop ebx
