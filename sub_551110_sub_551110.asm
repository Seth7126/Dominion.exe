...
0055111B    call 0x00761E50
00551120    mov eax, dword ptr ds:[0x008C4040]
00551125    xor eax, esp
00551127    mov dword ptr ss:[esp+0x2604], eax
0055112E    push esi
0055112F    push edi
00551130    call 0x00573400
00551135    push 0x00
00551137    push 0x00
00551139    push 0x01
...
00551141    push 0x01
00551143    call 0x00590760
00551148    add esp, 0x10
0055114B    call 0x00573400
...
00551180    mov dword ptr ss:[esp+0x1C], 0x00
...
005512BF    call 0x0063B870
005512C4    add esp, 0x0C
005512C7    call 0x0063BC30
005512CC    test al, al
005512CE    jz 0x005512D1
005512D0    int3
005512D1    call 0x0063BB00
