...
00688D53    push 0x8773C8                                   ; => [ String: ResizableBufferSetAllocatedLength ]
00688D58    push 0x2A
00688D5A    mov ecx, 0x877404                               ; => [ String: buffer.dataLength <= size ]
...
00688D6B    push 0x8773C8                                   ; => [ String: ResizableBufferSetAllocatedLength ]
00688D70    push 0x33
00688D72    mov ecx, 0x8773EC                               ; => [ String: buffer.dataPtr == NULL ]
00688D77    jmp 0x00688DC8
00688D79    mov ecx, edi
00688D7B    call 0x0064C020
00688D80    mov dword ptr ds:[esi], eax                     ; => [ Call: sub_64c020 ]
...
00688D8F    call 0x0064C020                                 ; => [ Call: sub_64c020 ]
...
00688DBA    pop ebx
00688DBB    ret
00688DBC    push 0x8773C8                                   ; => [ String: ResizableBufferSetAllocatedLength ]
00688DC1    push 0x39
00688DC3    mov ecx, 0x877434                               ; => [ String: buffer.dataPtr != NULL ]
00688DC8    push 0x8773A8
00688DCD    mov edx, 0x801800
00688DD2    call 0x0063B870                                 ; => [ String: ResizableBufferSetAllocatedLength | Call: sub_63b870 | Data: data_801800 | String: C:\x\ax2017\Engine\Network.cpp ]
00688DD7    add esp, 0x0C
00688DDA    call 0x0063BC30
00688DDF    test al, al
00688DE1    jz 0x00688DE4                                   ; => [ Call: sub_63bc30 ]
00688DE3    int3
00688DE4    call 0x0063BB00                                 ; => [ Call: sub_63bb00 ]
